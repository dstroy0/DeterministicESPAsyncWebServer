...
| Advanced attack  | ~HTTP + 12 | HTTP/1.1 desync+chunk+obs-fold+CRLF+range+upload, WS frame-abuse+ping+**deflate-bomb**, **SSE exhaustion+churn**, **WebDAV Depth:inf/XXE/traversal/PROPPATCH-bomb/LOCK-flood**, **CoAP option-abuse/block-bomb/observe-flood**, **SNMP getbulk-amp/BER-abuse/varbind-flood**, **OPC-UA hello-buffer-abuse/UACP-abuse/chunk-flood**, **Modbus illegal-requests/MBAP-abuse**, **MQTT malicious-broker (device-as-client)**, auth, csrf, throttle; tls handshake |
