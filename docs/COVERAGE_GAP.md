...
| Advanced attack  | ~HTTP + 10 | HTTP/1.1 desync+chunk+obs-fold+CRLF+range+upload, WS frame-abuse+ping, **SSE exhaustion+churn**, **WebDAV Depth:inf/XXE/traversal/PROPPATCH-bomb/LOCK-flood**, **CoAP option-abuse/block-bomb/observe-flood**, **SNMP getbulk-amp/BER-abuse/varbind-flood**, **OPC-UA hello-buffer-abuse/UACP-abuse/chunk-flood**, **Modbus illegal-requests/MBAP-abuse**, auth, csrf, throttle; tls handshake |
| Throughput bench |        ~16 | codecs (base64/hex/mime/mtconnect/**sse**/**webdav**/**coap**/**snmp**/**opcua**/**modbus**), storage, request-path (host), smb/dnc/relay/radio, CCOUNT primitives                                                                                                                                                                                                                             |
