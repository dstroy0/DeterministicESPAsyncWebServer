...
| ---------------- | ---------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Interop peers    |         11 | http, ws, **sse**, **webdav**, **mtconnect**, **redis**, coap, mqtt, modbus, snmp, opcua                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Advanced attack  | ~HTTP + 14 | HTTP/1.1 desync+chunk+obs-fold+CRLF+range+upload, WS frame-abuse+ping+**deflate-bomb**, **SSE exhaustion+churn**, **WebDAV Depth:inf/XXE/traversal/PROPPATCH-bomb/LOCK-flood**, **CoAP option-abuse/block-bomb/observe-flood**, **SNMP getbulk-amp/BER-abuse/varbind-flood**, **OPC-UA hello-buffer-abuse/UACP-abuse/chunk-flood**, **Modbus illegal-requests/MBAP-abuse**, **MQTT malicious-broker (device-as-client)**, **MTConnect param-abuse**, **Redis RESP fuzz**, auth, csrf, throttle; tls handshake |
| Throughput bench |        ~19 | codecs (base64/hex/mime/mtconnect/**sse**/**webdav**/**coap**/**snmp**/**opcua**/**modbus**/**ws-deflate**/**mqtt**/**redis**), storage, request-path (host), smb/dnc/relay/radio, CCOUNT primitives                                                                                                                                                                                                                                                                                                          |

The library implements **~50+ network protocols**; interop is the biggest gap by far (11 of ~50).
...
| TLS                                                                                                               |   n/a   |    -    |      ~      | downgrade/renegotiation/0-RTT/ALPN. **DRAM: TLS + the 8-protocol rig links (71.8% RAM) but begin() fails at runtime (-2) - needs a slim HTTP+TLS rig env or a PSRAM board**                                                   |
...
| Modbus                                                                                                            |   OK    |   OK    |     OK      | pymodbus peer (6/6 HW on rig); modbus_process_adu host+device bench; 2 advanced attacks (illegal-requests -> 6/6 proper exceptions, MBAP abuse) + fuzz - all held                                                             |
