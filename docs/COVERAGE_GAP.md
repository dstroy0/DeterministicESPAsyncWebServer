...
| ---------------- | ---------: | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Interop peers    |         10 | http, ws, **sse**, **webdav**, **mtconnect**, coap, mqtt, modbus, snmp, opcua                                                                                                                                                                                                                                                                                                                                                                                                            |
| Advanced attack  | ~HTTP + 13 | HTTP/1.1 desync+chunk+obs-fold+CRLF+range+upload, WS frame-abuse+ping+**deflate-bomb**, **SSE exhaustion+churn**, **WebDAV Depth:inf/XXE/traversal/PROPPATCH-bomb/LOCK-flood**, **CoAP option-abuse/block-bomb/observe-flood**, **SNMP getbulk-amp/BER-abuse/varbind-flood**, **OPC-UA hello-buffer-abuse/UACP-abuse/chunk-flood**, **Modbus illegal-requests/MBAP-abuse**, **MQTT malicious-broker (device-as-client)**, **MTConnect param-abuse**, auth, csrf, throttle; tls handshake |
| Throughput bench |        ~18 | codecs (base64/hex/mime/mtconnect/**sse**/**webdav**/**coap**/**snmp**/**opcua**/**modbus**/**ws-deflate**/**mqtt**), storage, request-path (host), smb/dnc/relay/radio, CCOUNT primitives                                                                                                                                                                                                                                                                                               |

The library implements **~50+ network protocols**; interop is the biggest gap by far (10 of ~50).
