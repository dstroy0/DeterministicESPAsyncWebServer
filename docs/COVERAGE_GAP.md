...
| Advanced attack  | ~HTTP + 8 | HTTP/1.1 desync+chunk+obs-fold+CRLF+range+upload, WS frame-abuse+ping, **SSE exhaustion+churn**, **WebDAV Depth:inf/XXE/traversal/PROPPATCH-bomb/LOCK-flood**, **CoAP option-abuse/block-bomb/observe-flood**, **SNMP getbulk-amp/BER-abuse/varbind-flood**, auth, csrf, throttle; modbus/opcua basic fuzz; tls handshake |
| Throughput bench |       ~14 | codecs (base64/hex/mime/mtconnect/**sse**/**webdav**/**coap**/**snmp**), storage, request-path (host), smb/dnc/relay/radio, CCOUNT primitives                                                                                                                                                                             |
