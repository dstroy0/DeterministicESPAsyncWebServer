...
| RFC 9147 DTLS 1.3      | 🔷      | Record layer: DTLSPlaintext + DTLSCiphertext (unified header, AEAD-128-GCM, §4.2.3 seq-num encryption + §4.2.2 reconstruction, §4.5.1 anti-replay). Handshake is roadmap | `native_dtls` (byte-exact KAT)      |
