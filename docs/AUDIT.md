...
| RFC 9147 DTLS 1.3      | 🔷      | Record layer (unified header, AEAD-128-GCM, §4.2.3 seq-num encryption + §4.2.2 reconstruction, §4.5.1 anti-replay) + handshake framing (§5.2 12-byte header, §5.4 reassembly, §7 ACK, §5.1 cookie). State machine is roadmap | `native_dtls`, `native_dtls_hs` (byte-exact KATs) |
