...
| RFC 9147 DTLS 1.3      | 🔷      | Record layer (unified header, AEAD-128-GCM, §4.2.3 seq-num encryption + §4.2.2 reconstruction, §4.5.1 anti-replay) + handshake framing (§5.2 header, §5.4 reassembly, §7 ACK, §5.1 cookie) + §5-6 server handshake (full 1-RTT, epoch 0→2→3, §5.9 `dtls13` labels) + §5.1 HRR group renegotiation (address-bound cookie). Full PTO roadmap | `native_dtls*`, `native_dtls_conn`, **`interop:wolfSSL` DTLS 1.3 (handshake + app data, direct + HRR)** |
