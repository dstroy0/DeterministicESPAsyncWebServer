...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:10.666 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.549 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.595 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.566 |
| `test_websocket`         | `native`               |    63 |   ✅   | 00:00:00.592 |
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.545 |
| `test_observability`     | `native_observability` |    15 |   ✅   | 00:00:00.691 |
| `test_http_ota`          | `native_ota`           |     3 |   ✅   | 00:00:00.636 |
| `test_provisioning`      | `native_prov`          |     5 |   ✅   | 00:00:00.640 |
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.828 |
...
| `test_ssh_conn`          | `native_ssh_conn`      |     2 |   ✅   | 00:00:01.240 |
| `test_regex`             | `native_app`           |     9 |   ✅   | 00:00:01.088 |
| `test_template`          | `native_app`           |     6 |   ✅   | 00:00:00.569 |
| `test_path_params`       | `native_app`           |     8 |   ✅   | 00:00:00.572 |
...
| `test_json`              | `native_app`           |    17 |   ✅   | 00:00:00.526 |
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.572 |
| `test_middleware`        | `native_app`           |     9 |   ✅   | 00:00:00.583 |
| `test_digest_auth`       | `native_app`           |     5 |   ✅   | 00:00:00.577 |
| `test_web_terminal`      | `native_app`           |     7 |   ✅   | 00:00:00.570 |
| `test_defer`             | `native_app`           |     3 |   ✅   | 00:00:00.549 |
| `test_multipart`         | `native_app`           |    19 |   ✅   | 00:00:00.583 |
| `test_auth`              | `native_app`           |    13 |   ✅   | 00:00:00.573 |
| `test_file_serving`      | `native_app`           |    12 |   ✅   | 00:00:00.586 |
| `test_dispatch`          | `native_app`           |    11 |   ✅   | 00:00:00.572 |
| `test_chunked`           | `native_app`           |    10 |   ✅   | 00:00:00.577 |
| `test_application`       | `native_app`           |    50 |   ✅   | 00:00:00.663 |
| `test_snmp_ber`          | `native_snmp`          |     9 |   ✅   | 00:00:00.663 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.473 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.358 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.778 |
| `test_coap`              | `native_coap`          |    26 |   ✅   | 00:00:00.648 |
| `test_webdav`            | `native_webdav`        |    19 |   ✅   | 00:00:00.631 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.622 |
| `test_modbus_master`     | `native_modbus_master` |     5 |   ✅   | 00:00:00.652 |
| `test_ota_rollback`      | `native_ota_rollback`  |     5 |   ✅   | 00:00:00.660 |
| `test_totp`              | `native_totp`          |     4 |   ✅   | 00:00:00.648 |
| `test_webhook`           | `native_webhook`       |     5 |   ✅   | 00:00:00.627 |
| `test_radio_power`       | `native_radio_power`   |     2 |   ✅   | 00:00:00.627 |
| `test_dns_resolver`      | `native_dns_resolver`  |     4 |   ✅   | 00:00:00.622 |
| `test_audit_log`         | `native_audit_log`     |    12 |   ✅   | 00:00:00.663 |
| `test_oidc`              | `native_oidc`          |    13 |   ✅   | 00:00:00.815 |
| `test_vfs`               | `native_vfs`           |    11 |   ✅   | 00:00:00.633 |
| `test_graphql`           | `native_graphql`       |    13 |   ✅   | 00:00:00.652 |
| `test_espnow`            | `native_espnow`        |     7 |   ✅   | 00:00:00.636 |
| `test_oauth2`            | `native_oauth2`        |     8 |   ✅   | 00:00:00.672 |
| `test_opcua`             | `native_opcua`         |    29 |   ✅   | 00:00:00.651 |
| `test_opcua_client`      | `native_opcua_client`  |    11 |   ✅   | 00:00:00.683 |
| `test_keepalive`         | `native_keepalive`     |    10 |   ✅   | 00:00:01.050 |
| `test_range`             | `native_range`         |    10 |   ✅   | 00:00:01.048 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.645 |
| `test_jwt`               | `native_jwt`           |    10 |   ✅   | 00:00:00.672 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.068 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.646 |
| `test_compliance`        | `native_compliance`    |    12 |   ✅   | 00:00:00.637 |
| `test_mqtt`              | `native_mqtt`          |    16 |   ✅   | 00:00:00.638 |
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.665 |
| `test_scratch`           | `native_scratch`       |    14 |   ✅   | 00:00:00.667 |
| `test_snmp_trap`         | `native_snmp_trap`     |     3 |   ✅   | 00:00:00.653 |
| `test_inflate`           | `native_inflate`       |    12 |   ✅   | 00:00:00.628 |
| `test_deflate`           | `native_deflate`       |    10 |   ✅   | 00:00:00.676 |
| `test_websocket`         | `native_ws_deflate`    |    67 |   ✅   | 00:00:01.002 |
| `test_time_source`       | `native_time_source`   |     9 |   ✅   | 00:00:00.619 |
| `test_config_store`      | `native_config_store`  |    14 |   ✅   | 00:00:00.623 |
| `test_device_id`         | `native_device_id`     |     4 |   ✅   | 00:00:00.638 |
| `test_auth_lockout`      | `native_auth_lockout`  |    10 |   ✅   | 00:00:00.623 |
| `test_csrf`              | `native_csrf`          |     9 |   ✅   | 00:00:00.670 |
| `test_telemetry`         | `native_telemetry`     |     8 |   ✅   | 00:00:00.653 |
| `test_dashboard`         | `native_dashboard`     |    11 |   ✅   | 00:00:00.641 |
| `test_net_egress`        | `native_net_egress`    |     5 |   ✅   | 00:00:00.631 |
| `test_partition_monitor` | `native_partition`     |     5 |   ✅   | 00:00:00.630 |
| `test_cbor`              | `native_cbor`          |    14 |   ✅   | 00:00:00.641 |
| `test_msgpack`           | `native_msgpack`       |    15 |   ✅   | 00:00:00.642 |
| `test_gpio_map`          | `native_gpio_map`      |     8 |   ✅   | 00:00:00.627 |
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.637 |
| `test_guardrails`        | `native_guardrails`    |     6 |   ✅   | 00:00:00.627 |
| `test_logbuf`            | `native_logbuf`        |     4 |   ✅   | 00:00:00.631 |
| `test_config_io`         | `native_config_io`     |     4 |   ✅   | 00:00:00.645 |
| `test_workers`           | `native_workers`       |     3 |   ✅   | 00:00:00.746 |
| `test_clock`             | `native_clock`         |     4 |   ✅   | 00:00:00.617 |
| `test_concurrency`       | `native_concurrency`   |     2 |   ✅   | 00:00:00.796 |
| `test_concurrency`       | `native_tsan`          |     2 |   ✅   | 00:00:01.065 |
...
----------------- native:test_sse [PASSED] Took 10.67 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:10.666
native         test_session       PASSED    00:00:00.549
native         test_presentation  PASSED    00:00:00.595
native         test_transport     PASSED    00:00:00.566
native         test_websocket     PASSED    00:00:00.592
native         test_http_parser   PASSED    00:00:00.545
================ 306 test cases: 306 succeeded in 00:00:13.514 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.691
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.640
...
================= 92 test cases: 92 succeeded in 00:00:06.418 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.240
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.088
native_app     test_template          PASSED    00:00:00.569
native_app     test_path_params       PASSED    00:00:00.572
...
native_app     test_json              PASSED    00:00:00.526
native_app     test_response_headers  PASSED    00:00:00.572
native_app     test_middleware        PASSED    00:00:00.583
native_app     test_digest_auth       PASSED    00:00:00.577
native_app     test_web_terminal      PASSED    00:00:00.570
native_app     test_defer             PASSED    00:00:00.549
native_app     test_multipart         PASSED    00:00:00.583
...
native_app     test_chunked           PASSED    00:00:00.577
native_app     test_application       PASSED    00:00:00.663
================ 204 test cases: 204 succeeded in 00:00:10.811 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
native_snmp    test_snmp_agent  PASSED    00:00:00.473
================= 22 test cases: 22 succeeded in 00:00:01.136 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.358
================== 9 test cases: 9 succeeded in 00:00:01.358 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.648
================= 26 test cases: 26 succeeded in 00:00:00.648 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.631
================= 19 test cases: 19 succeeded in 00:00:00.631 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.652
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.648
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.627
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.627
================== 2 test cases: 2 succeeded in 00:00:00.627 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.636
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.651
================= 29 test cases: 29 succeeded in 00:00:00.651 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.683
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.050
================= 10 test cases: 10 succeeded in 00:00:01.050 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
================= 10 test cases: 10 succeeded in 00:00:01.048 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.645
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.672
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.637
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.665
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.667
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.676
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.002
================= 67 test cases: 67 succeeded in 00:00:01.002 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.619
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.623
================= 14 test cases: 14 succeeded in 00:00:00.623 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.638
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.623
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.670
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.641
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.631
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.630
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.641
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.627
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.637
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.627
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.631
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.645
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.065
