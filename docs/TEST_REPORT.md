...
**Generated:** 2026-06-29 18:13:29
**Command:** `pio test` over 79 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1391 passed - 134s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:06.626 |
...
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.645 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.772 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.707 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.702 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.945 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.589 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.709 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.911 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.567 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.919 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.308 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.201 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.656 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.644 |
...
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.589 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.636 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.654 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.679 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.705 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.654 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.666 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.670 |
...
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.725 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.265 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.230 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.737 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.554 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.520 |
...
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.717 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.712 |
...
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.702 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.697 |
| `test_protobuf`          | `native_protobuf`       |     8 |   ✅   | 00:00:00.677 |
| `test_wamp`              | `native_wamp`           |    11 |   ✅   | 00:00:00.716 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.691 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.699 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.710 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.695 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |     7 |   ✅   | 00:00:00.698 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.685 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.731 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.672 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.694 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.710 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.682 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.703 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.703 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.875 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.694 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.686 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.689 |
...
| `test_http_client`       | `native_http_client`    |    10 |   ✅   | 00:00:00.703 |
...
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.675 |
...
------------------ native:test_sse [PASSED] Took 6.63 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.626
...
native         test_http_parser   PASSED    00:00:00.645
================ 318 test cases: 318 succeeded in 00:00:09.778 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 104 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.707
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.702
...
native_ssh     test_ssh_server     PASSED    00:00:00.709
native_ssh     test_ssh_transport  PASSED    00:00:00.911
native_ssh     test_ssh_channel    PASSED    00:00:00.567
================= 93 test cases: 93 succeeded in 00:00:06.722 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 104 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.919
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.308
...
native_app     test_template          PASSED    00:00:00.656
native_app     test_path_params       PASSED    00:00:00.644
...
native_app     test_middleware        PASSED    00:00:00.654
native_app     test_digest_auth       PASSED    00:00:00.679
native_app     test_web_terminal      PASSED    00:00:00.705
native_app     test_defer             PASSED    00:00:00.654
native_app     test_multipart         PASSED    00:00:00.666
native_app     test_auth              PASSED    00:00:00.670
...
native_app     test_application       PASSED    00:00:00.725
================ 219 test cases: 219 succeeded in 00:00:12.268 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 104 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.230
...
================= 29 test cases: 29 succeeded in 00:00:01.291 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 104 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.520
================= 10 test cases: 10 succeeded in 00:00:01.520 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 104 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.717
================= 19 test cases: 19 succeeded in 00:00:00.717 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 104 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.712
================= 18 test cases: 18 succeeded in 00:00:00.712 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 104 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.716
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.699
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.710
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.698
...
test/test_hostlink/test_hostlink.cpp:30: test_build_dm_read: Expected '@00RD0000001057*\r' Was '@00RD0000001057*\r\xA2\xD2\xC7\xFE\x7F' [FAILED]
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  ERRORED   00:00:00.688

============= 8 test cases: 1 failed, 6 succeeded in 00:00:00.688 =============
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 104 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.731
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.710
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.703
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.875
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.689
