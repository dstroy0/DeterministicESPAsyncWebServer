...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:07.040 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.554 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.585 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.574 |
| `test_websocket`         | `native`               |    63 |   ✅   | 00:00:00.620 |
...
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.824 |
| `test_ssh_auth`          | `native_ssh`           |    12 |   ✅   | 00:00:00.548 |
| `test_ssh_server`        | `native_ssh`           |     7 |   ✅   | 00:00:00.661 |
| `test_ssh_transport`     | `native_ssh`           |    23 |   ✅   | 00:00:00.872 |
| `test_ssh_channel`       | `native_ssh`           |    12 |   ✅   | 00:00:00.522 |
| `test_ssh_hardening`     | `native_ssh_hardened`  |     2 |   ✅   | 00:00:00.966 |
| `test_ssh_conn`          | `native_ssh_conn`      |     2 |   ✅   | 00:00:01.241 |
| `test_regex`             | `native_app`           |     9 |   ✅   | 00:00:01.091 |
| `test_template`          | `native_app`           |     6 |   ✅   | 00:00:00.574 |
| `test_path_params`       | `native_app`           |     8 |   ✅   | 00:00:00.579 |
| `test_digest_vectors`    | `native_app`           |     4 |   ✅   | 00:00:00.517 |
| `test_form_params`       | `native_app`           |     5 |   ✅   | 00:00:00.567 |
| `test_iface`             | `native_app`           |     7 |   ✅   | 00:00:00.575 |
| `test_json`              | `native_app`           |    17 |   ✅   | 00:00:00.523 |
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.580 |
| `test_middleware`        | `native_app`           |     9 |   ✅   | 00:00:00.579 |
| `test_digest_auth`       | `native_app`           |     5 |   ✅   | 00:00:00.580 |
| `test_web_terminal`      | `native_app`           |     7 |   ✅   | 00:00:00.577 |
| `test_defer`             | `native_app`           |     3 |   ✅   | 00:00:00.552 |
| `test_multipart`         | `native_app`           |    19 |   ✅   | 00:00:00.585 |
| `test_auth`              | `native_app`           |    13 |   ✅   | 00:00:00.580 |
| `test_file_serving`      | `native_app`           |    12 |   ✅   | 00:00:00.591 |
| `test_dispatch`          | `native_app`           |    11 |   ✅   | 00:00:00.574 |
| `test_chunked`           | `native_app`           |    10 |   ✅   | 00:00:00.609 |
| `test_application`       | `native_app`           |    52 |   ✅   | 00:00:00.665 |
| `test_snmp_ber`          | `native_snmp`          |     9 |   ✅   | 00:00:00.680 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.481 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.376 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.780 |
| `test_coap`              | `native_coap`          |    26 |   ✅   | 00:00:00.639 |
| `test_webdav`            | `native_webdav`        |    19 |   ✅   | 00:00:00.648 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.637 |
| `test_modbus_master`     | `native_modbus_master` |     5 |   ✅   | 00:00:00.655 |
| `test_ota_rollback`      | `native_ota_rollback`  |     5 |   ✅   | 00:00:00.635 |
| `test_totp`              | `native_totp`          |     4 |   ✅   | 00:00:00.646 |
| `test_webhook`           | `native_webhook`       |     5 |   ✅   | 00:00:00.635 |
| `test_radio_power`       | `native_radio_power`   |     2 |   ✅   | 00:00:00.622 |
| `test_dns_resolver`      | `native_dns_resolver`  |     4 |   ✅   | 00:00:00.624 |
| `test_audit_log`         | `native_audit_log`     |    12 |   ✅   | 00:00:00.646 |
| `test_oidc`              | `native_oidc`          |    13 |   ✅   | 00:00:00.811 |
| `test_vfs`               | `native_vfs`           |    11 |   ✅   | 00:00:00.639 |
| `test_graphql`           | `native_graphql`       |    13 |   ✅   | 00:00:00.625 |
| `test_espnow`            | `native_espnow`        |     7 |   ✅   | 00:00:00.634 |
| `test_oauth2`            | `native_oauth2`        |     8 |   ✅   | 00:00:00.665 |
| `test_opcua`             | `native_opcua`         |    29 |   ✅   | 00:00:00.659 |
| `test_opcua_client`      | `native_opcua_client`  |    11 |   ✅   | 00:00:00.681 |
| `test_keepalive`         | `native_keepalive`     |    10 |   ✅   | 00:00:01.037 |
| `test_range`             | `native_range`         |    13 |   ✅   | 00:00:01.041 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.665 |
| `test_jwt`               | `native_jwt`           |    10 |   ✅   | 00:00:00.675 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.073 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.645 |
| `test_compliance`        | `native_compliance`    |    12 |   ✅   | 00:00:00.643 |
| `test_mqtt`              | `native_mqtt`          |    16 |   ✅   | 00:00:00.637 |
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.676 |
| `test_scratch`           | `native_scratch`       |    14 |   ✅   | 00:00:00.662 |
| `test_snmp_trap`         | `native_snmp_trap`     |     3 |   ✅   | 00:00:00.650 |
| `test_inflate`           | `native_inflate`       |    12 |   ✅   | 00:00:00.633 |
| `test_deflate`           | `native_deflate`       |    10 |   ✅   | 00:00:00.691 |
| `test_websocket`         | `native_ws_deflate`    |    67 |   ✅   | 00:00:01.008 |
| `test_time_source`       | `native_time_source`   |     9 |   ✅   | 00:00:00.620 |
| `test_config_store`      | `native_config_store`  |    14 |   ✅   | 00:00:00.651 |
| `test_device_id`         | `native_device_id`     |     4 |   ✅   | 00:00:00.651 |
| `test_auth_lockout`      | `native_auth_lockout`  |    10 |   ✅   | 00:00:00.627 |
| `test_csrf`              | `native_csrf`          |     9 |   ✅   | 00:00:00.661 |
| `test_telemetry`         | `native_telemetry`     |     8 |   ✅   | 00:00:00.642 |
| `test_dashboard`         | `native_dashboard`     |    11 |   ✅   | 00:00:00.635 |
| `test_net_egress`        | `native_net_egress`    |     5 |   ✅   | 00:00:00.630 |
| `test_partition_monitor` | `native_partition`     |     5 |   ✅   | 00:00:00.626 |
| `test_cbor`              | `native_cbor`          |    14 |   ✅   | 00:00:00.635 |
| `test_msgpack`           | `native_msgpack`       |    15 |   ✅   | 00:00:00.651 |
| `test_gpio_map`          | `native_gpio_map`      |     8 |   ✅   | 00:00:00.647 |
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.632 |
| `test_guardrails`        | `native_guardrails`    |     6 |   ✅   | 00:00:00.632 |
| `test_logbuf`            | `native_logbuf`        |     4 |   ✅   | 00:00:00.644 |
| `test_config_io`         | `native_config_io`     |     4 |   ✅   | 00:00:00.659 |
| `test_workers`           | `native_workers`       |     3 |   ✅   | 00:00:00.746 |
| `test_clock`             | `native_clock`         |     4 |   ✅   | 00:00:00.618 |
...
------------------ native:test_sse [PASSED] Took 7.04 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:07.040
native         test_session       PASSED    00:00:00.554
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.824
native_ssh     test_ssh_auth       PASSED    00:00:00.548
native_ssh     test_ssh_server     PASSED    00:00:00.661
native_ssh     test_ssh_transport  PASSED    00:00:00.872
native_ssh     test_ssh_channel    PASSED    00:00:00.522
================= 92 test cases: 92 succeeded in 00:00:06.427 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.241
================== 2 test cases: 2 succeeded in 00:00:01.241 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
src/DeterministicESPAsyncWebServer.cpp:2788:76: warning: ‘snprintf’ output may be truncated before the last format character [-Wformat-truncation=]
 2788 |         snprintf(lastmod_line, sizeof(lastmod_line), "Last-Modified: %s\r\n", lm_date);
      |                                                                            ^
src/DeterministicESPAsyncWebServer.cpp:2788:17: note: ‘snprintf’ output between 18 and 57 bytes into a destination of size 56
 2788 |         snprintf(lastmod_line, sizeof(lastmod_line), "Last-Modified: %s\r\n", lm_date);
      |         ~~~~~~~~^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Testing...
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.091
native_app     test_template          PASSED    00:00:00.574
native_app     test_path_params       PASSED    00:00:00.579
native_app     test_digest_vectors    PASSED    00:00:00.517
native_app     test_form_params       PASSED    00:00:00.567
native_app     test_iface             PASSED    00:00:00.575
native_app     test_json              PASSED    00:00:00.523
native_app     test_response_headers  PASSED    00:00:00.580
native_app     test_middleware        PASSED    00:00:00.579
native_app     test_digest_auth       PASSED    00:00:00.580
native_app     test_web_terminal      PASSED    00:00:00.577
native_app     test_defer             PASSED    00:00:00.552
native_app     test_multipart         PASSED    00:00:00.585
native_app     test_auth              PASSED    00:00:00.580
...
================ 206 test cases: 206 succeeded in 00:00:10.897 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
================= 22 test cases: 22 succeeded in 00:00:01.160 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.376
================== 9 test cases: 9 succeeded in 00:00:01.376 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.780
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.639
================= 26 test cases: 26 succeeded in 00:00:00.639 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.648
...
================= 13 test cases: 13 succeeded in 00:00:00.637 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.635
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.635
================== 5 test cases: 5 succeeded in 00:00:00.635 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.624
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.646
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.625
================= 13 test cases: 13 succeeded in 00:00:00.625 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.659
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.681
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.037
================= 10 test cases: 10 succeeded in 00:00:01.037 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.041
================= 13 test cases: 13 succeeded in 00:00:01.041 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.645
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.643
...
================= 16 test cases: 16 succeeded in 00:00:00.637 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.650
...
================= 67 test cases: 67 succeeded in 00:00:01.008 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.620
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.627
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.661
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.630
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.635
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.632
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.659
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.618
