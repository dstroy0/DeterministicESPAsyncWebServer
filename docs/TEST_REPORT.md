...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:06.839 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.547 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.591 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.570 |
| `test_websocket`         | `native`               |    63 |   ✅   | 00:00:00.593 |
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.552 |
...
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.760 |
...
| `test_ssh_channel`       | `native_ssh`           |    12 |   ✅   | 00:00:00.531 |
| `test_ssh_hardening`     | `native_ssh_hardened`  |     2 |   ✅   | 00:00:00.893 |
| `test_ssh_conn`          | `native_ssh_conn`      |     2 |   ✅   | 00:00:01.263 |
| `test_regex`             | `native_app`           |     9 |   ✅   | 00:00:01.091 |
| `test_template`          | `native_app`           |     6 |   ✅   | 00:00:00.565 |
| `test_path_params`       | `native_app`           |     8 |   ✅   | 00:00:00.570 |
| `test_digest_vectors`    | `native_app`           |     4 |   ✅   | 00:00:00.523 |
| `test_form_params`       | `native_app`           |     5 |   ✅   | 00:00:00.563 |
| `test_iface`             | `native_app`           |     7 |   ✅   | 00:00:00.574 |
| `test_json`              | `native_app`           |    17 |   ✅   | 00:00:00.528 |
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.577 |
| `test_middleware`        | `native_app`           |     9 |   ✅   | 00:00:00.575 |
| `test_digest_auth`       | `native_app`           |     5 |   ✅   | 00:00:00.582 |
| `test_web_terminal`      | `native_app`           |     7 |   ✅   | 00:00:00.572 |
...
| `test_chunked`           | `native_app`           |     8 |   ✅   | 00:00:00.569 |
| `test_application`       | `native_app`           |    50 |   ✅   | 00:00:00.674 |
| `test_snmp_ber`          | `native_snmp`          |     9 |   ✅   | 00:00:00.697 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.495 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.413 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.771 |
| `test_coap`              | `native_coap`          |    26 |   ✅   | 00:00:00.678 |
| `test_webdav`            | `native_webdav`        |    19 |   ✅   | 00:00:00.678 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.674 |
...
| `test_oidc`              | `native_oidc`          |    13 |   ✅   | 00:00:00.825 |
...
| `test_opcua`             | `native_opcua`         |    29 |   ✅   | 00:00:00.692 |
| `test_opcua_client`      | `native_opcua_client`  |    11 |   ✅   | 00:00:00.693 |
| `test_keepalive`         | `native_keepalive`     |    10 |   ✅   | 00:00:01.028 |
| `test_range`             | `native_range`         |    10 |   ✅   | 00:00:01.044 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.671 |
| `test_jwt`               | `native_jwt`           |    10 |   ✅   | 00:00:00.708 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.062 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.660 |
| `test_compliance`        | `native_compliance`    |    12 |   ✅   | 00:00:00.670 |
| `test_mqtt`              | `native_mqtt`          |    16 |   ✅   | 00:00:00.666 |
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.696 |
| `test_scratch`           | `native_scratch`       |    14 |   ✅   | 00:00:00.699 |
| `test_snmp_trap`         | `native_snmp_trap`     |     3 |   ✅   | 00:00:00.680 |
...
| `test_config_store`      | `native_config_store`  |    14 |   ✅   | 00:00:00.646 |
| `test_device_id`         | `native_device_id`     |     4 |   ✅   | 00:00:00.675 |
| `test_auth_lockout`      | `native_auth_lockout`  |    10 |   ✅   | 00:00:00.653 |
| `test_csrf`              | `native_csrf`          |     9 |   ✅   | 00:00:00.685 |
| `test_telemetry`         | `native_telemetry`     |     8 |   ✅   | 00:00:00.663 |
| `test_dashboard`         | `native_dashboard`     |    11 |   ✅   | 00:00:00.663 |
...
| `test_concurrency`       | `native_tsan`          |     2 |   ✅   | 00:00:01.305 |
...
------------------ native:test_sse [PASSED] Took 6.84 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.839
native         test_session       PASSED    00:00:00.547
native         test_presentation  PASSED    00:00:00.591
native         test_transport     PASSED    00:00:00.570
native         test_websocket     PASSED    00:00:00.593
native         test_http_parser   PASSED    00:00:00.552
================ 306 test cases: 306 succeeded in 00:00:09.693 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.760
...
native_ssh     test_ssh_channel    PASSED    00:00:00.531
================= 92 test cases: 92 succeeded in 00:00:06.482 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.893
...
native_app     test_path_params       PASSED    00:00:00.570
native_app     test_digest_vectors    PASSED    00:00:00.523
native_app     test_form_params       PASSED    00:00:00.563
native_app     test_iface             PASSED    00:00:00.574
native_app     test_json              PASSED    00:00:00.528
native_app     test_response_headers  PASSED    00:00:00.577
native_app     test_middleware        PASSED    00:00:00.575
native_app     test_digest_auth       PASSED    00:00:00.582
...
native_app     test_chunked           PASSED    00:00:00.569
native_app     test_application       PASSED    00:00:00.674
================ 202 test cases: 202 succeeded in 00:00:10.847 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
native_snmp    test_snmp_agent  PASSED    00:00:00.495
================= 22 test cases: 22 succeeded in 00:00:01.192 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.413
================== 9 test cases: 9 succeeded in 00:00:01.413 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.674
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.825
================= 13 test cases: 13 succeeded in 00:00:00.825 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
================= 29 test cases: 29 succeeded in 00:00:00.692 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.028
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.044
================= 10 test cases: 10 succeeded in 00:00:01.044 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.062
================== 3 test cases: 3 succeeded in 00:00:01.062 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.653
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.305
