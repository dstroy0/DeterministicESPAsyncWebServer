...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:13.116 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.526 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.556 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.537 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.562 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.523 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.803 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.553 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.644 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.854 |
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.512 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.837 |
...
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.490 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.541 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.558 |
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.509 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.551 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.549 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.558 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.541 |
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.524 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.550 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.549 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.578 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.567 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.549 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.639 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.626 |
| `test_workers`          | `native_workers`      |     3 |   ✅   | 00:00:00.705 |
| `test_concurrency`      | `native_tsan`         |     2 |   ✅   | 00:00:01.383 |
...
----------------- native:test_sse [PASSED] Took 13.12 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:13.116
...
native               test_websocket         PASSED    00:00:00.562
native               test_http_parser       PASSED    00:00:00.523
native_ssh           test_ssh_crypto        PASSED    00:00:03.803
native_ssh           test_ssh_auth          PASSED    00:00:00.553
native_ssh           test_ssh_server        PASSED    00:00:00.644
native_ssh           test_ssh_transport     PASSED    00:00:00.854
native_ssh           test_ssh_channel       PASSED    00:00:00.512
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.837
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.171
native_app           test_regex             PASSED    00:00:01.047
native_app           test_template          PASSED    00:00:00.541
native_app           test_path_params       PASSED    00:00:00.544
native_app           test_digest_vectors    PASSED    00:00:00.490
native_app           test_form_params       PASSED    00:00:00.541
native_app           test_iface             PASSED    00:00:00.558
native_app           test_json              PASSED    00:00:00.509
native_app           test_response_headers  PASSED    00:00:00.551
native_app           test_middleware        PASSED    00:00:00.549
native_app           test_digest_auth       PASSED    00:00:00.558
native_app           test_web_terminal      PASSED    00:00:00.541
native_app           test_defer             PASSED    00:00:00.524
native_app           test_multipart         PASSED    00:00:00.550
...
native_workers       test_workers           PASSED    00:00:00.705
native_tsan          test_concurrency       PASSED    00:00:01.383
================ 619 test cases: 619 succeeded in 00:00:37.294 ================
```
