...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    11 |   ✅   | 00:00:06.658 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.691 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.698 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.701 |
| `test_mbus`              | `native_mbus`           |     8 |   ✅   | 00:00:00.683 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.684 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.685 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.684 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.662 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.654 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.165 |
...
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.604 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.772 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:01.129 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.687 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.705 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:04.093 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.622 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.738 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.945 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.568 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.075 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.604 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.377 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.626 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.619 |
...
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.619 |
...
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.417 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.435 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.788 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.538 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.616 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.886 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.943 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.817 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.683 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.704 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.775 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.683 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.708 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.689 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.695 |
| `test_protobuf`          | `native_protobuf`       |    10 |   ✅   | 00:00:00.681 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.712 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.690 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.672 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.684 |
...
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.763 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.689 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.689 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.713 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.663 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.693 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.695 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.675 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.648 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.682 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.678 |
| `test_sparkplug`         | `native_sparkplug`      |     6 |   ✅   | 00:00:00.697 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.700 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.670 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.688 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.681 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.652 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.674 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.689 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.953 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.682 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.668 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.671 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.705 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.687 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.735 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.248 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.243 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.685 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.750 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.301 |
| `test_http_client`       | `native_http_client`    |    11 |   ✅   | 00:00:00.653 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.684 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.676 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.738 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.703 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.690 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.679 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.724 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.211 |
...
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.677 |
...
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.669 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.691 |
...
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.646 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.691 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.835 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.639 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.813 |
...
------------ native_canopen:test_canopen [PASSED] Took 6.66 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.658
================= 11 test cases: 11 succeeded in 00:00:06.658 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.685
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.684
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.654
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.165
...
================ 318 test cases: 318 succeeded in 00:00:04.266 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
================= 10 test cases: 10 succeeded in 00:00:01.129 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.687
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.093
native_ssh     test_ssh_auth       PASSED    00:00:00.622
native_ssh     test_ssh_server     PASSED    00:00:00.738
native_ssh     test_ssh_transport  PASSED    00:00:00.945
native_ssh     test_ssh_channel    PASSED    00:00:00.568
================= 93 test cases: 93 succeeded in 00:00:06.965 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:01.075
================== 2 test cases: 2 succeeded in 00:00:01.075 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.604
================== 2 test cases: 2 succeeded in 00:00:01.604 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.377
native_app     test_template          PASSED    00:00:00.626
native_app     test_path_params       PASSED    00:00:00.619
...
native_app     test_middleware        PASSED    00:00:00.619
...
================ 219 test cases: 219 succeeded in 00:00:11.959 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.417
================= 12 test cases: 12 succeeded in 00:00:01.417 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
--------------- native_diag:test_diag [PASSED] Took 1.44 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.435
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.788
native_snmp    test_snmp_agent  PASSED    00:00:00.538
================= 30 test cases: 30 succeeded in 00:00:01.326 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 1.62 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.616
================= 10 test cases: 10 succeeded in 00:00:01.616 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
------------- native_telnet:test_telnet [PASSED] Took 0.89 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.886
...
================= 29 test cases: 29 succeeded in 00:00:00.943 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.817
================= 29 test cases: 29 succeeded in 00:00:00.817 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.683
================= 19 test cases: 19 succeeded in 00:00:00.683 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.704
================= 18 test cases: 18 succeeded in 00:00:00.704 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.775
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.683
================== 8 test cases: 8 succeeded in 00:00:00.683 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.695
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.712
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.672
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.763
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.695
================== 6 test cases: 6 succeeded in 00:00:00.695 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.675
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.648
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.697
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.700
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.670
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.688
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.681
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.689
================= 12 test cases: 12 succeeded in 00:00:00.689 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.953
================= 13 test cases: 13 succeeded in 00:00:00.953 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.705
...
================= 29 test cases: 29 succeeded in 00:00:00.687 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.735
...
-------------- native_range:test_range [PASSED] Took 1.24 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.243
================= 13 test cases: 13 succeeded in 00:00:01.243 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.750
================= 12 test cases: 12 succeeded in 00:00:00.750 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.301
================== 3 test cases: 3 succeeded in 00:00:01.301 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.211
================= 71 test cases: 71 succeeded in 00:00:01.211 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.646
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.639
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.813
================== 2 test cases: 2 succeeded in 00:00:00.813 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
