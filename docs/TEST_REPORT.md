...
| `test_ssh_conn`          | `native_ssh_conn`      |     2 |   ✅   | 00:00:01.273 |
| `test_regex`             | `native_app`           |     9 |   ✅   | 00:00:01.140 |
...
| `test_json`              | `native_app`           |    17 |   ✅   | 00:00:00.572 |
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.605 |
| `test_middleware`        | `native_app`           |     9 |   ✅   | 00:00:00.613 |
| `test_digest_auth`       | `native_app`           |     5 |   ✅   | 00:00:00.625 |
| `test_web_terminal`      | `native_app`           |     7 |   ✅   | 00:00:00.610 |
...
| `test_application`       | `native_app`           |    50 |   ✅   | 00:00:00.693 |
| `test_snmp_ber`          | `native_snmp`          |     9 |   ✅   | 00:00:00.719 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.512 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.440 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.821 |
| `test_coap`              | `native_coap`          |    26 |   ✅   | 00:00:00.703 |
| `test_webdav`            | `native_webdav`        |    19 |   ✅   | 00:00:00.671 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.660 |
...
| `test_graphql`           | `native_graphql`       |    13 |   ✅   | 00:00:00.693 |
| `test_espnow`            | `native_espnow`        |     7 |   ✅   | 00:00:00.656 |
| `test_oauth2`            | `native_oauth2`        |     8 |   ✅   | 00:00:00.694 |
| `test_opcua`             | `native_opcua`         |    29 |   ✅   | 00:00:00.714 |
| `test_opcua_client`      | `native_opcua_client`  |    11 |   ✅   | 00:00:00.712 |
| `test_keepalive`         | `native_keepalive`     |    10 |   ✅   | 00:00:01.074 |
| `test_range`             | `native_range`         |    10 |   ✅   | 00:00:01.072 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.688 |
| `test_jwt`               | `native_jwt`           |    10 |   ✅   | 00:00:00.713 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.121 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.684 |
| `test_compliance`        | `native_compliance`    |    12 |   ✅   | 00:00:00.659 |
| `test_mqtt`              | `native_mqtt`          |    16 |   ✅   | 00:00:00.681 |
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.716 |
...
| `test_websocket`         | `native_ws_deflate`    |    67 |   ✅   | 00:00:01.046 |
...
| `test_auth_lockout`      | `native_auth_lockout`  |    10 |   ✅   | 00:00:00.667 |
| `test_csrf`              | `native_csrf`          |     9 |   ✅   | 00:00:00.699 |
| `test_telemetry`         | `native_telemetry`     |     8 |   ✅   | 00:00:00.694 |
| `test_dashboard`         | `native_dashboard`     |    11 |   ✅   | 00:00:00.683 |
| `test_net_egress`        | `native_net_egress`    |     5 |   ✅   | 00:00:00.665 |
| `test_partition_monitor` | `native_partition`     |     5 |   ✅   | 00:00:00.685 |
| `test_cbor`              | `native_cbor`          |    14 |   ✅   | 00:00:00.668 |
| `test_msgpack`           | `native_msgpack`       |    15 |   ✅   | 00:00:00.679 |
| `test_gpio_map`          | `native_gpio_map`      |     8 |   ✅   | 00:00:00.678 |
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.676 |
...
| `test_concurrency`       | `native_concurrency`   |     2 |   ✅   | 00:00:00.938 |
...
----------------- native:test_sse [PASSED] Took 15.03 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:15.027
...
================ 306 test cases: 306 succeeded in 00:00:18.065 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.273
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.140
...
================ 204 test cases: 204 succeeded in 00:00:11.541 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
================= 22 test cases: 22 succeeded in 00:00:01.231 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.440
================== 9 test cases: 9 succeeded in 00:00:01.440 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.703
================= 26 test cases: 26 succeeded in 00:00:00.703 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.694
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.712
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.074
================= 10 test cases: 10 succeeded in 00:00:01.074 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.072
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.716
...
================= 67 test cases: 67 succeeded in 00:00:01.046 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.667
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.683
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.938
================== 2 test cases: 2 succeeded in 00:00:00.938 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
