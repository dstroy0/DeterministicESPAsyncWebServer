...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:05.837 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.647 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.683 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.666 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:04.458 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.664 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.664 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.673 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.676 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.681 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.672 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.671 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.680 |
...
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.628 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.647 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.611 |
...
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.956 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.652 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.885 |
| `test_ssh_transport`     | `native_ssh`            |    31 |   ✅   | 00:00:01.171 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.596 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.969 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.344 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.231 |
...
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.588 |
...
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.642 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.643 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.704 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.247 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.224 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.730 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.552 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:01.997 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.828 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.781 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.784 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.686 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.653 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.754 |
...
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.775 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.860 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.767 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.673 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.665 |
...
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.672 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.673 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.673 |
...
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.672 |
...
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.680 |
...
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.670 |
...
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.723 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.699 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.116 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.178 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.696 |
| `test_smtp`              | `native_smtp`           |    11 |   ✅   | 00:00:00.813 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.667 |
| `test_dns_server`        | `native_dns_server`     |     7 |   ✅   | 00:00:00.672 |
| `test_rtc`               | `native_rtc`            |     8 |   ✅   | 00:00:00.674 |
| `test_ld2410`            | `native_ld2410`         |     7 |   ✅   | 00:00:00.679 |
| `test_mpr121`            | `native_mpr121`         |     5 |   ✅   | 00:00:00.680 |
| `test_sht3x`             | `native_sht3x`          |     5 |   ✅   | 00:00:00.693 |
| `test_pca9685`           | `native_pca9685`        |     4 |   ✅   | 00:00:00.674 |
| `test_ads1115`           | `native_ads1115`        |     3 |   ✅   | 00:00:00.667 |
| `test_ina219`            | `native_ina219`         |     4 |   ✅   | 00:00:00.673 |
| `test_hpack`             | `native_hpack`          |     7 |   ✅   | 00:00:00.762 |
| `test_h2_frame`          | `native_h2frame`        |     6 |   ✅   | 00:00:00.676 |
| `test_h2_conn`           | `native_h2conn`         |     4 |   ✅   | 00:00:00.876 |
| `test_quic_varint`       | `native_quic_varint`    |     3 |   ✅   | 00:00:00.672 |
| `test_h3_frame`          | `native_h3frame`        |     7 |   ✅   | 00:00:00.670 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.723 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.169 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.674 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.691 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.703 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.732 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.707 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.704 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.671 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.731 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.097 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.693 |
...
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.725 |
...
| `test_statsd`            | `native_statsd`         |     9 |   ✅   | 00:00:00.740 |
...
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.269 |
| `test_qpack`             | `native_qpack`          |     9 |   ✅   | 00:00:00.767 |
| `test_quic_packet`       | `native_quic_packet`    |     8 |   ✅   | 00:00:00.671 |
...
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:05.837
================= 17 test cases: 17 succeeded in 00:00:05.837 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 164 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.683
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:04.458
================= 16 test cases: 16 succeeded in 00:00:04.458 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 164 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.664
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.676
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.681
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.680
...
native         test_transport     PASSED    00:00:00.628
native         test_websocket     PASSED    00:00:00.647
native         test_http_parser   PASSED    00:00:00.611
================ 323 test cases: 323 succeeded in 00:00:04.149 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 164 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.787
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.956
native_ssh     test_ssh_auth       PASSED    00:00:00.652
native_ssh     test_ssh_server     PASSED    00:00:00.885
native_ssh     test_ssh_transport  PASSED    00:00:01.171
native_ssh     test_ssh_channel    PASSED    00:00:00.596
================ 137 test cases: 137 succeeded in 00:00:07.258 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 164 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.344
================== 2 test cases: 2 succeeded in 00:00:01.344 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 164 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.231
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.247
================= 12 test cases: 12 succeeded in 00:00:01.247 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 164 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.224
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.730
native_snmp    test_snmp_agent  PASSED    00:00:00.552
================= 35 test cases: 35 succeeded in 00:00:01.282 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 164 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.828
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.784
================= 41 test cases: 41 succeeded in 00:00:00.784 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 164 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.686
================= 19 test cases: 19 succeeded in 00:00:00.686 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 164 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.754
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.775
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.860
================= 16 test cases: 16 succeeded in 00:00:00.860 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 164 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.665
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.672
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.673
================= 13 test cases: 13 succeeded in 00:00:00.673 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 164 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.672
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.680
================== 6 test cases: 6 succeeded in 00:00:00.680 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 164 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.723
================= 38 test cases: 38 succeeded in 00:00:00.723 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 164 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.116
================= 10 test cases: 10 succeeded in 00:00:01.116 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 164 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.178
================= 13 test cases: 13 succeeded in 00:00:01.178 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 164 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_ntp_server  test_ntp_server  PASSED    00:00:00.667
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_dns_server  test_dns_server  PASSED    00:00:00.672
================== 7 test cases: 7 succeeded in 00:00:00.672 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 164 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_rtc     test_rtc  PASSED    00:00:00.674
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ld2410  test_ld2410  PASSED    00:00:00.679
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_mpr121  test_mpr121  PASSED    00:00:00.680
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sht3x   test_sht3x  PASSED    00:00:00.693
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_pca9685  test_pca9685  PASSED    00:00:00.674
================== 4 test cases: 4 succeeded in 00:00:00.674 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 164 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_ads1115  test_ads1115  PASSED    00:00:00.667
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ina219  test_ina219  PASSED    00:00:00.673
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_hpack   test_hpack  PASSED    00:00:00.762
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_varint  test_quic_varint  PASSED    00:00:00.672
...
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h3frame  test_h3_frame  PASSED    00:00:00.670
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.723
================= 21 test cases: 21 succeeded in 00:00:00.723 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 164 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.169
================== 3 test cases: 3 succeeded in 00:00:01.169 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 164 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.703
================= 22 test cases: 22 succeeded in 00:00:00.703 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 164 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.732
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.704
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.097
================= 71 test cases: 71 succeeded in 00:00:01.097 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 164 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_statsd  test_statsd  PASSED    00:00:00.740
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.663
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.269
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_qpack   test_qpack  PASSED    00:00:00.767
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_packet  test_quic_packet  PASSED    00:00:00.671
================== 8 test cases: 8 succeeded in 00:00:00.671 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 164 tests
