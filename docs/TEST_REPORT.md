...
**Generated:** 2026-06-29 17:36:43
**Command:** `pio test` over 72 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1353 passed - 117s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:07.051 |
...
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.696 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.752 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.567 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.687 |
...
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.267 |
...
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.586 |
...
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.609 |
...
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.612 |
...
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.127 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.715 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.495 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.547 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.812 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.848 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.727 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.681 |
...
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.668 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.658 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.661 |
| `test_protobuf`          | `native_protobuf`       |     8 |   ✅   | 00:00:00.664 |
| `test_wamp`              | `native_wamp`           |    11 |   ✅   | 00:00:00.689 |
...
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.708 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.047 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.663 |
...
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.672 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.661 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.663 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.675 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.685 |
...
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.403 |
...
------------------ native:test_sse [PASSED] Took 7.05 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:07.051
...
================ 318 test cases: 318 succeeded in 00:00:10.027 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 97 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.696
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.267
...
native_app     test_form_params       PASSED    00:00:00.586
...
native_app     test_digest_auth       PASSED    00:00:00.609
...
native_app     test_file_serving      PASSED    00:00:00.612
...
================ 219 test cases: 219 succeeded in 00:00:11.274 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 97 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.127
...
================= 29 test cases: 29 succeeded in 00:00:01.210 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 97 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.547
================= 10 test cases: 10 succeeded in 00:00:01.547 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 97 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.848
================= 29 test cases: 29 succeeded in 00:00:00.848 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 97 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.681
...
================= 29 test cases: 29 succeeded in 00:00:00.657 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 97 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.062
================= 10 test cases: 10 succeeded in 00:00:01.062 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 97 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.692
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.708
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.663
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.403
================== 2 test cases: 2 succeeded in 00:00:01.403 ==================
```
