...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:11.209 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.491 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.518 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.499 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.527 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.488 |
| `test_ssh_crypto`       | `native_ssh`          |    38 |   ✅   | 00:00:04.192 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.502 |
...
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.128 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.953 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.499 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.501 |
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.454 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.509 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.507 |
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.471 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.515 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.514 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.513 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.509 |
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.485 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.524 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.516 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.523 |
| `test_dispatch`         | `native_app`          |    11 |   ✅   | 00:00:00.507 |
...
| `test_workers`          | `native_workers`      |     3 |   ✅   | 00:00:00.633 |
...
----------------- native:test_sse [PASSED] Took 11.21 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:11.209
...
native               test_http_parser       PASSED    00:00:00.488
native_ssh           test_ssh_crypto        PASSED    00:00:04.192
native_ssh           test_ssh_auth          PASSED    00:00:00.502
...
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.128
native_app           test_regex             PASSED    00:00:00.953
native_app           test_template          PASSED    00:00:00.499
native_app           test_path_params       PASSED    00:00:00.501
native_app           test_digest_vectors    PASSED    00:00:00.454
native_app           test_form_params       PASSED    00:00:00.509
native_app           test_iface             PASSED    00:00:00.507
native_app           test_json              PASSED    00:00:00.471
native_app           test_response_headers  PASSED    00:00:00.515
native_app           test_middleware        PASSED    00:00:00.514
native_app           test_digest_auth       PASSED    00:00:00.513
native_app           test_web_terminal      PASSED    00:00:00.509
native_app           test_defer             PASSED    00:00:00.485
native_app           test_multipart         PASSED    00:00:00.524
native_app           test_auth              PASSED    00:00:00.516
native_app           test_file_serving      PASSED    00:00:00.523
native_app           test_dispatch          PASSED    00:00:00.507
...
native_workers       test_workers           PASSED    00:00:00.633
native_tsan          test_concurrency       PASSED    00:00:01.255
================ 621 test cases: 621 succeeded in 00:00:34.434 ================
```
