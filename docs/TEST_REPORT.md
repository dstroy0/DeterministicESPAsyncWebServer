...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:06.872 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.586 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.622 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.604 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.626 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.586 |
| `test_ssh_crypto`       | `native_ssh`          |    38 |   ✅   | 00:00:03.784 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.603 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.729 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.958 |
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.573 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.906 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.278 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:01.102 |
...
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.593 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.587 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.610 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.591 |
...
| `test_dispatch`         | `native_app`          |    11 |   ✅   | 00:00:00.593 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.599 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.691 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.677 |
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:06.872
...
native_ssh           test_ssh_crypto        PASSED    00:00:03.784
native_ssh           test_ssh_auth          PASSED    00:00:00.603
native_ssh           test_ssh_server        PASSED    00:00:00.729
native_ssh           test_ssh_transport     PASSED    00:00:00.958
native_ssh           test_ssh_channel       PASSED    00:00:00.573
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.906
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.278
native_app           test_regex             PASSED    00:00:01.102
...
native_app           test_web_terminal      PASSED    00:00:00.591
...
native_app           test_dispatch          PASSED    00:00:00.593
...
================ 621 test cases: 621 succeeded in 00:00:32.637 ================
```
