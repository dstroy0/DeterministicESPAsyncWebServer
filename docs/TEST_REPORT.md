...
**Generated:** 2026-06-29 17:52:23
**Command:** `pio test` over 75 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1371 passed - 126s
...
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.580 |
...
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.198 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.149 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.726 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.524 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.542 |
...
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.646 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.740 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.646 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.659 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.653 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.664 |
| `test_protobuf`          | `native_protobuf`       |     8 |   ✅   | 00:00:00.683 |
| `test_wamp`              | `native_wamp`           |    11 |   ✅   | 00:00:00.711 |
...
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.679 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.716 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.888 |
...
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.721 |
...
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.712 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.132 |
| `test_http_client`       | `native_http_client`    |    10 |   ✅   | 00:00:00.659 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.678 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.677 |
...
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.040 |
...
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.771 |
...
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.654 |
...
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.669 |
...
------------------ native:test_sse [PASSED] Took 6.72 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.724
...
================ 318 test cases: 318 succeeded in 00:00:09.790 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 100 tests
...
================= 15 test cases: 15 succeeded in 00:00:00.744 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 100 tests
...
native_ssh     test_ssh_transport  PASSED    00:00:00.943
native_ssh     test_ssh_channel    PASSED    00:00:00.565
================= 93 test cases: 93 succeeded in 00:00:06.712 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 100 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.307
...
================ 219 test cases: 219 succeeded in 00:00:11.531 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 100 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.198
================= 12 test cases: 12 succeeded in 00:00:01.198 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 100 tests
...
================= 29 test cases: 29 succeeded in 00:00:01.250 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 100 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.542
================= 10 test cases: 10 succeeded in 00:00:01.542 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 100 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.646
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.740
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.664
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.711
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.679
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.716
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.888
================= 13 test cases: 13 succeeded in 00:00:00.888 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 100 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.124
================= 10 test cases: 10 succeeded in 00:00:01.124 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 100 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.132
================== 3 test cases: 3 succeeded in 00:00:01.132 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 100 tests
...
================= 71 test cases: 71 succeeded in 00:00:01.040 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 100 tests
...
--------------- native_csrf:test_csrf [PASSED] Took 0.77 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.771
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.654
