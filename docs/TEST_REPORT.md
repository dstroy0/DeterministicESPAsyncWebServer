...
**Generated:** 2026-06-29 18:20:19
**Command:** `pio test` over 80 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1397 passed - 131s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:06.957 |
...
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.733 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.653 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.676 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.771 |
...
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.155 |
...
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.210 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.136 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.716 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.501 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.533 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.803 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.958 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.750 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.705 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.690 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.751 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.663 |
...
| `test_wamp`              | `native_wamp`           |    11 |   ✅   | 00:00:00.694 |
...
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.762 |
...
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.709 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.693 |
...
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.707 |
...
------------------ native:test_sse [PASSED] Took 6.96 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.957
...
================ 318 test cases: 318 succeeded in 00:00:09.941 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 105 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.771
...
================= 93 test cases: 93 succeeded in 00:00:06.500 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 105 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.155
...
================ 219 test cases: 219 succeeded in 00:00:11.471 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 105 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.210
================= 12 test cases: 12 succeeded in 00:00:01.210 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 105 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.136
================== 2 test cases: 2 succeeded in 00:00:01.136 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 105 tests
...
================= 29 test cases: 29 succeeded in 00:00:01.217 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 105 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.533
================= 10 test cases: 10 succeeded in 00:00:01.533 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 105 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.958
================= 29 test cases: 29 succeeded in 00:00:00.958 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 105 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.663
...
test/test_hostlink/test_hostlink.cpp:30: test_build_dm_read: Expected '@00RD0000001057*\r' Was '@00RD0000001057*\r\x05\xDEe\xFC\x7F' [FAILED]
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  ERRORED   00:00:00.673

============= 8 test cases: 1 failed, 6 succeeded in 00:00:00.673 =============
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 105 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.762
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.738
================= 29 test cases: 29 succeeded in 00:00:00.738 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 105 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.121
================= 13 test cases: 13 succeeded in 00:00:01.121 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 105 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.697
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.150
================== 3 test cases: 3 succeeded in 00:00:01.150 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 105 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.709
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.707
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.808
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.448
================== 2 test cases: 2 succeeded in 00:00:01.448 ==================
```
