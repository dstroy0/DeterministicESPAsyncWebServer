...
**Generated:** 2026-06-29 19:28:22
**Command:** `pio test` over 90 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1473 passed - 149s
...
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.787 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.592 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.724 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.957 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.577 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.892 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.305 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.179 |
...
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.673 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.634 |
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.624 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.645 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.658 |
...
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.648 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.639 |
...
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.738 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.540 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.551 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.860 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.782 |
...
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.679 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.683 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.694 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.708 |
| `test_protobuf`          | `native_protobuf`       |     8 |   ✅   | 00:00:00.701 |
| `test_wamp`              | `native_wamp`           |    11 |   ✅   | 00:00:00.720 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.682 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.682 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.686 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.678 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |     7 |   ✅   | 00:00:00.678 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.687 |
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.729 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.689 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.706 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.689 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.710 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.682 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.728 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.693 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.701 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.703 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.696 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.726 |
...
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.718 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.850 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.680 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.691 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.671 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.700 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.709 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.718 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.121 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.090 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.693 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.730 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.151 |
| `test_http_client`       | `native_http_client`    |    10 |   ✅   | 00:00:00.700 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.699 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.682 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.709 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.733 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.715 |
...
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.703 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.685 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.713 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.678 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.684 |
...
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.705 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.802 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.686 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.853 |
...
------------------ native:test_sse [PASSED] Took 6.33 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.332
native         test_session       PASSED    00:00:00.610
native         test_presentation  PASSED    00:00:00.638
native         test_transport     PASSED    00:00:00.619
native         test_websocket     PASSED    00:00:00.642
native         test_http_parser   PASSED    00:00:00.596
================ 318 test cases: 318 succeeded in 00:00:09.438 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 115 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.787
native_ssh     test_ssh_auth       PASSED    00:00:00.592
native_ssh     test_ssh_server     PASSED    00:00:00.724
native_ssh     test_ssh_transport  PASSED    00:00:00.957
native_ssh     test_ssh_channel    PASSED    00:00:00.577
================= 93 test cases: 93 succeeded in 00:00:06.637 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 115 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.305
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.179
...
native_app     test_form_params       PASSED    00:00:00.673
native_app     test_iface             PASSED    00:00:00.634
native_app     test_json              PASSED    00:00:00.624
native_app     test_response_headers  PASSED    00:00:00.645
native_app     test_middleware        PASSED    00:00:00.658
...
native_app     test_multipart         PASSED    00:00:00.648
native_app     test_auth              PASSED    00:00:00.639
...
================ 219 test cases: 219 succeeded in 00:00:12.052 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 115 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.738
native_snmp    test_snmp_agent  PASSED    00:00:00.540
================= 29 test cases: 29 succeeded in 00:00:01.277 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 115 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.551
================= 10 test cases: 10 succeeded in 00:00:01.551 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 115 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.860
...
================= 29 test cases: 29 succeeded in 00:00:00.782 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 115 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.679
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.683
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.708
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.686
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.687
...
test/test_hostlink/test_hostlink.cpp:30: test_build_dm_read: Expected '@00RD0000001057*\r' Was '@00RD0000001057*\r\xAF\x11\xE8\xFE\x7F' [FAILED]
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  ERRORED   00:00:00.675

============= 8 test cases: 1 failed, 6 succeeded in 00:00:00.675 =============
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 115 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.729
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.706
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.710
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.728
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.703
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.726
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.718
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.850
================= 13 test cases: 13 succeeded in 00:00:00.850 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 115 tests
...
================= 13 test cases: 13 succeeded in 00:00:00.691 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 115 tests
...
================= 29 test cases: 29 succeeded in 00:00:00.709 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 115 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.733
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.703
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.685
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.713
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.684
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.705
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.686
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.853
