...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:06.591 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.495 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.530 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.520 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.547 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.496 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:04.230 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.526 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.665 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.941 |
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.494 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.778 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.124 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.971 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.509 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.516 |
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.465 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.518 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.514 |
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.469 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.518 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.524 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.534 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.520 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.527 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.523 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.539 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.510 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.511 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.606 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.571 |
| `test_workers`          | `native_workers`      |     3 |   ✅   | 00:00:00.632 |
| `test_concurrency`      | `native_tsan`         |     2 |   ✅   | 00:00:01.509 |
...
------------------ native:test_sse [PASSED] Took 6.59 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:06.591
...
native               test_websocket         PASSED    00:00:00.547
native               test_http_parser       PASSED    00:00:00.496
native_ssh           test_ssh_crypto        PASSED    00:00:04.230
native_ssh           test_ssh_auth          PASSED    00:00:00.526
...
native_app           test_multipart         PASSED    00:00:00.527
...
native_app           test_chunked           PASSED    00:00:00.511
native_app           test_application       PASSED    00:00:00.606
native_compliance    test_compliance        PASSED    00:00:00.571
native_workers       test_workers           PASSED    00:00:00.632
native_tsan          test_concurrency       PASSED    00:00:01.509
================ 616 test cases: 616 succeeded in 00:00:29.921 ================
```
