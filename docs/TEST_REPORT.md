...
**Generated:** 2026-07-04 02:09:11
**Command:** `pio test` over 119 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1971 passed - 158s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:10.368 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.482 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.501 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:03.383 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.499 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.496 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.493 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.490 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.503 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.618 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.516 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.515 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.507 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.520 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.513 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:00.775 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.447 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.483 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.464 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.485 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.449 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.607 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:00.737 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.521 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.509 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:02.257 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.475 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.666 |
| `test_ssh_transport`     | `native_ssh`            |    31 |   ✅   | 00:00:00.906 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.446 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.709 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.081 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:00.854 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.452 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.458 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.407 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.457 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.461 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.440 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.466 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.465 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.477 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.473 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.447 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.465 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.469 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.472 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.475 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.548 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.521 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:00.883 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:00.876 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.539 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.392 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:01.492 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.618 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.914 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.588 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.530 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.503 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.571 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.501 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.511 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.522 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.501 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.507 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.550 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.569 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.638 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.552 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.511 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.501 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.504 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.497 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.517 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.495 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.501 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.496 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.522 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.486 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.524 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.514 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.497 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.514 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.495 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.501 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.539 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.493 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.501 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.524 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.496 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.502 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.503 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.494 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.498 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.501 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.507 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.511 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.505 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.510 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.528 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.492 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.512 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.498 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.519 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.649 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.492 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.492 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.524 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.533 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.539 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.537 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:00.806 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:00.809 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.518 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.529 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:00.826 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.524 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.528 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.518 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.531 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.530 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.507 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.523 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.527 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:00.764 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.488 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.489 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.508 |
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.517 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.515 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.508 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.500 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.518 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.492 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.498 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.498 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.498 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.499 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.494 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.498 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.512 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.591 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.483 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.597 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.032 |
...
----------- native_canopen:test_canopen [PASSED] Took 10.37 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:10.368
================= 17 test cases: 17 succeeded in 00:00:10.368 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
----- native_det_primitives:test_det_primitives [PASSED] Took 0.48 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.482
...
------------- native_det_ip:test_det_ip [PASSED] Took 0.50 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.501
================= 10 test cases: 10 succeeded in 00:00:00.501 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
-------- native_ssh_ed25519:test_ssh_ed25519 [PASSED] Took 3.38 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:03.383
================= 16 test cases: 16 succeeded in 00:00:03.383 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
------------ native_promisc:test_promisc [PASSED] Took 0.50 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.499
================== 8 test cases: 8 succeeded in 00:00:00.499 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
-------- native_bus_capture:test_bus_capture [PASSED] Took 0.50 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.496
================== 5 test cases: 5 succeeded in 00:00:00.496 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
-------------- native_j1939:test_j1939 [PASSED] Took 0.49 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.493
================== 9 test cases: 9 succeeded in 00:00:00.493 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
---------- native_devicenet:test_devicenet [PASSED] Took 0.49 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.490
...
----------- native_nmea2000:test_nmea2000 [PASSED] Took 0.50 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.503
================== 6 test cases: 6 succeeded in 00:00:00.503 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.618
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.516
================== 8 test cases: 8 succeeded in 00:00:00.516 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.515
================== 6 test cases: 6 succeeded in 00:00:00.515 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.507
...
----------- native_nmea0183:test_nmea0183 [PASSED] Took 0.52 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.520
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.513
...
--------------- native:test_websocket [PASSED] Took 0.48 seconds ---------------
...
-------------- native:test_http_parser [PASSED] Took 0.45 seconds --------------

=================================== SUMMARY ===================================
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:00.775
native         test_session       PASSED    00:00:00.447
native         test_presentation  PASSED    00:00:00.483
native         test_transport     PASSED    00:00:00.464
native         test_websocket     PASSED    00:00:00.485
native         test_http_parser   PASSED    00:00:00.449
================ 323 test cases: 323 succeeded in 00:00:03.103 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
------ native_observability:test_observability [PASSED] Took 0.61 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.607
================= 17 test cases: 17 succeeded in 00:00:00.607 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
-------- native_accept_gate:test_accept_gate [PASSED] Took 0.74 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.737
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.521
================== 3 test cases: 3 succeeded in 00:00:00.521 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
----------- native_prov:test_provisioning [PASSED] Took 0.51 seconds -----------

=================================== SUMMARY ===================================
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.509
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 2.26 seconds -------------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:02.257
native_ssh     test_ssh_auth       PASSED    00:00:00.475
native_ssh     test_ssh_server     PASSED    00:00:00.666
native_ssh     test_ssh_transport  PASSED    00:00:00.906
native_ssh     test_ssh_channel    PASSED    00:00:00.446
================ 137 test cases: 137 succeeded in 00:00:04.749 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.081
================== 2 test cases: 2 succeeded in 00:00:01.081 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
--------------- native_app:test_regex [PASSED] Took 0.85 seconds ---------------
...
------------- native_app:test_template [PASSED] Took 0.45 seconds --------------
...
------------ native_app:test_path_params [PASSED] Took 0.46 seconds ------------
...
---------- native_app:test_digest_vectors [PASSED] Took 0.41 seconds -----------
...
------------ native_app:test_form_params [PASSED] Took 0.46 seconds ------------
...
--------------- native_app:test_iface [PASSED] Took 0.46 seconds ---------------
...
--------- native_app:test_response_headers [PASSED] Took 0.47 seconds ----------
...
------------- native_app:test_multipart [PASSED] Took 0.47 seconds -------------
...
----------- native_app:test_file_serving [PASSED] Took 0.47 seconds ------------
...
------------- native_app:test_dispatch [PASSED] Took 0.47 seconds --------------
...
------------ native_app:test_application [PASSED] Took 0.52 seconds ------------

=================================== SUMMARY ===================================
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:00.854
native_app     test_template          PASSED    00:00:00.452
native_app     test_path_params       PASSED    00:00:00.458
native_app     test_digest_vectors    PASSED    00:00:00.407
native_app     test_form_params       PASSED    00:00:00.457
native_app     test_iface             PASSED    00:00:00.461
native_app     test_json              PASSED    00:00:00.440
native_app     test_response_headers  PASSED    00:00:00.466
native_app     test_middleware        PASSED    00:00:00.465
native_app     test_digest_auth       PASSED    00:00:00.477
native_app     test_web_terminal      PASSED    00:00:00.473
native_app     test_defer             PASSED    00:00:00.447
native_app     test_multipart         PASSED    00:00:00.465
native_app     test_auth              PASSED    00:00:00.469
native_app     test_file_serving      PASSED    00:00:00.472
native_app     test_dispatch          PASSED    00:00:00.475
native_app     test_chunked           PASSED    00:00:00.548
native_app     test_application       PASSED    00:00:00.521
================ 225 test cases: 225 succeeded in 00:00:08.807 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
----- native_webdav_handler:test_webdav_handler [PASSED] Took 0.88 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:00.883
================= 12 test cases: 12 succeeded in 00:00:00.883 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:00.876
================== 2 test cases: 2 succeeded in 00:00:00.876 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
------------- native_snmp:test_snmp_ber [PASSED] Took 0.54 seconds -------------
...
------------ native_snmp:test_snmp_agent [PASSED] Took 0.39 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.539
native_snmp    test_snmp_agent  PASSED    00:00:00.392
================= 35 test cases: 35 succeeded in 00:00:00.931 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 1.49 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.492
================= 15 test cases: 15 succeeded in 00:00:01.492 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.618
================= 15 test cases: 15 succeeded in 00:00:00.618 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.914
================= 41 test cases: 41 succeeded in 00:00:00.914 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.588
================= 41 test cases: 41 succeeded in 00:00:00.588 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.530
================= 19 test cases: 19 succeeded in 00:00:00.530 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
------------- native_modbus:test_modbus [PASSED] Took 0.50 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.503
================= 22 test cases: 22 succeeded in 00:00:00.503 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
-------- native_cloudevents:test_cloudevents [PASSED] Took 0.57 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.571
...
----------- native_redis:test_redis_resp [PASSED] Took 0.50 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.501
================== 8 test cases: 8 succeeded in 00:00:00.501 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.511
================= 14 test cases: 14 succeeded in 00:00:00.511 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
------------ native_mqtt_sn:test_mqtt_sn [PASSED] Took 0.52 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.522
================= 13 test cases: 13 succeeded in 00:00:00.522 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
-------- native_flow_export:test_flow_export [PASSED] Took 0.50 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.501
================== 6 test cases: 6 succeeded in 00:00:00.501 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.507
================= 13 test cases: 13 succeeded in 00:00:00.507 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.550
...
---------------- native_dma:test_dma [PASSED] Took 0.57 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.569
...
------------ native_forward:test_forward [PASSED] Took 0.64 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.638
...
------------ native_gateway:test_gateway [PASSED] Took 0.55 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.552
================= 11 test cases: 11 succeeded in 00:00:00.552 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
--------------- native_lora:test_lora [PASSED] Took 0.51 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.511
================= 13 test cases: 13 succeeded in 00:00:00.511 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
-------------- native_nrf24:test_nrf24 [PASSED] Took 0.50 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.501
================= 10 test cases: 10 succeeded in 00:00:00.501 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
------------ native_enocean:test_enocean [PASSED] Took 0.50 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.504
================== 9 test cases: 9 succeeded in 00:00:00.504 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
-------------- native_pn532:test_pn532 [PASSED] Took 0.50 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_pn532   test_pn532  PASSED    00:00:00.497
================= 10 test cases: 10 succeeded in 00:00:00.497 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
------------- native_sigfox:test_sigfox [PASSED] Took 0.52 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.517
...
-------------- native_zwave:test_zwave [PASSED] Took 0.49 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.495
================== 9 test cases: 9 succeeded in 00:00:00.495 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
------------- native_zigbee:test_zigbee [PASSED] Took 0.50 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_zigbee  test_zigbee  PASSED    00:00:00.501
================== 9 test cases: 9 succeeded in 00:00:00.501 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
------------- native_thread:test_thread [PASSED] Took 0.50 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.496
================= 13 test cases: 13 succeeded in 00:00:00.496 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
--------------- native_wamp:test_wamp [PASSED] Took 0.52 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.522
================= 12 test cases: 12 succeeded in 00:00:00.522 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
------------ native_sunspec:test_sunspec [PASSED] Took 0.49 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.486
================== 5 test cases: 5 succeeded in 00:00:00.486 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.524
================== 6 test cases: 6 succeeded in 00:00:00.524 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.514
...
------------ native_grpcweb:test_grpcweb [PASSED] Took 0.50 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.497
================== 7 test cases: 7 succeeded in 00:00:00.497 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.514
================= 11 test cases: 11 succeeded in 00:00:00.514 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
--------------- native_fins:test_fins [PASSED] Took 0.49 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.495
================== 6 test cases: 6 succeeded in 00:00:00.495 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
----------- native_hostlink:test_hostlink [PASSED] Took 0.50 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.501
...
-------------- native_senml:test_senml [PASSED] Took 0.54 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.539
...
---------------- native_df1:test_df1 [PASSED] Took 0.49 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.493
================== 9 test cases: 9 succeeded in 00:00:00.493 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
--------------- native_cotp:test_cotp [PASSED] Took 0.50 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.501
================== 6 test cases: 6 succeeded in 00:00:00.501 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
------------- native_s7comm:test_s7comm [PASSED] Took 0.52 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.524
...
------------- native_melsec:test_melsec [PASSED] Took 0.50 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.496
================== 6 test cases: 6 succeeded in 00:00:00.496 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
------------- native_bacnet:test_bacnet [PASSED] Took 0.50 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.502
================== 9 test cases: 9 succeeded in 00:00:00.502 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
--------------- native_enip:test_enip [PASSED] Took 0.50 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.503
================== 6 test cases: 6 succeeded in 00:00:00.503 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
--------------- native_amqp:test_amqp [PASSED] Took 0.49 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.494
================== 7 test cases: 7 succeeded in 00:00:00.494 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.498
...
--------------- native_nats:test_nats [PASSED] Took 0.50 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.501
================= 14 test cases: 14 succeeded in 00:00:00.501 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
----- native_proxy_protocol:test_proxy_protocol [PASSED] Took 0.51 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.507
================== 8 test cases: 8 succeeded in 00:00:00.507 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
---------- native_sparkplug:test_sparkplug [PASSED] Took 0.51 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.511
...
------ native_modbus_master:test_modbus_master [PASSED] Took 0.50 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.505
================== 5 test cases: 5 succeeded in 00:00:00.505 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.510
...
------------ native_webhook:test_webhook [PASSED] Took 0.49 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.492
================== 5 test cases: 5 succeeded in 00:00:00.492 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.512
================== 2 test cases: 2 succeeded in 00:00:00.512 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
------- native_dns_resolver:test_dns_resolver [PASSED] Took 0.50 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.498
================== 4 test cases: 4 succeeded in 00:00:00.498 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
---------- native_audit_log:test_audit_log [PASSED] Took 0.52 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.519
================= 16 test cases: 16 succeeded in 00:00:00.519 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
--------------- native_oidc:test_oidc [PASSED] Took 0.65 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.649
...
---------------- native_vfs:test_vfs [PASSED] Took 0.49 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.492
================= 11 test cases: 11 succeeded in 00:00:00.492 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
------------ native_graphql:test_graphql [PASSED] Took 0.49 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.492
================= 32 test cases: 32 succeeded in 00:00:00.492 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.524
================== 7 test cases: 7 succeeded in 00:00:00.524 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
------------- native_oauth2:test_oauth2 [PASSED] Took 0.53 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.533
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.539
================= 38 test cases: 38 succeeded in 00:00:00.539 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
------- native_opcua_client:test_opcua_client [PASSED] Took 0.54 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.537
================= 14 test cases: 14 succeeded in 00:00:00.537 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
---------- native_keepalive:test_keepalive [PASSED] Took 0.81 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:00.806
================= 10 test cases: 10 succeeded in 00:00:00.806 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
-------------- native_range:test_range [PASSED] Took 0.81 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:00.809
...
------------- native_syslog:test_syslog [PASSED] Took 0.52 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.518
================= 10 test cases: 10 succeeded in 00:00:00.518 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
---------------- native_jwt:test_jwt [PASSED] Took 0.53 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.529
================= 21 test cases: 21 succeeded in 00:00:00.529 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
------------- native_upload:test_upload [PASSED] Took 0.83 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:00.826
================== 3 test cases: 3 succeeded in 00:00:00.826 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.528
================= 15 test cases: 15 succeeded in 00:00:00.528 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
--------------- native_mqtt:test_mqtt [PASSED] Took 0.52 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.518
================= 22 test cases: 22 succeeded in 00:00:00.518 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
---------- native_ws_client:test_ws_client [PASSED] Took 0.53 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.531
================= 16 test cases: 16 succeeded in 00:00:00.531 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
------------ native_scratch:test_scratch [PASSED] Took 0.53 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.530
================= 14 test cases: 14 succeeded in 00:00:00.530 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
---------- native_snmp_trap:test_snmp_trap [PASSED] Took 0.51 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.507
================== 7 test cases: 7 succeeded in 00:00:00.507 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
------------ native_deflate:test_deflate [PASSED] Took 0.53 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.527
...
test/test_websocket/test_websocket.cpp:1107: stress_ws_parse_max_payload [PASSED]
test/test_websocket/test_websocket.cpp:1108: stress_ws_parse_two_consecutive_frames [PASSED]
--------- native_ws_deflate:test_websocket [PASSED] Took 0.76 seconds ----------

=================================== SUMMARY ===================================
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.764
================= 71 test cases: 71 succeeded in 00:00:00.764 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
-------- native_time_source:test_time_source [PASSED] Took 0.49 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.488
================== 9 test cases: 9 succeeded in 00:00:00.488 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
------- native_config_store:test_config_store [PASSED] Took 0.49 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.489
================= 14 test cases: 14 succeeded in 00:00:00.489 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
---------- native_device_id:test_device_id [PASSED] Took 0.51 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.508
...
------- native_auth_lockout:test_auth_lockout [PASSED] Took 0.52 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.517
...
--------------- native_csrf:test_csrf [PASSED] Took 0.52 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.515
...
---------- native_telemetry:test_telemetry [PASSED] Took 0.51 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.508
================== 8 test cases: 8 succeeded in 00:00:00.508 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
---------- native_dashboard:test_dashboard [PASSED] Took 0.50 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.500
================= 15 test cases: 15 succeeded in 00:00:00.500 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
------ native_partition:test_partition_monitor [PASSED] Took 0.49 seconds ------

=================================== SUMMARY ===================================
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.492
================== 5 test cases: 5 succeeded in 00:00:00.492 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
--------------- native_cbor:test_cbor [PASSED] Took 0.50 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.498
================= 18 test cases: 18 succeeded in 00:00:00.498 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
------------ native_msgpack:test_msgpack [PASSED] Took 0.50 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.498
================= 17 test cases: 17 succeeded in 00:00:00.498 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
----------- native_gpio_map:test_gpio_map [PASSED] Took 0.50 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.498
================== 8 test cases: 8 succeeded in 00:00:00.498 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
------ native_udp_telemetry:test_udp_telemetry [PASSED] Took 0.50 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.499
================== 7 test cases: 7 succeeded in 00:00:00.499 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
--------- native_guardrails:test_guardrails [PASSED] Took 0.49 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.494
...
------------- native_logbuf:test_logbuf [PASSED] Took 0.50 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.498
================== 4 test cases: 4 succeeded in 00:00:00.498 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
---------- native_config_io:test_config_io [PASSED] Took 0.51 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.512
================== 4 test cases: 4 succeeded in 00:00:00.512 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
------------ native_workers:test_workers [PASSED] Took 0.59 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.591
================== 3 test cases: 3 succeeded in 00:00:00.591 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
-------------- native_clock:test_clock [PASSED] Took 0.48 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.483
================== 7 test cases: 7 succeeded in 00:00:00.483 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.597
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 1.03 seconds ------------

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.032
================== 2 test cases: 2 succeeded in 00:00:01.032 ==================
```
