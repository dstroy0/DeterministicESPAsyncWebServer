...
**Generated:** 2026-06-29 18:08:16
**Command:** `pio test` over 78 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1391 passed - 119s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:06.296 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.551 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.574 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.558 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.579 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.549 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.680 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.636 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.614 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:04.159 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.539 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.688 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.949 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.489 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.809 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.217 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.072 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.553 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.571 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.505 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.561 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.554 |
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.514 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.576 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.568 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.578 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.564 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.535 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.570 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.566 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.579 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.568 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.567 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.648 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.138 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.073 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.649 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.461 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.560 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.740 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.711 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.697 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.627 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.613 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.681 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.588 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.602 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.598 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.608 |
| `test_protobuf`          | `native_protobuf`       |     8 |   ✅   | 00:00:00.609 |
| `test_wamp`              | `native_wamp`           |    11 |   ✅   | 00:00:00.630 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.591 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.606 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.594 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.604 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |     7 |   ✅   | 00:00:00.609 |
...
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.612 |
...
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.641 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.807 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.606 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.635 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.613 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.658 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.638 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.652 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.006 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:00.979 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.610 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.639 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.054 |
| `test_http_client`       | `native_http_client`    |    10 |   ✅   | 00:00:00.610 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.612 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.646 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.664 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.656 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.644 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.597 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.632 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:00.937 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.589 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.599 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.621 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.596 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.634 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.635 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.611 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.594 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.609 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.626 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.623 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.612 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.600 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.615 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.595 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.653 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.735 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.602 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.736 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.490 |
...
------------------ native:test_sse [PASSED] Took 6.30 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.296
native         test_session       PASSED    00:00:00.551
native         test_presentation  PASSED    00:00:00.574
native         test_transport     PASSED    00:00:00.558
native         test_websocket     PASSED    00:00:00.579
native         test_http_parser   PASSED    00:00:00.549
================ 318 test cases: 318 succeeded in 00:00:09.107 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 103 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.680
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.636
...
native_ssh     test_ssh_auth       PASSED    00:00:00.539
...
================= 93 test cases: 93 succeeded in 00:00:06.823 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 103 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.809
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.217
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.072
native_app     test_template          PASSED    00:00:00.553
native_app     test_path_params       PASSED    00:00:00.571
native_app     test_digest_vectors    PASSED    00:00:00.505
native_app     test_form_params       PASSED    00:00:00.561
native_app     test_iface             PASSED    00:00:00.554
native_app     test_json              PASSED    00:00:00.514
native_app     test_response_headers  PASSED    00:00:00.576
native_app     test_middleware        PASSED    00:00:00.568
native_app     test_digest_auth       PASSED    00:00:00.578
native_app     test_web_terminal      PASSED    00:00:00.564
native_app     test_defer             PASSED    00:00:00.535
native_app     test_multipart         PASSED    00:00:00.570
native_app     test_auth              PASSED    00:00:00.566
native_app     test_file_serving      PASSED    00:00:00.579
native_app     test_dispatch          PASSED    00:00:00.568
native_app     test_chunked           PASSED    00:00:00.567
native_app     test_application       PASSED    00:00:00.648
================ 219 test cases: 219 succeeded in 00:00:10.649 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 103 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.138
================= 12 test cases: 12 succeeded in 00:00:01.138 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 103 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.073
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.649
native_snmp    test_snmp_agent  PASSED    00:00:00.461
================= 29 test cases: 29 succeeded in 00:00:01.111 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 103 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.560
================= 10 test cases: 10 succeeded in 00:00:01.560 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 103 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.740
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.697
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.627
================= 19 test cases: 19 succeeded in 00:00:00.627 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 103 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.613
================= 18 test cases: 18 succeeded in 00:00:00.613 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 103 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.681
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.602
================= 11 test cases: 11 succeeded in 00:00:00.602 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 103 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.598
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.608
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.609
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.630
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.591
...
------------- native_c37118:test_c37118 [PASSED] Took 0.61 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.606
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.594
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.604
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.609
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.612
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.641
================= 12 test cases: 12 succeeded in 00:00:00.641 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 103 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.807
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.606
...
================= 13 test cases: 13 succeeded in 00:00:00.635 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 103 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.613
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.658
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.638
================= 29 test cases: 29 succeeded in 00:00:00.638 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 103 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.652
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.006
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:00.979
================= 13 test cases: 13 succeeded in 00:00:00.979 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 103 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.639
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.054
================== 3 test cases: 3 succeeded in 00:00:01.054 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 103 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.610
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.597
================= 12 test cases: 12 succeeded in 00:00:00.597 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 103 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.937
================= 71 test cases: 71 succeeded in 00:00:00.937 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 103 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.589
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.599
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.621
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.634
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.611
================= 11 test cases: 11 succeeded in 00:00:00.611 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 103 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.594
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.609
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.626
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.623
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.612
...
------ native_udp_telemetry:test_udp_telemetry [PASSED] Took 0.60 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.600
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.595
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.653
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.735
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.602
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.490
