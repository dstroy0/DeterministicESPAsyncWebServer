...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:06.192 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.541 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.586 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.569 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.585 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.533 |
| `test_ssh_crypto`       | `native_ssh`          |    38 |   ✅   | 00:00:03.831 |
...
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.834 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.217 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:01.085 |
...
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.512 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.560 |
...
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.536 |
...
| `test_dispatch`         | `native_app`          |    11 |   ✅   | 00:00:00.564 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.555 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.658 |
...
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.834
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.217
native_app           test_regex             PASSED    00:00:01.085
native_app           test_template          PASSED    00:00:00.577
...
native_app           test_json              PASSED    00:00:00.512
native_app           test_response_headers  PASSED    00:00:00.560
...
native_app           test_defer             PASSED    00:00:00.536
...
native_app           test_dispatch          PASSED    00:00:00.564
...
================ 621 test cases: 621 succeeded in 00:00:30.723 ================
```
