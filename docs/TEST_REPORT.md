...
**Generated:** 2026-06-29 01:08:51
**Command:** `pio test` over 64 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1236 passed - 100s
...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:11.682 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.514 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.551 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.537 |
| `test_websocket`         | `native`               |    64 |   ✅   | 00:00:00.557 |
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.517 |
| `test_observability`     | `native_observability` |    15 |   ✅   | 00:00:00.645 |
| `test_http_ota`          | `native_ota`           |     3 |   ✅   | 00:00:00.555 |
| `test_provisioning`      | `native_prov`          |     5 |   ✅   | 00:00:00.572 |
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:04.204 |
| `test_ssh_auth`          | `native_ssh`           |    12 |   ✅   | 00:00:00.516 |
| `test_ssh_server`        | `native_ssh`           |     7 |   ✅   | 00:00:00.646 |
| `test_ssh_transport`     | `native_ssh`           |    23 |   ✅   | 00:00:00.925 |
| `test_ssh_channel`       | `native_ssh`           |    12 |   ✅   | 00:00:00.465 |
| `test_ssh_hardening`     | `native_ssh_hardened`  |     2 |   ✅   | 00:00:00.773 |
| `test_ssh_conn`          | `native_ssh_conn`      |     2 |   ✅   | 00:00:01.158 |
| `test_regex`             | `native_app`           |     9 |   ✅   | 00:00:01.005 |
| `test_template`          | `native_app`           |     6 |   ✅   | 00:00:00.527 |
| `test_path_params`       | `native_app`           |     8 |   ✅   | 00:00:00.522 |
| `test_digest_vectors`    | `native_app`           |     4 |   ✅   | 00:00:00.472 |
| `test_form_params`       | `native_app`           |     5 |   ✅   | 00:00:00.522 |
| `test_iface`             | `native_app`           |     7 |   ✅   | 00:00:00.528 |
| `test_json`              | `native_app`           |    17 |   ✅   | 00:00:00.483 |
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.531 |
| `test_middleware`        | `native_app`           |     9 |   ✅   | 00:00:00.530 |
| `test_digest_auth`       | `native_app`           |     9 |   ✅   | 00:00:00.535 |
| `test_web_terminal`      | `native_app`           |     7 |   ✅   | 00:00:00.529 |
| `test_defer`             | `native_app`           |     3 |   ✅   | 00:00:00.510 |
| `test_multipart`         | `native_app`           |    19 |   ✅   | 00:00:00.534 |
| `test_auth`              | `native_app`           |    13 |   ✅   | 00:00:00.533 |
| `test_file_serving`      | `native_app`           |    12 |   ✅   | 00:00:00.541 |
| `test_dispatch`          | `native_app`           |    11 |   ✅   | 00:00:00.528 |
| `test_chunked`           | `native_app`           |    10 |   ✅   | 00:00:00.535 |
| `test_application`       | `native_app`           |    52 |   ✅   | 00:00:00.605 |
| `test_diag`              | `native_diag`          |     2 |   ✅   | 00:00:01.000 |
| `test_snmp_ber`          | `native_snmp`          |    14 |   ✅   | 00:00:00.620 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.443 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.412 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.711 |
| `test_coap`              | `native_coap`          |    26 |   ✅   | 00:00:00.590 |
| `test_coap`              | `native_coap_observe`  |    26 |   ✅   | 00:00:00.572 |
| `test_webdav`            | `native_webdav`        |    19 |   ✅   | 00:00:00.589 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.580 |
| `test_modbus_master`     | `native_modbus_master` |     5 |   ✅   | 00:00:00.579 |
| `test_ota_rollback`      | `native_ota_rollback`  |     5 |   ✅   | 00:00:00.559 |
| `test_totp`              | `native_totp`          |     4 |   ✅   | 00:00:00.592 |
| `test_webhook`           | `native_webhook`       |     5 |   ✅   | 00:00:00.573 |
| `test_radio_power`       | `native_radio_power`   |     2 |   ✅   | 00:00:00.568 |
| `test_dns_resolver`      | `native_dns_resolver`  |     4 |   ✅   | 00:00:00.567 |
| `test_audit_log`         | `native_audit_log`     |    12 |   ✅   | 00:00:00.596 |
| `test_oidc`              | `native_oidc`          |    13 |   ✅   | 00:00:00.767 |
| `test_vfs`               | `native_vfs`           |    11 |   ✅   | 00:00:00.578 |
| `test_graphql`           | `native_graphql`       |    13 |   ✅   | 00:00:00.580 |
| `test_espnow`            | `native_espnow`        |     7 |   ✅   | 00:00:00.560 |
| `test_oauth2`            | `native_oauth2`        |     8 |   ✅   | 00:00:00.589 |
| `test_opcua`             | `native_opcua`         |    29 |   ✅   | 00:00:00.601 |
| `test_opcua_client`      | `native_opcua_client`  |    11 |   ✅   | 00:00:00.612 |
| `test_keepalive`         | `native_keepalive`     |    10 |   ✅   | 00:00:00.976 |
| `test_range`             | `native_range`         |    13 |   ✅   | 00:00:00.966 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.580 |
| `test_jwt`               | `native_jwt`           |    10 |   ✅   | 00:00:00.617 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:00.984 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.569 |
| `test_compliance`        | `native_compliance`    |    15 |   ✅   | 00:00:00.553 |
| `test_mqtt`              | `native_mqtt`          |    16 |   ✅   | 00:00:00.566 |
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.616 |
| `test_scratch`           | `native_scratch`       |    14 |   ✅   | 00:00:00.620 |
| `test_snmp_trap`         | `native_snmp_trap`     |     3 |   ✅   | 00:00:00.593 |
| `test_inflate`           | `native_inflate`       |    12 |   ✅   | 00:00:00.572 |
| `test_deflate`           | `native_deflate`       |    10 |   ✅   | 00:00:00.608 |
| `test_websocket`         | `native_ws_deflate`    |    68 |   ✅   | 00:00:00.908 |
| `test_time_source`       | `native_time_source`   |     9 |   ✅   | 00:00:00.565 |
| `test_config_store`      | `native_config_store`  |    14 |   ✅   | 00:00:00.567 |
| `test_device_id`         | `native_device_id`     |     4 |   ✅   | 00:00:00.588 |
| `test_auth_lockout`      | `native_auth_lockout`  |    10 |   ✅   | 00:00:00.585 |
| `test_csrf`              | `native_csrf`          |     9 |   ✅   | 00:00:00.594 |
| `test_telemetry`         | `native_telemetry`     |     8 |   ✅   | 00:00:00.607 |
| `test_dashboard`         | `native_dashboard`     |    11 |   ✅   | 00:00:00.568 |
| `test_net_egress`        | `native_net_egress`    |     5 |   ✅   | 00:00:00.559 |
| `test_partition_monitor` | `native_partition`     |     5 |   ✅   | 00:00:00.561 |
| `test_cbor`              | `native_cbor`          |    14 |   ✅   | 00:00:00.577 |
| `test_msgpack`           | `native_msgpack`       |    15 |   ✅   | 00:00:00.565 |
| `test_gpio_map`          | `native_gpio_map`      |     8 |   ✅   | 00:00:00.561 |
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.562 |
| `test_guardrails`        | `native_guardrails`    |     6 |   ✅   | 00:00:00.568 |
| `test_logbuf`            | `native_logbuf`        |     4 |   ✅   | 00:00:00.562 |
| `test_config_io`         | `native_config_io`     |     4 |   ✅   | 00:00:00.575 |
| `test_workers`           | `native_workers`       |     3 |   ✅   | 00:00:00.664 |
| `test_clock`             | `native_clock`         |     4 |   ✅   | 00:00:00.543 |
| `test_concurrency`       | `native_concurrency`   |     2 |   ✅   | 00:00:00.720 |
| `test_concurrency`       | `native_tsan`          |     2 |   ✅   | 00:00:01.234 |
...
|  60 | `stress_ws_parse_reset_100_cycles`                     |   ✅   | Stress - Ws parse reset 100 cycles                                        |
|  61 | `stress_ws_alloc_free_pool_cycle`                      |   ✅   | Stress - Ws alloc free pool cycle                                         |
|  62 | `stress_ws_parse_incremental_byte_by_byte`             |   ✅   | Stress - Ws parse incremental byte by byte                                |
|  63 | `stress_ws_parse_max_payload`                          |   ✅   | Stress - Ws parse max payload                                             |
|  64 | `stress_ws_parse_two_consecutive_frames`               |   ✅   | First frame                                                               |
...
|   9 | `test_nonce_is_128bit_hex`                   |   ✅   | The hardened nonce is SHA-256(CSPRNG + counter + millis) truncated to 16        |
...
|  46 | `test_serve_static_last_modified_conditional_get`     |   ✅   | (1) plain GET: 200 carries the Last-Modified header.                       |
|  47 | `test_serve_static_if_modified_since_malformed`       |   ✅   | Serve static if modified since malformed                                   |
|  48 | `test_serve_static_cache_control`                     |   ✅   | Serve static cache control                                                 |
|  49 | `test_request_log_hook_fires`                         |   ✅   | Request log hook fires                                                     |
|  50 | `test_stats_endpoint_emits_json`                      |   ✅   | Stats endpoint emits json                                                  |
|  51 | `test_sse_broadcast_after_upgrade_matches_path`       |   ✅   | Sse broadcast after upgrade matches path                                   |
|  52 | `test_metrics_emits_prometheus`                       |   ✅   | Metrics emits prometheus                                                   |
...
|  10 | `test_decoder_longform_length_count_past_buffer_fails`   |   ✅   | Decoder longform length count past buffer fails                             |
|  11 | `test_decoder_longform_length_too_wide_fails`            |   ✅   | Decoder longform length too wide fails                                      |
|  12 | `test_decoder_longform_length_content_past_buffer_fails` |   ✅   | 0x82 0x01 0x00 = long form, length 256; only a few content bytes follow.    |
|  13 | `test_decoder_indefinite_length_fails`                   |   ✅   | Decoder indefinite length fails                                             |
|  14 | `test_decoder_oversized_integer_fails`                   |   ✅   | Decoder oversized integer fails                                             |
...
|  58 | `test_ws_reset_frame_clears_fields`                    |   ✅   | Ws reset frame clears fields                                              |
|  59 | `test_ws_parse_mask_applied_correctly`                 |   ✅   | Frame with mask key {0x37, 0xFA, 0x21, 0x3D}, payload 'H' XOR 0x37 = 0x7F |
|  60 | `test_ws_permessage_deflate_inbound`                   |   ✅   | "Hello, World!" as permessage-deflate (SYNC_FLUSH, marker stripped) - the |
|  61 | `test_ws_rsv1_without_negotiation_closes`              |   ✅   | Ws rsv1 without negotiation closes                                        |
|  62 | `test_ws_permessage_deflate_outbound`                  |   ✅   | Ws permessage deflate outbound                                            |
|  63 | `test_ws_outbound_incompressible_not_flagged`          |   ✅   | Ws outbound incompressible not flagged                                    |
...
----------------- native:test_sse [PASSED] Took 11.68 seconds ------------------
...
--------------- native:test_transport [PASSED] Took 0.54 seconds ---------------

Processing test_websocket in native environment
--------------------------------------------------------------------------------
Building...
Testing...
test/test_websocket/test_websocket.cpp:989: test_sha1_empty_string      [PASSED]
test/test_websocket/test_websocket.cpp:990: test_sha1_abc               [PASSED]
test/test_websocket/test_websocket.cpp:991: test_sha1_rfc6455_handshake_key [PASSED]
test/test_websocket/test_websocket.cpp:992: test_sha1_different_inputs_different_digests [PASSED]
test/test_websocket/test_websocket.cpp:995: test_base64_encode_one_byte [PASSED]
test/test_websocket/test_websocket.cpp:996: test_base64_encode_two_bytes [PASSED]
test/test_websocket/test_websocket.cpp:997: test_base64_encode_three_bytes [PASSED]
test/test_websocket/test_websocket.cpp:998: test_base64_encode_ws_accept_key [PASSED]
test/test_websocket/test_websocket.cpp:999: test_base64_decode_one_byte [PASSED]
test/test_websocket/test_websocket.cpp:1000: test_base64_decode_two_bytes [PASSED]
test/test_websocket/test_websocket.cpp:1001: test_base64_decode_three_bytes [PASSED]
test/test_websocket/test_websocket.cpp:1002: test_base64_decode_ws_accept_key [PASSED]
test/test_websocket/test_websocket.cpp:1003: test_base64_decode_rejects_misplaced_padding [PASSED]
test/test_websocket/test_websocket.cpp:1004: test_base64_decode_respects_capacity [PASSED]
test/test_websocket/test_websocket.cpp:1005: test_base64_round_trip     [PASSED]
test/test_websocket/test_websocket.cpp:1008: test_ws_pool_size          [PASSED]
test/test_websocket/test_websocket.cpp:1009: test_ws_ids_match_indices_after_init [PASSED]
test/test_websocket/test_websocket.cpp:1010: test_ws_all_inactive_after_init [PASSED]
test/test_websocket/test_websocket.cpp:1011: test_ws_alloc_returns_non_null [PASSED]
test/test_websocket/test_websocket.cpp:1012: test_ws_alloc_sets_active  [PASSED]
test/test_websocket/test_websocket.cpp:1013: test_ws_alloc_sets_slot_id [PASSED]
test/test_websocket/test_websocket.cpp:1014: test_ws_alloc_sets_parse_state_header1 [PASSED]
test/test_websocket/test_websocket.cpp:1015: test_ws_alloc_pool_full_returns_null [PASSED]
test/test_websocket/test_websocket.cpp:1016: test_ws_find_returns_correct_conn [PASSED]
test/test_websocket/test_websocket.cpp:1017: test_ws_find_returns_null_when_empty [PASSED]
test/test_websocket/test_websocket.cpp:1018: test_ws_find_returns_null_for_different_slot [PASSED]
test/test_websocket/test_websocket.cpp:1019: test_ws_find_after_both_slots_allocated [PASSED]
test/test_websocket/test_websocket.cpp:1020: test_ws_free_deactivates_slot [PASSED]
test/test_websocket/test_websocket.cpp:1021: test_ws_free_restores_ws_id [PASSED]
test/test_websocket/test_websocket.cpp:1022: test_ws_free_makes_slot_findable_as_null [PASSED]
test/test_websocket/test_websocket.cpp:1023: test_ws_free_nop_on_unallocated [PASSED]
test/test_websocket/test_websocket.cpp:1024: test_ws_alloc_after_free_succeeds [PASSED]
test/test_websocket/test_websocket.cpp:1027: test_ws_parse_text_frame_sets_ready [PASSED]
test/test_websocket/test_websocket.cpp:1028: test_ws_parse_payload_stored_correctly [PASSED]
test/test_websocket/test_websocket.cpp:1029: test_ws_parse_binary_frame_sets_ready [PASSED]
test/test_websocket/test_websocket.cpp:1030: test_ws_parse_zero_length_unmasked_frame [PASSED]
test/test_websocket/test_websocket.cpp:1031: test_ws_parse_zero_length_masked_frame [PASSED]
test/test_websocket/test_websocket.cpp:1032: test_ws_reject_unmasked_data_frame [PASSED]
test/test_websocket/test_websocket.cpp:1033: test_ws_reject_reserved_opcode [PASSED]
test/test_websocket/test_websocket.cpp:1034: test_ws_reject_fragmented_control_frame [PASSED]
test/test_websocket/test_websocket.cpp:1035: test_ws_reject_oversized_control_frame [PASSED]
test/test_websocket/test_websocket.cpp:1036: test_ws_parse_16bit_length_frame [PASSED]
test/test_websocket/test_websocket.cpp:1037: test_ws_parse_rsv1_set_closes_protocol [PASSED]
test/test_websocket/test_websocket.cpp:1038: test_ws_parse_rsv2_set_closes_protocol [PASSED]
test/test_websocket/test_websocket.cpp:1039: test_ws_parse_rsv3_set_closes_protocol [PASSED]
test/test_websocket/test_websocket.cpp:1040: test_ws_parse_64bit_length_closes_too_big [PASSED]
test/test_websocket/test_websocket.cpp:1041: test_ws_parse_oversized_16bit_length_closes_too_big [PASSED]
test/test_websocket/test_websocket.cpp:1042: test_ws_fragment_start_waits_for_continuation [PASSED]
test/test_websocket/test_websocket.cpp:1043: test_ws_fragmented_message_reassembled [PASSED]
test/test_websocket/test_websocket.cpp:1044: test_ws_control_frame_interleaved_in_fragments [PASSED]
test/test_websocket/test_websocket.cpp:1045: test_ws_fragment_accumulation_overflow_rejected [PASSED]
test/test_websocket/test_websocket.cpp:1046: test_ws_continuation_without_start_rejected [PASSED]
test/test_websocket/test_websocket.cpp:1047: test_ws_new_data_frame_during_fragmentation_rejected [PASSED]
test/test_websocket/test_websocket.cpp:1048: test_ws_parse_ping_auto_pong_resets_frame [PASSED]
test/test_websocket/test_websocket.cpp:1049: test_ws_parse_pong_silently_ignored [PASSED]
test/test_websocket/test_websocket.cpp:1050: test_ws_parse_close_marks_ws_closed [PASSED]
test/test_websocket/test_websocket.cpp:1051: test_ws_parse_stops_at_frame_ready [PASSED]
test/test_websocket/test_websocket.cpp:1052: test_ws_reset_frame_clears_fields [PASSED]
test/test_websocket/test_websocket.cpp:1053: test_ws_parse_mask_applied_correctly [PASSED]
test/test_websocket/test_websocket.cpp:1062: stress_ws_parse_reset_100_cycles [PASSED]
test/test_websocket/test_websocket.cpp:1063: stress_ws_alloc_free_pool_cycle [PASSED]
test/test_websocket/test_websocket.cpp:1064: stress_ws_parse_incremental_byte_by_byte [PASSED]
test/test_websocket/test_websocket.cpp:1065: stress_ws_parse_max_payload [PASSED]
test/test_websocket/test_websocket.cpp:1066: stress_ws_parse_two_consecutive_frames [PASSED]
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:11.682
native         test_session       PASSED    00:00:00.514
native         test_presentation  PASSED    00:00:00.551
native         test_transport     PASSED    00:00:00.537
native         test_websocket     PASSED    00:00:00.557
native         test_http_parser   PASSED    00:00:00.517
================ 307 test cases: 307 succeeded in 00:00:14.358 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------ native_observability:test_observability [PASSED] Took 0.65 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.645
================= 15 test cases: 15 succeeded in 00:00:00.645 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------- native_ota:test_http_ota [PASSED] Took 0.55 seconds --------------

=================================== SUMMARY ===================================
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.555
================== 3 test cases: 3 succeeded in 00:00:00.555 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
----------- native_prov:test_provisioning [PASSED] Took 0.57 seconds -----------

=================================== SUMMARY ===================================
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.572
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 4.20 seconds -------------
...
----------- native_ssh:test_ssh_transport [PASSED] Took 0.93 seconds -----------
...
------------ native_ssh:test_ssh_channel [PASSED] Took 0.46 seconds ------------

=================================== SUMMARY ===================================
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.204
native_ssh     test_ssh_auth       PASSED    00:00:00.516
native_ssh     test_ssh_server     PASSED    00:00:00.646
native_ssh     test_ssh_transport  PASSED    00:00:00.925
native_ssh     test_ssh_channel    PASSED    00:00:00.465
================= 92 test cases: 92 succeeded in 00:00:06.756 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------ native_ssh_hardened:test_ssh_hardening [PASSED] Took 0.77 seconds -------

=================================== SUMMARY ===================================
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.773
================== 2 test cases: 2 succeeded in 00:00:00.773 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 1.16 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.158
================== 2 test cases: 2 succeeded in 00:00:01.158 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
src/DeterministicESPAsyncWebServer.cpp:2742:76: warning: ‘snprintf’ output may be truncated before the last format character [-Wformat-truncation=]
 2742 |         snprintf(lastmod_line, sizeof(lastmod_line), "Last-Modified: %s\r\n", lm_date);
      |                                                                            ^
src/DeterministicESPAsyncWebServer.cpp:2742:17: note: ‘snprintf’ output between 18 and 57 bytes into a destination of size 56
 2742 |         snprintf(lastmod_line, sizeof(lastmod_line), "Last-Modified: %s\r\n", lm_date);
      |         ~~~~~~~~^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Testing...
...
--------------- native_app:test_regex [PASSED] Took 1.01 seconds ---------------
...
------------- native_app:test_template [PASSED] Took 0.53 seconds --------------
...
------------ native_app:test_form_params [PASSED] Took 0.52 seconds ------------
...
--------------- native_app:test_iface [PASSED] Took 0.53 seconds ---------------
...
--------------- native_app:test_json [PASSED] Took 0.48 seconds ----------------
...
--------- native_app:test_response_headers [PASSED] Took 0.53 seconds ----------
...
------------ native_app:test_middleware [PASSED] Took 0.53 seconds -------------

Processing test_digest_auth in native_app environment
--------------------------------------------------------------------------------
Building...
Testing...
test/test_digest_auth/test_digest_auth.cpp:310: test_challenge_is_digest_sha256 [PASSED]
test/test_digest_auth/test_digest_auth.cpp:311: test_valid_digest_authenticates [PASSED]
test/test_digest_auth/test_digest_auth.cpp:312: test_wrong_password_rejected [PASSED]
test/test_digest_auth/test_digest_auth.cpp:313: test_bad_nonce_rejected [PASSED]
test/test_digest_auth/test_digest_auth.cpp:314: test_wrong_username_rejected [PASSED]
test/test_digest_auth/test_digest_auth.cpp:315: test_wrong_qop_rejected [PASSED]
test/test_digest_auth/test_digest_auth.cpp:316: test_missing_response_field_rejected [PASSED]
test/test_digest_auth/test_digest_auth.cpp:317: test_basic_scheme_on_digest_route_rejected [PASSED]
test/test_digest_auth/test_digest_auth.cpp:318: test_nonce_is_128bit_hex [PASSED]
------------ native_app:test_digest_auth [PASSED] Took 0.54 seconds ------------

Processing test_web_terminal in native_app environment
--------------------------------------------------------------------------------
Building...
Testing...
test/test_web_terminal/test_web_terminal.cpp:178: test_serves_terminal_page [PASSED]
test/test_web_terminal/test_web_terminal.cpp:179: test_ws_upgrade_tracks_client [PASSED]
test/test_web_terminal/test_web_terminal.cpp:180: test_command_delivered_to_callback [PASSED]
test/test_web_terminal/test_web_terminal.cpp:181: test_broadcast_reaches_client [PASSED]
test/test_web_terminal/test_web_terminal.cpp:182: test_printf_broadcast [PASSED]
test/test_web_terminal/test_web_terminal.cpp:183: test_no_broadcast_without_clients [PASSED]
test/test_web_terminal/test_web_terminal.cpp:184: test_close_clears_client [PASSED]
----------- native_app:test_web_terminal [PASSED] Took 0.53 seconds ------------
...
--------------- native_app:test_defer [PASSED] Took 0.51 seconds ---------------
...
--------------- native_app:test_auth [PASSED] Took 0.53 seconds ----------------
...
----------- native_app:test_file_serving [PASSED] Took 0.54 seconds ------------
...
------------- native_app:test_dispatch [PASSED] Took 0.53 seconds --------------

Processing test_chunked in native_app environment
--------------------------------------------------------------------------------
Building...
Testing...
test/test_chunked/test_chunked.cpp:309: test_headers_announce_chunked_no_content_length [PASSED]
test/test_chunked/test_chunked.cpp:310: test_single_chunk_framing       [PASSED]
test/test_chunked/test_chunked.cpp:311: test_multiple_chunks_in_order   [PASSED]
test/test_chunked/test_chunked.cpp:312: test_printf_chunk               [PASSED]
test/test_chunked/test_chunked.cpp:313: test_single_piece_then_terminator [PASSED]
test/test_chunked/test_chunked.cpp:314: test_empty_body_is_just_terminator [PASSED]
test/test_chunked/test_chunked.cpp:315: test_large_chunked_body_not_truncated [PASSED]
test/test_chunked/test_chunked.cpp:316: test_head_sends_headers_only    [PASSED]
test/test_chunked/test_chunked.cpp:317: test_custom_header_injected_into_chunked [PASSED]
test/test_chunked/test_chunked.cpp:318: test_log_hook_reports_total_body_length [PASSED]
-------------- native_app:test_chunked [PASSED] Took 0.53 seconds --------------

Processing test_application in native_app environment
--------------------------------------------------------------------------------
Building...
Testing...
test/test_application/test_application.cpp:1002: test_handler_reads_body [PASSED]
test/test_application/test_application.cpp:1003: test_handler_reads_query_param [PASSED]
test/test_application/test_application.cpp:1004: test_handler_reads_header [PASSED]
test/test_application/test_application.cpp:1005: test_wildcard_before_exact_wildcard_wins [PASSED]
test/test_application/test_application.cpp:1008: test_fn_on_registers_and_dispatches [PASSED]
test/test_application/test_application.cpp:1009: test_fn_on_path_copied_null_terminated [PASSED]
test/test_application/test_application.cpp:1010: test_fn_on_table_full_extra_routes_dropped [PASSED]
test/test_application/test_application.cpp:1011: test_fn_on_same_path_different_methods_are_distinct [PASSED]
test/test_application/test_application.cpp:1014: test_fn_on_not_found_called_when_no_match [PASSED]
test/test_application/test_application.cpp:1015: test_fn_on_not_found_not_called_when_match_exists [PASSED]
test/test_application/test_application.cpp:1018: test_fn_set_cors_options_preflight_clears_slot [PASSED]
test/test_application/test_application.cpp:1019: test_fn_set_cors_empty_string_disables [PASSED]
test/test_application/test_application.cpp:1022: test_wrong_method_does_not_match [PASSED]
test/test_application/test_application.cpp:1023: test_wrong_path_does_not_match [PASSED]
test/test_application/test_application.cpp:1024: test_all_http_methods_dispatched [PASSED]
test/test_application/test_application.cpp:1025: test_root_path_matches_exactly [PASSED]
test/test_application/test_application.cpp:1026: test_root_path_does_not_match_subpath [PASSED]
test/test_application/test_application.cpp:1027: test_wildcard_matches_any_suffix [PASSED]
test/test_application/test_application.cpp:1028: test_wildcard_does_not_match_unrelated_prefix [PASSED]
test/test_application/test_application.cpp:1029: test_exact_route_wins_when_registered_first [PASSED]
test/test_application/test_application.cpp:1030: test_slot_not_stuck_in_complete_after_handle [PASSED]
test/test_application/test_application.cpp:1031: test_parse_error_slot_auto_reset [PASSED]
test/test_application/test_application.cpp:1034: stress_last_route_dispatched_in_full_table [PASSED]
test/test_application/test_application.cpp:1035: stress_sequential_requests_no_state_leak [PASSED]
test/test_application/test_application.cpp:1036: stress_all_slots_dispatched_simultaneously [PASSED]
test/test_application/test_application.cpp:1037: stress_wildcard_matches_many_paths [PASSED]
test/test_application/test_application.cpp:1038: stress_handle_with_no_complete_slots_is_nop [PASSED]
test/test_application/test_application.cpp:1041: race_slot_complete_between_handle_calls [PASSED]
test/test_application/test_application.cpp:1042: race_conn_freed_after_parse_complete [PASSED]
test/test_application/test_application.cpp:1043: race_double_handle_no_double_dispatch [PASSED]
test/test_application/test_application.cpp:1044: race_error_and_valid_slot_in_same_handle [PASSED]
test/test_application/test_application.cpp:1045: race_callback_manually_resets_slot [PASSED]
test/test_application/test_application.cpp:1048: test_uri_too_long_auto_resets_slot [PASSED]
test/test_application/test_application.cpp:1051: test_transfer_encoding_chunked_is_501 [PASSED]
test/test_application/test_application.cpp:1052: test_transfer_encoding_identity_is_501 [PASSED]
test/test_application/test_application.cpp:1054: test_redirect_emits_location_and_status [PASSED]
test/test_application/test_application.cpp:1055: test_redirect_invalid_code_defaults_to_302 [PASSED]
test/test_application/test_application.cpp:1056: test_mime_type_detection [PASSED]
test/test_application/test_application.cpp:1058: test_serve_static_file_and_mime [PASSED]
test/test_application/test_application.cpp:1059: test_serve_static_index_fallback [PASSED]
test/test_application/test_application.cpp:1060: test_serve_static_gzip_when_accepted [PASSED]
test/test_application/test_application.cpp:1061: test_serve_static_no_gzip_when_not_accepted [PASSED]
test/test_application/test_application.cpp:1062: test_serve_static_traversal_not_leaked [PASSED]
test/test_application/test_application.cpp:1063: test_serve_static_missing_is_404 [PASSED]
test/test_application/test_application.cpp:1064: test_serve_static_etag_conditional_get [PASSED]
test/test_application/test_application.cpp:1065: test_serve_static_last_modified_conditional_get [PASSED]
test/test_application/test_application.cpp:1066: test_serve_static_if_modified_since_malformed [PASSED]
test/test_application/test_application.cpp:1067: test_serve_static_cache_control [PASSED]
test/test_application/test_application.cpp:1069: test_request_log_hook_fires [PASSED]
test/test_application/test_application.cpp:1070: test_stats_endpoint_emits_json [PASSED]
test/test_application/test_application.cpp:1073: test_sse_broadcast_after_upgrade_matches_path [PASSED]
test/test_application/test_application.cpp:1076: test_metrics_emits_prometheus [PASSED]
------------ native_app:test_application [PASSED] Took 0.60 seconds ------------

=================================== SUMMARY ===================================
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.005
native_app     test_template          PASSED    00:00:00.527
native_app     test_path_params       PASSED    00:00:00.522
native_app     test_digest_vectors    PASSED    00:00:00.472
native_app     test_form_params       PASSED    00:00:00.522
native_app     test_iface             PASSED    00:00:00.528
native_app     test_json              PASSED    00:00:00.483
native_app     test_response_headers  PASSED    00:00:00.531
native_app     test_middleware        PASSED    00:00:00.530
native_app     test_digest_auth       PASSED    00:00:00.535
native_app     test_web_terminal      PASSED    00:00:00.529
native_app     test_defer             PASSED    00:00:00.510
native_app     test_multipart         PASSED    00:00:00.534
native_app     test_auth              PASSED    00:00:00.533
native_app     test_file_serving      PASSED    00:00:00.541
native_app     test_dispatch          PASSED    00:00:00.528
native_app     test_chunked           PASSED    00:00:00.535
native_app     test_application       PASSED    00:00:00.605
================ 210 test cases: 210 succeeded in 00:00:09.971 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
--------------- native_diag:test_diag [PASSED] Took 1.00 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.000
================== 2 test cases: 2 succeeded in 00:00:01.000 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_snmp_ber/test_snmp_ber.cpp:260: test_integer_vectors          [PASSED]
test/test_snmp_ber/test_snmp_ber.cpp:261: test_oid_vector               [PASSED]
test/test_snmp_ber/test_snmp_ber.cpp:262: test_octet_string_and_null    [PASSED]
test/test_snmp_ber/test_snmp_ber.cpp:263: test_counter32_keeps_unsigned [PASSED]
test/test_snmp_ber/test_snmp_ber.cpp:264: test_sequence_roundtrip       [PASSED]
test/test_snmp_ber/test_snmp_ber.cpp:265: test_oid_roundtrip            [PASSED]
test/test_snmp_ber/test_snmp_ber.cpp:266: test_large_arc_roundtrip      [PASSED]
test/test_snmp_ber/test_snmp_ber.cpp:267: test_encoder_overflow_sets_not_ok [PASSED]
test/test_snmp_ber/test_snmp_ber.cpp:268: test_decoder_truncated_length_fails [PASSED]
test/test_snmp_ber/test_snmp_ber.cpp:269: test_decoder_longform_length_count_past_buffer_fails [PASSED]
test/test_snmp_ber/test_snmp_ber.cpp:270: test_decoder_longform_length_too_wide_fails [PASSED]
test/test_snmp_ber/test_snmp_ber.cpp:271: test_decoder_longform_length_content_past_buffer_fails [PASSED]
test/test_snmp_ber/test_snmp_ber.cpp:272: test_decoder_indefinite_length_fails [PASSED]
test/test_snmp_ber/test_snmp_ber.cpp:273: test_decoder_oversized_integer_fails [PASSED]
------------- native_snmp:test_snmp_ber [PASSED] Took 0.62 seconds -------------
...
------------ native_snmp:test_snmp_agent [PASSED] Took 0.44 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.620
native_snmp    test_snmp_agent  PASSED    00:00:00.443
================= 27 test cases: 27 succeeded in 00:00:01.063 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 1.41 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.412
================== 9 test cases: 9 succeeded in 00:00:01.412 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------- native_telnet:test_telnet [PASSED] Took 0.71 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.711
...
--------------- native_coap:test_coap [PASSED] Took 0.59 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.590
================= 26 test cases: 26 succeeded in 00:00:00.590 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
test/test_coap/test_coap.cpp:779: test_root_path                        [PASSED]
test/test_coap/test_coap.cpp:780: test_unknown_method_not_implemented   [PASSED]
----------- native_coap_observe:test_coap [PASSED] Took 0.57 seconds -----------

=================================== SUMMARY ===================================
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.572
================= 26 test cases: 26 succeeded in 00:00:00.572 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------- native_webdav:test_webdav [PASSED] Took 0.59 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.589
================= 19 test cases: 19 succeeded in 00:00:00.589 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------- native_modbus:test_modbus [PASSED] Took 0.58 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.580
================= 13 test cases: 13 succeeded in 00:00:00.580 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------ native_modbus_master:test_modbus_master [PASSED] Took 0.58 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.579
...
------- native_ota_rollback:test_ota_rollback [PASSED] Took 0.56 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.559
================== 5 test cases: 5 succeeded in 00:00:00.559 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
--------------- native_totp:test_totp [PASSED] Took 0.59 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.592
...
------------ native_webhook:test_webhook [PASSED] Took 0.57 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.573
...
-------- native_radio_power:test_radio_power [PASSED] Took 0.57 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.568
================== 2 test cases: 2 succeeded in 00:00:00.568 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.567
...
---------- native_audit_log:test_audit_log [PASSED] Took 0.60 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.596
...
--------------- native_oidc:test_oidc [PASSED] Took 0.77 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.767
...
---------------- native_vfs:test_vfs [PASSED] Took 0.58 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.578
...
------------ native_graphql:test_graphql [PASSED] Took 0.58 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.580
================= 13 test cases: 13 succeeded in 00:00:00.580 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------- native_espnow:test_espnow [PASSED] Took 0.56 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.560
...
------------- native_oauth2:test_oauth2 [PASSED] Took 0.59 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.589
================== 8 test cases: 8 succeeded in 00:00:00.589 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
-------------- native_opcua:test_opcua [PASSED] Took 0.60 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.601
================= 29 test cases: 29 succeeded in 00:00:00.601 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------- native_opcua_client:test_opcua_client [PASSED] Took 0.61 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.612
================= 11 test cases: 11 succeeded in 00:00:00.612 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
---------- native_keepalive:test_keepalive [PASSED] Took 0.98 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:00.976
================= 10 test cases: 10 succeeded in 00:00:00.976 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
-------------- native_range:test_range [PASSED] Took 0.97 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:00.966
================= 13 test cases: 13 succeeded in 00:00:00.966 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------- native_syslog:test_syslog [PASSED] Took 0.58 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.580
...
---------------- native_jwt:test_jwt [PASSED] Took 0.62 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.617
...
------------- native_upload:test_upload [PASSED] Took 0.98 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:00.984
================== 3 test cases: 3 succeeded in 00:00:00.984 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
-------- native_http_client:test_http_client [PASSED] Took 0.57 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.569
...
--------- native_compliance:test_compliance [PASSED] Took 0.55 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.553
================= 15 test cases: 15 succeeded in 00:00:00.553 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
================= 16 test cases: 16 succeeded in 00:00:00.566 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
---------- native_ws_client:test_ws_client [PASSED] Took 0.62 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.616
================= 10 test cases: 10 succeeded in 00:00:00.616 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------ native_scratch:test_scratch [PASSED] Took 0.62 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.620
================= 14 test cases: 14 succeeded in 00:00:00.620 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
---------- native_snmp_trap:test_snmp_trap [PASSED] Took 0.59 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.593
================== 3 test cases: 3 succeeded in 00:00:00.593 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.572
================= 12 test cases: 12 succeeded in 00:00:00.572 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------ native_deflate:test_deflate [PASSED] Took 0.61 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.608
================= 10 test cases: 10 succeeded in 00:00:00.608 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
test/test_websocket/test_websocket.cpp:1052: test_ws_reset_frame_clears_fields [PASSED]
test/test_websocket/test_websocket.cpp:1053: test_ws_parse_mask_applied_correctly [PASSED]
test/test_websocket/test_websocket.cpp:1055: test_ws_permessage_deflate_inbound [PASSED]
test/test_websocket/test_websocket.cpp:1056: test_ws_rsv1_without_negotiation_closes [PASSED]
test/test_websocket/test_websocket.cpp:1057: test_ws_permessage_deflate_outbound [PASSED]
test/test_websocket/test_websocket.cpp:1058: test_ws_outbound_incompressible_not_flagged [PASSED]
test/test_websocket/test_websocket.cpp:1062: stress_ws_parse_reset_100_cycles [PASSED]
test/test_websocket/test_websocket.cpp:1063: stress_ws_alloc_free_pool_cycle [PASSED]
test/test_websocket/test_websocket.cpp:1064: stress_ws_parse_incremental_byte_by_byte [PASSED]
test/test_websocket/test_websocket.cpp:1065: stress_ws_parse_max_payload [PASSED]
test/test_websocket/test_websocket.cpp:1066: stress_ws_parse_two_consecutive_frames [PASSED]
--------- native_ws_deflate:test_websocket [PASSED] Took 0.91 seconds ----------

=================================== SUMMARY ===================================
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.908
================= 68 test cases: 68 succeeded in 00:00:00.908 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
-------- native_time_source:test_time_source [PASSED] Took 0.56 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.565
================== 9 test cases: 9 succeeded in 00:00:00.565 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------- native_config_store:test_config_store [PASSED] Took 0.57 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.567
...
---------- native_device_id:test_device_id [PASSED] Took 0.59 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.588
...
------- native_auth_lockout:test_auth_lockout [PASSED] Took 0.58 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.585
================= 10 test cases: 10 succeeded in 00:00:00.585 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
--------------- native_csrf:test_csrf [PASSED] Took 0.59 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.594
================== 9 test cases: 9 succeeded in 00:00:00.594 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
---------- native_telemetry:test_telemetry [PASSED] Took 0.61 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.607
================== 8 test cases: 8 succeeded in 00:00:00.607 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.568
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.559
================== 5 test cases: 5 succeeded in 00:00:00.559 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.561
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.577
================= 14 test cases: 14 succeeded in 00:00:00.577 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------ native_msgpack:test_msgpack [PASSED] Took 0.56 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.565
================= 15 test cases: 15 succeeded in 00:00:00.565 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.561
================== 8 test cases: 8 succeeded in 00:00:00.561 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.562
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.568
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.562
================== 4 test cases: 4 succeeded in 00:00:00.562 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.575
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.664
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.543
...
-------- native_concurrency:test_concurrency [PASSED] Took 0.72 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.720
================== 2 test cases: 2 succeeded in 00:00:00.720 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 1.23 seconds ------------

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.234
================== 2 test cases: 2 succeeded in 00:00:01.234 ==================
```
