...
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.823 |
| `test_ssh_auth`          | `native_ssh`           |    12 |   ✅   | 00:00:00.556 |
| `test_ssh_server`        | `native_ssh`           |     7 |   ✅   | 00:00:00.665 |
| `test_ssh_transport`     | `native_ssh`           |    23 |   ✅   | 00:00:00.893 |
...
| `test_middleware`        | `native_app`           |     9 |   ✅   | 00:00:00.614 |
| `test_digest_auth`       | `native_app`           |     5 |   ✅   | 00:00:00.624 |
| `test_web_terminal`      | `native_app`           |     7 |   ✅   | 00:00:00.613 |
...
| `test_dispatch`          | `native_app`           |    11 |   ✅   | 00:00:00.629 |
| `test_chunked`           | `native_app`           |    10 |   ✅   | 00:00:00.645 |
| `test_application`       | `native_app`           |    52 |   ✅   | 00:00:00.713 |
| `test_snmp_ber`          | `native_snmp`          |     9 |   ✅   | 00:00:00.731 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.532 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.429 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.823 |
| `test_coap`              | `native_coap`          |    26 |   ✅   | 00:00:00.704 |
| `test_webdav`            | `native_webdav`        |    19 |   ✅   | 00:00:00.699 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.683 |
...
| `test_audit_log`         | `native_audit_log`     |    12 |   ✅   | 00:00:00.684 |
...
----------------- native:test_sse [PASSED] Took 13.45 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:13.454
...
native         test_websocket     PASSED    00:00:00.607
native         test_http_parser   PASSED    00:00:00.574
================ 306 test cases: 306 succeeded in 00:00:16.389 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.823
native_ssh     test_ssh_auth       PASSED    00:00:00.556
native_ssh     test_ssh_server     PASSED    00:00:00.665
native_ssh     test_ssh_transport  PASSED    00:00:00.893
native_ssh     test_ssh_channel    PASSED    00:00:00.538
================= 92 test cases: 92 succeeded in 00:00:06.475 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
native_app     test_middleware        PASSED    00:00:00.614
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.731
native_snmp    test_snmp_agent  PASSED    00:00:00.532
================= 22 test cases: 22 succeeded in 00:00:01.263 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.429
================== 9 test cases: 9 succeeded in 00:00:01.429 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.704
================= 26 test cases: 26 succeeded in 00:00:00.704 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.684
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.645
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.669
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.649
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.024
================= 67 test cases: 67 succeeded in 00:00:01.024 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.637
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.646
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.641
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.650
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.645
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.753
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.191
