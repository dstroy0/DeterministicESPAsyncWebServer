...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    11 |   ✅   | 00:00:05.845 |
...
| `test_mbus`              | `native_mbus`           |     8 |   ✅   | 00:00:00.698 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.712 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.677 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.688 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.726 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.682 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.183 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.603 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.695 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.635 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.655 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.607 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.773 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:01.148 |
...
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.698 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.927 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.545 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.101 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.657 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.399 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.634 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.611 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.587 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.627 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.632 |
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.584 |
...
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.618 |
...
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.653 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.633 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.730 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.441 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.404 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.801 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.548 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.584 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.855 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.794 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.785 |
...
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.701 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.691 |
...
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.677 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.694 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.682 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.713 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.688 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.661 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.686 |
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.769 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.701 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.698 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.684 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.705 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.677 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.695 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.652 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.706 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.692 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.671 |
| `test_sparkplug`         | `native_sparkplug`      |     6 |   ✅   | 00:00:00.707 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.738 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.699 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.717 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.684 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.682 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.689 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.704 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.993 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.713 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.685 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.692 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.705 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.727 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.729 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.286 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.274 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.710 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.754 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.319 |
| `test_http_client`       | `native_http_client`    |    11 |   ✅   | 00:00:00.714 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.672 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.669 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.761 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.716 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.714 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.679 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.729 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.229 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.687 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.698 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.727 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.688 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.759 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.707 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.704 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.693 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.712 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.686 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.695 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.730 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.730 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.679 |
...
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.643 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.789 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.119 |
...
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:05.845
================= 11 test cases: 11 succeeded in 00:00:05.845 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.698
================== 8 test cases: 8 succeeded in 00:00:00.698 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.726
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.682
...
------------- native:test_presentation [PASSED] Took 0.70 seconds --------------
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.183
native         test_session       PASSED    00:00:00.603
native         test_presentation  PASSED    00:00:00.695
native         test_transport     PASSED    00:00:00.635
native         test_websocket     PASSED    00:00:00.655
native         test_http_parser   PASSED    00:00:00.607
================ 318 test cases: 318 succeeded in 00:00:04.378 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.773
================= 17 test cases: 17 succeeded in 00:00:00.773 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.148
...
------ native_ssh_hardened:test_ssh_hardening [PASSED] Took 1.10 seconds -------

=================================== SUMMARY ===================================
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:01.101
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 1.66 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.657
================== 2 test cases: 2 succeeded in 00:00:01.657 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
--------------- native_app:test_regex [PASSED] Took 1.40 seconds ---------------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.399
native_app     test_template          PASSED    00:00:00.634
native_app     test_path_params       PASSED    00:00:00.611
native_app     test_digest_vectors    PASSED    00:00:00.587
native_app     test_form_params       PASSED    00:00:00.627
native_app     test_iface             PASSED    00:00:00.632
native_app     test_json              PASSED    00:00:00.584
...
native_app     test_defer             PASSED    00:00:00.618
...
native_app     test_dispatch          PASSED    00:00:00.653
native_app     test_chunked           PASSED    00:00:00.633
native_app     test_application       PASSED    00:00:00.730
================ 219 test cases: 219 succeeded in 00:00:12.280 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.441
================= 12 test cases: 12 succeeded in 00:00:01.441 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.404
================== 2 test cases: 2 succeeded in 00:00:01.404 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.801
native_snmp    test_snmp_agent  PASSED    00:00:00.548
================= 30 test cases: 30 succeeded in 00:00:01.349 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 1.58 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.584
================= 10 test cases: 10 succeeded in 00:00:01.584 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
================== 8 test cases: 8 succeeded in 00:00:00.855 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.794
================= 29 test cases: 29 succeeded in 00:00:00.794 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
================= 29 test cases: 29 succeeded in 00:00:00.785 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.691
================== 8 test cases: 8 succeeded in 00:00:00.691 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.677
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.682
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.713
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.688
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.769
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.701
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.677
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.738
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.699
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.717
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.684
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.993
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.713
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.727
================= 29 test cases: 29 succeeded in 00:00:00.727 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
---------- native_keepalive:test_keepalive [PASSED] Took 1.29 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.286
================= 10 test cases: 10 succeeded in 00:00:01.286 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.274
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.710
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.319
================== 3 test cases: 3 succeeded in 00:00:01.319 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.714
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.672
...
================= 19 test cases: 19 succeeded in 00:00:00.669 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.716
================= 14 test cases: 14 succeeded in 00:00:00.716 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.229
================= 71 test cases: 71 succeeded in 00:00:01.229 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.698
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.727
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.759
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.693
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.686
...
------ native_udp_telemetry:test_udp_telemetry [PASSED] Took 0.73 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.730
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.679
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.789
================== 2 test cases: 2 succeeded in 00:00:00.789 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 1.12 seconds ------------

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.119
================== 2 test cases: 2 succeeded in 00:00:01.119 ==================
```
