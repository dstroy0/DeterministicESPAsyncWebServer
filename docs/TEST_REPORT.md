...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:11.923 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.498 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.539 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.529 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.553 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.536 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.691 |
...
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.932 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.511 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.515 |
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.489 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.523 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.515 |
...
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.520 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.517 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.520 |
...
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.612 |
...
----------------- native:test_sse [PASSED] Took 11.92 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:11.923
native               test_session           PASSED    00:00:00.498
native               test_presentation      PASSED    00:00:00.539
native               test_transport         PASSED    00:00:00.529
native               test_websocket         PASSED    00:00:00.553
native               test_http_parser       PASSED    00:00:00.536
native_ssh           test_ssh_crypto        PASSED    00:00:03.691
...
native_app           test_regex             PASSED    00:00:00.932
native_app           test_template          PASSED    00:00:00.511
native_app           test_path_params       PASSED    00:00:00.515
native_app           test_digest_vectors    PASSED    00:00:00.489
native_app           test_form_params       PASSED    00:00:00.523
native_app           test_iface             PASSED    00:00:00.515
...
native_app           test_digest_auth       PASSED    00:00:00.520
native_app           test_web_terminal      PASSED    00:00:00.517
native_app           test_multipart         PASSED    00:00:00.520
...
================ 611 test cases: 611 succeeded in 00:00:32.788 ================
```
