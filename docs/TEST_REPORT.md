...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:12.904 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.548 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.581 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.560 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.593 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.541 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.725 |
...
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:01.048 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.580 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.566 |
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.509 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.559 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.577 |
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.521 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.568 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.579 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.582 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.571 |
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.542 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.571 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.570 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.583 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.569 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.569 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.663 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.661 |
| `test_workers`          | `native_workers`      |     3 |   ✅   | 00:00:00.729 |
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:12.904
native               test_session           PASSED    00:00:00.548
native               test_presentation      PASSED    00:00:00.581
...
native_ssh           test_ssh_crypto        PASSED    00:00:03.725
...
native_app           test_regex             PASSED    00:00:01.048
native_app           test_template          PASSED    00:00:00.580
native_app           test_path_params       PASSED    00:00:00.566
native_app           test_digest_vectors    PASSED    00:00:00.509
native_app           test_form_params       PASSED    00:00:00.559
native_app           test_iface             PASSED    00:00:00.577
...
native_app           test_multipart         PASSED    00:00:00.571
native_app           test_auth              PASSED    00:00:00.570
native_app           test_file_serving      PASSED    00:00:00.583
...
native_workers       test_workers           PASSED    00:00:00.729
native_tsan          test_concurrency       PASSED    00:00:01.352
================ 619 test cases: 619 succeeded in 00:00:37.701 ================
```
