...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    11 |   ✅   | 00:00:05.672 |
...
| `test_mbus`              | `native_mbus`           |     8 |   ✅   | 00:00:00.662 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.664 |
...
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.109 |
...
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:01.142 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.694 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.691 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.912 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.585 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.699 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.947 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.552 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.027 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.520 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.315 |
...
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.618 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.599 |
...
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.356 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.307 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.743 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.510 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.603 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.850 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.759 |
...
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.675 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.685 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.680 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.669 |
| `test_protobuf`          | `native_protobuf`       |    10 |   ✅   | 00:00:00.674 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.685 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.668 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.656 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.676 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.690 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.645 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.678 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.676 |
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.758 |
...
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.669 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.672 |
| `test_sparkplug`         | `native_sparkplug`      |     6 |   ✅   | 00:00:00.686 |
...
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.675 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.690 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.961 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.676 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.676 |
...
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.189 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.216 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.681 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.746 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.239 |
| `test_http_client`       | `native_http_client`    |    11 |   ✅   | 00:00:00.677 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.668 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.689 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.737 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.710 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.686 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.682 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.707 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.160 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.666 |
...
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.707 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.652 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.674 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.673 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.671 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.674 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.676 |
...
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.653 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.788 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.551 |
...
------------ native_canopen:test_canopen [PASSED] Took 5.67 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:05.672
================= 11 test cases: 11 succeeded in 00:00:05.672 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.664
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.109
...
================ 318 test cases: 318 succeeded in 00:00:04.138 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.142
================= 10 test cases: 10 succeeded in 00:00:01.142 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.912
native_ssh     test_ssh_auth       PASSED    00:00:00.585
native_ssh     test_ssh_server     PASSED    00:00:00.699
native_ssh     test_ssh_transport  PASSED    00:00:00.947
native_ssh     test_ssh_channel    PASSED    00:00:00.552
================= 93 test cases: 93 succeeded in 00:00:06.694 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:01.027
================== 2 test cases: 2 succeeded in 00:00:01.027 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.520
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.315
...
native_app     test_web_terminal      PASSED    00:00:00.618
native_app     test_defer             PASSED    00:00:00.599
...
================ 219 test cases: 219 succeeded in 00:00:11.743 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.356
================= 12 test cases: 12 succeeded in 00:00:01.356 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.307
...
================= 30 test cases: 30 succeeded in 00:00:01.253 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.603
================= 10 test cases: 10 succeeded in 00:00:01.603 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.850
================== 8 test cases: 8 succeeded in 00:00:00.850 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
================= 29 test cases: 29 succeeded in 00:00:00.759 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.675
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.669
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.645
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.758
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.675
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.961
================= 13 test cases: 13 succeeded in 00:00:00.961 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.676
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.189
================= 10 test cases: 10 succeeded in 00:00:01.189 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.216
================= 13 test cases: 13 succeeded in 00:00:01.216 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.681
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.239
================== 3 test cases: 3 succeeded in 00:00:01.239 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
================= 19 test cases: 19 succeeded in 00:00:00.689 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.737
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.160
================= 71 test cases: 71 succeeded in 00:00:01.160 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.666
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.673
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.653
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.788
================== 2 test cases: 2 succeeded in 00:00:00.788 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.551
================== 2 test cases: 2 succeeded in 00:00:01.551 ==================
```
