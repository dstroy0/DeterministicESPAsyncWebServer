...
**Generated:** 2026-06-29 17:04:00
**Command:** `pio test` over 68 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1320 passed - 110s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:06.871 |
...
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.581 |
...
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.903 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.550 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.653 |
...
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.587 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.586 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.598 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.580 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.561 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.594 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.590 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.600 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.582 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.589 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.663 |
...
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.459 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.783 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.843 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.729 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.669 |
...
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.646 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.646 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.630 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.651 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.631 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.653 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.652 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.656 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.858 |
...
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.061 |
...
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.679 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.674 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.643 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.644 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.674 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:00.998 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.625 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.633 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.657 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.626 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.662 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.621 |
...
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.636 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.621 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.630 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.655 |
...
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.161 |
...
------------------ native:test_sse [PASSED] Took 6.87 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.871
...
================ 318 test cases: 318 succeeded in 00:00:09.865 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 93 tests
...
native_app     test_response_headers  PASSED    00:00:00.587
native_app     test_middleware        PASSED    00:00:00.586
native_app     test_digest_auth       PASSED    00:00:00.598
native_app     test_web_terminal      PASSED    00:00:00.580
native_app     test_defer             PASSED    00:00:00.561
native_app     test_multipart         PASSED    00:00:00.594
native_app     test_auth              PASSED    00:00:00.590
native_app     test_file_serving      PASSED    00:00:00.600
native_app     test_dispatch          PASSED    00:00:00.582
native_app     test_chunked           PASSED    00:00:00.589
native_app     test_application       PASSED    00:00:00.663
================ 219 test cases: 219 succeeded in 00:00:11.052 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 93 tests
...
================= 29 test cases: 29 succeeded in 00:00:01.182 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 93 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.459
================= 10 test cases: 10 succeeded in 00:00:01.459 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 93 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.783
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.843
================= 29 test cases: 29 succeeded in 00:00:00.843 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 93 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.669
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.630
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.631
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.656
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.858
================= 13 test cases: 13 succeeded in 00:00:00.858 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 93 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.061
================= 10 test cases: 10 succeeded in 00:00:01.061 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 93 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.643
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.674
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.625
================== 9 test cases: 9 succeeded in 00:00:00.625 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 93 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.626
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.662
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.621
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.630
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.161
================== 2 test cases: 2 succeeded in 00:00:01.161 ==================
```
