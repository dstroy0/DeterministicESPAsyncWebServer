...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:06.953 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.386 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.413 |
| `test_transport`        | `native`              |    28 |   ✅   | 00:00:00.386 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.412 |
| `test_http_parser`      | `native`              |    80 |   ✅   | 00:00:00.461 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:02.837 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.405 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.504 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.687 |
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.389 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.619 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:00.822 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.785 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.468 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.479 |
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.376 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.386 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.388 |
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.385 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.399 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.401 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.399 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.394 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.406 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.394 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.400 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.388 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.393 |
| `test_application`      | `native_app`          |    49 |   ✅   | 00:00:00.465 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.493 |
...
------------------ native:test_sse [PASSED] Took 6.95 seconds ------------------
...
------------ native_app:test_form_params [PASSED] Took 0.39 seconds ------------
...
--------------- native_app:test_iface [PASSED] Took 0.39 seconds ---------------
...
--------- native_app:test_response_headers [PASSED] Took 0.40 seconds ----------
...
----------- native_app:test_web_terminal [PASSED] Took 0.39 seconds ------------
...
-------------- native_app:test_chunked [PASSED] Took 0.39 seconds --------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:06.953
native               test_session           PASSED    00:00:00.386
native               test_presentation      PASSED    00:00:00.413
native               test_transport         PASSED    00:00:00.386
native               test_websocket         PASSED    00:00:00.412
native               test_http_parser       PASSED    00:00:00.461
native_ssh           test_ssh_crypto        PASSED    00:00:02.837
native_ssh           test_ssh_auth          PASSED    00:00:00.405
native_ssh           test_ssh_server        PASSED    00:00:00.504
native_ssh           test_ssh_transport     PASSED    00:00:00.687
native_ssh           test_ssh_channel       PASSED    00:00:00.389
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.619
native_ssh_conn      test_ssh_conn          PASSED    00:00:00.822
native_app           test_regex             PASSED    00:00:00.785
native_app           test_template          PASSED    00:00:00.468
native_app           test_path_params       PASSED    00:00:00.479
native_app           test_digest_vectors    PASSED    00:00:00.376
native_app           test_form_params       PASSED    00:00:00.386
native_app           test_iface             PASSED    00:00:00.388
native_app           test_json              PASSED    00:00:00.385
native_app           test_response_headers  PASSED    00:00:00.399
native_app           test_middleware        PASSED    00:00:00.401
native_app           test_digest_auth       PASSED    00:00:00.399
native_app           test_web_terminal      PASSED    00:00:00.394
native_app           test_multipart         PASSED    00:00:00.406
native_app           test_auth              PASSED    00:00:00.394
native_app           test_file_serving      PASSED    00:00:00.400
native_app           test_dispatch          PASSED    00:00:00.388
native_app           test_chunked           PASSED    00:00:00.393
native_app           test_application       PASSED    00:00:00.465
native_compliance    test_compliance        PASSED    00:00:00.493
================ 594 test cases: 594 succeeded in 00:00:23.074 ================
```
