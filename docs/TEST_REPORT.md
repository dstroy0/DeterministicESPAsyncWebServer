...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:06.176 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.538 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.575 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.552 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.583 |
| `test_http_parser`       | `native`                |    82 |   ✅   | 00:00:00.538 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.670 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.603 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.607 |
| `test_ssh_crypto`        | `native_ssh`            |    38 |   ✅   | 00:00:04.163 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.524 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.681 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.939 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.483 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.816 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.186 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.054 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.563 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.555 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.501 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.548 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.548 |
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.502 |
...
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.551 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.532 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.559 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.559 |
...
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.632 |
| `test_webdav_handler`    | `native_webdav_handler` |     5 |   ✅   | 00:00:01.091 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.078 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.638 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.463 |
| `test_snmp_v3`           | `native_snmp_v3`        |     9 |   ✅   | 00:00:01.443 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.729 |
| `test_coap`              | `native_coap`           |    27 |   ✅   | 00:00:00.623 |
| `test_coap`              | `native_coap_observe`   |    27 |   ✅   | 00:00:00.637 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.602 |
| `test_modbus`            | `native_modbus`         |    13 |   ✅   | 00:00:00.610 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.622 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.591 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.611 |
...
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.620 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.798 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.586 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.594 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.590 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.608 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.613 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.640 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.001 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.011 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.592 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.645 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.023 |
| `test_http_client`       | `native_http_client`    |    10 |   ✅   | 00:00:00.606 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.586 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.595 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.638 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.621 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.607 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.596 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.641 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:00.920 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.594 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.589 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.608 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.593 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.627 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.624 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.591 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.587 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.581 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.605 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.591 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.584 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     4 |   ✅   | 00:00:00.590 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.594 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.571 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.606 |
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.176
native         test_session       PASSED    00:00:00.538
native         test_presentation  PASSED    00:00:00.575
native         test_transport     PASSED    00:00:00.552
native         test_websocket     PASSED    00:00:00.583
native         test_http_parser   PASSED    00:00:00.538
================ 310 test cases: 310 succeeded in 00:00:08.961 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.670
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.607
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.163
native_ssh     test_ssh_auth       PASSED    00:00:00.524
native_ssh     test_ssh_server     PASSED    00:00:00.681
native_ssh     test_ssh_transport  PASSED    00:00:00.939
native_ssh     test_ssh_channel    PASSED    00:00:00.483
================= 92 test cases: 92 succeeded in 00:00:06.789 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.816
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.186
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.054
native_app     test_template          PASSED    00:00:00.563
native_app     test_path_params       PASSED    00:00:00.555
native_app     test_digest_vectors    PASSED    00:00:00.501
native_app     test_form_params       PASSED    00:00:00.548
native_app     test_iface             PASSED    00:00:00.548
native_app     test_json              PASSED    00:00:00.502
...
native_app     test_web_terminal      PASSED    00:00:00.551
native_app     test_defer             PASSED    00:00:00.532
...
native_app     test_application       PASSED    00:00:00.632
================ 217 test cases: 217 succeeded in 00:00:10.462 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_webdav_handler/test_webdav_handler.cpp:191: test_copy_collection_recursive [PASSED]
test/test_webdav_handler/test_webdav_handler.cpp:192: test_copy_collection_depth0_shallow [PASSED]
test/test_webdav_handler/test_webdav_handler.cpp:193: test_copy_overwrite_semantics [PASSED]
test/test_webdav_handler/test_webdav_handler.cpp:194: test_move_collection_recursive [PASSED]
test/test_webdav_handler/test_webdav_handler.cpp:195: test_delete_collection_recursive [PASSED]
----- native_webdav_handler:test_webdav_handler [PASSED] Took 1.09 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.091
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.078
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.638
native_snmp    test_snmp_agent  PASSED    00:00:00.463
================= 29 test cases: 29 succeeded in 00:00:01.102 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
--------------- native_coap:test_coap [PASSED] Took 0.62 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.623
================= 27 test cases: 27 succeeded in 00:00:00.623 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
test/test_coap/test_coap.cpp:808: test_unknown_method_not_allowed       [PASSED]
test/test_coap/test_coap.cpp:809: test_unknown_critical_option_bad_option [PASSED]
----------- native_coap_observe:test_coap [PASSED] Took 0.64 seconds -----------

=================================== SUMMARY ===================================
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.637
================= 27 test cases: 27 succeeded in 00:00:00.637 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.610
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.622
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.611
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.620
================= 12 test cases: 12 succeeded in 00:00:00.620 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.798
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.590
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.608
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.613
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.001
================= 10 test cases: 10 succeeded in 00:00:01.001 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.011
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.592
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.023
================== 3 test cases: 3 succeeded in 00:00:01.023 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.606
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.586
================= 15 test cases: 15 succeeded in 00:00:00.586 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.595
================= 19 test cases: 19 succeeded in 00:00:00.595 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
================= 10 test cases: 10 succeeded in 00:00:00.638 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.621
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.607
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.641
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.594
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.589
================= 14 test cases: 14 succeeded in 00:00:00.589 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.627
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.624
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.591
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.581
...
================= 14 test cases: 14 succeeded in 00:00:00.605 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
================= 15 test cases: 15 succeeded in 00:00:00.591 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.584
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.590
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.606
