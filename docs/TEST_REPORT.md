...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    11 |   ✅   | 00:00:06.620 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.729 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.727 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.746 |
| `test_mbus`              | `native_mbus`           |     8 |   ✅   | 00:00:00.692 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.712 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.699 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.691 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.714 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.729 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.179 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.604 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.636 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.633 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.658 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.620 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.791 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:01.166 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.710 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.742 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:04.141 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.594 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.700 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.919 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.595 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.107 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.627 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.371 |
...
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.603 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.607 |
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.569 |
...
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.638 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.623 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.626 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.616 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.615 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.683 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.410 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.417 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.771 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.506 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.593 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.858 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.790 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.787 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.710 |
...
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.692 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.692 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.658 |
| `test_protobuf`          | `native_protobuf`       |    10 |   ✅   | 00:00:00.700 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.717 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.699 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.700 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.685 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.667 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.702 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.702 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.709 |
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.793 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.699 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.721 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.714 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.699 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.707 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.709 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.719 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.698 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.710 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.714 |
| `test_sparkplug`         | `native_sparkplug`      |     6 |   ✅   | 00:00:00.725 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.719 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.683 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.734 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.757 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.717 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.723 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.721 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.967 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.732 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.696 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.691 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.717 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.721 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.754 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.324 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.289 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.724 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.781 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.301 |
| `test_http_client`       | `native_http_client`    |    11 |   ✅   | 00:00:00.703 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.693 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.716 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.767 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.728 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.702 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.692 |
...
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.723 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.678 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.734 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.707 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.696 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.669 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.692 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.658 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.695 |
...
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.728 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.849 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.664 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.824 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.132 |
...
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.620
================= 11 test cases: 11 succeeded in 00:00:06.620 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.727
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.712
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.691
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.714
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.729
...
------------------ native:test_sse [PASSED] Took 1.18 seconds ------------------
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.179
native         test_session       PASSED    00:00:00.604
native         test_presentation  PASSED    00:00:00.636
native         test_transport     PASSED    00:00:00.633
native         test_websocket     PASSED    00:00:00.658
native         test_http_parser   PASSED    00:00:00.620
================ 318 test cases: 318 succeeded in 00:00:04.331 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.166
================= 10 test cases: 10 succeeded in 00:00:01.166 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.742
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 4.14 seconds -------------
...
------ native_ssh_hardened:test_ssh_hardening [PASSED] Took 1.11 seconds -------

=================================== SUMMARY ===================================
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:01.107
================== 2 test cases: 2 succeeded in 00:00:01.107 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 1.63 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.627
================== 2 test cases: 2 succeeded in 00:00:01.627 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.371
...
native_app     test_form_params       PASSED    00:00:00.603
...
native_app     test_multipart         PASSED    00:00:00.638
...
native_app     test_chunked           PASSED    00:00:00.615
native_app     test_application       PASSED    00:00:00.683
================ 219 test cases: 219 succeeded in 00:00:11.781 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
----- native_webdav_handler:test_webdav_handler [PASSED] Took 1.41 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.410
================= 12 test cases: 12 succeeded in 00:00:01.410 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.417
================== 2 test cases: 2 succeeded in 00:00:01.417 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.771
native_snmp    test_snmp_agent  PASSED    00:00:00.506
================= 30 test cases: 30 succeeded in 00:00:01.277 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
================== 8 test cases: 8 succeeded in 00:00:00.858 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
================= 29 test cases: 29 succeeded in 00:00:00.790 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
================= 29 test cases: 29 succeeded in 00:00:00.787 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.710
================= 19 test cases: 19 succeeded in 00:00:00.710 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.692
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.717
================= 12 test cases: 12 succeeded in 00:00:00.717 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.700
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.702
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.709
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.793
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.714
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.709
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.719
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.698
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.714
================== 8 test cases: 8 succeeded in 00:00:00.714 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.719
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.683
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.734
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.723
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.967
================= 13 test cases: 13 succeeded in 00:00:00.967 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.732
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.696
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.691
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.717
...
================= 29 test cases: 29 succeeded in 00:00:00.721 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.754
...
---------- native_keepalive:test_keepalive [PASSED] Took 1.32 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.324
================= 10 test cases: 10 succeeded in 00:00:01.324 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.289
================= 13 test cases: 13 succeeded in 00:00:01.289 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
================= 12 test cases: 12 succeeded in 00:00:00.781 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.767
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.702
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.692
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.723
================== 4 test cases: 4 succeeded in 00:00:00.723 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.734
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.707
================== 8 test cases: 8 succeeded in 00:00:00.707 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.669
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.658
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.728
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.132
================== 2 test cases: 2 succeeded in 00:00:01.132 ==================
```
