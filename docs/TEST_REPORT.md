...
**Generated:** 2026-06-29 18:02:27
**Command:** `pio test` over 77 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1385 passed - 128s
...
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.950 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.553 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.668 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.873 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.531 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.890 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.256 |
...
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.618 |
...
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.679 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.250 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.195 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.702 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.504 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.489 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.814 |
...
| `test_protobuf`          | `native_protobuf`       |     8 |   ✅   | 00:00:00.663 |
| `test_wamp`              | `native_wamp`           |    11 |   ✅   | 00:00:00.673 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.655 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.666 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.655 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.667 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |     7 |   ✅   | 00:00:00.664 |
...
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.714 |
...
------------------ native:test_sse [PASSED] Took 6.49 seconds ------------------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.950
native_ssh     test_ssh_auth       PASSED    00:00:00.553
native_ssh     test_ssh_server     PASSED    00:00:00.668
native_ssh     test_ssh_transport  PASSED    00:00:00.873
native_ssh     test_ssh_channel    PASSED    00:00:00.531
================= 93 test cases: 93 succeeded in 00:00:06.576 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 102 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.256
...
native_app     test_auth              PASSED    00:00:00.618
...
================ 219 test cases: 219 succeeded in 00:00:11.458 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 102 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.195
================== 2 test cases: 2 succeeded in 00:00:01.195 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 102 tests
...
================= 29 test cases: 29 succeeded in 00:00:01.206 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 102 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.489
================= 10 test cases: 10 succeeded in 00:00:01.489 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 102 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.732
...
---------- native_dashboard:test_dashboard [PASSED] Took 0.73 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.733
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.716
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.766
================== 3 test cases: 3 succeeded in 00:00:00.766 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 102 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.763
================== 2 test cases: 2 succeeded in 00:00:00.763 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 102 tests
