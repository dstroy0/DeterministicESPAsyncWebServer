...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:06.850 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.545 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.574 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.557 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.580 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.535 |
| `test_ssh_crypto`       | `native_ssh`          |    38 |   ✅   | 00:00:03.724 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.557 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.682 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.939 |
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.560 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.857 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.203 |
...
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.567 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.564 |
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:06.850
...
native               test_websocket         PASSED    00:00:00.580
native               test_http_parser       PASSED    00:00:00.535
native_ssh           test_ssh_crypto        PASSED    00:00:03.724
native_ssh           test_ssh_auth          PASSED    00:00:00.557
native_ssh           test_ssh_server        PASSED    00:00:00.682
native_ssh           test_ssh_transport     PASSED    00:00:00.939
native_ssh           test_ssh_channel       PASSED    00:00:00.560
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.857
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.203
...
native_workers       test_workers           PASSED    00:00:00.714
native_tsan          test_concurrency       PASSED    00:00:01.313
================ 621 test cases: 621 succeeded in 00:00:31.597 ================
```
