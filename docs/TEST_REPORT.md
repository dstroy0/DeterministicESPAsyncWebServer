...
**Generated:** 2026-06-29 06:42:50
**Command:** `pio test` over 67 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1309 passed - 111s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:07.085 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.612 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.650 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.634 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.669 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.610 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.757 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.688 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.695 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.932 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.560 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.674 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.886 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.533 |
...
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.548 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.584 |
...
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.155 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.684 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.485 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.456 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.779 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.814 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.736 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.663 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.650 |
...
| `test_http_client`       | `native_http_client`    |    10 |   ✅   | 00:00:00.649 |
...
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.680 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.018 |
...
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.652 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.643 |
...
------------------ native:test_sse [PASSED] Took 7.08 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:07.085
...
================ 318 test cases: 318 succeeded in 00:00:10.260 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 92 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.932
native_ssh     test_ssh_auth       PASSED    00:00:00.560
native_ssh     test_ssh_server     PASSED    00:00:00.674
native_ssh     test_ssh_transport  PASSED    00:00:00.886
native_ssh     test_ssh_channel    PASSED    00:00:00.533
================= 93 test cases: 93 succeeded in 00:00:06.585 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 92 tests
...
native_app     test_json              PASSED    00:00:00.548
native_app     test_response_headers  PASSED    00:00:00.584
...
================ 219 test cases: 219 succeeded in 00:00:11.180 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 92 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.155
================== 2 test cases: 2 succeeded in 00:00:01.155 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 92 tests
...
native_snmp    test_snmp_agent  PASSED    00:00:00.485
================= 29 test cases: 29 succeeded in 00:00:01.168 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 92 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.814
================= 29 test cases: 29 succeeded in 00:00:00.814 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 92 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.650
================= 18 test cases: 18 succeeded in 00:00:00.650 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 92 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.847
================= 13 test cases: 13 succeeded in 00:00:00.847 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 92 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.671
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.695
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.680
...
================= 71 test cases: 71 succeeded in 00:00:01.018 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 92 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.643
