...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:05.964 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.683 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.696 |
...
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.677 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.699 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.693 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.699 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.693 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.040 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.618 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.653 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.631 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.657 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.625 |
...
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.900 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.594 |
| `test_ssh_server`        | `native_ssh`            |    12 |   ✅   | 00:00:00.903 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.967 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.589 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.907 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.296 |
...
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.204 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.752 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.542 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.555 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.827 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.839 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.777 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.711 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.697 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.754 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.701 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.694 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.684 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.690 |
| `test_protobuf`          | `native_protobuf`       |    10 |   ✅   | 00:00:00.696 |
| `test_preempt_queue`     | `native_preempt_queue`  |     7 |   ✅   | 00:00:00.715 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.732 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.711 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.716 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.705 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.719 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.700 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.708 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.708 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.765 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.694 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.683 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.697 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.699 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.688 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.695 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.693 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.689 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.680 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.687 |
...
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.686 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.676 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.778 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.948 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.716 |
| `test_graphql`           | `native_graphql`        |    25 |   ✅   | 00:00:00.703 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.684 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.715 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.724 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.707 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.065 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.094 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.707 |
| `test_jwt`               | `native_jwt`            |    16 |   ✅   | 00:00:00.776 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.178 |
| `test_http_client`       | `native_http_client`    |    11 |   ✅   | 00:00:00.730 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.729 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.735 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.742 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.788 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.775 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.737 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.785 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.100 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.696 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.694 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.760 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.760 |
...
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.664 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.691 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.710 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.716 |
...
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:05.964
================= 17 test cases: 17 succeeded in 00:00:05.964 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.696
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.677
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.699
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.693
================== 5 test cases: 5 succeeded in 00:00:00.693 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.040
...
native         test_http_parser   PASSED    00:00:00.625
================ 318 test cases: 318 succeeded in 00:00:04.224 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.900
...
================ 106 test cases: 106 succeeded in 00:00:06.953 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.296
================== 2 test cases: 2 succeeded in 00:00:01.296 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
native_app     test_file_serving      PASSED    00:00:00.650
...
================ 225 test cases: 225 succeeded in 00:00:12.055 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.204
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.752
native_snmp    test_snmp_agent  PASSED    00:00:00.542
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.555
================= 10 test cases: 10 succeeded in 00:00:01.555 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.839
================= 29 test cases: 29 succeeded in 00:00:00.839 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
================= 29 test cases: 29 succeeded in 00:00:00.777 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.711
================= 19 test cases: 19 succeeded in 00:00:00.711 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.701
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.694
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.684
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.711
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.716
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.719
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.700
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.708
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.694
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.697
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.687
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.686
================== 2 test cases: 2 succeeded in 00:00:00.686 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.778
================= 16 test cases: 16 succeeded in 00:00:00.778 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.948
================= 13 test cases: 13 succeeded in 00:00:00.948 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.716
...
================= 25 test cases: 25 succeeded in 00:00:00.703 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
================= 29 test cases: 29 succeeded in 00:00:00.724 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.707
...
================= 16 test cases: 16 succeeded in 00:00:00.776 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.730
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.735
...
---------- native_snmp_trap:test_snmp_trap [PASSED] Took 0.77 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.775
...
------------ native_inflate:test_inflate [PASSED] Took 0.74 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.737
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.785
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.100
================= 71 test cases: 71 succeeded in 00:00:01.100 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.760
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.760
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.710
================= 18 test cases: 18 succeeded in 00:00:00.710 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
