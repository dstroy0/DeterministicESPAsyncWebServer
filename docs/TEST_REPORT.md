...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:12.395 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.550 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.584 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.570 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.596 |
| `test_http_parser`       | `native`                |    82 |   ✅   | 00:00:00.551 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.691 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.625 |
...
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.859 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.508 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.841 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.226 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.131 |
...
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.574 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.578 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.595 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.584 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.555 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.586 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.580 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.592 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.577 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.583 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.659 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.163 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.123 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.662 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.479 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.448 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.751 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.795 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.694 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.649 |
| `test_modbus`            | `native_modbus`         |    13 |   ✅   | 00:00:00.620 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.642 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.610 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.648 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.629 |
...
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.810 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.625 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.633 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.622 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.649 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.636 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.671 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.023 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.053 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.641 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.666 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.073 |
| `test_http_client`       | `native_http_client`    |    10 |   ✅   | 00:00:00.636 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.630 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.627 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.671 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.668 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.647 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.624 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.667 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:00.998 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.615 |
...
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.648 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.614 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.630 |
...
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.617 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.624 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     4 |   ✅   | 00:00:00.616 |
...
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.732 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.611 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.767 |
...
----------------- native:test_sse [PASSED] Took 12.39 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:12.395
native         test_session       PASSED    00:00:00.550
native         test_presentation  PASSED    00:00:00.584
native         test_transport     PASSED    00:00:00.570
native         test_websocket     PASSED    00:00:00.596
native         test_http_parser   PASSED    00:00:00.551
================ 310 test cases: 310 succeeded in 00:00:15.246 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.625
...
native_ssh     test_ssh_transport  PASSED    00:00:00.859
native_ssh     test_ssh_channel    PASSED    00:00:00.508
================= 93 test cases: 93 succeeded in 00:00:06.414 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.131
...
native_app     test_file_serving      PASSED    00:00:00.592
...
================ 219 test cases: 219 succeeded in 00:00:10.942 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.163
================= 12 test cases: 12 succeeded in 00:00:01.163 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.123
...
================= 29 test cases: 29 succeeded in 00:00:01.142 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.751
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.795
================= 29 test cases: 29 succeeded in 00:00:00.795 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.694
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.649
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.620
================= 13 test cases: 13 succeeded in 00:00:00.620 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.610
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.629
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.810
================= 13 test cases: 13 succeeded in 00:00:00.810 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.625
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.622
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.649
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.636
================= 29 test cases: 29 succeeded in 00:00:00.636 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.671
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.023
================= 10 test cases: 10 succeeded in 00:00:01.023 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.053
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.641
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.666
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.671
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.624
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.667
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.615
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.648
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.614
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.617
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.616
================== 4 test cases: 4 succeeded in 00:00:00.616 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.732
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.767
================== 2 test cases: 2 succeeded in 00:00:00.767 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
