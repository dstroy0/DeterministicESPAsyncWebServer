...
**Generated:** 2026-07-05 23:04:36
**Command:** `pio test` over 147 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 2167 passed - 299s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:06.275 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.681 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.692 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.707 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:04.477 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.683 |
...
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.677 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.716 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.703 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.705 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.694 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.697 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.054 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.603 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.632 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.623 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.661 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.627 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.778 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:01.066 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.712 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.695 |
| `test_ssh_crypto`        | `native_ssh`            |    45 |   ✅   | 00:00:04.068 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.677 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.853 |
| `test_ssh_transport`     | `native_ssh`            |    33 |   ✅   | 00:00:01.173 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.616 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.035 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.482 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.222 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.616 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.614 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.562 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.611 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.641 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.591 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.643 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.652 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.657 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.658 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.605 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.636 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.625 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.663 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.620 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.644 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.692 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.285 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.239 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.729 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.560 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:02.017 |
...
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.700 |
...
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.680 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.684 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.689 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.700 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.779 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.899 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.814 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.777 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.732 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.772 |
...
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.686 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.715 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.671 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.676 |
...
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.672 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.686 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.731 |
...
| `test_sht3x`             | `native_sht3x`          |     5 |   ✅   | 00:00:00.681 |
| `test_pca9685`           | `native_pca9685`        |     4 |   ✅   | 00:00:00.697 |
| `test_ads1115`           | `native_ads1115`        |     3 |   ✅   | 00:00:00.687 |
| `test_ina219`            | `native_ina219`         |     4 |   ✅   | 00:00:00.688 |
| `test_hpack`             | `native_hpack`          |     7 |   ✅   | 00:00:00.787 |
| `test_h2_frame`          | `native_h2frame`        |     6 |   ✅   | 00:00:00.700 |
| `test_h2_conn`           | `native_h2conn`         |     4 |   ✅   | 00:00:00.914 |
| `test_quic_varint`       | `native_quic_varint`    |     3 |   ✅   | 00:00:00.693 |
| `test_h3_frame`          | `native_h3frame`        |     7 |   ✅   | 00:00:00.709 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.770 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.225 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.693 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.737 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.690 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.727 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.724 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.712 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.702 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.713 |
| `test_ssh_zlib`          | `native_ssh_zlib`       |     9 |   ✅   | 00:00:00.749 |
| `test_ssh_comp`          | `native_ssh_comp`       |     5 |   ✅   | 00:00:01.083 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.108 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.679 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.685 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.684 |
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.720 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.738 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.697 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.675 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.682 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.693 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.691 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.700 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.693 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.667 |
| `test_statsd`            | `native_statsd`         |     9 |   ✅   | 00:00:00.724 |
...
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.174 |
| `test_qpack`             | `native_qpack`          |     9 |   ✅   | 00:00:00.817 |
| `test_quic_packet`       | `native_quic_packet`    |     8 |   ✅   | 00:00:00.709 |
| `test_quic_frame`        | `native_quic_frame`     |     8 |   ✅   | 00:00:00.719 |
| `test_quic_crypto`       | `native_quic_crypto`    |     7 |   ✅   | 00:00:00.802 |
| `test_tls13_kdf`         | `native_tls13_kdf`      |     5 |   ✅   | 00:00:00.732 |
| `test_quic_tp`           | `native_quic_tp`        |     7 |   ✅   | 00:00:00.725 |
| `test_tls13_msg`         | `native_tls13_msg`      |     7 |   ✅   | 00:00:00.811 |
| `test_quic_tls`          | `native_quic_tls`       |     4 |   ✅   | 00:00:00.996 |
| `test_ssh_chachapoly`    | `native_ssh_chachapoly` |     4 |   ✅   | 00:00:00.767 |
...
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.275
================= 17 test cases: 17 succeeded in 00:00:06.275 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_det_arena  test_det_arena  PASSED    00:00:00.707
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:04.477
================= 16 test cases: 16 succeeded in 00:00:04.477 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.683
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.677
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.703
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.054
native         test_session       PASSED    00:00:00.603
native         test_presentation  PASSED    00:00:00.632
native         test_transport     PASSED    00:00:00.623
native         test_websocket     PASSED    00:00:00.661
native         test_http_parser   PASSED    00:00:00.627
================ 323 test cases: 323 succeeded in 00:00:04.200 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.778
================= 17 test cases: 17 succeeded in 00:00:00.778 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.695
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.068
native_ssh     test_ssh_auth       PASSED    00:00:00.677
native_ssh     test_ssh_server     PASSED    00:00:00.853
native_ssh     test_ssh_transport  PASSED    00:00:01.173
native_ssh     test_ssh_channel    PASSED    00:00:00.616
================ 145 test cases: 145 succeeded in 00:00:07.387 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:01.035
================== 2 test cases: 2 succeeded in 00:00:01.035 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.482
================== 2 test cases: 2 succeeded in 00:00:01.482 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.222
native_app     test_template          PASSED    00:00:00.616
native_app     test_path_params       PASSED    00:00:00.614
native_app     test_digest_vectors    PASSED    00:00:00.562
native_app     test_form_params       PASSED    00:00:00.611
native_app     test_iface             PASSED    00:00:00.641
native_app     test_json              PASSED    00:00:00.591
native_app     test_response_headers  PASSED    00:00:00.643
native_app     test_middleware        PASSED    00:00:00.652
native_app     test_digest_auth       PASSED    00:00:00.657
native_app     test_web_terminal      PASSED    00:00:00.658
...
native_app     test_file_serving      PASSED    00:00:00.663
native_app     test_dispatch          PASSED    00:00:00.620
native_app     test_chunked           PASSED    00:00:00.644
native_app     test_application       PASSED    00:00:00.692
================ 225 test cases: 225 succeeded in 00:00:11.954 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.285
================= 12 test cases: 12 succeeded in 00:00:01.285 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
native_snmp    test_snmp_agent  PASSED    00:00:00.560
================= 35 test cases: 35 succeeded in 00:00:01.289 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 2.02 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:02.017
================= 15 test cases: 15 succeeded in 00:00:02.017 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.680
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.684
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.689
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.700
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.814
...
------------ native_enocean:test_enocean [PASSED] Took 0.77 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.772
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.686
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.676
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.672
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.731
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.663
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.678
================= 16 test cases: 16 succeeded in 00:00:00.678 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.673
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.724
================= 38 test cases: 38 succeeded in 00:00:00.724 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.174
================= 13 test cases: 13 succeeded in 00:00:01.174 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_smtp    test_smtp  PASSED    00:00:00.804
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_ntp_server  test_ntp_server  PASSED    00:00:00.683
================== 8 test cases: 8 succeeded in 00:00:00.683 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sht3x   test_sht3x  PASSED    00:00:00.681
================== 5 test cases: 5 succeeded in 00:00:00.681 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_pca9685  test_pca9685  PASSED    00:00:00.697
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_ads1115  test_ads1115  PASSED    00:00:00.687
================== 3 test cases: 3 succeeded in 00:00:00.687 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_hpack   test_hpack  PASSED    00:00:00.787
...
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h2frame  test_h2_frame  PASSED    00:00:00.700
...
Environment    Test          Status    Duration
-------------  ------------  --------  ------------
native_h2conn  test_h2_conn  PASSED    00:00:00.914
================== 4 test cases: 4 succeeded in 00:00:00.914 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_varint  test_quic_varint  PASSED    00:00:00.693
...
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h3frame  test_h3_frame  PASSED    00:00:00.709
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.770
================= 21 test cases: 21 succeeded in 00:00:00.770 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
------------- native_upload:test_upload [PASSED] Took 1.22 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.225
================== 3 test cases: 3 succeeded in 00:00:01.225 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.737
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.690
================= 22 test cases: 22 succeeded in 00:00:00.690 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.702
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.713
...
----------- native_ssh_comp:test_ssh_comp [PASSED] Took 1.08 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_comp  test_ssh_comp  PASSED    00:00:01.083
================== 5 test cases: 5 succeeded in 00:00:01.083 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.108
================= 71 test cases: 71 succeeded in 00:00:01.108 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.685
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.738
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.675
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.693
================== 5 test cases: 5 succeeded in 00:00:00.693 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.691
================= 18 test cases: 18 succeeded in 00:00:00.691 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.700
================= 17 test cases: 17 succeeded in 00:00:00.700 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_statsd  test_statsd  PASSED    00:00:00.724
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.174
================== 2 test cases: 2 succeeded in 00:00:01.174 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_qpack   test_qpack  PASSED    00:00:00.817
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_packet  test_quic_packet  PASSED    00:00:00.709
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_quic_frame  test_quic_frame  PASSED    00:00:00.719
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_crypto  test_quic_crypto  PASSED    00:00:00.802
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_tls13_kdf  test_tls13_kdf  PASSED    00:00:00.732
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_quic_tp  test_quic_tp  PASSED    00:00:00.725
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_tls13_msg  test_tls13_msg  PASSED    00:00:00.811
================== 7 test cases: 7 succeeded in 00:00:00.811 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
================== 4 test cases: 4 succeeded in 00:00:00.996 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 172 tests
...
----- native_ssh_chachapoly:test_ssh_chachapoly [PASSED] Took 0.77 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_ssh_chachapoly  test_ssh_chachapoly  PASSED    00:00:00.767
