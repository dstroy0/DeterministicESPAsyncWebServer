...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:15.237 |
...
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.916 |
...
| `test_ssh_channel`       | `native_ssh`           |    12 |   ✅   | 00:00:00.550 |
...
| `test_multipart`         | `native_app`           |    19 |   ✅   | 00:00:00.609 |
...
| `test_diag`              | `native_diag`          |     2 |   ✅   | 00:00:01.135 |
| `test_snmp_ber`          | `native_snmp`          |    15 |   ✅   | 00:00:00.692 |
| `test_snmp_agent`        | `native_snmp`          |    14 |   ✅   | 00:00:00.507 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.382 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.790 |
| `test_coap`              | `native_coap`          |    27 |   ✅   | 00:00:00.676 |
| `test_coap`              | `native_coap_observe`  |    27 |   ✅   | 00:00:00.703 |
| `test_webdav`            | `native_webdav`        |    19 |   ✅   | 00:00:00.659 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.663 |
...
| `test_opcua_client`      | `native_opcua_client`  |    11 |   ✅   | 00:00:00.697 |
...
| `test_jwt`               | `native_jwt`           |    12 |   ✅   | 00:00:00.681 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.120 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.655 |
...
| `test_auth_lockout`      | `native_auth_lockout`  |    10 |   ✅   | 00:00:00.638 |
...
| `test_partition_monitor` | `native_partition`     |     5 |   ✅   | 00:00:00.633 |
...
| `test_guardrails`        | `native_guardrails`    |     6 |   ✅   | 00:00:00.640 |
| `test_logbuf`            | `native_logbuf`        |     4 |   ✅   | 00:00:00.653 |
| `test_config_io`         | `native_config_io`     |     4 |   ✅   | 00:00:00.663 |
...
----------------- native:test_sse [PASSED] Took 15.24 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:15.237
...
================ 310 test cases: 310 succeeded in 00:00:18.214 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
================= 92 test cases: 92 succeeded in 00:00:06.585 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
native_app     test_multipart         PASSED    00:00:00.609
...
================ 217 test cases: 217 succeeded in 00:00:11.422 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.135
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.382
================== 9 test cases: 9 succeeded in 00:00:01.382 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.676
...
================= 27 test cases: 27 succeeded in 00:00:00.703 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.681
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.638
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.633
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.640
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.663
