...
| :----------------------- | :---------------------- | ----: | :----: | ------------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   |  00:00:06.187 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   |  00:00:00.639 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   |  00:00:00.653 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   |  00:00:04.404 |
...
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   |  00:00:01.011 |
...
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   |  00:00:00.638 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   |  00:00:00.832 |
| `test_ssh_transport`     | `native_ssh`            |    31 |   ✅   |  00:00:01.126 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   |  00:00:00.584 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   |  00:00:00.949 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   |  00:00:01.345 |
...
| `test_defer`             | `native_app`            |     3 |   ✅   |  00:00:00.583 |
...
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   |  00:00:01.225 |
| `test_diag`              | `native_diag`           |     2 |   ✅   |  00:00:01.177 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   |  00:00:00.687 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   |  00:00:00.511 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   |  00:00:02.466 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   |  00:00:00.822 |
| `test_coap`              | `native_coap`           |    41 |   ✅   |  00:00:00.949 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   |  00:00:00.756 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   |  00:00:00.674 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   |  00:00:00.668 |
...
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   |  00:00:00.660 |
...
| `test_forward`           | `native_forward`        |    16 |   ✅   |  00:00:00.838 |
...
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   |  00:00:00.643 |
...
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   |  00:00:00.643 |
...
| `test_melsec`            | `native_melsec`         |     6 |   ✅   |  00:00:00.652 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   |  00:00:00.656 |
| `test_enip`              | `native_enip`           |     6 |   ✅   |  00:00:00.651 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   |  00:00:00.656 |
...
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   |  00:00:00.674 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   |  00:00:00.893 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   |  00:00:00.658 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   |  00:00:00.665 |
...
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   |  00:00:01.125 |
| `test_range`             | `native_range`          |    13 |   ✅   |  00:00:01.100 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   |  00:00:00.665 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   |  00:00:00.706 |
...
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   |  00:00:00.665 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   |  00:00:00.681 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   |  00:00:00.691 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   |  00:00:00.681 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   |  00:00:00.663 |
...
| `test_config_store`      | `native_config_store`   |    14 |   ✅   |  00:00:00.666 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   |  00:00:00.705 |
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   |  00:00:00.680 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   |  00:00:00.692 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   |  00:00:00.672 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   |  00:00:00.683 |
...
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   |  00:00:00.655 |
...
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   |  00:00:00.793 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   |  00:00:01.183 |
...
------------ native_canopen:test_canopen [PASSED] Took 6.19 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.187
================= 17 test cases: 17 succeeded in 00:00:06.187 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.639
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:04.404
================= 16 test cases: 16 succeeded in 00:00:04.404 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.658
...
Environment    Test               Status    Duration
-------------  -----------------  --------  -------------
native         test_sse           PASSED    00:00:00.1000
...
================ 323 test cases: 323 succeeded in 00:00:04.038 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.011
================= 13 test cases: 13 succeeded in 00:00:01.011 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
native_ssh     test_ssh_auth       PASSED    00:00:00.638
native_ssh     test_ssh_server     PASSED    00:00:00.832
native_ssh     test_ssh_transport  PASSED    00:00:01.126
native_ssh     test_ssh_channel    PASSED    00:00:00.584
================ 137 test cases: 137 succeeded in 00:00:07.143 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.949
================== 2 test cases: 2 succeeded in 00:00:00.949 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.345
...
native_app     test_defer             PASSED    00:00:00.583
...
================ 225 test cases: 225 succeeded in 00:00:11.498 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.225
================= 12 test cases: 12 succeeded in 00:00:01.225 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:02.466
================= 15 test cases: 15 succeeded in 00:00:02.466 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.822
================= 15 test cases: 15 succeeded in 00:00:00.822 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.949
...
================= 41 test cases: 41 succeeded in 00:00:00.756 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.660
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.838
================= 16 test cases: 16 succeeded in 00:00:00.838 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.643
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.643
================== 7 test cases: 7 succeeded in 00:00:00.643 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.652
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.656
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.674
================= 16 test cases: 16 succeeded in 00:00:00.674 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
================= 17 test cases: 17 succeeded in 00:00:00.893 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
================= 32 test cases: 32 succeeded in 00:00:00.665 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.125
...
================= 21 test cases: 21 succeeded in 00:00:00.706 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.663
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.666
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.672
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.655
================== 6 test cases: 6 succeeded in 00:00:00.655 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.793
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.183
