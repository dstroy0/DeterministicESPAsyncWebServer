...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:13.448 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.666 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.647 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.681 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.654 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.666 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.660 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.678 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.687 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.686 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.684 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.658 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.678 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.660 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.062 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.602 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.635 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.627 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.669 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.627 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.782 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:00.990 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.693 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.666 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.882 |
| `test_ssh_auth`          | `native_ssh`            |    18 |   ✅   | 00:00:00.595 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.841 |
| `test_ssh_transport`     | `native_ssh`            |    27 |   ✅   | 00:00:01.053 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.563 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.889 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.297 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.195 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.617 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.620 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.556 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.621 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.633 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.573 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.619 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.618 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.626 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.616 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.598 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.614 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.621 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.625 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.618 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.618 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.695 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.232 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.199 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.711 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.535 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:01.965 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.824 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.953 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.765 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.664 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.673 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.742 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.649 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.656 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.681 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.657 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.657 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.717 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.750 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.846 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.756 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.657 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.657 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.651 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.662 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.651 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.643 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.657 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.645 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.680 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.653 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.673 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.652 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.660 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.661 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.663 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.651 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.724 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.663 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.657 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.654 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.663 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.699 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.660 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.666 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.666 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.675 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.663 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.677 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.677 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.659 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.663 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.664 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.653 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.660 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.679 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.926 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.652 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.666 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.686 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.678 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.710 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.709 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.132 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.125 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.685 |
| `test_jwt`               | `native_jwt`            |    16 |   ✅   | 00:00:00.717 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.141 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.676 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.647 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.663 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.690 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.708 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.694 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.672 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.709 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.092 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.676 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.682 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.670 |
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.677 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.688 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.685 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.672 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.676 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.666 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.663 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.670 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.662 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.670 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.648 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.658 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.680 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.787 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.631 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.842 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.317 |
...
----------- native_canopen:test_canopen [PASSED] Took 13.45 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:13.448
================= 17 test cases: 17 succeeded in 00:00:13.448 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.666
================== 5 test cases: 5 succeeded in 00:00:00.666 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.647
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.681
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.654
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.666
================== 9 test cases: 9 succeeded in 00:00:00.666 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.660
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.678
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.687
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.686
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.684
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.658
...
---------------- native:test_session [PASSED] Took 0.60 seconds ----------------
...
-------------- native:test_http_parser [PASSED] Took 0.63 seconds --------------

=================================== SUMMARY ===================================
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.062
native         test_session       PASSED    00:00:00.602
native         test_presentation  PASSED    00:00:00.635
native         test_transport     PASSED    00:00:00.627
native         test_websocket     PASSED    00:00:00.669
native         test_http_parser   PASSED    00:00:00.627
================ 323 test cases: 323 succeeded in 00:00:04.221 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
------ native_observability:test_observability [PASSED] Took 0.78 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.782
================= 17 test cases: 17 succeeded in 00:00:00.782 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.990
================= 13 test cases: 13 succeeded in 00:00:00.990 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.666
================== 5 test cases: 5 succeeded in 00:00:00.666 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 3.88 seconds -------------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.882
native_ssh     test_ssh_auth       PASSED    00:00:00.595
native_ssh     test_ssh_server     PASSED    00:00:00.841
native_ssh     test_ssh_transport  PASSED    00:00:01.053
native_ssh     test_ssh_channel    PASSED    00:00:00.563
================ 120 test cases: 120 succeeded in 00:00:06.933 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.889
================== 2 test cases: 2 succeeded in 00:00:00.889 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
------------ native_app:test_path_params [PASSED] Took 0.62 seconds ------------
...
---------- native_app:test_digest_vectors [PASSED] Took 0.56 seconds -----------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.195
native_app     test_template          PASSED    00:00:00.617
native_app     test_path_params       PASSED    00:00:00.620
native_app     test_digest_vectors    PASSED    00:00:00.556
native_app     test_form_params       PASSED    00:00:00.621
native_app     test_iface             PASSED    00:00:00.633
native_app     test_json              PASSED    00:00:00.573
native_app     test_response_headers  PASSED    00:00:00.619
native_app     test_middleware        PASSED    00:00:00.618
native_app     test_digest_auth       PASSED    00:00:00.626
native_app     test_web_terminal      PASSED    00:00:00.616
native_app     test_defer             PASSED    00:00:00.598
native_app     test_multipart         PASSED    00:00:00.614
native_app     test_auth              PASSED    00:00:00.621
native_app     test_file_serving      PASSED    00:00:00.625
native_app     test_dispatch          PASSED    00:00:00.618
native_app     test_chunked           PASSED    00:00:00.618
native_app     test_application       PASSED    00:00:00.695
================ 225 test cases: 225 succeeded in 00:00:11.680 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.232
================= 12 test cases: 12 succeeded in 00:00:01.232 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.711
native_snmp    test_snmp_agent  PASSED    00:00:00.535
================= 35 test cases: 35 succeeded in 00:00:01.246 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.965
================= 15 test cases: 15 succeeded in 00:00:01.965 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
================= 15 test cases: 15 succeeded in 00:00:00.824 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.953
================= 41 test cases: 41 succeeded in 00:00:00.953 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
------------- native_webdav:test_webdav [PASSED] Took 0.66 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.664
================= 19 test cases: 19 succeeded in 00:00:00.664 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.673
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.742
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.656
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.681
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.657
...
----------- native_protobuf:test_protobuf [PASSED] Took 0.66 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.657
================= 13 test cases: 13 succeeded in 00:00:00.657 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.846
================= 16 test cases: 16 succeeded in 00:00:00.846 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
------------ native_gateway:test_gateway [PASSED] Took 0.76 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.756
...
--------------- native_lora:test_lora [PASSED] Took 0.66 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.657
================= 13 test cases: 13 succeeded in 00:00:00.657 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.657
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_pn532   test_pn532  PASSED    00:00:00.662
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.651
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_zigbee  test_zigbee  PASSED    00:00:00.657
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.645
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.680
================= 12 test cases: 12 succeeded in 00:00:00.680 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
---------- native_lwm2m_tlv:test_lwm2m_tlv [PASSED] Took 0.66 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.661
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.651
================== 7 test cases: 7 succeeded in 00:00:00.651 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.724
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.654
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.663
================== 6 test cases: 6 succeeded in 00:00:00.663 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
------------- native_bacnet:test_bacnet [PASSED] Took 0.70 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.699
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.660
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.666
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.666
================== 9 test cases: 9 succeeded in 00:00:00.666 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.675
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.663
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.677
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.659
================== 5 test cases: 5 succeeded in 00:00:00.659 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.663
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.664
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.653
================== 2 test cases: 2 succeeded in 00:00:00.653 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.660
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.679
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.652
================= 11 test cases: 11 succeeded in 00:00:00.652 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.678
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.710
================= 38 test cases: 38 succeeded in 00:00:00.710 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.709
================= 14 test cases: 14 succeeded in 00:00:00.709 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
---------- native_keepalive:test_keepalive [PASSED] Took 1.13 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.132
================= 10 test cases: 10 succeeded in 00:00:01.132 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.125
================= 13 test cases: 13 succeeded in 00:00:01.125 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.685
...
================= 16 test cases: 16 succeeded in 00:00:00.717 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.141
================== 3 test cases: 3 succeeded in 00:00:01.141 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.676
================= 15 test cases: 15 succeeded in 00:00:00.676 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.663
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.690
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.708
================= 14 test cases: 14 succeeded in 00:00:00.708 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.694
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.672
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.709
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.092
================= 71 test cases: 71 succeeded in 00:00:01.092 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.682
================= 14 test cases: 14 succeeded in 00:00:00.682 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.677
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.688
================== 9 test cases: 9 succeeded in 00:00:00.688 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.672
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.666
================== 5 test cases: 5 succeeded in 00:00:00.666 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.663
================= 18 test cases: 18 succeeded in 00:00:00.663 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.670
================= 17 test cases: 17 succeeded in 00:00:00.670 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.662
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.670
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.648
================== 6 test cases: 6 succeeded in 00:00:00.648 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.658
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.680
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.787
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.631
================== 7 test cases: 7 succeeded in 00:00:00.631 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.842
================== 2 test cases: 2 succeeded in 00:00:00.842 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.317
================== 2 test cases: 2 succeeded in 00:00:01.317 ==================
```
