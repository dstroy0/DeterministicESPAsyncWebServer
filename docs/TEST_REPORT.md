...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:05.762 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.624 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.655 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:04.422 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.645 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.647 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.646 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.645 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.680 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.642 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.634 |
...
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.851 |
| `test_ssh_auth`          | `native_ssh`            |    18 |   ✅   | 00:00:00.575 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.825 |
| `test_ssh_transport`     | `native_ssh`            |    27 |   ✅   | 00:00:01.037 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.563 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.881 |
...
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:01.953 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.800 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.753 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.735 |
...
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.642 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.663 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.736 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.798 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.741 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.639 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.651 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.640 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.642 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.640 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.634 |
...
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.642 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.645 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.635 |
...
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.647 |
...
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.115 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.665 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.686 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.127 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.667 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.665 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.639 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.697 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.708 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.672 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.653 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.698 |
...
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.651 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.653 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.668 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.650 |
...
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.679 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.785 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.654 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.764 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.209 |
...
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:05.762
================= 17 test cases: 17 succeeded in 00:00:05.762 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.655
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.647
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.646
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.645
================== 8 test cases: 8 succeeded in 00:00:00.645 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
----------- native_iec60870:test_iec60870 [PASSED] Took 0.63 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.634
...
native_ssh     test_ssh_server     PASSED    00:00:00.825
native_ssh     test_ssh_transport  PASSED    00:00:01.037
native_ssh     test_ssh_channel    PASSED    00:00:00.563
================ 132 test cases: 132 succeeded in 00:00:06.851 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.881
================== 2 test cases: 2 succeeded in 00:00:00.881 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
================= 35 test cases: 35 succeeded in 00:00:01.194 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.953
================= 15 test cases: 15 succeeded in 00:00:01.953 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
================= 41 test cases: 41 succeeded in 00:00:00.735 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.642
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.663
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.736
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.798
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.741
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.639
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.640
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.634
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.642
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.635
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.647
================== 2 test cases: 2 succeeded in 00:00:00.647 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
================= 21 test cases: 21 succeeded in 00:00:00.686 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 144 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.672
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.698
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.650
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.679
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.764
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.209
================== 2 test cases: 2 succeeded in 00:00:01.209 ==================
```
