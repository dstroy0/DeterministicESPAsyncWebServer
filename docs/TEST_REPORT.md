...
**Generated:** 2026-07-04 21:36:31
**Command:** `pio test` over 124 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 2023 passed - 231s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:06.276 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.626 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.660 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.657 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:04.419 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.670 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.650 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.672 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.667 |
...
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.768 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:00.993 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.673 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.667 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.924 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.641 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.840 |
| `test_ssh_transport`     | `native_ssh`            |    31 |   ✅   | 00:00:01.121 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.574 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.956 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.365 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.197 |
...
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.620 |
...
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.666 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.669 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.645 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.674 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.733 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.296 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.232 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.735 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.566 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:02.015 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.857 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.808 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.816 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.713 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.719 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.800 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.684 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.682 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.688 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.680 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.710 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.722 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.793 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.869 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.786 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.712 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.680 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.708 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.686 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.704 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.707 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.691 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.714 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.736 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.709 |
...
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.658 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.710 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.658 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.676 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.670 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.683 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.704 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.700 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.701 |
...
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.734 |
...
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.724 |
...
| `test_dns_server`        | `native_dns_server`     |     7 |   ✅   | 00:00:00.687 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.741 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.166 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.691 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.686 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.675 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.692 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.675 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.676 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.640 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.699 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.052 |
...
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.648 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.644 |
...
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.261 |
...
------------ native_canopen:test_canopen [PASSED] Took 6.28 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.276
================= 17 test cases: 17 succeeded in 00:00:06.276 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 149 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.626
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.660
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:04.419
================= 16 test cases: 16 succeeded in 00:00:04.419 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 149 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.670
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.667
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.647
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:00.991
...
================ 323 test cases: 323 succeeded in 00:00:04.012 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 149 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.768
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.993
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.924
native_ssh     test_ssh_auth       PASSED    00:00:00.641
...
================ 137 test cases: 137 succeeded in 00:00:07.100 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 149 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.956
================== 2 test cases: 2 succeeded in 00:00:00.956 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 149 tests
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 1.36 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.365
================== 2 test cases: 2 succeeded in 00:00:01.365 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 149 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.197
...
native_app     test_iface             PASSED    00:00:00.620
...
native_app     test_auth              PASSED    00:00:00.666
native_app     test_file_serving      PASSED    00:00:00.669
native_app     test_dispatch          PASSED    00:00:00.645
native_app     test_chunked           PASSED    00:00:00.674
native_app     test_application       PASSED    00:00:00.733
================ 225 test cases: 225 succeeded in 00:00:12.010 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 149 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.296
================= 12 test cases: 12 succeeded in 00:00:01.296 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 149 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.735
native_snmp    test_snmp_agent  PASSED    00:00:00.566
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.857
================= 15 test cases: 15 succeeded in 00:00:00.857 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 149 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.808
================= 41 test cases: 41 succeeded in 00:00:00.808 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 149 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.719
================= 22 test cases: 22 succeeded in 00:00:00.719 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 149 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.800
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.682
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.710
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.704
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_zigbee  test_zigbee  PASSED    00:00:00.691
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.714
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.736
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.658
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.676
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.683
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.704
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.701
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.734
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_dns_server  test_dns_server  PASSED    00:00:00.687
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.166
================== 3 test cases: 3 succeeded in 00:00:01.166 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 149 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.686
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.675
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.676
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.640
...
================= 71 test cases: 71 succeeded in 00:00:01.052 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 149 tests
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.644
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.261
