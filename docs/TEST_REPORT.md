...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:11.266 |
...
| `test_provisioning`      | `native_prov`          |     5 |   ✅   | 00:00:00.652 |
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.893 |
| `test_ssh_auth`          | `native_ssh`           |    12 |   ✅   | 00:00:00.555 |
| `test_ssh_server`        | `native_ssh`           |     7 |   ✅   | 00:00:00.661 |
| `test_ssh_transport`     | `native_ssh`           |    23 |   ✅   | 00:00:00.874 |
| `test_ssh_channel`       | `native_ssh`           |    12 |   ✅   | 00:00:00.526 |
| `test_ssh_hardening`     | `native_ssh_hardened`  |     2 |   ✅   | 00:00:00.861 |
| `test_ssh_conn`          | `native_ssh_conn`      |     2 |   ✅   | 00:00:01.226 |
| `test_regex`             | `native_app`           |     9 |   ✅   | 00:00:01.097 |
| `test_template`          | `native_app`           |     6 |   ✅   | 00:00:00.587 |
| `test_path_params`       | `native_app`           |     8 |   ✅   | 00:00:00.583 |
| `test_digest_vectors`    | `native_app`           |     4 |   ✅   | 00:00:00.531 |
| `test_form_params`       | `native_app`           |     5 |   ✅   | 00:00:00.578 |
...
| `test_digest_auth`       | `native_app`           |     5 |   ✅   | 00:00:00.588 |
| `test_web_terminal`      | `native_app`           |     7 |   ✅   | 00:00:00.596 |
...
| `test_chunked`           | `native_app`           |    10 |   ✅   | 00:00:00.587 |
| `test_application`       | `native_app`           |    50 |   ✅   | 00:00:00.659 |
| `test_snmp_ber`          | `native_snmp`          |     9 |   ✅   | 00:00:00.684 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.499 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.369 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.771 |
| `test_coap`              | `native_coap`          |    26 |   ✅   | 00:00:00.664 |
| `test_webdav`            | `native_webdav`        |    19 |   ✅   | 00:00:00.654 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.653 |
...
| `test_oauth2`            | `native_oauth2`        |     8 |   ✅   | 00:00:00.690 |
| `test_opcua`             | `native_opcua`         |    29 |   ✅   | 00:00:00.669 |
...
| `test_dashboard`         | `native_dashboard`     |    11 |   ✅   | 00:00:00.667 |
| `test_net_egress`        | `native_net_egress`    |     5 |   ✅   | 00:00:00.638 |
| `test_partition_monitor` | `native_partition`     |     5 |   ✅   | 00:00:00.635 |
| `test_cbor`              | `native_cbor`          |    14 |   ✅   | 00:00:00.626 |
| `test_msgpack`           | `native_msgpack`       |    15 |   ✅   | 00:00:00.644 |
...
| `test_concurrency`       | `native_tsan`          |     2 |   ✅   | 00:00:01.133 |
...
----------------- native:test_sse [PASSED] Took 11.27 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:11.266
...
================ 306 test cases: 306 succeeded in 00:00:14.175 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.652
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.893
native_ssh     test_ssh_auth       PASSED    00:00:00.555
native_ssh     test_ssh_server     PASSED    00:00:00.661
native_ssh     test_ssh_transport  PASSED    00:00:00.874
native_ssh     test_ssh_channel    PASSED    00:00:00.526
================= 92 test cases: 92 succeeded in 00:00:06.509 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.097
native_app     test_template          PASSED    00:00:00.587
native_app     test_path_params       PASSED    00:00:00.583
native_app     test_digest_vectors    PASSED    00:00:00.531
native_app     test_form_params       PASSED    00:00:00.578
...
native_app     test_application       PASSED    00:00:00.659
================ 204 test cases: 204 succeeded in 00:00:11.052 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
================= 22 test cases: 22 succeeded in 00:00:01.183 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.369
================== 9 test cases: 9 succeeded in 00:00:01.369 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.690
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.669
================= 29 test cases: 29 succeeded in 00:00:00.669 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
================= 16 test cases: 16 succeeded in 00:00:00.644 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.682
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.633
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.655
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.638
================== 5 test cases: 5 succeeded in 00:00:00.638 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.635
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.644
================= 15 test cases: 15 succeeded in 00:00:00.644 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.133
================== 2 test cases: 2 succeeded in 00:00:01.133 ==================
```
