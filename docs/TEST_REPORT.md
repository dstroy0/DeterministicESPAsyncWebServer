...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:13.425 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.664 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.674 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.667 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:03.606 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.661 |
...
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.656 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.602 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.638 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.637 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.646 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.628 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.614 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.654 |
...
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.158 |
...
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.915 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.777 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.685 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.675 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.748 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.665 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.665 |
...
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.693 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.764 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.829 |
...
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.685 |
...
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.136 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.691 |
| `test_smtp`              | `native_smtp`           |    11 |   ✅   | 00:00:00.794 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.674 |
| `test_dns_server`        | `native_dns_server`     |     7 |   ✅   | 00:00:00.664 |
| `test_rtc`               | `native_rtc`            |     8 |   ✅   | 00:00:00.692 |
| `test_ld2410`            | `native_ld2410`         |     7 |   ✅   | 00:00:00.685 |
| `test_mpr121`            | `native_mpr121`         |     5 |   ✅   | 00:00:00.673 |
| `test_sht3x`             | `native_sht3x`          |     5 |   ✅   | 00:00:00.683 |
| `test_pca9685`           | `native_pca9685`        |     4 |   ✅   | 00:00:00.659 |
| `test_ads1115`           | `native_ads1115`        |     3 |   ✅   | 00:00:00.696 |
| `test_ina219`            | `native_ina219`         |     4 |   ✅   | 00:00:00.746 |
| `test_hpack`             | `native_hpack`          |     7 |   ✅   | 00:00:00.767 |
| `test_h2_frame`          | `native_h2frame`        |     6 |   ✅   | 00:00:00.675 |
| `test_h2_conn`           | `native_h2conn`         |     4 |   ✅   | 00:00:00.857 |
| `test_quic_varint`       | `native_quic_varint`    |     3 |   ✅   | 00:00:00.675 |
| `test_h3_frame`          | `native_h3frame`        |     7 |   ✅   | 00:00:00.702 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.727 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.123 |
...
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.735 |
...
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.043 |
...
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.673 |
...
| `test_statsd`            | `native_statsd`         |     9 |   ✅   | 00:00:00.704 |
...
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.796 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.251 |
| `test_qpack`             | `native_qpack`          |     9 |   ✅   | 00:00:00.753 |
| `test_quic_packet`       | `native_quic_packet`    |     8 |   ✅   | 00:00:00.665 |
| `test_quic_frame`        | `native_quic_frame`     |     8 |   ✅   | 00:00:00.686 |
| `test_ssh_chachapoly`    | `native_ssh_chachapoly` |     4 |   ✅   | 00:00:00.701 |
...
----------- native_canopen:test_canopen [PASSED] Took 13.43 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:13.425
================= 17 test cases: 17 succeeded in 00:00:13.425 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_det_arena  test_det_arena  PASSED    00:00:00.667
================= 17 test cases: 17 succeeded in 00:00:00.667 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
-------- native_ssh_ed25519:test_ssh_ed25519 [PASSED] Took 3.61 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:03.606
================= 16 test cases: 16 succeeded in 00:00:03.606 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.661
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.670
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.664
================== 5 test cases: 5 succeeded in 00:00:00.664 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
native         test_presentation  PASSED    00:00:00.644
...
================ 323 test cases: 323 succeeded in 00:00:04.198 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.771
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.999
================= 13 test cases: 13 succeeded in 00:00:00.999 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.878
native_ssh     test_ssh_auth       PASSED    00:00:00.644
native_ssh     test_ssh_server     PASSED    00:00:00.890
native_ssh     test_ssh_transport  PASSED    00:00:01.193
native_ssh     test_ssh_channel    PASSED    00:00:00.603
================ 145 test cases: 145 succeeded in 00:00:07.208 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:01.009
...
native_app     test_iface             PASSED    00:00:00.656
native_app     test_json              PASSED    00:00:00.602
native_app     test_response_headers  PASSED    00:00:00.638
native_app     test_middleware        PASSED    00:00:00.637
native_app     test_digest_auth       PASSED    00:00:00.646
...
================ 225 test cases: 225 succeeded in 00:00:11.899 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.158
...
================= 35 test cases: 35 succeeded in 00:00:01.221 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.915
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.675
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.665
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.764
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.829
================= 16 test cases: 16 succeeded in 00:00:00.829 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_zigbee  test_zigbee  PASSED    00:00:00.670
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.687
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.654
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.669
...
================= 16 test cases: 16 succeeded in 00:00:00.685 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.136
================= 13 test cases: 13 succeeded in 00:00:01.136 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_smtp    test_smtp  PASSED    00:00:00.794
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_ntp_server  test_ntp_server  PASSED    00:00:00.674
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_dns_server  test_dns_server  PASSED    00:00:00.664
================== 7 test cases: 7 succeeded in 00:00:00.664 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ld2410  test_ld2410  PASSED    00:00:00.685
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_mpr121  test_mpr121  PASSED    00:00:00.673
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sht3x   test_sht3x  PASSED    00:00:00.683
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_ads1115  test_ads1115  PASSED    00:00:00.696
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ina219  test_ina219  PASSED    00:00:00.746
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_hpack   test_hpack  PASSED    00:00:00.767
...
Environment    Test          Status    Duration
-------------  ------------  --------  ------------
native_h2conn  test_h2_conn  PASSED    00:00:00.857
================== 4 test cases: 4 succeeded in 00:00:00.857 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h3frame  test_h3_frame  PASSED    00:00:00.702
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.123
================== 3 test cases: 3 succeeded in 00:00:01.123 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.735
================= 16 test cases: 16 succeeded in 00:00:00.735 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.043
================= 71 test cases: 71 succeeded in 00:00:01.043 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_statsd  test_statsd  PASSED    00:00:00.704
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.796
================== 2 test cases: 2 succeeded in 00:00:00.796 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.251
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_qpack   test_qpack  PASSED    00:00:00.753
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_ssh_chachapoly  test_ssh_chachapoly  PASSED    00:00:00.701
