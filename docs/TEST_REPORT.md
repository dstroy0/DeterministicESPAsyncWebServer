...
**Generated:** 2026-06-29 18:52:50
**Command:** `pio test` over 84 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1426 passed - 141s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:06.475 |
...
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.916 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.573 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.690 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.903 |
...
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.590 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.640 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.643 |
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.593 |
...
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.613 |
...
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.171 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.720 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.506 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.483 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.809 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.784 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.754 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.698 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.648 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.715 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.686 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.658 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.654 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.690 |
| `test_protobuf`          | `native_protobuf`       |     8 |   ✅   | 00:00:00.690 |
| `test_wamp`              | `native_wamp`           |    11 |   ✅   | 00:00:00.697 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.676 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.667 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.660 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.657 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |     7 |   ✅   | 00:00:00.675 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.679 |
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.745 |
...
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.872 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.676 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.688 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.697 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.699 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.716 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.715 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.119 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.122 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.679 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.731 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.133 |
| `test_http_client`       | `native_http_client`    |    10 |   ✅   | 00:00:00.690 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.673 |
...
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.677 |
...
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.681 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.693 |
...
------------------ native:test_sse [PASSED] Took 6.47 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.475
...
================ 318 test cases: 318 succeeded in 00:00:09.562 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 109 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.916
native_ssh     test_ssh_auth       PASSED    00:00:00.573
native_ssh     test_ssh_server     PASSED    00:00:00.690
native_ssh     test_ssh_transport  PASSED    00:00:00.903
native_ssh     test_ssh_channel    PASSED    00:00:00.543
================= 93 test cases: 93 succeeded in 00:00:06.625 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 109 tests
...
native_app     test_digest_vectors    PASSED    00:00:00.590
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.171
...
================= 29 test cases: 29 succeeded in 00:00:01.226 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 109 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.483
================= 10 test cases: 10 succeeded in 00:00:01.483 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 109 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.784
================= 29 test cases: 29 succeeded in 00:00:00.784 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 109 tests
...
================= 29 test cases: 29 succeeded in 00:00:00.754 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 109 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.648
================= 18 test cases: 18 succeeded in 00:00:00.648 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 109 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.715
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.697
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.676
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.657
...
test/test_hostlink/test_hostlink.cpp:30: test_build_dm_read: Expected '@00RD0000001057*\r' Was '@00RD0000001057*\r1?v\xFF\x7F' [FAILED]
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  ERRORED   00:00:00.677

============= 8 test cases: 1 failed, 6 succeeded in 00:00:00.677 =============
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 109 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.872
================= 13 test cases: 13 succeeded in 00:00:00.872 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 109 tests
...
================= 29 test cases: 29 succeeded in 00:00:00.716 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 109 tests
...
================= 12 test cases: 12 succeeded in 00:00:00.731 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 109 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.673
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.677
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.693
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.709
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.170
