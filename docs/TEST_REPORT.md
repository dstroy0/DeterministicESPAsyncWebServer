...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:06.561 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.497 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.519 |
| `test_transport`        | `native`              |    28 |   ✅   | 00:00:00.496 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.527 |
| `test_http_parser`      | `native`              |    80 |   ✅   | 00:00:00.526 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.776 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.518 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.627 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.847 |
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.476 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.780 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.041 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.913 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.493 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.496 |
...
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.509 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.497 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.512 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.505 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.523 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.500 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.499 |
| `test_application`      | `native_app`          |    49 |   ✅   | 00:00:00.587 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.602 |
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:06.561
native               test_session           PASSED    00:00:00.497
native               test_presentation      PASSED    00:00:00.519
native               test_transport         PASSED    00:00:00.496
native               test_websocket         PASSED    00:00:00.527
...
native_ssh           test_ssh_server        PASSED    00:00:00.627
native_ssh           test_ssh_transport     PASSED    00:00:00.847
native_ssh           test_ssh_channel       PASSED    00:00:00.476
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.780
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.041
native_app           test_regex             PASSED    00:00:00.913
native_app           test_template          PASSED    00:00:00.493
native_app           test_path_params       PASSED    00:00:00.496
...
native_app           test_digest_auth       PASSED    00:00:00.509
native_app           test_web_terminal      PASSED    00:00:00.497
native_app           test_multipart         PASSED    00:00:00.512
native_app           test_auth              PASSED    00:00:00.505
native_app           test_file_serving      PASSED    00:00:00.523
native_app           test_dispatch          PASSED    00:00:00.500
native_app           test_chunked           PASSED    00:00:00.499
native_app           test_application       PASSED    00:00:00.587
native_compliance    test_compliance        PASSED    00:00:00.602
================ 594 test cases: 594 succeeded in 00:00:26.773 ================
```
