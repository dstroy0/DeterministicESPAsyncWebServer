...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:06.088 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.553 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.593 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.572 |
| `test_websocket`         | `native`               |    63 |   ✅   | 00:00:00.599 |
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.557 |
| `test_observability`     | `native_observability` |    15 |   ✅   | 00:00:00.699 |
| `test_http_ota`          | `native_ota`           |     3 |   ✅   | 00:00:00.640 |
| `test_provisioning`      | `native_prov`          |     5 |   ✅   | 00:00:00.649 |
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.846 |
...
| `test_ssh_channel`       | `native_ssh`           |    12 |   ✅   | 00:00:00.516 |
| `test_ssh_hardening`     | `native_ssh_hardened`  |     2 |   ✅   | 00:00:00.858 |
| `test_ssh_conn`          | `native_ssh_conn`      |     2 |   ✅   | 00:00:01.222 |
...
| `test_json`              | `native_app`           |    17 |   ✅   | 00:00:00.540 |
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.586 |
| `test_middleware`        | `native_app`           |     9 |   ✅   | 00:00:00.585 |
| `test_digest_auth`       | `native_app`           |     5 |   ✅   | 00:00:00.584 |
| `test_web_terminal`      | `native_app`           |     7 |   ✅   | 00:00:00.576 |
| `test_defer`             | `native_app`           |     3 |   ✅   | 00:00:00.552 |
| `test_multipart`         | `native_app`           |    19 |   ✅   | 00:00:00.589 |
| `test_auth`              | `native_app`           |    13 |   ✅   | 00:00:00.582 |
| `test_file_serving`      | `native_app`           |    12 |   ✅   | 00:00:00.602 |
| `test_dispatch`          | `native_app`           |    11 |   ✅   | 00:00:00.592 |
| `test_chunked`           | `native_app`           |    10 |   ✅   | 00:00:00.599 |
| `test_application`       | `native_app`           |    52 |   ✅   | 00:00:00.670 |
| `test_snmp_ber`          | `native_snmp`          |     9 |   ✅   | 00:00:00.673 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.479 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.363 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.765 |
| `test_coap`              | `native_coap`          |    26 |   ✅   | 00:00:00.655 |
| `test_webdav`            | `native_webdav`        |    19 |   ✅   | 00:00:00.633 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.626 |
| `test_modbus_master`     | `native_modbus_master` |     5 |   ✅   | 00:00:00.644 |
| `test_ota_rollback`      | `native_ota_rollback`  |     5 |   ✅   | 00:00:00.632 |
| `test_totp`              | `native_totp`          |     4 |   ✅   | 00:00:00.652 |
| `test_webhook`           | `native_webhook`       |     5 |   ✅   | 00:00:00.633 |
| `test_radio_power`       | `native_radio_power`   |     2 |   ✅   | 00:00:00.636 |
| `test_dns_resolver`      | `native_dns_resolver`  |     4 |   ✅   | 00:00:00.637 |
| `test_audit_log`         | `native_audit_log`     |    12 |   ✅   | 00:00:00.669 |
| `test_oidc`              | `native_oidc`          |    13 |   ✅   | 00:00:00.814 |
| `test_vfs`               | `native_vfs`           |    11 |   ✅   | 00:00:00.634 |
...
| `test_keepalive`         | `native_keepalive`     |    10 |   ✅   | 00:00:01.051 |
| `test_range`             | `native_range`         |    13 |   ✅   | 00:00:01.060 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.646 |
| `test_jwt`               | `native_jwt`           |    10 |   ✅   | 00:00:00.692 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.081 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.647 |
| `test_compliance`        | `native_compliance`    |    12 |   ✅   | 00:00:00.646 |
| `test_mqtt`              | `native_mqtt`          |    16 |   ✅   | 00:00:00.627 |
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.666 |
| `test_scratch`           | `native_scratch`       |    14 |   ✅   | 00:00:00.659 |
| `test_snmp_trap`         | `native_snmp_trap`     |     3 |   ✅   | 00:00:00.648 |
| `test_inflate`           | `native_inflate`       |    12 |   ✅   | 00:00:00.630 |
| `test_deflate`           | `native_deflate`       |    10 |   ✅   | 00:00:00.676 |
| `test_websocket`         | `native_ws_deflate`    |    67 |   ✅   | 00:00:00.997 |
| `test_time_source`       | `native_time_source`   |     9 |   ✅   | 00:00:00.630 |
| `test_config_store`      | `native_config_store`  |    14 |   ✅   | 00:00:00.616 |
| `test_device_id`         | `native_device_id`     |     4 |   ✅   | 00:00:00.644 |
| `test_auth_lockout`      | `native_auth_lockout`  |    10 |   ✅   | 00:00:00.616 |
| `test_csrf`              | `native_csrf`          |     9 |   ✅   | 00:00:00.658 |
| `test_telemetry`         | `native_telemetry`     |     8 |   ✅   | 00:00:00.638 |
| `test_dashboard`         | `native_dashboard`     |    11 |   ✅   | 00:00:00.649 |
| `test_net_egress`        | `native_net_egress`    |     5 |   ✅   | 00:00:00.627 |
| `test_partition_monitor` | `native_partition`     |     5 |   ✅   | 00:00:00.628 |
| `test_cbor`              | `native_cbor`          |    14 |   ✅   | 00:00:00.641 |
| `test_msgpack`           | `native_msgpack`       |    15 |   ✅   | 00:00:00.657 |
| `test_gpio_map`          | `native_gpio_map`      |     8 |   ✅   | 00:00:00.639 |
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.647 |
| `test_guardrails`        | `native_guardrails`    |     6 |   ✅   | 00:00:00.642 |
| `test_logbuf`            | `native_logbuf`        |     4 |   ✅   | 00:00:00.640 |
| `test_config_io`         | `native_config_io`     |     4 |   ✅   | 00:00:00.657 |
| `test_workers`           | `native_workers`       |     3 |   ✅   | 00:00:00.745 |
| `test_clock`             | `native_clock`         |     4 |   ✅   | 00:00:00.622 |
| `test_concurrency`       | `native_concurrency`   |     2 |   ✅   | 00:00:00.751 |
| `test_concurrency`       | `native_tsan`          |     2 |   ✅   | 00:00:01.260 |
...
------------------ native:test_sse [PASSED] Took 6.09 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.088
native         test_session       PASSED    00:00:00.553
native         test_presentation  PASSED    00:00:00.593
native         test_transport     PASSED    00:00:00.572
native         test_websocket     PASSED    00:00:00.599
native         test_http_parser   PASSED    00:00:00.557
================ 306 test cases: 306 succeeded in 00:00:08.962 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.699
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.640
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.649
...
================= 92 test cases: 92 succeeded in 00:00:06.445 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.858
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.222
...
native_app     test_json              PASSED    00:00:00.540
native_app     test_response_headers  PASSED    00:00:00.586
native_app     test_middleware        PASSED    00:00:00.585
native_app     test_digest_auth       PASSED    00:00:00.584
native_app     test_web_terminal      PASSED    00:00:00.576
native_app     test_defer             PASSED    00:00:00.552
native_app     test_multipart         PASSED    00:00:00.589
native_app     test_auth              PASSED    00:00:00.582
...
native_app     test_application       PASSED    00:00:00.670
================ 206 test cases: 206 succeeded in 00:00:11.094 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.673
native_snmp    test_snmp_agent  PASSED    00:00:00.479
================= 22 test cases: 22 succeeded in 00:00:01.152 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.363
================== 9 test cases: 9 succeeded in 00:00:01.363 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.655
================= 26 test cases: 26 succeeded in 00:00:00.655 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.633
================= 19 test cases: 19 succeeded in 00:00:00.633 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.644
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.632
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.633
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.669
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.814
================= 13 test cases: 13 succeeded in 00:00:00.814 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.634
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.051
================= 10 test cases: 10 succeeded in 00:00:01.051 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.060
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.646
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.692
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.627
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.666
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.659
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.648
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.630
================= 12 test cases: 12 succeeded in 00:00:00.630 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.997
================= 67 test cases: 67 succeeded in 00:00:00.997 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.616
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.644
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.616
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.658
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.649
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.628
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.657
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.642
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.622
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.751
================== 2 test cases: 2 succeeded in 00:00:00.751 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.260
