...
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.829 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.093 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.927 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.522 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.514 |
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.493 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.516 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.514 |
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.503 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.531 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.522 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.523 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.527 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.523 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.516 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.531 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.520 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.515 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.629 |
...
----------------- native:test_sse [PASSED] Took 13.65 seconds ------------------
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 3.70 seconds -------------
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 1.09 seconds -----------
...
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.829
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.093
native_app           test_regex             PASSED    00:00:00.927
native_app           test_template          PASSED    00:00:00.522
native_app           test_path_params       PASSED    00:00:00.514
native_app           test_digest_vectors    PASSED    00:00:00.493
native_app           test_form_params       PASSED    00:00:00.516
...
native_app           test_middleware        PASSED    00:00:00.522
native_app           test_digest_auth       PASSED    00:00:00.523
native_app           test_web_terminal      PASSED    00:00:00.527
native_app           test_multipart         PASSED    00:00:00.523
native_app           test_auth              PASSED    00:00:00.516
native_app           test_file_serving      PASSED    00:00:00.531
native_app           test_dispatch          PASSED    00:00:00.520
native_app           test_chunked           PASSED    00:00:00.515
native_app           test_application       PASSED    00:00:00.629
native_compliance    test_compliance        PASSED    00:00:00.641
================ 611 test cases: 611 succeeded in 00:00:34.503 ================
```
