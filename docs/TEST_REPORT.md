...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:12.035 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.566 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.600 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.579 |
| `test_websocket`         | `native`               |    67 |   ✅   | 00:00:00.604 |
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.561 |
| `test_observability`     | `native_observability` |    15 |   ✅   | 00:00:00.703 |
| `test_http_ota`          | `native_ota`           |     3 |   ✅   | 00:00:00.635 |
| `test_provisioning`      | `native_prov`          |     5 |   ✅   | 00:00:00.657 |
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.727 |
...
| `test_path_params`       | `native_app`           |     8 |   ✅   | 00:00:00.577 |
| `test_digest_vectors`    | `native_app`           |     4 |   ✅   | 00:00:00.526 |
| `test_form_params`       | `native_app`           |     5 |   ✅   | 00:00:00.572 |
| `test_iface`             | `native_app`           |     7 |   ✅   | 00:00:00.579 |
| `test_json`              | `native_app`           |    17 |   ✅   | 00:00:00.541 |
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.588 |
...
| `test_file_serving`      | `native_app`           |    12 |   ✅   | 00:00:00.601 |
...
| `test_diag`              | `native_diag`          |     2 |   ✅   | 00:00:01.090 |
| `test_snmp_ber`          | `native_snmp`          |    15 |   ✅   | 00:00:00.672 |
| `test_snmp_agent`        | `native_snmp`          |    14 |   ✅   | 00:00:00.489 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.401 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.783 |
| `test_coap`              | `native_coap`          |    27 |   ✅   | 00:00:00.662 |
| `test_coap`              | `native_coap_observe`  |    27 |   ✅   | 00:00:00.673 |
| `test_webdav`            | `native_webdav`        |    19 |   ✅   | 00:00:00.663 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.650 |
...
| `test_webhook`           | `native_webhook`       |     5 |   ✅   | 00:00:00.639 |
| `test_radio_power`       | `native_radio_power`   |     2 |   ✅   | 00:00:00.651 |
| `test_dns_resolver`      | `native_dns_resolver`  |     4 |   ✅   | 00:00:00.631 |
| `test_audit_log`         | `native_audit_log`     |    12 |   ✅   | 00:00:00.664 |
| `test_oidc`              | `native_oidc`          |    13 |   ✅   | 00:00:00.820 |
| `test_vfs`               | `native_vfs`           |    11 |   ✅   | 00:00:00.632 |
| `test_graphql`           | `native_graphql`       |    13 |   ✅   | 00:00:00.644 |
...
| `test_range`             | `native_range`         |    13 |   ✅   | 00:00:01.051 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.647 |
| `test_jwt`               | `native_jwt`           |    12 |   ✅   | 00:00:00.683 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.077 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.641 |
| `test_compliance`        | `native_compliance`    |    15 |   ✅   | 00:00:00.645 |
| `test_mqtt`              | `native_mqtt`          |    19 |   ✅   | 00:00:00.631 |
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.672 |
| `test_scratch`           | `native_scratch`       |    14 |   ✅   | 00:00:00.686 |
| `test_snmp_trap`         | `native_snmp_trap`     |     3 |   ✅   | 00:00:00.656 |
| `test_inflate`           | `native_inflate`       |    12 |   ✅   | 00:00:00.639 |
| `test_deflate`           | `native_deflate`       |    10 |   ✅   | 00:00:00.680 |
| `test_websocket`         | `native_ws_deflate`    |    71 |   ✅   | 00:00:00.970 |
...
| `test_net_egress`        | `native_net_egress`    |     5 |   ✅   | 00:00:00.633 |
...
| `test_concurrency`       | `native_tsan`          |     2 |   ✅   | 00:00:01.243 |
...
----------------- native:test_sse [PASSED] Took 12.03 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:12.035
...
================ 310 test cases: 310 succeeded in 00:00:14.945 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.703
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.635
================== 3 test cases: 3 succeeded in 00:00:00.635 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 3.73 seconds -------------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.727
...
================= 92 test cases: 92 succeeded in 00:00:06.395 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
native_app     test_file_serving      PASSED    00:00:00.601
...
================ 217 test cases: 217 succeeded in 00:00:11.069 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.090
...
================= 29 test cases: 29 succeeded in 00:00:01.161 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.401
================== 9 test cases: 9 succeeded in 00:00:01.401 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
================= 27 test cases: 27 succeeded in 00:00:00.662 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
================= 27 test cases: 27 succeeded in 00:00:00.673 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.639
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.664
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.632
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.644
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.051
================= 13 test cases: 13 succeeded in 00:00:01.051 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.631
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.656
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.639
...
================= 71 test cases: 71 succeeded in 00:00:00.970 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.633
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.243
================== 2 test cases: 2 succeeded in 00:00:01.243 ==================
```
