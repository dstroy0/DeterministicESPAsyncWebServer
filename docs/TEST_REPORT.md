...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:07.591 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.388 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.410 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.402 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.420 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.414 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:02.879 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.432 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.524 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.706 |
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.405 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.657 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:00.855 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.739 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.881 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.404 |
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.390 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.408 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.408 |
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.401 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.406 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.405 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.409 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.398 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.409 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.402 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.419 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.626 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.513 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.483 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.514 |
...
------------------ native:test_sse [PASSED] Took 7.59 seconds ------------------
...
--------------- native:test_transport [PASSED] Took 0.40 seconds ---------------
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 2.88 seconds -------------
...
------ native_ssh_hardened:test_ssh_hardening [PASSED] Took 0.66 seconds -------
...
--------------- native_app:test_regex [PASSED] Took 0.74 seconds ---------------
...
------------ native_app:test_digest_auth [PASSED] Took 0.41 seconds ------------
...
--------- native_compliance:test_compliance [PASSED] Took 0.51 seconds ---------

=================================== SUMMARY ===================================
Environment          Test                   Status    Duration
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:07.591
native               test_session           PASSED    00:00:00.388
native               test_presentation      PASSED    00:00:00.410
native               test_transport         PASSED    00:00:00.402
native               test_websocket         PASSED    00:00:00.420
native               test_http_parser       PASSED    00:00:00.414
native_ssh           test_ssh_crypto        PASSED    00:00:02.879
native_ssh           test_ssh_auth          PASSED    00:00:00.432
native_ssh           test_ssh_server        PASSED    00:00:00.524
native_ssh           test_ssh_transport     PASSED    00:00:00.706
native_ssh           test_ssh_channel       PASSED    00:00:00.405
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.657
native_ssh_conn      test_ssh_conn          PASSED    00:00:00.855
native_app           test_regex             PASSED    00:00:00.739
native_app           test_template          PASSED    00:00:00.881
native_app           test_path_params       PASSED    00:00:00.404
native_app           test_digest_vectors    PASSED    00:00:00.390
native_app           test_form_params       PASSED    00:00:00.408
native_app           test_iface             PASSED    00:00:00.408
native_app           test_json              PASSED    00:00:00.401
native_app           test_response_headers  PASSED    00:00:00.406
native_app           test_middleware        PASSED    00:00:00.405
native_app           test_digest_auth       PASSED    00:00:00.409
native_app           test_web_terminal      PASSED    00:00:00.398
native_app           test_multipart         PASSED    00:00:00.409
native_app           test_auth              PASSED    00:00:00.402
native_app           test_file_serving      PASSED    00:00:00.419
native_app           test_dispatch          PASSED    00:00:00.626
native_app           test_chunked           PASSED    00:00:00.513
native_app           test_application       PASSED    00:00:00.483
native_compliance    test_compliance        PASSED    00:00:00.514
================ 611 test cases: 611 succeeded in 00:00:24.698 ================
```
