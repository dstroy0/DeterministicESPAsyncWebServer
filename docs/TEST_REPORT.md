...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:13.168 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.683 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.695 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.697 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.705 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.687 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.684 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.679 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.688 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.709 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.697 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.010 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.611 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.642 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.613 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.640 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.600 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.741 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:00.994 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.677 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.692 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.794 |
| `test_ssh_auth`          | `native_ssh`            |    18 |   ✅   | 00:00:00.605 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.888 |
| `test_ssh_transport`     | `native_ssh`            |    27 |   ✅   | 00:00:01.121 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.583 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.920 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.310 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.170 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.623 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.631 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.572 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.614 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.609 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.574 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.624 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.615 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.675 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.627 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.584 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.617 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.620 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.627 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.619 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.619 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.709 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.207 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.148 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.706 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.531 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:02.073 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.802 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.963 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.782 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.695 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.687 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.793 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.672 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.686 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.688 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.686 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.702 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.699 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.773 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.862 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.767 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.696 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.687 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.664 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.686 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.676 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.683 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.696 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.690 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.701 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.687 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.718 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.677 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.673 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.682 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.694 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.674 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.754 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.684 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.672 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.701 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.696 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.694 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.698 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.685 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.687 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.684 |
...
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.715 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.723 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.714 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.704 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.693 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.719 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.917 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.692 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.706 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.684 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.708 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.711 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.718 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.101 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.134 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.712 |
| `test_jwt`               | `native_jwt`            |    16 |   ✅   | 00:00:00.742 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.198 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.726 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.702 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.706 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.720 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.726 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.715 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.708 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.780 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.058 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.689 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.676 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.712 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.687 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.718 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.690 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.686 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.662 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.665 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.674 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.690 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.694 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.681 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.680 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.659 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.707 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.777 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.720 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.858 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.573 |
...
----------- native_canopen:test_canopen [PASSED] Took 13.17 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:13.168
================= 17 test cases: 17 succeeded in 00:00:13.168 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.695
================== 9 test cases: 9 succeeded in 00:00:00.695 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.697
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.684
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.688
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.709
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.697
...
native         test_session       PASSED    00:00:00.611
native         test_presentation  PASSED    00:00:00.642
native         test_transport     PASSED    00:00:00.613
native         test_websocket     PASSED    00:00:00.640
native         test_http_parser   PASSED    00:00:00.600
================ 321 test cases: 321 succeeded in 00:00:04.117 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.741
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.677
================== 3 test cases: 3 succeeded in 00:00:00.677 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.692
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.794
native_ssh     test_ssh_auth       PASSED    00:00:00.605
native_ssh     test_ssh_server     PASSED    00:00:00.888
native_ssh     test_ssh_transport  PASSED    00:00:01.121
native_ssh     test_ssh_channel    PASSED    00:00:00.583
================ 120 test cases: 120 succeeded in 00:00:06.992 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.310
...
------------ native_app:test_digest_auth [PASSED] Took 0.68 seconds ------------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.170
native_app     test_template          PASSED    00:00:00.623
native_app     test_path_params       PASSED    00:00:00.631
native_app     test_digest_vectors    PASSED    00:00:00.572
native_app     test_form_params       PASSED    00:00:00.614
native_app     test_iface             PASSED    00:00:00.609
native_app     test_json              PASSED    00:00:00.574
native_app     test_response_headers  PASSED    00:00:00.624
...
native_app     test_defer             PASSED    00:00:00.584
native_app     test_multipart         PASSED    00:00:00.617
native_app     test_auth              PASSED    00:00:00.620
native_app     test_file_serving      PASSED    00:00:00.627
native_app     test_dispatch          PASSED    00:00:00.619
native_app     test_chunked           PASSED    00:00:00.619
native_app     test_application       PASSED    00:00:00.709
================ 225 test cases: 225 succeeded in 00:00:11.730 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.207
================= 12 test cases: 12 succeeded in 00:00:01.207 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.148
================== 2 test cases: 2 succeeded in 00:00:01.148 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.706
native_snmp    test_snmp_agent  PASSED    00:00:00.531
================= 35 test cases: 35 succeeded in 00:00:01.237 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:02.073
================= 15 test cases: 15 succeeded in 00:00:02.073 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.802
================= 15 test cases: 15 succeeded in 00:00:00.802 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.963
================= 41 test cases: 41 succeeded in 00:00:00.963 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.782
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.695
================= 19 test cases: 19 succeeded in 00:00:00.695 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.687
================= 22 test cases: 22 succeeded in 00:00:00.687 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.793
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.672
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.686
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.688
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.702
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.773
================= 11 test cases: 11 succeeded in 00:00:00.773 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------ native_forward:test_forward [PASSED] Took 0.86 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.862
================= 16 test cases: 16 succeeded in 00:00:00.862 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_lora:test_lora [PASSED] Took 0.70 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.696
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.687
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_pn532   test_pn532  PASSED    00:00:00.686
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.676
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.683
...
------------- native_zigbee:test_zigbee [PASSED] Took 0.70 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_zigbee  test_zigbee  PASSED    00:00:00.696
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.690
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.701
================= 12 test cases: 12 succeeded in 00:00:00.701 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.687
...
------------- native_c37118:test_c37118 [PASSED] Took 0.72 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.718
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.673
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.682
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.694
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.684
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.672
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.701
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.696
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.694
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.698
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.687
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.684
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.685
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.714
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.715
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.723
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.714
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.704
================== 2 test cases: 2 succeeded in 00:00:00.704 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.719
================= 16 test cases: 16 succeeded in 00:00:00.719 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.917
================= 17 test cases: 17 succeeded in 00:00:00.917 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.692
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.708
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.718
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.101
================= 10 test cases: 10 succeeded in 00:00:01.101 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.712
...
------------- native_upload:test_upload [PASSED] Took 1.20 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.198
================== 3 test cases: 3 succeeded in 00:00:01.198 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.702
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.706
================= 22 test cases: 22 succeeded in 00:00:00.706 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.720
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.715
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.708
================= 12 test cases: 12 succeeded in 00:00:00.708 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------ native_deflate:test_deflate [PASSED] Took 0.78 seconds ------------
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.058
================= 71 test cases: 71 succeeded in 00:00:01.058 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.676
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.712
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.690
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.686
================= 15 test cases: 15 succeeded in 00:00:00.686 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.662
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.665
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.694
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.681
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.680
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.659
...
-------------- native_clock:test_clock [PASSED] Took 0.72 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.720
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.858
================== 2 test cases: 2 succeeded in 00:00:00.858 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 1.57 seconds ------------

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.573
================== 2 test cases: 2 succeeded in 00:00:01.573 ==================
```
