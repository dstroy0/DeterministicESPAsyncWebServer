...
| :------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`           | `native`              |    37 |   ✅   | 00:00:12.537 |
| `test_session`       | `native`              |    19 |   ✅   | 00:00:00.474 |
| `test_presentation`  | `native`              |    63 |   ✅   | 00:00:00.498 |
| `test_transport`     | `native`              |    28 |   ✅   | 00:00:00.475 |
| `test_websocket`     | `native`              |    63 |   ✅   | 00:00:00.518 |
...
| `test_ssh_transport` | `native_ssh`          |    23 |   ✅   | 00:00:00.840 |
...
| `test_multipart`     | `native_app`          |    19 |   ✅   | 00:00:00.819 |
| `test_auth`          | `native_app`          |    13 |   ✅   | 00:00:00.491 |
| `test_file_serving`  | `native_app`          |    12 |   ✅   | 00:00:00.501 |
| `test_dispatch`      | `native_app`          |    10 |   ✅   | 00:00:00.497 |
| `test_application`   | `native_app`          |    47 |   ✅   | 00:00:00.581 |
...
----------------- native:test_sse [PASSED] Took 12.54 seconds ------------------
...
-------------------  ------------------  --------  ------------
native               test_sse            PASSED    00:00:12.537
native               test_session        PASSED    00:00:00.474
native               test_presentation   PASSED    00:00:00.498
native               test_transport      PASSED    00:00:00.475
native               test_websocket      PASSED    00:00:00.518
...
native_ssh           test_ssh_transport  PASSED    00:00:00.840
