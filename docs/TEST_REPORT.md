...
**Generated:** 2026-07-04 23:17:03
**Command:** `pio test` over 129 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 2052 passed - 248s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:10.747 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.635 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.645 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.666 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:04.423 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.663 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.676 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.671 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.673 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.665 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.664 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.655 |
...
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:01.043 |
...
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.843 |
| `test_ssh_transport`     | `native_ssh`            |    31 |   ✅   | 00:00:01.141 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.589 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.983 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.367 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.194 |
...
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.621 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.576 |
...
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.630 |
...
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:01.984 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.821 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.799 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.748 |
...
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.661 |
...
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.772 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.802 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.757 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.686 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.672 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.663 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.652 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.650 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.670 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.663 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.665 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.699 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.693 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.684 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.658 |
...
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.726 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.674 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.660 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.668 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.671 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.679 |
...
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.694 |
...
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.742 |
...
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.071 |
...
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.655 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.669 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.663 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.669 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.667 |
...
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.389 |
...
----------- native_canopen:test_canopen [PASSED] Took 10.75 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:10.747
================= 17 test cases: 17 succeeded in 00:00:10.747 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 154 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.645
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.663
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.676
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.671
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.673
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.655
...
================ 323 test cases: 323 succeeded in 00:00:04.113 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 154 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.043
================= 13 test cases: 13 succeeded in 00:00:01.043 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 154 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.983
================== 2 test cases: 2 succeeded in 00:00:00.983 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 154 tests
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 1.37 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.367
================== 2 test cases: 2 succeeded in 00:00:01.367 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 154 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.194
...
native_app     test_iface             PASSED    00:00:00.621
native_app     test_json              PASSED    00:00:00.576
...
native_app     test_multipart         PASSED    00:00:00.630
...
================ 225 test cases: 225 succeeded in 00:00:11.781 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 154 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.984
================= 15 test cases: 15 succeeded in 00:00:01.984 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 154 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.748
================= 41 test cases: 41 succeeded in 00:00:00.748 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 154 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.661
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.772
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.802
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.686
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.672
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.650
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.670
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.665
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.693
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.684
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.726
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.668
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_smtp    test_smtp  PASSED    00:00:00.809
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_rtc     test_rtc  PASSED    00:00:00.669
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_pca9685  test_pca9685  PASSED    00:00:00.666
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.071
================= 71 test cases: 71 succeeded in 00:00:01.071 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 154 tests
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 1.39 seconds ------------

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.389
================== 2 test cases: 2 succeeded in 00:00:01.389 ==================
```
