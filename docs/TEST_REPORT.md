...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:11.556 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.536 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.581 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.559 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.572 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.524 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.822 |
...
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.522 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.560 |
...
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.644 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.620 |
| `test_workers`          | `native_workers`      |     3 |   ✅   | 00:00:00.694 |
...
----------------- native:test_sse [PASSED] Took 11.56 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:11.556
native               test_session           PASSED    00:00:00.536
native               test_presentation      PASSED    00:00:00.581
native               test_transport         PASSED    00:00:00.559
...
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.211
...
native_app           test_digest_vectors    PASSED    00:00:00.488
native_app           test_form_params       PASSED    00:00:00.545
native_app           test_iface             PASSED    00:00:00.544
native_app           test_json              PASSED    00:00:00.506
native_app           test_response_headers  PASSED    00:00:00.550
...
native_app           test_defer             PASSED    00:00:00.522
native_app           test_multipart         PASSED    00:00:00.560
...
native_app           test_application       PASSED    00:00:00.644
native_compliance    test_compliance        PASSED    00:00:00.620
native_workers       test_workers           PASSED    00:00:00.694
native_tsan          test_concurrency       PASSED    00:00:01.327
================ 620 test cases: 620 succeeded in 00:00:35.767 ================
```
