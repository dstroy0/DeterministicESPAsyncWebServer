...
**Generated:** 2026-06-29 19:36:56
**Command:** `pio test` over 91 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1479 passed - 155s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:07.256 |
...
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.597 |
...
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.930 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.583 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.695 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.895 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.539 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.939 |
...
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.577 |
...
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.654 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.710 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.232 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.179 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.707 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.523 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.506 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.815 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.846 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.761 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.678 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.676 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.731 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.668 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.661 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.695 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.654 |
| `test_protobuf`          | `native_protobuf`       |     8 |   ✅   | 00:00:00.679 |
| `test_wamp`              | `native_wamp`           |    11 |   ✅   | 00:00:00.709 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.674 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.668 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.667 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.658 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |     7 |   ✅   | 00:00:00.672 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.689 |
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.732 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.684 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.683 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.678 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.661 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.658 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.671 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.661 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.686 |
...
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.697 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.876 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.706 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.697 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.679 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.703 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.701 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.722 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.119 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.125 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.687 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.739 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.142 |
| `test_http_client`       | `native_http_client`    |    10 |   ✅   | 00:00:00.687 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.657 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.686 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.704 |
...
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.661 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.709 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.671 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.685 |
...
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.671 |
...
------------------ native:test_sse [PASSED] Took 7.26 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:07.256
...
================ 318 test cases: 318 succeeded in 00:00:10.317 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.930
native_ssh     test_ssh_auth       PASSED    00:00:00.583
native_ssh     test_ssh_server     PASSED    00:00:00.695
native_ssh     test_ssh_transport  PASSED    00:00:00.895
native_ssh     test_ssh_channel    PASSED    00:00:00.539
================= 93 test cases: 93 succeeded in 00:00:06.642 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.939
...
native_app     test_chunked           PASSED    00:00:00.654
native_app     test_application       PASSED    00:00:00.710
================ 219 test cases: 219 succeeded in 00:00:11.841 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.179
================== 2 test cases: 2 succeeded in 00:00:01.179 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
================= 29 test cases: 29 succeeded in 00:00:01.230 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 1.51 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.506
================= 10 test cases: 10 succeeded in 00:00:01.506 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
================= 29 test cases: 29 succeeded in 00:00:00.846 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.731
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.695
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.654
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.679
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.689
...
test/test_hostlink/test_hostlink.cpp:30: test_build_dm_read: Expected '@00RD0000001057*\r' Was '@00RD0000001057*\rc2\xE2\xFF\x7F' [FAILED]
...
---------- native_hostlink:test_hostlink [ERRORED] Took 0.67 seconds ----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  ERRORED   00:00:00.672

============= 8 test cases: 1 failed, 6 succeeded in 00:00:00.672 =============
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
================= 12 test cases: 12 succeeded in 00:00:00.697 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.876
================= 13 test cases: 13 succeeded in 00:00:00.876 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.697
...
================= 29 test cases: 29 succeeded in 00:00:00.701 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.119
================= 10 test cases: 10 succeeded in 00:00:01.119 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
================= 12 test cases: 12 succeeded in 00:00:00.739 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.657
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.686
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.661
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.709
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.801
================== 3 test cases: 3 succeeded in 00:00:00.801 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.236
