...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:11.818 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.640 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.662 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.660 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.677 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.649 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.656 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.676 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.648 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.665 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.656 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.000 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.589 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.622 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.604 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.630 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.592 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.725 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:00.978 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.663 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.683 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.865 |
| `test_ssh_auth`          | `native_ssh`            |    18 |   ✅   | 00:00:00.590 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.836 |
| `test_ssh_transport`     | `native_ssh`            |    27 |   ✅   | 00:00:01.046 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.566 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.903 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.283 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.187 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.625 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.614 |
...
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.208 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.698 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.517 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:01.956 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.799 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.857 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.775 |
...
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.649 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.671 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.659 |
| `test_preempt_queue`     | `native_preempt_queue`  |     7 |   ✅   | 00:00:00.708 |
...
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.712 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.656 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.653 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.655 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.646 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.650 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.641 |
...
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.648 |
...
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.694 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.092 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.090 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.675 |
| `test_jwt`               | `native_jwt`            |    16 |   ✅   | 00:00:00.711 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.122 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.665 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.674 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.683 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.704 |
...
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.051 |
...
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.659 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.669 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.681 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.677 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.672 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.655 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.661 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.655 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.682 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.770 |
...
----------- native_canopen:test_canopen [PASSED] Took 11.82 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:11.818
================= 17 test cases: 17 succeeded in 00:00:11.818 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.640
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.677
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.649
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.656
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.676
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.665
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.656
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.978
================= 10 test cases: 10 succeeded in 00:00:00.978 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.865
native_ssh     test_ssh_auth       PASSED    00:00:00.590
native_ssh     test_ssh_server     PASSED    00:00:00.836
native_ssh     test_ssh_transport  PASSED    00:00:01.046
native_ssh     test_ssh_channel    PASSED    00:00:00.566
================ 120 test cases: 120 succeeded in 00:00:06.902 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.283
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.187
native_app     test_template          PASSED    00:00:00.625
native_app     test_path_params       PASSED    00:00:00.614
...
================ 225 test cases: 225 succeeded in 00:00:11.658 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.208
================== 2 test cases: 2 succeeded in 00:00:01.208 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.698
native_snmp    test_snmp_agent  PASSED    00:00:00.517
================= 35 test cases: 35 succeeded in 00:00:01.215 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.799
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.857
================= 41 test cases: 41 succeeded in 00:00:00.857 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.775
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.649
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.712
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.655
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.650
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.641
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.694
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.090
================= 13 test cases: 13 succeeded in 00:00:01.090 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.711
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.674
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.704
================= 16 test cases: 16 succeeded in 00:00:00.704 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.051
================= 71 test cases: 71 succeeded in 00:00:01.051 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.669
================== 5 test cases: 5 succeeded in 00:00:00.669 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.681
================= 18 test cases: 18 succeeded in 00:00:00.681 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.655
================== 7 test cases: 7 succeeded in 00:00:00.655 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.682
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.770
