...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:03.252 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.746 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.759 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.790 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:04.008 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.766 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.766 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.770 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.781 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.808 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.771 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.772 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.780 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.775 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.777 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.752 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.293 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.678 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.729 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.778 |
| `test_websocket`         | `native`                |    68 |   ✅   | 00:00:00.802 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.740 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.904 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:01.299 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.810 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.790 |
| `test_ssh_crypto`        | `native_ssh`            |    45 |   ✅   | 00:00:04.280 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.746 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.994 |
| `test_ssh_transport`     | `native_ssh`            |    33 |   ✅   | 00:00:01.323 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.693 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.267 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.877 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.547 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.707 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.705 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.640 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.700 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.706 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.669 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.715 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.705 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.746 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.716 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.666 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.724 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.711 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.748 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.712 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.715 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.841 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.592 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.533 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.835 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.630 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:02.456 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.956 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.925 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.910 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.777 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.756 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.905 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.771 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.767 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.787 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.765 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.771 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.825 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.916 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.992 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.920 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.777 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.759 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.780 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.760 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.767 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.758 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.750 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.758 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.795 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.766 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.751 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.765 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.769 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.764 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.758 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.761 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.875 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.757 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.760 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.751 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.748 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.758 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.764 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.753 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.749 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.763 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.754 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.800 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.809 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.753 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.805 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.762 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.774 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.751 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.816 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:01.040 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.780 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.777 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.753 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.812 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.851 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.826 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.475 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.457 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.795 |
| `test_smtp`              | `native_smtp`           |    11 |   ✅   | 00:00:00.896 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.763 |
| `test_dns_server`        | `native_dns_server`     |     7 |   ✅   | 00:00:00.765 |
| `test_rtc`               | `native_rtc`            |     8 |   ✅   | 00:00:00.765 |
| `test_ld2410`            | `native_ld2410`         |     7 |   ✅   | 00:00:00.782 |
| `test_mpr121`            | `native_mpr121`         |     5 |   ✅   | 00:00:00.779 |
| `test_sht3x`             | `native_sht3x`          |     5 |   ✅   | 00:00:00.768 |
| `test_pca9685`           | `native_pca9685`        |     4 |   ✅   | 00:00:00.765 |
| `test_ads1115`           | `native_ads1115`        |     3 |   ✅   | 00:00:00.742 |
| `test_ina219`            | `native_ina219`         |     4 |   ✅   | 00:00:00.747 |
| `test_hpack`             | `native_hpack`          |     7 |   ✅   | 00:00:00.893 |
| `test_h2_frame`          | `native_h2frame`        |     6 |   ✅   | 00:00:00.754 |
| `test_h2_conn`           | `native_h2conn`         |     4 |   ✅   | 00:00:01.053 |
| `test_quic_varint`       | `native_quic_varint`    |     3 |   ✅   | 00:00:00.751 |
| `test_h3_frame`          | `native_h3frame`        |     7 |   ✅   | 00:00:00.838 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.841 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.464 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.780 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.827 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.789 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.815 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.809 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.803 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.774 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.818 |
| `test_ssh_zlib`          | `native_ssh_zlib`       |     9 |   ✅   | 00:00:00.847 |
| `test_ssh_comp`          | `native_ssh_comp`       |     5 |   ✅   | 00:00:01.343 |
| `test_websocket`         | `native_ws_deflate`     |    72 |   ✅   | 00:00:01.414 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.761 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.788 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.807 |
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.832 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.845 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.807 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.779 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.761 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.777 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.815 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.787 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.788 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.776 |
| `test_statsd`            | `native_statsd`         |     9 |   ✅   | 00:00:00.805 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.773 |
| `test_failsafe`          | `native_failsafe`       |     6 |   ✅   | 00:00:00.774 |
| `test_sleep_sched`       | `native_sleep_sched`    |     8 |   ✅   | 00:00:00.786 |
| `test_wearlevel`         | `native_wearlevel`      |     5 |   ✅   | 00:00:00.768 |
| `test_netadapt`          | `native_netadapt`       |     6 |   ✅   | 00:00:00.754 |
| `test_dshot`             | `native_dshot`          |     7 |   ✅   | 00:00:00.774 |
| `test_hart`              | `native_hart`           |     6 |   ✅   | 00:00:00.784 |
| `test_nts`               | `native_nts`            |     4 |   ✅   | 00:00:00.778 |
| `test_dds`               | `native_dds`            |     4 |   ✅   | 00:00:00.759 |
| `test_xmpp`              | `native_xmpp`           |     6 |   ✅   | 00:00:00.773 |
| `test_rawl2`             | `native_rawl2`          |     4 |   ✅   | 00:00:00.762 |
| `test_spa_router`        | `native_spa_router`     |     2 |   ✅   | 00:00:00.764 |
| `test_goose`             | `native_goose`          |     3 |   ✅   | 00:00:00.773 |
| `test_mtconnect`         | `native_mtconnect`      |     4 |   ✅   | 00:00:00.784 |
| `test_j2735`             | `native_j2735`          |     8 |   ✅   | 00:00:00.787 |
| `test_nema_ts2`          | `native_nema_ts2`       |     4 |   ✅   | 00:00:00.763 |
| `test_snp`               | `native_snp`            |     4 |   ✅   | 00:00:00.749 |
| `test_directnet`         | `native_directnet`      |     4 |   ✅   | 00:00:00.776 |
| `test_sep2`              | `native_sep2`           |     5 |   ✅   | 00:00:00.752 |
| `test_profinet`          | `native_profinet`       |     4 |   ✅   | 00:00:00.754 |
| `test_ntcip`             | `native_ntcip`          |     3 |   ✅   | 00:00:00.758 |
| `test_openadr`           | `native_openadr`        |     4 |   ✅   | 00:00:00.762 |
| `test_mms`               | `native_mms`            |     4 |   ✅   | 00:00:00.755 |
| `test_cclink`            | `native_cclink`         |     4 |   ✅   | 00:00:00.755 |
| `test_powerlink`         | `native_powerlink`      |     3 |   ✅   | 00:00:00.755 |
| `test_sercos`            | `native_sercos`         |     3 |   ✅   | 00:00:00.768 |
| `test_profibus`          | `native_profibus`       |     4 |   ✅   | 00:00:00.764 |
| `test_lonworks`          | `native_lonworks`       |     4 |   ✅   | 00:00:00.765 |
| `test_mbplus`            | `native_mbplus`         |     5 |   ✅   | 00:00:00.758 |
| `test_interbus`          | `native_interbus`       |     4 |   ✅   | 00:00:00.769 |
| `test_iccp`              | `native_iccp`           |     4 |   ✅   | 00:00:00.780 |
| `test_wave`              | `native_wave`           |     4 |   ✅   | 00:00:00.758 |
| `test_utmc`              | `native_utmc`           |     5 |   ✅   | 00:00:00.778 |
| `test_ocit`              | `native_ocit`           |     4 |   ✅   | 00:00:00.773 |
| `test_atc`               | `native_atc`            |     4 |   ✅   | 00:00:00.805 |
| `test_southbound`        | `native_southbound`     |     5 |   ✅   | 00:00:00.786 |
| `test_exc_decoder`       | `native_exc_decoder`    |     5 |   ✅   | 00:00:00.774 |
| `test_http_delivery`     | `native_http_delivery`  |     6 |   ✅   | 00:00:00.775 |
| `test_hw_health`         | `native_hw_health`      |     5 |   ✅   | 00:00:00.767 |
| `test_mdns_adaptive`     | `native_mdns_adaptive`  |     4 |   ✅   | 00:00:00.761 |
| `test_sockpool`          | `native_sockpool`       |     5 |   ✅   | 00:00:00.775 |
| `test_psram_pool`        | `native_psram_pool`     |     5 |   ✅   | 00:00:00.772 |
| `test_happy_eyeballs`    | `native_happy_eyeballs` |     4 |   ✅   | 00:00:00.807 |
| `test_wifi_sniffer`      | `native_wifi_sniffer`   |     5 |   ✅   | 00:00:00.785 |
| `test_link_manager`      | `native_link_manager`   |     4 |   ✅   | 00:00:00.782 |
| `test_cc1101`            | `native_cc1101`         |    10 |   ✅   | 00:00:00.786 |
| `test_fdc2214`           | `native_fdc2214`        |     4 |   ✅   | 00:00:00.774 |
| `test_ldc1614`           | `native_ldc1614`        |     4 |   ✅   | 00:00:00.756 |
| `test_vl53l0x`           | `native_vl53l0x`        |     3 |   ✅   | 00:00:00.761 |
| `test_radio_sniff`       | `native_radio_sniff`    |     4 |   ✅   | 00:00:00.765 |
| `test_ble_gatt`          | `native_ble_gatt`       |     4 |   ✅   | 00:00:00.763 |
| `test_tls_policy`        | `native_tls_policy`     |     4 |   ✅   | 00:00:00.764 |
| `test_wisun`             | `native_wisun`          |     5 |   ✅   | 00:00:00.822 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.769 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.818 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.913 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.758 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.886 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.274 |
| `test_qpack`             | `native_qpack`          |     9 |   ✅   | 00:00:00.887 |
| `test_quic_packet`       | `native_quic_packet`    |     8 |   ✅   | 00:00:00.757 |
| `test_quic_frame`        | `native_quic_frame`     |     8 |   ✅   | 00:00:00.790 |
| `test_quic_crypto`       | `native_quic_crypto`    |     7 |   ✅   | 00:00:00.914 |
| `test_tls13_kdf`         | `native_tls13_kdf`      |     5 |   ✅   | 00:00:00.829 |
| `test_quic_tp`           | `native_quic_tp`        |     7 |   ✅   | 00:00:00.791 |
| `test_tls13_msg`         | `native_tls13_msg`      |     7 |   ✅   | 00:00:00.914 |
| `test_quic_tls`          | `native_quic_tls`       |    11 |   ✅   | 00:00:01.167 |
| `test_quic_conn`         | `native_quic_conn`      |     4 |   ✅   | 00:00:01.249 |
| `test_h3_conn`           | `native_h3_conn`        |    11 |   ✅   | 00:00:01.234 |
| `test_h3_e2e`            | `native_h3_e2e`         |     1 |   ✅   | 00:00:01.245 |
| `test_quic_server`       | `native_quic_server`    |     2 |   ✅   | 00:00:01.325 |
| `test_h3_server`         | `native_h3_server`      |     1 |   ✅   | 00:00:02.069 |
| `test_ssh_chachapoly`    | `native_ssh_chachapoly` |     4 |   ✅   | 00:00:00.803 |
...
|  33 | `test_begin_rekey_preserves_session_and_auth`              |   ✅   | Begin rekey preserves session and auth                                       |
...
|   3 | `test_cint_roundtrip`       |   ✅   | Cint roundtrip                                                                                |
|   4 | `test_bsm_core_roundtrip`   |   ✅   | Bsm core roundtrip                                                                            |
|   5 | `test_bsm_core_bit_length`  |   ✅   | msgCnt 7 + id 32 + secMark 16 + lat 31 + long 32 + elev 16 + speed 13 + heading 15 = 162 bits |
|   6 | `test_spat_roundtrip`       |   ✅   | Spat roundtrip                                                                                |
|   7 | `test_spat_decode_too_many` |   ✅   | Only room for 1 but 2 encoded -> false.                                                       |
|   8 | `test_map_roundtrip`        |   ✅   | Map roundtrip                                                                                 |
...
------------ native_canopen:test_canopen [PASSED] Took 3.25 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:03.252
================= 17 test cases: 17 succeeded in 00:00:03.252 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
----- native_det_primitives:test_det_primitives [PASSED] Took 0.75 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.746
...
------------- native_det_ip:test_det_ip [PASSED] Took 0.76 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.759
...
---------- native_det_arena:test_det_arena [PASSED] Took 0.79 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_det_arena  test_det_arena  PASSED    00:00:00.790
================= 17 test cases: 17 succeeded in 00:00:00.790 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
-------- native_ssh_ed25519:test_ssh_ed25519 [PASSED] Took 4.01 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:04.008
================= 16 test cases: 16 succeeded in 00:00:04.008 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------ native_promisc:test_promisc [PASSED] Took 0.77 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.766
...
-------- native_bus_capture:test_bus_capture [PASSED] Took 0.77 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.766
...
-------------- native_j1939:test_j1939 [PASSED] Took 0.77 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.770
...
---------- native_devicenet:test_devicenet [PASSED] Took 0.78 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.781
...
----------- native_nmea2000:test_nmea2000 [PASSED] Took 0.81 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.808
...
--------------- native_mbus:test_mbus [PASSED] Took 0.77 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.771
================= 11 test cases: 11 succeeded in 00:00:00.771 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
----------- native_iec60870:test_iec60870 [PASSED] Took 0.77 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.772
...
-------------- native_sdi12:test_sdi12 [PASSED] Took 0.78 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.780
...
---------------- native_dmx:test_dmx [PASSED] Took 0.77 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.775
...
----------- native_nmea0183:test_nmea0183 [PASSED] Took 0.78 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.777
...
------------- native_iolink:test_iolink [PASSED] Took 0.75 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.752
...
------------------ native:test_sse [PASSED] Took 1.29 seconds ------------------
...
---------------- native:test_session [PASSED] Took 0.68 seconds ----------------
...
------------- native:test_presentation [PASSED] Took 0.73 seconds --------------
...
--------------- native:test_transport [PASSED] Took 0.78 seconds ---------------
...
--------------- native:test_websocket [PASSED] Took 0.80 seconds ---------------
...
native         test_session       PASSED    00:00:00.678
native         test_presentation  PASSED    00:00:00.729
native         test_transport     PASSED    00:00:00.778
native         test_websocket     PASSED    00:00:00.802
native         test_http_parser   PASSED    00:00:00.740
================ 324 test cases: 324 succeeded in 00:00:05.020 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.904
================= 17 test cases: 17 succeeded in 00:00:00.904 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
-------- native_accept_gate:test_accept_gate [PASSED] Took 1.30 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.299
================= 13 test cases: 13 succeeded in 00:00:01.299 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------- native_ota:test_http_ota [PASSED] Took 0.81 seconds --------------

=================================== SUMMARY ===================================
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.810
================== 3 test cases: 3 succeeded in 00:00:00.810 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
----------- native_prov:test_provisioning [PASSED] Took 0.79 seconds -----------

=================================== SUMMARY ===================================
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.790
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 4.28 seconds -------------
...
------------- native_ssh:test_ssh_auth [PASSED] Took 0.75 seconds --------------
...
------------ native_ssh:test_ssh_server [PASSED] Took 0.99 seconds -------------
...
----------- native_ssh:test_ssh_transport [PASSED] Took 1.32 seconds -----------
...
------------ native_ssh:test_ssh_channel [PASSED] Took 0.69 seconds ------------

=================================== SUMMARY ===================================
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.280
native_ssh     test_ssh_auth       PASSED    00:00:00.746
native_ssh     test_ssh_server     PASSED    00:00:00.994
native_ssh     test_ssh_transport  PASSED    00:00:01.323
native_ssh     test_ssh_channel    PASSED    00:00:00.693
================ 145 test cases: 145 succeeded in 00:00:08.036 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------ native_ssh_hardened:test_ssh_hardening [PASSED] Took 1.27 seconds -------

=================================== SUMMARY ===================================
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:01.267
================== 2 test cases: 2 succeeded in 00:00:01.267 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 1.88 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.877
================== 2 test cases: 2 succeeded in 00:00:01.877 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
--------------- native_app:test_regex [PASSED] Took 1.55 seconds ---------------
...
------------- native_app:test_template [PASSED] Took 0.71 seconds --------------
...
------------ native_app:test_path_params [PASSED] Took 0.70 seconds ------------
...
---------- native_app:test_digest_vectors [PASSED] Took 0.64 seconds -----------
...
------------ native_app:test_form_params [PASSED] Took 0.70 seconds ------------
...
--------------- native_app:test_iface [PASSED] Took 0.71 seconds ---------------
...
--------------- native_app:test_json [PASSED] Took 0.67 seconds ----------------
...
--------- native_app:test_response_headers [PASSED] Took 0.72 seconds ----------
...
------------ native_app:test_digest_auth [PASSED] Took 0.75 seconds ------------
...
----------- native_app:test_web_terminal [PASSED] Took 0.72 seconds ------------
...
------------- native_app:test_multipart [PASSED] Took 0.72 seconds -------------
...
--------------- native_app:test_auth [PASSED] Took 0.71 seconds ----------------
...
----------- native_app:test_file_serving [PASSED] Took 0.75 seconds ------------
...
------------- native_app:test_dispatch [PASSED] Took 0.71 seconds --------------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.547
native_app     test_template          PASSED    00:00:00.707
native_app     test_path_params       PASSED    00:00:00.705
native_app     test_digest_vectors    PASSED    00:00:00.640
native_app     test_form_params       PASSED    00:00:00.700
native_app     test_iface             PASSED    00:00:00.706
native_app     test_json              PASSED    00:00:00.669
native_app     test_response_headers  PASSED    00:00:00.715
native_app     test_middleware        PASSED    00:00:00.705
native_app     test_digest_auth       PASSED    00:00:00.746
native_app     test_web_terminal      PASSED    00:00:00.716
native_app     test_defer             PASSED    00:00:00.666
native_app     test_multipart         PASSED    00:00:00.724
native_app     test_auth              PASSED    00:00:00.711
native_app     test_file_serving      PASSED    00:00:00.748
native_app     test_dispatch          PASSED    00:00:00.712
native_app     test_chunked           PASSED    00:00:00.715
native_app     test_application       PASSED    00:00:00.841
================ 225 test cases: 225 succeeded in 00:00:13.672 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
----- native_webdav_handler:test_webdav_handler [PASSED] Took 1.59 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.592
================= 12 test cases: 12 succeeded in 00:00:01.592 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
--------------- native_diag:test_diag [PASSED] Took 1.53 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.533
================== 2 test cases: 2 succeeded in 00:00:01.533 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------- native_snmp:test_snmp_ber [PASSED] Took 0.84 seconds -------------
...
------------ native_snmp:test_snmp_agent [PASSED] Took 0.63 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.835
native_snmp    test_snmp_agent  PASSED    00:00:00.630
================= 35 test cases: 35 succeeded in 00:00:01.466 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 2.46 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:02.456
================= 15 test cases: 15 succeeded in 00:00:02.456 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------- native_telnet:test_telnet [PASSED] Took 0.96 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.956
================= 15 test cases: 15 succeeded in 00:00:00.956 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
--------------- native_coap:test_coap [PASSED] Took 0.93 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.925
================= 41 test cases: 41 succeeded in 00:00:00.925 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
test/test_coap/test_coap.cpp:1076: test_well_known_core_discovery       [PASSED]
test/test_coap/test_coap.cpp:1077: test_well_known_core_rejects_post    [PASSED]
----------- native_coap_observe:test_coap [PASSED] Took 0.91 seconds -----------
...
------------- native_webdav:test_webdav [PASSED] Took 0.78 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.777
================= 19 test cases: 19 succeeded in 00:00:00.777 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------- native_modbus:test_modbus [PASSED] Took 0.76 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.756
================= 22 test cases: 22 succeeded in 00:00:00.756 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
-------- native_cloudevents:test_cloudevents [PASSED] Took 0.90 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.905
...
----------- native_redis:test_redis_resp [PASSED] Took 0.77 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.771
...
-------------- native_stomp:test_stomp [PASSED] Took 0.77 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.767
...
------------ native_mqtt_sn:test_mqtt_sn [PASSED] Took 0.79 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.787
...
-------- native_flow_export:test_flow_export [PASSED] Took 0.76 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.765
...
----------- native_protobuf:test_protobuf [PASSED] Took 0.77 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.771
================= 13 test cases: 13 succeeded in 00:00:00.771 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------ native_preempt_queue:test_preempt_queue [PASSED] Took 0.82 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.825
================= 11 test cases: 11 succeeded in 00:00:00.825 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
---------------- native_dma:test_dma [PASSED] Took 0.92 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.916
...
------------ native_forward:test_forward [PASSED] Took 0.99 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.992
================= 16 test cases: 16 succeeded in 00:00:00.992 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------ native_gateway:test_gateway [PASSED] Took 0.92 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.920
================= 11 test cases: 11 succeeded in 00:00:00.920 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
--------------- native_lora:test_lora [PASSED] Took 0.78 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.777
================= 13 test cases: 13 succeeded in 00:00:00.777 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
-------------- native_nrf24:test_nrf24 [PASSED] Took 0.76 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.759
================= 10 test cases: 10 succeeded in 00:00:00.759 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------ native_enocean:test_enocean [PASSED] Took 0.78 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.780
================== 9 test cases: 9 succeeded in 00:00:00.780 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_pn532   test_pn532  PASSED    00:00:00.760
================= 10 test cases: 10 succeeded in 00:00:00.760 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------- native_sigfox:test_sigfox [PASSED] Took 0.77 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.767
...
-------------- native_zwave:test_zwave [PASSED] Took 0.76 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.758
================== 9 test cases: 9 succeeded in 00:00:00.758 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_zigbee  test_zigbee  PASSED    00:00:00.750
...
------------- native_thread:test_thread [PASSED] Took 0.76 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.758
...
--------------- native_wamp:test_wamp [PASSED] Took 0.79 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.795
================= 12 test cases: 12 succeeded in 00:00:00.795 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------ native_sunspec:test_sunspec [PASSED] Took 0.77 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.766
================== 5 test cases: 5 succeeded in 00:00:00.766 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------- native_c37118:test_c37118 [PASSED] Took 0.75 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.751
================== 6 test cases: 6 succeeded in 00:00:00.751 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
--------------- native_dnp3:test_dnp3 [PASSED] Took 0.77 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.765
================== 8 test cases: 8 succeeded in 00:00:00.765 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.769
================== 7 test cases: 7 succeeded in 00:00:00.769 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
---------- native_lwm2m_tlv:test_lwm2m_tlv [PASSED] Took 0.76 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.764
================= 11 test cases: 11 succeeded in 00:00:00.764 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.758
...
----------- native_hostlink:test_hostlink [PASSED] Took 0.76 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.761
...
-------------- native_senml:test_senml [PASSED] Took 0.87 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.875
================== 9 test cases: 9 succeeded in 00:00:00.875 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
---------------- native_df1:test_df1 [PASSED] Took 0.76 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.757
...
--------------- native_cotp:test_cotp [PASSED] Took 0.76 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.760
================== 6 test cases: 6 succeeded in 00:00:00.760 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------- native_s7comm:test_s7comm [PASSED] Took 0.75 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.751
================== 8 test cases: 8 succeeded in 00:00:00.751 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------- native_melsec:test_melsec [PASSED] Took 0.75 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.748
...
------------- native_bacnet:test_bacnet [PASSED] Took 0.76 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.758
================== 9 test cases: 9 succeeded in 00:00:00.758 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.764
================== 6 test cases: 6 succeeded in 00:00:00.764 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
--------------- native_amqp:test_amqp [PASSED] Took 0.75 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.753
================== 7 test cases: 7 succeeded in 00:00:00.753 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
---------------- native_cip:test_cip [PASSED] Took 0.75 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.749
...
--------------- native_nats:test_nats [PASSED] Took 0.76 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.763
================= 14 test cases: 14 succeeded in 00:00:00.763 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
----- native_proxy_protocol:test_proxy_protocol [PASSED] Took 0.75 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.754
...
---------- native_sparkplug:test_sparkplug [PASSED] Took 0.80 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.800
...
------ native_modbus_master:test_modbus_master [PASSED] Took 0.81 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.809
================== 5 test cases: 5 succeeded in 00:00:00.809 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------- native_ota_rollback:test_ota_rollback [PASSED] Took 0.75 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.753
...
--------------- native_totp:test_totp [PASSED] Took 0.81 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.805
...
------------ native_webhook:test_webhook [PASSED] Took 0.76 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.762
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.774
...
------- native_dns_resolver:test_dns_resolver [PASSED] Took 0.75 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.751
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.816
================= 16 test cases: 16 succeeded in 00:00:00.816 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
--------------- native_oidc:test_oidc [PASSED] Took 1.04 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:01.040
================= 17 test cases: 17 succeeded in 00:00:01.040 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
---------------- native_vfs:test_vfs [PASSED] Took 0.78 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.780
================= 11 test cases: 11 succeeded in 00:00:00.780 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------ native_graphql:test_graphql [PASSED] Took 0.78 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.777
================= 32 test cases: 32 succeeded in 00:00:00.777 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------- native_espnow:test_espnow [PASSED] Took 0.75 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.753
================== 7 test cases: 7 succeeded in 00:00:00.753 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------- native_oauth2:test_oauth2 [PASSED] Took 0.81 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.812
================== 8 test cases: 8 succeeded in 00:00:00.812 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
-------------- native_opcua:test_opcua [PASSED] Took 0.85 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.851
================= 38 test cases: 38 succeeded in 00:00:00.851 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------- native_opcua_client:test_opcua_client [PASSED] Took 0.83 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.826
================= 14 test cases: 14 succeeded in 00:00:00.826 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
---------- native_keepalive:test_keepalive [PASSED] Took 1.48 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.475
================= 10 test cases: 10 succeeded in 00:00:01.475 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
-------------- native_range:test_range [PASSED] Took 1.46 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.457
================= 13 test cases: 13 succeeded in 00:00:01.457 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------- native_syslog:test_syslog [PASSED] Took 0.79 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.795
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_smtp    test_smtp  PASSED    00:00:00.896
================= 11 test cases: 11 succeeded in 00:00:00.896 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_ntp_server  test_ntp_server  PASSED    00:00:00.763
================== 8 test cases: 8 succeeded in 00:00:00.763 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
--------- native_dns_server:test_dns_server [PASSED] Took 0.76 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_dns_server  test_dns_server  PASSED    00:00:00.765
...
---------------- native_rtc:test_rtc [PASSED] Took 0.77 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_rtc     test_rtc  PASSED    00:00:00.765
================== 8 test cases: 8 succeeded in 00:00:00.765 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ld2410  test_ld2410  PASSED    00:00:00.782
...
------------- native_mpr121:test_mpr121 [PASSED] Took 0.78 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_mpr121  test_mpr121  PASSED    00:00:00.779
================== 5 test cases: 5 succeeded in 00:00:00.779 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
-------------- native_sht3x:test_sht3x [PASSED] Took 0.77 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sht3x   test_sht3x  PASSED    00:00:00.768
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_pca9685  test_pca9685  PASSED    00:00:00.765
================== 4 test cases: 4 succeeded in 00:00:00.765 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------ native_ads1115:test_ads1115 [PASSED] Took 0.74 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_ads1115  test_ads1115  PASSED    00:00:00.742
================== 3 test cases: 3 succeeded in 00:00:00.742 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------- native_ina219:test_ina219 [PASSED] Took 0.75 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ina219  test_ina219  PASSED    00:00:00.747
...
-------------- native_hpack:test_hpack [PASSED] Took 0.89 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_hpack   test_hpack  PASSED    00:00:00.893
...
----------- native_h2frame:test_h2_frame [PASSED] Took 0.75 seconds ------------

=================================== SUMMARY ===================================
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h2frame  test_h2_frame  PASSED    00:00:00.754
...
Environment    Test          Status    Duration
-------------  ------------  --------  ------------
native_h2conn  test_h2_conn  PASSED    00:00:01.053
================== 4 test cases: 4 succeeded in 00:00:01.053 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
-------- native_quic_varint:test_quic_varint [PASSED] Took 0.75 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_varint  test_quic_varint  PASSED    00:00:00.751
...
----------- native_h3frame:test_h3_frame [PASSED] Took 0.84 seconds ------------

=================================== SUMMARY ===================================
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h3frame  test_h3_frame  PASSED    00:00:00.838
================== 7 test cases: 7 succeeded in 00:00:00.838 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.841
================= 21 test cases: 21 succeeded in 00:00:00.841 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------- native_upload:test_upload [PASSED] Took 1.46 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.464
================== 3 test cases: 3 succeeded in 00:00:01.464 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
-------- native_http_client:test_http_client [PASSED] Took 0.78 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.780
================= 15 test cases: 15 succeeded in 00:00:00.780 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
--------- native_compliance:test_compliance [PASSED] Took 0.83 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.827
================= 15 test cases: 15 succeeded in 00:00:00.827 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.789
================= 22 test cases: 22 succeeded in 00:00:00.789 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.815
================= 16 test cases: 16 succeeded in 00:00:00.815 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------ native_scratch:test_scratch [PASSED] Took 0.81 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.809
================= 14 test cases: 14 succeeded in 00:00:00.809 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------ native_inflate:test_inflate [PASSED] Took 0.77 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.774
================= 12 test cases: 12 succeeded in 00:00:00.774 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------ native_deflate:test_deflate [PASSED] Took 0.82 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.818
================= 10 test cases: 10 succeeded in 00:00:00.818 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
----------- native_ssh_zlib:test_ssh_zlib [PASSED] Took 0.85 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_zlib  test_ssh_zlib  PASSED    00:00:00.847
================== 9 test cases: 9 succeeded in 00:00:00.847 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
----------- native_ssh_comp:test_ssh_comp [PASSED] Took 1.34 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_comp  test_ssh_comp  PASSED    00:00:01.343
================== 5 test cases: 5 succeeded in 00:00:01.343 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.414
================= 72 test cases: 72 succeeded in 00:00:01.414 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
-------- native_time_source:test_time_source [PASSED] Took 0.76 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.761
...
------- native_config_store:test_config_store [PASSED] Took 0.79 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.788
================= 14 test cases: 14 succeeded in 00:00:00.788 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
---------- native_device_id:test_device_id [PASSED] Took 0.81 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.807
================== 4 test cases: 4 succeeded in 00:00:00.807 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------- native_auth_lockout:test_auth_lockout [PASSED] Took 0.83 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.832
================= 11 test cases: 11 succeeded in 00:00:00.832 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
--------------- native_csrf:test_csrf [PASSED] Took 0.85 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.845
================== 9 test cases: 9 succeeded in 00:00:00.845 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
---------- native_telemetry:test_telemetry [PASSED] Took 0.81 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.807
================== 8 test cases: 8 succeeded in 00:00:00.807 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.779
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.761
================== 6 test cases: 6 succeeded in 00:00:00.761 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------ native_partition:test_partition_monitor [PASSED] Took 0.78 seconds ------

=================================== SUMMARY ===================================
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.777
================== 5 test cases: 5 succeeded in 00:00:00.777 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
--------------- native_cbor:test_cbor [PASSED] Took 0.81 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.815
================= 18 test cases: 18 succeeded in 00:00:00.815 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------ native_msgpack:test_msgpack [PASSED] Took 0.79 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.787
================= 17 test cases: 17 succeeded in 00:00:00.787 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
----------- native_gpio_map:test_gpio_map [PASSED] Took 0.79 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.788
...
------ native_udp_telemetry:test_udp_telemetry [PASSED] Took 0.78 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.776
...
------------- native_statsd:test_statsd [PASSED] Took 0.80 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_statsd  test_statsd  PASSED    00:00:00.805
================== 9 test cases: 9 succeeded in 00:00:00.805 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
--------- native_guardrails:test_guardrails [PASSED] Took 0.77 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.773
...
----------- native_failsafe:test_failsafe [PASSED] Took 0.77 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_failsafe  test_failsafe  PASSED    00:00:00.774
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_sleep_sched  test_sleep_sched  PASSED    00:00:00.786
...
---------- native_wearlevel:test_wearlevel [PASSED] Took 0.77 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_wearlevel  test_wearlevel  PASSED    00:00:00.768
================== 5 test cases: 5 succeeded in 00:00:00.768 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
----------- native_netadapt:test_netadapt [PASSED] Took 0.75 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_netadapt  test_netadapt  PASSED    00:00:00.754
================== 6 test cases: 6 succeeded in 00:00:00.754 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
-------------- native_dshot:test_dshot [PASSED] Took 0.77 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_dshot   test_dshot  PASSED    00:00:00.774
...
--------------- native_hart:test_hart [PASSED] Took 0.78 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_hart    test_hart  PASSED    00:00:00.784
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_nts     test_nts  PASSED    00:00:00.778
================== 4 test cases: 4 succeeded in 00:00:00.778 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
---------------- native_dds:test_dds [PASSED] Took 0.76 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dds     test_dds  PASSED    00:00:00.759
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_xmpp    test_xmpp  PASSED    00:00:00.773
================== 6 test cases: 6 succeeded in 00:00:00.773 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
-------------- native_rawl2:test_rawl2 [PASSED] Took 0.76 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_rawl2   test_rawl2  PASSED    00:00:00.762
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_spa_router  test_spa_router  PASSED    00:00:00.764
================== 2 test cases: 2 succeeded in 00:00:00.764 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
-------------- native_goose:test_goose [PASSED] Took 0.77 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_goose   test_goose  PASSED    00:00:00.773
================== 3 test cases: 3 succeeded in 00:00:00.773 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_mtconnect  test_mtconnect  PASSED    00:00:00.784
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_j2735/test_j2735.cpp:157: test_cint_bits                      [PASSED]
test/test_j2735/test_j2735.cpp:158: test_bit_writer_pattern             [PASSED]
test/test_j2735/test_j2735.cpp:159: test_cint_roundtrip                 [PASSED]
test/test_j2735/test_j2735.cpp:160: test_bsm_core_roundtrip             [PASSED]
test/test_j2735/test_j2735.cpp:161: test_bsm_core_bit_length            [PASSED]
test/test_j2735/test_j2735.cpp:162: test_spat_roundtrip                 [PASSED]
test/test_j2735/test_j2735.cpp:163: test_spat_decode_too_many           [PASSED]
test/test_j2735/test_j2735.cpp:164: test_map_roundtrip                  [PASSED]
-------------- native_j2735:test_j2735 [PASSED] Took 0.79 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j2735   test_j2735  PASSED    00:00:00.787
================== 8 test cases: 8 succeeded in 00:00:00.787 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nema_ts2  test_nema_ts2  PASSED    00:00:00.763
...
---------------- native_snp:test_snp [PASSED] Took 0.75 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_snp     test_snp  PASSED    00:00:00.749
...
---------- native_directnet:test_directnet [PASSED] Took 0.78 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_directnet  test_directnet  PASSED    00:00:00.776
...
--------------- native_sep2:test_sep2 [PASSED] Took 0.75 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_sep2    test_sep2  PASSED    00:00:00.752
================== 5 test cases: 5 succeeded in 00:00:00.752 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
----------- native_profinet:test_profinet [PASSED] Took 0.75 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_profinet  test_profinet  PASSED    00:00:00.754
...
-------------- native_ntcip:test_ntcip [PASSED] Took 0.76 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_ntcip   test_ntcip  PASSED    00:00:00.758
================== 3 test cases: 3 succeeded in 00:00:00.758 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------ native_openadr:test_openadr [PASSED] Took 0.76 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_openadr  test_openadr  PASSED    00:00:00.762
================== 4 test cases: 4 succeeded in 00:00:00.762 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
---------------- native_mms:test_mms [PASSED] Took 0.75 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_mms     test_mms  PASSED    00:00:00.755
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_cclink  test_cclink  PASSED    00:00:00.755
================== 4 test cases: 4 succeeded in 00:00:00.755 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
---------- native_powerlink:test_powerlink [PASSED] Took 0.75 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_powerlink  test_powerlink  PASSED    00:00:00.755
...
------------- native_sercos:test_sercos [PASSED] Took 0.77 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sercos  test_sercos  PASSED    00:00:00.768
================== 3 test cases: 3 succeeded in 00:00:00.768 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_profibus  test_profibus  PASSED    00:00:00.764
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_lonworks  test_lonworks  PASSED    00:00:00.765
================== 4 test cases: 4 succeeded in 00:00:00.765 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------- native_mbplus:test_mbplus [PASSED] Took 0.76 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_mbplus  test_mbplus  PASSED    00:00:00.758
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_interbus  test_interbus  PASSED    00:00:00.769
...
--------------- native_iccp:test_iccp [PASSED] Took 0.78 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_iccp    test_iccp  PASSED    00:00:00.780
...
--------------- native_wave:test_wave [PASSED] Took 0.76 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wave    test_wave  PASSED    00:00:00.758
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_utmc    test_utmc  PASSED    00:00:00.778
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_ocit    test_ocit  PASSED    00:00:00.773
================== 4 test cases: 4 succeeded in 00:00:00.773 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
---------------- native_atc:test_atc [PASSED] Took 0.80 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_atc     test_atc  PASSED    00:00:00.805
================== 4 test cases: 4 succeeded in 00:00:00.805 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
--------- native_southbound:test_southbound [PASSED] Took 0.79 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_southbound  test_southbound  PASSED    00:00:00.786
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_exc_decoder  test_exc_decoder  PASSED    00:00:00.774
...
------ native_http_delivery:test_http_delivery [PASSED] Took 0.77 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_http_delivery  test_http_delivery  PASSED    00:00:00.775
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_hw_health/test_hw_health.cpp:95: test_rail_monitor            [PASSED]
test/test_hw_health/test_hw_health.cpp:96: test_spi_backoff             [PASSED]
test/test_hw_health/test_hw_health.cpp:97: test_spi_backoff_clamps      [PASSED]
test/test_hw_health/test_hw_health.cpp:98: test_gpio_short              [PASSED]
test/test_hw_health/test_hw_health.cpp:99: test_cap_leak                [PASSED]
---------- native_hw_health:test_hw_health [PASSED] Took 0.77 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_hw_health  test_hw_health  PASSED    00:00:00.767
================== 5 test cases: 5 succeeded in 00:00:00.767 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------ native_mdns_adaptive:test_mdns_adaptive [PASSED] Took 0.76 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_mdns_adaptive  test_mdns_adaptive  PASSED    00:00:00.761
...
----------- native_sockpool:test_sockpool [PASSED] Took 0.78 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_sockpool  test_sockpool  PASSED    00:00:00.775
================== 5 test cases: 5 succeeded in 00:00:00.775 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
--------- native_psram_pool:test_psram_pool [PASSED] Took 0.77 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_psram_pool  test_psram_pool  PASSED    00:00:00.772
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_happy_eyeballs  test_happy_eyeballs  PASSED    00:00:00.807
================== 4 test cases: 4 succeeded in 00:00:00.807 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------- native_wifi_sniffer:test_wifi_sniffer [PASSED] Took 0.78 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_wifi_sniffer  test_wifi_sniffer  PASSED    00:00:00.785
...
------- native_link_manager:test_link_manager [PASSED] Took 0.78 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_link_manager  test_link_manager  PASSED    00:00:00.782
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_cc1101  test_cc1101  PASSED    00:00:00.786
================= 10 test cases: 10 succeeded in 00:00:00.786 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------ native_fdc2214:test_fdc2214 [PASSED] Took 0.77 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_fdc2214  test_fdc2214  PASSED    00:00:00.774
...
------------ native_ldc1614:test_ldc1614 [PASSED] Took 0.76 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_ldc1614  test_ldc1614  PASSED    00:00:00.756
...
------------ native_vl53l0x:test_vl53l0x [PASSED] Took 0.76 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_vl53l0x  test_vl53l0x  PASSED    00:00:00.761
...
-------- native_radio_sniff:test_radio_sniff [PASSED] Took 0.77 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_sniff  test_radio_sniff  PASSED    00:00:00.765
================== 4 test cases: 4 succeeded in 00:00:00.765 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_ble_gatt/test_ble_gatt.cpp:91: test_build_pdus                [PASSED]
test/test_ble_gatt/test_ble_gatt.cpp:92: test_build_overflow            [PASSED]
test/test_ble_gatt/test_ble_gatt.cpp:93: test_parse                     [PASSED]
test/test_ble_gatt/test_ble_gatt.cpp:94: test_char_json                 [PASSED]
----------- native_ble_gatt:test_ble_gatt [PASSED] Took 0.76 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ble_gatt  test_ble_gatt  PASSED    00:00:00.763
================== 4 test cases: 4 succeeded in 00:00:00.763 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
--------- native_tls_policy:test_tls_policy [PASSED] Took 0.76 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_tls_policy  test_tls_policy  PASSED    00:00:00.764
================== 4 test cases: 4 succeeded in 00:00:00.764 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_wisun/test_wisun.cpp:112: test_build_coap_get                 [PASSED]
test/test_wisun/test_wisun.cpp:113: test_build_coap_put_with_token_and_payload [PASSED]
test/test_wisun/test_wisun.cpp:114: test_build_coap_long_segment_extended_length [PASSED]
test/test_wisun/test_wisun.cpp:115: test_build_coap_rejects_bad_args    [PASSED]
test/test_wisun/test_wisun.cpp:116: test_node_registry                  [PASSED]
-------------- native_wisun:test_wisun [PASSED] Took 0.82 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_wisun   test_wisun  PASSED    00:00:00.822
...
------------- native_logbuf:test_logbuf [PASSED] Took 0.77 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.769
================== 4 test cases: 4 succeeded in 00:00:00.769 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
---------- native_config_io:test_config_io [PASSED] Took 0.82 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.818
================== 4 test cases: 4 succeeded in 00:00:00.818 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.913
================== 3 test cases: 3 succeeded in 00:00:00.913 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
-------------- native_clock:test_clock [PASSED] Took 0.76 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.758
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.886
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 1.27 seconds ------------

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.274
================== 2 test cases: 2 succeeded in 00:00:01.274 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
-------------- native_qpack:test_qpack [PASSED] Took 0.89 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_qpack   test_qpack  PASSED    00:00:00.887
================== 9 test cases: 9 succeeded in 00:00:00.887 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
-------- native_quic_packet:test_quic_packet [PASSED] Took 0.76 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_packet  test_quic_packet  PASSED    00:00:00.757
================== 8 test cases: 8 succeeded in 00:00:00.757 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
--------- native_quic_frame:test_quic_frame [PASSED] Took 0.79 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_quic_frame  test_quic_frame  PASSED    00:00:00.790
...
-------- native_quic_crypto:test_quic_crypto [PASSED] Took 0.91 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_crypto  test_quic_crypto  PASSED    00:00:00.914
================== 7 test cases: 7 succeeded in 00:00:00.914 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
---------- native_tls13_kdf:test_tls13_kdf [PASSED] Took 0.83 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_tls13_kdf  test_tls13_kdf  PASSED    00:00:00.829
================== 5 test cases: 5 succeeded in 00:00:00.829 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_quic_tp  test_quic_tp  PASSED    00:00:00.791
================== 7 test cases: 7 succeeded in 00:00:00.791 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_tls13_msg  test_tls13_msg  PASSED    00:00:00.914
================== 7 test cases: 7 succeeded in 00:00:00.914 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_quic_tls  test_quic_tls  PASSED    00:00:01.167
================= 11 test cases: 11 succeeded in 00:00:01.167 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
---------- native_quic_conn:test_quic_conn [PASSED] Took 1.25 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_quic_conn  test_quic_conn  PASSED    00:00:01.249
================== 4 test cases: 4 succeeded in 00:00:01.249 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------ native_h3_conn:test_h3_conn [PASSED] Took 1.23 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_h3_conn  test_h3_conn  PASSED    00:00:01.234
================= 11 test cases: 11 succeeded in 00:00:01.234 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
------------- native_h3_e2e:test_h3_e2e [PASSED] Took 1.25 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_h3_e2e  test_h3_e2e  PASSED    00:00:01.245
================== 1 test cases: 1 succeeded in 00:00:01.245 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
-------- native_quic_server:test_quic_server [PASSED] Took 1.33 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_server  test_quic_server  PASSED    00:00:01.325
================== 2 test cases: 2 succeeded in 00:00:01.325 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
---------- native_h3_server:test_h3_server [PASSED] Took 2.07 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_h3_server  test_h3_server  PASSED    00:00:02.069
================== 1 test cases: 1 succeeded in 00:00:02.069 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 229 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_ssh_chachapoly  test_ssh_chachapoly  PASSED    00:00:00.803
================== 4 test cases: 4 succeeded in 00:00:00.803 ==================
```
