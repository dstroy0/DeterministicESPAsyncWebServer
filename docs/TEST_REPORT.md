...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:06.010 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.512 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.538 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.521 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.551 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.540 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.750 |
...
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.842 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.101 |
...
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.525 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.523 |
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.515 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.529 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.527 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.546 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.530 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.539 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.534 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.536 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.521 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.535 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.620 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.641 |
...
------------------ native:test_sse [PASSED] Took 6.01 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:06.010
native               test_session           PASSED    00:00:00.512
...
native               test_http_parser       PASSED    00:00:00.540
...
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.842
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.101
...
native_app           test_form_params       PASSED    00:00:00.525
native_app           test_iface             PASSED    00:00:00.523
native_app           test_json              PASSED    00:00:00.515
native_app           test_response_headers  PASSED    00:00:00.529
native_app           test_middleware        PASSED    00:00:00.527
native_app           test_digest_auth       PASSED    00:00:00.546
native_app           test_web_terminal      PASSED    00:00:00.530
native_app           test_multipart         PASSED    00:00:00.539
native_app           test_auth              PASSED    00:00:00.534
...
================ 611 test cases: 611 succeeded in 00:00:27.183 ================
```
