...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:05.745 |
...
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.703 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.698 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.729 |
...
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.687 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.685 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.020 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.606 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.643 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.656 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.644 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.624 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.804 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:01.040 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.719 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.690 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.795 |
| `test_ssh_auth`          | `native_ssh`            |    18 |   ✅   | 00:00:00.615 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.879 |
...
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.560 |
...
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.209 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.725 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.535 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:02.079 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.860 |
...
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.683 |
...
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.694 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.674 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.675 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.688 |
...
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.711 |
...
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.709 |
...
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.099 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.705 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.730 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.136 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.700 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.717 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.685 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.716 |
...
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.689 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.706 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.705 |
...
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.705 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.745 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.723 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.822 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.698 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.838 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.340 |
...
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:05.745
================= 17 test cases: 17 succeeded in 00:00:05.745 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.703
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.729
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.687
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.685
...
native         test_presentation  PASSED    00:00:00.643
...
================ 323 test cases: 323 succeeded in 00:00:04.192 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.804
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.719
...
native_ssh     test_ssh_auth       PASSED    00:00:00.615
native_ssh     test_ssh_server     PASSED    00:00:00.879
native_ssh     test_ssh_transport  PASSED    00:00:01.118
native_ssh     test_ssh_channel    PASSED    00:00:00.595
================ 132 test cases: 132 succeeded in 00:00:07.002 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
native_app     test_digest_vectors    PASSED    00:00:00.560
...
================ 225 test cases: 225 succeeded in 00:00:11.836 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.209
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:02.079
================= 15 test cases: 15 succeeded in 00:00:02.079 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
================= 15 test cases: 15 succeeded in 00:00:00.860 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.706
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.682
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.728
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.733
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.720
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.694
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.688
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.711
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.709
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.099
================= 13 test cases: 13 succeeded in 00:00:01.099 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.136
================== 3 test cases: 3 succeeded in 00:00:01.136 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.705
================= 18 test cases: 18 succeeded in 00:00:00.705 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.705
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.745
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.822
================== 3 test cases: 3 succeeded in 00:00:00.822 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.340
================== 2 test cases: 2 succeeded in 00:00:01.340 ==================
```
