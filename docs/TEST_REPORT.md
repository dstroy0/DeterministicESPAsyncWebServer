...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:10.623 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.372 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.382 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.373 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.396 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.402 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:02.050 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.415 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.483 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.580 |
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.373 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.647 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:00.803 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.696 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.406 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.376 |
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.361 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.391 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.375 |
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.375 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.385 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.389 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.439 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.388 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.403 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.392 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.394 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.396 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.383 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.452 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.503 |
...
----------------- native:test_sse [PASSED] Took 10.62 seconds ------------------
...
------------- native:test_presentation [PASSED] Took 0.38 seconds --------------
...
--------------- native:test_transport [PASSED] Took 0.37 seconds ---------------
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 2.05 seconds -------------
...
------------ native_ssh:test_ssh_server [PASSED] Took 0.48 seconds -------------
...
------ native_ssh_hardened:test_ssh_hardening [PASSED] Took 0.65 seconds -------
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 0.80 seconds -----------
...
--------------- native_app:test_regex [PASSED] Took 0.70 seconds ---------------
...
------------ native_app:test_path_params [PASSED] Took 0.38 seconds ------------
...
---------- native_app:test_digest_vectors [PASSED] Took 0.36 seconds -----------
...
--------------- native_app:test_iface [PASSED] Took 0.38 seconds ---------------
...
--------------- native_app:test_json [PASSED] Took 0.37 seconds ----------------
...
--------- native_app:test_response_headers [PASSED] Took 0.39 seconds ----------
...
------------ native_app:test_middleware [PASSED] Took 0.39 seconds -------------
...
------------- native_app:test_multipart [PASSED] Took 0.40 seconds -------------
...
------------- native_app:test_dispatch [PASSED] Took 0.40 seconds --------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:10.623
native               test_session           PASSED    00:00:00.372
native               test_presentation      PASSED    00:00:00.382
native               test_transport         PASSED    00:00:00.373
native               test_websocket         PASSED    00:00:00.396
native               test_http_parser       PASSED    00:00:00.402
native_ssh           test_ssh_crypto        PASSED    00:00:02.050
native_ssh           test_ssh_auth          PASSED    00:00:00.415
native_ssh           test_ssh_server        PASSED    00:00:00.483
native_ssh           test_ssh_transport     PASSED    00:00:00.580
native_ssh           test_ssh_channel       PASSED    00:00:00.373
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.647
native_ssh_conn      test_ssh_conn          PASSED    00:00:00.803
native_app           test_regex             PASSED    00:00:00.696
native_app           test_template          PASSED    00:00:00.406
native_app           test_path_params       PASSED    00:00:00.376
native_app           test_digest_vectors    PASSED    00:00:00.361
native_app           test_form_params       PASSED    00:00:00.391
native_app           test_iface             PASSED    00:00:00.375
native_app           test_json              PASSED    00:00:00.375
native_app           test_response_headers  PASSED    00:00:00.385
native_app           test_middleware        PASSED    00:00:00.389
native_app           test_digest_auth       PASSED    00:00:00.439
native_app           test_web_terminal      PASSED    00:00:00.388
native_app           test_multipart         PASSED    00:00:00.403
native_app           test_auth              PASSED    00:00:00.392
native_app           test_file_serving      PASSED    00:00:00.394
native_app           test_dispatch          PASSED    00:00:00.396
native_app           test_chunked           PASSED    00:00:00.383
native_app           test_application       PASSED    00:00:00.452
native_compliance    test_compliance        PASSED    00:00:00.503
================ 611 test cases: 611 succeeded in 00:00:25.403 ================
```
