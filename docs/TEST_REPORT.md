...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    11 |   ✅   | 00:00:05.898 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.689 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.700 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.707 |
| `test_mbus`              | `native_mbus`           |     8 |   ✅   | 00:00:00.681 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.682 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.692 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.688 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.682 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.651 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.145 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.620 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.647 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.637 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.657 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.611 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.755 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:01.173 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.662 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.712 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:04.098 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.595 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.701 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.927 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.560 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.076 |
...
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.567 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.632 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.627 |
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.611 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.652 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.661 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.688 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.656 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.650 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.647 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.665 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.676 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.690 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.651 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.740 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.444 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.383 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.809 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.553 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.591 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.842 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.813 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.793 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.690 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.700 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.805 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.706 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.685 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.694 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.686 |
| `test_protobuf`          | `native_protobuf`       |    10 |   ✅   | 00:00:00.700 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.714 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.716 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.701 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.702 |
...
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.781 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.673 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.692 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.659 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.672 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.696 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.697 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.693 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.696 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.701 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.702 |
...
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.721 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.983 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.702 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.707 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.694 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.711 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.711 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.732 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.280 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.260 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.723 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.777 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.310 |
| `test_http_client`       | `native_http_client`    |    11 |   ✅   | 00:00:00.698 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.716 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.716 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.781 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.703 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.713 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.688 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.734 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.235 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.708 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.703 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.713 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.670 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.745 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.702 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.691 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.716 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.673 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.696 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.702 |
...
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.853 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.650 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.807 |
...
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:05.898
================= 11 test cases: 11 succeeded in 00:00:05.898 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.689
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.700
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.707
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.682
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.682
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.145
native         test_session       PASSED    00:00:00.620
native         test_presentation  PASSED    00:00:00.647
native         test_transport     PASSED    00:00:00.637
native         test_websocket     PASSED    00:00:00.657
native         test_http_parser   PASSED    00:00:00.611
================ 318 test cases: 318 succeeded in 00:00:04.317 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
-------- native_accept_gate:test_accept_gate [PASSED] Took 1.17 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.173
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 4.10 seconds -------------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.098
native_ssh     test_ssh_auth       PASSED    00:00:00.595
native_ssh     test_ssh_server     PASSED    00:00:00.701
native_ssh     test_ssh_transport  PASSED    00:00:00.927
native_ssh     test_ssh_channel    PASSED    00:00:00.560
================= 93 test cases: 93 succeeded in 00:00:06.881 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:01.076
...
------------ native_app:test_digest_auth [PASSED] Took 0.69 seconds ------------
...
native_app     test_digest_vectors    PASSED    00:00:00.567
native_app     test_form_params       PASSED    00:00:00.632
native_app     test_iface             PASSED    00:00:00.627
native_app     test_json              PASSED    00:00:00.611
native_app     test_response_headers  PASSED    00:00:00.652
native_app     test_middleware        PASSED    00:00:00.661
native_app     test_digest_auth       PASSED    00:00:00.688
native_app     test_web_terminal      PASSED    00:00:00.656
native_app     test_defer             PASSED    00:00:00.650
native_app     test_multipart         PASSED    00:00:00.647
native_app     test_auth              PASSED    00:00:00.665
native_app     test_file_serving      PASSED    00:00:00.676
native_app     test_dispatch          PASSED    00:00:00.690
native_app     test_chunked           PASSED    00:00:00.651
native_app     test_application       PASSED    00:00:00.740
================ 219 test cases: 219 succeeded in 00:00:12.464 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
----- native_webdav_handler:test_webdav_handler [PASSED] Took 1.44 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.444
================= 12 test cases: 12 succeeded in 00:00:01.444 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.383
================== 2 test cases: 2 succeeded in 00:00:01.383 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
native_snmp    test_snmp_agent  PASSED    00:00:00.553
================= 30 test cases: 30 succeeded in 00:00:01.362 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.591
================= 10 test cases: 10 succeeded in 00:00:01.591 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.793
================= 29 test cases: 29 succeeded in 00:00:00.793 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.805
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.706
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.714
================= 12 test cases: 12 succeeded in 00:00:00.714 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.701
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.702
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.692
================== 6 test cases: 6 succeeded in 00:00:00.692 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.659
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.696
================== 8 test cases: 8 succeeded in 00:00:00.696 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.701
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.702
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.983
================= 13 test cases: 13 succeeded in 00:00:00.983 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.707
================= 13 test cases: 13 succeeded in 00:00:00.707 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.694
...
================= 29 test cases: 29 succeeded in 00:00:00.711 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.280
================= 10 test cases: 10 succeeded in 00:00:01.280 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.723
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.310
================== 3 test cases: 3 succeeded in 00:00:01.310 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.703
...
test/test_websocket/test_websocket.cpp:1107: stress_ws_parse_max_payload [PASSED]
test/test_websocket/test_websocket.cpp:1108: stress_ws_parse_two_consecutive_frames [PASSED]
--------- native_ws_deflate:test_websocket [PASSED] Took 1.24 seconds ----------

=================================== SUMMARY ===================================
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.235
================= 71 test cases: 71 succeeded in 00:00:01.235 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.703
================= 14 test cases: 14 succeeded in 00:00:00.703 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.745
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.716
================== 5 test cases: 5 succeeded in 00:00:00.716 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.673
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.696
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.853
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.650
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.807
