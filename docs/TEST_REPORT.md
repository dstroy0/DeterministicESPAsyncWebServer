...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:05.740 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.653 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.668 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.662 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:04.431 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.671 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.675 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.677 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.666 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.689 |
...
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.796 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:01.037 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.708 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.679 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.947 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.656 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.862 |
| `test_ssh_transport`     | `native_ssh`            |    31 |   ✅   | 00:00:01.149 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.604 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.988 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.390 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.230 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.617 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.624 |
...
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.624 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.653 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.642 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.660 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.628 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.643 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.708 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.253 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.213 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.718 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.534 |
...
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.769 |
...
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.671 |
...
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.775 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.684 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.669 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.662 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.665 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.665 |
...
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.667 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.683 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.664 |
...
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.669 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.674 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.669 |
...
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.683 |
...
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.143 |
...
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.706 |
...
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.095 |
...
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.701 |
...
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.683 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.677 |
...
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.696 |
...
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.372 |
...
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:05.740
================= 17 test cases: 17 succeeded in 00:00:05.740 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 145 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:04.431
================= 16 test cases: 16 succeeded in 00:00:04.431 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 145 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.675
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.689
...
================ 323 test cases: 323 succeeded in 00:00:04.215 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 145 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.796
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.037
================= 13 test cases: 13 succeeded in 00:00:01.037 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 145 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.947
native_ssh     test_ssh_auth       PASSED    00:00:00.656
native_ssh     test_ssh_server     PASSED    00:00:00.862
native_ssh     test_ssh_transport  PASSED    00:00:01.149
native_ssh     test_ssh_channel    PASSED    00:00:00.604
================ 137 test cases: 137 succeeded in 00:00:07.218 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 145 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.390
================== 2 test cases: 2 succeeded in 00:00:01.390 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 145 tests
...
native_app     test_path_params       PASSED    00:00:00.624
...
native_app     test_file_serving      PASSED    00:00:00.660
native_app     test_dispatch          PASSED    00:00:00.628
native_app     test_chunked           PASSED    00:00:00.643
native_app     test_application       PASSED    00:00:00.708
================ 225 test cases: 225 succeeded in 00:00:11.960 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 145 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.253
================= 12 test cases: 12 succeeded in 00:00:01.253 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 145 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.213
...
native_snmp    test_snmp_agent  PASSED    00:00:00.534
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.769
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.775
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.684
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.669
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.665
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.667
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.664
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.669
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.669
...
================= 32 test cases: 32 succeeded in 00:00:00.683 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 145 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.143
================= 10 test cases: 10 succeeded in 00:00:01.143 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 145 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.706
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.095
================= 71 test cases: 71 succeeded in 00:00:01.095 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 145 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.701
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.677
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.696
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.372
