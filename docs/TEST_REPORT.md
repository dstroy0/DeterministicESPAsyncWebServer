...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:17.496 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.638 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.648 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.644 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.670 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.642 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.651 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.646 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.645 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.658 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.636 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:00.992 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.569 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.615 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.591 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.619 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.585 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.727 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:00.969 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.662 |
...
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:01.078 |
| `test_ssh_transport`     | `native_ssh`            |    27 |   ✅   | 00:00:01.046 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.555 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.883 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.266 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.165 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.586 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.597 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.532 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.591 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.587 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.556 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.602 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.598 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.619 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.594 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.571 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.601 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.608 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.617 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.592 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.606 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.688 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.192 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.154 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.696 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.505 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:01.957 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.809 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:01.061 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.764 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.654 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.664 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.719 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.697 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.658 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.657 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.651 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.652 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.727 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.748 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.888 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.770 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.641 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.682 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.652 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.650 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.650 |
...
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.725 |
...
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.902 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.658 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.668 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.667 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.692 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.706 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.690 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.096 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.097 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.694 |
| `test_jwt`               | `native_jwt`            |    16 |   ✅   | 00:00:00.732 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.122 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.655 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.690 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.656 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.712 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.700 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.690 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.669 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.699 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.060 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.647 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.644 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.669 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.650 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.684 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.675 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.677 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.646 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.671 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.657 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.643 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.648 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.676 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.673 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.641 |
...
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.185 |
...
----------- native_canopen:test_canopen [PASSED] Took 17.50 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:17.496
================= 17 test cases: 17 succeeded in 00:00:17.496 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.648
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.644
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.670
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.642
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.651
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.645
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.658
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.636
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:00.992
native         test_session       PASSED    00:00:00.569
native         test_presentation  PASSED    00:00:00.615
native         test_transport     PASSED    00:00:00.591
native         test_websocket     PASSED    00:00:00.619
native         test_http_parser   PASSED    00:00:00.585
================ 321 test cases: 321 succeeded in 00:00:03.971 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.727
================= 17 test cases: 17 succeeded in 00:00:00.727 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
================= 10 test cases: 10 succeeded in 00:00:00.969 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.662
...
------------ native_ssh:test_ssh_server [PASSED] Took 1.08 seconds -------------
...
native_ssh     test_ssh_channel    PASSED    00:00:00.555
================ 120 test cases: 120 succeeded in 00:00:07.167 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.266
================== 2 test cases: 2 succeeded in 00:00:01.266 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
native_app     test_template          PASSED    00:00:00.586
native_app     test_path_params       PASSED    00:00:00.597
native_app     test_digest_vectors    PASSED    00:00:00.532
native_app     test_form_params       PASSED    00:00:00.591
native_app     test_iface             PASSED    00:00:00.587
native_app     test_json              PASSED    00:00:00.556
native_app     test_response_headers  PASSED    00:00:00.602
native_app     test_middleware        PASSED    00:00:00.598
native_app     test_digest_auth       PASSED    00:00:00.619
...
native_app     test_auth              PASSED    00:00:00.608
native_app     test_file_serving      PASSED    00:00:00.617
native_app     test_dispatch          PASSED    00:00:00.592
native_app     test_chunked           PASSED    00:00:00.606
native_app     test_application       PASSED    00:00:00.688
================ 225 test cases: 225 succeeded in 00:00:11.309 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.192
================= 12 test cases: 12 succeeded in 00:00:01.192 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.696
native_snmp    test_snmp_agent  PASSED    00:00:00.505
================= 35 test cases: 35 succeeded in 00:00:01.200 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.809
...
--------------- native_coap:test_coap [PASSED] Took 1.06 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:01.061
================= 41 test cases: 41 succeeded in 00:00:01.061 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.764
================= 41 test cases: 41 succeeded in 00:00:00.764 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.654
================= 19 test cases: 19 succeeded in 00:00:00.654 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.697
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.652
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.727
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.748
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.888
================= 16 test cases: 16 succeeded in 00:00:00.888 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.770
...
--------------- native_lora:test_lora [PASSED] Took 0.64 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.641
================= 13 test cases: 13 succeeded in 00:00:00.641 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.682
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.652
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.650
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.725
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.662
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.649
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.672
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.641
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.671
...
================= 17 test cases: 17 succeeded in 00:00:00.902 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.667
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.690
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.096
================= 10 test cases: 10 succeeded in 00:00:01.096 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.122
================== 3 test cases: 3 succeeded in 00:00:01.122 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.655
================= 15 test cases: 15 succeeded in 00:00:00.655 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.656
================= 22 test cases: 22 succeeded in 00:00:00.656 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.700
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.699
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.060
================= 71 test cases: 71 succeeded in 00:00:01.060 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.644
================= 14 test cases: 14 succeeded in 00:00:00.644 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.650
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.677
...
================= 17 test cases: 17 succeeded in 00:00:00.643 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.648
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.673
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.641
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.185
================== 2 test cases: 2 succeeded in 00:00:01.185 ==================
```
