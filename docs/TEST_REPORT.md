...
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.232 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:01.077 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.557 |
...
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.518 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.572 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.558 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.580 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.582 |
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.557 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.589 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.586 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.594 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.574 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.573 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.668 |
...
------------------ native:test_sse [PASSED] Took 6.14 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:06.141
...
native               test_websocket         PASSED    00:00:00.582
native               test_http_parser       PASSED    00:00:00.538
native_ssh           test_ssh_crypto        PASSED    00:00:03.826
native_ssh           test_ssh_auth          PASSED    00:00:00.563
...
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.232
native_app           test_regex             PASSED    00:00:01.077
native_app           test_template          PASSED    00:00:00.557
native_app           test_path_params       PASSED    00:00:00.574
native_app           test_digest_vectors    PASSED    00:00:00.502
...
native_app           test_middleware        PASSED    00:00:00.558
...
native_tsan          test_concurrency       PASSED    00:00:01.529
================ 619 test cases: 619 succeeded in 00:00:31.149 ================
```
