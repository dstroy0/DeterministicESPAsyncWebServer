...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    11 |   ✅   | 00:00:14.445 |
...
| `test_mbus`              | `native_mbus`           |     8 |   ✅   | 00:00:00.671 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.671 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.676 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.650 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.686 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.670 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.120 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.581 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.608 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.596 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.628 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.595 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.731 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:01.092 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.680 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.694 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.892 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.589 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.697 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.935 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.547 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.033 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.509 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.308 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.598 |
...
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.558 |
...
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.582 |
...
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.614 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.609 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.688 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.358 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.301 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.757 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.503 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.613 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.826 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.872 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.758 |
...
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.681 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.656 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.674 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.673 |
| `test_protobuf`          | `native_protobuf`       |    10 |   ✅   | 00:00:00.666 |
| `test_preempt_queue`     | `native_preempt_queue`  |     7 |   ✅   | 00:00:00.689 |
...
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.685 |
...
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.675 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.672 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.672 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.673 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.690 |
...
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.701 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.701 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.668 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.694 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.714 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.944 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.675 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.689 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.682 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.709 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.693 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.722 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.199 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.217 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.686 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.748 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.251 |
| `test_http_client`       | `native_http_client`    |    11 |   ✅   | 00:00:00.653 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.680 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.679 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.748 |
...
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.213 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.664 |
...
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.717 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.684 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.665 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.679 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.673 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.684 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.663 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.679 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.682 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.659 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.672 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.690 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.798 |
...
----------- native_canopen:test_canopen [PASSED] Took 14.44 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:14.445
================= 11 test cases: 11 succeeded in 00:00:14.445 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.671
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.650
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.686
...
native         test_presentation  PASSED    00:00:00.608
...
================ 318 test cases: 318 succeeded in 00:00:04.128 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.731
================= 17 test cases: 17 succeeded in 00:00:00.731 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.092
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.694
...
native_ssh     test_ssh_auth       PASSED    00:00:00.589
native_ssh     test_ssh_server     PASSED    00:00:00.697
native_ssh     test_ssh_transport  PASSED    00:00:00.935
native_ssh     test_ssh_channel    PASSED    00:00:00.547
================= 93 test cases: 93 succeeded in 00:00:06.660 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:01.033
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.308
native_app     test_template          PASSED    00:00:00.598
...
native_app     test_defer             PASSED    00:00:00.582
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.358
================= 12 test cases: 12 succeeded in 00:00:01.358 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
================= 30 test cases: 30 succeeded in 00:00:01.260 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.613
================= 10 test cases: 10 succeeded in 00:00:01.613 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.826
...
--------------- native_coap:test_coap [PASSED] Took 0.87 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.872
================= 29 test cases: 29 succeeded in 00:00:00.872 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.758
================= 29 test cases: 29 succeeded in 00:00:00.758 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.681
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.674
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.689
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.685
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.675
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.701
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.701
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.694
...
================= 13 test cases: 13 succeeded in 00:00:00.944 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.693
================= 29 test cases: 29 succeeded in 00:00:00.693 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.217
================= 13 test cases: 13 succeeded in 00:00:01.217 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.251
================== 3 test cases: 3 succeeded in 00:00:01.251 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.748
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.213
================= 71 test cases: 71 succeeded in 00:00:01.213 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.664
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.717
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.679
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.690
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.798
