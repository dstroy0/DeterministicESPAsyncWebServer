...
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.290 |
...
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.553 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.559 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.560 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.576 |
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.610 |
...
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.585 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.570 |
...
| `test_concurrency`      | `native_tsan`         |     2 |   ✅   | 00:00:01.457 |
...
----------------- native:test_sse [PASSED] Took 14.41 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:14.408
...
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.290
...
native_app           test_response_headers  PASSED    00:00:00.553
native_app           test_middleware        PASSED    00:00:00.559
native_app           test_digest_auth       PASSED    00:00:00.560
native_app           test_web_terminal      PASSED    00:00:00.576
native_app           test_defer             PASSED    00:00:00.610
...
native_tsan          test_concurrency       PASSED    00:00:01.457
================ 619 test cases: 619 succeeded in 00:00:39.529 ================
```
