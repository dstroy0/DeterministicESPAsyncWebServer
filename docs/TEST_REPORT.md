...
**Generated:** 2026-06-29 17:47:24
**Command:** `pio test` over 74 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1364 passed - 117s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:06.568 |
...
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.578 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.714 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.634 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.665 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.753 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.571 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.688 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.923 |
...
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.589 |
...
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.672 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.165 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.141 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.694 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.508 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.505 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.786 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.793 |
...
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.711 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.642 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.645 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.646 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.645 |
| `test_protobuf`          | `native_protobuf`       |     8 |   ✅   | 00:00:00.644 |
| `test_wamp`              | `native_wamp`           |    11 |   ✅   | 00:00:00.658 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.673 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.660 |
...
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.632 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.644 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.665 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.670 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.674 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.036 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.036 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.653 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.687 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.065 |
...
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.680 |
...
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.685 |
...
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.644 |
...
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.631 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.633 |
...
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.621 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.738 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.123 |
...
------------------ native:test_sse [PASSED] Took 6.57 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.568
...
================ 318 test cases: 318 succeeded in 00:00:09.536 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 99 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.665
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.753
native_ssh     test_ssh_auth       PASSED    00:00:00.571
native_ssh     test_ssh_server     PASSED    00:00:00.688
native_ssh     test_ssh_transport  PASSED    00:00:00.923
native_ssh     test_ssh_channel    PASSED    00:00:00.528
================= 93 test cases: 93 succeeded in 00:00:06.463 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 99 tests
...
native_app     test_iface             PASSED    00:00:00.589
...
native_app     test_application       PASSED    00:00:00.672
...
----- native_webdav_handler:test_webdav_handler [PASSED] Took 1.16 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.165
================= 12 test cases: 12 succeeded in 00:00:01.165 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 99 tests
...
================= 29 test cases: 29 succeeded in 00:00:01.201 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 99 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.505
================= 10 test cases: 10 succeeded in 00:00:01.505 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 99 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.793
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.711
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.645
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.644
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.658
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.660
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.632
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.670
================= 29 test cases: 29 succeeded in 00:00:00.670 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 99 tests
...
================= 13 test cases: 13 succeeded in 00:00:01.036 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 99 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.653
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.687
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.065
================== 3 test cases: 3 succeeded in 00:00:01.065 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 99 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.680
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.685
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.644
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.631
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.633
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.621
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.738
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.123
================== 2 test cases: 2 succeeded in 00:00:01.123 ==================
```
