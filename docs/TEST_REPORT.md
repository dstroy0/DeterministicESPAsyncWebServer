...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:14.148 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.554 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.603 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.576 |
| `test_websocket`         | `native`               |    63 |   ✅   | 00:00:00.601 |
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.556 |
| `test_observability`     | `native_observability` |    15 |   ✅   | 00:00:00.709 |
| `test_http_ota`          | `native_ota`           |     3 |   ✅   | 00:00:00.644 |
| `test_provisioning`      | `native_prov`          |     5 |   ✅   | 00:00:00.646 |
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.816 |
| `test_ssh_auth`          | `native_ssh`           |    12 |   ✅   | 00:00:00.555 |
| `test_ssh_server`        | `native_ssh`           |     7 |   ✅   | 00:00:00.652 |
...
| `test_ssh_conn`          | `native_ssh_conn`      |     2 |   ✅   | 00:00:01.250 |
| `test_regex`             | `native_app`           |     9 |   ✅   | 00:00:01.135 |
...
| `test_form_params`       | `native_app`           |     5 |   ✅   | 00:00:00.576 |
| `test_iface`             | `native_app`           |     7 |   ✅   | 00:00:00.582 |
| `test_json`              | `native_app`           |    17 |   ✅   | 00:00:00.530 |
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.582 |
| `test_middleware`        | `native_app`           |     9 |   ✅   | 00:00:00.578 |
| `test_digest_auth`       | `native_app`           |     5 |   ✅   | 00:00:00.587 |
| `test_web_terminal`      | `native_app`           |     7 |   ✅   | 00:00:00.582 |
| `test_defer`             | `native_app`           |     3 |   ✅   | 00:00:00.555 |
| `test_multipart`         | `native_app`           |    19 |   ✅   | 00:00:00.585 |
| `test_auth`              | `native_app`           |    13 |   ✅   | 00:00:00.587 |
| `test_file_serving`      | `native_app`           |    12 |   ✅   | 00:00:00.599 |
| `test_dispatch`          | `native_app`           |    11 |   ✅   | 00:00:00.579 |
| `test_chunked`           | `native_app`           |    10 |   ✅   | 00:00:00.583 |
| `test_application`       | `native_app`           |    52 |   ✅   | 00:00:00.654 |
| `test_snmp_ber`          | `native_snmp`          |     9 |   ✅   | 00:00:00.675 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.484 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.355 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.761 |
| `test_coap`              | `native_coap`          |    26 |   ✅   | 00:00:00.641 |
| `test_webdav`            | `native_webdav`        |    19 |   ✅   | 00:00:00.659 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.643 |
| `test_modbus_master`     | `native_modbus_master` |     5 |   ✅   | 00:00:00.651 |
| `test_ota_rollback`      | `native_ota_rollback`  |     5 |   ✅   | 00:00:00.637 |
| `test_totp`              | `native_totp`          |     4 |   ✅   | 00:00:00.651 |
| `test_webhook`           | `native_webhook`       |     5 |   ✅   | 00:00:00.642 |
...
| `test_oidc`              | `native_oidc`          |    13 |   ✅   | 00:00:00.837 |
| `test_vfs`               | `native_vfs`           |    11 |   ✅   | 00:00:00.639 |
| `test_graphql`           | `native_graphql`       |    13 |   ✅   | 00:00:00.634 |
| `test_espnow`            | `native_espnow`        |     7 |   ✅   | 00:00:00.625 |
| `test_oauth2`            | `native_oauth2`        |     8 |   ✅   | 00:00:00.661 |
| `test_opcua`             | `native_opcua`         |    29 |   ✅   | 00:00:00.654 |
| `test_opcua_client`      | `native_opcua_client`  |    11 |   ✅   | 00:00:00.674 |
| `test_keepalive`         | `native_keepalive`     |    10 |   ✅   | 00:00:01.036 |
| `test_range`             | `native_range`         |    13 |   ✅   | 00:00:01.055 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.657 |
| `test_jwt`               | `native_jwt`           |    10 |   ✅   | 00:00:00.694 |
...
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.672 |
| `test_scratch`           | `native_scratch`       |    14 |   ✅   | 00:00:00.669 |
| `test_snmp_trap`         | `native_snmp_trap`     |     3 |   ✅   | 00:00:00.654 |
| `test_inflate`           | `native_inflate`       |    12 |   ✅   | 00:00:00.635 |
| `test_deflate`           | `native_deflate`       |    10 |   ✅   | 00:00:00.672 |
| `test_websocket`         | `native_ws_deflate`    |    67 |   ✅   | 00:00:01.010 |
| `test_time_source`       | `native_time_source`   |     9 |   ✅   | 00:00:00.622 |
| `test_config_store`      | `native_config_store`  |    14 |   ✅   | 00:00:00.629 |
| `test_device_id`         | `native_device_id`     |     4 |   ✅   | 00:00:00.639 |
| `test_auth_lockout`      | `native_auth_lockout`  |    10 |   ✅   | 00:00:00.634 |
| `test_csrf`              | `native_csrf`          |     9 |   ✅   | 00:00:00.666 |
| `test_telemetry`         | `native_telemetry`     |     8 |   ✅   | 00:00:00.649 |
| `test_dashboard`         | `native_dashboard`     |    11 |   ✅   | 00:00:00.633 |
| `test_net_egress`        | `native_net_egress`    |     5 |   ✅   | 00:00:00.623 |
| `test_partition_monitor` | `native_partition`     |     5 |   ✅   | 00:00:00.625 |
| `test_cbor`              | `native_cbor`          |    14 |   ✅   | 00:00:00.640 |
| `test_msgpack`           | `native_msgpack`       |    15 |   ✅   | 00:00:00.639 |
| `test_gpio_map`          | `native_gpio_map`      |     8 |   ✅   | 00:00:00.627 |
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.626 |
| `test_guardrails`        | `native_guardrails`    |     6 |   ✅   | 00:00:00.630 |
| `test_logbuf`            | `native_logbuf`        |     4 |   ✅   | 00:00:00.634 |
| `test_config_io`         | `native_config_io`     |     4 |   ✅   | 00:00:00.654 |
| `test_workers`           | `native_workers`       |     3 |   ✅   | 00:00:00.734 |
| `test_clock`             | `native_clock`         |     4 |   ✅   | 00:00:00.622 |
| `test_concurrency`       | `native_concurrency`   |     2 |   ✅   | 00:00:00.847 |
...
----------------- native:test_sse [PASSED] Took 14.15 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:14.148
...
native         test_websocket     PASSED    00:00:00.601
native         test_http_parser   PASSED    00:00:00.556
================ 306 test cases: 306 succeeded in 00:00:17.037 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.646
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.250
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.135
...
native_app     test_form_params       PASSED    00:00:00.576
native_app     test_iface             PASSED    00:00:00.582
native_app     test_json              PASSED    00:00:00.530
native_app     test_response_headers  PASSED    00:00:00.582
native_app     test_middleware        PASSED    00:00:00.578
...
native_app     test_auth              PASSED    00:00:00.587
native_app     test_file_serving      PASSED    00:00:00.599
native_app     test_dispatch          PASSED    00:00:00.579
native_app     test_chunked           PASSED    00:00:00.583
native_app     test_application       PASSED    00:00:00.654
================ 206 test cases: 206 succeeded in 00:00:11.038 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.675
native_snmp    test_snmp_agent  PASSED    00:00:00.484
================= 22 test cases: 22 succeeded in 00:00:01.159 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.355
================== 9 test cases: 9 succeeded in 00:00:01.355 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.641
================= 26 test cases: 26 succeeded in 00:00:00.641 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.659
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.643
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.642
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.634
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.625
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.661
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.654
================= 29 test cases: 29 succeeded in 00:00:00.654 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.674
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.036
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.055
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.672
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.669
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.654
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.635
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.672
================= 10 test cases: 10 succeeded in 00:00:00.672 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.010
================= 67 test cases: 67 succeeded in 00:00:01.010 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.629
================= 14 test cases: 14 succeeded in 00:00:00.629 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.639
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.634
================= 10 test cases: 10 succeeded in 00:00:00.634 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.666
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.633
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.623
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.640
...
================= 15 test cases: 15 succeeded in 00:00:00.639 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.626
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.630
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.634
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.654
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.734
