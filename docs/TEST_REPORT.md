...
**Generated:** 2026-06-29 17:41:14
**Command:** `pio test` over 73 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1358 passed - 106s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:06.045 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.510 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.538 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.521 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.553 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.511 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.642 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.561 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.583 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:04.116 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.504 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.649 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.926 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.467 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.774 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.149 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.042 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.526 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.530 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.472 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.518 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.523 |
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.481 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.524 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.533 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.542 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.528 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.506 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.537 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.532 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.543 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.527 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.538 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.608 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.074 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.051 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.606 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.437 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.507 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.689 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.688 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.674 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.596 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.575 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.651 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.576 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.564 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.564 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.568 |
| `test_protobuf`          | `native_protobuf`       |     8 |   ✅   | 00:00:00.565 |
| `test_wamp`              | `native_wamp`           |    11 |   ✅   | 00:00:00.592 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.560 |
...
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.571 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.558 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.567 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.594 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.754 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.576 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.595 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.566 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.582 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.597 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.610 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:00.951 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:00.969 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.571 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.604 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:00.987 |
| `test_http_client`       | `native_http_client`    |    10 |   ✅   | 00:00:00.576 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.578 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.559 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.608 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.591 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.589 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.568 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.606 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:00.927 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.568 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.559 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.588 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.558 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.606 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.582 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.578 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.562 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.553 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.582 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.581 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.568 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.556 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.567 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.574 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.592 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.676 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.546 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.691 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.294 |
...
------------------ native:test_sse [PASSED] Took 6.04 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.045
native         test_session       PASSED    00:00:00.510
native         test_presentation  PASSED    00:00:00.538
native         test_transport     PASSED    00:00:00.521
native         test_websocket     PASSED    00:00:00.553
native         test_http_parser   PASSED    00:00:00.511
================ 318 test cases: 318 succeeded in 00:00:08.678 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 98 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.642
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.561
...
------------- native_ssh:test_ssh_auth [PASSED] Took 0.50 seconds --------------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.116
native_ssh     test_ssh_auth       PASSED    00:00:00.504
native_ssh     test_ssh_server     PASSED    00:00:00.649
native_ssh     test_ssh_transport  PASSED    00:00:00.926
native_ssh     test_ssh_channel    PASSED    00:00:00.467
================= 93 test cases: 93 succeeded in 00:00:06.661 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 98 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.774
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.149
...
--------- native_app:test_response_headers [PASSED] Took 0.52 seconds ----------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.042
native_app     test_template          PASSED    00:00:00.526
native_app     test_path_params       PASSED    00:00:00.530
native_app     test_digest_vectors    PASSED    00:00:00.472
native_app     test_form_params       PASSED    00:00:00.518
native_app     test_iface             PASSED    00:00:00.523
native_app     test_json              PASSED    00:00:00.481
native_app     test_response_headers  PASSED    00:00:00.524
native_app     test_middleware        PASSED    00:00:00.533
native_app     test_digest_auth       PASSED    00:00:00.542
native_app     test_web_terminal      PASSED    00:00:00.528
native_app     test_defer             PASSED    00:00:00.506
native_app     test_multipart         PASSED    00:00:00.537
native_app     test_auth              PASSED    00:00:00.532
native_app     test_file_serving      PASSED    00:00:00.543
native_app     test_dispatch          PASSED    00:00:00.527
native_app     test_chunked           PASSED    00:00:00.538
native_app     test_application       PASSED    00:00:00.608
================ 219 test cases: 219 succeeded in 00:00:10.010 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 98 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.074
================= 12 test cases: 12 succeeded in 00:00:01.074 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 98 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.051
...
native_snmp    test_snmp_agent  PASSED    00:00:00.437
================= 29 test cases: 29 succeeded in 00:00:01.043 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 98 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.507
================= 10 test cases: 10 succeeded in 00:00:01.507 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 98 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.689
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.674
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.575
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.651
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.576
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.564
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.565
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.560
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.571
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.558
================== 2 test cases: 2 succeeded in 00:00:00.558 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 98 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.594
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.754
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.582
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.597
================= 29 test cases: 29 succeeded in 00:00:00.597 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 98 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.610
================= 11 test cases: 11 succeeded in 00:00:00.610 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 98 tests
...
---------- native_keepalive:test_keepalive [PASSED] Took 0.95 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:00.951
================= 10 test cases: 10 succeeded in 00:00:00.951 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 98 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:00.969
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.571
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.604
================= 12 test cases: 12 succeeded in 00:00:00.604 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 98 tests
...
------------- native_upload:test_upload [PASSED] Took 0.99 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:00.987
================== 3 test cases: 3 succeeded in 00:00:00.987 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 98 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.578
================= 15 test cases: 15 succeeded in 00:00:00.578 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 98 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.559
================= 19 test cases: 19 succeeded in 00:00:00.559 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 98 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.568
================= 12 test cases: 12 succeeded in 00:00:00.568 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 98 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.927
================= 71 test cases: 71 succeeded in 00:00:00.927 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 98 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.559
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.558
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.582
================== 8 test cases: 8 succeeded in 00:00:00.582 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 98 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.578
...
------ native_partition:test_partition_monitor [PASSED] Took 0.55 seconds ------
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.582
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.581
================= 15 test cases: 15 succeeded in 00:00:00.581 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 98 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.556
================== 7 test cases: 7 succeeded in 00:00:00.556 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 98 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.574
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.592
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.676
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.546
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.691
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.294
