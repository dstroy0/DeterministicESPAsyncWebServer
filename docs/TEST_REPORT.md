...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:08.796 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.446 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.478 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.466 |
| `test_websocket`         | `native`               |    63 |   ✅   | 00:00:00.484 |
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.454 |
| `test_observability`     | `native_observability` |    15 |   ✅   | 00:00:00.572 |
| `test_http_ota`          | `native_ota`           |     3 |   ✅   | 00:00:00.522 |
| `test_provisioning`      | `native_prov`          |     5 |   ✅   | 00:00:00.532 |
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:02.915 |
| `test_ssh_auth`          | `native_ssh`           |    12 |   ✅   | 00:00:00.443 |
| `test_ssh_server`        | `native_ssh`           |     7 |   ✅   | 00:00:00.553 |
| `test_ssh_transport`     | `native_ssh`           |    23 |   ✅   | 00:00:00.728 |
| `test_ssh_channel`       | `native_ssh`           |    12 |   ✅   | 00:00:00.414 |
| `test_ssh_hardening`     | `native_ssh_hardened`  |     2 |   ✅   | 00:00:00.705 |
| `test_ssh_conn`          | `native_ssh_conn`      |     2 |   ✅   | 00:00:01.025 |
| `test_regex`             | `native_app`           |     9 |   ✅   | 00:00:00.944 |
| `test_template`          | `native_app`           |     6 |   ✅   | 00:00:00.464 |
| `test_path_params`       | `native_app`           |     8 |   ✅   | 00:00:00.470 |
| `test_digest_vectors`    | `native_app`           |     4 |   ✅   | 00:00:00.426 |
| `test_form_params`       | `native_app`           |     5 |   ✅   | 00:00:00.465 |
| `test_iface`             | `native_app`           |     7 |   ✅   | 00:00:00.482 |
| `test_json`              | `native_app`           |    17 |   ✅   | 00:00:00.450 |
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.475 |
| `test_middleware`        | `native_app`           |     9 |   ✅   | 00:00:00.473 |
| `test_digest_auth`       | `native_app`           |     5 |   ✅   | 00:00:00.470 |
| `test_web_terminal`      | `native_app`           |     7 |   ✅   | 00:00:00.468 |
| `test_defer`             | `native_app`           |     3 |   ✅   | 00:00:00.455 |
| `test_multipart`         | `native_app`           |    19 |   ✅   | 00:00:00.474 |
| `test_auth`              | `native_app`           |    13 |   ✅   | 00:00:00.473 |
| `test_file_serving`      | `native_app`           |    12 |   ✅   | 00:00:00.482 |
| `test_dispatch`          | `native_app`           |    11 |   ✅   | 00:00:00.468 |
| `test_chunked`           | `native_app`           |    10 |   ✅   | 00:00:00.474 |
| `test_application`       | `native_app`           |    51 |   ✅   | 00:00:00.526 |
| `test_snmp_ber`          | `native_snmp`          |     9 |   ✅   | 00:00:00.542 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.388 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.109 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.625 |
| `test_coap`              | `native_coap`          |    26 |   ✅   | 00:00:00.544 |
| `test_webdav`            | `native_webdav`        |    19 |   ✅   | 00:00:00.523 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.521 |
| `test_modbus_master`     | `native_modbus_master` |     5 |   ✅   | 00:00:00.531 |
| `test_ota_rollback`      | `native_ota_rollback`  |     5 |   ✅   | 00:00:00.522 |
| `test_totp`              | `native_totp`          |     4 |   ✅   | 00:00:00.537 |
| `test_webhook`           | `native_webhook`       |     5 |   ✅   | 00:00:00.521 |
| `test_radio_power`       | `native_radio_power`   |     2 |   ✅   | 00:00:00.525 |
| `test_dns_resolver`      | `native_dns_resolver`  |     4 |   ✅   | 00:00:00.511 |
| `test_audit_log`         | `native_audit_log`     |    12 |   ✅   | 00:00:00.530 |
| `test_oidc`              | `native_oidc`          |    13 |   ✅   | 00:00:00.660 |
| `test_vfs`               | `native_vfs`           |    11 |   ✅   | 00:00:00.542 |
| `test_graphql`           | `native_graphql`       |    13 |   ✅   | 00:00:00.541 |
| `test_espnow`            | `native_espnow`        |     7 |   ✅   | 00:00:00.530 |
| `test_oauth2`            | `native_oauth2`        |     8 |   ✅   | 00:00:00.554 |
| `test_opcua`             | `native_opcua`         |    29 |   ✅   | 00:00:00.518 |
| `test_opcua_client`      | `native_opcua_client`  |    11 |   ✅   | 00:00:00.569 |
| `test_keepalive`         | `native_keepalive`     |    10 |   ✅   | 00:00:00.871 |
| `test_range`             | `native_range`         |    10 |   ✅   | 00:00:00.855 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.549 |
| `test_jwt`               | `native_jwt`           |    10 |   ✅   | 00:00:00.558 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:00.866 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.552 |
| `test_compliance`        | `native_compliance`    |    12 |   ✅   | 00:00:00.549 |
| `test_mqtt`              | `native_mqtt`          |    16 |   ✅   | 00:00:00.567 |
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.565 |
| `test_scratch`           | `native_scratch`       |    14 |   ✅   | 00:00:00.603 |
| `test_snmp_trap`         | `native_snmp_trap`     |     3 |   ✅   | 00:00:00.539 |
| `test_inflate`           | `native_inflate`       |    12 |   ✅   | 00:00:00.519 |
| `test_deflate`           | `native_deflate`       |    10 |   ✅   | 00:00:00.574 |
| `test_websocket`         | `native_ws_deflate`    |    67 |   ✅   | 00:00:00.828 |
| `test_time_source`       | `native_time_source`   |     9 |   ✅   | 00:00:00.522 |
| `test_config_store`      | `native_config_store`  |    14 |   ✅   | 00:00:00.531 |
| `test_device_id`         | `native_device_id`     |     4 |   ✅   | 00:00:00.541 |
| `test_auth_lockout`      | `native_auth_lockout`  |    10 |   ✅   | 00:00:00.543 |
| `test_csrf`              | `native_csrf`          |     9 |   ✅   | 00:00:00.547 |
| `test_telemetry`         | `native_telemetry`     |     8 |   ✅   | 00:00:00.527 |
| `test_dashboard`         | `native_dashboard`     |    11 |   ✅   | 00:00:00.518 |
| `test_net_egress`        | `native_net_egress`    |     5 |   ✅   | 00:00:00.514 |
| `test_partition_monitor` | `native_partition`     |     5 |   ✅   | 00:00:00.505 |
| `test_cbor`              | `native_cbor`          |    14 |   ✅   | 00:00:00.524 |
| `test_msgpack`           | `native_msgpack`       |    15 |   ✅   | 00:00:00.522 |
| `test_gpio_map`          | `native_gpio_map`      |     8 |   ✅   | 00:00:00.521 |
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.516 |
| `test_guardrails`        | `native_guardrails`    |     6 |   ✅   | 00:00:00.514 |
| `test_logbuf`            | `native_logbuf`        |     4 |   ✅   | 00:00:00.510 |
| `test_config_io`         | `native_config_io`     |     4 |   ✅   | 00:00:00.565 |
| `test_workers`           | `native_workers`       |     3 |   ✅   | 00:00:00.599 |
| `test_clock`             | `native_clock`         |     4 |   ✅   | 00:00:00.497 |
| `test_concurrency`       | `native_concurrency`   |     2 |   ✅   | 00:00:00.737 |
| `test_concurrency`       | `native_tsan`          |     2 |   ✅   | 00:00:00.867 |
...
|  47 | `test_serve_static_cache_control`                     |   ✅   | Serve static cache control                                                 |
|  48 | `test_request_log_hook_fires`                         |   ✅   | Request log hook fires                                                     |
|  49 | `test_stats_endpoint_emits_json`                      |   ✅   | Stats endpoint emits json                                                  |
|  50 | `test_sse_broadcast_after_upgrade_matches_path`       |   ✅   | Sse broadcast after upgrade matches path                                   |
|  51 | `test_metrics_emits_prometheus`                       |   ✅   | Metrics emits prometheus                                                   |
...
------------------ native:test_sse [PASSED] Took 8.80 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:08.796
native         test_session       PASSED    00:00:00.446
native         test_presentation  PASSED    00:00:00.478
native         test_transport     PASSED    00:00:00.466
native         test_websocket     PASSED    00:00:00.484
native         test_http_parser   PASSED    00:00:00.454
================ 306 test cases: 306 succeeded in 00:00:11.124 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.522
================== 3 test cases: 3 succeeded in 00:00:00.522 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
----------- native_prov:test_provisioning [PASSED] Took 0.53 seconds -----------

=================================== SUMMARY ===================================
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.532
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 2.92 seconds -------------
...
------------- native_ssh:test_ssh_auth [PASSED] Took 0.44 seconds --------------
...
------------ native_ssh:test_ssh_channel [PASSED] Took 0.41 seconds ------------

=================================== SUMMARY ===================================
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:02.915
native_ssh     test_ssh_auth       PASSED    00:00:00.443
native_ssh     test_ssh_server     PASSED    00:00:00.553
native_ssh     test_ssh_transport  PASSED    00:00:00.728
native_ssh     test_ssh_channel    PASSED    00:00:00.414
================= 92 test cases: 92 succeeded in 00:00:05.054 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.705
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 1.02 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.025
...
src/DeterministicESPAsyncWebServer.cpp:2789:76: warning: ‘snprintf’ output may be truncated before the last format character [-Wformat-truncation=]
 2789 |         snprintf(lastmod_line, sizeof(lastmod_line), "Last-Modified: %s\r\n", lm_date);
      |                                                                            ^
src/DeterministicESPAsyncWebServer.cpp:2789:17: note: ‘snprintf’ output between 18 and 57 bytes into a destination of size 56
 2789 |         snprintf(lastmod_line, sizeof(lastmod_line), "Last-Modified: %s\r\n", lm_date);
      |         ~~~~~~~~^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Testing...
...
------------- native_app:test_template [PASSED] Took 0.46 seconds --------------
...
------------ native_app:test_digest_auth [PASSED] Took 0.47 seconds ------------
...
----------- native_app:test_file_serving [PASSED] Took 0.48 seconds ------------
...
Building...
Testing...
test/test_application/test_application.cpp:973: test_handler_reads_body [PASSED]
test/test_application/test_application.cpp:974: test_handler_reads_query_param [PASSED]
test/test_application/test_application.cpp:975: test_handler_reads_header [PASSED]
test/test_application/test_application.cpp:976: test_wildcard_before_exact_wildcard_wins [PASSED]
test/test_application/test_application.cpp:979: test_fn_on_registers_and_dispatches [PASSED]
test/test_application/test_application.cpp:980: test_fn_on_path_copied_null_terminated [PASSED]
test/test_application/test_application.cpp:981: test_fn_on_table_full_extra_routes_dropped [PASSED]
test/test_application/test_application.cpp:982: test_fn_on_same_path_different_methods_are_distinct [PASSED]
test/test_application/test_application.cpp:985: test_fn_on_not_found_called_when_no_match [PASSED]
test/test_application/test_application.cpp:986: test_fn_on_not_found_not_called_when_match_exists [PASSED]
test/test_application/test_application.cpp:989: test_fn_set_cors_options_preflight_clears_slot [PASSED]
test/test_application/test_application.cpp:990: test_fn_set_cors_empty_string_disables [PASSED]
test/test_application/test_application.cpp:993: test_wrong_method_does_not_match [PASSED]
test/test_application/test_application.cpp:994: test_wrong_path_does_not_match [PASSED]
test/test_application/test_application.cpp:995: test_all_http_methods_dispatched [PASSED]
test/test_application/test_application.cpp:996: test_root_path_matches_exactly [PASSED]
test/test_application/test_application.cpp:997: test_root_path_does_not_match_subpath [PASSED]
test/test_application/test_application.cpp:998: test_wildcard_matches_any_suffix [PASSED]
test/test_application/test_application.cpp:999: test_wildcard_does_not_match_unrelated_prefix [PASSED]
test/test_application/test_application.cpp:1000: test_exact_route_wins_when_registered_first [PASSED]
test/test_application/test_application.cpp:1001: test_slot_not_stuck_in_complete_after_handle [PASSED]
test/test_application/test_application.cpp:1002: test_parse_error_slot_auto_reset [PASSED]
test/test_application/test_application.cpp:1005: stress_last_route_dispatched_in_full_table [PASSED]
test/test_application/test_application.cpp:1006: stress_sequential_requests_no_state_leak [PASSED]
test/test_application/test_application.cpp:1007: stress_all_slots_dispatched_simultaneously [PASSED]
test/test_application/test_application.cpp:1008: stress_wildcard_matches_many_paths [PASSED]
test/test_application/test_application.cpp:1009: stress_handle_with_no_complete_slots_is_nop [PASSED]
test/test_application/test_application.cpp:1012: race_slot_complete_between_handle_calls [PASSED]
test/test_application/test_application.cpp:1013: race_conn_freed_after_parse_complete [PASSED]
test/test_application/test_application.cpp:1014: race_double_handle_no_double_dispatch [PASSED]
test/test_application/test_application.cpp:1015: race_error_and_valid_slot_in_same_handle [PASSED]
test/test_application/test_application.cpp:1016: race_callback_manually_resets_slot [PASSED]
test/test_application/test_application.cpp:1019: test_uri_too_long_auto_resets_slot [PASSED]
test/test_application/test_application.cpp:1022: test_transfer_encoding_chunked_is_501 [PASSED]
test/test_application/test_application.cpp:1023: test_transfer_encoding_identity_is_501 [PASSED]
test/test_application/test_application.cpp:1025: test_redirect_emits_location_and_status [PASSED]
test/test_application/test_application.cpp:1026: test_redirect_invalid_code_defaults_to_302 [PASSED]
test/test_application/test_application.cpp:1027: test_mime_type_detection [PASSED]
test/test_application/test_application.cpp:1029: test_serve_static_file_and_mime [PASSED]
test/test_application/test_application.cpp:1030: test_serve_static_index_fallback [PASSED]
test/test_application/test_application.cpp:1031: test_serve_static_gzip_when_accepted [PASSED]
test/test_application/test_application.cpp:1032: test_serve_static_no_gzip_when_not_accepted [PASSED]
test/test_application/test_application.cpp:1033: test_serve_static_traversal_not_leaked [PASSED]
test/test_application/test_application.cpp:1034: test_serve_static_missing_is_404 [PASSED]
test/test_application/test_application.cpp:1035: test_serve_static_etag_conditional_get [PASSED]
test/test_application/test_application.cpp:1036: test_serve_static_last_modified_conditional_get [PASSED]
test/test_application/test_application.cpp:1037: test_serve_static_cache_control [PASSED]
test/test_application/test_application.cpp:1039: test_request_log_hook_fires [PASSED]
test/test_application/test_application.cpp:1040: test_stats_endpoint_emits_json [PASSED]
test/test_application/test_application.cpp:1043: test_sse_broadcast_after_upgrade_matches_path [PASSED]
test/test_application/test_application.cpp:1046: test_metrics_emits_prometheus [PASSED]
------------ native_app:test_application [PASSED] Took 0.53 seconds ------------

=================================== SUMMARY ===================================
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:00.944
native_app     test_template          PASSED    00:00:00.464
native_app     test_path_params       PASSED    00:00:00.470
native_app     test_digest_vectors    PASSED    00:00:00.426
native_app     test_form_params       PASSED    00:00:00.465
native_app     test_iface             PASSED    00:00:00.482
native_app     test_json              PASSED    00:00:00.450
native_app     test_response_headers  PASSED    00:00:00.475
native_app     test_middleware        PASSED    00:00:00.473
native_app     test_digest_auth       PASSED    00:00:00.470
native_app     test_web_terminal      PASSED    00:00:00.468
native_app     test_defer             PASSED    00:00:00.455
native_app     test_multipart         PASSED    00:00:00.474
native_app     test_auth              PASSED    00:00:00.473
native_app     test_file_serving      PASSED    00:00:00.482
native_app     test_dispatch          PASSED    00:00:00.468
native_app     test_chunked           PASSED    00:00:00.474
native_app     test_application       PASSED    00:00:00.526
================ 205 test cases: 205 succeeded in 00:00:08.942 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.542
native_snmp    test_snmp_agent  PASSED    00:00:00.388
================= 22 test cases: 22 succeeded in 00:00:00.930 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.109
================== 9 test cases: 9 succeeded in 00:00:01.109 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.625
...
--------------- native_coap:test_coap [PASSED] Took 0.54 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.544
================= 26 test cases: 26 succeeded in 00:00:00.544 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
------------- native_webdav:test_webdav [PASSED] Took 0.52 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.523
================= 19 test cases: 19 succeeded in 00:00:00.523 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.521
...
------ native_modbus_master:test_modbus_master [PASSED] Took 0.53 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.531
================== 5 test cases: 5 succeeded in 00:00:00.531 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.522
================== 5 test cases: 5 succeeded in 00:00:00.522 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
--------------- native_totp:test_totp [PASSED] Took 0.54 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.537
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.521
...
-------- native_radio_power:test_radio_power [PASSED] Took 0.52 seconds --------
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.511
================== 4 test cases: 4 succeeded in 00:00:00.511 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.530
================= 12 test cases: 12 succeeded in 00:00:00.530 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
--------------- native_oidc:test_oidc [PASSED] Took 0.66 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.660
================= 13 test cases: 13 succeeded in 00:00:00.660 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.541
================= 13 test cases: 13 succeeded in 00:00:00.541 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.530
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.554
================== 8 test cases: 8 succeeded in 00:00:00.554 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
-------------- native_opcua:test_opcua [PASSED] Took 0.52 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.518
================= 29 test cases: 29 succeeded in 00:00:00.518 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.569
...
---------- native_keepalive:test_keepalive [PASSED] Took 0.87 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:00.871
================= 10 test cases: 10 succeeded in 00:00:00.871 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_range/test_range.cpp:191: test_no_range_full_200              [PASSED]
test/test_range/test_range.cpp:192: test_range_prefix                   [PASSED]
test/test_range/test_range.cpp:193: test_range_open_ended               [PASSED]
test/test_range/test_range.cpp:194: test_range_suffix                   [PASSED]
test/test_range/test_range.cpp:195: test_range_single_byte              [PASSED]
test/test_range/test_range.cpp:196: test_range_clamped_to_eof           [PASSED]
test/test_range/test_range.cpp:197: test_range_unsatisfiable_416        [PASSED]
test/test_range/test_range.cpp:198: test_malformed_range_ignored        [PASSED]
test/test_range/test_range.cpp:199: test_multirange_falls_back_to_200   [PASSED]
test/test_range/test_range.cpp:200: test_head_with_range_no_body        [PASSED]
-------------- native_range:test_range [PASSED] Took 0.86 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:00.855
================= 10 test cases: 10 succeeded in 00:00:00.855 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
------------- native_syslog:test_syslog [PASSED] Took 0.55 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.549
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.558
================= 10 test cases: 10 succeeded in 00:00:00.558 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
------------- native_upload:test_upload [PASSED] Took 0.87 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:00.866
================== 3 test cases: 3 succeeded in 00:00:00.866 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
================= 10 test cases: 10 succeeded in 00:00:00.552 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.549
================= 12 test cases: 12 succeeded in 00:00:00.549 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.567
================= 16 test cases: 16 succeeded in 00:00:00.567 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
---------- native_ws_client:test_ws_client [PASSED] Took 0.57 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.565
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.603
================= 14 test cases: 14 succeeded in 00:00:00.603 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.539
================== 3 test cases: 3 succeeded in 00:00:00.539 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.574
...
test/test_websocket/test_websocket.cpp:1037: stress_ws_parse_max_payload [PASSED]
test/test_websocket/test_websocket.cpp:1038: stress_ws_parse_two_consecutive_frames [PASSED]
--------- native_ws_deflate:test_websocket [PASSED] Took 0.83 seconds ----------

=================================== SUMMARY ===================================
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.828
================= 67 test cases: 67 succeeded in 00:00:00.828 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.522
...
------- native_config_store:test_config_store [PASSED] Took 0.53 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.531
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.541
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.543
...
--------------- native_csrf:test_csrf [PASSED] Took 0.55 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.547
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.527
...
---------- native_dashboard:test_dashboard [PASSED] Took 0.52 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.518
================= 11 test cases: 11 succeeded in 00:00:00.518 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
--------- native_net_egress:test_net_egress [PASSED] Took 0.51 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.514
...
------ native_partition:test_partition_monitor [PASSED] Took 0.51 seconds ------

=================================== SUMMARY ===================================
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.505
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.524
...
------------ native_msgpack:test_msgpack [PASSED] Took 0.52 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.522
================= 15 test cases: 15 succeeded in 00:00:00.522 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.521
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.516
================== 4 test cases: 4 succeeded in 00:00:00.516 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
--------- native_guardrails:test_guardrails [PASSED] Took 0.51 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.514
...
------------- native_logbuf:test_logbuf [PASSED] Took 0.51 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.510
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.565
...
------------ native_workers:test_workers [PASSED] Took 0.60 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.599
...
-------------- native_clock:test_clock [PASSED] Took 0.50 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.497
================== 4 test cases: 4 succeeded in 00:00:00.497 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.737
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:00.867
