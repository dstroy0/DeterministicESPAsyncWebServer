...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:14.692 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.548 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.599 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.579 |
| `test_websocket`         | `native`               |    63 |   ✅   | 00:00:00.599 |
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.546 |
| `test_observability`     | `native_observability` |    15 |   ✅   | 00:00:00.678 |
| `test_http_ota`          | `native_ota`           |     3 |   ✅   | 00:00:00.645 |
| `test_provisioning`      | `native_prov`          |     5 |   ✅   | 00:00:00.650 |
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.848 |
| `test_ssh_auth`          | `native_ssh`           |    12 |   ✅   | 00:00:00.575 |
| `test_ssh_server`        | `native_ssh`           |     7 |   ✅   | 00:00:00.670 |
| `test_ssh_transport`     | `native_ssh`           |    23 |   ✅   | 00:00:00.883 |
| `test_ssh_channel`       | `native_ssh`           |    12 |   ✅   | 00:00:00.527 |
| `test_ssh_hardening`     | `native_ssh_hardened`  |     2 |   ✅   | 00:00:00.873 |
| `test_ssh_conn`          | `native_ssh_conn`      |     2 |   ✅   | 00:00:01.233 |
| `test_regex`             | `native_app`           |     9 |   ✅   | 00:00:01.095 |
| `test_template`          | `native_app`           |     6 |   ✅   | 00:00:00.565 |
| `test_path_params`       | `native_app`           |     8 |   ✅   | 00:00:00.575 |
| `test_digest_vectors`    | `native_app`           |     4 |   ✅   | 00:00:00.518 |
| `test_form_params`       | `native_app`           |     5 |   ✅   | 00:00:00.565 |
| `test_iface`             | `native_app`           |     7 |   ✅   | 00:00:00.578 |
| `test_json`              | `native_app`           |    17 |   ✅   | 00:00:00.527 |
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.575 |
| `test_middleware`        | `native_app`           |     9 |   ✅   | 00:00:00.576 |
| `test_digest_auth`       | `native_app`           |     5 |   ✅   | 00:00:00.585 |
| `test_web_terminal`      | `native_app`           |     7 |   ✅   | 00:00:00.582 |
| `test_defer`             | `native_app`           |     3 |   ✅   | 00:00:00.566 |
| `test_multipart`         | `native_app`           |    19 |   ✅   | 00:00:00.585 |
| `test_auth`              | `native_app`           |    13 |   ✅   | 00:00:00.575 |
| `test_file_serving`      | `native_app`           |    12 |   ✅   | 00:00:00.597 |
| `test_dispatch`          | `native_app`           |    11 |   ✅   | 00:00:00.583 |
| `test_chunked`           | `native_app`           |     8 |   ✅   | 00:00:00.584 |
| `test_application`       | `native_app`           |    50 |   ✅   | 00:00:00.679 |
| `test_snmp_ber`          | `native_snmp`          |     9 |   ✅   | 00:00:00.684 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.501 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.393 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.767 |
| `test_coap`              | `native_coap`          |    26 |   ✅   | 00:00:00.674 |
| `test_webdav`            | `native_webdav`        |    11 |   ✅   | 00:00:00.644 |
...
| `test_audit_log`         | `native_audit_log`     |    12 |   ✅   | 00:00:00.673 |
| `test_oidc`              | `native_oidc`          |    13 |   ✅   | 00:00:00.811 |
| `test_vfs`               | `native_vfs`           |    11 |   ✅   | 00:00:00.640 |
...
| `test_opcua`             | `native_opcua`         |    29 |   ✅   | 00:00:00.667 |
| `test_opcua_client`      | `native_opcua_client`  |    11 |   ✅   | 00:00:00.683 |
| `test_keepalive`         | `native_keepalive`     |    10 |   ✅   | 00:00:01.040 |
| `test_range`             | `native_range`         |    10 |   ✅   | 00:00:01.031 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.647 |
| `test_jwt`               | `native_jwt`           |    10 |   ✅   | 00:00:00.719 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.058 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.745 |
| `test_compliance`        | `native_compliance`    |    12 |   ✅   | 00:00:00.657 |
| `test_mqtt`              | `native_mqtt`          |    16 |   ✅   | 00:00:00.645 |
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.668 |
| `test_scratch`           | `native_scratch`       |    14 |   ✅   | 00:00:00.662 |
| `test_snmp_trap`         | `native_snmp_trap`     |     3 |   ✅   | 00:00:00.663 |
| `test_inflate`           | `native_inflate`       |    12 |   ✅   | 00:00:00.653 |
| `test_deflate`           | `native_deflate`       |    10 |   ✅   | 00:00:00.684 |
| `test_websocket`         | `native_ws_deflate`    |    67 |   ✅   | 00:00:00.990 |
...
| `test_csrf`              | `native_csrf`          |     9 |   ✅   | 00:00:00.700 |
| `test_telemetry`         | `native_telemetry`     |     8 |   ✅   | 00:00:00.676 |
| `test_dashboard`         | `native_dashboard`     |    11 |   ✅   | 00:00:00.650 |
| `test_net_egress`        | `native_net_egress`    |     5 |   ✅   | 00:00:00.624 |
| `test_partition_monitor` | `native_partition`     |     5 |   ✅   | 00:00:00.643 |
| `test_cbor`              | `native_cbor`          |    14 |   ✅   | 00:00:00.642 |
| `test_msgpack`           | `native_msgpack`       |     8 |   ✅   | 00:00:00.635 |
| `test_gpio_map`          | `native_gpio_map`      |     8 |   ✅   | 00:00:00.642 |
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.649 |
| `test_guardrails`        | `native_guardrails`    |     6 |   ✅   | 00:00:00.637 |
| `test_logbuf`            | `native_logbuf`        |     4 |   ✅   | 00:00:00.642 |
| `test_config_io`         | `native_config_io`     |     4 |   ✅   | 00:00:00.660 |
| `test_workers`           | `native_workers`       |     3 |   ✅   | 00:00:00.722 |
| `test_clock`             | `native_clock`         |     4 |   ✅   | 00:00:00.610 |
| `test_concurrency`       | `native_concurrency`   |     2 |   ✅   | 00:00:00.867 |
| `test_concurrency`       | `native_tsan`          |     2 |   ✅   | 00:00:01.205 |
...
----------------- native:test_sse [PASSED] Took 14.69 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:14.692
native         test_session       PASSED    00:00:00.548
native         test_presentation  PASSED    00:00:00.599
native         test_transport     PASSED    00:00:00.579
native         test_websocket     PASSED    00:00:00.599
native         test_http_parser   PASSED    00:00:00.546
================ 306 test cases: 306 succeeded in 00:00:17.565 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.678
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.645
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.848
native_ssh     test_ssh_auth       PASSED    00:00:00.575
native_ssh     test_ssh_server     PASSED    00:00:00.670
native_ssh     test_ssh_transport  PASSED    00:00:00.883
native_ssh     test_ssh_channel    PASSED    00:00:00.527
================= 92 test cases: 92 succeeded in 00:00:06.504 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.873
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.233
...
native_app     test_template          PASSED    00:00:00.565
native_app     test_path_params       PASSED    00:00:00.575
native_app     test_digest_vectors    PASSED    00:00:00.518
native_app     test_form_params       PASSED    00:00:00.565
native_app     test_iface             PASSED    00:00:00.578
native_app     test_json              PASSED    00:00:00.527
native_app     test_response_headers  PASSED    00:00:00.575
native_app     test_middleware        PASSED    00:00:00.576
native_app     test_digest_auth       PASSED    00:00:00.585
native_app     test_web_terminal      PASSED    00:00:00.582
native_app     test_defer             PASSED    00:00:00.566
native_app     test_multipart         PASSED    00:00:00.585
native_app     test_auth              PASSED    00:00:00.575
native_app     test_file_serving      PASSED    00:00:00.597
native_app     test_dispatch          PASSED    00:00:00.583
native_app     test_chunked           PASSED    00:00:00.584
native_app     test_application       PASSED    00:00:00.679
================ 202 test cases: 202 succeeded in 00:00:10.912 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
================= 22 test cases: 22 succeeded in 00:00:01.185 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.767
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.674
================= 26 test cases: 26 succeeded in 00:00:00.674 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.673
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.811
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.640
================= 11 test cases: 11 succeeded in 00:00:00.640 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.040
================= 10 test cases: 10 succeeded in 00:00:01.040 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.031
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.647
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.058
================== 3 test cases: 3 succeeded in 00:00:01.058 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.645
================= 16 test cases: 16 succeeded in 00:00:00.645 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.668
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.662
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.663
...
================= 67 test cases: 67 succeeded in 00:00:00.990 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.700
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.635
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.642
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.722
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.610
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.867
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.205
