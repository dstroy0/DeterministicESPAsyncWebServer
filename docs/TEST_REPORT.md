...
| `test_ssh_conn`          | `native_ssh_conn`      |     2 |   ✅   | 00:00:01.220 |
| `test_regex`             | `native_app`           |     9 |   ✅   | 00:00:01.112 |
...
| `test_digest_auth`       | `native_app`           |     5 |   ✅   | 00:00:00.592 |
| `test_web_terminal`      | `native_app`           |     7 |   ✅   | 00:00:00.589 |
| `test_defer`             | `native_app`           |     3 |   ✅   | 00:00:00.582 |
| `test_multipart`         | `native_app`           |    19 |   ✅   | 00:00:00.615 |
| `test_auth`              | `native_app`           |    13 |   ✅   | 00:00:00.590 |
| `test_file_serving`      | `native_app`           |    12 |   ✅   | 00:00:00.616 |
| `test_dispatch`          | `native_app`           |    11 |   ✅   | 00:00:00.588 |
| `test_chunked`           | `native_app`           |    10 |   ✅   | 00:00:00.614 |
| `test_application`       | `native_app`           |    50 |   ✅   | 00:00:00.660 |
| `test_snmp_ber`          | `native_snmp`          |     9 |   ✅   | 00:00:00.684 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.491 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.417 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.792 |
| `test_coap`              | `native_coap`          |    26 |   ✅   | 00:00:00.670 |
| `test_webdav`            | `native_webdav`        |    19 |   ✅   | 00:00:00.656 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.664 |
...
| `test_oidc`              | `native_oidc`          |    13 |   ✅   | 00:00:00.819 |
| `test_vfs`               | `native_vfs`           |    11 |   ✅   | 00:00:00.654 |
| `test_graphql`           | `native_graphql`       |    13 |   ✅   | 00:00:00.652 |
| `test_espnow`            | `native_espnow`        |     7 |   ✅   | 00:00:00.647 |
| `test_oauth2`            | `native_oauth2`        |     8 |   ✅   | 00:00:00.679 |
| `test_opcua`             | `native_opcua`         |    29 |   ✅   | 00:00:00.688 |
| `test_opcua_client`      | `native_opcua_client`  |    11 |   ✅   | 00:00:00.683 |
| `test_keepalive`         | `native_keepalive`     |    10 |   ✅   | 00:00:01.056 |
| `test_range`             | `native_range`         |    10 |   ✅   | 00:00:01.038 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.668 |
| `test_jwt`               | `native_jwt`           |    10 |   ✅   | 00:00:00.708 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.075 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.659 |
| `test_compliance`        | `native_compliance`    |    12 |   ✅   | 00:00:00.662 |
...
| `test_snmp_trap`         | `native_snmp_trap`     |     3 |   ✅   | 00:00:00.671 |
| `test_inflate`           | `native_inflate`       |    12 |   ✅   | 00:00:00.652 |
| `test_deflate`           | `native_deflate`       |    10 |   ✅   | 00:00:00.700 |
| `test_websocket`         | `native_ws_deflate`    |    67 |   ✅   | 00:00:01.003 |
...
| `test_cbor`              | `native_cbor`          |    14 |   ✅   | 00:00:00.634 |
| `test_msgpack`           | `native_msgpack`       |    15 |   ✅   | 00:00:00.658 |
| `test_gpio_map`          | `native_gpio_map`      |     8 |   ✅   | 00:00:00.667 |
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.660 |
| `test_guardrails`        | `native_guardrails`    |     6 |   ✅   | 00:00:00.650 |
...
| `test_clock`             | `native_clock`         |     4 |   ✅   | 00:00:00.637 |
...
------------------ native:test_sse [PASSED] Took 6.62 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.616
...
native         test_websocket     PASSED    00:00:00.604
native         test_http_parser   PASSED    00:00:00.585
================ 306 test cases: 306 succeeded in 00:00:09.564 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.656
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.220
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.112
...
native_app     test_web_terminal      PASSED    00:00:00.589
...
native_app     test_file_serving      PASSED    00:00:00.616
native_app     test_dispatch          PASSED    00:00:00.588
native_app     test_chunked           PASSED    00:00:00.614
native_app     test_application       PASSED    00:00:00.660
================ 204 test cases: 204 succeeded in 00:00:11.193 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
native_snmp    test_snmp_agent  PASSED    00:00:00.491
================= 22 test cases: 22 succeeded in 00:00:01.175 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.670
================= 26 test cases: 26 succeeded in 00:00:00.670 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.819
================= 13 test cases: 13 succeeded in 00:00:00.819 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.679
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.038
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.075
================== 3 test cases: 3 succeeded in 00:00:01.075 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.650
