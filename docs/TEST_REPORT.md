...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:06.031 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.685 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.716 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.706 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.690 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.706 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.712 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.743 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.699 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.701 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.717 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.704 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.711 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.707 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.122 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.665 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.717 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.716 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.705 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.682 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.827 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:01.091 |
...
| `test_ssh_auth`          | `native_ssh`            |    18 |   ✅   | 00:00:00.656 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.917 |
| `test_ssh_transport`     | `native_ssh`            |    27 |   ✅   | 00:00:01.128 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.638 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.978 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.428 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.272 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.661 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.668 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.626 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.663 |
...
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.665 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.640 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.673 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.661 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.685 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.668 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.672 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.753 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.320 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.277 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.782 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.576 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:02.153 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.873 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.988 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.848 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.752 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.743 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.802 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.733 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.734 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.750 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.724 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.735 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.768 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.849 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.942 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.829 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.740 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.737 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.750 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.731 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.741 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.758 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.750 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.767 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.785 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.744 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.739 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.756 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.763 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.798 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.751 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.746 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.783 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.747 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.746 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.744 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.728 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.723 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.734 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.745 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.746 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.752 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.742 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.745 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.761 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.748 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.773 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.732 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.754 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.742 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.783 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.971 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.786 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.753 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.709 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.738 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.757 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.755 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.198 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.214 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.760 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.776 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.208 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.737 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.747 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.718 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.758 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.774 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.743 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.717 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.761 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.113 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.729 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.741 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.750 |
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.753 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.738 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.732 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.719 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.712 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.699 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.718 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.726 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.717 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.725 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.708 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.732 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.734 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.849 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.700 |
...
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.031
================= 17 test cases: 17 succeeded in 00:00:06.031 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.685
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.716
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.712
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.743
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.704
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.711
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.707
...
--------------- native:test_transport [PASSED] Took 0.72 seconds ---------------
...
-------------- native:test_http_parser [PASSED] Took 0.68 seconds --------------

=================================== SUMMARY ===================================
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.122
native         test_session       PASSED    00:00:00.665
native         test_presentation  PASSED    00:00:00.717
native         test_transport     PASSED    00:00:00.716
native         test_websocket     PASSED    00:00:00.705
native         test_http_parser   PASSED    00:00:00.682
================ 323 test cases: 323 succeeded in 00:00:04.608 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.091
...
native_ssh     test_ssh_auth       PASSED    00:00:00.656
native_ssh     test_ssh_server     PASSED    00:00:00.917
native_ssh     test_ssh_transport  PASSED    00:00:01.128
native_ssh     test_ssh_channel    PASSED    00:00:00.638
================ 120 test cases: 120 succeeded in 00:00:07.315 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
native_app     test_template          PASSED    00:00:00.661
native_app     test_path_params       PASSED    00:00:00.668
native_app     test_digest_vectors    PASSED    00:00:00.626
native_app     test_form_params       PASSED    00:00:00.663
...
native_app     test_web_terminal      PASSED    00:00:00.665
native_app     test_defer             PASSED    00:00:00.640
native_app     test_multipart         PASSED    00:00:00.673
native_app     test_auth              PASSED    00:00:00.661
native_app     test_file_serving      PASSED    00:00:00.685
native_app     test_dispatch          PASSED    00:00:00.668
native_app     test_chunked           PASSED    00:00:00.672
native_app     test_application       PASSED    00:00:00.753
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.320
================= 12 test cases: 12 succeeded in 00:00:01.320 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.277
================== 2 test cases: 2 succeeded in 00:00:01.277 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
native_snmp    test_snmp_agent  PASSED    00:00:00.576
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 2.15 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:02.153
================= 15 test cases: 15 succeeded in 00:00:02.153 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.873
================= 15 test cases: 15 succeeded in 00:00:00.873 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.988
================= 41 test cases: 41 succeeded in 00:00:00.988 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
test/test_coap/test_coap.cpp:1076: test_well_known_core_discovery       [PASSED]
test/test_coap/test_coap.cpp:1077: test_well_known_core_rejects_post    [PASSED]
----------- native_coap_observe:test_coap [PASSED] Took 0.85 seconds -----------

=================================== SUMMARY ===================================
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.848
================= 41 test cases: 41 succeeded in 00:00:00.848 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.752
================= 19 test cases: 19 succeeded in 00:00:00.752 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.743
================= 22 test cases: 22 succeeded in 00:00:00.743 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.733
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.734
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.750
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.724
...
----------- native_protobuf:test_protobuf [PASSED] Took 0.74 seconds -----------
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.849
================= 11 test cases: 11 succeeded in 00:00:00.849 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.942
================= 16 test cases: 16 succeeded in 00:00:00.942 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
------------ native_gateway:test_gateway [PASSED] Took 0.83 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.829
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.740
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.750
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_pn532   test_pn532  PASSED    00:00:00.731
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.741
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.767
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.785
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.744
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.739
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.756
...
---------- native_lwm2m_tlv:test_lwm2m_tlv [PASSED] Took 0.80 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.798
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.783
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.746
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.728
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.723
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.734
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.745
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.752
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.742
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.748
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.773
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.732
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.754
================== 2 test cases: 2 succeeded in 00:00:00.754 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.742
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.783
================= 16 test cases: 16 succeeded in 00:00:00.783 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.753
================= 32 test cases: 32 succeeded in 00:00:00.753 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.709
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.738
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.757
================= 38 test cases: 38 succeeded in 00:00:00.757 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.755
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.760
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.208
================== 3 test cases: 3 succeeded in 00:00:01.208 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.737
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.747
================= 15 test cases: 15 succeeded in 00:00:00.747 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.718
================= 22 test cases: 22 succeeded in 00:00:00.718 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.774
================= 14 test cases: 14 succeeded in 00:00:00.774 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.743
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.717
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.113
================= 71 test cases: 71 succeeded in 00:00:01.113 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.741
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.750
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.753
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.719
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.712
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.699
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.726
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.725
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.732
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.734
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.700
