...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:13.250 |
...
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.810 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.546 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.665 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.866 |
...
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.559 |
...
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.554 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.553 |
...
| `test_concurrency`      | `native_tsan`         |     2 |   ✅   | 00:00:01.225 |
...
----------------- native:test_sse [PASSED] Took 13.25 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:13.250
...
native_ssh           test_ssh_crypto        PASSED    00:00:03.810
...
native_app           test_path_params       PASSED    00:00:00.559
...
native_app           test_dispatch          PASSED    00:00:00.554
native_app           test_chunked           PASSED    00:00:00.553
...
native_tsan          test_concurrency       PASSED    00:00:01.225
================ 619 test cases: 619 succeeded in 00:00:37.468 ================
```
