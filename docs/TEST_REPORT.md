...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:06.179 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.531 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.566 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.544 |
| `test_websocket`         | `native`               |    63 |   ✅   | 00:00:00.569 |
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.527 |
| `test_observability`     | `native_observability` |    15 |   ✅   | 00:00:00.673 |
| `test_http_ota`          | `native_ota`           |     3 |   ✅   | 00:00:00.616 |
| `test_provisioning`      | `native_prov`          |     5 |   ✅   | 00:00:00.626 |
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.822 |
| `test_ssh_auth`          | `native_ssh`           |    12 |   ✅   | 00:00:00.541 |
| `test_ssh_server`        | `native_ssh`           |     7 |   ✅   | 00:00:00.643 |
| `test_ssh_transport`     | `native_ssh`           |    23 |   ✅   | 00:00:00.863 |
| `test_ssh_channel`       | `native_ssh`           |    12 |   ✅   | 00:00:00.514 |
| `test_ssh_hardening`     | `native_ssh_hardened`  |     2 |   ✅   | 00:00:00.836 |
| `test_ssh_conn`          | `native_ssh_conn`      |     2 |   ✅   | 00:00:01.185 |
| `test_regex`             | `native_app`           |     9 |   ✅   | 00:00:01.110 |
| `test_template`          | `native_app`           |     6 |   ✅   | 00:00:00.556 |
| `test_path_params`       | `native_app`           |     8 |   ✅   | 00:00:00.551 |
| `test_digest_vectors`    | `native_app`           |     4 |   ✅   | 00:00:00.494 |
| `test_form_params`       | `native_app`           |     5 |   ✅   | 00:00:00.550 |
| `test_iface`             | `native_app`           |     7 |   ✅   | 00:00:00.551 |
| `test_json`              | `native_app`           |    17 |   ✅   | 00:00:00.505 |
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.551 |
| `test_middleware`        | `native_app`           |     9 |   ✅   | 00:00:00.551 |
| `test_digest_auth`       | `native_app`           |     5 |   ✅   | 00:00:00.547 |
| `test_web_terminal`      | `native_app`           |     7 |   ✅   | 00:00:00.548 |
| `test_defer`             | `native_app`           |     3 |   ✅   | 00:00:00.526 |
| `test_multipart`         | `native_app`           |    19 |   ✅   | 00:00:00.559 |
| `test_auth`              | `native_app`           |    13 |   ✅   | 00:00:00.553 |
| `test_file_serving`      | `native_app`           |    12 |   ✅   | 00:00:00.562 |
| `test_dispatch`          | `native_app`           |    11 |   ✅   | 00:00:00.553 |
| `test_chunked`           | `native_app`           |     8 |   ✅   | 00:00:00.547 |
| `test_application`       | `native_app`           |    50 |   ✅   | 00:00:00.643 |
| `test_snmp_ber`          | `native_snmp`          |     9 |   ✅   | 00:00:00.669 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.478 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.345 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.729 |
| `test_coap`              | `native_coap`          |    26 |   ✅   | 00:00:00.650 |
| `test_webdav`            | `native_webdav`        |    19 |   ✅   | 00:00:00.635 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.624 |
| `test_modbus_master`     | `native_modbus_master` |     5 |   ✅   | 00:00:00.646 |
| `test_ota_rollback`      | `native_ota_rollback`  |     5 |   ✅   | 00:00:00.624 |
| `test_totp`              | `native_totp`          |     4 |   ✅   | 00:00:00.638 |
| `test_webhook`           | `native_webhook`       |     5 |   ✅   | 00:00:00.630 |
| `test_radio_power`       | `native_radio_power`   |     2 |   ✅   | 00:00:00.615 |
| `test_dns_resolver`      | `native_dns_resolver`  |     4 |   ✅   | 00:00:00.616 |
| `test_audit_log`         | `native_audit_log`     |    12 |   ✅   | 00:00:00.652 |
| `test_oidc`              | `native_oidc`          |    13 |   ✅   | 00:00:00.802 |
| `test_vfs`               | `native_vfs`           |    11 |   ✅   | 00:00:00.623 |
| `test_graphql`           | `native_graphql`       |    13 |   ✅   | 00:00:00.639 |
| `test_espnow`            | `native_espnow`        |     7 |   ✅   | 00:00:00.626 |
| `test_oauth2`            | `native_oauth2`        |     8 |   ✅   | 00:00:00.646 |
| `test_opcua`             | `native_opcua`         |    29 |   ✅   | 00:00:00.660 |
| `test_opcua_client`      | `native_opcua_client`  |    11 |   ✅   | 00:00:00.666 |
| `test_keepalive`         | `native_keepalive`     |    10 |   ✅   | 00:00:01.012 |
| `test_range`             | `native_range`         |    10 |   ✅   | 00:00:01.006 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.635 |
| `test_jwt`               | `native_jwt`           |    10 |   ✅   | 00:00:00.670 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.039 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.637 |
| `test_compliance`        | `native_compliance`    |    12 |   ✅   | 00:00:00.626 |
| `test_mqtt`              | `native_mqtt`          |    16 |   ✅   | 00:00:00.626 |
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.662 |
| `test_scratch`           | `native_scratch`       |    14 |   ✅   | 00:00:00.656 |
| `test_snmp_trap`         | `native_snmp_trap`     |     3 |   ✅   | 00:00:00.640 |
| `test_inflate`           | `native_inflate`       |    12 |   ✅   | 00:00:00.626 |
| `test_deflate`           | `native_deflate`       |    10 |   ✅   | 00:00:00.669 |
| `test_websocket`         | `native_ws_deflate`    |    67 |   ✅   | 00:00:00.994 |
| `test_time_source`       | `native_time_source`   |     9 |   ✅   | 00:00:00.616 |
| `test_config_store`      | `native_config_store`  |    14 |   ✅   | 00:00:00.612 |
| `test_device_id`         | `native_device_id`     |     4 |   ✅   | 00:00:00.637 |
| `test_auth_lockout`      | `native_auth_lockout`  |    10 |   ✅   | 00:00:00.617 |
| `test_csrf`              | `native_csrf`          |     9 |   ✅   | 00:00:00.652 |
| `test_telemetry`         | `native_telemetry`     |     8 |   ✅   | 00:00:00.638 |
| `test_dashboard`         | `native_dashboard`     |    11 |   ✅   | 00:00:00.626 |
| `test_net_egress`        | `native_net_egress`    |     5 |   ✅   | 00:00:00.617 |
| `test_partition_monitor` | `native_partition`     |     5 |   ✅   | 00:00:00.626 |
| `test_cbor`              | `native_cbor`          |    14 |   ✅   | 00:00:00.613 |
| `test_msgpack`           | `native_msgpack`       |    15 |   ✅   | 00:00:00.631 |
| `test_gpio_map`          | `native_gpio_map`      |     8 |   ✅   | 00:00:00.628 |
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.623 |
| `test_guardrails`        | `native_guardrails`    |     6 |   ✅   | 00:00:00.618 |
| `test_logbuf`            | `native_logbuf`        |     4 |   ✅   | 00:00:00.626 |
| `test_config_io`         | `native_config_io`     |     4 |   ✅   | 00:00:00.658 |
| `test_workers`           | `native_workers`       |     3 |   ✅   | 00:00:00.719 |
| `test_clock`             | `native_clock`         |     4 |   ✅   | 00:00:00.597 |
| `test_concurrency`       | `native_concurrency`   |     2 |   ✅   | 00:00:00.724 |
| `test_concurrency`       | `native_tsan`          |     2 |   ✅   | 00:00:01.273 |
...
------------------ native:test_sse [PASSED] Took 6.18 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.179
native         test_session       PASSED    00:00:00.531
native         test_presentation  PASSED    00:00:00.566
native         test_transport     PASSED    00:00:00.544
native         test_websocket     PASSED    00:00:00.569
native         test_http_parser   PASSED    00:00:00.527
================ 306 test cases: 306 succeeded in 00:00:08.915 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.616
================== 3 test cases: 3 succeeded in 00:00:00.616 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.822
native_ssh     test_ssh_auth       PASSED    00:00:00.541
native_ssh     test_ssh_server     PASSED    00:00:00.643
native_ssh     test_ssh_transport  PASSED    00:00:00.863
native_ssh     test_ssh_channel    PASSED    00:00:00.514
================= 92 test cases: 92 succeeded in 00:00:06.383 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.836
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.185
...
------------- native_app:test_dispatch [PASSED] Took 0.55 seconds --------------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.110
native_app     test_template          PASSED    00:00:00.556
native_app     test_path_params       PASSED    00:00:00.551
native_app     test_digest_vectors    PASSED    00:00:00.494
native_app     test_form_params       PASSED    00:00:00.550
native_app     test_iface             PASSED    00:00:00.551
native_app     test_json              PASSED    00:00:00.505
...
native_app     test_web_terminal      PASSED    00:00:00.548
native_app     test_defer             PASSED    00:00:00.526
native_app     test_multipart         PASSED    00:00:00.559
native_app     test_auth              PASSED    00:00:00.553
native_app     test_file_serving      PASSED    00:00:00.562
native_app     test_dispatch          PASSED    00:00:00.553
native_app     test_chunked           PASSED    00:00:00.547
native_app     test_application       PASSED    00:00:00.643
================ 202 test cases: 202 succeeded in 00:00:10.459 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
native_snmp    test_snmp_agent  PASSED    00:00:00.478
================= 22 test cases: 22 succeeded in 00:00:01.146 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
================== 9 test cases: 9 succeeded in 00:00:01.345 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.624
================= 13 test cases: 13 succeeded in 00:00:00.624 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.646
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.638
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.630
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.615
================== 2 test cases: 2 succeeded in 00:00:00.615 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.652
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.802
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.623
================= 11 test cases: 11 succeeded in 00:00:00.623 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.639
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.626
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.646
...
================= 29 test cases: 29 succeeded in 00:00:00.660 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.666
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.012
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.635
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.670
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.039
================== 3 test cases: 3 succeeded in 00:00:01.039 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.626
================= 16 test cases: 16 succeeded in 00:00:00.626 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.640
================== 3 test cases: 3 succeeded in 00:00:00.640 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.626
================= 12 test cases: 12 succeeded in 00:00:00.626 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.994
================= 67 test cases: 67 succeeded in 00:00:00.994 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.612
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.637
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.617
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.652
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.638
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.617
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.613
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.631
================= 15 test cases: 15 succeeded in 00:00:00.631 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.628
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.623
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.618
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.719
================== 3 test cases: 3 succeeded in 00:00:00.719 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.724
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.273
================== 2 test cases: 2 succeeded in 00:00:01.273 ==================
```
