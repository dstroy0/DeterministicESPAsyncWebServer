...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:12.786 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.624 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.644 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.639 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:04.422 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.645 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.645 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.636 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.633 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.667 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.635 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.645 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.653 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.639 |
...
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:01.005 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.676 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.664 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.929 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.631 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.836 |
| `test_ssh_transport`     | `native_ssh`            |    31 |   ✅   | 00:00:01.128 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.583 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.955 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.354 |
...
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.564 |
...
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.169 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.686 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.511 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:01.944 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.813 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.921 |
...
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.736 |
...
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.645 |
...
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.734 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.640 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.652 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.647 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.639 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.642 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.643 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.648 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.644 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.674 |
...
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.699 |
...
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.640 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.667 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.659 |
...
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.637 |
...
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.696 |
...
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.658 |
...
----------- native_canopen:test_canopen [PASSED] Took 12.79 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:12.786
================= 17 test cases: 17 succeeded in 00:00:12.786 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.624
...
---------- native_det_arena:test_det_arena [PASSED] Took 0.64 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_det_arena  test_det_arena  PASSED    00:00:00.639
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:04.422
================= 16 test cases: 16 succeeded in 00:00:04.422 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.645
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.633
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.645
================== 8 test cases: 8 succeeded in 00:00:00.645 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.639
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.005
================= 13 test cases: 13 succeeded in 00:00:01.005 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.929
...
================ 137 test cases: 137 succeeded in 00:00:07.107 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.354
...
================ 225 test cases: 225 succeeded in 00:00:11.480 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.169
================== 2 test cases: 2 succeeded in 00:00:01.169 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.686
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 1.94 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.944
================= 15 test cases: 15 succeeded in 00:00:01.944 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.921
================= 41 test cases: 41 succeeded in 00:00:00.921 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.736
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.645
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.734
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.640
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.647
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_pn532   test_pn532  PASSED    00:00:00.639
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.642
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_zigbee  test_zigbee  PASSED    00:00:00.648
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.644
================= 13 test cases: 13 succeeded in 00:00:00.644 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.674
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.699
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.640
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.659
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.637
...
================= 13 test cases: 13 succeeded in 00:00:01.103 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
================= 21 test cases: 21 succeeded in 00:00:00.710 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.658
