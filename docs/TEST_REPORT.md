...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    11 |   ✅   | 00:00:13.799 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.662 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.687 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.706 |
| `test_mbus`              | `native_mbus`           |     8 |   ✅   | 00:00:00.676 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.691 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.697 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.690 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.694 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.690 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.170 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.593 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.627 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.608 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.637 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.603 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.759 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:01.137 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.695 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.736 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:04.037 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.590 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.689 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.913 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.569 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.083 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.593 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.386 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.608 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.617 |
...
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.579 |
...
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.617 |
...
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.419 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.401 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.774 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.511 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.593 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.842 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.898 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.791 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.668 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.693 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.766 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.678 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.691 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.663 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.701 |
| `test_protobuf`          | `native_protobuf`       |    10 |   ✅   | 00:00:00.690 |
| `test_preempt_queue`     | `native_preempt_queue`  |     7 |   ✅   | 00:00:00.715 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.719 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.690 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.697 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.696 |
...
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.692 |
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.773 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.688 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.700 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.690 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.691 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.687 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.686 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.706 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.688 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.666 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.699 |
| `test_sparkplug`         | `native_sparkplug`      |     6 |   ✅   | 00:00:00.715 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.716 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.703 |
...
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.698 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.729 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.991 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.696 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.703 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.705 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.724 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.707 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.728 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.282 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.252 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.712 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.765 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.321 |
| `test_http_client`       | `native_http_client`    |    11 |   ✅   | 00:00:00.698 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.716 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.708 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.770 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.728 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.712 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.688 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.732 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.214 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.689 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.680 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.690 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.688 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.735 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.671 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.692 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.689 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.658 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.697 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.699 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.690 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.694 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.664 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.686 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.732 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.858 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.702 |
...
----------- native_canopen:test_canopen [PASSED] Took 13.80 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:13.799
================= 11 test cases: 11 succeeded in 00:00:13.799 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.706
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.676
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.697
...
------------------ native:test_sse [PASSED] Took 1.17 seconds ------------------
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.170
native         test_session       PASSED    00:00:00.593
native         test_presentation  PASSED    00:00:00.627
native         test_transport     PASSED    00:00:00.608
native         test_websocket     PASSED    00:00:00.637
native         test_http_parser   PASSED    00:00:00.603
================ 318 test cases: 318 succeeded in 00:00:04.239 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.759
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.137
================= 10 test cases: 10 succeeded in 00:00:01.137 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.695
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.736
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.037
native_ssh     test_ssh_auth       PASSED    00:00:00.590
native_ssh     test_ssh_server     PASSED    00:00:00.689
native_ssh     test_ssh_transport  PASSED    00:00:00.913
native_ssh     test_ssh_channel    PASSED    00:00:00.569
================ 101 test cases: 101 succeeded in 00:00:06.798 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:01.083
================== 2 test cases: 2 succeeded in 00:00:01.083 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 1.59 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.593
================== 2 test cases: 2 succeeded in 00:00:01.593 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
--------------- native_app:test_regex [PASSED] Took 1.39 seconds ---------------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.386
native_app     test_template          PASSED    00:00:00.608
native_app     test_path_params       PASSED    00:00:00.617
...
native_app     test_web_terminal      PASSED    00:00:00.617
...
================ 219 test cases: 219 succeeded in 00:00:11.837 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.419
================= 12 test cases: 12 succeeded in 00:00:01.419 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
--------------- native_diag:test_diag [PASSED] Took 1.40 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.401
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.774
native_snmp    test_snmp_agent  PASSED    00:00:00.511
================= 30 test cases: 30 succeeded in 00:00:01.285 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.593
================= 10 test cases: 10 succeeded in 00:00:01.593 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.842
...
================= 29 test cases: 29 succeeded in 00:00:00.898 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.791
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.766
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.701
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.690
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.715
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.719
================= 12 test cases: 12 succeeded in 00:00:00.719 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.690
================== 5 test cases: 5 succeeded in 00:00:00.690 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.697
================== 6 test cases: 6 succeeded in 00:00:00.697 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.692
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.688
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.700
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.688
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.666
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.715
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.716
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.703
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.698
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.729
================= 12 test cases: 12 succeeded in 00:00:00.729 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.991
================= 13 test cases: 13 succeeded in 00:00:00.991 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.703
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.724
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.282
================= 10 test cases: 10 succeeded in 00:00:01.282 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.252
================= 13 test cases: 13 succeeded in 00:00:01.252 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.765
================= 12 test cases: 12 succeeded in 00:00:00.765 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_upload:test_upload [PASSED] Took 1.32 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.321
================== 3 test cases: 3 succeeded in 00:00:01.321 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.698
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.716
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.708
================= 19 test cases: 19 succeeded in 00:00:00.708 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
---------- native_ws_client:test_ws_client [PASSED] Took 0.77 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.770
================= 10 test cases: 10 succeeded in 00:00:00.770 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.728
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.712
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.688
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.214
================= 71 test cases: 71 succeeded in 00:00:01.214 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.690
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.688
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.689
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.694
================== 7 test cases: 7 succeeded in 00:00:00.694 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.686
...
------------ native_workers:test_workers [PASSED] Took 0.86 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.858
================== 3 test cases: 3 succeeded in 00:00:00.858 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.702
