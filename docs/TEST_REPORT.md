...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:06.089 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.610 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.613 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.615 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:04.510 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.606 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.590 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.599 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.602 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.623 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.601 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.596 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.591 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.601 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.628 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.604 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:00.938 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.545 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.575 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.567 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.599 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.556 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.730 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:00.964 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.630 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.643 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:04.255 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.611 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.888 |
| `test_ssh_transport`     | `native_ssh`            |    31 |   ✅   | 00:00:01.239 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.555 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.901 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.287 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.130 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.599 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.573 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.516 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.572 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.591 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.530 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.572 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.573 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.592 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.572 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.555 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.576 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.583 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.585 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.570 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.575 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.649 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.175 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.129 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.657 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.484 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:02.145 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.759 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.734 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.732 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.644 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.597 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.690 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.630 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.612 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.600 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.595 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.597 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.632 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.710 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.761 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.703 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.611 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.622 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.591 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.595 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.604 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.605 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.603 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.610 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.639 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.619 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:01.097 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.614 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.596 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.635 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.612 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.618 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.675 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.599 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.620 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.629 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.628 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.637 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.668 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.626 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.637 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.621 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.627 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.636 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.655 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.608 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.643 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.628 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.614 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.630 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.642 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.867 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.614 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.636 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.602 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.654 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.660 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.645 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.057 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.067 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.648 |
| `test_smtp`              | `native_smtp`           |    11 |   ✅   | 00:00:00.731 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.620 |
| `test_dns_server`        | `native_dns_server`     |     7 |   ✅   | 00:00:00.613 |
| `test_rtc`               | `native_rtc`            |     8 |   ✅   | 00:00:00.614 |
| `test_ld2410`            | `native_ld2410`         |     7 |   ✅   | 00:00:00.623 |
| `test_mpr121`            | `native_mpr121`         |     5 |   ✅   | 00:00:00.601 |
| `test_sht3x`             | `native_sht3x`          |     5 |   ✅   | 00:00:00.601 |
| `test_pca9685`           | `native_pca9685`        |     4 |   ✅   | 00:00:00.630 |
| `test_ads1115`           | `native_ads1115`        |     3 |   ✅   | 00:00:00.607 |
| `test_ina219`            | `native_ina219`         |     4 |   ✅   | 00:00:00.621 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.663 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.081 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.621 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.651 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.614 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.641 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.702 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.639 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.646 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.658 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.008 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.616 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.615 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.613 |
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.641 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.641 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.623 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.636 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.628 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.607 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.627 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.604 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.607 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.615 |
| `test_statsd`            | `native_statsd`         |     9 |   ✅   | 00:00:00.634 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.605 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.608 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.620 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.736 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.591 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.748 |
...
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.089
================= 17 test cases: 17 succeeded in 00:00:06.089 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
----- native_det_primitives:test_det_primitives [PASSED] Took 0.61 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.610
...
------------- native_det_ip:test_det_ip [PASSED] Took 0.61 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.613
...
---------- native_det_arena:test_det_arena [PASSED] Took 0.61 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_det_arena  test_det_arena  PASSED    00:00:00.615
================= 17 test cases: 17 succeeded in 00:00:00.615 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
-------- native_ssh_ed25519:test_ssh_ed25519 [PASSED] Took 4.51 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:04.510
================= 16 test cases: 16 succeeded in 00:00:04.510 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
------------ native_promisc:test_promisc [PASSED] Took 0.61 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.606
...
-------- native_bus_capture:test_bus_capture [PASSED] Took 0.59 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.590
...
-------------- native_j1939:test_j1939 [PASSED] Took 0.60 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.599
================== 9 test cases: 9 succeeded in 00:00:00.599 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
---------- native_devicenet:test_devicenet [PASSED] Took 0.60 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.602
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.623
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.601
================= 11 test cases: 11 succeeded in 00:00:00.601 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.596
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.591
...
---------------- native_dmx:test_dmx [PASSED] Took 0.60 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.601
================== 5 test cases: 5 succeeded in 00:00:00.601 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.628
================== 7 test cases: 7 succeeded in 00:00:00.628 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
------------- native_iolink:test_iolink [PASSED] Took 0.60 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.604
...
native         test_session       PASSED    00:00:00.545
native         test_presentation  PASSED    00:00:00.575
native         test_transport     PASSED    00:00:00.567
native         test_websocket     PASSED    00:00:00.599
native         test_http_parser   PASSED    00:00:00.556
================ 323 test cases: 323 succeeded in 00:00:03.779 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.730
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.643
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 4.26 seconds -------------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.255
native_ssh     test_ssh_auth       PASSED    00:00:00.611
native_ssh     test_ssh_server     PASSED    00:00:00.888
native_ssh     test_ssh_transport  PASSED    00:00:01.239
native_ssh     test_ssh_channel    PASSED    00:00:00.555
================ 137 test cases: 137 succeeded in 00:00:07.549 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.901
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.287
...
--------------- native_app:test_regex [PASSED] Took 1.13 seconds ---------------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.130
native_app     test_template          PASSED    00:00:00.599
native_app     test_path_params       PASSED    00:00:00.573
native_app     test_digest_vectors    PASSED    00:00:00.516
native_app     test_form_params       PASSED    00:00:00.572
native_app     test_iface             PASSED    00:00:00.591
native_app     test_json              PASSED    00:00:00.530
native_app     test_response_headers  PASSED    00:00:00.572
native_app     test_middleware        PASSED    00:00:00.573
native_app     test_digest_auth       PASSED    00:00:00.592
native_app     test_web_terminal      PASSED    00:00:00.572
native_app     test_defer             PASSED    00:00:00.555
native_app     test_multipart         PASSED    00:00:00.576
native_app     test_auth              PASSED    00:00:00.583
native_app     test_file_serving      PASSED    00:00:00.585
native_app     test_dispatch          PASSED    00:00:00.570
native_app     test_chunked           PASSED    00:00:00.575
native_app     test_application       PASSED    00:00:00.649
================ 225 test cases: 225 succeeded in 00:00:10.914 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.175
================= 12 test cases: 12 succeeded in 00:00:01.175 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.129
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.657
native_snmp    test_snmp_agent  PASSED    00:00:00.484
================= 35 test cases: 35 succeeded in 00:00:01.141 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:02.145
================= 15 test cases: 15 succeeded in 00:00:02.145 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.759
...
--------------- native_coap:test_coap [PASSED] Took 0.73 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.734
================= 41 test cases: 41 succeeded in 00:00:00.734 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.732
================= 41 test cases: 41 succeeded in 00:00:00.732 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
------------- native_webdav:test_webdav [PASSED] Took 0.64 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.644
================= 19 test cases: 19 succeeded in 00:00:00.644 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.597
================= 22 test cases: 22 succeeded in 00:00:00.597 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
-------- native_cloudevents:test_cloudevents [PASSED] Took 0.69 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.690
...
----------- native_redis:test_redis_resp [PASSED] Took 0.63 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.630
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.612
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.595
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.597
================= 13 test cases: 13 succeeded in 00:00:00.597 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.632
...
------------ native_forward:test_forward [PASSED] Took 0.76 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.761
================= 16 test cases: 16 succeeded in 00:00:00.761 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.703
================= 11 test cases: 11 succeeded in 00:00:00.703 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
--------------- native_lora:test_lora [PASSED] Took 0.61 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.611
================= 13 test cases: 13 succeeded in 00:00:00.611 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
-------------- native_nrf24:test_nrf24 [PASSED] Took 0.62 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.622
================= 10 test cases: 10 succeeded in 00:00:00.622 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
------------ native_enocean:test_enocean [PASSED] Took 0.59 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.591
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_pn532   test_pn532  PASSED    00:00:00.595
...
------------- native_sigfox:test_sigfox [PASSED] Took 0.60 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.604
================== 7 test cases: 7 succeeded in 00:00:00.604 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.605
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_zigbee  test_zigbee  PASSED    00:00:00.603
...
------------- native_thread:test_thread [PASSED] Took 0.61 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.610
================= 13 test cases: 13 succeeded in 00:00:00.610 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.639
================= 12 test cases: 12 succeeded in 00:00:00.639 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
------------ native_sunspec:test_sunspec [PASSED] Took 0.62 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.619
...
------------- native_c37118:test_c37118 [PASSED] Took 1.10 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:01.097
================== 6 test cases: 6 succeeded in 00:00:01.097 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.614
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.596
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.635
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.612
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.618
================== 7 test cases: 7 succeeded in 00:00:00.618 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.675
...
---------------- native_df1:test_df1 [PASSED] Took 0.60 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.599
================== 9 test cases: 9 succeeded in 00:00:00.599 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.620
================== 6 test cases: 6 succeeded in 00:00:00.620 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.629
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.628
================== 6 test cases: 6 succeeded in 00:00:00.628 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.637
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.626
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.637
================== 9 test cases: 9 succeeded in 00:00:00.637 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
--------------- native_nats:test_nats [PASSED] Took 0.62 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.621
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.627
...
---------- native_sparkplug:test_sparkplug [PASSED] Took 0.64 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.636
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.655
...
------- native_ota_rollback:test_ota_rollback [PASSED] Took 0.61 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.608
================== 5 test cases: 5 succeeded in 00:00:00.608 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.643
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.614
================== 2 test cases: 2 succeeded in 00:00:00.614 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.630
================== 4 test cases: 4 succeeded in 00:00:00.630 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
================= 16 test cases: 16 succeeded in 00:00:00.642 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.867
================= 17 test cases: 17 succeeded in 00:00:00.867 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.614
...
================= 32 test cases: 32 succeeded in 00:00:00.636 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.602
================== 7 test cases: 7 succeeded in 00:00:00.602 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.654
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.660
================= 38 test cases: 38 succeeded in 00:00:00.660 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.645
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.057
================= 10 test cases: 10 succeeded in 00:00:01.057 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.067
================= 13 test cases: 13 succeeded in 00:00:01.067 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
------------- native_syslog:test_syslog [PASSED] Took 0.65 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.648
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_smtp    test_smtp  PASSED    00:00:00.731
================= 11 test cases: 11 succeeded in 00:00:00.731 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
--------- native_ntp_server:test_ntp_server [PASSED] Took 0.62 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_ntp_server  test_ntp_server  PASSED    00:00:00.620
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_dns_server  test_dns_server  PASSED    00:00:00.613
...
---------------- native_rtc:test_rtc [PASSED] Took 0.61 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_rtc     test_rtc  PASSED    00:00:00.614
================== 8 test cases: 8 succeeded in 00:00:00.614 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
------------- native_ld2410:test_ld2410 [PASSED] Took 0.62 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ld2410  test_ld2410  PASSED    00:00:00.623
================== 7 test cases: 7 succeeded in 00:00:00.623 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
------------- native_mpr121:test_mpr121 [PASSED] Took 0.60 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_mpr121  test_mpr121  PASSED    00:00:00.601
================== 5 test cases: 5 succeeded in 00:00:00.601 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
-------------- native_sht3x:test_sht3x [PASSED] Took 0.60 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sht3x   test_sht3x  PASSED    00:00:00.601
================== 5 test cases: 5 succeeded in 00:00:00.601 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
------------ native_pca9685:test_pca9685 [PASSED] Took 0.63 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_pca9685  test_pca9685  PASSED    00:00:00.630
================== 4 test cases: 4 succeeded in 00:00:00.630 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
------------ native_ads1115:test_ads1115 [PASSED] Took 0.61 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_ads1115  test_ads1115  PASSED    00:00:00.607
...
------------- native_ina219:test_ina219 [PASSED] Took 0.62 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ina219  test_ina219  PASSED    00:00:00.621
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.663
================= 21 test cases: 21 succeeded in 00:00:00.663 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.081
================== 3 test cases: 3 succeeded in 00:00:01.081 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
================= 15 test cases: 15 succeeded in 00:00:00.621 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.651
================= 15 test cases: 15 succeeded in 00:00:00.651 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
--------------- native_mqtt:test_mqtt [PASSED] Took 0.61 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.614
================= 22 test cases: 22 succeeded in 00:00:00.614 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
---------- native_ws_client:test_ws_client [PASSED] Took 0.64 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.641
================= 16 test cases: 16 succeeded in 00:00:00.641 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.639
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.658
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.008
================= 71 test cases: 71 succeeded in 00:00:01.008 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
------- native_config_store:test_config_store [PASSED] Took 0.61 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.615
================= 14 test cases: 14 succeeded in 00:00:00.615 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.613
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.641
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.641
================== 9 test cases: 9 succeeded in 00:00:00.641 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.623
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.636
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.628
================== 6 test cases: 6 succeeded in 00:00:00.628 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.607
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.627
================= 18 test cases: 18 succeeded in 00:00:00.627 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
----------- native_gpio_map:test_gpio_map [PASSED] Took 0.61 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.607
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.615
================== 7 test cases: 7 succeeded in 00:00:00.615 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
------------- native_statsd:test_statsd [PASSED] Took 0.63 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_statsd  test_statsd  PASSED    00:00:00.634
================== 9 test cases: 9 succeeded in 00:00:00.634 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.605
================== 6 test cases: 6 succeeded in 00:00:00.605 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 156 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.608
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.620
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.736
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.591
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.748
