...
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.589 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.567 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.598 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.549 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.868 |
...
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.882 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.243 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:01.066 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.575 |
...
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.564 |
...
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.583 |
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.560 |
...
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.597 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.587 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.691 |
...
native               test_presentation      PASSED    00:00:00.589
...
native_ssh           test_ssh_crypto        PASSED    00:00:03.868
...
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.882
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.243
native_app           test_regex             PASSED    00:00:01.066
native_app           test_template          PASSED    00:00:00.575
...
native_app           test_iface             PASSED    00:00:00.564
...
native_app           test_defer             PASSED    00:00:00.560
...
================ 619 test cases: 619 succeeded in 00:00:31.875 ================
```
