...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:10.571 |
...
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.715 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.675 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.681 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.909 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.588 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.706 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.906 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.587 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.914 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.321 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.187 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.614 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.622 |
...
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.722 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.260 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.200 |
...
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.835 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.734 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.678 |
| `test_modbus`            | `native_modbus`         |    13 |   ✅   | 00:00:00.682 |
...
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.874 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.665 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.669 |
...
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.107 |
...
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.691 |
...
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.656 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.668 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.633 |
...
| `test_udp_telemetry`     | `native_udp_telemetry`  |     4 |   ✅   | 00:00:00.661 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.654 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.644 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.662 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.750 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.633 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.796 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.349 |
...
----------------- native:test_sse [PASSED] Took 10.57 seconds ------------------
...
---------------- native:test_session [PASSED] Took 0.77 seconds ----------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:10.571
native         test_session       PASSED    00:00:00.775
...
================ 318 test cases: 318 succeeded in 00:00:13.771 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.909
native_ssh     test_ssh_auth       PASSED    00:00:00.588
native_ssh     test_ssh_server     PASSED    00:00:00.706
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.914
================== 2 test cases: 2 succeeded in 00:00:00.914 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.321
...
native_app     test_path_params       PASSED    00:00:00.622
...
native_app     test_application       PASSED    00:00:00.722
================ 219 test cases: 219 succeeded in 00:00:11.806 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.200
...
================= 29 test cases: 29 succeeded in 00:00:01.204 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.835
================= 29 test cases: 29 succeeded in 00:00:00.835 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.734
================= 29 test cases: 29 succeeded in 00:00:00.734 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.874
================= 13 test cases: 13 succeeded in 00:00:00.874 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.107
================= 10 test cases: 10 succeeded in 00:00:01.107 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.656
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.633
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.662
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.349
