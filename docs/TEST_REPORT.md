...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:13.226 |
...
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.566 |
...
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.911 |
...
| `test_graphql`           | `native_graphql`       |    13 |   ✅   | 00:00:00.646 |
...
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.684 |
| `test_jwt`               | `native_jwt`           |    12 |   ✅   | 00:00:00.703 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.101 |
...
| `test_dashboard`         | `native_dashboard`     |    11 |   ✅   | 00:00:00.640 |
...
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.663 |
...
| `test_concurrency`       | `native_tsan`          |     2 |   ✅   | 00:00:01.168 |
...
----------------- native:test_sse [PASSED] Took 13.23 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:13.226
...
================ 310 test cases: 310 succeeded in 00:00:16.205 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.911
...
================= 92 test cases: 92 succeeded in 00:00:06.563 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
native_app     test_chunked           PASSED    00:00:00.598
native_app     test_application       PASSED    00:00:00.677
================ 217 test cases: 217 succeeded in 00:00:11.427 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
================= 29 test cases: 29 succeeded in 00:00:01.179 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.684
================= 27 test cases: 27 succeeded in 00:00:00.684 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.101
================== 3 test cases: 3 succeeded in 00:00:01.101 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.663
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.168
