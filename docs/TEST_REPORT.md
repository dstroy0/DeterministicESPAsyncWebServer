...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    11 |   ✅   | 00:00:05.647 |
...
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.670 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.653 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.714 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.673 |
...
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.742 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:01.113 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.674 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.688 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:04.056 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.586 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.685 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.899 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.541 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.046 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.573 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.335 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.620 |
...
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.562 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.613 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.620 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.632 |
...
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.621 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.688 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.403 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.363 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.758 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.508 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.566 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.833 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.779 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.757 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.690 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.694 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.749 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.671 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.662 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.642 |
...
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.662 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.668 |
...
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.747 |
...
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.679 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.664 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.650 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.641 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.677 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.642 |
| `test_sparkplug`         | `native_sparkplug`      |     6 |   ✅   | 00:00:00.694 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.693 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.669 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.679 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.647 |
...
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.886 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.670 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.670 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.664 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.686 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.690 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.699 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.244 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.221 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.677 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.736 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.283 |
| `test_http_client`       | `native_http_client`    |    11 |   ✅   | 00:00:00.679 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.668 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.659 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.759 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.717 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.699 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.652 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.719 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.183 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.675 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.679 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.689 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.670 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.724 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.677 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.666 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.676 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.649 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.646 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.688 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.682 |
...
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.634 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.766 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.520 |
...
------------ native_canopen:test_canopen [PASSED] Took 5.65 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:05.647
================= 11 test cases: 11 succeeded in 00:00:05.647 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.670
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.653
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.714
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.673
...
================ 318 test cases: 318 succeeded in 00:00:04.163 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
================= 17 test cases: 17 succeeded in 00:00:00.742 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.113
...
native_ssh     test_ssh_auth       PASSED    00:00:00.586
native_ssh     test_ssh_server     PASSED    00:00:00.685
native_ssh     test_ssh_transport  PASSED    00:00:00.899
native_ssh     test_ssh_channel    PASSED    00:00:00.541
================= 93 test cases: 93 succeeded in 00:00:06.768 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:01.046
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.573
...
--------------- native_app:test_regex [PASSED] Took 1.34 seconds ---------------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.335
native_app     test_template          PASSED    00:00:00.620
...
native_app     test_response_headers  PASSED    00:00:00.613
native_app     test_middleware        PASSED    00:00:00.620
native_app     test_digest_auth       PASSED    00:00:00.632
...
native_app     test_chunked           PASSED    00:00:00.621
native_app     test_application       PASSED    00:00:00.688
================ 219 test cases: 219 succeeded in 00:00:11.773 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.403
================= 12 test cases: 12 succeeded in 00:00:01.403 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
--------------- native_diag:test_diag [PASSED] Took 1.36 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.363
================== 2 test cases: 2 succeeded in 00:00:01.363 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
================= 30 test cases: 30 succeeded in 00:00:01.266 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.566
================= 10 test cases: 10 succeeded in 00:00:01.566 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
================== 8 test cases: 8 succeeded in 00:00:00.833 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.779
================= 29 test cases: 29 succeeded in 00:00:00.779 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.694
================= 18 test cases: 18 succeeded in 00:00:00.694 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.671
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.662
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.642
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.668
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.747
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.679
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.641
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.694
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.679
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.647
...
================= 13 test cases: 13 succeeded in 00:00:00.886 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.686
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.690
================= 29 test cases: 29 succeeded in 00:00:00.690 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
---------- native_keepalive:test_keepalive [PASSED] Took 1.24 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.244
================= 10 test cases: 10 succeeded in 00:00:01.244 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
-------------- native_range:test_range [PASSED] Took 1.22 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.221
================= 13 test cases: 13 succeeded in 00:00:01.221 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.677
...
------------- native_upload:test_upload [PASSED] Took 1.28 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.283
================== 3 test cases: 3 succeeded in 00:00:01.283 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.679
...
================= 19 test cases: 19 succeeded in 00:00:00.659 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.183
================= 71 test cases: 71 succeeded in 00:00:01.183 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.689
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.677
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.649
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.646
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.688
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.682
...
================== 4 test cases: 4 succeeded in 00:00:00.634 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 1.52 seconds ------------

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.520
================== 2 test cases: 2 succeeded in 00:00:01.520 ==================
```
