...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    11 |   ✅   | 00:00:05.652 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.644 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.674 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.696 |
| `test_mbus`              | `native_mbus`           |     8 |   ✅   | 00:00:00.670 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.676 |
...
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.112 |
...
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.589 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.731 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:01.075 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.687 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.687 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.913 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.578 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.699 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.942 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.542 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.026 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.533 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.317 |
...
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.564 |
...
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.621 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.613 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.622 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.607 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.613 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.685 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.359 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.328 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.754 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.501 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.614 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.834 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.755 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.756 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.687 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.685 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.759 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.669 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.655 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.678 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.648 |
| `test_protobuf`          | `native_protobuf`       |    10 |   ✅   | 00:00:00.676 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.687 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.647 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.670 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.670 |
...
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.681 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.690 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.692 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.708 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.709 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.213 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.212 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.695 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.756 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.247 |
| `test_http_client`       | `native_http_client`    |    11 |   ✅   | 00:00:00.678 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.681 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.680 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.742 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.709 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.693 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.681 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.713 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.165 |
...
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.669 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.710 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.657 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.675 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.678 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.654 |
...
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.647 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.700 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.815 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.642 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.775 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.522 |
...
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:05.652
================= 11 test cases: 11 succeeded in 00:00:05.652 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.644
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.674
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.696
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.676
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.112
...
================ 318 test cases: 318 succeeded in 00:00:04.130 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.075
================= 10 test cases: 10 succeeded in 00:00:01.075 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
native_ssh     test_ssh_server     PASSED    00:00:00.699
native_ssh     test_ssh_transport  PASSED    00:00:00.942
native_ssh     test_ssh_channel    PASSED    00:00:00.542
================= 93 test cases: 93 succeeded in 00:00:06.675 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 1.53 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.533
...
--------------- native_app:test_regex [PASSED] Took 1.32 seconds ---------------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.317
...
native_app     test_json              PASSED    00:00:00.564
...
native_app     test_multipart         PASSED    00:00:00.621
native_app     test_auth              PASSED    00:00:00.613
native_app     test_file_serving      PASSED    00:00:00.622
native_app     test_dispatch          PASSED    00:00:00.607
native_app     test_chunked           PASSED    00:00:00.613
native_app     test_application       PASSED    00:00:00.685
================ 219 test cases: 219 succeeded in 00:00:11.644 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.359
================= 12 test cases: 12 succeeded in 00:00:01.359 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.328
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.754
native_snmp    test_snmp_agent  PASSED    00:00:00.501
================= 30 test cases: 30 succeeded in 00:00:01.255 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
================= 10 test cases: 10 succeeded in 00:00:01.614 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.834
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.756
================= 29 test cases: 29 succeeded in 00:00:00.756 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.759
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.669
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.648
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.670
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.668
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.695
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.690
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.213
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.756
...
================= 19 test cases: 19 succeeded in 00:00:00.680 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.742
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.165
================= 71 test cases: 71 succeeded in 00:00:01.165 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.654
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.647
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.700
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.775
================== 2 test cases: 2 succeeded in 00:00:00.775 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.522
================== 2 test cases: 2 succeeded in 00:00:01.522 ==================
```
