...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    11 |   ✅   | 00:00:05.917 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.631 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.639 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.659 |
| `test_mbus`              | `native_mbus`           |     8 |   ✅   | 00:00:00.628 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.643 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.771 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.627 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.622 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.638 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:00.966 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.560 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.594 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.574 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.609 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.562 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.711 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:00.955 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.644 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.644 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.889 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.551 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.654 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.865 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.519 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.849 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.239 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.129 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.580 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.585 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.526 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.587 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.583 |
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.536 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.585 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.584 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.600 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.583 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.562 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.586 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.590 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.603 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.583 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.587 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.665 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.176 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.131 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.671 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.486 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.456 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.762 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.739 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.720 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.656 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.634 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.689 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.636 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.649 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.620 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.639 |
| `test_protobuf`          | `native_protobuf`       |    10 |   ✅   | 00:00:00.628 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.662 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.626 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.618 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.635 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.627 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.628 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.623 |
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.690 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.634 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.631 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.630 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.625 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.632 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.628 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.629 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.620 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.639 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.633 |
| `test_sparkplug`         | `native_sparkplug`      |     6 |   ✅   | 00:00:00.645 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.655 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.619 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.649 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.634 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.626 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.622 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.640 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.821 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.633 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.640 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.628 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.656 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.661 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.669 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.045 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.068 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.634 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.679 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.077 |
| `test_http_client`       | `native_http_client`    |    11 |   ✅   | 00:00:00.629 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.640 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.649 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.656 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.658 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.653 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.633 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.681 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:00.999 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.634 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.627 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.648 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.624 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.665 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.644 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.643 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.625 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.629 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.620 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.622 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.623 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.638 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.621 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.618 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.649 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.730 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.611 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.758 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.341 |
...
------------ native_canopen:test_canopen [PASSED] Took 5.92 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:05.917
================= 11 test cases: 11 succeeded in 00:00:05.917 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.631
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.639
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.659
...
--------------- native_mbus:test_mbus [PASSED] Took 0.63 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.628
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.643
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.771
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.627
================== 5 test cases: 5 succeeded in 00:00:00.627 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.622
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:00.966
native         test_session       PASSED    00:00:00.560
native         test_presentation  PASSED    00:00:00.594
native         test_transport     PASSED    00:00:00.574
native         test_websocket     PASSED    00:00:00.609
native         test_http_parser   PASSED    00:00:00.562
================ 318 test cases: 318 succeeded in 00:00:03.865 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.955
================= 10 test cases: 10 succeeded in 00:00:00.955 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.644
...
native_ssh     test_ssh_server     PASSED    00:00:00.654
native_ssh     test_ssh_transport  PASSED    00:00:00.865
native_ssh     test_ssh_channel    PASSED    00:00:00.519
================= 93 test cases: 93 succeeded in 00:00:06.477 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.849
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.239
================== 2 test cases: 2 succeeded in 00:00:01.239 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.129
native_app     test_template          PASSED    00:00:00.580
native_app     test_path_params       PASSED    00:00:00.585
native_app     test_digest_vectors    PASSED    00:00:00.526
native_app     test_form_params       PASSED    00:00:00.587
native_app     test_iface             PASSED    00:00:00.583
native_app     test_json              PASSED    00:00:00.536
native_app     test_response_headers  PASSED    00:00:00.585
native_app     test_middleware        PASSED    00:00:00.584
native_app     test_digest_auth       PASSED    00:00:00.600
native_app     test_web_terminal      PASSED    00:00:00.583
native_app     test_defer             PASSED    00:00:00.562
native_app     test_multipart         PASSED    00:00:00.586
native_app     test_auth              PASSED    00:00:00.590
native_app     test_file_serving      PASSED    00:00:00.603
native_app     test_dispatch          PASSED    00:00:00.583
native_app     test_chunked           PASSED    00:00:00.587
native_app     test_application       PASSED    00:00:00.665
================ 219 test cases: 219 succeeded in 00:00:11.053 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.176
================= 12 test cases: 12 succeeded in 00:00:01.176 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.131
================== 2 test cases: 2 succeeded in 00:00:01.131 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.671
native_snmp    test_snmp_agent  PASSED    00:00:00.486
================= 30 test cases: 30 succeeded in 00:00:01.158 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.456
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.762
...
--------------- native_coap:test_coap [PASSED] Took 0.74 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.739
================= 29 test cases: 29 succeeded in 00:00:00.739 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.720
================= 29 test cases: 29 succeeded in 00:00:00.720 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.656
================= 19 test cases: 19 succeeded in 00:00:00.656 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.634
================= 18 test cases: 18 succeeded in 00:00:00.634 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.689
...
------------ native_mqtt_sn:test_mqtt_sn [PASSED] Took 0.62 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.620
...
----------- native_protobuf:test_protobuf [PASSED] Took 0.63 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.628
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.626
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.635
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.627
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.628
...
--------------- native_fins:test_fins [PASSED] Took 0.62 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.623
...
test/test_hostlink/test_hostlink.cpp:30: test_build_dm_read: Expected '@00RD0000001057*\r' Was '@00RD0000001057*\rK\xD5\xA7\xFD\x7F' [FAILED]
...
---------- native_hostlink:test_hostlink [ERRORED] Took 0.64 seconds ----------
...
-------------- native_senml:test_senml [PASSED] Took 0.69 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.690
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.634
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.625
================== 6 test cases: 6 succeeded in 00:00:00.625 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.632
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.628
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.629
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.620
================== 8 test cases: 8 succeeded in 00:00:00.620 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.645
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.649
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.626
================== 2 test cases: 2 succeeded in 00:00:00.626 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.622
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.640
================= 12 test cases: 12 succeeded in 00:00:00.640 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.821
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.628
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.661
================= 29 test cases: 29 succeeded in 00:00:00.661 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.669
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.045
================= 10 test cases: 10 succeeded in 00:00:01.045 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.634
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.679
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.077
================== 3 test cases: 3 succeeded in 00:00:01.077 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
-------- native_http_client:test_http_client [PASSED] Took 0.63 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.629
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.640
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.649
================= 19 test cases: 19 succeeded in 00:00:00.649 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.658
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.681
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.999
================= 71 test cases: 71 succeeded in 00:00:00.999 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.634
================== 9 test cases: 9 succeeded in 00:00:00.634 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.627
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.648
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.665
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.644
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.643
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.629
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.620
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.622
================= 15 test cases: 15 succeeded in 00:00:00.622 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.623
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.638
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.621
================== 6 test cases: 6 succeeded in 00:00:00.621 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.618
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.649
================== 4 test cases: 4 succeeded in 00:00:00.649 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.730
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.611
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.758
================== 2 test cases: 2 succeeded in 00:00:00.758 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.341
================== 2 test cases: 2 succeeded in 00:00:01.341 ==================
```
