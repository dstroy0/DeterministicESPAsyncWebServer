...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:08.872 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.568 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.565 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.597 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.616 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.554 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.672 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.598 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.614 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.077 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.591 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.680 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.882 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.539 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.841 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.200 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.129 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.591 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.573 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.533 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.571 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.535 |
...
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.605 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.574 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.608 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.566 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.582 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.652 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.135 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.069 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.704 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.501 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.345 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.795 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:01.002 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.743 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.635 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.655 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.700 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.641 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.671 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.633 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.646 |
| `test_protobuf`          | `native_protobuf`       |     8 |   ✅   | 00:00:00.681 |
| `test_wamp`              | `native_wamp`           |    11 |   ✅   | 00:00:00.717 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.642 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.656 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.677 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.641 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |     7 |   ✅   | 00:00:00.662 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.615 |
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.678 |
...
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.607 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.593 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.631 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.711 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.627 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.622 |
| `test_sparkplug`         | `native_sparkplug`      |     6 |   ✅   | 00:00:00.664 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.642 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.640 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.644 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.611 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.694 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.644 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.758 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.808 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.641 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.630 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.639 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.639 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.643 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.679 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.047 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.057 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.662 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.682 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.139 |
| `test_http_client`       | `native_http_client`    |    10 |   ✅   | 00:00:00.661 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.648 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.684 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.715 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.684 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.657 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.666 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.678 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:00.990 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.656 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.645 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.671 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.750 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.664 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.632 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.656 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.670 |
...
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.639 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.615 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.613 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.656 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.738 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.654 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.802 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.090 |
...
------------------ native:test_sse [PASSED] Took 8.87 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:08.872
native         test_session       PASSED    00:00:00.568
native         test_presentation  PASSED    00:00:00.565
...
================ 318 test cases: 318 succeeded in 00:00:11.773 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.672
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.598
================== 3 test cases: 3 succeeded in 00:00:00.598 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.614
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 3.08 seconds -------------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.077
native_ssh     test_ssh_auth       PASSED    00:00:00.591
native_ssh     test_ssh_server     PASSED    00:00:00.680
native_ssh     test_ssh_transport  PASSED    00:00:00.882
native_ssh     test_ssh_channel    PASSED    00:00:00.539
================= 93 test cases: 93 succeeded in 00:00:05.769 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.841
================== 2 test cases: 2 succeeded in 00:00:00.841 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
native_app     test_template          PASSED    00:00:00.591
...
native_app     test_iface             PASSED    00:00:00.535
...
native_app     test_multipart         PASSED    00:00:00.605
native_app     test_auth              PASSED    00:00:00.574
native_app     test_file_serving      PASSED    00:00:00.608
native_app     test_dispatch          PASSED    00:00:00.566
native_app     test_chunked           PASSED    00:00:00.582
native_app     test_application       PASSED    00:00:00.652
================ 219 test cases: 219 succeeded in 00:00:11.004 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.069
...
================= 29 test cases: 29 succeeded in 00:00:01.205 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.345
================= 10 test cases: 10 succeeded in 00:00:01.345 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.795
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:01.002
================= 29 test cases: 29 succeeded in 00:00:01.002 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.700
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.641
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.633
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.642
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.641
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.615
...
test/test_hostlink/test_hostlink.cpp:30: test_build_dm_read: Expected '@00RD0000001057*\r' Was '@00RD0000001057*\r\x7F\xD9D\xFE\x7F' [FAILED]
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  ERRORED   00:00:00.637

============= 8 test cases: 1 failed, 6 succeeded in 00:00:00.637 =============
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.678
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.607
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.593
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.631
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.711
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.664
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.642
================== 5 test cases: 5 succeeded in 00:00:00.642 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.644
...
------------ native_webhook:test_webhook [PASSED] Took 0.61 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.611
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.694
================== 2 test cases: 2 succeeded in 00:00:00.694 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.644
================== 4 test cases: 4 succeeded in 00:00:00.644 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.758
================= 12 test cases: 12 succeeded in 00:00:00.758 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.808
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.641
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.630
================= 13 test cases: 13 succeeded in 00:00:00.630 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.639
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.639
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.643
================= 29 test cases: 29 succeeded in 00:00:00.643 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.047
================= 10 test cases: 10 succeeded in 00:00:01.047 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.057
================= 13 test cases: 13 succeeded in 00:00:01.057 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.682
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.139
================== 3 test cases: 3 succeeded in 00:00:01.139 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.648
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.684
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.657
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.666
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.678
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.645
...
------- native_auth_lockout:test_auth_lockout [PASSED] Took 0.75 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.750
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.664
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.639
================== 7 test cases: 7 succeeded in 00:00:00.639 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.615
================== 6 test cases: 6 succeeded in 00:00:00.615 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.613
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.656
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.738
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.090
================== 2 test cases: 2 succeeded in 00:00:01.090 ==================
```
