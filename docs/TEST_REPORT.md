...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:06.263 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.694 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.697 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.715 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:04.500 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.712 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.695 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.735 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.706 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.740 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.722 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.711 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.712 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.722 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.717 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.701 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.141 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.654 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.675 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.681 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.707 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.660 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.869 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:01.164 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.743 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.737 |
| `test_ssh_crypto`        | `native_ssh`            |    45 |   ✅   | 00:00:04.159 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.723 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.944 |
| `test_ssh_transport`     | `native_ssh`            |    33 |   ✅   | 00:00:01.222 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.653 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.065 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.508 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.314 |
...
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.659 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.615 |
...
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.638 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.693 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.679 |
...
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.335 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.272 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.758 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.599 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:02.082 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.870 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.859 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.820 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.755 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.736 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.824 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.707 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.704 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.722 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.746 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.726 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.725 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.799 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.901 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.817 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.712 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.703 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.728 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.706 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.714 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.684 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.721 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.703 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.726 |
...
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.738 |
...
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.708 |
...
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.721 |
...
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.721 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.711 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.740 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.726 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.744 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.225 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.207 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.705 |
| `test_smtp`              | `native_smtp`           |    11 |   ✅   | 00:00:00.810 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.687 |
| `test_dns_server`        | `native_dns_server`     |     7 |   ✅   | 00:00:00.692 |
| `test_rtc`               | `native_rtc`            |     8 |   ✅   | 00:00:00.701 |
| `test_ld2410`            | `native_ld2410`         |     7 |   ✅   | 00:00:00.716 |
| `test_mpr121`            | `native_mpr121`         |     5 |   ✅   | 00:00:00.710 |
| `test_sht3x`             | `native_sht3x`          |     5 |   ✅   | 00:00:00.689 |
| `test_pca9685`           | `native_pca9685`        |     4 |   ✅   | 00:00:00.690 |
| `test_ads1115`           | `native_ads1115`        |     3 |   ✅   | 00:00:00.699 |
| `test_ina219`            | `native_ina219`         |     4 |   ✅   | 00:00:00.707 |
| `test_hpack`             | `native_hpack`          |     7 |   ✅   | 00:00:00.824 |
| `test_h2_frame`          | `native_h2frame`        |     6 |   ✅   | 00:00:00.696 |
| `test_h2_conn`           | `native_h2conn`         |     4 |   ✅   | 00:00:00.926 |
| `test_quic_varint`       | `native_quic_varint`    |     3 |   ✅   | 00:00:00.696 |
| `test_h3_frame`          | `native_h3frame`        |     7 |   ✅   | 00:00:00.744 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.768 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.247 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.692 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.723 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.693 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.789 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.731 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.740 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.721 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.766 |
| `test_ssh_zlib`          | `native_ssh_zlib`       |     9 |   ✅   | 00:00:00.792 |
| `test_ssh_comp`          | `native_ssh_comp`       |     5 |   ✅   | 00:00:01.111 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.180 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.701 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.713 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.737 |
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.739 |
...
| `test_statsd`            | `native_statsd`         |     9 |   ✅   | 00:00:00.745 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.710 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.711 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.723 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.854 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.704 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.831 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.078 |
| `test_qpack`             | `native_qpack`          |     9 |   ✅   | 00:00:00.810 |
| `test_quic_packet`       | `native_quic_packet`    |     8 |   ✅   | 00:00:00.723 |
| `test_quic_frame`        | `native_quic_frame`     |     8 |   ✅   | 00:00:00.746 |
| `test_quic_crypto`       | `native_quic_crypto`    |     7 |   ✅   | 00:00:00.829 |
| `test_tls13_kdf`         | `native_tls13_kdf`      |     5 |   ✅   | 00:00:00.768 |
| `test_quic_tp`           | `native_quic_tp`        |     7 |   ✅   | 00:00:00.726 |
| `test_tls13_msg`         | `native_tls13_msg`      |     7 |   ✅   | 00:00:00.821 |
| `test_ssh_chachapoly`    | `native_ssh_chachapoly` |     4 |   ✅   | 00:00:00.750 |
