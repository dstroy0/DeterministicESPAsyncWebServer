...
| :------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`           | `native`              |    37 |   ✅   | 00:00:06.329 |
| `test_session`       | `native`              |    19 |   ✅   | 00:00:00.476 |
| `test_presentation`  | `native`              |    63 |   ✅   | 00:00:00.505 |
| `test_transport`     | `native`              |    28 |   ✅   | 00:00:00.480 |
| `test_websocket`     | `native`              |    63 |   ✅   | 00:00:00.516 |
| `test_http_parser`   | `native`              |    80 |   ✅   | 00:00:00.508 |
| `test_ssh_crypto`    | `native_ssh`          |    37 |   ✅   | 00:00:03.804 |
| `test_ssh_auth`      | `native_ssh`          |    12 |   ✅   | 00:00:00.512 |
...
| `test_ssh_hardening` | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.789 |
| `test_ssh_conn`      | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.036 |
| `test_multipart`     | `native_app`          |    19 |   ✅   | 00:00:00.831 |
| `test_auth`          | `native_app`          |    13 |   ✅   | 00:00:00.490 |
| `test_file_serving`  | `native_app`          |    12 |   ✅   | 00:00:00.502 |
| `test_dispatch`      | `native_app`          |    10 |   ✅   | 00:00:00.483 |
| `test_application`   | `native_app`          |    47 |   ✅   | 00:00:00.574 |
...
-------------------  ------------------  --------  ------------
native               test_sse            PASSED    00:00:06.329
...
native               test_websocket      PASSED    00:00:00.516
native               test_http_parser    PASSED    00:00:00.508
native_ssh           test_ssh_crypto     PASSED    00:00:03.804
native_ssh           test_ssh_auth       PASSED    00:00:00.512
...
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.789
native_ssh_conn      test_ssh_conn       PASSED    00:00:01.036
native_app           test_multipart      PASSED    00:00:00.831
native_app           test_auth           PASSED    00:00:00.490
native_app           test_file_serving   PASSED    00:00:00.502
native_app           test_dispatch       PASSED    00:00:00.483
native_app           test_application    PASSED    00:00:00.574
native_compliance    test_compliance     PASSED    00:00:00.610
================ 498 test cases: 498 succeeded in 00:00:20.380 ================
```
