...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:19.188 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.542 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.570 |
| `test_transport`        | `native`              |    28 |   ✅   | 00:00:00.546 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.578 |
| `test_http_parser`      | `native`              |    80 |   ✅   | 00:00:00.577 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.900 |
...
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.606 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.860 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.116 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.981 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.537 |
...
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.550 |
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.537 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.569 |
...
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.567 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.565 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.593 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.559 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.567 |
| `test_application`      | `native_app`          |    49 |   ✅   | 00:00:00.693 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.671 |
...
----------------- native:test_sse [PASSED] Took 19.19 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:19.188
native               test_session           PASSED    00:00:00.542
native               test_presentation      PASSED    00:00:00.570
native               test_transport         PASSED    00:00:00.546
native               test_websocket         PASSED    00:00:00.578
...
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.860
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.116
native_app           test_regex             PASSED    00:00:00.981
native_app           test_template          PASSED    00:00:00.537
...
native_app           test_iface             PASSED    00:00:00.550
native_app           test_json              PASSED    00:00:00.537
native_app           test_response_headers  PASSED    00:00:00.569
...
native_app           test_multipart         PASSED    00:00:00.567
native_app           test_auth              PASSED    00:00:00.565
native_app           test_file_serving      PASSED    00:00:00.593
native_app           test_dispatch          PASSED    00:00:00.559
...
================ 594 test cases: 594 succeeded in 00:00:41.409 ================
```
