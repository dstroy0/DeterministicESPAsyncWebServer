...
**Generated:** 2026-06-29 19:16:40
**Command:** `pio test` over 88 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1455 passed - 164s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:12.852 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.710 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.717 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.668 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.692 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.668 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.811 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.703 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.741 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:04.022 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.664 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.740 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.968 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.621 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.003 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.388 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.254 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.669 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.655 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.660 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.682 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.691 |
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.653 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.701 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.726 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.680 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.691 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.672 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.685 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.664 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.689 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.660 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.670 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.782 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.284 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.239 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.765 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.569 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.594 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.879 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.916 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.793 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.778 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.750 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.813 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.711 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.764 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.710 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.709 |
| `test_protobuf`          | `native_protobuf`       |     8 |   ✅   | 00:00:00.748 |
| `test_wamp`              | `native_wamp`           |    11 |   ✅   | 00:00:00.771 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.779 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.734 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.692 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.730 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |     7 |   ✅   | 00:00:00.758 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.714 |
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.797 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.713 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.721 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.722 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.750 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.729 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.712 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.702 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.718 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.771 |
...
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.746 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.771 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.956 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.726 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.727 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.729 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.746 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.750 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.761 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.189 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.178 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.776 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.812 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.205 |
| `test_http_client`       | `native_http_client`    |    10 |   ✅   | 00:00:00.785 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.759 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.751 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.791 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.791 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.775 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.708 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.757 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.140 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.736 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.743 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.768 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.734 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.755 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.738 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.715 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.717 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.724 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.750 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.750 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.736 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.713 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.758 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.718 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.793 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.830 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.674 |
...
----------------- native:test_sse [PASSED] Took 12.85 seconds ------------------
...
---------------- native:test_session [PASSED] Took 0.71 seconds ----------------
...
------------- native:test_presentation [PASSED] Took 0.72 seconds --------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:12.852
...
================ 318 test cases: 318 succeeded in 00:00:16.307 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 113 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.811
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.022
native_ssh     test_ssh_auth       PASSED    00:00:00.664
native_ssh     test_ssh_server     PASSED    00:00:00.740
native_ssh     test_ssh_transport  PASSED    00:00:00.968
native_ssh     test_ssh_channel    PASSED    00:00:00.621
================= 93 test cases: 93 succeeded in 00:00:07.014 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 113 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:01.003
...
------------ native_app:test_middleware [PASSED] Took 0.73 seconds -------------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.254
native_app     test_template          PASSED    00:00:00.669
native_app     test_path_params       PASSED    00:00:00.655
native_app     test_digest_vectors    PASSED    00:00:00.660
native_app     test_form_params       PASSED    00:00:00.682
native_app     test_iface             PASSED    00:00:00.691
native_app     test_json              PASSED    00:00:00.653
native_app     test_response_headers  PASSED    00:00:00.701
native_app     test_middleware        PASSED    00:00:00.726
native_app     test_digest_auth       PASSED    00:00:00.680
...
native_app     test_auth              PASSED    00:00:00.664
native_app     test_file_serving      PASSED    00:00:00.689
native_app     test_dispatch          PASSED    00:00:00.660
native_app     test_chunked           PASSED    00:00:00.670
native_app     test_application       PASSED    00:00:00.782
================ 219 test cases: 219 succeeded in 00:00:12.885 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 113 tests
...
================= 29 test cases: 29 succeeded in 00:00:01.334 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 113 tests
...
================= 29 test cases: 29 succeeded in 00:00:00.916 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 113 tests
...
================= 18 test cases: 18 succeeded in 00:00:00.750 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 113 tests
...
-------- native_cloudevents:test_cloudevents [PASSED] Took 0.81 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.813
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.711
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.710
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.709
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.748
...
--------------- native_wamp:test_wamp [PASSED] Took 0.77 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.771
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.734
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.692
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.730
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.714
...
test/test_hostlink/test_hostlink.cpp:30: test_build_dm_read: Expected '@00RD0000001057*\r' Was '@00RD0000001057*\r5\xC8\xF2\xFF\x7F' [FAILED]
...
---------- native_hostlink:test_hostlink [ERRORED] Took 0.71 seconds ----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  ERRORED   00:00:00.707

============= 8 test cases: 1 failed, 6 succeeded in 00:00:00.707 =============
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 113 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.797
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.722
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.750
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.729
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.702
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.718
...
------ native_modbus_master:test_modbus_master [PASSED] Took 0.77 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.771
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.746
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.771
================= 12 test cases: 12 succeeded in 00:00:00.771 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 113 tests
...
================= 13 test cases: 13 succeeded in 00:00:00.956 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 113 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.726
================= 11 test cases: 11 succeeded in 00:00:00.726 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 113 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.727
================= 13 test cases: 13 succeeded in 00:00:00.727 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 113 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.746
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.750
================= 29 test cases: 29 succeeded in 00:00:00.750 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 113 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.761
...
---------------- native_jwt:test_jwt [PASSED] Took 0.81 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.812
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.205
================== 3 test cases: 3 succeeded in 00:00:01.205 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 113 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.785
...
--------- native_compliance:test_compliance [PASSED] Took 0.76 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.759
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.751
================= 19 test cases: 19 succeeded in 00:00:00.751 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 113 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.791
================= 10 test cases: 10 succeeded in 00:00:00.791 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 113 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.757
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.140
================= 71 test cases: 71 succeeded in 00:00:01.140 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 113 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.743
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.734
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.755
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.717
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.750
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.713
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.793
================== 4 test cases: 4 succeeded in 00:00:00.793 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 113 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.830
================== 3 test cases: 3 succeeded in 00:00:00.830 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 113 tests
