...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:14.198 |
...
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.906 |
| `test_ssh_auth`          | `native_ssh`           |    12 |   ✅   | 00:00:00.566 |
| `test_ssh_server`        | `native_ssh`           |     7 |   ✅   | 00:00:00.674 |
| `test_ssh_transport`     | `native_ssh`           |    23 |   ✅   | 00:00:00.888 |
...
| `test_diag`              | `native_diag`          |     2 |   ✅   | 00:00:01.159 |
| `test_snmp_ber`          | `native_snmp`          |    15 |   ✅   | 00:00:00.698 |
| `test_snmp_agent`        | `native_snmp`          |    14 |   ✅   | 00:00:00.505 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.391 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.802 |
| `test_coap`              | `native_coap`          |    27 |   ✅   | 00:00:00.686 |
| `test_coap`              | `native_coap_observe`  |    27 |   ✅   | 00:00:00.688 |
...
| `test_cbor`              | `native_cbor`          |    14 |   ✅   | 00:00:00.643 |
| `test_msgpack`           | `native_msgpack`       |    15 |   ✅   | 00:00:00.651 |
| `test_gpio_map`          | `native_gpio_map`      |     8 |   ✅   | 00:00:00.654 |
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.639 |
...
----------------- native:test_sse [PASSED] Took 14.20 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:14.198
...
================ 310 test cases: 310 succeeded in 00:00:17.217 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.906
native_ssh     test_ssh_auth       PASSED    00:00:00.566
native_ssh     test_ssh_server     PASSED    00:00:00.674
native_ssh     test_ssh_transport  PASSED    00:00:00.888
native_ssh     test_ssh_channel    PASSED    00:00:00.545
================= 92 test cases: 92 succeeded in 00:00:06.579 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
================ 217 test cases: 217 succeeded in 00:00:11.401 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.159
================== 2 test cases: 2 succeeded in 00:00:01.159 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
================= 29 test cases: 29 succeeded in 00:00:01.203 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
================= 27 test cases: 27 succeeded in 00:00:00.686 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
================= 27 test cases: 27 succeeded in 00:00:00.688 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
================= 13 test cases: 13 succeeded in 00:00:00.852 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.702
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.036
================= 71 test cases: 71 succeeded in 00:00:01.036 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.643
