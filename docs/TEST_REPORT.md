...
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.083 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.918 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.504 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.502 |
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.479 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.498 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.500 |
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.483 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.504 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.501 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.505 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.500 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.541 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.504 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.518 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.505 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.500 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.595 |
...
------------------ native:test_sse [PASSED] Took 6.44 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:06.438
...
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.083
native_app           test_regex             PASSED    00:00:00.918
native_app           test_template          PASSED    00:00:00.504
native_app           test_path_params       PASSED    00:00:00.502
native_app           test_digest_vectors    PASSED    00:00:00.479
native_app           test_form_params       PASSED    00:00:00.498
native_app           test_iface             PASSED    00:00:00.500
native_app           test_json              PASSED    00:00:00.483
native_app           test_response_headers  PASSED    00:00:00.504
native_app           test_middleware        PASSED    00:00:00.501
...
native_app           test_auth              PASSED    00:00:00.504
native_app           test_file_serving      PASSED    00:00:00.518
native_app           test_dispatch          PASSED    00:00:00.505
...
================ 611 test cases: 611 succeeded in 00:00:26.853 ================
```
