...
| :------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`           | `native`              |    37 |   ✅   | 00:00:14.864 |
| `test_session`       | `native`              |    19 |   ✅   | 00:00:00.495 |
| `test_presentation`  | `native`              |    63 |   ✅   | 00:00:00.533 |
| `test_transport`     | `native`              |    28 |   ✅   | 00:00:00.503 |
| `test_websocket`     | `native`              |    63 |   ✅   | 00:00:00.544 |
| `test_http_parser`   | `native`              |    80 |   ✅   | 00:00:00.564 |
| `test_ssh_crypto`    | `native_ssh`          |    37 |   ✅   | 00:00:03.700 |
...
| `test_ssh_conn`      | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.071 |
| `test_multipart`     | `native_app`          |    19 |   ✅   | 00:00:00.825 |
| `test_auth`          | `native_app`          |    13 |   ✅   | 00:00:00.501 |
| `test_file_serving`  | `native_app`          |    12 |   ✅   | 00:00:00.541 |
| `test_dispatch`      | `native_app`          |    10 |   ✅   | 00:00:00.514 |
| `test_application`   | `native_app`          |    47 |   ✅   | 00:00:00.605 |
| `test_compliance`    | `native_compliance`   |    12 |   ✅   | 00:00:00.674 |
...
----------------- native:test_sse [PASSED] Took 14.86 seconds ------------------
...
-------------------  ------------------  --------  ------------
native               test_sse            PASSED    00:00:14.864
native               test_session        PASSED    00:00:00.495
native               test_presentation   PASSED    00:00:00.533
native               test_transport      PASSED    00:00:00.503
native               test_websocket      PASSED    00:00:00.544
native               test_http_parser    PASSED    00:00:00.564
native_ssh           test_ssh_crypto     PASSED    00:00:03.700
