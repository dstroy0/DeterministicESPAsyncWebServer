...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:13.440 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.525 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.557 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.541 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.567 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.532 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.817 |
...
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.191 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:01.069 |
...
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.557 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.562 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.655 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.629 |
| `test_concurrency`      | `native_tsan`         |     2 |   ✅   | 00:00:01.798 |
...
----------------- native:test_sse [PASSED] Took 13.44 seconds ------------------
...
----------- native_tsan:test_concurrency [PASSED] Took 1.80 seconds ------------

=================================== SUMMARY ===================================
Environment          Test                   Status    Duration
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:13.440
native               test_session           PASSED    00:00:00.525
native               test_presentation      PASSED    00:00:00.557
native               test_transport         PASSED    00:00:00.541
native               test_websocket         PASSED    00:00:00.567
native               test_http_parser       PASSED    00:00:00.532
native_ssh           test_ssh_crypto        PASSED    00:00:03.817
...
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.191
native_app           test_regex             PASSED    00:00:01.069
...
native_app           test_form_params       PASSED    00:00:00.558
native_app           test_iface             PASSED    00:00:00.562
native_app           test_json              PASSED    00:00:00.514
native_app           test_response_headers  PASSED    00:00:00.570
native_app           test_middleware        PASSED    00:00:00.565
native_app           test_digest_auth       PASSED    00:00:00.566
native_app           test_web_terminal      PASSED    00:00:00.554
...
native_app           test_dispatch          PASSED    00:00:00.557
...
native_tsan          test_concurrency       PASSED    00:00:01.798
================ 613 test cases: 613 succeeded in 00:00:37.051 ================
```
