...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:12.892 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.570 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.622 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.601 |
| `test_websocket`         | `native`               |    64 |   ✅   | 00:00:00.632 |
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.581 |
| `test_observability`     | `native_observability` |    15 |   ✅   | 00:00:00.740 |
| `test_http_ota`          | `native_ota`           |     3 |   ✅   | 00:00:00.668 |
| `test_provisioning`      | `native_prov`          |     5 |   ✅   | 00:00:00.668 |
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.873 |
| `test_ssh_auth`          | `native_ssh`           |    12 |   ✅   | 00:00:00.579 |
| `test_ssh_server`        | `native_ssh`           |     7 |   ✅   | 00:00:00.809 |
| `test_ssh_transport`     | `native_ssh`           |    23 |   ✅   | 00:00:00.899 |
| `test_ssh_channel`       | `native_ssh`           |    12 |   ✅   | 00:00:00.544 |
| `test_ssh_hardening`     | `native_ssh_hardened`  |     2 |   ✅   | 00:00:00.903 |
| `test_ssh_conn`          | `native_ssh_conn`      |     2 |   ✅   | 00:00:01.306 |
| `test_regex`             | `native_app`           |     9 |   ✅   | 00:00:01.183 |
| `test_template`          | `native_app`           |     6 |   ✅   | 00:00:00.609 |
| `test_path_params`       | `native_app`           |     8 |   ✅   | 00:00:00.597 |
| `test_digest_vectors`    | `native_app`           |     4 |   ✅   | 00:00:00.542 |
| `test_form_params`       | `native_app`           |     5 |   ✅   | 00:00:00.590 |
| `test_iface`             | `native_app`           |     7 |   ✅   | 00:00:00.600 |
| `test_json`              | `native_app`           |    17 |   ✅   | 00:00:00.557 |
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.597 |
| `test_middleware`        | `native_app`           |     9 |   ✅   | 00:00:00.639 |
| `test_digest_auth`       | `native_app`           |    10 |   ✅   | 00:00:00.644 |
| `test_web_terminal`      | `native_app`           |     7 |   ✅   | 00:00:00.615 |
| `test_defer`             | `native_app`           |     3 |   ✅   | 00:00:00.592 |
| `test_multipart`         | `native_app`           |    19 |   ✅   | 00:00:00.629 |
| `test_auth`              | `native_app`           |    13 |   ✅   | 00:00:00.603 |
| `test_file_serving`      | `native_app`           |    12 |   ✅   | 00:00:00.619 |
| `test_dispatch`          | `native_app`           |    11 |   ✅   | 00:00:00.601 |
| `test_chunked`           | `native_app`           |    10 |   ✅   | 00:00:00.612 |
| `test_application`       | `native_app`           |    52 |   ✅   | 00:00:00.689 |
| `test_diag`              | `native_diag`          |     2 |   ✅   | 00:00:01.147 |
| `test_snmp_ber`          | `native_snmp`          |    14 |   ✅   | 00:00:00.721 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.504 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.396 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.806 |
| `test_coap`              | `native_coap`          |    27 |   ✅   | 00:00:00.694 |
| `test_coap`              | `native_coap_observe`  |    27 |   ✅   | 00:00:00.712 |
| `test_webdav`            | `native_webdav`        |    19 |   ✅   | 00:00:00.678 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.665 |
| `test_modbus_master`     | `native_modbus_master` |     5 |   ✅   | 00:00:00.677 |
| `test_ota_rollback`      | `native_ota_rollback`  |     5 |   ✅   | 00:00:00.647 |
| `test_totp`              | `native_totp`          |     4 |   ✅   | 00:00:00.702 |
| `test_webhook`           | `native_webhook`       |     5 |   ✅   | 00:00:00.676 |
| `test_radio_power`       | `native_radio_power`   |     2 |   ✅   | 00:00:00.661 |
| `test_dns_resolver`      | `native_dns_resolver`  |     4 |   ✅   | 00:00:00.666 |
| `test_audit_log`         | `native_audit_log`     |    12 |   ✅   | 00:00:00.702 |
| `test_oidc`              | `native_oidc`          |    13 |   ✅   | 00:00:00.849 |
| `test_vfs`               | `native_vfs`           |    11 |   ✅   | 00:00:00.669 |
| `test_graphql`           | `native_graphql`       |    13 |   ✅   | 00:00:00.647 |
| `test_espnow`            | `native_espnow`        |     7 |   ✅   | 00:00:00.659 |
| `test_oauth2`            | `native_oauth2`        |     8 |   ✅   | 00:00:00.692 |
| `test_opcua`             | `native_opcua`         |    29 |   ✅   | 00:00:00.674 |
| `test_opcua_client`      | `native_opcua_client`  |    11 |   ✅   | 00:00:00.699 |
| `test_keepalive`         | `native_keepalive`     |    10 |   ✅   | 00:00:01.082 |
| `test_range`             | `native_range`         |    13 |   ✅   | 00:00:01.092 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.671 |
| `test_jwt`               | `native_jwt`           |    11 |   ✅   | 00:00:00.717 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.120 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.685 |
| `test_compliance`        | `native_compliance`    |    15 |   ✅   | 00:00:00.667 |
| `test_mqtt`              | `native_mqtt`          |    17 |   ✅   | 00:00:00.678 |
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.698 |
| `test_scratch`           | `native_scratch`       |    14 |   ✅   | 00:00:00.688 |
| `test_snmp_trap`         | `native_snmp_trap`     |     3 |   ✅   | 00:00:00.684 |
| `test_inflate`           | `native_inflate`       |    12 |   ✅   | 00:00:00.659 |
| `test_deflate`           | `native_deflate`       |    10 |   ✅   | 00:00:00.710 |
| `test_websocket`         | `native_ws_deflate`    |    68 |   ✅   | 00:00:01.052 |
| `test_time_source`       | `native_time_source`   |     9 |   ✅   | 00:00:00.658 |
| `test_config_store`      | `native_config_store`  |    14 |   ✅   | 00:00:00.658 |
| `test_device_id`         | `native_device_id`     |     4 |   ✅   | 00:00:00.691 |
| `test_auth_lockout`      | `native_auth_lockout`  |    10 |   ✅   | 00:00:00.678 |
| `test_csrf`              | `native_csrf`          |     9 |   ✅   | 00:00:00.713 |
| `test_telemetry`         | `native_telemetry`     |     8 |   ✅   | 00:00:00.711 |
| `test_dashboard`         | `native_dashboard`     |    11 |   ✅   | 00:00:00.706 |
| `test_net_egress`        | `native_net_egress`    |     5 |   ✅   | 00:00:00.687 |
| `test_partition_monitor` | `native_partition`     |     5 |   ✅   | 00:00:00.731 |
| `test_cbor`              | `native_cbor`          |    14 |   ✅   | 00:00:00.712 |
| `test_msgpack`           | `native_msgpack`       |    15 |   ✅   | 00:00:00.716 |
| `test_gpio_map`          | `native_gpio_map`      |     8 |   ✅   | 00:00:00.666 |
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.671 |
| `test_guardrails`        | `native_guardrails`    |     6 |   ✅   | 00:00:00.669 |
| `test_logbuf`            | `native_logbuf`        |     4 |   ✅   | 00:00:00.669 |
| `test_config_io`         | `native_config_io`     |     4 |   ✅   | 00:00:00.689 |
| `test_workers`           | `native_workers`       |     3 |   ✅   | 00:00:00.794 |
| `test_clock`             | `native_clock`         |     4 |   ✅   | 00:00:00.661 |
| `test_concurrency`       | `native_concurrency`   |     2 |   ✅   | 00:00:00.877 |
| `test_concurrency`       | `native_tsan`          |     2 |   ✅   | 00:00:01.279 |
...
|  10 | `test_nonce_is_128bit_hex`                   |   ✅   | The hardened nonce is SHA-256(CSPRNG + counter + millis) truncated to 16        |
...
|   6 | `test_alg_not_hs256_rejected`     |   ✅   | Alg not hs256 rejected     |
|   7 | `test_bearer_header`              |   ✅   | Bearer header              |
|   8 | `test_claim_int`                  |   ✅   | Claim int                  |
|   9 | `test_claim_missing`              |   ✅   | Claim missing              |
|  10 | `test_claim_str`                  |   ✅   | Claim str                  |
|  11 | `test_scope_allows`               |   ✅   | Scope allows               |
...
|  11 | `test_subscribe`                       |   ✅   | Subscribe                                          |
|  12 | `test_unsubscribe`                     |   ✅   | Unsubscribe                                        |
|  13 | `test_ack_packets`                     |   ✅   | Ack packets                                        |
|  14 | `test_connack`                         |   ✅   | Connack                                            |
|  15 | `test_suback`                          |   ✅   | Suback                                             |
|  16 | `test_ping_disconnect`                 |   ✅   | Ping disconnect                                    |
|  17 | `test_fixed_header_multibyte_remlen`   |   ✅   | Remaining length 300 -> 2-byte field {0xAC, 0x02}. |
...
----------------- native:test_sse [PASSED] Took 12.89 seconds ------------------
...
------------- native:test_presentation [PASSED] Took 0.62 seconds --------------
...
--------------- native:test_transport [PASSED] Took 0.60 seconds ---------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:12.892
native         test_session       PASSED    00:00:00.570
native         test_presentation  PASSED    00:00:00.622
native         test_transport     PASSED    00:00:00.601
native         test_websocket     PASSED    00:00:00.632
native         test_http_parser   PASSED    00:00:00.581
================ 307 test cases: 307 succeeded in 00:00:15.897 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------ native_observability:test_observability [PASSED] Took 0.74 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.740
================= 15 test cases: 15 succeeded in 00:00:00.740 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.668
================== 3 test cases: 3 succeeded in 00:00:00.668 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.668
...
------------ native_ssh:test_ssh_server [PASSED] Took 0.81 seconds -------------
...
------------ native_ssh:test_ssh_channel [PASSED] Took 0.54 seconds ------------

=================================== SUMMARY ===================================
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.873
native_ssh     test_ssh_auth       PASSED    00:00:00.579
native_ssh     test_ssh_server     PASSED    00:00:00.809
native_ssh     test_ssh_transport  PASSED    00:00:00.899
native_ssh     test_ssh_channel    PASSED    00:00:00.544
================= 92 test cases: 92 succeeded in 00:00:06.704 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.903
================== 2 test cases: 2 succeeded in 00:00:00.903 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 1.31 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.306
...
src/DeterministicESPAsyncWebServer.cpp:2758:76: warning: ‘snprintf’ output may be truncated before the last format character [-Wformat-truncation=]
 2758 |         snprintf(lastmod_line, sizeof(lastmod_line), "Last-Modified: %s\r\n", lm_date);
      |                                                                            ^
src/DeterministicESPAsyncWebServer.cpp:2758:17: note: ‘snprintf’ output between 18 and 57 bytes into a destination of size 56
 2758 |         snprintf(lastmod_line, sizeof(lastmod_line), "Last-Modified: %s\r\n", lm_date);
      |         ~~~~~~~~^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Testing...
...
--------------- native_app:test_regex [PASSED] Took 1.18 seconds ---------------
...
--------------- native_app:test_json [PASSED] Took 0.56 seconds ----------------
...
------------ native_app:test_middleware [PASSED] Took 0.64 seconds -------------

Processing test_digest_auth in native_app environment
--------------------------------------------------------------------------------
Building...
Testing...
test/test_digest_auth/test_digest_auth.cpp:334: test_challenge_is_digest_sha256 [PASSED]
test/test_digest_auth/test_digest_auth.cpp:335: test_valid_digest_authenticates [PASSED]
test/test_digest_auth/test_digest_auth.cpp:336: test_wrong_password_rejected [PASSED]
test/test_digest_auth/test_digest_auth.cpp:337: test_bad_nonce_rejected [PASSED]
test/test_digest_auth/test_digest_auth.cpp:338: test_wrong_username_rejected [PASSED]
test/test_digest_auth/test_digest_auth.cpp:339: test_wrong_qop_rejected [PASSED]
test/test_digest_auth/test_digest_auth.cpp:340: test_missing_response_field_rejected [PASSED]
test/test_digest_auth/test_digest_auth.cpp:341: test_basic_scheme_on_digest_route_rejected [PASSED]
test/test_digest_auth/test_digest_auth.cpp:342: test_uri_mismatch_rejected [PASSED]
test/test_digest_auth/test_digest_auth.cpp:343: test_nonce_is_128bit_hex [PASSED]
------------ native_app:test_digest_auth [PASSED] Took 0.64 seconds ------------
...
----------- native_app:test_web_terminal [PASSED] Took 0.61 seconds ------------
...
----------- native_app:test_file_serving [PASSED] Took 0.62 seconds ------------
...
-------------- native_app:test_chunked [PASSED] Took 0.61 seconds --------------
...
------------ native_app:test_application [PASSED] Took 0.69 seconds ------------

=================================== SUMMARY ===================================
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.183
native_app     test_template          PASSED    00:00:00.609
native_app     test_path_params       PASSED    00:00:00.597
native_app     test_digest_vectors    PASSED    00:00:00.542
native_app     test_form_params       PASSED    00:00:00.590
native_app     test_iface             PASSED    00:00:00.600
native_app     test_json              PASSED    00:00:00.557
native_app     test_response_headers  PASSED    00:00:00.597
native_app     test_middleware        PASSED    00:00:00.639
native_app     test_digest_auth       PASSED    00:00:00.644
native_app     test_web_terminal      PASSED    00:00:00.615
native_app     test_defer             PASSED    00:00:00.592
native_app     test_multipart         PASSED    00:00:00.629
native_app     test_auth              PASSED    00:00:00.603
native_app     test_file_serving      PASSED    00:00:00.619
native_app     test_dispatch          PASSED    00:00:00.601
native_app     test_chunked           PASSED    00:00:00.612
native_app     test_application       PASSED    00:00:00.689
================ 211 test cases: 211 succeeded in 00:00:11.518 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.721
native_snmp    test_snmp_agent  PASSED    00:00:00.504
================= 27 test cases: 27 succeeded in 00:00:01.225 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 1.40 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.396
================== 9 test cases: 9 succeeded in 00:00:01.396 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------- native_telnet:test_telnet [PASSED] Took 0.81 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.806
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.694
================= 27 test cases: 27 succeeded in 00:00:00.694 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
test/test_coap/test_coap.cpp:808: test_unknown_method_not_allowed       [PASSED]
test/test_coap/test_coap.cpp:809: test_unknown_critical_option_bad_option [PASSED]
----------- native_coap_observe:test_coap [PASSED] Took 0.71 seconds -----------

=================================== SUMMARY ===================================
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.712
================= 27 test cases: 27 succeeded in 00:00:00.712 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.678
================= 19 test cases: 19 succeeded in 00:00:00.678 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------- native_modbus:test_modbus [PASSED] Took 0.67 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.665
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.647
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.702
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.676
================== 5 test cases: 5 succeeded in 00:00:00.676 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.661
================== 2 test cases: 2 succeeded in 00:00:00.661 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.666
================== 4 test cases: 4 succeeded in 00:00:00.666 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.702
================= 12 test cases: 12 succeeded in 00:00:00.702 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
--------------- native_oidc:test_oidc [PASSED] Took 0.85 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.849
================= 13 test cases: 13 succeeded in 00:00:00.849 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.647
================= 13 test cases: 13 succeeded in 00:00:00.647 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.659
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.674
================= 29 test cases: 29 succeeded in 00:00:00.674 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.699
================= 11 test cases: 11 succeeded in 00:00:00.699 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.082
================= 10 test cases: 10 succeeded in 00:00:01.082 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.092
================= 13 test cases: 13 succeeded in 00:00:01.092 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.671
================== 6 test cases: 6 succeeded in 00:00:00.671 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_jwt/test_jwt.cpp:162: test_valid_token_accepts                [PASSED]
test/test_jwt/test_jwt.cpp:163: test_wrong_secret_rejects               [PASSED]
test/test_jwt/test_jwt.cpp:164: test_tampered_payload_rejects           [PASSED]
test/test_jwt/test_jwt.cpp:165: test_tampered_signature_rejects         [PASSED]
test/test_jwt/test_jwt.cpp:166: test_malformed_rejected                 [PASSED]
test/test_jwt/test_jwt.cpp:167: test_alg_not_hs256_rejected             [PASSED]
test/test_jwt/test_jwt.cpp:168: test_bearer_header                      [PASSED]
test/test_jwt/test_jwt.cpp:169: test_claim_int                          [PASSED]
test/test_jwt/test_jwt.cpp:170: test_claim_missing                      [PASSED]
test/test_jwt/test_jwt.cpp:171: test_claim_str                          [PASSED]
test/test_jwt/test_jwt.cpp:172: test_scope_allows                       [PASSED]
---------------- native_jwt:test_jwt [PASSED] Took 0.72 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.717
================= 11 test cases: 11 succeeded in 00:00:00.717 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------- native_upload:test_upload [PASSED] Took 1.12 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.120
================== 3 test cases: 3 succeeded in 00:00:01.120 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
-------- native_http_client:test_http_client [PASSED] Took 0.68 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.685
================= 10 test cases: 10 succeeded in 00:00:00.685 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.667
================= 15 test cases: 15 succeeded in 00:00:00.667 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_mqtt/test_mqtt.cpp:287: test_remlen_boundaries                [PASSED]
test/test_mqtt/test_mqtt.cpp:288: test_remlen_too_big                   [PASSED]
test/test_mqtt/test_mqtt.cpp:289: test_remlen_decode_incomplete         [PASSED]
test/test_mqtt/test_mqtt.cpp:290: test_remlen_decode_malformed          [PASSED]
test/test_mqtt/test_mqtt.cpp:291: test_connect_minimal                  [PASSED]
test/test_mqtt/test_mqtt.cpp:292: test_connect_full                     [PASSED]
test/test_mqtt/test_mqtt.cpp:293: test_publish_qos0_roundtrip           [PASSED]
test/test_mqtt/test_mqtt.cpp:294: test_publish_qos1_flags_and_id        [PASSED]
test/test_mqtt/test_mqtt.cpp:295: test_publish_topic_overflow_rejected  [PASSED]
test/test_mqtt/test_mqtt.cpp:296: test_publish_qos3_rejected            [PASSED]
test/test_mqtt/test_mqtt.cpp:297: test_subscribe                        [PASSED]
test/test_mqtt/test_mqtt.cpp:298: test_unsubscribe                      [PASSED]
test/test_mqtt/test_mqtt.cpp:299: test_ack_packets                      [PASSED]
test/test_mqtt/test_mqtt.cpp:300: test_connack                          [PASSED]
test/test_mqtt/test_mqtt.cpp:301: test_suback                           [PASSED]
test/test_mqtt/test_mqtt.cpp:302: test_ping_disconnect                  [PASSED]
test/test_mqtt/test_mqtt.cpp:303: test_fixed_header_multibyte_remlen    [PASSED]
--------------- native_mqtt:test_mqtt [PASSED] Took 0.68 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.678
================= 17 test cases: 17 succeeded in 00:00:00.678 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
---------- native_ws_client:test_ws_client [PASSED] Took 0.70 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.698
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.688
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.684
================== 3 test cases: 3 succeeded in 00:00:00.684 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.659
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.710
...
test/test_websocket/test_websocket.cpp:1065: stress_ws_parse_max_payload [PASSED]
test/test_websocket/test_websocket.cpp:1066: stress_ws_parse_two_consecutive_frames [PASSED]
--------- native_ws_deflate:test_websocket [PASSED] Took 1.05 seconds ----------

=================================== SUMMARY ===================================
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.052
================= 68 test cases: 68 succeeded in 00:00:01.052 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
-------- native_time_source:test_time_source [PASSED] Took 0.66 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.658
================== 9 test cases: 9 succeeded in 00:00:00.658 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.658
================= 14 test cases: 14 succeeded in 00:00:00.658 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.691
================== 4 test cases: 4 succeeded in 00:00:00.691 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.678
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.713
================== 9 test cases: 9 succeeded in 00:00:00.713 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.711
...
================= 11 test cases: 11 succeeded in 00:00:00.706 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
--------- native_net_egress:test_net_egress [PASSED] Took 0.69 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.687
================== 5 test cases: 5 succeeded in 00:00:00.687 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------ native_partition:test_partition_monitor [PASSED] Took 0.73 seconds ------

=================================== SUMMARY ===================================
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.731
...
--------------- native_cbor:test_cbor [PASSED] Took 0.71 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.712
================= 14 test cases: 14 succeeded in 00:00:00.712 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------ native_msgpack:test_msgpack [PASSED] Took 0.72 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.716
================= 15 test cases: 15 succeeded in 00:00:00.716 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.666
...
--------- native_guardrails:test_guardrails [PASSED] Took 0.67 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.669
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.669
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.689
...
------------ native_workers:test_workers [PASSED] Took 0.79 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.794
================== 3 test cases: 3 succeeded in 00:00:00.794 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.661
================== 4 test cases: 4 succeeded in 00:00:00.661 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
-------- native_concurrency:test_concurrency [PASSED] Took 0.88 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.877
================== 2 test cases: 2 succeeded in 00:00:00.877 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.279
