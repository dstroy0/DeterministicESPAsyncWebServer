...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    11 |   ✅   | 00:00:09.968 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.664 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.665 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.679 |
| `test_mbus`              | `native_mbus`           |     8 |   ✅   | 00:00:00.675 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.679 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.641 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.671 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.681 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.633 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.116 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.577 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.614 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.591 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.628 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.586 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.725 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:01.122 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.661 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.650 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:04.019 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.569 |
| `test_ssh_server`        | `native_ssh`            |    12 |   ✅   | 00:00:00.816 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.884 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.545 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.057 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.541 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.360 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.596 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.592 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.533 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.587 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.596 |
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.557 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.622 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.600 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.611 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.623 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.568 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.596 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.597 |
...
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.684 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.381 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.338 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.728 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.493 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.556 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.812 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.748 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.745 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.673 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.680 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.733 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.655 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.626 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.656 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.659 |
| `test_protobuf`          | `native_protobuf`       |    10 |   ✅   | 00:00:00.658 |
| `test_preempt_queue`     | `native_preempt_queue`  |     7 |   ✅   | 00:00:00.678 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.679 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.660 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.649 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.659 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.658 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.660 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.654 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.647 |
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.733 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.654 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.633 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.672 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.655 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.663 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.674 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.663 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.659 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.654 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.656 |
| `test_sparkplug`         | `native_sparkplug`      |     6 |   ✅   | 00:00:00.676 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.684 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.650 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.670 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.657 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.652 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.656 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.659 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.942 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.674 |
| `test_graphql`           | `native_graphql`        |    25 |   ✅   | 00:00:00.658 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.656 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.672 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.671 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.684 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.199 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.212 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.666 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.735 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.246 |
| `test_http_client`       | `native_http_client`    |    11 |   ✅   | 00:00:00.639 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.656 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.666 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.740 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.694 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.674 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.667 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.694 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.173 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.647 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.648 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.684 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.659 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.704 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.632 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.657 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.625 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.645 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.676 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.659 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.663 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.649 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.661 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.681 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.686 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.820 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.636 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.808 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.452 |
...
------------ native_canopen:test_canopen [PASSED] Took 9.97 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:09.968
================= 11 test cases: 11 succeeded in 00:00:09.968 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.664
...
---------- native_devicenet:test_devicenet [PASSED] Took 0.67 seconds ----------
...
--------------- native_mbus:test_mbus [PASSED] Took 0.68 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.675
...
----------- native_iec60870:test_iec60870 [PASSED] Took 0.68 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.679
...
-------------- native_sdi12:test_sdi12 [PASSED] Took 0.64 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.641
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.671
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.681
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.633
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.116
native         test_session       PASSED    00:00:00.577
native         test_presentation  PASSED    00:00:00.614
native         test_transport     PASSED    00:00:00.591
native         test_websocket     PASSED    00:00:00.628
native         test_http_parser   PASSED    00:00:00.586
================ 318 test cases: 318 succeeded in 00:00:04.112 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.725
================= 17 test cases: 17 succeeded in 00:00:00.725 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
-------- native_accept_gate:test_accept_gate [PASSED] Took 1.12 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.122
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.650
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 4.02 seconds -------------
...
------------ native_ssh:test_ssh_server [PASSED] Took 0.82 seconds -------------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.019
native_ssh     test_ssh_auth       PASSED    00:00:00.569
native_ssh     test_ssh_server     PASSED    00:00:00.816
native_ssh     test_ssh_transport  PASSED    00:00:00.884
native_ssh     test_ssh_channel    PASSED    00:00:00.545
================ 106 test cases: 106 succeeded in 00:00:06.833 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:01.057
================== 2 test cases: 2 succeeded in 00:00:01.057 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 1.54 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.541
...
--------------- native_app:test_regex [PASSED] Took 1.36 seconds ---------------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.360
native_app     test_template          PASSED    00:00:00.596
native_app     test_path_params       PASSED    00:00:00.592
native_app     test_digest_vectors    PASSED    00:00:00.533
native_app     test_form_params       PASSED    00:00:00.587
native_app     test_iface             PASSED    00:00:00.596
native_app     test_json              PASSED    00:00:00.557
native_app     test_response_headers  PASSED    00:00:00.622
native_app     test_middleware        PASSED    00:00:00.600
native_app     test_digest_auth       PASSED    00:00:00.611
native_app     test_web_terminal      PASSED    00:00:00.623
native_app     test_defer             PASSED    00:00:00.568
native_app     test_multipart         PASSED    00:00:00.596
native_app     test_auth              PASSED    00:00:00.597
...
native_app     test_application       PASSED    00:00:00.684
================ 219 test cases: 219 succeeded in 00:00:11.537 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
----- native_webdav_handler:test_webdav_handler [PASSED] Took 1.38 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.381
================= 12 test cases: 12 succeeded in 00:00:01.381 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
--------------- native_diag:test_diag [PASSED] Took 1.34 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.338
================== 2 test cases: 2 succeeded in 00:00:01.338 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
native_snmp    test_snmp_agent  PASSED    00:00:00.493
================= 30 test cases: 30 succeeded in 00:00:01.221 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 1.56 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.556
================= 10 test cases: 10 succeeded in 00:00:01.556 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.812
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.748
================= 29 test cases: 29 succeeded in 00:00:00.748 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.745
================= 29 test cases: 29 succeeded in 00:00:00.745 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.680
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.733
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.655
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.626
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.659
================== 6 test cases: 6 succeeded in 00:00:00.659 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.658
================= 10 test cases: 10 succeeded in 00:00:00.658 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.679
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.660
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.649
================== 6 test cases: 6 succeeded in 00:00:00.649 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.659
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.658
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.660
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.654
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.647
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.733
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.633
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.663
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.674
...
--------------- native_amqp:test_amqp [PASSED] Took 0.66 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.663
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.659
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.654
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.656
================== 8 test cases: 8 succeeded in 00:00:00.656 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.684
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.650
================== 5 test cases: 5 succeeded in 00:00:00.650 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.670
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.656
...
================= 13 test cases: 13 succeeded in 00:00:00.942 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.674
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.658
================= 25 test cases: 25 succeeded in 00:00:00.658 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.672
================== 8 test cases: 8 succeeded in 00:00:00.672 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.671
================= 29 test cases: 29 succeeded in 00:00:00.671 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.684
...
---------- native_keepalive:test_keepalive [PASSED] Took 1.20 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.199
================= 10 test cases: 10 succeeded in 00:00:01.199 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.212
================= 13 test cases: 13 succeeded in 00:00:01.212 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.735
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.246
================== 3 test cases: 3 succeeded in 00:00:01.246 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.639
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.666
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.694
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.667
================= 12 test cases: 12 succeeded in 00:00:00.667 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.694
================= 10 test cases: 10 succeeded in 00:00:00.694 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
test/test_websocket/test_websocket.cpp:1107: stress_ws_parse_max_payload [PASSED]
test/test_websocket/test_websocket.cpp:1108: stress_ws_parse_two_consecutive_frames [PASSED]
--------- native_ws_deflate:test_websocket [PASSED] Took 1.17 seconds ----------

=================================== SUMMARY ===================================
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.173
================= 71 test cases: 71 succeeded in 00:00:01.173 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.647
================== 9 test cases: 9 succeeded in 00:00:00.647 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.648
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.684
...
------- native_auth_lockout:test_auth_lockout [PASSED] Took 0.66 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.659
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.704
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.632
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.625
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.645
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.676
================= 14 test cases: 14 succeeded in 00:00:00.676 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.659
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.663
================== 8 test cases: 8 succeeded in 00:00:00.663 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.649
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.661
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.820
================== 3 test cases: 3 succeeded in 00:00:00.820 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
================== 7 test cases: 7 succeeded in 00:00:00.636 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
-------- native_concurrency:test_concurrency [PASSED] Took 0.81 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.808
================== 2 test cases: 2 succeeded in 00:00:00.808 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 1.45 seconds ------------

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.452
================== 2 test cases: 2 succeeded in 00:00:01.452 ==================
```
