...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:06.156 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.566 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.620 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.590 |
| `test_websocket`         | `native`               |    64 |   ✅   | 00:00:00.616 |
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.576 |
| `test_observability`     | `native_observability` |    15 |   ✅   | 00:00:00.721 |
| `test_http_ota`          | `native_ota`           |     3 |   ✅   | 00:00:00.661 |
| `test_provisioning`      | `native_prov`          |     5 |   ✅   | 00:00:00.682 |
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.779 |
| `test_ssh_auth`          | `native_ssh`           |    12 |   ✅   | 00:00:00.580 |
| `test_ssh_server`        | `native_ssh`           |     7 |   ✅   | 00:00:00.692 |
| `test_ssh_transport`     | `native_ssh`           |    23 |   ✅   | 00:00:00.939 |
| `test_ssh_channel`       | `native_ssh`           |    12 |   ✅   | 00:00:00.548 |
| `test_ssh_hardening`     | `native_ssh_hardened`  |     2 |   ✅   | 00:00:00.883 |
| `test_ssh_conn`          | `native_ssh_conn`      |     2 |   ✅   | 00:00:01.295 |
| `test_regex`             | `native_app`           |     9 |   ✅   | 00:00:01.160 |
| `test_template`          | `native_app`           |     6 |   ✅   | 00:00:00.602 |
| `test_path_params`       | `native_app`           |     8 |   ✅   | 00:00:00.603 |
| `test_digest_vectors`    | `native_app`           |     4 |   ✅   | 00:00:00.546 |
| `test_form_params`       | `native_app`           |     5 |   ✅   | 00:00:00.607 |
| `test_iface`             | `native_app`           |     7 |   ✅   | 00:00:00.615 |
| `test_json`              | `native_app`           |    17 |   ✅   | 00:00:00.570 |
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.605 |
| `test_middleware`        | `native_app`           |     9 |   ✅   | 00:00:00.613 |
| `test_digest_auth`       | `native_app`           |     9 |   ✅   | 00:00:00.643 |
| `test_web_terminal`      | `native_app`           |     7 |   ✅   | 00:00:00.620 |
| `test_defer`             | `native_app`           |     3 |   ✅   | 00:00:00.606 |
| `test_multipart`         | `native_app`           |    19 |   ✅   | 00:00:00.640 |
| `test_auth`              | `native_app`           |    13 |   ✅   | 00:00:00.620 |
| `test_file_serving`      | `native_app`           |    12 |   ✅   | 00:00:00.633 |
| `test_dispatch`          | `native_app`           |    11 |   ✅   | 00:00:00.623 |
| `test_chunked`           | `native_app`           |    10 |   ✅   | 00:00:00.623 |
| `test_application`       | `native_app`           |    52 |   ✅   | 00:00:00.689 |
| `test_diag`              | `native_diag`          |     2 |   ✅   | 00:00:01.152 |
| `test_snmp_ber`          | `native_snmp`          |    14 |   ✅   | 00:00:00.729 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.515 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.447 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.815 |
| `test_coap`              | `native_coap`          |    27 |   ✅   | 00:00:00.701 |
| `test_coap`              | `native_coap_observe`  |    27 |   ✅   | 00:00:00.675 |
| `test_webdav`            | `native_webdav`        |    19 |   ✅   | 00:00:00.677 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.686 |
| `test_modbus_master`     | `native_modbus_master` |     5 |   ✅   | 00:00:00.688 |
| `test_ota_rollback`      | `native_ota_rollback`  |     5 |   ✅   | 00:00:00.668 |
| `test_totp`              | `native_totp`          |     4 |   ✅   | 00:00:00.754 |
| `test_webhook`           | `native_webhook`       |     5 |   ✅   | 00:00:00.678 |
| `test_radio_power`       | `native_radio_power`   |     2 |   ✅   | 00:00:00.673 |
| `test_dns_resolver`      | `native_dns_resolver`  |     4 |   ✅   | 00:00:00.677 |
| `test_audit_log`         | `native_audit_log`     |    12 |   ✅   | 00:00:00.702 |
| `test_oidc`              | `native_oidc`          |    13 |   ✅   | 00:00:00.844 |
| `test_vfs`               | `native_vfs`           |    11 |   ✅   | 00:00:00.675 |
| `test_graphql`           | `native_graphql`       |    13 |   ✅   | 00:00:00.686 |
| `test_espnow`            | `native_espnow`        |     7 |   ✅   | 00:00:00.666 |
| `test_oauth2`            | `native_oauth2`        |     8 |   ✅   | 00:00:00.689 |
| `test_opcua`             | `native_opcua`         |    29 |   ✅   | 00:00:00.708 |
| `test_opcua_client`      | `native_opcua_client`  |    11 |   ✅   | 00:00:00.706 |
| `test_keepalive`         | `native_keepalive`     |    10 |   ✅   | 00:00:01.093 |
| `test_range`             | `native_range`         |    13 |   ✅   | 00:00:01.066 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.694 |
| `test_jwt`               | `native_jwt`           |    10 |   ✅   | 00:00:00.719 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.121 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.672 |
| `test_compliance`        | `native_compliance`    |    15 |   ✅   | 00:00:00.666 |
| `test_mqtt`              | `native_mqtt`          |    17 |   ✅   | 00:00:00.681 |
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.708 |
| `test_scratch`           | `native_scratch`       |    14 |   ✅   | 00:00:00.715 |
| `test_snmp_trap`         | `native_snmp_trap`     |     3 |   ✅   | 00:00:00.681 |
| `test_inflate`           | `native_inflate`       |    12 |   ✅   | 00:00:00.671 |
| `test_deflate`           | `native_deflate`       |    10 |   ✅   | 00:00:00.722 |
| `test_websocket`         | `native_ws_deflate`    |    68 |   ✅   | 00:00:01.020 |
| `test_time_source`       | `native_time_source`   |     9 |   ✅   | 00:00:00.650 |
| `test_config_store`      | `native_config_store`  |    14 |   ✅   | 00:00:00.670 |
| `test_device_id`         | `native_device_id`     |     4 |   ✅   | 00:00:00.708 |
| `test_auth_lockout`      | `native_auth_lockout`  |    10 |   ✅   | 00:00:00.680 |
| `test_csrf`              | `native_csrf`          |     9 |   ✅   | 00:00:00.714 |
| `test_telemetry`         | `native_telemetry`     |     8 |   ✅   | 00:00:00.663 |
| `test_dashboard`         | `native_dashboard`     |    11 |   ✅   | 00:00:00.673 |
| `test_net_egress`        | `native_net_egress`    |     5 |   ✅   | 00:00:00.676 |
| `test_partition_monitor` | `native_partition`     |     5 |   ✅   | 00:00:00.660 |
| `test_cbor`              | `native_cbor`          |    14 |   ✅   | 00:00:00.683 |
| `test_msgpack`           | `native_msgpack`       |    15 |   ✅   | 00:00:00.690 |
| `test_gpio_map`          | `native_gpio_map`      |     8 |   ✅   | 00:00:00.690 |
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.672 |
| `test_guardrails`        | `native_guardrails`    |     6 |   ✅   | 00:00:00.684 |
| `test_logbuf`            | `native_logbuf`        |     4 |   ✅   | 00:00:00.684 |
| `test_config_io`         | `native_config_io`     |     4 |   ✅   | 00:00:00.697 |
| `test_workers`           | `native_workers`       |     3 |   ✅   | 00:00:00.771 |
| `test_clock`             | `native_clock`         |     4 |   ✅   | 00:00:00.665 |
| `test_concurrency`       | `native_concurrency`   |     2 |   ✅   | 00:00:00.791 |
| `test_concurrency`       | `native_tsan`          |     2 |   ✅   | 00:00:01.287 |
...
------------------ native:test_sse [PASSED] Took 6.16 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.156
native         test_session       PASSED    00:00:00.566
native         test_presentation  PASSED    00:00:00.620
native         test_transport     PASSED    00:00:00.590
native         test_websocket     PASSED    00:00:00.616
native         test_http_parser   PASSED    00:00:00.576
================ 307 test cases: 307 succeeded in 00:00:09.124 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------ native_observability:test_observability [PASSED] Took 0.72 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.721
================= 15 test cases: 15 succeeded in 00:00:00.721 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.661
================== 3 test cases: 3 succeeded in 00:00:00.661 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.682
================== 5 test cases: 5 succeeded in 00:00:00.682 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
----------- native_ssh:test_ssh_transport [PASSED] Took 0.94 seconds -----------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.779
native_ssh     test_ssh_auth       PASSED    00:00:00.580
native_ssh     test_ssh_server     PASSED    00:00:00.692
native_ssh     test_ssh_transport  PASSED    00:00:00.939
native_ssh     test_ssh_channel    PASSED    00:00:00.548
================= 92 test cases: 92 succeeded in 00:00:06.539 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.883
================== 2 test cases: 2 succeeded in 00:00:00.883 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 1.29 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.295
...
src/DeterministicESPAsyncWebServer.cpp:2747:76: warning: ‘snprintf’ output may be truncated before the last format character [-Wformat-truncation=]
 2747 |         snprintf(lastmod_line, sizeof(lastmod_line), "Last-Modified: %s\r\n", lm_date);
      |                                                                            ^
src/DeterministicESPAsyncWebServer.cpp:2747:17: note: ‘snprintf’ output between 18 and 57 bytes into a destination of size 56
 2747 |         snprintf(lastmod_line, sizeof(lastmod_line), "Last-Modified: %s\r\n", lm_date);
      |         ~~~~~~~~^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Testing...
...
--------------- native_app:test_iface [PASSED] Took 0.62 seconds ---------------
...
------------ native_app:test_middleware [PASSED] Took 0.61 seconds -------------
...
--------------- native_app:test_defer [PASSED] Took 0.61 seconds ---------------
...
------------- native_app:test_multipart [PASSED] Took 0.64 seconds -------------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.160
native_app     test_template          PASSED    00:00:00.602
native_app     test_path_params       PASSED    00:00:00.603
native_app     test_digest_vectors    PASSED    00:00:00.546
native_app     test_form_params       PASSED    00:00:00.607
native_app     test_iface             PASSED    00:00:00.615
native_app     test_json              PASSED    00:00:00.570
native_app     test_response_headers  PASSED    00:00:00.605
native_app     test_middleware        PASSED    00:00:00.613
native_app     test_digest_auth       PASSED    00:00:00.643
native_app     test_web_terminal      PASSED    00:00:00.620
native_app     test_defer             PASSED    00:00:00.606
native_app     test_multipart         PASSED    00:00:00.640
native_app     test_auth              PASSED    00:00:00.620
native_app     test_file_serving      PASSED    00:00:00.633
native_app     test_dispatch          PASSED    00:00:00.623
native_app     test_chunked           PASSED    00:00:00.623
native_app     test_application       PASSED    00:00:00.689
================ 210 test cases: 210 succeeded in 00:00:11.616 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.152
...
------------ native_snmp:test_snmp_agent [PASSED] Took 0.52 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.729
native_snmp    test_snmp_agent  PASSED    00:00:00.515
================= 27 test cases: 27 succeeded in 00:00:01.244 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.447
================== 9 test cases: 9 succeeded in 00:00:01.447 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.815
================== 8 test cases: 8 succeeded in 00:00:00.815 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.701
================= 27 test cases: 27 succeeded in 00:00:00.701 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
test/test_coap/test_coap.cpp:808: test_unknown_method_not_allowed       [PASSED]
test/test_coap/test_coap.cpp:809: test_unknown_critical_option_bad_option [PASSED]
----------- native_coap_observe:test_coap [PASSED] Took 0.67 seconds -----------

=================================== SUMMARY ===================================
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.675
================= 27 test cases: 27 succeeded in 00:00:00.675 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.677
================= 19 test cases: 19 succeeded in 00:00:00.677 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.686
================= 13 test cases: 13 succeeded in 00:00:00.686 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.688
================== 5 test cases: 5 succeeded in 00:00:00.688 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.678
================== 5 test cases: 5 succeeded in 00:00:00.678 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.677
================== 4 test cases: 4 succeeded in 00:00:00.677 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.844
================= 13 test cases: 13 succeeded in 00:00:00.844 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.675
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.686
================= 13 test cases: 13 succeeded in 00:00:00.686 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------- native_espnow:test_espnow [PASSED] Took 0.67 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.666
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.689
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.708
================= 29 test cases: 29 succeeded in 00:00:00.708 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------- native_opcua_client:test_opcua_client [PASSED] Took 0.71 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.706
...
---------- native_keepalive:test_keepalive [PASSED] Took 1.09 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.093
================= 10 test cases: 10 succeeded in 00:00:01.093 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
-------------- native_range:test_range [PASSED] Took 1.07 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.066
================= 13 test cases: 13 succeeded in 00:00:01.066 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.694
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.719
================= 10 test cases: 10 succeeded in 00:00:00.719 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.121
================== 3 test cases: 3 succeeded in 00:00:01.121 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
================= 10 test cases: 10 succeeded in 00:00:00.672 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.666
================= 15 test cases: 15 succeeded in 00:00:00.666 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.681
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.708
================= 10 test cases: 10 succeeded in 00:00:00.708 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.715
================= 14 test cases: 14 succeeded in 00:00:00.715 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.681
================== 3 test cases: 3 succeeded in 00:00:00.681 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.722
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.020
================= 68 test cases: 68 succeeded in 00:00:01.020 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.650
================== 9 test cases: 9 succeeded in 00:00:00.650 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------- native_config_store:test_config_store [PASSED] Took 0.67 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.670
================= 14 test cases: 14 succeeded in 00:00:00.670 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
---------- native_device_id:test_device_id [PASSED] Took 0.71 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.708
================== 4 test cases: 4 succeeded in 00:00:00.708 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.680
================= 10 test cases: 10 succeeded in 00:00:00.680 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.714
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.663
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.673
================= 11 test cases: 11 succeeded in 00:00:00.673 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.676
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.660
...
================= 14 test cases: 14 succeeded in 00:00:00.683 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.690
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.672
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.684
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.684
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.697
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.771
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.665
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.791
================== 2 test cases: 2 succeeded in 00:00:00.791 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 1.29 seconds ------------

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.287
