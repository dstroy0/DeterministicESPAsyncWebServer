...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:10.135 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.658 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.692 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.669 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:04.498 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.734 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.701 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.715 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.703 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.705 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.697 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.705 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.716 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.672 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.689 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.666 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.065 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.608 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.634 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.630 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.649 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.616 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.801 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:01.109 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.699 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.674 |
| `test_ssh_crypto`        | `native_ssh`            |    45 |   ✅   | 00:00:04.065 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.699 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.878 |
| `test_ssh_transport`     | `native_ssh`            |    33 |   ✅   | 00:00:01.146 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.595 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.016 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.467 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.250 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.628 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.645 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.562 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.617 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.628 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.583 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.629 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.631 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.650 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.635 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.626 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.635 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.636 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.642 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.621 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.691 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.786 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.339 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.254 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.804 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.537 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:01.991 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.847 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.879 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.762 |
...
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.663 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.676 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.680 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.664 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.753 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.776 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.851 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.791 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.680 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.685 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.677 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.670 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.669 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.666 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.705 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.681 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.709 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.681 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.683 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.683 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.695 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.686 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.677 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.676 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.727 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.690 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.678 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.671 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.681 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.678 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.725 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.717 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.702 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.682 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.691 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.702 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.699 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.664 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.696 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.673 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.666 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.665 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.710 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.911 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.685 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.686 |
...
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.214 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.250 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.729 |
| `test_smtp`              | `native_smtp`           |    11 |   ✅   | 00:00:00.852 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.707 |
| `test_dns_server`        | `native_dns_server`     |     7 |   ✅   | 00:00:00.686 |
| `test_rtc`               | `native_rtc`            |     8 |   ✅   | 00:00:00.665 |
| `test_ld2410`            | `native_ld2410`         |     7 |   ✅   | 00:00:00.678 |
| `test_mpr121`            | `native_mpr121`         |     5 |   ✅   | 00:00:00.671 |
| `test_sht3x`             | `native_sht3x`          |     5 |   ✅   | 00:00:00.687 |
| `test_pca9685`           | `native_pca9685`        |     4 |   ✅   | 00:00:00.682 |
| `test_ads1115`           | `native_ads1115`        |     3 |   ✅   | 00:00:00.720 |
| `test_ina219`            | `native_ina219`         |     4 |   ✅   | 00:00:00.686 |
| `test_hpack`             | `native_hpack`          |     7 |   ✅   | 00:00:00.788 |
| `test_h2_frame`          | `native_h2frame`        |     6 |   ✅   | 00:00:00.672 |
| `test_h2_conn`           | `native_h2conn`         |     4 |   ✅   | 00:00:00.893 |
| `test_quic_varint`       | `native_quic_varint`    |     3 |   ✅   | 00:00:00.663 |
| `test_h3_frame`          | `native_h3frame`        |     7 |   ✅   | 00:00:00.685 |
...
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.711 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.689 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.788 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.731 |
...
| `test_ssh_zlib`          | `native_ssh_zlib`       |     9 |   ✅   | 00:00:00.740 |
| `test_ssh_comp`          | `native_ssh_comp`       |     5 |   ✅   | 00:00:01.068 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.076 |
...
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.691 |
...
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.706 |
| `test_statsd`            | `native_statsd`         |     9 |   ✅   | 00:00:00.733 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.718 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.699 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.731 |
...
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.091 |
| `test_qpack`             | `native_qpack`          |     9 |   ✅   | 00:00:00.787 |
| `test_quic_packet`       | `native_quic_packet`    |     8 |   ✅   | 00:00:00.662 |
| `test_quic_frame`        | `native_quic_frame`     |     8 |   ✅   | 00:00:00.726 |
| `test_quic_crypto`       | `native_quic_crypto`    |     7 |   ✅   | 00:00:00.792 |
| `test_tls13_kdf`         | `native_tls13_kdf`      |     5 |   ✅   | 00:00:00.746 |
| `test_quic_tp`           | `native_quic_tp`        |     7 |   ✅   | 00:00:00.688 |
| `test_tls13_msg`         | `native_tls13_msg`      |     7 |   ✅   | 00:00:00.776 |
| `test_quic_tls`          | `native_quic_tls`       |    11 |   ✅   | 00:00:00.968 |
| `test_quic_conn`         | `native_quic_conn`      |     4 |   ✅   | 00:00:01.034 |
| `test_h3_conn`           | `native_h3_conn`        |    11 |   ✅   | 00:00:00.984 |
| `test_h3_e2e`            | `native_h3_e2e`         |     1 |   ✅   | 00:00:01.030 |
| `test_quic_server`       | `native_quic_server`    |     2 |   ✅   | 00:00:01.101 |
| `test_h3_server`         | `native_h3_server`      |     1 |   ✅   | 00:00:01.611 |
...
----------- native_canopen:test_canopen [PASSED] Took 10.13 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:10.135
================= 17 test cases: 17 succeeded in 00:00:10.135 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_det_arena  test_det_arena  PASSED    00:00:00.669
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:04.498
================= 16 test cases: 16 succeeded in 00:00:04.498 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.734
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.701
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.715
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.697
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.716
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.666
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.065
native         test_session       PASSED    00:00:00.608
native         test_presentation  PASSED    00:00:00.634
native         test_transport     PASSED    00:00:00.630
native         test_websocket     PASSED    00:00:00.649
native         test_http_parser   PASSED    00:00:00.616
================ 323 test cases: 323 succeeded in 00:00:04.202 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.801
================= 17 test cases: 17 succeeded in 00:00:00.801 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.109
================= 13 test cases: 13 succeeded in 00:00:01.109 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.699
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.065
native_ssh     test_ssh_auth       PASSED    00:00:00.699
native_ssh     test_ssh_server     PASSED    00:00:00.878
native_ssh     test_ssh_transport  PASSED    00:00:01.146
native_ssh     test_ssh_channel    PASSED    00:00:00.595
================ 145 test cases: 145 succeeded in 00:00:07.383 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:01.016
================== 2 test cases: 2 succeeded in 00:00:01.016 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_app:test_application [PASSED] Took 0.79 seconds ------------

=================================== SUMMARY ===================================
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.250
native_app     test_template          PASSED    00:00:00.628
native_app     test_path_params       PASSED    00:00:00.645
native_app     test_digest_vectors    PASSED    00:00:00.562
...
native_app     test_response_headers  PASSED    00:00:00.629
native_app     test_middleware        PASSED    00:00:00.631
native_app     test_digest_auth       PASSED    00:00:00.650
native_app     test_web_terminal      PASSED    00:00:00.635
native_app     test_defer             PASSED    00:00:00.626
native_app     test_multipart         PASSED    00:00:00.635
native_app     test_auth              PASSED    00:00:00.636
native_app     test_file_serving      PASSED    00:00:00.642
native_app     test_dispatch          PASSED    00:00:00.621
native_app     test_chunked           PASSED    00:00:00.691
native_app     test_application       PASSED    00:00:00.786
================ 225 test cases: 225 succeeded in 00:00:12.097 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.339
================= 12 test cases: 12 succeeded in 00:00:01.339 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.254
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.804
native_snmp    test_snmp_agent  PASSED    00:00:00.537
================= 35 test cases: 35 succeeded in 00:00:01.341 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.991
================= 15 test cases: 15 succeeded in 00:00:01.991 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.847
...
================= 41 test cases: 41 succeeded in 00:00:00.879 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.762
================= 41 test cases: 41 succeeded in 00:00:00.762 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.663
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.676
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.664
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.753
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.776
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.851
================= 16 test cases: 16 succeeded in 00:00:00.851 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.685
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.677
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_pn532   test_pn532  PASSED    00:00:00.670
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.669
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_zigbee  test_zigbee  PASSED    00:00:00.705
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.681
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.683
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.683
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.695
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.686
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.690
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.671
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.681
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.678
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.725
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.717
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.691
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.664
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.696
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.665
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.911
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.685
...
================= 32 test cases: 32 succeeded in 00:00:00.686 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.214
================= 10 test cases: 10 succeeded in 00:00:01.214 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------------- native_range:test_range [PASSED] Took 1.25 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.250
================= 13 test cases: 13 succeeded in 00:00:01.250 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_smtp    test_smtp  PASSED    00:00:00.852
================= 11 test cases: 11 succeeded in 00:00:00.852 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_ntp_server  test_ntp_server  PASSED    00:00:00.707
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_rtc     test_rtc  PASSED    00:00:00.665
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sht3x   test_sht3x  PASSED    00:00:00.687
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_pca9685  test_pca9685  PASSED    00:00:00.682
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ina219  test_ina219  PASSED    00:00:00.686
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_hpack   test_hpack  PASSED    00:00:00.788
...
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h2frame  test_h2_frame  PASSED    00:00:00.672
...
Environment    Test          Status    Duration
-------------  ------------  --------  ------------
native_h2conn  test_h2_conn  PASSED    00:00:00.893
================== 4 test cases: 4 succeeded in 00:00:00.893 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h3frame  test_h3_frame  PASSED    00:00:00.685
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_zlib  test_ssh_zlib  PASSED    00:00:00.740
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_comp  test_ssh_comp  PASSED    00:00:01.068
================== 5 test cases: 5 succeeded in 00:00:01.068 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.076
================= 71 test cases: 71 succeeded in 00:00:01.076 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.706
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.718
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.699
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.731
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 1.09 seconds ------------

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.091
================== 2 test cases: 2 succeeded in 00:00:01.091 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_packet  test_quic_packet  PASSED    00:00:00.662
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_quic_frame  test_quic_frame  PASSED    00:00:00.726
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_crypto  test_quic_crypto  PASSED    00:00:00.792
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_quic_tp  test_quic_tp  PASSED    00:00:00.688
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_tls13_msg  test_tls13_msg  PASSED    00:00:00.776
...
================= 11 test cases: 11 succeeded in 00:00:00.984 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_h3_e2e  test_h3_e2e  PASSED    00:00:01.030
================== 1 test cases: 1 succeeded in 00:00:01.030 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_server  test_quic_server  PASSED    00:00:01.101
================== 2 test cases: 2 succeeded in 00:00:01.101 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
---------- native_h3_server:test_h3_server [PASSED] Took 1.61 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_h3_server  test_h3_server  PASSED    00:00:01.611
================== 1 test cases: 1 succeeded in 00:00:01.611 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
