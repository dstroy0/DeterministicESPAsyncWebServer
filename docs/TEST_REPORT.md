...
**Generated:** 2026-07-05 01:20:57
**Command:** `pio test` over 133 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 2072 passed - 255s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:09.762 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.635 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.663 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.653 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:04.398 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.651 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.646 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.658 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.655 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.665 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.651 |
...
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.657 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:00.989 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.586 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.629 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.613 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.634 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.602 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.777 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:01.010 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.678 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.681 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.957 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.646 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.842 |
| `test_ssh_transport`     | `native_ssh`            |    31 |   ✅   | 00:00:01.139 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.581 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.937 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.335 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.184 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.615 |
...
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.616 |
...
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.191 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.702 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.521 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:01.952 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.818 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.846 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.767 |
...
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.646 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.658 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.656 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.659 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.715 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.769 |
...
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.656 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.656 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.655 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.647 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.646 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.663 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.642 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.681 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.660 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.654 |
...
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.642 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.658 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.671 |
...
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.129 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.096 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.662 |
| `test_smtp`              | `native_smtp`           |    11 |   ✅   | 00:00:00.789 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.660 |
| `test_dns_server`        | `native_dns_server`     |     7 |   ✅   | 00:00:00.655 |
| `test_rtc`               | `native_rtc`            |     8 |   ✅   | 00:00:00.653 |
| `test_ld2410`            | `native_ld2410`         |     7 |   ✅   | 00:00:00.666 |
| `test_mpr121`            | `native_mpr121`         |     5 |   ✅   | 00:00:00.662 |
| `test_sht3x`             | `native_sht3x`          |     5 |   ✅   | 00:00:00.655 |
| `test_pca9685`           | `native_pca9685`        |     4 |   ✅   | 00:00:00.656 |
| `test_ads1115`           | `native_ads1115`        |     3 |   ✅   | 00:00:00.663 |
| `test_ina219`            | `native_ina219`         |     4 |   ✅   | 00:00:00.656 |
| `test_hpack`             | `native_hpack`          |     7 |   ✅   | 00:00:00.768 |
| `test_h2_frame`          | `native_h2frame`        |     6 |   ✅   | 00:00:00.662 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.708 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.137 |
...
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.683 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.664 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.706 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.094 |
...
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.683 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.690 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.674 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.664 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.674 |
...
------------ native_canopen:test_canopen [PASSED] Took 9.76 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:09.762
================= 17 test cases: 17 succeeded in 00:00:09.762 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 158 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.635
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_det_arena  test_det_arena  PASSED    00:00:00.653
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:04.398
================= 16 test cases: 16 succeeded in 00:00:04.398 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 158 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.646
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.658
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.655
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.665
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.651
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.657
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:00.989
...
native         test_websocket     PASSED    00:00:00.634
native         test_http_parser   PASSED    00:00:00.602
================ 323 test cases: 323 succeeded in 00:00:04.054 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 158 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.010
================= 13 test cases: 13 succeeded in 00:00:01.010 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 158 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.957
native_ssh     test_ssh_auth       PASSED    00:00:00.646
native_ssh     test_ssh_server     PASSED    00:00:00.842
native_ssh     test_ssh_transport  PASSED    00:00:01.139
native_ssh     test_ssh_channel    PASSED    00:00:00.581
================ 137 test cases: 137 succeeded in 00:00:07.164 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 158 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.937
================== 2 test cases: 2 succeeded in 00:00:00.937 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 158 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.335
================== 2 test cases: 2 succeeded in 00:00:01.335 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 158 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.184
native_app     test_template          PASSED    00:00:00.615
...
native_app     test_auth              PASSED    00:00:00.616
...
================ 225 test cases: 225 succeeded in 00:00:11.648 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 158 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.191
================== 2 test cases: 2 succeeded in 00:00:01.191 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 158 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.952
================= 15 test cases: 15 succeeded in 00:00:01.952 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 158 tests
...
--------------- native_coap:test_coap [PASSED] Took 0.85 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.846
================= 41 test cases: 41 succeeded in 00:00:00.846 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 158 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.767
================= 41 test cases: 41 succeeded in 00:00:00.767 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 158 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.646
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.656
...
================= 11 test cases: 11 succeeded in 00:00:00.715 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 158 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.769
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.656
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.656
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.647
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.646
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_zigbee  test_zigbee  PASSED    00:00:00.663
...
------------- native_thread:test_thread [PASSED] Took 0.64 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.642
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.654
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.638
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.659
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.642
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.660
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.642
================== 2 test cases: 2 succeeded in 00:00:00.642 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 158 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.671
================= 16 test cases: 16 succeeded in 00:00:00.671 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 158 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.129
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.096
================= 13 test cases: 13 succeeded in 00:00:01.096 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 158 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_ntp_server  test_ntp_server  PASSED    00:00:00.660
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ld2410  test_ld2410  PASSED    00:00:00.666
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sht3x   test_sht3x  PASSED    00:00:00.655
================== 5 test cases: 5 succeeded in 00:00:00.655 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 158 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_ads1115  test_ads1115  PASSED    00:00:00.663
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ina219  test_ina219  PASSED    00:00:00.656
================== 4 test cases: 4 succeeded in 00:00:00.656 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 158 tests
...
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h2frame  test_h2_frame  PASSED    00:00:00.662
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.137
================== 3 test cases: 3 succeeded in 00:00:01.137 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 158 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.094
================= 71 test cases: 71 succeeded in 00:00:01.094 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 158 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.683
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.690
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_statsd  test_statsd  PASSED    00:00:00.691
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.666
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.630
================== 7 test cases: 7 succeeded in 00:00:00.630 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 158 tests
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.142
