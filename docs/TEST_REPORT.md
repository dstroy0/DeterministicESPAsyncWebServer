...
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.668 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.653 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.660 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.003 |
...
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:00.991 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.678 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.673 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.827 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.648 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.885 |
| `test_ssh_transport`     | `native_ssh`            |    31 |   ✅   | 00:00:01.175 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.584 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.948 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.335 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.154 |
...
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.649 |
...
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.677 |
...
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.037 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.653 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.660 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.675 |
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.679 |
...
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.771 |
...
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.261
================= 17 test cases: 17 succeeded in 00:00:06.261 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 145 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_det_arena  test_det_arena  PASSED    00:00:00.664
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.719
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.668
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.653
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.003
...
================ 323 test cases: 323 succeeded in 00:00:04.052 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 145 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.991
...
native_ssh     test_ssh_transport  PASSED    00:00:01.175
native_ssh     test_ssh_channel    PASSED    00:00:00.584
================ 137 test cases: 137 succeeded in 00:00:07.120 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 145 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.948
================== 2 test cases: 2 succeeded in 00:00:00.948 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 145 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.154
...
================ 225 test cases: 225 succeeded in 00:00:11.532 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 145 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.688
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:02.069
================= 15 test cases: 15 succeeded in 00:00:02.069 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 145 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:01.016
================= 41 test cases: 41 succeeded in 00:00:01.016 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 145 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.672
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.649
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.740
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.667
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.657
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.691
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.648
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.659
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.677
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.720
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.657
================= 32 test cases: 32 succeeded in 00:00:00.657 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 145 tests
...
================= 38 test cases: 38 succeeded in 00:00:00.684 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 145 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.080
================= 13 test cases: 13 succeeded in 00:00:01.080 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 145 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.112
================== 3 test cases: 3 succeeded in 00:00:01.112 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 145 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.037
================= 71 test cases: 71 succeeded in 00:00:01.037 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 145 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.653
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.771
================== 2 test cases: 2 succeeded in 00:00:00.771 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 145 tests
