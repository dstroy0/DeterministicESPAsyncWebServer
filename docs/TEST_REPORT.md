...
<<<<<<< HEAD
**Generated:** 2026-06-22 18:02:59
**Command:** `pio test -e native -e native_app -e native_ssh -e native_ssh_hardened -e native_ssh_conn -e native_compliance`
**Result:** ✅ 495 passed - 45s
=======
**Generated:** 2026-06-22 21:57:36
**Command:** `pio test -e native -e native_app -e native_ssh -e native_ssh_hardened -e native_ssh_conn -e native_compliance`
**Result:** ✅ 495 passed - 26s
>>>>>>> ded48b99ed5d44b46bd27c93b4e23b4cc6e95a86
...
| :------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_http_parser`   | `native`              |    80 |   ✅   | 00:00:02.783 |
| `test_presentation`  | `native`              |    63 |   ✅   | 00:00:01.888 |
| `test_session`       | `native`              |    19 |   ✅   | 00:00:01.801 |
| `test_sse`           | `native`              |    37 |   ✅   | 00:00:01.790 |
| `test_transport`     | `native`              |    28 |   ✅   | 00:00:02.324 |
| `test_websocket`     | `native`              |    63 |   ✅   | 00:00:02.299 |
| `test_ssh_auth`      | `native_ssh`          |    12 |   ✅   | 00:00:02.469 |
| `test_ssh_channel`   | `native_ssh`          |    12 |   ✅   | 00:00:02.317 |
| `test_ssh_crypto`    | `native_ssh`          |    37 |   ✅   | 00:00:06.168 |
| `test_ssh_server`    | `native_ssh`          |     7 |   ✅   | 00:00:02.604 |
| `test_ssh_transport` | `native_ssh`          |    23 |   ✅   | 00:00:02.851 |
| `test_ssh_hardening` | `native_ssh_hardened` |     2 |   ✅   | 00:00:01.114 |
| `test_ssh_conn`      | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.300 |
| `test_application`   | `native_app`          |    44 |   ✅   | 00:00:02.425 |
| `test_auth`          | `native_app`          |    13 |   ✅   | 00:00:02.370 |
| `test_dispatch`      | `native_app`          |    10 |   ✅   | 00:00:02.263 |
| `test_file_serving`  | `native_app`          |    12 |   ✅   | 00:00:02.341 |
| `test_multipart`     | `native_app`          |    19 |   ✅   | 00:00:02.413 |
| `test_compliance`    | `native_compliance`   |    12 |   ✅   | 00:00:01.003 |
=======
| Suite                | Environment           | Tests | Status | Duration     |
| -------------------- | --------------------- | ----- | ------ | ------------ |
| `test_sse`           | `native`              | 37    | ✅     | 00:00:10.974 |
| `test_session`       | `native`              | 19    | ✅     | 00:00:00.385 |
| `test_presentation`  | `native`              | 63    | ✅     | 00:00:00.404 |
| `test_transport`     | `native`              | 28    | ✅     | 00:00:00.381 |
| `test_websocket`     | `native`              | 63    | ✅     | 00:00:00.408 |
| `test_http_parser`   | `native`              | 80    | ✅     | 00:00:00.400 |
| `test_ssh_crypto`    | `native_ssh`          | 37    | ✅     | 00:00:02.894 |
| `test_ssh_auth`      | `native_ssh`          | 12    | ✅     | 00:00:00.406 |
| `test_ssh_server`    | `native_ssh`          | 7     | ✅     | 00:00:00.502 |
| `test_ssh_transport` | `native_ssh`          | 23    | ✅     | 00:00:00.692 |
| `test_ssh_channel`   | `native_ssh`          | 12    | ✅     | 00:00:00.377 |
| `test_ssh_hardening` | `native_ssh_hardened` | 2     | ✅     | 00:00:00.622 |
| `test_ssh_conn`      | `native_ssh_conn`     | 2     | ✅     | 00:00:00.820 |
| `test_multipart`     | `native_app`          | 19    | ✅     | 00:00:00.634 |
| `test_auth`          | `native_app`          | 13    | ✅     | 00:00:00.387 |
| `test_file_serving`  | `native_app`          | 12    | ✅     | 00:00:00.397 |
| `test_dispatch`      | `native_app`          | 10    | ✅     | 00:00:00.390 |
| `test_application`   | `native_app`          | 44    | ✅     | 00:00:00.456 |
| `test_compliance`    | `native_compliance`   | 12    | ✅     | 00:00:00.488 |
...
|  73 | `test_bad_expect_lf_is_error`                            |   ✅   | CRLF in version line replaced by CR + X (no LF)      ## test_session - ✅ 19 passed
...
---------------- native:test_session [PASSED] Took 0.39 seconds ----------------
...
-------------- native:test_http_parser [PASSED] Took 2.78 seconds --------------
=======
...
------------- native:test_presentation [PASSED] Took 1.89 seconds --------------
...
---------------- native:test_session [PASSED] Took 1.80 seconds ----------------
...
------------------ native:test_sse [PASSED] Took 1.79 seconds ------------------
...
--------------- native:test_transport [PASSED] Took 2.32 seconds ---------------
...
--------------- native:test_websocket [PASSED] Took 2.30 seconds ---------------
=======
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 2.89 seconds ------------
>>>>>>> ded48b99ed5d44b46bd27c93b4e23b4cc6e95a86
...
------------- native_ssh:test_ssh_auth [PASSED] Took 2.47 seconds --------------
=======
...
------------- native_ssh:test_ssh_auth [PASSED] Took 0.41 seconds -------------
...
------------ native_ssh:test_ssh_channel [PASSED] Took 2.32 seconds ------------
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 6.17 seconds -------------
...
------------ native_ssh:test_ssh_server [PASSED] Took 2.60 seconds -------------
...
----------- native_ssh:test_ssh_transport [PASSED] Took 2.85 seconds -----------
=======
...
------------ native_ssh:test_ssh_channel [PASSED] Took 0.38 seconds ------------
>>>>>>> ded48b99ed5d44b46bd27c93b4e23b4cc6e95a86
...
--------------- native_app:test_auth [PASSED] Took 0.39 seconds ---------------
...
------------- native_app:test_dispatch [PASSED] Took 0.39 seconds -------------
>>>>>>> ded48b99ed5d44b46bd27c93b4e23b4cc6e95a86
...
Testing...
<<<<<<< HEAD
test\test_application\test_application.cpp:734: test_handler_reads_body [PASSED]
test\test_application\test_application.cpp:735: test_handler_reads_query_param [PASSED]
test\test_application\test_application.cpp:736: test_handler_reads_header [PASSED]
test\test_application\test_application.cpp:737: test_wildcard_before_exact_wildcard_wins [PASSED]
test\test_application\test_application.cpp:740: test_fn_on_registers_and_dispatches [PASSED]
test\test_application\test_application.cpp:741: test_fn_on_path_copied_null_terminated [PASSED]
test\test_application\test_application.cpp:742: test_fn_on_table_full_extra_routes_dropped [PASSED]
test\test_application\test_application.cpp:743: test_fn_on_same_path_different_methods_are_distinct [PASSED]
test\test_application\test_application.cpp:746: test_fn_on_not_found_called_when_no_match [PASSED]
test\test_application\test_application.cpp:747: test_fn_on_not_found_not_called_when_match_exists [PASSED]
test\test_application\test_application.cpp:750: test_fn_set_cors_options_preflight_clears_slot [PASSED]
test\test_application\test_application.cpp:751: test_fn_set_cors_empty_string_disables [PASSED]
test\test_application\test_application.cpp:754: test_wrong_method_does_not_match [PASSED]
test\test_application\test_application.cpp:755: test_wrong_path_does_not_match [PASSED]
test\test_application\test_application.cpp:756: test_all_http_methods_dispatched [PASSED]
test\test_application\test_application.cpp:757: test_root_path_matches_exactly [PASSED]
test\test_application\test_application.cpp:758: test_root_path_does_not_match_subpath [PASSED]
test\test_application\test_application.cpp:759: test_wildcard_matches_any_suffix [PASSED]
test\test_application\test_application.cpp:760: test_wildcard_does_not_match_unrelated_prefix [PASSED]
test\test_application\test_application.cpp:761: test_exact_route_wins_when_registered_first [PASSED]
test\test_application\test_application.cpp:762: test_slot_not_stuck_in_complete_after_handle [PASSED]
test\test_application\test_application.cpp:763: test_parse_error_slot_auto_reset [PASSED]
test\test_application\test_application.cpp:766: stress_last_route_dispatched_in_full_table [PASSED]
test\test_application\test_application.cpp:767: stress_sequential_requests_no_state_leak [PASSED]
test\test_application\test_application.cpp:768: stress_all_slots_dispatched_simultaneously [PASSED]
test\test_application\test_application.cpp:769: stress_wildcard_matches_many_paths [PASSED]
test\test_application\test_application.cpp:770: stress_handle_with_no_complete_slots_is_nop [PASSED]
test\test_application\test_application.cpp:773: race_slot_complete_between_handle_calls [PASSED]
test\test_application\test_application.cpp:774: race_conn_freed_after_parse_complete [PASSED]
test\test_application\test_application.cpp:775: race_double_handle_no_double_dispatch [PASSED]
test\test_application\test_application.cpp:776: race_error_and_valid_slot_in_same_handle [PASSED]
test\test_application\test_application.cpp:777: race_callback_manually_resets_slot [PASSED]
test\test_application\test_application.cpp:780: test_uri_too_long_auto_resets_slot [PASSED]
test\test_application\test_application.cpp:783: test_transfer_encoding_chunked_is_501 [PASSED]
test\test_application\test_application.cpp:784: test_transfer_encoding_identity_is_501 [PASSED]
test\test_application\test_application.cpp:786: test_redirect_emits_location_and_status [PASSED]
test\test_application\test_application.cpp:787: test_redirect_invalid_code_defaults_to_302 [PASSED]
test\test_application\test_application.cpp:788: test_mime_type_detection [PASSED]
test\test_application\test_application.cpp:790: test_serve_static_file_and_mime [PASSED]
test\test_application\test_application.cpp:791: test_serve_static_index_fallback [PASSED]
test\test_application\test_application.cpp:792: test_serve_static_gzip_when_accepted [PASSED]
test\test_application\test_application.cpp:793: test_serve_static_no_gzip_when_not_accepted [PASSED]
test\test_application\test_application.cpp:794: test_serve_static_traversal_not_leaked [PASSED]
test\test_application\test_application.cpp:795: test_serve_static_missing_is_404 [PASSED]
------------ native_app:test_application [PASSED] Took 2.43 seconds ------------
...
--------------- native_app:test_auth [PASSED] Took 2.37 seconds ----------------
...
------------- native_app:test_dispatch [PASSED] Took 2.26 seconds --------------
...
----------- native_app:test_file_serving [PASSED] Took 2.34 seconds ------------
...
------------- native_app:test_multipart [PASSED] Took 2.41 seconds -------------
=======
test/test_application/test_application.cpp:734: test_handler_reads_body	[PASSED]
test/test_application/test_application.cpp:735: test_handler_reads_query_param	[PASSED]
test/test_application/test_application.cpp:736: test_handler_reads_header	[PASSED]
test/test_application/test_application.cpp:737: test_wildcard_before_exact_wildcard_wins	[PASSED]
test/test_application/test_application.cpp:740: test_fn_on_registers_and_dispatches	[PASSED]
test/test_application/test_application.cpp:741: test_fn_on_path_copied_null_terminated	[PASSED]
test/test_application/test_application.cpp:742: test_fn_on_table_full_extra_routes_dropped	[PASSED]
test/test_application/test_application.cpp:743: test_fn_on_same_path_different_methods_are_distinct	[PASSED]
test/test_application/test_application.cpp:746: test_fn_on_not_found_called_when_no_match	[PASSED]
test/test_application/test_application.cpp:747: test_fn_on_not_found_not_called_when_match_exists	[PASSED]
test/test_application/test_application.cpp:750: test_fn_set_cors_options_preflight_clears_slot	[PASSED]
test/test_application/test_application.cpp:751: test_fn_set_cors_empty_string_disables	[PASSED]
test/test_application/test_application.cpp:754: test_wrong_method_does_not_match	[PASSED]
test/test_application/test_application.cpp:755: test_wrong_path_does_not_match	[PASSED]
test/test_application/test_application.cpp:756: test_all_http_methods_dispatched	[PASSED]
test/test_application/test_application.cpp:757: test_root_path_matches_exactly	[PASSED]
test/test_application/test_application.cpp:758: test_root_path_does_not_match_subpath	[PASSED]
test/test_application/test_application.cpp:759: test_wildcard_matches_any_suffix	[PASSED]
test/test_application/test_application.cpp:760: test_wildcard_does_not_match_unrelated_prefix	[PASSED]
test/test_application/test_application.cpp:761: test_exact_route_wins_when_registered_first	[PASSED]
test/test_application/test_application.cpp:762: test_slot_not_stuck_in_complete_after_handle	[PASSED]
test/test_application/test_application.cpp:763: test_parse_error_slot_auto_reset	[PASSED]
test/test_application/test_application.cpp:766: stress_last_route_dispatched_in_full_table	[PASSED]
test/test_application/test_application.cpp:767: stress_sequential_requests_no_state_leak	[PASSED]
test/test_application/test_application.cpp:768: stress_all_slots_dispatched_simultaneously	[PASSED]
test/test_application/test_application.cpp:769: stress_wildcard_matches_many_paths	[PASSED]
test/test_application/test_application.cpp:770: stress_handle_with_no_complete_slots_is_nop	[PASSED]
test/test_application/test_application.cpp:773: race_slot_complete_between_handle_calls	[PASSED]
test/test_application/test_application.cpp:774: race_conn_freed_after_parse_complete	[PASSED]
test/test_application/test_application.cpp:775: race_double_handle_no_double_dispatch	[PASSED]
test/test_application/test_application.cpp:776: race_error_and_valid_slot_in_same_handle	[PASSED]
test/test_application/test_application.cpp:777: race_callback_manually_resets_slot	[PASSED]
test/test_application/test_application.cpp:780: test_uri_too_long_auto_resets_slot	[PASSED]
test/test_application/test_application.cpp:783: test_transfer_encoding_chunked_is_501	[PASSED]
test/test_application/test_application.cpp:784: test_transfer_encoding_identity_is_501	[PASSED]
test/test_application/test_application.cpp:786: test_redirect_emits_location_and_status	[PASSED]
test/test_application/test_application.cpp:787: test_redirect_invalid_code_defaults_to_302	[PASSED]
test/test_application/test_application.cpp:788: test_mime_type_detection	[PASSED]
test/test_application/test_application.cpp:790: test_serve_static_file_and_mime	[PASSED]
test/test_application/test_application.cpp:791: test_serve_static_index_fallback	[PASSED]
test/test_application/test_application.cpp:792: test_serve_static_gzip_when_accepted	[PASSED]
test/test_application/test_application.cpp:793: test_serve_static_no_gzip_when_not_accepted	[PASSED]
test/test_application/test_application.cpp:794: test_serve_static_traversal_not_leaked	[PASSED]
test/test_application/test_application.cpp:795: test_serve_static_missing_is_404	[PASSED]
------------ native_app:test_application [PASSED] Took 0.46 seconds ------------
>>>>>>> ded48b99ed5d44b46bd27c93b4e23b4cc6e95a86
...
--------- native_compliance:test_compliance [PASSED] Took 1.00 seconds ---------
=======
...
-------------------  ------------------  --------  ------------
<<<<<<< HEAD
native               test_http_parser    PASSED    00:00:02.783
native               test_presentation   PASSED    00:00:01.888
native               test_session        PASSED    00:00:01.801
native               test_sse            PASSED    00:00:01.790
native               test_transport      PASSED    00:00:02.324
native               test_websocket      PASSED    00:00:02.299
native_ssh           test_ssh_auth       PASSED    00:00:02.469
native_ssh           test_ssh_channel    PASSED    00:00:02.317
native_ssh           test_ssh_crypto     PASSED    00:00:06.168
native_ssh           test_ssh_server     PASSED    00:00:02.604
native_ssh           test_ssh_transport  PASSED    00:00:02.851
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:01.114
native_ssh_conn      test_ssh_conn       PASSED    00:00:01.300
native_app           test_application    PASSED    00:00:02.425
native_app           test_auth           PASSED    00:00:02.370
native_app           test_dispatch       PASSED    00:00:02.263
native_app           test_file_serving   PASSED    00:00:02.341
native_app           test_multipart      PASSED    00:00:02.413
native_compliance    test_compliance     PASSED    00:00:01.003
================ 495 test cases: 495 succeeded in 00:00:44.521 ================
=======
native               test_sse            PASSED    00:00:10.974
native               test_session        PASSED    00:00:00.385
native               test_presentation   PASSED    00:00:00.404
native               test_transport      PASSED    00:00:00.381
native               test_websocket      PASSED    00:00:00.408
native               test_http_parser    PASSED    00:00:00.400
native_ssh           test_ssh_crypto     PASSED    00:00:02.894
native_ssh           test_ssh_auth       PASSED    00:00:00.406
native_ssh           test_ssh_server     PASSED    00:00:00.502
native_ssh           test_ssh_transport  PASSED    00:00:00.692
native_ssh           test_ssh_channel    PASSED    00:00:00.377
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.622
native_ssh_conn      test_ssh_conn       PASSED    00:00:00.820
native_app           test_multipart      PASSED    00:00:00.634
native_app           test_auth           PASSED    00:00:00.387
native_app           test_file_serving   PASSED    00:00:00.397
native_app           test_dispatch       PASSED    00:00:00.390
native_app           test_application    PASSED    00:00:00.456
native_compliance    test_compliance     PASSED    00:00:00.488
================ 495 test cases: 495 succeeded in 00:00:22.017 ================
>>>>>>> ded48b99ed5d44b46bd27c93b4e23b4cc6e95a86
```
