...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:06.130 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.528 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.546 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.544 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.569 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.546 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.557 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.551 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.535 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.547 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.549 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:00.829 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.465 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.493 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.475 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.500 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.476 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.597 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:00.785 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.569 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.570 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:02.960 |
| `test_ssh_auth`          | `native_ssh`            |    18 |   ✅   | 00:00:00.469 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.686 |
| `test_ssh_transport`     | `native_ssh`            |    27 |   ✅   | 00:00:00.892 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.443 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.727 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.047 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:00.941 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.484 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.484 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.443 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.480 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.480 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.452 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.482 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.480 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.497 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.485 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.465 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.487 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.489 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.493 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.488 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.484 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.548 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:00.970 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:00.923 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.629 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.407 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:01.644 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.652 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.625 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.617 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.583 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.549 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.592 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.546 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.533 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.557 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.541 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.534 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.737 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.621 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.666 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.632 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.545 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.536 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.539 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.530 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.551 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.547 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.542 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.558 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.563 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.530 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.537 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.550 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.543 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.540 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.534 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.538 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.590 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.545 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.548 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.542 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.540 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.540 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.548 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.541 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.532 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.550 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.547 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.557 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.563 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.546 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.561 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.546 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.531 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.541 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.562 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.723 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.542 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.545 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.541 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.556 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.565 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.565 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:00.942 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.015 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.555 |
| `test_jwt`               | `native_jwt`            |    16 |   ✅   | 00:00:00.594 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:00.896 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.552 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.554 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.550 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.579 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.586 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.559 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.540 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.577 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:00.860 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.552 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.544 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.560 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.536 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.578 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.552 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.537 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.541 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.561 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.536 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.542 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.545 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.551 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.549 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.556 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.556 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.634 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.520 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.628 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:00.859 |
...
------------ native_canopen:test_canopen [PASSED] Took 6.13 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.130
================= 17 test cases: 17 succeeded in 00:00:06.130 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
----- native_det_primitives:test_det_primitives [PASSED] Took 0.53 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.528
================== 5 test cases: 5 succeeded in 00:00:00.528 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
-------------- native_j1939:test_j1939 [PASSED] Took 0.55 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.546
...
---------- native_devicenet:test_devicenet [PASSED] Took 0.54 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.544
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.569
...
--------------- native_mbus:test_mbus [PASSED] Took 0.55 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.546
================= 11 test cases: 11 succeeded in 00:00:00.546 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.557
...
-------------- native_sdi12:test_sdi12 [PASSED] Took 0.55 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.551
...
---------------- native_dmx:test_dmx [PASSED] Took 0.53 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.535
================== 5 test cases: 5 succeeded in 00:00:00.535 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
----------- native_nmea0183:test_nmea0183 [PASSED] Took 0.55 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.547
================== 7 test cases: 7 succeeded in 00:00:00.547 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------- native_iolink:test_iolink [PASSED] Took 0.55 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.549
================== 5 test cases: 5 succeeded in 00:00:00.549 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------------ native:test_sse [PASSED] Took 0.83 seconds ------------------
...
---------------- native:test_session [PASSED] Took 0.47 seconds ----------------
...
------------- native:test_presentation [PASSED] Took 0.49 seconds --------------
...
--------------- native:test_websocket [PASSED] Took 0.50 seconds ---------------
...
-------------- native:test_http_parser [PASSED] Took 0.48 seconds --------------

=================================== SUMMARY ===================================
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:00.829
native         test_session       PASSED    00:00:00.465
native         test_presentation  PASSED    00:00:00.493
native         test_transport     PASSED    00:00:00.475
native         test_websocket     PASSED    00:00:00.500
native         test_http_parser   PASSED    00:00:00.476
================ 321 test cases: 321 succeeded in 00:00:03.237 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------ native_observability:test_observability [PASSED] Took 0.60 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.597
================= 17 test cases: 17 succeeded in 00:00:00.597 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
-------- native_accept_gate:test_accept_gate [PASSED] Took 0.79 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.785
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.569
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.570
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 2.96 seconds -------------
...
------------- native_ssh:test_ssh_auth [PASSED] Took 0.47 seconds --------------
...
------------ native_ssh:test_ssh_server [PASSED] Took 0.69 seconds -------------
...
----------- native_ssh:test_ssh_transport [PASSED] Took 0.89 seconds -----------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:02.960
native_ssh     test_ssh_auth       PASSED    00:00:00.469
native_ssh     test_ssh_server     PASSED    00:00:00.686
native_ssh     test_ssh_transport  PASSED    00:00:00.892
native_ssh     test_ssh_channel    PASSED    00:00:00.443
================ 120 test cases: 120 succeeded in 00:00:05.450 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------ native_ssh_hardened:test_ssh_hardening [PASSED] Took 0.73 seconds -------

=================================== SUMMARY ===================================
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.727
================== 2 test cases: 2 succeeded in 00:00:00.727 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.047
================== 2 test cases: 2 succeeded in 00:00:01.047 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_app:test_regex [PASSED] Took 0.94 seconds ---------------
...
------------- native_app:test_template [PASSED] Took 0.48 seconds --------------
...
--------------- native_app:test_iface [PASSED] Took 0.48 seconds ---------------
...
--------------- native_app:test_json [PASSED] Took 0.45 seconds ----------------
...
------------ native_app:test_digest_auth [PASSED] Took 0.50 seconds ------------
...
------------- native_app:test_multipart [PASSED] Took 0.49 seconds -------------
...
------------ native_app:test_application [PASSED] Took 0.55 seconds ------------

=================================== SUMMARY ===================================
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:00.941
native_app     test_template          PASSED    00:00:00.484
native_app     test_path_params       PASSED    00:00:00.484
native_app     test_digest_vectors    PASSED    00:00:00.443
native_app     test_form_params       PASSED    00:00:00.480
native_app     test_iface             PASSED    00:00:00.480
native_app     test_json              PASSED    00:00:00.452
native_app     test_response_headers  PASSED    00:00:00.482
native_app     test_middleware        PASSED    00:00:00.480
native_app     test_digest_auth       PASSED    00:00:00.497
native_app     test_web_terminal      PASSED    00:00:00.485
native_app     test_defer             PASSED    00:00:00.465
native_app     test_multipart         PASSED    00:00:00.487
native_app     test_auth              PASSED    00:00:00.489
native_app     test_file_serving      PASSED    00:00:00.493
native_app     test_dispatch          PASSED    00:00:00.488
native_app     test_chunked           PASSED    00:00:00.484
native_app     test_application       PASSED    00:00:00.548
================ 225 test cases: 225 succeeded in 00:00:09.161 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
----- native_webdav_handler:test_webdav_handler [PASSED] Took 0.97 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:00.970
================= 12 test cases: 12 succeeded in 00:00:00.970 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_diag:test_diag [PASSED] Took 0.92 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:00.923
================== 2 test cases: 2 succeeded in 00:00:00.923 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------- native_snmp:test_snmp_ber [PASSED] Took 0.63 seconds -------------
...
------------ native_snmp:test_snmp_agent [PASSED] Took 0.41 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.629
native_snmp    test_snmp_agent  PASSED    00:00:00.407
================= 35 test cases: 35 succeeded in 00:00:01.036 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 1.64 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.644
================= 15 test cases: 15 succeeded in 00:00:01.644 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------- native_telnet:test_telnet [PASSED] Took 0.65 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.652
================= 15 test cases: 15 succeeded in 00:00:00.652 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_coap:test_coap [PASSED] Took 0.63 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.625
================= 41 test cases: 41 succeeded in 00:00:00.625 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.617
================= 41 test cases: 41 succeeded in 00:00:00.617 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------- native_webdav:test_webdav [PASSED] Took 0.58 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.583
================= 19 test cases: 19 succeeded in 00:00:00.583 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.549
================= 22 test cases: 22 succeeded in 00:00:00.549 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
-------- native_cloudevents:test_cloudevents [PASSED] Took 0.59 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.592
================== 7 test cases: 7 succeeded in 00:00:00.592 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
----------- native_redis:test_redis_resp [PASSED] Took 0.55 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.546
...
-------------- native_stomp:test_stomp [PASSED] Took 0.53 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.533
================= 14 test cases: 14 succeeded in 00:00:00.533 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------ native_mqtt_sn:test_mqtt_sn [PASSED] Took 0.56 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.557
================= 13 test cases: 13 succeeded in 00:00:00.557 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.541
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.534
================= 13 test cases: 13 succeeded in 00:00:00.534 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
---------------- native_dma:test_dma [PASSED] Took 0.62 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.621
...
------------ native_forward:test_forward [PASSED] Took 0.67 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.666
================= 16 test cases: 16 succeeded in 00:00:00.666 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.632
================= 11 test cases: 11 succeeded in 00:00:00.632 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_lora:test_lora [PASSED] Took 0.54 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.545
...
-------------- native_nrf24:test_nrf24 [PASSED] Took 0.54 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.536
================= 10 test cases: 10 succeeded in 00:00:00.536 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------ native_enocean:test_enocean [PASSED] Took 0.54 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.539
================== 9 test cases: 9 succeeded in 00:00:00.539 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
-------------- native_pn532:test_pn532 [PASSED] Took 0.53 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_pn532   test_pn532  PASSED    00:00:00.530
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.551
...
-------------- native_zwave:test_zwave [PASSED] Took 0.55 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.547
================== 9 test cases: 9 succeeded in 00:00:00.547 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------- native_zigbee:test_zigbee [PASSED] Took 0.54 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_zigbee  test_zigbee  PASSED    00:00:00.542
================== 9 test cases: 9 succeeded in 00:00:00.542 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------- native_thread:test_thread [PASSED] Took 0.56 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.558
================= 13 test cases: 13 succeeded in 00:00:00.558 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_wamp:test_wamp [PASSED] Took 0.56 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.563
================= 12 test cases: 12 succeeded in 00:00:00.563 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------ native_sunspec:test_sunspec [PASSED] Took 0.53 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.530
...
------------- native_c37118:test_c37118 [PASSED] Took 0.54 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.537
================== 6 test cases: 6 succeeded in 00:00:00.537 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.550
...
------------ native_grpcweb:test_grpcweb [PASSED] Took 0.54 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.543
================== 7 test cases: 7 succeeded in 00:00:00.543 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
---------- native_lwm2m_tlv:test_lwm2m_tlv [PASSED] Took 0.54 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.540
================= 11 test cases: 11 succeeded in 00:00:00.540 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_fins:test_fins [PASSED] Took 0.53 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.534
================== 6 test cases: 6 succeeded in 00:00:00.534 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
----------- native_hostlink:test_hostlink [PASSED] Took 0.54 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.538
================== 7 test cases: 7 succeeded in 00:00:00.538 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
-------------- native_senml:test_senml [PASSED] Took 0.59 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.590
...
---------------- native_df1:test_df1 [PASSED] Took 0.54 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.545
================== 9 test cases: 9 succeeded in 00:00:00.545 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_cotp:test_cotp [PASSED] Took 0.55 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.548
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.542
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.540
================== 6 test cases: 6 succeeded in 00:00:00.540 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------- native_bacnet:test_bacnet [PASSED] Took 0.54 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.540
================== 9 test cases: 9 succeeded in 00:00:00.540 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.548
================== 6 test cases: 6 succeeded in 00:00:00.548 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.532
...
--------------- native_nats:test_nats [PASSED] Took 0.55 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.550
================= 14 test cases: 14 succeeded in 00:00:00.550 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
----- native_proxy_protocol:test_proxy_protocol [PASSED] Took 0.55 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.547
================== 8 test cases: 8 succeeded in 00:00:00.547 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.557
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.563
...
------- native_ota_rollback:test_ota_rollback [PASSED] Took 0.55 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.546
================== 5 test cases: 5 succeeded in 00:00:00.546 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_totp:test_totp [PASSED] Took 0.56 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.561
...
------------ native_webhook:test_webhook [PASSED] Took 0.55 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.546
================== 5 test cases: 5 succeeded in 00:00:00.546 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
-------- native_radio_power:test_radio_power [PASSED] Took 0.53 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.531
================== 2 test cases: 2 succeeded in 00:00:00.531 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------- native_dns_resolver:test_dns_resolver [PASSED] Took 0.54 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.541
================== 4 test cases: 4 succeeded in 00:00:00.541 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.562
================= 16 test cases: 16 succeeded in 00:00:00.562 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_oidc:test_oidc [PASSED] Took 0.72 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.723
================= 17 test cases: 17 succeeded in 00:00:00.723 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.542
================= 11 test cases: 11 succeeded in 00:00:00.542 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------ native_graphql:test_graphql [PASSED] Took 0.54 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.545
================= 32 test cases: 32 succeeded in 00:00:00.545 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------- native_espnow:test_espnow [PASSED] Took 0.54 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.541
================== 7 test cases: 7 succeeded in 00:00:00.541 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.556
...
-------------- native_opcua:test_opcua [PASSED] Took 0.57 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.565
================= 38 test cases: 38 succeeded in 00:00:00.565 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.565
================= 14 test cases: 14 succeeded in 00:00:00.565 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
---------- native_keepalive:test_keepalive [PASSED] Took 0.94 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:00.942
================= 10 test cases: 10 succeeded in 00:00:00.942 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.015
================= 13 test cases: 13 succeeded in 00:00:01.015 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------- native_syslog:test_syslog [PASSED] Took 0.56 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.555
================= 10 test cases: 10 succeeded in 00:00:00.555 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
---------------- native_jwt:test_jwt [PASSED] Took 0.59 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.594
================= 16 test cases: 16 succeeded in 00:00:00.594 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------- native_upload:test_upload [PASSED] Took 0.90 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:00.896
================== 3 test cases: 3 succeeded in 00:00:00.896 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
-------- native_http_client:test_http_client [PASSED] Took 0.55 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.552
================= 15 test cases: 15 succeeded in 00:00:00.552 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.554
================= 15 test cases: 15 succeeded in 00:00:00.554 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_mqtt:test_mqtt [PASSED] Took 0.55 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.550
================= 22 test cases: 22 succeeded in 00:00:00.550 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
---------- native_ws_client:test_ws_client [PASSED] Took 0.58 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.579
================= 16 test cases: 16 succeeded in 00:00:00.579 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------ native_scratch:test_scratch [PASSED] Took 0.59 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.586
================= 14 test cases: 14 succeeded in 00:00:00.586 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
---------- native_snmp_trap:test_snmp_trap [PASSED] Took 0.56 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.559
...
------------ native_inflate:test_inflate [PASSED] Took 0.54 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.540
================= 12 test cases: 12 succeeded in 00:00:00.540 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.577
================= 10 test cases: 10 succeeded in 00:00:00.577 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
test/test_websocket/test_websocket.cpp:1107: stress_ws_parse_max_payload [PASSED]
test/test_websocket/test_websocket.cpp:1108: stress_ws_parse_two_consecutive_frames [PASSED]
--------- native_ws_deflate:test_websocket [PASSED] Took 0.86 seconds ----------

=================================== SUMMARY ===================================
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.860
================= 71 test cases: 71 succeeded in 00:00:00.860 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
-------- native_time_source:test_time_source [PASSED] Took 0.55 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.552
================== 9 test cases: 9 succeeded in 00:00:00.552 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------- native_config_store:test_config_store [PASSED] Took 0.54 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.544
================= 14 test cases: 14 succeeded in 00:00:00.544 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.560
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.536
================= 10 test cases: 10 succeeded in 00:00:00.536 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_csrf:test_csrf [PASSED] Took 0.58 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.578
...
---------- native_telemetry:test_telemetry [PASSED] Took 0.55 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.552
================== 8 test cases: 8 succeeded in 00:00:00.552 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
---------- native_dashboard:test_dashboard [PASSED] Took 0.54 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.537
================= 15 test cases: 15 succeeded in 00:00:00.537 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------- native_net_egress:test_net_egress [PASSED] Took 0.54 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.541
================== 6 test cases: 6 succeeded in 00:00:00.541 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_cbor:test_cbor [PASSED] Took 0.54 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.536
================= 18 test cases: 18 succeeded in 00:00:00.536 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.542
================= 17 test cases: 17 succeeded in 00:00:00.542 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
----------- native_gpio_map:test_gpio_map [PASSED] Took 0.54 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.545
================== 8 test cases: 8 succeeded in 00:00:00.545 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------ native_udp_telemetry:test_udp_telemetry [PASSED] Took 0.55 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.551
================== 7 test cases: 7 succeeded in 00:00:00.551 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------- native_guardrails:test_guardrails [PASSED] Took 0.55 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.549
================== 6 test cases: 6 succeeded in 00:00:00.549 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.556
...
---------- native_config_io:test_config_io [PASSED] Took 0.56 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.556
================== 4 test cases: 4 succeeded in 00:00:00.556 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------ native_workers:test_workers [PASSED] Took 0.63 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.634
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.520
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.628
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 0.86 seconds ------------

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:00.859
================== 2 test cases: 2 succeeded in 00:00:00.859 ==================
```
