...
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.548 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.573 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.527 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.801 |
...
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.503 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.835 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.203 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:01.076 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.546 |
...
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.554 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.549 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.549 |
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.525 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.553 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.543 |
...
native               test_transport         PASSED    00:00:00.548
...
native_ssh           test_ssh_channel       PASSED    00:00:00.503
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.835
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.203
native_app           test_regex             PASSED    00:00:01.076
native_app           test_template          PASSED    00:00:00.546
...
native_app           test_middleware        PASSED    00:00:00.554
native_app           test_digest_auth       PASSED    00:00:00.549
native_app           test_web_terminal      PASSED    00:00:00.549
native_app           test_defer             PASSED    00:00:00.525
native_app           test_multipart         PASSED    00:00:00.553
native_app           test_auth              PASSED    00:00:00.543
...
================ 619 test cases: 619 succeeded in 00:00:30.262 ================
```
