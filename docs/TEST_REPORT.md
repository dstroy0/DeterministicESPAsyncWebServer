...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:02.198 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.537 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.481 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.494 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:02.102 |
| `test_crypto_kat`        | `native_crypto_kat`     |     8 |   ✅   | 00:00:01.416 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.490 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.480 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.562 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.478 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.497 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.484 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.481 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.493 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.482 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.476 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.481 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:00.800 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.400 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.428 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.443 |
| `test_websocket`         | `native`                |    68 |   ✅   | 00:00:00.461 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.429 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.620 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:00.786 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.531 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.552 |
| `test_ssh_crypto`        | `native_ssh`            |    45 |   ✅   | 00:00:02.317 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.441 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.564 |
| `test_ssh_transport`     | `native_ssh`            |    34 |   ✅   | 00:00:01.523 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.416 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.805 |
| `test_ssh_conn`          | `native_ssh_conn`       |     3 |   ✅   | 00:00:01.272 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:00.961 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.434 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.431 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.378 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.420 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.425 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.414 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.442 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.419 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.443 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.441 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.411 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.446 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.446 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.453 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.437 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.439 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.603 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.034 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.056 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.566 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.394 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:01.409 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.659 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.582 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.670 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.540 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.539 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.644 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.560 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.549 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.521 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.533 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.516 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.547 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.586 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.633 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.605 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.502 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.493 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.567 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.578 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.548 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.643 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.514 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.543 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.544 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.537 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.510 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.548 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.525 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.532 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.512 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.537 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.567 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.516 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.523 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.535 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.510 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.498 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.520 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.516 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.525 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.514 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.524 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.593 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.541 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.507 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.528 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.540 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.501 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.504 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.606 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.694 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.599 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.520 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.512 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.560 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.551 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.558 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.077 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.100 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.617 |
| `test_smtp`              | `native_smtp`           |    11 |   ✅   | 00:00:00.586 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.515 |
| `test_dns_server`        | `native_dns_server`     |     7 |   ✅   | 00:00:00.531 |
| `test_rtc`               | `native_rtc`            |     8 |   ✅   | 00:00:00.525 |
| `test_ld2410`            | `native_ld2410`         |     7 |   ✅   | 00:00:00.572 |
| `test_mpr121`            | `native_mpr121`         |     5 |   ✅   | 00:00:00.527 |
| `test_sht3x`             | `native_sht3x`          |     5 |   ✅   | 00:00:00.600 |
| `test_pca9685`           | `native_pca9685`        |     4 |   ✅   | 00:00:00.538 |
| `test_ads1115`           | `native_ads1115`        |     3 |   ✅   | 00:00:00.575 |
| `test_ina219`            | `native_ina219`         |     4 |   ✅   | 00:00:00.508 |
| `test_hpack`             | `native_hpack`          |     7 |   ✅   | 00:00:00.605 |
| `test_h2_frame`          | `native_h2frame`        |     6 |   ✅   | 00:00:00.538 |
| `test_h2_conn`           | `native_h2conn`         |     4 |   ✅   | 00:00:00.699 |
| `test_quic_varint`       | `native_quic_varint`    |     3 |   ✅   | 00:00:00.531 |
| `test_h3_frame`          | `native_h3frame`        |     7 |   ✅   | 00:00:00.566 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.546 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:00.900 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.497 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.506 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.488 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.529 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.508 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.501 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.521 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.538 |
| `test_ssh_zlib`          | `native_ssh_zlib`       |     9 |   ✅   | 00:00:00.546 |
| `test_ssh_comp`          | `native_ssh_comp`       |     5 |   ✅   | 00:00:00.890 |
| `test_websocket`         | `native_ws_deflate`     |    72 |   ✅   | 00:00:00.849 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.513 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.491 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.559 |
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.504 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.541 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.509 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.494 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.479 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.553 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.537 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.496 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.611 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.500 |
| `test_statsd`            | `native_statsd`         |     9 |   ✅   | 00:00:00.519 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.500 |
| `test_failsafe`          | `native_failsafe`       |     6 |   ✅   | 00:00:00.592 |
| `test_sleep_sched`       | `native_sleep_sched`    |     8 |   ✅   | 00:00:00.573 |
| `test_wearlevel`         | `native_wearlevel`      |     5 |   ✅   | 00:00:00.478 |
| `test_netadapt`          | `native_netadapt`       |     6 |   ✅   | 00:00:00.467 |
| `test_dshot`             | `native_dshot`          |     7 |   ✅   | 00:00:00.584 |
| `test_hart`              | `native_hart`           |     6 |   ✅   | 00:00:00.494 |
| `test_nts`               | `native_nts`            |     4 |   ✅   | 00:00:00.483 |
| `test_dds`               | `native_dds`            |     4 |   ✅   | 00:00:00.494 |
| `test_xmpp`              | `native_xmpp`           |     6 |   ✅   | 00:00:00.551 |
| `test_rawl2`             | `native_rawl2`          |     4 |   ✅   | 00:00:00.471 |
| `test_spa_router`        | `native_spa_router`     |     2 |   ✅   | 00:00:00.480 |
| `test_goose`             | `native_goose`          |     3 |   ✅   | 00:00:00.547 |
| `test_mtconnect`         | `native_mtconnect`      |     4 |   ✅   | 00:00:00.477 |
| `test_j2735`             | `native_j2735`          |     9 |   ✅   | 00:00:00.486 |
| `test_nema_ts2`          | `native_nema_ts2`       |     4 |   ✅   | 00:00:00.500 |
| `test_snp`               | `native_snp`            |     4 |   ✅   | 00:00:00.496 |
| `test_directnet`         | `native_directnet`      |     4 |   ✅   | 00:00:00.480 |
| `test_sep2`              | `native_sep2`           |     5 |   ✅   | 00:00:00.483 |
| `test_profinet`          | `native_profinet`       |     4 |   ✅   | 00:00:00.488 |
| `test_ntcip`             | `native_ntcip`          |     3 |   ✅   | 00:00:00.531 |
| `test_openadr`           | `native_openadr`        |     4 |   ✅   | 00:00:00.495 |
| `test_mms`               | `native_mms`            |     4 |   ✅   | 00:00:00.481 |
| `test_cclink`            | `native_cclink`         |     4 |   ✅   | 00:00:00.525 |
| `test_powerlink`         | `native_powerlink`      |     3 |   ✅   | 00:00:00.551 |
| `test_sercos`            | `native_sercos`         |     3 |   ✅   | 00:00:00.503 |
| `test_profibus`          | `native_profibus`       |     4 |   ✅   | 00:00:00.500 |
| `test_lonworks`          | `native_lonworks`       |     4 |   ✅   | 00:00:00.490 |
| `test_mbplus`            | `native_mbplus`         |     5 |   ✅   | 00:00:00.490 |
| `test_interbus`          | `native_interbus`       |     4 |   ✅   | 00:00:00.491 |
| `test_iccp`              | `native_iccp`           |     4 |   ✅   | 00:00:00.510 |
| `test_wave`              | `native_wave`           |     4 |   ✅   | 00:00:00.492 |
| `test_utmc`              | `native_utmc`           |     5 |   ✅   | 00:00:00.575 |
| `test_ocit`              | `native_ocit`           |     4 |   ✅   | 00:00:00.480 |
| `test_atc`               | `native_atc`            |     4 |   ✅   | 00:00:00.496 |
| `test_southbound`        | `native_southbound`     |     5 |   ✅   | 00:00:00.494 |
| `test_exc_decoder`       | `native_exc_decoder`    |     5 |   ✅   | 00:00:00.510 |
| `test_http_delivery`     | `native_http_delivery`  |     6 |   ✅   | 00:00:00.497 |
| `test_hw_health`         | `native_hw_health`      |     5 |   ✅   | 00:00:00.837 |
| `test_mdns_adaptive`     | `native_mdns_adaptive`  |     4 |   ✅   | 00:00:00.488 |
| `test_sockpool`          | `native_sockpool`       |     5 |   ✅   | 00:00:00.484 |
| `test_psram_pool`        | `native_psram_pool`     |     5 |   ✅   | 00:00:00.506 |
| `test_happy_eyeballs`    | `native_happy_eyeballs` |     4 |   ✅   | 00:00:00.522 |
| `test_wifi_sniffer`      | `native_wifi_sniffer`   |     5 |   ✅   | 00:00:00.497 |
| `test_link_manager`      | `native_link_manager`   |     4 |   ✅   | 00:00:00.530 |
| `test_cc1101`            | `native_cc1101`         |    10 |   ✅   | 00:00:00.486 |
| `test_fdc2214`           | `native_fdc2214`        |     4 |   ✅   | 00:00:00.480 |
| `test_ldc1614`           | `native_ldc1614`        |     4 |   ✅   | 00:00:00.550 |
| `test_vl53l0x`           | `native_vl53l0x`        |     3 |   ✅   | 00:00:00.520 |
| `test_radio_sniff`       | `native_radio_sniff`    |     4 |   ✅   | 00:00:00.524 |
| `test_ble_gatt`          | `native_ble_gatt`       |     4 |   ✅   | 00:00:00.531 |
| `test_tls_policy`        | `native_tls_policy`     |     4 |   ✅   | 00:00:00.473 |
| `test_wisun`             | `native_wisun`          |     6 |   ✅   | 00:00:00.531 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.504 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.520 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.602 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.467 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.651 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:00.692 |
| `test_qpack`             | `native_qpack`          |     9 |   ✅   | 00:00:00.544 |
| `test_quic_packet`       | `native_quic_packet`    |     8 |   ✅   | 00:00:00.486 |
| `test_quic_frame`        | `native_quic_frame`     |     8 |   ✅   | 00:00:00.514 |
| `test_quic_crypto`       | `native_quic_crypto`    |     7 |   ✅   | 00:00:00.580 |
| `test_tls13_kdf`         | `native_tls13_kdf`      |     5 |   ✅   | 00:00:00.609 |
| `test_quic_tp`           | `native_quic_tp`        |     7 |   ✅   | 00:00:00.642 |
| `test_tls13_msg`         | `native_tls13_msg`      |     7 |   ✅   | 00:00:00.555 |
| `test_quic_tls`          | `native_quic_tls`       |    11 |   ✅   | 00:00:00.757 |
| `test_quic_conn`         | `native_quic_conn`      |     4 |   ✅   | 00:00:00.776 |
| `test_h3_conn`           | `native_h3_conn`        |    11 |   ✅   | 00:00:00.774 |
| `test_h3_e2e`            | `native_h3_e2e`         |     1 |   ✅   | 00:00:00.813 |
| `test_quic_server`       | `native_quic_server`    |     2 |   ✅   | 00:00:00.831 |
| `test_h3_server`         | `native_h3_server`      |     1 |   ✅   | 00:00:01.289 |
| `test_ssh_chachapoly`    | `native_ssh_chachapoly` |     4 |   ✅   | 00:00:00.523 |
...
native_canopen:test_canopen Took 2.20 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:02.198
================= 17 test cases: 17 succeeded in 00:00:02.198 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_det_primitives:test_det_primitives Took 0.54 seconds --------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.537
================== 5 test cases: 5 succeeded in 00:00:00.537 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_det_ip:test_det_ip Took 0.48 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.481
================= 10 test cases: 10 succeeded in 00:00:00.481 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_det_arena:test_det_arena Took 0.49 seconds ------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_det_arena  test_det_arena  PASSED    00:00:00.494
================= 17 test cases: 17 succeeded in 00:00:00.494 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_ssh_ed25519:test_ssh_ed25519 Took 2.10 seconds --------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:02.102
================= 16 test cases: 16 succeeded in 00:00:02.102 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_crypto_kat:test_crypto_kat Took 1.42 seconds ----------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_crypto_kat  test_crypto_kat  PASSED    00:00:01.416
================== 8 test cases: 8 succeeded in 00:00:01.416 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_promisc:test_promisc Took 0.49 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.490
================== 8 test cases: 8 succeeded in 00:00:00.490 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_bus_capture:test_bus_capture Took 0.48 seconds --------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.480
================== 5 test cases: 5 succeeded in 00:00:00.480 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_j1939:test_j1939 Took 0.56 seconds --------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.562
================== 9 test cases: 9 succeeded in 00:00:00.562 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_devicenet:test_devicenet Took 0.48 seconds ------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.478
================== 8 test cases: 8 succeeded in 00:00:00.478 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_nmea2000:test_nmea2000 Took 0.50 seconds --------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.497
================== 6 test cases: 6 succeeded in 00:00:00.497 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_mbus:test_mbus Took 0.48 seconds ----------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.484
================= 11 test cases: 11 succeeded in 00:00:00.484 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_iec60870:test_iec60870 Took 0.48 seconds --------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.481
================== 8 test cases: 8 succeeded in 00:00:00.481 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_sdi12:test_sdi12 Took 0.49 seconds --------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.493
================== 6 test cases: 6 succeeded in 00:00:00.493 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_dmx:test_dmx Took 0.48 seconds ------------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.482
================== 5 test cases: 5 succeeded in 00:00:00.482 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_nmea0183:test_nmea0183 Took 0.48 seconds --------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.476
================== 7 test cases: 7 succeeded in 00:00:00.476 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_iolink:test_iolink Took 0.48 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.481
================== 5 test cases: 5 succeeded in 00:00:00.481 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native:test_sse Took 0.80 seconds ----------------------------------------------------------------------------- [PASSED]
...
native:test_session Took 0.40 seconds ------------------------------------------------------------------------- [PASSED]
...
native:test_presentation Took 0.43 seconds -------------------------------------------------------------------- [PASSED]
...
native:test_transport Took 0.44 seconds ----------------------------------------------------------------------- [PASSED]
...
native:test_websocket Took 0.46 seconds ----------------------------------------------------------------------- [PASSED]
...
native:test_http_parser Took 0.43 seconds --------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:00.800
native         test_session       PASSED    00:00:00.400
native         test_presentation  PASSED    00:00:00.428
native         test_transport     PASSED    00:00:00.443
native         test_websocket     PASSED    00:00:00.461
native         test_http_parser   PASSED    00:00:00.429
================ 324 test cases: 324 succeeded in 00:00:02.961 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_observability:test_observability Took 0.62 seconds ----------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.620
================= 17 test cases: 17 succeeded in 00:00:00.620 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_accept_gate:test_accept_gate Took 0.79 seconds --------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.786
================= 13 test cases: 13 succeeded in 00:00:00.786 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_ota:test_http_ota Took 0.53 seconds -------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.531
================== 3 test cases: 3 succeeded in 00:00:00.531 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_prov:test_provisioning Took 0.55 seconds --------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.552
================== 5 test cases: 5 succeeded in 00:00:00.552 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_ssh:test_ssh_crypto Took 2.32 seconds ------------------------------------------------------------------ [PASSED]
...
native_ssh:test_ssh_auth Took 0.44 seconds -------------------------------------------------------------------- [PASSED]
...
native_ssh:test_ssh_server Took 0.56 seconds ------------------------------------------------------------------ [PASSED]
...
native_ssh:test_ssh_transport Took 1.52 seconds --------------------------------------------------------------- [PASSED]
...
native_ssh:test_ssh_channel Took 0.42 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:02.317
native_ssh     test_ssh_auth       PASSED    00:00:00.441
native_ssh     test_ssh_server     PASSED    00:00:00.564
native_ssh     test_ssh_transport  PASSED    00:00:01.523
native_ssh     test_ssh_channel    PASSED    00:00:00.416
================ 146 test cases: 146 succeeded in 00:00:05.261 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_ssh_hardened:test_ssh_hardening Took 0.81 seconds ------------------------------------------------------ [PASSED]

=================================== SUMMARY ===================================
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.805
================== 2 test cases: 2 succeeded in 00:00:00.805 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_ssh_conn:test_ssh_conn Took 1.27 seconds --------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.272
================== 3 test cases: 3 succeeded in 00:00:01.272 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_app:test_regex Took 0.96 seconds ----------------------------------------------------------------------- [PASSED]
...
native_app:test_template Took 0.43 seconds -------------------------------------------------------------------- [PASSED]
...
native_app:test_path_params Took 0.43 seconds ----------------------------------------------------------------- [PASSED]
...
native_app:test_digest_vectors Took 0.38 seconds -------------------------------------------------------------- [PASSED]
...
native_app:test_form_params Took 0.42 seconds ----------------------------------------------------------------- [PASSED]
...
native_app:test_iface Took 0.43 seconds ----------------------------------------------------------------------- [PASSED]
...
native_app:test_json Took 0.41 seconds ------------------------------------------------------------------------ [PASSED]
...
native_app:test_response_headers Took 0.44 seconds ------------------------------------------------------------ [PASSED]
...
native_app:test_middleware Took 0.42 seconds ------------------------------------------------------------------ [PASSED]
...
native_app:test_digest_auth Took 0.44 seconds ----------------------------------------------------------------- [PASSED]
...
native_app:test_web_terminal Took 0.44 seconds ---------------------------------------------------------------- [PASSED]
...
native_app:test_defer Took 0.41 seconds ----------------------------------------------------------------------- [PASSED]
...
native_app:test_multipart Took 0.45 seconds ------------------------------------------------------------------- [PASSED]
...
native_app:test_auth Took 0.45 seconds ------------------------------------------------------------------------ [PASSED]
...
native_app:test_file_serving Took 0.45 seconds ---------------------------------------------------------------- [PASSED]
...
native_app:test_dispatch Took 0.44 seconds -------------------------------------------------------------------- [PASSED]
...
native_app:test_chunked Took 0.44 seconds --------------------------------------------------------------------- [PASSED]
...
native_app:test_application Took 0.60 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:00.961
native_app     test_template          PASSED    00:00:00.434
native_app     test_path_params       PASSED    00:00:00.431
native_app     test_digest_vectors    PASSED    00:00:00.378
native_app     test_form_params       PASSED    00:00:00.420
native_app     test_iface             PASSED    00:00:00.425
native_app     test_json              PASSED    00:00:00.414
native_app     test_response_headers  PASSED    00:00:00.442
native_app     test_middleware        PASSED    00:00:00.419
native_app     test_digest_auth       PASSED    00:00:00.443
native_app     test_web_terminal      PASSED    00:00:00.441
native_app     test_defer             PASSED    00:00:00.411
native_app     test_multipart         PASSED    00:00:00.446
native_app     test_auth              PASSED    00:00:00.446
native_app     test_file_serving      PASSED    00:00:00.453
native_app     test_dispatch          PASSED    00:00:00.437
native_app     test_chunked           PASSED    00:00:00.439
native_app     test_application       PASSED    00:00:00.603
================ 225 test cases: 225 succeeded in 00:00:08.443 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_webdav_handler:test_webdav_handler Took 1.03 seconds --------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.034
================= 12 test cases: 12 succeeded in 00:00:01.034 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_diag:test_diag Took 1.06 seconds ----------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.056
================== 2 test cases: 2 succeeded in 00:00:01.056 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_snmp:test_snmp_ber Took 0.57 seconds ------------------------------------------------------------------- [PASSED]
...
native_snmp:test_snmp_agent Took 0.39 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.566
native_snmp    test_snmp_agent  PASSED    00:00:00.394
================= 35 test cases: 35 succeeded in 00:00:00.960 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_snmp_v3:test_snmp_v3 Took 1.41 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.409
================= 15 test cases: 15 succeeded in 00:00:01.409 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_telnet:test_telnet Took 0.66 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.659
...
native_coap:test_coap Took 0.58 seconds ----------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.582
================= 41 test cases: 41 succeeded in 00:00:00.582 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
test/test_coap/test_coap.cpp:1076: test_well_known_core_discovery                                               [PASSED]
test/test_coap/test_coap.cpp:1077: test_well_known_core_rejects_post                                            [PASSED]
native_coap_observe:test_coap Took 0.67 seconds --------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.670
================= 41 test cases: 41 succeeded in 00:00:00.670 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_webdav:test_webdav Took 0.54 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.540
================= 19 test cases: 19 succeeded in 00:00:00.540 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_modbus:test_modbus Took 0.54 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.539
================= 22 test cases: 22 succeeded in 00:00:00.539 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_cloudevents:test_cloudevents Took 0.64 seconds --------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.644
...
native_redis:test_redis_resp Took 0.56 seconds ---------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.560
================== 8 test cases: 8 succeeded in 00:00:00.560 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_stomp:test_stomp Took 0.55 seconds --------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.549
================= 14 test cases: 14 succeeded in 00:00:00.549 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_mqtt_sn:test_mqtt_sn Took 0.52 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.521
================= 13 test cases: 13 succeeded in 00:00:00.521 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_flow_export:test_flow_export Took 0.53 seconds --------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.533
================== 6 test cases: 6 succeeded in 00:00:00.533 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_protobuf:test_protobuf Took 0.52 seconds --------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.516
================= 13 test cases: 13 succeeded in 00:00:00.516 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_preempt_queue:test_preempt_queue Took 0.55 seconds ----------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.547
================= 11 test cases: 11 succeeded in 00:00:00.547 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_dma:test_dma Took 0.59 seconds ------------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.586
================= 11 test cases: 11 succeeded in 00:00:00.586 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_forward:test_forward Took 0.63 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.633
================= 16 test cases: 16 succeeded in 00:00:00.633 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_gateway:test_gateway Took 0.61 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.605
================= 11 test cases: 11 succeeded in 00:00:00.605 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_lora:test_lora Took 0.50 seconds ----------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.502
================= 13 test cases: 13 succeeded in 00:00:00.502 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_nrf24:test_nrf24 Took 0.49 seconds --------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.493
================= 10 test cases: 10 succeeded in 00:00:00.493 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_enocean:test_enocean Took 0.57 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.567
================== 9 test cases: 9 succeeded in 00:00:00.567 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_pn532:test_pn532 Took 0.58 seconds --------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_pn532   test_pn532  PASSED    00:00:00.578
================= 10 test cases: 10 succeeded in 00:00:00.578 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_sigfox:test_sigfox Took 0.55 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.548
================== 7 test cases: 7 succeeded in 00:00:00.548 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_zwave:test_zwave Took 0.64 seconds --------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.643
...
native_zigbee:test_zigbee Took 0.51 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_zigbee  test_zigbee  PASSED    00:00:00.514
================== 9 test cases: 9 succeeded in 00:00:00.514 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_thread:test_thread Took 0.54 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.543
================= 13 test cases: 13 succeeded in 00:00:00.543 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_wamp:test_wamp Took 0.54 seconds ----------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.544
================= 12 test cases: 12 succeeded in 00:00:00.544 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_sunspec:test_sunspec Took 0.54 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.537
================== 5 test cases: 5 succeeded in 00:00:00.537 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_c37118:test_c37118 Took 0.51 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.510
================== 6 test cases: 6 succeeded in 00:00:00.510 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_dnp3:test_dnp3 Took 0.55 seconds ----------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.548
================== 8 test cases: 8 succeeded in 00:00:00.548 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_grpcweb:test_grpcweb Took 0.53 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.525
================== 7 test cases: 7 succeeded in 00:00:00.525 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_lwm2m_tlv:test_lwm2m_tlv Took 0.53 seconds ------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.532
================= 11 test cases: 11 succeeded in 00:00:00.532 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_fins:test_fins Took 0.51 seconds ----------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.512
================== 6 test cases: 6 succeeded in 00:00:00.512 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_hostlink:test_hostlink Took 0.54 seconds --------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.537
================== 7 test cases: 7 succeeded in 00:00:00.537 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_senml:test_senml Took 0.57 seconds --------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.567
================== 9 test cases: 9 succeeded in 00:00:00.567 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_df1:test_df1 Took 0.52 seconds ------------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.516
...
native_cotp:test_cotp Took 0.52 seconds ----------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.523
================== 6 test cases: 6 succeeded in 00:00:00.523 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_s7comm:test_s7comm Took 0.53 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.535
================== 8 test cases: 8 succeeded in 00:00:00.535 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_melsec:test_melsec Took 0.51 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.510
================== 6 test cases: 6 succeeded in 00:00:00.510 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_bacnet:test_bacnet Took 0.50 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.498
================== 9 test cases: 9 succeeded in 00:00:00.498 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_enip:test_enip Took 0.52 seconds ----------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.520
================== 6 test cases: 6 succeeded in 00:00:00.520 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_amqp:test_amqp Took 0.52 seconds ----------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.516
================== 7 test cases: 7 succeeded in 00:00:00.516 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_cip:test_cip Took 0.53 seconds ------------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.525
================== 9 test cases: 9 succeeded in 00:00:00.525 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_nats:test_nats Took 0.51 seconds ----------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.514
================= 14 test cases: 14 succeeded in 00:00:00.514 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_proxy_protocol:test_proxy_protocol Took 0.52 seconds --------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.524
================== 8 test cases: 8 succeeded in 00:00:00.524 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_sparkplug:test_sparkplug Took 0.59 seconds ------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.593
================== 7 test cases: 7 succeeded in 00:00:00.593 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_modbus_master:test_modbus_master Took 0.54 seconds ----------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.541
================== 5 test cases: 5 succeeded in 00:00:00.541 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_ota_rollback:test_ota_rollback Took 0.51 seconds ------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.507
================== 5 test cases: 5 succeeded in 00:00:00.507 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_totp:test_totp Took 0.53 seconds ----------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.528
================== 4 test cases: 4 succeeded in 00:00:00.528 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_webhook:test_webhook Took 0.54 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.540
================== 5 test cases: 5 succeeded in 00:00:00.540 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_radio_power:test_radio_power Took 0.50 seconds --------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.501
================== 2 test cases: 2 succeeded in 00:00:00.501 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_dns_resolver:test_dns_resolver Took 0.50 seconds ------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.504
================== 4 test cases: 4 succeeded in 00:00:00.504 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_audit_log:test_audit_log Took 0.61 seconds ------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.606
================= 16 test cases: 16 succeeded in 00:00:00.606 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_oidc:test_oidc Took 0.69 seconds ----------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.694
================= 17 test cases: 17 succeeded in 00:00:00.694 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_vfs:test_vfs Took 0.60 seconds ------------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.599
================= 11 test cases: 11 succeeded in 00:00:00.599 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_graphql:test_graphql Took 0.52 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.520
================= 32 test cases: 32 succeeded in 00:00:00.520 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_espnow:test_espnow Took 0.51 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.512
================== 7 test cases: 7 succeeded in 00:00:00.512 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_oauth2:test_oauth2 Took 0.56 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.560
================== 8 test cases: 8 succeeded in 00:00:00.560 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_opcua:test_opcua Took 0.55 seconds --------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.551
================= 38 test cases: 38 succeeded in 00:00:00.551 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_opcua_client:test_opcua_client Took 0.56 seconds ------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.558
================= 14 test cases: 14 succeeded in 00:00:00.558 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_keepalive:test_keepalive Took 1.08 seconds ------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.077
================= 10 test cases: 10 succeeded in 00:00:01.077 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_range:test_range Took 1.10 seconds --------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.100
================= 13 test cases: 13 succeeded in 00:00:01.100 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_syslog:test_syslog Took 0.62 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.617
================= 10 test cases: 10 succeeded in 00:00:00.617 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_smtp:test_smtp Took 0.59 seconds ----------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_smtp    test_smtp  PASSED    00:00:00.586
================= 11 test cases: 11 succeeded in 00:00:00.586 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_ntp_server:test_ntp_server Took 0.52 seconds ----------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_ntp_server  test_ntp_server  PASSED    00:00:00.515
================== 8 test cases: 8 succeeded in 00:00:00.515 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_dns_server:test_dns_server Took 0.53 seconds ----------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_dns_server  test_dns_server  PASSED    00:00:00.531
================== 7 test cases: 7 succeeded in 00:00:00.531 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_rtc:test_rtc Took 0.53 seconds ------------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_rtc     test_rtc  PASSED    00:00:00.525
================== 8 test cases: 8 succeeded in 00:00:00.525 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_ld2410:test_ld2410 Took 0.57 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ld2410  test_ld2410  PASSED    00:00:00.572
================== 7 test cases: 7 succeeded in 00:00:00.572 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_mpr121:test_mpr121 Took 0.53 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_mpr121  test_mpr121  PASSED    00:00:00.527
================== 5 test cases: 5 succeeded in 00:00:00.527 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_sht3x:test_sht3x Took 0.60 seconds --------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sht3x   test_sht3x  PASSED    00:00:00.600
================== 5 test cases: 5 succeeded in 00:00:00.600 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_pca9685:test_pca9685 Took 0.54 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_pca9685  test_pca9685  PASSED    00:00:00.538
================== 4 test cases: 4 succeeded in 00:00:00.538 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_ads1115:test_ads1115 Took 0.58 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_ads1115  test_ads1115  PASSED    00:00:00.575
================== 3 test cases: 3 succeeded in 00:00:00.575 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_ina219:test_ina219 Took 0.51 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ina219  test_ina219  PASSED    00:00:00.508
================== 4 test cases: 4 succeeded in 00:00:00.508 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_hpack:test_hpack Took 0.60 seconds --------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_hpack   test_hpack  PASSED    00:00:00.605
================== 7 test cases: 7 succeeded in 00:00:00.605 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_h2frame:test_h2_frame Took 0.54 seconds ---------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h2frame  test_h2_frame  PASSED    00:00:00.538
================== 6 test cases: 6 succeeded in 00:00:00.538 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_h2conn:test_h2_conn Took 0.70 seconds ------------------------------------------------------------------ [PASSED]

=================================== SUMMARY ===================================
Environment    Test          Status    Duration
-------------  ------------  --------  ------------
native_h2conn  test_h2_conn  PASSED    00:00:00.699
...
native_quic_varint:test_quic_varint Took 0.53 seconds --------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_varint  test_quic_varint  PASSED    00:00:00.531
================== 3 test cases: 3 succeeded in 00:00:00.531 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_h3frame:test_h3_frame Took 0.57 seconds ---------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h3frame  test_h3_frame  PASSED    00:00:00.566
================== 7 test cases: 7 succeeded in 00:00:00.566 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_jwt:test_jwt Took 0.55 seconds ------------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.546
================= 21 test cases: 21 succeeded in 00:00:00.546 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_upload:test_upload Took 0.90 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:00.900
================== 3 test cases: 3 succeeded in 00:00:00.900 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_http_client:test_http_client Took 0.50 seconds --------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.497
================= 15 test cases: 15 succeeded in 00:00:00.497 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_compliance:test_compliance Took 0.51 seconds ----------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.506
================= 15 test cases: 15 succeeded in 00:00:00.506 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_mqtt:test_mqtt Took 0.49 seconds ----------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.488
================= 22 test cases: 22 succeeded in 00:00:00.488 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_ws_client:test_ws_client Took 0.53 seconds ------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.529
================= 16 test cases: 16 succeeded in 00:00:00.529 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_scratch:test_scratch Took 0.51 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.508
================= 14 test cases: 14 succeeded in 00:00:00.508 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_snmp_trap:test_snmp_trap Took 0.50 seconds ------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.501
================== 7 test cases: 7 succeeded in 00:00:00.501 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_inflate:test_inflate Took 0.52 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.521
================= 12 test cases: 12 succeeded in 00:00:00.521 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_deflate:test_deflate Took 0.54 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.538
================= 10 test cases: 10 succeeded in 00:00:00.538 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_ssh_zlib:test_ssh_zlib Took 0.55 seconds --------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_zlib  test_ssh_zlib  PASSED    00:00:00.546
================== 9 test cases: 9 succeeded in 00:00:00.546 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_ssh_comp:test_ssh_comp Took 0.89 seconds --------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_comp  test_ssh_comp  PASSED    00:00:00.890
================== 5 test cases: 5 succeeded in 00:00:00.890 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
test/test_websocket/test_websocket.cpp:1149: stress_ws_parse_max_payload                                        [PASSED]
test/test_websocket/test_websocket.cpp:1150: stress_ws_parse_two_consecutive_frames                             [PASSED]
native_ws_deflate:test_websocket Took 0.85 seconds ------------------------------------------------------------ [PASSED]

=================================== SUMMARY ===================================
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.849
================= 72 test cases: 72 succeeded in 00:00:00.849 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_time_source:test_time_source Took 0.51 seconds --------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.513
================== 9 test cases: 9 succeeded in 00:00:00.513 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_config_store:test_config_store Took 0.49 seconds ------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.491
================= 14 test cases: 14 succeeded in 00:00:00.491 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_device_id:test_device_id Took 0.56 seconds ------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.559
================== 4 test cases: 4 succeeded in 00:00:00.559 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_auth_lockout:test_auth_lockout Took 0.50 seconds ------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.504
================= 11 test cases: 11 succeeded in 00:00:00.504 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_csrf:test_csrf Took 0.54 seconds ----------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.541
================== 9 test cases: 9 succeeded in 00:00:00.541 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_telemetry:test_telemetry Took 0.51 seconds ------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.509
================== 8 test cases: 8 succeeded in 00:00:00.509 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_dashboard:test_dashboard Took 0.49 seconds ------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.494
================= 15 test cases: 15 succeeded in 00:00:00.494 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_net_egress:test_net_egress Took 0.48 seconds ----------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.479
================== 6 test cases: 6 succeeded in 00:00:00.479 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_partition:test_partition_monitor Took 0.55 seconds ----------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.553
================== 5 test cases: 5 succeeded in 00:00:00.553 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_cbor:test_cbor Took 0.54 seconds ----------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.537
================= 18 test cases: 18 succeeded in 00:00:00.537 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_msgpack:test_msgpack Took 0.50 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.496
================= 17 test cases: 17 succeeded in 00:00:00.496 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_gpio_map:test_gpio_map Took 0.61 seconds --------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.611
================== 8 test cases: 8 succeeded in 00:00:00.611 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_udp_telemetry:test_udp_telemetry Took 0.50 seconds ----------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.500
================== 7 test cases: 7 succeeded in 00:00:00.500 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_statsd:test_statsd Took 0.52 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_statsd  test_statsd  PASSED    00:00:00.519
================== 9 test cases: 9 succeeded in 00:00:00.519 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_guardrails:test_guardrails Took 0.50 seconds ----------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.500
================== 6 test cases: 6 succeeded in 00:00:00.500 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_failsafe:test_failsafe Took 0.59 seconds --------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_failsafe  test_failsafe  PASSED    00:00:00.592
================== 6 test cases: 6 succeeded in 00:00:00.592 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_sleep_sched:test_sleep_sched Took 0.57 seconds --------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_sleep_sched  test_sleep_sched  PASSED    00:00:00.573
================== 8 test cases: 8 succeeded in 00:00:00.573 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_wearlevel:test_wearlevel Took 0.48 seconds ------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_wearlevel  test_wearlevel  PASSED    00:00:00.478
================== 5 test cases: 5 succeeded in 00:00:00.478 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_netadapt:test_netadapt Took 0.47 seconds --------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_netadapt  test_netadapt  PASSED    00:00:00.467
================== 6 test cases: 6 succeeded in 00:00:00.467 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_dshot:test_dshot Took 0.58 seconds --------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_dshot   test_dshot  PASSED    00:00:00.584
================== 7 test cases: 7 succeeded in 00:00:00.584 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_hart:test_hart Took 0.49 seconds ----------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_hart    test_hart  PASSED    00:00:00.494
================== 6 test cases: 6 succeeded in 00:00:00.494 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_nts:test_nts Took 0.48 seconds ------------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_nts     test_nts  PASSED    00:00:00.483
================== 4 test cases: 4 succeeded in 00:00:00.483 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_dds:test_dds Took 0.49 seconds ------------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dds     test_dds  PASSED    00:00:00.494
================== 4 test cases: 4 succeeded in 00:00:00.494 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_xmpp:test_xmpp Took 0.55 seconds ----------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_xmpp    test_xmpp  PASSED    00:00:00.551
================== 6 test cases: 6 succeeded in 00:00:00.551 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_rawl2:test_rawl2 Took 0.47 seconds --------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_rawl2   test_rawl2  PASSED    00:00:00.471
================== 4 test cases: 4 succeeded in 00:00:00.471 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_spa_router:test_spa_router Took 0.48 seconds ----------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_spa_router  test_spa_router  PASSED    00:00:00.480
================== 2 test cases: 2 succeeded in 00:00:00.480 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_goose:test_goose Took 0.55 seconds --------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_goose   test_goose  PASSED    00:00:00.547
================== 3 test cases: 3 succeeded in 00:00:00.547 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_mtconnect:test_mtconnect Took 0.48 seconds ------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_mtconnect  test_mtconnect  PASSED    00:00:00.477
================== 4 test cases: 4 succeeded in 00:00:00.477 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_j2735:test_j2735 Took 0.49 seconds --------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j2735   test_j2735  PASSED    00:00:00.486
================== 9 test cases: 9 succeeded in 00:00:00.486 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_nema_ts2:test_nema_ts2 Took 0.50 seconds --------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nema_ts2  test_nema_ts2  PASSED    00:00:00.500
================== 4 test cases: 4 succeeded in 00:00:00.500 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_snp:test_snp Took 0.50 seconds ------------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_snp     test_snp  PASSED    00:00:00.496
================== 4 test cases: 4 succeeded in 00:00:00.496 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_directnet:test_directnet Took 0.48 seconds ------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_directnet  test_directnet  PASSED    00:00:00.480
================== 4 test cases: 4 succeeded in 00:00:00.480 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_sep2:test_sep2 Took 0.48 seconds ----------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_sep2    test_sep2  PASSED    00:00:00.483
================== 5 test cases: 5 succeeded in 00:00:00.483 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_profinet:test_profinet Took 0.49 seconds --------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_profinet  test_profinet  PASSED    00:00:00.488
================== 4 test cases: 4 succeeded in 00:00:00.488 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_ntcip:test_ntcip Took 0.53 seconds --------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_ntcip   test_ntcip  PASSED    00:00:00.531
================== 3 test cases: 3 succeeded in 00:00:00.531 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_openadr:test_openadr Took 0.49 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_openadr  test_openadr  PASSED    00:00:00.495
================== 4 test cases: 4 succeeded in 00:00:00.495 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_mms:test_mms Took 0.48 seconds ------------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_mms     test_mms  PASSED    00:00:00.481
================== 4 test cases: 4 succeeded in 00:00:00.481 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_cclink:test_cclink Took 0.52 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_cclink  test_cclink  PASSED    00:00:00.525
================== 4 test cases: 4 succeeded in 00:00:00.525 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_powerlink:test_powerlink Took 0.55 seconds ------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_powerlink  test_powerlink  PASSED    00:00:00.551
================== 3 test cases: 3 succeeded in 00:00:00.551 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_sercos:test_sercos Took 0.50 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sercos  test_sercos  PASSED    00:00:00.503
================== 3 test cases: 3 succeeded in 00:00:00.503 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_profibus:test_profibus Took 0.50 seconds --------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_profibus  test_profibus  PASSED    00:00:00.500
================== 4 test cases: 4 succeeded in 00:00:00.500 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_lonworks:test_lonworks Took 0.49 seconds --------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_lonworks  test_lonworks  PASSED    00:00:00.490
================== 4 test cases: 4 succeeded in 00:00:00.490 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_mbplus:test_mbplus Took 0.49 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_mbplus  test_mbplus  PASSED    00:00:00.490
================== 5 test cases: 5 succeeded in 00:00:00.490 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_interbus:test_interbus Took 0.49 seconds --------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_interbus  test_interbus  PASSED    00:00:00.491
================== 4 test cases: 4 succeeded in 00:00:00.491 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_iccp:test_iccp Took 0.51 seconds ----------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_iccp    test_iccp  PASSED    00:00:00.510
================== 4 test cases: 4 succeeded in 00:00:00.510 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_wave:test_wave Took 0.49 seconds ----------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wave    test_wave  PASSED    00:00:00.492
================== 4 test cases: 4 succeeded in 00:00:00.492 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_utmc:test_utmc Took 0.57 seconds ----------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_utmc    test_utmc  PASSED    00:00:00.575
================== 5 test cases: 5 succeeded in 00:00:00.575 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_ocit:test_ocit Took 0.48 seconds ----------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_ocit    test_ocit  PASSED    00:00:00.480
================== 4 test cases: 4 succeeded in 00:00:00.480 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_atc:test_atc Took 0.50 seconds ------------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_atc     test_atc  PASSED    00:00:00.496
================== 4 test cases: 4 succeeded in 00:00:00.496 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_southbound:test_southbound Took 0.49 seconds ----------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_southbound  test_southbound  PASSED    00:00:00.494
================== 5 test cases: 5 succeeded in 00:00:00.494 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_exc_decoder:test_exc_decoder Took 0.51 seconds --------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_exc_decoder  test_exc_decoder  PASSED    00:00:00.510
================== 5 test cases: 5 succeeded in 00:00:00.510 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_http_delivery:test_http_delivery Took 0.50 seconds ----------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_http_delivery  test_http_delivery  PASSED    00:00:00.497
================== 6 test cases: 6 succeeded in 00:00:00.497 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_hw_health:test_hw_health Took 0.84 seconds ------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_hw_health  test_hw_health  PASSED    00:00:00.837
================== 5 test cases: 5 succeeded in 00:00:00.837 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_mdns_adaptive:test_mdns_adaptive Took 0.49 seconds ----------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_mdns_adaptive  test_mdns_adaptive  PASSED    00:00:00.488
================== 4 test cases: 4 succeeded in 00:00:00.488 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_sockpool:test_sockpool Took 0.48 seconds --------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_sockpool  test_sockpool  PASSED    00:00:00.484
================== 5 test cases: 5 succeeded in 00:00:00.484 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_psram_pool:test_psram_pool Took 0.51 seconds ----------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_psram_pool  test_psram_pool  PASSED    00:00:00.506
================== 5 test cases: 5 succeeded in 00:00:00.506 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_happy_eyeballs:test_happy_eyeballs Took 0.52 seconds --------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_happy_eyeballs  test_happy_eyeballs  PASSED    00:00:00.522
================== 4 test cases: 4 succeeded in 00:00:00.522 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_wifi_sniffer:test_wifi_sniffer Took 0.50 seconds ------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_wifi_sniffer  test_wifi_sniffer  PASSED    00:00:00.497
================== 5 test cases: 5 succeeded in 00:00:00.497 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_link_manager:test_link_manager Took 0.53 seconds ------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_link_manager  test_link_manager  PASSED    00:00:00.530
================== 4 test cases: 4 succeeded in 00:00:00.530 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_cc1101:test_cc1101 Took 0.49 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_cc1101  test_cc1101  PASSED    00:00:00.486
================= 10 test cases: 10 succeeded in 00:00:00.486 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_fdc2214:test_fdc2214 Took 0.48 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_fdc2214  test_fdc2214  PASSED    00:00:00.480
================== 4 test cases: 4 succeeded in 00:00:00.480 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_ldc1614:test_ldc1614 Took 0.55 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_ldc1614  test_ldc1614  PASSED    00:00:00.550
================== 4 test cases: 4 succeeded in 00:00:00.550 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_vl53l0x:test_vl53l0x Took 0.52 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_vl53l0x  test_vl53l0x  PASSED    00:00:00.520
================== 3 test cases: 3 succeeded in 00:00:00.520 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_radio_sniff:test_radio_sniff Took 0.52 seconds --------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_sniff  test_radio_sniff  PASSED    00:00:00.524
================== 4 test cases: 4 succeeded in 00:00:00.524 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_ble_gatt:test_ble_gatt Took 0.53 seconds --------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ble_gatt  test_ble_gatt  PASSED    00:00:00.531
================== 4 test cases: 4 succeeded in 00:00:00.531 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_tls_policy:test_tls_policy Took 0.47 seconds ----------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_tls_policy  test_tls_policy  PASSED    00:00:00.473
================== 4 test cases: 4 succeeded in 00:00:00.473 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_wisun:test_wisun Took 0.53 seconds --------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_wisun   test_wisun  PASSED    00:00:00.531
================== 6 test cases: 6 succeeded in 00:00:00.531 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_logbuf:test_logbuf Took 0.50 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.504
================== 4 test cases: 4 succeeded in 00:00:00.504 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_config_io:test_config_io Took 0.52 seconds ------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.520
================== 4 test cases: 4 succeeded in 00:00:00.520 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_workers:test_workers Took 0.60 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.602
================== 3 test cases: 3 succeeded in 00:00:00.602 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_clock:test_clock Took 0.47 seconds --------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.467
================== 7 test cases: 7 succeeded in 00:00:00.467 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_concurrency:test_concurrency Took 0.65 seconds --------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.651
================== 2 test cases: 2 succeeded in 00:00:00.651 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race                                          [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race                                      [PASSED]
native_tsan:test_concurrency Took 0.69 seconds ---------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:00.692
================== 2 test cases: 2 succeeded in 00:00:00.692 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_qpack:test_qpack Took 0.54 seconds --------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_qpack   test_qpack  PASSED    00:00:00.544
================== 9 test cases: 9 succeeded in 00:00:00.544 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_quic_packet:test_quic_packet Took 0.49 seconds --------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_packet  test_quic_packet  PASSED    00:00:00.486
================== 8 test cases: 8 succeeded in 00:00:00.486 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_quic_frame:test_quic_frame Took 0.51 seconds ----------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_quic_frame  test_quic_frame  PASSED    00:00:00.514
================== 8 test cases: 8 succeeded in 00:00:00.514 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_quic_crypto:test_quic_crypto Took 0.58 seconds --------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_crypto  test_quic_crypto  PASSED    00:00:00.580
================== 7 test cases: 7 succeeded in 00:00:00.580 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_tls13_kdf:test_tls13_kdf Took 0.61 seconds ------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_tls13_kdf  test_tls13_kdf  PASSED    00:00:00.609
================== 5 test cases: 5 succeeded in 00:00:00.609 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_quic_tp:test_quic_tp Took 0.64 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_quic_tp  test_quic_tp  PASSED    00:00:00.642
...
native_tls13_msg:test_tls13_msg Took 0.55 seconds ------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_tls13_msg  test_tls13_msg  PASSED    00:00:00.555
================== 7 test cases: 7 succeeded in 00:00:00.555 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_quic_tls:test_quic_tls Took 0.76 seconds --------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_quic_tls  test_quic_tls  PASSED    00:00:00.757
================= 11 test cases: 11 succeeded in 00:00:00.757 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_quic_conn:test_quic_conn Took 0.78 seconds ------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_quic_conn  test_quic_conn  PASSED    00:00:00.776
...
native_h3_conn:test_h3_conn Took 0.77 seconds ----------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_h3_conn  test_h3_conn  PASSED    00:00:00.774
================= 11 test cases: 11 succeeded in 00:00:00.774 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_h3_e2e:test_h3_e2e Took 0.81 seconds ------------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_h3_e2e  test_h3_e2e  PASSED    00:00:00.813
================== 1 test cases: 1 succeeded in 00:00:00.813 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_quic_server:test_quic_server Took 0.83 seconds --------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_server  test_quic_server  PASSED    00:00:00.831
...
native_h3_server:test_h3_server Took 1.29 seconds ------------------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_h3_server  test_h3_server  PASSED    00:00:01.289
================== 1 test cases: 1 succeeded in 00:00:01.289 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 230 tests
...
native_ssh_chachapoly:test_ssh_chachapoly Took 0.52 seconds --------------------------------------------------- [PASSED]

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_ssh_chachapoly  test_ssh_chachapoly  PASSED    00:00:00.523
================== 4 test cases: 4 succeeded in 00:00:00.523 ==================
```
