...
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.711 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:00.957 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.650 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.659 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.860 |
| `test_ssh_auth`          | `native_ssh`            |    18 |   ✅   | 00:00:00.574 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.828 |
...
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.252 |
...
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.588 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.594 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.553 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.600 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.603 |
...
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.611 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.595 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.602 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.676 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.190 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.167 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.682 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.503 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:01.957 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.791 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.993 |
...
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.712 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.630 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.642 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.645 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.639 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.652 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.698 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.753 |
| `test_forward`           | `native_forward`        |    10 |   ✅   | 00:00:00.887 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.665 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.645 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.637 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.631 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.634 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.638 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.637 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.637 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.700 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.635 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.630 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.633 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.640 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.641 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.641 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.635 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.640 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.644 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.642 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.655 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.663 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.636 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.661 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.643 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.645 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.635 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.666 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.881 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.649 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.635 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.644 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.666 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.682 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.680 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.089 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.090 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.655 |
...
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.644 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.683 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.683 |
...
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.009 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.629 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.654 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.654 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.641 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.671 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.657 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.648 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.640 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.638 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.647 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.651 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.642 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.640 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.637 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.644 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.664 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.744 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.619 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.784 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.774 |
...
------------ native_canopen:test_canopen [PASSED] Took 6.79 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.787
================= 17 test cases: 17 succeeded in 00:00:06.787 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 131 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.662
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.660
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.642
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.026
...
================ 321 test cases: 321 succeeded in 00:00:03.995 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 131 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.711
================= 17 test cases: 17 succeeded in 00:00:00.711 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 131 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.957
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.659
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.860
native_ssh     test_ssh_auth       PASSED    00:00:00.574
native_ssh     test_ssh_server     PASSED    00:00:00.828
native_ssh     test_ssh_transport  PASSED    00:00:01.042
native_ssh     test_ssh_channel    PASSED    00:00:00.555
================ 120 test cases: 120 succeeded in 00:00:06.858 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 131 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.252
...
native_app     test_path_params       PASSED    00:00:00.593
native_app     test_digest_vectors    PASSED    00:00:00.533
native_app     test_form_params       PASSED    00:00:00.588
native_app     test_iface             PASSED    00:00:00.594
native_app     test_json              PASSED    00:00:00.553
native_app     test_response_headers  PASSED    00:00:00.600
native_app     test_middleware        PASSED    00:00:00.603
...
native_app     test_file_serving      PASSED    00:00:00.611
native_app     test_dispatch          PASSED    00:00:00.595
native_app     test_chunked           PASSED    00:00:00.602
native_app     test_application       PASSED    00:00:00.676
================ 225 test cases: 225 succeeded in 00:00:11.260 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 131 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.190
================= 12 test cases: 12 succeeded in 00:00:01.190 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 131 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.682
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.791
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.993
================= 41 test cases: 41 succeeded in 00:00:00.993 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 131 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.712
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.645
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.698
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_forward/test_forward.cpp:170: test_default_deny               [PASSED]
test/test_forward/test_forward.cpp:171: test_allow_forwards             [PASSED]
test/test_forward/test_forward.cpp:172: test_no_self_forward            [PASSED]
test/test_forward/test_forward.cpp:173: test_deny_wins_over_allow       [PASSED]
test/test_forward/test_forward.cpp:174: test_multi_destination_fanout   [PASSED]
test/test_forward/test_forward.cpp:175: test_rate_cap_drops_then_reopens [PASSED]
test/test_forward/test_forward.cpp:176: test_send_failure_counted       [PASSED]
test/test_forward/test_forward.cpp:177: test_add_if_validation_and_table_full [PASSED]
test/test_forward/test_forward.cpp:178: test_add_rule_table_full        [PASSED]
test/test_forward/test_forward.cpp:179: test_unregistered_destination_is_inert [PASSED]
------------ native_forward:test_forward [PASSED] Took 0.89 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.887
================= 10 test cases: 10 succeeded in 00:00:00.887 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 131 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.665
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.637
================== 6 test cases: 6 succeeded in 00:00:00.637 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 131 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.631
...
------------ native_grpcweb:test_grpcweb [PASSED] Took 0.63 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.634
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.638
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.637
================== 6 test cases: 6 succeeded in 00:00:00.637 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 131 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.700
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.633
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.640
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.641
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.635
================== 7 test cases: 7 succeeded in 00:00:00.635 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 131 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.644
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.663
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.636
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.661
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.635
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.666
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.881
================= 17 test cases: 17 succeeded in 00:00:00.881 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 131 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.635
================= 32 test cases: 32 succeeded in 00:00:00.635 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 131 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.682
================= 38 test cases: 38 succeeded in 00:00:00.682 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 131 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.680
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.089
================= 10 test cases: 10 succeeded in 00:00:01.089 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 131 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.655
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.644
================= 22 test cases: 22 succeeded in 00:00:00.644 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 131 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.683
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.009
================= 71 test cases: 71 succeeded in 00:00:01.009 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 131 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.654
...
================= 10 test cases: 10 succeeded in 00:00:00.641 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 131 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.671
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.648
================= 15 test cases: 15 succeeded in 00:00:00.648 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 131 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.640
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.638
================== 5 test cases: 5 succeeded in 00:00:00.638 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 131 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.647
================= 18 test cases: 18 succeeded in 00:00:00.647 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 131 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.642
================== 8 test cases: 8 succeeded in 00:00:00.642 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 131 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.637
================== 6 test cases: 6 succeeded in 00:00:00.637 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 131 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.644
================== 4 test cases: 4 succeeded in 00:00:00.644 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 131 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.664
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.744
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 1.77 seconds ------------

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.774
================== 2 test cases: 2 succeeded in 00:00:01.774 ==================
```
