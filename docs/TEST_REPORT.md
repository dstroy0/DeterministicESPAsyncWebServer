...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    11 |   ✅   | 00:00:12.316 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.569 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.559 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.588 |
| `test_mbus`              | `native_mbus`           |     8 |   ✅   | 00:00:00.569 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.563 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.571 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.582 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.572 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.561 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:00.906 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.519 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.551 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.534 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.557 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.520 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.636 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:00.870 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.587 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.589 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:04.284 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.518 |
| `test_ssh_server`        | `native_ssh`            |    12 |   ✅   | 00:00:00.845 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.919 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.489 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.776 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.142 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.035 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.529 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.531 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.482 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.526 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.531 |
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.494 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.536 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.533 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.547 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.532 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.519 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.546 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.537 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.554 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.533 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.550 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.622 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.071 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.028 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.612 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.445 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.528 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.704 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.767 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.659 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.610 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.622 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.633 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.581 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.591 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.592 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.570 |
| `test_protobuf`          | `native_protobuf`       |    10 |   ✅   | 00:00:00.598 |
| `test_preempt_queue`     | `native_preempt_queue`  |     7 |   ✅   | 00:00:00.624 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.601 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.563 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.555 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.559 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.598 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.578 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.569 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.561 |
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.619 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.572 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.574 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.566 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.557 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.581 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.562 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.583 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.565 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.568 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.577 |
| `test_sparkplug`         | `native_sparkplug`      |     6 |   ✅   | 00:00:00.612 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.599 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.583 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.604 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.572 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.574 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.604 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.621 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.796 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.599 |
| `test_graphql`           | `native_graphql`        |    25 |   ✅   | 00:00:00.580 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.609 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.624 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.627 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.635 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.013 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:00.950 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.593 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.650 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.016 |
| `test_http_client`       | `native_http_client`    |    11 |   ✅   | 00:00:00.578 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.595 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.569 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.601 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.617 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.589 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.555 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.645 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:00.920 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.569 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.573 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.607 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.582 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.621 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.593 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.584 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.558 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.570 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.564 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.576 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.585 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.570 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.569 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.571 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.582 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.662 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.562 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.736 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.175 |
...
----------- native_canopen:test_canopen [PASSED] Took 12.32 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:12.316
================= 11 test cases: 11 succeeded in 00:00:12.316 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
-------------- native_j1939:test_j1939 [PASSED] Took 0.57 seconds --------------
...
---------- native_devicenet:test_devicenet [PASSED] Took 0.56 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.559
...
----------- native_nmea2000:test_nmea2000 [PASSED] Took 0.59 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.588
...
--------------- native_mbus:test_mbus [PASSED] Took 0.57 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.569
================== 8 test cases: 8 succeeded in 00:00:00.569 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.563
================== 8 test cases: 8 succeeded in 00:00:00.563 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
-------------- native_sdi12:test_sdi12 [PASSED] Took 0.57 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.571
================== 6 test cases: 6 succeeded in 00:00:00.571 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
---------------- native_dmx:test_dmx [PASSED] Took 0.58 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.582
...
----------- native_nmea0183:test_nmea0183 [PASSED] Took 0.57 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.572
...
------------------ native:test_sse [PASSED] Took 0.91 seconds ------------------
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:00.906
native         test_session       PASSED    00:00:00.519
native         test_presentation  PASSED    00:00:00.551
native         test_transport     PASSED    00:00:00.534
native         test_websocket     PASSED    00:00:00.557
native         test_http_parser   PASSED    00:00:00.520
================ 318 test cases: 318 succeeded in 00:00:03.586 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------ native_observability:test_observability [PASSED] Took 0.64 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.636
================= 17 test cases: 17 succeeded in 00:00:00.636 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
-------- native_accept_gate:test_accept_gate [PASSED] Took 0.87 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.870
================= 10 test cases: 10 succeeded in 00:00:00.870 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_ota:test_http_ota [PASSED] Took 0.59 seconds --------------

=================================== SUMMARY ===================================
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.587
================== 3 test cases: 3 succeeded in 00:00:00.587 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
----------- native_prov:test_provisioning [PASSED] Took 0.59 seconds -----------
...
------------ native_ssh:test_ssh_server [PASSED] Took 0.84 seconds -------------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.284
native_ssh     test_ssh_auth       PASSED    00:00:00.518
native_ssh     test_ssh_server     PASSED    00:00:00.845
native_ssh     test_ssh_transport  PASSED    00:00:00.919
native_ssh     test_ssh_channel    PASSED    00:00:00.489
================ 106 test cases: 106 succeeded in 00:00:07.054 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.776
================== 2 test cases: 2 succeeded in 00:00:00.776 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 1.14 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.142
================== 2 test cases: 2 succeeded in 00:00:01.142 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
--------------- native_app:test_regex [PASSED] Took 1.03 seconds ---------------
...
------------ native_app:test_path_params [PASSED] Took 0.53 seconds ------------
...
------------ native_app:test_form_params [PASSED] Took 0.53 seconds ------------
...
--------- native_app:test_response_headers [PASSED] Took 0.54 seconds ----------
...
--------------- native_app:test_auth [PASSED] Took 0.54 seconds ----------------
...
----------- native_app:test_file_serving [PASSED] Took 0.55 seconds ------------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.035
native_app     test_template          PASSED    00:00:00.529
native_app     test_path_params       PASSED    00:00:00.531
native_app     test_digest_vectors    PASSED    00:00:00.482
native_app     test_form_params       PASSED    00:00:00.526
native_app     test_iface             PASSED    00:00:00.531
native_app     test_json              PASSED    00:00:00.494
native_app     test_response_headers  PASSED    00:00:00.536
native_app     test_middleware        PASSED    00:00:00.533
native_app     test_digest_auth       PASSED    00:00:00.547
native_app     test_web_terminal      PASSED    00:00:00.532
native_app     test_defer             PASSED    00:00:00.519
native_app     test_multipart         PASSED    00:00:00.546
native_app     test_auth              PASSED    00:00:00.537
native_app     test_file_serving      PASSED    00:00:00.554
native_app     test_dispatch          PASSED    00:00:00.533
native_app     test_chunked           PASSED    00:00:00.550
native_app     test_application       PASSED    00:00:00.622
================ 219 test cases: 219 succeeded in 00:00:10.139 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
----- native_webdav_handler:test_webdav_handler [PASSED] Took 1.07 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.071
================= 12 test cases: 12 succeeded in 00:00:01.071 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
--------------- native_diag:test_diag [PASSED] Took 1.03 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.028
================== 2 test cases: 2 succeeded in 00:00:01.028 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_snmp:test_snmp_ber [PASSED] Took 0.61 seconds -------------
...
------------ native_snmp:test_snmp_agent [PASSED] Took 0.45 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.612
native_snmp    test_snmp_agent  PASSED    00:00:00.445
================= 30 test cases: 30 succeeded in 00:00:01.057 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 1.53 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.528
================= 10 test cases: 10 succeeded in 00:00:01.528 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_telnet:test_telnet [PASSED] Took 0.70 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.704
================== 8 test cases: 8 succeeded in 00:00:00.704 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
--------------- native_coap:test_coap [PASSED] Took 0.77 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.767
================= 29 test cases: 29 succeeded in 00:00:00.767 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
test/test_coap/test_coap.cpp:844: test_well_known_core_discovery        [PASSED]
test/test_coap/test_coap.cpp:845: test_well_known_core_rejects_post     [PASSED]
----------- native_coap_observe:test_coap [PASSED] Took 0.66 seconds -----------

=================================== SUMMARY ===================================
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.659
================= 29 test cases: 29 succeeded in 00:00:00.659 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_webdav:test_webdav [PASSED] Took 0.61 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.610
================= 19 test cases: 19 succeeded in 00:00:00.610 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_modbus:test_modbus [PASSED] Took 0.62 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.622
================= 18 test cases: 18 succeeded in 00:00:00.622 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
-------- native_cloudevents:test_cloudevents [PASSED] Took 0.63 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.633
...
----------- native_redis:test_redis_resp [PASSED] Took 0.58 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.581
...
-------------- native_stomp:test_stomp [PASSED] Took 0.59 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.591
...
------------ native_mqtt_sn:test_mqtt_sn [PASSED] Took 0.59 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.592
...
-------- native_flow_export:test_flow_export [PASSED] Took 0.57 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.570
================== 6 test cases: 6 succeeded in 00:00:00.570 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
----------- native_protobuf:test_protobuf [PASSED] Took 0.60 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.598
================= 10 test cases: 10 succeeded in 00:00:00.598 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------ native_preempt_queue:test_preempt_queue [PASSED] Took 0.62 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.624
================== 7 test cases: 7 succeeded in 00:00:00.624 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
--------------- native_wamp:test_wamp [PASSED] Took 0.60 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.601
================= 12 test cases: 12 succeeded in 00:00:00.601 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------ native_sunspec:test_sunspec [PASSED] Took 0.56 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.563
...
------------- native_c37118:test_c37118 [PASSED] Took 0.56 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.555
================== 6 test cases: 6 succeeded in 00:00:00.555 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
--------------- native_dnp3:test_dnp3 [PASSED] Took 0.56 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.559
...
------------ native_grpcweb:test_grpcweb [PASSED] Took 0.60 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.598
================== 7 test cases: 7 succeeded in 00:00:00.598 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
---------- native_lwm2m_tlv:test_lwm2m_tlv [PASSED] Took 0.58 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.578
...
----------- native_hostlink:test_hostlink [PASSED] Took 0.56 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.561
================== 7 test cases: 7 succeeded in 00:00:00.561 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
-------------- native_senml:test_senml [PASSED] Took 0.62 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.619
================== 6 test cases: 6 succeeded in 00:00:00.619 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
---------------- native_df1:test_df1 [PASSED] Took 0.57 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.572
================== 9 test cases: 9 succeeded in 00:00:00.572 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
--------------- native_cotp:test_cotp [PASSED] Took 0.57 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.574
...
------------- native_s7comm:test_s7comm [PASSED] Took 0.57 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.566
...
------------- native_melsec:test_melsec [PASSED] Took 0.56 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.557
================== 6 test cases: 6 succeeded in 00:00:00.557 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_bacnet:test_bacnet [PASSED] Took 0.58 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.581
================== 8 test cases: 8 succeeded in 00:00:00.581 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
--------------- native_enip:test_enip [PASSED] Took 0.56 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.562
...
--------------- native_amqp:test_amqp [PASSED] Took 0.58 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.583
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.565
...
--------------- native_nats:test_nats [PASSED] Took 0.57 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.568
...
----- native_proxy_protocol:test_proxy_protocol [PASSED] Took 0.58 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.577
...
---------- native_sparkplug:test_sparkplug [PASSED] Took 0.61 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.612
================== 6 test cases: 6 succeeded in 00:00:00.612 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------ native_modbus_master:test_modbus_master [PASSED] Took 0.60 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.599
================== 5 test cases: 5 succeeded in 00:00:00.599 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.583
...
--------------- native_totp:test_totp [PASSED] Took 0.60 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.604
================== 4 test cases: 4 succeeded in 00:00:00.604 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.572
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.574
================== 2 test cases: 2 succeeded in 00:00:00.574 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------- native_dns_resolver:test_dns_resolver [PASSED] Took 0.60 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.604
================== 4 test cases: 4 succeeded in 00:00:00.604 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
---------- native_audit_log:test_audit_log [PASSED] Took 0.62 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.621
================= 12 test cases: 12 succeeded in 00:00:00.621 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.796
================= 13 test cases: 13 succeeded in 00:00:00.796 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
---------------- native_vfs:test_vfs [PASSED] Took 0.60 seconds ----------------
...
================= 25 test cases: 25 succeeded in 00:00:00.580 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_espnow:test_espnow [PASSED] Took 0.61 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.609
================== 7 test cases: 7 succeeded in 00:00:00.609 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_oauth2:test_oauth2 [PASSED] Took 0.62 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.624
...
-------------- native_opcua:test_opcua [PASSED] Took 0.63 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.627
================= 29 test cases: 29 succeeded in 00:00:00.627 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------- native_opcua_client:test_opcua_client [PASSED] Took 0.64 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.635
================= 11 test cases: 11 succeeded in 00:00:00.635 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.013
================= 10 test cases: 10 succeeded in 00:00:01.013 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
-------------- native_range:test_range [PASSED] Took 0.95 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:00.950
================= 13 test cases: 13 succeeded in 00:00:00.950 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_syslog:test_syslog [PASSED] Took 0.59 seconds -------------
...
---------------- native_jwt:test_jwt [PASSED] Took 0.65 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.650
================= 12 test cases: 12 succeeded in 00:00:00.650 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_upload:test_upload [PASSED] Took 1.02 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.016
================== 3 test cases: 3 succeeded in 00:00:01.016 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
-------- native_http_client:test_http_client [PASSED] Took 0.58 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.578
================= 11 test cases: 11 succeeded in 00:00:00.578 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
--------- native_compliance:test_compliance [PASSED] Took 0.59 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.595
================= 15 test cases: 15 succeeded in 00:00:00.595 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.569
================= 19 test cases: 19 succeeded in 00:00:00.569 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
---------- native_ws_client:test_ws_client [PASSED] Took 0.60 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.601
================= 10 test cases: 10 succeeded in 00:00:00.601 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.617
================= 14 test cases: 14 succeeded in 00:00:00.617 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.589
================== 3 test cases: 3 succeeded in 00:00:00.589 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------ native_inflate:test_inflate [PASSED] Took 0.56 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.555
================= 12 test cases: 12 succeeded in 00:00:00.555 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------ native_deflate:test_deflate [PASSED] Took 0.64 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.645
...
test/test_websocket/test_websocket.cpp:1107: stress_ws_parse_max_payload [PASSED]
test/test_websocket/test_websocket.cpp:1108: stress_ws_parse_two_consecutive_frames [PASSED]
--------- native_ws_deflate:test_websocket [PASSED] Took 0.92 seconds ----------

=================================== SUMMARY ===================================
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.920
================= 71 test cases: 71 succeeded in 00:00:00.920 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
-------- native_time_source:test_time_source [PASSED] Took 0.57 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.569
================== 9 test cases: 9 succeeded in 00:00:00.569 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.573
================= 14 test cases: 14 succeeded in 00:00:00.573 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
---------- native_device_id:test_device_id [PASSED] Took 0.61 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.607
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.582
...
--------------- native_csrf:test_csrf [PASSED] Took 0.62 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.621
================== 9 test cases: 9 succeeded in 00:00:00.621 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
---------- native_telemetry:test_telemetry [PASSED] Took 0.59 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.593
================== 8 test cases: 8 succeeded in 00:00:00.593 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
---------- native_dashboard:test_dashboard [PASSED] Took 0.58 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.584
================= 11 test cases: 11 succeeded in 00:00:00.584 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.558
...
------ native_partition:test_partition_monitor [PASSED] Took 0.57 seconds ------

=================================== SUMMARY ===================================
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.570
...
--------------- native_cbor:test_cbor [PASSED] Took 0.56 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.564
================= 14 test cases: 14 succeeded in 00:00:00.564 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------ native_msgpack:test_msgpack [PASSED] Took 0.58 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.576
...
----------- native_gpio_map:test_gpio_map [PASSED] Took 0.59 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.585
================== 8 test cases: 8 succeeded in 00:00:00.585 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------ native_udp_telemetry:test_udp_telemetry [PASSED] Took 0.57 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.570
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.569
================== 6 test cases: 6 succeeded in 00:00:00.569 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_logbuf:test_logbuf [PASSED] Took 0.57 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.571
================== 4 test cases: 4 succeeded in 00:00:00.571 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.582
...
-------------- native_clock:test_clock [PASSED] Took 0.56 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.562
================== 7 test cases: 7 succeeded in 00:00:00.562 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
-------- native_concurrency:test_concurrency [PASSED] Took 0.74 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.736
================== 2 test cases: 2 succeeded in 00:00:00.736 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 1.17 seconds ------------

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.175
================== 2 test cases: 2 succeeded in 00:00:01.175 ==================
```
