...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:05.961 |
...
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.669 |
...
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.654 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.651 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:00.998 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.580 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.619 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.599 |
...
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:00.962 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.676 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.678 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.859 |
| `test_ssh_auth`          | `native_ssh`            |    18 |   ✅   | 00:00:00.587 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.838 |
| `test_ssh_transport`     | `native_ssh`            |    27 |   ✅   | 00:00:01.136 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.555 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.896 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.260 |
...
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.609 |
...
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.613 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.687 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.221 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.178 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.733 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.527 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:01.977 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.805 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.778 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.745 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.671 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.661 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.721 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.638 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.641 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.662 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.667 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.653 |
| `test_preempt_queue`     | `native_preempt_queue`  |     7 |   ✅   | 00:00:00.684 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.688 |
...
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.650 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.659 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.663 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.718 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.652 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.650 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.653 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.665 |
...
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.661 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.679 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.675 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.681 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.652 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.681 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.658 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.641 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.659 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.687 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.918 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.705 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.661 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.655 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.698 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.699 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.702 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.076 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.081 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.662 |
| `test_jwt`               | `native_jwt`            |    16 |   ✅   | 00:00:00.717 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.126 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.664 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.676 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.676 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.684 |
...
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.029 |
...
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.649 |
...
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.668 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.664 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.675 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.651 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.651 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.660 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.663 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.669 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.691 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.771 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.633 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.766 |
...
------------ native_canopen:test_canopen [PASSED] Took 5.96 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:05.961
================= 17 test cases: 17 succeeded in 00:00:05.961 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.669
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.654
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.651
...
================ 321 test cases: 321 succeeded in 00:00:04.033 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.962
================= 10 test cases: 10 succeeded in 00:00:00.962 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.676
================== 3 test cases: 3 succeeded in 00:00:00.676 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.859
native_ssh     test_ssh_auth       PASSED    00:00:00.587
native_ssh     test_ssh_server     PASSED    00:00:00.838
native_ssh     test_ssh_transport  PASSED    00:00:01.136
native_ssh     test_ssh_channel    PASSED    00:00:00.555
================ 120 test cases: 120 succeeded in 00:00:06.975 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.260
...
native_app     test_middleware        PASSED    00:00:00.609
...
native_app     test_chunked           PASSED    00:00:00.613
native_app     test_application       PASSED    00:00:00.687
================ 225 test cases: 225 succeeded in 00:00:11.589 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.221
================= 12 test cases: 12 succeeded in 00:00:01.221 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
native_snmp    test_snmp_agent  PASSED    00:00:00.527
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.977
================= 15 test cases: 15 succeeded in 00:00:01.977 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.778
================= 41 test cases: 41 succeeded in 00:00:00.778 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.661
================= 22 test cases: 22 succeeded in 00:00:00.661 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.638
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.662
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.667
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.653
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.688
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.650
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.659
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.663
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.718
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.652
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.665
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.679
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.652
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.641
================== 2 test cases: 2 succeeded in 00:00:00.641 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.687
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.918
================= 17 test cases: 17 succeeded in 00:00:00.918 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.705
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.661
================= 32 test cases: 32 succeeded in 00:00:00.661 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.655
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.081
================= 13 test cases: 13 succeeded in 00:00:01.081 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.664
...
================= 16 test cases: 16 succeeded in 00:00:00.684 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.029
================= 71 test cases: 71 succeeded in 00:00:01.029 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.668
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.651
================= 17 test cases: 17 succeeded in 00:00:00.651 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.663
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.691
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.766
