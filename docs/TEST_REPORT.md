...
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.625 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.643 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.638 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:04.400 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.656 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.641 |
...
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.655 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.637 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.001 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.574 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.621 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.600 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.627 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.591 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.782 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:01.174 |
...
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.831 |
| `test_ssh_transport`     | `native_ssh`            |    31 |   ✅   | 00:00:01.115 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.564 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.941 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.332 |
...
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.555 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.606 |
...
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.686 |
...
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.758 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.664 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.656 |
...
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.665 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.734 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.812 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.748 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.642 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.656 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.642 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.655 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.646 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.640 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.642 |
...
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.647 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.646 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.636 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.705 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.637 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.653 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.644 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.642 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.642 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.654 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.645 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.641 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.664 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.637 |
...
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.892 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.651 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.660 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.651 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.681 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.685 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.688 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.083 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.104 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.657 |
| `test_smtp`              | `native_smtp`           |    11 |   ✅   | 00:00:00.746 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.644 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.703 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.125 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.653 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.673 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.642 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.684 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.679 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.665 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.631 |
...
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.643 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.662 |
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.662 |
...
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.636 |
...
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.623 |
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.625
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.643
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_det_arena  test_det_arena  PASSED    00:00:00.638
================= 17 test cases: 17 succeeded in 00:00:00.638 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:04.400
================= 16 test cases: 16 succeeded in 00:00:04.400 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.641
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.655
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.637
...
================ 323 test cases: 323 succeeded in 00:00:04.014 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.174
...
native_ssh     test_ssh_server     PASSED    00:00:00.831
native_ssh     test_ssh_transport  PASSED    00:00:01.115
native_ssh     test_ssh_channel    PASSED    00:00:00.564
================ 137 test cases: 137 succeeded in 00:00:07.084 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.941
================== 2 test cases: 2 succeeded in 00:00:00.941 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.332
...
native_app     test_response_headers  PASSED    00:00:00.606
...
native_app     test_application       PASSED    00:00:00.686
================ 225 test cases: 225 succeeded in 00:00:11.379 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.656
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.665
...
---------------- native_dma:test_dma [PASSED] Took 0.73 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.734
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.812
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.642
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.642
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.640
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_zigbee  test_zigbee  PASSED    00:00:00.642
================== 9 test cases: 9 succeeded in 00:00:00.642 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.647
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.636
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.637
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.644
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.642
================== 9 test cases: 9 succeeded in 00:00:00.642 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.645
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.637
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.892
================= 17 test cases: 17 succeeded in 00:00:00.892 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.651
...
================= 32 test cases: 32 succeeded in 00:00:00.660 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.104
================= 13 test cases: 13 succeeded in 00:00:01.104 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
--------------- native_smtp:test_smtp [PASSED] Took 0.75 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_smtp    test_smtp  PASSED    00:00:00.746
...
--------- native_ntp_server:test_ntp_server [PASSED] Took 0.64 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_ntp_server  test_ntp_server  PASSED    00:00:00.644
================== 8 test cases: 8 succeeded in 00:00:00.644 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.125
================== 3 test cases: 3 succeeded in 00:00:01.125 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.642
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.679
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.631
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.643
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.623
