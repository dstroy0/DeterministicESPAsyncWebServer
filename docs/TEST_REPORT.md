...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:07.453 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.445 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.469 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.452 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.479 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.449 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.566 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.518 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.503 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:02.896 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.432 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.533 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.712 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.403 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.674 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.000 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:00.885 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.458 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.460 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.413 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.459 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.466 |
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.425 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.464 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.464 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.474 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.473 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.450 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.465 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.461 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.480 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.458 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.467 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.527 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:00.918 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:00.892 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.539 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.381 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.177 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.610 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.686 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.555 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.520 |
| `test_modbus`            | `native_modbus`         |    13 |   ✅   | 00:00:00.509 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.526 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.503 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.520 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.511 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.511 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.518 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.529 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.650 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.502 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.515 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.515 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.533 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.531 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.548 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.314 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:00.823 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.524 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.759 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:00.884 |
| `test_http_client`       | `native_http_client`    |    10 |   ✅   | 00:00:00.666 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.515 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.506 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.554 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.538 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.531 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.515 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.559 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:00.777 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.496 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.623 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.526 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.504 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.724 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.541 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.503 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.505 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.502 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.518 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.535 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.502 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     4 |   ✅   | 00:00:00.511 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.512 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.504 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.628 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.594 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.502 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.613 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:00.777 |
...
------------------ native:test_sse [PASSED] Took 7.45 seconds ------------------
...
--------------- native:test_transport [PASSED] Took 0.45 seconds ---------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:07.453
native         test_session       PASSED    00:00:00.445
native         test_presentation  PASSED    00:00:00.469
native         test_transport     PASSED    00:00:00.452
native         test_websocket     PASSED    00:00:00.479
native         test_http_parser   PASSED    00:00:00.449
================ 318 test cases: 318 succeeded in 00:00:09.747 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
----------- native_prov:test_provisioning [PASSED] Took 0.50 seconds -----------

=================================== SUMMARY ===================================
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.503
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 2.90 seconds -------------
...
------------- native_ssh:test_ssh_auth [PASSED] Took 0.43 seconds --------------
...
----------- native_ssh:test_ssh_transport [PASSED] Took 0.71 seconds -----------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:02.896
native_ssh     test_ssh_auth       PASSED    00:00:00.432
native_ssh     test_ssh_server     PASSED    00:00:00.533
native_ssh     test_ssh_transport  PASSED    00:00:00.712
native_ssh     test_ssh_channel    PASSED    00:00:00.403
================= 93 test cases: 93 succeeded in 00:00:04.977 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
------ native_ssh_hardened:test_ssh_hardening [PASSED] Took 0.67 seconds -------

=================================== SUMMARY ===================================
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.674
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.000
...
--------------- native_app:test_json [PASSED] Took 0.43 seconds ----------------
...
--------- native_app:test_response_headers [PASSED] Took 0.46 seconds ----------
...
------------ native_app:test_middleware [PASSED] Took 0.46 seconds -------------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:00.885
native_app     test_template          PASSED    00:00:00.458
native_app     test_path_params       PASSED    00:00:00.460
native_app     test_digest_vectors    PASSED    00:00:00.413
native_app     test_form_params       PASSED    00:00:00.459
native_app     test_iface             PASSED    00:00:00.466
native_app     test_json              PASSED    00:00:00.425
native_app     test_response_headers  PASSED    00:00:00.464
native_app     test_middleware        PASSED    00:00:00.464
native_app     test_digest_auth       PASSED    00:00:00.474
native_app     test_web_terminal      PASSED    00:00:00.473
native_app     test_defer             PASSED    00:00:00.450
native_app     test_multipart         PASSED    00:00:00.465
native_app     test_auth              PASSED    00:00:00.461
native_app     test_file_serving      PASSED    00:00:00.480
native_app     test_dispatch          PASSED    00:00:00.458
native_app     test_chunked           PASSED    00:00:00.467
native_app     test_application       PASSED    00:00:00.527
================ 219 test cases: 219 succeeded in 00:00:08.748 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:00.918
================= 12 test cases: 12 succeeded in 00:00:00.918 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
--------------- native_diag:test_diag [PASSED] Took 0.89 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:00.892
...
------------ native_snmp:test_snmp_agent [PASSED] Took 0.38 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.539
native_snmp    test_snmp_agent  PASSED    00:00:00.381
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 1.18 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.177
...
------------- native_telnet:test_telnet [PASSED] Took 0.61 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.610
...
test/test_coap/test_coap.cpp:844: test_well_known_core_discovery        [PASSED]
test/test_coap/test_coap.cpp:845: test_well_known_core_rejects_post     [PASSED]
----------- native_coap_observe:test_coap [PASSED] Took 0.56 seconds -----------

=================================== SUMMARY ===================================
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.555
================= 29 test cases: 29 succeeded in 00:00:00.555 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.520
================= 19 test cases: 19 succeeded in 00:00:00.520 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
------------- native_modbus:test_modbus [PASSED] Took 0.51 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.509
================= 13 test cases: 13 succeeded in 00:00:00.509 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
------- native_ota_rollback:test_ota_rollback [PASSED] Took 0.50 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.503
================== 5 test cases: 5 succeeded in 00:00:00.503 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.511
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.511
================== 2 test cases: 2 succeeded in 00:00:00.511 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.518
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.529
================= 12 test cases: 12 succeeded in 00:00:00.529 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
---------------- native_vfs:test_vfs [PASSED] Took 0.50 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.502
================= 11 test cases: 11 succeeded in 00:00:00.502 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
------------ native_graphql:test_graphql [PASSED] Took 0.51 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.515
================= 13 test cases: 13 succeeded in 00:00:00.515 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.515
================== 7 test cases: 7 succeeded in 00:00:00.515 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.531
================= 29 test cases: 29 succeeded in 00:00:00.531 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
================= 11 test cases: 11 succeeded in 00:00:00.548 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.314
================= 10 test cases: 10 succeeded in 00:00:01.314 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
-------------- native_range:test_range [PASSED] Took 0.82 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:00.823
================= 13 test cases: 13 succeeded in 00:00:00.823 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.524
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:00.884
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.515
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.506
================= 19 test cases: 19 succeeded in 00:00:00.506 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.554
================= 10 test cases: 10 succeeded in 00:00:00.554 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.538
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.531
...
------------ native_inflate:test_inflate [PASSED] Took 0.51 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.515
================= 12 test cases: 12 succeeded in 00:00:00.515 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
test/test_websocket/test_websocket.cpp:1107: stress_ws_parse_max_payload [PASSED]
test/test_websocket/test_websocket.cpp:1108: stress_ws_parse_two_consecutive_frames [PASSED]
--------- native_ws_deflate:test_websocket [PASSED] Took 0.78 seconds ----------

=================================== SUMMARY ===================================
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.777
================= 71 test cases: 71 succeeded in 00:00:00.777 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
-------- native_time_source:test_time_source [PASSED] Took 0.50 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.496
================== 9 test cases: 9 succeeded in 00:00:00.496 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
------- native_auth_lockout:test_auth_lockout [PASSED] Took 0.50 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.504
================= 10 test cases: 10 succeeded in 00:00:00.504 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.503
================= 11 test cases: 11 succeeded in 00:00:00.503 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.505
...
------ native_partition:test_partition_monitor [PASSED] Took 0.50 seconds ------

=================================== SUMMARY ===================================
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.502
================== 5 test cases: 5 succeeded in 00:00:00.502 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.518
================= 14 test cases: 14 succeeded in 00:00:00.518 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.535
================= 15 test cases: 15 succeeded in 00:00:00.535 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.502
================== 8 test cases: 8 succeeded in 00:00:00.502 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
------ native_udp_telemetry:test_udp_telemetry [PASSED] Took 0.51 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.511
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.512
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.628
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.502
================== 4 test cases: 4 succeeded in 00:00:00.502 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.613
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:00.777
