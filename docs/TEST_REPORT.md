...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    11 |   ✅   | 00:00:06.085 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.657 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.661 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.673 |
| `test_mbus`              | `native_mbus`           |     8 |   ✅   | 00:00:00.664 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.669 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.659 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.658 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.671 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.670 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.086 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.584 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.606 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.605 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.621 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.582 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.729 |
...
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.876 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.570 |
| `test_ssh_server`        | `native_ssh`            |    10 |   ✅   | 00:00:00.696 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.930 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.558 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.026 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.516 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.300 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.600 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.604 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.551 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.597 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.602 |
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.559 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.610 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.608 |
...
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.606 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.603 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.626 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.596 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.610 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.684 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.343 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.305 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.745 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.502 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.595 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.824 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.813 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.736 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.664 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.668 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.743 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.652 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.657 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.650 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.644 |
| `test_protobuf`          | `native_protobuf`       |    10 |   ✅   | 00:00:00.665 |
| `test_preempt_queue`     | `native_preempt_queue`  |     7 |   ✅   | 00:00:00.686 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.683 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.666 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.644 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.660 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.656 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.662 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.667 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.646 |
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.739 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.656 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.662 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.660 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.642 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.660 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.663 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.657 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.664 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.639 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.673 |
| `test_sparkplug`         | `native_sparkplug`      |     6 |   ✅   | 00:00:00.671 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.689 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.658 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.674 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.660 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.655 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.659 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.685 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.937 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.665 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.670 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.634 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.672 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.678 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.682 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.204 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.194 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.666 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.725 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.237 |
| `test_http_client`       | `native_http_client`    |    11 |   ✅   | 00:00:00.651 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.641 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.668 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.730 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.708 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.673 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.664 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.699 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.144 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.646 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.656 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.669 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.666 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.694 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.660 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.646 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.656 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.662 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.666 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.667 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.662 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.668 |
...
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.783 |
...
------------ native_canopen:test_canopen [PASSED] Took 6.09 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.085
================= 11 test cases: 11 succeeded in 00:00:06.085 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.657
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.673
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.669
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.670
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.086
native         test_session       PASSED    00:00:00.584
native         test_presentation  PASSED    00:00:00.606
native         test_transport     PASSED    00:00:00.605
native         test_websocket     PASSED    00:00:00.621
native         test_http_parser   PASSED    00:00:00.582
================ 318 test cases: 318 succeeded in 00:00:04.085 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.876
native_ssh     test_ssh_auth       PASSED    00:00:00.570
native_ssh     test_ssh_server     PASSED    00:00:00.696
native_ssh     test_ssh_transport  PASSED    00:00:00.930
native_ssh     test_ssh_channel    PASSED    00:00:00.558
================ 104 test cases: 104 succeeded in 00:00:06.631 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:01.026
================== 2 test cases: 2 succeeded in 00:00:01.026 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 1.52 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.516
...
--------------- native_app:test_regex [PASSED] Took 1.30 seconds ---------------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.300
native_app     test_template          PASSED    00:00:00.600
native_app     test_path_params       PASSED    00:00:00.604
native_app     test_digest_vectors    PASSED    00:00:00.551
native_app     test_form_params       PASSED    00:00:00.597
native_app     test_iface             PASSED    00:00:00.602
native_app     test_json              PASSED    00:00:00.559
native_app     test_response_headers  PASSED    00:00:00.610
native_app     test_middleware        PASSED    00:00:00.608
...
native_app     test_multipart         PASSED    00:00:00.606
native_app     test_auth              PASSED    00:00:00.603
native_app     test_file_serving      PASSED    00:00:00.626
native_app     test_dispatch          PASSED    00:00:00.596
native_app     test_chunked           PASSED    00:00:00.610
native_app     test_application       PASSED    00:00:00.684
================ 219 test cases: 219 succeeded in 00:00:11.558 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
----- native_webdav_handler:test_webdav_handler [PASSED] Took 1.34 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.343
================= 12 test cases: 12 succeeded in 00:00:01.343 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.305
================== 2 test cases: 2 succeeded in 00:00:01.305 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.745
native_snmp    test_snmp_agent  PASSED    00:00:00.502
================= 30 test cases: 30 succeeded in 00:00:01.246 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.595
================= 10 test cases: 10 succeeded in 00:00:01.595 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.736
================= 29 test cases: 29 succeeded in 00:00:00.736 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.668
================= 18 test cases: 18 succeeded in 00:00:00.668 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.657
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.650
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.644
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.656
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.646
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.739
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.662
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.660
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.642
================== 6 test cases: 6 succeeded in 00:00:00.642 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.660
================== 8 test cases: 8 succeeded in 00:00:00.660 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.663
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.639
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.673
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.689
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.674
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.660
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.659
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.685
================= 12 test cases: 12 succeeded in 00:00:00.685 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.937
================= 13 test cases: 13 succeeded in 00:00:00.937 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.670
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.634
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.678
================= 29 test cases: 29 succeeded in 00:00:00.678 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.682
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.204
================= 10 test cases: 10 succeeded in 00:00:01.204 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_upload:test_upload [PASSED] Took 1.24 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.237
================== 3 test cases: 3 succeeded in 00:00:01.237 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.651
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.641
================= 15 test cases: 15 succeeded in 00:00:00.641 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.673
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.144
================= 71 test cases: 71 succeeded in 00:00:01.144 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.656
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.694
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.660
================== 8 test cases: 8 succeeded in 00:00:00.660 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.662
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.667
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.668
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.783
================== 2 test cases: 2 succeeded in 00:00:00.783 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
