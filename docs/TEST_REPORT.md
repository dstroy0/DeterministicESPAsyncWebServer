...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:06.200 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.631 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.665 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.652 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.675 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.661 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.668 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.678 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.683 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.680 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.672 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.013 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.599 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.621 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.610 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.631 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.615 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.747 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:00.964 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.675 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.657 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.867 |
| `test_ssh_auth`          | `native_ssh`            |    18 |   ✅   | 00:00:00.607 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.854 |
| `test_ssh_transport`     | `native_ssh`            |    27 |   ✅   | 00:00:01.074 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.582 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.954 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.326 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.195 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.628 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.627 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.558 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.617 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.616 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.575 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.618 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.616 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.626 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.608 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.580 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.603 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.603 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.619 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.597 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.604 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.690 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.199 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.160 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.693 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.505 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:01.964 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.801 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.753 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.740 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.657 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.669 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.719 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.647 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.653 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.656 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.666 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.661 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.692 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.761 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.884 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.783 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.668 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.681 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.681 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.666 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.637 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.661 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.656 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.653 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.683 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.655 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.655 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.651 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.667 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.649 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.641 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.645 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.710 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.654 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.643 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.658 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.650 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.646 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.643 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.655 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.656 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.641 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.652 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.675 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.669 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.646 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.675 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.656 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.648 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.654 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.683 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.935 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.691 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.689 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.661 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.697 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.702 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.701 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.114 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.098 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.687 |
| `test_jwt`               | `native_jwt`            |    16 |   ✅   | 00:00:00.720 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.126 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.666 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.680 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.660 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.702 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.708 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.671 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.669 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.710 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.045 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.652 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.658 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.669 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.648 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.686 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.649 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.665 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.643 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.690 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.697 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.676 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.676 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.674 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.660 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.668 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.707 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.776 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.661 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.804 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.182 |
...
------------ native_canopen:test_canopen [PASSED] Took 6.20 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.200
================= 17 test cases: 17 succeeded in 00:00:06.200 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.631
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.665
================== 9 test cases: 9 succeeded in 00:00:00.665 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.675
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.668
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.678
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.683
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.680
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.672
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.013
native         test_session       PASSED    00:00:00.599
native         test_presentation  PASSED    00:00:00.621
native         test_transport     PASSED    00:00:00.610
native         test_websocket     PASSED    00:00:00.631
native         test_http_parser   PASSED    00:00:00.615
================ 321 test cases: 321 succeeded in 00:00:04.088 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------ native_observability:test_observability [PASSED] Took 0.75 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.747
================= 17 test cases: 17 succeeded in 00:00:00.747 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.964
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.675
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.657
...
----------- native_ssh:test_ssh_transport [PASSED] Took 1.07 seconds -----------
...
------------ native_ssh:test_ssh_channel [PASSED] Took 0.58 seconds ------------

=================================== SUMMARY ===================================
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.867
native_ssh     test_ssh_auth       PASSED    00:00:00.607
native_ssh     test_ssh_server     PASSED    00:00:00.854
native_ssh     test_ssh_transport  PASSED    00:00:01.074
native_ssh     test_ssh_channel    PASSED    00:00:00.582
================ 120 test cases: 120 succeeded in 00:00:06.983 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------ native_ssh_hardened:test_ssh_hardening [PASSED] Took 0.95 seconds -------

=================================== SUMMARY ===================================
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.954
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.326
================== 2 test cases: 2 succeeded in 00:00:01.326 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
native_app     test_template          PASSED    00:00:00.628
native_app     test_path_params       PASSED    00:00:00.627
native_app     test_digest_vectors    PASSED    00:00:00.558
native_app     test_form_params       PASSED    00:00:00.617
native_app     test_iface             PASSED    00:00:00.616
native_app     test_json              PASSED    00:00:00.575
native_app     test_response_headers  PASSED    00:00:00.618
native_app     test_middleware        PASSED    00:00:00.616
native_app     test_digest_auth       PASSED    00:00:00.626
native_app     test_web_terminal      PASSED    00:00:00.608
native_app     test_defer             PASSED    00:00:00.580
native_app     test_multipart         PASSED    00:00:00.603
native_app     test_auth              PASSED    00:00:00.603
native_app     test_file_serving      PASSED    00:00:00.619
native_app     test_dispatch          PASSED    00:00:00.597
native_app     test_chunked           PASSED    00:00:00.604
native_app     test_application       PASSED    00:00:00.690
================ 225 test cases: 225 succeeded in 00:00:11.581 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.199
================= 12 test cases: 12 succeeded in 00:00:01.199 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.160
================== 2 test cases: 2 succeeded in 00:00:01.160 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.693
native_snmp    test_snmp_agent  PASSED    00:00:00.505
================= 35 test cases: 35 succeeded in 00:00:01.198 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.964
================= 15 test cases: 15 succeeded in 00:00:01.964 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.801
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.753
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.740
================= 41 test cases: 41 succeeded in 00:00:00.740 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.669
================= 22 test cases: 22 succeeded in 00:00:00.669 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.719
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.653
================= 14 test cases: 14 succeeded in 00:00:00.653 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
-------- native_flow_export:test_flow_export [PASSED] Took 0.67 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.666
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.661
================= 13 test cases: 13 succeeded in 00:00:00.661 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.692
...
---------------- native_dma:test_dma [PASSED] Took 0.76 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.761
...
------------ native_forward:test_forward [PASSED] Took 0.88 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.884
================= 16 test cases: 16 succeeded in 00:00:00.884 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.783
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.668
================= 13 test cases: 13 succeeded in 00:00:00.668 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.681
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.681
...
-------------- native_pn532:test_pn532 [PASSED] Took 0.67 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_pn532   test_pn532  PASSED    00:00:00.666
...
------------- native_sigfox:test_sigfox [PASSED] Took 0.64 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.637
...
-------------- native_zwave:test_zwave [PASSED] Took 0.66 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.661
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.653
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.683
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.655
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.655
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.651
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.667
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.649
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.645
...
---------------- native_df1:test_df1 [PASSED] Took 0.65 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.654
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.643
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.650
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.646
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.655
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.656
================== 9 test cases: 9 succeeded in 00:00:00.656 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_nats:test_nats [PASSED] Took 0.64 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.641
...
----- native_proxy_protocol:test_proxy_protocol [PASSED] Took 0.65 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.652
================== 8 test cases: 8 succeeded in 00:00:00.652 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.675
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.669
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.675
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.656
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.648
================== 2 test cases: 2 succeeded in 00:00:00.648 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.654
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.683
================= 16 test cases: 16 succeeded in 00:00:00.683 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.935
================= 17 test cases: 17 succeeded in 00:00:00.935 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.691
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.661
...
================= 38 test cases: 38 succeeded in 00:00:00.702 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.701
...
---------- native_keepalive:test_keepalive [PASSED] Took 1.11 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.114
================= 10 test cases: 10 succeeded in 00:00:01.114 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.098
================= 13 test cases: 13 succeeded in 00:00:01.098 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.720
================= 16 test cases: 16 succeeded in 00:00:00.720 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.126
================== 3 test cases: 3 succeeded in 00:00:01.126 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.680
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.660
================= 22 test cases: 22 succeeded in 00:00:00.660 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.702
================= 16 test cases: 16 succeeded in 00:00:00.702 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.671
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.669
================= 12 test cases: 12 succeeded in 00:00:00.669 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.045
================= 71 test cases: 71 succeeded in 00:00:01.045 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.652
================== 9 test cases: 9 succeeded in 00:00:00.652 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.669
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.648
================= 10 test cases: 10 succeeded in 00:00:00.648 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.686
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.649
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.665
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.643
================== 6 test cases: 6 succeeded in 00:00:00.643 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.690
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.697
================= 18 test cases: 18 succeeded in 00:00:00.697 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.676
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.674
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.668
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.707
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.776
================== 3 test cases: 3 succeeded in 00:00:00.776 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.804
================== 2 test cases: 2 succeeded in 00:00:00.804 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.182
================== 2 test cases: 2 succeeded in 00:00:01.182 ==================
```
