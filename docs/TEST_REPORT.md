...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    11 |   ✅   | 00:00:13.311 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.687 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.695 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.720 |
| `test_mbus`              | `native_mbus`           |     8 |   ✅   | 00:00:00.713 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.707 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.714 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.666 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.695 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.696 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.191 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.605 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.638 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.615 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.671 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.599 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.760 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:01.165 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.688 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.701 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:04.066 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.590 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.693 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.904 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.565 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.062 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.626 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.376 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.636 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.633 |
...
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.574 |
...
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.715 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.413 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.350 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.759 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.521 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.591 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.831 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.894 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.763 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.699 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.707 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.755 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.673 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.669 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.682 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.685 |
| `test_protobuf`          | `native_protobuf`       |    10 |   ✅   | 00:00:00.683 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.724 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.684 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.666 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.669 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.682 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.692 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.673 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.669 |
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.764 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.672 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.669 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.662 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.676 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.672 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.670 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.666 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.667 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.670 |
...
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.691 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.893 |
...
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.681 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.704 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.263 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.232 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.688 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.756 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.296 |
| `test_http_client`       | `native_http_client`    |    11 |   ✅   | 00:00:00.688 |
...
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.691 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.675 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.705 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.221 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.672 |
...
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.650 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.690 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.668 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.666 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.679 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.676 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.673 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.690 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.682 |
...
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.442 |
...
----------- native_canopen:test_canopen [PASSED] Took 13.31 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:13.311
================= 11 test cases: 11 succeeded in 00:00:13.311 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.687
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.720
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.707
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.714
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.695
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.191
...
================ 318 test cases: 318 succeeded in 00:00:04.319 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.760
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.165
================= 10 test cases: 10 succeeded in 00:00:01.165 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.066
native_ssh     test_ssh_auth       PASSED    00:00:00.590
native_ssh     test_ssh_server     PASSED    00:00:00.693
native_ssh     test_ssh_transport  PASSED    00:00:00.904
native_ssh     test_ssh_channel    PASSED    00:00:00.565
================= 93 test cases: 93 succeeded in 00:00:06.817 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.626
================== 2 test cases: 2 succeeded in 00:00:01.626 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.376
native_app     test_template          PASSED    00:00:00.636
native_app     test_path_params       PASSED    00:00:00.633
...
native_app     test_application       PASSED    00:00:00.715
================ 219 test cases: 219 succeeded in 00:00:11.993 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.413
================= 12 test cases: 12 succeeded in 00:00:01.413 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
--------------- native_diag:test_diag [PASSED] Took 1.35 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.350
...
================= 30 test cases: 30 succeeded in 00:00:01.280 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
================== 8 test cases: 8 succeeded in 00:00:00.831 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.894
================= 29 test cases: 29 succeeded in 00:00:00.894 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.763
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.699
================= 19 test cases: 19 succeeded in 00:00:00.699 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.707
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.755
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.673
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.724
================= 12 test cases: 12 succeeded in 00:00:00.724 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.669
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.682
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.692
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.662
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.893
================= 13 test cases: 13 succeeded in 00:00:00.893 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.681
================= 29 test cases: 29 succeeded in 00:00:00.681 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
---------- native_keepalive:test_keepalive [PASSED] Took 1.26 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.263
================= 10 test cases: 10 succeeded in 00:00:01.263 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.232
================= 13 test cases: 13 succeeded in 00:00:01.232 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.688
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.296
================== 3 test cases: 3 succeeded in 00:00:01.296 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.688
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.675
...
test/test_websocket/test_websocket.cpp:1107: stress_ws_parse_max_payload [PASSED]
test/test_websocket/test_websocket.cpp:1108: stress_ws_parse_two_consecutive_frames [PASSED]
--------- native_ws_deflate:test_websocket [PASSED] Took 1.22 seconds ----------

=================================== SUMMARY ===================================
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.221
================= 71 test cases: 71 succeeded in 00:00:01.221 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.672
================== 9 test cases: 9 succeeded in 00:00:00.672 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.650
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.690
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.682
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.442
================== 2 test cases: 2 succeeded in 00:00:01.442 ==================
```
