...
**Generated:** 2026-06-29 19:09:41
**Command:** `pio test` over 87 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1447 passed - 133s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:06.187 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.544 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.585 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.566 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.603 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.561 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.681 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.605 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.584 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:04.192 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.557 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.708 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.976 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.513 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.808 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.204 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.082 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.573 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.580 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.525 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.569 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.583 |
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.531 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.594 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.587 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.608 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.588 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.552 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.579 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.574 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.597 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.567 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.580 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.653 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.123 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.076 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.647 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.480 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.554 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.750 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.707 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.711 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.618 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.629 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.702 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.608 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.614 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.612 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.606 |
| `test_protobuf`          | `native_protobuf`       |     8 |   ✅   | 00:00:00.586 |
| `test_wamp`              | `native_wamp`           |    11 |   ✅   | 00:00:00.620 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.588 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.599 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.607 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.599 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |     7 |   ✅   | 00:00:00.607 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.588 |
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.650 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.603 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.603 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.611 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.596 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.600 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.601 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.594 |
...
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.601 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.610 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.604 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.645 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.795 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.601 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.609 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.595 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.626 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.635 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.636 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.027 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:00.991 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.618 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.657 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.043 |
| `test_http_client`       | `native_http_client`    |    10 |   ✅   | 00:00:00.591 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.623 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.611 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.641 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.655 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.632 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.611 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.651 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:00.989 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.600 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.610 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.641 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.602 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.633 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.620 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.615 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.614 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.611 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.628 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.596 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.617 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.594 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.602 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.604 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.623 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.691 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.581 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.733 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.111 |
...
------------------ native:test_sse [PASSED] Took 6.19 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.187
native         test_session       PASSED    00:00:00.544
native         test_presentation  PASSED    00:00:00.585
native         test_transport     PASSED    00:00:00.566
native         test_websocket     PASSED    00:00:00.603
native         test_http_parser   PASSED    00:00:00.561
================ 318 test cases: 318 succeeded in 00:00:09.046 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.681
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.605
================== 3 test cases: 3 succeeded in 00:00:00.605 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.584
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.192
native_ssh     test_ssh_auth       PASSED    00:00:00.557
native_ssh     test_ssh_server     PASSED    00:00:00.708
native_ssh     test_ssh_transport  PASSED    00:00:00.976
native_ssh     test_ssh_channel    PASSED    00:00:00.513
================= 93 test cases: 93 succeeded in 00:00:06.946 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.808
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.204
================== 2 test cases: 2 succeeded in 00:00:01.204 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
native_app     test_template          PASSED    00:00:00.573
native_app     test_path_params       PASSED    00:00:00.580
native_app     test_digest_vectors    PASSED    00:00:00.525
native_app     test_form_params       PASSED    00:00:00.569
...
native_app     test_middleware        PASSED    00:00:00.587
native_app     test_digest_auth       PASSED    00:00:00.608
native_app     test_web_terminal      PASSED    00:00:00.588
native_app     test_defer             PASSED    00:00:00.552
native_app     test_multipart         PASSED    00:00:00.579
native_app     test_auth              PASSED    00:00:00.574
native_app     test_file_serving      PASSED    00:00:00.597
native_app     test_dispatch          PASSED    00:00:00.567
native_app     test_chunked           PASSED    00:00:00.580
native_app     test_application       PASSED    00:00:00.653
================ 219 test cases: 219 succeeded in 00:00:10.919 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
----- native_webdav_handler:test_webdav_handler [PASSED] Took 1.12 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.123
================= 12 test cases: 12 succeeded in 00:00:01.123 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
--------------- native_diag:test_diag [PASSED] Took 1.08 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.076
...
------------- native_snmp:test_snmp_ber [PASSED] Took 0.65 seconds -------------
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.647
native_snmp    test_snmp_agent  PASSED    00:00:00.480
================= 29 test cases: 29 succeeded in 00:00:01.128 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.554
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.750
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.707
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.618
================= 19 test cases: 19 succeeded in 00:00:00.618 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.629
================= 18 test cases: 18 succeeded in 00:00:00.629 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.608
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.614
...
------------ native_mqtt_sn:test_mqtt_sn [PASSED] Took 0.61 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.612
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.606
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.620
================= 11 test cases: 11 succeeded in 00:00:00.620 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.588
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.607
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.607
================== 7 test cases: 7 succeeded in 00:00:00.607 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.588
...
test/test_hostlink/test_hostlink.cpp:30: test_build_dm_read: Expected '@00RD0000001057*\r' Was '@00RD0000001057*\r\x8A\xDDZ\xFC\x7F' [FAILED]
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  ERRORED   00:00:00.584

============= 8 test cases: 1 failed, 6 succeeded in 00:00:00.584 =============
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.650
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.603
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.603
...
------------- native_s7comm:test_s7comm [PASSED] Took 0.61 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.611
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.600
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.594
...
------ native_modbus_master:test_modbus_master [PASSED] Took 0.63 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.629
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.601
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.610
================== 2 test cases: 2 succeeded in 00:00:00.610 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.645
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.601
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.609
================= 13 test cases: 13 succeeded in 00:00:00.609 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.595
...
------------- native_oauth2:test_oauth2 [PASSED] Took 0.63 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.626
================== 8 test cases: 8 succeeded in 00:00:00.626 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.635
================= 29 test cases: 29 succeeded in 00:00:00.635 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.636
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.027
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:00.991
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.618
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.657
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.043
================== 3 test cases: 3 succeeded in 00:00:01.043 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.591
================= 10 test cases: 10 succeeded in 00:00:00.591 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.623
================= 15 test cases: 15 succeeded in 00:00:00.623 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.611
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.655
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.632
...
------------ native_inflate:test_inflate [PASSED] Took 0.61 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.611
...
------------ native_deflate:test_deflate [PASSED] Took 0.65 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.651
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.989
================= 71 test cases: 71 succeeded in 00:00:00.989 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.600
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.610
================= 14 test cases: 14 succeeded in 00:00:00.610 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.602
================= 10 test cases: 10 succeeded in 00:00:00.602 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
--------------- native_csrf:test_csrf [PASSED] Took 0.63 seconds ---------------
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.620
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.615
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.614
================== 5 test cases: 5 succeeded in 00:00:00.614 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.628
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.596
================= 15 test cases: 15 succeeded in 00:00:00.596 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.617
================== 8 test cases: 8 succeeded in 00:00:00.617 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.602
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.604
================== 4 test cases: 4 succeeded in 00:00:00.604 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 112 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.623
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.691
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.581
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.733
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.111
================== 2 test cases: 2 succeeded in 00:00:01.111 ==================
```
