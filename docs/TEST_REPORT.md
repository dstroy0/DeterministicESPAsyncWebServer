...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:06.215 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.432 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.442 |
| `test_transport`        | `native`              |    28 |   ✅   | 00:00:00.426 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.449 |
| `test_http_parser`      | `native`              |    80 |   ✅   | 00:00:00.453 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:02.890 |
...
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.428 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.709 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:00.947 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.811 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.448 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.473 |
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.452 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.467 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.463 |
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.461 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.448 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.446 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.470 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.445 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.454 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.440 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.447 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.448 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.456 |
| `test_application`      | `native_app`          |    49 |   ✅   | 00:00:00.522 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.568 |
...
------------------ native:test_sse [PASSED] Took 6.22 seconds ------------------
...
---------------- native:test_session [PASSED] Took 0.43 seconds ----------------
...
------------- native:test_presentation [PASSED] Took 0.44 seconds --------------
...
--------------- native:test_transport [PASSED] Took 0.43 seconds ---------------
...
--------------- native:test_websocket [PASSED] Took 0.45 seconds ---------------
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 0.95 seconds -----------
...
----------- native_app:test_web_terminal [PASSED] Took 0.44 seconds ------------
...
------------- native_app:test_multipart [PASSED] Took 0.45 seconds -------------
...
--------------- native_app:test_auth [PASSED] Took 0.44 seconds ----------------
...
----------- native_app:test_file_serving [PASSED] Took 0.45 seconds ------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:06.215
native               test_session           PASSED    00:00:00.432
native               test_presentation      PASSED    00:00:00.442
native               test_transport         PASSED    00:00:00.426
native               test_websocket         PASSED    00:00:00.449
native               test_http_parser       PASSED    00:00:00.453
native_ssh           test_ssh_crypto        PASSED    00:00:02.890
...
native_ssh           test_ssh_channel       PASSED    00:00:00.428
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.709
native_ssh_conn      test_ssh_conn          PASSED    00:00:00.947
native_app           test_regex             PASSED    00:00:00.811
native_app           test_template          PASSED    00:00:00.448
native_app           test_path_params       PASSED    00:00:00.473
native_app           test_digest_vectors    PASSED    00:00:00.452
native_app           test_form_params       PASSED    00:00:00.467
native_app           test_iface             PASSED    00:00:00.463
native_app           test_json              PASSED    00:00:00.461
native_app           test_response_headers  PASSED    00:00:00.448
native_app           test_middleware        PASSED    00:00:00.446
native_app           test_digest_auth       PASSED    00:00:00.470
native_app           test_web_terminal      PASSED    00:00:00.445
native_app           test_multipart         PASSED    00:00:00.454
native_app           test_auth              PASSED    00:00:00.440
native_app           test_file_serving      PASSED    00:00:00.447
native_app           test_dispatch          PASSED    00:00:00.448
native_app           test_chunked           PASSED    00:00:00.456
native_app           test_application       PASSED    00:00:00.522
native_compliance    test_compliance        PASSED    00:00:00.568
================ 594 test cases: 594 succeeded in 00:00:23.803 ================
```
