...
**Generated:** 2026-07-04 23:33:21
**Command:** `pio test` over 130 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 2055 passed - 261s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:06.341 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.696 |
...
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.749 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.740 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.739 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.745 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.773 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.739 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.762 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.755 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.758 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.751 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.113 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.625 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.693 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.662 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.689 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.642 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.857 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:01.059 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.776 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.760 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:04.121 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.695 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.958 |
| `test_ssh_transport`     | `native_ssh`            |    31 |   ✅   | 00:00:01.204 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.675 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.052 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.502 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.289 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.678 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.669 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.617 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.676 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.669 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.645 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.655 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.673 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.699 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.691 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.676 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.687 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.678 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.713 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.700 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.678 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.760 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.321 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.271 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.785 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.597 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:02.072 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.926 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.881 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.833 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.767 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.741 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.832 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.764 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.757 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.773 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.781 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.757 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.796 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.847 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.884 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.838 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.742 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.757 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.732 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.725 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.721 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.719 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.739 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.741 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.779 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.750 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.736 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.748 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.714 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.731 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.740 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.758 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.827 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.745 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.753 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.771 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.731 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.707 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.710 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.727 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.746 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.751 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.751 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.774 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.780 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.726 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.752 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.720 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.707 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.734 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.752 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.973 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.734 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.771 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.737 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.757 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.790 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.753 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.185 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.180 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.743 |
| `test_smtp`              | `native_smtp`           |    11 |   ✅   | 00:00:00.850 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.722 |
...
| `test_mpr121`            | `native_mpr121`         |     5 |   ✅   | 00:00:00.725 |
| `test_sht3x`             | `native_sht3x`          |     5 |   ✅   | 00:00:00.727 |
| `test_pca9685`           | `native_pca9685`        |     4 |   ✅   | 00:00:00.733 |
| `test_ads1115`           | `native_ads1115`        |     3 |   ✅   | 00:00:00.731 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.782 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.310 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.745 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.722 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.705 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.763 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.768 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.732 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.715 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.781 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.110 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.710 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.724 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.746 |
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.757 |
...
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.714 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.728 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.732 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.721 |
| `test_statsd`            | `native_statsd`         |     9 |   ✅   | 00:00:00.744 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.723 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.698 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.727 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.856 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.694 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.865 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.332 |
...
------------ native_canopen:test_canopen [PASSED] Took 6.34 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.341
================= 17 test cases: 17 succeeded in 00:00:06.341 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.696
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.749
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.740
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.773
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.739
================== 8 test cases: 8 succeeded in 00:00:00.739 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.762
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.758
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.751
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.113
native         test_session       PASSED    00:00:00.625
native         test_presentation  PASSED    00:00:00.693
native         test_transport     PASSED    00:00:00.662
native         test_websocket     PASSED    00:00:00.689
native         test_http_parser   PASSED    00:00:00.642
================ 323 test cases: 323 succeeded in 00:00:04.423 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
------ native_observability:test_observability [PASSED] Took 0.86 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.857
================= 17 test cases: 17 succeeded in 00:00:00.857 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.059
================= 13 test cases: 13 succeeded in 00:00:01.059 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.776
...
----------- native_prov:test_provisioning [PASSED] Took 0.76 seconds -----------

=================================== SUMMARY ===================================
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.760
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 4.12 seconds -------------
...
------------ native_ssh:test_ssh_channel [PASSED] Took 0.67 seconds ------------

=================================== SUMMARY ===================================
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.121
native_ssh     test_ssh_auth       PASSED    00:00:00.695
native_ssh     test_ssh_server     PASSED    00:00:00.958
native_ssh     test_ssh_transport  PASSED    00:00:01.204
native_ssh     test_ssh_channel    PASSED    00:00:00.675
================ 137 test cases: 137 succeeded in 00:00:07.653 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:01.052
================== 2 test cases: 2 succeeded in 00:00:01.052 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.502
================== 2 test cases: 2 succeeded in 00:00:01.502 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
--------------- native_app:test_regex [PASSED] Took 1.29 seconds ---------------
...
--------------- native_app:test_json [PASSED] Took 0.64 seconds ----------------
...
----------- native_app:test_file_serving [PASSED] Took 0.71 seconds ------------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.289
native_app     test_template          PASSED    00:00:00.678
native_app     test_path_params       PASSED    00:00:00.669
native_app     test_digest_vectors    PASSED    00:00:00.617
native_app     test_form_params       PASSED    00:00:00.676
native_app     test_iface             PASSED    00:00:00.669
native_app     test_json              PASSED    00:00:00.645
native_app     test_response_headers  PASSED    00:00:00.655
native_app     test_middleware        PASSED    00:00:00.673
native_app     test_digest_auth       PASSED    00:00:00.699
native_app     test_web_terminal      PASSED    00:00:00.691
native_app     test_defer             PASSED    00:00:00.676
native_app     test_multipart         PASSED    00:00:00.687
native_app     test_auth              PASSED    00:00:00.678
native_app     test_file_serving      PASSED    00:00:00.713
native_app     test_dispatch          PASSED    00:00:00.700
native_app     test_chunked           PASSED    00:00:00.678
native_app     test_application       PASSED    00:00:00.760
================ 225 test cases: 225 succeeded in 00:00:12.853 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.321
================= 12 test cases: 12 succeeded in 00:00:01.321 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.271
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.785
native_snmp    test_snmp_agent  PASSED    00:00:00.597
================= 35 test cases: 35 succeeded in 00:00:01.382 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:02.072
================= 15 test cases: 15 succeeded in 00:00:02.072 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.926
================= 15 test cases: 15 succeeded in 00:00:00.926 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.833
================= 41 test cases: 41 succeeded in 00:00:00.833 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.767
================= 19 test cases: 19 succeeded in 00:00:00.767 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.741
...
-------- native_cloudevents:test_cloudevents [PASSED] Took 0.83 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.832
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.757
...
-------- native_flow_export:test_flow_export [PASSED] Took 0.78 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.781
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.757
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.847
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.838
================= 11 test cases: 11 succeeded in 00:00:00.838 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.757
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_pn532   test_pn532  PASSED    00:00:00.725
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.721
...
------------- native_zigbee:test_zigbee [PASSED] Took 0.74 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_zigbee  test_zigbee  PASSED    00:00:00.739
...
------------- native_thread:test_thread [PASSED] Took 0.74 seconds -------------
...
================= 12 test cases: 12 succeeded in 00:00:00.779 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.736
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.748
...
---------- native_lwm2m_tlv:test_lwm2m_tlv [PASSED] Took 0.73 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.731
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.758
================== 7 test cases: 7 succeeded in 00:00:00.758 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.827
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.771
...
------------- native_melsec:test_melsec [PASSED] Took 0.73 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.731
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.727
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.746
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.751
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.774
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.780
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.726
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.752
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.734
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.973
================= 17 test cases: 17 succeeded in 00:00:00.973 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.737
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.757
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.790
================= 38 test cases: 38 succeeded in 00:00:00.790 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.753
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.180
================= 13 test cases: 13 succeeded in 00:00:01.180 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.743
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_smtp    test_smtp  PASSED    00:00:00.850
================= 11 test cases: 11 succeeded in 00:00:00.850 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
--------- native_ntp_server:test_ntp_server [PASSED] Took 0.72 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_ntp_server  test_ntp_server  PASSED    00:00:00.722
...
------------- native_mpr121:test_mpr121 [PASSED] Took 0.72 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_mpr121  test_mpr121  PASSED    00:00:00.725
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sht3x   test_sht3x  PASSED    00:00:00.727
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.782
================= 21 test cases: 21 succeeded in 00:00:00.782 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
-------- native_http_client:test_http_client [PASSED] Took 0.74 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.745
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.722
================= 15 test cases: 15 succeeded in 00:00:00.722 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.705
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.768
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.732
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.781
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.110
================= 71 test cases: 71 succeeded in 00:00:01.110 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.710
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.724
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.746
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.757
...
---------- native_telemetry:test_telemetry [PASSED] Took 0.77 seconds ----------
...
================= 18 test cases: 18 succeeded in 00:00:00.714 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.728
================= 17 test cases: 17 succeeded in 00:00:00.728 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_statsd  test_statsd  PASSED    00:00:00.744
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.723
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.727
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.856
================== 3 test cases: 3 succeeded in 00:00:00.856 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 155 tests
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.332
================== 2 test cases: 2 succeeded in 00:00:01.332 ==================
```
