...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:13.701 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.573 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.610 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.595 |
| `test_websocket`         | `native`               |    67 |   ✅   | 00:00:00.614 |
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.571 |
| `test_observability`     | `native_observability` |    15 |   ✅   | 00:00:00.709 |
| `test_http_ota`          | `native_ota`           |     3 |   ✅   | 00:00:00.654 |
| `test_provisioning`      | `native_prov`          |     5 |   ✅   | 00:00:00.644 |
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.894 |
| `test_ssh_auth`          | `native_ssh`           |    12 |   ✅   | 00:00:00.565 |
| `test_ssh_server`        | `native_ssh`           |     7 |   ✅   | 00:00:00.669 |
| `test_ssh_transport`     | `native_ssh`           |    23 |   ✅   | 00:00:00.883 |
| `test_ssh_channel`       | `native_ssh`           |    12 |   ✅   | 00:00:00.527 |
| `test_ssh_hardening`     | `native_ssh_hardened`  |     2 |   ✅   | 00:00:00.868 |
| `test_ssh_conn`          | `native_ssh_conn`      |     2 |   ✅   | 00:00:01.242 |
| `test_regex`             | `native_app`           |     9 |   ✅   | 00:00:01.115 |
| `test_template`          | `native_app`           |     6 |   ✅   | 00:00:00.595 |
| `test_path_params`       | `native_app`           |     8 |   ✅   | 00:00:00.592 |
| `test_digest_vectors`    | `native_app`           |     4 |   ✅   | 00:00:00.529 |
| `test_form_params`       | `native_app`           |     5 |   ✅   | 00:00:00.590 |
| `test_iface`             | `native_app`           |     7 |   ✅   | 00:00:00.596 |
| `test_json`              | `native_app`           |    17 |   ✅   | 00:00:00.536 |
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.596 |
| `test_middleware`        | `native_app`           |     9 |   ✅   | 00:00:00.601 |
| `test_digest_auth`       | `native_app`           |    10 |   ✅   | 00:00:00.603 |
| `test_web_terminal`      | `native_app`           |     7 |   ✅   | 00:00:00.587 |
| `test_defer`             | `native_app`           |     3 |   ✅   | 00:00:00.570 |
| `test_multipart`         | `native_app`           |    19 |   ✅   | 00:00:00.616 |
| `test_auth`              | `native_app`           |    13 |   ✅   | 00:00:00.594 |
| `test_file_serving`      | `native_app`           |    12 |   ✅   | 00:00:00.610 |
| `test_dispatch`          | `native_app`           |    11 |   ✅   | 00:00:00.595 |
| `test_chunked`           | `native_app`           |    10 |   ✅   | 00:00:00.604 |
| `test_application`       | `native_app`           |    52 |   ✅   | 00:00:00.674 |
| `test_diag`              | `native_diag`          |     2 |   ✅   | 00:00:01.134 |
| `test_snmp_ber`          | `native_snmp`          |    15 |   ✅   | 00:00:00.680 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.492 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.375 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.787 |
| `test_coap`              | `native_coap`          |    27 |   ✅   | 00:00:00.663 |
| `test_coap`              | `native_coap_observe`  |    27 |   ✅   | 00:00:00.674 |
| `test_webdav`            | `native_webdav`        |    19 |   ✅   | 00:00:00.667 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.645 |
| `test_modbus_master`     | `native_modbus_master` |     5 |   ✅   | 00:00:00.671 |
| `test_ota_rollback`      | `native_ota_rollback`  |     5 |   ✅   | 00:00:00.642 |
| `test_totp`              | `native_totp`          |     4 |   ✅   | 00:00:00.662 |
...
| `test_audit_log`         | `native_audit_log`     |    12 |   ✅   | 00:00:00.678 |
| `test_oidc`              | `native_oidc`          |    13 |   ✅   | 00:00:00.829 |
| `test_vfs`               | `native_vfs`           |    11 |   ✅   | 00:00:00.647 |
| `test_graphql`           | `native_graphql`       |    13 |   ✅   | 00:00:00.645 |
| `test_espnow`            | `native_espnow`        |     7 |   ✅   | 00:00:00.640 |
| `test_oauth2`            | `native_oauth2`        |     8 |   ✅   | 00:00:00.667 |
| `test_opcua`             | `native_opcua`         |    29 |   ✅   | 00:00:00.668 |
| `test_opcua_client`      | `native_opcua_client`  |    11 |   ✅   | 00:00:00.687 |
| `test_keepalive`         | `native_keepalive`     |    10 |   ✅   | 00:00:01.072 |
| `test_range`             | `native_range`         |    13 |   ✅   | 00:00:01.074 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.660 |
| `test_jwt`               | `native_jwt`           |    11 |   ✅   | 00:00:00.691 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.139 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.652 |
| `test_compliance`        | `native_compliance`    |    15 |   ✅   | 00:00:00.659 |
| `test_mqtt`              | `native_mqtt`          |    17 |   ✅   | 00:00:00.664 |
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.682 |
...
| `test_deflate`           | `native_deflate`       |    10 |   ✅   | 00:00:00.686 |
...
| `test_device_id`         | `native_device_id`     |     4 |   ✅   | 00:00:00.661 |
| `test_auth_lockout`      | `native_auth_lockout`  |    10 |   ✅   | 00:00:00.647 |
| `test_csrf`              | `native_csrf`          |     9 |   ✅   | 00:00:00.673 |
| `test_telemetry`         | `native_telemetry`     |     8 |   ✅   | 00:00:00.660 |
| `test_dashboard`         | `native_dashboard`     |    11 |   ✅   | 00:00:00.644 |
| `test_net_egress`        | `native_net_egress`    |     5 |   ✅   | 00:00:00.643 |
| `test_partition_monitor` | `native_partition`     |     5 |   ✅   | 00:00:00.634 |
...
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.644 |
| `test_guardrails`        | `native_guardrails`    |     6 |   ✅   | 00:00:00.639 |
| `test_logbuf`            | `native_logbuf`        |     4 |   ✅   | 00:00:00.646 |
| `test_config_io`         | `native_config_io`     |     4 |   ✅   | 00:00:00.660 |
| `test_workers`           | `native_workers`       |     3 |   ✅   | 00:00:00.752 |
| `test_clock`             | `native_clock`         |     4 |   ✅   | 00:00:00.627 |
| `test_concurrency`       | `native_concurrency`   |     2 |   ✅   | 00:00:00.862 |
| `test_concurrency`       | `native_tsan`          |     2 |   ✅   | 00:00:01.193 |
...
----------------- native:test_sse [PASSED] Took 13.70 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:13.701
...
native         test_websocket     PASSED    00:00:00.614
native         test_http_parser   PASSED    00:00:00.571
================ 310 test cases: 310 succeeded in 00:00:16.665 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.654
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.894
...
native_ssh     test_ssh_channel    PASSED    00:00:00.527
================= 92 test cases: 92 succeeded in 00:00:06.538 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.115
native_app     test_template          PASSED    00:00:00.595
native_app     test_path_params       PASSED    00:00:00.592
native_app     test_digest_vectors    PASSED    00:00:00.529
...
native_app     test_digest_auth       PASSED    00:00:00.603
native_app     test_web_terminal      PASSED    00:00:00.587
native_app     test_defer             PASSED    00:00:00.570
native_app     test_multipart         PASSED    00:00:00.616
native_app     test_auth              PASSED    00:00:00.594
...
================ 211 test cases: 211 succeeded in 00:00:11.204 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.134
================== 2 test cases: 2 succeeded in 00:00:01.134 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
native_snmp    test_snmp_agent  PASSED    00:00:00.492
================= 28 test cases: 28 succeeded in 00:00:01.172 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 1.37 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.375
================== 9 test cases: 9 succeeded in 00:00:01.375 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.663
================= 27 test cases: 27 succeeded in 00:00:00.663 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
================= 27 test cases: 27 succeeded in 00:00:00.674 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.642
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.662
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.645
================= 13 test cases: 13 succeeded in 00:00:00.645 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.668
================= 29 test cases: 29 succeeded in 00:00:00.668 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.072
================= 10 test cases: 10 succeeded in 00:00:01.072 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.074
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.660
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.691
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.652
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.682
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.686
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.661
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.673
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.644
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.634
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.644
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.660
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.752
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.193
