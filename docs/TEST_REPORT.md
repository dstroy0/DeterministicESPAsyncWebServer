...
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.665 |
...
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.589 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.730 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:00.967 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.662 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.660 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.872 |
| `test_ssh_auth`          | `native_ssh`            |    18 |   ✅   | 00:00:00.579 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.827 |
| `test_ssh_transport`     | `native_ssh`            |    27 |   ✅   | 00:00:01.039 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.569 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.872 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.263 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.174 |
...
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.598 |
...
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.600 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.581 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.604 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.602 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.622 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.595 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.609 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.680 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.197 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.148 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.684 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.510 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:01.954 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.794 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.759 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.742 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.671 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.655 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.713 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.660 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.653 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.652 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.644 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.646 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.673 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.754 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.815 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.748 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.658 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.696 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.668 |
...
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.661 |
...
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.638 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.665 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.646 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.658 |
...
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.639 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.657 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.652 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.645 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.649 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.688 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.887 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.647 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.667 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.652 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.676 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.687 |
...
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.652 |
| `test_jwt`               | `native_jwt`            |    16 |   ✅   | 00:00:00.703 |
...
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.678 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.664 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.637 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.690 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.035 |
...
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.691 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.664 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.640 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.648 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.653 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.655 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.661 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.651 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.647 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.643 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.645 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.658 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.745 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.640 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.805 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.751 |
...
----------- native_canopen:test_canopen [PASSED] Took 16.19 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:16.192
================= 17 test cases: 17 succeeded in 00:00:16.192 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.640
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.665
...
native         test_http_parser   PASSED    00:00:00.589
================ 321 test cases: 321 succeeded in 00:00:03.985 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.967
================= 10 test cases: 10 succeeded in 00:00:00.967 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.872
native_ssh     test_ssh_auth       PASSED    00:00:00.579
native_ssh     test_ssh_server     PASSED    00:00:00.827
native_ssh     test_ssh_transport  PASSED    00:00:01.039
native_ssh     test_ssh_channel    PASSED    00:00:00.569
================ 120 test cases: 120 succeeded in 00:00:06.887 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.263
================== 2 test cases: 2 succeeded in 00:00:01.263 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.174
...
native_app     test_form_params       PASSED    00:00:00.598
...
native_app     test_web_terminal      PASSED    00:00:00.600
native_app     test_defer             PASSED    00:00:00.581
native_app     test_multipart         PASSED    00:00:00.604
...
native_app     test_chunked           PASSED    00:00:00.609
native_app     test_application       PASSED    00:00:00.680
================ 225 test cases: 225 succeeded in 00:00:11.431 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.684
native_snmp    test_snmp_agent  PASSED    00:00:00.510
================= 35 test cases: 35 succeeded in 00:00:01.193 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.954
================= 15 test cases: 15 succeeded in 00:00:01.954 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.759
================= 41 test cases: 41 succeeded in 00:00:00.759 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.742
================= 41 test cases: 41 succeeded in 00:00:00.742 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.655
================= 22 test cases: 22 succeeded in 00:00:00.655 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.713
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.652
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.646
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.673
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.815
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.658
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.668
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.661
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.638
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.658
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.639
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.657
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.652
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.649
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.887
================= 17 test cases: 17 succeeded in 00:00:00.887 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
================= 32 test cases: 32 succeeded in 00:00:00.667 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.687
================= 38 test cases: 38 succeeded in 00:00:00.687 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.652
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.678
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.637
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.690
================= 10 test cases: 10 succeeded in 00:00:00.690 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.035
================= 71 test cases: 71 succeeded in 00:00:01.035 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.691
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.640
================= 15 test cases: 15 succeeded in 00:00:00.640 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.655
================= 18 test cases: 18 succeeded in 00:00:00.655 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.661
================= 17 test cases: 17 succeeded in 00:00:00.661 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 133 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.647
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.643
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.658
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.745
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.805
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 1.75 seconds ------------

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.751
================== 2 test cases: 2 succeeded in 00:00:01.751 ==================
```
