...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:06.282 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.451 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.480 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.457 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.485 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.447 |
| `test_ssh_crypto`       | `native_ssh`          |    38 |   ✅   | 00:00:02.928 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.456 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.564 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.757 |
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.430 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.699 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:00.999 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:01.125 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.465 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.469 |
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.418 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.461 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.462 |
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.431 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.467 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.466 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.468 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.463 |
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.530 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.478 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.475 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.476 |
| `test_dispatch`         | `native_app`          |    11 |   ✅   | 00:00:00.468 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.458 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.551 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.504 |
| `test_workers`          | `native_workers`      |     3 |   ✅   | 00:00:00.584 |
| `test_concurrency`      | `native_tsan`         |     2 |   ✅   | 00:00:00.895 |
...
----------- native_ssh:test_ssh_transport [PASSED] Took 0.76 seconds -----------
...
------------ native_workers:test_workers [PASSED] Took 0.58 seconds ------------
...
----------- native_tsan:test_concurrency [PASSED] Took 0.89 seconds ------------

=================================== SUMMARY ===================================
Environment          Test                   Status    Duration
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:06.282
native               test_session           PASSED    00:00:00.451
native               test_presentation      PASSED    00:00:00.480
native               test_transport         PASSED    00:00:00.457
native               test_websocket         PASSED    00:00:00.485
native               test_http_parser       PASSED    00:00:00.447
native_ssh           test_ssh_crypto        PASSED    00:00:02.928
native_ssh           test_ssh_auth          PASSED    00:00:00.456
native_ssh           test_ssh_server        PASSED    00:00:00.564
native_ssh           test_ssh_transport     PASSED    00:00:00.757
native_ssh           test_ssh_channel       PASSED    00:00:00.430
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.699
native_ssh_conn      test_ssh_conn          PASSED    00:00:00.999
native_app           test_regex             PASSED    00:00:01.125
native_app           test_template          PASSED    00:00:00.465
native_app           test_path_params       PASSED    00:00:00.469
native_app           test_digest_vectors    PASSED    00:00:00.418
native_app           test_form_params       PASSED    00:00:00.461
native_app           test_iface             PASSED    00:00:00.462
native_app           test_json              PASSED    00:00:00.431
native_app           test_response_headers  PASSED    00:00:00.467
native_app           test_middleware        PASSED    00:00:00.466
native_app           test_digest_auth       PASSED    00:00:00.468
native_app           test_web_terminal      PASSED    00:00:00.463
native_app           test_defer             PASSED    00:00:00.530
native_app           test_multipart         PASSED    00:00:00.478
...
native_app           test_chunked           PASSED    00:00:00.458
native_app           test_application       PASSED    00:00:00.551
native_compliance    test_compliance        PASSED    00:00:00.504
native_workers       test_workers           PASSED    00:00:00.584
native_tsan          test_concurrency       PASSED    00:00:00.895
================ 621 test cases: 621 succeeded in 00:00:26.548 ================
```
