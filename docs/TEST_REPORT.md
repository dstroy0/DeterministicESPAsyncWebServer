...
**Generated:** 2026-07-04 19:30:35
**Command:** `pio test` over 121 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1999 passed - 153s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:10.052 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.401 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.422 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.414 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:01.945 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.415 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.414 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.412 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.424 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.422 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.431 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.414 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.410 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.416 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.411 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.420 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:00.626 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.345 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.364 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.361 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.379 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.353 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.481 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:00.622 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.426 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.418 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:01.890 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.372 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.475 |
| `test_ssh_transport`     | `native_ssh`            |    31 |   ✅   | 00:00:00.617 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.345 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.581 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:00.906 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.020 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.355 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.582 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.322 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.357 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.356 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.337 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.359 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.360 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.366 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.360 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.346 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.365 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.364 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.367 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.363 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.368 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.404 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.251 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.061 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.438 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.303 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:01.113 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.493 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.586 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.452 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.439 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.424 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.757 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.406 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.479 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.413 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:01.448 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.432 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.424 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.449 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.857 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.686 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.404 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.413 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.418 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.814 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.409 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.535 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.406 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.419 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.437 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.405 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.410 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.415 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.403 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.409 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.411 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.417 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.449 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.409 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.407 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.423 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.413 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.415 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.410 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.400 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.404 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.415 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.411 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.428 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.431 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.413 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.425 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.415 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.408 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.416 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.425 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.536 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.419 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.429 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.413 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.423 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.430 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.438 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:00.659 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:00.668 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.424 |
| `test_smtp`              | `native_smtp`           |    11 |   ✅   | 00:00:00.465 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.453 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:00.681 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.417 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.427 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.421 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.439 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.517 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.420 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.417 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.436 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:00.637 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.414 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.418 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.423 |
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.429 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.438 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.413 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.415 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.415 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.424 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.410 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.434 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.414 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.417 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.417 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.408 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.427 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.478 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.402 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.480 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:00.739 |
...
----------- native_canopen:test_canopen [PASSED] Took 10.05 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:10.052
================= 17 test cases: 17 succeeded in 00:00:10.052 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
----- native_det_primitives:test_det_primitives [PASSED] Took 0.40 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.401
================== 5 test cases: 5 succeeded in 00:00:00.401 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------- native_det_ip:test_det_ip [PASSED] Took 0.42 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.422
================= 10 test cases: 10 succeeded in 00:00:00.422 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
---------- native_det_arena:test_det_arena [PASSED] Took 0.41 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_det_arena  test_det_arena  PASSED    00:00:00.414
================= 17 test cases: 17 succeeded in 00:00:00.414 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
-------- native_ssh_ed25519:test_ssh_ed25519 [PASSED] Took 1.94 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:01.945
================= 16 test cases: 16 succeeded in 00:00:01.945 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------ native_promisc:test_promisc [PASSED] Took 0.41 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.415
================== 8 test cases: 8 succeeded in 00:00:00.415 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
-------- native_bus_capture:test_bus_capture [PASSED] Took 0.41 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.414
================== 5 test cases: 5 succeeded in 00:00:00.414 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
-------------- native_j1939:test_j1939 [PASSED] Took 0.41 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.412
================== 9 test cases: 9 succeeded in 00:00:00.412 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
---------- native_devicenet:test_devicenet [PASSED] Took 0.42 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.424
================== 8 test cases: 8 succeeded in 00:00:00.424 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
----------- native_nmea2000:test_nmea2000 [PASSED] Took 0.42 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.422
================== 6 test cases: 6 succeeded in 00:00:00.422 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
--------------- native_mbus:test_mbus [PASSED] Took 0.43 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.431
================= 11 test cases: 11 succeeded in 00:00:00.431 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
----------- native_iec60870:test_iec60870 [PASSED] Took 0.41 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.414
================== 8 test cases: 8 succeeded in 00:00:00.414 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
-------------- native_sdi12:test_sdi12 [PASSED] Took 0.41 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.410
================== 6 test cases: 6 succeeded in 00:00:00.410 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
---------------- native_dmx:test_dmx [PASSED] Took 0.42 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.416
================== 5 test cases: 5 succeeded in 00:00:00.416 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
----------- native_nmea0183:test_nmea0183 [PASSED] Took 0.41 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.411
================== 7 test cases: 7 succeeded in 00:00:00.411 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------- native_iolink:test_iolink [PASSED] Took 0.42 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.420
================== 5 test cases: 5 succeeded in 00:00:00.420 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------------ native:test_sse [PASSED] Took 0.63 seconds ------------------
...
---------------- native:test_session [PASSED] Took 0.35 seconds ----------------
...
------------- native:test_presentation [PASSED] Took 0.36 seconds --------------
...
--------------- native:test_transport [PASSED] Took 0.36 seconds ---------------
...
--------------- native:test_websocket [PASSED] Took 0.38 seconds ---------------
...
-------------- native:test_http_parser [PASSED] Took 0.35 seconds --------------

=================================== SUMMARY ===================================
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:00.626
native         test_session       PASSED    00:00:00.345
native         test_presentation  PASSED    00:00:00.364
native         test_transport     PASSED    00:00:00.361
native         test_websocket     PASSED    00:00:00.379
native         test_http_parser   PASSED    00:00:00.353
================ 323 test cases: 323 succeeded in 00:00:02.427 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------ native_observability:test_observability [PASSED] Took 0.48 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.481
================= 17 test cases: 17 succeeded in 00:00:00.481 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
-------- native_accept_gate:test_accept_gate [PASSED] Took 0.62 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.622
...
------------- native_ota:test_http_ota [PASSED] Took 0.43 seconds --------------

=================================== SUMMARY ===================================
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.426
================== 3 test cases: 3 succeeded in 00:00:00.426 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
----------- native_prov:test_provisioning [PASSED] Took 0.42 seconds -----------

=================================== SUMMARY ===================================
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.418
================== 5 test cases: 5 succeeded in 00:00:00.418 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 1.89 seconds -------------
...
------------- native_ssh:test_ssh_auth [PASSED] Took 0.37 seconds --------------
...
------------ native_ssh:test_ssh_server [PASSED] Took 0.47 seconds -------------
...
----------- native_ssh:test_ssh_transport [PASSED] Took 0.62 seconds -----------
...
------------ native_ssh:test_ssh_channel [PASSED] Took 0.34 seconds ------------

=================================== SUMMARY ===================================
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:01.890
native_ssh     test_ssh_auth       PASSED    00:00:00.372
native_ssh     test_ssh_server     PASSED    00:00:00.475
native_ssh     test_ssh_transport  PASSED    00:00:00.617
native_ssh     test_ssh_channel    PASSED    00:00:00.345
================ 137 test cases: 137 succeeded in 00:00:03.698 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------ native_ssh_hardened:test_ssh_hardening [PASSED] Took 0.58 seconds -------

=================================== SUMMARY ===================================
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.581
================== 2 test cases: 2 succeeded in 00:00:00.581 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 0.91 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:00.906
================== 2 test cases: 2 succeeded in 00:00:00.906 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
--------------- native_app:test_regex [PASSED] Took 1.02 seconds ---------------
...
------------- native_app:test_template [PASSED] Took 0.35 seconds --------------
...
---------- native_app:test_digest_vectors [PASSED] Took 0.32 seconds -----------
...
------------ native_app:test_form_params [PASSED] Took 0.36 seconds ------------
...
--------------- native_app:test_iface [PASSED] Took 0.36 seconds ---------------
...
--------------- native_app:test_json [PASSED] Took 0.34 seconds ----------------
...
--------- native_app:test_response_headers [PASSED] Took 0.36 seconds ----------
...
------------ native_app:test_middleware [PASSED] Took 0.36 seconds -------------
...
------------ native_app:test_digest_auth [PASSED] Took 0.37 seconds ------------
...
----------- native_app:test_web_terminal [PASSED] Took 0.36 seconds ------------
...
--------------- native_app:test_defer [PASSED] Took 0.35 seconds ---------------
...
------------- native_app:test_multipart [PASSED] Took 0.36 seconds -------------
...
--------------- native_app:test_auth [PASSED] Took 0.36 seconds ----------------
...
----------- native_app:test_file_serving [PASSED] Took 0.37 seconds ------------
...
------------- native_app:test_dispatch [PASSED] Took 0.36 seconds --------------
...
-------------- native_app:test_chunked [PASSED] Took 0.37 seconds --------------
...
------------ native_app:test_application [PASSED] Took 0.40 seconds ------------

=================================== SUMMARY ===================================
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.020
native_app     test_template          PASSED    00:00:00.355
native_app     test_path_params       PASSED    00:00:00.582
native_app     test_digest_vectors    PASSED    00:00:00.322
native_app     test_form_params       PASSED    00:00:00.357
native_app     test_iface             PASSED    00:00:00.356
native_app     test_json              PASSED    00:00:00.337
native_app     test_response_headers  PASSED    00:00:00.359
native_app     test_middleware        PASSED    00:00:00.360
native_app     test_digest_auth       PASSED    00:00:00.366
native_app     test_web_terminal      PASSED    00:00:00.360
native_app     test_defer             PASSED    00:00:00.346
native_app     test_multipart         PASSED    00:00:00.365
native_app     test_auth              PASSED    00:00:00.364
native_app     test_file_serving      PASSED    00:00:00.367
native_app     test_dispatch          PASSED    00:00:00.363
native_app     test_chunked           PASSED    00:00:00.368
native_app     test_application       PASSED    00:00:00.404
================ 225 test cases: 225 succeeded in 00:00:07.351 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.251
================= 12 test cases: 12 succeeded in 00:00:01.251 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
--------------- native_diag:test_diag [PASSED] Took 1.06 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.061
================== 2 test cases: 2 succeeded in 00:00:01.061 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------- native_snmp:test_snmp_ber [PASSED] Took 0.44 seconds -------------
...
------------ native_snmp:test_snmp_agent [PASSED] Took 0.30 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.438
native_snmp    test_snmp_agent  PASSED    00:00:00.303
================= 35 test cases: 35 succeeded in 00:00:00.741 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 1.11 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.113
================= 15 test cases: 15 succeeded in 00:00:01.113 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------- native_telnet:test_telnet [PASSED] Took 0.49 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.493
================= 15 test cases: 15 succeeded in 00:00:00.493 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.586
================= 41 test cases: 41 succeeded in 00:00:00.586 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
test/test_coap/test_coap.cpp:1076: test_well_known_core_discovery       [PASSED]
test/test_coap/test_coap.cpp:1077: test_well_known_core_rejects_post    [PASSED]
----------- native_coap_observe:test_coap [PASSED] Took 0.45 seconds -----------

=================================== SUMMARY ===================================
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.452
================= 41 test cases: 41 succeeded in 00:00:00.452 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------- native_webdav:test_webdav [PASSED] Took 0.44 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.439
================= 19 test cases: 19 succeeded in 00:00:00.439 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------- native_modbus:test_modbus [PASSED] Took 0.42 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.424
================= 22 test cases: 22 succeeded in 00:00:00.424 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.757
...
----------- native_redis:test_redis_resp [PASSED] Took 0.41 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.406
================== 8 test cases: 8 succeeded in 00:00:00.406 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
-------------- native_stomp:test_stomp [PASSED] Took 0.48 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.479
================= 14 test cases: 14 succeeded in 00:00:00.479 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------ native_mqtt_sn:test_mqtt_sn [PASSED] Took 0.41 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.413
================= 13 test cases: 13 succeeded in 00:00:00.413 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
-------- native_flow_export:test_flow_export [PASSED] Took 1.45 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:01.448
================== 6 test cases: 6 succeeded in 00:00:01.448 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
----------- native_protobuf:test_protobuf [PASSED] Took 0.43 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.432
================= 13 test cases: 13 succeeded in 00:00:00.432 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------ native_preempt_queue:test_preempt_queue [PASSED] Took 0.42 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.424
================= 11 test cases: 11 succeeded in 00:00:00.424 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
---------------- native_dma:test_dma [PASSED] Took 0.45 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.449
================= 11 test cases: 11 succeeded in 00:00:00.449 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.857
================= 16 test cases: 16 succeeded in 00:00:00.857 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
--------------- native_lora:test_lora [PASSED] Took 0.40 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.404
================= 13 test cases: 13 succeeded in 00:00:00.404 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
-------------- native_nrf24:test_nrf24 [PASSED] Took 0.41 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.413
================= 10 test cases: 10 succeeded in 00:00:00.413 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------ native_enocean:test_enocean [PASSED] Took 0.42 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.418
================== 9 test cases: 9 succeeded in 00:00:00.418 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
-------------- native_pn532:test_pn532 [PASSED] Took 0.81 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_pn532   test_pn532  PASSED    00:00:00.814
================= 10 test cases: 10 succeeded in 00:00:00.814 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------- native_sigfox:test_sigfox [PASSED] Took 0.41 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.409
================== 7 test cases: 7 succeeded in 00:00:00.409 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
-------------- native_zwave:test_zwave [PASSED] Took 0.54 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.535
================== 9 test cases: 9 succeeded in 00:00:00.535 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------- native_zigbee:test_zigbee [PASSED] Took 0.41 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_zigbee  test_zigbee  PASSED    00:00:00.406
================== 9 test cases: 9 succeeded in 00:00:00.406 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------- native_thread:test_thread [PASSED] Took 0.42 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.419
================= 13 test cases: 13 succeeded in 00:00:00.419 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
--------------- native_wamp:test_wamp [PASSED] Took 0.44 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.437
================= 12 test cases: 12 succeeded in 00:00:00.437 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------ native_sunspec:test_sunspec [PASSED] Took 0.40 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.405
================== 5 test cases: 5 succeeded in 00:00:00.405 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------- native_c37118:test_c37118 [PASSED] Took 0.41 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.410
================== 6 test cases: 6 succeeded in 00:00:00.410 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
--------------- native_dnp3:test_dnp3 [PASSED] Took 0.42 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.415
================== 8 test cases: 8 succeeded in 00:00:00.415 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------ native_grpcweb:test_grpcweb [PASSED] Took 0.40 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.403
================== 7 test cases: 7 succeeded in 00:00:00.403 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
---------- native_lwm2m_tlv:test_lwm2m_tlv [PASSED] Took 0.41 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.409
================= 11 test cases: 11 succeeded in 00:00:00.409 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
--------------- native_fins:test_fins [PASSED] Took 0.41 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.411
================== 6 test cases: 6 succeeded in 00:00:00.411 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
----------- native_hostlink:test_hostlink [PASSED] Took 0.42 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.417
================== 7 test cases: 7 succeeded in 00:00:00.417 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
-------------- native_senml:test_senml [PASSED] Took 0.45 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.449
================== 9 test cases: 9 succeeded in 00:00:00.449 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
---------------- native_df1:test_df1 [PASSED] Took 0.41 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.409
================== 9 test cases: 9 succeeded in 00:00:00.409 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
--------------- native_cotp:test_cotp [PASSED] Took 0.41 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.407
================== 6 test cases: 6 succeeded in 00:00:00.407 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------- native_s7comm:test_s7comm [PASSED] Took 0.42 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.423
================== 8 test cases: 8 succeeded in 00:00:00.423 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------- native_melsec:test_melsec [PASSED] Took 0.41 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.413
================== 6 test cases: 6 succeeded in 00:00:00.413 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------- native_bacnet:test_bacnet [PASSED] Took 0.42 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.415
================== 9 test cases: 9 succeeded in 00:00:00.415 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
--------------- native_enip:test_enip [PASSED] Took 0.41 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.410
================== 6 test cases: 6 succeeded in 00:00:00.410 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
--------------- native_amqp:test_amqp [PASSED] Took 0.40 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.400
================== 7 test cases: 7 succeeded in 00:00:00.400 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
---------------- native_cip:test_cip [PASSED] Took 0.40 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.404
================== 9 test cases: 9 succeeded in 00:00:00.404 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
--------------- native_nats:test_nats [PASSED] Took 0.42 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.415
================= 14 test cases: 14 succeeded in 00:00:00.415 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
----- native_proxy_protocol:test_proxy_protocol [PASSED] Took 0.41 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.411
================== 8 test cases: 8 succeeded in 00:00:00.411 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
---------- native_sparkplug:test_sparkplug [PASSED] Took 0.43 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.428
================== 7 test cases: 7 succeeded in 00:00:00.428 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------ native_modbus_master:test_modbus_master [PASSED] Took 0.43 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.431
================== 5 test cases: 5 succeeded in 00:00:00.431 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------- native_ota_rollback:test_ota_rollback [PASSED] Took 0.41 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.413
================== 5 test cases: 5 succeeded in 00:00:00.413 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
--------------- native_totp:test_totp [PASSED] Took 0.42 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.425
================== 4 test cases: 4 succeeded in 00:00:00.425 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------ native_webhook:test_webhook [PASSED] Took 0.42 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.415
================== 5 test cases: 5 succeeded in 00:00:00.415 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
-------- native_radio_power:test_radio_power [PASSED] Took 0.41 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.408
================== 2 test cases: 2 succeeded in 00:00:00.408 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------- native_dns_resolver:test_dns_resolver [PASSED] Took 0.42 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.416
================== 4 test cases: 4 succeeded in 00:00:00.416 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
---------- native_audit_log:test_audit_log [PASSED] Took 0.43 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.425
================= 16 test cases: 16 succeeded in 00:00:00.425 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
--------------- native_oidc:test_oidc [PASSED] Took 0.54 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.536
...
---------------- native_vfs:test_vfs [PASSED] Took 0.42 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.419
================= 11 test cases: 11 succeeded in 00:00:00.419 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------ native_graphql:test_graphql [PASSED] Took 0.43 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.429
================= 32 test cases: 32 succeeded in 00:00:00.429 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------- native_espnow:test_espnow [PASSED] Took 0.41 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.413
================== 7 test cases: 7 succeeded in 00:00:00.413 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------- native_oauth2:test_oauth2 [PASSED] Took 0.42 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.423
================== 8 test cases: 8 succeeded in 00:00:00.423 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
-------------- native_opcua:test_opcua [PASSED] Took 0.43 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.430
================= 38 test cases: 38 succeeded in 00:00:00.430 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------- native_opcua_client:test_opcua_client [PASSED] Took 0.44 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.438
================= 14 test cases: 14 succeeded in 00:00:00.438 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
---------- native_keepalive:test_keepalive [PASSED] Took 0.66 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:00.659
...
-------------- native_range:test_range [PASSED] Took 0.67 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:00.668
...
------------- native_syslog:test_syslog [PASSED] Took 0.42 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.424
================= 10 test cases: 10 succeeded in 00:00:00.424 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
--------------- native_smtp:test_smtp [PASSED] Took 0.46 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_smtp    test_smtp  PASSED    00:00:00.465
================= 11 test cases: 11 succeeded in 00:00:00.465 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
---------------- native_jwt:test_jwt [PASSED] Took 0.45 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.453
================= 21 test cases: 21 succeeded in 00:00:00.453 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------- native_upload:test_upload [PASSED] Took 0.68 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:00.681
...
-------- native_http_client:test_http_client [PASSED] Took 0.42 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.417
================= 15 test cases: 15 succeeded in 00:00:00.417 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
--------- native_compliance:test_compliance [PASSED] Took 0.43 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.427
================= 15 test cases: 15 succeeded in 00:00:00.427 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
--------------- native_mqtt:test_mqtt [PASSED] Took 0.42 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.421
================= 22 test cases: 22 succeeded in 00:00:00.421 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
---------- native_ws_client:test_ws_client [PASSED] Took 0.44 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.439
================= 16 test cases: 16 succeeded in 00:00:00.439 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------ native_scratch:test_scratch [PASSED] Took 0.52 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.517
================= 14 test cases: 14 succeeded in 00:00:00.517 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
---------- native_snmp_trap:test_snmp_trap [PASSED] Took 0.42 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.420
================== 7 test cases: 7 succeeded in 00:00:00.420 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------ native_inflate:test_inflate [PASSED] Took 0.42 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.417
================= 12 test cases: 12 succeeded in 00:00:00.417 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------ native_deflate:test_deflate [PASSED] Took 0.44 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.436
================= 10 test cases: 10 succeeded in 00:00:00.436 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
test/test_websocket/test_websocket.cpp:1107: stress_ws_parse_max_payload [PASSED]
test/test_websocket/test_websocket.cpp:1108: stress_ws_parse_two_consecutive_frames [PASSED]
--------- native_ws_deflate:test_websocket [PASSED] Took 0.64 seconds ----------

=================================== SUMMARY ===================================
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.637
================= 71 test cases: 71 succeeded in 00:00:00.637 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
-------- native_time_source:test_time_source [PASSED] Took 0.41 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.414
================== 9 test cases: 9 succeeded in 00:00:00.414 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------- native_config_store:test_config_store [PASSED] Took 0.42 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.418
================= 14 test cases: 14 succeeded in 00:00:00.418 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
---------- native_device_id:test_device_id [PASSED] Took 0.42 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.423
================== 4 test cases: 4 succeeded in 00:00:00.423 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------- native_auth_lockout:test_auth_lockout [PASSED] Took 0.43 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.429
================= 11 test cases: 11 succeeded in 00:00:00.429 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
--------------- native_csrf:test_csrf [PASSED] Took 0.44 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.438
================== 9 test cases: 9 succeeded in 00:00:00.438 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
---------- native_telemetry:test_telemetry [PASSED] Took 0.41 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.413
================== 8 test cases: 8 succeeded in 00:00:00.413 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
---------- native_dashboard:test_dashboard [PASSED] Took 0.42 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.415
================= 15 test cases: 15 succeeded in 00:00:00.415 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
--------- native_net_egress:test_net_egress [PASSED] Took 0.42 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.415
================== 6 test cases: 6 succeeded in 00:00:00.415 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------ native_partition:test_partition_monitor [PASSED] Took 0.42 seconds ------

=================================== SUMMARY ===================================
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.424
================== 5 test cases: 5 succeeded in 00:00:00.424 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
--------------- native_cbor:test_cbor [PASSED] Took 0.41 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.410
================= 18 test cases: 18 succeeded in 00:00:00.410 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------ native_msgpack:test_msgpack [PASSED] Took 0.43 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.434
================= 17 test cases: 17 succeeded in 00:00:00.434 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
----------- native_gpio_map:test_gpio_map [PASSED] Took 0.41 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.414
================== 8 test cases: 8 succeeded in 00:00:00.414 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------ native_udp_telemetry:test_udp_telemetry [PASSED] Took 0.42 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.417
================== 7 test cases: 7 succeeded in 00:00:00.417 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
--------- native_guardrails:test_guardrails [PASSED] Took 0.42 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.417
================== 6 test cases: 6 succeeded in 00:00:00.417 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------- native_logbuf:test_logbuf [PASSED] Took 0.41 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.408
================== 4 test cases: 4 succeeded in 00:00:00.408 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
---------- native_config_io:test_config_io [PASSED] Took 0.43 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.427
================== 4 test cases: 4 succeeded in 00:00:00.427 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
------------ native_workers:test_workers [PASSED] Took 0.48 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.478
================== 3 test cases: 3 succeeded in 00:00:00.478 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
-------------- native_clock:test_clock [PASSED] Took 0.40 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.402
================== 7 test cases: 7 succeeded in 00:00:00.402 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 146 tests
...
-------- native_concurrency:test_concurrency [PASSED] Took 0.48 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.480
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 0.74 seconds ------------

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:00.739
