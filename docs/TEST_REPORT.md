...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:06.543 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.648 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.671 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.690 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.689 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.667 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.660 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.672 |
...
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.789 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.967 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.746 |
...
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.751 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.849 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.758 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.659 |
...
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.704 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.734 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.726 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.705 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.722 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.728 |
...
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.696 |
...
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.731 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.731 |
...
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.714 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.713 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.672 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.701 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.716 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.688 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.722 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.699 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.714 |
...
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.385 |
...
------------ native_canopen:test_canopen [PASSED] Took 6.54 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.543
================= 17 test cases: 17 succeeded in 00:00:06.543 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.648
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.671
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.690
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.667
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.672
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.649
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.023
native         test_session       PASSED    00:00:00.598
native         test_presentation  PASSED    00:00:00.645
native         test_transport     PASSED    00:00:00.634
native         test_websocket     PASSED    00:00:00.648
native         test_http_parser   PASSED    00:00:00.641
================ 323 test cases: 323 succeeded in 00:00:04.189 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
================= 13 test cases: 13 succeeded in 00:00:00.955 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.764
...
================ 132 test cases: 132 succeeded in 00:00:06.911 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.878
...
================ 225 test cases: 225 succeeded in 00:00:11.508 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.789
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.967
================= 41 test cases: 41 succeeded in 00:00:00.967 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.746
================= 41 test cases: 41 succeeded in 00:00:00.746 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 143 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.751
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.659
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.719
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.691
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.657
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.676
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.704
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.726
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.728
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.696
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.731
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.731
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.714
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.716
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.722
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.714
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.385
================== 2 test cases: 2 succeeded in 00:00:01.385 ==================
```
