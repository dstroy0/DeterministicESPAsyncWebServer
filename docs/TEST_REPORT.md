...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:13.251 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.690 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.697 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.686 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:04.454 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.721 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.684 |
...
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.693 |
...
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.663 |
...
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.726 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.712 |
| `test_ssh_crypto`        | `native_ssh`            |    45 |   ✅   | 00:00:04.078 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.690 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.905 |
| `test_ssh_transport`     | `native_ssh`            |    33 |   ✅   | 00:00:01.180 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.607 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.012 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.483 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.208 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.642 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.621 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.562 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.624 |
...
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.644 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.681 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.698 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.680 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.673 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.707 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.773 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.834 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.794 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.682 |
...
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.679 |
...
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.717 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.706 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.707 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.712 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.983 |
...
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.196 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.194 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.702 |
| `test_smtp`              | `native_smtp`           |    11 |   ✅   | 00:00:00.823 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.697 |
| `test_dns_server`        | `native_dns_server`     |     7 |   ✅   | 00:00:00.706 |
| `test_rtc`               | `native_rtc`            |     8 |   ✅   | 00:00:00.688 |
| `test_ld2410`            | `native_ld2410`         |     7 |   ✅   | 00:00:00.707 |
| `test_mpr121`            | `native_mpr121`         |     5 |   ✅   | 00:00:00.694 |
| `test_sht3x`             | `native_sht3x`          |     5 |   ✅   | 00:00:00.728 |
| `test_pca9685`           | `native_pca9685`        |     4 |   ✅   | 00:00:00.748 |
| `test_ads1115`           | `native_ads1115`        |     3 |   ✅   | 00:00:00.733 |
| `test_ina219`            | `native_ina219`         |     4 |   ✅   | 00:00:00.723 |
| `test_hpack`             | `native_hpack`          |     7 |   ✅   | 00:00:00.794 |
| `test_h2_frame`          | `native_h2frame`        |     6 |   ✅   | 00:00:00.691 |
| `test_h2_conn`           | `native_h2conn`         |     4 |   ✅   | 00:00:00.896 |
| `test_quic_varint`       | `native_quic_varint`    |     3 |   ✅   | 00:00:00.676 |
| `test_h3_frame`          | `native_h3frame`        |     7 |   ✅   | 00:00:00.699 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.725 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.152 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.685 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.707 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.673 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.715 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.735 |
...
| `test_ssh_zlib`          | `native_ssh_zlib`       |     9 |   ✅   | 00:00:00.736 |
| `test_ssh_comp`          | `native_ssh_comp`       |     5 |   ✅   | 00:00:01.071 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.148 |
...
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.674 |
...
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.681 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.694 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.702 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.707 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.695 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.682 |
| `test_statsd`            | `native_statsd`         |     9 |   ✅   | 00:00:00.702 |
...
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.839 |
...
----------- native_canopen:test_canopen [PASSED] Took 13.25 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:13.251
================= 17 test cases: 17 succeeded in 00:00:13.251 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.690
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_det_arena  test_det_arena  PASSED    00:00:00.686
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:04.454
================= 16 test cases: 16 succeeded in 00:00:04.454 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.721
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.684
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.693
...
native         test_transport     PASSED    00:00:00.663
native         test_websocket     PASSED    00:00:00.682
native         test_http_parser   PASSED    00:00:00.642
================ 323 test cases: 323 succeeded in 00:00:04.275 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.726
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.078
native_ssh     test_ssh_auth       PASSED    00:00:00.690
native_ssh     test_ssh_server     PASSED    00:00:00.905
native_ssh     test_ssh_transport  PASSED    00:00:01.180
native_ssh     test_ssh_channel    PASSED    00:00:00.607
================ 145 test cases: 145 succeeded in 00:00:07.459 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.483
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.208
native_app     test_template          PASSED    00:00:00.642
native_app     test_path_params       PASSED    00:00:00.621
native_app     test_digest_vectors    PASSED    00:00:00.562
native_app     test_form_params       PASSED    00:00:00.624
...
================ 225 test cases: 225 succeeded in 00:00:11.982 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.244
================= 12 test cases: 12 succeeded in 00:00:01.244 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
================= 35 test cases: 35 succeeded in 00:00:01.241 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.987
================= 15 test cases: 15 succeeded in 00:00:01.987 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.817
================= 41 test cases: 41 succeeded in 00:00:00.817 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.644
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.673
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.707
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.834
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.682
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.679
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.666
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.666
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.717
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.707
...
================= 17 test cases: 17 succeeded in 00:00:00.983 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.196
================= 10 test cases: 10 succeeded in 00:00:01.196 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.702
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_ntp_server  test_ntp_server  PASSED    00:00:00.697
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_dns_server  test_dns_server  PASSED    00:00:00.706
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_rtc     test_rtc  PASSED    00:00:00.688
================== 8 test cases: 8 succeeded in 00:00:00.688 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ld2410  test_ld2410  PASSED    00:00:00.707
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_mpr121  test_mpr121  PASSED    00:00:00.694
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sht3x   test_sht3x  PASSED    00:00:00.728
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_pca9685  test_pca9685  PASSED    00:00:00.748
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_ads1115  test_ads1115  PASSED    00:00:00.733
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ina219  test_ina219  PASSED    00:00:00.723
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_hpack   test_hpack  PASSED    00:00:00.794
...
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h2frame  test_h2_frame  PASSED    00:00:00.691
...
Environment    Test          Status    Duration
-------------  ------------  --------  ------------
native_h2conn  test_h2_conn  PASSED    00:00:00.896
================== 4 test cases: 4 succeeded in 00:00:00.896 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_varint  test_quic_varint  PASSED    00:00:00.676
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.707
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.735
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_zlib  test_ssh_zlib  PASSED    00:00:00.736
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_comp  test_ssh_comp  PASSED    00:00:01.071
================== 5 test cases: 5 succeeded in 00:00:01.071 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.148
================= 71 test cases: 71 succeeded in 00:00:01.148 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.702
================= 18 test cases: 18 succeeded in 00:00:00.702 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.707
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.695
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_statsd  test_statsd  PASSED    00:00:00.702
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.839
================== 3 test cases: 3 succeeded in 00:00:00.839 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_qpack   test_qpack  PASSED    00:00:00.823
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_ssh_chachapoly  test_ssh_chachapoly  PASSED    00:00:00.689
