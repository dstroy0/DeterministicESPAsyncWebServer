...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:13.930 |
...
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:01.052 |
...
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.554 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.556 |
...
| `test_dispatch`         | `native_app`          |    11 |   ✅   | 00:00:00.548 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.560 |
...
| `test_concurrency`      | `native_tsan`         |     2 |   ✅   | 00:00:01.432 |
...
----------------- native:test_sse [PASSED] Took 13.93 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:13.930
...
native_app           test_regex             PASSED    00:00:01.052
...
native_app           test_middleware        PASSED    00:00:00.556
...
native_app           test_dispatch          PASSED    00:00:00.548
native_app           test_chunked           PASSED    00:00:00.560
...
native_tsan          test_concurrency       PASSED    00:00:01.432
================ 620 test cases: 620 succeeded in 00:00:38.336 ================
```
