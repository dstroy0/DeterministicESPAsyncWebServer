...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    11 |   ✅   | 00:00:05.620 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.645 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.641 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.661 |
| `test_mbus`              | `native_mbus`           |     8 |   ✅   | 00:00:00.644 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.646 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.644 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.644 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.639 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.640 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.105 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.564 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.596 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.577 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.605 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.570 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.715 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:01.098 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.655 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.658 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:04.051 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.558 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.663 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.876 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.520 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.020 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.508 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.327 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.582 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.587 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.525 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.580 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.582 |
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.545 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.588 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.583 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.604 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.586 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.564 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.592 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.596 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.602 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.590 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.592 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.665 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.351 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.323 |
...
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.807 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.743 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.741 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.639 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.662 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.735 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.647 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.650 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.645 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.646 |
| `test_protobuf`          | `native_protobuf`       |    10 |   ✅   | 00:00:00.659 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.668 |
...
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.646 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.652 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.646 |
| `test_sparkplug`         | `native_sparkplug`      |     6 |   ✅   | 00:00:00.665 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.658 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.619 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.659 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.649 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.622 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.650 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.666 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.921 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.650 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.643 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.640 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.670 |
...
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.655 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.718 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.252 |
| `test_http_client`       | `native_http_client`    |    11 |   ✅   | 00:00:00.647 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.650 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.659 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.713 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.676 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.658 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.645 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.683 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.148 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.644 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.625 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.659 |
...
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.648 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.644 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.648 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.649 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.666 |
...
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.665 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.785 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.609 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.735 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.614 |
...
------------ native_canopen:test_canopen [PASSED] Took 5.62 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:05.620
================= 11 test cases: 11 succeeded in 00:00:05.620 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.645
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.661
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.644
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.639
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.640
...
native         test_session       PASSED    00:00:00.564
native         test_presentation  PASSED    00:00:00.596
native         test_transport     PASSED    00:00:00.577
native         test_websocket     PASSED    00:00:00.605
native         test_http_parser   PASSED    00:00:00.570
================ 318 test cases: 318 succeeded in 00:00:04.017 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.715
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.098
================= 10 test cases: 10 succeeded in 00:00:01.098 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.051
native_ssh     test_ssh_auth       PASSED    00:00:00.558
native_ssh     test_ssh_server     PASSED    00:00:00.663
native_ssh     test_ssh_transport  PASSED    00:00:00.876
native_ssh     test_ssh_channel    PASSED    00:00:00.520
================= 93 test cases: 93 succeeded in 00:00:06.666 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:01.020
================== 2 test cases: 2 succeeded in 00:00:01.020 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.327
native_app     test_template          PASSED    00:00:00.582
native_app     test_path_params       PASSED    00:00:00.587
native_app     test_digest_vectors    PASSED    00:00:00.525
native_app     test_form_params       PASSED    00:00:00.580
native_app     test_iface             PASSED    00:00:00.582
native_app     test_json              PASSED    00:00:00.545
...
native_app     test_web_terminal      PASSED    00:00:00.586
native_app     test_defer             PASSED    00:00:00.564
native_app     test_multipart         PASSED    00:00:00.592
native_app     test_auth              PASSED    00:00:00.596
native_app     test_file_serving      PASSED    00:00:00.602
...
================ 219 test cases: 219 succeeded in 00:00:11.290 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.351
================= 12 test cases: 12 succeeded in 00:00:01.351 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.323
...
================= 30 test cases: 30 succeeded in 00:00:01.208 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.743
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.639
================= 19 test cases: 19 succeeded in 00:00:00.639 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.662
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.650
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.668
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.665
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.658
================== 5 test cases: 5 succeeded in 00:00:00.658 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.649
================== 5 test cases: 5 succeeded in 00:00:00.649 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.622
================== 2 test cases: 2 succeeded in 00:00:00.622 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
================= 13 test cases: 13 succeeded in 00:00:00.921 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.643
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.640
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.670
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.252
================== 3 test cases: 3 succeeded in 00:00:01.252 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.713
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.676
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.645
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.683
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.625
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.649
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.666
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.665
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.735
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.614
================== 2 test cases: 2 succeeded in 00:00:01.614 ==================
```
