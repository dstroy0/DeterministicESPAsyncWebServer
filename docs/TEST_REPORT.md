...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:08.163 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.533 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.569 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.555 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.577 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.526 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.833 |
...
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:01.049 |
...
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.543 |
...
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.556 |
...
| `test_workers`          | `native_workers`      |     3 |   ✅   | 00:00:00.724 |
| `test_concurrency`      | `native_tsan`         |     2 |   ✅   | 00:00:01.326 |
...
------------------ native:test_sse [PASSED] Took 8.16 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:08.163
native               test_session           PASSED    00:00:00.533
...
native_ssh           test_ssh_crypto        PASSED    00:00:03.833
...
native_app           test_regex             PASSED    00:00:01.049
...
native_app           test_iface             PASSED    00:00:00.543
...
native_tsan          test_concurrency       PASSED    00:00:01.326
================ 619 test cases: 619 succeeded in 00:00:32.804 ================
```
