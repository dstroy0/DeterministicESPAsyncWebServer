...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:16.505 |
...
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.593 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.734 |
...
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.652 |
...
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.222 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.193 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.730 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.553 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.493 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.799 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.897 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.778 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.682 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.688 |
...
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.726 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.681 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.665 |
...
| `test_sparkplug`         | `native_sparkplug`      |     6 |   ✅   | 00:00:00.723 |
...
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.719 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.846 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.671 |
...
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.095 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.132 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.698 |
...
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.670 |
...
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.685 |
...
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.690 |
...
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.188 |
...
----------------- native:test_sse [PASSED] Took 16.50 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:16.505
...
================ 318 test cases: 318 succeeded in 00:00:19.572 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
================= 15 test cases: 15 succeeded in 00:00:00.734 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.917
native_ssh     test_ssh_auth       PASSED    00:00:00.579
native_ssh     test_ssh_server     PASSED    00:00:00.697
native_ssh     test_ssh_transport  PASSED    00:00:00.897
native_ssh     test_ssh_channel    PASSED    00:00:00.545
================= 93 test cases: 93 succeeded in 00:00:06.635 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.288
...
src/DeterministicESPAsyncWebServer.cpp:2920:76: warning: ‘snprintf’ output may be truncated before the last format character [-Wformat-truncation=]
 2920 |         snprintf(lastmod_line, sizeof(lastmod_line), "Last-Modified: %s\r\n", lm_date);
      |                                                                            ^
src/DeterministicESPAsyncWebServer.cpp:2920:17: note: ‘snprintf’ output between 18 and 57 bytes into a destination of size 56
 2920 |         snprintf(lastmod_line, sizeof(lastmod_line), "Last-Modified: %s\r\n", lm_date);
      |         ~~~~~~~~^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Testing...
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.185
...
native_app     test_auth              PASSED    00:00:00.652
...
================ 219 test cases: 219 succeeded in 00:00:11.792 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.222
================= 12 test cases: 12 succeeded in 00:00:01.222 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.193
...
================= 29 test cases: 29 succeeded in 00:00:01.283 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.897
================= 29 test cases: 29 succeeded in 00:00:00.897 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.778
================= 29 test cases: 29 succeeded in 00:00:00.778 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
================= 18 test cases: 18 succeeded in 00:00:00.688 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
test/test_hostlink/test_hostlink.cpp:30: test_build_dm_read: Expected '@00RD0000001057*\r' Was '@00RD0000001057*\rI\xF6\x09\xFE\x7F' [FAILED]
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  ERRORED   00:00:00.684

============= 8 test cases: 1 failed, 6 succeeded in 00:00:00.684 =============
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.681
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.665
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.723
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.671
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.095
================= 10 test cases: 10 succeeded in 00:00:01.095 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.698
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.670
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.188
