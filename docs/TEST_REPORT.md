...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:06.179 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.665 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.650 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.646 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:04.401 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.667 |
...
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.660 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.654 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.652 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.644 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.656 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.012 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.585 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.620 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.615 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.638 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.616 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.774 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:01.002 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.682 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.669 |
| `test_ssh_crypto`        | `native_ssh`            |    45 |   ✅   | 00:00:04.037 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.647 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.850 |
| `test_ssh_transport`     | `native_ssh`            |    33 |   ✅   | 00:00:01.132 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.587 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.992 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.388 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.172 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.607 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.617 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.549 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.595 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.613 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.567 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.611 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.617 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.632 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.607 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.591 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.617 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.613 |
...
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.689 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.240 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.185 |
...
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.786 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.759 |
...
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.665 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.663 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.660 |
...
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.772 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.648 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.654 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.654 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.660 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.659 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.659 |
...
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.672 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.653 |
...
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.664 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.649 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.680 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.689 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.693 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.109 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.106 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.665 |
| `test_smtp`              | `native_smtp`           |    11 |   ✅   | 00:00:00.784 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.654 |
| `test_dns_server`        | `native_dns_server`     |     7 |   ✅   | 00:00:00.644 |
| `test_rtc`               | `native_rtc`            |     8 |   ✅   | 00:00:00.664 |
| `test_ld2410`            | `native_ld2410`         |     7 |   ✅   | 00:00:00.655 |
| `test_mpr121`            | `native_mpr121`         |     5 |   ✅   | 00:00:00.659 |
| `test_sht3x`             | `native_sht3x`          |     5 |   ✅   | 00:00:00.645 |
| `test_pca9685`           | `native_pca9685`        |     4 |   ✅   | 00:00:00.648 |
| `test_ads1115`           | `native_ads1115`        |     3 |   ✅   | 00:00:00.651 |
| `test_ina219`            | `native_ina219`         |     4 |   ✅   | 00:00:00.639 |
...
| `test_quic_varint`       | `native_quic_varint`    |     3 |   ✅   | 00:00:00.644 |
| `test_h3_frame`          | `native_h3frame`        |     7 |   ✅   | 00:00:00.668 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.708 |
...
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.666 |
...
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.655 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.653 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.663 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.665 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.652 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.649 |
| `test_statsd`            | `native_statsd`         |     9 |   ✅   | 00:00:00.687 |
...
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.628 |
| `test_qpack`             | `native_qpack`          |     9 |   ✅   | 00:00:00.775 |
| `test_quic_packet`       | `native_quic_packet`    |     8 |   ✅   | 00:00:00.651 |
...
------------ native_canopen:test_canopen [PASSED] Took 6.18 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.179
================= 17 test cases: 17 succeeded in 00:00:06.179 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.650
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_det_arena  test_det_arena  PASSED    00:00:00.646
================= 17 test cases: 17 succeeded in 00:00:00.646 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:04.401
================= 16 test cases: 16 succeeded in 00:00:04.401 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.667
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.660
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.654
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.652
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.012
...
native         test_websocket     PASSED    00:00:00.638
native         test_http_parser   PASSED    00:00:00.616
================ 323 test cases: 323 succeeded in 00:00:04.086 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.774
================= 17 test cases: 17 succeeded in 00:00:00.774 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
================= 13 test cases: 13 succeeded in 00:00:01.002 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.669
...
native_ssh     test_ssh_auth       PASSED    00:00:00.647
native_ssh     test_ssh_server     PASSED    00:00:00.850
native_ssh     test_ssh_transport  PASSED    00:00:01.132
native_ssh     test_ssh_channel    PASSED    00:00:00.587
================ 145 test cases: 145 succeeded in 00:00:07.253 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.992
================== 2 test cases: 2 succeeded in 00:00:00.992 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.388
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.172
native_app     test_template          PASSED    00:00:00.607
native_app     test_path_params       PASSED    00:00:00.617
native_app     test_digest_vectors    PASSED    00:00:00.549
...
================ 225 test cases: 225 succeeded in 00:00:11.561 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.240
================= 12 test cases: 12 succeeded in 00:00:01.240 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.185
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.786
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.759
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.665
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.660
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.772
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.648
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.654
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.654
================== 9 test cases: 9 succeeded in 00:00:00.654 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_pn532   test_pn532  PASSED    00:00:00.660
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.659
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.659
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.644
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.639
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.643
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.651
================== 9 test cases: 9 succeeded in 00:00:00.651 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.656
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.649
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.672
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.653
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.664
================= 32 test cases: 32 succeeded in 00:00:00.664 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.649
================== 7 test cases: 7 succeeded in 00:00:00.649 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
================= 38 test cases: 38 succeeded in 00:00:00.689 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.109
================= 10 test cases: 10 succeeded in 00:00:01.109 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.106
================= 13 test cases: 13 succeeded in 00:00:01.106 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_ntp_server  test_ntp_server  PASSED    00:00:00.654
...
--------- native_dns_server:test_dns_server [PASSED] Took 0.64 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_dns_server  test_dns_server  PASSED    00:00:00.644
================== 7 test cases: 7 succeeded in 00:00:00.644 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_mpr121  test_mpr121  PASSED    00:00:00.659
...
-------------- native_sht3x:test_sht3x [PASSED] Took 0.64 seconds --------------
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_pca9685  test_pca9685  PASSED    00:00:00.648
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_ads1115  test_ads1115  PASSED    00:00:00.651
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ina219  test_ina219  PASSED    00:00:00.639
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_varint  test_quic_varint  PASSED    00:00:00.644
...
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h3frame  test_h3_frame  PASSED    00:00:00.668
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.708
================= 21 test cases: 21 succeeded in 00:00:00.708 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
================= 22 test cases: 22 succeeded in 00:00:00.666 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.655
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.665
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.652
...
------------- native_statsd:test_statsd [PASSED] Took 0.69 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_statsd  test_statsd  PASSED    00:00:00.687
================== 9 test cases: 9 succeeded in 00:00:00.687 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.628
================== 2 test cases: 2 succeeded in 00:00:01.628 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_packet  test_quic_packet  PASSED    00:00:00.651
