...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:06.515 |
...
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.832 |
...
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.581 |
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:06.515
...
native_ssh           test_ssh_crypto        PASSED    00:00:03.832
...
native_app           test_regex             PASSED    00:00:01.089
native_app           test_template          PASSED    00:00:00.579
native_app           test_path_params       PASSED    00:00:00.584
native_app           test_digest_vectors    PASSED    00:00:00.524
...
native_app           test_chunked           PASSED    00:00:00.581
...
================ 620 test cases: 620 succeeded in 00:00:31.602 ================
```
