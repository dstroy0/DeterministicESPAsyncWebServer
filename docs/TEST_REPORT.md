...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:06.990 |
...
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.813 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.543 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.645 |
...
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.092 |
...
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.511 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.516 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.513 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.507 |
...
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.508 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.615 |
...
------------------ native:test_sse [PASSED] Took 6.99 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:06.990
...
native_ssh           test_ssh_crypto        PASSED    00:00:03.813
native_ssh           test_ssh_auth          PASSED    00:00:00.543
native_ssh           test_ssh_server        PASSED    00:00:00.645
...
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.092
...
native_app           test_response_headers  PASSED    00:00:00.511
