...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:06.478 |
...
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.845 |
...
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.187 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:01.063 |
...
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.557 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.563 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.561 |
...
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.557 |
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:06.478
...
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.187
native_app           test_regex             PASSED    00:00:01.063
...
native_app           test_chunked           PASSED    00:00:00.557
...
================ 620 test cases: 620 succeeded in 00:00:30.738 ================
```
