...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:12.897 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.561 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.603 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.577 |
| `test_websocket`         | `native`               |    63 |   ✅   | 00:00:00.601 |
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.569 |
| `test_observability`     | `native_observability` |    15 |   ✅   | 00:00:00.706 |
| `test_http_ota`          | `native_ota`           |     3 |   ✅   | 00:00:00.650 |
| `test_provisioning`      | `native_prov`          |     5 |   ✅   | 00:00:00.674 |
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.856 |
...
| `test_ssh_channel`       | `native_ssh`           |    12 |   ✅   | 00:00:00.546 |
| `test_ssh_hardening`     | `native_ssh_hardened`  |     2 |   ✅   | 00:00:00.880 |
| `test_ssh_conn`          | `native_ssh_conn`      |     2 |   ✅   | 00:00:01.245 |
| `test_regex`             | `native_app`           |     9 |   ✅   | 00:00:01.133 |
| `test_template`          | `native_app`           |     6 |   ✅   | 00:00:00.583 |
...
| `test_json`              | `native_app`           |    17 |   ✅   | 00:00:00.533 |
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.594 |
| `test_middleware`        | `native_app`           |     9 |   ✅   | 00:00:00.591 |
| `test_digest_auth`       | `native_app`           |     5 |   ✅   | 00:00:00.597 |
| `test_web_terminal`      | `native_app`           |     7 |   ✅   | 00:00:00.588 |
...
| `test_chunked`           | `native_app`           |     8 |   ✅   | 00:00:00.593 |
| `test_application`       | `native_app`           |    50 |   ✅   | 00:00:00.683 |
| `test_snmp_ber`          | `native_snmp`          |     9 |   ✅   | 00:00:00.713 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.508 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.394 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.768 |
...
| `test_oidc`              | `native_oidc`          |    13 |   ✅   | 00:00:00.820 |
...
| `test_range`             | `native_range`         |    10 |   ✅   | 00:00:01.081 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.680 |
| `test_jwt`               | `native_jwt`           |    10 |   ✅   | 00:00:00.705 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.110 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.647 |
| `test_compliance`        | `native_compliance`    |    12 |   ✅   | 00:00:00.669 |
...
| `test_snmp_trap`         | `native_snmp_trap`     |     3 |   ✅   | 00:00:00.677 |
| `test_inflate`           | `native_inflate`       |    12 |   ✅   | 00:00:00.658 |
| `test_deflate`           | `native_deflate`       |    10 |   ✅   | 00:00:00.709 |
| `test_websocket`         | `native_ws_deflate`    |    67 |   ✅   | 00:00:01.035 |
...
| `test_dashboard`         | `native_dashboard`     |    11 |   ✅   | 00:00:00.659 |
| `test_net_egress`        | `native_net_egress`    |     5 |   ✅   | 00:00:00.661 |
...
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.664 |
...
----------------- native:test_sse [PASSED] Took 12.90 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:12.897
...
native         test_http_parser   PASSED    00:00:00.569
================ 306 test cases: 306 succeeded in 00:00:15.807 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.706
...
native_ssh     test_ssh_channel    PASSED    00:00:00.546
================= 92 test cases: 92 succeeded in 00:00:06.534 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.245
...
native_app     test_template          PASSED    00:00:00.583
...
================ 202 test cases: 202 succeeded in 00:00:11.213 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
================= 22 test cases: 22 succeeded in 00:00:01.221 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.394
================== 9 test cases: 9 succeeded in 00:00:01.394 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.768
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.820
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.705
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.110
================== 3 test cases: 3 succeeded in 00:00:01.110 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
================= 67 test cases: 67 succeeded in 00:00:01.035 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.661
