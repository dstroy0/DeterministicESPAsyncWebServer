...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:06.483 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.578 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.613 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.598 |
| `test_websocket`         | `native`               |    63 |   ✅   | 00:00:00.621 |
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.567 |
...
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.875 |
| `test_ssh_auth`          | `native_ssh`           |    12 |   ✅   | 00:00:00.567 |
| `test_ssh_server`        | `native_ssh`           |     7 |   ✅   | 00:00:00.671 |
| `test_ssh_transport`     | `native_ssh`           |    23 |   ✅   | 00:00:00.901 |
| `test_ssh_channel`       | `native_ssh`           |    12 |   ✅   | 00:00:00.535 |
| `test_ssh_hardening`     | `native_ssh_hardened`  |     2 |   ✅   | 00:00:00.861 |
| `test_ssh_conn`          | `native_ssh_conn`      |     2 |   ✅   | 00:00:01.269 |
| `test_regex`             | `native_app`           |     9 |   ✅   | 00:00:01.146 |
| `test_template`          | `native_app`           |     6 |   ✅   | 00:00:00.599 |
| `test_path_params`       | `native_app`           |     8 |   ✅   | 00:00:00.605 |
| `test_digest_vectors`    | `native_app`           |     4 |   ✅   | 00:00:00.538 |
| `test_form_params`       | `native_app`           |     5 |   ✅   | 00:00:00.597 |
| `test_iface`             | `native_app`           |     7 |   ✅   | 00:00:00.591 |
| `test_json`              | `native_app`           |    17 |   ✅   | 00:00:00.552 |
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.620 |
| `test_middleware`        | `native_app`           |     9 |   ✅   | 00:00:00.604 |
| `test_digest_auth`       | `native_app`           |     5 |   ✅   | 00:00:00.604 |
...
| `test_snmp_ber`          | `native_snmp`          |     9 |   ✅   | 00:00:00.670 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.494 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.370 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.765 |
| `test_coap`              | `native_coap`          |    26 |   ✅   | 00:00:00.662 |
| `test_webdav`            | `native_webdav`        |    19 |   ✅   | 00:00:00.657 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.652 |
...
| `test_jwt`               | `native_jwt`           |    10 |   ✅   | 00:00:00.710 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.124 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.662 |
| `test_compliance`        | `native_compliance`    |    12 |   ✅   | 00:00:00.663 |
| `test_mqtt`              | `native_mqtt`          |    16 |   ✅   | 00:00:00.659 |
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.720 |
...
| `test_websocket`         | `native_ws_deflate`    |    67 |   ✅   | 00:00:01.025 |
...
| `test_auth_lockout`      | `native_auth_lockout`  |    10 |   ✅   | 00:00:00.640 |
...
| `test_cbor`              | `native_cbor`          |    14 |   ✅   | 00:00:00.662 |
| `test_msgpack`           | `native_msgpack`       |    15 |   ✅   | 00:00:00.653 |
| `test_gpio_map`          | `native_gpio_map`      |     8 |   ✅   | 00:00:00.636 |
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.645 |
...
| `test_clock`             | `native_clock`         |     4 |   ✅   | 00:00:00.612 |
| `test_concurrency`       | `native_concurrency`   |     2 |   ✅   | 00:00:00.833 |
| `test_concurrency`       | `native_tsan`          |     2 |   ✅   | 00:00:01.475 |
...
------------------ native:test_sse [PASSED] Took 6.48 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.483
native         test_session       PASSED    00:00:00.578
...
native         test_http_parser   PASSED    00:00:00.567
================ 306 test cases: 306 succeeded in 00:00:09.459 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
native_ssh     test_ssh_transport  PASSED    00:00:00.901
native_ssh     test_ssh_channel    PASSED    00:00:00.535
================= 92 test cases: 92 succeeded in 00:00:06.549 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.861
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.146
native_app     test_template          PASSED    00:00:00.599
native_app     test_path_params       PASSED    00:00:00.605
native_app     test_digest_vectors    PASSED    00:00:00.538
...
================ 206 test cases: 206 succeeded in 00:00:11.327 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
================= 22 test cases: 22 succeeded in 00:00:01.164 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.662
================= 26 test cases: 26 succeeded in 00:00:00.662 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.663
...
================= 67 test cases: 67 succeeded in 00:00:01.025 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.645
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.612
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.475
================== 2 test cases: 2 succeeded in 00:00:01.475 ==================
```
