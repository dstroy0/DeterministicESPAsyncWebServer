...
**Generated:** 2026-06-29 17:15:32
**Command:** `pio test` over 69 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1328 passed - 98s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:07.316 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.449 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.473 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.461 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.489 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.453 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.896 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.525 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.524 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:02.922 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.438 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.550 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.719 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.422 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.686 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:00.983 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:00.900 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.476 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.473 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.431 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.463 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.470 |
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.439 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.490 |
...
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.484 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.472 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.532 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.468 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.480 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.539 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:00.946 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:00.915 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.553 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.397 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.191 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.620 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.784 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.581 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.524 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.520 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.570 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.509 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.520 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.519 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.526 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.509 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.533 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.515 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.509 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.516 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.548 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.650 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.514 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.523 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.511 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.571 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.532 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.635 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:00.867 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:00.849 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.520 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.571 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:00.875 |
| `test_http_client`       | `native_http_client`    |    10 |   ✅   | 00:00:00.523 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.521 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.511 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.558 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.555 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.533 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.522 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.550 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:00.789 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.515 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.505 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.523 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.510 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.534 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.531 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.519 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.504 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.566 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.523 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.506 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.528 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.523 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.522 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.517 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.525 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.800 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.507 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.637 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:00.818 |
...
------------------ native:test_sse [PASSED] Took 7.32 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:07.316
native         test_session       PASSED    00:00:00.449
native         test_presentation  PASSED    00:00:00.473
native         test_transport     PASSED    00:00:00.461
native         test_websocket     PASSED    00:00:00.489
native         test_http_parser   PASSED    00:00:00.453
================ 318 test cases: 318 succeeded in 00:00:09.641 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
================= 15 test cases: 15 succeeded in 00:00:00.896 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.525
================== 3 test cases: 3 succeeded in 00:00:00.525 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.524
...
------------ native_ssh:test_ssh_channel [PASSED] Took 0.42 seconds ------------

=================================== SUMMARY ===================================
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:02.922
native_ssh     test_ssh_auth       PASSED    00:00:00.438
native_ssh     test_ssh_server     PASSED    00:00:00.550
native_ssh     test_ssh_transport  PASSED    00:00:00.719
native_ssh     test_ssh_channel    PASSED    00:00:00.422
================= 93 test cases: 93 succeeded in 00:00:05.050 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.686
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:00.983
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:00.900
native_app     test_template          PASSED    00:00:00.476
native_app     test_path_params       PASSED    00:00:00.473
native_app     test_digest_vectors    PASSED    00:00:00.431
native_app     test_form_params       PASSED    00:00:00.463
native_app     test_iface             PASSED    00:00:00.470
native_app     test_json              PASSED    00:00:00.439
native_app     test_response_headers  PASSED    00:00:00.490
...
native_app     test_multipart         PASSED    00:00:00.484
native_app     test_auth              PASSED    00:00:00.472
native_app     test_file_serving      PASSED    00:00:00.532
native_app     test_dispatch          PASSED    00:00:00.468
native_app     test_chunked           PASSED    00:00:00.480
native_app     test_application       PASSED    00:00:00.539
================ 219 test cases: 219 succeeded in 00:00:09.020 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
----- native_webdav_handler:test_webdav_handler [PASSED] Took 0.95 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:00.946
================= 12 test cases: 12 succeeded in 00:00:00.946 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:00.915
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.553
native_snmp    test_snmp_agent  PASSED    00:00:00.397
================= 29 test cases: 29 succeeded in 00:00:00.949 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 1.19 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.191
================= 10 test cases: 10 succeeded in 00:00:01.191 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.620
...
test/test_coap/test_coap.cpp:844: test_well_known_core_discovery        [PASSED]
test/test_coap/test_coap.cpp:845: test_well_known_core_rejects_post     [PASSED]
----------- native_coap_observe:test_coap [PASSED] Took 0.58 seconds -----------

=================================== SUMMARY ===================================
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.581
================= 29 test cases: 29 succeeded in 00:00:00.581 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.524
================= 19 test cases: 19 succeeded in 00:00:00.524 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.520
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.570
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.509
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.519
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.526
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.509
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.533
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.515
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.509
================== 2 test cases: 2 succeeded in 00:00:00.509 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.516
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.548
================= 12 test cases: 12 succeeded in 00:00:00.548 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.650
...
---------------- native_vfs:test_vfs [PASSED] Took 0.51 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.514
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.523
================= 13 test cases: 13 succeeded in 00:00:00.523 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.511
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.571
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.532
================= 29 test cases: 29 succeeded in 00:00:00.532 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:00.867
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:00.849
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.520
...
================= 12 test cases: 12 succeeded in 00:00:00.571 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:00.875
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.523
================= 10 test cases: 10 succeeded in 00:00:00.523 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.521
================= 15 test cases: 15 succeeded in 00:00:00.521 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.511
================= 19 test cases: 19 succeeded in 00:00:00.511 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.555
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.533
================== 3 test cases: 3 succeeded in 00:00:00.533 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.522
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.789
================= 71 test cases: 71 succeeded in 00:00:00.789 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.505
================= 14 test cases: 14 succeeded in 00:00:00.505 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
---------- native_device_id:test_device_id [PASSED] Took 0.52 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.523
...
------- native_auth_lockout:test_auth_lockout [PASSED] Took 0.51 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.510
================= 10 test cases: 10 succeeded in 00:00:00.510 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
--------------- native_csrf:test_csrf [PASSED] Took 0.53 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.534
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.519
...
--------- native_net_egress:test_net_egress [PASSED] Took 0.50 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.504
================== 5 test cases: 5 succeeded in 00:00:00.504 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.566
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.523
================= 14 test cases: 14 succeeded in 00:00:00.523 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
------------ native_msgpack:test_msgpack [PASSED] Took 0.51 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.506
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.523
================== 7 test cases: 7 succeeded in 00:00:00.523 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.522
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.517
================== 4 test cases: 4 succeeded in 00:00:00.517 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.800
================== 3 test cases: 3 succeeded in 00:00:00.800 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.507
================== 4 test cases: 4 succeeded in 00:00:00.507 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.637
================== 2 test cases: 2 succeeded in 00:00:00.637 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 94 tests
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 0.82 seconds ------------

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:00.818
