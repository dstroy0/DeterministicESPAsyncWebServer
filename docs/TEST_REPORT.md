...
**Generated:** 2026-07-02 18:09:51
**Command:** `pio test` over 112 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1872 passed - 206s
...
| :----------------------- | :---------------------- | ----: | :----: | ------------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   |  00:00:06.641 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   |  00:00:00.724 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   |  00:00:00.729 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   |  00:00:00.716 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   |  00:00:00.738 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   |  00:00:00.712 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   |  00:00:00.716 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   |  00:00:00.732 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   |  00:00:00.721 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   |  00:00:00.746 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   |  00:00:00.710 |
| `test_sse`               | `native`                |    37 |   ✅   |  00:00:01.098 |
| `test_session`           | `native`                |    19 |   ✅   |  00:00:00.661 |
| `test_presentation`      | `native`                |    63 |   ✅   |  00:00:00.672 |
| `test_transport`         | `native`                |    42 |   ✅   |  00:00:00.673 |
| `test_websocket`         | `native`                |    67 |   ✅   |  00:00:00.692 |
| `test_http_parser`       | `native`                |    93 |   ✅   |  00:00:00.657 |
| `test_observability`     | `native_observability`  |    17 |   ✅   |  00:00:00.795 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   |  00:00:01.106 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   |  00:00:00.747 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   |  00:00:00.741 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   |  00:00:03.944 |
| `test_ssh_auth`          | `native_ssh`            |    18 |   ✅   |  00:00:00.644 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   |  00:00:00.920 |
| `test_ssh_transport`     | `native_ssh`            |    27 |   ✅   |  00:00:01.108 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   |  00:00:00.631 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   |  00:00:00.942 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   |  00:00:01.348 |
| `test_regex`             | `native_app`            |     9 |   ✅   |  00:00:01.256 |
| `test_template`          | `native_app`            |     6 |   ✅   |  00:00:00.683 |
| `test_path_params`       | `native_app`            |     8 |   ✅   |  00:00:00.653 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   |  00:00:00.580 |
| `test_form_params`       | `native_app`            |     5 |   ✅   |  00:00:00.658 |
| `test_iface`             | `native_app`            |     7 |   ✅   |  00:00:00.678 |
| `test_json`              | `native_app`            |    23 |   ✅   |  00:00:00.634 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   |  00:00:00.685 |
| `test_middleware`        | `native_app`            |     9 |   ✅   |  00:00:00.673 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   |  00:00:00.674 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   |  00:00:00.649 |
| `test_defer`             | `native_app`            |     3 |   ✅   |  00:00:00.646 |
| `test_multipart`         | `native_app`            |    19 |   ✅   |  00:00:00.660 |
| `test_auth`              | `native_app`            |    13 |   ✅   |  00:00:00.680 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   |  00:00:00.682 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   |  00:00:00.666 |
| `test_chunked`           | `native_app`            |    12 |   ✅   |  00:00:00.686 |
| `test_application`       | `native_app`            |    53 |   ✅   |  00:00:00.736 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   |  00:00:01.266 |
| `test_diag`              | `native_diag`           |     2 |   ✅   |  00:00:01.232 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   |  00:00:00.744 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   |  00:00:00.558 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   |  00:00:02.008 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   |  00:00:00.858 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.1000 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   |  00:00:00.840 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   |  00:00:00.731 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   |  00:00:00.734 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   |  00:00:00.794 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   |  00:00:00.753 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   |  00:00:00.722 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   |  00:00:00.712 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   |  00:00:00.697 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   |  00:00:00.692 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   |  00:00:00.768 |
| `test_dma`               | `native_dma`            |    11 |   ✅   |  00:00:00.802 |
| `test_forward`           | `native_forward`        |    16 |   ✅   |  00:00:00.880 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   |  00:00:00.823 |
| `test_lora`              | `native_lora`           |    13 |   ✅   |  00:00:00.718 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   |  00:00:00.725 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   |  00:00:00.712 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   |  00:00:00.694 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   |  00:00:00.683 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   |  00:00:00.756 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   |  00:00:00.697 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   |  00:00:00.731 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   |  00:00:00.711 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   |  00:00:00.686 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   |  00:00:00.689 |
| `test_fins`              | `native_fins`           |     6 |   ✅   |  00:00:00.667 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   |  00:00:00.681 |
| `test_senml`             | `native_senml`          |     9 |   ✅   |  00:00:00.764 |
| `test_df1`               | `native_df1`            |     9 |   ✅   |  00:00:00.693 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   |  00:00:00.713 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   |  00:00:00.718 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   |  00:00:00.702 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   |  00:00:00.688 |
| `test_enip`              | `native_enip`           |     6 |   ✅   |  00:00:00.699 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   |  00:00:00.704 |
| `test_cip`               | `native_cip`            |     9 |   ✅   |  00:00:00.680 |
| `test_nats`              | `native_nats`           |    14 |   ✅   |  00:00:00.682 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   |  00:00:00.696 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   |  00:00:00.713 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   |  00:00:00.713 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   |  00:00:00.702 |
| `test_totp`              | `native_totp`           |     4 |   ✅   |  00:00:00.707 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   |  00:00:00.704 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   |  00:00:00.681 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   |  00:00:00.715 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   |  00:00:00.723 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   |  00:00:00.957 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   |  00:00:00.672 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   |  00:00:00.693 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   |  00:00:00.675 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   |  00:00:00.720 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   |  00:00:00.721 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   |  00:00:00.749 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   |  00:00:01.133 |
| `test_range`             | `native_range`          |    13 |   ✅   |  00:00:01.154 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   |  00:00:00.733 |
| `test_jwt`               | `native_jwt`            |    16 |   ✅   |  00:00:00.753 |
| `test_upload`            | `native_upload`         |     3 |   ✅   |  00:00:01.165 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   |  00:00:00.703 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   |  00:00:00.685 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   |  00:00:00.716 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   |  00:00:00.746 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   |  00:00:00.740 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   |  00:00:00.726 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   |  00:00:00.711 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   |  00:00:00.748 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   |  00:00:01.086 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   |  00:00:00.692 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   |  00:00:00.674 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   |  00:00:00.706 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   |  00:00:00.692 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   |  00:00:00.737 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   |  00:00:00.718 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   |  00:00:00.701 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   |  00:00:00.724 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   |  00:00:00.684 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   |  00:00:00.717 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   |  00:00:00.681 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   |  00:00:00.701 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   |  00:00:00.695 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   |  00:00:00.696 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   |  00:00:00.687 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   |  00:00:00.719 |
| `test_workers`           | `native_workers`        |     3 |   ✅   |  00:00:00.820 |
| `test_clock`             | `native_clock`          |     7 |   ✅   |  00:00:00.681 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   |  00:00:00.816 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   |  00:00:01.286 |
...
------------ native_canopen:test_canopen [PASSED] Took 6.64 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.641
================= 17 test cases: 17 succeeded in 00:00:06.641 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.729
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.738
...
----------- native_iec60870:test_iec60870 [PASSED] Took 0.72 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.716
================== 8 test cases: 8 succeeded in 00:00:00.716 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.732
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.721
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.710
...
---------------- native:test_session [PASSED] Took 0.66 seconds ----------------
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.098
native         test_session       PASSED    00:00:00.661
native         test_presentation  PASSED    00:00:00.672
native         test_transport     PASSED    00:00:00.673
native         test_websocket     PASSED    00:00:00.692
native         test_http_parser   PASSED    00:00:00.657
================ 321 test cases: 321 succeeded in 00:00:04.454 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.795
================= 17 test cases: 17 succeeded in 00:00:00.795 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.106
================= 10 test cases: 10 succeeded in 00:00:01.106 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
------------- native_ota:test_http_ota [PASSED] Took 0.75 seconds --------------

=================================== SUMMARY ===================================
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.747
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 3.94 seconds -------------
...
------------ native_ssh:test_ssh_server [PASSED] Took 0.92 seconds -------------
...
----------- native_ssh:test_ssh_transport [PASSED] Took 1.11 seconds -----------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.944
native_ssh     test_ssh_auth       PASSED    00:00:00.644
native_ssh     test_ssh_server     PASSED    00:00:00.920
native_ssh     test_ssh_transport  PASSED    00:00:01.108
native_ssh     test_ssh_channel    PASSED    00:00:00.631
================ 120 test cases: 120 succeeded in 00:00:07.247 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
------ native_ssh_hardened:test_ssh_hardening [PASSED] Took 0.94 seconds -------
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.348
================== 2 test cases: 2 succeeded in 00:00:01.348 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
--------------- native_app:test_regex [PASSED] Took 1.26 seconds ---------------
...
------------- native_app:test_template [PASSED] Took 0.68 seconds --------------
...
------------ native_app:test_middleware [PASSED] Took 0.67 seconds -------------
...
------------- native_app:test_dispatch [PASSED] Took 0.67 seconds --------------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.256
native_app     test_template          PASSED    00:00:00.683
native_app     test_path_params       PASSED    00:00:00.653
native_app     test_digest_vectors    PASSED    00:00:00.580
native_app     test_form_params       PASSED    00:00:00.658
native_app     test_iface             PASSED    00:00:00.678
native_app     test_json              PASSED    00:00:00.634
native_app     test_response_headers  PASSED    00:00:00.685
native_app     test_middleware        PASSED    00:00:00.673
native_app     test_digest_auth       PASSED    00:00:00.674
native_app     test_web_terminal      PASSED    00:00:00.649
native_app     test_defer             PASSED    00:00:00.646
native_app     test_multipart         PASSED    00:00:00.660
native_app     test_auth              PASSED    00:00:00.680
native_app     test_file_serving      PASSED    00:00:00.682
native_app     test_dispatch          PASSED    00:00:00.666
native_app     test_chunked           PASSED    00:00:00.686
native_app     test_application       PASSED    00:00:00.736
================ 225 test cases: 225 succeeded in 00:00:12.579 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.266
================= 12 test cases: 12 succeeded in 00:00:01.266 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.232
================== 2 test cases: 2 succeeded in 00:00:01.232 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.744
native_snmp    test_snmp_agent  PASSED    00:00:00.558
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:02.008
================= 15 test cases: 15 succeeded in 00:00:02.008 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.858
================= 15 test cases: 15 succeeded in 00:00:00.858 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  -------------
native_coap    test_coap  PASSED    00:00:00.1000
================= 41 test cases: 41 succeeded in 00:00:00.1000 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.840
================= 41 test cases: 41 succeeded in 00:00:00.840 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.731
================= 19 test cases: 19 succeeded in 00:00:00.731 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.734
================= 22 test cases: 22 succeeded in 00:00:00.734 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.794
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.753
...
-------------- native_stomp:test_stomp [PASSED] Took 0.72 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.722
...
------------ native_mqtt_sn:test_mqtt_sn [PASSED] Took 0.71 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.712
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.697
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.768
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.802
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.880
================= 16 test cases: 16 succeeded in 00:00:00.880 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.823
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.718
================= 13 test cases: 13 succeeded in 00:00:00.718 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.725
...
------------ native_enocean:test_enocean [PASSED] Took 0.71 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.712
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_pn532   test_pn532  PASSED    00:00:00.694
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.683
...
--------------- native_wamp:test_wamp [PASSED] Took 0.76 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.756
================= 12 test cases: 12 succeeded in 00:00:00.756 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.697
================== 5 test cases: 5 succeeded in 00:00:00.697 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.731
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.711
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.689
================= 11 test cases: 11 succeeded in 00:00:00.689 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.667
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.681
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.764
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.693
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.713
...
------------- native_s7comm:test_s7comm [PASSED] Took 0.72 seconds -------------
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.702
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.688
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.699
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.680
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.682
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.696
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.713
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.713
...
------- native_ota_rollback:test_ota_rollback [PASSED] Took 0.70 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.702
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.707
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.704
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.681
================== 2 test cases: 2 succeeded in 00:00:00.681 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
------- native_dns_resolver:test_dns_resolver [PASSED] Took 0.71 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.715
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.723
================= 16 test cases: 16 succeeded in 00:00:00.723 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.957
================= 17 test cases: 17 succeeded in 00:00:00.957 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.672
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.693
================= 32 test cases: 32 succeeded in 00:00:00.693 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.675
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.720
...
-------------- native_opcua:test_opcua [PASSED] Took 0.72 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.721
================= 38 test cases: 38 succeeded in 00:00:00.721 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
------- native_opcua_client:test_opcua_client [PASSED] Took 0.75 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.749
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.133
================= 10 test cases: 10 succeeded in 00:00:01.133 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.154
================= 13 test cases: 13 succeeded in 00:00:01.154 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.733
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.753
================= 16 test cases: 16 succeeded in 00:00:00.753 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.165
================== 3 test cases: 3 succeeded in 00:00:01.165 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.703
================= 15 test cases: 15 succeeded in 00:00:00.703 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.685
================= 15 test cases: 15 succeeded in 00:00:00.685 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.716
================= 22 test cases: 22 succeeded in 00:00:00.716 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
------------ native_scratch:test_scratch [PASSED] Took 0.74 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.740
...
---------- native_snmp_trap:test_snmp_trap [PASSED] Took 0.73 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.726
...
------------ native_inflate:test_inflate [PASSED] Took 0.71 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.711
================= 12 test cases: 12 succeeded in 00:00:00.711 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.748
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.086
================= 71 test cases: 71 succeeded in 00:00:01.086 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.692
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.674
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.706
================== 4 test cases: 4 succeeded in 00:00:00.706 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.737
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.718
================== 8 test cases: 8 succeeded in 00:00:00.718 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.701
================= 15 test cases: 15 succeeded in 00:00:00.701 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.684
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.717
================= 18 test cases: 18 succeeded in 00:00:00.717 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.701
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.696
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.687
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.719
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.681
================== 7 test cases: 7 succeeded in 00:00:00.681 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.816
================== 2 test cases: 2 succeeded in 00:00:00.816 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 137 tests
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.286
================== 2 test cases: 2 succeeded in 00:00:01.286 ==================
```
