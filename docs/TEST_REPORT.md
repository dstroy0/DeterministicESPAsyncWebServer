...
| -------------------- | --------------------- | ----- | ------ | ------------ |
| `test_sse`           | `native`              | 37    | ✅     | 00:00:06.836 |
| `test_session`       | `native`              | 19    | ✅     | 00:00:00.479 |
| `test_presentation`  | `native`              | 63    | ✅     | 00:00:00.507 |
| `test_transport`     | `native`              | 28    | ✅     | 00:00:00.483 |
| `test_websocket`     | `native`              | 63    | ✅     | 00:00:00.517 |
| `test_http_parser`   | `native`              | 80    | ✅     | 00:00:00.515 |
| `test_ssh_crypto`    | `native_ssh`          | 37    | ✅     | 00:00:04.119 |
| `test_ssh_auth`      | `native_ssh`          | 12    | ✅     | 00:00:00.536 |
| `test_ssh_server`    | `native_ssh`          | 7     | ✅     | 00:00:00.655 |
| `test_ssh_transport` | `native_ssh`          | 23    | ✅     | 00:00:00.845 |
| `test_ssh_channel`   | `native_ssh`          | 12    | ✅     | 00:00:00.487 |
| `test_ssh_hardening` | `native_ssh_hardened` | 2     | ✅     | 00:00:00.788 |
| `test_ssh_conn`      | `native_ssh_conn`     | 2     | ✅     | 00:00:01.034 |
| `test_multipart`     | `native_app`          | 19    | ✅     | 00:00:00.817 |
| `test_auth`          | `native_app`          | 13    | ✅     | 00:00:00.486 |
| `test_file_serving`  | `native_app`          | 12    | ✅     | 00:00:00.498 |
| `test_dispatch`      | `native_app`          | 10    | ✅     | 00:00:00.482 |
| `test_application`   | `native_app`          | 44    | ✅     | 00:00:00.562 |
...
-------------------  ------------------  --------  ------------
native               test_sse            PASSED    00:00:06.836
native               test_session        PASSED    00:00:00.479
native               test_presentation   PASSED    00:00:00.507
native               test_transport      PASSED    00:00:00.483
native               test_websocket      PASSED    00:00:00.517
native               test_http_parser    PASSED    00:00:00.515
native_ssh           test_ssh_crypto     PASSED    00:00:04.119
native_ssh           test_ssh_auth       PASSED    00:00:00.536
native_ssh           test_ssh_server     PASSED    00:00:00.655
native_ssh           test_ssh_transport  PASSED    00:00:00.845
native_ssh           test_ssh_channel    PASSED    00:00:00.487
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.788
native_ssh_conn      test_ssh_conn       PASSED    00:00:01.034
native_app           test_multipart      PASSED    00:00:00.817
native_app           test_auth           PASSED    00:00:00.486
native_app           test_file_serving   PASSED    00:00:00.498
native_app           test_dispatch       PASSED    00:00:00.482
native_app           test_application    PASSED    00:00:00.562
native_compliance    test_compliance     PASSED    00:00:00.624
================ 495 test cases: 495 succeeded in 00:00:21.269 ================
```
