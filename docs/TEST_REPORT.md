...
**Generated:** 2026-06-29 17:56:58
**Command:** `pio test` over 76 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1378 passed - 126s
...
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.658 |
...
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.563 |
...
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.677 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.664 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.675 |
...
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.710 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.507 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.464 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.792 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.751 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.764 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.684 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.677 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.741 |
...
| `test_protobuf`          | `native_protobuf`       |     8 |   ✅   | 00:00:00.661 |
| `test_wamp`              | `native_wamp`           |    11 |   ✅   | 00:00:00.715 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.655 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.656 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.666 |
...
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.660 |
...
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.675 |
...
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.131 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.702 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.739 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.156 |
| `test_http_client`       | `native_http_client`    |    10 |   ✅   | 00:00:00.676 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.667 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.681 |
...
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.061 |
...
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.656 |
...
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.742 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.623 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.756 |
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.658
...
================= 93 test cases: 93 succeeded in 00:00:06.648 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 101 tests
...
native_app     test_json              PASSED    00:00:00.563
...
native_app     test_file_serving      PASSED    00:00:00.677
native_app     test_dispatch          PASSED    00:00:00.664
native_app     test_chunked           PASSED    00:00:00.675
native_app     test_application       PASSED    00:00:00.709
================ 219 test cases: 219 succeeded in 00:00:11.937 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 101 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.464
...
================= 29 test cases: 29 succeeded in 00:00:00.764 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 101 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.741
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.660
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.675
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.131
================= 13 test cases: 13 succeeded in 00:00:01.131 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 101 tests
...
================= 19 test cases: 19 succeeded in 00:00:00.681 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 101 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.061
================= 71 test cases: 71 succeeded in 00:00:01.061 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 101 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.656
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.742
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.756
================== 2 test cases: 2 succeeded in 00:00:00.756 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 101 tests
