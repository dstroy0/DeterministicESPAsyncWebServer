...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:06.180 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.680 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.701 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.698 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:04.441 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.668 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.665 |
...
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.695 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.687 |
...
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:01.023 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.687 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.680 |
| `test_ssh_crypto`        | `native_ssh`            |    45 |   ✅   | 00:00:04.058 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.685 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.878 |
| `test_ssh_transport`     | `native_ssh`            |    33 |   ✅   | 00:00:01.179 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.632 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.042 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.509 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.271 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.664 |
...
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.667 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.625 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.666 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.659 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.686 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.651 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.642 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.675 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.687 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.732 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.673 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.673 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.750 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.317 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.286 |
...
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.853 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.827 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.824 |
...
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.725 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.672 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.723 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.771 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.851 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.810 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.697 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.720 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.696 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.698 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.706 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.700 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.685 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.689 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.732 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.690 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.702 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.699 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.698 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.713 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.693 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.702 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.732 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.679 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.671 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.685 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.704 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.695 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.708 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.703 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.727 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.700 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.695 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.724 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.712 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.707 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.700 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.692 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.676 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.684 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.702 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.929 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.711 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.672 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.678 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.687 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.721 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.723 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.148 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.167 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.731 |
| `test_smtp`              | `native_smtp`           |    11 |   ✅   | 00:00:00.798 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.693 |
| `test_dns_server`        | `native_dns_server`     |     7 |   ✅   | 00:00:00.690 |
| `test_rtc`               | `native_rtc`            |     8 |   ✅   | 00:00:00.699 |
| `test_ld2410`            | `native_ld2410`         |     7 |   ✅   | 00:00:00.692 |
| `test_mpr121`            | `native_mpr121`         |     5 |   ✅   | 00:00:00.689 |
| `test_sht3x`             | `native_sht3x`          |     5 |   ✅   | 00:00:00.682 |
| `test_pca9685`           | `native_pca9685`        |     4 |   ✅   | 00:00:00.680 |
| `test_ads1115`           | `native_ads1115`        |     3 |   ✅   | 00:00:00.689 |
| `test_ina219`            | `native_ina219`         |     4 |   ✅   | 00:00:00.657 |
| `test_hpack`             | `native_hpack`          |     7 |   ✅   | 00:00:00.790 |
| `test_h2_frame`          | `native_h2frame`        |     6 |   ✅   | 00:00:00.661 |
| `test_h2_conn`           | `native_h2conn`         |     4 |   ✅   | 00:00:00.888 |
| `test_quic_varint`       | `native_quic_varint`    |     3 |   ✅   | 00:00:00.658 |
| `test_h3_frame`          | `native_h3frame`        |     7 |   ✅   | 00:00:00.678 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.746 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.181 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.678 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.701 |
...
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.685 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.737 |
| `test_ssh_zlib`          | `native_ssh_zlib`       |     9 |   ✅   | 00:00:00.744 |
| `test_ssh_comp`          | `native_ssh_comp`       |     5 |   ✅   | 00:00:01.068 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.120 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.686 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.685 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.702 |
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.693 |
...
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.676 |
...
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.685 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.709 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.806 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.659 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.822 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.569 |
| `test_qpack`             | `native_qpack`          |     9 |   ✅   | 00:00:00.772 |
| `test_quic_packet`       | `native_quic_packet`    |     8 |   ✅   | 00:00:00.673 |
| `test_quic_frame`        | `native_quic_frame`     |     8 |   ✅   | 00:00:00.687 |
| `test_quic_crypto`       | `native_quic_crypto`    |     7 |   ✅   | 00:00:00.770 |
| `test_tls13_kdf`         | `native_tls13_kdf`      |     5 |   ✅   | 00:00:00.724 |
| `test_quic_tp`           | `native_quic_tp`        |     7 |   ✅   | 00:00:00.684 |
| `test_tls13_msg`         | `native_tls13_msg`      |     7 |   ✅   | 00:00:00.789 |
...
| `test_h3_e2e`            | `native_h3_e2e`         |     1 |   ✅   | 00:00:01.014 |
| `test_quic_server`       | `native_quic_server`    |     2 |   ✅   | 00:00:01.079 |
| `test_h3_server`         | `native_h3_server`      |     1 |   ✅   | 00:00:01.594 |
| `test_ssh_chachapoly`    | `native_ssh_chachapoly` |     4 |   ✅   | 00:00:00.716 |
...
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.180
================= 17 test cases: 17 succeeded in 00:00:06.180 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.680
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.701
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_det_arena  test_det_arena  PASSED    00:00:00.698
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.668
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.665
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.695
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.687
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.023
================= 13 test cases: 13 succeeded in 00:00:01.023 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.058
native_ssh     test_ssh_auth       PASSED    00:00:00.685
native_ssh     test_ssh_server     PASSED    00:00:00.878
native_ssh     test_ssh_transport  PASSED    00:00:01.179
native_ssh     test_ssh_channel    PASSED    00:00:00.632
================ 145 test cases: 145 succeeded in 00:00:07.432 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:01.042
================== 2 test cases: 2 succeeded in 00:00:01.042 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.509
================== 2 test cases: 2 succeeded in 00:00:01.509 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
native_app     test_iface             PASSED    00:00:00.667
native_app     test_json              PASSED    00:00:00.625
native_app     test_response_headers  PASSED    00:00:00.666
native_app     test_middleware        PASSED    00:00:00.659
native_app     test_digest_auth       PASSED    00:00:00.686
native_app     test_web_terminal      PASSED    00:00:00.651
native_app     test_defer             PASSED    00:00:00.642
native_app     test_multipart         PASSED    00:00:00.675
native_app     test_auth              PASSED    00:00:00.687
native_app     test_file_serving      PASSED    00:00:00.732
native_app     test_dispatch          PASSED    00:00:00.673
native_app     test_chunked           PASSED    00:00:00.673
native_app     test_application       PASSED    00:00:00.750
================ 225 test cases: 225 succeeded in 00:00:12.645 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
--------------- native_diag:test_diag [PASSED] Took 1.29 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.286
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.853
================= 15 test cases: 15 succeeded in 00:00:00.853 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.827
================= 41 test cases: 41 succeeded in 00:00:00.827 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.824
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.725
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.723
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.771
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.810
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.720
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.706
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.700
================== 9 test cases: 9 succeeded in 00:00:00.700 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.689
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.732
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.713
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.702
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.732
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.671
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.704
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.695
...
---------------- native_cip:test_cip [PASSED] Took 0.73 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.727
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.700
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.695
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.724
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.712
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.700
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.676
================== 2 test cases: 2 succeeded in 00:00:00.676 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.678
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.687
================== 8 test cases: 8 succeeded in 00:00:00.687 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.148
================= 10 test cases: 10 succeeded in 00:00:01.148 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.167
================= 13 test cases: 13 succeeded in 00:00:01.167 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.731
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_smtp    test_smtp  PASSED    00:00:00.798
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_dns_server  test_dns_server  PASSED    00:00:00.690
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_rtc     test_rtc  PASSED    00:00:00.699
================== 8 test cases: 8 succeeded in 00:00:00.699 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ld2410  test_ld2410  PASSED    00:00:00.692
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_mpr121  test_mpr121  PASSED    00:00:00.689
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sht3x   test_sht3x  PASSED    00:00:00.682
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_ads1115  test_ads1115  PASSED    00:00:00.689
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_hpack   test_hpack  PASSED    00:00:00.790
================== 7 test cases: 7 succeeded in 00:00:00.790 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test          Status    Duration
-------------  ------------  --------  ------------
native_h2conn  test_h2_conn  PASSED    00:00:00.888
================== 4 test cases: 4 succeeded in 00:00:00.888 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h3frame  test_h3_frame  PASSED    00:00:00.678
================== 7 test cases: 7 succeeded in 00:00:00.678 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.746
================= 21 test cases: 21 succeeded in 00:00:00.746 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.181
================== 3 test cases: 3 succeeded in 00:00:01.181 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.701
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.685
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.737
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_zlib  test_ssh_zlib  PASSED    00:00:00.744
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.120
================= 71 test cases: 71 succeeded in 00:00:01.120 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.686
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.693
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.676
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.806
================== 3 test cases: 3 succeeded in 00:00:00.806 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.659
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.569
================== 2 test cases: 2 succeeded in 00:00:01.569 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_qpack   test_qpack  PASSED    00:00:00.772
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_packet  test_quic_packet  PASSED    00:00:00.673
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_tls13_kdf  test_tls13_kdf  PASSED    00:00:00.724
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_quic_tp  test_quic_tp  PASSED    00:00:00.684
================== 7 test cases: 7 succeeded in 00:00:00.684 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_tls13_msg  test_tls13_msg  PASSED    00:00:00.789
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_h3_e2e  test_h3_e2e  PASSED    00:00:01.014
================== 1 test cases: 1 succeeded in 00:00:01.014 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
---------- native_h3_server:test_h3_server [PASSED] Took 1.59 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_h3_server  test_h3_server  PASSED    00:00:01.594
================== 1 test cases: 1 succeeded in 00:00:01.594 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_ssh_chachapoly  test_ssh_chachapoly  PASSED    00:00:00.716
