...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:13.323 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.558 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.608 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.565 |
| `test_websocket`         | `native`               |    63 |   ✅   | 00:00:00.597 |
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.551 |
| `test_observability`     | `native_observability` |    15 |   ✅   | 00:00:00.732 |
| `test_http_ota`          | `native_ota`           |     3 |   ✅   | 00:00:00.701 |
| `test_provisioning`      | `native_prov`          |     5 |   ✅   | 00:00:00.654 |
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.845 |
...
| `test_iface`             | `native_app`           |     7 |   ✅   | 00:00:00.585 |
| `test_json`              | `native_app`           |    17 |   ✅   | 00:00:00.535 |
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.579 |
...
| `test_dispatch`          | `native_app`           |    11 |   ✅   | 00:00:00.581 |
| `test_chunked`           | `native_app`           |     8 |   ✅   | 00:00:00.584 |
| `test_application`       | `native_app`           |    50 |   ✅   | 00:00:00.672 |
| `test_snmp_ber`          | `native_snmp`          |     9 |   ✅   | 00:00:00.692 |
...
| `test_webdav`            | `native_webdav`        |    11 |   ✅   | 00:00:00.640 |
...
| `test_oidc`              | `native_oidc`          |    13 |   ✅   | 00:00:00.823 |
...
| `test_keepalive`         | `native_keepalive`     |    10 |   ✅   | 00:00:01.033 |
| `test_range`             | `native_range`         |    10 |   ✅   | 00:00:01.049 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.649 |
| `test_jwt`               | `native_jwt`           |    10 |   ✅   | 00:00:00.700 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.078 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.649 |
| `test_compliance`        | `native_compliance`    |    12 |   ✅   | 00:00:00.650 |
| `test_mqtt`              | `native_mqtt`          |    16 |   ✅   | 00:00:00.656 |
...
| `test_websocket`         | `native_ws_deflate`    |    67 |   ✅   | 00:00:01.004 |
...
| `test_msgpack`           | `native_msgpack`       |     8 |   ✅   | 00:00:00.644 |
| `test_gpio_map`          | `native_gpio_map`      |     8 |   ✅   | 00:00:00.641 |
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.651 |
...
| `test_concurrency`       | `native_tsan`          |     2 |   ✅   | 00:00:01.112 |
...
----------------- native:test_sse [PASSED] Took 13.32 seconds ------------------
...
================= 15 test cases: 15 succeeded in 00:00:00.732 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.654
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.845
...
native_ssh     test_ssh_channel    PASSED    00:00:00.534
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.113
...
native_app     test_iface             PASSED    00:00:00.585
native_app     test_json              PASSED    00:00:00.535
native_app     test_response_headers  PASSED    00:00:00.579
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.640
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.823
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.033
================= 10 test cases: 10 succeeded in 00:00:01.033 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.049
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.649
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.078
================== 3 test cases: 3 succeeded in 00:00:01.078 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
================= 16 test cases: 16 succeeded in 00:00:00.656 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
================= 67 test cases: 67 succeeded in 00:00:01.004 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.641
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.112
================== 2 test cases: 2 succeeded in 00:00:01.112 ==================
```
