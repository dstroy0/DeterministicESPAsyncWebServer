...
**Generated:** 2026-06-29 19:05:12
**Command:** `pio test` over 86 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1440 passed - 149s
...
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.285 |
...
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.701 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.227 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.184 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.723 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.501 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.475 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.818 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.842 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.767 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.683 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.689 |
...
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.658 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.675 |
| `test_protobuf`          | `native_protobuf`       |     8 |   ✅   | 00:00:00.676 |
| `test_wamp`              | `native_wamp`           |    11 |   ✅   | 00:00:00.687 |
...
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |     7 |   ✅   | 00:00:00.673 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.656 |
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.744 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.653 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.661 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.673 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.664 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.684 |
...
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.869 |
...
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.110 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.120 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.674 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.704 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.153 |
| `test_http_client`       | `native_http_client`    |    10 |   ✅   | 00:00:00.667 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.680 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.703 |
...
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.671 |
...
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.683 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.659 |
...
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.162 |
...
================ 318 test cases: 318 succeeded in 00:00:15.195 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 111 tests
...
================= 93 test cases: 93 succeeded in 00:00:06.692 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 111 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.285
...
native_app     test_digest_auth       PASSED    00:00:00.655
...
native_app     test_auth              PASSED    00:00:00.607
...
native_app     test_application       PASSED    00:00:00.701
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.723
native_snmp    test_snmp_agent  PASSED    00:00:00.501
================= 29 test cases: 29 succeeded in 00:00:01.223 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 111 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.475
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.842
================= 29 test cases: 29 succeeded in 00:00:00.842 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 111 tests
...
================= 18 test cases: 18 succeeded in 00:00:00.689 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 111 tests
...
test/test_hostlink/test_hostlink.cpp:30: test_build_dm_read: Expected '@00RD0000001057*\r' Was '@00RD0000001057*\rWz\x87\xFF\x7F' [FAILED]
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  ERRORED   00:00:00.663

============= 8 test cases: 1 failed, 6 succeeded in 00:00:00.663 =============
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 111 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.653
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.661
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.869
================= 13 test cases: 13 succeeded in 00:00:00.869 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 111 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.110
================= 10 test cases: 10 succeeded in 00:00:01.110 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 111 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.704
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.683
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.659
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.677
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.162
