...
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.878 |
...
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:01.067 |
...
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.559 |
...
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.561 |
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.541 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.575 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.569 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.576 |
| `test_dispatch`         | `native_app`          |    11 |   ✅   | 00:00:00.551 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.555 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.651 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.632 |
| `test_workers`          | `native_workers`      |     3 |   ✅   | 00:00:00.700 |
| `test_concurrency`      | `native_tsan`         |     2 |   ✅   | 00:00:01.277 |
...
----------------- native:test_sse [PASSED] Took 12.88 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:12.876
...
native_ssh           test_ssh_transport     PASSED    00:00:00.878
...
native_app           test_regex             PASSED    00:00:01.067
native_app           test_template          PASSED    00:00:00.560
...
native_app           test_iface             PASSED    00:00:00.559
...
native_app           test_web_terminal      PASSED    00:00:00.561
native_app           test_defer             PASSED    00:00:00.541
native_app           test_multipart         PASSED    00:00:00.575
native_app           test_auth              PASSED    00:00:00.569
native_app           test_file_serving      PASSED    00:00:00.576
...
native_compliance    test_compliance        PASSED    00:00:00.632
native_workers       test_workers           PASSED    00:00:00.700
native_tsan          test_concurrency       PASSED    00:00:01.277
================ 621 test cases: 621 succeeded in 00:00:37.448 ================
```
