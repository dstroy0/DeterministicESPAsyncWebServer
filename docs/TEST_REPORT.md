...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:12.293 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.676 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.684 |
...
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.667 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.691 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.677 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.681 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.677 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.005 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.585 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.621 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.607 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.645 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.613 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.750 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:00.990 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.678 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.685 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.889 |
| `test_ssh_auth`          | `native_ssh`            |    18 |   ✅   | 00:00:00.595 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.841 |
| `test_ssh_transport`     | `native_ssh`            |    27 |   ✅   | 00:00:01.046 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.560 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.897 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.284 |
...
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.612 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.574 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.627 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.611 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.631 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.610 |
...
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.616 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.696 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.231 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.178 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.725 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.532 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:01.993 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.824 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.888 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.789 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.679 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.698 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.730 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.688 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.673 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.702 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.679 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.681 |
| `test_preempt_queue`     | `native_preempt_queue`  |     7 |   ✅   | 00:00:00.702 |
...
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.680 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.684 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.743 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.687 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.678 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.673 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.650 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.656 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.652 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.659 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.661 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.674 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.658 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.683 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.707 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.667 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.699 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.693 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.728 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.699 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.710 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.886 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.677 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.704 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.687 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.701 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.718 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.706 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.090 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.094 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.687 |
| `test_jwt`               | `native_jwt`            |    16 |   ✅   | 00:00:00.715 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.149 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.660 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.668 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.697 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.701 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.710 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.713 |
...
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.672 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.687 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.662 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.706 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.685 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.674 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.656 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.688 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.672 |
...
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.688 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.690 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.697 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.795 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.683 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.819 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.129 |
...
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:12.293
================= 17 test cases: 17 succeeded in 00:00:12.293 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.676
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.684
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.667
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.691
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.677
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.677
================== 5 test cases: 5 succeeded in 00:00:00.677 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
native         test_transport     PASSED    00:00:00.607
native         test_websocket     PASSED    00:00:00.645
native         test_http_parser   PASSED    00:00:00.613
================ 321 test cases: 321 succeeded in 00:00:04.076 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.750
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.678
================== 3 test cases: 3 succeeded in 00:00:00.678 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.685
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.889
native_ssh     test_ssh_auth       PASSED    00:00:00.595
native_ssh     test_ssh_server     PASSED    00:00:00.841
native_ssh     test_ssh_transport  PASSED    00:00:01.046
native_ssh     test_ssh_channel    PASSED    00:00:00.560
================ 120 test cases: 120 succeeded in 00:00:06.932 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.284
================== 2 test cases: 2 succeeded in 00:00:01.284 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
native_app     test_iface             PASSED    00:00:00.612
native_app     test_json              PASSED    00:00:00.574
native_app     test_response_headers  PASSED    00:00:00.627
native_app     test_middleware        PASSED    00:00:00.611
native_app     test_digest_auth       PASSED    00:00:00.631
native_app     test_web_terminal      PASSED    00:00:00.610
...
native_app     test_chunked           PASSED    00:00:00.616
native_app     test_application       PASSED    00:00:00.696
================ 225 test cases: 225 succeeded in 00:00:11.656 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.231
================= 12 test cases: 12 succeeded in 00:00:01.231 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.178
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.725
native_snmp    test_snmp_agent  PASSED    00:00:00.532
================= 35 test cases: 35 succeeded in 00:00:01.257 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.993
================= 15 test cases: 15 succeeded in 00:00:01.993 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.789
================= 41 test cases: 41 succeeded in 00:00:00.789 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.698
================= 22 test cases: 22 succeeded in 00:00:00.698 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.730
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.702
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.681
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.702
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.680
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.743
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.687
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.673
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.656
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.652
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.674
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.658
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.683
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.707
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.667
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.693
...
-------- native_radio_power:test_radio_power [PASSED] Took 0.73 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.728
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.699
================== 4 test cases: 4 succeeded in 00:00:00.699 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.710
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.886
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.677
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.704
================= 32 test cases: 32 succeeded in 00:00:00.704 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.701
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.718
================= 38 test cases: 38 succeeded in 00:00:00.718 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.090
================= 10 test cases: 10 succeeded in 00:00:01.090 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.094
================= 13 test cases: 13 succeeded in 00:00:01.094 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.149
================== 3 test cases: 3 succeeded in 00:00:01.149 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.668
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.697
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.710
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.713
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.672
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.687
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.662
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.674
================= 15 test cases: 15 succeeded in 00:00:00.674 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.656
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.688
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.672
================= 18 test cases: 18 succeeded in 00:00:00.672 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.688
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.795
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.683
================== 7 test cases: 7 succeeded in 00:00:00.683 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.819
================== 2 test cases: 2 succeeded in 00:00:00.819 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.129
================== 2 test cases: 2 succeeded in 00:00:01.129 ==================
```
