...
| :---- | :---------- | ----: | :----: | -------: |
<<<<<<< HEAD
| `test_http_parser`   | `native`              |    80 |   ✅   | 00:00:03.611 |
| `test_presentation`  | `native`              |    63 |   ✅   | 00:00:02.878 |
| `test_session`       | `native`              |    19 |   ✅   | 00:00:02.915 |
| `test_sse`           | `native`              |    37 |   ✅   | 00:00:02.640 |
| `test_transport`     | `native`              |    28 |   ✅   | 00:00:02.845 |
| `test_websocket`     | `native`              |    63 |   ✅   | 00:00:02.735 |
| `test_ssh_auth`      | `native_ssh`          |    12 |   ✅   | 00:00:03.133 |
| `test_ssh_channel`   | `native_ssh`          |    12 |   ✅   | 00:00:02.729 |
| `test_ssh_crypto`    | `native_ssh`          |    37 |   ✅   | 00:00:06.606 |
| `test_ssh_server`    | `native_ssh`          |     7 |   ✅   | 00:00:02.973 |
| `test_ssh_transport` | `native_ssh`          |    23 |   ✅   | 00:00:03.333 |
| `test_ssh_hardening` | `native_ssh_hardened` |     2 |   ✅   | 00:00:01.767 |
| `test_ssh_conn`      | `native_ssh_conn`     |     2 |   ✅   | 00:00:02.014 |
| `test_application`   | `native_app`          |    47 |   ✅   | 00:00:02.915 |
| `test_auth`          | `native_app`          |    13 |   ✅   | 00:00:02.792 |
| `test_dispatch`      | `native_app`          |    10 |   ✅   | 00:00:03.036 |
| `test_file_serving`  | `native_app`          |    12 |   ✅   | 00:00:02.896 |
| `test_multipart`     | `native_app`          |    19 |   ✅   | 00:00:02.703 |
| `test_compliance`    | `native_compliance`   |    12 |   ✅   | 00:00:01.430 |
=======
| Suite                | Environment           | Tests | Status |     Duration |
| :------------------- | :-------------------- | ----: | :----: | -----------: |
...
>>>>>>> e018e74e6810eeb5e2c479699e799fa55082840f
...
=======
| `test_sse`           | `native`              |    37 |   ✅   | 00:00:09.123 |
| `test_session`       | `native`              |    19 |   ✅   | 00:00:00.477 |
| `test_presentation`  | `native`              |    63 |   ✅   | 00:00:00.503 |
| `test_transport`     | `native`              |    28 |   ✅   | 00:00:00.484 |
| `test_websocket`     | `native`              |    63 |   ✅   | 00:00:00.511 |
| `test_http_parser`   | `native`              |    80 |   ✅   | 00:00:00.514 |
| `test_ssh_crypto`    | `native_ssh`          |    37 |   ✅   | 00:00:03.803 |
| `test_ssh_auth`      | `native_ssh`          |    12 |   ✅   | 00:00:00.513 |
| `test_ssh_server`    | `native_ssh`          |     7 |   ✅   | 00:00:00.621 |
| `test_ssh_transport` | `native_ssh`          |    23 |   ✅   | 00:00:00.875 |
| `test_ssh_channel`   | `native_ssh`          |    12 |   ✅   | 00:00:00.500 |
| `test_ssh_hardening` | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.776 |
| `test_ssh_conn`      | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.039 |
| `test_multipart`     | `native_app`          |    19 |   ✅   | 00:00:00.810 |
| `test_auth`          | `native_app`          |    13 |   ✅   | 00:00:00.486 |
| `test_file_serving`  | `native_app`          |    12 |   ✅   | 00:00:00.490 |
| `test_dispatch`      | `native_app`          |    10 |   ✅   | 00:00:00.477 |
| `test_application`   | `native_app`          |    47 |   ✅   | 00:00:00.577 |
| `test_compliance`    | `native_compliance`   |    12 |   ✅   | 00:00:00.592 |
>>>>>>> 0cf241fdc2441ea4cfc0e062c2422b525c7692c3
...
------------------ native:test_sse [PASSED] Took 9.12 seconds ------------------
...
-------------- native:test_http_parser [PASSED] Took 3.61 seconds --------------
=======
...
------------- native:test_presentation [PASSED] Took 2.88 seconds --------------
=======
test/test_sse/test_sse.cpp:372: test_sse_pool_size                      [PASSED]
test/test_sse/test_sse.cpp:373: test_sse_ids_match_indices_after_init   [PASSED]
test/test_sse/test_sse.cpp:374: test_sse_all_inactive_after_init        [PASSED]
...
---------------- native:test_session [PASSED] Took 2.92 seconds ----------------
=======
test/test_session/test_session.cpp:347: test_empty_queue_does_not_crash [PASSED]
test/test_session/test_session.cpp:348: test_pool_initializes_to_parse_method [PASSED]
test/test_session/test_session.cpp:349: test_reset_clears_mid_parse_state [PASSED]
...
------------------ native:test_sse [PASSED] Took 2.64 seconds ------------------
=======
test/test_presentation/test_presentation.cpp:844: test_fn_reset_sets_parse_state_to_method [PASSED]
test/test_presentation/test_presentation.cpp:845: test_fn_reset_sets_slot_id [PASSED]
test/test_presentation/test_presentation.cpp:846: test_fn_reset_clears_method [PASSED]
...
--------------- native:test_transport [PASSED] Took 2.85 seconds ---------------
=======
test/test_transport/test_transport.cpp:394: test_pool_capacity_is_four  [PASSED]
test/test_transport/test_transport.cpp:395: test_rx_buffer_size_is_one_kb [PASSED]
test/test_transport/test_transport.cpp:396: test_timeout_constant_is_5000ms [PASSED]
...
--------------- native:test_websocket [PASSED] Took 2.73 seconds ---------------
=======
=======
test/test_websocket/test_websocket.cpp:846: test_sha1_empty_string      [PASSED]
test/test_websocket/test_websocket.cpp:847: test_sha1_abc               [PASSED]
...
------------- native_ssh:test_ssh_auth [PASSED] Took 3.13 seconds --------------
=======
=======
>>>>>>> e018e74e6810eeb5e2c479699e799fa55082840f
...
------------ native_ssh:test_ssh_channel [PASSED] Took 2.73 seconds ------------
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 6.61 seconds -------------
=======
...
------------ native_ssh:test_ssh_server [PASSED] Took 2.97 seconds -------------
=======
test/test_ssh_server/test_ssh_server.cpp:362: test_full_handshake_to_channel_data [PASSED]
test/test_ssh_server/test_ssh_server.cpp:363: test_channel_open_before_auth_rejected [PASSED]
test/test_ssh_server/test_ssh_server.cpp:364: test_disconnect_closes    [PASSED]
...
----------- native_ssh:test_ssh_transport [PASSED] Took 3.33 seconds -----------
=======
=======
test/test_ssh_transport/test_ssh_transport.cpp:515: test_server_banner_format [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:516: test_recv_banner_complete [PASSED]
...
------ native_ssh_hardened:test_ssh_hardening [PASSED] Took 1.77 seconds -------
=======
...
------------- native_app:test_multipart [PASSED] Took 0.81 seconds -------------
...
------------ native_app:test_application [PASSED] Took 2.91 seconds ------------
=======
test/test_multipart/test_multipart.cpp:494: test_no_content_type_returns_false [PASSED]
test/test_multipart/test_multipart.cpp:495: test_no_boundary_in_content_type_returns_false [PASSED]
test/test_multipart/test_multipart.cpp:496: test_body_missing_delimiter_returns_false [PASSED]
...
--------------- native_app:test_auth [PASSED] Took 2.79 seconds ----------------
...
------------- native_app:test_dispatch [PASSED] Took 3.04 seconds --------------
=======
test/test_auth/test_auth.cpp:251: test_unprotected_route_fires_handler  [PASSED]
test/test_auth/test_auth.cpp:252: test_protected_route_no_header_returns_401 [PASSED]
test/test_auth/test_auth.cpp:253: test_protected_route_wrong_password_returns_401 [PASSED]
...
----------- native_app:test_file_serving [PASSED] Took 2.90 seconds ------------
=======
test/test_file_serving/test_file_serving.cpp:324: test_missing_file_returns_404 [PASSED]
test/test_file_serving/test_file_serving.cpp:325: test_existing_file_returns_200 [PASSED]
test/test_file_serving/test_file_serving.cpp:326: test_response_includes_content_type_html [PASSED]
...
------------- native_app:test_multipart [PASSED] Took 2.70 seconds -------------
=======
=======
test/test_dispatch/test_dispatch.cpp:162: test_method_mismatch_returns_405 [PASSED]
test/test_dispatch/test_dispatch.cpp:163: test_405_includes_allow_header [PASSED]
...
--------- native_compliance:test_compliance [PASSED] Took 1.43 seconds ---------
=======
=======
>>>>>>> e018e74e6810eeb5e2c479699e799fa55082840f
...
<<<<<<< HEAD
<<<<<<< HEAD
native               test_http_parser    PASSED    00:00:03.611
native               test_presentation   PASSED    00:00:02.878
native               test_session        PASSED    00:00:02.915
native               test_sse            PASSED    00:00:02.640
native               test_transport      PASSED    00:00:02.845
native               test_websocket      PASSED    00:00:02.735
native_ssh           test_ssh_auth       PASSED    00:00:03.133
native_ssh           test_ssh_channel    PASSED    00:00:02.729
native_ssh           test_ssh_crypto     PASSED    00:00:06.606
native_ssh           test_ssh_server     PASSED    00:00:02.973
native_ssh           test_ssh_transport  PASSED    00:00:03.333
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:01.767
native_ssh_conn      test_ssh_conn       PASSED    00:00:02.014
native_app           test_application    PASSED    00:00:02.915
native_app           test_auth           PASSED    00:00:02.792
native_app           test_dispatch       PASSED    00:00:03.036
native_app           test_file_serving   PASSED    00:00:02.896
native_app           test_multipart      PASSED    00:00:02.703
native_compliance    test_compliance     PASSED    00:00:01.430
================ 498 test cases: 498 succeeded in 00:00:55.951 ================
=======
native               test_sse            PASSED    00:00:09.123
native               test_session        PASSED    00:00:00.477
native               test_presentation   PASSED    00:00:00.503
native               test_transport      PASSED    00:00:00.484
native               test_websocket      PASSED    00:00:00.511
native               test_http_parser    PASSED    00:00:00.514
native_ssh           test_ssh_crypto     PASSED    00:00:03.803
native_ssh           test_ssh_auth       PASSED    00:00:00.513
native_ssh           test_ssh_server     PASSED    00:00:00.621
native_ssh           test_ssh_transport  PASSED    00:00:00.875
native_ssh           test_ssh_channel    PASSED    00:00:00.500
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.776
native_ssh_conn      test_ssh_conn       PASSED    00:00:01.039
native_app           test_multipart      PASSED    00:00:00.810
native_app           test_auth           PASSED    00:00:00.486
native_app           test_file_serving   PASSED    00:00:00.490
native_app           test_dispatch       PASSED    00:00:00.477
native_app           test_application    PASSED    00:00:00.577
native_compliance    test_compliance     PASSED    00:00:00.592
================ 498 test cases: 498 succeeded in 00:00:23.172 ================
>>>>>>> 0cf241fdc2441ea4cfc0e062c2422b525c7692c3
=======
