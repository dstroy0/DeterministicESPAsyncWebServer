...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:12.590 |
...
| `test_ssh_crypto`       | `native_ssh`          |    38 |   ✅   | 00:00:03.920 |
...
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.517 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.824 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.198 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:01.057 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.552 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.552 |
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.494 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.546 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.549 |
...
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.605 |
| `test_workers`          | `native_workers`      |     3 |   ✅   | 00:00:00.699 |
...
----------------- native:test_sse [PASSED] Took 12.59 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:12.590
...
native_ssh           test_ssh_channel       PASSED    00:00:00.517
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.824
...
native_compliance    test_compliance        PASSED    00:00:00.605
native_workers       test_workers           PASSED    00:00:00.699
native_tsan          test_concurrency       PASSED    00:00:01.415
================ 621 test cases: 621 succeeded in 00:00:37.021 ================
```
