...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:05.684 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.568 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.589 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.594 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.615 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.584 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.584 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.576 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.599 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.589 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.593 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:00.864 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.525 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.567 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.549 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.579 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.537 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.659 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:00.895 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.573 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.604 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:04.327 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.538 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.867 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.948 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.511 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.794 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.193 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.075 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.567 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.558 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.504 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.555 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.554 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.517 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.564 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.567 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.567 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.559 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.531 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.568 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.569 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.572 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.558 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.562 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.634 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.106 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.053 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.634 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.488 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.563 |
...
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.602 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.599 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.650 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.588 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.596 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.564 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.599 |
| `test_protobuf`          | `native_protobuf`       |    10 |   ✅   | 00:00:00.583 |
| `test_preempt_queue`     | `native_preempt_queue`  |     7 |   ✅   | 00:00:00.630 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.622 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.580 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.584 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.573 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.601 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.589 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.587 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.588 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.635 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.586 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.577 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.577 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.595 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.582 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.579 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.563 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.594 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.584 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.581 |
| `test_sparkplug`         | `native_sparkplug`      |     6 |   ✅   | 00:00:00.605 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.617 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.591 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.604 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.595 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.598 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.575 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.618 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.845 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.575 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.612 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.602 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.624 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.624 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.632 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.011 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.014 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.610 |
| `test_jwt`               | `native_jwt`            |    16 |   ✅   | 00:00:00.643 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.012 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.593 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.579 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.608 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.622 |
...
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.629 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:00.954 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.570 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.575 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.604 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.587 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.626 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.605 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.622 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.605 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.605 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.605 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.578 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.592 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.586 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.591 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.580 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.599 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.697 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.559 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.688 |
...
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:05.684
================= 17 test cases: 17 succeeded in 00:00:05.684 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.568
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.589
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.594
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.615
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.584
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.576
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.599
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.589
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.593
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:00.864
native         test_session       PASSED    00:00:00.525
native         test_presentation  PASSED    00:00:00.567
native         test_transport     PASSED    00:00:00.549
native         test_websocket     PASSED    00:00:00.579
native         test_http_parser   PASSED    00:00:00.537
================ 318 test cases: 318 succeeded in 00:00:03.622 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.659
...
-------- native_accept_gate:test_accept_gate [PASSED] Took 0.89 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.895
================= 10 test cases: 10 succeeded in 00:00:00.895 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.573
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.327
native_ssh     test_ssh_auth       PASSED    00:00:00.538
native_ssh     test_ssh_server     PASSED    00:00:00.867
native_ssh     test_ssh_transport  PASSED    00:00:00.948
native_ssh     test_ssh_channel    PASSED    00:00:00.511
================ 110 test cases: 110 succeeded in 00:00:07.191 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.794
...
-------------- native_app:test_chunked [PASSED] Took 0.56 seconds --------------
...
------------ native_app:test_application [PASSED] Took 0.63 seconds ------------

=================================== SUMMARY ===================================
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.075
native_app     test_template          PASSED    00:00:00.567
native_app     test_path_params       PASSED    00:00:00.558
native_app     test_digest_vectors    PASSED    00:00:00.504
native_app     test_form_params       PASSED    00:00:00.555
native_app     test_iface             PASSED    00:00:00.554
native_app     test_json              PASSED    00:00:00.517
native_app     test_response_headers  PASSED    00:00:00.564
native_app     test_middleware        PASSED    00:00:00.567
native_app     test_digest_auth       PASSED    00:00:00.567
native_app     test_web_terminal      PASSED    00:00:00.559
native_app     test_defer             PASSED    00:00:00.531
native_app     test_multipart         PASSED    00:00:00.568
native_app     test_auth              PASSED    00:00:00.569
native_app     test_file_serving      PASSED    00:00:00.572
native_app     test_dispatch          PASSED    00:00:00.558
native_app     test_chunked           PASSED    00:00:00.562
native_app     test_application       PASSED    00:00:00.634
================ 225 test cases: 225 succeeded in 00:00:10.584 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.106
================= 12 test cases: 12 succeeded in 00:00:01.106 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.053
================== 2 test cases: 2 succeeded in 00:00:01.053 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.634
native_snmp    test_snmp_agent  PASSED    00:00:00.488
================= 35 test cases: 35 succeeded in 00:00:01.123 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.563
================= 10 test cases: 10 succeeded in 00:00:01.563 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.602
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.599
================= 22 test cases: 22 succeeded in 00:00:00.599 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.650
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.564
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.599
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.622
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.584
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.601
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.589
...
----------- native_hostlink:test_hostlink [PASSED] Took 0.59 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.588
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.635
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.586
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.577
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.577
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.595
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.582
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.563
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.594
================== 8 test cases: 8 succeeded in 00:00:00.594 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.584
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.581
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.605
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.617
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.595
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.598
================== 2 test cases: 2 succeeded in 00:00:00.598 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.575
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.618
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.845
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.575
...
================= 32 test cases: 32 succeeded in 00:00:00.612 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.624
================= 38 test cases: 38 succeeded in 00:00:00.624 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.632
================= 14 test cases: 14 succeeded in 00:00:00.632 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
================= 13 test cases: 13 succeeded in 00:00:01.014 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.610
...
================= 16 test cases: 16 succeeded in 00:00:00.643 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.012
================== 3 test cases: 3 succeeded in 00:00:01.012 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.579
...
================= 22 test cases: 22 succeeded in 00:00:00.608 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.622
================= 16 test cases: 16 succeeded in 00:00:00.622 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.629
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.954
================= 71 test cases: 71 succeeded in 00:00:00.954 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.570
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.575
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.626
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.605
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.622
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.605
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.605
================== 5 test cases: 5 succeeded in 00:00:00.605 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.605
================= 18 test cases: 18 succeeded in 00:00:00.605 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.578
================= 17 test cases: 17 succeeded in 00:00:00.578 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.591
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.580
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.697
...
-------- native_concurrency:test_concurrency [PASSED] Took 0.69 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.688
