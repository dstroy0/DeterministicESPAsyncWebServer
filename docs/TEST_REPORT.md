...
**Generated:** 2026-07-02 21:05:49
**Command:** `pio test` over 115 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1899 passed - 154s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:07.207 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.592 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.517 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.527 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.527 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.515 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.514 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.521 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.509 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.531 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.501 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:00.868 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.453 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.477 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.470 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.488 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.469 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.569 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:00.771 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.861 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.583 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:02.932 |
| `test_ssh_auth`          | `native_ssh`            |    18 |   ✅   | 00:00:00.458 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.679 |
| `test_ssh_transport`     | `native_ssh`            |    27 |   ✅   | 00:00:00.858 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.433 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.685 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:00.975 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:00.879 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.473 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.477 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.435 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.475 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.474 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.440 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.476 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.477 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.486 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.487 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.459 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.483 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.476 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.492 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.476 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.480 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.542 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:00.920 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:00.878 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.545 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.401 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:01.614 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.615 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.702 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.596 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.536 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.539 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.577 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.522 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.509 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.528 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.531 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.525 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.534 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.592 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.658 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.591 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.528 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.516 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.532 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.520 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.511 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.527 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.521 |
| `test_thread`            | `native_thread`         |     8 |   ✅   | 00:00:00.525 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.538 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.517 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.516 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.509 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.519 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.516 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.510 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.511 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.557 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.522 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.514 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.515 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.521 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.517 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.514 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.516 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.524 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.524 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.518 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.532 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.538 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.516 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.527 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.527 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.508 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.531 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.532 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.696 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.517 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.520 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.520 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.538 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.536 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.560 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:00.840 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:00.835 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.529 |
| `test_jwt`               | `native_jwt`            |    16 |   ✅   | 00:00:00.560 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.038 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.524 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.539 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.527 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.545 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.542 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.542 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.523 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.559 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:00.805 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.521 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.519 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.526 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.527 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.543 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.538 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.514 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.518 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.527 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.520 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.527 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.522 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.522 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.518 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.526 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.537 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.607 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.509 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.600 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:00.802 |
...
|  39 | `test_forwarded_ipv6_and_unknown_not_keyed`              |   ✅   | Forwarded ipv6 and unknown not keyed                                            |
...
------------ native_canopen:test_canopen [PASSED] Took 7.21 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:07.207
================= 17 test cases: 17 succeeded in 00:00:07.207 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
----- native_det_primitives:test_det_primitives [PASSED] Took 0.59 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.592
...
-------------- native_j1939:test_j1939 [PASSED] Took 0.52 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.517
================== 9 test cases: 9 succeeded in 00:00:00.517 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
---------- native_devicenet:test_devicenet [PASSED] Took 0.53 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.527
================== 8 test cases: 8 succeeded in 00:00:00.527 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
----------- native_nmea2000:test_nmea2000 [PASSED] Took 0.53 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.527
================== 6 test cases: 6 succeeded in 00:00:00.527 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_mbus:test_mbus [PASSED] Took 0.51 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.515
================= 11 test cases: 11 succeeded in 00:00:00.515 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
----------- native_iec60870:test_iec60870 [PASSED] Took 0.51 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.514
...
-------------- native_sdi12:test_sdi12 [PASSED] Took 0.52 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.521
================== 6 test cases: 6 succeeded in 00:00:00.521 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
---------------- native_dmx:test_dmx [PASSED] Took 0.51 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.509
================== 5 test cases: 5 succeeded in 00:00:00.509 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
----------- native_nmea0183:test_nmea0183 [PASSED] Took 0.53 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.531
...
------------- native_iolink:test_iolink [PASSED] Took 0.50 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.501
================== 5 test cases: 5 succeeded in 00:00:00.501 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------------ native:test_sse [PASSED] Took 0.87 seconds ------------------
...
--------------- native:test_transport [PASSED] Took 0.47 seconds ---------------
...
Building...
Testing...
test/test_http_parser/test_http_parser.cpp:1002: test_accessor_null_guards [PASSED]
test/test_http_parser/test_http_parser.cpp:1003: test_cookie_parse_edges [PASSED]
test/test_http_parser/test_http_parser.cpp:1004: test_forwarded_ip_whitespace_and_invalid [PASSED]
test/test_http_parser/test_http_parser.cpp:1007: test_reset_sets_parse_method_state [PASSED]
test/test_http_parser/test_http_parser.cpp:1008: test_reset_preserves_slot_id [PASSED]
test/test_http_parser/test_http_parser.cpp:1009: test_reset_clears_method [PASSED]
test/test_http_parser/test_http_parser.cpp:1010: test_reset_clears_path [PASSED]
test/test_http_parser/test_http_parser.cpp:1011: test_reset_clears_header_count [PASSED]
test/test_http_parser/test_http_parser.cpp:1012: test_reset_clears_body [PASSED]
test/test_http_parser/test_http_parser.cpp:1013: test_reset_clears_query_count [PASSED]
test/test_http_parser/test_http_parser.cpp:1016: test_feed_after_complete_does_not_change_state [PASSED]
test/test_http_parser/test_http_parser.cpp:1017: test_feed_after_error_does_not_change_state [PASSED]
test/test_http_parser/test_http_parser.cpp:1018: test_feed_after_entity_too_large_does_not_change_state [PASSED]
test/test_http_parser/test_http_parser.cpp:1021: test_method_get        [PASSED]
test/test_http_parser/test_http_parser.cpp:1022: test_method_post       [PASSED]
test/test_http_parser/test_http_parser.cpp:1023: test_method_put        [PASSED]
test/test_http_parser/test_http_parser.cpp:1024: test_method_delete     [PASSED]
test/test_http_parser/test_http_parser.cpp:1025: test_method_patch      [PASSED]
test/test_http_parser/test_http_parser.cpp:1026: test_method_head       [PASSED]
test/test_http_parser/test_http_parser.cpp:1027: test_method_options    [PASSED]
test/test_http_parser/test_http_parser.cpp:1028: test_method_overflow_is_error [PASSED]
test/test_http_parser/test_http_parser.cpp:1031: test_path_root         [PASSED]
test/test_http_parser/test_http_parser.cpp:1032: test_path_segments     [PASSED]
test/test_http_parser/test_http_parser.cpp:1033: test_path_without_query [PASSED]
test/test_http_parser/test_http_parser.cpp:1034: test_path_overflow_is_414 [PASSED]
test/test_http_parser/test_http_parser.cpp:1037: test_single_query_param [PASSED]
test/test_http_parser/test_http_parser.cpp:1038: test_two_query_params  [PASSED]
test/test_http_parser/test_http_parser.cpp:1039: test_query_key_not_found_returns_null [PASSED]
test/test_http_parser/test_http_parser.cpp:1040: test_query_empty_value [PASSED]
test/test_http_parser/test_http_parser.cpp:1043: test_single_header_stored [PASSED]
test/test_http_parser/test_http_parser.cpp:1044: test_header_lookup_case_insensitive [PASSED]
test/test_http_parser/test_http_parser.cpp:1045: test_cookie_basic_and_positions [PASSED]
test/test_http_parser/test_http_parser.cpp:1046: test_cookie_missing_and_no_header [PASSED]
test/test_http_parser/test_http_parser.cpp:1047: test_cookie_exact_name_not_substring [PASSED]
test/test_http_parser/test_http_parser.cpp:1048: test_cookie_quoted_and_value_with_equals [PASSED]
test/test_http_parser/test_http_parser.cpp:1049: test_forwarded_rfc7239 [PASSED]
test/test_http_parser/test_http_parser.cpp:1050: test_forwarded_leftmost_client [PASSED]
test/test_http_parser/test_http_parser.cpp:1051: test_forwarded_strips_quotes_and_port [PASSED]
test/test_http_parser/test_http_parser.cpp:1052: test_forwarded_ipv6_and_unknown_not_keyed [PASSED]
test/test_http_parser/test_http_parser.cpp:1053: test_header_leading_space_stripped [PASSED]
test/test_http_parser/test_http_parser.cpp:1054: test_content_length_header_parsed [PASSED]
test/test_http_parser/test_http_parser.cpp:1055: test_content_length_in_headers_array [PASSED]
test/test_http_parser/test_http_parser.cpp:1056: test_multiple_headers_stored [PASSED]
test/test_http_parser/test_http_parser.cpp:1057: test_missing_header_returns_null [PASSED]
test/test_http_parser/test_http_parser.cpp:1060: test_get_no_body_completes [PASSED]
test/test_http_parser/test_http_parser.cpp:1061: test_post_with_body    [PASSED]
test/test_http_parser/test_http_parser.cpp:1062: test_put_with_body     [PASSED]
test/test_http_parser/test_http_parser.cpp:1063: test_body_starting_with_newline [PASSED]
test/test_http_parser/test_http_parser.cpp:1064: test_post_content_length_zero [PASSED]
test/test_http_parser/test_http_parser.cpp:1065: test_body_exactly_at_buffer_limit [PASSED]
test/test_http_parser/test_http_parser.cpp:1066: test_body_null_terminated_after_complete [PASSED]
test/test_http_parser/test_http_parser.cpp:1069: test_body_one_over_limit_is_413 [PASSED]
test/test_http_parser/test_http_parser.cpp:1070: test_body_far_over_limit_is_413 [PASSED]
test/test_http_parser/test_http_parser.cpp:1071: test_413_no_body_bytes_fed [PASSED]
test/test_http_parser/test_http_parser.cpp:1072: test_413_header_still_stored [PASSED]
test/test_http_parser/test_http_parser.cpp:1073: test_body_exactly_at_limit_is_not_413 [PASSED]
test/test_http_parser/test_http_parser.cpp:1076: test_path_overflow_stops_feeding [PASSED]
test/test_http_parser/test_http_parser.cpp:1077: test_414_path_filled_to_capacity [PASSED]
test/test_http_parser/test_http_parser.cpp:1080: test_method_nul_byte_is_error [PASSED]
test/test_http_parser/test_http_parser.cpp:1081: test_method_control_char_is_error [PASSED]
test/test_http_parser/test_http_parser.cpp:1082: test_method_del_byte_is_error [PASSED]
test/test_http_parser/test_http_parser.cpp:1083: test_method_non_tchar_symbol_is_error [PASSED]
test/test_http_parser/test_http_parser.cpp:1084: test_method_tchar_symbols_accepted [PASSED]
test/test_http_parser/test_http_parser.cpp:1087: test_path_nul_byte_is_error [PASSED]
test/test_http_parser/test_http_parser.cpp:1088: test_path_control_char_is_error [PASSED]
test/test_http_parser/test_http_parser.cpp:1089: test_path_del_byte_is_error [PASSED]
test/test_http_parser/test_http_parser.cpp:1090: test_query_nul_byte_is_error [PASSED]
test/test_http_parser/test_http_parser.cpp:1091: test_query_control_char_is_error [PASSED]
test/test_http_parser/test_http_parser.cpp:1094: test_header_key_space_is_error [PASSED]
test/test_http_parser/test_http_parser.cpp:1095: test_header_key_nul_byte_is_error [PASSED]
test/test_http_parser/test_http_parser.cpp:1096: test_header_key_control_char_is_error [PASSED]
test/test_http_parser/test_http_parser.cpp:1097: test_header_key_mid_cr_is_error [PASSED]
test/test_http_parser/test_http_parser.cpp:1098: test_header_key_colon_at_start_skips_header [PASSED]
test/test_http_parser/test_http_parser.cpp:1099: test_long_standard_header_key_accepted [PASSED]
test/test_http_parser/test_http_parser.cpp:1100: test_overlong_header_key_truncated_not_error [PASSED]
test/test_http_parser/test_http_parser.cpp:1103: test_header_val_nul_byte_is_error [PASSED]
test/test_http_parser/test_http_parser.cpp:1104: test_header_val_control_char_is_error [PASSED]
test/test_http_parser/test_http_parser.cpp:1105: test_header_val_del_byte_is_error [PASSED]
test/test_http_parser/test_http_parser.cpp:1106: test_header_val_htab_mid_value_allowed [PASSED]
test/test_http_parser/test_http_parser.cpp:1107: test_header_val_leading_htab_stripped [PASSED]
test/test_http_parser/test_http_parser.cpp:1108: test_header_val_obs_text_allowed [PASSED]
test/test_http_parser/test_http_parser.cpp:1111: test_version_http11_recognized [PASSED]
test/test_http_parser/test_http_parser.cpp:1112: test_version_http10_recognized [PASSED]
test/test_http_parser/test_http_parser.cpp:1113: test_version_unknown_is_http_unknown [PASSED]
test/test_http_parser/test_http_parser.cpp:1114: test_version_reset_to_unknown [PASSED]
test/test_http_parser/test_http_parser.cpp:1117: test_bad_expect_lf_is_error [PASSED]
test/test_http_parser/test_http_parser.cpp:1118: test_blank_line_non_lf_is_error [PASSED]
test/test_http_parser/test_http_parser.cpp:1121: test_slots_are_independent [PASSED]
test/test_http_parser/test_http_parser.cpp:1124: test_incremental_byte_by_byte [PASSED]
test/test_http_parser/test_http_parser.cpp:1125: test_incremental_two_chunks [PASSED]
test/test_http_parser/test_http_parser.cpp:1128: stress_many_requests_same_slot [PASSED]
test/test_http_parser/test_http_parser.cpp:1129: stress_max_headers     [PASSED]
test/test_http_parser/test_http_parser.cpp:1130: stress_max_query_params [PASSED]
-------------- native:test_http_parser [PASSED] Took 0.47 seconds --------------

=================================== SUMMARY ===================================
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:00.868
native         test_session       PASSED    00:00:00.453
native         test_presentation  PASSED    00:00:00.477
native         test_transport     PASSED    00:00:00.470
native         test_websocket     PASSED    00:00:00.488
native         test_http_parser   PASSED    00:00:00.469
================ 321 test cases: 321 succeeded in 00:00:03.225 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.569
================= 17 test cases: 17 succeeded in 00:00:00.569 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
-------- native_accept_gate:test_accept_gate [PASSED] Took 0.77 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.771
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.861
================== 3 test cases: 3 succeeded in 00:00:00.861 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
----------- native_prov:test_provisioning [PASSED] Took 0.58 seconds -----------

=================================== SUMMARY ===================================
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.583
================== 5 test cases: 5 succeeded in 00:00:00.583 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 2.93 seconds -------------
...
------------- native_ssh:test_ssh_auth [PASSED] Took 0.46 seconds --------------
...
------------ native_ssh:test_ssh_channel [PASSED] Took 0.43 seconds ------------

=================================== SUMMARY ===================================
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:02.932
native_ssh     test_ssh_auth       PASSED    00:00:00.458
native_ssh     test_ssh_server     PASSED    00:00:00.679
native_ssh     test_ssh_transport  PASSED    00:00:00.858
native_ssh     test_ssh_channel    PASSED    00:00:00.433
================ 120 test cases: 120 succeeded in 00:00:05.361 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------ native_ssh_hardened:test_ssh_hardening [PASSED] Took 0.69 seconds -------

=================================== SUMMARY ===================================
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.685
================== 2 test cases: 2 succeeded in 00:00:00.685 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 0.98 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:00.975
================== 2 test cases: 2 succeeded in 00:00:00.975 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_app:test_regex [PASSED] Took 0.88 seconds ---------------
...
------------ native_app:test_path_params [PASSED] Took 0.48 seconds ------------
...
---------- native_app:test_digest_vectors [PASSED] Took 0.44 seconds -----------
...
------------ native_app:test_form_params [PASSED] Took 0.48 seconds ------------
...
------------ native_app:test_middleware [PASSED] Took 0.48 seconds -------------
...
----------- native_app:test_web_terminal [PASSED] Took 0.49 seconds ------------
...
--------------- native_app:test_defer [PASSED] Took 0.46 seconds ---------------
...
--------------- native_app:test_auth [PASSED] Took 0.48 seconds ----------------
...
-------------- native_app:test_chunked [PASSED] Took 0.48 seconds --------------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:00.879
native_app     test_template          PASSED    00:00:00.473
native_app     test_path_params       PASSED    00:00:00.477
native_app     test_digest_vectors    PASSED    00:00:00.435
native_app     test_form_params       PASSED    00:00:00.475
native_app     test_iface             PASSED    00:00:00.474
native_app     test_json              PASSED    00:00:00.440
native_app     test_response_headers  PASSED    00:00:00.476
native_app     test_middleware        PASSED    00:00:00.477
native_app     test_digest_auth       PASSED    00:00:00.486
native_app     test_web_terminal      PASSED    00:00:00.487
native_app     test_defer             PASSED    00:00:00.459
native_app     test_multipart         PASSED    00:00:00.483
native_app     test_auth              PASSED    00:00:00.476
native_app     test_file_serving      PASSED    00:00:00.492
native_app     test_dispatch          PASSED    00:00:00.476
native_app     test_chunked           PASSED    00:00:00.480
native_app     test_application       PASSED    00:00:00.542
================ 225 test cases: 225 succeeded in 00:00:08.986 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
----- native_webdav_handler:test_webdav_handler [PASSED] Took 0.92 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:00.920
================= 12 test cases: 12 succeeded in 00:00:00.920 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_diag:test_diag [PASSED] Took 0.88 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:00.878
================== 2 test cases: 2 succeeded in 00:00:00.878 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------- native_snmp:test_snmp_ber [PASSED] Took 0.55 seconds -------------
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.545
native_snmp    test_snmp_agent  PASSED    00:00:00.401
================= 35 test cases: 35 succeeded in 00:00:00.946 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 1.61 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.614
================= 15 test cases: 15 succeeded in 00:00:01.614 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------- native_telnet:test_telnet [PASSED] Took 0.62 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.615
================= 15 test cases: 15 succeeded in 00:00:00.615 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.702
================= 41 test cases: 41 succeeded in 00:00:00.702 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
test/test_coap/test_coap.cpp:1076: test_well_known_core_discovery       [PASSED]
test/test_coap/test_coap.cpp:1077: test_well_known_core_rejects_post    [PASSED]
----------- native_coap_observe:test_coap [PASSED] Took 0.60 seconds -----------

=================================== SUMMARY ===================================
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.596
================= 41 test cases: 41 succeeded in 00:00:00.596 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------- native_webdav:test_webdav [PASSED] Took 0.54 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.536
...
------------- native_modbus:test_modbus [PASSED] Took 0.54 seconds -------------
...
-------- native_cloudevents:test_cloudevents [PASSED] Took 0.58 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.577
================== 7 test cases: 7 succeeded in 00:00:00.577 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.522
================== 8 test cases: 8 succeeded in 00:00:00.522 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
-------------- native_stomp:test_stomp [PASSED] Took 0.51 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.509
================= 14 test cases: 14 succeeded in 00:00:00.509 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.528
================= 13 test cases: 13 succeeded in 00:00:00.528 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.531
...
----------- native_protobuf:test_protobuf [PASSED] Took 0.52 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.525
================= 13 test cases: 13 succeeded in 00:00:00.525 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------ native_preempt_queue:test_preempt_queue [PASSED] Took 0.53 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.534
================= 11 test cases: 11 succeeded in 00:00:00.534 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
---------------- native_dma:test_dma [PASSED] Took 0.59 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.592
================= 11 test cases: 11 succeeded in 00:00:00.592 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------ native_forward:test_forward [PASSED] Took 0.66 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.658
================= 16 test cases: 16 succeeded in 00:00:00.658 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------ native_gateway:test_gateway [PASSED] Took 0.59 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.591
...
--------------- native_lora:test_lora [PASSED] Took 0.53 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.528
================= 13 test cases: 13 succeeded in 00:00:00.528 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
-------------- native_nrf24:test_nrf24 [PASSED] Took 0.52 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.516
================= 10 test cases: 10 succeeded in 00:00:00.516 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------ native_enocean:test_enocean [PASSED] Took 0.53 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.532
...
-------------- native_pn532:test_pn532 [PASSED] Took 0.52 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_pn532   test_pn532  PASSED    00:00:00.520
================= 10 test cases: 10 succeeded in 00:00:00.520 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------- native_sigfox:test_sigfox [PASSED] Took 0.51 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.511
================== 7 test cases: 7 succeeded in 00:00:00.511 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
-------------- native_zwave:test_zwave [PASSED] Took 0.53 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.527
================== 9 test cases: 9 succeeded in 00:00:00.527 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------- native_zigbee:test_zigbee [PASSED] Took 0.52 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_zigbee  test_zigbee  PASSED    00:00:00.521
================== 9 test cases: 9 succeeded in 00:00:00.521 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_thread/test_thread.cpp:113: test_fcs_x25_check_value          [PASSED]
test/test_thread/test_thread.cpp:114: test_encode_decode_round_trip     [PASSED]
test/test_thread/test_thread.cpp:115: test_byte_stuffing_round_trip     [PASSED]
test/test_thread/test_thread.cpp:116: test_decode_needs_more_without_flag [PASSED]
test/test_thread/test_thread.cpp:117: test_decode_rejects_bad_fcs       [PASSED]
test/test_thread/test_thread.cpp:118: test_decode_rejects_dangling_escape [PASSED]
test/test_thread/test_thread.cpp:119: test_decode_rejects_small_payload_buffer [PASSED]
test/test_thread/test_thread.cpp:120: test_encode_bounds                [PASSED]
------------- native_thread:test_thread [PASSED] Took 0.52 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.525
...
--------------- native_wamp:test_wamp [PASSED] Took 0.54 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.538
================= 12 test cases: 12 succeeded in 00:00:00.538 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------ native_sunspec:test_sunspec [PASSED] Took 0.52 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.517
================== 5 test cases: 5 succeeded in 00:00:00.517 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------- native_c37118:test_c37118 [PASSED] Took 0.52 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.516
================== 6 test cases: 6 succeeded in 00:00:00.516 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_dnp3:test_dnp3 [PASSED] Took 0.51 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.509
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.519
================== 7 test cases: 7 succeeded in 00:00:00.519 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
---------- native_lwm2m_tlv:test_lwm2m_tlv [PASSED] Took 0.52 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.516
================= 11 test cases: 11 succeeded in 00:00:00.516 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_fins:test_fins [PASSED] Took 0.51 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.510
...
----------- native_hostlink:test_hostlink [PASSED] Took 0.51 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.511
================== 7 test cases: 7 succeeded in 00:00:00.511 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
-------------- native_senml:test_senml [PASSED] Took 0.56 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.557
...
---------------- native_df1:test_df1 [PASSED] Took 0.52 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.522
================== 9 test cases: 9 succeeded in 00:00:00.522 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_cotp:test_cotp [PASSED] Took 0.51 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.514
================== 6 test cases: 6 succeeded in 00:00:00.514 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------- native_s7comm:test_s7comm [PASSED] Took 0.51 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.515
...
------------- native_melsec:test_melsec [PASSED] Took 0.52 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.521
================== 6 test cases: 6 succeeded in 00:00:00.521 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------- native_bacnet:test_bacnet [PASSED] Took 0.52 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.517
================== 9 test cases: 9 succeeded in 00:00:00.517 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_enip:test_enip [PASSED] Took 0.51 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.514
================== 6 test cases: 6 succeeded in 00:00:00.514 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_amqp:test_amqp [PASSED] Took 0.52 seconds ---------------
...
---------------- native_cip:test_cip [PASSED] Took 0.52 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.524
================== 9 test cases: 9 succeeded in 00:00:00.524 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_nats:test_nats [PASSED] Took 0.52 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.524
================= 14 test cases: 14 succeeded in 00:00:00.524 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
----- native_proxy_protocol:test_proxy_protocol [PASSED] Took 0.52 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.518
================== 8 test cases: 8 succeeded in 00:00:00.518 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
---------- native_sparkplug:test_sparkplug [PASSED] Took 0.53 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.532
================== 7 test cases: 7 succeeded in 00:00:00.532 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------ native_modbus_master:test_modbus_master [PASSED] Took 0.54 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.538
================== 5 test cases: 5 succeeded in 00:00:00.538 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------- native_ota_rollback:test_ota_rollback [PASSED] Took 0.52 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.516
...
--------------- native_totp:test_totp [PASSED] Took 0.53 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.527
================== 4 test cases: 4 succeeded in 00:00:00.527 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------ native_webhook:test_webhook [PASSED] Took 0.53 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.527
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.508
================== 2 test cases: 2 succeeded in 00:00:00.508 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.531
...
---------- native_audit_log:test_audit_log [PASSED] Took 0.53 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.532
================= 16 test cases: 16 succeeded in 00:00:00.532 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_oidc:test_oidc [PASSED] Took 0.70 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.696
================= 17 test cases: 17 succeeded in 00:00:00.696 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
---------------- native_vfs:test_vfs [PASSED] Took 0.52 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.517
================= 11 test cases: 11 succeeded in 00:00:00.517 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------- native_espnow:test_espnow [PASSED] Took 0.52 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.520
...
------------- native_oauth2:test_oauth2 [PASSED] Took 0.54 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.538
================== 8 test cases: 8 succeeded in 00:00:00.538 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.536
================= 38 test cases: 38 succeeded in 00:00:00.536 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.560
================= 14 test cases: 14 succeeded in 00:00:00.560 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
---------- native_keepalive:test_keepalive [PASSED] Took 0.84 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:00.840
...
-------------- native_range:test_range [PASSED] Took 0.84 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:00.835
================= 13 test cases: 13 succeeded in 00:00:00.835 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------- native_syslog:test_syslog [PASSED] Took 0.53 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.529
================= 10 test cases: 10 succeeded in 00:00:00.529 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
---------------- native_jwt:test_jwt [PASSED] Took 0.56 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.560
================= 16 test cases: 16 succeeded in 00:00:00.560 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------- native_upload:test_upload [PASSED] Took 1.04 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.038
================== 3 test cases: 3 succeeded in 00:00:01.038 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
-------- native_http_client:test_http_client [PASSED] Took 0.52 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.524
================= 15 test cases: 15 succeeded in 00:00:00.524 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------- native_compliance:test_compliance [PASSED] Took 0.54 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.539
================= 15 test cases: 15 succeeded in 00:00:00.539 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_mqtt:test_mqtt [PASSED] Took 0.53 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.527
================= 22 test cases: 22 succeeded in 00:00:00.527 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
---------- native_ws_client:test_ws_client [PASSED] Took 0.55 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.545
================= 16 test cases: 16 succeeded in 00:00:00.545 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------ native_scratch:test_scratch [PASSED] Took 0.54 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.542
================= 14 test cases: 14 succeeded in 00:00:00.542 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
---------- native_snmp_trap:test_snmp_trap [PASSED] Took 0.54 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.542
================== 7 test cases: 7 succeeded in 00:00:00.542 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.523
================= 12 test cases: 12 succeeded in 00:00:00.523 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------ native_deflate:test_deflate [PASSED] Took 0.56 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.559
================= 10 test cases: 10 succeeded in 00:00:00.559 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
test/test_websocket/test_websocket.cpp:1107: stress_ws_parse_max_payload [PASSED]
test/test_websocket/test_websocket.cpp:1108: stress_ws_parse_two_consecutive_frames [PASSED]
--------- native_ws_deflate:test_websocket [PASSED] Took 0.81 seconds ----------

=================================== SUMMARY ===================================
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.805
================= 71 test cases: 71 succeeded in 00:00:00.805 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
-------- native_time_source:test_time_source [PASSED] Took 0.52 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.521
================== 9 test cases: 9 succeeded in 00:00:00.521 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------- native_config_store:test_config_store [PASSED] Took 0.52 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.519
================= 14 test cases: 14 succeeded in 00:00:00.519 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
---------- native_device_id:test_device_id [PASSED] Took 0.53 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.526
...
------- native_auth_lockout:test_auth_lockout [PASSED] Took 0.53 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.527
================= 10 test cases: 10 succeeded in 00:00:00.527 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_csrf:test_csrf [PASSED] Took 0.54 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.543
================== 9 test cases: 9 succeeded in 00:00:00.543 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.538
================== 8 test cases: 8 succeeded in 00:00:00.538 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
---------- native_dashboard:test_dashboard [PASSED] Took 0.51 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.514
================= 15 test cases: 15 succeeded in 00:00:00.514 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.518
================== 6 test cases: 6 succeeded in 00:00:00.518 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------ native_partition:test_partition_monitor [PASSED] Took 0.53 seconds ------

=================================== SUMMARY ===================================
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.527
================== 5 test cases: 5 succeeded in 00:00:00.527 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_cbor:test_cbor [PASSED] Took 0.52 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.520
================= 18 test cases: 18 succeeded in 00:00:00.520 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------ native_msgpack:test_msgpack [PASSED] Took 0.53 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.527
================= 17 test cases: 17 succeeded in 00:00:00.527 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
----------- native_gpio_map:test_gpio_map [PASSED] Took 0.52 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.522
================== 8 test cases: 8 succeeded in 00:00:00.522 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------ native_udp_telemetry:test_udp_telemetry [PASSED] Took 0.52 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.522
================== 7 test cases: 7 succeeded in 00:00:00.522 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------- native_guardrails:test_guardrails [PASSED] Took 0.52 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.518
================== 6 test cases: 6 succeeded in 00:00:00.518 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------- native_logbuf:test_logbuf [PASSED] Took 0.53 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.526
================== 4 test cases: 4 succeeded in 00:00:00.526 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.537
================== 4 test cases: 4 succeeded in 00:00:00.537 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
------------ native_workers:test_workers [PASSED] Took 0.61 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.607
================== 3 test cases: 3 succeeded in 00:00:00.607 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
-------------- native_clock:test_clock [PASSED] Took 0.51 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.509
================== 7 test cases: 7 succeeded in 00:00:00.509 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
-------- native_concurrency:test_concurrency [PASSED] Took 0.60 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.600
================== 2 test cases: 2 succeeded in 00:00:00.600 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 0.80 seconds ------------

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:00.802
