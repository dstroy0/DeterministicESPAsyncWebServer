...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:11.614 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.675 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.670 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.685 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:03.622 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.684 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.678 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.680 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.679 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.700 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.686 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.704 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.701 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.687 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.705 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.690 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.053 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.602 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.653 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.645 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.652 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.622 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.794 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:01.052 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.710 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.700 |
| `test_ssh_crypto`        | `native_ssh`            |    45 |   ✅   | 00:00:03.904 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.669 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.906 |
...
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.452 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.229 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.637 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.632 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.575 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.635 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.634 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.595 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.641 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.645 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.656 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.642 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.614 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.640 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.644 |
...
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.215 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.727 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.539 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:02.104 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.846 |
...
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.690 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.763 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.684 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.681 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.718 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.692 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.693 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.740 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.777 |
...
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.691 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.695 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.685 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.679 |
...
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.673 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.685 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.687 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.682 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.685 |
...
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.684 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.729 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.689 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.712 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.733 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.676 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.712 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.697 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.683 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.690 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.709 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.922 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.685 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.694 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.676 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.716 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.717 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.738 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.154 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.139 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.695 |
| `test_smtp`              | `native_smtp`           |    11 |   ✅   | 00:00:00.814 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.701 |
| `test_dns_server`        | `native_dns_server`     |     7 |   ✅   | 00:00:00.685 |
| `test_rtc`               | `native_rtc`            |     8 |   ✅   | 00:00:00.682 |
...
| `test_ads1115`           | `native_ads1115`        |     3 |   ✅   | 00:00:00.684 |
| `test_ina219`            | `native_ina219`         |     4 |   ✅   | 00:00:00.675 |
| `test_hpack`             | `native_hpack`          |     7 |   ✅   | 00:00:00.793 |
| `test_h2_frame`          | `native_h2frame`        |     6 |   ✅   | 00:00:00.683 |
| `test_h2_conn`           | `native_h2conn`         |     4 |   ✅   | 00:00:00.879 |
| `test_quic_varint`       | `native_quic_varint`    |     3 |   ✅   | 00:00:00.687 |
| `test_h3_frame`          | `native_h3frame`        |     7 |   ✅   | 00:00:00.694 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.727 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.180 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.695 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.717 |
...
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.733 |
| `test_ssh_zlib`          | `native_ssh_zlib`       |     9 |   ✅   | 00:00:00.743 |
| `test_ssh_comp`          | `native_ssh_comp`       |     5 |   ✅   | 00:00:01.075 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.096 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.688 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.680 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.705 |
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.705 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.718 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.700 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.687 |
...
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.691 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.699 |
| `test_statsd`            | `native_statsd`         |     9 |   ✅   | 00:00:00.719 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.681 |
...
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.806 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.139 |
| `test_qpack`             | `native_qpack`          |     9 |   ✅   | 00:00:00.781 |
| `test_quic_packet`       | `native_quic_packet`    |     8 |   ✅   | 00:00:00.688 |
| `test_quic_frame`        | `native_quic_frame`     |     8 |   ✅   | 00:00:00.703 |
| `test_quic_crypto`       | `native_quic_crypto`    |     7 |   ✅   | 00:00:00.781 |
| `test_tls13_kdf`         | `native_tls13_kdf`      |     5 |   ✅   | 00:00:00.729 |
| `test_quic_tp`           | `native_quic_tp`        |     7 |   ✅   | 00:00:00.705 |
| `test_tls13_msg`         | `native_tls13_msg`      |     7 |   ✅   | 00:00:00.778 |
| `test_quic_tls`          | `native_quic_tls`       |    11 |   ✅   | 00:00:00.954 |
...
| `test_quic_server`       | `native_quic_server`    |     2 |   ✅   | 00:00:01.069 |
| `test_h3_server`         | `native_h3_server`      |     1 |   ✅   | 00:00:01.551 |
| `test_ssh_chachapoly`    | `native_ssh_chachapoly` |     4 |   ✅   | 00:00:00.711 |
...
----------- native_canopen:test_canopen [PASSED] Took 11.61 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:11.614
================= 17 test cases: 17 succeeded in 00:00:11.614 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.675
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.670
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:03.622
================= 16 test cases: 16 succeeded in 00:00:03.622 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.678
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.679
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.704
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.705
...
native         test_presentation  PASSED    00:00:00.653
native         test_transport     PASSED    00:00:00.645
native         test_websocket     PASSED    00:00:00.652
native         test_http_parser   PASSED    00:00:00.622
================ 323 test cases: 323 succeeded in 00:00:04.227 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.794
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.710
================== 3 test cases: 3 succeeded in 00:00:00.710 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.700
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.904
native_ssh     test_ssh_auth       PASSED    00:00:00.669
native_ssh     test_ssh_server     PASSED    00:00:00.906
native_ssh     test_ssh_transport  PASSED    00:00:01.201
native_ssh     test_ssh_channel    PASSED    00:00:00.618
================ 145 test cases: 145 succeeded in 00:00:07.298 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.452
...
native_app     test_path_params       PASSED    00:00:00.632
native_app     test_digest_vectors    PASSED    00:00:00.575
native_app     test_form_params       PASSED    00:00:00.635
...
native_app     test_digest_auth       PASSED    00:00:00.656
native_app     test_web_terminal      PASSED    00:00:00.642
native_app     test_defer             PASSED    00:00:00.614
native_app     test_multipart         PASSED    00:00:00.640
native_app     test_auth              PASSED    00:00:00.644
...
================ 225 test cases: 225 succeeded in 00:00:12.080 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.215
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.727
native_snmp    test_snmp_agent  PASSED    00:00:00.539
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.846
================= 15 test cases: 15 succeeded in 00:00:00.846 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.690
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.763
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.681
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.692
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.740
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.777
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_pn532   test_pn532  PASSED    00:00:00.691
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.685
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_zigbee  test_zigbee  PASSED    00:00:00.679
================== 9 test cases: 9 succeeded in 00:00:00.679 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.673
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.685
================== 7 test cases: 7 succeeded in 00:00:00.685 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.684
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.729
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.689
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.733
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.697
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.683
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.690
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.709
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.922
================= 17 test cases: 17 succeeded in 00:00:00.922 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.676
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.717
================= 38 test cases: 38 succeeded in 00:00:00.717 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.139
================= 13 test cases: 13 succeeded in 00:00:01.139 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.695
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_smtp    test_smtp  PASSED    00:00:00.814
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_ntp_server  test_ntp_server  PASSED    00:00:00.701
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_dns_server  test_dns_server  PASSED    00:00:00.685
================== 7 test cases: 7 succeeded in 00:00:00.685 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_rtc     test_rtc  PASSED    00:00:00.682
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_ads1115  test_ads1115  PASSED    00:00:00.684
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_hpack   test_hpack  PASSED    00:00:00.793
...
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h2frame  test_h2_frame  PASSED    00:00:00.683
...
Environment    Test          Status    Duration
-------------  ------------  --------  ------------
native_h2conn  test_h2_conn  PASSED    00:00:00.879
================== 4 test cases: 4 succeeded in 00:00:00.879 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_varint  test_quic_varint  PASSED    00:00:00.687
...
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h3frame  test_h3_frame  PASSED    00:00:00.694
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.180
================== 3 test cases: 3 succeeded in 00:00:01.180 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.717
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.733
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_zlib  test_ssh_zlib  PASSED    00:00:00.743
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.096
================= 71 test cases: 71 succeeded in 00:00:01.096 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.688
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.705
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.705
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.687
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.691
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.699
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_statsd  test_statsd  PASSED    00:00:00.719
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.681
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.806
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.139
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_packet  test_quic_packet  PASSED    00:00:00.688
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_quic_frame  test_quic_frame  PASSED    00:00:00.703
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_crypto  test_quic_crypto  PASSED    00:00:00.781
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_tls13_kdf  test_tls13_kdf  PASSED    00:00:00.729
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_quic_tp  test_quic_tp  PASSED    00:00:00.705
================== 7 test cases: 7 succeeded in 00:00:00.705 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_tls13_msg  test_tls13_msg  PASSED    00:00:00.778
...
----------- native_quic_tls:test_quic_tls [PASSED] Took 0.95 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_quic_tls  test_quic_tls  PASSED    00:00:00.954
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_h3_conn  test_h3_conn  PASSED    00:00:00.979
================= 11 test cases: 11 succeeded in 00:00:00.979 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------- native_quic_server:test_quic_server [PASSED] Took 1.07 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_server  test_quic_server  PASSED    00:00:01.069
================== 2 test cases: 2 succeeded in 00:00:01.069 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_h3_server  test_h3_server  PASSED    00:00:01.551
================== 1 test cases: 1 succeeded in 00:00:01.551 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_ssh_chachapoly  test_ssh_chachapoly  PASSED    00:00:00.711
