...
**Generated:** 2026-07-02 19:56:36
**Command:** `pio test` over 114 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1890 passed - 194s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:05.843 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.671 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.674 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.716 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.742 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.688 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.686 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.678 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.674 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.694 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.705 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.034 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.614 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.629 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.622 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.655 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.613 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.756 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:01.028 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.716 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.718 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.778 |
| `test_ssh_auth`          | `native_ssh`            |    18 |   ✅   | 00:00:00.604 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.909 |
| `test_ssh_transport`     | `native_ssh`            |    27 |   ✅   | 00:00:01.167 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.604 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.905 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.289 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.177 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.619 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.618 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.565 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.617 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.628 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.582 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.618 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.621 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.637 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.621 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.595 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.627 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.626 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.638 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.628 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.629 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.711 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.213 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.151 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.721 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.569 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:02.116 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.824 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.783 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.781 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.685 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.686 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.750 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.678 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.675 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.682 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.679 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.678 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.712 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.770 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.820 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.769 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.675 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.676 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.664 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.685 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.672 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.673 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.673 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.709 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.679 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.681 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.677 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.674 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.674 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.684 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.682 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.752 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.672 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.681 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.675 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.687 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.671 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.660 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.677 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.689 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.675 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.680 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.692 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.702 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.694 |
...
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.923 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.694 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.690 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.671 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.699 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.704 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.713 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.099 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.107 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.706 |
| `test_jwt`               | `native_jwt`            |    16 |   ✅   | 00:00:00.730 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.127 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.680 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.697 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.683 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.710 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.718 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.706 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.682 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.715 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.034 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.673 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.679 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.708 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.670 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.718 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.688 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.668 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.676 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.679 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.678 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.686 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.681 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.680 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.670 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.674 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.701 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.787 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.675 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.820 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.201 |
...
------------ native_canopen:test_canopen [PASSED] Took 5.84 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:05.843
================= 17 test cases: 17 succeeded in 00:00:05.843 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.671
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.674
...
---------- native_devicenet:test_devicenet [PASSED] Took 0.72 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.716
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.742
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.688
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.674
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.694
...
------------- native_iolink:test_iolink [PASSED] Took 0.71 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.705
...
--------------- native:test_websocket [PASSED] Took 0.65 seconds ---------------
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.034
native         test_session       PASSED    00:00:00.614
native         test_presentation  PASSED    00:00:00.629
native         test_transport     PASSED    00:00:00.622
native         test_websocket     PASSED    00:00:00.655
native         test_http_parser   PASSED    00:00:00.613
================ 321 test cases: 321 succeeded in 00:00:04.168 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.756
...
-------- native_accept_gate:test_accept_gate [PASSED] Took 1.03 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.028
================= 10 test cases: 10 succeeded in 00:00:01.028 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.716
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.718
...
------------ native_ssh:test_ssh_channel [PASSED] Took 0.60 seconds ------------

=================================== SUMMARY ===================================
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.778
native_ssh     test_ssh_auth       PASSED    00:00:00.604
native_ssh     test_ssh_server     PASSED    00:00:00.909
native_ssh     test_ssh_transport  PASSED    00:00:01.167
native_ssh     test_ssh_channel    PASSED    00:00:00.604
================ 120 test cases: 120 succeeded in 00:00:07.063 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.905
================== 2 test cases: 2 succeeded in 00:00:00.905 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.289
================== 2 test cases: 2 succeeded in 00:00:01.289 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.177
native_app     test_template          PASSED    00:00:00.619
native_app     test_path_params       PASSED    00:00:00.618
native_app     test_digest_vectors    PASSED    00:00:00.565
native_app     test_form_params       PASSED    00:00:00.617
native_app     test_iface             PASSED    00:00:00.628
native_app     test_json              PASSED    00:00:00.582
native_app     test_response_headers  PASSED    00:00:00.618
native_app     test_middleware        PASSED    00:00:00.621
native_app     test_digest_auth       PASSED    00:00:00.637
native_app     test_web_terminal      PASSED    00:00:00.621
native_app     test_defer             PASSED    00:00:00.595
native_app     test_multipart         PASSED    00:00:00.627
native_app     test_auth              PASSED    00:00:00.626
native_app     test_file_serving      PASSED    00:00:00.638
native_app     test_dispatch          PASSED    00:00:00.628
native_app     test_chunked           PASSED    00:00:00.629
native_app     test_application       PASSED    00:00:00.711
================ 225 test cases: 225 succeeded in 00:00:11.756 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.213
================= 12 test cases: 12 succeeded in 00:00:01.213 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.151
================== 2 test cases: 2 succeeded in 00:00:01.151 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
native_snmp    test_snmp_agent  PASSED    00:00:00.569
================= 35 test cases: 35 succeeded in 00:00:01.291 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:02.116
================= 15 test cases: 15 succeeded in 00:00:02.116 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.783
================= 41 test cases: 41 succeeded in 00:00:00.783 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
test/test_coap/test_coap.cpp:1076: test_well_known_core_discovery       [PASSED]
test/test_coap/test_coap.cpp:1077: test_well_known_core_rejects_post    [PASSED]
----------- native_coap_observe:test_coap [PASSED] Took 0.78 seconds -----------

=================================== SUMMARY ===================================
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.781
================= 41 test cases: 41 succeeded in 00:00:00.781 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.685
================= 19 test cases: 19 succeeded in 00:00:00.685 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
================= 22 test cases: 22 succeeded in 00:00:00.686 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.750
...
----------- native_redis:test_redis_resp [PASSED] Took 0.68 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.678
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.682
...
----------- native_protobuf:test_protobuf [PASSED] Took 0.68 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.678
================= 13 test cases: 13 succeeded in 00:00:00.678 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
------ native_preempt_queue:test_preempt_queue [PASSED] Took 0.71 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.712
================= 11 test cases: 11 succeeded in 00:00:00.712 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
---------------- native_dma:test_dma [PASSED] Took 0.77 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.770
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.820
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.769
================= 11 test cases: 11 succeeded in 00:00:00.769 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.675
================= 13 test cases: 13 succeeded in 00:00:00.675 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.676
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.664
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_pn532   test_pn532  PASSED    00:00:00.685
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.672
================== 7 test cases: 7 succeeded in 00:00:00.672 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.673
================== 9 test cases: 9 succeeded in 00:00:00.673 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_zigbee  test_zigbee  PASSED    00:00:00.673
================== 9 test cases: 9 succeeded in 00:00:00.673 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.709
================= 12 test cases: 12 succeeded in 00:00:00.709 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.681
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.677
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.674
...
---------- native_lwm2m_tlv:test_lwm2m_tlv [PASSED] Took 0.67 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.674
================= 11 test cases: 11 succeeded in 00:00:00.674 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.752
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.675
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.687
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.671
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.677
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.689
...
----- native_proxy_protocol:test_proxy_protocol [PASSED] Took 0.68 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.680
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.694
...
--------------- native_oidc:test_oidc [PASSED] Took 0.92 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.923
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.690
================= 32 test cases: 32 succeeded in 00:00:00.690 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.671
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.704
================= 38 test cases: 38 succeeded in 00:00:00.704 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.713
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.099
================= 10 test cases: 10 succeeded in 00:00:01.099 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.107
================= 13 test cases: 13 succeeded in 00:00:01.107 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.706
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.127
================== 3 test cases: 3 succeeded in 00:00:01.127 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.680
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.697
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.683
================= 22 test cases: 22 succeeded in 00:00:00.683 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.710
================= 16 test cases: 16 succeeded in 00:00:00.710 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.718
================= 14 test cases: 14 succeeded in 00:00:00.718 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.706
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.682
================= 12 test cases: 12 succeeded in 00:00:00.682 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.715
================= 10 test cases: 10 succeeded in 00:00:00.715 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
test/test_websocket/test_websocket.cpp:1107: stress_ws_parse_max_payload [PASSED]
test/test_websocket/test_websocket.cpp:1108: stress_ws_parse_two_consecutive_frames [PASSED]
--------- native_ws_deflate:test_websocket [PASSED] Took 1.03 seconds ----------

=================================== SUMMARY ===================================
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.034
================= 71 test cases: 71 succeeded in 00:00:01.034 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.673
================== 9 test cases: 9 succeeded in 00:00:00.673 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.679
================= 14 test cases: 14 succeeded in 00:00:00.679 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.718
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.688
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.668
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.679
================== 5 test cases: 5 succeeded in 00:00:00.679 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
================= 18 test cases: 18 succeeded in 00:00:00.678 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.686
================= 17 test cases: 17 succeeded in 00:00:00.686 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 139 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.681
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.680
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.670
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.674
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.701
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.675
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.201
================== 2 test cases: 2 succeeded in 00:00:01.201 ==================
```
