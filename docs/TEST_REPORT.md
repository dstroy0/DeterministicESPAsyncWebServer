...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:08.726 |
...
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.799 |
...
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.201 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:01.057 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.548 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.553 |
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.498 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.554 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.550 |
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.510 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.556 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.554 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.555 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.553 |
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.528 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.562 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.552 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.570 |
| `test_dispatch`         | `native_app`          |    11 |   ✅   | 00:00:00.555 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.551 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.647 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.625 |
| `test_workers`          | `native_workers`      |     3 |   ✅   | 00:00:00.701 |
...
------------------ native:test_sse [PASSED] Took 8.73 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:08.726
native               test_session           PASSED    00:00:00.537
...
native_ssh           test_ssh_crypto        PASSED    00:00:03.799
...
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.201
native_app           test_regex             PASSED    00:00:01.057
native_app           test_template          PASSED    00:00:00.548
native_app           test_path_params       PASSED    00:00:00.553
native_app           test_digest_vectors    PASSED    00:00:00.498
...
native_app           test_web_terminal      PASSED    00:00:00.553
native_app           test_defer             PASSED    00:00:00.528
native_app           test_multipart         PASSED    00:00:00.562
native_app           test_auth              PASSED    00:00:00.552
native_app           test_file_serving      PASSED    00:00:00.570
native_app           test_dispatch          PASSED    00:00:00.555
...
native_workers       test_workers           PASSED    00:00:00.701
native_tsan          test_concurrency       PASSED    00:00:01.118
================ 620 test cases: 620 succeeded in 00:00:32.807 ================
```
