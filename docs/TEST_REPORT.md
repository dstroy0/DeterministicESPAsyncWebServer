...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:13.582 |
...
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:04.332 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.596 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.746 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:01.031 |
...
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:01.061 |
...
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.569 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.596 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.557 |
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.534 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.577 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.558 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.575 |
...
| `test_concurrency`      | `native_tsan`         |     2 |   ✅   | 00:00:01.528 |
...
----------------- native:test_sse [PASSED] Took 13.58 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:13.582
...
native_ssh           test_ssh_crypto        PASSED    00:00:04.332
native_ssh           test_ssh_auth          PASSED    00:00:00.596
native_ssh           test_ssh_server        PASSED    00:00:00.746
...
native_app           test_regex             PASSED    00:00:01.061
...
native_app           test_middleware        PASSED    00:00:00.569
native_app           test_digest_auth       PASSED    00:00:00.596
native_app           test_web_terminal      PASSED    00:00:00.557
native_app           test_defer             PASSED    00:00:00.534
native_app           test_multipart         PASSED    00:00:00.577
native_app           test_auth              PASSED    00:00:00.558
native_app           test_file_serving      PASSED    00:00:00.575
...
native_tsan          test_concurrency       PASSED    00:00:01.528
================ 620 test cases: 620 succeeded in 00:00:39.503 ================
```
