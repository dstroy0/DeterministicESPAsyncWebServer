...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:10.968 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.524 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.559 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.541 |
| `test_websocket`         | `native`               |    63 |   ✅   | 00:00:00.563 |
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.525 |
| `test_observability`     | `native_observability` |    15 |   ✅   | 00:00:00.662 |
| `test_http_ota`          | `native_ota`           |     3 |   ✅   | 00:00:00.624 |
| `test_provisioning`      | `native_prov`          |     5 |   ✅   | 00:00:00.632 |
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.814 |
| `test_ssh_auth`          | `native_ssh`           |    12 |   ✅   | 00:00:00.538 |
| `test_ssh_server`        | `native_ssh`           |     7 |   ✅   | 00:00:00.643 |
| `test_ssh_transport`     | `native_ssh`           |    23 |   ✅   | 00:00:00.853 |
| `test_ssh_channel`       | `native_ssh`           |    12 |   ✅   | 00:00:00.504 |
| `test_ssh_hardening`     | `native_ssh_hardened`  |     2 |   ✅   | 00:00:00.851 |
| `test_ssh_conn`          | `native_ssh_conn`      |     2 |   ✅   | 00:00:01.227 |
| `test_regex`             | `native_app`           |     9 |   ✅   | 00:00:01.047 |
| `test_template`          | `native_app`           |     6 |   ✅   | 00:00:00.545 |
| `test_path_params`       | `native_app`           |     8 |   ✅   | 00:00:00.543 |
| `test_digest_vectors`    | `native_app`           |     4 |   ✅   | 00:00:00.491 |
| `test_form_params`       | `native_app`           |     5 |   ✅   | 00:00:00.536 |
| `test_iface`             | `native_app`           |     7 |   ✅   | 00:00:00.552 |
| `test_json`              | `native_app`           |    17 |   ✅   | 00:00:00.498 |
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.546 |
| `test_middleware`        | `native_app`           |     9 |   ✅   | 00:00:00.548 |
| `test_digest_auth`       | `native_app`           |     5 |   ✅   | 00:00:00.557 |
| `test_web_terminal`      | `native_app`           |     7 |   ✅   | 00:00:00.544 |
| `test_defer`             | `native_app`           |     3 |   ✅   | 00:00:00.518 |
| `test_multipart`         | `native_app`           |    19 |   ✅   | 00:00:00.557 |
| `test_auth`              | `native_app`           |    13 |   ✅   | 00:00:00.551 |
| `test_file_serving`      | `native_app`           |    12 |   ✅   | 00:00:00.560 |
| `test_dispatch`          | `native_app`           |    11 |   ✅   | 00:00:00.543 |
| `test_chunked`           | `native_app`           |     8 |   ✅   | 00:00:00.548 |
| `test_application`       | `native_app`           |    50 |   ✅   | 00:00:00.643 |
| `test_snmp_ber`          | `native_snmp`          |     9 |   ✅   | 00:00:00.656 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.469 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.346 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.733 |
| `test_coap`              | `native_coap`          |    26 |   ✅   | 00:00:00.650 |
| `test_webdav`            | `native_webdav`        |    11 |   ✅   | 00:00:00.614 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.616 |
| `test_modbus_master`     | `native_modbus_master` |     5 |   ✅   | 00:00:00.636 |
| `test_ota_rollback`      | `native_ota_rollback`  |     5 |   ✅   | 00:00:00.608 |
| `test_totp`              | `native_totp`          |     4 |   ✅   | 00:00:00.635 |
| `test_webhook`           | `native_webhook`       |     5 |   ✅   | 00:00:00.616 |
| `test_radio_power`       | `native_radio_power`   |     2 |   ✅   | 00:00:00.606 |
| `test_dns_resolver`      | `native_dns_resolver`  |     4 |   ✅   | 00:00:00.617 |
| `test_audit_log`         | `native_audit_log`     |    12 |   ✅   | 00:00:00.631 |
| `test_oidc`              | `native_oidc`          |    13 |   ✅   | 00:00:00.796 |
| `test_vfs`               | `native_vfs`           |    11 |   ✅   | 00:00:00.624 |
| `test_graphql`           | `native_graphql`       |    13 |   ✅   | 00:00:00.642 |
| `test_espnow`            | `native_espnow`        |     7 |   ✅   | 00:00:00.624 |
| `test_oauth2`            | `native_oauth2`        |     8 |   ✅   | 00:00:00.641 |
| `test_opcua`             | `native_opcua`         |    29 |   ✅   | 00:00:00.647 |
| `test_opcua_client`      | `native_opcua_client`  |    11 |   ✅   | 00:00:00.651 |
| `test_keepalive`         | `native_keepalive`     |    10 |   ✅   | 00:00:00.995 |
| `test_range`             | `native_range`         |    10 |   ✅   | 00:00:00.997 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.632 |
| `test_jwt`               | `native_jwt`           |    10 |   ✅   | 00:00:00.668 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.024 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.637 |
| `test_compliance`        | `native_compliance`    |    12 |   ✅   | 00:00:00.625 |
| `test_mqtt`              | `native_mqtt`          |    16 |   ✅   | 00:00:00.629 |
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.648 |
| `test_scratch`           | `native_scratch`       |    14 |   ✅   | 00:00:00.657 |
| `test_snmp_trap`         | `native_snmp_trap`     |     3 |   ✅   | 00:00:00.646 |
| `test_inflate`           | `native_inflate`       |    12 |   ✅   | 00:00:00.629 |
| `test_deflate`           | `native_deflate`       |    10 |   ✅   | 00:00:00.669 |
| `test_websocket`         | `native_ws_deflate`    |    67 |   ✅   | 00:00:00.971 |
| `test_time_source`       | `native_time_source`   |     9 |   ✅   | 00:00:00.606 |
| `test_config_store`      | `native_config_store`  |    14 |   ✅   | 00:00:00.628 |
| `test_device_id`         | `native_device_id`     |     4 |   ✅   | 00:00:00.631 |
| `test_auth_lockout`      | `native_auth_lockout`  |    10 |   ✅   | 00:00:00.607 |
| `test_csrf`              | `native_csrf`          |     9 |   ✅   | 00:00:00.644 |
| `test_telemetry`         | `native_telemetry`     |     8 |   ✅   | 00:00:00.612 |
| `test_dashboard`         | `native_dashboard`     |    11 |   ✅   | 00:00:00.620 |
| `test_net_egress`        | `native_net_egress`    |     5 |   ✅   | 00:00:00.612 |
| `test_partition_monitor` | `native_partition`     |     5 |   ✅   | 00:00:00.615 |
| `test_cbor`              | `native_cbor`          |    14 |   ✅   | 00:00:00.630 |
| `test_msgpack`           | `native_msgpack`       |     8 |   ✅   | 00:00:00.629 |
| `test_gpio_map`          | `native_gpio_map`      |     8 |   ✅   | 00:00:00.618 |
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.612 |
| `test_guardrails`        | `native_guardrails`    |     6 |   ✅   | 00:00:00.643 |
| `test_logbuf`            | `native_logbuf`        |     4 |   ✅   | 00:00:00.616 |
| `test_config_io`         | `native_config_io`     |     4 |   ✅   | 00:00:00.641 |
| `test_workers`           | `native_workers`       |     3 |   ✅   | 00:00:00.703 |
| `test_clock`             | `native_clock`         |     4 |   ✅   | 00:00:00.597 |
| `test_concurrency`       | `native_concurrency`   |     2 |   ✅   | 00:00:00.798 |
| `test_concurrency`       | `native_tsan`          |     2 |   ✅   | 00:00:01.140 |
...
----------------- native:test_sse [PASSED] Took 10.97 seconds ------------------
...
------------- native:test_presentation [PASSED] Took 0.56 seconds --------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:10.968
native         test_session       PASSED    00:00:00.524
native         test_presentation  PASSED    00:00:00.559
native         test_transport     PASSED    00:00:00.541
native         test_websocket     PASSED    00:00:00.563
native         test_http_parser   PASSED    00:00:00.525
================ 306 test cases: 306 succeeded in 00:00:13.681 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.662
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.624
================== 3 test cases: 3 succeeded in 00:00:00.624 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.632
...
----------- native_ssh:test_ssh_transport [PASSED] Took 0.85 seconds -----------
...
native_ssh     test_ssh_auth       PASSED    00:00:00.538
native_ssh     test_ssh_server     PASSED    00:00:00.643
native_ssh     test_ssh_transport  PASSED    00:00:00.853
native_ssh     test_ssh_channel    PASSED    00:00:00.504
================= 92 test cases: 92 succeeded in 00:00:06.353 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.227
...
Building...
Testing...
test/test_file_serving/test_file_serving.cpp:328: test_missing_file_returns_404 [PASSED]
test/test_file_serving/test_file_serving.cpp:329: test_existing_file_returns_200 [PASSED]
test/test_file_serving/test_file_serving.cpp:330: test_response_includes_content_type_html [PASSED]
test/test_file_serving/test_file_serving.cpp:331: test_response_includes_content_type_js [PASSED]
test/test_file_serving/test_file_serving.cpp:332: test_content_length_matches_file_size [PASSED]
test/test_file_serving/test_file_serving.cpp:333: test_file_body_is_sent [PASSED]
test/test_file_serving/test_file_serving.cpp:334: test_empty_file_returns_200_with_zero_length [PASSED]
test/test_file_serving/test_file_serving.cpp:335: test_large_file_body_fully_sent [PASSED]
test/test_file_serving/test_file_serving.cpp:336: test_serve_file_does_not_affect_other_routes [PASSED]
test/test_file_serving/test_file_serving.cpp:337: test_multiple_content_types [PASSED]
test/test_file_serving/test_file_serving.cpp:338: stress_serve_file_50_requests [PASSED]
test/test_file_serving/test_file_serving.cpp:339: stress_alternate_missing_and_found [PASSED]
...
Building...
Testing...
test/test_chunked/test_chunked.cpp:210: test_headers_announce_chunked_no_content_length [PASSED]
test/test_chunked/test_chunked.cpp:211: test_single_chunk_framing       [PASSED]
test/test_chunked/test_chunked.cpp:212: test_multiple_chunks_in_order   [PASSED]
test/test_chunked/test_chunked.cpp:213: test_printf_chunk               [PASSED]
test/test_chunked/test_chunked.cpp:214: test_empty_writes_do_not_terminate_early [PASSED]
test/test_chunked/test_chunked.cpp:215: test_head_sends_headers_only    [PASSED]
test/test_chunked/test_chunked.cpp:216: test_custom_header_injected_into_chunked [PASSED]
test/test_chunked/test_chunked.cpp:217: test_log_hook_reports_total_body_length [PASSED]
...
native_app     test_path_params       PASSED    00:00:00.543
native_app     test_digest_vectors    PASSED    00:00:00.491
native_app     test_form_params       PASSED    00:00:00.536
native_app     test_iface             PASSED    00:00:00.552
native_app     test_json              PASSED    00:00:00.498
native_app     test_response_headers  PASSED    00:00:00.546
native_app     test_middleware        PASSED    00:00:00.548
native_app     test_digest_auth       PASSED    00:00:00.557
native_app     test_web_terminal      PASSED    00:00:00.544
native_app     test_defer             PASSED    00:00:00.518
native_app     test_multipart         PASSED    00:00:00.557
native_app     test_auth              PASSED    00:00:00.551
...
================ 202 test cases: 202 succeeded in 00:00:10.327 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.656
native_snmp    test_snmp_agent  PASSED    00:00:00.469
================= 22 test cases: 22 succeeded in 00:00:01.125 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.346
================== 9 test cases: 9 succeeded in 00:00:01.346 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
--------------- native_coap:test_coap [PASSED] Took 0.65 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.650
================= 26 test cases: 26 succeeded in 00:00:00.650 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.614
...
================= 13 test cases: 13 succeeded in 00:00:00.616 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.636
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.635
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.616
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.617
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.631
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.642
================= 13 test cases: 13 succeeded in 00:00:00.642 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.641
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.647
================= 29 test cases: 29 succeeded in 00:00:00.647 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.651
...
---------- native_keepalive:test_keepalive [PASSED] Took 0.99 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:00.995
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:00.997
================= 10 test cases: 10 succeeded in 00:00:00.997 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.668
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.024
================== 3 test cases: 3 succeeded in 00:00:01.024 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.625
================= 12 test cases: 12 succeeded in 00:00:00.625 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.629
================= 16 test cases: 16 succeeded in 00:00:00.629 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.648
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.646
================== 3 test cases: 3 succeeded in 00:00:00.646 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.629
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.669
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.971
================= 67 test cases: 67 succeeded in 00:00:00.971 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
-------- native_time_source:test_time_source [PASSED] Took 0.61 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.606
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.631
================== 4 test cases: 4 succeeded in 00:00:00.631 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.607
================= 10 test cases: 10 succeeded in 00:00:00.607 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.644
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.620
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.612
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.615
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.630
================= 14 test cases: 14 succeeded in 00:00:00.630 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.629
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.618
================== 8 test cases: 8 succeeded in 00:00:00.618 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.616
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.703
...
-------------- native_clock:test_clock [PASSED] Took 0.60 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.597
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.140
================== 2 test cases: 2 succeeded in 00:00:01.140 ==================
```
