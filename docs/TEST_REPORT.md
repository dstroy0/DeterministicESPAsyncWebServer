...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:06.208 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.653 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.656 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.657 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.678 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.653 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.683 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.699 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.679 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.685 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.678 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.034 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.609 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.634 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.617 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.644 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.621 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.749 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:01.036 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.696 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.713 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.896 |
| `test_ssh_auth`          | `native_ssh`            |    18 |   ✅   | 00:00:00.599 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.851 |
| `test_ssh_transport`     | `native_ssh`            |    27 |   ✅   | 00:00:01.060 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.568 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.920 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.315 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.205 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.595 |
...
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.595 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.567 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.599 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.597 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.616 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.597 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.573 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.613 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.601 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.615 |
...
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.212 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.182 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.703 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.507 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:02.005 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.804 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.775 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.750 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.679 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.684 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.722 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.666 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.660 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.668 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.672 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.657 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.677 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.757 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.818 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.757 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.650 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.661 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.658 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.662 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.649 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.654 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.651 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.661 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.699 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.659 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.659 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.667 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.669 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.661 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.664 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.674 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.723 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.656 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.653 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.645 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.653 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.658 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.666 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.658 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.658 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.719 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.669 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.684 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.686 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.658 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.671 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.663 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.655 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.657 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.692 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.897 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.667 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.668 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.645 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.688 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.694 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.704 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.093 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.108 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.679 |
| `test_jwt`               | `native_jwt`            |    16 |   ✅   | 00:00:00.713 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.128 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.677 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.690 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.675 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.709 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.697 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.677 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.674 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.704 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.033 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.659 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.669 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.662 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.658 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.698 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.679 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.681 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.670 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.671 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.675 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.668 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.670 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.661 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.651 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.657 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.688 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.768 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.638 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.760 |
...
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.208
================= 17 test cases: 17 succeeded in 00:00:06.208 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.656
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.653
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.683
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.699
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.685
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.678
...
native         test_session       PASSED    00:00:00.609
native         test_presentation  PASSED    00:00:00.634
native         test_transport     PASSED    00:00:00.617
native         test_websocket     PASSED    00:00:00.644
native         test_http_parser   PASSED    00:00:00.621
================ 321 test cases: 321 succeeded in 00:00:04.159 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.749
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.036
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.696
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.713
...
----------- native_ssh:test_ssh_transport [PASSED] Took 1.06 seconds -----------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.896
native_ssh     test_ssh_auth       PASSED    00:00:00.599
native_ssh     test_ssh_server     PASSED    00:00:00.851
native_ssh     test_ssh_transport  PASSED    00:00:01.060
native_ssh     test_ssh_channel    PASSED    00:00:00.568
================ 120 test cases: 120 succeeded in 00:00:06.973 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.315
================== 2 test cases: 2 succeeded in 00:00:01.315 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_app:test_regex [PASSED] Took 1.21 seconds ---------------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.205
native_app     test_template          PASSED    00:00:00.595
...
native_app     test_iface             PASSED    00:00:00.595
native_app     test_json              PASSED    00:00:00.567
native_app     test_response_headers  PASSED    00:00:00.599
native_app     test_middleware        PASSED    00:00:00.597
native_app     test_digest_auth       PASSED    00:00:00.616
native_app     test_web_terminal      PASSED    00:00:00.597
native_app     test_defer             PASSED    00:00:00.573
native_app     test_multipart         PASSED    00:00:00.613
native_app     test_auth              PASSED    00:00:00.601
native_app     test_file_serving      PASSED    00:00:00.615
...
================ 225 test cases: 225 succeeded in 00:00:11.411 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.212
================= 12 test cases: 12 succeeded in 00:00:01.212 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.182
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.703
native_snmp    test_snmp_agent  PASSED    00:00:00.507
================= 35 test cases: 35 succeeded in 00:00:01.210 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:02.005
================= 15 test cases: 15 succeeded in 00:00:02.005 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.775
================= 41 test cases: 41 succeeded in 00:00:00.775 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.750
================= 41 test cases: 41 succeeded in 00:00:00.750 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.684
================= 22 test cases: 22 succeeded in 00:00:00.684 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.722
...
----------- native_redis:test_redis_resp [PASSED] Took 0.67 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.666
...
------------ native_mqtt_sn:test_mqtt_sn [PASSED] Took 0.67 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.668
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.672
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.677
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.818
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.757
================= 11 test cases: 11 succeeded in 00:00:00.757 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.650
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.661
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.658
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.649
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.654
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_zigbee  test_zigbee  PASSED    00:00:00.651
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.661
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.659
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.659
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.667
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.664
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.723
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.656
================== 9 test cases: 9 succeeded in 00:00:00.656 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.653
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.645
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.653
================== 6 test cases: 6 succeeded in 00:00:00.653 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.666
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.658
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.658
================== 9 test cases: 9 succeeded in 00:00:00.658 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
--------------- native_nats:test_nats [PASSED] Took 0.72 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.719
================= 14 test cases: 14 succeeded in 00:00:00.719 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.669
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.686
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.658
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.663
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.655
================== 2 test cases: 2 succeeded in 00:00:00.655 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.657
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.692
================= 16 test cases: 16 succeeded in 00:00:00.692 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.897
================= 17 test cases: 17 succeeded in 00:00:00.897 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.668
================= 32 test cases: 32 succeeded in 00:00:00.668 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.645
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.694
================= 38 test cases: 38 succeeded in 00:00:00.694 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.679
================= 10 test cases: 10 succeeded in 00:00:00.679 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.713
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.128
================== 3 test cases: 3 succeeded in 00:00:01.128 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.677
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.690
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.675
================= 22 test cases: 22 succeeded in 00:00:00.675 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.709
================= 16 test cases: 16 succeeded in 00:00:00.709 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.697
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.677
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.704
================= 10 test cases: 10 succeeded in 00:00:00.704 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.033
================= 71 test cases: 71 succeeded in 00:00:01.033 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.659
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.669
================= 14 test cases: 14 succeeded in 00:00:00.669 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.662
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.658
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.698
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.681
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.670
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.671
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.675
================= 18 test cases: 18 succeeded in 00:00:00.675 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.668
================= 17 test cases: 17 succeeded in 00:00:00.668 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 140 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.670
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.661
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.688
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.768
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.638
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.760
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 1.35 seconds ------------
