...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:13.433 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.529 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.562 |
| `test_transport`        | `native`              |    28 |   ✅   | 00:00:00.554 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.584 |
| `test_http_parser`      | `native`              |    80 |   ✅   | 00:00:00.563 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.920 |
...
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.119 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.992 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.538 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.556 |
...
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.540 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.540 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.548 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.543 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.541 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.547 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.557 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.540 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.541 |
| `test_application`      | `native_app`          |    49 |   ✅   | 00:00:00.639 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.656 |
...
----------------- native:test_sse [PASSED] Took 13.43 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:13.433
native               test_session           PASSED    00:00:00.529
native               test_presentation      PASSED    00:00:00.562
native               test_transport         PASSED    00:00:00.554
native               test_websocket         PASSED    00:00:00.584
native               test_http_parser       PASSED    00:00:00.563
native_ssh           test_ssh_crypto        PASSED    00:00:03.920
...
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.119
native_app           test_regex             PASSED    00:00:00.992
native_app           test_template          PASSED    00:00:00.538
native_app           test_path_params       PASSED    00:00:00.556
...
native_app           test_digest_auth       PASSED    00:00:00.548
native_app           test_web_terminal      PASSED    00:00:00.543
native_app           test_multipart         PASSED    00:00:00.541
native_app           test_auth              PASSED    00:00:00.547
native_app           test_file_serving      PASSED    00:00:00.557
native_app           test_dispatch          PASSED    00:00:00.540
native_app           test_chunked           PASSED    00:00:00.541
native_app           test_application       PASSED    00:00:00.639
native_compliance    test_compliance        PASSED    00:00:00.656
================ 594 test cases: 594 succeeded in 00:00:35.159 ================
```
