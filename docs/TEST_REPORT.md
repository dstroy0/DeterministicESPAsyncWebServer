...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:11.691 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.564 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.601 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.581 |
| `test_websocket`         | `native`               |    63 |   ✅   | 00:00:00.600 |
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.568 |
| `test_observability`     | `native_observability` |    15 |   ✅   | 00:00:00.705 |
| `test_http_ota`          | `native_ota`           |     3 |   ✅   | 00:00:00.646 |
| `test_provisioning`      | `native_prov`          |     5 |   ✅   | 00:00:00.646 |
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.854 |
...
| `test_ssh_hardening`     | `native_ssh_hardened`  |     2 |   ✅   | 00:00:00.864 |
...
| `test_json`              | `native_app`           |    17 |   ✅   | 00:00:00.556 |
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.601 |
| `test_middleware`        | `native_app`           |     9 |   ✅   | 00:00:00.617 |
| `test_digest_auth`       | `native_app`           |     5 |   ✅   | 00:00:00.595 |
| `test_web_terminal`      | `native_app`           |     7 |   ✅   | 00:00:00.593 |
| `test_defer`             | `native_app`           |     3 |   ✅   | 00:00:00.577 |
...
| `test_dispatch`          | `native_app`           |    11 |   ✅   | 00:00:00.599 |
| `test_chunked`           | `native_app`           |    10 |   ✅   | 00:00:00.605 |
| `test_application`       | `native_app`           |    50 |   ✅   | 00:00:00.671 |
| `test_snmp_ber`          | `native_snmp`          |     9 |   ✅   | 00:00:00.677 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.491 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.373 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.782 |
| `test_coap`              | `native_coap`          |    26 |   ✅   | 00:00:00.665 |
| `test_webdav`            | `native_webdav`        |    19 |   ✅   | 00:00:00.658 |
...
| `test_webhook`           | `native_webhook`       |     5 |   ✅   | 00:00:00.646 |
| `test_radio_power`       | `native_radio_power`   |     2 |   ✅   | 00:00:00.640 |
| `test_dns_resolver`      | `native_dns_resolver`  |     4 |   ✅   | 00:00:00.631 |
| `test_audit_log`         | `native_audit_log`     |    12 |   ✅   | 00:00:00.670 |
| `test_oidc`              | `native_oidc`          |    13 |   ✅   | 00:00:00.824 |
| `test_vfs`               | `native_vfs`           |    11 |   ✅   | 00:00:00.628 |
| `test_graphql`           | `native_graphql`       |    13 |   ✅   | 00:00:00.650 |
| `test_espnow`            | `native_espnow`        |     7 |   ✅   | 00:00:00.635 |
| `test_oauth2`            | `native_oauth2`        |     8 |   ✅   | 00:00:00.660 |
| `test_opcua`             | `native_opcua`         |    29 |   ✅   | 00:00:00.689 |
| `test_opcua_client`      | `native_opcua_client`  |    11 |   ✅   | 00:00:00.680 |
| `test_keepalive`         | `native_keepalive`     |    10 |   ✅   | 00:00:01.053 |
| `test_range`             | `native_range`         |    10 |   ✅   | 00:00:01.069 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.650 |
| `test_jwt`               | `native_jwt`           |    10 |   ✅   | 00:00:00.680 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.090 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.650 |
| `test_compliance`        | `native_compliance`    |    12 |   ✅   | 00:00:00.650 |
| `test_mqtt`              | `native_mqtt`          |    16 |   ✅   | 00:00:00.645 |
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.676 |
| `test_scratch`           | `native_scratch`       |    14 |   ✅   | 00:00:00.681 |
| `test_snmp_trap`         | `native_snmp_trap`     |     3 |   ✅   | 00:00:00.668 |
| `test_inflate`           | `native_inflate`       |    12 |   ✅   | 00:00:00.640 |
| `test_deflate`           | `native_deflate`       |    10 |   ✅   | 00:00:00.687 |
| `test_websocket`         | `native_ws_deflate`    |    67 |   ✅   | 00:00:01.013 |
| `test_time_source`       | `native_time_source`   |     9 |   ✅   | 00:00:00.641 |
| `test_config_store`      | `native_config_store`  |    14 |   ✅   | 00:00:00.642 |
| `test_device_id`         | `native_device_id`     |     4 |   ✅   | 00:00:00.656 |
| `test_auth_lockout`      | `native_auth_lockout`  |    10 |   ✅   | 00:00:00.624 |
| `test_csrf`              | `native_csrf`          |     9 |   ✅   | 00:00:00.669 |
| `test_telemetry`         | `native_telemetry`     |     8 |   ✅   | 00:00:00.631 |
...
| `test_cbor`              | `native_cbor`          |    14 |   ✅   | 00:00:00.652 |
| `test_msgpack`           | `native_msgpack`       |    15 |   ✅   | 00:00:00.643 |
| `test_gpio_map`          | `native_gpio_map`      |     8 |   ✅   | 00:00:00.649 |
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.636 |
| `test_guardrails`        | `native_guardrails`    |     6 |   ✅   | 00:00:00.635 |
...
| `test_concurrency`       | `native_tsan`          |     2 |   ✅   | 00:00:01.157 |
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:11.691
...
native         test_websocket     PASSED    00:00:00.600
native         test_http_parser   PASSED    00:00:00.568
================ 306 test cases: 306 succeeded in 00:00:14.606 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.854
...
================= 92 test cases: 92 succeeded in 00:00:06.483 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
native_app     test_web_terminal      PASSED    00:00:00.593
native_app     test_defer             PASSED    00:00:00.577
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.677
native_snmp    test_snmp_agent  PASSED    00:00:00.491
================= 22 test cases: 22 succeeded in 00:00:01.168 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.373
================== 9 test cases: 9 succeeded in 00:00:01.373 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.665
================= 26 test cases: 26 succeeded in 00:00:00.665 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.658
================= 19 test cases: 19 succeeded in 00:00:00.658 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.646
================== 5 test cases: 5 succeeded in 00:00:00.646 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.631
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.635
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.660
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.053
================= 10 test cases: 10 succeeded in 00:00:01.053 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.069
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.650
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.681
...
================= 67 test cases: 67 succeeded in 00:00:01.013 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.642
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.669
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.631
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.636
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.635
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.157
================== 2 test cases: 2 succeeded in 00:00:01.157 ==================
```
