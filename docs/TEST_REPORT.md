...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:07.837 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.632 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.537 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.649 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:02.855 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.559 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.650 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.586 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.657 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.568 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.558 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.556 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.562 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.548 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.563 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.561 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:00.844 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.487 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.500 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.505 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.509 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.490 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.656 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:00.802 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.567 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.562 |
| `test_ssh_crypto`        | `native_ssh`            |    43 |   ✅   | 00:00:03.020 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.518 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.710 |
| `test_ssh_transport`     | `native_ssh`            |    32 |   ✅   | 00:00:00.966 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.479 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:00.952 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.497 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.498 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.447 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.490 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.542 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.462 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.588 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.621 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.572 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.499 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.518 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.499 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.502 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.497 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.509 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.501 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.559 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.016 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:00.965 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.579 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.457 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:01.659 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.688 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.997 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.618 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.570 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.551 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.619 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.558 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.556 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.584 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.544 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.550 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.650 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.627 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.691 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.628 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.569 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.562 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.557 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.545 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.548 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.557 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.558 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.582 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.574 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.567 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.595 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.546 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.568 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.568 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.551 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.549 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.584 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.550 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.627 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.599 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.581 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.546 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.551 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.541 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.559 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.558 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.558 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.567 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.569 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.580 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.567 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.555 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.606 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.570 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.605 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.750 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.560 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.571 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.554 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.584 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.575 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.596 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:00.924 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:00.906 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.572 |
| `test_smtp`              | `native_smtp`           |    11 |   ✅   | 00:00:00.619 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.557 |
| `test_dns_server`        | `native_dns_server`     |     7 |   ✅   | 00:00:00.563 |
| `test_rtc`               | `native_rtc`            |     8 |   ✅   | 00:00:00.565 |
| `test_ld2410`            | `native_ld2410`         |     7 |   ✅   | 00:00:00.565 |
| `test_mpr121`            | `native_mpr121`         |     5 |   ✅   | 00:00:00.554 |
| `test_sht3x`             | `native_sht3x`          |     5 |   ✅   | 00:00:00.571 |
| `test_pca9685`           | `native_pca9685`        |     4 |   ✅   | 00:00:00.557 |
| `test_ads1115`           | `native_ads1115`        |     3 |   ✅   | 00:00:00.557 |
| `test_ina219`            | `native_ina219`         |     4 |   ✅   | 00:00:00.583 |
| `test_hpack`             | `native_hpack`          |     7 |   ✅   | 00:00:00.649 |
| `test_h2_frame`          | `native_h2frame`        |     6 |   ✅   | 00:00:00.560 |
| `test_h2_conn`           | `native_h2conn`         |     4 |   ✅   | 00:00:00.725 |
| `test_quic_varint`       | `native_quic_varint`    |     3 |   ✅   | 00:00:00.584 |
| `test_h3_frame`          | `native_h3frame`        |     7 |   ✅   | 00:00:00.639 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.598 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:00.930 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.559 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.569 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.566 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.589 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.657 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.583 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.567 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.635 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.022 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.678 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.600 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.579 |
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.633 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.596 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.570 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.572 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.565 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.563 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.575 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.550 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.556 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.559 |
| `test_statsd`            | `native_statsd`         |     9 |   ✅   | 00:00:00.585 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.574 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.564 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.576 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.662 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.536 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.679 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:00.934 |
| `test_qpack`             | `native_qpack`          |     9 |   ✅   | 00:00:00.623 |
| `test_quic_packet`       | `native_quic_packet`    |     8 |   ✅   | 00:00:00.551 |
| `test_quic_frame`        | `native_quic_frame`     |     8 |   ✅   | 00:00:00.623 |
| `test_ssh_chachapoly`    | `native_ssh_chachapoly` |     4 |   ✅   | 00:00:00.579 |
...
|  40 | `test_pkt_encrypted_fragmented`              |   ✅   | Pkt encrypted fragmented                                                                 |
|  41 | `test_pkt_encrypted_two_packets`             |   ✅   | Pkt encrypted two packets                                                                |
|  42 | `test_ssh_kdf_canonical_mpint_k`             |   ✅   | Ssh kdf canonical mpint k                                                                |
|  43 | `test_ssh_kdf_extension_chain`               |   ✅   | Ssh kdf extension chain                                                                  |
...
|  18 | `test_kexinit_parse_rejects_truncated`                     |   ✅   | Kexinit parse rejects truncated                                              |
|  19 | `test_exchange_hash_matches_independent_assembly`          |   ✅   | Populate the session fields the hash reads.                                  |
|  20 | `test_exchange_hash_changes_with_input`                    |   ✅   | Exchange hash changes with input                                             |
|  21 | `test_kexdh_parse_init_extracts_e_with_padding`            |   ✅   | Kexdh parse init extracts e with padding                                     |
|  22 | `test_kexdh_parse_init_extracts_small_e`                   |   ✅   | Kexdh parse init extracts small e                                            |
|  23 | `test_kexdh_parse_init_rejects_wrong_type`                 |   ✅   | Kexdh parse init rejects wrong type                                          |
|  24 | `test_kexdh_parse_init_rejects_oversized_e`                |   ✅   | mpint with 300 magnitude bytes → exceeds 2048 bits.                          |
|  25 | `test_kexdh_build_reply_structure`                         |   ✅   | Kexdh build reply structure                                                  |
|  26 | `test_kexdh_handle_produces_reply_and_installs_keys`       |   ✅   | Kexdh handle produces reply and installs keys                                |
|  27 | `test_kexdh_handle_rejects_invalid_e`                      |   ✅   | Kexdh handle rejects invalid e                                               |
|  28 | `test_kexdh_handle_curve25519_ed25519_end_to_end`          |   ✅   | Kexdh handle curve25519 ed25519 end to end                                   |
|  29 | `test_kexdh_handle_curve25519_rejects_low_order`           |   ✅   | Kexdh handle curve25519 rejects low order                                    |
|  30 | `test_derive_keys_session_id_affects_output`               |   ✅   | Derive keys session id affects output                                        |
|  31 | `test_rekey_needed_threshold`                              |   ✅   | Rekey needed threshold                                                       |
|  32 | `test_begin_rekey_preserves_session_and_auth`              |   ✅   | Begin rekey preserves session and auth                                       |
...
------------ native_canopen:test_canopen [PASSED] Took 7.84 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:07.837
================= 17 test cases: 17 succeeded in 00:00:07.837 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
----- native_det_primitives:test_det_primitives [PASSED] Took 0.63 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.632
================== 5 test cases: 5 succeeded in 00:00:00.632 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------- native_det_ip:test_det_ip [PASSED] Took 0.54 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.537
================= 10 test cases: 10 succeeded in 00:00:00.537 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
---------- native_det_arena:test_det_arena [PASSED] Took 0.65 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_det_arena  test_det_arena  PASSED    00:00:00.649
...
-------- native_ssh_ed25519:test_ssh_ed25519 [PASSED] Took 2.85 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:02.855
================= 16 test cases: 16 succeeded in 00:00:02.855 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------ native_promisc:test_promisc [PASSED] Took 0.56 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.559
================== 8 test cases: 8 succeeded in 00:00:00.559 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
-------- native_bus_capture:test_bus_capture [PASSED] Took 0.65 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.650
...
-------------- native_j1939:test_j1939 [PASSED] Took 0.59 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.586
================== 9 test cases: 9 succeeded in 00:00:00.586 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
---------- native_devicenet:test_devicenet [PASSED] Took 0.66 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.657
...
----------- native_nmea2000:test_nmea2000 [PASSED] Took 0.57 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.568
...
--------------- native_mbus:test_mbus [PASSED] Took 0.56 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.558
================= 11 test cases: 11 succeeded in 00:00:00.558 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
----------- native_iec60870:test_iec60870 [PASSED] Took 0.56 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.556
...
-------------- native_sdi12:test_sdi12 [PASSED] Took 0.56 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.562
================== 6 test cases: 6 succeeded in 00:00:00.562 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
---------------- native_dmx:test_dmx [PASSED] Took 0.55 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.548
================== 5 test cases: 5 succeeded in 00:00:00.548 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
----------- native_nmea0183:test_nmea0183 [PASSED] Took 0.56 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.563
================== 7 test cases: 7 succeeded in 00:00:00.563 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------- native_iolink:test_iolink [PASSED] Took 0.56 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.561
================== 5 test cases: 5 succeeded in 00:00:00.561 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------------ native:test_sse [PASSED] Took 0.84 seconds ------------------
...
------------- native:test_presentation [PASSED] Took 0.50 seconds --------------
...
-------------- native:test_http_parser [PASSED] Took 0.49 seconds --------------

=================================== SUMMARY ===================================
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:00.844
native         test_session       PASSED    00:00:00.487
native         test_presentation  PASSED    00:00:00.500
native         test_transport     PASSED    00:00:00.505
native         test_websocket     PASSED    00:00:00.509
native         test_http_parser   PASSED    00:00:00.490
================ 323 test cases: 323 succeeded in 00:00:03.334 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------ native_observability:test_observability [PASSED] Took 0.66 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.656
================= 17 test cases: 17 succeeded in 00:00:00.656 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
-------- native_accept_gate:test_accept_gate [PASSED] Took 0.80 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.802
...
------------- native_ota:test_http_ota [PASSED] Took 0.57 seconds --------------

=================================== SUMMARY ===================================
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.567
================== 3 test cases: 3 succeeded in 00:00:00.567 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
----------- native_prov:test_provisioning [PASSED] Took 0.56 seconds -----------

=================================== SUMMARY ===================================
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.562
================== 5 test cases: 5 succeeded in 00:00:00.562 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_ssh_crypto/test_ssh_crypto.cpp:1039: test_sha256_empty        [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1040: test_sha256_abc          [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1041: test_sha256_448bit       [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1042: test_sha256_streaming    [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1045: test_hmac_sha256_tc1     [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1046: test_hmac_sha256_tc2     [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1047: test_hmac_sha256_tc3     [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1048: test_hmac_sha256_streaming [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1049: test_hmac_sha512_tc1     [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1050: test_hmac_sha512_tc2     [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1051: test_hmac_sha512_streaming [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1054: test_aes256ctr_encrypt   [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1055: test_aes256ctr_decrypt   [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1056: test_aes256ctr_multi_block [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1057: test_aes256ctr_wipe      [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1060: test_bn_roundtrip        [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1061: test_bn_cmp_equal        [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1062: test_bn_cmp_less         [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1063: test_bn_cmp_greater      [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1064: test_bn_is_zero          [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1065: test_bn_dh_validate_rejects_zero [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1066: test_bn_dh_validate_rejects_one [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1067: test_bn_dh_validate_accepts_two [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1070: test_expmod_exp1         [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1071: test_expmod_exp2         [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1072: test_expmod_exp3         [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1073: test_expmod_commutative  [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1076: test_rsa_pkcs1_pad_structure [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1077: test_rsa_sign_verify_roundtrip [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1078: test_rsa_encode_pubkey   [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1079: test_rsa_verify_valid_signature [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1080: test_rsa_verify_rejects_tampered_signature [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1081: test_rsa_verify_rejects_wrong_message [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1084: test_pkt_send_recv_unencrypted [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1085: test_pkt_padding_alignment [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1086: test_pkt_seq_increments  [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1087: test_pkt_disconnect_zeroes_state [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1088: test_pkt_encrypted_roundtrip [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1089: test_pkt_chacha20poly1305_roundtrip [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1090: test_pkt_encrypted_fragmented [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1091: test_pkt_encrypted_two_packets [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1092: test_ssh_kdf_canonical_mpint_k [PASSED]
test/test_ssh_crypto/test_ssh_crypto.cpp:1093: test_ssh_kdf_extension_chain [PASSED]
------------ native_ssh:test_ssh_crypto [PASSED] Took 3.02 seconds -------------
...
------------ native_ssh:test_ssh_server [PASSED] Took 0.71 seconds -------------

Processing test_ssh_transport in native_ssh environment
--------------------------------------------------------------------------------
Building...
Testing...
test/test_ssh_transport/test_ssh_transport.cpp:837: test_transport_index_guards [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:838: test_banner_and_build_caps [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:839: test_kexinit_parse_field_and_trunc [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:840: test_kexdh_parse_and_handle_errors [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:841: test_server_banner_format [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:842: test_recv_banner_complete [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:843: test_recv_banner_bare_lf [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:844: test_recv_banner_split_across_reads [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:845: test_recv_banner_skips_preamble_lines [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:846: test_kexinit_build_starts_with_msg_and_stores_is [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:847: test_kexinit_parse_accepts_supported [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:848: test_kexinit_parse_accepts_when_ours_listed_among_others [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:849: test_kexinit_parse_rejects_missing_kex [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:850: test_kexinit_parse_rejects_hostkey_we_lack [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:851: test_kexinit_parse_steers_to_curve_ed25519 [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:852: test_kexinit_parse_rejects_missing_cipher [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:853: test_kexinit_parse_selects_chacha20poly1305 [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:854: test_kexinit_parse_rejects_truncated [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:855: test_exchange_hash_matches_independent_assembly [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:856: test_exchange_hash_changes_with_input [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:857: test_kexdh_parse_init_extracts_e_with_padding [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:858: test_kexdh_parse_init_extracts_small_e [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:859: test_kexdh_parse_init_rejects_wrong_type [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:860: test_kexdh_parse_init_rejects_oversized_e [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:861: test_kexdh_build_reply_structure [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:862: test_kexdh_handle_produces_reply_and_installs_keys [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:863: test_kexdh_handle_rejects_invalid_e [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:864: test_kexdh_handle_curve25519_ed25519_end_to_end [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:865: test_kexdh_handle_curve25519_rejects_low_order [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:866: test_derive_keys_session_id_affects_output [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:867: test_rekey_needed_threshold [PASSED]
test/test_ssh_transport/test_ssh_transport.cpp:868: test_begin_rekey_preserves_session_and_auth [PASSED]
----------- native_ssh:test_ssh_transport [PASSED] Took 0.97 seconds -----------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.020
native_ssh     test_ssh_auth       PASSED    00:00:00.518
native_ssh     test_ssh_server     PASSED    00:00:00.710
native_ssh     test_ssh_transport  PASSED    00:00:00.966
native_ssh     test_ssh_channel    PASSED    00:00:00.479
================ 142 test cases: 142 succeeded in 00:00:05.693 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
ssh_packet.cpp:(.text+0x640): undefined reference to `ssh_chachapoly_encrypt(unsigned char const*, unsigned int, unsigned char*, unsigned char const*, unsigned int)'
...
ssh_packet.cpp:(.text+0x8f6): undefined reference to `ssh_chachapoly_get_length(unsigned char const*, unsigned int, unsigned char const*)'
/usr/bin/ld: ssh_packet.cpp:(.text+0xa44): undefined reference to `ssh_chachapoly_decrypt(unsigned char const*, unsigned int, unsigned char*, unsigned char const*, unsigned int)'
...
------ native_ssh_hardened:test_ssh_hardening [ERRORED] Took 0.78 seconds ------

=================================== SUMMARY ===================================
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  ERRORED   00:00:00.784
================== 1 test cases: 0 succeeded in 00:00:00.784 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Building stage has failed, see errors above. Use `pio test -vvv` option to enable verbose output.
---------- native_ssh_conn:test_ssh_conn [ERRORED] Took 1.03 seconds ----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  ERRORED   00:00:01.029
================== 1 test cases: 0 succeeded in 00:00:01.029 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
src/DeterministicESPAsyncWebServer.cpp:2938:76: warning: ‘snprintf’ output may be truncated before the last format character [-Wformat-truncation=]
 2938 |         snprintf(lastmod_line, sizeof(lastmod_line), "Last-Modified: %s\r\n", lm_date);
      |                                                                            ^
src/DeterministicESPAsyncWebServer.cpp:2938:17: note: ‘snprintf’ output between 18 and 57 bytes into a destination of size 56
 2938 |         snprintf(lastmod_line, sizeof(lastmod_line), "Last-Modified: %s\r\n", lm_date);
      |         ~~~~~~~~^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Testing...
...
---------- native_app:test_digest_vectors [PASSED] Took 0.45 seconds -----------
...
--------------- native_app:test_json [PASSED] Took 0.46 seconds ----------------
...
------------ native_app:test_middleware [PASSED] Took 0.62 seconds -------------
...
------------ native_app:test_digest_auth [PASSED] Took 0.57 seconds ------------
...
--------------- native_app:test_defer [PASSED] Took 0.52 seconds ---------------
...
------------- native_app:test_multipart [PASSED] Took 0.50 seconds -------------
...
--------------- native_app:test_auth [PASSED] Took 0.50 seconds ----------------
...
------------ native_app:test_application [PASSED] Took 0.56 seconds ------------

=================================== SUMMARY ===================================
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:00.952
native_app     test_template          PASSED    00:00:00.497
native_app     test_path_params       PASSED    00:00:00.498
native_app     test_digest_vectors    PASSED    00:00:00.447
native_app     test_form_params       PASSED    00:00:00.490
native_app     test_iface             PASSED    00:00:00.542
native_app     test_json              PASSED    00:00:00.462
native_app     test_response_headers  PASSED    00:00:00.588
native_app     test_middleware        PASSED    00:00:00.621
native_app     test_digest_auth       PASSED    00:00:00.572
native_app     test_web_terminal      PASSED    00:00:00.499
native_app     test_defer             PASSED    00:00:00.518
native_app     test_multipart         PASSED    00:00:00.499
native_app     test_auth              PASSED    00:00:00.502
native_app     test_file_serving      PASSED    00:00:00.497
native_app     test_dispatch          PASSED    00:00:00.509
native_app     test_chunked           PASSED    00:00:00.501
native_app     test_application       PASSED    00:00:00.559
================ 225 test cases: 225 succeeded in 00:00:09.753 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
----- native_webdav_handler:test_webdav_handler [PASSED] Took 1.02 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.016
================= 12 test cases: 12 succeeded in 00:00:01.016 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
--------------- native_diag:test_diag [PASSED] Took 0.96 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:00.965
================== 2 test cases: 2 succeeded in 00:00:00.965 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------- native_snmp:test_snmp_ber [PASSED] Took 0.58 seconds -------------
...
------------ native_snmp:test_snmp_agent [PASSED] Took 0.46 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.579
native_snmp    test_snmp_agent  PASSED    00:00:00.457
================= 35 test cases: 35 succeeded in 00:00:01.037 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 1.66 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.659
================= 15 test cases: 15 succeeded in 00:00:01.659 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------- native_telnet:test_telnet [PASSED] Took 0.69 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.688
================= 15 test cases: 15 succeeded in 00:00:00.688 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
--------------- native_coap:test_coap [PASSED] Took 1.00 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.997
================= 41 test cases: 41 succeeded in 00:00:00.997 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
test/test_coap/test_coap.cpp:1076: test_well_known_core_discovery       [PASSED]
test/test_coap/test_coap.cpp:1077: test_well_known_core_rejects_post    [PASSED]
----------- native_coap_observe:test_coap [PASSED] Took 0.62 seconds -----------

=================================== SUMMARY ===================================
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.618
================= 41 test cases: 41 succeeded in 00:00:00.618 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------- native_webdav:test_webdav [PASSED] Took 0.57 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.570
================= 19 test cases: 19 succeeded in 00:00:00.570 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------- native_modbus:test_modbus [PASSED] Took 0.55 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.551
================= 22 test cases: 22 succeeded in 00:00:00.551 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
-------- native_cloudevents:test_cloudevents [PASSED] Took 0.62 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.619
================== 7 test cases: 7 succeeded in 00:00:00.619 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
----------- native_redis:test_redis_resp [PASSED] Took 0.56 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.558
================== 8 test cases: 8 succeeded in 00:00:00.558 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
-------------- native_stomp:test_stomp [PASSED] Took 0.56 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.556
================= 14 test cases: 14 succeeded in 00:00:00.556 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------ native_mqtt_sn:test_mqtt_sn [PASSED] Took 0.58 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.584
================= 13 test cases: 13 succeeded in 00:00:00.584 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
-------- native_flow_export:test_flow_export [PASSED] Took 0.54 seconds --------
...
----------- native_protobuf:test_protobuf [PASSED] Took 0.55 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.550
================= 13 test cases: 13 succeeded in 00:00:00.550 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------ native_preempt_queue:test_preempt_queue [PASSED] Took 0.65 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.650
================= 11 test cases: 11 succeeded in 00:00:00.650 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
---------------- native_dma:test_dma [PASSED] Took 0.63 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.627
================= 11 test cases: 11 succeeded in 00:00:00.627 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------ native_forward:test_forward [PASSED] Took 0.69 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.691
================= 16 test cases: 16 succeeded in 00:00:00.691 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------ native_gateway:test_gateway [PASSED] Took 0.63 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.628
================= 11 test cases: 11 succeeded in 00:00:00.628 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
--------------- native_lora:test_lora [PASSED] Took 0.57 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.569
================= 13 test cases: 13 succeeded in 00:00:00.569 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
-------------- native_nrf24:test_nrf24 [PASSED] Took 0.56 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.562
================= 10 test cases: 10 succeeded in 00:00:00.562 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------ native_enocean:test_enocean [PASSED] Took 0.56 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.557
================== 9 test cases: 9 succeeded in 00:00:00.557 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
-------------- native_pn532:test_pn532 [PASSED] Took 0.55 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_pn532   test_pn532  PASSED    00:00:00.545
================= 10 test cases: 10 succeeded in 00:00:00.545 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------- native_sigfox:test_sigfox [PASSED] Took 0.55 seconds -------------
...
-------------- native_zwave:test_zwave [PASSED] Took 0.56 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.557
================== 9 test cases: 9 succeeded in 00:00:00.557 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------- native_zigbee:test_zigbee [PASSED] Took 0.56 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_zigbee  test_zigbee  PASSED    00:00:00.558
================== 9 test cases: 9 succeeded in 00:00:00.558 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------- native_thread:test_thread [PASSED] Took 0.58 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.582
================= 13 test cases: 13 succeeded in 00:00:00.582 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
--------------- native_wamp:test_wamp [PASSED] Took 0.57 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.574
================= 12 test cases: 12 succeeded in 00:00:00.574 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------ native_sunspec:test_sunspec [PASSED] Took 0.57 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.567
...
------------- native_c37118:test_c37118 [PASSED] Took 0.60 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.595
================== 6 test cases: 6 succeeded in 00:00:00.595 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
--------------- native_dnp3:test_dnp3 [PASSED] Took 0.55 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.546
...
------------ native_grpcweb:test_grpcweb [PASSED] Took 0.57 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.568
================== 7 test cases: 7 succeeded in 00:00:00.568 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
---------- native_lwm2m_tlv:test_lwm2m_tlv [PASSED] Took 0.57 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.568
================= 11 test cases: 11 succeeded in 00:00:00.568 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
--------------- native_fins:test_fins [PASSED] Took 0.55 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.551
...
----------- native_hostlink:test_hostlink [PASSED] Took 0.55 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.549
================== 7 test cases: 7 succeeded in 00:00:00.549 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
-------------- native_senml:test_senml [PASSED] Took 0.58 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.584
================== 9 test cases: 9 succeeded in 00:00:00.584 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
---------------- native_df1:test_df1 [PASSED] Took 0.55 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.550
================== 9 test cases: 9 succeeded in 00:00:00.550 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.627
================== 6 test cases: 6 succeeded in 00:00:00.627 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------- native_s7comm:test_s7comm [PASSED] Took 0.60 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.599
================== 8 test cases: 8 succeeded in 00:00:00.599 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------- native_melsec:test_melsec [PASSED] Took 0.58 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.581
...
------------- native_bacnet:test_bacnet [PASSED] Took 0.55 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.546
...
--------------- native_enip:test_enip [PASSED] Took 0.55 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.551
================== 6 test cases: 6 succeeded in 00:00:00.551 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
--------------- native_amqp:test_amqp [PASSED] Took 0.54 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.541
...
---------------- native_cip:test_cip [PASSED] Took 0.56 seconds ----------------
...
--------------- native_nats:test_nats [PASSED] Took 0.56 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.558
...
----- native_proxy_protocol:test_proxy_protocol [PASSED] Took 0.56 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.558
================== 8 test cases: 8 succeeded in 00:00:00.558 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
---------- native_sparkplug:test_sparkplug [PASSED] Took 0.57 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.567
...
------ native_modbus_master:test_modbus_master [PASSED] Took 0.57 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.569
...
------- native_ota_rollback:test_ota_rollback [PASSED] Took 0.58 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.580
...
--------------- native_totp:test_totp [PASSED] Took 0.57 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.567
================== 4 test cases: 4 succeeded in 00:00:00.567 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------ native_webhook:test_webhook [PASSED] Took 0.56 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.555
================== 5 test cases: 5 succeeded in 00:00:00.555 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
-------- native_radio_power:test_radio_power [PASSED] Took 0.61 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.606
================== 2 test cases: 2 succeeded in 00:00:00.606 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------- native_dns_resolver:test_dns_resolver [PASSED] Took 0.57 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.570
================== 4 test cases: 4 succeeded in 00:00:00.570 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
---------- native_audit_log:test_audit_log [PASSED] Took 0.61 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.605
================= 16 test cases: 16 succeeded in 00:00:00.605 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
--------------- native_oidc:test_oidc [PASSED] Took 0.75 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.750
================= 17 test cases: 17 succeeded in 00:00:00.750 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
---------------- native_vfs:test_vfs [PASSED] Took 0.56 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.560
================= 11 test cases: 11 succeeded in 00:00:00.560 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------ native_graphql:test_graphql [PASSED] Took 0.57 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.571
================= 32 test cases: 32 succeeded in 00:00:00.571 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------- native_espnow:test_espnow [PASSED] Took 0.55 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.554
================== 7 test cases: 7 succeeded in 00:00:00.554 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------- native_oauth2:test_oauth2 [PASSED] Took 0.58 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.584
================== 8 test cases: 8 succeeded in 00:00:00.584 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
-------------- native_opcua:test_opcua [PASSED] Took 0.58 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.575
================= 38 test cases: 38 succeeded in 00:00:00.575 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------- native_opcua_client:test_opcua_client [PASSED] Took 0.60 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.596
================= 14 test cases: 14 succeeded in 00:00:00.596 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
---------- native_keepalive:test_keepalive [PASSED] Took 0.92 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:00.924
================= 10 test cases: 10 succeeded in 00:00:00.924 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
-------------- native_range:test_range [PASSED] Took 0.91 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:00.906
================= 13 test cases: 13 succeeded in 00:00:00.906 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------- native_syslog:test_syslog [PASSED] Took 0.57 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.572
================= 10 test cases: 10 succeeded in 00:00:00.572 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
--------------- native_smtp:test_smtp [PASSED] Took 0.62 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_smtp    test_smtp  PASSED    00:00:00.619
================= 11 test cases: 11 succeeded in 00:00:00.619 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
--------- native_ntp_server:test_ntp_server [PASSED] Took 0.56 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_ntp_server  test_ntp_server  PASSED    00:00:00.557
================== 8 test cases: 8 succeeded in 00:00:00.557 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
--------- native_dns_server:test_dns_server [PASSED] Took 0.56 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_dns_server  test_dns_server  PASSED    00:00:00.563
================== 7 test cases: 7 succeeded in 00:00:00.563 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
---------------- native_rtc:test_rtc [PASSED] Took 0.57 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_rtc     test_rtc  PASSED    00:00:00.565
================== 8 test cases: 8 succeeded in 00:00:00.565 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------- native_ld2410:test_ld2410 [PASSED] Took 0.56 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ld2410  test_ld2410  PASSED    00:00:00.565
...
------------- native_mpr121:test_mpr121 [PASSED] Took 0.55 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_mpr121  test_mpr121  PASSED    00:00:00.554
================== 5 test cases: 5 succeeded in 00:00:00.554 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
-------------- native_sht3x:test_sht3x [PASSED] Took 0.57 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sht3x   test_sht3x  PASSED    00:00:00.571
...
------------ native_pca9685:test_pca9685 [PASSED] Took 0.56 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_pca9685  test_pca9685  PASSED    00:00:00.557
================== 4 test cases: 4 succeeded in 00:00:00.557 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------ native_ads1115:test_ads1115 [PASSED] Took 0.56 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_ads1115  test_ads1115  PASSED    00:00:00.557
================== 3 test cases: 3 succeeded in 00:00:00.557 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------- native_ina219:test_ina219 [PASSED] Took 0.58 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ina219  test_ina219  PASSED    00:00:00.583
...
-------------- native_hpack:test_hpack [PASSED] Took 0.65 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_hpack   test_hpack  PASSED    00:00:00.649
...
----------- native_h2frame:test_h2_frame [PASSED] Took 0.56 seconds ------------

=================================== SUMMARY ===================================
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h2frame  test_h2_frame  PASSED    00:00:00.560
================== 6 test cases: 6 succeeded in 00:00:00.560 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------ native_h2conn:test_h2_conn [PASSED] Took 0.73 seconds -------------

=================================== SUMMARY ===================================
Environment    Test          Status    Duration
-------------  ------------  --------  ------------
native_h2conn  test_h2_conn  PASSED    00:00:00.725
...
-------- native_quic_varint:test_quic_varint [PASSED] Took 0.58 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_varint  test_quic_varint  PASSED    00:00:00.584
...
----------- native_h3frame:test_h3_frame [PASSED] Took 0.64 seconds ------------

=================================== SUMMARY ===================================
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h3frame  test_h3_frame  PASSED    00:00:00.639
...
---------------- native_jwt:test_jwt [PASSED] Took 0.60 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.598
================= 21 test cases: 21 succeeded in 00:00:00.598 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------- native_upload:test_upload [PASSED] Took 0.93 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:00.930
================== 3 test cases: 3 succeeded in 00:00:00.930 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
-------- native_http_client:test_http_client [PASSED] Took 0.56 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.559
================= 15 test cases: 15 succeeded in 00:00:00.559 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
--------- native_compliance:test_compliance [PASSED] Took 0.57 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.569
================= 15 test cases: 15 succeeded in 00:00:00.569 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
--------------- native_mqtt:test_mqtt [PASSED] Took 0.57 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.566
================= 22 test cases: 22 succeeded in 00:00:00.566 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
---------- native_ws_client:test_ws_client [PASSED] Took 0.59 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.589
================= 16 test cases: 16 succeeded in 00:00:00.589 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------ native_scratch:test_scratch [PASSED] Took 0.66 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.657
================= 14 test cases: 14 succeeded in 00:00:00.657 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
---------- native_snmp_trap:test_snmp_trap [PASSED] Took 0.58 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.583
...
------------ native_inflate:test_inflate [PASSED] Took 0.57 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.567
================= 12 test cases: 12 succeeded in 00:00:00.567 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------ native_deflate:test_deflate [PASSED] Took 0.63 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.635
================= 10 test cases: 10 succeeded in 00:00:00.635 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.678
...
------- native_config_store:test_config_store [PASSED] Took 0.60 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.600
================= 14 test cases: 14 succeeded in 00:00:00.600 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
---------- native_device_id:test_device_id [PASSED] Took 0.58 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.579
================== 4 test cases: 4 succeeded in 00:00:00.579 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------- native_auth_lockout:test_auth_lockout [PASSED] Took 0.63 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.633
...
--------------- native_csrf:test_csrf [PASSED] Took 0.60 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.596
================== 9 test cases: 9 succeeded in 00:00:00.596 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
---------- native_telemetry:test_telemetry [PASSED] Took 0.57 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.570
...
---------- native_dashboard:test_dashboard [PASSED] Took 0.57 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.572
================= 15 test cases: 15 succeeded in 00:00:00.572 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
--------- native_net_egress:test_net_egress [PASSED] Took 0.56 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.565
...
------ native_partition:test_partition_monitor [PASSED] Took 0.56 seconds ------

=================================== SUMMARY ===================================
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.563
...
--------------- native_cbor:test_cbor [PASSED] Took 0.58 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.575
================= 18 test cases: 18 succeeded in 00:00:00.575 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------ native_msgpack:test_msgpack [PASSED] Took 0.55 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.550
================= 17 test cases: 17 succeeded in 00:00:00.550 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
----------- native_gpio_map:test_gpio_map [PASSED] Took 0.56 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.556
================== 8 test cases: 8 succeeded in 00:00:00.556 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------ native_udp_telemetry:test_udp_telemetry [PASSED] Took 0.56 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.559
================== 7 test cases: 7 succeeded in 00:00:00.559 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------- native_statsd:test_statsd [PASSED] Took 0.59 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_statsd  test_statsd  PASSED    00:00:00.585
...
--------- native_guardrails:test_guardrails [PASSED] Took 0.57 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.574
================== 6 test cases: 6 succeeded in 00:00:00.574 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
------------- native_logbuf:test_logbuf [PASSED] Took 0.56 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.564
...
---------- native_config_io:test_config_io [PASSED] Took 0.58 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.576
...
------------ native_workers:test_workers [PASSED] Took 0.66 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.662
================== 3 test cases: 3 succeeded in 00:00:00.662 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
-------------- native_clock:test_clock [PASSED] Took 0.54 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.536
================== 7 test cases: 7 succeeded in 00:00:00.536 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
-------- native_concurrency:test_concurrency [PASSED] Took 0.68 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.679
================== 2 test cases: 2 succeeded in 00:00:00.679 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 0.93 seconds ------------

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:00.934
================== 2 test cases: 2 succeeded in 00:00:00.934 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
-------------- native_qpack:test_qpack [PASSED] Took 0.62 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_qpack   test_qpack  PASSED    00:00:00.623
================== 9 test cases: 9 succeeded in 00:00:00.623 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
-------- native_quic_packet:test_quic_packet [PASSED] Took 0.55 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_packet  test_quic_packet  PASSED    00:00:00.551
================== 8 test cases: 8 succeeded in 00:00:00.551 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
--------- native_quic_frame:test_quic_frame [PASSED] Took 0.62 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_quic_frame  test_quic_frame  PASSED    00:00:00.623
================== 8 test cases: 8 succeeded in 00:00:00.623 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
----- native_ssh_chachapoly:test_ssh_chachapoly [PASSED] Took 0.58 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_ssh_chachapoly  test_ssh_chachapoly  PASSED    00:00:00.579
================== 4 test cases: 4 succeeded in 00:00:00.579 ==================
```
