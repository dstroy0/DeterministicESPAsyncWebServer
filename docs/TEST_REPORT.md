...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:13.217 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.505 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.538 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.522 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.546 |
| `test_http_parser`       | `native`                |    82 |   ✅   | 00:00:00.505 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.626 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.569 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.561 |
| `test_ssh_crypto`        | `native_ssh`            |    38 |   ✅   | 00:00:04.100 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.499 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.642 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.913 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.466 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.755 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.116 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.004 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.521 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.519 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.465 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.514 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.523 |
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.478 |
| `test_response_headers`  | `native_app`            |     9 |   ✅   | 00:00:00.523 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.530 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.540 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.525 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.502 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.529 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.526 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.537 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.521 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.529 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.599 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.053 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.011 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.596 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.435 |
| `test_snmp_v3`           | `native_snmp_v3`        |     9 |   ✅   | 00:00:01.407 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.696 |
| `test_coap`              | `native_coap`           |    27 |   ✅   | 00:00:00.572 |
| `test_coap`              | `native_coap_observe`   |    27 |   ✅   | 00:00:00.607 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.586 |
| `test_modbus`            | `native_modbus`         |    13 |   ✅   | 00:00:00.573 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.589 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.559 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.578 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.562 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.558 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.558 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.580 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.759 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.571 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.567 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.560 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.587 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.588 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.608 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:00.960 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:00.963 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.568 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.612 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:00.980 |
| `test_http_client`       | `native_http_client`    |    10 |   ✅   | 00:00:00.567 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.574 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.555 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.589 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.607 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.590 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.568 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.600 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:00.918 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.562 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.552 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.580 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.557 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.598 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.552 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.572 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.566 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.556 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.550 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.571 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.559 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     4 |   ✅   | 00:00:00.565 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.560 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.560 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.588 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.656 |
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:13.217
...
native         test_websocket     PASSED    00:00:00.546
native         test_http_parser   PASSED    00:00:00.505
================ 310 test cases: 310 succeeded in 00:00:15.833 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
------ native_observability:test_observability [PASSED] Took 0.63 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.626
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.561
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.100
native_ssh     test_ssh_auth       PASSED    00:00:00.499
native_ssh     test_ssh_server     PASSED    00:00:00.642
native_ssh     test_ssh_transport  PASSED    00:00:00.913
native_ssh     test_ssh_channel    PASSED    00:00:00.466
================= 92 test cases: 92 succeeded in 00:00:06.620 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
------ native_ssh_hardened:test_ssh_hardening [PASSED] Took 0.75 seconds -------
...
--------------- native_app:test_regex [PASSED] Took 1.00 seconds ---------------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.004
native_app     test_template          PASSED    00:00:00.521
native_app     test_path_params       PASSED    00:00:00.519
native_app     test_digest_vectors    PASSED    00:00:00.465
native_app     test_form_params       PASSED    00:00:00.514
native_app     test_iface             PASSED    00:00:00.523
native_app     test_json              PASSED    00:00:00.478
...
native_app     test_web_terminal      PASSED    00:00:00.525
native_app     test_defer             PASSED    00:00:00.502
native_app     test_multipart         PASSED    00:00:00.529
native_app     test_auth              PASSED    00:00:00.526
native_app     test_file_serving      PASSED    00:00:00.537
native_app     test_dispatch          PASSED    00:00:00.521
native_app     test_chunked           PASSED    00:00:00.529
native_app     test_application       PASSED    00:00:00.599
================ 217 test cases: 217 succeeded in 00:00:09.888 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
----- native_webdav_handler:test_webdav_handler [PASSED] Took 1.05 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.053
================= 12 test cases: 12 succeeded in 00:00:01.053 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
--------------- native_diag:test_diag [PASSED] Took 1.01 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.011
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.596
native_snmp    test_snmp_agent  PASSED    00:00:00.435
================= 29 test cases: 29 succeeded in 00:00:01.031 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.407
================== 9 test cases: 9 succeeded in 00:00:01.407 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.696
...
--------------- native_coap:test_coap [PASSED] Took 0.57 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.572
================= 27 test cases: 27 succeeded in 00:00:00.572 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.607
================= 27 test cases: 27 succeeded in 00:00:00.607 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.586
================= 19 test cases: 19 succeeded in 00:00:00.586 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.573
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.589
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.578
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.562
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.558
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.580
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.571
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.567
================= 13 test cases: 13 succeeded in 00:00:00.567 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.587
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.588
================= 29 test cases: 29 succeeded in 00:00:00.588 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.608
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:00.960
================= 10 test cases: 10 succeeded in 00:00:00.960 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:00.963
================= 13 test cases: 13 succeeded in 00:00:00.963 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.568
...
---------------- native_jwt:test_jwt [PASSED] Took 0.61 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.612
================= 12 test cases: 12 succeeded in 00:00:00.612 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:00.980
================== 3 test cases: 3 succeeded in 00:00:00.980 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.567
================= 10 test cases: 10 succeeded in 00:00:00.567 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.574
================= 15 test cases: 15 succeeded in 00:00:00.574 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.555
================= 19 test cases: 19 succeeded in 00:00:00.555 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.590
...
------------ native_deflate:test_deflate [PASSED] Took 0.60 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.600
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.918
================= 71 test cases: 71 succeeded in 00:00:00.918 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.552
================= 14 test cases: 14 succeeded in 00:00:00.552 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.580
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.557
================= 10 test cases: 10 succeeded in 00:00:00.557 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.598
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.556
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.550
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.571
================= 15 test cases: 15 succeeded in 00:00:00.571 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.559
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.565
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.560
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.656
