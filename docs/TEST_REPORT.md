...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:13.424 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.515 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.549 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.542 |
| `test_websocket`         | `native`               |    67 |   ✅   | 00:00:00.573 |
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.524 |
| `test_observability`     | `native_observability` |    15 |   ✅   | 00:00:00.662 |
| `test_http_ota`          | `native_ota`           |     3 |   ✅   | 00:00:00.618 |
| `test_provisioning`      | `native_prov`          |     5 |   ✅   | 00:00:00.607 |
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:04.149 |
| `test_ssh_auth`          | `native_ssh`           |    12 |   ✅   | 00:00:00.520 |
| `test_ssh_server`        | `native_ssh`           |     7 |   ✅   | 00:00:00.669 |
| `test_ssh_transport`     | `native_ssh`           |    23 |   ✅   | 00:00:00.971 |
| `test_ssh_channel`       | `native_ssh`           |    12 |   ✅   | 00:00:00.495 |
| `test_ssh_hardening`     | `native_ssh_hardened`  |     2 |   ✅   | 00:00:00.814 |
| `test_ssh_conn`          | `native_ssh_conn`      |     2 |   ✅   | 00:00:01.183 |
| `test_regex`             | `native_app`           |     9 |   ✅   | 00:00:01.044 |
| `test_template`          | `native_app`           |     6 |   ✅   | 00:00:00.547 |
| `test_path_params`       | `native_app`           |     8 |   ✅   | 00:00:00.537 |
| `test_digest_vectors`    | `native_app`           |     4 |   ✅   | 00:00:00.486 |
| `test_form_params`       | `native_app`           |     5 |   ✅   | 00:00:00.538 |
| `test_iface`             | `native_app`           |     7 |   ✅   | 00:00:00.540 |
| `test_json`              | `native_app`           |    17 |   ✅   | 00:00:00.502 |
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.547 |
| `test_middleware`        | `native_app`           |     9 |   ✅   | 00:00:00.546 |
| `test_digest_auth`       | `native_app`           |    11 |   ✅   | 00:00:00.559 |
| `test_web_terminal`      | `native_app`           |     9 |   ✅   | 00:00:00.538 |
| `test_defer`             | `native_app`           |     3 |   ✅   | 00:00:00.527 |
| `test_multipart`         | `native_app`           |    19 |   ✅   | 00:00:00.554 |
| `test_auth`              | `native_app`           |    13 |   ✅   | 00:00:00.545 |
| `test_file_serving`      | `native_app`           |    12 |   ✅   | 00:00:00.556 |
| `test_dispatch`          | `native_app`           |    11 |   ✅   | 00:00:00.537 |
| `test_chunked`           | `native_app`           |    12 |   ✅   | 00:00:00.544 |
| `test_application`       | `native_app`           |    53 |   ✅   | 00:00:00.621 |
| `test_diag`              | `native_diag`          |     2 |   ✅   | 00:00:01.049 |
| `test_snmp_ber`          | `native_snmp`          |    15 |   ✅   | 00:00:00.617 |
| `test_snmp_agent`        | `native_snmp`          |    14 |   ✅   | 00:00:00.449 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.426 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.707 |
| `test_coap`              | `native_coap`          |    27 |   ✅   | 00:00:00.608 |
| `test_coap`              | `native_coap_observe`  |    27 |   ✅   | 00:00:00.616 |
| `test_webdav`            | `native_webdav`        |    19 |   ✅   | 00:00:00.594 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.595 |
...
| `test_webhook`           | `native_webhook`       |     5 |   ✅   | 00:00:00.598 |
| `test_radio_power`       | `native_radio_power`   |     2 |   ✅   | 00:00:00.578 |
| `test_dns_resolver`      | `native_dns_resolver`  |     4 |   ✅   | 00:00:00.578 |
| `test_audit_log`         | `native_audit_log`     |    12 |   ✅   | 00:00:00.622 |
| `test_oidc`              | `native_oidc`          |    13 |   ✅   | 00:00:00.783 |
| `test_vfs`               | `native_vfs`           |    11 |   ✅   | 00:00:00.593 |
| `test_graphql`           | `native_graphql`       |    13 |   ✅   | 00:00:00.573 |
| `test_espnow`            | `native_espnow`        |     7 |   ✅   | 00:00:00.594 |
| `test_oauth2`            | `native_oauth2`        |     8 |   ✅   | 00:00:00.613 |
| `test_opcua`             | `native_opcua`         |    29 |   ✅   | 00:00:00.616 |
| `test_opcua_client`      | `native_opcua_client`  |    11 |   ✅   | 00:00:00.615 |
| `test_keepalive`         | `native_keepalive`     |    10 |   ✅   | 00:00:00.977 |
| `test_range`             | `native_range`         |    13 |   ✅   | 00:00:01.001 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.602 |
| `test_jwt`               | `native_jwt`           |    12 |   ✅   | 00:00:00.648 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.007 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.586 |
| `test_compliance`        | `native_compliance`    |    15 |   ✅   | 00:00:00.597 |
| `test_mqtt`              | `native_mqtt`          |    19 |   ✅   | 00:00:00.612 |
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.610 |
| `test_scratch`           | `native_scratch`       |    14 |   ✅   | 00:00:00.613 |
| `test_snmp_trap`         | `native_snmp_trap`     |     3 |   ✅   | 00:00:00.608 |
| `test_inflate`           | `native_inflate`       |    12 |   ✅   | 00:00:00.590 |
| `test_deflate`           | `native_deflate`       |    10 |   ✅   | 00:00:00.637 |
| `test_websocket`         | `native_ws_deflate`    |    71 |   ✅   | 00:00:00.907 |
| `test_time_source`       | `native_time_source`   |     9 |   ✅   | 00:00:00.582 |
| `test_config_store`      | `native_config_store`  |    14 |   ✅   | 00:00:00.579 |
| `test_device_id`         | `native_device_id`     |     4 |   ✅   | 00:00:00.596 |
| `test_auth_lockout`      | `native_auth_lockout`  |    10 |   ✅   | 00:00:00.573 |
| `test_csrf`              | `native_csrf`          |     9 |   ✅   | 00:00:00.609 |
| `test_telemetry`         | `native_telemetry`     |     8 |   ✅   | 00:00:00.574 |
| `test_dashboard`         | `native_dashboard`     |    11 |   ✅   | 00:00:00.585 |
| `test_net_egress`        | `native_net_egress`    |     5 |   ✅   | 00:00:00.586 |
| `test_partition_monitor` | `native_partition`     |     5 |   ✅   | 00:00:00.579 |
| `test_cbor`              | `native_cbor`          |    14 |   ✅   | 00:00:00.590 |
| `test_msgpack`           | `native_msgpack`       |    15 |   ✅   | 00:00:00.571 |
| `test_gpio_map`          | `native_gpio_map`      |     8 |   ✅   | 00:00:00.579 |
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.591 |
| `test_guardrails`        | `native_guardrails`    |     6 |   ✅   | 00:00:00.581 |
| `test_logbuf`            | `native_logbuf`        |     4 |   ✅   | 00:00:00.583 |
| `test_config_io`         | `native_config_io`     |     4 |   ✅   | 00:00:00.598 |
| `test_workers`           | `native_workers`       |     3 |   ✅   | 00:00:00.684 |
| `test_clock`             | `native_clock`         |     4 |   ✅   | 00:00:00.578 |
...
----------------- native:test_sse [PASSED] Took 13.42 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:13.424
native         test_session       PASSED    00:00:00.515
native         test_presentation  PASSED    00:00:00.549
native         test_transport     PASSED    00:00:00.542
native         test_websocket     PASSED    00:00:00.573
native         test_http_parser   PASSED    00:00:00.524
================ 310 test cases: 310 succeeded in 00:00:16.128 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.618
================== 3 test cases: 3 succeeded in 00:00:00.618 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.149
native_ssh     test_ssh_auth       PASSED    00:00:00.520
native_ssh     test_ssh_server     PASSED    00:00:00.669
native_ssh     test_ssh_transport  PASSED    00:00:00.971
native_ssh     test_ssh_channel    PASSED    00:00:00.495
================= 92 test cases: 92 succeeded in 00:00:06.804 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.814
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.183
...
native_app     test_template          PASSED    00:00:00.547
native_app     test_path_params       PASSED    00:00:00.537
native_app     test_digest_vectors    PASSED    00:00:00.486
native_app     test_form_params       PASSED    00:00:00.538
native_app     test_iface             PASSED    00:00:00.540
native_app     test_json              PASSED    00:00:00.502
native_app     test_response_headers  PASSED    00:00:00.547
native_app     test_middleware        PASSED    00:00:00.546
native_app     test_digest_auth       PASSED    00:00:00.559
native_app     test_web_terminal      PASSED    00:00:00.538
native_app     test_defer             PASSED    00:00:00.527
native_app     test_multipart         PASSED    00:00:00.554
native_app     test_auth              PASSED    00:00:00.545
native_app     test_file_serving      PASSED    00:00:00.556
native_app     test_dispatch          PASSED    00:00:00.537
native_app     test_chunked           PASSED    00:00:00.544
native_app     test_application       PASSED    00:00:00.621
================ 217 test cases: 217 succeeded in 00:00:10.270 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.049
================== 2 test cases: 2 succeeded in 00:00:01.049 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.617
native_snmp    test_snmp_agent  PASSED    00:00:00.449
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.426
================== 9 test cases: 9 succeeded in 00:00:01.426 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.707
...
================= 27 test cases: 27 succeeded in 00:00:00.608 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.616
================= 27 test cases: 27 succeeded in 00:00:00.616 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.595
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.598
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.622
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.783
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.594
...
================= 29 test cases: 29 succeeded in 00:00:00.616 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.001
================= 13 test cases: 13 succeeded in 00:00:01.001 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.602
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.007
================== 3 test cases: 3 succeeded in 00:00:01.007 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.586
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.597
================= 15 test cases: 15 succeeded in 00:00:00.597 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.612
================= 19 test cases: 19 succeeded in 00:00:00.612 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.610
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.608
================== 3 test cases: 3 succeeded in 00:00:00.608 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.907
================= 71 test cases: 71 succeeded in 00:00:00.907 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.579
================= 14 test cases: 14 succeeded in 00:00:00.579 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.596
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.573
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.609
================== 9 test cases: 9 succeeded in 00:00:00.609 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.574
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.586
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.590
================= 14 test cases: 14 succeeded in 00:00:00.590 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.579
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.581
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.583
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.598
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.578
================== 4 test cases: 4 succeeded in 00:00:00.578 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
