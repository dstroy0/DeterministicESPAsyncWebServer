...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:06.028 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.637 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.663 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.678 |
| `test_mbus`              | `native_mbus`           |     8 |   ✅   | 00:00:00.641 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.661 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.651 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.644 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.656 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.648 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:00.994 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.579 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.616 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.593 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.626 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.586 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.726 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:00.987 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.667 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.655 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.856 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.565 |
| `test_ssh_server`        | `native_ssh`            |    12 |   ✅   | 00:00:00.823 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.908 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.558 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.890 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.280 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.183 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.606 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.604 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.541 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.595 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.599 |
...
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.611 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.609 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.627 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.609 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.611 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.690 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.196 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.141 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.699 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.503 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.460 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.794 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.856 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.743 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.682 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.663 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.723 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.660 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.651 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.667 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.638 |
| `test_protobuf`          | `native_protobuf`       |    10 |   ✅   | 00:00:00.643 |
| `test_preempt_queue`     | `native_preempt_queue`  |     7 |   ✅   | 00:00:00.693 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.673 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.655 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.652 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.649 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.652 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.654 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.639 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.653 |
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.704 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.650 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.645 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.653 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.645 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.638 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.640 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.647 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.656 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.657 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.654 |
| `test_sparkplug`         | `native_sparkplug`      |     6 |   ✅   | 00:00:00.669 |
...
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.891 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.650 |
| `test_graphql`           | `native_graphql`        |    25 |   ✅   | 00:00:00.667 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.646 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.669 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.679 |
...
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.659 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.700 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.133 |
| `test_http_client`       | `native_http_client`    |    11 |   ✅   | 00:00:00.655 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.638 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.662 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.676 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.687 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.667 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.655 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.695 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.048 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.646 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.636 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.656 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.642 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.701 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.654 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.653 |
...
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.655 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.652 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.661 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.651 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.683 |
...
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.443 |
...
------------ native_canopen:test_canopen [PASSED] Took 6.03 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.028
================= 17 test cases: 17 succeeded in 00:00:06.028 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.637
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.641
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.644
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:00.994
native         test_session       PASSED    00:00:00.579
native         test_presentation  PASSED    00:00:00.616
native         test_transport     PASSED    00:00:00.593
native         test_websocket     PASSED    00:00:00.626
native         test_http_parser   PASSED    00:00:00.586
================ 318 test cases: 318 succeeded in 00:00:03.995 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.987
================= 10 test cases: 10 succeeded in 00:00:00.987 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.667
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.856
native_ssh     test_ssh_auth       PASSED    00:00:00.565
native_ssh     test_ssh_server     PASSED    00:00:00.823
native_ssh     test_ssh_transport  PASSED    00:00:00.908
native_ssh     test_ssh_channel    PASSED    00:00:00.558
================ 106 test cases: 106 succeeded in 00:00:06.711 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.890
================== 2 test cases: 2 succeeded in 00:00:00.890 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
native_app     test_multipart         PASSED    00:00:00.611
...
native_app     test_chunked           PASSED    00:00:00.611
native_app     test_application       PASSED    00:00:00.690
================ 225 test cases: 225 succeeded in 00:00:11.471 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
--------------- native_diag:test_diag [PASSED] Took 1.14 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.141
================== 2 test cases: 2 succeeded in 00:00:01.141 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
================= 30 test cases: 30 succeeded in 00:00:01.202 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.460
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.856
================= 29 test cases: 29 succeeded in 00:00:00.856 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
================= 29 test cases: 29 succeeded in 00:00:00.743 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.723
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.651
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.638
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.643
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.693
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.673
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.652
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.649
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.652
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.654
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.639
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.653
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.645
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.653
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.645
================== 6 test cases: 6 succeeded in 00:00:00.645 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.638
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.640
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.647
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.654
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.669
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.891
================= 13 test cases: 13 succeeded in 00:00:00.891 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.650
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.667
================= 25 test cases: 25 succeeded in 00:00:00.667 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.646
...
================= 29 test cases: 29 succeeded in 00:00:00.679 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.659
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.700
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.133
================== 3 test cases: 3 succeeded in 00:00:01.133 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
================= 15 test cases: 15 succeeded in 00:00:00.638 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.655
================= 12 test cases: 12 succeeded in 00:00:00.655 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.695
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.048
================= 71 test cases: 71 succeeded in 00:00:01.048 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.636
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.656
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.642
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.701
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.654
================== 8 test cases: 8 succeeded in 00:00:00.654 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.653
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.655
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.652
================== 7 test cases: 7 succeeded in 00:00:00.652 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.683
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.443
================== 2 test cases: 2 succeeded in 00:00:01.443 ==================
```
