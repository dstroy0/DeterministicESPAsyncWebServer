...
| :------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_http_parser`   | `native`              |    80 |   ✅   | 00:00:03.278 |
| `test_presentation`  | `native`              |    63 |   ✅   | 00:00:03.165 |
| `test_session`       | `native`              |    19 |   ✅   | 00:00:02.262 |
| `test_sse`           | `native`              |    37 |   ✅   | 00:00:02.323 |
| `test_transport`     | `native`              |    28 |   ✅   | 00:00:02.456 |
| `test_websocket`     | `native`              |    63 |   ✅   | 00:00:02.299 |
| `test_ssh_auth`      | `native_ssh`          |    12 |   ✅   | 00:00:02.528 |
| `test_ssh_channel`   | `native_ssh`          |    12 |   ✅   | 00:00:03.536 |
| `test_ssh_crypto`    | `native_ssh`          |    37 |   ✅   | 00:00:06.370 |
| `test_ssh_server`    | `native_ssh`          |     7 |   ✅   | 00:00:02.592 |
| `test_ssh_transport` | `native_ssh`          |    23 |   ✅   | 00:00:02.959 |
| `test_ssh_hardening` | `native_ssh_hardened` |     2 |   ✅   | 00:00:01.478 |
| `test_ssh_conn`      | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.607 |
| `test_application`   | `native_app`          |    44 |   ✅   | 00:00:02.888 |
| `test_auth`          | `native_app`          |    13 |   ✅   | 00:00:02.463 |
| `test_dispatch`      | `native_app`          |    10 |   ✅   | 00:00:02.834 |
| `test_file_serving`  | `native_app`          |    12 |   ✅   | 00:00:02.181 |
| `test_multipart`     | `native_app`          |    19 |   ✅   | 00:00:02.229 |
| `test_compliance`    | `native_compliance`   |    12 |   ✅   | 00:00:01.229 |
...
-------------- native:test_http_parser [PASSED] Took 3.28 seconds --------------
...
------------- native:test_presentation [PASSED] Took 3.16 seconds --------------
...
---------------- native:test_session [PASSED] Took 2.26 seconds ----------------
...
------------------ native:test_sse [PASSED] Took 2.32 seconds ------------------
...
--------------- native:test_transport [PASSED] Took 2.46 seconds ---------------
...
------------- native_ssh:test_ssh_auth [PASSED] Took 2.53 seconds --------------
...
------------ native_ssh:test_ssh_channel [PASSED] Took 3.54 seconds ------------
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 6.37 seconds -------------
...
------------ native_ssh:test_ssh_server [PASSED] Took 2.59 seconds -------------
...
----------- native_ssh:test_ssh_transport [PASSED] Took 2.96 seconds -----------
...
------ native_ssh_hardened:test_ssh_hardening [PASSED] Took 1.48 seconds -------
...
------------ native_app:test_application [PASSED] Took 2.89 seconds ------------
...
--------------- native_app:test_auth [PASSED] Took 2.46 seconds ----------------
...
------------- native_app:test_dispatch [PASSED] Took 2.83 seconds --------------
...
----------- native_app:test_file_serving [PASSED] Took 2.18 seconds ------------
...
------------- native_app:test_multipart [PASSED] Took 2.23 seconds -------------
...
--------- native_compliance:test_compliance [PASSED] Took 1.23 seconds ---------

=================================== SUMMARY ===================================
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native               test_http_parser    PASSED    00:00:03.278
native               test_presentation   PASSED    00:00:03.165
native               test_session        PASSED    00:00:02.262
native               test_sse            PASSED    00:00:02.323
native               test_transport      PASSED    00:00:02.456
native               test_websocket      PASSED    00:00:02.299
native_ssh           test_ssh_auth       PASSED    00:00:02.528
native_ssh           test_ssh_channel    PASSED    00:00:03.536
native_ssh           test_ssh_crypto     PASSED    00:00:06.370
native_ssh           test_ssh_server     PASSED    00:00:02.592
native_ssh           test_ssh_transport  PASSED    00:00:02.959
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:01.478
native_ssh_conn      test_ssh_conn       PASSED    00:00:01.607
native_app           test_application    PASSED    00:00:02.888
native_app           test_auth           PASSED    00:00:02.463
native_app           test_dispatch       PASSED    00:00:02.834
native_app           test_file_serving   PASSED    00:00:02.181
native_app           test_multipart      PASSED    00:00:02.229
native_compliance    test_compliance     PASSED    00:00:01.229
================ 495 test cases: 495 succeeded in 00:00:50.677 ================
```
