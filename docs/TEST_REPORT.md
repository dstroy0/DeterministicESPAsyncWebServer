...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:06.079 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.656 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.672 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.683 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.692 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.674 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.663 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.678 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.663 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.671 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.669 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.051 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.612 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.636 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.612 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.635 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.605 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.739 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:00.990 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.690 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.678 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.775 |
| `test_ssh_auth`          | `native_ssh`            |    18 |   ✅   | 00:00:00.591 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.885 |
| `test_ssh_transport`     | `native_ssh`            |    27 |   ✅   | 00:00:01.106 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.565 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.885 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.254 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.159 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.606 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.606 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.548 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.605 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.604 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.569 |
...
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.605 |
...
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.186 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.154 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.706 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.516 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:02.082 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.829 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.905 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.768 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.688 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.693 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.749 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.668 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.669 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.673 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.690 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.665 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.697 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.766 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.839 |
...
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.658 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.678 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.700 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.665 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.661 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.667 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.736 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.682 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.666 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.674 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.667 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.680 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.657 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.678 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.658 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.699 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.681 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.696 |
...
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.668 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.666 |
...
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.677 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.665 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.730 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.705 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.727 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.083 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.085 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.686 |
| `test_jwt`               | `native_jwt`            |    16 |   ✅   | 00:00:00.732 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.151 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.676 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.661 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.664 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.717 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.714 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.688 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.667 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.715 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.065 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.677 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.668 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.683 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.666 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.710 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.687 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.658 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.671 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.664 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.662 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.663 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.696 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.684 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.666 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.671 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.698 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.767 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.647 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.769 |
...
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.079
================= 17 test cases: 17 succeeded in 00:00:06.079 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 134 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.683
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.692
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.674
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.671
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.669
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.051
native         test_session       PASSED    00:00:00.612
native         test_presentation  PASSED    00:00:00.636
...
================ 321 test cases: 321 succeeded in 00:00:04.150 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 134 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.739
================= 17 test cases: 17 succeeded in 00:00:00.739 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 134 tests
...
================= 10 test cases: 10 succeeded in 00:00:00.990 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 134 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.678
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 3.77 seconds -------------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.775
native_ssh     test_ssh_auth       PASSED    00:00:00.591
native_ssh     test_ssh_server     PASSED    00:00:00.885
native_ssh     test_ssh_transport  PASSED    00:00:01.106
native_ssh     test_ssh_channel    PASSED    00:00:00.565
================ 120 test cases: 120 succeeded in 00:00:06.922 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 134 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.885
================== 2 test cases: 2 succeeded in 00:00:00.885 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 134 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.159
native_app     test_template          PASSED    00:00:00.606
native_app     test_path_params       PASSED    00:00:00.606
native_app     test_digest_vectors    PASSED    00:00:00.548
native_app     test_form_params       PASSED    00:00:00.605
native_app     test_iface             PASSED    00:00:00.604
native_app     test_json              PASSED    00:00:00.569
...
native_app     test_defer             PASSED    00:00:00.605
...
================ 225 test cases: 225 succeeded in 00:00:11.602 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 134 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.186
================= 12 test cases: 12 succeeded in 00:00:01.186 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 134 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.154
================== 2 test cases: 2 succeeded in 00:00:01.154 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 134 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.905
================= 41 test cases: 41 succeeded in 00:00:00.905 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 134 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.768
================= 41 test cases: 41 succeeded in 00:00:00.768 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 134 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.693
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.749
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.673
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.690
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.665
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.697
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.839
================= 16 test cases: 16 succeeded in 00:00:00.839 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 134 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.658
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.678
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.700
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.665
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.661
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.736
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.667
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.657
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.678
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.699
================= 14 test cases: 14 succeeded in 00:00:00.699 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 134 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.681
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.696
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.668
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.666
================== 2 test cases: 2 succeeded in 00:00:00.666 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 134 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.677
================= 32 test cases: 32 succeeded in 00:00:00.677 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 134 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.730
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.705
================= 38 test cases: 38 succeeded in 00:00:00.705 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 134 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.083
================= 10 test cases: 10 succeeded in 00:00:01.083 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 134 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.085
================= 13 test cases: 13 succeeded in 00:00:01.085 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 134 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.151
================== 3 test cases: 3 succeeded in 00:00:01.151 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 134 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.661
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.664
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.717
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.714
================= 14 test cases: 14 succeeded in 00:00:00.714 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 134 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.688
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.065
================= 71 test cases: 71 succeeded in 00:00:01.065 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 134 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.677
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.683
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.710
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.658
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.671
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.664
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.662
================= 18 test cases: 18 succeeded in 00:00:00.662 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 134 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.696
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.684
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.666
================== 6 test cases: 6 succeeded in 00:00:00.666 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 134 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.767
================== 3 test cases: 3 succeeded in 00:00:00.767 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 134 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.769
================== 2 test cases: 2 succeeded in 00:00:00.769 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 134 tests
