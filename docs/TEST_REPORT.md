...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:07.807 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.349 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.369 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.353 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.381 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.344 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:02.209 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.363 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.450 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.612 |
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.342 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.543 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:00.763 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.671 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.360 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.357 |
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.318 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.352 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.352 |
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.331 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.357 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.351 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.352 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.350 |
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.337 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.356 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.355 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.361 |
| `test_dispatch`         | `native_app`          |    11 |   ✅   | 00:00:00.352 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.351 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.420 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.421 |
| `test_workers`          | `native_workers`      |     3 |   ✅   | 00:00:00.530 |
| `test_concurrency`      | `native_tsan`         |     2 |   ✅   | 00:00:01.046 |
...
------------------ native:test_sse [PASSED] Took 7.81 seconds ------------------
...
------------- native:test_presentation [PASSED] Took 0.37 seconds --------------
...
--------------- native:test_transport [PASSED] Took 0.35 seconds ---------------
...
-------------- native:test_http_parser [PASSED] Took 0.34 seconds --------------
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 2.21 seconds -------------
...
------------ native_ssh:test_ssh_server [PASSED] Took 0.45 seconds -------------
...
----------- native_ssh:test_ssh_transport [PASSED] Took 0.61 seconds -----------
...
------ native_ssh_hardened:test_ssh_hardening [PASSED] Took 0.54 seconds -------
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 0.76 seconds -----------
...
--------------- native_app:test_regex [PASSED] Took 0.67 seconds ---------------
...
------------- native_app:test_template [PASSED] Took 0.36 seconds --------------
...
------------ native_app:test_path_params [PASSED] Took 0.36 seconds ------------
...
------------ native_app:test_form_params [PASSED] Took 0.35 seconds ------------
...
--------------- native_app:test_iface [PASSED] Took 0.35 seconds ---------------
...
--------------- native_app:test_json [PASSED] Took 0.33 seconds ----------------
...
------------ native_app:test_middleware [PASSED] Took 0.35 seconds -------------
...
------------ native_app:test_digest_auth [PASSED] Took 0.35 seconds ------------
...
----------- native_app:test_web_terminal [PASSED] Took 0.35 seconds ------------
...
--------------- native_app:test_defer [PASSED] Took 0.34 seconds ---------------
...
--------------- native_app:test_auth [PASSED] Took 0.35 seconds ----------------
...
----------- native_app:test_file_serving [PASSED] Took 0.36 seconds ------------
...
------------- native_app:test_dispatch [PASSED] Took 0.35 seconds --------------
...
-------------- native_app:test_chunked [PASSED] Took 0.35 seconds --------------
...
--------- native_compliance:test_compliance [PASSED] Took 0.42 seconds ---------
...
------------ native_workers:test_workers [PASSED] Took 0.53 seconds ------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:07.807
native               test_session           PASSED    00:00:00.349
native               test_presentation      PASSED    00:00:00.369
native               test_transport         PASSED    00:00:00.353
native               test_websocket         PASSED    00:00:00.381
native               test_http_parser       PASSED    00:00:00.344
native_ssh           test_ssh_crypto        PASSED    00:00:02.209
native_ssh           test_ssh_auth          PASSED    00:00:00.363
native_ssh           test_ssh_server        PASSED    00:00:00.450
native_ssh           test_ssh_transport     PASSED    00:00:00.612
native_ssh           test_ssh_channel       PASSED    00:00:00.342
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.543
native_ssh_conn      test_ssh_conn          PASSED    00:00:00.763
native_app           test_regex             PASSED    00:00:00.671
native_app           test_template          PASSED    00:00:00.360
native_app           test_path_params       PASSED    00:00:00.357
native_app           test_digest_vectors    PASSED    00:00:00.318
native_app           test_form_params       PASSED    00:00:00.352
native_app           test_iface             PASSED    00:00:00.352
native_app           test_json              PASSED    00:00:00.331
native_app           test_response_headers  PASSED    00:00:00.357
native_app           test_middleware        PASSED    00:00:00.351
native_app           test_digest_auth       PASSED    00:00:00.352
native_app           test_web_terminal      PASSED    00:00:00.350
native_app           test_defer             PASSED    00:00:00.337
native_app           test_multipart         PASSED    00:00:00.356
native_app           test_auth              PASSED    00:00:00.355
native_app           test_file_serving      PASSED    00:00:00.361
native_app           test_dispatch          PASSED    00:00:00.352
native_app           test_chunked           PASSED    00:00:00.351
native_app           test_application       PASSED    00:00:00.420
native_compliance    test_compliance        PASSED    00:00:00.421
native_workers       test_workers           PASSED    00:00:00.530
native_tsan          test_concurrency       PASSED    00:00:01.046
================ 620 test cases: 620 succeeded in 00:00:23.565 ================
```
