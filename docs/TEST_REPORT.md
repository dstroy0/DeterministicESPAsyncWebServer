...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:13.598 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.643 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.652 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.655 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:04.421 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.652 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.650 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.676 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.653 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.663 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.669 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.647 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.657 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.651 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.666 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.659 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.366 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.580 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.613 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.604 |
...
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.943 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.668 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.850 |
| `test_ssh_transport`     | `native_ssh`            |    31 |   ✅   | 00:00:01.141 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.582 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.927 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.346 |
...
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.610 |
...
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.606 |
...
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.164 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.707 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.541 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:01.969 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.816 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.989 |
...
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.773 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.664 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.693 |
...
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.743 |
...
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.649 |
...
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.662 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.668 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.654 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.671 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.638 |
...
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.648 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.648 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.643 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.647 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.646 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.643 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.659 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.652 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.647 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.660 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.670 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.641 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.665 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.654 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.636 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.637 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.670 |
...
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.095 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.672 |
| `test_smtp`              | `native_smtp`           |    11 |   ✅   | 00:00:00.779 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.647 |
| `test_dns_server`        | `native_dns_server`     |     7 |   ✅   | 00:00:00.648 |
| `test_rtc`               | `native_rtc`            |     8 |   ✅   | 00:00:00.646 |
| `test_ld2410`            | `native_ld2410`         |     7 |   ✅   | 00:00:00.642 |
| `test_mpr121`            | `native_mpr121`         |     5 |   ✅   | 00:00:00.642 |
| `test_sht3x`             | `native_sht3x`          |     5 |   ✅   | 00:00:00.641 |
| `test_pca9685`           | `native_pca9685`        |     4 |   ✅   | 00:00:00.654 |
| `test_ads1115`           | `native_ads1115`        |     3 |   ✅   | 00:00:00.643 |
| `test_ina219`            | `native_ina219`         |     4 |   ✅   | 00:00:00.642 |
| `test_hpack`             | `native_hpack`          |     7 |   ✅   | 00:00:00.740 |
| `test_h2_frame`          | `native_h2frame`        |     6 |   ✅   | 00:00:00.637 |
| `test_h2_conn`           | `native_h2conn`         |     4 |   ✅   | 00:00:00.869 |
| `test_quic_varint`       | `native_quic_varint`    |     3 |   ✅   | 00:00:00.646 |
| `test_h3_frame`          | `native_h3frame`        |     7 |   ✅   | 00:00:00.664 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.699 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.111 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.642 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.674 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.673 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.677 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.670 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.666 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.647 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.687 |
...
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.651 |
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.675 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.692 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.661 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.653 |
...
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.659 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.665 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.647 |
| `test_statsd`            | `native_statsd`         |     9 |   ✅   | 00:00:00.681 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.644 |
...
----------- native_canopen:test_canopen [PASSED] Took 13.60 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:13.598
================= 17 test cases: 17 succeeded in 00:00:13.598 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.643
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.652
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:04.421
================= 16 test cases: 16 succeeded in 00:00:04.421 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.676
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.663
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.669
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.647
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.651
...
------------------ native:test_sse [PASSED] Took 1.37 seconds ------------------
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.366
...
================ 323 test cases: 323 succeeded in 00:00:04.402 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.943
native_ssh     test_ssh_auth       PASSED    00:00:00.668
...
================ 137 test cases: 137 succeeded in 00:00:07.184 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.927
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.346
...
native_app     test_form_params       PASSED    00:00:00.610
...
native_app     test_auth              PASSED    00:00:00.606
...
================ 225 test cases: 225 succeeded in 00:00:11.520 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.164
================== 2 test cases: 2 succeeded in 00:00:01.164 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
native_snmp    test_snmp_agent  PASSED    00:00:00.541
================= 35 test cases: 35 succeeded in 00:00:01.248 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.969
================= 15 test cases: 15 succeeded in 00:00:01.969 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.816
================= 15 test cases: 15 succeeded in 00:00:00.816 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.989
================= 41 test cases: 41 succeeded in 00:00:00.989 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.773
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.693
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.743
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.649
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.662
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.654
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.671
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.638
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.648
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.647
================== 9 test cases: 9 succeeded in 00:00:00.647 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.646
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.643
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.652
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.647
================== 8 test cases: 8 succeeded in 00:00:00.647 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.660
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.665
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.654
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.636
================== 2 test cases: 2 succeeded in 00:00:00.636 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.637
...
================= 16 test cases: 16 succeeded in 00:00:00.670 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.095
================= 13 test cases: 13 succeeded in 00:00:01.095 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_smtp    test_smtp  PASSED    00:00:00.779
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_ntp_server  test_ntp_server  PASSED    00:00:00.647
================== 8 test cases: 8 succeeded in 00:00:00.647 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_rtc     test_rtc  PASSED    00:00:00.646
...
------------- native_ld2410:test_ld2410 [PASSED] Took 0.64 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ld2410  test_ld2410  PASSED    00:00:00.642
...
------------- native_mpr121:test_mpr121 [PASSED] Took 0.64 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_mpr121  test_mpr121  PASSED    00:00:00.642
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sht3x   test_sht3x  PASSED    00:00:00.641
================== 5 test cases: 5 succeeded in 00:00:00.641 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_pca9685  test_pca9685  PASSED    00:00:00.654
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_ads1115  test_ads1115  PASSED    00:00:00.643
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ina219  test_ina219  PASSED    00:00:00.642
...
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h2frame  test_h2_frame  PASSED    00:00:00.637
...
Environment    Test          Status    Duration
-------------  ------------  --------  ------------
native_h2conn  test_h2_conn  PASSED    00:00:00.869
================== 4 test cases: 4 succeeded in 00:00:00.869 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_varint  test_quic_varint  PASSED    00:00:00.646
...
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h3frame  test_h3_frame  PASSED    00:00:00.664
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.699
================= 21 test cases: 21 succeeded in 00:00:00.699 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.642
================= 15 test cases: 15 succeeded in 00:00:00.642 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.677
================= 16 test cases: 16 succeeded in 00:00:00.677 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 165 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.670
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.647
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.651
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.661
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_statsd  test_statsd  PASSED    00:00:00.681
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_qpack   test_qpack  PASSED    00:00:00.763
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_ssh_chachapoly  test_ssh_chachapoly  PASSED    00:00:00.694
