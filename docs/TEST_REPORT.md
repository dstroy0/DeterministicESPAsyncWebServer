...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:15.622 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.556 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.590 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.574 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.606 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.567 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.699 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.638 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.635 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.878 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.543 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.647 |
...
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.120 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.579 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.578 |
...
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.582 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.580 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.595 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.580 |
...
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.584 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.658 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.172 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.119 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.660 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.478 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.455 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.792 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.850 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.720 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.648 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.642 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.695 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.647 |
...
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.619 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.623 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.657 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.815 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.622 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.624 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.621 |
...
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.642 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.676 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.074 |
...
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.663 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.647 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.638 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.668 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.010 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.621 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.622 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.650 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.629 |
...
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.616 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.633 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.650 |
...
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.253 |
...
----------------- native:test_sse [PASSED] Took 15.62 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:15.622
native         test_session       PASSED    00:00:00.556
native         test_presentation  PASSED    00:00:00.590
native         test_transport     PASSED    00:00:00.574
native         test_websocket     PASSED    00:00:00.606
native         test_http_parser   PASSED    00:00:00.567
================ 318 test cases: 318 succeeded in 00:00:18.515 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 91 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.638
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.635
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.120
native_app     test_template          PASSED    00:00:00.579
native_app     test_path_params       PASSED    00:00:00.578
...
native_app     test_middleware        PASSED    00:00:00.580
native_app     test_digest_auth       PASSED    00:00:00.595
native_app     test_web_terminal      PASSED    00:00:00.580
...
native_app     test_application       PASSED    00:00:00.658
================ 219 test cases: 219 succeeded in 00:00:10.977 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 91 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.172
================= 12 test cases: 12 succeeded in 00:00:01.172 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 91 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.119
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.660
native_snmp    test_snmp_agent  PASSED    00:00:00.478
================= 29 test cases: 29 succeeded in 00:00:01.139 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 91 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.455
================= 10 test cases: 10 succeeded in 00:00:01.455 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 91 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.850
================= 29 test cases: 29 succeeded in 00:00:00.850 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 91 tests
...
================= 18 test cases: 18 succeeded in 00:00:00.642 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 91 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.695
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.647
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.619
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.657
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.622
================= 11 test cases: 11 succeeded in 00:00:00.622 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 91 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.624
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.621
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.642
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.676
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.074
================== 3 test cases: 3 succeeded in 00:00:01.074 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 91 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.663
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.647
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.638
================= 12 test cases: 12 succeeded in 00:00:00.638 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 91 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.668
================= 10 test cases: 10 succeeded in 00:00:00.668 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 91 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.621
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.622
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.650
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.629
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.616
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.633
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.650
================== 4 test cases: 4 succeeded in 00:00:00.650 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 91 tests
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.253
================== 2 test cases: 2 succeeded in 00:00:01.253 ==================
```
