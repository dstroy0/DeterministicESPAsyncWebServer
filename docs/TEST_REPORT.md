...
**Generated:** 2026-06-29 22:41:52
**Command:** `pio test` over 93 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1509 passed - 155s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    11 |   ✅   | 00:00:05.918 |
...
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.577 |
...
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.888 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.562 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.673 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.887 |
...
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.163 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.599 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.590 |
...
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.595 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.598 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.620 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.595 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.575 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.602 |
...
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.193 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.125 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.705 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.500 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.469 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.824 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.771 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.760 |
...
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.676 |
...
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.646 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.638 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.654 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.658 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.645 |
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.700 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.644 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.639 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.642 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.648 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.640 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.642 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.661 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.651 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.656 |
...
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.833 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.663 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.661 |
...
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.080 |
...
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.695 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.688 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.674 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.687 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.684 |
...
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.791 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.681 |
...
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:05.918
================= 11 test cases: 11 succeeded in 00:00:05.918 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 118 tests
...
native_ssh     test_ssh_transport  PASSED    00:00:00.887
native_ssh     test_ssh_channel    PASSED    00:00:00.521
================= 93 test cases: 93 succeeded in 00:00:06.531 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 118 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.163
native_app     test_template          PASSED    00:00:00.599
native_app     test_path_params       PASSED    00:00:00.590
...
native_app     test_response_headers  PASSED    00:00:00.595
native_app     test_middleware        PASSED    00:00:00.598
native_app     test_digest_auth       PASSED    00:00:00.620
native_app     test_web_terminal      PASSED    00:00:00.595
native_app     test_defer             PASSED    00:00:00.575
native_app     test_multipart         PASSED    00:00:00.602
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.193
================= 12 test cases: 12 succeeded in 00:00:01.193 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 118 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.125
================== 2 test cases: 2 succeeded in 00:00:01.125 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 118 tests
...
================= 30 test cases: 30 succeeded in 00:00:01.204 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 118 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.469
================= 10 test cases: 10 succeeded in 00:00:01.469 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 118 tests
...
================= 29 test cases: 29 succeeded in 00:00:00.771 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 118 tests
...
================= 29 test cases: 29 succeeded in 00:00:00.760 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 118 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.676
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.646
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.638
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.654
...
test/test_hostlink/test_hostlink.cpp:30: test_build_dm_read: Expected '@00RD0000001057*\r' Was '@00RD0000001057*\r\xAC\x11\x0F\xFE\x7F' [FAILED]
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.639
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.642
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.648
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.640
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.642
...
================= 13 test cases: 13 succeeded in 00:00:00.833 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 118 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.098
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.706
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.654
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.726
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.080
================= 71 test cases: 71 succeeded in 00:00:01.080 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 118 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.791
