...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:12.841 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.487 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.515 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.505 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.526 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.521 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.792 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.536 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.636 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.854 |
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.496 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.807 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.058 |
...
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.529 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.517 |
...
----------------- native:test_sse [PASSED] Took 12.84 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:12.841
...
native               test_websocket         PASSED    00:00:00.526
...
native_ssh           test_ssh_server        PASSED    00:00:00.636
native_ssh           test_ssh_transport     PASSED    00:00:00.854
native_ssh           test_ssh_channel       PASSED    00:00:00.496
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.807
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.058
...
native_app           test_form_params       PASSED    00:00:00.500
...
native_app           test_digest_auth       PASSED    00:00:00.529
native_app           test_web_terminal      PASSED    00:00:00.517
...
================ 611 test cases: 611 succeeded in 00:00:33.372 ================
```
