...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    11 |   ✅   | 00:00:11.753 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.651 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.647 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.670 |
| `test_mbus`              | `native_mbus`           |     8 |   ✅   | 00:00:00.629 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.644 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.665 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.649 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.623 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.645 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.088 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.568 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.605 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.581 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.617 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.570 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.746 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:01.105 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.653 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.651 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:04.048 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.559 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.679 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.875 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.525 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.016 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.538 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.345 |
...
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.543 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.593 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.593 |
...
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.593 |
...
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.671 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.362 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.331 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.732 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.499 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.544 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.817 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.827 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.747 |
...
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.628 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.653 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.656 |
| `test_protobuf`          | `native_protobuf`       |    10 |   ✅   | 00:00:00.652 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.684 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.646 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.651 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.648 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.649 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.649 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.648 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.625 |
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.732 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.648 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.651 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.661 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.650 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.648 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.651 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.646 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.627 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.636 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.649 |
| `test_sparkplug`         | `native_sparkplug`      |     6 |   ✅   | 00:00:00.670 |
...
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.629 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.647 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.672 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.865 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.633 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.653 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.647 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.669 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.664 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.682 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.215 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.218 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.662 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.728 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.241 |
| `test_http_client`       | `native_http_client`    |    11 |   ✅   | 00:00:00.664 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.635 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.660 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.724 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.697 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.666 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.653 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.695 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.171 |
...
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.692 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.642 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.656 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.649 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.646 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.663 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.658 |
...
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.653 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.671 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.796 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.620 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.782 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.412 |
...
----------- native_canopen:test_canopen [PASSED] Took 11.75 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:11.753
================= 11 test cases: 11 succeeded in 00:00:11.753 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.647
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.629
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.649
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.623
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.645
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.088
native         test_session       PASSED    00:00:00.568
native         test_presentation  PASSED    00:00:00.605
native         test_transport     PASSED    00:00:00.581
native         test_websocket     PASSED    00:00:00.617
native         test_http_parser   PASSED    00:00:00.570
================ 318 test cases: 318 succeeded in 00:00:04.029 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
================= 15 test cases: 15 succeeded in 00:00:00.746 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.651
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.048
native_ssh     test_ssh_auth       PASSED    00:00:00.559
native_ssh     test_ssh_server     PASSED    00:00:00.679
native_ssh     test_ssh_transport  PASSED    00:00:00.875
native_ssh     test_ssh_channel    PASSED    00:00:00.525
================= 93 test cases: 93 succeeded in 00:00:06.686 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.538
================== 2 test cases: 2 succeeded in 00:00:01.538 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
--------------- native_app:test_regex [PASSED] Took 1.35 seconds ---------------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.345
...
native_app     test_json              PASSED    00:00:00.543
native_app     test_response_headers  PASSED    00:00:00.593
native_app     test_middleware        PASSED    00:00:00.593
...
native_app     test_auth              PASSED    00:00:00.593
...
native_app     test_application       PASSED    00:00:00.671
================ 219 test cases: 219 succeeded in 00:00:11.367 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.362
================= 12 test cases: 12 succeeded in 00:00:01.362 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
--------------- native_diag:test_diag [PASSED] Took 1.33 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.331
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.732
native_snmp    test_snmp_agent  PASSED    00:00:00.499
================= 30 test cases: 30 succeeded in 00:00:01.231 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.544
================= 10 test cases: 10 succeeded in 00:00:01.544 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.817
================== 8 test cases: 8 succeeded in 00:00:00.817 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
================= 29 test cases: 29 succeeded in 00:00:00.827 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.747
================= 29 test cases: 29 succeeded in 00:00:00.747 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.628
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.646
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.649
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.648
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.625
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.648
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.651
================== 6 test cases: 6 succeeded in 00:00:00.651 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.627
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.636
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.649
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.629
================== 2 test cases: 2 succeeded in 00:00:00.629 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.647
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.865
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.664
================= 29 test cases: 29 succeeded in 00:00:00.664 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.215
================= 10 test cases: 10 succeeded in 00:00:01.215 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.218
================= 13 test cases: 13 succeeded in 00:00:01.218 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.728
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.241
================== 3 test cases: 3 succeeded in 00:00:01.241 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.635
...
================= 19 test cases: 19 succeeded in 00:00:00.660 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.171
================= 71 test cases: 71 succeeded in 00:00:01.171 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.692
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.642
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.656
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.646
================== 5 test cases: 5 succeeded in 00:00:00.646 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.658
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.653
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.796
================== 3 test cases: 3 succeeded in 00:00:00.796 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.620
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.412
================== 2 test cases: 2 succeeded in 00:00:01.412 ==================
```
