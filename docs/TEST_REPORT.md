...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:13.293 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.550 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.580 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.566 |
| `test_websocket`         | `native`               |    63 |   ✅   | 00:00:00.586 |
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.545 |
| `test_observability`     | `native_observability` |    15 |   ✅   | 00:00:00.687 |
| `test_http_ota`          | `native_ota`           |     3 |   ✅   | 00:00:00.624 |
| `test_provisioning`      | `native_prov`          |     5 |   ✅   | 00:00:00.633 |
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.795 |
| `test_ssh_auth`          | `native_ssh`           |    12 |   ✅   | 00:00:00.543 |
| `test_ssh_server`        | `native_ssh`           |     7 |   ✅   | 00:00:00.642 |
| `test_ssh_transport`     | `native_ssh`           |    23 |   ✅   | 00:00:00.870 |
| `test_ssh_channel`       | `native_ssh`           |    12 |   ✅   | 00:00:00.512 |
| `test_ssh_hardening`     | `native_ssh_hardened`  |     2 |   ✅   | 00:00:00.852 |
| `test_ssh_conn`          | `native_ssh_conn`      |     2 |   ✅   | 00:00:01.202 |
| `test_regex`             | `native_app`           |     9 |   ✅   | 00:00:01.071 |
| `test_template`          | `native_app`           |     6 |   ✅   | 00:00:00.566 |
| `test_path_params`       | `native_app`           |     8 |   ✅   | 00:00:00.573 |
| `test_digest_vectors`    | `native_app`           |     4 |   ✅   | 00:00:00.514 |
| `test_form_params`       | `native_app`           |     5 |   ✅   | 00:00:00.562 |
| `test_iface`             | `native_app`           |     7 |   ✅   | 00:00:00.571 |
| `test_json`              | `native_app`           |    17 |   ✅   | 00:00:00.521 |
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.573 |
| `test_middleware`        | `native_app`           |     9 |   ✅   | 00:00:00.570 |
| `test_digest_auth`       | `native_app`           |     5 |   ✅   | 00:00:00.569 |
| `test_web_terminal`      | `native_app`           |     7 |   ✅   | 00:00:00.562 |
| `test_defer`             | `native_app`           |     3 |   ✅   | 00:00:00.549 |
| `test_multipart`         | `native_app`           |    19 |   ✅   | 00:00:00.579 |
| `test_auth`              | `native_app`           |    13 |   ✅   | 00:00:00.574 |
| `test_file_serving`      | `native_app`           |    12 |   ✅   | 00:00:00.591 |
| `test_dispatch`          | `native_app`           |    11 |   ✅   | 00:00:00.565 |
| `test_chunked`           | `native_app`           |    10 |   ✅   | 00:00:00.572 |
| `test_application`       | `native_app`           |    50 |   ✅   | 00:00:00.646 |
| `test_snmp_ber`          | `native_snmp`          |     9 |   ✅   | 00:00:00.662 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.472 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.351 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.746 |
| `test_coap`              | `native_coap`          |    26 |   ✅   | 00:00:00.644 |
| `test_webdav`            | `native_webdav`        |    19 |   ✅   | 00:00:00.637 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.626 |
| `test_modbus_master`     | `native_modbus_master` |     5 |   ✅   | 00:00:00.641 |
| `test_ota_rollback`      | `native_ota_rollback`  |     5 |   ✅   | 00:00:00.611 |
...
| `test_dns_resolver`      | `native_dns_resolver`  |     4 |   ✅   | 00:00:00.614 |
| `test_audit_log`         | `native_audit_log`     |    12 |   ✅   | 00:00:00.643 |
| `test_oidc`              | `native_oidc`          |    13 |   ✅   | 00:00:00.806 |
| `test_vfs`               | `native_vfs`           |    11 |   ✅   | 00:00:00.626 |
| `test_graphql`           | `native_graphql`       |    13 |   ✅   | 00:00:00.638 |
| `test_espnow`            | `native_espnow`        |     7 |   ✅   | 00:00:00.620 |
| `test_oauth2`            | `native_oauth2`        |     8 |   ✅   | 00:00:00.650 |
| `test_opcua`             | `native_opcua`         |    29 |   ✅   | 00:00:00.652 |
| `test_opcua_client`      | `native_opcua_client`  |    11 |   ✅   | 00:00:00.660 |
| `test_keepalive`         | `native_keepalive`     |    10 |   ✅   | 00:00:01.027 |
| `test_range`             | `native_range`         |    10 |   ✅   | 00:00:01.018 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.632 |
| `test_jwt`               | `native_jwt`           |    10 |   ✅   | 00:00:00.664 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.036 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.628 |
| `test_compliance`        | `native_compliance`    |    12 |   ✅   | 00:00:00.636 |
| `test_mqtt`              | `native_mqtt`          |    16 |   ✅   | 00:00:00.628 |
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.646 |
| `test_scratch`           | `native_scratch`       |    14 |   ✅   | 00:00:00.656 |
| `test_snmp_trap`         | `native_snmp_trap`     |     3 |   ✅   | 00:00:00.645 |
| `test_inflate`           | `native_inflate`       |    12 |   ✅   | 00:00:00.623 |
| `test_deflate`           | `native_deflate`       |    10 |   ✅   | 00:00:00.659 |
| `test_websocket`         | `native_ws_deflate`    |    67 |   ✅   | 00:00:00.986 |
| `test_time_source`       | `native_time_source`   |     9 |   ✅   | 00:00:00.613 |
| `test_config_store`      | `native_config_store`  |    14 |   ✅   | 00:00:00.626 |
| `test_device_id`         | `native_device_id`     |     4 |   ✅   | 00:00:00.629 |
| `test_auth_lockout`      | `native_auth_lockout`  |    10 |   ✅   | 00:00:00.614 |
| `test_csrf`              | `native_csrf`          |     9 |   ✅   | 00:00:00.647 |
| `test_telemetry`         | `native_telemetry`     |     8 |   ✅   | 00:00:00.625 |
| `test_dashboard`         | `native_dashboard`     |    11 |   ✅   | 00:00:00.631 |
| `test_net_egress`        | `native_net_egress`    |     5 |   ✅   | 00:00:00.612 |
| `test_partition_monitor` | `native_partition`     |     5 |   ✅   | 00:00:00.620 |
| `test_cbor`              | `native_cbor`          |    14 |   ✅   | 00:00:00.636 |
| `test_msgpack`           | `native_msgpack`       |    15 |   ✅   | 00:00:00.637 |
| `test_gpio_map`          | `native_gpio_map`      |     8 |   ✅   | 00:00:00.624 |
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.621 |
| `test_guardrails`        | `native_guardrails`    |     6 |   ✅   | 00:00:00.629 |
| `test_logbuf`            | `native_logbuf`        |     4 |   ✅   | 00:00:00.617 |
| `test_config_io`         | `native_config_io`     |     4 |   ✅   | 00:00:00.634 |
| `test_workers`           | `native_workers`       |     3 |   ✅   | 00:00:00.727 |
| `test_clock`             | `native_clock`         |     4 |   ✅   | 00:00:00.597 |
| `test_concurrency`       | `native_concurrency`   |     2 |   ✅   | 00:00:00.728 |
...
----------------- native:test_sse [PASSED] Took 13.29 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:13.293
native         test_session       PASSED    00:00:00.550
native         test_presentation  PASSED    00:00:00.580
native         test_transport     PASSED    00:00:00.566
native         test_websocket     PASSED    00:00:00.586
native         test_http_parser   PASSED    00:00:00.545
================ 306 test cases: 306 succeeded in 00:00:16.120 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.633
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 3.80 seconds -------------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.795
native_ssh     test_ssh_auth       PASSED    00:00:00.543
native_ssh     test_ssh_server     PASSED    00:00:00.642
native_ssh     test_ssh_transport  PASSED    00:00:00.870
native_ssh     test_ssh_channel    PASSED    00:00:00.512
================= 92 test cases: 92 succeeded in 00:00:06.362 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.852
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.202
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.071
native_app     test_template          PASSED    00:00:00.566
native_app     test_path_params       PASSED    00:00:00.573
native_app     test_digest_vectors    PASSED    00:00:00.514
native_app     test_form_params       PASSED    00:00:00.562
native_app     test_iface             PASSED    00:00:00.571
native_app     test_json              PASSED    00:00:00.521
native_app     test_response_headers  PASSED    00:00:00.573
native_app     test_middleware        PASSED    00:00:00.570
native_app     test_digest_auth       PASSED    00:00:00.569
native_app     test_web_terminal      PASSED    00:00:00.562
...
native_app     test_file_serving      PASSED    00:00:00.591
native_app     test_dispatch          PASSED    00:00:00.565
native_app     test_chunked           PASSED    00:00:00.572
native_app     test_application       PASSED    00:00:00.646
================ 204 test cases: 204 succeeded in 00:00:10.727 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.662
native_snmp    test_snmp_agent  PASSED    00:00:00.472
================= 22 test cases: 22 succeeded in 00:00:01.134 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.351
================== 9 test cases: 9 succeeded in 00:00:01.351 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
--------------- native_coap:test_coap [PASSED] Took 0.64 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.644
================= 26 test cases: 26 succeeded in 00:00:00.644 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.637
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.626
================= 13 test cases: 13 succeeded in 00:00:00.626 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.641
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.611
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.614
================== 4 test cases: 4 succeeded in 00:00:00.614 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.643
...
--------------- native_oidc:test_oidc [PASSED] Took 0.81 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.806
================= 13 test cases: 13 succeeded in 00:00:00.806 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.626
...
================= 13 test cases: 13 succeeded in 00:00:00.638 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.620
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.650
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.652
================= 29 test cases: 29 succeeded in 00:00:00.652 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.660
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.018
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.664
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.036
================== 3 test cases: 3 succeeded in 00:00:01.036 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.628
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.628
================= 16 test cases: 16 succeeded in 00:00:00.628 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.656
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.645
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.623
================= 12 test cases: 12 succeeded in 00:00:00.623 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.659
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.986
================= 67 test cases: 67 succeeded in 00:00:00.986 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.613
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.626
================= 14 test cases: 14 succeeded in 00:00:00.626 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.629
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.614
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.625
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.631
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.620
================== 5 test cases: 5 succeeded in 00:00:00.620 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.637
================= 15 test cases: 15 succeeded in 00:00:00.637 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.624
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.629
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.617
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.634
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.727
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.728
