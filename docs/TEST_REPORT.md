...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:06.072 |
...
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.563 |
...
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.179 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.138 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.702 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.517 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.518 |
...
| `test_protobuf`          | `native_protobuf`       |    10 |   ✅   | 00:00:00.663 |
| `test_preempt_queue`     | `native_preempt_queue`  |     7 |   ✅   | 00:00:00.718 |
...
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.666 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.658 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.649 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.714 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.661 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.644 |
...
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.651 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.661 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.666 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.650 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.648 |
...
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.765 |
...
------------ native_canopen:test_canopen [PASSED] Took 6.07 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.072
================= 17 test cases: 17 succeeded in 00:00:06.072 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.645
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.667
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.750
native_ssh     test_ssh_auth       PASSED    00:00:00.587
native_ssh     test_ssh_server     PASSED    00:00:00.864
native_ssh     test_ssh_transport  PASSED    00:00:01.100
native_ssh     test_ssh_channel    PASSED    00:00:00.560
================ 120 test cases: 120 succeeded in 00:00:06.860 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
================ 225 test cases: 225 succeeded in 00:00:11.421 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.179
================= 12 test cases: 12 succeeded in 00:00:01.179 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.138
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.518
================= 10 test cases: 10 succeeded in 00:00:01.518 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.666
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.649
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.644
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.688
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.075
================= 13 test cases: 13 succeeded in 00:00:01.075 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.653
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.651
================== 8 test cases: 8 succeeded in 00:00:00.651 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.650
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.765
