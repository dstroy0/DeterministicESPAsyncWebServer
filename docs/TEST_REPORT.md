...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:14.481 |
...
| `test_http_parser`       | `native`                |    82 |   ✅   | 00:00:00.614 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.753 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.683 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.706 |
| `test_ssh_crypto`        | `native_ssh`            |    38 |   ✅   | 00:00:03.970 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.596 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.701 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.909 |
...
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.588 |
...
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.235 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.215 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.749 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.525 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.527 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.835 |
...
| `test_modbus`            | `native_modbus`         |    13 |   ✅   | 00:00:00.705 |
...
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.856 |
...
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.725 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.732 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.710 |
...
| `test_udp_telemetry`     | `native_udp_telemetry`  |     4 |   ✅   | 00:00:00.683 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.661 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.669 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.717 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.829 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.657 |
...
----------------- native:test_sse [PASSED] Took 14.48 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:14.481
...
================ 310 test cases: 310 succeeded in 00:00:17.623 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.706
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.970
native_ssh     test_ssh_auth       PASSED    00:00:00.596
native_ssh     test_ssh_server     PASSED    00:00:00.701
native_ssh     test_ssh_transport  PASSED    00:00:00.909
native_ssh     test_ssh_channel    PASSED    00:00:00.565
================= 92 test cases: 92 succeeded in 00:00:06.740 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
native_app     test_digest_vectors    PASSED    00:00:00.588
...
================ 219 test cases: 219 succeeded in 00:00:12.059 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.235
================= 12 test cases: 12 succeeded in 00:00:01.235 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.749
native_snmp    test_snmp_agent  PASSED    00:00:00.525
================= 29 test cases: 29 succeeded in 00:00:01.274 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
================== 8 test cases: 8 succeeded in 00:00:00.835 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.856
================= 13 test cases: 13 succeeded in 00:00:00.856 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.725
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.717
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.829
================== 3 test cases: 3 succeeded in 00:00:00.829 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.657
