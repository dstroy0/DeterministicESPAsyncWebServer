...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:05.690 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.661 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.668 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.659 |
...
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.018 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.591 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.620 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.598 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.628 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.601 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.735 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:00.981 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.673 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.678 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.772 |
| `test_ssh_auth`          | `native_ssh`            |    18 |   ✅   | 00:00:00.598 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.877 |
| `test_ssh_transport`     | `native_ssh`            |    27 |   ✅   | 00:00:01.095 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.556 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.895 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.269 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.147 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.605 |
...
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.620 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.610 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.625 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.611 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.585 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.610 |
...
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.202 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.177 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.707 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.520 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:02.077 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.835 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.777 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.755 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.676 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.688 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.727 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.655 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.669 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.663 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.676 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.666 |
| `test_preempt_queue`     | `native_preempt_queue`  |     7 |   ✅   | 00:00:00.688 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.747 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.703 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.673 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.679 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.675 |
...
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.721 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.665 |
...
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.664 |
...
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.689 |
...
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.661 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.713 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.901 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.682 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.682 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.681 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.699 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.695 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.720 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.088 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.078 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.715 |
| `test_jwt`               | `native_jwt`            |    16 |   ✅   | 00:00:00.718 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.158 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.673 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.680 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.679 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.698 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.717 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.693 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.677 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.715 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.055 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.670 |
...
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.691 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.693 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.702 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.693 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.680 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.668 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.662 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.692 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.787 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.655 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.784 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.264 |
...
------------ native_canopen:test_canopen [PASSED] Took 5.69 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:05.690
================= 17 test cases: 17 succeeded in 00:00:05.690 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 130 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.661
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.659
...
------------------ native:test_sse [PASSED] Took 1.02 seconds ------------------
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.018
native         test_session       PASSED    00:00:00.591
native         test_presentation  PASSED    00:00:00.620
native         test_transport     PASSED    00:00:00.598
native         test_websocket     PASSED    00:00:00.628
native         test_http_parser   PASSED    00:00:00.601
================ 321 test cases: 321 succeeded in 00:00:04.057 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 130 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.981
================= 10 test cases: 10 succeeded in 00:00:00.981 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 130 tests
...
----------- native_ssh:test_ssh_transport [PASSED] Took 1.09 seconds -----------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.772
native_ssh     test_ssh_auth       PASSED    00:00:00.598
native_ssh     test_ssh_server     PASSED    00:00:00.877
native_ssh     test_ssh_transport  PASSED    00:00:01.095
native_ssh     test_ssh_channel    PASSED    00:00:00.556
================ 120 test cases: 120 succeeded in 00:00:06.899 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 130 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.895
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.147
native_app     test_template          PASSED    00:00:00.605
...
native_app     test_response_headers  PASSED    00:00:00.620
native_app     test_middleware        PASSED    00:00:00.610
native_app     test_digest_auth       PASSED    00:00:00.625
native_app     test_web_terminal      PASSED    00:00:00.611
native_app     test_defer             PASSED    00:00:00.585
native_app     test_multipart         PASSED    00:00:00.610
...
================ 225 test cases: 225 succeeded in 00:00:11.479 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 130 tests
...
================= 12 test cases: 12 succeeded in 00:00:01.202 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 130 tests
...
================= 35 test cases: 35 succeeded in 00:00:01.227 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 130 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:02.077
================= 15 test cases: 15 succeeded in 00:00:02.077 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 130 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.777
================= 41 test cases: 41 succeeded in 00:00:00.777 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 130 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.755
================= 41 test cases: 41 succeeded in 00:00:00.755 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 130 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.727
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.663
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.676
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.747
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.673
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.679
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.675
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.721
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.665
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.664
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.689
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.705
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.661
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.682
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.682
================= 32 test cases: 32 succeeded in 00:00:00.682 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 130 tests
...
================= 38 test cases: 38 succeeded in 00:00:00.695 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 130 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.720
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.078
================= 13 test cases: 13 succeeded in 00:00:01.078 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 130 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.715
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.718
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.673
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.679
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.693
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.677
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.055
================= 71 test cases: 71 succeeded in 00:00:01.055 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 130 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.670
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.691
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.702
================= 17 test cases: 17 succeeded in 00:00:00.702 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 130 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.668
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.692
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.655
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.784
================== 2 test cases: 2 succeeded in 00:00:00.784 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 130 tests
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.264
