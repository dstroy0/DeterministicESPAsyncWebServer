...
| :------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`           | `native`              |    37 |   ✅   | 00:00:08.235 |
| `test_session`       | `native`              |    19 |   ✅   | 00:00:00.378 |
| `test_presentation`  | `native`              |    63 |   ✅   | 00:00:00.399 |
| `test_transport`     | `native`              |    28 |   ✅   | 00:00:00.387 |
| `test_websocket`     | `native`              |    63 |   ✅   | 00:00:00.405 |
| `test_http_parser`   | `native`              |    80 |   ✅   | 00:00:00.406 |
| `test_ssh_crypto`    | `native_ssh`          |    37 |   ✅   | 00:00:02.860 |
| `test_ssh_auth`      | `native_ssh`          |    12 |   ✅   | 00:00:00.399 |
| `test_ssh_server`    | `native_ssh`          |     7 |   ✅   | 00:00:00.501 |
| `test_ssh_transport` | `native_ssh`          |    23 |   ✅   | 00:00:00.781 |
| `test_ssh_channel`   | `native_ssh`          |    12 |   ✅   | 00:00:00.374 |
| `test_ssh_hardening` | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.626 |
| `test_ssh_conn`      | `native_ssh_conn`     |     2 |   ✅   | 00:00:00.836 |
| `test_multipart`     | `native_app`          |    19 |   ✅   | 00:00:00.650 |
| `test_auth`          | `native_app`          |    13 |   ✅   | 00:00:00.388 |
| `test_file_serving`  | `native_app`          |    12 |   ✅   | 00:00:00.394 |
| `test_dispatch`      | `native_app`          |    10 |   ✅   | 00:00:00.394 |
| `test_application`   | `native_app`          |    44 |   ✅   | 00:00:00.603 |
| `test_compliance`    | `native_compliance`   |    12 |   ✅   | 00:00:00.494 |
...
------------------ native:test_sse [PASSED] Took 8.24 seconds ------------------
...
---------------- native:test_session [PASSED] Took 0.38 seconds ----------------
...
--------------- native:test_websocket [PASSED] Took 0.40 seconds ---------------
...
-------------- native:test_http_parser [PASSED] Took 0.41 seconds --------------
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 2.86 seconds -------------
...
----------- native_ssh:test_ssh_transport [PASSED] Took 0.78 seconds -----------
...
------------ native_ssh:test_ssh_channel [PASSED] Took 0.37 seconds ------------
...
------ native_ssh_hardened:test_ssh_hardening [PASSED] Took 0.63 seconds -------
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 0.84 seconds -----------
...
-------------------  ------------------  --------  ------------
native               test_sse            PASSED    00:00:08.235
native               test_session        PASSED    00:00:00.378
native               test_presentation   PASSED    00:00:00.399
native               test_transport      PASSED    00:00:00.387
native               test_websocket      PASSED    00:00:00.405
native               test_http_parser    PASSED    00:00:00.406
native_ssh           test_ssh_crypto     PASSED    00:00:02.860
native_ssh           test_ssh_auth       PASSED    00:00:00.399
native_ssh           test_ssh_server     PASSED    00:00:00.501
native_ssh           test_ssh_transport  PASSED    00:00:00.781
native_ssh           test_ssh_channel    PASSED    00:00:00.374
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.626
native_ssh_conn      test_ssh_conn       PASSED    00:00:00.836
native_app           test_multipart      PASSED    00:00:00.650
native_app           test_auth           PASSED    00:00:00.388
native_app           test_file_serving   PASSED    00:00:00.394
native_app           test_dispatch       PASSED    00:00:00.394
native_app           test_application    PASSED    00:00:00.603
native_compliance    test_compliance     PASSED    00:00:00.494
================ 495 test cases: 495 succeeded in 00:00:19.510 ================
```
