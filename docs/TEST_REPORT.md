...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:06.351 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.517 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.556 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.538 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.561 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.524 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.800 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.540 |
...
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.832 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.202 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:01.043 |
...
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.535 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.541 |
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.499 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.545 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.542 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.543 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.539 |
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.518 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.552 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.548 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.556 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.551 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.540 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.636 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.612 |
| `test_workers`          | `native_workers`      |     3 |   ✅   | 00:00:00.688 |
| `test_concurrency`      | `native_tsan`         |     2 |   ✅   | 00:00:01.071 |
...
------------------ native:test_sse [PASSED] Took 6.35 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:06.351
native               test_session           PASSED    00:00:00.517
native               test_presentation      PASSED    00:00:00.556
...
native_ssh           test_ssh_crypto        PASSED    00:00:03.800
native_ssh           test_ssh_auth          PASSED    00:00:00.540
...
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.832
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.202
native_app           test_regex             PASSED    00:00:01.043
...
native_app           test_form_params       PASSED    00:00:00.535
native_app           test_iface             PASSED    00:00:00.541
native_app           test_json              PASSED    00:00:00.499
native_app           test_response_headers  PASSED    00:00:00.545
native_app           test_middleware        PASSED    00:00:00.542
native_app           test_digest_auth       PASSED    00:00:00.543
native_app           test_web_terminal      PASSED    00:00:00.539
native_app           test_defer             PASSED    00:00:00.518
native_app           test_multipart         PASSED    00:00:00.552
native_app           test_auth              PASSED    00:00:00.548
native_app           test_file_serving      PASSED    00:00:00.556
native_app           test_dispatch          PASSED    00:00:00.551
native_app           test_chunked           PASSED    00:00:00.540
native_app           test_application       PASSED    00:00:00.636
native_compliance    test_compliance        PASSED    00:00:00.612
native_workers       test_workers           PASSED    00:00:00.688
native_tsan          test_concurrency       PASSED    00:00:01.071
================ 619 test cases: 619 succeeded in 00:00:30.067 ================
```
