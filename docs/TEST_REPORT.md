...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:07.035 |
...
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.473 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:04.200 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.623 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.643 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.919 |
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.463 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.734 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.095 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.943 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.506 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.494 |
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.439 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.493 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.490 |
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.446 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.490 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.496 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.494 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.490 |
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.472 |
...
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.486 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.484 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.582 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.547 |
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:07.035
...
native               test_http_parser       PASSED    00:00:00.473
native_ssh           test_ssh_crypto        PASSED    00:00:04.200
native_ssh           test_ssh_auth          PASSED    00:00:00.623
native_ssh           test_ssh_server        PASSED    00:00:00.643
native_ssh           test_ssh_transport     PASSED    00:00:00.919
native_ssh           test_ssh_channel       PASSED    00:00:00.463
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.734
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.095
native_app           test_regex             PASSED    00:00:00.943
native_app           test_template          PASSED    00:00:00.506
native_app           test_path_params       PASSED    00:00:00.494
native_app           test_digest_vectors    PASSED    00:00:00.439
native_app           test_form_params       PASSED    00:00:00.493
native_app           test_iface             PASSED    00:00:00.490
native_app           test_json              PASSED    00:00:00.446
native_app           test_response_headers  PASSED    00:00:00.490
native_app           test_middleware        PASSED    00:00:00.496
native_app           test_digest_auth       PASSED    00:00:00.494
native_app           test_web_terminal      PASSED    00:00:00.490
native_app           test_defer             PASSED    00:00:00.472
