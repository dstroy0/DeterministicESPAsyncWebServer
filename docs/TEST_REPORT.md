...
**Generated:** 2026-07-05 06:47:01
**Command:** `pio test` over 137 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 2089 passed - 263s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:05.806 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.628 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.641 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.646 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:04.397 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.635 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.643 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.647 |
...
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.639 |
...
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:01.015 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.685 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.663 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.945 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.633 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.834 |
| `test_ssh_transport`     | `native_ssh`            |    31 |   ✅   | 00:00:01.133 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.568 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.955 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.333 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.164 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.596 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.600 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.547 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.594 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.603 |
...
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.618 |
...
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.786 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.764 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.763 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.679 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.658 |
...
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.670 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.658 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.686 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.740 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.818 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.762 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.651 |
...
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.657 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.643 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.643 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.675 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.657 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.668 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.662 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.715 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.678 |
...
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.685 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.658 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.667 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.664 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.665 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.666 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.679 |
...
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.933 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.695 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.699 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.673 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.719 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.729 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.725 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.140 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.162 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.694 |
| `test_smtp`              | `native_smtp`           |    11 |   ✅   | 00:00:00.807 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.679 |
| `test_dns_server`        | `native_dns_server`     |     7 |   ✅   | 00:00:00.689 |
| `test_rtc`               | `native_rtc`            |     8 |   ✅   | 00:00:00.686 |
| `test_ld2410`            | `native_ld2410`         |     7 |   ✅   | 00:00:00.682 |
| `test_mpr121`            | `native_mpr121`         |     5 |   ✅   | 00:00:00.690 |
| `test_sht3x`             | `native_sht3x`          |     5 |   ✅   | 00:00:00.699 |
| `test_pca9685`           | `native_pca9685`        |     4 |   ✅   | 00:00:00.693 |
| `test_ads1115`           | `native_ads1115`        |     3 |   ✅   | 00:00:00.695 |
| `test_ina219`            | `native_ina219`         |     4 |   ✅   | 00:00:00.685 |
| `test_hpack`             | `native_hpack`          |     7 |   ✅   | 00:00:00.770 |
| `test_h2_frame`          | `native_h2frame`        |     6 |   ✅   | 00:00:00.676 |
| `test_h2_conn`           | `native_h2conn`         |     4 |   ✅   | 00:00:00.915 |
| `test_quic_varint`       | `native_quic_varint`    |     3 |   ✅   | 00:00:00.681 |
| `test_h3_frame`          | `native_h3frame`        |     4 |   ✅   | 00:00:00.696 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.749 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.179 |
...
------------ native_canopen:test_canopen [PASSED] Took 5.81 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:05.806
================= 17 test cases: 17 succeeded in 00:00:05.806 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 162 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.628
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.641
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:04.397
================= 16 test cases: 16 succeeded in 00:00:04.397 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 162 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.635
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.643
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.647
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.639
...
================ 323 test cases: 323 succeeded in 00:00:03.993 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 162 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.685
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.945
native_ssh     test_ssh_auth       PASSED    00:00:00.633
native_ssh     test_ssh_server     PASSED    00:00:00.834
native_ssh     test_ssh_transport  PASSED    00:00:01.133
native_ssh     test_ssh_channel    PASSED    00:00:00.568
================ 137 test cases: 137 succeeded in 00:00:07.112 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 162 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.955
================== 2 test cases: 2 succeeded in 00:00:00.955 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 162 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.333
================== 2 test cases: 2 succeeded in 00:00:01.333 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 162 tests
...
native_app     test_multipart         PASSED    00:00:00.618
...
================ 225 test cases: 225 succeeded in 00:00:11.482 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 162 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.786
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.764
...
================= 41 test cases: 41 succeeded in 00:00:00.763 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 162 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.670
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.740
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.762
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.651
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.657
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.675
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.657
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.662
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.678
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.685
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.665
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.666
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.679
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.933
================= 17 test cases: 17 succeeded in 00:00:00.933 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 162 tests
...
================= 32 test cases: 32 succeeded in 00:00:00.699 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 162 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.719
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.162
================= 13 test cases: 13 succeeded in 00:00:01.162 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 162 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_smtp    test_smtp  PASSED    00:00:00.807
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_ntp_server  test_ntp_server  PASSED    00:00:00.679
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_rtc     test_rtc  PASSED    00:00:00.686
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sht3x   test_sht3x  PASSED    00:00:00.699
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ina219  test_ina219  PASSED    00:00:00.685
...
Environment    Test          Status    Duration
-------------  ------------  --------  ------------
native_h2conn  test_h2_conn  PASSED    00:00:00.915
================== 4 test cases: 4 succeeded in 00:00:00.915 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 162 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_varint  test_quic_varint  PASSED    00:00:00.681
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.749
================= 21 test cases: 21 succeeded in 00:00:00.749 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 162 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.179
================== 3 test cases: 3 succeeded in 00:00:01.179 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 162 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.722
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.119
================= 71 test cases: 71 succeeded in 00:00:01.119 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 162 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.711
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.693
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.678
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_statsd  test_statsd  PASSED    00:00:00.694
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.694
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.824
================== 3 test cases: 3 succeeded in 00:00:00.824 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 162 tests
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.153
================== 2 test cases: 2 succeeded in 00:00:01.153 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 162 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_qpack   test_qpack  PASSED    00:00:00.791
