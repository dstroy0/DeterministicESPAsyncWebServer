...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:07.369 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.617 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.679 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.634 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.666 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.613 |
| `test_ssh_crypto`       | `native_ssh`          |    38 |   ✅   | 00:00:03.904 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.626 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.733 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.942 |
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.642 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.971 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.336 |
...
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.578 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.638 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.650 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.650 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.638 |
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.621 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.644 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.645 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.725 |
| `test_dispatch`         | `native_app`          |    11 |   ✅   | 00:00:00.641 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.663 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.736 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.709 |
...
------------------ native:test_sse [PASSED] Took 7.37 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:07.369
native               test_session           PASSED    00:00:00.617
native               test_presentation      PASSED    00:00:00.679
...
native_ssh           test_ssh_auth          PASSED    00:00:00.626
native_ssh           test_ssh_server        PASSED    00:00:00.733
native_ssh           test_ssh_transport     PASSED    00:00:00.942
native_ssh           test_ssh_channel       PASSED    00:00:00.642
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.971
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.336
...
native_app           test_file_serving      PASSED    00:00:00.725
native_app           test_dispatch          PASSED    00:00:00.641
native_app           test_chunked           PASSED    00:00:00.663
...
================ 621 test cases: 621 succeeded in 00:00:34.773 ================
```
