...
**Generated:** 2026-07-05 01:04:55
**Command:** `pio test` over 132 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 2066 passed - 250s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:06.231 |
...
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:04.418 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.656 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.671 |
...
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.665 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.684 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.650 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.642 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.656 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.673 |
...
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.974 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.661 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.856 |
| `test_ssh_transport`     | `native_ssh`            |    31 |   ✅   | 00:00:01.151 |
...
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.213 |
...
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.714 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.243 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.203 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.714 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.522 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:01.990 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.821 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.791 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.782 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.680 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.667 |
...
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.661 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.648 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.674 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.760 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.818 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.742 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.657 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.644 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.663 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.643 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.638 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.650 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.656 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.639 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.670 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.658 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.643 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.655 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.665 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.671 |
...
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.656 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.654 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.671 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.659 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.677 |
...
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.672 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.698 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.704 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.673 |
...
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.678 |
...
| `test_statsd`            | `native_statsd`         |     9 |   ✅   | 00:00:00.693 |
...
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.646 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.787 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.358 |
...
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.231
================= 17 test cases: 17 succeeded in 00:00:06.231 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 157 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:04.418
================= 16 test cases: 16 succeeded in 00:00:04.418 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 157 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.656
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.671
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.665
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.650
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.642
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.673
...
================ 323 test cases: 323 succeeded in 00:00:04.083 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 157 tests
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 3.97 seconds -------------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.974
...
================ 137 test cases: 137 succeeded in 00:00:07.246 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 157 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.213
...
native_app     test_application       PASSED    00:00:00.714
================ 225 test cases: 225 succeeded in 00:00:11.946 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 157 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.243
================= 12 test cases: 12 succeeded in 00:00:01.243 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 157 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.203
...
================= 35 test cases: 35 succeeded in 00:00:01.235 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 157 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.990
================= 15 test cases: 15 succeeded in 00:00:01.990 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 157 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.791
================= 41 test cases: 41 succeeded in 00:00:00.791 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 157 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.680
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.661
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.674
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.760
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.742
...
-------------- native_nrf24:test_nrf24 [PASSED] Took 0.64 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.644
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_pn532   test_pn532  PASSED    00:00:00.643
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.639
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.670
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.658
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.671
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.656
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.654
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.659
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.677
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.114
================= 13 test cases: 13 succeeded in 00:00:01.114 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 157 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.664
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_dns_server  test_dns_server  PASSED    00:00:00.660
================== 7 test cases: 7 succeeded in 00:00:00.660 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 157 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sht3x   test_sht3x  PASSED    00:00:00.668
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ina219  test_ina219  PASSED    00:00:00.647
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_hpack   test_hpack  PASSED    00:00:00.741
...
================= 21 test cases: 21 succeeded in 00:00:00.713 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 157 tests
...
================= 22 test cases: 22 succeeded in 00:00:00.672 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 157 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.704
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.678
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_statsd  test_statsd  PASSED    00:00:00.693
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.646
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.358
================== 2 test cases: 2 succeeded in 00:00:01.358 ==================
```
