...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:16.397 |
...
| `test_ssh_crypto`       | `native_ssh`          |    38 |   ✅   | 00:00:03.841 |
...
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.567 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.578 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.572 |
...
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.566 |
...
----------------- native:test_sse [PASSED] Took 16.40 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:16.397
...
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.846
...
native_app           test_path_params       PASSED    00:00:00.561
native_app           test_digest_vectors    PASSED    00:00:00.518
native_app           test_form_params       PASSED    00:00:00.560
native_app           test_iface             PASSED    00:00:00.563
native_app           test_json              PASSED    00:00:00.524
native_app           test_response_headers  PASSED    00:00:00.567
...
native_tsan          test_concurrency       PASSED    00:00:01.524
================ 621 test cases: 621 succeeded in 00:00:41.429 ================
```
