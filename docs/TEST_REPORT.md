...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:06.117 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.390 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.406 |
| `test_transport`        | `native`              |    34 |   ✅   | 00:00:00.392 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.419 |
| `test_http_parser`      | `native`              |    80 |   ✅   | 00:00:00.423 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:02.854 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.422 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.513 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.895 |
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.403 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.641 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:00.858 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.725 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.414 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.399 |
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.380 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.405 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.412 |
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.391 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.413 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.401 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.403 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.400 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.408 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.411 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.424 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.409 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.400 |
| `test_application`      | `native_app`          |    49 |   ✅   | 00:00:00.482 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.496 |
...
------------------ native:test_sse [PASSED] Took 6.12 seconds ------------------
...
------------- native:test_presentation [PASSED] Took 0.41 seconds --------------
...
--------------- native:test_websocket [PASSED] Took 0.42 seconds ---------------
...
-------------- native:test_http_parser [PASSED] Took 0.42 seconds --------------
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 2.85 seconds -------------
...
------------- native_ssh:test_ssh_auth [PASSED] Took 0.42 seconds --------------
...
------------ native_ssh:test_ssh_server [PASSED] Took 0.51 seconds -------------
...
------ native_ssh_hardened:test_ssh_hardening [PASSED] Took 0.64 seconds -------
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 0.86 seconds -----------
...
--------------- native_app:test_regex [PASSED] Took 0.72 seconds ---------------
...
------------- native_app:test_template [PASSED] Took 0.41 seconds --------------
...
------------ native_app:test_path_params [PASSED] Took 0.40 seconds ------------
...
---------- native_app:test_digest_vectors [PASSED] Took 0.38 seconds -----------
...
------------ native_app:test_form_params [PASSED] Took 0.41 seconds ------------
...
--------------- native_app:test_iface [PASSED] Took 0.41 seconds ---------------
...
--------------- native_app:test_json [PASSED] Took 0.39 seconds ----------------
...
--------- native_app:test_response_headers [PASSED] Took 0.41 seconds ----------
...
------------ native_app:test_middleware [PASSED] Took 0.40 seconds -------------
...
------------ native_app:test_digest_auth [PASSED] Took 0.40 seconds ------------
...
----------- native_app:test_web_terminal [PASSED] Took 0.40 seconds ------------
...
------------- native_app:test_multipart [PASSED] Took 0.41 seconds -------------
...
--------------- native_app:test_auth [PASSED] Took 0.41 seconds ----------------
...
----------- native_app:test_file_serving [PASSED] Took 0.42 seconds ------------
...
------------- native_app:test_dispatch [PASSED] Took 0.41 seconds --------------
...
-------------- native_app:test_chunked [PASSED] Took 0.40 seconds --------------
...
------------ native_app:test_application [PASSED] Took 0.48 seconds ------------
...
--------- native_compliance:test_compliance [PASSED] Took 0.50 seconds ---------

=================================== SUMMARY ===================================
Environment          Test                   Status    Duration
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:06.117
native               test_session           PASSED    00:00:00.390
native               test_presentation      PASSED    00:00:00.406
native               test_transport         PASSED    00:00:00.392
native               test_websocket         PASSED    00:00:00.419
native               test_http_parser       PASSED    00:00:00.423
native_ssh           test_ssh_crypto        PASSED    00:00:02.854
native_ssh           test_ssh_auth          PASSED    00:00:00.422
native_ssh           test_ssh_server        PASSED    00:00:00.513
native_ssh           test_ssh_transport     PASSED    00:00:00.895
native_ssh           test_ssh_channel       PASSED    00:00:00.403
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.641
native_ssh_conn      test_ssh_conn          PASSED    00:00:00.858
native_app           test_regex             PASSED    00:00:00.725
native_app           test_template          PASSED    00:00:00.414
native_app           test_path_params       PASSED    00:00:00.399
native_app           test_digest_vectors    PASSED    00:00:00.380
native_app           test_form_params       PASSED    00:00:00.405
native_app           test_iface             PASSED    00:00:00.412
native_app           test_json              PASSED    00:00:00.391
native_app           test_response_headers  PASSED    00:00:00.413
native_app           test_middleware        PASSED    00:00:00.401
native_app           test_digest_auth       PASSED    00:00:00.403
native_app           test_web_terminal      PASSED    00:00:00.400
native_app           test_multipart         PASSED    00:00:00.408
native_app           test_auth              PASSED    00:00:00.411
native_app           test_file_serving      PASSED    00:00:00.424
native_app           test_dispatch          PASSED    00:00:00.409
native_app           test_chunked           PASSED    00:00:00.400
native_app           test_application       PASSED    00:00:00.482
native_compliance    test_compliance        PASSED    00:00:00.496
================ 600 test cases: 600 succeeded in 00:00:22.505 ================
```
