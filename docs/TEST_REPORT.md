...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    11 |   ✅   | 00:00:10.730 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.654 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.657 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.669 |
| `test_mbus`              | `native_mbus`           |     8 |   ✅   | 00:00:00.667 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.690 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.696 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.710 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.720 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.687 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.152 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.587 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.603 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.585 |
...
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:01.120 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.712 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.730 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:04.077 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.574 |
| `test_ssh_server`        | `native_ssh`            |    10 |   ✅   | 00:00:00.685 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.907 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.562 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.041 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.572 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.435 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.640 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.636 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.554 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.604 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.596 |
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.551 |
...
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.373 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.325 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.765 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.517 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.589 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.863 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.920 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.796 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.714 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.671 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.753 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.662 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.655 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.668 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.658 |
| `test_protobuf`          | `native_protobuf`       |    10 |   ✅   | 00:00:00.654 |
| `test_preempt_queue`     | `native_preempt_queue`  |     7 |   ✅   | 00:00:00.722 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.684 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.652 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.629 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.651 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.656 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.668 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.661 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.652 |
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.757 |
...
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.645 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.652 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.663 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.653 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.665 |
...
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.653 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.674 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.662 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.666 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.659 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.679 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.958 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.664 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.658 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.669 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.682 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.710 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.701 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.248 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.247 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.690 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.773 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.303 |
| `test_http_client`       | `native_http_client`    |    11 |   ✅   | 00:00:00.695 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.680 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.694 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.751 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.718 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.703 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.693 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.730 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.226 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.670 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.692 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.688 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.675 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.701 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.664 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.658 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.657 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.665 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.679 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.673 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.653 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.662 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.675 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.667 |
...
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.110 |
...
----------- native_canopen:test_canopen [PASSED] Took 10.73 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:10.730
================= 11 test cases: 11 succeeded in 00:00:10.730 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.654
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.667
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.696
...
---------------- native_dmx:test_dmx [PASSED] Took 0.71 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.710
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.720
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.687
...
native         test_transport     PASSED    00:00:00.585
native         test_websocket     PASSED    00:00:00.622
native         test_http_parser   PASSED    00:00:00.576
================ 318 test cases: 318 succeeded in 00:00:04.124 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.120
================= 10 test cases: 10 succeeded in 00:00:01.120 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.077
native_ssh     test_ssh_auth       PASSED    00:00:00.574
native_ssh     test_ssh_server     PASSED    00:00:00.685
native_ssh     test_ssh_transport  PASSED    00:00:00.907
native_ssh     test_ssh_channel    PASSED    00:00:00.562
================ 104 test cases: 104 succeeded in 00:00:06.804 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------ native_ssh_hardened:test_ssh_hardening [PASSED] Took 1.04 seconds -------

=================================== SUMMARY ===================================
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:01.041
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 1.57 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.572
...
--------------- native_app:test_regex [PASSED] Took 1.43 seconds ---------------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.435
native_app     test_template          PASSED    00:00:00.640
native_app     test_path_params       PASSED    00:00:00.636
native_app     test_digest_vectors    PASSED    00:00:00.554
native_app     test_form_params       PASSED    00:00:00.604
native_app     test_iface             PASSED    00:00:00.596
native_app     test_json              PASSED    00:00:00.551
...
native_app     test_web_terminal      PASSED    00:00:00.590
...
native_app     test_file_serving      PASSED    00:00:00.605
...
================ 219 test cases: 219 succeeded in 00:00:11.656 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.373
================= 12 test cases: 12 succeeded in 00:00:01.373 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.325
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.765
native_snmp    test_snmp_agent  PASSED    00:00:00.517
================= 30 test cases: 30 succeeded in 00:00:01.282 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 1.59 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.589
================= 10 test cases: 10 succeeded in 00:00:01.589 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.863
================== 8 test cases: 8 succeeded in 00:00:00.863 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.920
================= 29 test cases: 29 succeeded in 00:00:00.920 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.796
================= 29 test cases: 29 succeeded in 00:00:00.796 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.714
================= 19 test cases: 19 succeeded in 00:00:00.714 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.662
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.658
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.722
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.629
================== 6 test cases: 6 succeeded in 00:00:00.629 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.668
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.757
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.653
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.662
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.958
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.669
...
================= 29 test cases: 29 succeeded in 00:00:00.710 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.248
================= 10 test cases: 10 succeeded in 00:00:01.248 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.247
================= 13 test cases: 13 succeeded in 00:00:01.247 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.690
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.773
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.303
================== 3 test cases: 3 succeeded in 00:00:01.303 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.694
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.730
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.226
================= 71 test cases: 71 succeeded in 00:00:01.226 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.692
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.664
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.673
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.653
================== 8 test cases: 8 succeeded in 00:00:00.653 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.667
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 1.11 seconds ------------

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.110
================== 2 test cases: 2 succeeded in 00:00:01.110 ==================
```
