...
**Generated:** 2026-06-29 18:58:28
**Command:** `pio test` over 85 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1434 passed - 146s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:06.604 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.640 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.690 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.656 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.707 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.620 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.779 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.712 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.756 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.948 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.629 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.763 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.987 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.605 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.975 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.423 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.301 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.673 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.660 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.617 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.693 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.664 |
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.631 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.680 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.664 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.682 |
...
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.695 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.670 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.703 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.766 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.294 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.256 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.755 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.559 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.537 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.891 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.867 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.834 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.777 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.704 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.751 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.666 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.675 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.677 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.668 |
| `test_protobuf`          | `native_protobuf`       |     8 |   ✅   | 00:00:00.666 |
| `test_wamp`              | `native_wamp`           |    11 |   ✅   | 00:00:00.719 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.723 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.678 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.670 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.660 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |     7 |   ✅   | 00:00:00.661 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.664 |
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.722 |
...
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.667 |
...
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.890 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.678 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.663 |
...
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.113 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.696 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.717 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.154 |
| `test_http_client`       | `native_http_client`    |    10 |   ✅   | 00:00:00.657 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.676 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.667 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.689 |
...
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.649 |
...
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.354 |
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.604
native         test_session       PASSED    00:00:00.640
native         test_presentation  PASSED    00:00:00.690
...
================ 318 test cases: 318 succeeded in 00:00:09.918 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 110 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.779
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.756
...
------------ native_ssh:test_ssh_server [PASSED] Took 0.76 seconds -------------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.948
native_ssh     test_ssh_auth       PASSED    00:00:00.629
native_ssh     test_ssh_server     PASSED    00:00:00.763
native_ssh     test_ssh_transport  PASSED    00:00:00.987
native_ssh     test_ssh_channel    PASSED    00:00:00.605
================= 93 test cases: 93 succeeded in 00:00:06.932 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 110 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.975
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.423
...
native_app     test_template          PASSED    00:00:00.673
native_app     test_path_params       PASSED    00:00:00.660
native_app     test_digest_vectors    PASSED    00:00:00.617
native_app     test_form_params       PASSED    00:00:00.693
native_app     test_iface             PASSED    00:00:00.664
native_app     test_json              PASSED    00:00:00.631
native_app     test_response_headers  PASSED    00:00:00.680
native_app     test_middleware        PASSED    00:00:00.664
native_app     test_digest_auth       PASSED    00:00:00.682
...
native_app     test_file_serving      PASSED    00:00:00.695
native_app     test_dispatch          PASSED    00:00:00.670
native_app     test_chunked           PASSED    00:00:00.703
native_app     test_application       PASSED    00:00:00.766
================ 219 test cases: 219 succeeded in 00:00:12.800 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 110 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.294
================= 12 test cases: 12 succeeded in 00:00:01.294 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 110 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.256
...
================= 29 test cases: 29 succeeded in 00:00:01.315 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 110 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.891
================== 8 test cases: 8 succeeded in 00:00:00.891 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 110 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.867
================= 29 test cases: 29 succeeded in 00:00:00.867 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 110 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.834
================= 29 test cases: 29 succeeded in 00:00:00.834 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 110 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.751
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.723
...
test/test_hostlink/test_hostlink.cpp:30: test_build_dm_read: Expected '@00RD0000001057*\r' Was '@00RD0000001057*\r\xA5G\xF7\xFC\x7F' [FAILED]
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  ERRORED   00:00:00.652

============= 8 test cases: 1 failed, 6 succeeded in 00:00:00.652 =============
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 110 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.722
...
================= 13 test cases: 13 succeeded in 00:00:00.890 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 110 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.113
================= 13 test cases: 13 succeeded in 00:00:01.113 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 110 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.154
================== 3 test cases: 3 succeeded in 00:00:01.154 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 110 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.649
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.705
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.634
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.665
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.656
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.354
================== 2 test cases: 2 succeeded in 00:00:01.354 ==================
```
