...
| :------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`           | `native`              |    37 |   ✅   | 00:00:05.857 |
| `test_session`       | `native`              |    19 |   ✅   | 00:00:00.388 |
| `test_presentation`  | `native`              |    63 |   ✅   | 00:00:00.398 |
| `test_transport`     | `native`              |    28 |   ✅   | 00:00:00.386 |
| `test_websocket`     | `native`              |    63 |   ✅   | 00:00:00.405 |
| `test_http_parser`   | `native`              |    80 |   ✅   | 00:00:00.403 |
| `test_ssh_crypto`    | `native_ssh`          |    37 |   ✅   | 00:00:02.849 |
| `test_ssh_auth`      | `native_ssh`          |    12 |   ✅   | 00:00:00.407 |
| `test_ssh_server`    | `native_ssh`          |     7 |   ✅   | 00:00:00.520 |
| `test_ssh_transport` | `native_ssh`          |    23 |   ✅   | 00:00:00.699 |
| `test_ssh_channel`   | `native_ssh`          |    12 |   ✅   | 00:00:00.384 |
| `test_ssh_hardening` | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.623 |
| `test_ssh_conn`      | `native_ssh_conn`     |     2 |   ✅   | 00:00:00.849 |
| `test_multipart`     | `native_app`          |    19 |   ✅   | 00:00:00.915 |
| `test_auth`          | `native_app`          |    13 |   ✅   | 00:00:00.606 |
| `test_file_serving`  | `native_app`          |    12 |   ✅   | 00:00:00.571 |
| `test_dispatch`      | `native_app`          |    10 |   ✅   | 00:00:00.484 |
| `test_application`   | `native_app`          |    47 |   ✅   | 00:00:00.468 |
| `test_compliance`    | `native_compliance`   |    12 |   ✅   | 00:00:00.495 |
...
------------------ native:test_sse [PASSED] Took 5.86 seconds ------------------
...
----------- native_ssh:test_ssh_transport [PASSED] Took 0.70 seconds -----------
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 0.85 seconds -----------
...
------------- native_app:test_multipart [PASSED] Took 0.92 seconds -------------
...
------------ native_app:test_application [PASSED] Took 0.47 seconds ------------
...
-------------------  ------------------  --------  ------------
native               test_sse            PASSED    00:00:05.857
native               test_session        PASSED    00:00:00.388
native               test_presentation   PASSED    00:00:00.398
native               test_transport      PASSED    00:00:00.386
native               test_websocket      PASSED    00:00:00.405
native               test_http_parser    PASSED    00:00:00.403
native_ssh           test_ssh_crypto     PASSED    00:00:02.849
native_ssh           test_ssh_auth       PASSED    00:00:00.407
native_ssh           test_ssh_server     PASSED    00:00:00.520
native_ssh           test_ssh_transport  PASSED    00:00:00.699
native_ssh           test_ssh_channel    PASSED    00:00:00.384
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.623
native_ssh_conn      test_ssh_conn       PASSED    00:00:00.849
native_app           test_multipart      PASSED    00:00:00.915
native_app           test_auth           PASSED    00:00:00.606
native_app           test_file_serving   PASSED    00:00:00.571
native_app           test_dispatch       PASSED    00:00:00.484
native_app           test_application    PASSED    00:00:00.468
native_compliance    test_compliance     PASSED    00:00:00.495
================ 498 test cases: 498 succeeded in 00:00:17.707 ================
```
