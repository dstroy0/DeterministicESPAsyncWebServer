...
**Generated:** 2026-07-04 22:28:45
**Command:** `pio test` over 126 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 2038 passed - 231s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:05.801 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.649 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.648 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.653 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:04.396 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.646 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.645 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.645 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.660 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.657 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.644 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.652 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.653 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.651 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.648 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.649 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.005 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.580 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.612 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.612 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.631 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.593 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.769 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:01.007 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.679 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.668 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.958 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.636 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.839 |
| `test_ssh_transport`     | `native_ssh`            |    31 |   ✅   | 00:00:01.150 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.579 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.940 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.335 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.193 |
...
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.598 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.565 |
...
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.694 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.522 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:01.949 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.785 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.770 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.760 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.671 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.642 |
...
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.642 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.671 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.660 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.704 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.758 |
...
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.668 |
...
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.651 |
...
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.146 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.096 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.665 |
| `test_smtp`              | `native_smtp`           |    11 |   ✅   | 00:00:00.776 |
...
| `test_ld2410`            | `native_ld2410`         |     7 |   ✅   | 00:00:00.645 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.696 |
...
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.657 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.695 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.699 |
...
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.652 |
...
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.649 |
...
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.629 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.774 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.307 |
...
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:05.801
================= 17 test cases: 17 succeeded in 00:00:05.801 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 151 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.648
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:04.396
================= 16 test cases: 16 succeeded in 00:00:04.396 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 151 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.645
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.657
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.652
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.648
...
native         test_presentation  PASSED    00:00:00.612
native         test_transport     PASSED    00:00:00.612
native         test_websocket     PASSED    00:00:00.631
native         test_http_parser   PASSED    00:00:00.593
================ 323 test cases: 323 succeeded in 00:00:04.034 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 151 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.007
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.679
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.958
native_ssh     test_ssh_auth       PASSED    00:00:00.636
native_ssh     test_ssh_server     PASSED    00:00:00.839
native_ssh     test_ssh_transport  PASSED    00:00:01.150
native_ssh     test_ssh_channel    PASSED    00:00:00.579
================ 137 test cases: 137 succeeded in 00:00:07.162 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 151 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.940
================== 2 test cases: 2 succeeded in 00:00:00.940 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 151 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.193
...
native_app     test_iface             PASSED    00:00:00.598
native_app     test_json              PASSED    00:00:00.565
...
================ 225 test cases: 225 succeeded in 00:00:11.504 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 151 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.949
================= 15 test cases: 15 succeeded in 00:00:01.949 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 151 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.785
================= 15 test cases: 15 succeeded in 00:00:00.785 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 151 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.770
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.642
================= 22 test cases: 22 succeeded in 00:00:00.642 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 151 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.704
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.758
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.639
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.633
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.655
================= 13 test cases: 13 succeeded in 00:00:00.655 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 151 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.645
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.648
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.635
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.668
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.651
================== 5 test cases: 5 succeeded in 00:00:00.651 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 151 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.914
================= 17 test cases: 17 succeeded in 00:00:00.914 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 151 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.662
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.146
================= 10 test cases: 10 succeeded in 00:00:01.146 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 151 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_smtp    test_smtp  PASSED    00:00:00.776
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ld2410  test_ld2410  PASSED    00:00:00.645
...
================= 21 test cases: 21 succeeded in 00:00:00.696 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 151 tests
...
================= 22 test cases: 22 succeeded in 00:00:00.657 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 151 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.695
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.699
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.649
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.774
