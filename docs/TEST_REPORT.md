...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:13.622 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.519 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.542 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.524 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.572 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.534 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.805 |
...
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.556 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.578 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.544 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.542 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.653 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.654 |
...
----------------- native:test_sse [PASSED] Took 13.62 seconds ------------------
...
--------------- native_app:test_regex [PASSED] Took 0.96 seconds ---------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:13.622
native               test_session           PASSED    00:00:00.519
native               test_presentation      PASSED    00:00:00.542
native               test_transport         PASSED    00:00:00.524
native               test_websocket         PASSED    00:00:00.572
native               test_http_parser       PASSED    00:00:00.534
native_ssh           test_ssh_crypto        PASSED    00:00:03.805
...
native_app           test_auth              PASSED    00:00:00.556
native_app           test_file_serving      PASSED    00:00:00.578
native_app           test_dispatch          PASSED    00:00:00.544
...
================ 611 test cases: 611 succeeded in 00:00:35.383 ================
```
