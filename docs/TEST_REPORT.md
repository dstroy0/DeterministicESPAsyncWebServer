...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:07.477 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.483 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.516 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.501 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.528 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.518 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.794 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.533 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.635 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.849 |
...
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.908 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.501 |
...
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.494 |
...
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.507 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.500 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.507 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.502 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.518 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.503 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.502 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.593 |
...
------------------ native:test_sse [PASSED] Took 7.48 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:07.477
native               test_session           PASSED    00:00:00.483
native               test_presentation      PASSED    00:00:00.516
native               test_transport         PASSED    00:00:00.501
...
native_ssh           test_ssh_server        PASSED    00:00:00.635
native_ssh           test_ssh_transport     PASSED    00:00:00.849
...
native_app           test_regex             PASSED    00:00:00.908
native_app           test_template          PASSED    00:00:00.501
native_app           test_path_params       PASSED    00:00:00.499
native_app           test_digest_vectors    PASSED    00:00:00.482
native_app           test_form_params       PASSED    00:00:00.497
native_app           test_iface             PASSED    00:00:00.494
...
native_app           test_digest_auth       PASSED    00:00:00.507
...
native_app           test_file_serving      PASSED    00:00:00.518
native_app           test_dispatch          PASSED    00:00:00.503
native_app           test_chunked           PASSED    00:00:00.502
native_app           test_application       PASSED    00:00:00.593
native_compliance    test_compliance        PASSED    00:00:00.632
================ 611 test cases: 611 succeeded in 00:00:27.846 ================
```
