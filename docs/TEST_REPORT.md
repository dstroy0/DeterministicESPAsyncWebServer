...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:15.223 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.568 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.602 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.576 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.604 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.558 |
| `test_ssh_crypto`       | `native_ssh`          |    38 |   ✅   | 00:00:03.896 |
...
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.604 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.604 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.618 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.586 |
...
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.592 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.705 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.669 |
| `test_workers`          | `native_workers`      |     3 |   ✅   | 00:00:00.749 |
| `test_concurrency`      | `native_tsan`         |     2 |   ✅   | 00:00:01.446 |
...
----------------- native:test_sse [PASSED] Took 15.22 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:15.223
native               test_session           PASSED    00:00:00.568
native               test_presentation      PASSED    00:00:00.602
...
native_app           test_regex             PASSED    00:00:01.126
...
native_tsan          test_concurrency       PASSED    00:00:01.446
================ 621 test cases: 621 succeeded in 00:00:41.129 ================
```
