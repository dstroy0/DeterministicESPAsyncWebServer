...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:05.975 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.617 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.605 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.603 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:04.528 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.642 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.633 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.628 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.620 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.646 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.607 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.615 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.624 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.607 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.620 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.621 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:00.962 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.568 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.593 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.594 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.611 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.577 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.734 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:00.976 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.656 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.626 |
| `test_ssh_crypto`        | `native_ssh`            |    45 |   ✅   | 00:00:04.291 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.632 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.911 |
| `test_ssh_transport`     | `native_ssh`            |    33 |   ✅   | 00:00:01.261 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.567 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.958 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.395 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.145 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.584 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.584 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.539 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.604 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.597 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.558 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.619 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.605 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.623 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.601 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.573 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.595 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.592 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.610 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.590 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.596 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.668 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.194 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.168 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.668 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.506 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:02.144 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.804 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.760 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.751 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.666 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.630 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.696 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.609 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.609 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.636 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.633 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.613 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.671 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.710 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.795 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.735 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.645 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.626 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.631 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.615 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.613 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.629 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.615 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.615 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.647 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.611 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.617 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.612 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.606 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.608 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.614 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.613 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.659 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.630 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.636 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.630 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.616 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.619 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.613 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.625 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.624 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.631 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.633 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.661 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.651 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.618 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.636 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.638 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.611 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.625 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.651 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.879 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.628 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.608 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.603 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.656 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.657 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.655 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.058 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.066 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.628 |
| `test_smtp`              | `native_smtp`           |    11 |   ✅   | 00:00:00.728 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.631 |
| `test_dns_server`        | `native_dns_server`     |     7 |   ✅   | 00:00:00.607 |
| `test_rtc`               | `native_rtc`            |     8 |   ✅   | 00:00:01.641 |
| `test_ld2410`            | `native_ld2410`         |     7 |   ✅   | 00:00:00.625 |
| `test_mpr121`            | `native_mpr121`         |     5 |   ✅   | 00:00:00.625 |
| `test_sht3x`             | `native_sht3x`          |     5 |   ✅   | 00:00:00.610 |
| `test_pca9685`           | `native_pca9685`        |     4 |   ✅   | 00:00:00.622 |
| `test_ads1115`           | `native_ads1115`        |     3 |   ✅   | 00:00:00.632 |
| `test_ina219`            | `native_ina219`         |     4 |   ✅   | 00:00:00.627 |
| `test_hpack`             | `native_hpack`          |     7 |   ✅   | 00:00:00.748 |
| `test_h2_frame`          | `native_h2frame`        |     6 |   ✅   | 00:00:00.630 |
| `test_h2_conn`           | `native_h2conn`         |     4 |   ✅   | 00:00:00.868 |
| `test_quic_varint`       | `native_quic_varint`    |     3 |   ✅   | 00:00:00.630 |
| `test_h3_frame`          | `native_h3frame`        |     7 |   ✅   | 00:00:00.629 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.680 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.114 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.636 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.662 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.632 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.651 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.660 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.658 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.632 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.663 |
| `test_ssh_zlib`          | `native_ssh_zlib`       |     9 |   ✅   | 00:00:00.703 |
| `test_ssh_comp`          | `native_ssh_comp`       |     5 |   ✅   | 00:00:00.994 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.044 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.622 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.618 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.646 |
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.637 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.640 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.619 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.626 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.624 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.610 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.619 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.633 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.639 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.621 |
| `test_statsd`            | `native_statsd`         |     9 |   ✅   | 00:00:00.650 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.622 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.626 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.661 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.750 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.609 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.741 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.172 |
| `test_qpack`             | `native_qpack`          |     9 |   ✅   | 00:00:00.744 |
| `test_quic_packet`       | `native_quic_packet`    |     8 |   ✅   | 00:00:00.660 |
| `test_quic_frame`        | `native_quic_frame`     |     8 |   ✅   | 00:00:00.691 |
| `test_quic_crypto`       | `native_quic_crypto`    |     7 |   ✅   | 00:00:00.732 |
| `test_tls13_kdf`         | `native_tls13_kdf`      |     5 |   ✅   | 00:00:00.673 |
| `test_quic_tp`           | `native_quic_tp`        |     7 |   ✅   | 00:00:00.653 |
| `test_tls13_msg`         | `native_tls13_msg`      |     7 |   ✅   | 00:00:00.734 |
| `test_quic_tls`          | `native_quic_tls`       |    11 |   ✅   | 00:00:00.916 |
| `test_quic_conn`         | `native_quic_conn`      |     4 |   ✅   | 00:00:00.976 |
| `test_h3_conn`           | `native_h3_conn`        |    11 |   ✅   | 00:00:00.916 |
| `test_h3_e2e`            | `native_h3_e2e`         |     1 |   ✅   | 00:00:00.978 |
| `test_quic_server`       | `native_quic_server`    |     2 |   ✅   | 00:00:01.010 |
| `test_h3_server`         | `native_h3_server`      |     1 |   ✅   | 00:00:01.504 |
| `test_ssh_chachapoly`    | `native_ssh_chachapoly` |     4 |   ✅   | 00:00:00.648 |
...
------------ native_canopen:test_canopen [PASSED] Took 5.97 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:05.975
================= 17 test cases: 17 succeeded in 00:00:05.975 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
----- native_det_primitives:test_det_primitives [PASSED] Took 0.62 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.617
================== 5 test cases: 5 succeeded in 00:00:00.617 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------- native_det_ip:test_det_ip [PASSED] Took 0.60 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.605
================= 10 test cases: 10 succeeded in 00:00:00.605 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
---------- native_det_arena:test_det_arena [PASSED] Took 0.60 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_det_arena  test_det_arena  PASSED    00:00:00.603
================= 17 test cases: 17 succeeded in 00:00:00.603 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------- native_ssh_ed25519:test_ssh_ed25519 [PASSED] Took 4.53 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:04.528
================= 16 test cases: 16 succeeded in 00:00:04.528 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_promisc:test_promisc [PASSED] Took 0.64 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.642
...
-------- native_bus_capture:test_bus_capture [PASSED] Took 0.63 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.633
================== 5 test cases: 5 succeeded in 00:00:00.633 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------------- native_j1939:test_j1939 [PASSED] Took 0.63 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.628
================== 9 test cases: 9 succeeded in 00:00:00.628 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
---------- native_devicenet:test_devicenet [PASSED] Took 0.62 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.620
...
----------- native_nmea2000:test_nmea2000 [PASSED] Took 0.65 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.646
...
--------------- native_mbus:test_mbus [PASSED] Took 0.61 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.607
================= 11 test cases: 11 succeeded in 00:00:00.607 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.615
================== 8 test cases: 8 succeeded in 00:00:00.615 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------------- native_sdi12:test_sdi12 [PASSED] Took 0.62 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.624
================== 6 test cases: 6 succeeded in 00:00:00.624 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
----------- native_nmea0183:test_nmea0183 [PASSED] Took 0.62 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.620
================== 7 test cases: 7 succeeded in 00:00:00.620 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------- native_iolink:test_iolink [PASSED] Took 0.62 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.621
================== 5 test cases: 5 succeeded in 00:00:00.621 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------- native:test_presentation [PASSED] Took 0.59 seconds --------------
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:00.962
native         test_session       PASSED    00:00:00.568
native         test_presentation  PASSED    00:00:00.593
native         test_transport     PASSED    00:00:00.594
native         test_websocket     PASSED    00:00:00.611
native         test_http_parser   PASSED    00:00:00.577
================ 323 test cases: 323 succeeded in 00:00:03.905 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.734
================= 17 test cases: 17 succeeded in 00:00:00.734 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------- native_accept_gate:test_accept_gate [PASSED] Took 0.98 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.976
================= 13 test cases: 13 succeeded in 00:00:00.976 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.656
================== 3 test cases: 3 succeeded in 00:00:00.656 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.626
================== 5 test cases: 5 succeeded in 00:00:00.626 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 4.29 seconds -------------
...
----------- native_ssh:test_ssh_transport [PASSED] Took 1.26 seconds -----------
...
------------ native_ssh:test_ssh_channel [PASSED] Took 0.57 seconds ------------

=================================== SUMMARY ===================================
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.291
native_ssh     test_ssh_auth       PASSED    00:00:00.632
native_ssh     test_ssh_server     PASSED    00:00:00.911
native_ssh     test_ssh_transport  PASSED    00:00:01.261
native_ssh     test_ssh_channel    PASSED    00:00:00.567
================ 145 test cases: 145 succeeded in 00:00:07.661 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------ native_ssh_hardened:test_ssh_hardening [PASSED] Took 0.96 seconds -------

=================================== SUMMARY ===================================
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.958
================== 2 test cases: 2 succeeded in 00:00:00.958 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 1.39 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.395
================== 2 test cases: 2 succeeded in 00:00:01.395 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
--------------- native_app:test_regex [PASSED] Took 1.15 seconds ---------------
...
------------ native_app:test_digest_auth [PASSED] Took 0.62 seconds ------------
...
--------------- native_app:test_auth [PASSED] Took 0.59 seconds ----------------
...
------------- native_app:test_dispatch [PASSED] Took 0.59 seconds --------------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.145
native_app     test_template          PASSED    00:00:00.584
native_app     test_path_params       PASSED    00:00:00.584
native_app     test_digest_vectors    PASSED    00:00:00.539
native_app     test_form_params       PASSED    00:00:00.604
native_app     test_iface             PASSED    00:00:00.597
native_app     test_json              PASSED    00:00:00.558
native_app     test_response_headers  PASSED    00:00:00.619
native_app     test_middleware        PASSED    00:00:00.605
native_app     test_digest_auth       PASSED    00:00:00.623
native_app     test_web_terminal      PASSED    00:00:00.601
native_app     test_defer             PASSED    00:00:00.573
native_app     test_multipart         PASSED    00:00:00.595
native_app     test_auth              PASSED    00:00:00.592
native_app     test_file_serving      PASSED    00:00:00.610
native_app     test_dispatch          PASSED    00:00:00.590
native_app     test_chunked           PASSED    00:00:00.596
native_app     test_application       PASSED    00:00:00.668
================ 225 test cases: 225 succeeded in 00:00:11.283 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
----- native_webdav_handler:test_webdav_handler [PASSED] Took 1.19 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.194
================= 12 test cases: 12 succeeded in 00:00:01.194 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
--------------- native_diag:test_diag [PASSED] Took 1.17 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.168
================== 2 test cases: 2 succeeded in 00:00:01.168 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.668
native_snmp    test_snmp_agent  PASSED    00:00:00.506
================= 35 test cases: 35 succeeded in 00:00:01.174 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 2.14 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:02.144
================= 15 test cases: 15 succeeded in 00:00:02.144 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------- native_telnet:test_telnet [PASSED] Took 0.80 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.804
================= 15 test cases: 15 succeeded in 00:00:00.804 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
--------------- native_coap:test_coap [PASSED] Took 0.76 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.760
================= 41 test cases: 41 succeeded in 00:00:00.760 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
test/test_coap/test_coap.cpp:1076: test_well_known_core_discovery       [PASSED]
test/test_coap/test_coap.cpp:1077: test_well_known_core_rejects_post    [PASSED]
----------- native_coap_observe:test_coap [PASSED] Took 0.75 seconds -----------

=================================== SUMMARY ===================================
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.751
================= 41 test cases: 41 succeeded in 00:00:00.751 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.666
================= 19 test cases: 19 succeeded in 00:00:00.666 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------- native_modbus:test_modbus [PASSED] Took 0.63 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.630
================= 22 test cases: 22 succeeded in 00:00:00.630 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.696
...
----------- native_redis:test_redis_resp [PASSED] Took 0.61 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.609
================== 8 test cases: 8 succeeded in 00:00:00.609 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------------- native_stomp:test_stomp [PASSED] Took 0.61 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.609
================= 14 test cases: 14 succeeded in 00:00:00.609 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_mqtt_sn:test_mqtt_sn [PASSED] Took 0.64 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.636
...
-------- native_flow_export:test_flow_export [PASSED] Took 0.63 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.633
================== 6 test cases: 6 succeeded in 00:00:00.633 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
----------- native_protobuf:test_protobuf [PASSED] Took 0.61 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.613
================= 13 test cases: 13 succeeded in 00:00:00.613 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.710
...
------------ native_forward:test_forward [PASSED] Took 0.80 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.795
...
------------ native_gateway:test_gateway [PASSED] Took 0.74 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.735
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.645
================= 13 test cases: 13 succeeded in 00:00:00.645 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------------- native_nrf24:test_nrf24 [PASSED] Took 0.63 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.626
...
------------ native_enocean:test_enocean [PASSED] Took 0.63 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.631
================== 9 test cases: 9 succeeded in 00:00:00.631 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------------- native_pn532:test_pn532 [PASSED] Took 0.61 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_pn532   test_pn532  PASSED    00:00:00.615
================= 10 test cases: 10 succeeded in 00:00:00.615 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------- native_sigfox:test_sigfox [PASSED] Took 0.61 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.613
================== 7 test cases: 7 succeeded in 00:00:00.613 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------------- native_zwave:test_zwave [PASSED] Took 0.63 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.629
...
------------- native_zigbee:test_zigbee [PASSED] Took 0.61 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_zigbee  test_zigbee  PASSED    00:00:00.615
================== 9 test cases: 9 succeeded in 00:00:00.615 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------- native_thread:test_thread [PASSED] Took 0.62 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.615
================= 13 test cases: 13 succeeded in 00:00:00.615 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
--------------- native_wamp:test_wamp [PASSED] Took 0.65 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.647
================= 12 test cases: 12 succeeded in 00:00:00.647 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_sunspec:test_sunspec [PASSED] Took 0.61 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.611
...
------------- native_c37118:test_c37118 [PASSED] Took 0.62 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.617
================== 6 test cases: 6 succeeded in 00:00:00.617 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
--------------- native_dnp3:test_dnp3 [PASSED] Took 0.61 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.612
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.606
...
---------- native_lwm2m_tlv:test_lwm2m_tlv [PASSED] Took 0.61 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.608
================= 11 test cases: 11 succeeded in 00:00:00.608 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
--------------- native_fins:test_fins [PASSED] Took 0.61 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.614
================== 6 test cases: 6 succeeded in 00:00:00.614 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
----------- native_hostlink:test_hostlink [PASSED] Took 0.61 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.613
================== 7 test cases: 7 succeeded in 00:00:00.613 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
---------------- native_df1:test_df1 [PASSED] Took 0.63 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.630
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.636
================== 6 test cases: 6 succeeded in 00:00:00.636 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------- native_s7comm:test_s7comm [PASSED] Took 0.63 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.630
================== 8 test cases: 8 succeeded in 00:00:00.630 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------- native_melsec:test_melsec [PASSED] Took 0.62 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.616
================== 6 test cases: 6 succeeded in 00:00:00.616 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------- native_bacnet:test_bacnet [PASSED] Took 0.62 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.619
...
--------------- native_enip:test_enip [PASSED] Took 0.61 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.613
...
--------------- native_amqp:test_amqp [PASSED] Took 0.62 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.625
...
---------------- native_cip:test_cip [PASSED] Took 0.62 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.624
================== 9 test cases: 9 succeeded in 00:00:00.624 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
--------------- native_nats:test_nats [PASSED] Took 0.63 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.631
...
----- native_proxy_protocol:test_proxy_protocol [PASSED] Took 0.63 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.633
================== 8 test cases: 8 succeeded in 00:00:00.633 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
---------- native_sparkplug:test_sparkplug [PASSED] Took 0.66 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.661
================== 7 test cases: 7 succeeded in 00:00:00.661 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.651
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.618
================== 5 test cases: 5 succeeded in 00:00:00.618 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.638
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.611
================== 2 test cases: 2 succeeded in 00:00:00.611 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.625
...
---------- native_audit_log:test_audit_log [PASSED] Took 0.65 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.651
================= 16 test cases: 16 succeeded in 00:00:00.651 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
--------------- native_oidc:test_oidc [PASSED] Took 0.88 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.879
================= 17 test cases: 17 succeeded in 00:00:00.879 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_graphql:test_graphql [PASSED] Took 0.61 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.608
================= 32 test cases: 32 succeeded in 00:00:00.608 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.656
================== 8 test cases: 8 succeeded in 00:00:00.656 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------------- native_opcua:test_opcua [PASSED] Took 0.66 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.657
================= 38 test cases: 38 succeeded in 00:00:00.657 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------- native_opcua_client:test_opcua_client [PASSED] Took 0.65 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.655
...
---------- native_keepalive:test_keepalive [PASSED] Took 1.06 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.058
================= 10 test cases: 10 succeeded in 00:00:01.058 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.628
================= 10 test cases: 10 succeeded in 00:00:00.628 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
--------------- native_smtp:test_smtp [PASSED] Took 0.73 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_smtp    test_smtp  PASSED    00:00:00.728
================= 11 test cases: 11 succeeded in 00:00:00.728 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
--------- native_ntp_server:test_ntp_server [PASSED] Took 0.63 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_ntp_server  test_ntp_server  PASSED    00:00:00.631
================== 8 test cases: 8 succeeded in 00:00:00.631 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
--------- native_dns_server:test_dns_server [PASSED] Took 0.61 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_dns_server  test_dns_server  PASSED    00:00:00.607
...
---------------- native_rtc:test_rtc [PASSED] Took 1.64 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_rtc     test_rtc  PASSED    00:00:01.641
================== 8 test cases: 8 succeeded in 00:00:01.641 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------- native_ld2410:test_ld2410 [PASSED] Took 0.63 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ld2410  test_ld2410  PASSED    00:00:00.625
================== 7 test cases: 7 succeeded in 00:00:00.625 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------- native_mpr121:test_mpr121 [PASSED] Took 0.63 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_mpr121  test_mpr121  PASSED    00:00:00.625
================== 5 test cases: 5 succeeded in 00:00:00.625 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------------- native_sht3x:test_sht3x [PASSED] Took 0.61 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sht3x   test_sht3x  PASSED    00:00:00.610
================== 5 test cases: 5 succeeded in 00:00:00.610 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_pca9685:test_pca9685 [PASSED] Took 0.62 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_pca9685  test_pca9685  PASSED    00:00:00.622
================== 4 test cases: 4 succeeded in 00:00:00.622 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_ads1115:test_ads1115 [PASSED] Took 0.63 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_ads1115  test_ads1115  PASSED    00:00:00.632
================== 3 test cases: 3 succeeded in 00:00:00.632 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------- native_ina219:test_ina219 [PASSED] Took 0.63 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ina219  test_ina219  PASSED    00:00:00.627
================== 4 test cases: 4 succeeded in 00:00:00.627 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------------- native_hpack:test_hpack [PASSED] Took 0.75 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_hpack   test_hpack  PASSED    00:00:00.748
...
----------- native_h2frame:test_h2_frame [PASSED] Took 0.63 seconds ------------

=================================== SUMMARY ===================================
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h2frame  test_h2_frame  PASSED    00:00:00.630
================== 6 test cases: 6 succeeded in 00:00:00.630 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_h2conn:test_h2_conn [PASSED] Took 0.87 seconds -------------

=================================== SUMMARY ===================================
Environment    Test          Status    Duration
-------------  ------------  --------  ------------
native_h2conn  test_h2_conn  PASSED    00:00:00.868
================== 4 test cases: 4 succeeded in 00:00:00.868 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------- native_quic_varint:test_quic_varint [PASSED] Took 0.63 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_varint  test_quic_varint  PASSED    00:00:00.630
...
----------- native_h3frame:test_h3_frame [PASSED] Took 0.63 seconds ------------

=================================== SUMMARY ===================================
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h3frame  test_h3_frame  PASSED    00:00:00.629
================== 7 test cases: 7 succeeded in 00:00:00.629 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
---------------- native_jwt:test_jwt [PASSED] Took 0.68 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.680
================= 21 test cases: 21 succeeded in 00:00:00.680 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.114
================== 3 test cases: 3 succeeded in 00:00:01.114 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.636
================= 15 test cases: 15 succeeded in 00:00:00.636 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
---------- native_ws_client:test_ws_client [PASSED] Took 0.65 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.651
================= 16 test cases: 16 succeeded in 00:00:00.651 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.660
...
---------- native_snmp_trap:test_snmp_trap [PASSED] Took 0.66 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.658
================== 7 test cases: 7 succeeded in 00:00:00.658 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.663
...
----------- native_ssh_zlib:test_ssh_zlib [PASSED] Took 0.70 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_zlib  test_ssh_zlib  PASSED    00:00:00.703
================== 9 test cases: 9 succeeded in 00:00:00.703 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
----------- native_ssh_comp:test_ssh_comp [PASSED] Took 0.99 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_comp  test_ssh_comp  PASSED    00:00:00.994
================== 5 test cases: 5 succeeded in 00:00:00.994 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.044
================= 71 test cases: 71 succeeded in 00:00:01.044 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.618
================= 14 test cases: 14 succeeded in 00:00:00.618 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
---------- native_device_id:test_device_id [PASSED] Took 0.65 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.646
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.637
================= 11 test cases: 11 succeeded in 00:00:00.637 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
--------------- native_csrf:test_csrf [PASSED] Took 0.64 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.640
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.626
================= 15 test cases: 15 succeeded in 00:00:00.626 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
--------- native_net_egress:test_net_egress [PASSED] Took 0.62 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.624
================== 6 test cases: 6 succeeded in 00:00:00.624 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.610
================== 5 test cases: 5 succeeded in 00:00:00.610 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.619
================= 18 test cases: 18 succeeded in 00:00:00.619 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.633
================= 17 test cases: 17 succeeded in 00:00:00.633 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------ native_udp_telemetry:test_udp_telemetry [PASSED] Took 0.62 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.621
================== 7 test cases: 7 succeeded in 00:00:00.621 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------- native_statsd:test_statsd [PASSED] Took 0.65 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_statsd  test_statsd  PASSED    00:00:00.650
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.622
================== 6 test cases: 6 succeeded in 00:00:00.622 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.626
...
---------- native_config_io:test_config_io [PASSED] Took 0.66 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.661
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.750
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.609
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.741
================== 2 test cases: 2 succeeded in 00:00:00.741 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.172
================== 2 test cases: 2 succeeded in 00:00:01.172 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------------- native_qpack:test_qpack [PASSED] Took 0.74 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_qpack   test_qpack  PASSED    00:00:00.744
...
-------- native_quic_packet:test_quic_packet [PASSED] Took 0.66 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_packet  test_quic_packet  PASSED    00:00:00.660
...
--------- native_quic_frame:test_quic_frame [PASSED] Took 0.69 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_quic_frame  test_quic_frame  PASSED    00:00:00.691
================== 8 test cases: 8 succeeded in 00:00:00.691 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------- native_quic_crypto:test_quic_crypto [PASSED] Took 0.73 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_crypto  test_quic_crypto  PASSED    00:00:00.732
...
---------- native_tls13_kdf:test_tls13_kdf [PASSED] Took 0.67 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_tls13_kdf  test_tls13_kdf  PASSED    00:00:00.673
================== 5 test cases: 5 succeeded in 00:00:00.673 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_quic_tp:test_quic_tp [PASSED] Took 0.65 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_quic_tp  test_quic_tp  PASSED    00:00:00.653
...
---------- native_tls13_msg:test_tls13_msg [PASSED] Took 0.73 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_tls13_msg  test_tls13_msg  PASSED    00:00:00.734
...
----------- native_quic_tls:test_quic_tls [PASSED] Took 0.92 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_quic_tls  test_quic_tls  PASSED    00:00:00.916
...
---------- native_quic_conn:test_quic_conn [PASSED] Took 0.98 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_quic_conn  test_quic_conn  PASSED    00:00:00.976
================== 4 test cases: 4 succeeded in 00:00:00.976 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_h3_conn:test_h3_conn [PASSED] Took 0.92 seconds ------------
...
------------- native_h3_e2e:test_h3_e2e [PASSED] Took 0.98 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_h3_e2e  test_h3_e2e  PASSED    00:00:00.978
================== 1 test cases: 1 succeeded in 00:00:00.978 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------- native_quic_server:test_quic_server [PASSED] Took 1.01 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_server  test_quic_server  PASSED    00:00:01.010
================== 2 test cases: 2 succeeded in 00:00:01.010 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
---------- native_h3_server:test_h3_server [PASSED] Took 1.50 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_h3_server  test_h3_server  PASSED    00:00:01.504
================== 1 test cases: 1 succeeded in 00:00:01.504 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
----- native_ssh_chachapoly:test_ssh_chachapoly [PASSED] Took 0.65 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_ssh_chachapoly  test_ssh_chachapoly  PASSED    00:00:00.648
