...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:06.980 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.578 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.591 |
| `test_transport`        | `native`              |    34 |   ✅   | 00:00:00.570 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.590 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.584 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.967 |
...
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.899 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.189 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:01.003 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.569 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.563 |
...
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.564 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.564 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.563 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.576 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.565 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.580 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.601 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.592 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.587 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.674 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.708 |
...
------------------ native:test_sse [PASSED] Took 6.98 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:06.980
...
native               test_websocket         PASSED    00:00:00.590
native               test_http_parser       PASSED    00:00:00.584
native_ssh           test_ssh_crypto        PASSED    00:00:03.967
...
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.899
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.189
native_app           test_regex             PASSED    00:00:01.003
native_app           test_template          PASSED    00:00:00.569
native_app           test_path_params       PASSED    00:00:00.563
...
native_app           test_middleware        PASSED    00:00:00.564
native_app           test_digest_auth       PASSED    00:00:00.563
...
================ 603 test cases: 603 succeeded in 00:00:29.696 ================
```
