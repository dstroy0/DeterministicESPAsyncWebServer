...
**Generated:** 2026-07-04 21:24:27
**Command:** `pio test` over 123 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 2016 passed - 236s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:12.865 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.651 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.639 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.652 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:04.434 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.666 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.662 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.673 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.664 |
...
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.684 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.638 |
...
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:01.062 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.702 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.704 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.997 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.670 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.866 |
| `test_ssh_transport`     | `native_ssh`            |    31 |   ✅   | 00:00:01.197 |
...
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.214 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.614 |
...
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.646 |
...
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.656 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.636 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.639 |
...
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.686 |
...
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.685 |
...
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.679 |
...
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.680 |
...
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.683 |
...
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.673 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.676 |
...
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.673 |
...
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.696 |
...
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.677 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.721 |
...
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.695 |
...
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.726 |
...
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.426 |
...
----------- native_canopen:test_canopen [PASSED] Took 12.87 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:12.865
================= 17 test cases: 17 succeeded in 00:00:12.865 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.639
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_det_arena  test_det_arena  PASSED    00:00:00.652
================= 17 test cases: 17 succeeded in 00:00:00.652 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:04.434
================= 16 test cases: 16 succeeded in 00:00:04.434 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.666
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.664
...
native         test_presentation  PASSED    00:00:00.684
native         test_transport     PASSED    00:00:00.638
native         test_websocket     PASSED    00:00:00.672
native         test_http_parser   PASSED    00:00:00.620
================ 323 test cases: 323 succeeded in 00:00:04.259 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.062
================= 13 test cases: 13 succeeded in 00:00:01.062 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.702
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 4.00 seconds -------------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.997
native_ssh     test_ssh_auth       PASSED    00:00:00.670
native_ssh     test_ssh_server     PASSED    00:00:00.866
native_ssh     test_ssh_transport  PASSED    00:00:01.197
native_ssh     test_ssh_channel    PASSED    00:00:00.593
================ 137 test cases: 137 succeeded in 00:00:07.322 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.214
native_app     test_template          PASSED    00:00:00.614
...
native_app     test_middleware        PASSED    00:00:00.646
...
native_app     test_multipart         PASSED    00:00:00.656
native_app     test_auth              PASSED    00:00:00.636
native_app     test_file_serving      PASSED    00:00:00.639
...
================ 225 test cases: 225 succeeded in 00:00:11.906 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.219
...
================= 35 test cases: 35 succeeded in 00:00:01.320 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 2.19 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:02.187
================= 15 test cases: 15 succeeded in 00:00:02.187 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
================= 41 test cases: 41 succeeded in 00:00:00.985 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.686
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.685
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.679
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.680
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.683
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.676
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.673
================= 11 test cases: 11 succeeded in 00:00:00.673 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.696
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_ntp_server  test_ntp_server  PASSED    00:00:00.677
...
================= 21 test cases: 21 succeeded in 00:00:00.721 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
================= 22 test cases: 22 succeeded in 00:00:00.695 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 148 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.726
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.426
