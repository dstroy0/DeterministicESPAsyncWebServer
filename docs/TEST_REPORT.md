...
**Generated:** 2026-06-29 18:32:51
**Command:** `pio test` over 81 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1406 passed - 139s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:12.685 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.600 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.654 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.623 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.656 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.600 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.726 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.657 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.677 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.890 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.556 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.661 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.877 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.525 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.862 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.282 |
...
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.537 |
...
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.498 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.466 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.829 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.840 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.737 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.670 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.653 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.713 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.640 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.643 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.650 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.646 |
| `test_protobuf`          | `native_protobuf`       |     8 |   ✅   | 00:00:00.638 |
| `test_wamp`              | `native_wamp`           |    11 |   ✅   | 00:00:00.677 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.643 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.626 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.661 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.643 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |     7 |   ✅   | 00:00:00.644 |
...
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.650 |
...
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.832 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.644 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.662 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.642 |
...
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.100 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.085 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.651 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.683 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.102 |
| `test_http_client`       | `native_http_client`    |    10 |   ✅   | 00:00:00.654 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.649 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.655 |
...
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:00.996 |
...
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.748 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.629 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.780 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.181 |
...
----------------- native:test_sse [PASSED] Took 12.68 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:12.685
native         test_session       PASSED    00:00:00.600
native         test_presentation  PASSED    00:00:00.654
native         test_transport     PASSED    00:00:00.623
native         test_websocket     PASSED    00:00:00.656
native         test_http_parser   PASSED    00:00:00.600
================ 318 test cases: 318 succeeded in 00:00:15.818 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 106 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.677
...
native_ssh     test_ssh_transport  PASSED    00:00:00.877
native_ssh     test_ssh_channel    PASSED    00:00:00.525
================= 93 test cases: 93 succeeded in 00:00:06.508 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 106 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.282
...
native_app     test_json              PASSED    00:00:00.537
...
================ 219 test cases: 219 succeeded in 00:00:11.264 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 106 tests
...
native_snmp    test_snmp_agent  PASSED    00:00:00.498
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.466
================= 10 test cases: 10 succeeded in 00:00:01.466 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 106 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.840
================= 29 test cases: 29 succeeded in 00:00:00.840 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 106 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.670
================= 19 test cases: 19 succeeded in 00:00:00.670 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 106 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.638
...
test/test_hostlink/test_hostlink.cpp:30: test_build_dm_read: Expected '@00RD0000001057*\r' Was '@00RD0000001057*\r\x01\xBC\x81\xFF\x7F' [FAILED]
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.650
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.832
================= 13 test cases: 13 succeeded in 00:00:00.832 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 106 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.644
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.642
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.100
================= 10 test cases: 10 succeeded in 00:00:01.100 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 106 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.651
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.102
================== 3 test cases: 3 succeeded in 00:00:01.102 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 106 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.655
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.996
================= 71 test cases: 71 succeeded in 00:00:00.996 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 106 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.641
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.632
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.748
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.780
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.181
================== 2 test cases: 2 succeeded in 00:00:01.181 ==================
```
