...
**Generated:** 2026-07-05 18:48:47
**Command:** `pio test` over 142 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 2137 passed - 260s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:06.157 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.649 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.659 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.657 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:03.591 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.675 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.661 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.673 |
...
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.658 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.026 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.587 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.621 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.615 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.639 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.607 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.775 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:01.032 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.696 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.680 |
| `test_ssh_crypto`        | `native_ssh`            |    45 |   ✅   | 00:00:03.888 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.643 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.928 |
| `test_ssh_transport`     | `native_ssh`            |    33 |   ✅   | 00:00:01.178 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.595 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.989 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.421 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.175 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.605 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.605 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.552 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.605 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.611 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.571 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.615 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.616 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.642 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.613 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.600 |
...
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.617 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.693 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.227 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.182 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.698 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.518 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:02.070 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.823 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.892 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.736 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.676 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.679 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.748 |
...
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.660 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.659 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.692 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.737 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.843 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.739 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.665 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.653 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.658 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.654 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.661 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.667 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.659 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.663 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.685 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.671 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.657 |
...
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.673 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.712 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.658 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.660 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.661 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.650 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.673 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.670 |
...
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.673 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.673 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.657 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.668 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.661 |
...
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.890 |
...
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.688 |
...
| `test_smtp`              | `native_smtp`           |    11 |   ✅   | 00:00:00.774 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.659 |
| `test_dns_server`        | `native_dns_server`     |     7 |   ✅   | 00:00:00.658 |
| `test_rtc`               | `native_rtc`            |     8 |   ✅   | 00:00:00.660 |
| `test_ld2410`            | `native_ld2410`         |     7 |   ✅   | 00:00:00.653 |
| `test_mpr121`            | `native_mpr121`         |     5 |   ✅   | 00:00:00.665 |
| `test_sht3x`             | `native_sht3x`          |     5 |   ✅   | 00:00:00.662 |
| `test_pca9685`           | `native_pca9685`        |     4 |   ✅   | 00:00:00.655 |
| `test_ads1115`           | `native_ads1115`        |     3 |   ✅   | 00:00:00.662 |
| `test_ina219`            | `native_ina219`         |     4 |   ✅   | 00:00:00.657 |
| `test_hpack`             | `native_hpack`          |     7 |   ✅   | 00:00:00.765 |
| `test_h2_frame`          | `native_h2frame`        |     6 |   ✅   | 00:00:00.650 |
| `test_h2_conn`           | `native_h2conn`         |     4 |   ✅   | 00:00:00.871 |
| `test_quic_varint`       | `native_quic_varint`    |     3 |   ✅   | 00:00:00.651 |
| `test_h3_frame`          | `native_h3frame`        |     7 |   ✅   | 00:00:00.684 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.714 |
...
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.654 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.706 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.705 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.684 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.686 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.701 |
| `test_ssh_zlib`          | `native_ssh_zlib`       |     9 |   ✅   | 00:00:00.718 |
...
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.684 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.705 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.655 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.669 |
...
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.653 |
...
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.792 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.504 |
| `test_qpack`             | `native_qpack`          |     9 |   ✅   | 00:00:00.737 |
| `test_quic_packet`       | `native_quic_packet`    |     8 |   ✅   | 00:00:00.652 |
| `test_quic_frame`        | `native_quic_frame`     |     8 |   ✅   | 00:00:00.664 |
| `test_ssh_chachapoly`    | `native_ssh_chachapoly` |     4 |   ✅   | 00:00:00.686 |
...
------------ native_canopen:test_canopen [PASSED] Took 6.16 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.157
================= 17 test cases: 17 succeeded in 00:00:06.157 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_det_arena  test_det_arena  PASSED    00:00:00.657
================= 17 test cases: 17 succeeded in 00:00:00.657 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
-------- native_ssh_ed25519:test_ssh_ed25519 [PASSED] Took 3.59 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:03.591
================= 16 test cases: 16 succeeded in 00:00:03.591 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.661
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.673
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.658
...
native         test_transport     PASSED    00:00:00.615
native         test_websocket     PASSED    00:00:00.639
native         test_http_parser   PASSED    00:00:00.607
================ 323 test cases: 323 succeeded in 00:00:04.095 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.775
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.032
================= 13 test cases: 13 succeeded in 00:00:01.032 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.888
native_ssh     test_ssh_auth       PASSED    00:00:00.643
native_ssh     test_ssh_server     PASSED    00:00:00.928
native_ssh     test_ssh_transport  PASSED    00:00:01.178
native_ssh     test_ssh_channel    PASSED    00:00:00.595
================ 145 test cases: 145 succeeded in 00:00:07.232 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.989
================== 2 test cases: 2 succeeded in 00:00:00.989 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.421
================== 2 test cases: 2 succeeded in 00:00:01.421 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
native_app     test_chunked           PASSED    00:00:00.617
native_app     test_application       PASSED    00:00:00.693
================ 225 test cases: 225 succeeded in 00:00:11.582 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.227
================= 12 test cases: 12 succeeded in 00:00:01.227 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
native_snmp    test_snmp_agent  PASSED    00:00:00.518
================= 35 test cases: 35 succeeded in 00:00:01.216 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:02.070
================= 15 test cases: 15 succeeded in 00:00:02.070 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.823
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.892
================= 41 test cases: 41 succeeded in 00:00:00.892 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
================= 41 test cases: 41 succeeded in 00:00:00.736 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.748
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.660
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.737
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.843
================= 16 test cases: 16 succeeded in 00:00:00.843 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.739
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.665
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.653
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_pn532   test_pn532  PASSED    00:00:00.654
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.661
================== 7 test cases: 7 succeeded in 00:00:00.661 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.663
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.685
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.671
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.657
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.673
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.660
================== 6 test cases: 6 succeeded in 00:00:00.660 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.673
================== 9 test cases: 9 succeeded in 00:00:00.673 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.670
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.673
================== 7 test cases: 7 succeeded in 00:00:00.673 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.673
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.668
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.661
================== 5 test cases: 5 succeeded in 00:00:00.661 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.659
================== 2 test cases: 2 succeeded in 00:00:00.659 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.890
================= 17 test cases: 17 succeeded in 00:00:00.890 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.688
================= 38 test cases: 38 succeeded in 00:00:00.688 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_smtp    test_smtp  PASSED    00:00:00.774
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_dns_server  test_dns_server  PASSED    00:00:00.658
================== 7 test cases: 7 succeeded in 00:00:00.658 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_rtc     test_rtc  PASSED    00:00:00.660
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_mpr121  test_mpr121  PASSED    00:00:00.665
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_pca9685  test_pca9685  PASSED    00:00:00.655
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ina219  test_ina219  PASSED    00:00:00.657
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_hpack   test_hpack  PASSED    00:00:00.765
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_varint  test_quic_varint  PASSED    00:00:00.651
================== 3 test cases: 3 succeeded in 00:00:00.651 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
================= 21 test cases: 21 succeeded in 00:00:00.714 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.654
================= 22 test cases: 22 succeeded in 00:00:00.654 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.706
================= 16 test cases: 16 succeeded in 00:00:00.706 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.686
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_zlib  test_ssh_zlib  PASSED    00:00:00.718
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.705
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.655
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.669
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.653
================= 17 test cases: 17 succeeded in 00:00:00.653 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.792
================== 2 test cases: 2 succeeded in 00:00:00.792 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 1.50 seconds ------------

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.504
================== 2 test cases: 2 succeeded in 00:00:01.504 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 167 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_qpack   test_qpack  PASSED    00:00:00.737
...
-------- native_quic_packet:test_quic_packet [PASSED] Took 0.65 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_packet  test_quic_packet  PASSED    00:00:00.652
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_ssh_chachapoly  test_ssh_chachapoly  PASSED    00:00:00.686
