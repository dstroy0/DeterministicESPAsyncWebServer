...
| `test_ssh_auth`      | `native_ssh`          |    12 |   ✅   | 00:00:00.523 |
...
| `test_multipart`     | `native_app`          |    19 |   ✅   | 00:00:00.835 |
| `test_auth`          | `native_app`          |    13 |   ✅   | 00:00:00.510 |
| `test_file_serving`  | `native_app`          |    12 |   ✅   | 00:00:00.524 |
| `test_dispatch`      | `native_app`          |    10 |   ✅   | 00:00:00.490 |
...
native_ssh           test_ssh_auth       PASSED    00:00:00.523
...
native_app           test_multipart      PASSED    00:00:00.835
...
================ 498 test cases: 498 succeeded in 00:00:20.607 ================
```
