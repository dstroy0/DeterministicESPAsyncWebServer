...
**Generated:** 2026-07-05 03:04:14
**Command:** `pio test` over 136 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 2083 passed - 233s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:05.561 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.582 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.598 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.599 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:04.486 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.597 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.604 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.588 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.587 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.606 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.585 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.580 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.592 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.612 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.594 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.588 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:00.929 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.543 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.576 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.576 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.589 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.554 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.710 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:00.946 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.622 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.615 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:04.187 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.603 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.884 |
| `test_ssh_transport`     | `native_ssh`            |    31 |   ✅   | 00:00:01.229 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.535 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.854 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.254 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.093 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.568 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.567 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.504 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.563 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.572 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.529 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.561 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.568 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.588 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.566 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.542 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.578 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.573 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.584 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.567 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.582 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.648 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.132 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.103 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.633 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.477 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:02.120 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.761 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.695 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.711 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.605 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.600 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.663 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.603 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.591 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.599 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.590 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.593 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.629 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.695 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.733 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.686 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.587 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.596 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.584 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.585 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.587 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.600 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.588 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.601 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.624 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.585 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.599 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.589 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.599 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.608 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.585 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.608 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.651 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.575 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.594 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.584 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.576 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.589 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.591 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.579 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.586 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.606 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.610 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.617 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.615 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.581 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.600 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.591 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.595 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.592 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.607 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.831 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.593 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.595 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.580 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.619 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.646 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.642 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.022 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.025 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.623 |
| `test_smtp`              | `native_smtp`           |    11 |   ✅   | 00:00:00.711 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.591 |
| `test_dns_server`        | `native_dns_server`     |     7 |   ✅   | 00:00:00.599 |
| `test_rtc`               | `native_rtc`            |     8 |   ✅   | 00:00:00.592 |
| `test_ld2410`            | `native_ld2410`         |     7 |   ✅   | 00:00:00.588 |
| `test_mpr121`            | `native_mpr121`         |     5 |   ✅   | 00:00:00.580 |
| `test_sht3x`             | `native_sht3x`          |     5 |   ✅   | 00:00:00.612 |
| `test_pca9685`           | `native_pca9685`        |     4 |   ✅   | 00:00:00.589 |
| `test_ads1115`           | `native_ads1115`        |     3 |   ✅   | 00:00:00.597 |
| `test_ina219`            | `native_ina219`         |     4 |   ✅   | 00:00:00.602 |
| `test_hpack`             | `native_hpack`          |     7 |   ✅   | 00:00:00.677 |
| `test_h2_frame`          | `native_h2frame`        |     6 |   ✅   | 00:00:00.592 |
| `test_h2_conn`           | `native_h2conn`         |     4 |   ✅   | 00:00:00.802 |
| `test_quic_varint`       | `native_quic_varint`    |     3 |   ✅   | 00:00:00.588 |
| `test_h3_frame`          | `native_h3frame`        |     4 |   ✅   | 00:00:00.600 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.636 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.063 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.600 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.620 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.591 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.627 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.648 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.612 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.595 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.637 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:00.990 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.585 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.584 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.608 |
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.606 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.617 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.611 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.592 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.592 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.591 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.585 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.582 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.582 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.612 |
| `test_statsd`            | `native_statsd`         |     9 |   ✅   | 00:00:00.651 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.595 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.596 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.624 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.717 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.567 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.701 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.396 |
...
------------ native_canopen:test_canopen [PASSED] Took 5.56 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:05.561
================= 17 test cases: 17 succeeded in 00:00:05.561 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
----- native_det_primitives:test_det_primitives [PASSED] Took 0.58 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.582
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.598
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_det_arena  test_det_arena  PASSED    00:00:00.599
================= 17 test cases: 17 succeeded in 00:00:00.599 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:04.486
================= 16 test cases: 16 succeeded in 00:00:04.486 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
------------ native_promisc:test_promisc [PASSED] Took 0.60 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.597
================== 8 test cases: 8 succeeded in 00:00:00.597 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
-------- native_bus_capture:test_bus_capture [PASSED] Took 0.60 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.604
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.588
================== 9 test cases: 9 succeeded in 00:00:00.588 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
---------- native_devicenet:test_devicenet [PASSED] Took 0.59 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.587
================== 8 test cases: 8 succeeded in 00:00:00.587 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
--------------- native_mbus:test_mbus [PASSED] Took 0.59 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.585
...
----------- native_iec60870:test_iec60870 [PASSED] Took 0.58 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.580
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.592
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.612
================== 5 test cases: 5 succeeded in 00:00:00.612 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
----------- native_nmea0183:test_nmea0183 [PASSED] Took 0.59 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.594
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.588
...
------------------ native:test_sse [PASSED] Took 0.93 seconds ------------------
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:00.929
native         test_session       PASSED    00:00:00.543
native         test_presentation  PASSED    00:00:00.576
native         test_transport     PASSED    00:00:00.576
native         test_websocket     PASSED    00:00:00.589
native         test_http_parser   PASSED    00:00:00.554
================ 323 test cases: 323 succeeded in 00:00:03.766 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.710
================= 17 test cases: 17 succeeded in 00:00:00.710 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
-------- native_accept_gate:test_accept_gate [PASSED] Took 0.95 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.946
================= 13 test cases: 13 succeeded in 00:00:00.946 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.622
================== 3 test cases: 3 succeeded in 00:00:00.622 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
----------- native_prov:test_provisioning [PASSED] Took 0.62 seconds -----------

=================================== SUMMARY ===================================
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.615
================== 5 test cases: 5 succeeded in 00:00:00.615 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 4.19 seconds -------------
...
----------- native_ssh:test_ssh_transport [PASSED] Took 1.23 seconds -----------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.187
native_ssh     test_ssh_auth       PASSED    00:00:00.603
native_ssh     test_ssh_server     PASSED    00:00:00.884
native_ssh     test_ssh_transport  PASSED    00:00:01.229
native_ssh     test_ssh_channel    PASSED    00:00:00.535
================ 137 test cases: 137 succeeded in 00:00:07.438 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.854
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.254
================== 2 test cases: 2 succeeded in 00:00:01.254 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.093
native_app     test_template          PASSED    00:00:00.568
native_app     test_path_params       PASSED    00:00:00.567
native_app     test_digest_vectors    PASSED    00:00:00.504
native_app     test_form_params       PASSED    00:00:00.563
native_app     test_iface             PASSED    00:00:00.572
native_app     test_json              PASSED    00:00:00.529
native_app     test_response_headers  PASSED    00:00:00.561
native_app     test_middleware        PASSED    00:00:00.568
native_app     test_digest_auth       PASSED    00:00:00.588
native_app     test_web_terminal      PASSED    00:00:00.566
native_app     test_defer             PASSED    00:00:00.542
native_app     test_multipart         PASSED    00:00:00.578
native_app     test_auth              PASSED    00:00:00.573
native_app     test_file_serving      PASSED    00:00:00.584
native_app     test_dispatch          PASSED    00:00:00.567
native_app     test_chunked           PASSED    00:00:00.582
native_app     test_application       PASSED    00:00:00.648
================ 225 test cases: 225 succeeded in 00:00:10.754 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
----- native_webdav_handler:test_webdav_handler [PASSED] Took 1.13 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.132
================= 12 test cases: 12 succeeded in 00:00:01.132 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
--------------- native_diag:test_diag [PASSED] Took 1.10 seconds ---------------
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.633
native_snmp    test_snmp_agent  PASSED    00:00:00.477
================= 35 test cases: 35 succeeded in 00:00:01.110 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:02.120
================= 15 test cases: 15 succeeded in 00:00:02.120 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
------------- native_telnet:test_telnet [PASSED] Took 0.76 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.761
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.695
================= 41 test cases: 41 succeeded in 00:00:00.695 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.711
================= 41 test cases: 41 succeeded in 00:00:00.711 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
------------- native_webdav:test_webdav [PASSED] Took 0.60 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.605
================= 19 test cases: 19 succeeded in 00:00:00.605 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
------------- native_modbus:test_modbus [PASSED] Took 0.60 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.600
================= 22 test cases: 22 succeeded in 00:00:00.600 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.663
...
----------- native_redis:test_redis_resp [PASSED] Took 0.60 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.603
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.599
================= 13 test cases: 13 succeeded in 00:00:00.599 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.590
================== 6 test cases: 6 succeeded in 00:00:00.590 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.593
...
------ native_preempt_queue:test_preempt_queue [PASSED] Took 0.63 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.629
================= 11 test cases: 11 succeeded in 00:00:00.629 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
---------------- native_dma:test_dma [PASSED] Took 0.70 seconds ----------------
...
------------ native_forward:test_forward [PASSED] Took 0.73 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.733
================= 16 test cases: 16 succeeded in 00:00:00.733 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
------------ native_gateway:test_gateway [PASSED] Took 0.69 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.686
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.587
================= 13 test cases: 13 succeeded in 00:00:00.587 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
-------------- native_nrf24:test_nrf24 [PASSED] Took 0.60 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.596
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.584
...
------------- native_sigfox:test_sigfox [PASSED] Took 0.59 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.587
================== 7 test cases: 7 succeeded in 00:00:00.587 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
-------------- native_zwave:test_zwave [PASSED] Took 0.60 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.600
================== 9 test cases: 9 succeeded in 00:00:00.600 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
------------- native_zigbee:test_zigbee [PASSED] Took 0.59 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_zigbee  test_zigbee  PASSED    00:00:00.588
================== 9 test cases: 9 succeeded in 00:00:00.588 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
------------- native_thread:test_thread [PASSED] Took 0.60 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.601
================= 13 test cases: 13 succeeded in 00:00:00.601 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
--------------- native_wamp:test_wamp [PASSED] Took 0.62 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.624
================= 12 test cases: 12 succeeded in 00:00:00.624 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
------------ native_sunspec:test_sunspec [PASSED] Took 0.58 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.585
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.599
...
--------------- native_dnp3:test_dnp3 [PASSED] Took 0.59 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.589
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.599
================== 7 test cases: 7 succeeded in 00:00:00.599 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.585
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.608
================== 7 test cases: 7 succeeded in 00:00:00.608 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
-------------- native_senml:test_senml [PASSED] Took 0.65 seconds --------------
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.575
================== 9 test cases: 9 succeeded in 00:00:00.575 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.594
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.584
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.576
================== 6 test cases: 6 succeeded in 00:00:00.576 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
------------- native_bacnet:test_bacnet [PASSED] Took 0.59 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.589
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.591
================== 6 test cases: 6 succeeded in 00:00:00.591 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.579
...
---------------- native_cip:test_cip [PASSED] Took 0.59 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.586
...
--------------- native_nats:test_nats [PASSED] Took 0.61 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.606
================= 14 test cases: 14 succeeded in 00:00:00.606 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.610
================== 8 test cases: 8 succeeded in 00:00:00.610 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
---------- native_sparkplug:test_sparkplug [PASSED] Took 0.62 seconds ----------
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.615
================== 5 test cases: 5 succeeded in 00:00:00.615 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.600
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.591
...
-------- native_radio_power:test_radio_power [PASSED] Took 0.60 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.595
================== 2 test cases: 2 succeeded in 00:00:00.595 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.592
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.607
...
--------------- native_oidc:test_oidc [PASSED] Took 0.83 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.831
================= 17 test cases: 17 succeeded in 00:00:00.831 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
------------ native_graphql:test_graphql [PASSED] Took 0.60 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.595
================= 32 test cases: 32 succeeded in 00:00:00.595 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.580
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.619
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.646
================= 38 test cases: 38 succeeded in 00:00:00.646 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.642
================= 14 test cases: 14 succeeded in 00:00:00.642 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.022
================= 10 test cases: 10 succeeded in 00:00:01.022 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
-------------- native_range:test_range [PASSED] Took 1.02 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.025
================= 13 test cases: 13 succeeded in 00:00:01.025 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
------------- native_syslog:test_syslog [PASSED] Took 0.62 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.623
================= 10 test cases: 10 succeeded in 00:00:00.623 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_smtp    test_smtp  PASSED    00:00:00.711
================= 11 test cases: 11 succeeded in 00:00:00.711 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_ntp_server  test_ntp_server  PASSED    00:00:00.591
================== 8 test cases: 8 succeeded in 00:00:00.591 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_dns_server  test_dns_server  PASSED    00:00:00.599
================== 7 test cases: 7 succeeded in 00:00:00.599 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
---------------- native_rtc:test_rtc [PASSED] Took 0.59 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_rtc     test_rtc  PASSED    00:00:00.592
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ld2410  test_ld2410  PASSED    00:00:00.588
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_mpr121  test_mpr121  PASSED    00:00:00.580
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sht3x   test_sht3x  PASSED    00:00:00.612
================== 5 test cases: 5 succeeded in 00:00:00.612 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
------------ native_pca9685:test_pca9685 [PASSED] Took 0.59 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_pca9685  test_pca9685  PASSED    00:00:00.589
...
------------ native_ads1115:test_ads1115 [PASSED] Took 0.60 seconds ------------
...
------------- native_ina219:test_ina219 [PASSED] Took 0.60 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ina219  test_ina219  PASSED    00:00:00.602
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_hpack/test_hpack.cpp:185: test_int_coding                     [PASSED]
test/test_hpack/test_hpack.cpp:186: test_huffman                        [PASSED]
test/test_hpack/test_hpack.cpp:187: test_decode_c31_and_index           [PASSED]
test/test_hpack/test_hpack.cpp:188: test_dynamic_eviction               [PASSED]
test/test_hpack/test_hpack.cpp:189: test_encode_static                  [PASSED]
test/test_hpack/test_hpack.cpp:190: test_encode_decode_roundtrip        [PASSED]
test/test_hpack/test_hpack.cpp:191: test_reject_malformed               [PASSED]
-------------- native_hpack:test_hpack [PASSED] Took 0.68 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_hpack   test_hpack  PASSED    00:00:00.677
================== 7 test cases: 7 succeeded in 00:00:00.677 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
----------- native_h2frame:test_h2_frame [PASSED] Took 0.59 seconds ------------

=================================== SUMMARY ===================================
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h2frame  test_h2_frame  PASSED    00:00:00.592
================== 6 test cases: 6 succeeded in 00:00:00.592 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
------------ native_h2conn:test_h2_conn [PASSED] Took 0.80 seconds -------------

=================================== SUMMARY ===================================
Environment    Test          Status    Duration
-------------  ------------  --------  ------------
native_h2conn  test_h2_conn  PASSED    00:00:00.802
...
-------- native_quic_varint:test_quic_varint [PASSED] Took 0.59 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_varint  test_quic_varint  PASSED    00:00:00.588
================== 3 test cases: 3 succeeded in 00:00:00.588 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_h3_frame/test_h3_frame.cpp:93: test_header_roundtrip          [PASSED]
test/test_h3_frame/test_h3_frame.cpp:94: test_build_data_and_goaway     [PASSED]
test/test_h3_frame/test_h3_frame.cpp:95: test_settings_roundtrip        [PASSED]
test/test_h3_frame/test_h3_frame.cpp:96: test_reserved                  [PASSED]
----------- native_h3frame:test_h3_frame [PASSED] Took 0.60 seconds ------------
...
---------------- native_jwt:test_jwt [PASSED] Took 0.64 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.636
================= 21 test cases: 21 succeeded in 00:00:00.636 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
------------- native_upload:test_upload [PASSED] Took 1.06 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.063
================== 3 test cases: 3 succeeded in 00:00:01.063 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.600
================= 15 test cases: 15 succeeded in 00:00:00.600 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.591
================= 22 test cases: 22 succeeded in 00:00:00.591 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.627
================= 16 test cases: 16 succeeded in 00:00:00.627 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.648
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.595
================= 12 test cases: 12 succeeded in 00:00:00.595 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.637
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.990
================= 71 test cases: 71 succeeded in 00:00:00.990 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.585
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.584
================= 14 test cases: 14 succeeded in 00:00:00.584 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.608
================== 4 test cases: 4 succeeded in 00:00:00.608 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.606
================= 11 test cases: 11 succeeded in 00:00:00.606 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.611
...
---------- native_dashboard:test_dashboard [PASSED] Took 0.59 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.592
================= 15 test cases: 15 succeeded in 00:00:00.592 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.592
================== 6 test cases: 6 succeeded in 00:00:00.592 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.591
================== 5 test cases: 5 succeeded in 00:00:00.591 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
--------------- native_cbor:test_cbor [PASSED] Took 0.59 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.585
================= 18 test cases: 18 succeeded in 00:00:00.585 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.582
================= 17 test cases: 17 succeeded in 00:00:00.582 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
----------- native_gpio_map:test_gpio_map [PASSED] Took 0.58 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.582
...
------ native_udp_telemetry:test_udp_telemetry [PASSED] Took 0.61 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.612
================== 7 test cases: 7 succeeded in 00:00:00.612 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_statsd  test_statsd  PASSED    00:00:00.651
================== 9 test cases: 9 succeeded in 00:00:00.651 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.595
...
---------- native_config_io:test_config_io [PASSED] Took 0.62 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.624
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.717
...
-------------- native_clock:test_clock [PASSED] Took 0.57 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.567
...
-------- native_concurrency:test_concurrency [PASSED] Took 0.70 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.701
================== 2 test cases: 2 succeeded in 00:00:00.701 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 161 tests
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.396
================== 2 test cases: 2 succeeded in 00:00:01.396 ==================
```
