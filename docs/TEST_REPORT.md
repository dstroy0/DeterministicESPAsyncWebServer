...
**Generated:** 2026-06-29 21:56:14
**Command:** `pio test` over 92 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1498 passed - 136s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:06.074 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.538 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.568 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.551 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.577 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.541 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.653 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:00.898 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.591 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.582 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:04.134 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.535 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.684 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.984 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.493 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.793 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.165 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.056 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.549 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.557 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.496 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.546 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.555 |
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.501 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.561 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.566 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.586 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.575 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.556 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.588 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.568 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.580 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.560 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.570 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.655 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.110 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.048 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.616 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.458 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.524 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.705 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.694 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.653 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.596 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.586 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.643 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.562 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.582 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.589 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.568 |
| `test_protobuf`          | `native_protobuf`       |    10 |   ✅   | 00:00:00.583 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.613 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.571 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.581 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.573 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.591 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.567 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.581 |
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.649 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.555 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.571 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.568 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.582 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.560 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.579 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.582 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.577 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.587 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.604 |
| `test_sparkplug`         | `native_sparkplug`      |     6 |   ✅   | 00:00:00.617 |
...
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.578 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.571 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.614 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.771 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.590 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.584 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.574 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.623 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.606 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.625 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:00.972 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:00.986 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.576 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.629 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.003 |
| `test_http_client`       | `native_http_client`    |    11 |   ✅   | 00:00:00.580 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.565 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.590 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.633 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.625 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.591 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.569 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.626 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:00.914 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.583 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.583 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.590 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.586 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.613 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.578 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.575 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.562 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.579 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.586 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.584 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.596 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.585 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.564 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.569 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.599 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.675 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.563 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.684 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.146 |
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.074
native         test_session       PASSED    00:00:00.538
native         test_presentation  PASSED    00:00:00.568
native         test_transport     PASSED    00:00:00.551
native         test_websocket     PASSED    00:00:00.577
native         test_http_parser   PASSED    00:00:00.541
================ 318 test cases: 318 succeeded in 00:00:08.849 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.653
...
-------- native_accept_gate:test_accept_gate [PASSED] Took 0.90 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.898
================= 10 test cases: 10 succeeded in 00:00:00.898 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.591
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.582
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 4.13 seconds -------------
...
----------- native_ssh:test_ssh_transport [PASSED] Took 0.98 seconds -----------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.134
native_ssh     test_ssh_auth       PASSED    00:00:00.535
native_ssh     test_ssh_server     PASSED    00:00:00.684
native_ssh     test_ssh_transport  PASSED    00:00:00.984
native_ssh     test_ssh_channel    PASSED    00:00:00.493
================= 93 test cases: 93 succeeded in 00:00:06.831 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.793
================== 2 test cases: 2 succeeded in 00:00:00.793 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.165
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.056
native_app     test_template          PASSED    00:00:00.549
native_app     test_path_params       PASSED    00:00:00.557
native_app     test_digest_vectors    PASSED    00:00:00.496
native_app     test_form_params       PASSED    00:00:00.546
native_app     test_iface             PASSED    00:00:00.555
native_app     test_json              PASSED    00:00:00.501
native_app     test_response_headers  PASSED    00:00:00.561
native_app     test_middleware        PASSED    00:00:00.566
native_app     test_digest_auth       PASSED    00:00:00.586
native_app     test_web_terminal      PASSED    00:00:00.575
native_app     test_defer             PASSED    00:00:00.556
native_app     test_multipart         PASSED    00:00:00.588
native_app     test_auth              PASSED    00:00:00.568
native_app     test_file_serving      PASSED    00:00:00.580
native_app     test_dispatch          PASSED    00:00:00.560
native_app     test_chunked           PASSED    00:00:00.570
native_app     test_application       PASSED    00:00:00.655
================ 219 test cases: 219 succeeded in 00:00:10.627 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.110
================= 12 test cases: 12 succeeded in 00:00:01.110 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.616
native_snmp    test_snmp_agent  PASSED    00:00:00.458
================= 30 test cases: 30 succeeded in 00:00:01.074 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 1.52 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.524
================= 10 test cases: 10 succeeded in 00:00:01.524 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.705
...
================= 29 test cases: 29 succeeded in 00:00:00.694 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.653
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.596
================= 19 test cases: 19 succeeded in 00:00:00.596 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
------------- native_modbus:test_modbus [PASSED] Took 0.59 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.586
================= 18 test cases: 18 succeeded in 00:00:00.586 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.643
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.582
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.589
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.568
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.583
================= 10 test cases: 10 succeeded in 00:00:00.583 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.613
================= 12 test cases: 12 succeeded in 00:00:00.613 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.571
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.581
...
================== 7 test cases: 7 succeeded in 00:00:00.573 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.591
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.581
================== 6 test cases: 6 succeeded in 00:00:00.581 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
test/test_hostlink/test_hostlink.cpp:30: test_build_dm_read: Expected '@00RD0000001057*\r' Was '@00RD0000001057*\r\x10\xEFU\xFF\x7F' [FAILED]
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  ERRORED   00:00:00.578

============= 8 test cases: 1 failed, 6 succeeded in 00:00:00.578 =============
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.649
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.555
================== 9 test cases: 9 succeeded in 00:00:00.555 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.568
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.582
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.579
================== 6 test cases: 6 succeeded in 00:00:00.579 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.582
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.577
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.587
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.604
...
-------- native_radio_power:test_radio_power [PASSED] Took 0.58 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.578
================== 2 test cases: 2 succeeded in 00:00:00.578 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
================= 12 test cases: 12 succeeded in 00:00:00.614 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.771
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.590
================= 11 test cases: 11 succeeded in 00:00:00.590 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.574
================== 7 test cases: 7 succeeded in 00:00:00.574 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.623
...
-------------- native_opcua:test_opcua [PASSED] Took 0.61 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.606
================= 29 test cases: 29 succeeded in 00:00:00.606 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.625
================= 11 test cases: 11 succeeded in 00:00:00.625 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:00.972
================= 10 test cases: 10 succeeded in 00:00:00.972 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:00.986
================= 13 test cases: 13 succeeded in 00:00:00.986 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.576
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.629
================= 12 test cases: 12 succeeded in 00:00:00.629 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.003
================== 3 test cases: 3 succeeded in 00:00:01.003 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.580
================= 11 test cases: 11 succeeded in 00:00:00.580 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
--------- native_compliance:test_compliance [PASSED] Took 0.56 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.565
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.590
================= 19 test cases: 19 succeeded in 00:00:00.590 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.633
================= 10 test cases: 10 succeeded in 00:00:00.633 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.625
================= 14 test cases: 14 succeeded in 00:00:00.625 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.569
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.914
================= 71 test cases: 71 succeeded in 00:00:00.914 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.583
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.590
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.586
================= 10 test cases: 10 succeeded in 00:00:00.586 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.613
================== 9 test cases: 9 succeeded in 00:00:00.613 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
---------- native_telemetry:test_telemetry [PASSED] Took 0.58 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.578
...
================= 11 test cases: 11 succeeded in 00:00:00.575 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.562
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.579
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.586
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.584
================= 15 test cases: 15 succeeded in 00:00:00.584 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.564
================== 6 test cases: 6 succeeded in 00:00:00.564 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.599
================== 4 test cases: 4 succeeded in 00:00:00.599 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
------------ native_workers:test_workers [PASSED] Took 0.67 seconds ------------
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.563
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.684
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.146
================== 2 test cases: 2 succeeded in 00:00:01.146 ==================
```
