...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:11.760 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.562 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.595 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.580 |
| `test_websocket`         | `native`               |    63 |   ✅   | 00:00:00.605 |
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.565 |
| `test_observability`     | `native_observability` |    15 |   ✅   | 00:00:00.701 |
| `test_http_ota`          | `native_ota`           |     3 |   ✅   | 00:00:00.648 |
| `test_provisioning`      | `native_prov`          |     5 |   ✅   | 00:00:00.653 |
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.851 |
| `test_ssh_auth`          | `native_ssh`           |    12 |   ✅   | 00:00:00.556 |
| `test_ssh_server`        | `native_ssh`           |     7 |   ✅   | 00:00:00.667 |
| `test_ssh_transport`     | `native_ssh`           |    23 |   ✅   | 00:00:00.879 |
| `test_ssh_channel`       | `native_ssh`           |    12 |   ✅   | 00:00:00.523 |
...
| `test_form_params`       | `native_app`           |     5 |   ✅   | 00:00:00.585 |
| `test_iface`             | `native_app`           |     7 |   ✅   | 00:00:00.583 |
| `test_json`              | `native_app`           |    17 |   ✅   | 00:00:00.536 |
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.583 |
| `test_middleware`        | `native_app`           |     9 |   ✅   | 00:00:00.587 |
| `test_digest_auth`       | `native_app`           |     5 |   ✅   | 00:00:00.591 |
| `test_web_terminal`      | `native_app`           |     7 |   ✅   | 00:00:00.579 |
...
| `test_dispatch`          | `native_app`           |    11 |   ✅   | 00:00:00.586 |
| `test_chunked`           | `native_app`           |    10 |   ✅   | 00:00:00.591 |
| `test_application`       | `native_app`           |    50 |   ✅   | 00:00:00.660 |
| `test_snmp_ber`          | `native_snmp`          |     9 |   ✅   | 00:00:00.668 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.484 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.370 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.763 |
| `test_coap`              | `native_coap`          |    26 |   ✅   | 00:00:00.645 |
| `test_webdav`            | `native_webdav`        |    19 |   ✅   | 00:00:00.657 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.655 |
...
| `test_radio_power`       | `native_radio_power`   |     2 |   ✅   | 00:00:00.640 |
| `test_dns_resolver`      | `native_dns_resolver`  |     4 |   ✅   | 00:00:00.643 |
| `test_audit_log`         | `native_audit_log`     |    12 |   ✅   | 00:00:00.654 |
| `test_oidc`              | `native_oidc`          |    13 |   ✅   | 00:00:00.818 |
...
| `test_opcua`             | `native_opcua`         |    29 |   ✅   | 00:00:00.685 |
| `test_opcua_client`      | `native_opcua_client`  |    11 |   ✅   | 00:00:00.676 |
| `test_keepalive`         | `native_keepalive`     |    10 |   ✅   | 00:00:01.042 |
| `test_range`             | `native_range`         |    10 |   ✅   | 00:00:01.059 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.647 |
| `test_jwt`               | `native_jwt`           |    10 |   ✅   | 00:00:00.682 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.082 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.642 |
| `test_compliance`        | `native_compliance`    |    12 |   ✅   | 00:00:00.643 |
| `test_mqtt`              | `native_mqtt`          |    16 |   ✅   | 00:00:00.635 |
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.672 |
| `test_scratch`           | `native_scratch`       |    14 |   ✅   | 00:00:00.666 |
| `test_snmp_trap`         | `native_snmp_trap`     |     3 |   ✅   | 00:00:00.654 |
| `test_inflate`           | `native_inflate`       |    12 |   ✅   | 00:00:00.641 |
| `test_deflate`           | `native_deflate`       |    10 |   ✅   | 00:00:00.675 |
| `test_websocket`         | `native_ws_deflate`    |    67 |   ✅   | 00:00:01.002 |
| `test_time_source`       | `native_time_source`   |     9 |   ✅   | 00:00:00.665 |
| `test_config_store`      | `native_config_store`  |    14 |   ✅   | 00:00:00.637 |
| `test_device_id`         | `native_device_id`     |     4 |   ✅   | 00:00:00.664 |
| `test_auth_lockout`      | `native_auth_lockout`  |    10 |   ✅   | 00:00:00.633 |
| `test_csrf`              | `native_csrf`          |     9 |   ✅   | 00:00:00.661 |
| `test_telemetry`         | `native_telemetry`     |     8 |   ✅   | 00:00:00.655 |
| `test_dashboard`         | `native_dashboard`     |    11 |   ✅   | 00:00:00.645 |
| `test_net_egress`        | `native_net_egress`    |     5 |   ✅   | 00:00:00.636 |
...
| `test_clock`             | `native_clock`         |     4 |   ✅   | 00:00:00.638 |
| `test_concurrency`       | `native_concurrency`   |     2 |   ✅   | 00:00:00.802 |
| `test_concurrency`       | `native_tsan`          |     2 |   ✅   | 00:00:01.118 |
...
----------------- native:test_sse [PASSED] Took 11.76 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:11.760
native         test_session       PASSED    00:00:00.562
...
================ 306 test cases: 306 succeeded in 00:00:14.666 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.701
...
native_ssh     test_ssh_server     PASSED    00:00:00.667
native_ssh     test_ssh_transport  PASSED    00:00:00.879
native_ssh     test_ssh_channel    PASSED    00:00:00.523
...
native_app     test_form_params       PASSED    00:00:00.585
native_app     test_iface             PASSED    00:00:00.583
native_app     test_json              PASSED    00:00:00.536
native_app     test_response_headers  PASSED    00:00:00.583
native_app     test_middleware        PASSED    00:00:00.587
native_app     test_digest_auth       PASSED    00:00:00.591
...
native_app     test_dispatch          PASSED    00:00:00.586
native_app     test_chunked           PASSED    00:00:00.591
native_app     test_application       PASSED    00:00:00.660
================ 204 test cases: 204 succeeded in 00:00:11.030 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.370
================== 9 test cases: 9 succeeded in 00:00:01.370 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.645
================= 26 test cases: 26 succeeded in 00:00:00.645 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.640
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.654
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.818
...
================= 29 test cases: 29 succeeded in 00:00:00.685 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.059
================= 10 test cases: 10 succeeded in 00:00:01.059 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.082
================== 3 test cases: 3 succeeded in 00:00:01.082 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
================= 16 test cases: 16 succeeded in 00:00:00.635 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.666
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.641
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.675
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.665
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.637
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.636
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.118
================== 2 test cases: 2 succeeded in 00:00:01.118 ==================
```
