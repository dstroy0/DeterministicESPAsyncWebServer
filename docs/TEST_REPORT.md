...
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.550 |
...
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.556 |
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.528 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.559 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.557 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.572 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.553 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.551 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.647 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.649 |
| `test_workers`          | `native_workers`      |     3 |   ✅   | 00:00:00.710 |
| `test_concurrency`      | `native_tsan`         |     2 |   ✅   | 00:00:01.364 |
...
----------------- native:test_sse [PASSED] Took 12.69 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:12.686
native               test_session           PASSED    00:00:00.550
native               test_presentation      PASSED    00:00:00.583
...
native_ssh           test_ssh_transport     PASSED    00:00:00.868
...
native_app           test_template          PASSED    00:00:00.550
native_app           test_path_params       PASSED    00:00:00.557
native_app           test_digest_vectors    PASSED    00:00:00.499
...
native_app           test_middleware        PASSED    00:00:00.560
native_app           test_digest_auth       PASSED    00:00:00.574
native_app           test_web_terminal      PASSED    00:00:00.556
native_app           test_defer             PASSED    00:00:00.528
native_app           test_multipart         PASSED    00:00:00.559
native_app           test_auth              PASSED    00:00:00.557
...
native_workers       test_workers           PASSED    00:00:00.710
native_tsan          test_concurrency       PASSED    00:00:01.364
================ 619 test cases: 619 succeeded in 00:00:37.261 ================
```
