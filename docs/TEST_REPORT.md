...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:06.556 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.495 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.530 |
| `test_transport`        | `native`              |    34 |   ✅   | 00:00:00.518 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.536 |
| `test_http_parser`      | `native`              |    80 |   ✅   | 00:00:00.535 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.828 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.544 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.648 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.850 |
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.505 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.799 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.062 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.940 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.520 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.527 |
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.496 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.511 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.524 |
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.531 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.533 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.516 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.524 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.522 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.533 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.531 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.547 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.547 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.544 |
| `test_application`      | `native_app`          |    49 |   ✅   | 00:00:00.641 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.640 |
...
------------------ native:test_sse [PASSED] Took 6.56 seconds ------------------
...
------------ native_app:test_digest_auth [PASSED] Took 0.52 seconds ------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:06.556
native               test_session           PASSED    00:00:00.495
native               test_presentation      PASSED    00:00:00.530
native               test_transport         PASSED    00:00:00.518
native               test_websocket         PASSED    00:00:00.536
native               test_http_parser       PASSED    00:00:00.535
native_ssh           test_ssh_crypto        PASSED    00:00:03.828
native_ssh           test_ssh_auth          PASSED    00:00:00.544
native_ssh           test_ssh_server        PASSED    00:00:00.648
native_ssh           test_ssh_transport     PASSED    00:00:00.850
native_ssh           test_ssh_channel       PASSED    00:00:00.505
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.799
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.062
native_app           test_regex             PASSED    00:00:00.940
native_app           test_template          PASSED    00:00:00.520
native_app           test_path_params       PASSED    00:00:00.527
native_app           test_digest_vectors    PASSED    00:00:00.496
native_app           test_form_params       PASSED    00:00:00.511
native_app           test_iface             PASSED    00:00:00.524
native_app           test_json              PASSED    00:00:00.531
native_app           test_response_headers  PASSED    00:00:00.533
native_app           test_middleware        PASSED    00:00:00.516
native_app           test_digest_auth       PASSED    00:00:00.524
native_app           test_web_terminal      PASSED    00:00:00.522
native_app           test_multipart         PASSED    00:00:00.533
native_app           test_auth              PASSED    00:00:00.531
native_app           test_file_serving      PASSED    00:00:00.547
native_app           test_dispatch          PASSED    00:00:00.547
...
================ 600 test cases: 600 succeeded in 00:00:27.534 ================
```
