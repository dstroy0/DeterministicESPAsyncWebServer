...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:16.185 |
...
| `test_ssh_crypto`       | `native_ssh`          |    38 |   ✅   | 00:00:03.825 |
...
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:01.045 |
...
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.547 |
...
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.559 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.559 |
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.530 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.560 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.571 |
...
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.642 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.619 |
...
----------------- native:test_sse [PASSED] Took 16.19 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:16.185
...
native_app           test_regex             PASSED    00:00:01.045
...
native_app           test_form_params       PASSED    00:00:00.547
...
native_app           test_auth              PASSED    00:00:00.571
...
native_app           test_application       PASSED    00:00:00.642
...
================ 621 test cases: 621 succeeded in 00:00:40.573 ================
```
