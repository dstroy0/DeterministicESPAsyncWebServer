...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:13.736 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.717 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.720 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.732 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:03.648 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.706 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.679 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.692 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.696 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.710 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.713 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.732 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.707 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.705 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.712 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.692 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.096 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.641 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.668 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.640 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.646 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.617 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.810 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:01.074 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.718 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.701 |
| `test_ssh_crypto`        | `native_ssh`            |    45 |   ✅   | 00:00:03.905 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.673 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.933 |
| `test_ssh_transport`     | `native_ssh`            |    33 |   ✅   | 00:00:01.219 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.705 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.060 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.481 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.258 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.659 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.653 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.593 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.623 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.622 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.621 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.663 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.666 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.683 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.668 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.629 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.652 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.683 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.657 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.640 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.657 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.744 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.273 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.272 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.746 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.578 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:02.155 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.879 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:01.044 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.810 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.709 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.697 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.765 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.690 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.671 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.679 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.703 |
...
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.892 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.794 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.706 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.703 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.704 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.697 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.682 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.687 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.686 |
...
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.689 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.714 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.714 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.700 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.704 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.765 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.713 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.699 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.754 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.690 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.698 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.706 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.673 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.679 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.683 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.674 |
...
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.718 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.712 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.709 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.697 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.717 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.932 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.687 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.684 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.677 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.712 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.701 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.719 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.152 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.189 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.726 |
| `test_smtp`              | `native_smtp`           |    11 |   ✅   | 00:00:00.834 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.695 |
| `test_dns_server`        | `native_dns_server`     |     7 |   ✅   | 00:00:00.689 |
| `test_rtc`               | `native_rtc`            |     8 |   ✅   | 00:00:00.675 |
| `test_ld2410`            | `native_ld2410`         |     7 |   ✅   | 00:00:00.698 |
| `test_mpr121`            | `native_mpr121`         |     5 |   ✅   | 00:00:00.685 |
| `test_sht3x`             | `native_sht3x`          |     5 |   ✅   | 00:00:00.686 |
| `test_pca9685`           | `native_pca9685`        |     4 |   ✅   | 00:00:00.672 |
| `test_ads1115`           | `native_ads1115`        |     3 |   ✅   | 00:00:00.665 |
| `test_ina219`            | `native_ina219`         |     4 |   ✅   | 00:00:00.669 |
| `test_hpack`             | `native_hpack`          |     7 |   ✅   | 00:00:00.777 |
| `test_h2_frame`          | `native_h2frame`        |     6 |   ✅   | 00:00:00.680 |
...
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.763 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.196 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.727 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.713 |
...
| `test_ssh_zlib`          | `native_ssh_zlib`       |     9 |   ✅   | 00:00:00.737 |
| `test_ssh_comp`          | `native_ssh_comp`       |     5 |   ✅   | 00:00:01.074 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.125 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.683 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.697 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.715 |
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.709 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.756 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.730 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.662 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.687 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.680 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.685 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.682 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.675 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.669 |
...
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.716 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.823 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.697 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.852 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.371 |
| `test_qpack`             | `native_qpack`          |     9 |   ✅   | 00:00:00.813 |
| `test_quic_packet`       | `native_quic_packet`    |     8 |   ✅   | 00:00:00.714 |
| `test_quic_frame`        | `native_quic_frame`     |     8 |   ✅   | 00:00:00.687 |
| `test_quic_crypto`       | `native_quic_crypto`    |     7 |   ✅   | 00:00:00.778 |
| `test_tls13_kdf`         | `native_tls13_kdf`      |     5 |   ✅   | 00:00:00.711 |
| `test_quic_tp`           | `native_quic_tp`        |     7 |   ✅   | 00:00:00.698 |
| `test_tls13_msg`         | `native_tls13_msg`      |     7 |   ✅   | 00:00:00.779 |
| `test_quic_tls`          | `native_quic_tls`       |    11 |   ✅   | 00:00:00.963 |
| `test_quic_conn`         | `native_quic_conn`      |     4 |   ✅   | 00:00:01.028 |
| `test_h3_conn`           | `native_h3_conn`        |    11 |   ✅   | 00:00:01.000 |
| `test_h3_e2e`            | `native_h3_e2e`         |     1 |   ✅   | 00:00:01.028 |
| `test_quic_server`       | `native_quic_server`    |     2 |   ✅   | 00:00:01.085 |
| `test_h3_server`         | `native_h3_server`      |     1 |   ✅   | 00:00:01.561 |
| `test_ssh_chachapoly`    | `native_ssh_chachapoly` |     4 |   ✅   | 00:00:00.692 |
...
----------- native_canopen:test_canopen [PASSED] Took 13.74 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:13.736
================= 17 test cases: 17 succeeded in 00:00:13.736 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.717
...
------------- native_det_ip:test_det_ip [PASSED] Took 0.72 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.720
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_det_arena  test_det_arena  PASSED    00:00:00.732
...
-------- native_ssh_ed25519:test_ssh_ed25519 [PASSED] Took 3.65 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:03.648
================= 16 test cases: 16 succeeded in 00:00:03.648 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.706
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.679
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.696
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.713
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.732
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.705
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.712
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.692
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.096
native         test_session       PASSED    00:00:00.641
native         test_presentation  PASSED    00:00:00.668
native         test_transport     PASSED    00:00:00.640
native         test_websocket     PASSED    00:00:00.646
native         test_http_parser   PASSED    00:00:00.617
================ 323 test cases: 323 succeeded in 00:00:04.308 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.810
================= 17 test cases: 17 succeeded in 00:00:00.810 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.074
================= 13 test cases: 13 succeeded in 00:00:01.074 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.701
...
------------ native_ssh:test_ssh_channel [PASSED] Took 0.71 seconds ------------

=================================== SUMMARY ===================================
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.905
native_ssh     test_ssh_auth       PASSED    00:00:00.673
native_ssh     test_ssh_server     PASSED    00:00:00.933
native_ssh     test_ssh_transport  PASSED    00:00:01.219
native_ssh     test_ssh_channel    PASSED    00:00:00.705
================ 145 test cases: 145 succeeded in 00:00:07.435 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:01.060
================== 2 test cases: 2 succeeded in 00:00:01.060 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.481
================== 2 test cases: 2 succeeded in 00:00:01.481 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
---------- native_app:test_digest_vectors [PASSED] Took 0.59 seconds -----------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.258
native_app     test_template          PASSED    00:00:00.659
native_app     test_path_params       PASSED    00:00:00.653
native_app     test_digest_vectors    PASSED    00:00:00.593
...
native_app     test_response_headers  PASSED    00:00:00.663
native_app     test_middleware        PASSED    00:00:00.666
native_app     test_digest_auth       PASSED    00:00:00.683
native_app     test_web_terminal      PASSED    00:00:00.668
native_app     test_defer             PASSED    00:00:00.629
native_app     test_multipart         PASSED    00:00:00.652
native_app     test_auth              PASSED    00:00:00.683
native_app     test_file_serving      PASSED    00:00:00.657
native_app     test_dispatch          PASSED    00:00:00.640
native_app     test_chunked           PASSED    00:00:00.657
native_app     test_application       PASSED    00:00:00.744
================ 225 test cases: 225 succeeded in 00:00:12.372 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.273
================= 12 test cases: 12 succeeded in 00:00:01.273 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
native_snmp    test_snmp_agent  PASSED    00:00:00.578
================= 35 test cases: 35 succeeded in 00:00:01.324 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 2.16 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:02.155
================= 15 test cases: 15 succeeded in 00:00:02.155 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
================= 15 test cases: 15 succeeded in 00:00:00.879 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:01.044
================= 41 test cases: 41 succeeded in 00:00:01.044 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.709
================= 19 test cases: 19 succeeded in 00:00:00.709 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.765
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.690
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.703
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.892
================= 16 test cases: 16 succeeded in 00:00:00.892 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.794
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.706
================= 13 test cases: 13 succeeded in 00:00:00.706 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.704
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_pn532   test_pn532  PASSED    00:00:00.697
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.682
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_zigbee  test_zigbee  PASSED    00:00:00.686
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.689
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.714
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.714
================= 11 test cases: 11 succeeded in 00:00:00.714 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.700
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.704
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.765
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.713
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.754
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.698
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.706
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.679
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.683
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.674
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.718
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.712
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.709
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.697
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.717
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.932
================= 17 test cases: 17 succeeded in 00:00:00.932 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.712
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.719
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.189
================= 13 test cases: 13 succeeded in 00:00:01.189 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.726
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_smtp    test_smtp  PASSED    00:00:00.834
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_ntp_server  test_ntp_server  PASSED    00:00:00.695
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_dns_server  test_dns_server  PASSED    00:00:00.689
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_rtc     test_rtc  PASSED    00:00:00.675
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ld2410  test_ld2410  PASSED    00:00:00.698
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sht3x   test_sht3x  PASSED    00:00:00.686
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_pca9685  test_pca9685  PASSED    00:00:00.672
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_ads1115  test_ads1115  PASSED    00:00:00.665
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ina219  test_ina219  PASSED    00:00:00.669
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_hpack   test_hpack  PASSED    00:00:00.777
...
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h2frame  test_h2_frame  PASSED    00:00:00.680
...
---------------- native_jwt:test_jwt [PASSED] Took 0.76 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.763
================= 21 test cases: 21 succeeded in 00:00:00.763 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.196
================== 3 test cases: 3 succeeded in 00:00:01.196 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.713
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_zlib  test_ssh_zlib  PASSED    00:00:00.737
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.125
================= 71 test cases: 71 succeeded in 00:00:01.125 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.715
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.709
================= 11 test cases: 11 succeeded in 00:00:00.709 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.756
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.730
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.685
================= 18 test cases: 18 succeeded in 00:00:00.685 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.682
================= 17 test cases: 17 succeeded in 00:00:00.682 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.716
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.697
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.371
================== 2 test cases: 2 succeeded in 00:00:01.371 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_qpack   test_qpack  PASSED    00:00:00.813
================== 9 test cases: 9 succeeded in 00:00:00.813 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_crypto  test_quic_crypto  PASSED    00:00:00.778
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_tls13_kdf  test_tls13_kdf  PASSED    00:00:00.711
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_tls13_msg  test_tls13_msg  PASSED    00:00:00.779
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_quic_conn  test_quic_conn  PASSED    00:00:01.028
================== 4 test cases: 4 succeeded in 00:00:01.028 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_h3_conn  test_h3_conn  PASSED    00:00:01.000
================= 11 test cases: 11 succeeded in 00:00:01.000 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_h3_e2e  test_h3_e2e  PASSED    00:00:01.028
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_server  test_quic_server  PASSED    00:00:01.085
================== 2 test cases: 2 succeeded in 00:00:01.085 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_h3_server  test_h3_server  PASSED    00:00:01.561
================== 1 test cases: 1 succeeded in 00:00:01.561 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_ssh_chachapoly  test_ssh_chachapoly  PASSED    00:00:00.692
