...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:05.727 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.646 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.672 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.680 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.716 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.664 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.683 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.683 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.678 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.674 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.678 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.020 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.598 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.638 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.657 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.670 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.632 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.762 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:01.027 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.689 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.707 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.901 |
| `test_ssh_auth`          | `native_ssh`            |    18 |   ✅   | 00:00:00.603 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.853 |
| `test_ssh_transport`     | `native_ssh`            |    27 |   ✅   | 00:00:01.081 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.567 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.907 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.293 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.219 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.631 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.634 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.569 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.628 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.624 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.590 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.636 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.644 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.666 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.652 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.626 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.644 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.636 |
...
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.721 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.259 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.190 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.712 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.532 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:01.985 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.815 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.815 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.754 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.690 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.683 |
...
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.665 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.678 |
| `test_preempt_queue`     | `native_preempt_queue`  |     7 |   ✅   | 00:00:00.713 |
...
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.648 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.678 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.654 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.654 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.707 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.644 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.654 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.650 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.644 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.645 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.654 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.657 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.664 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.656 |
...
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.640 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.691 |
...
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.106 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.650 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.664 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.646 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.676 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.701 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.665 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.657 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.703 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.056 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.668 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.653 |
...
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.674 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.663 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.653 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.651 |
...
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.658 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.653 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.650 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.672 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.768 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.637 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.777 |
...
------------ native_canopen:test_canopen [PASSED] Took 5.73 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:05.727
================= 17 test cases: 17 succeeded in 00:00:05.727 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.646
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.716
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.678
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:01.020
native         test_session       PASSED    00:00:00.598
native         test_presentation  PASSED    00:00:00.638
native         test_transport     PASSED    00:00:00.657
native         test_websocket     PASSED    00:00:00.670
native         test_http_parser   PASSED    00:00:00.632
================ 321 test cases: 321 succeeded in 00:00:04.216 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.762
================= 17 test cases: 17 succeeded in 00:00:00.762 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.027
================= 10 test cases: 10 succeeded in 00:00:01.027 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.707
...
native_ssh     test_ssh_server     PASSED    00:00:00.853
native_ssh     test_ssh_transport  PASSED    00:00:01.081
native_ssh     test_ssh_channel    PASSED    00:00:00.567
================ 120 test cases: 120 succeeded in 00:00:07.005 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.907
================== 2 test cases: 2 succeeded in 00:00:00.907 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.293
================== 2 test cases: 2 succeeded in 00:00:01.293 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.219
native_app     test_template          PASSED    00:00:00.631
native_app     test_path_params       PASSED    00:00:00.634
native_app     test_digest_vectors    PASSED    00:00:00.569
native_app     test_form_params       PASSED    00:00:00.628
native_app     test_iface             PASSED    00:00:00.624
native_app     test_json              PASSED    00:00:00.590
native_app     test_response_headers  PASSED    00:00:00.636
native_app     test_middleware        PASSED    00:00:00.644
native_app     test_digest_auth       PASSED    00:00:00.666
native_app     test_web_terminal      PASSED    00:00:00.652
native_app     test_defer             PASSED    00:00:00.626
native_app     test_multipart         PASSED    00:00:00.644
native_app     test_auth              PASSED    00:00:00.636
...
native_app     test_application       PASSED    00:00:00.721
================ 225 test cases: 225 succeeded in 00:00:12.011 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.259
================= 12 test cases: 12 succeeded in 00:00:01.259 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.190
...
================= 35 test cases: 35 succeeded in 00:00:01.244 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 1.98 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.985
================= 15 test cases: 15 succeeded in 00:00:01.985 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
================= 15 test cases: 15 succeeded in 00:00:00.815 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.815
================= 41 test cases: 41 succeeded in 00:00:00.815 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.754
================= 41 test cases: 41 succeeded in 00:00:00.754 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.683
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.665
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.713
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.648
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.654
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.654
================== 6 test cases: 6 succeeded in 00:00:00.654 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.650
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.644
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.654
================== 6 test cases: 6 succeeded in 00:00:00.654 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.656
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.640
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.691
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.106
================== 3 test cases: 3 succeeded in 00:00:01.106 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.650
================= 15 test cases: 15 succeeded in 00:00:00.650 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.664
...
================= 22 test cases: 22 succeeded in 00:00:00.646 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.676
================= 16 test cases: 16 succeeded in 00:00:00.676 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.056
================= 71 test cases: 71 succeeded in 00:00:01.056 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.653
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.674
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.663
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.651
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.658
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.653
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.672
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.637
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.777
================== 2 test cases: 2 succeeded in 00:00:00.777 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
