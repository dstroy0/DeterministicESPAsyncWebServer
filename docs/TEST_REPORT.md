...
**Generated:** 2026-06-29 23:00:09
**Command:** `pio test` over 96 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1532 passed - 164s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    11 |   ✅   | 00:00:06.486 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.642 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.649 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.667 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:00.982 |
...
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.583 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.753 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:00.984 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.648 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.672 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.898 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.580 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.666 |
...
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.578 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.653 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.622 |
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.581 |
...
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.637 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.635 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.638 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.629 |
...
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.170 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.736 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.550 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.494 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.823 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.776 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.794 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.692 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.695 |
...
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.671 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.679 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.679 |
| `test_sparkplug`         | `native_sparkplug`      |     6 |   ✅   | 00:00:00.699 |
...
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.683 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.695 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.902 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.699 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.664 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.682 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.712 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.713 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.724 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.141 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.138 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.703 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.755 |
...
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.744 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.746 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.696 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.691 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.747 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.064 |
...
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.659 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.665 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.658 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.704 |
...
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.217 |
...
------------ native_canopen:test_canopen [PASSED] Took 6.49 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.486
================= 11 test cases: 11 succeeded in 00:00:06.486 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 121 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.642
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:00.982
...
================ 318 test cases: 318 succeeded in 00:00:03.977 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 121 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.753
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.984
================= 10 test cases: 10 succeeded in 00:00:00.984 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 121 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.672
...
================= 93 test cases: 93 succeeded in 00:00:06.575 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 121 tests
...
native_app     test_digest_vectors    PASSED    00:00:00.578
native_app     test_form_params       PASSED    00:00:00.653
native_app     test_iface             PASSED    00:00:00.622
native_app     test_json              PASSED    00:00:00.581
...
native_app     test_web_terminal      PASSED    00:00:00.637
native_app     test_defer             PASSED    00:00:00.635
native_app     test_multipart         PASSED    00:00:00.638
native_app     test_auth              PASSED    00:00:00.629
...
================ 219 test cases: 219 succeeded in 00:00:11.997 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 121 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.170
================== 2 test cases: 2 succeeded in 00:00:01.170 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 121 tests
...
================= 30 test cases: 30 succeeded in 00:00:01.287 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 121 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.494
================= 10 test cases: 10 succeeded in 00:00:01.494 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 121 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.776
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.695
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.689
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.708
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.665
...
test/test_hostlink/test_hostlink.cpp:30: test_build_dm_read: Expected '@00RD0000001057*\r' Was '@00RD0000001057*\rxh\xD8\xFE\x7F' [FAILED]
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  ERRORED   00:00:00.667

============= 8 test cases: 1 failed, 6 succeeded in 00:00:00.667 =============
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 121 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.677
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.671
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.683
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.724
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.141
================= 10 test cases: 10 succeeded in 00:00:01.141 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 121 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.138
================= 13 test cases: 13 succeeded in 00:00:01.138 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 121 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.703
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.755
================= 12 test cases: 12 succeeded in 00:00:00.755 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 121 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.744
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.747
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.064
================= 71 test cases: 71 succeeded in 00:00:01.064 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 121 tests
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.659
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.704
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.217
================== 2 test cases: 2 succeeded in 00:00:01.217 ==================
```
