...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:06.658 |
...
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.723 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.650 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.658 |
| `test_ssh_crypto`        | `native_ssh`            |    38 |   ✅   | 00:00:03.744 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.557 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.694 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.921 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.533 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.863 |
...
| `test_response_headers`  | `native_app`            |     9 |   ✅   | 00:00:00.610 |
...
| `test_webdav_handler`    | `native_webdav_handler` |     5 |   ✅   | 00:00:01.155 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.115 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.676 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.497 |
| `test_snmp_v3`           | `native_snmp_v3`        |     9 |   ✅   | 00:00:01.409 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.781 |
| `test_coap`              | `native_coap`           |    27 |   ✅   | 00:00:00.676 |
| `test_coap`              | `native_coap_observe`   |    27 |   ✅   | 00:00:00.678 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.657 |
| `test_modbus`            | `native_modbus`         |    13 |   ✅   | 00:00:00.656 |
...
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.062 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.646 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.688 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.084 |
| `test_http_client`       | `native_http_client`    |    10 |   ✅   | 00:00:00.656 |
...
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.006 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.638 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.632 |
...
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.641 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.642 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     4 |   ✅   | 00:00:00.646 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.651 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.635 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.664 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.749 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.634 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.826 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.637 |
...
------------------ native:test_sse [PASSED] Took 6.66 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.658
...
================ 310 test cases: 310 succeeded in 00:00:09.615 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.723
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.744
native_ssh     test_ssh_auth       PASSED    00:00:00.557
native_ssh     test_ssh_server     PASSED    00:00:00.694
native_ssh     test_ssh_transport  PASSED    00:00:00.921
native_ssh     test_ssh_channel    PASSED    00:00:00.533
================= 92 test cases: 92 succeeded in 00:00:06.449 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.863
================== 2 test cases: 2 succeeded in 00:00:00.863 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
================ 217 test cases: 217 succeeded in 00:00:11.282 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.155
================== 5 test cases: 5 succeeded in 00:00:01.155 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.115
================== 2 test cases: 2 succeeded in 00:00:01.115 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
================= 29 test cases: 29 succeeded in 00:00:01.172 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
================== 9 test cases: 9 succeeded in 00:00:01.409 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.678
================= 27 test cases: 27 succeeded in 00:00:00.678 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.062
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.084
================== 3 test cases: 3 succeeded in 00:00:01.084 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
================= 71 test cases: 71 succeeded in 00:00:01.006 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.632
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.641
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.635
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.749
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.826
================== 2 test cases: 2 succeeded in 00:00:00.826 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 1.64 seconds ------------

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.637
================== 2 test cases: 2 succeeded in 00:00:01.637 ==================
```
