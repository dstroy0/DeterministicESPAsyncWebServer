...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:11.027 |
...
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.824 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.559 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.659 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.881 |
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.515 |
...
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.522 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.558 |
...
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.546 |
...
| `test_workers`          | `native_workers`      |     3 |   ✅   | 00:00:00.706 |
| `test_concurrency`      | `native_tsan`         |     2 |   ✅   | 00:00:01.199 |
...
----------------- native:test_sse [PASSED] Took 11.03 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:11.027
...
native_ssh           test_ssh_transport     PASSED    00:00:00.881
...
native_app           test_json              PASSED    00:00:00.522
native_app           test_response_headers  PASSED    00:00:00.558
...
native_app           test_defer             PASSED    00:00:00.546
...
native_workers       test_workers           PASSED    00:00:00.706
native_tsan          test_concurrency       PASSED    00:00:01.199
================ 620 test cases: 620 succeeded in 00:00:35.658 ================
```
