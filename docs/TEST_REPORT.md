...
**Generated:** 2026-06-29 17:30:39
**Command:** `pio test` over 71 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1342 passed - 113s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:06.275 |
...
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.637 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.640 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.907 |
...
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.856 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.235 |
...
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.590 |
...
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.565 |
...
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.577 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.591 |
...
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.690 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.497 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.463 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.772 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.717 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.717 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.637 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.647 |
...
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.643 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.634 |
| `test_protobuf`          | `native_protobuf`       |     8 |   ✅   | 00:00:00.634 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.662 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.628 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.651 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.637 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.630 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.623 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.662 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.832 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.641 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.651 |
...
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.724 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.119 |
...
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.675 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.676 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.660 |
...
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.624 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.633 |
...
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.638 |
...
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.624 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.620 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.651 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.734 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.617 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.746 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.089 |
...
------------------ native:test_sse [PASSED] Took 6.28 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.275
...
================ 318 test cases: 318 succeeded in 00:00:09.192 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 96 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.637
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.907
...
================= 93 test cases: 93 succeeded in 00:00:06.485 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 96 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.856
================== 2 test cases: 2 succeeded in 00:00:00.856 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 96 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.235
================== 2 test cases: 2 succeeded in 00:00:01.235 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 96 tests
...
native_app     test_defer             PASSED    00:00:00.565
...
================ 219 test cases: 219 succeeded in 00:00:11.175 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 96 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.463
================= 10 test cases: 10 succeeded in 00:00:01.463 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 96 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.717
================= 29 test cases: 29 succeeded in 00:00:00.717 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 96 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.717
================= 29 test cases: 29 succeeded in 00:00:00.717 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 96 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.647
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.634
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.662
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.628
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.637
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.630
================== 2 test cases: 2 succeeded in 00:00:00.630 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 96 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.623
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.662
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.119
================== 3 test cases: 3 succeeded in 00:00:01.119 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 96 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.675
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.660
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.624
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.638
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.624
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.620
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.651
================== 4 test cases: 4 succeeded in 00:00:00.651 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 96 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.746
================== 2 test cases: 2 succeeded in 00:00:00.746 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 96 tests
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.089
