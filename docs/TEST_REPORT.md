...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:05.940 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.532 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.560 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.546 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.570 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.529 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.708 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.548 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.677 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:01.004 |
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.520 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.830 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.194 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:01.039 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.547 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.550 |
...
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.508 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.555 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.552 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.552 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.548 |
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.528 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.556 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.556 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.570 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.552 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.559 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.657 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.633 |
...
------------------ native:test_sse [PASSED] Took 5.94 seconds ------------------
...
----------- native_ssh:test_ssh_transport [PASSED] Took 1.00 seconds -----------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:05.940
native               test_session           PASSED    00:00:00.532
native               test_presentation      PASSED    00:00:00.560
...
native_ssh           test_ssh_crypto        PASSED    00:00:03.708
native_ssh           test_ssh_auth          PASSED    00:00:00.548
native_ssh           test_ssh_server        PASSED    00:00:00.677
native_ssh           test_ssh_transport     PASSED    00:00:01.004
native_ssh           test_ssh_channel       PASSED    00:00:00.520
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.830
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.194
...
native_app           test_response_headers  PASSED    00:00:00.555
native_app           test_middleware        PASSED    00:00:00.552
native_app           test_digest_auth       PASSED    00:00:00.552
native_app           test_web_terminal      PASSED    00:00:00.548
native_app           test_defer             PASSED    00:00:00.528
native_app           test_multipart         PASSED    00:00:00.556
native_app           test_auth              PASSED    00:00:00.556
native_app           test_file_serving      PASSED    00:00:00.570
native_app           test_dispatch          PASSED    00:00:00.552
native_app           test_chunked           PASSED    00:00:00.559
...
================ 619 test cases: 619 succeeded in 00:00:30.138 ================
```
