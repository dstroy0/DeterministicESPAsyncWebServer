...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:11.007 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.479 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.496 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.496 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.508 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.481 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:02.960 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.503 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.610 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.764 |
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.460 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.750 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.082 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.863 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.463 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.462 |
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.430 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.463 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.445 |
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.440 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.473 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.463 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.482 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.450 |
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.423 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.458 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.467 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.472 |
| `test_dispatch`         | `native_app`          |    11 |   ✅   | 00:00:00.451 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.483 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.546 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.542 |
| `test_workers`          | `native_workers`      |     3 |   ✅   | 00:00:00.571 |
| `test_concurrency`      | `native_tsan`         |     2 |   ✅   | 00:00:00.982 |
...
----------------- native:test_sse [PASSED] Took 11.01 seconds ------------------
...
------------ native_ssh:test_ssh_server [PASSED] Took 0.61 seconds -------------
...
--------------- native_app:test_regex [PASSED] Took 0.86 seconds ---------------
...
----------- native_tsan:test_concurrency [PASSED] Took 0.98 seconds ------------

=================================== SUMMARY ===================================
Environment          Test                   Status    Duration
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:11.007
native               test_session           PASSED    00:00:00.479
native               test_presentation      PASSED    00:00:00.496
native               test_transport         PASSED    00:00:00.496
native               test_websocket         PASSED    00:00:00.508
native               test_http_parser       PASSED    00:00:00.481
native_ssh           test_ssh_crypto        PASSED    00:00:02.960
native_ssh           test_ssh_auth          PASSED    00:00:00.503
native_ssh           test_ssh_server        PASSED    00:00:00.610
native_ssh           test_ssh_transport     PASSED    00:00:00.764
native_ssh           test_ssh_channel       PASSED    00:00:00.460
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.750
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.082
native_app           test_regex             PASSED    00:00:00.863
native_app           test_template          PASSED    00:00:00.463
native_app           test_path_params       PASSED    00:00:00.462
native_app           test_digest_vectors    PASSED    00:00:00.430
native_app           test_form_params       PASSED    00:00:00.463
native_app           test_iface             PASSED    00:00:00.445
native_app           test_json              PASSED    00:00:00.440
native_app           test_response_headers  PASSED    00:00:00.473
native_app           test_middleware        PASSED    00:00:00.463
native_app           test_digest_auth       PASSED    00:00:00.482
native_app           test_web_terminal      PASSED    00:00:00.450
native_app           test_defer             PASSED    00:00:00.423
native_app           test_multipart         PASSED    00:00:00.458
native_app           test_auth              PASSED    00:00:00.467
native_app           test_file_serving      PASSED    00:00:00.472
native_app           test_dispatch          PASSED    00:00:00.451
native_app           test_chunked           PASSED    00:00:00.483
native_app           test_application       PASSED    00:00:00.546
native_compliance    test_compliance        PASSED    00:00:00.542
native_workers       test_workers           PASSED    00:00:00.571
native_tsan          test_concurrency       PASSED    00:00:00.982
================ 620 test cases: 620 succeeded in 00:00:31.425 ================
```
