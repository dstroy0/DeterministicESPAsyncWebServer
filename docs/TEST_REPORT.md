...
**Generated:** 2026-06-30 17:20:42
**Command:** `pio test` over 103 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1617 passed - 137s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    11 |   ✅   | 00:00:06.903 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.557 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.523 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.535 |
| `test_mbus`              | `native_mbus`           |     8 |   ✅   | 00:00:00.622 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.515 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.528 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.886 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.514 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.516 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:00.846 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.452 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.478 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.463 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.486 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.460 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.572 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:00.862 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.536 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.544 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.041 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.449 |
| `test_ssh_server`        | `native_ssh`            |    12 |   ✅   | 00:00:00.669 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.733 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.444 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.807 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.193 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.044 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.469 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.468 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.427 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.474 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.469 |
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.444 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.476 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.472 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.484 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.473 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.453 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.477 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.470 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.487 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.479 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.474 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.536 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.056 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.046 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.595 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.397 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.256 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.670 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.700 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.592 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.531 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.567 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.596 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.521 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.541 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.532 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.533 |
| `test_protobuf`          | `native_protobuf`       |    10 |   ✅   | 00:00:00.530 |
| `test_preempt_queue`     | `native_preempt_queue`  |     7 |   ✅   | 00:00:00.551 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.553 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.536 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.532 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.551 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.520 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.507 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.519 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.530 |
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.599 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.532 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.541 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.540 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.544 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.511 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.526 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.533 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.526 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.526 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.544 |
| `test_sparkplug`         | `native_sparkplug`      |     6 |   ✅   | 00:00:00.556 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.555 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.530 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.553 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.524 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.510 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.526 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.556 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.746 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.543 |
| `test_graphql`           | `native_graphql`        |    25 |   ✅   | 00:00:00.520 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.533 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.560 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.543 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.563 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:00.966 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:00.977 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.542 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.596 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.009 |
| `test_http_client`       | `native_http_client`    |    11 |   ✅   | 00:00:00.527 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.534 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.536 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.589 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.567 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.547 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.525 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.575 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:00.950 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.538 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.547 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.564 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.540 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.560 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.541 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.531 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.519 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.541 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.553 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.536 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.546 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.528 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.529 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.535 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.543 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.647 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.516 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.635 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:00.829 |

---

## test_canopen - ✅ 11 passed
...
|  28 | `test_well_known_core_discovery`           |   ✅   | Well known core discovery                                                   |
|  29 | `test_well_known_core_rejects_post`        |   ✅   | Well known core rejects post                                                |
...
|  14 | `test_rtu_crc16_known_vector`               |   ✅   | Rtu crc16 known vector                               |
|  15 | `test_rtu_read_holding_roundtrip`           |   ✅   | Rtu read holding roundtrip                           |
|  16 | `test_rtu_bad_crc_dropped`                  |   ✅   | Rtu bad crc dropped                                  |
|  17 | `test_rtu_wrong_address_dropped`            |   ✅   | Rtu wrong address dropped                            |
|  18 | `test_rtu_broadcast_executes_without_reply` |   ✅   | Rtu broadcast executes without reply                 |
...
|   2 | `test_build_no_headers_no_body`           |   ✅   | Build no headers no body           |
|   3 | `test_build_escapes_header`               |   ✅   | Build escapes header               |
|   4 | `test_build_overflow_fails_closed`        |   ✅   | Build overflow fails closed        |
|   5 | `test_round_trip`                         |   ✅   | Round trip                         |
|   6 | `test_parse_message_crlf`                 |   ✅   | Parse message crlf                 |
|   7 | `test_parse_content_length_body_with_nul` |   ✅   | Parse content length body with nul |
|   8 | `test_parse_skips_leading_heartbeats`     |   ✅   | Parse skips leading heartbeats     |
|   9 | `test_parse_incomplete_and_malformed`     |   ✅   | Parse incomplete and malformed     |
|  10 | `test_unescape`                           |   ✅   | Unescape                           |
|  11 | `test_unescape_rejects_bad`               |   ✅   | Unescape rejects bad               |

</details>

---

## test_mqtt_sn - ✅ 8 passed
...
|   2 | `test_json_multi_record`     |   ✅   | Json multi record     |
|   3 | `test_json_string_bool_time` |   ✅   | Json string bool time |
|   4 | `test_cbor_round_trip`       |   ✅   | Cbor round trip       |
|   5 | `test_cbor_base_name_key`    |   ✅   | Cbor base name key    |
...
|   2 | `test_build_pub`                   |   ✅   | Build pub                   |
|   3 | `test_build_pub_with_reply`        |   ✅   | Build pub with reply        |
|   4 | `test_build_pub_empty_payload`     |   ✅   | Build pub empty payload     |
|   5 | `test_build_sub_and_unsub`         |   ✅   | Build sub and unsub         |
|   6 | `test_parse_msg`                   |   ✅   | Parse msg                   |
|   7 | `test_parse_msg_with_reply`        |   ✅   | Parse msg with reply        |
|   8 | `test_parse_control_lines`         |   ✅   | Parse control lines         |
|   9 | `test_parse_incomplete`            |   ✅   | Parse incomplete            |
...
|   2 | `test_string_escapes_decoded`          |   ✅   | \n \t \r \\ \/ and an unknown escape (\z) are all decoded by the arg lexer. |
|   3 | `test_number_arg_variants_parse`       |   ✅   | float, exponent, signed-exponent and negative-int argument values all parse |
|   4 | `test_bool_args`                       |   ✅   | Bool args                                                                   |
|   5 | `test_null_arg_value`                  |   ✅   | `null` parses; greet's name arg is then not a string, so it stays "?".      |
|   6 | `test_control_char_is_unicode_escaped` |   ✅   | Control char is unicode escaped                                             |
|   7 | `test_unterminated_string_arg_fails`   |   ✅   | Unterminated string arg fails                                               |
|   8 | `test_arg_missing_colon_fails`         |   ✅   | Arg missing colon fails                                                     |
|   9 | `test_bad_arg_value_fails`             |   ✅   | Bad arg value fails                                                         |
|  10 | `test_trailing_junk_fails`             |   ✅   | Trailing junk fails                                                         |
|  11 | `test_long_field_name_hits_limit`      |   ✅   | Long field name hits limit                                                  |
|  12 | `test_null_inputs_fail_closed`         |   ✅   | Null inputs fail closed                                                     |
|  13 | `test_unknown_operation_keyword_fails` |   ✅   | Unknown operation keyword fails                                             |
|  14 | `test_selection_is_honored`            |   ✅   | Only the requested field appears.                                           |
|  15 | `test_nested_object`                   |   ✅   | Nested object                                                               |
|  16 | `test_args_collected_along_path`       |   ✅   | `id` is on the object `sensor`; the leaf resolver `sensor.value` reads it.  |
|  17 | `test_scalar_types`                    |   ✅   | Scalar types                                                                |
|  18 | `test_string_arg_and_escaping`         |   ✅   | String arg is decoded, and the resolver's output string is JSON-escaped.    |
|  19 | `test_unresolved_field_is_null`        |   ✅   | Unresolved field is null                                                    |
|  20 | `test_query_keyword_and_name`          |   ✅   | Query keyword and name                                                      |
|  21 | `test_comments_and_commas`             |   ✅   | Comments and commas                                                         |
|  22 | `test_parse_error_reports_errors`      |   ✅   | Parse error reports errors                                                  |
|  23 | `test_mutation_rejected`               |   ✅   | Mutation rejected                                                           |
|  24 | `test_depth_limit`                     |   ✅   | Depth limit                                                                 |
|  25 | `test_overflow_fails_closed`           |   ✅   | Overflow fails closed                                                       |
...
|   9 | `test_parse_chunked_oversize_size_clamped` |   ✅   | Parse chunked oversize size clamped                                |
|  10 | `test_parse_connection_close_body`         |   ✅   | No Content-Length / chunked: body is everything after the headers. |
|  11 | `test_parse_malformed`                     |   ✅   | Parse malformed                                                    |
...
Testing...
test/test_canopen/test_canopen.cpp:230: test_nmt_start_node             [PASSED]
test/test_canopen/test_canopen.cpp:231: test_sync                       [PASSED]
test/test_canopen/test_canopen.cpp:232: test_heartbeat_roundtrip        [PASSED]
test/test_canopen/test_canopen.cpp:233: test_emcy_roundtrip             [PASSED]
test/test_canopen/test_canopen.cpp:234: test_pdo_roundtrip              [PASSED]
test/test_canopen/test_canopen.cpp:235: test_sdo_read_request           [PASSED]
test/test_canopen/test_canopen.cpp:236: test_sdo_write_expedited        [PASSED]
test/test_canopen/test_canopen.cpp:237: test_sdo_upload_response_expedited [PASSED]
test/test_canopen/test_canopen.cpp:238: test_sdo_abort_roundtrip        [PASSED]
test/test_canopen/test_canopen.cpp:239: test_sdo_download_ack           [PASSED]
test/test_canopen/test_canopen.cpp:240: test_parse_classifies           [PASSED]
------------ native_canopen:test_canopen [PASSED] Took 6.90 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.903
================= 11 test cases: 11 succeeded in 00:00:06.903 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
-------------- native_j1939:test_j1939 [PASSED] Took 0.56 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.557
...
---------- native_devicenet:test_devicenet [PASSED] Took 0.52 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.523
================== 8 test cases: 8 succeeded in 00:00:00.523 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
----------- native_nmea2000:test_nmea2000 [PASSED] Took 0.54 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.535
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_mbus/test_mbus.cpp:164: test_ack                              [PASSED]
test/test_mbus/test_mbus.cpp:165: test_short_frame_roundtrip            [PASSED]
test/test_mbus/test_mbus.cpp:166: test_req_ud2_fcb                      [PASSED]
test/test_mbus/test_mbus.cpp:167: test_long_frame_roundtrip             [PASSED]
test/test_mbus/test_mbus.cpp:168: test_parse_rejects_corruption         [PASSED]
test/test_mbus/test_mbus.cpp:169: test_dif_data_len                     [PASSED]
test/test_mbus/test_mbus.cpp:170: test_record_walk                      [PASSED]
test/test_mbus/test_mbus.cpp:171: test_record_truncated_fails           [PASSED]
--------------- native_mbus:test_mbus [PASSED] Took 0.62 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.622
================== 8 test cases: 8 succeeded in 00:00:00.622 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
----------- native_iec60870:test_iec60870 [PASSED] Took 0.52 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.515
...
-------------- native_sdi12:test_sdi12 [PASSED] Took 0.53 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.528
================== 6 test cases: 6 succeeded in 00:00:00.528 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
---------------- native_dmx:test_dmx [PASSED] Took 0.89 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.886
...
----------- native_nmea0183:test_nmea0183 [PASSED] Took 0.51 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.514
================== 7 test cases: 7 succeeded in 00:00:00.514 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_iolink:test_iolink [PASSED] Took 0.52 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.516
================== 5 test cases: 5 succeeded in 00:00:00.516 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------------ native:test_sse [PASSED] Took 0.85 seconds ------------------
...
---------------- native:test_session [PASSED] Took 0.45 seconds ----------------
...
------------- native:test_presentation [PASSED] Took 0.48 seconds --------------
...
--------------- native:test_transport [PASSED] Took 0.46 seconds ---------------
...
--------------- native:test_websocket [PASSED] Took 0.49 seconds ---------------
...
-------------- native:test_http_parser [PASSED] Took 0.46 seconds --------------

=================================== SUMMARY ===================================
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:00.846
native         test_session       PASSED    00:00:00.452
native         test_presentation  PASSED    00:00:00.478
native         test_transport     PASSED    00:00:00.463
native         test_websocket     PASSED    00:00:00.486
native         test_http_parser   PASSED    00:00:00.460
================ 318 test cases: 318 succeeded in 00:00:03.186 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------ native_observability:test_observability [PASSED] Took 0.57 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.572
================= 17 test cases: 17 succeeded in 00:00:00.572 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
-------- native_accept_gate:test_accept_gate [PASSED] Took 0.86 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.862
...
------------- native_ota:test_http_ota [PASSED] Took 0.54 seconds --------------

=================================== SUMMARY ===================================
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.536
...
----------- native_prov:test_provisioning [PASSED] Took 0.54 seconds -----------

=================================== SUMMARY ===================================
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.544
================== 5 test cases: 5 succeeded in 00:00:00.544 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 3.04 seconds -------------
...
------------- native_ssh:test_ssh_auth [PASSED] Took 0.45 seconds --------------
...
----------- native_ssh:test_ssh_transport [PASSED] Took 0.73 seconds -----------
...
------------ native_ssh:test_ssh_channel [PASSED] Took 0.44 seconds ------------

=================================== SUMMARY ===================================
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.041
native_ssh     test_ssh_auth       PASSED    00:00:00.449
native_ssh     test_ssh_server     PASSED    00:00:00.669
native_ssh     test_ssh_transport  PASSED    00:00:00.733
native_ssh     test_ssh_channel    PASSED    00:00:00.444
================ 106 test cases: 106 succeeded in 00:00:05.336 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------ native_ssh_hardened:test_ssh_hardening [PASSED] Took 0.81 seconds -------

=================================== SUMMARY ===================================
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.807
================== 2 test cases: 2 succeeded in 00:00:00.807 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 1.19 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.193
================== 2 test cases: 2 succeeded in 00:00:01.193 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
--------------- native_app:test_regex [PASSED] Took 1.04 seconds ---------------
...
------------- native_app:test_template [PASSED] Took 0.47 seconds --------------
...
------------ native_app:test_path_params [PASSED] Took 0.47 seconds ------------
...
---------- native_app:test_digest_vectors [PASSED] Took 0.43 seconds -----------
...
------------ native_app:test_form_params [PASSED] Took 0.47 seconds ------------
...
--------------- native_app:test_iface [PASSED] Took 0.47 seconds ---------------
...
--------------- native_app:test_json [PASSED] Took 0.44 seconds ----------------
...
--------- native_app:test_response_headers [PASSED] Took 0.48 seconds ----------
...
------------ native_app:test_middleware [PASSED] Took 0.47 seconds -------------
...
------------ native_app:test_digest_auth [PASSED] Took 0.48 seconds ------------
...
----------- native_app:test_web_terminal [PASSED] Took 0.47 seconds ------------
...
--------------- native_app:test_defer [PASSED] Took 0.45 seconds ---------------
...
------------- native_app:test_multipart [PASSED] Took 0.48 seconds -------------
...
--------------- native_app:test_auth [PASSED] Took 0.47 seconds ----------------
...
----------- native_app:test_file_serving [PASSED] Took 0.49 seconds ------------
...
-------------- native_app:test_chunked [PASSED] Took 0.47 seconds --------------
...
------------ native_app:test_application [PASSED] Took 0.54 seconds ------------

=================================== SUMMARY ===================================
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.044
native_app     test_template          PASSED    00:00:00.469
native_app     test_path_params       PASSED    00:00:00.468
native_app     test_digest_vectors    PASSED    00:00:00.427
native_app     test_form_params       PASSED    00:00:00.474
native_app     test_iface             PASSED    00:00:00.469
native_app     test_json              PASSED    00:00:00.444
native_app     test_response_headers  PASSED    00:00:00.476
native_app     test_middleware        PASSED    00:00:00.472
native_app     test_digest_auth       PASSED    00:00:00.484
native_app     test_web_terminal      PASSED    00:00:00.473
native_app     test_defer             PASSED    00:00:00.453
native_app     test_multipart         PASSED    00:00:00.477
native_app     test_auth              PASSED    00:00:00.470
native_app     test_file_serving      PASSED    00:00:00.487
native_app     test_dispatch          PASSED    00:00:00.479
native_app     test_chunked           PASSED    00:00:00.474
native_app     test_application       PASSED    00:00:00.536
================ 219 test cases: 219 succeeded in 00:00:09.074 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
----- native_webdav_handler:test_webdav_handler [PASSED] Took 1.06 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.056
================= 12 test cases: 12 succeeded in 00:00:01.056 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
--------------- native_diag:test_diag [PASSED] Took 1.05 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.046
================== 2 test cases: 2 succeeded in 00:00:01.046 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_snmp:test_snmp_ber [PASSED] Took 0.59 seconds -------------

Processing test_snmp_agent in native_snmp environment
--------------------------------------------------------------------------------
Building...
Testing...
test/test_snmp_agent/test_snmp_agent.cpp:374: test_get_string_v2c       [PASSED]
test/test_snmp_agent/test_snmp_agent.cpp:375: test_get_unknown_v2c_exception [PASSED]
test/test_snmp_agent/test_snmp_agent.cpp:376: test_get_bad_instance_v2c_nosuchinstance [PASSED]
test/test_snmp_agent/test_snmp_agent.cpp:377: test_get_unknown_v1_error [PASSED]
test/test_snmp_agent/test_snmp_agent.cpp:378: test_getnext_walks_to_first [PASSED]
test/test_snmp_agent/test_snmp_agent.cpp:379: test_getnext_past_end_endofmibview [PASSED]
test/test_snmp_agent/test_snmp_agent.cpp:380: test_set_without_rw_community_denied [PASSED]
test/test_snmp_agent/test_snmp_agent.cpp:381: test_set_with_rw_community_invokes_setter [PASSED]
test/test_snmp_agent/test_snmp_agent.cpp:382: test_set_readonly_not_writable [PASSED]
test/test_snmp_agent/test_snmp_agent.cpp:383: test_getbulk_returns_multiple [PASSED]
test/test_snmp_agent/test_snmp_agent.cpp:384: test_dynamic_counter_value [PASSED]
test/test_snmp_agent/test_snmp_agent.cpp:385: test_uptime_is_timeticks  [PASSED]
test/test_snmp_agent/test_snmp_agent.cpp:386: test_unknown_community_no_response [PASSED]
test/test_snmp_agent/test_snmp_agent.cpp:387: test_v3_message_dropped   [PASSED]
------------ native_snmp:test_snmp_agent [PASSED] Took 0.40 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.595
native_snmp    test_snmp_agent  PASSED    00:00:00.397
================= 30 test cases: 30 succeeded in 00:00:00.992 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 1.26 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.256
================= 10 test cases: 10 succeeded in 00:00:01.256 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_telnet:test_telnet [PASSED] Took 0.67 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.670
...
--------------- native_coap:test_coap [PASSED] Took 0.70 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.700
================= 29 test cases: 29 succeeded in 00:00:00.700 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
test/test_coap/test_coap.cpp:844: test_well_known_core_discovery        [PASSED]
test/test_coap/test_coap.cpp:845: test_well_known_core_rejects_post     [PASSED]
----------- native_coap_observe:test_coap [PASSED] Took 0.59 seconds -----------

=================================== SUMMARY ===================================
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.592
================= 29 test cases: 29 succeeded in 00:00:00.592 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_webdav:test_webdav [PASSED] Took 0.53 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.531
================= 19 test cases: 19 succeeded in 00:00:00.531 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_modbus:test_modbus [PASSED] Took 0.57 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.567
================= 18 test cases: 18 succeeded in 00:00:00.567 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
-------- native_cloudevents:test_cloudevents [PASSED] Took 0.60 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.596
================== 7 test cases: 7 succeeded in 00:00:00.596 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
----------- native_redis:test_redis_resp [PASSED] Took 0.52 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.521
================== 8 test cases: 8 succeeded in 00:00:00.521 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_stomp/test_stomp.cpp:161: test_build_send                     [PASSED]
test/test_stomp/test_stomp.cpp:162: test_build_no_headers_no_body       [PASSED]
test/test_stomp/test_stomp.cpp:163: test_build_escapes_header           [PASSED]
test/test_stomp/test_stomp.cpp:164: test_build_overflow_fails_closed    [PASSED]
test/test_stomp/test_stomp.cpp:165: test_round_trip                     [PASSED]
test/test_stomp/test_stomp.cpp:166: test_parse_message_crlf             [PASSED]
test/test_stomp/test_stomp.cpp:167: test_parse_content_length_body_with_nul [PASSED]
test/test_stomp/test_stomp.cpp:168: test_parse_skips_leading_heartbeats [PASSED]
test/test_stomp/test_stomp.cpp:169: test_parse_incomplete_and_malformed [PASSED]
test/test_stomp/test_stomp.cpp:170: test_unescape                       [PASSED]
test/test_stomp/test_stomp.cpp:171: test_unescape_rejects_bad           [PASSED]
-------------- native_stomp:test_stomp [PASSED] Took 0.54 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.541
================= 11 test cases: 11 succeeded in 00:00:00.541 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_mqtt_sn/test_mqtt_sn.cpp:182: test_make_flags                 [PASSED]
test/test_mqtt_sn/test_mqtt_sn.cpp:183: test_build_connect_bytes        [PASSED]
test/test_mqtt_sn/test_mqtt_sn.cpp:184: test_build_publish_bytes        [PASSED]
test/test_mqtt_sn/test_mqtt_sn.cpp:185: test_register_round_trip        [PASSED]
test/test_mqtt_sn/test_mqtt_sn.cpp:186: test_parse_connack_regack_suback_publish [PASSED]
test/test_mqtt_sn/test_mqtt_sn.cpp:187: test_three_octet_length         [PASSED]
test/test_mqtt_sn/test_mqtt_sn.cpp:188: test_optional_fields            [PASSED]
test/test_mqtt_sn/test_mqtt_sn.cpp:189: test_overflow_and_malformed     [PASSED]
------------ native_mqtt_sn:test_mqtt_sn [PASSED] Took 0.53 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.532
================== 8 test cases: 8 succeeded in 00:00:00.532 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
-------- native_flow_export:test_flow_export [PASSED] Took 0.53 seconds --------
...
----------- native_protobuf:test_protobuf [PASSED] Took 0.53 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.530
================= 10 test cases: 10 succeeded in 00:00:00.530 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_preempt_queue/test_preempt_queue.cpp:132: test_start_validates_and_runs [PASSED]
test/test_preempt_queue/test_preempt_queue.cpp:133: test_fifo_order     [PASSED]
test/test_preempt_queue/test_preempt_queue.cpp:134: test_urgent_goes_to_front [PASSED]
test/test_preempt_queue/test_preempt_queue.cpp:135: test_fail_closed_when_full [PASSED]
test/test_preempt_queue/test_preempt_queue.cpp:136: test_high_water_tracks_peak [PASSED]
test/test_preempt_queue/test_preempt_queue.cpp:137: test_from_isr_enqueues [PASSED]
test/test_preempt_queue/test_preempt_queue.cpp:138: test_drain_empties_and_reuses [PASSED]
------ native_preempt_queue:test_preempt_queue [PASSED] Took 0.55 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.551
================== 7 test cases: 7 succeeded in 00:00:00.551 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
--------------- native_wamp:test_wamp [PASSED] Took 0.55 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.553
================= 12 test cases: 12 succeeded in 00:00:00.553 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------ native_sunspec:test_sunspec [PASSED] Took 0.54 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.536
================== 5 test cases: 5 succeeded in 00:00:00.536 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_c37118:test_c37118 [PASSED] Took 0.53 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.532
================== 6 test cases: 6 succeeded in 00:00:00.532 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.551
================== 7 test cases: 7 succeeded in 00:00:00.551 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------ native_grpcweb:test_grpcweb [PASSED] Took 0.52 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.520
================== 7 test cases: 7 succeeded in 00:00:00.520 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
---------- native_lwm2m_tlv:test_lwm2m_tlv [PASSED] Took 0.51 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.507
================= 11 test cases: 11 succeeded in 00:00:00.507 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
--------------- native_fins:test_fins [PASSED] Took 0.52 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.519
================== 6 test cases: 6 succeeded in 00:00:00.519 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
----------- native_hostlink:test_hostlink [PASSED] Took 0.53 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.530
================== 7 test cases: 7 succeeded in 00:00:00.530 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_senml/test_senml.cpp:154: test_json_canonical                 [PASSED]
test/test_senml/test_senml.cpp:155: test_json_multi_record              [PASSED]
test/test_senml/test_senml.cpp:156: test_json_string_bool_time          [PASSED]
test/test_senml/test_senml.cpp:157: test_cbor_round_trip                [PASSED]
test/test_senml/test_senml.cpp:158: test_cbor_base_name_key             [PASSED]
test/test_senml/test_senml.cpp:159: test_overflow_fails_closed          [PASSED]
-------------- native_senml:test_senml [PASSED] Took 0.60 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.599
================== 6 test cases: 6 succeeded in 00:00:00.599 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
---------------- native_df1:test_df1 [PASSED] Took 0.53 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.532
================== 9 test cases: 9 succeeded in 00:00:00.532 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
--------------- native_cotp:test_cotp [PASSED] Took 0.54 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.541
================== 6 test cases: 6 succeeded in 00:00:00.541 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_s7comm:test_s7comm [PASSED] Took 0.54 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.540
================== 8 test cases: 8 succeeded in 00:00:00.540 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_melsec:test_melsec [PASSED] Took 0.54 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.544
...
------------- native_bacnet:test_bacnet [PASSED] Took 0.51 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.511
================== 8 test cases: 8 succeeded in 00:00:00.511 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
--------------- native_enip:test_enip [PASSED] Took 0.53 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.526
================== 6 test cases: 6 succeeded in 00:00:00.526 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
--------------- native_amqp:test_amqp [PASSED] Took 0.53 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.533
================== 7 test cases: 7 succeeded in 00:00:00.533 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
---------------- native_cip:test_cip [PASSED] Took 0.53 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.526
================== 8 test cases: 8 succeeded in 00:00:00.526 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_nats/test_nats.cpp:130: test_build_connect                    [PASSED]
test/test_nats/test_nats.cpp:131: test_build_pub                        [PASSED]
test/test_nats/test_nats.cpp:132: test_build_pub_with_reply             [PASSED]
test/test_nats/test_nats.cpp:133: test_build_pub_empty_payload          [PASSED]
test/test_nats/test_nats.cpp:134: test_build_sub_and_unsub              [PASSED]
test/test_nats/test_nats.cpp:135: test_parse_msg                        [PASSED]
test/test_nats/test_nats.cpp:136: test_parse_msg_with_reply             [PASSED]
test/test_nats/test_nats.cpp:137: test_parse_control_lines              [PASSED]
test/test_nats/test_nats.cpp:138: test_parse_incomplete                 [PASSED]
test/test_nats/test_nats.cpp:139: test_build_overflow_fails_closed      [PASSED]
--------------- native_nats:test_nats [PASSED] Took 0.53 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.526
================= 10 test cases: 10 succeeded in 00:00:00.526 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
----- native_proxy_protocol:test_proxy_protocol [PASSED] Took 0.54 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.544
================== 8 test cases: 8 succeeded in 00:00:00.544 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
---------- native_sparkplug:test_sparkplug [PASSED] Took 0.56 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.556
================== 6 test cases: 6 succeeded in 00:00:00.556 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------ native_modbus_master:test_modbus_master [PASSED] Took 0.56 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.555
...
------- native_ota_rollback:test_ota_rollback [PASSED] Took 0.53 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.530
================== 5 test cases: 5 succeeded in 00:00:00.530 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
--------------- native_totp:test_totp [PASSED] Took 0.55 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.553
...
------------ native_webhook:test_webhook [PASSED] Took 0.52 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.524
================== 5 test cases: 5 succeeded in 00:00:00.524 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
-------- native_radio_power:test_radio_power [PASSED] Took 0.51 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.510
================== 2 test cases: 2 succeeded in 00:00:00.510 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------- native_dns_resolver:test_dns_resolver [PASSED] Took 0.53 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.526
================== 4 test cases: 4 succeeded in 00:00:00.526 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
---------- native_audit_log:test_audit_log [PASSED] Took 0.56 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.556
================= 12 test cases: 12 succeeded in 00:00:00.556 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.746
...
---------------- native_vfs:test_vfs [PASSED] Took 0.54 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.543
================= 11 test cases: 11 succeeded in 00:00:00.543 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_graphql/test_graphql.cpp:266: test_flat_selection             [PASSED]
test/test_graphql/test_graphql.cpp:267: test_string_escapes_decoded     [PASSED]
test/test_graphql/test_graphql.cpp:268: test_number_arg_variants_parse  [PASSED]
test/test_graphql/test_graphql.cpp:269: test_bool_args                  [PASSED]
test/test_graphql/test_graphql.cpp:270: test_null_arg_value             [PASSED]
test/test_graphql/test_graphql.cpp:271: test_control_char_is_unicode_escaped [PASSED]
test/test_graphql/test_graphql.cpp:272: test_unterminated_string_arg_fails [PASSED]
test/test_graphql/test_graphql.cpp:273: test_arg_missing_colon_fails    [PASSED]
test/test_graphql/test_graphql.cpp:274: test_bad_arg_value_fails        [PASSED]
test/test_graphql/test_graphql.cpp:275: test_trailing_junk_fails        [PASSED]
test/test_graphql/test_graphql.cpp:276: test_long_field_name_hits_limit [PASSED]
test/test_graphql/test_graphql.cpp:277: test_null_inputs_fail_closed    [PASSED]
test/test_graphql/test_graphql.cpp:278: test_unknown_operation_keyword_fails [PASSED]
test/test_graphql/test_graphql.cpp:279: test_selection_is_honored       [PASSED]
test/test_graphql/test_graphql.cpp:280: test_nested_object              [PASSED]
test/test_graphql/test_graphql.cpp:281: test_args_collected_along_path  [PASSED]
test/test_graphql/test_graphql.cpp:282: test_scalar_types               [PASSED]
test/test_graphql/test_graphql.cpp:283: test_string_arg_and_escaping    [PASSED]
test/test_graphql/test_graphql.cpp:284: test_unresolved_field_is_null   [PASSED]
test/test_graphql/test_graphql.cpp:285: test_query_keyword_and_name     [PASSED]
test/test_graphql/test_graphql.cpp:286: test_comments_and_commas        [PASSED]
test/test_graphql/test_graphql.cpp:287: test_parse_error_reports_errors [PASSED]
test/test_graphql/test_graphql.cpp:288: test_mutation_rejected          [PASSED]
test/test_graphql/test_graphql.cpp:289: test_depth_limit                [PASSED]
test/test_graphql/test_graphql.cpp:290: test_overflow_fails_closed      [PASSED]
------------ native_graphql:test_graphql [PASSED] Took 0.52 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.520
================= 25 test cases: 25 succeeded in 00:00:00.520 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_espnow:test_espnow [PASSED] Took 0.53 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.533
================== 7 test cases: 7 succeeded in 00:00:00.533 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_oauth2:test_oauth2 [PASSED] Took 0.56 seconds -------------
...
-------------- native_opcua:test_opcua [PASSED] Took 0.54 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.543
================= 29 test cases: 29 succeeded in 00:00:00.543 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------- native_opcua_client:test_opcua_client [PASSED] Took 0.56 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.563
================= 11 test cases: 11 succeeded in 00:00:00.563 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
---------- native_keepalive:test_keepalive [PASSED] Took 0.97 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:00.966
================= 10 test cases: 10 succeeded in 00:00:00.966 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
-------------- native_range:test_range [PASSED] Took 0.98 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:00.977
================= 13 test cases: 13 succeeded in 00:00:00.977 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_syslog:test_syslog [PASSED] Took 0.54 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.542
================== 6 test cases: 6 succeeded in 00:00:00.542 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.596
================= 12 test cases: 12 succeeded in 00:00:00.596 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_upload:test_upload [PASSED] Took 1.01 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.009
================== 3 test cases: 3 succeeded in 00:00:01.009 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_http_client/test_http_client.cpp:150: test_url_http_default   [PASSED]
test/test_http_client/test_http_client.cpp:151: test_url_https_port_nopath [PASSED]
test/test_http_client/test_http_client.cpp:152: test_url_bad_scheme     [PASSED]
test/test_http_client/test_http_client.cpp:153: test_build_get          [PASSED]
test/test_http_client/test_http_client.cpp:154: test_build_post_with_body_and_port [PASSED]
test/test_http_client/test_http_client.cpp:155: test_parse_content_length [PASSED]
test/test_http_client/test_http_client.cpp:156: test_parse_status_404   [PASSED]
test/test_http_client/test_http_client.cpp:157: test_parse_chunked      [PASSED]
test/test_http_client/test_http_client.cpp:158: test_parse_chunked_oversize_size_clamped [PASSED]
test/test_http_client/test_http_client.cpp:159: test_parse_connection_close_body [PASSED]
test/test_http_client/test_http_client.cpp:160: test_parse_malformed    [PASSED]
-------- native_http_client:test_http_client [PASSED] Took 0.53 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.527
================= 11 test cases: 11 succeeded in 00:00:00.527 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
--------- native_compliance:test_compliance [PASSED] Took 0.53 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.534
================= 15 test cases: 15 succeeded in 00:00:00.534 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
--------------- native_mqtt:test_mqtt [PASSED] Took 0.54 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.536
================= 19 test cases: 19 succeeded in 00:00:00.536 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
================= 10 test cases: 10 succeeded in 00:00:00.589 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------ native_scratch:test_scratch [PASSED] Took 0.57 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.567
================= 14 test cases: 14 succeeded in 00:00:00.567 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
---------- native_snmp_trap:test_snmp_trap [PASSED] Took 0.55 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.547
...
------------ native_inflate:test_inflate [PASSED] Took 0.52 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.525
================= 12 test cases: 12 succeeded in 00:00:00.525 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------ native_deflate:test_deflate [PASSED] Took 0.58 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.575
================= 10 test cases: 10 succeeded in 00:00:00.575 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
test/test_websocket/test_websocket.cpp:1107: stress_ws_parse_max_payload [PASSED]
test/test_websocket/test_websocket.cpp:1108: stress_ws_parse_two_consecutive_frames [PASSED]
--------- native_ws_deflate:test_websocket [PASSED] Took 0.95 seconds ----------

=================================== SUMMARY ===================================
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.950
================= 71 test cases: 71 succeeded in 00:00:00.950 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
-------- native_time_source:test_time_source [PASSED] Took 0.54 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.538
================== 9 test cases: 9 succeeded in 00:00:00.538 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------- native_config_store:test_config_store [PASSED] Took 0.55 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.547
================= 14 test cases: 14 succeeded in 00:00:00.547 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
---------- native_device_id:test_device_id [PASSED] Took 0.56 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.564
...
------- native_auth_lockout:test_auth_lockout [PASSED] Took 0.54 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.540
================= 10 test cases: 10 succeeded in 00:00:00.540 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
--------------- native_csrf:test_csrf [PASSED] Took 0.56 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.560
================== 9 test cases: 9 succeeded in 00:00:00.560 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
---------- native_telemetry:test_telemetry [PASSED] Took 0.54 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.541
================== 8 test cases: 8 succeeded in 00:00:00.541 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
---------- native_dashboard:test_dashboard [PASSED] Took 0.53 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.531
...
--------- native_net_egress:test_net_egress [PASSED] Took 0.52 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.519
================== 5 test cases: 5 succeeded in 00:00:00.519 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------ native_partition:test_partition_monitor [PASSED] Took 0.54 seconds ------

=================================== SUMMARY ===================================
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.541
...
--------------- native_cbor:test_cbor [PASSED] Took 0.55 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.553
================= 14 test cases: 14 succeeded in 00:00:00.553 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------ native_msgpack:test_msgpack [PASSED] Took 0.54 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.536
================= 17 test cases: 17 succeeded in 00:00:00.536 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
----------- native_gpio_map:test_gpio_map [PASSED] Took 0.55 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.546
...
------ native_udp_telemetry:test_udp_telemetry [PASSED] Took 0.53 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.528
================== 7 test cases: 7 succeeded in 00:00:00.528 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
--------- native_guardrails:test_guardrails [PASSED] Took 0.53 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.529
================== 6 test cases: 6 succeeded in 00:00:00.529 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------- native_logbuf:test_logbuf [PASSED] Took 0.54 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.535
================== 4 test cases: 4 succeeded in 00:00:00.535 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
---------- native_config_io:test_config_io [PASSED] Took 0.54 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.543
================== 4 test cases: 4 succeeded in 00:00:00.543 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
------------ native_workers:test_workers [PASSED] Took 0.65 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.647
================== 3 test cases: 3 succeeded in 00:00:00.647 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
-------------- native_clock:test_clock [PASSED] Took 0.52 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.516
...
-------- native_concurrency:test_concurrency [PASSED] Took 0.63 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.635
================== 2 test cases: 2 succeeded in 00:00:00.635 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 128 tests
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 0.83 seconds ------------

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:00.829
