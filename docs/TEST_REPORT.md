...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:15.920 |
...
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.559 |
| `test_observability`     | `native_observability` |    15 |   ✅   | 00:00:00.702 |
| `test_http_ota`          | `native_ota`           |     3 |   ✅   | 00:00:00.642 |
| `test_provisioning`      | `native_prov`          |     5 |   ✅   | 00:00:00.656 |
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.882 |
...
| `test_ssh_hardening`     | `native_ssh_hardened`  |     2 |   ✅   | 00:00:00.884 |
| `test_ssh_conn`          | `native_ssh_conn`      |     2 |   ✅   | 00:00:01.273 |
| `test_regex`             | `native_app`           |     9 |   ✅   | 00:00:01.171 |
...
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.621 |
...
| `test_snmp_ber`          | `native_snmp`          |    15 |   ✅   | 00:00:00.708 |
| `test_snmp_agent`        | `native_snmp`          |    14 |   ✅   | 00:00:00.519 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.395 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.787 |
| `test_coap`              | `native_coap`          |    27 |   ✅   | 00:00:00.665 |
| `test_coap`              | `native_coap_observe`  |    27 |   ✅   | 00:00:00.667 |
...
| `test_webhook`           | `native_webhook`       |     5 |   ✅   | 00:00:00.626 |
| `test_radio_power`       | `native_radio_power`   |     2 |   ✅   | 00:00:00.633 |
| `test_dns_resolver`      | `native_dns_resolver`  |     4 |   ✅   | 00:00:00.627 |
| `test_audit_log`         | `native_audit_log`     |    12 |   ✅   | 00:00:00.651 |
| `test_oidc`              | `native_oidc`          |    13 |   ✅   | 00:00:00.828 |
| `test_vfs`               | `native_vfs`           |    11 |   ✅   | 00:00:00.649 |
| `test_graphql`           | `native_graphql`       |    13 |   ✅   | 00:00:00.637 |
| `test_espnow`            | `native_espnow`        |     7 |   ✅   | 00:00:00.630 |
...
| `test_jwt`               | `native_jwt`           |    12 |   ✅   | 00:00:00.688 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.077 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.640 |
| `test_compliance`        | `native_compliance`    |    15 |   ✅   | 00:00:00.650 |
| `test_mqtt`              | `native_mqtt`          |    19 |   ✅   | 00:00:00.674 |
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.706 |
...
| `test_config_store`      | `native_config_store`  |    14 |   ✅   | 00:00:00.650 |
| `test_device_id`         | `native_device_id`     |     4 |   ✅   | 00:00:00.683 |
| `test_auth_lockout`      | `native_auth_lockout`  |    10 |   ✅   | 00:00:00.655 |
| `test_csrf`              | `native_csrf`          |     9 |   ✅   | 00:00:00.689 |
| `test_telemetry`         | `native_telemetry`     |     8 |   ✅   | 00:00:00.675 |
| `test_dashboard`         | `native_dashboard`     |    11 |   ✅   | 00:00:00.668 |
...
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.707 |
| `test_guardrails`        | `native_guardrails`    |     6 |   ✅   | 00:00:00.676 |
| `test_logbuf`            | `native_logbuf`        |     4 |   ✅   | 00:00:00.680 |
...
| `test_concurrency`       | `native_concurrency`   |     2 |   ✅   | 00:00:00.949 |
...
----------------- native:test_sse [PASSED] Took 15.92 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:15.920
...
native         test_http_parser   PASSED    00:00:00.559
================ 310 test cases: 310 succeeded in 00:00:18.909 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.642
...
================= 92 test cases: 92 succeeded in 00:00:06.545 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.884
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.171
...
================ 217 test cases: 217 succeeded in 00:00:11.481 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
================= 29 test cases: 29 succeeded in 00:00:01.227 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.395
================== 9 test cases: 9 succeeded in 00:00:01.395 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
================= 27 test cases: 27 succeeded in 00:00:00.665 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.667
================= 27 test cases: 27 succeeded in 00:00:00.667 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.626
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.627
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.828
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.637
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.630
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.650
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.655
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.680
...
-------- native_concurrency:test_concurrency [PASSED] Took 0.95 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.949
