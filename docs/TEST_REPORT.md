...
**Generated:** 2026-06-29 23:29:53
**Command:** `pio test` over 101 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1566 passed - 163s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    11 |   ✅   | 00:00:05.734 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.657 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.650 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.675 |
| `test_mbus`              | `native_mbus`           |     8 |   ✅   | 00:00:00.650 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.657 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.665 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.666 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.660 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:00.961 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.579 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.617 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.596 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.624 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.585 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.727 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:00.961 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.671 |
...
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.697 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.933 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.538 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.876 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.268 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.148 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.599 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.607 |
...
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.603 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.578 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.612 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.654 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.681 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.618 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.683 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.740 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.192 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.140 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.706 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.500 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.526 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.803 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.748 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.731 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.676 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.660 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.718 |
...
| `test_protobuf`          | `native_protobuf`       |    10 |   ✅   | 00:00:00.656 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.680 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.655 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.668 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.656 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.645 |
...
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.679 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.694 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.705 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.699 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.706 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.657 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.663 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.664 |
| `test_sparkplug`         | `native_sparkplug`      |     6 |   ✅   | 00:00:00.685 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.692 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.648 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.682 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.659 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.645 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.653 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.687 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.863 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.657 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.675 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.650 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.687 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.683 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.693 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.063 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.079 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.666 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.701 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.097 |
| `test_http_client`       | `native_http_client`    |    11 |   ✅   | 00:00:00.667 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.662 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.674 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.684 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.695 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.679 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.656 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.716 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.021 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.644 |
...
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.658 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.660 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.649 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.652 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.659 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.647 |
...
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.754 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.648 |
...
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:05.734
================= 11 test cases: 11 succeeded in 00:00:05.734 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 126 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.650
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.650
================== 8 test cases: 8 succeeded in 00:00:00.650 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 126 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.666
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.961
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.671
================== 3 test cases: 3 succeeded in 00:00:00.671 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 126 tests
...
native_ssh     test_ssh_server     PASSED    00:00:00.697
native_ssh     test_ssh_transport  PASSED    00:00:00.933
native_ssh     test_ssh_channel    PASSED    00:00:00.538
================= 93 test cases: 93 succeeded in 00:00:06.512 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 126 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.876
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.268
================== 2 test cases: 2 succeeded in 00:00:01.268 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 126 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.148
native_app     test_template          PASSED    00:00:00.599
native_app     test_path_params       PASSED    00:00:00.607
...
native_app     test_web_terminal      PASSED    00:00:00.603
native_app     test_defer             PASSED    00:00:00.578
native_app     test_multipart         PASSED    00:00:00.612
native_app     test_auth              PASSED    00:00:00.654
native_app     test_file_serving      PASSED    00:00:00.681
native_app     test_dispatch          PASSED    00:00:00.618
native_app     test_chunked           PASSED    00:00:00.683
native_app     test_application       PASSED    00:00:00.740
================ 219 test cases: 219 succeeded in 00:00:11.684 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 126 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.140
...
================= 30 test cases: 30 succeeded in 00:00:01.206 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 126 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.526
================= 10 test cases: 10 succeeded in 00:00:01.526 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 126 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.803
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.731
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.660
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.718
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.656
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.668
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.645
...
test/test_hostlink/test_hostlink.cpp:30: test_build_dm_read: Expected '@00RD0000001057*\r' Was '@00RD0000001057*\re\xEC\xAB\xFC\x7F' [FAILED]
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  ERRORED   00:00:00.645

============= 8 test cases: 1 failed, 6 succeeded in 00:00:00.645 =============
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 126 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.679
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.663
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.685
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.692
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.659
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.863
================= 13 test cases: 13 succeeded in 00:00:00.863 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 126 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.683
================= 29 test cases: 29 succeeded in 00:00:00.683 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 126 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.063
================= 10 test cases: 10 succeeded in 00:00:01.063 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 126 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.079
================= 13 test cases: 13 succeeded in 00:00:01.079 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 126 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.097
================== 3 test cases: 3 succeeded in 00:00:01.097 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 126 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.667
================= 11 test cases: 11 succeeded in 00:00:00.667 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 126 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.674
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.021
================= 71 test cases: 71 succeeded in 00:00:01.021 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 126 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.644
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.658
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.754
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.380
================== 2 test cases: 2 succeeded in 00:00:01.380 ==================
```
