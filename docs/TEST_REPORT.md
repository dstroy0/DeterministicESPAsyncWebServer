...
**Generated:** 2026-06-29 17:24:33
**Command:** `pio test` over 70 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1334 passed - 123s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:14.117 |
...
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.203 |
...
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.201 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.153 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.701 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.511 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.527 |
...
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.667 |
...
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.682 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.668 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.662 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.657 |
...
----------------- native:test_sse [PASSED] Took 14.12 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:14.117
...
================ 318 test cases: 318 succeeded in 00:00:17.163 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 95 tests
...
================= 93 test cases: 93 succeeded in 00:00:06.543 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 95 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.203
...
================ 219 test cases: 219 succeeded in 00:00:11.654 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 95 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.201
================= 12 test cases: 12 succeeded in 00:00:01.201 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 95 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.153
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.527
================= 10 test cases: 10 succeeded in 00:00:01.527 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 95 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.690
================== 5 test cases: 5 succeeded in 00:00:00.690 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 95 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.700
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.093
================= 13 test cases: 13 succeeded in 00:00:01.093 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 95 tests
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.057
================= 71 test cases: 71 succeeded in 00:00:01.057 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 95 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.692
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.657
