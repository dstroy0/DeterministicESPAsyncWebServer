...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:06.852 |
...
| `test_http_parser`       | `native`                |    82 |   ✅   | 00:00:00.577 |
...
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.246 |
...
| `test_response_headers`  | `native_app`            |     9 |   ✅   | 00:00:00.615 |
...
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.069 |
...
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.639 |
...
------------------ native:test_sse [PASSED] Took 6.85 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.852
...
================ 310 test cases: 310 succeeded in 00:00:09.840 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
================= 92 test cases: 92 succeeded in 00:00:06.575 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.246
...
native_app     test_application       PASSED    00:00:00.702
================ 217 test cases: 217 succeeded in 00:00:11.540 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
================= 29 test cases: 29 succeeded in 00:00:01.219 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 90 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.639
