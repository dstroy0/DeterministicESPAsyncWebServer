...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:15.181 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.507 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.537 |
| `test_transport`        | `native`              |    28 |   ✅   | 00:00:00.518 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.542 |
| `test_http_parser`      | `native`              |    80 |   ✅   | 00:00:00.537 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.849 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.527 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.641 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.884 |
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.501 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.811 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.053 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.896 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.509 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.513 |
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.495 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.497 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.520 |
...
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.506 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.522 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.521 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.525 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.513 |
...
----------------- native:test_sse [PASSED] Took 15.18 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:15.181
...
native               test_websocket         PASSED    00:00:00.542
native               test_http_parser       PASSED    00:00:00.537
native_ssh           test_ssh_crypto        PASSED    00:00:03.849
native_ssh           test_ssh_auth          PASSED    00:00:00.527
native_ssh           test_ssh_server        PASSED    00:00:00.641
native_ssh           test_ssh_transport     PASSED    00:00:00.884
native_ssh           test_ssh_channel       PASSED    00:00:00.501
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.811
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.053
native_app           test_regex             PASSED    00:00:00.896
native_app           test_template          PASSED    00:00:00.509
native_app           test_path_params       PASSED    00:00:00.513
native_app           test_digest_vectors    PASSED    00:00:00.495
native_app           test_form_params       PASSED    00:00:00.497
native_app           test_iface             PASSED    00:00:00.520
...
native_app           test_web_terminal      PASSED    00:00:00.506
native_app           test_multipart         PASSED    00:00:00.522
native_app           test_auth              PASSED    00:00:00.521
native_app           test_file_serving      PASSED    00:00:00.525
native_app           test_dispatch          PASSED    00:00:00.513
...
================ 592 test cases: 592 succeeded in 00:00:35.892 ================
```
