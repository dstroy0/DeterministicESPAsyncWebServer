...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:14.119 |
...
| `test_ssh_crypto`       | `native_ssh`          |    38 |   ✅   | 00:00:03.806 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.542 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.655 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.863 |
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.511 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.821 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.197 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:01.034 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.544 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.546 |
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.488 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.543 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.546 |
...
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.554 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.552 |
...
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.631 |
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:14.119
...
native_ssh           test_ssh_auth          PASSED    00:00:00.542
...
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.821
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.197
native_app           test_regex             PASSED    00:00:01.034
native_app           test_template          PASSED    00:00:00.544
native_app           test_path_params       PASSED    00:00:00.546
native_app           test_digest_vectors    PASSED    00:00:00.488
native_app           test_form_params       PASSED    00:00:00.543
native_app           test_iface             PASSED    00:00:00.546
...
native_app           test_digest_auth       PASSED    00:00:00.554
...
native_compliance    test_compliance        PASSED    00:00:00.631
native_workers       test_workers           PASSED    00:00:00.693
native_tsan          test_concurrency       PASSED    00:00:01.272
================ 621 test cases: 621 succeeded in 00:00:38.240 ================
```
