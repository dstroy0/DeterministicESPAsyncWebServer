...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:07.475 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.548 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.580 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.563 |
| `test_websocket`         | `native`               |    63 |   ✅   | 00:00:00.597 |
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.553 |
...
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.860 |
| `test_ssh_auth`          | `native_ssh`           |    12 |   ✅   | 00:00:00.564 |
...
| `test_ssh_hardening`     | `native_ssh_hardened`  |     2 |   ✅   | 00:00:00.888 |
...
| `test_digest_auth`       | `native_app`           |     5 |   ✅   | 00:00:00.581 |
...
| `test_file_serving`      | `native_app`           |    12 |   ✅   | 00:00:00.587 |
| `test_dispatch`          | `native_app`           |    11 |   ✅   | 00:00:00.573 |
| `test_chunked`           | `native_app`           |     8 |   ✅   | 00:00:00.580 |
| `test_application`       | `native_app`           |    50 |   ✅   | 00:00:00.669 |
| `test_snmp_ber`          | `native_snmp`          |     9 |   ✅   | 00:00:00.693 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.498 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.393 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.765 |
| `test_coap`              | `native_coap`          |    26 |   ✅   | 00:00:00.679 |
| `test_webdav`            | `native_webdav`        |    11 |   ✅   | 00:00:00.659 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.658 |
| `test_modbus_master`     | `native_modbus_master` |     5 |   ✅   | 00:00:00.664 |
...
| `test_espnow`            | `native_espnow`        |     7 |   ✅   | 00:00:00.654 |
...
| `test_range`             | `native_range`         |    10 |   ✅   | 00:00:01.058 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.653 |
| `test_jwt`               | `native_jwt`           |    10 |   ✅   | 00:00:00.709 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.060 |
...
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.694 |
| `test_scratch`           | `native_scratch`       |    14 |   ✅   | 00:00:00.678 |
| `test_snmp_trap`         | `native_snmp_trap`     |     3 |   ✅   | 00:00:00.672 |
| `test_inflate`           | `native_inflate`       |    12 |   ✅   | 00:00:00.649 |
| `test_deflate`           | `native_deflate`       |    10 |   ✅   | 00:00:00.689 |
| `test_websocket`         | `native_ws_deflate`    |    67 |   ✅   | 00:00:01.017 |
...
| `test_cbor`              | `native_cbor`          |    14 |   ✅   | 00:00:00.657 |
| `test_msgpack`           | `native_msgpack`       |     8 |   ✅   | 00:00:00.643 |
| `test_gpio_map`          | `native_gpio_map`      |     8 |   ✅   | 00:00:00.658 |
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.656 |
...
| `test_concurrency`       | `native_tsan`          |     2 |   ✅   | 00:00:01.268 |
...
------------------ native:test_sse [PASSED] Took 7.47 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:07.475
native         test_session       PASSED    00:00:00.548
native         test_presentation  PASSED    00:00:00.580
native         test_transport     PASSED    00:00:00.563
native         test_websocket     PASSED    00:00:00.597
native         test_http_parser   PASSED    00:00:00.553
================ 306 test cases: 306 succeeded in 00:00:10.315 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
native_ssh     test_ssh_auth       PASSED    00:00:00.564
...
================= 92 test cases: 92 succeeded in 00:00:06.522 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.888
...
native_app     test_digest_auth       PASSED    00:00:00.581
...
native_app     test_file_serving      PASSED    00:00:00.587
...
================ 202 test cases: 202 succeeded in 00:00:10.861 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
================= 22 test cases: 22 succeeded in 00:00:01.191 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.679
================= 26 test cases: 26 succeeded in 00:00:00.679 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.664
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.654
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.058
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.060
================== 3 test cases: 3 succeeded in 00:00:01.060 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.689
...
================= 67 test cases: 67 succeeded in 00:00:01.017 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.268
