...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:14.698 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.589 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.622 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.614 |
| `test_websocket`         | `native`               |    63 |   ✅   | 00:00:00.640 |
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.598 |
| `test_http_ota`          | `native_ota`           |     3 |   ✅   | 00:00:00.688 |
| `test_provisioning`      | `native_prov`          |     5 |   ✅   | 00:00:00.680 |
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.872 |
| `test_ssh_auth`          | `native_ssh`           |    12 |   ✅   | 00:00:00.593 |
| `test_ssh_server`        | `native_ssh`           |     7 |   ✅   | 00:00:00.707 |
| `test_ssh_transport`     | `native_ssh`           |    23 |   ✅   | 00:00:00.903 |
| `test_ssh_channel`       | `native_ssh`           |    12 |   ✅   | 00:00:00.566 |
| `test_ssh_hardening`     | `native_ssh_hardened`  |     2 |   ✅   | 00:00:00.916 |
| `test_ssh_conn`          | `native_ssh_conn`      |     2 |   ✅   | 00:00:01.301 |
...
| `test_json`              | `native_app`           |    17 |   ✅   | 00:00:00.586 |
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.655 |
| `test_middleware`        | `native_app`           |     9 |   ✅   | 00:00:00.645 |
| `test_digest_auth`       | `native_app`           |     5 |   ✅   | 00:00:00.653 |
| `test_web_terminal`      | `native_app`           |     7 |   ✅   | 00:00:00.640 |
| `test_defer`             | `native_app`           |     3 |   ✅   | 00:00:00.630 |
...
| `test_chunked`           | `native_app`           |     8 |   ✅   | 00:00:00.652 |
| `test_application`       | `native_app`           |    50 |   ✅   | 00:00:00.744 |
| `test_snmp_ber`          | `native_snmp`          |     9 |   ✅   | 00:00:00.806 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.570 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.449 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.850 |
| `test_coap`              | `native_coap`          |    26 |   ✅   | 00:00:00.732 |
| `test_webdav`            | `native_webdav`        |    11 |   ✅   | 00:00:00.730 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.727 |
| `test_modbus_master`     | `native_modbus_master` |     5 |   ✅   | 00:00:00.742 |
| `test_ota_rollback`      | `native_ota_rollback`  |     5 |   ✅   | 00:00:00.681 |
| `test_totp`              | `native_totp`          |     4 |   ✅   | 00:00:00.711 |
| `test_webhook`           | `native_webhook`       |     5 |   ✅   | 00:00:00.698 |
| `test_radio_power`       | `native_radio_power`   |     2 |   ✅   | 00:00:00.701 |
| `test_dns_resolver`      | `native_dns_resolver`  |     4 |   ✅   | 00:00:00.704 |
| `test_audit_log`         | `native_audit_log`     |    12 |   ✅   | 00:00:00.735 |
...
| `test_oauth2`            | `native_oauth2`        |     8 |   ✅   | 00:00:00.752 |
| `test_opcua`             | `native_opcua`         |    29 |   ✅   | 00:00:00.768 |
| `test_opcua_client`      | `native_opcua_client`  |    11 |   ✅   | 00:00:00.730 |
| `test_keepalive`         | `native_keepalive`     |    10 |   ✅   | 00:00:01.132 |
| `test_range`             | `native_range`         |    10 |   ✅   | 00:00:01.106 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.718 |
| `test_jwt`               | `native_jwt`           |    10 |   ✅   | 00:00:00.749 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.155 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.724 |
| `test_compliance`        | `native_compliance`    |    12 |   ✅   | 00:00:00.704 |
| `test_mqtt`              | `native_mqtt`          |    16 |   ✅   | 00:00:00.723 |
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.734 |
| `test_scratch`           | `native_scratch`       |    14 |   ✅   | 00:00:00.751 |
...
| `test_websocket`         | `native_ws_deflate`    |    67 |   ✅   | 00:00:01.048 |
...
| `test_dashboard`         | `native_dashboard`     |    11 |   ✅   | 00:00:00.686 |
| `test_net_egress`        | `native_net_egress`    |     5 |   ✅   | 00:00:00.700 |
...
| `test_clock`             | `native_clock`         |     4 |   ✅   | 00:00:00.676 |
| `test_concurrency`       | `native_concurrency`   |     2 |   ✅   | 00:00:00.957 |
...
----------------- native:test_sse [PASSED] Took 14.70 seconds ------------------
...
--------------------  ----------------------  --------  ------------
native                test_sse                PASSED    00:00:14.698
...
native_ssh            test_ssh_auth           PASSED    00:00:00.593
...
native_ssh_hardened   test_ssh_hardening      PASSED    00:00:00.916
native_ssh_conn       test_ssh_conn           PASSED    00:00:01.301
...
native_app            test_web_terminal       PASSED    00:00:00.640
native_app            test_defer              PASSED    00:00:00.630
...
native_app            test_chunked            PASSED    00:00:00.652
native_app            test_application        PASSED    00:00:00.744
native_snmp           test_snmp_ber           PASSED    00:00:00.806
native_snmp           test_snmp_agent         PASSED    00:00:00.570
native_snmp_v3        test_snmp_v3            PASSED    00:00:01.449
native_telnet         test_telnet             PASSED    00:00:00.850
native_coap           test_coap               PASSED    00:00:00.732
native_webdav         test_webdav             PASSED    00:00:00.730
native_modbus         test_modbus             PASSED    00:00:00.727
native_modbus_master  test_modbus_master      PASSED    00:00:00.742
native_ota_rollback   test_ota_rollback       PASSED    00:00:00.681
native_totp           test_totp               PASSED    00:00:00.711
native_webhook        test_webhook            PASSED    00:00:00.698
native_radio_power    test_radio_power        PASSED    00:00:00.701
native_dns_resolver   test_dns_resolver       PASSED    00:00:00.704
native_audit_log      test_audit_log          PASSED    00:00:00.735
...
native_oauth2         test_oauth2             PASSED    00:00:00.752
native_opcua          test_opcua              PASSED    00:00:00.768
native_opcua_client   test_opcua_client       PASSED    00:00:00.730
...
native_http_client    test_http_client        PASSED    00:00:00.724
native_compliance     test_compliance         PASSED    00:00:00.704
native_mqtt           test_mqtt               PASSED    00:00:00.723
native_ws_client      test_ws_client          PASSED    00:00:00.734
native_scratch        test_scratch            PASSED    00:00:00.751
...
native_clock          test_clock              PASSED    00:00:00.676
native_concurrency    test_concurrency        PASSED    00:00:00.957
native_tsan           test_concurrency        PASSED    00:00:01.408
=============== 1157 test cases: 1157 succeeded in 00:01:22.527 ===============
```
