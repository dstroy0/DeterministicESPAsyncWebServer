...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:10.928 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.492 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.522 |
| `test_transport`        | `native`              |    34 |   ✅   | 00:00:00.507 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.534 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.527 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.786 |
...
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.818 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.080 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.927 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.513 |
...
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.497 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.513 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.511 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.525 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.508 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.522 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.515 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.528 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.515 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.515 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.605 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.620 |
...
----------------- native:test_sse [PASSED] Took 10.93 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:10.928
native               test_session           PASSED    00:00:00.492
native               test_presentation      PASSED    00:00:00.522
native               test_transport         PASSED    00:00:00.507
native               test_websocket         PASSED    00:00:00.534
native               test_http_parser       PASSED    00:00:00.527
native_ssh           test_ssh_crypto        PASSED    00:00:03.786
...
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.818
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.080
native_app           test_regex             PASSED    00:00:00.927
native_app           test_template          PASSED    00:00:00.513
...
native_app           test_json              PASSED    00:00:00.497
native_app           test_response_headers  PASSED    00:00:00.513
native_app           test_middleware        PASSED    00:00:00.511
native_app           test_digest_auth       PASSED    00:00:00.525
native_app           test_web_terminal      PASSED    00:00:00.508
native_app           test_multipart         PASSED    00:00:00.522
native_app           test_auth              PASSED    00:00:00.515
native_app           test_file_serving      PASSED    00:00:00.528
native_app           test_dispatch          PASSED    00:00:00.515
native_app           test_chunked           PASSED    00:00:00.515
native_app           test_application       PASSED    00:00:00.605
native_compliance    test_compliance        PASSED    00:00:00.620
================ 603 test cases: 603 succeeded in 00:00:31.628 ================
```
