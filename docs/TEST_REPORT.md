...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:06.530 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.581 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.623 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.618 |
| `test_websocket`         | `native`               |    63 |   ✅   | 00:00:00.633 |
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.584 |
| `test_observability`     | `native_observability` |    15 |   ✅   | 00:00:00.758 |
| `test_http_ota`          | `native_ota`           |     3 |   ✅   | 00:00:00.701 |
| `test_provisioning`      | `native_prov`          |     5 |   ✅   | 00:00:00.690 |
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.885 |
...
| `test_ssh_channel`       | `native_ssh`           |    12 |   ✅   | 00:00:00.543 |
| `test_ssh_hardening`     | `native_ssh_hardened`  |     2 |   ✅   | 00:00:00.927 |
| `test_ssh_conn`          | `native_ssh_conn`      |     2 |   ✅   | 00:00:01.300 |
...
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.607 |
| `test_middleware`        | `native_app`           |     9 |   ✅   | 00:00:00.617 |
| `test_digest_auth`       | `native_app`           |     5 |   ✅   | 00:00:00.615 |
| `test_web_terminal`      | `native_app`           |     7 |   ✅   | 00:00:00.623 |
...
| `test_chunked`           | `native_app`           |    10 |   ✅   | 00:00:00.621 |
| `test_application`       | `native_app`           |    50 |   ✅   | 00:00:00.697 |
| `test_snmp_ber`          | `native_snmp`          |     9 |   ✅   | 00:00:00.734 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.511 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.428 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.820 |
| `test_coap`              | `native_coap`          |    26 |   ✅   | 00:00:00.728 |
| `test_webdav`            | `native_webdav`        |    19 |   ✅   | 00:00:00.721 |
...
| `test_radio_power`       | `native_radio_power`   |     2 |   ✅   | 00:00:00.689 |
| `test_dns_resolver`      | `native_dns_resolver`  |     4 |   ✅   | 00:00:00.665 |
| `test_audit_log`         | `native_audit_log`     |    12 |   ✅   | 00:00:00.707 |
| `test_oidc`              | `native_oidc`          |    13 |   ✅   | 00:00:00.846 |
| `test_vfs`               | `native_vfs`           |    11 |   ✅   | 00:00:00.690 |
| `test_graphql`           | `native_graphql`       |    13 |   ✅   | 00:00:00.689 |
| `test_espnow`            | `native_espnow`        |     7 |   ✅   | 00:00:00.695 |
| `test_oauth2`            | `native_oauth2`        |     8 |   ✅   | 00:00:00.717 |
| `test_opcua`             | `native_opcua`         |    29 |   ✅   | 00:00:00.724 |
| `test_opcua_client`      | `native_opcua_client`  |    11 |   ✅   | 00:00:00.720 |
| `test_keepalive`         | `native_keepalive`     |    10 |   ✅   | 00:00:01.108 |
| `test_range`             | `native_range`         |    10 |   ✅   | 00:00:01.136 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.699 |
| `test_jwt`               | `native_jwt`           |    10 |   ✅   | 00:00:00.741 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.138 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.682 |
| `test_compliance`        | `native_compliance`    |    12 |   ✅   | 00:00:00.699 |
| `test_mqtt`              | `native_mqtt`          |    16 |   ✅   | 00:00:00.687 |
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.733 |
| `test_scratch`           | `native_scratch`       |    14 |   ✅   | 00:00:00.727 |
| `test_snmp_trap`         | `native_snmp_trap`     |     3 |   ✅   | 00:00:00.716 |
| `test_inflate`           | `native_inflate`       |    12 |   ✅   | 00:00:00.676 |
| `test_deflate`           | `native_deflate`       |    10 |   ✅   | 00:00:00.724 |
| `test_websocket`         | `native_ws_deflate`    |    67 |   ✅   | 00:00:01.068 |
| `test_time_source`       | `native_time_source`   |     9 |   ✅   | 00:00:00.672 |
| `test_config_store`      | `native_config_store`  |    14 |   ✅   | 00:00:00.704 |
| `test_device_id`         | `native_device_id`     |     4 |   ✅   | 00:00:00.695 |
| `test_auth_lockout`      | `native_auth_lockout`  |    10 |   ✅   | 00:00:00.681 |
| `test_csrf`              | `native_csrf`          |     9 |   ✅   | 00:00:00.716 |
| `test_telemetry`         | `native_telemetry`     |     8 |   ✅   | 00:00:00.717 |
| `test_dashboard`         | `native_dashboard`     |    11 |   ✅   | 00:00:00.687 |
| `test_net_egress`        | `native_net_egress`    |     5 |   ✅   | 00:00:00.682 |
| `test_partition_monitor` | `native_partition`     |     5 |   ✅   | 00:00:00.703 |
| `test_cbor`              | `native_cbor`          |    14 |   ✅   | 00:00:00.704 |
| `test_msgpack`           | `native_msgpack`       |    15 |   ✅   | 00:00:00.708 |
| `test_gpio_map`          | `native_gpio_map`      |     8 |   ✅   | 00:00:00.689 |
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.704 |
| `test_guardrails`        | `native_guardrails`    |     6 |   ✅   | 00:00:00.695 |
| `test_logbuf`            | `native_logbuf`        |     4 |   ✅   | 00:00:00.696 |
| `test_config_io`         | `native_config_io`     |     4 |   ✅   | 00:00:00.710 |
| `test_workers`           | `native_workers`       |     3 |   ✅   | 00:00:00.820 |
| `test_clock`             | `native_clock`         |     4 |   ✅   | 00:00:00.660 |
...
------------------ native:test_sse [PASSED] Took 6.53 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.530
...
================ 306 test cases: 306 succeeded in 00:00:09.568 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.758
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.690
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.885
...
native_ssh     test_ssh_channel    PASSED    00:00:00.543
================= 92 test cases: 92 succeeded in 00:00:06.604 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.300
...
================ 204 test cases: 204 succeeded in 00:00:11.556 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.734
native_snmp    test_snmp_agent  PASSED    00:00:00.511
================= 22 test cases: 22 succeeded in 00:00:01.245 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 1.43 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.428
================== 9 test cases: 9 succeeded in 00:00:01.428 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
================== 8 test cases: 8 succeeded in 00:00:00.820 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.728
================= 26 test cases: 26 succeeded in 00:00:00.728 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.721
================= 19 test cases: 19 succeeded in 00:00:00.721 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.689
================== 2 test cases: 2 succeeded in 00:00:00.689 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.846
================= 13 test cases: 13 succeeded in 00:00:00.846 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.695
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.108
================= 10 test cases: 10 succeeded in 00:00:01.108 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
================= 10 test cases: 10 succeeded in 00:00:01.136 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.138
================== 3 test cases: 3 succeeded in 00:00:01.138 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.733
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.716
...
================= 67 test cases: 67 succeeded in 00:00:01.068 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.695
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.717
================== 8 test cases: 8 succeeded in 00:00:00.717 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.704
================= 14 test cases: 14 succeeded in 00:00:00.704 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 88 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.704
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.696
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.710
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.660
