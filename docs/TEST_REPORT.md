...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:06.018 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.693 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.682 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.688 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:03.654 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.682 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.674 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.700 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.687 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.701 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.692 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.685 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.687 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.686 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.674 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.679 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.080 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.605 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.638 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.673 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.659 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.623 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.798 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:01.044 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.712 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.699 |
| `test_ssh_crypto`        | `native_ssh`            |    45 |   ✅   | 00:00:03.918 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.677 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.905 |
| `test_ssh_transport`     | `native_ssh`            |    33 |   ✅   | 00:00:01.205 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.617 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.011 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.456 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.232 |
...
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.260 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.220 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.728 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.543 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:02.103 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.837 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.935 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.802 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.702 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.701 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.764 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.694 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.690 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.692 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.702 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.688 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.730 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.768 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.865 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.763 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.685 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.682 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.670 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.683 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.688 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.683 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.683 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.685 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.699 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.691 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.682 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.677 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.689 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.681 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.716 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.683 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.744 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.688 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.685 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.669 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.690 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.684 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.696 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.682 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.692 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.694 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.684 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.699 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.708 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.678 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.698 |
...
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.706 |
...
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.707 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.726 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.729 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.144 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.141 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.705 |
| `test_smtp`              | `native_smtp`           |    11 |   ✅   | 00:00:00.799 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.682 |
| `test_dns_server`        | `native_dns_server`     |     7 |   ✅   | 00:00:00.697 |
| `test_rtc`               | `native_rtc`            |     8 |   ✅   | 00:00:00.691 |
| `test_ld2410`            | `native_ld2410`         |     7 |   ✅   | 00:00:00.687 |
| `test_mpr121`            | `native_mpr121`         |     5 |   ✅   | 00:00:00.684 |
| `test_sht3x`             | `native_sht3x`          |     5 |   ✅   | 00:00:00.677 |
| `test_pca9685`           | `native_pca9685`        |     4 |   ✅   | 00:00:00.685 |
| `test_ads1115`           | `native_ads1115`        |     3 |   ✅   | 00:00:00.682 |
...
| `test_h2_conn`           | `native_h2conn`         |     4 |   ✅   | 00:00:00.899 |
| `test_quic_varint`       | `native_quic_varint`    |     3 |   ✅   | 00:00:00.685 |
| `test_h3_frame`          | `native_h3frame`        |     7 |   ✅   | 00:00:00.698 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.731 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.173 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.698 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.711 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.699 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.723 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.725 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.701 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.693 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.736 |
| `test_ssh_zlib`          | `native_ssh_zlib`       |     9 |   ✅   | 00:00:00.801 |
| `test_ssh_comp`          | `native_ssh_comp`       |     5 |   ✅   | 00:00:01.091 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.115 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.675 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.696 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.700 |
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.716 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.723 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.699 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.689 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.682 |
...
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.680 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.692 |
| `test_statsd`            | `native_statsd`         |     9 |   ✅   | 00:00:00.715 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.686 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.684 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.712 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.815 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.673 |
...
| `test_quic_packet`       | `native_quic_packet`    |     8 |   ✅   | 00:00:00.679 |
| `test_quic_frame`        | `native_quic_frame`     |     8 |   ✅   | 00:00:00.705 |
| `test_quic_crypto`       | `native_quic_crypto`    |     7 |   ✅   | 00:00:00.772 |
| `test_tls13_kdf`         | `native_tls13_kdf`      |     5 |   ✅   | 00:00:00.727 |
| `test_quic_tp`           | `native_quic_tp`        |     7 |   ✅   | 00:00:00.718 |
| `test_tls13_msg`         | `native_tls13_msg`      |     7 |   ✅   | 00:00:00.796 |
| `test_quic_tls`          | `native_quic_tls`       |    11 |   ✅   | 00:00:00.973 |
| `test_quic_conn`         | `native_quic_conn`      |     1 |   ✅   | 00:00:00.977 |
| `test_h3_conn`           | `native_h3_conn`        |     3 |   ✅   | 00:00:00.972 |
| `test_h3_e2e`            | `native_h3_e2e`         |     1 |   ✅   | 00:00:01.013 |
| `test_quic_server`       | `native_quic_server`    |     1 |   ✅   | 00:00:01.028 |
| `test_h3_server`         | `native_h3_server`      |     1 |   ✅   | 00:00:01.569 |
| `test_ssh_chachapoly`    | `native_ssh_chachapoly` |     4 |   ✅   | 00:00:00.710 |
...
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.018
================= 17 test cases: 17 succeeded in 00:00:06.018 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.693
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.682
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_det_arena  test_det_arena  PASSED    00:00:00.688
================= 17 test cases: 17 succeeded in 00:00:00.688 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:03.654
================= 16 test cases: 16 succeeded in 00:00:03.654 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.682
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.674
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.700
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.692
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.686
...
native         test_session       PASSED    00:00:00.605
...
native         test_http_parser   PASSED    00:00:00.623
================ 323 test cases: 323 succeeded in 00:00:04.278 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.798
================= 17 test cases: 17 succeeded in 00:00:00.798 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.044
================= 13 test cases: 13 succeeded in 00:00:01.044 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.918
native_ssh     test_ssh_auth       PASSED    00:00:00.677
native_ssh     test_ssh_server     PASSED    00:00:00.905
native_ssh     test_ssh_transport  PASSED    00:00:01.205
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:01.011
================== 2 test cases: 2 succeeded in 00:00:01.011 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.456
================== 2 test cases: 2 succeeded in 00:00:01.456 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.232
...
================ 225 test cases: 225 succeeded in 00:00:12.075 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.260
================= 12 test cases: 12 succeeded in 00:00:01.260 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.220
...
native_snmp    test_snmp_agent  PASSED    00:00:00.543
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:02.103
================= 15 test cases: 15 succeeded in 00:00:02.103 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.935
================= 41 test cases: 41 succeeded in 00:00:00.935 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.802
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.702
================= 19 test cases: 19 succeeded in 00:00:00.702 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.701
================= 22 test cases: 22 succeeded in 00:00:00.701 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.764
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.692
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.730
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.768
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.763
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.682
================= 10 test cases: 10 succeeded in 00:00:00.682 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.670
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_zigbee  test_zigbee  PASSED    00:00:00.683
================== 9 test cases: 9 succeeded in 00:00:00.683 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.685
================= 13 test cases: 13 succeeded in 00:00:00.685 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.682
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.689
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.681
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.716
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.685
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.669
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.682
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.692
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.699
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.698
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.706
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.707
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.729
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.144
================= 10 test cases: 10 succeeded in 00:00:01.144 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.141
================= 13 test cases: 13 succeeded in 00:00:01.141 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_smtp    test_smtp  PASSED    00:00:00.799
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_rtc     test_rtc  PASSED    00:00:00.691
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sht3x   test_sht3x  PASSED    00:00:00.677
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_pca9685  test_pca9685  PASSED    00:00:00.685
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_ads1115  test_ads1115  PASSED    00:00:00.682
...
Environment    Test          Status    Duration
-------------  ------------  --------  ------------
native_h2conn  test_h2_conn  PASSED    00:00:00.899
================== 4 test cases: 4 succeeded in 00:00:00.899 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h3frame  test_h3_frame  PASSED    00:00:00.698
...
================= 21 test cases: 21 succeeded in 00:00:00.731 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.173
================== 3 test cases: 3 succeeded in 00:00:01.173 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.699
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.723
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.725
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.736
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_zlib  test_ssh_zlib  PASSED    00:00:00.801
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_comp  test_ssh_comp  PASSED    00:00:01.091
================== 5 test cases: 5 succeeded in 00:00:01.091 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.696
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.716
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.699
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.680
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_statsd  test_statsd  PASSED    00:00:00.715
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.686
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.815
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.673
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_packet  test_quic_packet  PASSED    00:00:00.679
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_quic_frame  test_quic_frame  PASSED    00:00:00.705
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_crypto  test_quic_crypto  PASSED    00:00:00.772
...
---------- native_tls13_msg:test_tls13_msg [PASSED] Took 0.80 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_tls13_msg  test_tls13_msg  PASSED    00:00:00.796
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_quic_conn  test_quic_conn  PASSED    00:00:00.977
================== 1 test cases: 1 succeeded in 00:00:00.977 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_h3_conn  test_h3_conn  PASSED    00:00:00.972
================== 3 test cases: 3 succeeded in 00:00:00.972 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_h3_e2e  test_h3_e2e  PASSED    00:00:01.013
================== 1 test cases: 1 succeeded in 00:00:01.013 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_h3_server  test_h3_server  PASSED    00:00:01.569
================== 1 test cases: 1 succeeded in 00:00:01.569 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_ssh_chachapoly  test_ssh_chachapoly  PASSED    00:00:00.710
