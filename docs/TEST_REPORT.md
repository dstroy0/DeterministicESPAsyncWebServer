...
**Generated:** 2026-06-29 19:23:03
**Command:** `pio test` over 89 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1465 passed - 135s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:06.605 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.534 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.570 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.555 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.598 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.558 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.687 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.606 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.621 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:04.173 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.532 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.679 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.948 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.493 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.815 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.193 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.074 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.556 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.576 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.503 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.554 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.560 |
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.514 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.568 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.570 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.584 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.571 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.572 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.594 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.576 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.581 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.574 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.567 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.643 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.137 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.071 |
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.613 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.476 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.553 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.746 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.713 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.706 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.626 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.603 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.658 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.590 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.596 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.573 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.590 |
| `test_protobuf`          | `native_protobuf`       |     8 |   ✅   | 00:00:00.593 |
| `test_wamp`              | `native_wamp`           |    11 |   ✅   | 00:00:00.644 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.585 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.586 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.600 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.606 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |     7 |   ✅   | 00:00:00.588 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.602 |
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.668 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.579 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.598 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.588 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.576 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.588 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.601 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.579 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.595 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.597 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.611 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.593 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.596 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.599 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.587 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.593 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.626 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.795 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.608 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.612 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.593 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.619 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.640 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.635 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.005 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:00.993 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.622 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.643 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.066 |
| `test_http_client`       | `native_http_client`    |    10 |   ✅   | 00:00:00.621 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.604 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.593 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.618 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.637 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.628 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.590 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.636 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:00.964 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.603 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.596 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.609 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.587 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.622 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.593 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.614 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.596 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.606 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.616 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.595 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.585 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.595 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.603 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.590 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.632 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.695 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.566 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.787 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.227 |
...
|   7 | `test_overflow_and_malformed`   |   ✅   | Overflow and malformed   |
...
------------------ native:test_sse [PASSED] Took 6.60 seconds ------------------
...
--------------- native:test_transport [PASSED] Took 0.55 seconds ---------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.605
native         test_session       PASSED    00:00:00.534
native         test_presentation  PASSED    00:00:00.570
native         test_transport     PASSED    00:00:00.555
native         test_websocket     PASSED    00:00:00.598
native         test_http_parser   PASSED    00:00:00.558
================ 318 test cases: 318 succeeded in 00:00:09.420 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.606
================== 3 test cases: 3 succeeded in 00:00:00.606 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.621
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 4.17 seconds -------------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.173
native_ssh     test_ssh_auth       PASSED    00:00:00.532
native_ssh     test_ssh_server     PASSED    00:00:00.679
native_ssh     test_ssh_transport  PASSED    00:00:00.948
native_ssh     test_ssh_channel    PASSED    00:00:00.493
================= 93 test cases: 93 succeeded in 00:00:06.824 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.815
================== 2 test cases: 2 succeeded in 00:00:00.815 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
src/DeterministicESPAsyncWebServer.cpp:2923:76: warning: ‘snprintf’ output may be truncated before the last format character [-Wformat-truncation=]
 2923 |         snprintf(lastmod_line, sizeof(lastmod_line), "Last-Modified: %s\r\n", lm_date);
      |                                                                            ^
src/DeterministicESPAsyncWebServer.cpp:2923:17: note: ‘snprintf’ output between 18 and 57 bytes into a destination of size 56
 2923 |         snprintf(lastmod_line, sizeof(lastmod_line), "Last-Modified: %s\r\n", lm_date);
      |         ~~~~~~~~^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Testing...
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.074
native_app     test_template          PASSED    00:00:00.556
native_app     test_path_params       PASSED    00:00:00.576
native_app     test_digest_vectors    PASSED    00:00:00.503
native_app     test_form_params       PASSED    00:00:00.554
native_app     test_iface             PASSED    00:00:00.560
native_app     test_json              PASSED    00:00:00.514
native_app     test_response_headers  PASSED    00:00:00.568
native_app     test_middleware        PASSED    00:00:00.570
native_app     test_digest_auth       PASSED    00:00:00.584
native_app     test_web_terminal      PASSED    00:00:00.571
native_app     test_defer             PASSED    00:00:00.572
native_app     test_multipart         PASSED    00:00:00.594
native_app     test_auth              PASSED    00:00:00.576
native_app     test_file_serving      PASSED    00:00:00.581
native_app     test_dispatch          PASSED    00:00:00.574
native_app     test_chunked           PASSED    00:00:00.567
native_app     test_application       PASSED    00:00:00.643
================ 219 test cases: 219 succeeded in 00:00:10.738 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
----- native_webdav_handler:test_webdav_handler [PASSED] Took 1.14 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.137
================= 12 test cases: 12 succeeded in 00:00:01.137 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
--------------- native_diag:test_diag [PASSED] Took 1.07 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.071
================== 2 test cases: 2 succeeded in 00:00:01.071 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.613
native_snmp    test_snmp_agent  PASSED    00:00:00.476
================= 29 test cases: 29 succeeded in 00:00:01.089 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.746
...
================= 29 test cases: 29 succeeded in 00:00:00.713 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.706
================= 29 test cases: 29 succeeded in 00:00:00.706 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.626
================= 19 test cases: 19 succeeded in 00:00:00.626 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.603
================= 18 test cases: 18 succeeded in 00:00:00.603 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.658
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_redis_resp/test_redis_resp.cpp:125: test_encode_command       [PASSED]
test/test_redis_resp/test_redis_resp.cpp:126: test_encode_binary_safe   [PASSED]
test/test_redis_resp/test_redis_resp.cpp:127: test_encode_overflow_fails_closed [PASSED]
test/test_redis_resp/test_redis_resp.cpp:128: test_parse_simple_and_error [PASSED]
test/test_redis_resp/test_redis_resp.cpp:129: test_parse_integer        [PASSED]
test/test_redis_resp/test_redis_resp.cpp:130: test_parse_bulk_and_nil   [PASSED]
test/test_redis_resp/test_redis_resp.cpp:131: test_parse_array_cursor   [PASSED]
test/test_redis_resp/test_redis_resp.cpp:132: test_parse_incomplete_and_malformed [PASSED]
----------- native_redis:test_redis_resp [PASSED] Took 0.59 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.590
================== 8 test cases: 8 succeeded in 00:00:00.590 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_stomp/test_stomp.cpp:159: test_build_send                     [PASSED]
test/test_stomp/test_stomp.cpp:160: test_build_no_headers_no_body       [PASSED]
test/test_stomp/test_stomp.cpp:161: test_build_escapes_header           [PASSED]
test/test_stomp/test_stomp.cpp:162: test_build_overflow_fails_closed    [PASSED]
test/test_stomp/test_stomp.cpp:163: test_round_trip                     [PASSED]
test/test_stomp/test_stomp.cpp:164: test_parse_message_crlf             [PASSED]
test/test_stomp/test_stomp.cpp:165: test_parse_content_length_body_with_nul [PASSED]
test/test_stomp/test_stomp.cpp:166: test_parse_skips_leading_heartbeats [PASSED]
...
-------------- native_stomp:test_stomp [PASSED] Took 0.60 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.596
================= 11 test cases: 11 succeeded in 00:00:00.596 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
------------ native_mqtt_sn:test_mqtt_sn [PASSED] Took 0.57 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.573
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_protobuf/test_protobuf.cpp:185: test_vector_field1_150        [PASSED]
test/test_protobuf/test_protobuf.cpp:186: test_vector_string_testing    [PASSED]
test/test_protobuf/test_protobuf.cpp:187: test_zigzag_mapping           [PASSED]
test/test_protobuf/test_protobuf.cpp:188: test_fixed_and_float_bytes    [PASSED]
test/test_protobuf/test_protobuf.cpp:189: test_round_trip_reader        [PASSED]
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_wamp/test_wamp.cpp:151: test_build_hello                      [PASSED]
test/test_wamp/test_wamp.cpp:152: test_build_subscribe_default_options  [PASSED]
test/test_wamp/test_wamp.cpp:153: test_build_publish_with_args          [PASSED]
test/test_wamp/test_wamp.cpp:154: test_build_publish_kwargs_only        [PASSED]
test/test_wamp/test_wamp.cpp:155: test_build_call_and_register_and_yield [PASSED]
test/test_wamp/test_wamp.cpp:156: test_build_unsubscribe_and_goodbye    [PASSED]
test/test_wamp/test_wamp.cpp:157: test_build_overflow_fails_closed      [PASSED]
test/test_wamp/test_wamp.cpp:158: test_parse_type_and_id                [PASSED]
test/test_wamp/test_wamp.cpp:159: test_parse_event_positions            [PASSED]
test/test_wamp/test_wamp.cpp:160: test_parse_get_uri_and_nesting        [PASSED]
test/test_wamp/test_wamp.cpp:161: test_parse_malformed                  [PASSED]
--------------- native_wamp:test_wamp [PASSED] Took 0.64 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.644
================= 11 test cases: 11 succeeded in 00:00:00.644 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
------------- native_c37118:test_c37118 [PASSED] Took 0.59 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.586
...
--------------- native_dnp3:test_dnp3 [PASSED] Took 0.60 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.600
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_lwm2m_tlv/test_lwm2m_tlv.cpp:170: test_write_int_1byte        [PASSED]
test/test_lwm2m_tlv/test_lwm2m_tlv.cpp:171: test_write_int_2byte        [PASSED]
test/test_lwm2m_tlv/test_lwm2m_tlv.cpp:172: test_write_string_8bit_length [PASSED]
test/test_lwm2m_tlv/test_lwm2m_tlv.cpp:173: test_write_16bit_id         [PASSED]
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.588
...
--------------- native_fins:test_fins [PASSED] Took 0.60 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.602
...
test/test_hostlink/test_hostlink.cpp:30: test_build_dm_read: Expected '@00RD0000001057*\r' Was '@00RD0000001057*\rB\x92m\xFF\x7F' [FAILED]
...
---------- native_hostlink:test_hostlink [ERRORED] Took 0.59 seconds ----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  ERRORED   00:00:00.594

============= 8 test cases: 1 failed, 6 succeeded in 00:00:00.594 =============
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
-------------- native_senml:test_senml [PASSED] Took 0.67 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.668
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.579
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.598
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.588
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.588
================== 8 test cases: 8 succeeded in 00:00:00.588 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.601
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_amqp/test_amqp.cpp:131: test_protocol_header                  [PASSED]
test/test_amqp/test_amqp.cpp:132: test_build_method_bytes               [PASSED]
test/test_amqp/test_amqp.cpp:133: test_method_round_trip                [PASSED]
test/test_amqp/test_amqp.cpp:134: test_heartbeat                        [PASSED]
test/test_amqp/test_amqp.cpp:135: test_parse_stream                     [PASSED]
test/test_amqp/test_amqp.cpp:136: test_parse_rejects_bad                [PASSED]
test/test_amqp/test_amqp.cpp:137: test_build_overflow_fails_closed      [PASSED]
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.595
...
Library Manager: Unity@2.6.1 has been installed!
Testing...
test/test_nats/test_nats.cpp:128: test_build_connect                    [PASSED]
test/test_nats/test_nats.cpp:129: test_build_pub                        [PASSED]
test/test_nats/test_nats.cpp:130: test_build_pub_with_reply             [PASSED]
test/test_nats/test_nats.cpp:131: test_build_pub_empty_payload          [PASSED]
test/test_nats/test_nats.cpp:132: test_build_sub_and_unsub              [PASSED]
test/test_nats/test_nats.cpp:133: test_parse_msg                        [PASSED]
test/test_nats/test_nats.cpp:134: test_parse_msg_with_reply             [PASSED]
test/test_nats/test_nats.cpp:135: test_parse_control_lines              [PASSED]
test/test_nats/test_nats.cpp:136: test_parse_incomplete                 [PASSED]
test/test_nats/test_nats.cpp:137: test_build_overflow_fails_closed      [PASSED]
--------------- native_nats:test_nats [PASSED] Took 0.60 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.597
================= 10 test cases: 10 succeeded in 00:00:00.597 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
------ native_modbus_master:test_modbus_master [PASSED] Took 0.61 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.611
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.593
================== 5 test cases: 5 succeeded in 00:00:00.593 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.599
...
-------- native_radio_power:test_radio_power [PASSED] Took 0.59 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.587
================== 2 test cases: 2 succeeded in 00:00:00.587 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
---------- native_audit_log:test_audit_log [PASSED] Took 0.63 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.626
================= 12 test cases: 12 succeeded in 00:00:00.626 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
--------------- native_oidc:test_oidc [PASSED] Took 0.79 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.795
================= 13 test cases: 13 succeeded in 00:00:00.795 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
---------------- native_vfs:test_vfs [PASSED] Took 0.61 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.608
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.612
================= 13 test cases: 13 succeeded in 00:00:00.612 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.593
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.640
================= 29 test cases: 29 succeeded in 00:00:00.640 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.005
================= 10 test cases: 10 succeeded in 00:00:01.005 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
-------------- native_range:test_range [PASSED] Took 0.99 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:00.993
================= 13 test cases: 13 succeeded in 00:00:00.993 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.622
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.643
================= 12 test cases: 12 succeeded in 00:00:00.643 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.066
================== 3 test cases: 3 succeeded in 00:00:01.066 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
================= 10 test cases: 10 succeeded in 00:00:00.621 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
================= 15 test cases: 15 succeeded in 00:00:00.604 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.593
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.637
================= 14 test cases: 14 succeeded in 00:00:00.637 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.628
================== 3 test cases: 3 succeeded in 00:00:00.628 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.636
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.964
================= 71 test cases: 71 succeeded in 00:00:00.964 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
-------- native_time_source:test_time_source [PASSED] Took 0.60 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.603
================== 9 test cases: 9 succeeded in 00:00:00.603 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.596
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.609
================== 4 test cases: 4 succeeded in 00:00:00.609 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.587
================= 10 test cases: 10 succeeded in 00:00:00.587 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.622
...
---------- native_dashboard:test_dashboard [PASSED] Took 0.61 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.614
================= 11 test cases: 11 succeeded in 00:00:00.614 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
--------- native_net_egress:test_net_egress [PASSED] Took 0.60 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.596
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.606
================== 5 test cases: 5 succeeded in 00:00:00.606 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.616
================= 14 test cases: 14 succeeded in 00:00:00.616 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.595
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.595
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.603
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.590
...
---------- native_config_io:test_config_io [PASSED] Took 0.63 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.632
...
------------ native_workers:test_workers [PASSED] Took 0.69 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.695
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.566
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.787
================== 2 test cases: 2 succeeded in 00:00:00.787 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 114 tests
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.227
================== 2 test cases: 2 succeeded in 00:00:01.227 ==================
```
