...
**Generated:** 2026-06-29 22:48:22
**Command:** `pio test` over 94 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1518 passed - 154s
...
| :----------------------- | :---------------------- | ----: | :----: | ------------: |
| `test_canopen`           | `native_canopen`        |    11 |   ✅   |  00:00:10.516 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   |  00:00:00.642 |
| `test_sse`               | `native`                |    37 |   ✅   |  00:00:00.975 |
| `test_session`           | `native`                |    19 |   ✅   |  00:00:00.569 |
| `test_presentation`      | `native`                |    63 |   ✅   |  00:00:00.614 |
| `test_transport`         | `native`                |    42 |   ✅   |  00:00:00.588 |
| `test_websocket`         | `native`                |    67 |   ✅   |  00:00:00.620 |
| `test_http_parser`       | `native`                |    90 |   ✅   |  00:00:00.584 |
| `test_observability`     | `native_observability`  |    15 |   ✅   |  00:00:00.722 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   |  00:00:00.931 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   |  00:00:00.662 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   |  00:00:00.679 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   |  00:00:03.745 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   |  00:00:00.562 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   |  00:00:00.690 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   |  00:00:00.927 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   |  00:00:00.528 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   |  00:00:00.862 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   |  00:00:01.214 |
| `test_regex`             | `native_app`            |     9 |   ✅   |  00:00:01.128 |
| `test_template`          | `native_app`            |     6 |   ✅   |  00:00:00.593 |
| `test_path_params`       | `native_app`            |     8 |   ✅   |  00:00:00.595 |
...
| `test_json`              | `native_app`            |    17 |   ✅   |  00:00:00.554 |
...
| `test_auth`              | `native_app`            |    13 |   ✅   |  00:00:00.595 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   |  00:00:00.609 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   |  00:00:00.589 |
| `test_chunked`           | `native_app`            |    12 |   ✅   |  00:00:00.613 |
| `test_application`       | `native_app`            |    53 |   ✅   |  00:00:00.685 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   |  00:00:01.166 |
| `test_diag`              | `native_diag`           |     2 |   ✅   |  00:00:01.113 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   |  00:00:00.687 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   |  00:00:00.507 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   |  00:00:01.509 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   |  00:00:00.784 |
| `test_coap`              | `native_coap`           |    29 |   ✅   |  00:00:00.825 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   |  00:00:00.727 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   |  00:00:00.654 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   |  00:00:00.668 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   |  00:00:00.707 |
...
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   |  00:00:00.636 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   |  00:00:00.653 |
...
| `test_fins`              | `native_fins`           |     6 |   ✅   |  00:00:00.642 |
| `test_senml`             | `native_senml`          |     6 |   ✅   |  00:00:00.720 |
| `test_df1`               | `native_df1`            |     9 |   ✅   |  00:00:00.638 |
...
| `test_sparkplug`         | `native_sparkplug`      |     6 |   ✅   |  00:00:00.663 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   |  00:00:00.657 |
...
| `test_oidc`              | `native_oidc`           |    13 |   ✅   |  00:00:00.822 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   |  00:00:00.649 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   |  00:00:00.633 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   |  00:00:00.648 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   |  00:00:00.665 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   |  00:00:00.675 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   |  00:00:00.684 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   |  00:00:01.042 |
| `test_range`             | `native_range`          |    13 |   ✅   |  00:00:01.063 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   |  00:00:00.661 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   |  00:00:00.694 |
| `test_upload`            | `native_upload`         |     3 |   ✅   |  00:00:01.083 |
| `test_http_client`       | `native_http_client`    |    11 |   ✅   |  00:00:00.659 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   |  00:00:00.646 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   |  00:00:00.652 |
...
| `test_deflate`           | `native_deflate`        |    10 |   ✅   |  00:00:00.688 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:00.1000 |
...
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   |  00:00:00.665 |
...
| `test_cbor`              | `native_cbor`           |    14 |   ✅   |  00:00:00.637 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   |  00:00:00.664 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   |  00:00:00.658 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   |  00:00:00.638 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   |  00:00:00.645 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   |  00:00:00.645 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   |  00:00:00.657 |
| `test_workers`           | `native_workers`        |     3 |   ✅   |  00:00:00.747 |
| `test_clock`             | `native_clock`          |     4 |   ✅   |  00:00:00.629 |
...
----------- native_canopen:test_canopen [PASSED] Took 10.52 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:10.516
================= 11 test cases: 11 succeeded in 00:00:10.516 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 119 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.722
...
-------- native_accept_gate:test_accept_gate [PASSED] Took 0.93 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.931
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 3.74 seconds -------------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.745
native_ssh     test_ssh_auth       PASSED    00:00:00.562
native_ssh     test_ssh_server     PASSED    00:00:00.690
native_ssh     test_ssh_transport  PASSED    00:00:00.927
native_ssh     test_ssh_channel    PASSED    00:00:00.528
================= 93 test cases: 93 succeeded in 00:00:06.452 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 119 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.862
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.128
native_app     test_template          PASSED    00:00:00.593
native_app     test_path_params       PASSED    00:00:00.595
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.166
================= 12 test cases: 12 succeeded in 00:00:01.166 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 119 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.113
================== 2 test cases: 2 succeeded in 00:00:01.113 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 119 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.687
native_snmp    test_snmp_agent  PASSED    00:00:00.507
================= 30 test cases: 30 succeeded in 00:00:01.194 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 119 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.509
================= 10 test cases: 10 succeeded in 00:00:01.509 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 119 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.784
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.825
================= 29 test cases: 29 succeeded in 00:00:00.825 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 119 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.727
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.707
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.636
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.653
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.642
...
test/test_hostlink/test_hostlink.cpp:30: test_build_dm_read: Expected '@00RD0000001057*\r' Was '@00RD0000001057*\r\x82\xBF\xEB\xFC\x7F' [FAILED]
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  ERRORED   00:00:00.647

============= 8 test cases: 1 failed, 6 succeeded in 00:00:00.647 =============
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 119 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.638
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.657
...
================= 13 test cases: 13 succeeded in 00:00:00.822 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 119 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.633
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.665
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.675
================= 29 test cases: 29 succeeded in 00:00:00.675 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 119 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.063
================= 13 test cases: 13 succeeded in 00:00:01.063 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 119 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.694
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.646
...
================= 19 test cases: 19 succeeded in 00:00:00.652 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 119 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.688
...
Environment        Test            Status    Duration
-----------------  --------------  --------  -------------
native_ws_deflate  test_websocket  PASSED    00:00:00.1000
================= 71 test cases: 71 succeeded in 00:00:00.1000 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 119 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.665
================== 8 test cases: 8 succeeded in 00:00:00.665 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 119 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.637
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.645
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.657
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.629
