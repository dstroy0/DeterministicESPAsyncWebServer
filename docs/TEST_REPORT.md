...
**Generated:** 2026-06-29 23:06:49
**Command:** `pio test` over 97 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1540 passed - 156s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    11 |   ✅   | 00:00:05.780 |
...
| `test_mbus`              | `native_mbus`           |     8 |   ✅   | 00:00:00.647 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:00.970 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.572 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.623 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.596 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.623 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.582 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.719 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:00.968 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.659 |
...
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.932 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.532 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.869 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.242 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.125 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.597 |
...
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.596 |
...
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.183 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.146 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.696 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.499 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.521 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.782 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.741 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.728 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.654 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.659 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.728 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.649 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.635 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.657 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.655 |
| `test_protobuf`          | `native_protobuf`       |    10 |   ✅   | 00:00:00.657 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.684 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.646 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.659 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.647 |
...
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.648 |
...
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.677 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.838 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.655 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.659 |
...
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.696 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.090 |
| `test_http_client`       | `native_http_client`    |    11 |   ✅   | 00:00:00.678 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.661 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.664 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.685 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.689 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.682 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.651 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.697 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.004 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.654 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.659 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.664 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.643 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.683 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.663 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.652 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.664 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.643 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.661 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.691 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.646 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.654 |
...
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.628 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.760 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.854 |
...
------------ native_canopen:test_canopen [PASSED] Took 5.78 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:05.780
================= 11 test cases: 11 succeeded in 00:00:05.780 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 122 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:00.970
...
native         test_websocket     PASSED    00:00:00.623
native         test_http_parser   PASSED    00:00:00.582
================ 318 test cases: 318 succeeded in 00:00:03.967 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 122 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.719
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.968
================= 10 test cases: 10 succeeded in 00:00:00.968 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 122 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.659
...
native_ssh     test_ssh_transport  PASSED    00:00:00.932
native_ssh     test_ssh_channel    PASSED    00:00:00.532
================= 93 test cases: 93 succeeded in 00:00:06.495 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 122 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.869
================== 2 test cases: 2 succeeded in 00:00:00.869 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 122 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.242
================== 2 test cases: 2 succeeded in 00:00:01.242 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 122 tests
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.125
native_app     test_template          PASSED    00:00:00.597
...
native_app     test_response_headers  PASSED    00:00:00.596
...
================ 219 test cases: 219 succeeded in 00:00:11.304 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 122 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.183
================= 12 test cases: 12 succeeded in 00:00:01.183 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 122 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.146
...
================= 30 test cases: 30 succeeded in 00:00:01.195 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 122 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.521
================= 10 test cases: 10 succeeded in 00:00:01.521 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 122 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.741
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.728
================= 29 test cases: 29 succeeded in 00:00:00.728 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 122 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.728
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.635
...
test/test_hostlink/test_hostlink.cpp:30: test_build_dm_read: Expected '@00RD0000001057*\r' Was '@00RD0000001057*\rz\xFA\xE4\xFE\x7F' [FAILED]
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  ERRORED   00:00:00.651

============= 8 test cases: 1 failed, 6 succeeded in 00:00:00.651 =============
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 122 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.640
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.648
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.677
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.655
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.696
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.090
================== 3 test cases: 3 succeeded in 00:00:01.090 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 122 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.685
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.004
================= 71 test cases: 71 succeeded in 00:00:01.004 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 122 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.654
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.659
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.683
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.652
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.643
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.661
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.646
================== 8 test cases: 8 succeeded in 00:00:00.646 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 122 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.628
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 1.85 seconds ------------

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.854
================== 2 test cases: 2 succeeded in 00:00:01.854 ==================
```
