...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:13.998 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.632 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.636 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.642 |
...
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:00.986 |
...
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.576 |
| `test_ssh_server`        | `native_ssh`            |    12 |   ✅   | 00:00:00.882 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.885 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.549 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.883 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.270 |
...
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.779 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.751 |
...
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.658 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.639 |
...
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.647 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.636 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.652 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.658 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.653 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.643 |
| `test_sparkplug`         | `native_sparkplug`      |     6 |   ✅   | 00:00:00.673 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.668 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.637 |
...
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.676 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.889 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.655 |
| `test_graphql`           | `native_graphql`        |    25 |   ✅   | 00:00:00.668 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.638 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.680 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.683 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.690 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.099 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.109 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.668 |
| `test_jwt`               | `native_jwt`            |    16 |   ✅   | 00:00:00.706 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.121 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.662 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.656 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.661 |
...
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.031 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.641 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.647 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.663 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.660 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.691 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.667 |
...
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.670 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.757 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.626 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.797 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.575 |
...
----------- native_canopen:test_canopen [PASSED] Took 14.00 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:13.998
================= 17 test cases: 17 succeeded in 00:00:13.998 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.636
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.642
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.639
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.656
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.724
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.986
================= 10 test cases: 10 succeeded in 00:00:00.986 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
native_ssh     test_ssh_auth       PASSED    00:00:00.576
native_ssh     test_ssh_server     PASSED    00:00:00.882
native_ssh     test_ssh_transport  PASSED    00:00:00.885
native_ssh     test_ssh_channel    PASSED    00:00:00.549
================ 106 test cases: 106 succeeded in 00:00:06.768 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.270
...
================ 225 test cases: 225 succeeded in 00:00:11.457 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
================= 30 test cases: 30 succeeded in 00:00:01.207 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.779
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.751
================= 29 test cases: 29 succeeded in 00:00:00.751 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.658
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.639
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.676
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.640
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.636
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.653
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.643
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.668
================== 5 test cases: 5 succeeded in 00:00:00.668 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.637
...
================= 13 test cases: 13 succeeded in 00:00:00.889 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
================= 25 test cases: 25 succeeded in 00:00:00.668 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.109
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.668
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.662
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.031
================= 71 test cases: 71 succeeded in 00:00:01.031 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 129 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.641
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.660
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.667
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.670
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.757
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.575
================== 2 test cases: 2 succeeded in 00:00:01.575 ==================
```
