...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:06.336 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.488 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.522 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.518 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.529 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.487 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:04.206 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.505 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.654 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.918 |
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.473 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.745 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.116 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.971 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.510 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.508 |
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.451 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.501 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.502 |
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.459 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.516 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.524 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.514 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.502 |
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.487 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.522 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.519 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.522 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.511 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.512 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.600 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.573 |
| `test_workers`          | `native_workers`      |     3 |   ✅   | 00:00:00.632 |
...
------------------ native:test_sse [PASSED] Took 6.34 seconds ------------------
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 4.21 seconds -------------
...
--------------- native_app:test_defer [PASSED] Took 0.49 seconds ---------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:06.336
native               test_session           PASSED    00:00:00.488
...
native               test_http_parser       PASSED    00:00:00.487
native_ssh           test_ssh_crypto        PASSED    00:00:04.206
native_ssh           test_ssh_auth          PASSED    00:00:00.505
native_ssh           test_ssh_server        PASSED    00:00:00.654
native_ssh           test_ssh_transport     PASSED    00:00:00.918
native_ssh           test_ssh_channel       PASSED    00:00:00.473
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.745
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.116
native_app           test_regex             PASSED    00:00:00.971
native_app           test_template          PASSED    00:00:00.510
native_app           test_path_params       PASSED    00:00:00.508
native_app           test_digest_vectors    PASSED    00:00:00.451
native_app           test_form_params       PASSED    00:00:00.501
native_app           test_iface             PASSED    00:00:00.502
native_app           test_json              PASSED    00:00:00.459
native_app           test_response_headers  PASSED    00:00:00.516
native_app           test_middleware        PASSED    00:00:00.524
native_app           test_digest_auth       PASSED    00:00:00.514
native_app           test_web_terminal      PASSED    00:00:00.502
native_app           test_defer             PASSED    00:00:00.487
native_app           test_multipart         PASSED    00:00:00.522
native_app           test_auth              PASSED    00:00:00.519
native_app           test_file_serving      PASSED    00:00:00.522
native_app           test_dispatch          PASSED    00:00:00.511
native_app           test_chunked           PASSED    00:00:00.512
native_app           test_application       PASSED    00:00:00.600
native_compliance    test_compliance        PASSED    00:00:00.573
native_workers       test_workers           PASSED    00:00:00.632
native_tsan          test_concurrency       PASSED    00:00:01.250
================ 619 test cases: 619 succeeded in 00:00:29.583 ================
```
