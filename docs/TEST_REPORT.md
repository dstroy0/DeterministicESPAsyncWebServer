...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:06.148 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.552 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.579 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.562 |
| `test_websocket`         | `native`               |    64 |   ✅   | 00:00:00.591 |
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.544 |
| `test_observability`     | `native_observability` |    15 |   ✅   | 00:00:00.687 |
| `test_http_ota`          | `native_ota`           |     3 |   ✅   | 00:00:00.621 |
| `test_provisioning`      | `native_prov`          |     5 |   ✅   | 00:00:00.634 |
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:03.811 |
| `test_ssh_auth`          | `native_ssh`           |    12 |   ✅   | 00:00:00.547 |
| `test_ssh_server`        | `native_ssh`           |     7 |   ✅   | 00:00:00.650 |
| `test_ssh_transport`     | `native_ssh`           |    23 |   ✅   | 00:00:00.862 |
| `test_ssh_channel`       | `native_ssh`           |    12 |   ✅   | 00:00:00.504 |
| `test_ssh_hardening`     | `native_ssh_hardened`  |     2 |   ✅   | 00:00:00.838 |
| `test_ssh_conn`          | `native_ssh_conn`      |     2 |   ✅   | 00:00:01.200 |
| `test_regex`             | `native_app`           |     9 |   ✅   | 00:00:01.111 |
| `test_template`          | `native_app`           |     6 |   ✅   | 00:00:00.569 |
| `test_path_params`       | `native_app`           |     8 |   ✅   | 00:00:00.574 |
| `test_digest_vectors`    | `native_app`           |     4 |   ✅   | 00:00:00.506 |
| `test_form_params`       | `native_app`           |     5 |   ✅   | 00:00:00.568 |
| `test_iface`             | `native_app`           |     7 |   ✅   | 00:00:00.571 |
| `test_json`              | `native_app`           |    17 |   ✅   | 00:00:00.524 |
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.573 |
| `test_middleware`        | `native_app`           |     9 |   ✅   | 00:00:00.571 |
| `test_digest_auth`       | `native_app`           |     9 |   ✅   | 00:00:00.580 |
| `test_web_terminal`      | `native_app`           |     7 |   ✅   | 00:00:00.569 |
| `test_defer`             | `native_app`           |     3 |   ✅   | 00:00:00.549 |
| `test_multipart`         | `native_app`           |    19 |   ✅   | 00:00:00.578 |
| `test_auth`              | `native_app`           |    13 |   ✅   | 00:00:00.569 |
| `test_file_serving`      | `native_app`           |    12 |   ✅   | 00:00:00.588 |
| `test_dispatch`          | `native_app`           |    11 |   ✅   | 00:00:00.575 |
| `test_chunked`           | `native_app`           |    10 |   ✅   | 00:00:00.575 |
| `test_application`       | `native_app`           |    52 |   ✅   | 00:00:00.651 |
| `test_diag`              | `native_diag`          |     2 |   ✅   | 00:00:01.086 |
| `test_snmp_ber`          | `native_snmp`          |    14 |   ✅   | 00:00:00.663 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.476 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.354 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.745 |
| `test_coap`              | `native_coap`          |    26 |   ✅   | 00:00:00.628 |
| `test_coap`              | `native_coap_observe`  |    26 |   ✅   | 00:00:00.652 |
| `test_webdav`            | `native_webdav`        |    19 |   ✅   | 00:00:00.645 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.614 |
| `test_modbus_master`     | `native_modbus_master` |     5 |   ✅   | 00:00:00.645 |
| `test_ota_rollback`      | `native_ota_rollback`  |     5 |   ✅   | 00:00:00.619 |
| `test_totp`              | `native_totp`          |     4 |   ✅   | 00:00:00.636 |
| `test_webhook`           | `native_webhook`       |     5 |   ✅   | 00:00:00.619 |
| `test_radio_power`       | `native_radio_power`   |     2 |   ✅   | 00:00:00.613 |
| `test_dns_resolver`      | `native_dns_resolver`  |     4 |   ✅   | 00:00:00.616 |
| `test_audit_log`         | `native_audit_log`     |    12 |   ✅   | 00:00:00.659 |
| `test_oidc`              | `native_oidc`          |    13 |   ✅   | 00:00:00.815 |
| `test_vfs`               | `native_vfs`           |    11 |   ✅   | 00:00:00.628 |
| `test_graphql`           | `native_graphql`       |    13 |   ✅   | 00:00:00.628 |
| `test_espnow`            | `native_espnow`        |     7 |   ✅   | 00:00:00.606 |
| `test_oauth2`            | `native_oauth2`        |     8 |   ✅   | 00:00:00.643 |
| `test_opcua`             | `native_opcua`         |    29 |   ✅   | 00:00:00.653 |
| `test_opcua_client`      | `native_opcua_client`  |    11 |   ✅   | 00:00:00.657 |
| `test_keepalive`         | `native_keepalive`     |    10 |   ✅   | 00:00:01.031 |
| `test_range`             | `native_range`         |    13 |   ✅   | 00:00:01.040 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.627 |
| `test_jwt`               | `native_jwt`           |    10 |   ✅   | 00:00:00.662 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:01.067 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.611 |
| `test_compliance`        | `native_compliance`    |    15 |   ✅   | 00:00:00.608 |
| `test_mqtt`              | `native_mqtt`          |    16 |   ✅   | 00:00:00.634 |
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.656 |
| `test_scratch`           | `native_scratch`       |    14 |   ✅   | 00:00:00.651 |
| `test_snmp_trap`         | `native_snmp_trap`     |     3 |   ✅   | 00:00:00.641 |
| `test_inflate`           | `native_inflate`       |    12 |   ✅   | 00:00:00.628 |
| `test_deflate`           | `native_deflate`       |    10 |   ✅   | 00:00:00.664 |
| `test_websocket`         | `native_ws_deflate`    |    68 |   ✅   | 00:00:00.991 |
| `test_time_source`       | `native_time_source`   |     9 |   ✅   | 00:00:00.622 |
| `test_config_store`      | `native_config_store`  |    14 |   ✅   | 00:00:00.621 |
| `test_device_id`         | `native_device_id`     |     4 |   ✅   | 00:00:00.633 |
| `test_auth_lockout`      | `native_auth_lockout`  |    10 |   ✅   | 00:00:00.613 |
| `test_csrf`              | `native_csrf`          |     9 |   ✅   | 00:00:00.657 |
| `test_telemetry`         | `native_telemetry`     |     8 |   ✅   | 00:00:00.634 |
| `test_dashboard`         | `native_dashboard`     |    11 |   ✅   | 00:00:00.628 |
| `test_net_egress`        | `native_net_egress`    |     5 |   ✅   | 00:00:00.613 |
| `test_partition_monitor` | `native_partition`     |     5 |   ✅   | 00:00:00.611 |
| `test_cbor`              | `native_cbor`          |    14 |   ✅   | 00:00:00.622 |
| `test_msgpack`           | `native_msgpack`       |    15 |   ✅   | 00:00:00.632 |
| `test_gpio_map`          | `native_gpio_map`      |     8 |   ✅   | 00:00:00.620 |
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.633 |
| `test_guardrails`        | `native_guardrails`    |     6 |   ✅   | 00:00:00.613 |
| `test_logbuf`            | `native_logbuf`        |     4 |   ✅   | 00:00:00.623 |
| `test_config_io`         | `native_config_io`     |     4 |   ✅   | 00:00:00.637 |
| `test_workers`           | `native_workers`       |     3 |   ✅   | 00:00:00.726 |
| `test_clock`             | `native_clock`         |     4 |   ✅   | 00:00:00.606 |
| `test_concurrency`       | `native_concurrency`   |     2 |   ✅   | 00:00:00.729 |
| `test_concurrency`       | `native_tsan`          |     2 |   ✅   | 00:00:01.325 |
...
------------------ native:test_sse [PASSED] Took 6.15 seconds ------------------
...
---------------- native:test_session [PASSED] Took 0.55 seconds ----------------
...
------------- native:test_presentation [PASSED] Took 0.58 seconds --------------
...
--------------- native:test_websocket [PASSED] Took 0.59 seconds ---------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.148
native         test_session       PASSED    00:00:00.552
native         test_presentation  PASSED    00:00:00.579
native         test_transport     PASSED    00:00:00.562
native         test_websocket     PASSED    00:00:00.591
native         test_http_parser   PASSED    00:00:00.544
================ 307 test cases: 307 succeeded in 00:00:08.975 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------ native_observability:test_observability [PASSED] Took 0.69 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.687
================= 15 test cases: 15 succeeded in 00:00:00.687 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------- native_ota:test_http_ota [PASSED] Took 0.62 seconds --------------

=================================== SUMMARY ===================================
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.621
================== 3 test cases: 3 succeeded in 00:00:00.621 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
----------- native_prov:test_provisioning [PASSED] Took 0.63 seconds -----------

=================================== SUMMARY ===================================
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.634
================== 5 test cases: 5 succeeded in 00:00:00.634 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------ native_ssh:test_ssh_channel [PASSED] Took 0.50 seconds ------------

=================================== SUMMARY ===================================
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.811
native_ssh     test_ssh_auth       PASSED    00:00:00.547
native_ssh     test_ssh_server     PASSED    00:00:00.650
native_ssh     test_ssh_transport  PASSED    00:00:00.862
native_ssh     test_ssh_channel    PASSED    00:00:00.504
================= 92 test cases: 92 succeeded in 00:00:06.373 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.838
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 1.20 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.200
================== 2 test cases: 2 succeeded in 00:00:01.200 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
--------------- native_app:test_regex [PASSED] Took 1.11 seconds ---------------
...
---------- native_app:test_digest_vectors [PASSED] Took 0.51 seconds -----------
...
--------------- native_app:test_json [PASSED] Took 0.52 seconds ----------------
...
--------- native_app:test_response_headers [PASSED] Took 0.57 seconds ----------
...
------------ native_app:test_middleware [PASSED] Took 0.57 seconds -------------
...
------------ native_app:test_digest_auth [PASSED] Took 0.58 seconds ------------
...
----------- native_app:test_web_terminal [PASSED] Took 0.57 seconds ------------
...
--------------- native_app:test_defer [PASSED] Took 0.55 seconds ---------------
...
----------- native_app:test_file_serving [PASSED] Took 0.59 seconds ------------
...
------------- native_app:test_dispatch [PASSED] Took 0.57 seconds --------------
...
-------------- native_app:test_chunked [PASSED] Took 0.58 seconds --------------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.111
native_app     test_template          PASSED    00:00:00.569
native_app     test_path_params       PASSED    00:00:00.574
native_app     test_digest_vectors    PASSED    00:00:00.506
native_app     test_form_params       PASSED    00:00:00.568
native_app     test_iface             PASSED    00:00:00.571
native_app     test_json              PASSED    00:00:00.524
native_app     test_response_headers  PASSED    00:00:00.573
native_app     test_middleware        PASSED    00:00:00.571
native_app     test_digest_auth       PASSED    00:00:00.580
native_app     test_web_terminal      PASSED    00:00:00.569
native_app     test_defer             PASSED    00:00:00.549
native_app     test_multipart         PASSED    00:00:00.578
native_app     test_auth              PASSED    00:00:00.569
native_app     test_file_serving      PASSED    00:00:00.588
native_app     test_dispatch          PASSED    00:00:00.575
native_app     test_chunked           PASSED    00:00:00.575
native_app     test_application       PASSED    00:00:00.651
================ 210 test cases: 210 succeeded in 00:00:10.801 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
--------------- native_diag:test_diag [PASSED] Took 1.09 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.086
================== 2 test cases: 2 succeeded in 00:00:01.086 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------- native_snmp:test_snmp_ber [PASSED] Took 0.66 seconds -------------
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.663
native_snmp    test_snmp_agent  PASSED    00:00:00.476
================= 27 test cases: 27 succeeded in 00:00:01.138 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 1.35 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.354
================== 9 test cases: 9 succeeded in 00:00:01.354 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------- native_telnet:test_telnet [PASSED] Took 0.75 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.745
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.628
================= 26 test cases: 26 succeeded in 00:00:00.628 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
test/test_coap/test_coap.cpp:779: test_root_path                        [PASSED]
test/test_coap/test_coap.cpp:780: test_unknown_method_not_implemented   [PASSED]
----------- native_coap_observe:test_coap [PASSED] Took 0.65 seconds -----------

=================================== SUMMARY ===================================
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.652
================= 26 test cases: 26 succeeded in 00:00:00.652 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.645
================= 19 test cases: 19 succeeded in 00:00:00.645 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------- native_modbus:test_modbus [PASSED] Took 0.61 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.614
================= 13 test cases: 13 succeeded in 00:00:00.614 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------ native_modbus_master:test_modbus_master [PASSED] Took 0.64 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.645
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.619
================== 5 test cases: 5 succeeded in 00:00:00.619 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
--------------- native_totp:test_totp [PASSED] Took 0.64 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.636
================== 4 test cases: 4 succeeded in 00:00:00.636 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------ native_webhook:test_webhook [PASSED] Took 0.62 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.619
================== 5 test cases: 5 succeeded in 00:00:00.619 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.613
================== 2 test cases: 2 succeeded in 00:00:00.613 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------- native_dns_resolver:test_dns_resolver [PASSED] Took 0.62 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.616
================== 4 test cases: 4 succeeded in 00:00:00.616 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.659
================= 12 test cases: 12 succeeded in 00:00:00.659 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
--------------- native_oidc:test_oidc [PASSED] Took 0.82 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.815
================= 13 test cases: 13 succeeded in 00:00:00.815 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.628
...
------------ native_graphql:test_graphql [PASSED] Took 0.63 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.628
================= 13 test cases: 13 succeeded in 00:00:00.628 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.606
...
------------- native_oauth2:test_oauth2 [PASSED] Took 0.64 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.643
...
-------------- native_opcua:test_opcua [PASSED] Took 0.65 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.653
================= 29 test cases: 29 succeeded in 00:00:00.653 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------- native_opcua_client:test_opcua_client [PASSED] Took 0.66 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.657
...
---------- native_keepalive:test_keepalive [PASSED] Took 1.03 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.031
================= 10 test cases: 10 succeeded in 00:00:01.031 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.040
================= 13 test cases: 13 succeeded in 00:00:01.040 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------- native_syslog:test_syslog [PASSED] Took 0.63 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.627
...
---------------- native_jwt:test_jwt [PASSED] Took 0.66 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.662
================= 10 test cases: 10 succeeded in 00:00:00.662 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.067
================== 3 test cases: 3 succeeded in 00:00:01.067 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
-------- native_http_client:test_http_client [PASSED] Took 0.61 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.611
================= 10 test cases: 10 succeeded in 00:00:00.611 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.608
================= 15 test cases: 15 succeeded in 00:00:00.608 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
--------------- native_mqtt:test_mqtt [PASSED] Took 0.63 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.634
================= 16 test cases: 16 succeeded in 00:00:00.634 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
---------- native_ws_client:test_ws_client [PASSED] Took 0.66 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.656
================= 10 test cases: 10 succeeded in 00:00:00.656 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------ native_scratch:test_scratch [PASSED] Took 0.65 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.651
================= 14 test cases: 14 succeeded in 00:00:00.651 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
---------- native_snmp_trap:test_snmp_trap [PASSED] Took 0.64 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.641
================== 3 test cases: 3 succeeded in 00:00:00.641 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.628
================= 12 test cases: 12 succeeded in 00:00:00.628 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.664
================= 10 test cases: 10 succeeded in 00:00:00.664 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
test/test_websocket/test_websocket.cpp:1065: stress_ws_parse_max_payload [PASSED]
test/test_websocket/test_websocket.cpp:1066: stress_ws_parse_two_consecutive_frames [PASSED]
--------- native_ws_deflate:test_websocket [PASSED] Took 0.99 seconds ----------

=================================== SUMMARY ===================================
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.991
================= 68 test cases: 68 succeeded in 00:00:00.991 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
-------- native_time_source:test_time_source [PASSED] Took 0.62 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.622
================== 9 test cases: 9 succeeded in 00:00:00.622 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------- native_config_store:test_config_store [PASSED] Took 0.62 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.621
================= 14 test cases: 14 succeeded in 00:00:00.621 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
---------- native_device_id:test_device_id [PASSED] Took 0.63 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.633
...
------- native_auth_lockout:test_auth_lockout [PASSED] Took 0.61 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.613
================= 10 test cases: 10 succeeded in 00:00:00.613 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
--------------- native_csrf:test_csrf [PASSED] Took 0.66 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.657
...
---------- native_telemetry:test_telemetry [PASSED] Took 0.63 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.634
================== 8 test cases: 8 succeeded in 00:00:00.634 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
---------- native_dashboard:test_dashboard [PASSED] Took 0.63 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.628
================= 11 test cases: 11 succeeded in 00:00:00.628 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
--------- native_net_egress:test_net_egress [PASSED] Took 0.61 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.613
================== 5 test cases: 5 succeeded in 00:00:00.613 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------ native_partition:test_partition_monitor [PASSED] Took 0.61 seconds ------

=================================== SUMMARY ===================================
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.611
================== 5 test cases: 5 succeeded in 00:00:00.611 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
--------------- native_cbor:test_cbor [PASSED] Took 0.62 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.622
================= 14 test cases: 14 succeeded in 00:00:00.622 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------ native_msgpack:test_msgpack [PASSED] Took 0.63 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.632
================= 15 test cases: 15 succeeded in 00:00:00.632 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
----------- native_gpio_map:test_gpio_map [PASSED] Took 0.62 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.620
================== 8 test cases: 8 succeeded in 00:00:00.620 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.633
================== 4 test cases: 4 succeeded in 00:00:00.633 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
--------- native_guardrails:test_guardrails [PASSED] Took 0.61 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.613
================== 6 test cases: 6 succeeded in 00:00:00.613 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
------------- native_logbuf:test_logbuf [PASSED] Took 0.62 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.623
...
---------- native_config_io:test_config_io [PASSED] Took 0.64 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.637
...
------------ native_workers:test_workers [PASSED] Took 0.73 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.726
================== 3 test cases: 3 succeeded in 00:00:00.726 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.606
================== 4 test cases: 4 succeeded in 00:00:00.606 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
-------- native_concurrency:test_concurrency [PASSED] Took 0.73 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.729
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 1.33 seconds ------------

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.325
