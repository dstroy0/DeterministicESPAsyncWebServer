...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:12.250 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.491 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.520 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.507 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.537 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.530 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.704 |
...
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.812 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.083 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.914 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.509 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.509 |
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.480 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.503 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.512 |
...
----------------- native:test_sse [PASSED] Took 12.25 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:12.250
...
native_ssh           test_ssh_crypto        PASSED    00:00:03.704
...
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.812
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.083
native_app           test_regex             PASSED    00:00:00.914
native_app           test_template          PASSED    00:00:00.509
native_app           test_path_params       PASSED    00:00:00.509
native_app           test_digest_vectors    PASSED    00:00:00.480
native_app           test_form_params       PASSED    00:00:00.503
native_app           test_iface             PASSED    00:00:00.512
...
================ 611 test cases: 611 succeeded in 00:00:32.902 ================
```
