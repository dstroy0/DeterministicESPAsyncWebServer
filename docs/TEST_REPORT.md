...
**Generated:** 2026-07-06 07:53:42
**Command:** `pio test` over 152 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 2193 passed - 277s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:06.207 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.569 |
| `test_det_ip`            | `native_det_ip`         |    10 |   ✅   | 00:00:00.569 |
| `test_det_arena`         | `native_det_arena`      |    17 |   ✅   | 00:00:00.579 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:04.479 |
| `test_promisc`           | `native_promisc`        |     8 |   ✅   | 00:00:00.592 |
| `test_bus_capture`       | `native_bus_capture`    |     5 |   ✅   | 00:00:00.573 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.591 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.573 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.601 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.584 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.595 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.589 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.574 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.584 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.583 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:00.956 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.538 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.566 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.561 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.585 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.550 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.693 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:00.939 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.617 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.605 |
| `test_ssh_crypto`        | `native_ssh`            |    45 |   ✅   | 00:00:04.244 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.605 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.883 |
| `test_ssh_transport`     | `native_ssh`            |    33 |   ✅   | 00:00:01.243 |
| `test_ssh_channel`       | `native_ssh`            |    32 |   ✅   | 00:00:00.545 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.898 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.353 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.118 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.564 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.562 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.504 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.562 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.568 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.534 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.571 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.562 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.587 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.565 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.540 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.570 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.565 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.584 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.569 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.566 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.641 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.149 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.109 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.618 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.474 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:02.102 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.733 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.898 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.701 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.608 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.616 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.659 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.588 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.587 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.600 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.586 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.586 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.655 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.678 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.773 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.701 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.593 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.588 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.578 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.585 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.579 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.577 |
| `test_zigbee`            | `native_zigbee`         |     9 |   ✅   | 00:00:00.596 |
| `test_thread`            | `native_thread`         |    13 |   ✅   | 00:00:00.588 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.627 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.602 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.582 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.582 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.607 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.594 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.587 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.579 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.629 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.584 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.587 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.595 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.571 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.580 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.595 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.586 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.597 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.596 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.601 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.596 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.603 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.591 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.596 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.589 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.573 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.585 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.614 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.824 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.585 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.581 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.588 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.604 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.627 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.627 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.038 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.048 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.608 |
| `test_smtp`              | `native_smtp`           |    11 |   ✅   | 00:00:00.710 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.586 |
| `test_dns_server`        | `native_dns_server`     |     7 |   ✅   | 00:00:00.598 |
| `test_rtc`               | `native_rtc`            |     8 |   ✅   | 00:00:00.595 |
| `test_ld2410`            | `native_ld2410`         |     7 |   ✅   | 00:00:00.593 |
| `test_mpr121`            | `native_mpr121`         |     5 |   ✅   | 00:00:00.584 |
| `test_sht3x`             | `native_sht3x`          |     5 |   ✅   | 00:00:00.585 |
| `test_pca9685`           | `native_pca9685`        |     4 |   ✅   | 00:00:00.583 |
| `test_ads1115`           | `native_ads1115`        |     3 |   ✅   | 00:00:00.579 |
| `test_ina219`            | `native_ina219`         |     4 |   ✅   | 00:00:00.591 |
| `test_hpack`             | `native_hpack`          |     7 |   ✅   | 00:00:00.699 |
| `test_h2_frame`          | `native_h2frame`        |     6 |   ✅   | 00:00:00.571 |
| `test_h2_conn`           | `native_h2conn`         |     4 |   ✅   | 00:00:00.785 |
| `test_quic_varint`       | `native_quic_varint`    |     3 |   ✅   | 00:00:00.580 |
| `test_h3_frame`          | `native_h3frame`        |     7 |   ✅   | 00:00:00.588 |
| `test_jwt`               | `native_jwt`            |    21 |   ✅   | 00:00:00.621 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.073 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.577 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.612 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.592 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.618 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.631 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.612 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.583 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.632 |
| `test_ssh_zlib`          | `native_ssh_zlib`       |     9 |   ✅   | 00:00:00.651 |
| `test_ssh_comp`          | `native_ssh_comp`       |     5 |   ✅   | 00:00:00.947 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:00.960 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.582 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.588 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.602 |
| `test_auth_lockout`      | `native_auth_lockout`   |    11 |   ✅   | 00:00:00.589 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.616 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.572 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.575 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.585 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.587 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.583 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.604 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.596 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.591 |
| `test_statsd`            | `native_statsd`         |     9 |   ✅   | 00:00:00.640 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.594 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.589 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.611 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.709 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.576 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.711 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.271 |
| `test_qpack`             | `native_qpack`          |     9 |   ✅   | 00:00:00.678 |
| `test_quic_packet`       | `native_quic_packet`    |     8 |   ✅   | 00:00:00.571 |
| `test_quic_frame`        | `native_quic_frame`     |     8 |   ✅   | 00:00:00.602 |
| `test_quic_crypto`       | `native_quic_crypto`    |     7 |   ✅   | 00:00:00.663 |
| `test_tls13_kdf`         | `native_tls13_kdf`      |     5 |   ✅   | 00:00:00.622 |
| `test_quic_tp`           | `native_quic_tp`        |     7 |   ✅   | 00:00:00.619 |
| `test_tls13_msg`         | `native_tls13_msg`      |     7 |   ✅   | 00:00:00.689 |
| `test_quic_tls`          | `native_quic_tls`       |    11 |   ✅   | 00:00:00.877 |
| `test_quic_conn`         | `native_quic_conn`      |     4 |   ✅   | 00:00:00.935 |
| `test_h3_conn`           | `native_h3_conn`        |    11 |   ✅   | 00:00:00.855 |
| `test_h3_e2e`            | `native_h3_e2e`         |     1 |   ✅   | 00:00:00.895 |
| `test_quic_server`       | `native_quic_server`    |     2 |   ✅   | 00:00:00.957 |
| `test_h3_server`         | `native_h3_server`      |     1 |   ✅   | 00:00:01.415 |
| `test_ssh_chachapoly`    | `native_ssh_chachapoly` |     4 |   ✅   | 00:00:00.610 |
...
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.207
================= 17 test cases: 17 succeeded in 00:00:06.207 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
----- native_det_primitives:test_det_primitives [PASSED] Took 0.57 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.569
...
------------- native_det_ip:test_det_ip [PASSED] Took 0.57 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_det_ip  test_det_ip  PASSED    00:00:00.569
...
---------- native_det_arena:test_det_arena [PASSED] Took 0.58 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_det_arena  test_det_arena  PASSED    00:00:00.579
================= 17 test cases: 17 succeeded in 00:00:00.579 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------- native_ssh_ed25519:test_ssh_ed25519 [PASSED] Took 4.48 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_ssh_ed25519  test_ssh_ed25519  PASSED    00:00:04.479
================= 16 test cases: 16 succeeded in 00:00:04.479 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_promisc:test_promisc [PASSED] Took 0.59 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_promisc  test_promisc  PASSED    00:00:00.592
...
-------- native_bus_capture:test_bus_capture [PASSED] Took 0.57 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_bus_capture  test_bus_capture  PASSED    00:00:00.573
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.591
================== 9 test cases: 9 succeeded in 00:00:00.591 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
---------- native_devicenet:test_devicenet [PASSED] Took 0.57 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.573
...
----------- native_nmea2000:test_nmea2000 [PASSED] Took 0.60 seconds -----------
...
--------------- native_mbus:test_mbus [PASSED] Took 0.58 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.584
...
----------- native_iec60870:test_iec60870 [PASSED] Took 0.59 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.595
================== 8 test cases: 8 succeeded in 00:00:00.595 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------------- native_sdi12:test_sdi12 [PASSED] Took 0.59 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.589
================== 6 test cases: 6 succeeded in 00:00:00.589 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
---------------- native_dmx:test_dmx [PASSED] Took 0.57 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.574
...
----------- native_nmea0183:test_nmea0183 [PASSED] Took 0.58 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.584
...
------------- native_iolink:test_iolink [PASSED] Took 0.58 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.583
...
------------------ native:test_sse [PASSED] Took 0.96 seconds ------------------
...
---------------- native:test_session [PASSED] Took 0.54 seconds ----------------
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:00.956
native         test_session       PASSED    00:00:00.538
native         test_presentation  PASSED    00:00:00.566
native         test_transport     PASSED    00:00:00.561
native         test_websocket     PASSED    00:00:00.585
native         test_http_parser   PASSED    00:00:00.550
================ 323 test cases: 323 succeeded in 00:00:03.756 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.693
================= 17 test cases: 17 succeeded in 00:00:00.693 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------- native_accept_gate:test_accept_gate [PASSED] Took 0.94 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.939
================= 13 test cases: 13 succeeded in 00:00:00.939 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.617
================== 3 test cases: 3 succeeded in 00:00:00.617 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
----------- native_prov:test_provisioning [PASSED] Took 0.61 seconds -----------

=================================== SUMMARY ===================================
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.605
================== 5 test cases: 5 succeeded in 00:00:00.605 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 4.24 seconds -------------
...
------------- native_ssh:test_ssh_auth [PASSED] Took 0.60 seconds --------------
...
------------ native_ssh:test_ssh_server [PASSED] Took 0.88 seconds -------------
...
----------- native_ssh:test_ssh_transport [PASSED] Took 1.24 seconds -----------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.244
native_ssh     test_ssh_auth       PASSED    00:00:00.605
native_ssh     test_ssh_server     PASSED    00:00:00.883
native_ssh     test_ssh_transport  PASSED    00:00:01.243
native_ssh     test_ssh_channel    PASSED    00:00:00.545
================ 145 test cases: 145 succeeded in 00:00:07.519 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.898
================== 2 test cases: 2 succeeded in 00:00:00.898 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 1.35 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.353
================== 2 test cases: 2 succeeded in 00:00:01.353 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
src/DeterministicESPAsyncWebServer.cpp:3100:76: warning: ‘snprintf’ output may be truncated before the last format character [-Wformat-truncation=]
 3100 |         snprintf(lastmod_line, sizeof(lastmod_line), "Last-Modified: %s\r\n", lm_date);
      |                                                                            ^
src/DeterministicESPAsyncWebServer.cpp:3100:17: note: ‘snprintf’ output between 18 and 57 bytes into a destination of size 56
 3100 |         snprintf(lastmod_line, sizeof(lastmod_line), "Last-Modified: %s\r\n", lm_date);
      |         ~~~~~~~~^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Testing...
...
--------------- native_app:test_regex [PASSED] Took 1.12 seconds ---------------
...
------------- native_app:test_template [PASSED] Took 0.56 seconds --------------
...
---------- native_app:test_digest_vectors [PASSED] Took 0.50 seconds -----------
...
------------ native_app:test_form_params [PASSED] Took 0.56 seconds ------------
...
----------- native_app:test_web_terminal [PASSED] Took 0.56 seconds ------------
...
--------------- native_app:test_defer [PASSED] Took 0.54 seconds ---------------
...
----------- native_app:test_file_serving [PASSED] Took 0.58 seconds ------------
...
------------ native_app:test_application [PASSED] Took 0.64 seconds ------------

=================================== SUMMARY ===================================
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:01.118
native_app     test_template          PASSED    00:00:00.564
native_app     test_path_params       PASSED    00:00:00.562
native_app     test_digest_vectors    PASSED    00:00:00.504
native_app     test_form_params       PASSED    00:00:00.562
native_app     test_iface             PASSED    00:00:00.568
native_app     test_json              PASSED    00:00:00.534
native_app     test_response_headers  PASSED    00:00:00.571
native_app     test_middleware        PASSED    00:00:00.562
native_app     test_digest_auth       PASSED    00:00:00.587
native_app     test_web_terminal      PASSED    00:00:00.565
native_app     test_defer             PASSED    00:00:00.540
native_app     test_multipart         PASSED    00:00:00.570
native_app     test_auth              PASSED    00:00:00.565
native_app     test_file_serving      PASSED    00:00:00.584
native_app     test_dispatch          PASSED    00:00:00.569
native_app     test_chunked           PASSED    00:00:00.566
native_app     test_application       PASSED    00:00:00.641
================ 225 test cases: 225 succeeded in 00:00:10.733 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
----- native_webdav_handler:test_webdav_handler [PASSED] Took 1.15 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.149
================= 12 test cases: 12 succeeded in 00:00:01.149 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
--------------- native_diag:test_diag [PASSED] Took 1.11 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.109
================== 2 test cases: 2 succeeded in 00:00:01.109 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_snmp:test_snmp_agent [PASSED] Took 0.47 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.618
native_snmp    test_snmp_agent  PASSED    00:00:00.474
================= 35 test cases: 35 succeeded in 00:00:01.091 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 2.10 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:02.102
================= 15 test cases: 15 succeeded in 00:00:02.102 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------- native_telnet:test_telnet [PASSED] Took 0.73 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.733
================= 15 test cases: 15 succeeded in 00:00:00.733 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
--------------- native_coap:test_coap [PASSED] Took 0.90 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.898
================= 41 test cases: 41 succeeded in 00:00:00.898 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
test/test_coap/test_coap.cpp:1076: test_well_known_core_discovery       [PASSED]
test/test_coap/test_coap.cpp:1077: test_well_known_core_rejects_post    [PASSED]
----------- native_coap_observe:test_coap [PASSED] Took 0.70 seconds -----------

=================================== SUMMARY ===================================
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.701
================= 41 test cases: 41 succeeded in 00:00:00.701 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.608
================= 19 test cases: 19 succeeded in 00:00:00.608 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.616
================= 22 test cases: 22 succeeded in 00:00:00.616 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------- native_cloudevents:test_cloudevents [PASSED] Took 0.66 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.659
...
----------- native_redis:test_redis_resp [PASSED] Took 0.59 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.588
================== 8 test cases: 8 succeeded in 00:00:00.588 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_stomp   test_stomp  PASSED    00:00:00.587
================= 14 test cases: 14 succeeded in 00:00:00.587 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_mqtt_sn:test_mqtt_sn [PASSED] Took 0.60 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.600
================= 13 test cases: 13 succeeded in 00:00:00.600 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------- native_flow_export:test_flow_export [PASSED] Took 0.59 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.586
================== 6 test cases: 6 succeeded in 00:00:00.586 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
----------- native_protobuf:test_protobuf [PASSED] Took 0.59 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.586
================= 13 test cases: 13 succeeded in 00:00:00.586 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.655
================= 11 test cases: 11 succeeded in 00:00:00.655 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
---------------- native_dma:test_dma [PASSED] Took 0.68 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dma     test_dma  PASSED    00:00:00.678
...
------------ native_forward:test_forward [PASSED] Took 0.77 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.773
================= 16 test cases: 16 succeeded in 00:00:00.773 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_gateway:test_gateway [PASSED] Took 0.70 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.701
================= 11 test cases: 11 succeeded in 00:00:00.701 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
--------------- native_lora:test_lora [PASSED] Took 0.59 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.593
================= 13 test cases: 13 succeeded in 00:00:00.593 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------------- native_nrf24:test_nrf24 [PASSED] Took 0.59 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.588
================= 10 test cases: 10 succeeded in 00:00:00.588 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_enocean:test_enocean [PASSED] Took 0.58 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.578
...
-------------- native_pn532:test_pn532 [PASSED] Took 0.59 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_pn532   test_pn532  PASSED    00:00:00.585
...
------------- native_sigfox:test_sigfox [PASSED] Took 0.58 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.579
================== 7 test cases: 7 succeeded in 00:00:00.579 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------------- native_zwave:test_zwave [PASSED] Took 0.58 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.577
================== 9 test cases: 9 succeeded in 00:00:00.577 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------- native_zigbee:test_zigbee [PASSED] Took 0.60 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_zigbee  test_zigbee  PASSED    00:00:00.596
...
------------- native_thread:test_thread [PASSED] Took 0.59 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_thread  test_thread  PASSED    00:00:00.588
================= 13 test cases: 13 succeeded in 00:00:00.588 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
--------------- native_wamp:test_wamp [PASSED] Took 0.63 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.627
================= 12 test cases: 12 succeeded in 00:00:00.627 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_sunspec:test_sunspec [PASSED] Took 0.60 seconds ------------
...
------------- native_c37118:test_c37118 [PASSED] Took 0.58 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_c37118  test_c37118  PASSED    00:00:00.582
================== 6 test cases: 6 succeeded in 00:00:00.582 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
--------------- native_dnp3:test_dnp3 [PASSED] Took 0.58 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.582
================== 8 test cases: 8 succeeded in 00:00:00.582 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_grpcweb:test_grpcweb [PASSED] Took 0.61 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.607
================== 7 test cases: 7 succeeded in 00:00:00.607 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
---------- native_lwm2m_tlv:test_lwm2m_tlv [PASSED] Took 0.59 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_lwm2m_tlv  test_lwm2m_tlv  PASSED    00:00:00.594
================= 11 test cases: 11 succeeded in 00:00:00.594 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
--------------- native_fins:test_fins [PASSED] Took 0.59 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.587
================== 6 test cases: 6 succeeded in 00:00:00.587 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
----------- native_hostlink:test_hostlink [PASSED] Took 0.58 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.579
================== 7 test cases: 7 succeeded in 00:00:00.579 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------------- native_senml:test_senml [PASSED] Took 0.63 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.629
...
---------------- native_df1:test_df1 [PASSED] Took 0.58 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.584
...
--------------- native_cotp:test_cotp [PASSED] Took 0.59 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.587
================== 6 test cases: 6 succeeded in 00:00:00.587 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.595
================== 8 test cases: 8 succeeded in 00:00:00.595 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------- native_melsec:test_melsec [PASSED] Took 0.57 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.571
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.580
================== 9 test cases: 9 succeeded in 00:00:00.580 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
--------------- native_enip:test_enip [PASSED] Took 0.59 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.595
...
--------------- native_amqp:test_amqp [PASSED] Took 0.59 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.586
...
---------------- native_cip:test_cip [PASSED] Took 0.60 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.597
================== 9 test cases: 9 succeeded in 00:00:00.597 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
--------------- native_nats:test_nats [PASSED] Took 0.60 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.596
...
----- native_proxy_protocol:test_proxy_protocol [PASSED] Took 0.60 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.601
================== 8 test cases: 8 succeeded in 00:00:00.601 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
---------- native_sparkplug:test_sparkplug [PASSED] Took 0.60 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.596
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.603
================== 5 test cases: 5 succeeded in 00:00:00.603 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------- native_ota_rollback:test_ota_rollback [PASSED] Took 0.59 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.591
================== 5 test cases: 5 succeeded in 00:00:00.591 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.596
================== 4 test cases: 4 succeeded in 00:00:00.596 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_webhook:test_webhook [PASSED] Took 0.59 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.589
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.573
================== 2 test cases: 2 succeeded in 00:00:00.573 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------- native_dns_resolver:test_dns_resolver [PASSED] Took 0.58 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.585
================== 4 test cases: 4 succeeded in 00:00:00.585 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.614
================= 16 test cases: 16 succeeded in 00:00:00.614 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.824
================= 17 test cases: 17 succeeded in 00:00:00.824 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
---------------- native_vfs:test_vfs [PASSED] Took 0.59 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.585
================= 11 test cases: 11 succeeded in 00:00:00.585 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.581
================= 32 test cases: 32 succeeded in 00:00:00.581 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------- native_espnow:test_espnow [PASSED] Took 0.59 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.588
================== 7 test cases: 7 succeeded in 00:00:00.588 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------- native_oauth2:test_oauth2 [PASSED] Took 0.60 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.604
================== 8 test cases: 8 succeeded in 00:00:00.604 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
================= 38 test cases: 38 succeeded in 00:00:00.627 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------- native_opcua_client:test_opcua_client [PASSED] Took 0.63 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.627
================= 14 test cases: 14 succeeded in 00:00:00.627 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
---------- native_keepalive:test_keepalive [PASSED] Took 1.04 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.038
================= 10 test cases: 10 succeeded in 00:00:01.038 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------------- native_range:test_range [PASSED] Took 1.05 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.048
================= 13 test cases: 13 succeeded in 00:00:01.048 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------- native_syslog:test_syslog [PASSED] Took 0.61 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.608
...
--------------- native_smtp:test_smtp [PASSED] Took 0.71 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_smtp    test_smtp  PASSED    00:00:00.710
================= 11 test cases: 11 succeeded in 00:00:00.710 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
--------- native_ntp_server:test_ntp_server [PASSED] Took 0.59 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_ntp_server  test_ntp_server  PASSED    00:00:00.586
...
--------- native_dns_server:test_dns_server [PASSED] Took 0.60 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_dns_server  test_dns_server  PASSED    00:00:00.598
...
---------------- native_rtc:test_rtc [PASSED] Took 0.60 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_rtc     test_rtc  PASSED    00:00:00.595
================== 8 test cases: 8 succeeded in 00:00:00.595 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------- native_ld2410:test_ld2410 [PASSED] Took 0.59 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ld2410  test_ld2410  PASSED    00:00:00.593
...
------------- native_mpr121:test_mpr121 [PASSED] Took 0.58 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_mpr121  test_mpr121  PASSED    00:00:00.584
================== 5 test cases: 5 succeeded in 00:00:00.584 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------------- native_sht3x:test_sht3x [PASSED] Took 0.58 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sht3x   test_sht3x  PASSED    00:00:00.585
...
------------ native_pca9685:test_pca9685 [PASSED] Took 0.58 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_pca9685  test_pca9685  PASSED    00:00:00.583
...
------------ native_ads1115:test_ads1115 [PASSED] Took 0.58 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_ads1115  test_ads1115  PASSED    00:00:00.579
================== 3 test cases: 3 succeeded in 00:00:00.579 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------- native_ina219:test_ina219 [PASSED] Took 0.59 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_ina219  test_ina219  PASSED    00:00:00.591
...
-------------- native_hpack:test_hpack [PASSED] Took 0.70 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_hpack   test_hpack  PASSED    00:00:00.699
...
----------- native_h2frame:test_h2_frame [PASSED] Took 0.57 seconds ------------

=================================== SUMMARY ===================================
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h2frame  test_h2_frame  PASSED    00:00:00.571
================== 6 test cases: 6 succeeded in 00:00:00.571 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_h2conn:test_h2_conn [PASSED] Took 0.78 seconds -------------

=================================== SUMMARY ===================================
Environment    Test          Status    Duration
-------------  ------------  --------  ------------
native_h2conn  test_h2_conn  PASSED    00:00:00.785
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_varint  test_quic_varint  PASSED    00:00:00.580
================== 3 test cases: 3 succeeded in 00:00:00.580 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
----------- native_h3frame:test_h3_frame [PASSED] Took 0.59 seconds ------------

=================================== SUMMARY ===================================
Environment     Test           Status    Duration
--------------  -------------  --------  ------------
native_h3frame  test_h3_frame  PASSED    00:00:00.588
================== 7 test cases: 7 succeeded in 00:00:00.588 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.621
================= 21 test cases: 21 succeeded in 00:00:00.621 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.073
================== 3 test cases: 3 succeeded in 00:00:01.073 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.577
================= 15 test cases: 15 succeeded in 00:00:00.577 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.612
================= 15 test cases: 15 succeeded in 00:00:00.612 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
--------------- native_mqtt:test_mqtt [PASSED] Took 0.59 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.592
================= 22 test cases: 22 succeeded in 00:00:00.592 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.618
================= 16 test cases: 16 succeeded in 00:00:00.618 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_scratch:test_scratch [PASSED] Took 0.63 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.631
================= 14 test cases: 14 succeeded in 00:00:00.631 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
---------- native_snmp_trap:test_snmp_trap [PASSED] Took 0.61 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.612
================== 7 test cases: 7 succeeded in 00:00:00.612 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_inflate:test_inflate [PASSED] Took 0.58 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.583
================= 12 test cases: 12 succeeded in 00:00:00.583 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.632
================= 10 test cases: 10 succeeded in 00:00:00.632 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
----------- native_ssh_zlib:test_ssh_zlib [PASSED] Took 0.65 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_zlib  test_ssh_zlib  PASSED    00:00:00.651
...
----------- native_ssh_comp:test_ssh_comp [PASSED] Took 0.95 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_comp  test_ssh_comp  PASSED    00:00:00.947
================== 5 test cases: 5 succeeded in 00:00:00.947 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
test/test_websocket/test_websocket.cpp:1107: stress_ws_parse_max_payload [PASSED]
test/test_websocket/test_websocket.cpp:1108: stress_ws_parse_two_consecutive_frames [PASSED]
--------- native_ws_deflate:test_websocket [PASSED] Took 0.96 seconds ----------

=================================== SUMMARY ===================================
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.960
================= 71 test cases: 71 succeeded in 00:00:00.960 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------- native_time_source:test_time_source [PASSED] Took 0.58 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.582
================== 9 test cases: 9 succeeded in 00:00:00.582 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------- native_config_store:test_config_store [PASSED] Took 0.59 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.588
...
---------- native_device_id:test_device_id [PASSED] Took 0.60 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.602
================== 4 test cases: 4 succeeded in 00:00:00.602 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------- native_auth_lockout:test_auth_lockout [PASSED] Took 0.59 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.589
================= 11 test cases: 11 succeeded in 00:00:00.589 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.616
================== 9 test cases: 9 succeeded in 00:00:00.616 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.572
================== 8 test cases: 8 succeeded in 00:00:00.572 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.575
...
--------- native_net_egress:test_net_egress [PASSED] Took 0.59 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.585
...
------ native_partition:test_partition_monitor [PASSED] Took 0.59 seconds ------

=================================== SUMMARY ===================================
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.587
================== 5 test cases: 5 succeeded in 00:00:00.587 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.583
================= 18 test cases: 18 succeeded in 00:00:00.583 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_msgpack:test_msgpack [PASSED] Took 0.60 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.604
================= 17 test cases: 17 succeeded in 00:00:00.604 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
----------- native_gpio_map:test_gpio_map [PASSED] Took 0.60 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.596
================== 8 test cases: 8 succeeded in 00:00:00.596 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------ native_udp_telemetry:test_udp_telemetry [PASSED] Took 0.59 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.591
================== 7 test cases: 7 succeeded in 00:00:00.591 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------- native_statsd:test_statsd [PASSED] Took 0.64 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_statsd  test_statsd  PASSED    00:00:00.640
================== 9 test cases: 9 succeeded in 00:00:00.640 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
--------- native_guardrails:test_guardrails [PASSED] Took 0.59 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.594
================== 6 test cases: 6 succeeded in 00:00:00.594 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------- native_logbuf:test_logbuf [PASSED] Took 0.59 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.589
...
---------- native_config_io:test_config_io [PASSED] Took 0.61 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.611
================== 4 test cases: 4 succeeded in 00:00:00.611 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_workers:test_workers [PASSED] Took 0.71 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.709
...
-------------- native_clock:test_clock [PASSED] Took 0.58 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.576
...
-------- native_concurrency:test_concurrency [PASSED] Took 0.71 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.711
================== 2 test cases: 2 succeeded in 00:00:00.711 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.271
================== 2 test cases: 2 succeeded in 00:00:01.271 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------------- native_qpack:test_qpack [PASSED] Took 0.68 seconds --------------
...
-------- native_quic_packet:test_quic_packet [PASSED] Took 0.57 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_packet  test_quic_packet  PASSED    00:00:00.571
...
--------- native_quic_frame:test_quic_frame [PASSED] Took 0.60 seconds ---------

=================================== SUMMARY ===================================
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_quic_frame  test_quic_frame  PASSED    00:00:00.602
================== 8 test cases: 8 succeeded in 00:00:00.602 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------- native_quic_crypto:test_quic_crypto [PASSED] Took 0.66 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_crypto  test_quic_crypto  PASSED    00:00:00.663
================== 7 test cases: 7 succeeded in 00:00:00.663 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
---------- native_tls13_kdf:test_tls13_kdf [PASSED] Took 0.62 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_tls13_kdf  test_tls13_kdf  PASSED    00:00:00.622
================== 5 test cases: 5 succeeded in 00:00:00.622 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_quic_tp:test_quic_tp [PASSED] Took 0.62 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_quic_tp  test_quic_tp  PASSED    00:00:00.619
...
---------- native_tls13_msg:test_tls13_msg [PASSED] Took 0.69 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_tls13_msg  test_tls13_msg  PASSED    00:00:00.689
...
----------- native_quic_tls:test_quic_tls [PASSED] Took 0.88 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_quic_tls  test_quic_tls  PASSED    00:00:00.877
...
---------- native_quic_conn:test_quic_conn [PASSED] Took 0.93 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_quic_conn  test_quic_conn  PASSED    00:00:00.935
================== 4 test cases: 4 succeeded in 00:00:00.935 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------ native_h3_conn:test_h3_conn [PASSED] Took 0.85 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_h3_conn  test_h3_conn  PASSED    00:00:00.855
================= 11 test cases: 11 succeeded in 00:00:00.855 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
------------- native_h3_e2e:test_h3_e2e [PASSED] Took 0.89 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_h3_e2e  test_h3_e2e  PASSED    00:00:00.895
================== 1 test cases: 1 succeeded in 00:00:00.895 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
-------- native_quic_server:test_quic_server [PASSED] Took 0.96 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_quic_server  test_quic_server  PASSED    00:00:00.957
...
---------- native_h3_server:test_h3_server [PASSED] Took 1.41 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_h3_server  test_h3_server  PASSED    00:00:01.415
================== 1 test cases: 1 succeeded in 00:00:01.415 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 177 tests
...
----- native_ssh_chachapoly:test_ssh_chachapoly [PASSED] Took 0.61 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_ssh_chachapoly  test_ssh_chachapoly  PASSED    00:00:00.610
================== 4 test cases: 4 succeeded in 00:00:00.610 ==================
```
