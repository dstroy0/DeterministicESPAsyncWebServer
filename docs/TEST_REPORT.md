...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:06.143 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.484 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.515 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.506 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.546 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.520 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.774 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.535 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.641 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.852 |
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.512 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.803 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.079 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.917 |
...
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.495 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.505 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.511 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.506 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.503 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.512 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.509 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.518 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.502 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.507 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.599 |
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:06.143
native               test_session           PASSED    00:00:00.484
native               test_presentation      PASSED    00:00:00.515
native               test_transport         PASSED    00:00:00.506
native               test_websocket         PASSED    00:00:00.546
native               test_http_parser       PASSED    00:00:00.520
native_ssh           test_ssh_crypto        PASSED    00:00:03.774
native_ssh           test_ssh_auth          PASSED    00:00:00.535
native_ssh           test_ssh_server        PASSED    00:00:00.641
native_ssh           test_ssh_transport     PASSED    00:00:00.852
native_ssh           test_ssh_channel       PASSED    00:00:00.512
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.803
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.079
native_app           test_regex             PASSED    00:00:00.917
...
native_app           test_json              PASSED    00:00:00.495
native_app           test_response_headers  PASSED    00:00:00.505
native_app           test_middleware        PASSED    00:00:00.511
native_app           test_digest_auth       PASSED    00:00:00.506
native_app           test_web_terminal      PASSED    00:00:00.503
native_app           test_multipart         PASSED    00:00:00.512
native_app           test_auth              PASSED    00:00:00.509
native_app           test_file_serving      PASSED    00:00:00.518
native_app           test_dispatch          PASSED    00:00:00.502
...
================ 611 test cases: 611 succeeded in 00:00:26.588 ================
```
