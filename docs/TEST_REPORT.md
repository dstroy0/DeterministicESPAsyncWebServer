...
**Generated:** 2026-07-02 19:44:10
**Command:** `pio test` over 113 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 1881 passed - 157s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:06.210 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.513 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.619 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.940 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.553 |
| `test_mbus`              | `native_mbus`           |    11 |   ✅   | 00:00:00.522 |
| `test_iec60870`          | `native_iec60870`       |     8 |   ✅   | 00:00:00.624 |
| `test_sdi12`             | `native_sdi12`          |     6 |   ✅   | 00:00:00.526 |
| `test_dmx`               | `native_dmx`            |     5 |   ✅   | 00:00:00.607 |
| `test_nmea0183`          | `native_nmea0183`       |     7 |   ✅   | 00:00:00.526 |
| `test_iolink`            | `native_iolink`         |     5 |   ✅   | 00:00:00.515 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:00.780 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.457 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.486 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.472 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.525 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.470 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.576 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:00.772 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.524 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.535 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:02.945 |
| `test_ssh_auth`          | `native_ssh`            |    18 |   ✅   | 00:00:00.468 |
| `test_ssh_server`        | `native_ssh`            |    16 |   ✅   | 00:00:00.680 |
| `test_ssh_transport`     | `native_ssh`            |    27 |   ✅   | 00:00:00.856 |
| `test_ssh_channel`       | `native_ssh`            |    20 |   ✅   | 00:00:00.437 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.709 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:00.997 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:00.910 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.477 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.475 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.432 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.478 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.475 |
| `test_json`              | `native_app`            |    23 |   ✅   | 00:00:00.445 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.475 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.476 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.487 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.475 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.460 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.482 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.493 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.497 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.478 |
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.489 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.554 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:00.965 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:00.934 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.559 |
| `test_snmp_agent`        | `native_snmp`           |    19 |   ✅   | 00:00:00.418 |
| `test_snmp_v3`           | `native_snmp_v3`        |    15 |   ✅   | 00:00:01.663 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.633 |
| `test_coap`              | `native_coap`           |    41 |   ✅   | 00:00:00.713 |
| `test_coap`              | `native_coap_observe`   |    41 |   ✅   | 00:00:00.605 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.542 |
| `test_modbus`            | `native_modbus`         |    22 |   ✅   | 00:00:00.522 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.593 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.525 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.533 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.530 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.528 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.544 |
| `test_preempt_queue`     | `native_preempt_queue`  |    11 |   ✅   | 00:00:00.582 |
| `test_dma`               | `native_dma`            |    11 |   ✅   | 00:00:00.586 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.687 |
| `test_gateway`           | `native_gateway`        |    11 |   ✅   | 00:00:00.603 |
| `test_lora`              | `native_lora`           |    13 |   ✅   | 00:00:00.529 |
| `test_nrf24`             | `native_nrf24`          |    10 |   ✅   | 00:00:00.521 |
| `test_enocean`           | `native_enocean`        |     9 |   ✅   | 00:00:00.520 |
| `test_pn532`             | `native_pn532`          |    10 |   ✅   | 00:00:00.527 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.530 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.571 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.581 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.516 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.537 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.529 |
| `test_grpcweb`           | `native_grpcweb`        |     7 |   ✅   | 00:00:00.538 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    11 |   ✅   | 00:00:00.532 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.568 |
| `test_hostlink`          | `native_hostlink`       |     7 |   ✅   | 00:00:00.521 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.659 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.539 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.526 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.546 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.544 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.566 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.536 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.535 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.534 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.541 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.552 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.542 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.560 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.533 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.632 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.548 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.539 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.540 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.562 |
| `test_oidc`              | `native_oidc`           |    17 |   ✅   | 00:00:00.745 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.554 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.584 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.603 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.573 |
| `test_opcua`             | `native_opcua`          |    38 |   ✅   | 00:00:00.549 |
| `test_opcua_client`      | `native_opcua_client`   |    14 |   ✅   | 00:00:00.723 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:00.880 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:00.885 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.582 |
| `test_jwt`               | `native_jwt`            |    16 |   ✅   | 00:00:00.576 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:00.882 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.531 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.527 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.530 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.558 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.560 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.550 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.519 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.571 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:00.838 |
| `test_time_source`       | `native_time_source`    |     9 |   ✅   | 00:00:00.519 |
| `test_config_store`      | `native_config_store`   |    14 |   ✅   | 00:00:00.519 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.543 |
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.530 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.557 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.556 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.534 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.523 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.536 |
| `test_cbor`              | `native_cbor`           |    18 |   ✅   | 00:00:00.521 |
| `test_msgpack`           | `native_msgpack`        |    17 |   ✅   | 00:00:00.527 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.528 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.529 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.519 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.560 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.556 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.611 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.517 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.623 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:00.847 |
...
------------ native_canopen:test_canopen [PASSED] Took 6.21 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:06.210
================= 17 test cases: 17 succeeded in 00:00:06.210 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
----- native_det_primitives:test_det_primitives [PASSED] Took 0.51 seconds -----

=================================== SUMMARY ===================================
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_det_primitives  test_det_primitives  PASSED    00:00:00.513
================== 5 test cases: 5 succeeded in 00:00:00.513 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
-------------- native_j1939:test_j1939 [PASSED] Took 0.62 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.619
================== 9 test cases: 9 succeeded in 00:00:00.619 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
---------- native_devicenet:test_devicenet [PASSED] Took 0.94 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_devicenet  test_devicenet  PASSED    00:00:00.940
================== 8 test cases: 8 succeeded in 00:00:00.940 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
----------- native_nmea2000:test_nmea2000 [PASSED] Took 0.55 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.553
...
--------------- native_mbus:test_mbus [PASSED] Took 0.52 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mbus    test_mbus  PASSED    00:00:00.522
================= 11 test cases: 11 succeeded in 00:00:00.522 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
----------- native_iec60870:test_iec60870 [PASSED] Took 0.62 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_iec60870  test_iec60870  PASSED    00:00:00.624
================== 8 test cases: 8 succeeded in 00:00:00.624 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_sdi12   test_sdi12  PASSED    00:00:00.526
...
---------------- native_dmx:test_dmx [PASSED] Took 0.61 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_dmx     test_dmx  PASSED    00:00:00.607
================== 5 test cases: 5 succeeded in 00:00:00.607 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea0183  test_nmea0183  PASSED    00:00:00.526
================== 7 test cases: 7 succeeded in 00:00:00.526 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
------------- native_iolink:test_iolink [PASSED] Took 0.51 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_iolink  test_iolink  PASSED    00:00:00.515
================== 5 test cases: 5 succeeded in 00:00:00.515 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
------------------ native:test_sse [PASSED] Took 0.78 seconds ------------------
...
---------------- native:test_session [PASSED] Took 0.46 seconds ----------------
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:00.780
native         test_session       PASSED    00:00:00.457
native         test_presentation  PASSED    00:00:00.486
native         test_transport     PASSED    00:00:00.472
native         test_websocket     PASSED    00:00:00.525
native         test_http_parser   PASSED    00:00:00.470
================ 321 test cases: 321 succeeded in 00:00:03.190 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
------ native_observability:test_observability [PASSED] Took 0.58 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_observability  test_observability  PASSED    00:00:00.576
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:00.772
...
------------- native_ota:test_http_ota [PASSED] Took 0.52 seconds --------------

=================================== SUMMARY ===================================
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.524
================== 3 test cases: 3 succeeded in 00:00:00.524 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment    Test               Status    Duration
-------------  -----------------  --------  ------------
native_prov    test_provisioning  PASSED    00:00:00.535
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 2.95 seconds -------------
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:02.945
native_ssh     test_ssh_auth       PASSED    00:00:00.468
native_ssh     test_ssh_server     PASSED    00:00:00.680
native_ssh     test_ssh_transport  PASSED    00:00:00.856
native_ssh     test_ssh_channel    PASSED    00:00:00.437
================ 120 test cases: 120 succeeded in 00:00:05.387 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
------ native_ssh_hardened:test_ssh_hardening [PASSED] Took 0.71 seconds -------

=================================== SUMMARY ===================================
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.709
================== 2 test cases: 2 succeeded in 00:00:00.709 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 1.00 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:00.997
================== 2 test cases: 2 succeeded in 00:00:00.997 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
----------- native_app:test_web_terminal [PASSED] Took 0.48 seconds ------------
...
-------------- native_app:test_chunked [PASSED] Took 0.49 seconds --------------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:00.910
native_app     test_template          PASSED    00:00:00.477
native_app     test_path_params       PASSED    00:00:00.475
native_app     test_digest_vectors    PASSED    00:00:00.432
native_app     test_form_params       PASSED    00:00:00.478
native_app     test_iface             PASSED    00:00:00.475
native_app     test_json              PASSED    00:00:00.445
native_app     test_response_headers  PASSED    00:00:00.475
native_app     test_middleware        PASSED    00:00:00.476
native_app     test_digest_auth       PASSED    00:00:00.487
native_app     test_web_terminal      PASSED    00:00:00.475
native_app     test_defer             PASSED    00:00:00.460
native_app     test_multipart         PASSED    00:00:00.482
native_app     test_auth              PASSED    00:00:00.493
native_app     test_file_serving      PASSED    00:00:00.497
native_app     test_dispatch          PASSED    00:00:00.478
native_app     test_chunked           PASSED    00:00:00.489
native_app     test_application       PASSED    00:00:00.554
================ 225 test cases: 225 succeeded in 00:00:09.059 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:00.965
================= 12 test cases: 12 succeeded in 00:00:00.965 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
--------------- native_diag:test_diag [PASSED] Took 0.93 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:00.934
...
------------- native_snmp:test_snmp_ber [PASSED] Took 0.56 seconds -------------
...
------------ native_snmp:test_snmp_agent [PASSED] Took 0.42 seconds ------------

=================================== SUMMARY ===================================
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.559
native_snmp    test_snmp_agent  PASSED    00:00:00.418
================= 35 test cases: 35 succeeded in 00:00:00.978 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.663
================= 15 test cases: 15 succeeded in 00:00:01.663 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
------------- native_telnet:test_telnet [PASSED] Took 0.63 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.633
================= 15 test cases: 15 succeeded in 00:00:00.633 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
--------------- native_coap:test_coap [PASSED] Took 0.71 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.713
================= 41 test cases: 41 succeeded in 00:00:00.713 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
test/test_coap/test_coap.cpp:1076: test_well_known_core_discovery       [PASSED]
test/test_coap/test_coap.cpp:1077: test_well_known_core_rejects_post    [PASSED]
----------- native_coap_observe:test_coap [PASSED] Took 0.61 seconds -----------

=================================== SUMMARY ===================================
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.605
================= 41 test cases: 41 succeeded in 00:00:00.605 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.542
================= 19 test cases: 19 succeeded in 00:00:00.542 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
------------- native_modbus:test_modbus [PASSED] Took 0.52 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.522
================= 22 test cases: 22 succeeded in 00:00:00.522 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_cloudevents  test_cloudevents  PASSED    00:00:00.593
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.525
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.530
================= 13 test cases: 13 succeeded in 00:00:00.530 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_flow_export  test_flow_export  PASSED    00:00:00.528
...
----------- native_protobuf:test_protobuf [PASSED] Took 0.54 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_protobuf  test_protobuf  PASSED    00:00:00.544
================= 13 test cases: 13 succeeded in 00:00:00.544 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
------ native_preempt_queue:test_preempt_queue [PASSED] Took 0.58 seconds ------

=================================== SUMMARY ===================================
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_preempt_queue  test_preempt_queue  PASSED    00:00:00.582
================= 11 test cases: 11 succeeded in 00:00:00.582 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_forward  test_forward  PASSED    00:00:00.687
================= 16 test cases: 16 succeeded in 00:00:00.687 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
------------ native_gateway:test_gateway [PASSED] Took 0.60 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_gateway  test_gateway  PASSED    00:00:00.603
================= 11 test cases: 11 succeeded in 00:00:00.603 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_lora    test_lora  PASSED    00:00:00.529
================= 13 test cases: 13 succeeded in 00:00:00.529 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_nrf24   test_nrf24  PASSED    00:00:00.521
================= 10 test cases: 10 succeeded in 00:00:00.521 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
------------ native_enocean:test_enocean [PASSED] Took 0.52 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_enocean  test_enocean  PASSED    00:00:00.520
================== 9 test cases: 9 succeeded in 00:00:00.520 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_pn532   test_pn532  PASSED    00:00:00.527
...
------------- native_sigfox:test_sigfox [PASSED] Took 0.53 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_sigfox  test_sigfox  PASSED    00:00:00.530
...
-------------- native_zwave:test_zwave [PASSED] Took 0.57 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_zwave   test_zwave  PASSED    00:00:00.571
================== 9 test cases: 9 succeeded in 00:00:00.571 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
--------------- native_wamp:test_wamp [PASSED] Took 0.58 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.581
================= 12 test cases: 12 succeeded in 00:00:00.581 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_sunspec  test_sunspec  PASSED    00:00:00.516
...
--------------- native_dnp3:test_dnp3 [PASSED] Took 0.53 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_dnp3    test_dnp3  PASSED    00:00:00.529
================== 8 test cases: 8 succeeded in 00:00:00.529 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_grpcweb  test_grpcweb  PASSED    00:00:00.538
...
---------- native_lwm2m_tlv:test_lwm2m_tlv [PASSED] Took 0.53 seconds ----------
...
--------------- native_fins:test_fins [PASSED] Took 0.57 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.568
...
----------- native_hostlink:test_hostlink [PASSED] Took 0.52 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  PASSED    00:00:00.521
================== 7 test cases: 7 succeeded in 00:00:00.521 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
-------------- native_senml:test_senml [PASSED] Took 0.66 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_senml   test_senml  PASSED    00:00:00.659
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_df1     test_df1  PASSED    00:00:00.539
...
--------------- native_cotp:test_cotp [PASSED] Took 0.53 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cotp    test_cotp  PASSED    00:00:00.526
================== 6 test cases: 6 succeeded in 00:00:00.526 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
------------- native_s7comm:test_s7comm [PASSED] Took 0.55 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_s7comm  test_s7comm  PASSED    00:00:00.546
...
------------- native_bacnet:test_bacnet [PASSED] Took 0.57 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_bacnet  test_bacnet  PASSED    00:00:00.566
================== 9 test cases: 9 succeeded in 00:00:00.566 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
--------------- native_enip:test_enip [PASSED] Took 0.54 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_enip    test_enip  PASSED    00:00:00.536
================== 6 test cases: 6 succeeded in 00:00:00.536 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.535
================== 7 test cases: 7 succeeded in 00:00:00.535 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.534
================== 9 test cases: 9 succeeded in 00:00:00.534 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
--------------- native_nats:test_nats [PASSED] Took 0.54 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.541
================= 14 test cases: 14 succeeded in 00:00:00.541 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_proxy_protocol  test_proxy_protocol  PASSED    00:00:00.552
...
---------- native_sparkplug:test_sparkplug [PASSED] Took 0.54 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_sparkplug  test_sparkplug  PASSED    00:00:00.542
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.560
================== 5 test cases: 5 succeeded in 00:00:00.560 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.533
================== 5 test cases: 5 succeeded in 00:00:00.533 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
--------------- native_totp:test_totp [PASSED] Took 0.63 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.632
================== 4 test cases: 4 succeeded in 00:00:00.632 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_webhook  test_webhook  PASSED    00:00:00.548
...
-------- native_radio_power:test_radio_power [PASSED] Took 0.54 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.539
================== 2 test cases: 2 succeeded in 00:00:00.539 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.540
================== 4 test cases: 4 succeeded in 00:00:00.540 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
--------------- native_oidc:test_oidc [PASSED] Took 0.74 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.745
================= 17 test cases: 17 succeeded in 00:00:00.745 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
---------------- native_vfs:test_vfs [PASSED] Took 0.55 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.554
================= 11 test cases: 11 succeeded in 00:00:00.554 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.584
================= 32 test cases: 32 succeeded in 00:00:00.584 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
------------- native_espnow:test_espnow [PASSED] Took 0.60 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_espnow  test_espnow  PASSED    00:00:00.603
================== 7 test cases: 7 succeeded in 00:00:00.603 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
------------- native_oauth2:test_oauth2 [PASSED] Took 0.57 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_oauth2  test_oauth2  PASSED    00:00:00.573
...
-------------- native_opcua:test_opcua [PASSED] Took 0.55 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.549
================= 38 test cases: 38 succeeded in 00:00:00.549 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
------- native_opcua_client:test_opcua_client [PASSED] Took 0.72 seconds -------

=================================== SUMMARY ===================================
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.723
================= 14 test cases: 14 succeeded in 00:00:00.723 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
---------- native_keepalive:test_keepalive [PASSED] Took 0.88 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:00.880
================= 10 test cases: 10 succeeded in 00:00:00.880 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
-------------- native_range:test_range [PASSED] Took 0.89 seconds --------------

=================================== SUMMARY ===================================
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:00.885
================= 13 test cases: 13 succeeded in 00:00:00.885 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.582
================= 10 test cases: 10 succeeded in 00:00:00.582 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
---------------- native_jwt:test_jwt [PASSED] Took 0.58 seconds ----------------

=================================== SUMMARY ===================================
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.576
================= 16 test cases: 16 succeeded in 00:00:00.576 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
------------- native_upload:test_upload [PASSED] Took 0.88 seconds -------------

=================================== SUMMARY ===================================
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:00.882
================== 3 test cases: 3 succeeded in 00:00:00.882 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.531
================= 15 test cases: 15 succeeded in 00:00:00.531 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.527
================= 15 test cases: 15 succeeded in 00:00:00.527 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_mqtt    test_mqtt  PASSED    00:00:00.530
================= 22 test cases: 22 succeeded in 00:00:00.530 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
---------- native_ws_client:test_ws_client [PASSED] Took 0.56 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.558
================= 16 test cases: 16 succeeded in 00:00:00.558 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
------------ native_scratch:test_scratch [PASSED] Took 0.56 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_scratch  test_scratch  PASSED    00:00:00.560
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.550
================== 7 test cases: 7 succeeded in 00:00:00.550 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.519
================= 12 test cases: 12 succeeded in 00:00:00.519 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
------------ native_deflate:test_deflate [PASSED] Took 0.57 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.571
================= 10 test cases: 10 succeeded in 00:00:00.571 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
test/test_websocket/test_websocket.cpp:1107: stress_ws_parse_max_payload [PASSED]
test/test_websocket/test_websocket.cpp:1108: stress_ws_parse_two_consecutive_frames [PASSED]
--------- native_ws_deflate:test_websocket [PASSED] Took 0.84 seconds ----------

=================================== SUMMARY ===================================
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.838
================= 71 test cases: 71 succeeded in 00:00:00.838 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_time_source  test_time_source  PASSED    00:00:00.519
...
---------- native_device_id:test_device_id [PASSED] Took 0.54 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.543
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.530
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.557
...
---------- native_telemetry:test_telemetry [PASSED] Took 0.56 seconds ----------

=================================== SUMMARY ===================================
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.556
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.534
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.523
================== 5 test cases: 5 succeeded in 00:00:00.523 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.536
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.521
================= 18 test cases: 18 succeeded in 00:00:00.521 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
----------- native_gpio_map:test_gpio_map [PASSED] Took 0.53 seconds -----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.528
================== 8 test cases: 8 succeeded in 00:00:00.528 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.529
================== 7 test cases: 7 succeeded in 00:00:00.529 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.519
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.560
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.611
================== 3 test cases: 3 succeeded in 00:00:00.611 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.517
================== 7 test cases: 7 succeeded in 00:00:00.517 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
-------- native_concurrency:test_concurrency [PASSED] Took 0.62 seconds --------

=================================== SUMMARY ===================================
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.623
================== 2 test cases: 2 succeeded in 00:00:00.623 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 138 tests
...
test/test_concurrency/test_concurrency.cpp:109: test_spsc_ring_no_race  [PASSED]
test/test_concurrency/test_concurrency.cpp:110: test_state_handoff_no_race [PASSED]
----------- native_tsan:test_concurrency [PASSED] Took 0.85 seconds ------------

=================================== SUMMARY ===================================
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:00.847
