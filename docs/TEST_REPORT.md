...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:06.584 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.555 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.597 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.577 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.589 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.543 |
...
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.566 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.565 |
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.547 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.575 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.570 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.589 |
| `test_dispatch`         | `native_app`          |    11 |   ✅   | 00:00:00.566 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.572 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.660 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.642 |
| `test_workers`          | `native_workers`      |     3 |   ✅   | 00:00:00.725 |
| `test_concurrency`      | `native_tsan`         |     2 |   ✅   | 00:00:01.151 |
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:06.584
native               test_session           PASSED    00:00:00.555
...
native               test_http_parser       PASSED    00:00:00.543
...
native_app           test_file_serving      PASSED    00:00:00.589
...
native_workers       test_workers           PASSED    00:00:00.725
native_tsan          test_concurrency       PASSED    00:00:01.151
================ 620 test cases: 620 succeeded in 00:00:31.214 ================
```
