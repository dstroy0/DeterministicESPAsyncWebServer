...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:15.639 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.548 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.586 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.572 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.598 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.557 |
| `test_ssh_crypto`       | `native_ssh`          |    38 |   ✅   | 00:00:03.827 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.561 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.685 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.972 |
...
| `test_dispatch`         | `native_app`          |    11 |   ✅   | 00:00:00.585 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.564 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.665 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.634 |
| `test_workers`          | `native_workers`      |     3 |   ✅   | 00:00:00.712 |
| `test_concurrency`      | `native_tsan`         |     2 |   ✅   | 00:00:01.455 |
...
----------------- native:test_sse [PASSED] Took 15.64 seconds ------------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:15.639
native               test_session           PASSED    00:00:00.548
native               test_presentation      PASSED    00:00:00.586
...
native_ssh           test_ssh_auth          PASSED    00:00:00.561
native_ssh           test_ssh_server        PASSED    00:00:00.685
native_ssh           test_ssh_transport     PASSED    00:00:00.972
...
native_app           test_template          PASSED    00:00:00.570
...
native_app           test_dispatch          PASSED    00:00:00.585
native_app           test_chunked           PASSED    00:00:00.564
native_app           test_application       PASSED    00:00:00.665
native_compliance    test_compliance        PASSED    00:00:00.634
native_workers       test_workers           PASSED    00:00:00.712
native_tsan          test_concurrency       PASSED    00:00:01.455
================ 621 test cases: 621 succeeded in 00:00:40.719 ================
```
