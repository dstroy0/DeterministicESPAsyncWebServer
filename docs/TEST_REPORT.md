...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:06.129 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.500 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.526 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.528 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.539 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.494 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:04.228 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.519 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.659 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.928 |
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.477 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.772 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.132 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.957 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.513 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.505 |
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.457 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.505 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.509 |
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.475 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.514 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.507 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.515 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.515 |
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.488 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.521 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.511 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.525 |
| `test_dispatch`         | `native_app`          |    11 |   ✅   | 00:00:00.517 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.513 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.601 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.568 |
| `test_workers`          | `native_workers`      |     3 |   ✅   | 00:00:00.636 |
| `test_concurrency`      | `native_tsan`         |     2 |   ✅   | 00:00:01.310 |
...
------------------ native:test_sse [PASSED] Took 6.13 seconds ------------------
...
------------ native_ssh:test_ssh_crypto [PASSED] Took 4.23 seconds -------------
...
----------- native_ssh_conn:test_ssh_conn [PASSED] Took 1.13 seconds -----------
...
---------- native_app:test_digest_vectors [PASSED] Took 0.46 seconds -----------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:06.129
native               test_session           PASSED    00:00:00.500
native               test_presentation      PASSED    00:00:00.526
native               test_transport         PASSED    00:00:00.528
native               test_websocket         PASSED    00:00:00.539
native               test_http_parser       PASSED    00:00:00.494
native_ssh           test_ssh_crypto        PASSED    00:00:04.228
native_ssh           test_ssh_auth          PASSED    00:00:00.519
native_ssh           test_ssh_server        PASSED    00:00:00.659
native_ssh           test_ssh_transport     PASSED    00:00:00.928
native_ssh           test_ssh_channel       PASSED    00:00:00.477
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.772
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.132
native_app           test_regex             PASSED    00:00:00.957
native_app           test_template          PASSED    00:00:00.513
native_app           test_path_params       PASSED    00:00:00.505
native_app           test_digest_vectors    PASSED    00:00:00.457
native_app           test_form_params       PASSED    00:00:00.505
native_app           test_iface             PASSED    00:00:00.509
native_app           test_json              PASSED    00:00:00.475
native_app           test_response_headers  PASSED    00:00:00.514
native_app           test_middleware        PASSED    00:00:00.507
native_app           test_digest_auth       PASSED    00:00:00.515
native_app           test_web_terminal      PASSED    00:00:00.515
native_app           test_defer             PASSED    00:00:00.488
native_app           test_multipart         PASSED    00:00:00.521
native_app           test_auth              PASSED    00:00:00.511
native_app           test_file_serving      PASSED    00:00:00.525
native_app           test_dispatch          PASSED    00:00:00.517
native_app           test_chunked           PASSED    00:00:00.513
native_app           test_application       PASSED    00:00:00.601
native_compliance    test_compliance        PASSED    00:00:00.568
native_workers       test_workers           PASSED    00:00:00.636
native_tsan          test_concurrency       PASSED    00:00:01.310
================ 620 test cases: 620 succeeded in 00:00:29.593 ================
```
