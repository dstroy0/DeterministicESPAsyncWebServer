...
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.848 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.214 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:01.078 |
...
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.578 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.576 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.571 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.575 |
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.553 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.581 |
...
| `test_workers`          | `native_workers`      |     3 |   ✅   | 00:00:00.708 |
| `test_concurrency`      | `native_tsan`         |     2 |   ✅   | 00:00:01.437 |
...
----------------- native:test_sse [PASSED] Took 15.16 seconds ------------------
...
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.848
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.214
native_app           test_regex             PASSED    00:00:01.078
native_app           test_template          PASSED    00:00:00.571
native_app           test_path_params       PASSED    00:00:00.565
native_app           test_digest_vectors    PASSED    00:00:00.511
native_app           test_form_params       PASSED    00:00:00.575
...
native_workers       test_workers           PASSED    00:00:00.708
native_tsan          test_concurrency       PASSED    00:00:01.437
================ 621 test cases: 621 succeeded in 00:00:40.193 ================
```
