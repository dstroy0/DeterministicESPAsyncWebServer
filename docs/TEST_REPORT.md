...
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.587 |
...
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.648 |
...
| `test_snmp_ber`          | `native_snmp`           |    15 |   ✅   | 00:00:00.752 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.528 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.513 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.847 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.783 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.799 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.693 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.717 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.756 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.661 |
...
| `test_protobuf`          | `native_protobuf`       |     8 |   ✅   | 00:00:00.704 |
| `test_wamp`              | `native_wamp`           |    11 |   ✅   | 00:00:00.713 |
...
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |     7 |   ✅   | 00:00:00.677 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.683 |
...
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.688 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.692 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.686 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.677 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.697 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.672 |
| `test_proxy_protocol`    | `native_proxy_protocol` |     8 |   ✅   | 00:00:00.674 |
| `test_sparkplug`         | `native_sparkplug`      |     6 |   ✅   | 00:00:00.692 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.689 |
| `test_ota_rollback`      | `native_ota_rollback`   |     5 |   ✅   | 00:00:00.685 |
| `test_totp`              | `native_totp`           |     4 |   ✅   | 00:00:00.701 |
| `test_webhook`           | `native_webhook`        |     5 |   ✅   | 00:00:00.687 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.669 |
| `test_dns_resolver`      | `native_dns_resolver`   |     4 |   ✅   | 00:00:00.685 |
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.703 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.859 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.679 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.687 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.666 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.706 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.739 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.738 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.122 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.149 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.713 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.734 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.217 |
| `test_http_client`       | `native_http_client`    |    10 |   ✅   | 00:00:00.727 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.710 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.716 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.745 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.727 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.730 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.674 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.727 |
...
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.659 |
...
------------------ native:test_sse [PASSED] Took 6.80 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:06.799
...
native         test_websocket     PASSED    00:00:00.651
native         test_http_parser   PASSED    00:00:00.610
================ 318 test cases: 318 succeeded in 00:00:09.951 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
================= 15 test cases: 15 succeeded in 00:00:00.767 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.936
native_ssh     test_ssh_auth       PASSED    00:00:00.600
...
================= 93 test cases: 93 succeeded in 00:00:06.750 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
native_app     test_chunked           PASSED    00:00:00.648
native_app     test_application       PASSED    00:00:00.706
================ 219 test cases: 219 succeeded in 00:00:11.824 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
================= 29 test cases: 29 succeeded in 00:00:01.280 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.513
================= 10 test cases: 10 succeeded in 00:00:01.513 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
================== 8 test cases: 8 succeeded in 00:00:00.847 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.799
================= 29 test cases: 29 succeeded in 00:00:00.799 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_modbus  test_modbus  PASSED    00:00:00.717
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_redis   test_redis_resp  PASSED    00:00:00.661
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.713
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_fins    test_fins  PASSED    00:00:00.683
...
test/test_hostlink/test_hostlink.cpp:30: test_build_dm_read: Expected '@00RD0000001057*\r' Was '@00RD0000001057*\r#\xBE\x17\xFC\x7F' [FAILED]
...
---------- native_hostlink:test_hostlink [ERRORED] Took 0.69 seconds ----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  ERRORED   00:00:00.695

============= 8 test cases: 1 failed, 6 succeeded in 00:00:00.695 =============
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_melsec  test_melsec  PASSED    00:00:00.688
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_cip     test_cip  PASSED    00:00:00.697
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_ota_rollback  test_ota_rollback  PASSED    00:00:00.685
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.669
================== 2 test cases: 2 succeeded in 00:00:00.669 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.859
================= 13 test cases: 13 succeeded in 00:00:00.859 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.679
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.217
================== 3 test cases: 3 succeeded in 00:00:01.217 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.745
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.727
================= 10 test cases: 10 succeeded in 00:00:00.727 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 116 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.659
