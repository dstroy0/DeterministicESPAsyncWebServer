...
| :----------------------- | :--------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`               |    37 |   ✅   | 00:00:11.998 |
| `test_session`           | `native`               |    19 |   ✅   | 00:00:00.505 |
| `test_presentation`      | `native`               |    63 |   ✅   | 00:00:00.541 |
| `test_transport`         | `native`               |    42 |   ✅   | 00:00:00.537 |
| `test_websocket`         | `native`               |    67 |   ✅   | 00:00:00.551 |
| `test_http_parser`       | `native`               |    82 |   ✅   | 00:00:00.503 |
| `test_observability`     | `native_observability` |    15 |   ✅   | 00:00:00.642 |
| `test_http_ota`          | `native_ota`           |     3 |   ✅   | 00:00:00.557 |
| `test_provisioning`      | `native_prov`          |     5 |   ✅   | 00:00:00.604 |
| `test_ssh_crypto`        | `native_ssh`           |    38 |   ✅   | 00:00:04.127 |
| `test_ssh_auth`          | `native_ssh`           |    12 |   ✅   | 00:00:00.503 |
| `test_ssh_server`        | `native_ssh`           |     7 |   ✅   | 00:00:00.649 |
| `test_ssh_transport`     | `native_ssh`           |    23 |   ✅   | 00:00:00.915 |
| `test_ssh_channel`       | `native_ssh`           |    12 |   ✅   | 00:00:00.468 |
| `test_ssh_hardening`     | `native_ssh_hardened`  |     2 |   ✅   | 00:00:00.783 |
| `test_ssh_conn`          | `native_ssh_conn`      |     2 |   ✅   | 00:00:01.147 |
| `test_regex`             | `native_app`           |     9 |   ✅   | 00:00:00.995 |
| `test_template`          | `native_app`           |     6 |   ✅   | 00:00:00.519 |
| `test_path_params`       | `native_app`           |     8 |   ✅   | 00:00:00.519 |
| `test_digest_vectors`    | `native_app`           |     4 |   ✅   | 00:00:00.470 |
| `test_form_params`       | `native_app`           |     5 |   ✅   | 00:00:00.515 |
| `test_iface`             | `native_app`           |     7 |   ✅   | 00:00:00.516 |
| `test_json`              | `native_app`           |    17 |   ✅   | 00:00:00.476 |
| `test_response_headers`  | `native_app`           |     9 |   ✅   | 00:00:00.523 |
| `test_middleware`        | `native_app`           |     9 |   ✅   | 00:00:00.525 |
| `test_digest_auth`       | `native_app`           |    10 |   ✅   | 00:00:00.534 |
| `test_web_terminal`      | `native_app`           |     7 |   ✅   | 00:00:00.520 |
| `test_defer`             | `native_app`           |     3 |   ✅   | 00:00:00.497 |
| `test_multipart`         | `native_app`           |    19 |   ✅   | 00:00:00.532 |
| `test_auth`              | `native_app`           |    13 |   ✅   | 00:00:00.524 |
| `test_file_serving`      | `native_app`           |    12 |   ✅   | 00:00:00.536 |
| `test_dispatch`          | `native_app`           |    11 |   ✅   | 00:00:00.523 |
| `test_chunked`           | `native_app`           |    10 |   ✅   | 00:00:00.533 |
| `test_application`       | `native_app`           |    53 |   ✅   | 00:00:00.605 |
| `test_diag`              | `native_diag`          |     2 |   ✅   | 00:00:01.024 |
| `test_snmp_ber`          | `native_snmp`          |    15 |   ✅   | 00:00:00.628 |
| `test_snmp_agent`        | `native_snmp`          |    13 |   ✅   | 00:00:00.457 |
| `test_snmp_v3`           | `native_snmp_v3`       |     9 |   ✅   | 00:00:01.465 |
| `test_telnet`            | `native_telnet`        |     8 |   ✅   | 00:00:00.703 |
| `test_coap`              | `native_coap`          |    27 |   ✅   | 00:00:00.604 |
| `test_coap`              | `native_coap_observe`  |    27 |   ✅   | 00:00:00.592 |
| `test_webdav`            | `native_webdav`        |    19 |   ✅   | 00:00:00.587 |
| `test_modbus`            | `native_modbus`        |    13 |   ✅   | 00:00:00.576 |
| `test_modbus_master`     | `native_modbus_master` |     5 |   ✅   | 00:00:00.620 |
| `test_ota_rollback`      | `native_ota_rollback`  |     5 |   ✅   | 00:00:00.583 |
| `test_totp`              | `native_totp`          |     4 |   ✅   | 00:00:00.591 |
| `test_webhook`           | `native_webhook`       |     5 |   ✅   | 00:00:00.572 |
| `test_radio_power`       | `native_radio_power`   |     2 |   ✅   | 00:00:00.567 |
| `test_dns_resolver`      | `native_dns_resolver`  |     4 |   ✅   | 00:00:00.565 |
| `test_audit_log`         | `native_audit_log`     |    12 |   ✅   | 00:00:00.598 |
| `test_oidc`              | `native_oidc`          |    13 |   ✅   | 00:00:00.754 |
| `test_vfs`               | `native_vfs`           |    11 |   ✅   | 00:00:00.577 |
| `test_graphql`           | `native_graphql`       |    13 |   ✅   | 00:00:00.593 |
| `test_espnow`            | `native_espnow`        |     7 |   ✅   | 00:00:00.570 |
| `test_oauth2`            | `native_oauth2`        |     8 |   ✅   | 00:00:00.589 |
| `test_opcua`             | `native_opcua`         |    29 |   ✅   | 00:00:00.595 |
| `test_opcua_client`      | `native_opcua_client`  |    11 |   ✅   | 00:00:00.631 |
| `test_keepalive`         | `native_keepalive`     |    10 |   ✅   | 00:00:00.977 |
| `test_range`             | `native_range`         |    13 |   ✅   | 00:00:00.959 |
| `test_syslog`            | `native_syslog`        |     6 |   ✅   | 00:00:00.578 |
| `test_jwt`               | `native_jwt`           |    11 |   ✅   | 00:00:00.624 |
| `test_upload`            | `native_upload`        |     3 |   ✅   | 00:00:00.985 |
| `test_http_client`       | `native_http_client`   |    10 |   ✅   | 00:00:00.575 |
| `test_compliance`        | `native_compliance`    |    15 |   ✅   | 00:00:00.563 |
| `test_mqtt`              | `native_mqtt`          |    17 |   ✅   | 00:00:00.571 |
| `test_ws_client`         | `native_ws_client`     |    10 |   ✅   | 00:00:00.615 |
| `test_scratch`           | `native_scratch`       |    14 |   ✅   | 00:00:00.613 |
| `test_snmp_trap`         | `native_snmp_trap`     |     3 |   ✅   | 00:00:00.582 |
| `test_inflate`           | `native_inflate`       |    12 |   ✅   | 00:00:00.578 |
| `test_deflate`           | `native_deflate`       |    10 |   ✅   | 00:00:00.617 |
| `test_websocket`         | `native_ws_deflate`    |    71 |   ✅   | 00:00:00.892 |
| `test_time_source`       | `native_time_source`   |     9 |   ✅   | 00:00:00.570 |
| `test_config_store`      | `native_config_store`  |    14 |   ✅   | 00:00:00.571 |
| `test_device_id`         | `native_device_id`     |     4 |   ✅   | 00:00:00.603 |
| `test_auth_lockout`      | `native_auth_lockout`  |    10 |   ✅   | 00:00:00.568 |
| `test_csrf`              | `native_csrf`          |     9 |   ✅   | 00:00:00.599 |
| `test_telemetry`         | `native_telemetry`     |     8 |   ✅   | 00:00:00.593 |
| `test_dashboard`         | `native_dashboard`     |    11 |   ✅   | 00:00:00.578 |
| `test_net_egress`        | `native_net_egress`    |     5 |   ✅   | 00:00:00.575 |
| `test_partition_monitor` | `native_partition`     |     5 |   ✅   | 00:00:00.564 |
| `test_cbor`              | `native_cbor`          |    14 |   ✅   | 00:00:00.577 |
| `test_msgpack`           | `native_msgpack`       |    15 |   ✅   | 00:00:00.578 |
| `test_gpio_map`          | `native_gpio_map`      |     8 |   ✅   | 00:00:00.575 |
| `test_udp_telemetry`     | `native_udp_telemetry` |     4 |   ✅   | 00:00:00.566 |
| `test_guardrails`        | `native_guardrails`    |     6 |   ✅   | 00:00:00.573 |
| `test_logbuf`            | `native_logbuf`        |     4 |   ✅   | 00:00:00.572 |
| `test_config_io`         | `native_config_io`     |     4 |   ✅   | 00:00:00.588 |
| `test_workers`           | `native_workers`       |     3 |   ✅   | 00:00:00.672 |
| `test_clock`             | `native_clock`         |     4 |   ✅   | 00:00:00.557 |
| `test_concurrency`       | `native_concurrency`   |     2 |   ✅   | 00:00:00.743 |
...
----------------- native:test_sse [PASSED] Took 12.00 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:11.998
native         test_session       PASSED    00:00:00.505
native         test_presentation  PASSED    00:00:00.541
native         test_transport     PASSED    00:00:00.537
native         test_websocket     PASSED    00:00:00.551
native         test_http_parser   PASSED    00:00:00.503
================ 310 test cases: 310 succeeded in 00:00:14.636 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test           Status    Duration
-------------  -------------  --------  ------------
native_ota     test_http_ota  PASSED    00:00:00.557
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:04.127
native_ssh     test_ssh_auth       PASSED    00:00:00.503
native_ssh     test_ssh_server     PASSED    00:00:00.649
native_ssh     test_ssh_transport  PASSED    00:00:00.915
native_ssh     test_ssh_channel    PASSED    00:00:00.468
================= 92 test cases: 92 succeeded in 00:00:06.661 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.783
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_ssh_conn  test_ssh_conn  PASSED    00:00:01.147
...
--------------- native_app:test_regex [PASSED] Took 0.99 seconds ---------------
...
--------------- native_app:test_defer [PASSED] Took 0.50 seconds ---------------
...
Environment    Test                   Status    Duration
-------------  ---------------------  --------  ------------
native_app     test_regex             PASSED    00:00:00.995
native_app     test_template          PASSED    00:00:00.519
native_app     test_path_params       PASSED    00:00:00.519
native_app     test_digest_vectors    PASSED    00:00:00.470
native_app     test_form_params       PASSED    00:00:00.515
native_app     test_iface             PASSED    00:00:00.516
native_app     test_json              PASSED    00:00:00.476
native_app     test_response_headers  PASSED    00:00:00.523
native_app     test_middleware        PASSED    00:00:00.525
native_app     test_digest_auth       PASSED    00:00:00.534
native_app     test_web_terminal      PASSED    00:00:00.520
native_app     test_defer             PASSED    00:00:00.497
native_app     test_multipart         PASSED    00:00:00.532
native_app     test_auth              PASSED    00:00:00.524
native_app     test_file_serving      PASSED    00:00:00.536
native_app     test_dispatch          PASSED    00:00:00.523
native_app     test_chunked           PASSED    00:00:00.533
native_app     test_application       PASSED    00:00:00.605
================ 212 test cases: 212 succeeded in 00:00:09.862 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
--------------- native_diag:test_diag [PASSED] Took 1.02 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.024
================== 2 test cases: 2 succeeded in 00:00:01.024 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test             Status    Duration
-------------  ---------------  --------  ------------
native_snmp    test_snmp_ber    PASSED    00:00:00.628
native_snmp    test_snmp_agent  PASSED    00:00:00.457
================= 28 test cases: 28 succeeded in 00:00:01.084 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.465
================== 9 test cases: 9 succeeded in 00:00:01.465 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_telnet  test_telnet  PASSED    00:00:00.703
...
--------------- native_coap:test_coap [PASSED] Took 0.60 seconds ---------------

=================================== SUMMARY ===================================
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.604
================= 27 test cases: 27 succeeded in 00:00:00.604 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
================= 27 test cases: 27 succeeded in 00:00:00.592 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_webdav  test_webdav  PASSED    00:00:00.587
================= 19 test cases: 19 succeeded in 00:00:00.587 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_modbus_master  test_modbus_master  PASSED    00:00:00.620
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_totp    test_totp  PASSED    00:00:00.591
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_radio_power  test_radio_power  PASSED    00:00:00.567
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_dns_resolver  test_dns_resolver  PASSED    00:00:00.565
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_vfs     test_vfs  PASSED    00:00:00.577
================= 11 test cases: 11 succeeded in 00:00:00.577 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.593
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_opcua   test_opcua  PASSED    00:00:00.595
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:00.977
================= 10 test cases: 10 succeeded in 00:00:00.977 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:00.959
================= 13 test cases: 13 succeeded in 00:00:00.959 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.578
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.624
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:00.985
================== 3 test cases: 3 succeeded in 00:00:00.985 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.563
...
================= 17 test cases: 17 succeeded in 00:00:00.571 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_snmp_trap  test_snmp_trap  PASSED    00:00:00.582
================== 3 test cases: 3 succeeded in 00:00:00.582 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.578
================= 12 test cases: 12 succeeded in 00:00:00.578 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.617
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:00.892
================= 71 test cases: 71 succeeded in 00:00:00.892 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_config_store  test_config_store  PASSED    00:00:00.571
================= 14 test cases: 14 succeeded in 00:00:00.571 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_device_id  test_device_id  PASSED    00:00:00.603
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.568
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_csrf    test_csrf  PASSED    00:00:00.599
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_net_egress  test_net_egress  PASSED    00:00:00.575
...
Environment       Test                    Status    Duration
----------------  ----------------------  --------  ------------
native_partition  test_partition_monitor  PASSED    00:00:00.564
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_gpio_map  test_gpio_map  PASSED    00:00:00.575
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.566
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.573
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.572
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_config_io  test_config_io  PASSED    00:00:00.588
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.672
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_concurrency  test_concurrency  PASSED    00:00:00.743
================== 2 test cases: 2 succeeded in 00:00:00.743 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 89 tests
