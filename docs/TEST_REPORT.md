...
| :------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`           | `native`              |    37 |   ✅   | 00:00:06.814 |
| `test_session`       | `native`              |    19 |   ✅   | 00:00:00.503 |
| `test_presentation`  | `native`              |    63 |   ✅   | 00:00:00.518 |
| `test_transport`     | `native`              |    28 |   ✅   | 00:00:00.496 |
| `test_websocket`     | `native`              |    63 |   ✅   | 00:00:00.539 |
| `test_http_parser`   | `native`              |    80 |   ✅   | 00:00:00.523 |
| `test_ssh_crypto`    | `native_ssh`          |    37 |   ✅   | 00:00:03.676 |
| `test_ssh_auth`      | `native_ssh`          |    12 |   ✅   | 00:00:00.522 |
| `test_ssh_server`    | `native_ssh`          |     7 |   ✅   | 00:00:00.654 |
| `test_ssh_transport` | `native_ssh`          |    23 |   ✅   | 00:00:00.898 |
| `test_ssh_channel`   | `native_ssh`          |    12 |   ✅   | 00:00:00.501 |
| `test_ssh_hardening` | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.816 |
| `test_ssh_conn`      | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.060 |
| `test_multipart`     | `native_app`          |    19 |   ✅   | 00:00:00.829 |
| `test_auth`          | `native_app`          |    13 |   ✅   | 00:00:00.526 |
| `test_file_serving`  | `native_app`          |    12 |   ✅   | 00:00:00.515 |
| `test_dispatch`      | `native_app`          |    10 |   ✅   | 00:00:00.497 |
| `test_application`   | `native_app`          |    47 |   ✅   | 00:00:00.594 |
...
------------------ native:test_sse [PASSED] Took 6.81 seconds ------------------
...
-------------------  ------------------  --------  ------------
native               test_sse            PASSED    00:00:06.814
native               test_session        PASSED    00:00:00.503
...
native_ssh           test_ssh_crypto     PASSED    00:00:03.676
native_ssh           test_ssh_auth       PASSED    00:00:00.522
native_ssh           test_ssh_server     PASSED    00:00:00.654
native_ssh           test_ssh_transport  PASSED    00:00:00.898
native_ssh           test_ssh_channel    PASSED    00:00:00.501
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:00.816
native_ssh_conn      test_ssh_conn       PASSED    00:00:01.060
native_app           test_multipart      PASSED    00:00:00.829
native_app           test_auth           PASSED    00:00:00.526
native_app           test_file_serving   PASSED    00:00:00.515
...
================ 498 test cases: 498 succeeded in 00:00:21.131 ================
```
