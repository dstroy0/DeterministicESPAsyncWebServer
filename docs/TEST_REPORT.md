...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:06.804 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.470 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.502 |
| `test_transport`        | `native`              |    28 |   ✅   | 00:00:00.470 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.506 |
| `test_http_parser`      | `native`              |    80 |   ✅   | 00:00:00.491 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:03.745 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.497 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.593 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.809 |
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.456 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.900 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:01.022 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.886 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.475 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.478 |
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.446 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.473 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.470 |
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.473 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.480 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.480 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.492 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.486 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.481 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.486 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.485 |
| `test_dispatch`         | `native_app`          |    10 |   ✅   | 00:00:00.480 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.479 |
| `test_application`      | `native_app`          |    49 |   ✅   | 00:00:00.582 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.590 |
...
------------ native_ssh:test_ssh_server [PASSED] Took 0.59 seconds -------------
...
----------- native_ssh:test_ssh_transport [PASSED] Took 0.81 seconds -----------
...
--------------- native_app:test_json [PASSED] Took 0.47 seconds ----------------
...
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:06.804
native               test_session           PASSED    00:00:00.470
native               test_presentation      PASSED    00:00:00.502
native               test_transport         PASSED    00:00:00.470
native               test_websocket         PASSED    00:00:00.506
native               test_http_parser       PASSED    00:00:00.491
native_ssh           test_ssh_crypto        PASSED    00:00:03.745
native_ssh           test_ssh_auth          PASSED    00:00:00.497
native_ssh           test_ssh_server        PASSED    00:00:00.593
native_ssh           test_ssh_transport     PASSED    00:00:00.809
native_ssh           test_ssh_channel       PASSED    00:00:00.456
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.900
native_ssh_conn      test_ssh_conn          PASSED    00:00:01.022
native_app           test_regex             PASSED    00:00:00.886
native_app           test_template          PASSED    00:00:00.475
native_app           test_path_params       PASSED    00:00:00.478
native_app           test_digest_vectors    PASSED    00:00:00.446
native_app           test_form_params       PASSED    00:00:00.473
native_app           test_iface             PASSED    00:00:00.470
native_app           test_json              PASSED    00:00:00.473
native_app           test_response_headers  PASSED    00:00:00.480
...
native_app           test_multipart         PASSED    00:00:00.481
native_app           test_auth              PASSED    00:00:00.486
native_app           test_file_serving      PASSED    00:00:00.485
native_app           test_dispatch          PASSED    00:00:00.480
native_app           test_chunked           PASSED    00:00:00.479
native_app           test_application       PASSED    00:00:00.582
native_compliance    test_compliance        PASSED    00:00:00.590
================ 594 test cases: 594 succeeded in 00:00:26.485 ================
```
