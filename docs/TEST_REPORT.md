...
| :---------------------- | :-------------------- | ----: | :----: | -----------: |
| `test_sse`              | `native`              |    37 |   ✅   | 00:00:11.305 |
| `test_session`          | `native`              |    19 |   ✅   | 00:00:00.420 |
| `test_presentation`     | `native`              |    63 |   ✅   | 00:00:00.444 |
| `test_transport`        | `native`              |    42 |   ✅   | 00:00:00.445 |
| `test_websocket`        | `native`              |    63 |   ✅   | 00:00:00.449 |
| `test_http_parser`      | `native`              |    82 |   ✅   | 00:00:00.418 |
| `test_ssh_crypto`       | `native_ssh`          |    37 |   ✅   | 00:00:02.908 |
| `test_ssh_auth`         | `native_ssh`          |    12 |   ✅   | 00:00:00.442 |
| `test_ssh_server`       | `native_ssh`          |     7 |   ✅   | 00:00:00.531 |
| `test_ssh_transport`    | `native_ssh`          |    23 |   ✅   | 00:00:00.714 |
| `test_ssh_channel`      | `native_ssh`          |    12 |   ✅   | 00:00:00.413 |
| `test_ssh_hardening`    | `native_ssh_hardened` |     2 |   ✅   | 00:00:00.670 |
| `test_ssh_conn`         | `native_ssh_conn`     |     2 |   ✅   | 00:00:00.924 |
| `test_regex`            | `native_app`          |     9 |   ✅   | 00:00:00.818 |
| `test_template`         | `native_app`          |     6 |   ✅   | 00:00:00.435 |
| `test_path_params`      | `native_app`          |     8 |   ✅   | 00:00:00.426 |
| `test_digest_vectors`   | `native_app`          |     4 |   ✅   | 00:00:00.389 |
| `test_form_params`      | `native_app`          |     5 |   ✅   | 00:00:00.434 |
| `test_iface`            | `native_app`          |     7 |   ✅   | 00:00:00.439 |
| `test_json`             | `native_app`          |    17 |   ✅   | 00:00:00.403 |
| `test_response_headers` | `native_app`          |     9 |   ✅   | 00:00:00.455 |
| `test_middleware`       | `native_app`          |     9 |   ✅   | 00:00:00.435 |
| `test_digest_auth`      | `native_app`          |     5 |   ✅   | 00:00:00.442 |
| `test_web_terminal`     | `native_app`          |     7 |   ✅   | 00:00:00.449 |
| `test_defer`            | `native_app`          |     3 |   ✅   | 00:00:00.421 |
| `test_multipart`        | `native_app`          |    19 |   ✅   | 00:00:00.480 |
| `test_auth`             | `native_app`          |    13 |   ✅   | 00:00:00.441 |
| `test_file_serving`     | `native_app`          |    12 |   ✅   | 00:00:00.494 |
| `test_dispatch`         | `native_app`          |    11 |   ✅   | 00:00:00.445 |
| `test_chunked`          | `native_app`          |     8 |   ✅   | 00:00:00.459 |
| `test_application`      | `native_app`          |    50 |   ✅   | 00:00:00.512 |
| `test_compliance`       | `native_compliance`   |    12 |   ✅   | 00:00:00.494 |
| `test_workers`          | `native_workers`      |     3 |   ✅   | 00:00:00.572 |
| `test_concurrency`      | `native_tsan`         |     2 |   ✅   | 00:00:01.011 |
...
----------------- native:test_sse [PASSED] Took 11.31 seconds ------------------
...
---------------- native:test_session [PASSED] Took 0.42 seconds ----------------
...
--------------- native_app:test_regex [PASSED] Took 0.82 seconds ---------------
...
------------- native_app:test_template [PASSED] Took 0.43 seconds --------------
...
------------ native_app:test_path_params [PASSED] Took 0.43 seconds ------------
...
---------- native_app:test_digest_vectors [PASSED] Took 0.39 seconds -----------
...
------------ native_app:test_form_params [PASSED] Took 0.43 seconds ------------
...
--------------- native_app:test_iface [PASSED] Took 0.44 seconds ---------------
...
--------------- native_app:test_json [PASSED] Took 0.40 seconds ----------------
...
------------ native_app:test_middleware [PASSED] Took 0.43 seconds -------------
...
------------ native_app:test_digest_auth [PASSED] Took 0.44 seconds ------------
...
--------------- native_app:test_defer [PASSED] Took 0.42 seconds ---------------
...
------------ native_app:test_application [PASSED] Took 0.51 seconds ------------
...
------------ native_workers:test_workers [PASSED] Took 0.57 seconds ------------
...
----------- native_tsan:test_concurrency [PASSED] Took 1.01 seconds ------------

=================================== SUMMARY ===================================
Environment          Test                   Status    Duration
-------------------  ---------------------  --------  ------------
native               test_sse               PASSED    00:00:11.305
native               test_session           PASSED    00:00:00.420
native               test_presentation      PASSED    00:00:00.444
native               test_transport         PASSED    00:00:00.445
native               test_websocket         PASSED    00:00:00.449
native               test_http_parser       PASSED    00:00:00.418
native_ssh           test_ssh_crypto        PASSED    00:00:02.908
native_ssh           test_ssh_auth          PASSED    00:00:00.442
native_ssh           test_ssh_server        PASSED    00:00:00.531
native_ssh           test_ssh_transport     PASSED    00:00:00.714
native_ssh           test_ssh_channel       PASSED    00:00:00.413
native_ssh_hardened  test_ssh_hardening     PASSED    00:00:00.670
native_ssh_conn      test_ssh_conn          PASSED    00:00:00.924
native_app           test_regex             PASSED    00:00:00.818
native_app           test_template          PASSED    00:00:00.435
native_app           test_path_params       PASSED    00:00:00.426
native_app           test_digest_vectors    PASSED    00:00:00.389
native_app           test_form_params       PASSED    00:00:00.434
native_app           test_iface             PASSED    00:00:00.439
native_app           test_json              PASSED    00:00:00.403
native_app           test_response_headers  PASSED    00:00:00.455
native_app           test_middleware        PASSED    00:00:00.435
native_app           test_digest_auth       PASSED    00:00:00.442
native_app           test_web_terminal      PASSED    00:00:00.449
native_app           test_defer             PASSED    00:00:00.421
native_app           test_multipart         PASSED    00:00:00.480
native_app           test_auth              PASSED    00:00:00.441
native_app           test_file_serving      PASSED    00:00:00.494
native_app           test_dispatch          PASSED    00:00:00.445
native_app           test_chunked           PASSED    00:00:00.459
native_app           test_application       PASSED    00:00:00.512
native_compliance    test_compliance        PASSED    00:00:00.494
native_workers       test_workers           PASSED    00:00:00.572
native_tsan          test_concurrency       PASSED    00:00:01.011
================ 620 test cases: 620 succeeded in 00:00:30.540 ================
```
