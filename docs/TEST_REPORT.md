...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:15.942 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.582 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.632 |
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.602 |
| `test_websocket`         | `native`                |    67 |   ✅   | 00:00:00.666 |
| `test_http_parser`       | `native`                |    90 |   ✅   | 00:00:00.642 |
| `test_observability`     | `native_observability`  |    15 |   ✅   | 00:00:00.725 |
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:01.004 |
...
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.889 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.540 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:00.889 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.272 |
...
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.606 |
...
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.829 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.900 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.735 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.665 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.664 |
...
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.647 |
...
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.725 |
...
| `test_audit_log`         | `native_audit_log`      |    12 |   ✅   | 00:00:00.675 |
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.840 |
| `test_vfs`               | `native_vfs`            |    11 |   ✅   | 00:00:00.653 |
| `test_graphql`           | `native_graphql`        |    13 |   ✅   | 00:00:00.652 |
| `test_espnow`            | `native_espnow`         |     7 |   ✅   | 00:00:00.632 |
| `test_oauth2`            | `native_oauth2`         |     8 |   ✅   | 00:00:00.662 |
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.683 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.673 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.054 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.068 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.664 |
...
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.663 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.710 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.712 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.664 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.655 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.700 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.016 |
...
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.645 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.642 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.637 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.639 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.642 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.654 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.637 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     7 |   ✅   | 00:00:00.641 |
| `test_guardrails`        | `native_guardrails`     |     6 |   ✅   | 00:00:00.632 |
| `test_logbuf`            | `native_logbuf`         |     4 |   ✅   | 00:00:00.643 |
| `test_config_io`         | `native_config_io`      |     4 |   ✅   | 00:00:00.668 |
| `test_workers`           | `native_workers`        |     3 |   ✅   | 00:00:00.743 |
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.617 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.825 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.355 |
...
----------------- native:test_sse [PASSED] Took 15.94 seconds ------------------
...
-------------  -----------------  --------  ------------
native         test_sse           PASSED    00:00:15.942
native         test_session       PASSED    00:00:00.582
native         test_presentation  PASSED    00:00:00.632
native         test_transport     PASSED    00:00:00.602
native         test_websocket     PASSED    00:00:00.666
native         test_http_parser   PASSED    00:00:00.642
================ 318 test cases: 318 succeeded in 00:00:19.066 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
================= 15 test cases: 15 succeeded in 00:00:00.725 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.004
...
native_ssh     test_ssh_transport  PASSED    00:00:00.889
native_ssh     test_ssh_channel    PASSED    00:00:00.540
================= 93 test cases: 93 succeeded in 00:00:06.608 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
================= 30 test cases: 30 succeeded in 00:00:01.224 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
------------ native_snmp_v3:test_snmp_v3 [PASSED] Took 1.48 seconds ------------
...
================== 8 test cases: 8 succeeded in 00:00:00.829 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_coap    test_coap  PASSED    00:00:00.900
================= 29 test cases: 29 succeeded in 00:00:00.900 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.735
================= 29 test cases: 29 succeeded in 00:00:00.735 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_mqtt_sn  test_mqtt_sn  PASSED    00:00:00.647
...
test/test_hostlink/test_hostlink.cpp:30: test_build_dm_read: Expected '@00RD0000001057*\r' Was '@00RD0000001057*\r\xFB\x95A\xFD\x7F' [FAILED]
...
---------- native_hostlink:test_hostlink [ERRORED] Took 0.66 seconds ----------

=================================== SUMMARY ===================================
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_hostlink  test_hostlink  ERRORED   00:00:00.664

============= 8 test cases: 1 failed, 6 succeeded in 00:00:00.664 =============
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_audit_log  test_audit_log  PASSED    00:00:00.675
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.840
================= 13 test cases: 13 succeeded in 00:00:00.840 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_graphql  test_graphql  PASSED    00:00:00.652
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_opcua_client  test_opcua_client  PASSED    00:00:00.673
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_deflate  test_deflate  PASSED    00:00:00.700
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.016
================= 71 test cases: 71 succeeded in 00:00:01.016 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_telemetry  test_telemetry  PASSED    00:00:00.645
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_dashboard  test_dashboard  PASSED    00:00:00.642
================= 11 test cases: 11 succeeded in 00:00:00.642 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 117 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.642
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_msgpack  test_msgpack  PASSED    00:00:00.654
...
Environment           Test                Status    Duration
--------------------  ------------------  --------  ------------
native_udp_telemetry  test_udp_telemetry  PASSED    00:00:00.641
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_guardrails  test_guardrails  PASSED    00:00:00.632
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_logbuf  test_logbuf  PASSED    00:00:00.643
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_workers  test_workers  PASSED    00:00:00.743
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_clock   test_clock  PASSED    00:00:00.617
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.355
