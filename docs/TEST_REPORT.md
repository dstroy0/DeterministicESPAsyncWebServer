...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    11 |   ✅   | 00:00:12.745 |
| `test_j1939`             | `native_j1939`          |     9 |   ✅   | 00:00:00.760 |
| `test_devicenet`         | `native_devicenet`      |     8 |   ✅   | 00:00:00.675 |
| `test_nmea2000`          | `native_nmea2000`       |     6 |   ✅   | 00:00:00.690 |
| `test_mbus`              | `native_mbus`           |     8 |   ✅   | 00:00:00.652 |
...
| `test_transport`         | `native`                |    42 |   ✅   | 00:00:00.603 |
...
| `test_accept_gate`       | `native_accept_gate`    |    10 |   ✅   | 00:00:01.114 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.675 |
| `test_provisioning`      | `native_prov`           |     5 |   ✅   | 00:00:00.675 |
| `test_ssh_crypto`        | `native_ssh`            |    39 |   ✅   | 00:00:03.891 |
| `test_ssh_auth`          | `native_ssh`            |    12 |   ✅   | 00:00:00.601 |
| `test_ssh_server`        | `native_ssh`            |     7 |   ✅   | 00:00:00.720 |
| `test_ssh_transport`     | `native_ssh`            |    23 |   ✅   | 00:00:00.953 |
| `test_ssh_channel`       | `native_ssh`            |    12 |   ✅   | 00:00:00.548 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.047 |
| `test_ssh_conn`          | `native_ssh_conn`       |     2 |   ✅   | 00:00:01.524 |
| `test_regex`             | `native_app`            |     9 |   ✅   | 00:00:01.317 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.603 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.609 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.545 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.600 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.605 |
| `test_json`              | `native_app`            |    17 |   ✅   | 00:00:00.567 |
| `test_response_headers`  | `native_app`            |    11 |   ✅   | 00:00:00.601 |
...
| `test_chunked`           | `native_app`            |    12 |   ✅   | 00:00:00.608 |
| `test_application`       | `native_app`            |    53 |   ✅   | 00:00:00.694 |
| `test_webdav_handler`    | `native_webdav_handler` |    12 |   ✅   | 00:00:01.341 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.311 |
| `test_snmp_ber`          | `native_snmp`           |    16 |   ✅   | 00:00:00.741 |
| `test_snmp_agent`        | `native_snmp`           |    14 |   ✅   | 00:00:00.499 |
| `test_snmp_v3`           | `native_snmp_v3`        |    10 |   ✅   | 00:00:01.594 |
| `test_telnet`            | `native_telnet`         |     8 |   ✅   | 00:00:00.828 |
| `test_coap`              | `native_coap`           |    29 |   ✅   | 00:00:00.752 |
| `test_coap`              | `native_coap_observe`   |    29 |   ✅   | 00:00:00.752 |
| `test_webdav`            | `native_webdav`         |    19 |   ✅   | 00:00:00.678 |
| `test_modbus`            | `native_modbus`         |    18 |   ✅   | 00:00:00.683 |
| `test_cloudevents`       | `native_cloudevents`    |     7 |   ✅   | 00:00:00.744 |
| `test_redis_resp`        | `native_redis`          |     8 |   ✅   | 00:00:00.665 |
| `test_stomp`             | `native_stomp`          |    11 |   ✅   | 00:00:00.673 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |     8 |   ✅   | 00:00:00.672 |
| `test_flow_export`       | `native_flow_export`    |     6 |   ✅   | 00:00:00.673 |
| `test_protobuf`          | `native_protobuf`       |    10 |   ✅   | 00:00:00.667 |
| `test_wamp`              | `native_wamp`           |    12 |   ✅   | 00:00:00.689 |
| `test_sunspec`           | `native_sunspec`        |     5 |   ✅   | 00:00:00.673 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.675 |
| `test_dnp3`              | `native_dnp3`           |     7 |   ✅   | 00:00:00.671 |
...
| `test_senml`             | `native_senml`          |     6 |   ✅   | 00:00:00.744 |
| `test_df1`               | `native_df1`            |     9 |   ✅   | 00:00:00.663 |
| `test_cotp`              | `native_cotp`           |     6 |   ✅   | 00:00:00.667 |
| `test_s7comm`            | `native_s7comm`         |     8 |   ✅   | 00:00:00.661 |
| `test_melsec`            | `native_melsec`         |     6 |   ✅   | 00:00:00.665 |
| `test_bacnet`            | `native_bacnet`         |     8 |   ✅   | 00:00:00.662 |
| `test_enip`              | `native_enip`           |     6 |   ✅   | 00:00:00.677 |
| `test_amqp`              | `native_amqp`           |     7 |   ✅   | 00:00:00.670 |
| `test_cip`               | `native_cip`            |     8 |   ✅   | 00:00:00.652 |
| `test_nats`              | `native_nats`           |    10 |   ✅   | 00:00:00.673 |
...
| `test_oidc`              | `native_oidc`           |    13 |   ✅   | 00:00:00.950 |
...
| `test_opcua`             | `native_opcua`          |    29 |   ✅   | 00:00:00.696 |
| `test_opcua_client`      | `native_opcua_client`   |    11 |   ✅   | 00:00:00.701 |
| `test_keepalive`         | `native_keepalive`      |    10 |   ✅   | 00:00:01.198 |
| `test_range`             | `native_range`          |    13 |   ✅   | 00:00:01.202 |
| `test_syslog`            | `native_syslog`         |     6 |   ✅   | 00:00:00.680 |
| `test_jwt`               | `native_jwt`            |    12 |   ✅   | 00:00:00.734 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.238 |
| `test_http_client`       | `native_http_client`    |    11 |   ✅   | 00:00:00.644 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.649 |
| `test_mqtt`              | `native_mqtt`           |    19 |   ✅   | 00:00:00.680 |
| `test_ws_client`         | `native_ws_client`      |    10 |   ✅   | 00:00:00.739 |
| `test_scratch`           | `native_scratch`        |    14 |   ✅   | 00:00:00.700 |
| `test_snmp_trap`         | `native_snmp_trap`      |     3 |   ✅   | 00:00:00.683 |
| `test_inflate`           | `native_inflate`        |    12 |   ✅   | 00:00:00.643 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.716 |
| `test_websocket`         | `native_ws_deflate`     |    71 |   ✅   | 00:00:01.149 |
...
| `test_auth_lockout`      | `native_auth_lockout`   |    10 |   ✅   | 00:00:00.665 |
| `test_csrf`              | `native_csrf`           |     9 |   ✅   | 00:00:00.705 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.663 |
| `test_dashboard`         | `native_dashboard`      |    11 |   ✅   | 00:00:00.670 |
| `test_net_egress`        | `native_net_egress`     |     5 |   ✅   | 00:00:00.671 |
| `test_partition_monitor` | `native_partition`      |     5 |   ✅   | 00:00:00.669 |
| `test_cbor`              | `native_cbor`           |    14 |   ✅   | 00:00:00.688 |
| `test_msgpack`           | `native_msgpack`        |    15 |   ✅   | 00:00:00.661 |
| `test_gpio_map`          | `native_gpio_map`       |     8 |   ✅   | 00:00:00.668 |
...
| `test_clock`             | `native_clock`          |     4 |   ✅   | 00:00:00.631 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.770 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.373 |
...
----------- native_canopen:test_canopen [PASSED] Took 12.74 seconds ------------

=================================== SUMMARY ===================================
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_canopen  test_canopen  PASSED    00:00:12.745
================= 11 test cases: 11 succeeded in 00:00:12.745 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_j1939   test_j1939  PASSED    00:00:00.760
...
Environment      Test           Status    Duration
---------------  -------------  --------  ------------
native_nmea2000  test_nmea2000  PASSED    00:00:00.690
...
native         test_transport     PASSED    00:00:00.603
native         test_websocket     PASSED    00:00:00.631
native         test_http_parser   PASSED    00:00:00.642
================ 318 test cases: 318 succeeded in 00:00:04.186 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_accept_gate  test_accept_gate  PASSED    00:00:01.114
...
Environment    Test                Status    Duration
-------------  ------------------  --------  ------------
native_ssh     test_ssh_crypto     PASSED    00:00:03.891
native_ssh     test_ssh_auth       PASSED    00:00:00.601
native_ssh     test_ssh_server     PASSED    00:00:00.720
native_ssh     test_ssh_transport  PASSED    00:00:00.953
native_ssh     test_ssh_channel    PASSED    00:00:00.548
================= 93 test cases: 93 succeeded in 00:00:06.713 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment          Test                Status    Duration
-------------------  ------------------  --------  ------------
native_ssh_hardened  test_ssh_hardening  PASSED    00:00:01.047
...
native_app     test_chunked           PASSED    00:00:00.608
native_app     test_application       PASSED    00:00:00.694
================ 219 test cases: 219 succeeded in 00:00:11.658 ================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment            Test                 Status    Duration
---------------------  -------------------  --------  ------------
native_webdav_handler  test_webdav_handler  PASSED    00:00:01.341
================= 12 test cases: 12 succeeded in 00:00:01.341 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_diag    test_diag  PASSED    00:00:01.311
...
================= 30 test cases: 30 succeeded in 00:00:01.240 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_snmp_v3  test_snmp_v3  PASSED    00:00:01.594
================= 10 test cases: 10 succeeded in 00:00:01.594 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
================== 8 test cases: 8 succeeded in 00:00:00.828 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
================= 29 test cases: 29 succeeded in 00:00:00.752 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment          Test       Status    Duration
-------------------  ---------  --------  ------------
native_coap_observe  test_coap  PASSED    00:00:00.752
================= 29 test cases: 29 succeeded in 00:00:00.752 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_wamp    test_wamp  PASSED    00:00:00.689
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_amqp    test_amqp  PASSED    00:00:00.670
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_nats    test_nats  PASSED    00:00:00.673
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_oidc    test_oidc  PASSED    00:00:00.950
...
================= 29 test cases: 29 succeeded in 00:00:00.696 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_keepalive  test_keepalive  PASSED    00:00:01.198
================= 10 test cases: 10 succeeded in 00:00:01.198 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test        Status    Duration
-------------  ----------  --------  ------------
native_range   test_range  PASSED    00:00:01.202
================= 13 test cases: 13 succeeded in 00:00:01.202 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_syslog  test_syslog  PASSED    00:00:00.680
...
Environment    Test      Status    Duration
-------------  --------  --------  ------------
native_jwt     test_jwt  PASSED    00:00:00.734
...
Environment    Test         Status    Duration
-------------  -----------  --------  ------------
native_upload  test_upload  PASSED    00:00:01.238
================== 3 test cases: 3 succeeded in 00:00:01.238 ==================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment         Test              Status    Duration
------------------  ----------------  --------  ------------
native_http_client  test_http_client  PASSED    00:00:00.644
...
Environment        Test             Status    Duration
-----------------  ---------------  --------  ------------
native_compliance  test_compliance  PASSED    00:00:00.649
...
Environment       Test            Status    Duration
----------------  --------------  --------  ------------
native_ws_client  test_ws_client  PASSED    00:00:00.739
...
Environment     Test          Status    Duration
--------------  ------------  --------  ------------
native_inflate  test_inflate  PASSED    00:00:00.643
...
Environment        Test            Status    Duration
-----------------  --------------  --------  ------------
native_ws_deflate  test_websocket  PASSED    00:00:01.149
================= 71 test cases: 71 succeeded in 00:00:01.149 =================
Verbosity level can be increased via `-v, -vv, or -vvv` option
Collected 127 tests
...
Environment          Test               Status    Duration
-------------------  -----------------  --------  ------------
native_auth_lockout  test_auth_lockout  PASSED    00:00:00.665
...
Environment    Test       Status    Duration
-------------  ---------  --------  ------------
native_cbor    test_cbor  PASSED    00:00:00.688
...
Environment    Test              Status    Duration
-------------  ----------------  --------  ------------
native_tsan    test_concurrency  PASSED    00:00:01.373
================== 2 test cases: 2 succeeded in 00:00:01.373 ==================
```
