...
| --------------------------------------------------------------------------------------------------------- | ------------------------------------ | ---------------- | ---------------- |
| `ACCEPT_THROTTLE`                                                                                         | L4-Transport/AcceptThrottle          | 735.5 KB (57.5%) | 79.9 KB (25.0%)  |
| `ADS`                                                                                                     | L7-Application/AdsClient             | 735.7 KB (57.5%) | 43.2 KB (13.5%)  |
| `ADS1115`                                                                                                 | Drivers/Ads1115                      | 280.2 KB (21.9%) | 21.3 KB (6.7%)   |
| `AUDIT_LOG`                                                                                               | L7-Application/AuditLog              | 738.1 KB (57.7%) | 82.8 KB (25.9%)  |
| `AUTH_LOCKOUT`                                                                                            | L6-Presentation/AuthLockout          | 736.8 KB (57.6%) | 80.5 KB (25.1%)  |
...
| `EDGE_CACHE+HTTP_CACHE+HTTP_CLIENT+EDGE_MESH+EDGE_CACHE_SLOTS+EDGE_FETCH_SLOTS+MESH_MAX_PEERS`            | L7-Application/MeshCache             | 760.9 KB (59.4%) | 112.7 KB (35.2%) |
...
| `ETHERNET`                                                                                                | Peripherals/Ethernet                 | 774.1 KB (60.5%) | 80.0 KB (25.0%)  |
| `ETHERNET+ETH_W5500+ETH_W5500_CS+ETH_W5500_RST+ETH_W5500_INT+ETH_W5500_SCK+ETH_W5500_MISO+ETH_W5500_MOSI` | Peripherals/EthernetW5500            | 774.1 KB (60.5%) | 80.0 KB (25.0%)  |
| `EXC_DECODER+FTP+FTP_SESSION`                                                                             | L7-Application/CoreDump              | 822.2 KB (64.2%) | 81.5 KB (25.5%)  |
| `GPIB`                                                                                                    | L7-Application/Gpib                  | 708.2 KB (55.3%) | 42.6 KB (13.3%)  |
| `GPIO_MAP`                                                                                                | L7-Application/GpioMap               | 740.1 KB (57.8%) | 80.0 KB (25.0%)  |
| `GRAPHQL`                                                                                                 | L7-Application/GraphQL               | 740.5 KB (57.9%) | 84.2 KB (26.3%)  |
...
| `IKEV2`                                                                                                   | L5-Session/IKEv2                     | 710.1 KB (55.5%) | 42.9 KB (13.4%)  |
...
| `JWT`                                                                                                     | L6-Presentation/JWTAuth              | 737.9 KB (57.7%) | 81.0 KB (25.3%)  |
| `KEEPALIVE`                                                                                               | L4-Transport/KeepAlive               | 735.9 KB (57.5%) | 79.9 KB (25.0%)  |
| `LD2410`                                                                                                  | Drivers/Ld2410                       | 264.3 KB (20.7%) | 21.1 KB (6.6%)   |
| `LOGBUF`                                                                                                  | L7-Application/LogBuffer             | 737.0 KB (57.6%) | 83.0 KB (25.9%)  |
...
| `PARTITION_MONITOR`                                                                                       | L7-Application/PartitionMonitor      | 736.4 KB (57.5%) | 79.9 KB (25.0%)  |
...
| `SSH+SSH_CLIENT+SSH_CLIENT_MAX_CHANNELS+CLIENT_RX_BUF`                                                    | L5-Session/SSHReverseTunnel          | 827.1 KB (64.6%) | 108.4 KB (33.9%) |
| `STATS`                                                                                                   | L7-Application/Stats                 | 737.6 KB (57.6%) | 80.0 KB (25.0%)  |
...
| `TLS+TLS_RESUMPTION+TLS_ARENA_SIZE`                                                                       | L4-Transport/TlsResumption           | 838.9 KB (65.5%) | 103.4 KB (32.3%) |
| `TOTP`                                                                                                    | L7-Application/Totp                  | 736.9 KB (57.6%) | 79.9 KB (25.0%)  |
| `UDP_TELEMETRY`                                                                                           | L7-Application/UdpTelemetry          | 711.1 KB (55.6%) | 44.0 KB (13.7%)  |
| `UPLOAD`                                                                                                  | L7-Application/FileUpload            | 777.1 KB (60.7%) | 99.6 KB (31.1%)  |
...
| `core/CORS`                                                                                               | L7-Application/CORS                  | 735.7 KB (57.5%) | 79.9 KB (25.0%)  |
| `core/ChunkedResponse`                                                                                    | L7-Application/ChunkedResponse       | 736.3 KB (57.5%) | 79.9 KB (25.0%)  |
| `core/DigestAuth`                                                                                         | L6-Presentation/DigestAuth           | 735.7 KB (57.5%) | 79.9 KB (25.0%)  |
| `core/EthernetW5500`                                                                                      | Peripherals/EthernetW5500            | 458.6 KB (35.8%) | 71.9 KB (22.5%)  |
| `core/Expert`                                                                                             | Foundation/Expert                    | 738.5 KB (57.7%) | 79.9 KB (25.0%)  |
| `core/FileServing`                                                                                        | L7-Application/FileServing           | 776.2 KB (60.6%) | 79.9 KB (25.0%)  |
| `core/FormParams`                                                                                         | L6-Presentation/FormParams           | 736.4 KB (57.5%) | 79.9 KB (25.0%)  |
| `core/InterfaceFilter`                                                                                    | L7-Application/InterfaceFilter       | 737.3 KB (57.6%) | 79.9 KB (25.0%)  |
| `core/Json`                                                                                               | L6-Presentation/Json                 | 739.7 KB (57.8%) | 79.9 KB (25.0%)  |
| `core/MediaStreaming`                                                                                     | L7-Application/MediaStreaming        | 735.8 KB (57.5%) | 79.9 KB (25.0%)  |
| `core/Middleware`                                                                                         | L7-Application/Middleware            | 736.2 KB (57.5%) | 79.9 KB (25.0%)  |
| `core/Multipart`                                                                                          | L6-Presentation/Multipart            | 736.9 KB (57.6%) | 79.9 KB (25.0%)  |
| `core/NetEgress`                                                                                          | L7-Application/NetEgress             | 736.4 KB (57.5%) | 79.9 KB (25.0%)  |
| `core/PathParams`                                                                                         | L7-Application/PathParams            | 736.0 KB (57.5%) | 79.9 KB (25.0%)  |
| `core/RegexRoutes`                                                                                        | L7-Application/RegexRoutes           | 735.9 KB (57.5%) | 79.9 KB (25.0%)  |
| `core/ResponseHeaders`                                                                                    | L7-Application/ResponseHeaders       | 736.1 KB (57.5%) | 79.9 KB (25.0%)  |
| `core/SSHCryptoSelfTest`                                                                                  | L5-Session/SSHCryptoSelfTest         | 263.2 KB (20.6%) | 21.0 KB (6.6%)   |
| `core/ServerSentEvents`                                                                                   | L6-Presentation/ServerSentEvents     | 736.6 KB (57.5%) | 79.9 KB (25.0%)  |
| `core/Sysadmin`                                                                                           | Foundation/Sysadmin                  | 749.4 KB (58.5%) | 79.9 KB (25.0%)  |
| `core/Templating`                                                                                         | L7-Application/Templating            | 737.4 KB (57.6%) | 79.9 KB (25.0%)  |
| `core/WebSocket`                                                                                          | L6-Presentation/WebSocket            | 736.1 KB (57.5%) | 79.9 KB (25.0%)  |
