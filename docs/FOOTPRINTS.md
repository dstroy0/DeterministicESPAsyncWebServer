...
| --------------------------------------------------------------------------------------------------------- | --------------------------------------- | ---------------- | ---------------- |
| `ACCEPT_THROTTLE`                                                                                         | L4-Transport/02.AcceptThrottle          | 734.4 KB (57.4%) | 79.9 KB (25.0%)  |
| `ADS`                                                                                                     | L7-Application/73.AdsClient             | 753.8 KB (58.9%) | 44.4 KB (13.9%)  |
| `ADS1115`                                                                                                 | L7-Application/66.Ads1115               | 280.1 KB (21.9%) | 21.3 KB (6.7%)   |
| `AUDIT_LOG`                                                                                               | L7-Application/49.AuditLog              | 736.8 KB (57.6%) | 82.8 KB (25.9%)  |
| `AUTH_LOCKOUT`                                                                                            | L6-Presentation/12.AuthLockout          | 735.6 KB (57.5%) | 80.4 KB (25.1%)  |
| `BUS_CAPTURE+FORWARD+ETHERNET`                                                                            | Foundation/22.CanCapture                | 753.1 KB (58.8%) | 44.4 KB (13.9%)  |
| `CBOR`                                                                                                    | L6-Presentation/13.Cbor                 | 736.9 KB (57.6%) | 79.9 KB (25.0%)  |
| `COAP`                                                                                                    | L7-Application/13.CoAP                  | 740.1 KB (57.8%) | 82.3 KB (25.7%)  |
...
| `DNS_RESOLVER`                                                                                            | L7-Application/48.DnsResolver           | 740.4 KB (57.8%) | 81.1 KB (25.3%)  |
...
| `PER_IP_THROTTLE`                                                                                         | L4-Transport/05.PerIpThrottle           | 734.9 KB (57.4%) | 80.3 KB (25.1%)  |
...
| `SSH`                                                                                                     | L5-Session/03.SSHHostKey                | 802.9 KB (62.7%) | 105.7 KB (33.0%) |
...
| `SYSLOG`                                                                                                  | L7-Application/19.Syslog                | 737.9 KB (57.6%) | 81.7 KB (25.5%)  |
| `TELEMETRY`                                                                                               | L7-Application/34.Telemetry             | 743.2 KB (58.1%) | 80.2 KB (25.1%)  |
| `TELNET`                                                                                                  | L5-Session/04.Telnet                    | 736.8 KB (57.6%) | 80.4 KB (25.1%)  |
...
| `TLS+TLS_ARENA_SIZE`                                                                                      | L6-Presentation/07.SecureWebSocket      | 836.3 KB (65.3%) | 103.2 KB (32.2%) |
...
| `VFS`                                                                                                     | L7-Application/51.Vfs                   | 777.1 KB (60.7%) | 84.3 KB (26.3%)  |
| `WEBDAV`                                                                                                  | L7-Application/29.WebDav                | 801.8 KB (62.6%) | 102.9 KB (32.2%) |
| `WEBDAV+WEBDAV_MAX_ENTRIES+WEBDAV_BUF_SIZE`                                                               | L7-Application/29.WebDav                | 802.1 KB (62.7%) | 88.7 KB (27.7%)  |
| `WEB_TERMINAL`                                                                                            | L6-Presentation/10.WebTerminal          | 739.2 KB (57.8%) | 79.9 KB (25.0%)  |
...
| `WS_DEFLATE`                                                                                              | L6-Presentation/11.WebSocketCompression | 739.2 KB (57.7%) | 87.9 KB (27.5%)  |
...
| `core/01.Basic`                                                                                           | Foundation/01.Basic                     | 736.6 KB (57.5%) | 79.9 KB (25.0%)  |
| `core/01.ChunkedResponse`                                                                                 | L7-Application/01.ChunkedResponse       | 735.3 KB (57.4%) | 79.9 KB (25.0%)  |
| `core/01.FormParams`                                                                                      | L6-Presentation/01.FormParams           | 735.4 KB (57.5%) | 79.9 KB (25.0%)  |
| `core/02.Advanced`                                                                                        | Foundation/02.Advanced                  | 743.1 KB (58.1%) | 80.0 KB (25.0%)  |
| `core/02.CORS`                                                                                            | L7-Application/02.CORS                  | 734.6 KB (57.4%) | 79.9 KB (25.0%)  |
...
| `core/05.PathParams`                                                                                      | L7-Application/05.PathParams            | 735.0 KB (57.4%) | 79.9 KB (25.0%)  |
| `core/06.RegexRoutes`                                                                                     | L7-Application/06.RegexRoutes           | 734.9 KB (57.4%) | 79.9 KB (25.0%)  |
| `core/07.ResponseHeaders`                                                                                 | L7-Application/07.ResponseHeaders       | 735.1 KB (57.4%) | 79.9 KB (25.0%)  |
| `core/08.ServerSentEvents`                                                                                | L6-Presentation/08.ServerSentEvents     | 735.2 KB (57.4%) | 79.9 KB (25.0%)  |
| `core/08.Templating`                                                                                      | L7-Application/08.Templating            | 736.3 KB (57.5%) | 79.9 KB (25.0%)  |
| `core/09.WebSocket`                                                                                       | L6-Presentation/09.WebSocket            | 735.0 KB (57.4%) | 79.9 KB (25.0%)  |
| `core/10.FileServing`                                                                                     | L7-Application/10.FileServing           | 775.0 KB (60.5%) | 79.9 KB (25.0%)  |
| `core/23.EthernetW5500`                                                                                   | Foundation/23.EthernetW5500             | 458.6 KB (35.8%) | 71.9 KB (22.5%)  |
| `core/36.NetEgress`                                                                                       | L7-Application/36.NetEgress             | 735.3 KB (57.4%) | 79.9 KB (25.0%)  |
| `core/71.MediaStreaming`                                                                                  | L7-Application/71.MediaStreaming        | 734.5 KB (57.4%) | 79.9 KB (25.0%)  |
