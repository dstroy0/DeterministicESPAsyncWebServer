...
| ---------------------------------------- | --------------------------------------- | ---------------- | ---------------- |
| `ACCEPT_THROTTLE`                        | L4-Transport/02.AcceptThrottle          | 733.1 KB (57.3%) | 64.4 KB (20.1%)  |
...
| `AUTH_LOCKOUT`                           | L6-Presentation/12.AuthLockout          | 734.3 KB (57.4%) | 65.0 KB (20.3%)  |
| `BUS_CAPTURE+FORWARD+ETHERNET`           | Foundation/22.CanCapture                | 753.1 KB (58.8%) | 44.4 KB (13.9%)  |
| `CBOR`                                   | L6-Presentation/13.Cbor                 | 735.5 KB (57.5%) | 64.5 KB (20.2%)  |
| `COAP`                                   | L7-Application/13.CoAP                  | 738.8 KB (57.7%) | 66.9 KB (20.9%)  |
...
| `DIAG`                                   | L7-Application/20.Diagnostics           | 733.5 KB (57.3%) | 64.4 KB (20.1%)  |
...
| `ETAG`                                   | L7-Application/09.ETag                  | 807.6 KB (63.1%) | 65.7 KB (20.5%)  |
| `ETHERNET`                               | Foundation/19.Ethernet                  | 771.0 KB (60.2%) | 64.5 KB (20.2%)  |
...
| `IPV6`                                   | Foundation/20.IPv6                      | 735.7 KB (57.5%) | 64.4 KB (20.1%)  |
| `IP_ALLOWLIST`                           | L4-Transport/07.IpAllowlist             | 734.6 KB (57.4%) | 64.4 KB (20.1%)  |
...
| `MSGPACK`                                | L6-Presentation/14.MsgPack              | 736.8 KB (57.6%) | 64.5 KB (20.2%)  |
...
| `PER_IP_THROTTLE`                        | L4-Transport/05.PerIpThrottle           | 733.6 KB (57.3%) | 64.9 KB (20.3%)  |
...
| `TLS`                                    | L6-Presentation/07.SecureWebSocket      | 834.9 KB (65.2%) | 114.2 KB (35.7%) |
| `TLS+MTLS`                               | L4-Transport/04.mTLS                    | 835.9 KB (65.3%) | 114.5 KB (35.8%) |
| `TLS+TLS_RESUMPTION`                     | L4-Transport/06.TlsResumption           | 835.8 KB (65.3%) | 114.3 KB (35.7%) |
...
| `core/01.FormParams`                     | L6-Presentation/01.FormParams           | 734.1 KB (57.4%) | 64.4 KB (20.1%)  |
| `core/02.Advanced`                       | Foundation/02.Advanced                  | 741.8 KB (58.0%) | 64.5 KB (20.2%)  |
| `core/02.CORS`                           | L7-Application/02.CORS                  | 733.3 KB (57.3%) | 64.4 KB (20.1%)  |
| `core/02.Json`                           | L6-Presentation/02.Json                 | 737.3 KB (57.6%) | 64.4 KB (20.1%)  |
| `core/02.SSHCryptoSelfTest`              | L5-Session/02.SSHCryptoSelfTest         | 263.2 KB (20.6%) | 21.0 KB (6.6%)   |
| `core/03.Expert`                         | Foundation/03.Expert                    | 736.0 KB (57.5%) | 64.5 KB (20.1%)  |
| `core/03.InterfaceFilter`                | L7-Application/03.InterfaceFilter       | 734.9 KB (57.4%) | 64.4 KB (20.1%)  |
| `core/03.Multipart`                      | L6-Presentation/03.Multipart            | 734.4 KB (57.4%) | 64.4 KB (20.1%)  |
...
| `core/08.ServerSentEvents`               | L6-Presentation/08.ServerSentEvents     | 733.9 KB (57.3%) | 64.4 KB (20.1%)  |
| `core/08.Templating`                     | L7-Application/08.Templating            | 735.0 KB (57.4%) | 64.5 KB (20.1%)  |
| `core/09.WebSocket`                      | L6-Presentation/09.WebSocket            | 733.7 KB (57.3%) | 64.4 KB (20.1%)  |
| `core/10.FileServing`                    | L7-Application/10.FileServing           | 773.7 KB (60.4%) | 64.5 KB (20.1%)  |
