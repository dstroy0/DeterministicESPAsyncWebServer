...
| `CBOR`                                                                                                    | L6-Presentation/13.Cbor                 | 736.8 KB (57.6%) | 79.9 KB (25.0%)  |
...
| `CSRF`                                                                                                    | L7-Application/33.Csrf                  | 735.9 KB (57.5%) | 79.9 KB (25.0%)  |
| `DASHBOARD`                                                                                               | L7-Application/35.Dashboard             | 754.8 KB (59.0%) | 80.2 KB (25.1%)  |
| `DEVICE_ID`                                                                                               | L7-Application/32.DeviceUuid            | 734.9 KB (57.4%) | 79.9 KB (25.0%)  |
...
| `HTTP_CLIENT+WEBHOOK`                                                                                     | L7-Application/46.Webhook               | 744.8 KB (58.2%) | 99.1 KB (31.0%)  |
| `INA219`                                                                                                  | L7-Application/67.Ina219                | 280.3 KB (21.9%) | 21.3 KB (6.7%)   |
| `IPV6`                                                                                                    | Foundation/20.IPv6                      | 736.9 KB (57.6%) | 79.9 KB (25.0%)  |
| `IP_ALLOWLIST`                                                                                            | L4-Transport/07.IpAllowlist             | 735.8 KB (57.5%) | 79.9 KB (25.0%)  |
| `JWT`                                                                                                     | L6-Presentation/06.JWTAuth              | 736.6 KB (57.5%) | 81.0 KB (25.3%)  |
...
| `MODBUS`                                                                                                  | L7-Application/30.ModbusTcp             | 736.2 KB (57.5%) | 80.1 KB (25.0%)  |
...
| `NTP`                                                                                                     | L7-Application/18.SNTP                  | 759.6 KB (59.3%) | 82.3 KB (25.7%)  |
| `NTP+TIME_SOURCE`                                                                                         | L7-Application/31.TimeSourceFallback    | 755.2 KB (59.0%) | 81.4 KB (25.4%)  |
...
| `OPCUA`                                                                                                   | L7-Application/55.OpcUa                 | 742.3 KB (58.0%) | 89.9 KB (28.1%)  |
| `OPCUA+OPCUA_CLIENT`                                                                                      | L7-Application/56.OpcUaClient           | 764.7 KB (59.7%) | 93.7 KB (29.3%)  |
...
| `PARTITION_MONITOR`                                                                                       | L7-Application/37.PartitionMonitor      | 735.2 KB (57.4%) | 79.9 KB (25.0%)  |
...
| `RANGE`                                                                                                   | L7-Application/12.Range                 | 776.1 KB (60.6%) | 79.9 KB (25.0%)  |
...
| `SNMP`                                                                                                    | L7-Application/14.SNMP                  | 743.1 KB (58.1%) | 92.0 KB (28.7%)  |
| `SNMP+SNMP_TRAP`                                                                                          | L7-Application/26.SnmpTrap              | 711.3 KB (55.6%) | 43.9 KB (13.7%)  |
| `SSH`                                                                                                     | L5-Session/03.SSHHostKey                | 802.8 KB (62.7%) | 105.7 KB (33.0%) |
...
| `UPLOAD`                                                                                                  | L7-Application/11.FileUpload            | 776.0 KB (60.6%) | 89.0 KB (27.8%)  |
...
| `WS_DEFLATE`                                                                                              | L6-Presentation/11.WebSocketCompression | 739.1 KB (57.7%) | 87.9 KB (27.5%)  |
...
| `core/01.FormParams`                                                                                      | L6-Presentation/01.FormParams           | 735.3 KB (57.4%) | 79.9 KB (25.0%)  |
| `core/02.Advanced`                                                                                        | Foundation/02.Advanced                  | 743.0 KB (58.0%) | 80.0 KB (25.0%)  |
| `core/02.CORS`                                                                                            | L7-Application/02.CORS                  | 734.5 KB (57.4%) | 79.9 KB (25.0%)  |
| `core/02.Json`                                                                                            | L6-Presentation/02.Json                 | 738.5 KB (57.7%) | 79.9 KB (25.0%)  |
...
| `core/03.InterfaceFilter`                                                                                 | L7-Application/03.InterfaceFilter       | 736.1 KB (57.5%) | 79.9 KB (25.0%)  |
| `core/03.Multipart`                                                                                       | L6-Presentation/03.Multipart            | 735.6 KB (57.5%) | 79.9 KB (25.0%)  |
...
| `core/05.PathParams`                                                                                      | L7-Application/05.PathParams            | 734.9 KB (57.4%) | 79.9 KB (25.0%)  |
| `core/06.RegexRoutes`                                                                                     | L7-Application/06.RegexRoutes           | 734.8 KB (57.4%) | 79.9 KB (25.0%)  |
