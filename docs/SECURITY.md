...
- [src/crypto/bignum.h](@ref bignum.h) / [.cpp](@ref bignum.cpp) - 2048-bit Montgomery arithmetic (shared library primitive)
- [src/crypto/sha256.h](@ref sha256.h) / [.cpp](@ref sha256.cpp) - SHA-256 (shared library primitive)
- [src/crypto/hmac_sha256.h](@ref hmac_sha256.h) / [.cpp](@ref hmac_sha256.cpp) - HMAC-SHA2-256 (shared library primitive)
- [src/crypto/aes256ctr.h](@ref aes256ctr.h) / [.cpp](@ref aes256ctr.cpp) - AES-256-CTR (shared library primitive)
- [src/network_drivers/presentation/ssh/transport/ssh_dh.h](@ref ssh_dh.h) / [.cpp](@ref ssh_dh.cpp) - DH-group14-SHA256 KEX
- [src/crypto/rsa.h](@ref rsa.h) / [.cpp](@ref rsa.cpp) - RSA-2048 PKCS#1 v1.5 verify + software sign (shared primitive)
...
| RSA sign bignum temporaries (n/d/m/s)         | Before [`dws_rsa_sign_sw()`](@ref dws_rsa_sign_sw) returns       | `crypto/rsa.cpp` |
...
| DER private key stack copy                    | After `mbedtls_pk_parse_key()` in `dws_ssh_rsa_load_pubkey()`    | `ssh_rsa.cpp`    |
