...
- update CHANGELOG.md [skip ci] ([`2f9fb69`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/2f9fb694a452b76784b9120dc195b4998c14c3bf))

### Changes

- Bump version: 7.137.0 → 7.138.0 ([`36de313`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/36de31312af2c3ae10e76b3d7c7763b12322f9ed))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`f2784f7`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/f2784f7d8d197915bf3054f5b8be877feee8e2dd))

### Features

- device_clear + device_trigger DEVICE_CORE calls ([`aa42729`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/aa427294e42e3522a66bac9ec6e19a594e49b05c))
...
- update CHANGELOG.md [skip ci] ([`b8bc9d7`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/b8bc9d7b3536baf645808f67deeb70663afeb5cc))

### Changes

- Bump version: 7.136.0 → 7.137.0 ([`31334f4`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/31334f4e4b179920859c8c065973786bf352cc09))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`f1c7ebc`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/f1c7ebc231d5e42307994c15f0ae747f4ce0d2cd))

### Features

- UNREGISTER message builder ([`26bc672`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/26bc6722aa5d2d95efe4237467dd12ad63d77c5e))
...
- update CHANGELOG.md [skip ci] ([`4343600`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4343600d164b55498f58125e01ce488e2fd5c3fb))

### Changes

- Bump version: 7.135.0 → 7.136.0 ([`739372e`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/739372eed4ea62197ac81c4605cbfcf5d8654ba2))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`a715785`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/a71578550e8be8e8ef36e099880fe629dc1146e6))

### Features

- VLW (distance through water) sentence decoder ([`74ab8a9`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/74ab8a9d7a7cc32ffe040454462bd2dfcafacd2f))
...
- update CHANGELOG.md [skip ci] ([`941056d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/941056d14464077cccb3277a8ef40492d0e452a5))

### Changes

- Bump version: 7.134.0 → 7.135.0 ([`69c52b1`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/69c52b110d451a4de03036df98a8b7199702f6a9))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`8a87871`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/8a87871deb26cf9fd3140008b2e9c7ef1a9677c6))

### Features

- content HEADER frame builder ([`2b85e95`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/2b85e95737bd9108740e87e06052bae26b88344c))
...
- update CHANGELOG.md [skip ci] ([`ec11baf`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/ec11baf6cdcd4eef3b0bcdb9998ac498a2c2ab66))

### Changes

- Bump version: 7.128.0 → 7.129.0 ([`5fec547`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/5fec5474be869f596c40fce5370522fd2aac217a))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`5ed980c`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/5ed980c30f909ca158f2c6d6674cb13c79ad4e0e))

### Features

- Get_Attributes_All request builder (service 0x01) ([`68631f5`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/68631f55a38b683438d2f61246b384000818aabc))
...
- update CHANGELOG.md [skip ci] ([`13f2118`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/13f2118abf58719437b50f1433b211bb6ac63315))

### Changes

- Bump version: 7.127.0 → 7.128.0 ([`d782b57`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/d782b57e5485cedd750769a1f8a560d835a1ba7c))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`e519d21`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/e519d2113ff6c5ae23baeaeb4684abc75aa251dc))

### Features

- Write Var request builder (function 0x05) ([`66ed561`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/66ed561eb13e642c6e37246e290afc1bbd113e0b))
...
- update CHANGELOG.md [skip ci] ([`de20424`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/de2042410ce1c2617f1ca5cd7aa41a14fe0d4a35))

### Changes

- Bump version: 7.126.0 → 7.127.0 ([`72ca8ac`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/72ca8acbc298c77e4fa6a9f844c86473223ffe22))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`08ca1c5`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/08ca1c59589ddf1b7f3097d475cfb2e51178d131))

### Features

- RDM DISC_UNIQUE_BRANCH discovery response builder ([`ab536e1`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/ab536e1de660564251891e0cea683e4cc020ed6e))
...
- update CHANGELOG.md [skip ci] ([`b9a7dea`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/b9a7deab22b1bdd7bc1bed1816ca1b9fce2dbbc0))

### Changes

- Bump version: 7.125.0 → 7.126.0 ([`8eabb5e`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/8eabb5ec5f3e2035c40d7ea4ae52a30a4a294c6a))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`fcd6c75`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/fcd6c7518a0cea070904e6cc72468406a085ecc5))

### Features

- object-header builders (start-stop range + all-objects) ([`cfd5b0d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/cfd5b0d5d4c0495844de79a26d131a0d99c4ed88))
...
- update CHANGELOG.md [skip ci] ([`f1f0fc0`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/f1f0fc057af12520b7750b0bd16ec31d9c489ca4))

### Changes

- Bump version: 7.124.0 → 7.125.0 ([`d7233f0`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/d7233f0b7da4c14a41280d64d29ba88011b5cf8b))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`2d10930`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/2d10930c380c177ba942c6f52be52a1311c0f7db))

### Features

- scaled measured value (M_ME_NB_1) information object ([`975f429`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/975f42979d2bb5f0819a371d3dfa5f6b4e319934))
...
- update CHANGELOG.md [skip ci] ([`cdaaa6a`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/cdaaa6a00b12fc0feb256437c45f4e6d4eef1803))

### Changes

- Bump version: 7.123.0 → 7.124.0 ([`10bc474`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/10bc4748630398acff3a9745def525e3be059f61))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`769ef54`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/769ef54d3836328f2189c662d71e3087e28c0e1c))

### Features

- REQ_UD1 (class-1 / alarm data) request builder ([`327985a`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/327985ae4e4ddc53b61785a3550f090ada0871c6))
...
- update CHANGELOG.md [skip ci] ([`cb5dc35`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/cb5dc35d95dc8ea16dc927cb4e5d1ab73c189bd8))

### Changes

- Bump version: 7.122.0 → 7.123.0 ([`621d7e6`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/621d7e6cc5dbfbf525d6d4014413be31ddceaffd))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`969df78`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/969df785678add21dc0b306cbdffe1e7a1b617a2))

### Features

- continuous-measurement (aR) + verification (aV) commands ([`6e768f7`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/6e768f778c04afc0d2dec326e4eaffcd2cd11133))
...
- update CHANGELOG.md [skip ci] ([`538fb5b`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/538fb5ba2bf5dcfcc060f42dd129c1ced4333e63))

### Changes

- Bump version: 7.120.0 → 7.121.0 ([`a0de27d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/a0de27d83d70e930653729967a9317b5ca84d11a))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`3b8af46`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/3b8af46530557170e6851ea6a298002b3e15b512))

### Features

- RUN (0401) / STOP (0402) operating-mode commands ([`06441ca`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/06441ca909b15c3d7e6944b25a9a5bb74f62cd7e))
...
- update CHANGELOG.md [skip ci] ([`c2773ea`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/c2773ea05b144e673cab4b2f957c32d7c88bc57b))

### Changes

- Bump version: 7.117.0 → 7.118.0 ([`2233d1f`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/2233d1f70bb023e30cdc00106e1e91ed0f3908ba))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`569c357`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/569c357105af09529d003cfe71f0d61917d1e839))

### Features

- headers support (HPUB build + HMSG parse) ([`9eca18f`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/9eca18f44048cd2acf30f3d8586eddd886aa4221))
...
- update CHANGELOG.md [skip ci] ([`9f55d56`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/9f55d5683a4a868670e338df50ab7231ca1f5640))

### Changes

- Bump version: 7.115.0 → 7.116.0 ([`7830fde`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/7830fdec0b6b37cdd9de287820508d0ea4c27e1a))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`3f5e97c`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/3f5e97c4a0279e8c7982508dc1d525900e329b27))

### Features

- decode payloads + metrics (subscriber side) ([`0d701ec`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/0d701ec1efa282ea0513a26d16895aafebb0023a))
...
- update CHANGELOG.md [skip ci] ([`35a156a`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/35a156a10ed0e85bcd513d500968d80a265e973a))

### Changes

- Bump version: 7.113.0 → 7.114.0 ([`9323212`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/9323212dba4b81c059a01aa58ed8064d21499ae2))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`e113c81`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/e113c81dd37fbf5d13c207f43d71e6b066f555f5))

### Features

- parse the identify (aI!) response ([`380975c`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/380975ca19ee8b2d6596aa0c5a66629acce25b59))
...
- update CHANGELOG.md [skip ci] ([`27b1c90`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/27b1c90eda681c1dd9bc73ef767c9618af65e8b6))

### Changes

- Bump version: 7.112.0 → 7.113.0 ([`b4e97ea`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/b4e97eadcb609be8ee7b6f0781b9af4918e19b5d))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`08e1fec`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/08e1fec05774211d319b89e3a1dbc4dc36f9aff0))

### Features

- decode HDG heading/deviation/variation sentence ([`a6eeb8a`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/a6eeb8a12dc2fb2fb06baf3e2feaa88740bfdf7b))
...
- update CHANGELOG.md [skip ci] ([`1347172`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/1347172f650a211abea45843efc8dbc214a7a069))

### Changes

- Bump version: 7.110.0 → 7.111.0 ([`30e56ef`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/30e56efba75a5eca0af80b271046f575ccb7024a))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`4a8f932`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4a8f932f06b1b3a8be9d8c9a2d19a0097e0bfc05))

### Features

- decode Engine Parameters Dynamic (PGN 127489) ([`ae820ab`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/ae820ab892d85fee2bb69e4ef3c2e0b7b7479aad))
...
- update CHANGELOG.md [skip ci] ([`2fb9f26`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/2fb9f269d2525fe0b5e1396e6ab2bedd3b0d7475))

### Changes

- Bump version: 7.109.0 → 7.110.0 ([`34ce564`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/34ce564b014816660855d717c28c0db04df3fa97))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`2ba1a5b`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/2ba1a5b7f7609dfae14f4dbece500e317ae04340))

### Features

- decode DM1 active diagnostic trouble codes (PGN 65226) ([`f8d1102`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/f8d1102d20a304dee7bbb2b252d20486fcb7a585))
...
- update CHANGELOG.md [skip ci] ([`07bcdc6`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/07bcdc6899e606f789f90dc2f7d6b124edb98654))

### Changes

- Bump version: 7.108.0 → 7.109.0 ([`3e7c47b`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/3e7c47b9cf62db4c755754d22ea4ca598c2253ab))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`ab657ca`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/ab657ca2a4fd37d95aeeaa7e843358c0e1b34176))

### Features

- decode Rudder (PGN 127245) ([`27a9d06`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/27a9d06a5a8d249a2997bcb0c6ed1707999a7f91))
...
- update CHANGELOG.md [skip ci] ([`5666072`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/56660729657ed9dea41a3bf070c323a1b123dc6b))

### Changes

- Bump version: 7.107.0 → 7.108.0 ([`c051bb6`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/c051bb6a8fcea8a06e6d4e20d3f3faf7a32f681b))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`57fe6c5`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/57fe6c53f83a9329816a5e7aee6242d5b156d28b))

### Features

- build the UnRegisterSession request ([`c581d2e`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/c581d2e5e01e7ae24be808d9ad6dbc111073618e))
...
- update CHANGELOG.md [skip ci] ([`30a848d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/30a848d8d0bf2f396a5ac3d07b171dbb0b8b9bda))

### Changes

- Bump version: 7.105.0 → 7.106.0 ([`4942d5d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4942d5d619e441b73b01ef33b8e4811b4209baa5))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`6336ddf`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/6336ddfcfa2cb85c25048f1eb1e7e7f7d314fa1c))

### Features

- decode the APDU header (application layer) ([`622d0de`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/622d0dee8b50e3d1dd4ec40f9a17f97891e8d241))
...
- update CHANGELOG.md [skip ci] ([`e15fb87`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/e15fb8761035a2e726583ae289fd525e2d11a069))

### Changes

- Bump version: 7.101.0 → 7.102.0 ([`f7dfbcd`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/f7dfbcd858daa0fb9ad4b56cd5e24cc24d5ca5bf))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`e0d0ed5`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/e0d0ed5d0500b8bdecbea3a0ce9db67c9560f3ae))
...
- update CHANGELOG.md [skip ci] ([`e73207a`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/e73207ad6ab3a3440a0739482ad766b48fce9a25))

### Changes

- Bump version: 7.100.0 → 7.101.0 ([`dab39b3`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/dab39b3a7772f8e6d5636ab0c4a8d79a300692fd))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`707462f`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/707462fb0b96af4174e44cf4a3a4ef4129921a2c))

### Features

- decode IC1 inlet/exhaust conditions (PGN 65270) ([`59a1420`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/59a142023209a0e1b524de5aace2bbea2165d9d8))
...
- update CHANGELOG.md [skip ci] ([`79126c6`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/79126c60f02c0f86406908b5f937408d39ad6a17))

### Changes

- Bump version: 7.98.0 → 7.99.0 ([`4c25050`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4c25050481c409f09159b26c1bfdbb1a687c9877))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`c70c6b1`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/c70c6b1478ab88514df00214d884fb7aff78b597))

### Features

- decode the object header (group/variation/qualifier/range) ([`69c0fca`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/69c0fcadbc9a7749af4ff35ad94f672579ef646c))
...
- update CHANGELOG.md [skip ci] ([`70636d0`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/70636d0bfcb5bb2372b403fe505aa3fe08ff1a28))

### Changes

- Bump version: 7.97.0 → 7.98.0 ([`905f575`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/905f575aa4798bd4cbe9d69bd91e18b64adce07b))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`6c4c572`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/6c4c572c8de517135ba7723e8e4997e5c3e6405c))

### Features

- build Set_Attribute_Single request (service 0x10) ([`4d2765c`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4d2765cebc3fea7ca29188e1413e02a995c1b29c))
...
- update CHANGELOG.md [skip ci] ([`94115fc`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/94115fcb23635bdc06b739a463be105b52688e54))

### Changes

- Bump version: 7.96.0 → 7.97.0 ([`c071ad3`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/c071ad3873c46a8489577b8cfa72b0ed7f86d4d2))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`7166e12`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/7166e12aa099a1ec26090f1132c1dc38c0500882))

### Features

- build the batch-write request (command 0x1401) ([`36f0c9b`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/36f0c9ba108ac712550bce61686fe1c0e344b77a))
...
- update CHANGELOG.md [skip ci] ([`546bc2f`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/546bc2faa0b3f3b8169a95427082fbf39cd7e9ec))

### Changes

- Bump version: 7.93.0 → 7.94.0 ([`9ef7a56`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/9ef7a564e503a9831cee74ff5055b600b109f4bc))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`c89392d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/c89392d2c451a5fdee4bee0d2296dd3acec836a1))

### Features

- add the GOOSE subscriber (frame parser) ([`34eb593`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/34eb5938150da45960d729c47d365c530baf76b5))
...
- update CHANGELOG.md [skip ci] ([`070ca83`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/070ca83976f090096c483a53512c0a1ddcb6dfc8))

### Changes

- Bump version: 7.92.0 → 7.93.0 ([`7ff6b72`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/7ff6b7285abf3686c77849e62756261a7bda8b48))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`d578af4`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/d578af448e4cb6a6e3488ec16a2f42c29b210500))

### Features

- decode the data-frame STAT word (Table 6) ([`0e38b36`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/0e38b368b83140b39f3e9bec22456c09c94c9d2b))
...
- update CHANGELOG.md [skip ci] ([`59fd273`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/59fd27356a6c0f00dceed8de45175faac8441fac))

### Changes

- Bump version: 7.91.0 → 7.92.0 ([`dc30b76`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/dc30b76f1c38266366500834857f6b9ce9a646cc))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`e25dd1d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/e25dd1de7e4ec286a5bdb3781139a48b5f2670ba))

### Features

- decode Attitude (PGN 127257) ([`52f6a33`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/52f6a339d3be10fa6974b04606a67615084b24d3))
...
- update CHANGELOG.md [skip ci] ([`31815f6`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/31815f60fb04e096e139a2fba0dc15f726cfe49a))

### Changes

- Bump version: 7.90.0 → 7.91.0 ([`b66f654`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/b66f65439f3b4e43de5daca259a738a34008da0b))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`8d064e0`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/8d064e0654f8eef9ee524571b876419e83411e7e))

### Features

- decode Temperature (PGN 130312) ([`824b5d7`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/824b5d771c3c570a02665354ed918ebf76adfbbc))
...
- update CHANGELOG.md [skip ci] ([`58b610b`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/58b610b3ae4a9805793010fc094b5c8234b0b87a))

### Changes

- Bump version: 7.89.0 → 7.90.0 ([`347eece`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/347eece2a35aaadfacc4bf3959ed382a8c515baa))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`b49e95e`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/b49e95e5dafd04dfa13e0b3b3980efee2b7b1bf4))

### Features

- decode GSA DOP + active-satellites sentence ([`c580fa2`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/c580fa2ae82b8e02664d4ba23693a5d8595daa2c))
...
- update CHANGELOG.md [skip ci] ([`68f9f63`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/68f9f63ecd22042b24610dd29bf5a0cd888efba9))

### Changes

- Bump version: 7.88.0 → 7.89.0 ([`bb7d803`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/bb7d803b35f2ce396cabda971f0a1e909e099745))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`d287c3c`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/d287c3c50c15fc1a437a1adb1a605526c59f94a6))

### Features

- decode VTG track + ground speed sentence ([`e7ca178`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/e7ca178404041b8f81bfbe9de0de71a1634de5e6))
...
- update CHANGELOG.md [skip ci] ([`6d29b75`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/6d29b75a951336cb9dc240d4a2e43e65fe911db3))

### Changes

- Bump version: 7.87.0 → 7.88.0 ([`3a949d7`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/3a949d7896a2f932f81c4d30cc4e913e4bdc76ff))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`16223d6`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/16223d608e37f2b29390b083828feae398d937ba))

### Features

- decode the variable-data-structure fixed header ([`05e02d2`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/05e02d2e980030b3613a9ff12974008a61847e8e))
...
- update CHANGELOG.md [skip ci] ([`19b7637`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/19b76377e4f31e011f7e29f4f19bb7f198639867))

### Changes

- Bump version: 7.84.0 → 7.85.0 ([`ef6e538`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/ef6e53807fd36476b202d96e0298f5b8c8fad67a))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`88fd475`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/88fd4757c4f30d594f157814f1917b06789625e9))

### Features

- build + decode the TIME message (CiA 301 7.2.6) ([`faf149d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/faf149d2fcb77e54289b678d065b413832595467))
...
- update CHANGELOG.md [skip ci] ([`d8369cd`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/d8369cd41789eb5e889b99f21d5b770255fd07dd))

### Changes

- Bump version: 7.83.0 → 7.84.0 ([`737ffea`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/737ffeab3bb9d6d465dc574163fa615d44828d8f))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`6206494`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/620649413690efd80e498bfc229d0d67b2fa85a2))

### Features

- decode Engine Parameters Rapid Update (PGN 127488) ([`53c08e9`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/53c08e9b5284b51d48d752b348cf89b5f01a8447))
...
- update CHANGELOG.md [skip ci] ([`c50c5aa`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/c50c5aacc3a20e6e1aaa211ba26ed20ec6322f8c))

### Changes

- Bump version: 7.81.0 → 7.82.0 ([`c68ab31`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/c68ab3110e7a77a3b57105cde90432ef87588308))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`0210382`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/0210382d87ca537505aa41844ab687542576925f))

### Features

- decode ZDA time & date sentence ([`02ef8f5`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/02ef8f56f8fb45f02a40fc6f914e5d643a61424b))
...
- update CHANGELOG.md [skip ci] ([`c4a7817`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/c4a7817c7198ded3c22c2321ce750f2a8608f999))

### Changes

- Bump version: 7.79.0 → 7.80.0 ([`d207bb1`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/d207bb15bfe54d62b45be10071768918cb834d29))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`a404f1d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/a404f1d54a295b62c45381aaa7d0541d1cae92fc))

### Features

- decode UBX-NAV-TIMEUTC validated UTC time solution ([`68c0bed`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/68c0bed595b3412dc99eea072edf0a6d5f44bf67))
...
- update CHANGELOG.md [skip ci] ([`0760190`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/0760190faf88f2cd877ab7067f423cccaeb24f3c))

### Changes

- Bump version: 7.77.0 → 7.78.0 ([`06cd08b`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/06cd08bbdeb41c4a044e2d94a57b5cf0b9891377))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`97ffcd0`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/97ffcd0bc1b4282f6ea2af1af12dddc0b2eca1c1))

### Features

- pack resolution (RFC 8428 s4.6) ([`d78a03c`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/d78a03c77d9252893d35571cc3c9fa387508b89f))
...
- update CHANGELOG.md [skip ci] ([`cc43b3f`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/cc43b3f9002bfef07a9240a042b4a0f703d7cf2b))

### Changes

- Bump version: 7.76.0 → 7.77.0 ([`547df52`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/547df52f7a3ce7d6c7b884bd9fe382d9bed28fd4))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`467ea10`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/467ea107703f9957463ee146860e33aabd09de78))

### Features

- decode record values + VIF units (EN 13757-3) ([`2d0c727`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/2d0c727933f1fb83c7b854e484b89a18033b1a5e))
...
- update CHANGELOG.md [skip ci] ([`f7c7d14`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/f7c7d1429f74d44eb5225e08fd21a49878f0b714))

### Changes

- Bump version: 7.75.0 → 7.76.0 ([`5b02f49`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/5b02f49ac39df6653e68a212aaef5012af60ab9c))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`d69d1dc`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/d69d1dc07d29d1418fe5afb229758baf21e2ed37))

### Features

- typed information objects (M_SP/M_ME_NC/C_SC) ([`0a1a8da`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/0a1a8da92932db54d0092f382dd3b2e5fa1e2b7a))
...
- update CHANGELOG.md [skip ci] ([`e079579`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/e079579c4253c7d178cb184982e227a4ad7952d8))

### Changes

- Bump version: 7.74.0 → 7.75.0 ([`a91f06e`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/a91f06ec7c05a1871543c4fb547eb23d982c0c67))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`50c5f3f`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/50c5f3f9067612c4ff727f363f0f810d9260b992))

### Features

- transport function - fragment reassembly (IEEE 1815 s8.2) ([`45df73c`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/45df73c33d77964ac86388c29bcf5956c46e1f16))
...
- update CHANGELOG.md [skip ci] ([`b1c9b9f`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/b1c9b9f4dfebbc34cb583aabe16df94b0ad9079c))

### Changes

- Bump version: 7.73.0 → 7.74.0 ([`4b8e5d0`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4b8e5d0a71d362240c30f227c0d5ea67665a993c))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`31c1eb0`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/31c1eb066fe71fc79c6051a49b63600fc3cf83bc))

### Features

- segmented SDO transfer (CiA 301 s7.2.4.3) ([`d53b103`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/d53b103408c5d052f410a73ca4d88087d7a6460d))
...
- update CHANGELOG.md [skip ci] ([`1f11c52`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/1f11c523ea724118e53f11739b6267606d06b90e))

### Changes

- Bump version: 7.68.0 → 7.69.0 ([`2dc551e`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/2dc551eebc11bd76d4de21a748fb8fa3c610cc7f))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`1c04072`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/1c04072a223b205811400bd5d86e037f32ab8124))

### Features

- typed GSV (satellites in view) decoder ([`efa7f61`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/efa7f614085d133491f25e2101fe15c0c63c684a))
...
- update CHANGELOG.md [skip ci] ([`9b4465a`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/9b4465a6b85a1072c62cec1cb16d04ad81709405))

### Changes

- Bump version: 7.67.0 → 7.68.0 ([`433889c`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/433889c789395a697176774443e6a73e7c8537eb))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`f026d29`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/f026d2936b49a84070ce6b5e2edfaf181f4f844b))

### Features

- typed Position + Wind PGN decoders ([`247178e`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/247178eb00852d268200f4af12467a48f7d535f8))
...
- update CHANGELOG.md [skip ci] ([`3bfb0e7`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/3bfb0e73781e16385455d212c6fb5b8c3f3d9854))

### Changes

- Bump version: 7.58.0 → 7.59.0 ([`0183b88`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/0183b8837a7334919ef447d66e2bda77b4139edb))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`977116f`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/977116f45056391ccfcb0c84550476720b994856))

### Features

- enforce LOCK/UNLOCK (RFC 4918 class 2) ([`4fcbaf7`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4fcbaf71dd486f90e25ae51c86ae39d1aa9aad61))
...
- update CHANGELOG.md [skip ci] ([`3e0cef6`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/3e0cef67ed1bba72c001d8177c3647059b9775a1))

### Changes

- Bump version: 7.57.0 → 7.58.0 ([`d6e92f1`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/d6e92f196287ed7a9442ee25ae248e0de2c9e6a2))

### Documentation

- update ESP32 build footprints [skip ci] ([`e39769f`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/e39769f83316d79d1030cb4319ab7a5bc00ea3ef))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`50d8bdb`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/50d8bdbd03975be557f64fef705421d12f6fe229))

### Features

- master bit-access function codes (FC 0x01/0x02/0x05/0x0F) ([`81a858a`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/81a858af3c9748c63c1d63b95a5717944662129f))
...
- update CHANGELOG.md [skip ci] ([`92e764d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/92e764d052ed9fb42ecc2d57f31f44e0b3a8f9b1))

### Changes

- Bump version: 7.56.0 → 7.57.0 ([`3cb7384`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/3cb73845e66bec819c0a45b4416750ca35a30cc0))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`bd9bd71`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/bd9bd71ed4ae8ece968466acabc0c698633598c6))

### Features

- anti-DoS COOKIE (RFC 7296 s2.6) ([`f71f78c`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/f71f78cbcef6f6a7d5352e29527439af5be3ce4f))
...
- update CHANGELOG.md [skip ci] ([`8278e6b`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/8278e6b559afe2716e4b1debc3eca180043a9db1))

### Changes

- Bump version: 7.55.0 → 7.56.0 ([`5c2d080`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/5c2d0808471088217ff5accfea856e0ef0a9c4e7))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`5c87650`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/5c8765066b9a4bf9d964fad7a80b803abe732fe2))

### Features

- message fragmentation (RFC 7383) ([`dc2e3d9`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/dc2e3d95742b060fd88ca18de3ea7b033e0c42ec))
...
- update CHANGELOG.md [skip ci] ([`52f5f59`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/52f5f59c202bb90ab4297650c30d3c36b31176d4))

### Changes

- Bump version: 7.54.0 → 7.55.0 ([`438230d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/438230dc25c8ace1c39374d20017536624ef8164))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`feb3c90`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/feb3c901802afc5e1aa471d30148d278589db14f))

### Features

- Configuration payload (RFC 7296 s3.15) ([`120683a`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/120683a3d11a3d5de085ecded70b266f1603f739))
...
- update CHANGELOG.md [skip ci] ([`50eae07`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/50eae076787d85179a7e93f80da97f648f620da5))

### Changes

- Bump version: 7.51.0 → 7.52.0 ([`f8596c8`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/f8596c8ec0fa8b97c0e370a46ad94104fcdbc2c9))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`f85f418`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/f85f41862e5fe8cb03f6a55734b55376bc98f6b5))

### Features

- anti-replay window (RFC 4303 s3.4.3) ([`6027454`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/6027454360136aae6e341fce6f71908a01c1e099))
...
- update CHANGELOG.md [skip ci] ([`3f2d522`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/3f2d522b5c34e768f9c1406728f43d4e3c5bf3d4))

### Changes

- Bump version: 7.48.0 → 7.49.0 ([`172040a`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/172040af1a9a9940ae905e8d9dadb17865704518))

### Documentation

- update ESP32 build footprints [skip ci] ([`ec190ba`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/ec190bac0e48c597e099273d9913a3d2e7323208))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`bc7f7fc`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/bc7f7fc1d91dc2b65e7104d583b152737e7a8bc1))

### Features

- RSA-2048 certificate AUTH verify (RFC 7296 s2.15, RFC 7427) ([`9bff303`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/9bff303bf6394a23c0d753ec46b3f550c5f363ef))
...
- update CHANGELOG.md [skip ci] ([`6ec5b9f`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/6ec5b9ffad91c676cf59dd5b5081290857af6648))

### Changes

- Bump version: 7.47.0 → 7.48.0 ([`0d9b20a`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/0d9b20ab7ed4000454e7287d8dc9355e221c9527))

### Documentation

- update ESP32 build footprints [skip ci] ([`c808d91`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/c808d913450604ed140b389afbfd21308d90febf))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`f1431b7`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/f1431b789695bd19119fce4800ce4329328fb98e))

### Features

- CREATE_CHILD_SA exchange + Child-SA key schedule (RFC 7296 s1.3/s2.17) ([`996c5b0`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/996c5b0c71245693da47c5a7d626cb1a7e7e5c44))
...
- update CHANGELOG.md [skip ci] ([`18705c3`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/18705c358fe77a7108f93bb52af97ccb16c91f7c))

### Changes

- Bump version: 7.45.0 → 7.46.0 ([`a9a6e85`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/a9a6e85037daa45c117c5c028c064afb47dcc255))

### Documentation

- update ESP32 build footprints [skip ci] ([`0cd175d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/0cd175df93e117207ebc01af3715619e2cbb61a1))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`fa89d7d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/fa89d7dfb72bdbdf30a0f392dfa11ac18d944b1d))

### Features

- responder IKE_AUTH - full bidirectional handshake to ESTABLISHED ([`0bc2c80`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/0bc2c8019598b71fc4f0d48fa6dc19ddaaac0b5d))
...
- update CHANGELOG.md [skip ci] ([`19f28a9`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/19f28a9176e43c5ec1b68cd6637f6de9d5c841a2))

### Changes

- Bump version: 7.44.0 → 7.45.0 ([`350c95a`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/350c95add89a179c4784ca811ead71d91790e2ea))

### Documentation

- update ESP32 build footprints [skip ci] ([`d596eb4`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/d596eb4b67362ddc862ff4c326db9cfd66a5d57c))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`2ea6467`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/2ea64673e2a2cbba446f85cc71c67990dd99a6b6))

### Features

- responder IKE_SA_INIT handshake driver (RFC 7296 s1.2) ([`f6b59bf`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/f6b59bfcd495cc3082700deca7c26fc9b57a3d8c))
...
- update CHANGELOG.md [skip ci] ([`54dea21`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/54dea2124ae6c9c9562fce5115bf109bd9e44713))

### Changes

- Bump version: 7.43.0 → 7.44.0 ([`cb6d79e`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/cb6d79eb91d045f4fe581a3b8c2336f7db25d2a0))

### Documentation

- update ESP32 build footprints [skip ci] ([`aacbecb`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/aacbecb784368fbf7a0f9090a008be1c0a66cfec))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`61a1279`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/61a12794973091ad5825b6443df1da74befa461b))

### Features

- initiator IKE_AUTH receive - full handshake to ESTABLISHED ([`00d47aa`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/00d47aac1873fe66ca58e7cab94986e187d43b13))
...
- update CHANGELOG.md [skip ci] ([`7a94df6`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/7a94df67e4d3253a03f57fa09befe780767968b8))

### Changes

- Bump version: 7.42.0 → 7.43.0 ([`59f1e08`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/59f1e082f52d31f17027b6c66643f172d323570b))

### Documentation

- update ESP32 build footprints [skip ci] ([`b850f41`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/b850f4192bff130c600a5e38ab918a9221b7c6b6))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`5d6e919`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/5d6e91960886742e4a99192703ced88aa3a81b2b))

### Features

- initiator IKE_AUTH send (PSK) - SK{IDi|AUTH} ([`c645fd2`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/c645fd20e0855d7a36d3614be1991d30e9c76e19))
...
- update CHANGELOG.md [skip ci] ([`848398f`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/848398fdf4402ddd5e6837d1ed7283acef3c7f5c))

### Changes

- Bump version: 7.40.0 → 7.41.0 ([`713dee8`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/713dee867c39107488b97d9610edeebe892ea4f3))

### Documentation

- update ESP32 build footprints [skip ci] ([`e275edd`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/e275edd9b47cbd291a8df6cbd2668ae74c929008))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`233e475`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/233e4754599f76a352849e39044e5ab5dd09acf0))

### Features

- IKE SA context + key material from a completed exchange ([`1e40dbe`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/1e40dbeed0acb09b90b1c09a9a67674368ea8b18))
...
- update CHANGELOG.md [skip ci] ([`822e292`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/822e292665da74d358498c95750a0fb47e753e9f))

### Changes

- Bump version: 7.37.0 → 7.38.0 ([`4a2568d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4a2568db8c61a5856981bec3bd66fa9e9c2bb39d))

### Documentation

- update ESP32 build footprints [skip ci] ([`7ef4c2f`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/7ef4c2fb8ae43cb68fe93872fd457aa68892ff59))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`4e07938`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4e07938b44f9fbc51b66464c559d046ac771ea23))

### Features

- IKE_SA_INIT message assembly (RFC 7296 s1.2) ([`6735e24`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/6735e24b7a8f127882764f0ebfdad9a7a61cb086))
...
- resolve unit 0 to Serial0 under USB-CDC-on-boot ([`909a734`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/909a7345129a60b93d52ad1e23fb0d3ff289d3ef))
- stop counting bytes as sent when the packet cannot hold them ([`a5f5801`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/a5f5801dbae160305ed1ce95772a1eb8b778345e))
- stack buffer overflow on a long bareword argument value ([`e6fa43b`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/e6fa43bf205de218cc82b7536b891c5f36dd9f66))
- fix(docs) README.md ([`3071b8f`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/3071b8f90f8a43406a3bad7a390beff07c1a91b9))
- honour GCOVR_EXCL in the per-branch union ([`ac7fdb4`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/ac7fdb45f6677dc098318bd3235d9c86693d5ea8))
- union coverage BRANCH BY BRANCH across envs, not per line ([`c7f1250`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/c7f1250a5c143c4281f70282a30f7841cbf035e8))
- pin DWS_SMB_BUF so the request-builder guards are provably dead ([`155b7d1`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/155b7d1e2978cf79800bfce4e0021233ef4c6fe4))
- clamp delta-seconds with int64_t, not long (LLP64 overflow) ([`4e3afa4`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4e3afa41fe26dac7490f708ea61aa23ac76c91a0))
- stop test/coverage.xml going stale ([`4dedded`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4dedded19de11d5342d031d80505ab6903973aaf))
- make the whole native matrix buildable off Linux ([`a29196b`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/a29196b261f30d9ded00937309711b8f607d86eb))
...
- update CHANGELOG.md [skip ci] ([`01f80dc`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/01f80dc02b4ae3ccc37de0cd46b3f768254abf5d))
- update test report + coverage [skip ci] ([`8469164`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/8469164abdea44251c4a648dd0a0ce5f4474780b))
- update CHANGELOG.md [skip ci] ([`42fc099`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/42fc09972687d6056e460e9aaaf4ccc3a57dd673))
- update test report + coverage [skip ci] ([`a94ddee`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/a94ddee584c6a4cc76d82dadd37e7744d5310087))
- update CHANGELOG.md [skip ci] ([`3bd6ff4`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/3bd6ff41fd64899aae8f3d5fc1d7cb8327ed633a))
- update test report + coverage [skip ci] ([`8495083`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/8495083a85beccbe606de8bde6afea06bebf81ae))
- update CHANGELOG.md [skip ci] ([`b04ed2b`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/b04ed2bf675777da5517749ae478b90570e9a6b8))
- update test report + coverage [skip ci] ([`d66993a`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/d66993a28cf5216a992cb6276a0e478d14849366))
- update CHANGELOG.md [skip ci] ([`e664c5b`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/e664c5b3bc102691339602be2d38ae9ec5a7050b))
- update test report + coverage [skip ci] ([`b2f8f3e`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/b2f8f3ec11f5388b4eb1e821ce06db2be89c3043))
- update CHANGELOG.md [skip ci] ([`c95bb09`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/c95bb09ac219b07a0afe72dd6dd7700d28e7973c))
- update CHANGELOG.md [skip ci] ([`28972fb`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/28972fb7389126f4fc6992faa37f32012dd9a714))
- update CHANGELOG.md [skip ci] ([`89ab0ea`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/89ab0eaa881c3b21dfbd39dad6652b61867ef20d))
- update test report + coverage [skip ci] ([`2841109`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/28411094b30f2aa28c17747dae8d761ab1d96400))
- update CHANGELOG.md [skip ci] ([`f502863`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/f5028635cb6d5e5d4d53e2ffe4db0d4a0d210f6a))
- update test report + coverage [skip ci] ([`3087114`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/308711489bd2e96cb8a3a800193ed7cbebccbf55))
- update CHANGELOG.md [skip ci] ([`feaf516`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/feaf516e68d88d30ff8f627276c5220676eb7afa))
- update test report + coverage [skip ci] ([`5746f0d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/5746f0d097dc598c5c6e9996758492494656f6af))
- update CHANGELOG.md [skip ci] ([`bdc07c1`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/bdc07c15404b1347f7bd48ce94d6d18a3a5733fa))
- update CHANGELOG.md [skip ci] ([`4bc856e`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4bc856ee94f170e4a00419926094067124eb1fc5))
- update CHANGELOG.md [skip ci] ([`3f0006c`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/3f0006c18a6113853961e06ca0fa5c7f935b9541))
- update CHANGELOG.md [skip ci] ([`853b9de`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/853b9de926d597a8ebcded5357c9bd5b236b7ec9))
- update test report + coverage [skip ci] ([`ea45c83`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/ea45c83ddfd3bfbc2559f07e5972b271a54d7e46))
- update CHANGELOG.md [skip ci] ([`356b664`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/356b6649cd5e01c5a7417270f2fd43e5024f1255))
- update CHANGELOG.md [skip ci] ([`4d2cff0`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4d2cff03d9f27f65ff8629d3d46cd3f823612a42))
- update CHANGELOG.md [skip ci] ([`ab88b05`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/ab88b05c72a1d967b64831c5e66cd7cd17373ad8))
- gate the job on test results instead of discarding them ([`bf29412`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/bf29412f980e2172aac8961cb8ba29c9f4f559b9))
- compile the native envs with -fno-exceptions ([`53a5637`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/53a563755d7fa3cd91180cec28ad6cdd5e13498f))
...
- Merge branch 'main' of https://github.com/dstroy0/DeterministicESPAsyncWebServer ([`630b95d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/630b95d34056388e23fea85bd262503a854e89ec))
- Merge branch 'main' of https://github.com/dstroy0/DeterministicESPAsyncWebServer ([`b29c6df`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/b29c6dff3356ecbde4cea5c9ccc1a09f37db6fac))
- Merge branch 'main' of https://github.com/dstroy0/DeterministicESPAsyncWebServer ([`5bcbd43`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/5bcbd43310c79a2c0abca9fc24007ce9a4f67a61))
- Merge branch 'main' of https://github.com/dstroy0/DeterministicESPAsyncWebServer ([`8618455`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/8618455301276e3665e363dd051e2c42020d2429))
- Merge branch 'main' of https://github.com/dstroy0/DeterministicESPAsyncWebServer ([`b076dec`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/b076decf9f060f8680493bf3b3f188cb61c2098c))
- update(docs) README.md ([`64a445c`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/64a445cd54a09aa5fe58a03f48869c35bd69f3d3))
- Merge remote-tracking branch 'origin/main' ([`f906b70`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/f906b704d84a5007d1e7298850228abcd3c2cdcf))
- Merge branch 'main' of https://github.com/dstroy0/DeterministicESPAsyncWebServer ([`c494871`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/c494871a998e65ef7b2a9217ed4d52a3465c7df2))
- local branch-coverage tooling ([`feaf825`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/feaf825d7827b4493600c7e25a02adcdf2447f4b))
...
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`042b89b`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/042b89bdac8f4624d925ed73225a3688dc0f71a5))
- update ESP32 build footprints [skip ci] ([`4bc13fa`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4bc13fad9b8bc82982d7160a5ce7987d5c5b2a4a))
- record the migration and stop describing the retired loops as current ([`418ec3e`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/418ec3ec556794700d086418d0509abe67d53caa))
- update ESP32 build footprints [skip ci] ([`1c01908`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/1c019088b5b509cff2015d6f28e1ceeb67bfb2dd))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`acf4d7d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/acf4d7d29858f3b5b80fb87bbabe3e6cc7f7bbc2))
- update ESP32 build footprints [skip ci] ([`e3e91c7`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/e3e91c72eb43d8256d756036d0b3179216c12e7b))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`5d946ba`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/5d946ba5c8e0aceeb44684e89cd534d3954b8312))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`1d85457`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/1d8545705c6234abd1d69937ec621b4fafcd48ff))
- update ESP32 build footprints [skip ci] ([`c252350`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/c252350db316c2f3f3a39e07640afd6c8c884597))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`12b2c26`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/12b2c2611260dc9ccf490f7f8287f9e78728c090))
- update ESP32 build footprints [skip ci] ([`2ccb495`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/2ccb49554e1d206326c8a5b0e5f498d23decb55b))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`5c3a0ef`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/5c3a0efb0b5a42aef14a471410336baec6944cb4))
- update ESP32 build footprints [skip ci] ([`4c3e92c`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4c3e92cba11763620127539441e832aac1baa56b))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`2561daa`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/2561daae9e92ea6003ec6b410f9b0184d1083cf2))
...
- IEC 61784-3 black-channel Safety Communication Layer primitives ([`88ffda7`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/88ffda70f5dba4042ce586bbdf84a182d3bdc527))
- Waveshare HMMD 24GHz mmWave micro-motion radar codec ([`bbea456`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/bbea45629cbb0b2e86cd98730a2dc434b645ba92))
- RCWL-0516 presence sensor + shared one-GPIO presence facade ([`44924ba`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/44924bab72b47203fc4b5d88d6860591f5adaa44))
- support the HLK-LD2410B, and decode command ACKs ([`7d39c5b`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/7d39c5b4088d5c63fa54a07e43c11e7708fe7b1a))
- FANUC Stream Motion (J519) UDP codec ([`1065b9f`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/1065b9f005c9f191f1117108e1a9f331ae6ab292))
- feat(dpa/cpa) side channel analysis engine ([`04f54c2`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/04f54c21f1b586e1c32ba8d61446938ec58469c3))
- EUROMAP 77 (OPC 40077) IMM_MES_Interface model ([`2ecbaf7`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/2ecbaf78ecf5e458a475886433825c406b973d1e))

### Refactor

- use the shared CRC engine ([`88bf388`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/88bf388acaba44496233e67be4e9c0b97314bfd2))
- use the shared CRC engine ([`aa8a422`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/aa8a42227ea48700a3716cf083d97e7965028db2))
- use the shared CRC engine ([`affe7aa`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/affe7aaeedc71ab167d3578a9619e238926677d3))
- use the shared CRC engine ([`6c8559d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/6c8559d247d2b70a2074492ad5feb8dbc93dbb95))
- use the shared CRC engine ([`3e43c06`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/3e43c0631c172f3dafaf4fa039113d2912534b02))
- use the shared CRC engine ([`f8a9330`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/f8a93307d2deb4043e28ae2da8f2e18e1ddd5f64))
- use the shared CRC engine ([`51d4cd1`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/51d4cd1a8db69ab722bf7558990b32c3efd1ef07))
- use the shared CRC engine ([`1bfc349`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/1bfc3494d1afee6b8f714db948eac24cba30c0f9))
- use the shared CRC engine ([`9c29cc6`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/9c29cc6474f24c4ae4f6865e3eb9f26444903750))
- use the shared CRC engine ([`c1e3d41`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/c1e3d4149fbed96407f08c5ef4a8d0bf13646a50))
- use the shared CRC engine ([`9595473`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/9595473a773fcc1157f5b6cd197d3cc3b4eb00ce))
- use the shared CRC engine ([`9d6d40b`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/9d6d40ba82bcb20c7200984874237521a129fd5c))
- use the shared CRC engine ([`0578bbd`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/0578bbd058384c5fc153b606d2a13e1414bc1eb2))
...
- adversarially re-verify GCOVR_EXCL markers added this session ([`ef505f9`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/ef505f9f49e28b6bd22c76ba6257a5a30bff5f19))
- raise line/branch coverage across native envs toward 100% ([`a9b9565`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/a9b95655a9b854d40add3c7635111cb447ac774a))
- 100% line + branch on snmp, smtp, oidc, senml, ntrip, dnc, dbm, sftp ([`ea0e6a0`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/ea0e6a090f0e82ace6d547c1d422a0e9b9c4f2a3))
- 100% line + branch across the SSH transport, auth and connection layers ([`297fdd2`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/297fdd2db2217f0eba20c74ec0f863323caf2853))
...
- update CHANGELOG.md [skip ci] ([`a428e1d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/a428e1dd1cabedc3e1e0e5870c268d1644757485))
...
- Bump version: 7.28.5 → 7.29.0 ([`461f691`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/461f6910edb01b40531b68610ffd28a61e575045))
...
- PackML / OMAC machine state model (ISA-TR88.00.02) ([`5b8c90e`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/5b8c90e8017455286c227f6f2c25ef8526a70277))
...
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`c50a465`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/c50a465b93016b468e58c22c24389bfeafebe603))
...
- update CHANGELOG.md [skip ci] ([`b702957`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/b702957d5a0ff97348213e509aa755ef2e588db6))

### Changes

- Bump version: 7.17.1 → 7.18.0 ([`0b43e8d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/0b43e8d2df267f57f934d2079eeccd74846ab7c3))

### Documentation

- update ESP32 build footprints [skip ci] ([`93923ad`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/93923adb094371056645e27c30b78728065aa091))

### Refactor

- scope the protocol enums and let the types flow ([`412f131`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/412f131babe40a993eea5e2c516704898529197a))
...
- make pre-commit granular - format only what is staged, warn about the rest ([`3dd314d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/3dd314d301346b6b7bbe0a26441c39559b56c5a5))
...
- update CHANGELOG.md [skip ci] ([`0987a31`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/0987a31026833814a76be01e2cb3e220e502d570))
...
- Bump version: 7.12.0 → 7.13.0 ([`f4ae260`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/f4ae26067886c005ffe796976428ec7d18a8e177))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`bc5b653`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/bc5b65382a4e5bdf62cdbede3c05fc7bbbfdd26b))
...
- close channel-agility roaming - live channel-hop scan + per-channel survey ([`f98525d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/f98525de3720c345e08e2a56963216e1e7c34b29))
...
- update CHANGELOG.md [skip ci] ([`05b113b`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/05b113bb426e604a59ac9fb2b8ab13887b564df5))

### Changes

- Bump version: 7.0.5 → 7.1.0 ([`044d875`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/044d875d22a7be0b9abf50641c33a0ec2b9f50dc))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`2844940`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/2844940c18438fc1a9125d24517d243192e4a786))

### Features

- per-variant default sizing (src/board_profiles/) ([`66055fd`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/66055fde0f3c183d905a9f218f25560e46bc1ecb))
...
- update test report + coverage [skip ci] ([`995398d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/995398d2cc5337306ac826be5fc26b91caeb2565))
- update CHANGELOG.md [skip ci] ([`4de0744`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4de074432fd398fc1bce46db88f70bb1ed467eb2))
...
- Bump version: 6.30.0 → 6.30.1 ([`7149103`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/714910349d0e3182b047e1e96ac4a6f95dbb2f97))

### Documentation

- update ESP32 build footprints [skip ci] ([`97403a2`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/97403a2d1df9b9d3d91bc9a06855dbc1cb49e698))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`4f863fe`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4f863feace2d0f5bf5bba62c2032d1ad15aad209))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`6fdf7dd`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/6fdf7ddd7a112ac653ad0d6dc3021f5f8b5ec473))
...
- update CHANGELOG.md [skip ci] ([`1157b2d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/1157b2d67c5d2cc0f12ea60516281834759cab7d))
...
- update CHANGELOG.md [skip ci] ([`9818660`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/9818660300af3c148ba413f4cc510fb5166ec973))
...
- update CHANGELOG.md [skip ci] ([`aa18889`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/aa188890e9f293ab58b6569b7764945f0f9b613e))
...
- Bump version: 6.24.1 → 6.25.0 ([`83a30ac`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/83a30acebf78d1f05cdd0f17777719db62b50792))

### Documentation

- update ESP32 build footprints [skip ci] ([`705d591`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/705d5917a21f0242e99b4ba3105f8ca238a0a54d))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`5daf994`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/5daf99482c3c22f9a0d9d80ea9e24f566335d1c8))
...
- update CHANGELOG.md [skip ci] ([`e96d934`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/e96d934fc53447084df2fdf4117d1bd1fc115eef))
- update test report + coverage [skip ci] ([`99558b0`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/99558b0a341d175bf4bd248dd0b4bb97c16b7bf3))
- update CHANGELOG.md [skip ci] ([`797777f`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/797777f3f6e932c8455c06bfcc6885a228d9a1bd))
- update test report + coverage [skip ci] ([`4a0538a`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4a0538aab7cf0fdc46dbe855016b1688ada72846))
- update CHANGELOG.md [skip ci] ([`026b12e`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/026b12edb34f95033e0612f537e15582208eaddd))
- update CHANGELOG.md [skip ci] ([`3696bc8`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/3696bc8d5ce29b76000b96ad166da5fb47912364))
- update test report + coverage [skip ci] ([`7ac65a5`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/7ac65a576a9248dfd0de0567f03cf9583df3e500))
- update CHANGELOG.md [skip ci] ([`fd78524`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/fd7852494361e767801650cd942e53161e04888a))
- update test report + coverage [skip ci] ([`51879f0`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/51879f03d4621ee275ba2ec4cb9facad2030062c))
- update CHANGELOG.md [skip ci] ([`3c8f961`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/3c8f961377bc961d1be93cec9f7326e056c52adc))
- update test report + coverage [skip ci] ([`50197c7`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/50197c72d682e1112d85eb6d885ac52773b65636))
- update CHANGELOG.md [skip ci] ([`567cc75`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/567cc75176d9b26708abec5c1c2a6b2a9dc50f3f))
- update test report + coverage [skip ci] ([`f8afe7e`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/f8afe7efdd2376a2534cc1ae327860b3d8a483a7))
- update CHANGELOG.md [skip ci] ([`3a64b2f`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/3a64b2f450b72bdaf21043683b71aa4d84370c37))
...
- update test report + coverage [skip ci] ([`e540320`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/e540320fface911a0627717528dd6ca391025075))
- update CHANGELOG.md [skip ci] ([`d2ce06b`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/d2ce06b5bdd5998ebb594488101ff820b665e051))
...
- update ESP32 build footprints [skip ci] ([`e98c2ec`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/e98c2ec00acdffd4cbe6219ad092103b24c58e0a))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`ec71fe0`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/ec71fe0c27c7ba8a609db41957487b393a0da4ae))
...
- update ESP32 build footprints [skip ci] ([`d948c37`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/d948c37e8cd468b936d4a6c2cf877f29f987e2fc))
- update ESP32 build footprints [skip ci] ([`7ac09cf`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/7ac09cf5d13bb428c69d159679374686b1c44d4d))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`0f0378f`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/0f0378f6f730c6ffde6d5bb172989a88b45ad88f))
- update ESP32 build footprints [skip ci] ([`01de263`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/01de263ef6997867a9b3f30e2c7a36f639e408c7))
- update ESP32 build footprints [skip ci] ([`4876198`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4876198b553fa0c756f9f56fedf24e24521a9044))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`792ecde`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/792ecdeac8829b61142c41d33e35c20d631dcf5d))
- update ESP32 build footprints [skip ci] ([`99d88af`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/99d88af6d46724368d111bf12a342d8897eb88de))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`ef0fa4d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/ef0fa4daa1ff590c56a1d22515b4de8b45796273))
...
- update ESP32 build footprints [skip ci] ([`a066983`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/a0669838a389e8949b5315139926139dff0c77c2))
...
- reduce cognitive complexity S3776 in parse_extension ([`a2809fe`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/a2809feca7751bf5d6117452e846f589dd302eb0))
- reduce cognitive complexity S3776 in quic_tp_parse ([`bab1b3f`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/bab1b3f23fdc2ca801e4fb4ef1733308c846ee32))
- reduce cognitive complexity S3776 in smb_client ([`c99a943`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/c99a943b58d26164204cf130cf1ea9629a54a0e2))
- reduce cognitive complexity S3776 in ssh_auth/redis_resp ([`0ce1fc5`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/0ce1fc518e56cc980fc86179d5dd7079a2147204))
- reduce cognitive complexity S3776 in mms/http_delivery ([`e1b66d1`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/e1b66d108b2e50d9a6145fde3f8d18a0dae193ff))
...
- update test report + coverage [skip ci] ([`bf52eeb`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/bf52eeb060c6cfe4abb3a2bd86ad965342a63c70))
- update CHANGELOG.md [skip ci] ([`09c125e`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/09c125e3fa7704566af9c73c4bd7b83e327e8eee))

### Changes

- Bump version: 6.21.0 → 6.22.0 ([`eb399e1`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/eb399e1d27f3a3e23dd7771edf08908d29323855))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`3565409`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/356540984e1a9863217e27a9124cb169f2ccdc20))

### Features

- CoAP-over-DTLS bridge (RFC 7252 sec 9) ([`21db473`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/21db473fcb1f4989bbe818d03d95bfc3b0d86bfb))
...
- update CHANGELOG.md [skip ci] ([`94181da`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/94181da663566e6552def98d0b5a70e3b4473ea1))
...
- Bump version: 6.4.1 → 6.5.0 ([`f7a98ec`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/f7a98ec47e228418ea1b835269bce16a386ce09e))
- @ ([`a43b629`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/a43b6296f47aaf65a1f6d8e7ea25e0f92f3912b1))

### Documentation

- update ESP32 build footprints [skip ci] ([`09de92d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/09de92d6a2720445481b88c2bbbd769cc0698417))
...
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`3c79e90`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/3c79e9090170497bca5b62a531f5684d3857f41b))
...
- correct the gap backlog - QUIC server engine exists + build-verifies on PSRAM ([`4203264`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4203264701afd48b9e691e3590ea71fece549c6a))
...
- update CHANGELOG.md [skip ci] ([`416c701`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/416c7015f7a1b10a6a5c68d7eb6a73b28c7ad231))
...
- device-as-STOMP-client /stomp/probe route + stomp_parse_frame bench ([`f4c458b`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/f4c458b748418f1735961aeb8d8270fcb17ffac3))
...
- device-as-SMTP-client /smtp/probe route + smtp_run /bench op ([`eb13a2c`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/eb13a2c96023f992eb3d26a4c367a3ffffa71824))
...
- update CHANGELOG.md [skip ci] ([`1507770`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/1507770e878f005b323361f7bc6f57e46d59f6d8))
- update CHANGELOG.md [skip ci] ([`eefc6c1`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/eefc6c1695bb5b1105116c4bb43be0968cfe5dea))
- update CHANGELOG.md [skip ci] ([`3283fbb`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/3283fbb5456e05a3aaddd315797d0aee276cf1b7))
- update CHANGELOG.md [skip ci] ([`273ee5d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/273ee5d0c6bf2df222cf20638d53b1a19a7fd047))
...
- update CHANGELOG.md [skip ci] ([`cb1d47d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/cb1d47d3e9c9e379b479968a115e26d6c9c7a83d))
- update CHANGELOG.md [skip ci] ([`c90fbee`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/c90fbeec0e5620185473272d832f872d6e98f132))
...
- update test report + coverage [skip ci] ([`5038fa3`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/5038fa33f537e939d3f2a928e2adea20210fbf88))
- update CHANGELOG.md [skip ci] ([`95eb89f`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/95eb89f7c457a1dc7574ec060f36e29466c61046))
...
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`8608943`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/8608943e6a73d4570103c2b5b1ce820dede8b6d9))
- update ESP32 build footprints [skip ci] ([`27c69ba`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/27c69baf1975a3b45ff498a3f4cbe37bfb2331d5))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`4511c87`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4511c871e8f29002174194c09ac35170bb8d3d58))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`29db421`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/29db421ef913ee1586cd737a44a507b6bf375775))
- update ESP32 build footprints [skip ci] ([`4ce0324`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4ce0324c453bc24ce121c31544c8c7d39d7d6d12))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`1c976e3`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/1c976e3970d0d37c1ce68f8388823217f17e5764))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`8274278`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/8274278dc2d6dbba4cecfcaca3d08e3b56521851))
- update ESP32 build footprints [skip ci] ([`fdec991`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/fdec9918b0dbe343c25629d0f77807b6d610b839))
...
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`f3940c3`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/f3940c392a32be71f11f18272672a00ebeb6ead5))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`e7f9883`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/e7f9883509786db43267be5dc3f3fed27c3cfcb1))
...
- update ESP32 build footprints [skip ci] ([`b4cea4a`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/b4cea4a68c0f5a52febe585337fe5889954dfc11))
...
- advanced HTTP/1.1 exploitation vectors in the network attack tool ([`a27c4d6`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/a27c4d6787e6dd9a14239f748f71bc1792dd5c4d))

### Refactor

- extract middleware + rate limiter from dwserver.cpp into src/server/middleware.cpp ([`a21f159`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/a21f159255ea335006e2144899d48713fc7bb905))
- extract the regex route matcher from dwserver.cpp into src/server/regex.cpp ([`fcc1959`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/fcc19598f8f9173582465d0df8494b215f7205ad))
- extract WebSocket + SSE from dwserver.cpp into src/server/websocket_sse.cpp ([`5dba7d1`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/5dba7d1566f3ce4551add08eff79ae51b53b9795))
...
- ocit/rawl2/wave anon wire-const enums -> namespacing structs ([`67eccc2`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/67eccc29743683c0c23be97a96bc09c2e33389e0))
...
- rename release workflow to Release Library CI ([`84598c5`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/84598c5ee058aba8f4d606ed24a207e0c99cae9b))
- update CHANGELOG.md [skip ci] ([`0fbb703`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/0fbb7034cd0d0cebfd07b249ca570dcc96049130))
- update test report + coverage [skip ci] ([`7d4a1fe`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/7d4a1fe07d35244f4828d71f20ce25d5b16b3e10))
- update CHANGELOG.md [skip ci] ([`00e74e4`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/00e74e4a1b83c607f88499a4f8cf87a8975b46c7))
...
- update CHANGELOG.md [skip ci] ([`fa32c7c`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/fa32c7c30c69be3b85f0375c94a75efcb3c96389))
...
- update CHANGELOG.md [skip ci] ([`2147599`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/2147599a7d1cdefb7b01a1ea9cb040ec8afc7a08))
...
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`5a9c6ea`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/5a9c6eaf645d41fe748a6d2dbc98f53fa007903a))
...
- update ESP32 build footprints [skip ci] ([`7218c91`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/7218c91b5424e88bbef4f9a728ae3c535f9ff17b))
...
- scoped enums for forward/gateway/docstore/webdav/sqlite (enum class 29/N) ([`3b7b4c0`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/3b7b4c04bd1e879efdbe16b167fe34e5e0e5ce48))
...
- scoped enums (enum class 12/N) ([`8aa6103`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/8aa6103488aff50b71d6307cf9b7a2d03c66b1d7))
- scoped type-tag enums (enum class 11/N) ([`fa86dd4`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/fa86dd4e17680a161ef9614739fd0642c7e55653))
- scoped enums (enum class 10/N) ([`6cd168f`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/6cd168f0a3eddb98e05e8c97d41d080b6c4e9b90))
...
- update ESP32 build footprints [skip ci] ([`6e1e231`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/6e1e2316a7852a106d79983a3d8c7a1932c7a461))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`5e7c07b`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/5e7c07b1d90e12618f2e9325f3498ab788b62071))
...
- scoped result enums (enum class 5/N) ([`d88982f`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/d88982f21d30288f83a76fc4c3e89b9a60576004))
- scoped result enums (enum class 4/N) ([`6a9a6ec`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/6a9a6ec50b95613d478515258cc16bfe434cb1fe))
...
- fuzz the DDS/RTPS message walker (completes the corpus) ([`8c6b573`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/8c6b57347875e9b0c67f12d4fb811c4dd0933cb3))
...
- update CHANGELOG.md [skip ci] ([`da764cf`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/da764cf0562cd13e1c99a78275010b5a379a2296))

### Changes

- Bump version: 5.91.0 → 5.91.1 ([`d2cf9b3`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/d2cf9b3932d70cbcc6848b1f19ecb5189c92c4ee))
...
- update CHANGELOG.md [skip ci] ([`4efc401`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4efc4011e83ddfcca8e79d28b720395320b1223f))

### Changes

- Bump version: 5.90.0 → 5.91.0 ([`a1cfcf9`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/a1cfcf9d28f44015a1fae316d0205b116b0a587c))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`2cbbb6d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/2cbbb6d12825afe6784eb014d822491bf20de9f9))
- update ESP32 build footprints [skip ci] ([`75b828e`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/75b828eb0971fc98a855ccab79b16856518df025))

### Features

- smb_read / smb_write on the SmbHandle ([`5146517`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/5146517fdea0a56f3445138a213bdca6d6394d64))
...
- update CHANGELOG.md [skip ci] ([`066c62a`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/066c62ada8884d7e030fde09c88a074688ee8ed5))

### Changes

- Bump version: 5.82.0 → 5.83.0 ([`e06f9ea`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/e06f9ea750f172b2eca00201cfd2510c8445f3d6))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`71feea2`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/71feea28c7a519aef51f529dfd0d47db0049fb9e))

### Features

- NTLM digests MD4 + MD5 + HMAC-MD5 - SMB2 increment 2 ([`ef9f743`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/ef9f743a2bff643bde20b2504287ec46b4a03c39))
...
- update CHANGELOG.md [skip ci] ([`bad7476`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/bad7476732f789173281791c7c7bf45d38627ee2))

### Changes

- Bump version: 5.74.0 → 5.75.0 ([`2564a7f`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/2564a7f8e97f2878a3319745d08d8553e46e33ea))

### Documentation

- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`3d7f419`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/3d7f41923889fb4c213c7eb6617a62595953c348))

### Features

- bounded single-table database writer ([`428f1c5`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/428f1c5738120e1bf6dfa0e6f0945cd2712bf213))
...
- Bump version: 5.73.2 → 5.73.3 ([`ce11421`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/ce11421c60a6b07fbed402fd7fba87cb2413c0b3))
...
- Bump version: 5.73.0 → 5.73.1 ([`29c8208`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/29c8208df35971281bd5ff845247d204aa3a4556))
...
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`7bdbdc1`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/7bdbdc1a630564ffdadc8f94a7e233bf1dd2b14f))
- update ESP32 build footprints [skip ci] ([`34b6ac0`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/34b6ac0dd6f814e5fef8881fe4b3af8211c1d12f))
...
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`63c2ffa`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/63c2ffac881bcc60297008cc346460c1cb0e6deb))
...
- SD batch/write-size sweep - sizes the atomic journal + queue ([`c9133f0`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/c9133f01b63669ca3eaef9faeaee310a949dd846))
...
- update test report + coverage [skip ci] ([`86a05f2`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/86a05f24b746521e99f617720f59f467ea08e5cb))
- update CHANGELOG.md [skip ci] ([`9813a1b`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/9813a1b86528c22829b3e29f9f80323c45c338a0))
...
- Bump version: 5.63.0 → 5.64.0 ([`f280d17`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/f280d178596c5fd0269f4ae10d37096eb7934760))
...
- add the sample sequence cursor (from/count long-poll) ([`4ad241c`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4ad241c41bad4638bf7116d4c1c86ac79100456f))

### Testing

- regenerate platformio.ini + test/README.md for the mtconnect matrix desc ([`89edcfd`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/89edcfd62763e386fb3969f6e447fe0bfc56de43))
...
- resolve two real SonarCloud smells at source ([`6dbb23b`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/6dbb23b751156987b6e946dc6a17300cc71fcce4))
...
- update CHANGELOG.md [skip ci] ([`dc0705a`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/dc0705ac7a5ea6caca2e10000d7ac193e58c93af))
...
- update CHANGELOG.md [skip ci] ([`486981d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/486981d392e66119f791da0e273fde3995e90856))
...
- update CHANGELOG.md [skip ci] ([`cefb27a`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/cefb27ac48e8e95a4ff525dae830e7fff41dbe45))
- update CHANGELOG.md [skip ci] ([`470e394`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/470e39451edb8e7d0f37d35c8e40ee26d155e232))
...
- update CHANGELOG.md [skip ci] ([`428dbf3`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/428dbf3dfa1d7ab669a19e62e8ee1fa68ccaea00))
...
- update CHANGELOG.md [skip ci] ([`86d339a`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/86d339a5eecce99b0db54c238411d86d4e873a5d))
...
- update CHANGELOG.md [skip ci] ([`42640f5`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/42640f5fa6d14d48d7e5d1eea16c757bcd456716))
...
- update CHANGELOG.md [skip ci] ([`7ac6891`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/7ac68910fe1f36e8e6e1be8c9d48359f93e9069e))
- update test report + coverage [skip ci] ([`5fb2ac0`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/5fb2ac092511bdfe151bed3d3348f20a9936f93b))
- update CHANGELOG.md [skip ci] ([`3581d42`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/3581d42f68e1bcc5f5c77cefe130a938d194ef16))
...
- update CHANGELOG.md [skip ci] ([`55f0008`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/55f00086979f3e0e12ae27b5546ea5e850721ed2))
- update CHANGELOG.md [skip ci] ([`83ad1a3`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/83ad1a3c0cd42a3d22b0271bb0f25779856a5f54))
- update CHANGELOG.md [skip ci] ([`787fd3a`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/787fd3a99b6abd2552f8b7381cac7b7763fbd09c))
...
- update ESP32 build footprints [skip ci] ([`5c3dc9d`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/5c3dc9d979450654e0ea4fabc5d72bc24b383946))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`8709aad`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/8709aadae3f44fd1764ef5f7af2d8b5518a3d5bb))
...
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`5c1794c`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/5c1794c467bb156dd0fce6c4e92f37175bbb194b))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`afdf125`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/afdf125c908bb210aa5542fe15b8e9a7a2dd2db1))
...
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`f8d141f`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/f8d141f57f87ae2aa05ee8030d13aab2f677365c))
...
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`5e2b592`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/5e2b592666721e37e35c8cbcf52121a6e83701dd))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`55e0d1f`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/55e0d1f8c5b7a9dff6747d14dad481043d42a761))
...
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`ead1b96`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/ead1b96fcfa2896430c97d0db673577716d9d5b9))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`5343d73`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/5343d73cdee38fc5dc609949437dea41a8d11af3))
...
- cover null guards + SPI init start-clock clamps ([`a46c173`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/a46c17395f3d3ccccd01efded8f56ac1131730a6))
- cover range-parse + builder edge guards ([`d156c09`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/d156c0935c108907bd35b2e17139e8a80ff8bd23))
...
- cover WebDAV method error paths (DELETE 404, COPY 400/502/403/404, MOVE-replace, PROPFIND 404/finite-depth) ([`d959354`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/d959354d6e0ae3222ca188e0dd67007fe2049a05))
- cover scratch_alloc align==0 default-alignment branch (->100%) ([`55825dd`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/55825ddf30394f6ccbd6425a3e91d75135195b4c))
...
- cover literal-name/Huffman encode edges + decode error paths (->98%) ([`3c9c398`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/3c9c398a8b10571e262e5e9f6afaaf0a0b189d31))
...
- parse_open truncation guards + annotate dead internals -> 100% ([`4e52594`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4e525943158a328952231108ff68bbfdceca2333))
- reject malformed DataValue + AdditionalHeader underrun (99%) ([`a57af3a`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/a57af3af689ff41a0276ec7ebe3f7d66e261583b))
- parse_write truncated-item/IndexRange + parse_open wrong TypeId ([`4e6f9ca`](https://github.com/dstroy0/DeterministicESPAsyncWebServer/commit/4e6f9ca32fe411c90c3de8418bd3a69bc74cdc9c))
