...
| `ACCEPT_THROTTLE` | `L4-Transport/02.AcceptThrottle` | 750,865 | 65,992 |
| `core/02.CORS` | `L7-Application/02.CORS` | 751,025 | 65,984 |
| `RADIO_POWER+RADIO_WIFI_PS` | `L7-Application/47.RadioPower` | 751,093 | 65,984 |
| `core/04.BasicAuth` | `L6-Presentation/04.BasicAuth` | 751,093 | 65,984 |
| `core/05.DigestAuth` | `L6-Presentation/05.DigestAuth` | 751,209 | 65,984 |
| `DIAG` | `L7-Application/20.Diagnostics` | 751,261 | 65,984 |
| `core/06.RegexRoutes` | `L7-Application/06.RegexRoutes` | 751,329 | 65,984 |
| `PER_IP_THROTTLE` | `L4-Transport/05.PerIpThrottle` | 751,393 | 66,432 |
| `DEVICE_ID` | `L7-Application/32.DeviceUuid` | 751,425 | 66,024 |
| `core/05.PathParams` | `L7-Application/05.PathParams` | 751,429 | 65,984 |
| `core/09.WebSocket` | `L6-Presentation/09.WebSocket` | 751,473 | 65,984 |
| `GUARDRAILS` | `L7-Application/40.Guardrails` | 751,561 | 65,984 |
| `core/07.ResponseHeaders` | `L7-Application/07.ResponseHeaders` | 751,577 | 65,984 |
| `core/04.Middleware` | `L7-Application/04.Middleware` | 751,669 | 65,984 |
| `core/08.ServerSentEvents` | `L6-Presentation/08.ServerSentEvents` | 751,705 | 65,992 |
| `core/01.ChunkedResponse` | `L7-Application/01.ChunkedResponse` | 751,717 | 65,992 |
| `KEEPALIVE` | `L4-Transport/01.KeepAlive` | 751,725 | 65,992 |
| `core/36.NetEgress` | `L7-Application/36.NetEgress` | 751,729 | 65,984 |
| `PARTITION_MONITOR` | `L7-Application/37.PartitionMonitor` | 751,769 | 65,984 |
| `core/01.FormParams` | `L6-Presentation/01.FormParams` | 751,865 | 65,984 |
| `OTA_ROLLBACK` | `L7-Application/44.OtaRollback` | 752,081 | 65,984 |
| `AUTH_LOCKOUT` | `L6-Presentation/12.AuthLockout` | 752,105 | 66,560 |
| `core/03.Multipart` | `L6-Presentation/03.Multipart` | 752,165 | 65,984 |
| `TOTP` | `L7-Application/45.Totp` | 752,221 | 66,016 |
| `IP_ALLOWLIST` | `L4-Transport/07.IpAllowlist` | 752,401 | 65,984 |
| `CSRF` | `L7-Application/33.Csrf` | 752,485 | 66,032 |
| `LOGBUF` | `L7-Application/41.LogBuffer` | 752,525 | 69,104 |
| `core/03.InterfaceFilter` | `L7-Application/03.InterfaceFilter` | 752,685 | 65,984 |
| `MODBUS` | `L7-Application/30.ModbusTcp` | 752,781 | 66,256 |
| `core/08.Templating` | `L7-Application/08.Templating` | 752,853 | 66,016 |
| `STATS` | `L7-Application/22.Stats` | 752,921 | 66,080 |
| `MODBUS+MODBUS_MASTER` | `L7-Application/43.ModbusScan` | 753,109 | 66,256 |
| `core/01.Basic` | `Foundation/01.Basic` | 753,125 | 65,984 |
| `JWT` | `L6-Presentation/06.JWTAuth` | 753,213 | 66,560 |
| `TELNET` | `L5-Session/03.Telnet` | 753,313 | 66,512 |
| `AUDIT_LOG` | `L7-Application/49.AuditLog` | 753,317 | 68,968 |
| `CBOR` | `L6-Presentation/13.Cbor` | 753,325 | 66,056 |
| `IPV6` | `Foundation/20.IPv6` | 753,509 | 65,984 |
| `core/03.Expert` | `Foundation/03.Expert` | 753,773 | 66,000 |
| `SYSLOG` | `L7-Application/19.Syslog` | 754,437 | 67,840 |
| `MSGPACK` | `L6-Presentation/14.MsgPack` | 754,617 | 66,056 |
| `STATS+METRICS` | `L7-Application/21.PrometheusMetrics` | 755,049 | 66,120 |
| `core/02.Json` | `L6-Presentation/02.Json` | 755,129 | 65,984 |
| `GPIO_MAP` | `L7-Application/38.GpioMap` | 755,313 | 66,040 |
| `WS_DEFLATE` | `L6-Presentation/11.WebSocketCompression` | 755,697 | 74,184 |
| `WEB_TERMINAL` | `L6-Presentation/10.WebTerminal` | 755,813 | 66,064 |
| `GRAPHQL` | `L7-Application/52.GraphQL` | 755,933 | 70,384 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/42.ConfigExport` | 756,001 | 66,044 |
| `OTA` | `L7-Application/16.OTA` | 756,317 | 102,112 |
| `COAP` | `L7-Application/13.CoAP` | 756,697 | 68,496 |
| `DNS_RESOLVER` | `L7-Application/48.DnsResolver` | 757,017 | 67,264 |
| `PROVISIONING` | `L7-Application/17.Provisioning` | 758,641 | 67,548 |
| `OPCUA` | `L7-Application/55.OpcUa` | 758,985 | 76,272 |
| `core/02.Advanced` | `Foundation/02.Advanced` | 759,777 | 66,096 |
| `SNMP` | `L7-Application/14.SNMP` | 759,853 | 78,384 |
| `TELEMETRY` | `L7-Application/34.Telemetry` | 759,889 | 66,300 |
| `RELAY` | `L7-Application/70.PortForward` | 760,965 | 100,600 |
| `HTTP_CLIENT+WEBHOOK` | `L7-Application/46.Webhook` | 761,545 | 85,736 |
...
| `core/04.Sysadmin` | `Foundation/04.Sysadmin` | 764,985 | 65,992 |
...
| `DASHBOARD` | `L7-Application/35.Dashboard` | 771,801 | 66,352 |
| `NTP+TIME_SOURCE` | `L7-Application/31.TimeSourceFallback` | 772,245 | 67,596 |
| `MDNS` | `L7-Application/15.mDNS` | 776,505 | 67,888 |
| `NTP` | `L7-Application/18.SNTP` | 776,757 | 68,536 |
| `OPCUA+OPCUA_CLIENT` | `L7-Application/56.OpcUaClient` | 781,925 | 80,128 |
| `ETHERNET` | `Foundation/19.Ethernet` | 789,661 | 66,028 |
| `core/10.FileServing` | `L7-Application/10.FileServing` | 792,413 | 66,016 |
| `UPLOAD` | `L7-Application/11.FileUpload` | 793,549 | 71,208 |
| `RANGE` | `L7-Application/12.Range` | 793,665 | 66,016 |
| `VFS` | `L7-Application/51.Vfs` | 794,613 | 70,512 |
| `WEBDAV` | `L7-Application/29.WebDav` | 820,421 | 105,352 |
| `SSH` | `L5-Session/03.SSHHostKey` | 820,977 | 88,308 |
| `ETAG` | `L7-Application/09.ETag` | 827,201 | 67,288 |
| `WS_CLIENT+TLS+WS_CLIENT_TLS` | `L7-Application/25.WebSocketClient` | 831,333 | 120,548 |
| `TLS` | `L6-Presentation/07.SecureWebSocket` | 855,133 | 116,900 |
| `TLS+TLS_RESUMPTION` | `L4-Transport/06.TlsResumption` | 856,005 | 117,060 |
| `TLS+MTLS` | `L4-Transport/04.mTLS` | 856,117 | 117,236 |
