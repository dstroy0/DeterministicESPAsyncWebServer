...
| `ACCEPT_THROTTLE` | `L4-Transport/02.AcceptThrottle` | 751,169 | 65,984 |
| `core/02.CORS` | `L7-Application/02.CORS` | 751,313 | 65,976 |
| `RADIO_POWER+RADIO_WIFI_PS` | `L7-Application/47.RadioPower` | 751,389 | 65,976 |
| `core/04.BasicAuth` | `L6-Presentation/04.BasicAuth` | 751,393 | 65,976 |
| `core/05.DigestAuth` | `L6-Presentation/05.DigestAuth` | 751,521 | 65,976 |
| `DIAG` | `L7-Application/20.Diagnostics` | 751,561 | 65,976 |
| `core/06.RegexRoutes` | `L7-Application/06.RegexRoutes` | 751,645 | 65,976 |
| `PER_IP_THROTTLE` | `L4-Transport/05.PerIpThrottle` | 751,709 | 66,424 |
| `DEVICE_ID` | `L7-Application/32.DeviceUuid` | 751,741 | 66,016 |
| `core/05.PathParams` | `L7-Application/05.PathParams` | 751,745 | 65,976 |
| `core/09.WebSocket` | `L6-Presentation/09.WebSocket` | 751,769 | 65,976 |
| `GUARDRAILS` | `L7-Application/40.Guardrails` | 751,877 | 65,992 |
| `core/07.ResponseHeaders` | `L7-Application/07.ResponseHeaders` | 751,893 | 65,976 |
| `core/04.Middleware` | `L7-Application/04.Middleware` | 751,969 | 65,984 |
| `KEEPALIVE` | `L4-Transport/01.KeepAlive` | 752,005 | 65,984 |
| `core/08.ServerSentEvents` | `L6-Presentation/08.ServerSentEvents` | 752,025 | 65,984 |
| `core/36.NetEgress` | `L7-Application/36.NetEgress` | 752,045 | 65,976 |
| `PARTITION_MONITOR` | `L7-Application/37.PartitionMonitor` | 752,089 | 65,984 |
| `core/01.ChunkedResponse` | `L7-Application/01.ChunkedResponse` | 752,097 | 65,992 |
| `core/01.FormParams` | `L6-Presentation/01.FormParams` | 752,169 | 65,976 |
| `OTA_ROLLBACK` | `L7-Application/44.OtaRollback` | 752,373 | 65,992 |
| `AUTH_LOCKOUT` | `L6-Presentation/12.AuthLockout` | 752,397 | 66,552 |
| `core/03.Multipart` | `L6-Presentation/03.Multipart` | 752,485 | 65,976 |
| `TOTP` | `L7-Application/45.Totp` | 752,541 | 66,016 |
| `IP_ALLOWLIST` | `L4-Transport/07.IpAllowlist` | 752,697 | 65,976 |
| `CSRF` | `L7-Application/33.Csrf` | 752,761 | 66,032 |
| `LOGBUF` | `L7-Application/41.LogBuffer` | 752,849 | 69,104 |
| `core/03.InterfaceFilter` | `L7-Application/03.InterfaceFilter` | 752,957 | 65,976 |
| `MODBUS` | `L7-Application/30.ModbusTcp` | 753,097 | 66,264 |
| `core/08.Templating` | `L7-Application/08.Templating` | 753,197 | 66,024 |
| `STATS` | `L7-Application/22.Stats` | 753,253 | 66,080 |
| `MODBUS+MODBUS_MASTER` | `L7-Application/43.ModbusScan` | 753,425 | 66,256 |
| `core/01.Basic` | `Foundation/01.Basic` | 753,429 | 65,992 |
| `JWT` | `L6-Presentation/06.JWTAuth` | 753,521 | 66,552 |
| `TELNET` | `L5-Session/03.Telnet` | 753,589 | 66,520 |
| `AUDIT_LOG` | `L7-Application/49.AuditLog` | 753,609 | 68,968 |
| `CBOR` | `L6-Presentation/13.Cbor` | 753,689 | 66,056 |
| `IPV6` | `Foundation/20.IPv6` | 753,813 | 65,976 |
| `core/03.Expert` | `Foundation/03.Expert` | 754,061 | 66,000 |
| `SYSLOG` | `L7-Application/19.Syslog` | 754,745 | 67,840 |
| `MSGPACK` | `L6-Presentation/14.MsgPack` | 754,969 | 66,056 |
| `STATS+METRICS` | `L7-Application/21.PrometheusMetrics` | 755,377 | 66,120 |
| `core/02.Json` | `L6-Presentation/02.Json` | 755,429 | 65,984 |
| `GPIO_MAP` | `L7-Application/38.GpioMap` | 755,629 | 66,040 |
| `WS_DEFLATE` | `L6-Presentation/11.WebSocketCompression` | 756,037 | 74,192 |
| `WEB_TERMINAL` | `L6-Presentation/10.WebTerminal` | 756,089 | 66,064 |
| `GRAPHQL` | `L7-Application/52.GraphQL` | 756,257 | 70,392 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/42.ConfigExport` | 756,317 | 66,044 |
| `OTA` | `L7-Application/16.OTA` | 756,645 | 102,112 |
| `COAP` | `L7-Application/13.CoAP` | 756,997 | 68,496 |
| `DNS_RESOLVER` | `L7-Application/48.DnsResolver` | 757,313 | 67,264 |
| `PROVISIONING` | `L7-Application/17.Provisioning` | 758,941 | 67,548 |
| `OPCUA` | `L7-Application/55.OpcUa` | 759,293 | 76,264 |
| `core/02.Advanced` | `Foundation/02.Advanced` | 760,077 | 66,088 |
| `SNMP` | `L7-Application/14.SNMP` | 760,149 | 78,384 |
| `TELEMETRY` | `L7-Application/34.Telemetry` | 760,197 | 66,300 |
| `RELAY` | `L7-Application/70.PortForward` | 761,277 | 100,592 |
| `HTTP_CLIENT+WEBHOOK` | `L7-Application/46.Webhook` | 761,885 | 85,736 |
| `OAUTH2+HTTP_CLIENT` | `L7-Application/54.OAuth2` | 764,189 | 88,800 |
| `PROMISC+FORWARD+ETHERNET` | `Foundation/21.WifiCapture` | 764,637 | 47,520 |
| `OIDC` | `L7-Application/50.OidcAuth` | 764,817 | 79,120 |
...
| `DASHBOARD` | `L7-Application/35.Dashboard` | 772,113 | 66,352 |
| `NTP+TIME_SOURCE` | `L7-Application/31.TimeSourceFallback` | 772,553 | 67,596 |
| `MDNS` | `L7-Application/15.mDNS` | 776,809 | 67,880 |
| `NTP` | `L7-Application/18.SNTP` | 777,069 | 68,528 |
| `OPCUA+OPCUA_CLIENT` | `L7-Application/56.OpcUaClient` | 782,233 | 80,136 |
| `ETHERNET` | `Foundation/19.Ethernet` | 789,981 | 66,028 |
| `core/10.FileServing` | `L7-Application/10.FileServing` | 792,701 | 66,016 |
| `UPLOAD` | `L7-Application/11.FileUpload` | 793,825 | 71,216 |
| `RANGE` | `L7-Application/12.Range` | 793,933 | 66,016 |
| `VFS` | `L7-Application/51.Vfs` | 794,913 | 70,504 |
| `WEBDAV` | `L7-Application/29.WebDav` | 820,673 | 105,352 |
| `SSH` | `L5-Session/03.SSHHostKey` | 821,221 | 88,316 |
| `ETAG` | `L7-Application/09.ETag` | 827,453 | 67,288 |
| `WS_CLIENT+TLS+WS_CLIENT_TLS` | `L7-Application/25.WebSocketClient` | 831,333 | 120,548 |
| `TLS` | `L6-Presentation/07.SecureWebSocket` | 855,441 | 116,900 |
| `TLS+TLS_RESUMPTION` | `L4-Transport/06.TlsResumption` | 856,245 | 117,060 |
| `TLS+MTLS` | `L4-Transport/04.mTLS` | 856,385 | 117,236 |
