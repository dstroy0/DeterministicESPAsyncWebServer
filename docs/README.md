...
| `DNS_SERVER` | `L7-Application/DnsServer` | 725,677 | 45,976 |
| `COAP+COAP_BLOCK+COAP_MAX_PAYLOAD` | `L7-Application/CoapBlock` | 727,557 | 48,352 |
| `UDP_TELEMETRY` | `L7-Application/UdpTelemetry` | 728,137 | 44,944 |
| `SNMP+SNMP_TRAP` | `L7-Application/SnmpTrap` | 728,417 | 44,928 |
| `STATSD` | `L7-Application/StatsdMetrics` | 728,425 | 45,088 |
| `COAP+COAP_OBSERVE` | `L7-Application/CoapObserve` | 729,369 | 46,104 |
| `ESPNOW` | `L7-Application/EspNow` | 731,293 | 43,576 |
| `DNC` | `L7-Application/EthernetDnc` | 733,857 | 61,112 |
| `HTTP_CLIENT` | `L7-Application/HttpClient` | 734,557 | 63,160 |
...
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/ConfigExport` | 757,329 | 81,852 |
| `OTA` | `L7-Application/OTA` | 757,669 | 102,128 |
| `COAP` | `L7-Application/CoAP` | 757,985 | 84,296 |
...
| `ADS` | `L7-Application/AdsClient` | 771,933 | 45,440 |
| `DASHBOARD` | `L7-Application/Dashboard` | 773,173 | 82,152 |
| `NTP+TIME_SOURCE` | `L7-Application/TimeSourceFallback` | 773,549 | 83,404 |
| `EDGE_CACHE+HTTP_CACHE+HTTP_CLIENT` | `L7-Application/EdgeCache` | 773,689 | 119,264 |
| `MDNS` | `L7-Application/mDNS` | 777,813 | 83,688 |
| `NTP` | `L7-Application/SNTP` | 778,057 | 84,336 |
| `EDGE_CACHE+HTTP_CACHE+HTTP_CLIENT+EDGE_MESH+EDGE_CACHE_SLOTS+EDGE_FETCH_SLOTS+MESH_MAX_PEERS` | `L7-Application/MeshCache` | 778,289 | 115,320 |
| `EDGE_CACHE+HTTP_CACHE+HTTP_CLIENT+EDGE_MESH` | `L7-Application/MeshCache` | 778,433 | 124,240 |
| `IFACE_BRIDGE` | `L7-Application/InterfaceBridge` | 780,393 | 82,632 |
| `COAP+DTLS` | `L7-Application/CoapSecure` | 780,501 | 102,864 |
| `OPCUA+OPCUA_CLIENT` | `L7-Application/OpcUaClient` | 783,445 | 95,936 |
| `ETHERNET` | `Peripherals/Ethernet` | 791,209 | 81,836 |
| `ETHERNET+ETH_W5500+ETH_W5500_CS+ETH_W5500_RST+ETH_W5500_INT+ETH_W5500_SCK+ETH_W5500_MISO+ETH_W5500_MOSI` | `Peripherals/EthernetW5500` | 791,225 | 81,836 |
| `core/FileServing` | `L7-Application/FileServing` | 793,713 | 81,824 |
| `UPLOAD` | `L7-Application/FileUpload` | 794,853 | 91,128 |
| `RANGE` | `L7-Application/Range` | 795,005 | 81,824 |
| `VFS` | `L7-Application/Vfs` | 795,973 | 86,312 |
...
| `TLS+TLS_ARENA_SIZE` | `L6-Presentation/SecureWebSocket` | 856,485 | 105,652 |
| `TLS+TLS_RESUMPTION` | `L4-Transport/TlsResumption` | 856,693 | 122,180 |
| `TLS+MTLS` | `L4-Transport/mTLS` | 856,829 | 122,356 |
| `TLS+TLS_RESUMPTION+TLS_ARENA_SIZE` | `L4-Transport/TlsResumption` | 857,325 | 105,812 |
| `TLS+MTLS+TLS_ARENA_SIZE` | `L4-Transport/mTLS` | 857,497 | 105,988 |
| `SSH+FILE_SERVING+SSH_SFTP+SSH_SCP` | `L5-Session/SSHSftp` | 881,025 | 118,508 |
