...
| `ACCEPT_THROTTLE` | `L4-Transport/AcceptThrottle` | 752,669 | 81,788 |
| `core/CORS` | `L7-Application/CORS` | 752,833 | 81,780 |
| `core/DigestAuth` | `L6-Presentation/DigestAuth` | 752,893 | 81,780 |
| `core/BasicAuth` | `L6-Presentation/BasicAuth` | 752,905 | 81,780 |
| `RADIO_POWER+RADIO_WIFI_PS` | `L7-Application/RadioPower` | 752,917 | 81,780 |
| `core/MediaStreaming` | `L7-Application/MediaStreaming` | 752,969 | 81,780 |
| `core/RegexRoutes` | `L7-Application/RegexRoutes` | 753,009 | 81,780 |
| `KEEPALIVE` | `L4-Transport/KeepAlive` | 753,053 | 81,780 |
| `DIFFSERV` | `L4-Transport/DiffServ` | 753,085 | 81,780 |
| `DEVICE_ID` | `L7-Application/DeviceUuid` | 753,097 | 81,820 |
| `core/PathParams` | `L7-Application/PathParams` | 753,129 | 81,780 |
| `GUARDRAILS` | `L7-Application/Guardrails` | 753,209 | 81,796 |
| `PER_IP_THROTTLE` | `L4-Transport/PerIpThrottle` | 753,229 | 82,228 |
| `core/ResponseHeaders` | `L7-Application/ResponseHeaders` | 753,261 | 81,780 |
| `core/WebSocket` | `L6-Presentation/WebSocket` | 753,277 | 81,780 |
| `ADS` | `L7-Application/AdsClient` | 753,317 | 44,204 |
| `core/Middleware` | `L7-Application/Middleware` | 753,361 | 81,788 |
| `core/ChunkedResponse` | `L7-Application/ChunkedResponse` | 753,485 | 81,796 |
| `DIAG` | `L7-Application/Diagnostics` | 753,521 | 81,780 |
| `core/ServerSentEvents` | `L6-Presentation/ServerSentEvents` | 753,525 | 81,788 |
| `core/NetEgress` | `L7-Application/NetEgress` | 753,561 | 81,780 |
| `core/FormParams` | `L6-Presentation/FormParams` | 753,581 | 81,780 |
| `PARTITION_MONITOR` | `L7-Application/PartitionMonitor` | 753,621 | 81,788 |
| `OTA_ROLLBACK` | `L7-Application/OtaRollback` | 753,897 | 81,796 |
| `AUTH_LOCKOUT` | `L6-Presentation/AuthLockout` | 753,993 | 82,356 |
| `TOTP` | `L7-Application/Totp` | 754,041 | 81,820 |
| `core/Multipart` | `L6-Presentation/Multipart` | 754,065 | 81,780 |
| `LOGBUF` | `L7-Application/LogBuffer` | 754,237 | 84,908 |
| `IP_ALLOWLIST` | `L4-Transport/IpAllowlist` | 754,277 | 81,780 |
| `core/InterfaceFilter` | `L7-Application/InterfaceFilter` | 754,509 | 81,780 |
| `CSRF` | `L7-Application/Csrf` | 754,545 | 81,836 |
| `core/Templating` | `L7-Application/Templating` | 754,557 | 81,828 |
| `MODBUS` | `L7-Application/ModbusTcp` | 754,561 | 82,068 |
| `SPA_ROUTER` | `L7-Application/SpaFallback` | 754,661 | 81,780 |
| `STATS` | `L7-Application/Stats` | 754,793 | 81,884 |
| `CONTROL` | `L7-Application/PidTuning` | 754,953 | 89,860 |
| `core/Basic` | `Foundation/Basic` | 755,029 | 81,796 |
| `MODBUS+MODBUS_MASTER` | `L7-Application/ModbusScan` | 755,049 | 82,060 |
| `JWT` | `L6-Presentation/JWTAuth` | 755,133 | 82,932 |
| `TELNET` | `L5-Session/Telnet` | 755,213 | 82,324 |
| `CBOR` | `L6-Presentation/Cbor` | 755,297 | 81,860 |
| `AUDIT_LOG` | `L7-Application/AuditLog` | 755,321 | 84,772 |
| `IPV6` | `Foundation/IPv6` | 755,541 | 81,780 |
| `core/Expert` | `Foundation/Expert` | 755,721 | 81,804 |
| `SYSLOG` | `L7-Application/Syslog` | 756,549 | 83,692 |
| `MSGPACK` | `L6-Presentation/MsgPack` | 756,701 | 81,860 |
| `STATS+METRICS` | `L7-Application/PrometheusMetrics` | 756,801 | 81,924 |
| `core/Json` | `L6-Presentation/Json` | 756,981 | 81,788 |
| `AUTH_LOCKOUT+FORWARDED_TRUST` | `L6-Presentation/ForwardedTrust` | 757,193 | 82,396 |
| `GPIO_MAP` | `L7-Application/GpioMap` | 757,369 | 81,844 |
| `WEB_TERMINAL` | `L6-Presentation/WebTerminal` | 757,633 | 81,868 |
| `WS_DEFLATE` | `L6-Presentation/WebSocketCompression` | 757,689 | 89,996 |
| `GRAPHQL` | `L7-Application/GraphQL` | 757,777 | 86,196 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/ConfigExport` | 757,869 | 81,848 |
| `OTA` | `L7-Application/OTA` | 758,437 | 102,132 |
| `COAP` | `L7-Application/CoAP` | 758,873 | 84,348 |
| `DNS_RESOLVER` | `L7-Application/DnsResolver` | 759,037 | 83,068 |
| `PROVISIONING` | `L7-Application/Provisioning` | 761,213 | 83,416 |
| `OPCUA` | `L7-Application/OpcUa` | 761,325 | 92,068 |
| `core/Advanced` | `Foundation/Advanced` | 761,677 | 81,892 |
| `TELEMETRY` | `L7-Application/Telemetry` | 761,949 | 82,104 |
| `SNMP` | `L7-Application/SNMP` | 762,193 | 94,236 |
| `RELAY` | `L7-Application/PortForward` | 762,789 | 116,396 |
| `HTTP_CLIENT+WEBHOOK` | `L7-Application/Webhook` | 763,589 | 101,540 |
| `OPCUA+OPCUA_CLIENT` | `L7-Application/OpcUaClient` | 765,729 | 94,684 |
| `OAUTH2+HTTP_CLIENT` | `L7-Application/OAuth2` | 765,937 | 104,604 |
| `PROMISC+FORWARD+ETHERNET` | `Peripherals/WifiCapture` | 766,049 | 47,584 |
| `core/Sysadmin` | `Foundation/Sysadmin` | 766,833 | 81,796 |
| `OIDC` | `L7-Application/OidcAuth` | 766,877 | 99,844 |
| `RTC+TIME_SOURCE+NTP` | `Drivers/Rtc` | 767,001 | 45,388 |
| `OPCUA+UMATI` | `L7-Application/Umati` | 767,897 | 92,212 |
| `NTRIP_CASTER` | `L7-Application/NtripCaster` | 770,905 | 84,704 |
| `BUS_CAPTURE+FORWARD+ETHERNET` | `Peripherals/CanCapture` | 771,997 | 45,568 |
| `DASHBOARD` | `L7-Application/Dashboard` | 773,801 | 82,156 |
| `EDGE_CACHE+HTTP_CACHE+HTTP_CLIENT` | `L7-Application/EdgeCache` | 774,101 | 119,268 |
| `NTP+TIME_SOURCE` | `L7-Application/TimeSourceFallback` | 774,361 | 83,396 |
| `EDGE_CACHE+HTTP_CACHE+HTTP_CLIENT+EDGE_MESH` | `L7-Application/MeshCache` | 778,433 | 124,240 |
| `MDNS` | `L7-Application/mDNS` | 778,461 | 83,688 |
| `EDGE_CACHE+HTTP_CACHE+HTTP_CLIENT+EDGE_MESH+EDGE_CACHE_SLOTS+EDGE_FETCH_SLOTS+MESH_MAX_PEERS` | `L7-Application/MeshCache` | 778,629 | 115,324 |
| `NTP` | `L7-Application/SNTP` | 778,877 | 84,328 |
| `MDNS+PROMISC+WIFI_SNIFFER+MDNS_ADAPTIVE` | `L7-Application/MdnsAdaptive` | 780,533 | 83,776 |
| `IFACE_BRIDGE` | `L7-Application/InterfaceBridge` | 781,005 | 82,628 |
| `COAP+DTLS` | `L7-Application/CoapSecure` | 781,305 | 102,924 |
| `ETHERNET` | `Peripherals/Ethernet` | 792,213 | 81,840 |
| `ETHERNET+ETH_W5500+ETH_W5500_CS+ETH_W5500_RST+ETH_W5500_INT+ETH_W5500_SCK+ETH_W5500_MISO+ETH_W5500_MOSI` | `Peripherals/EthernetW5500` | 792,245 | 81,840 |
| `core/FileServing` | `L7-Application/FileServing` | 794,377 | 81,820 |
| `UPLOAD` | `L7-Application/FileUpload` | 795,325 | 101,956 |
| `RANGE` | `L7-Application/Range` | 795,525 | 81,820 |
| `VFS` | `L7-Application/Vfs` | 796,557 | 86,308 |
| `WEBDAV` | `L7-Application/WebDav` | 821,069 | 105,352 |
| `WEBDAV+WEBDAV_MAX_ENTRIES+WEBDAV_BUF_SIZE` | `L7-Application/WebDav` | 822,465 | 90,852 |
| `ETAG` | `L7-Application/ETag` | 829,245 | 83,084 |
| `SSH` | `L5-Session/SSHHostKey` | 831,033 | 109,208 |
...
| `HOTSWAP` | `L7-Application/HotSwapStorage` | 838,665 | 82,720 |
| `EXC_DECODER+FTP+FTP_SESSION` | `L7-Application/CoreDump` | 841,417 | 83,420 |
| `HTTP_DELIVERY+FILE_SERVING+RANGE` | `L7-Application/HttpDelivery` | 842,945 | 82,696 |
| `SSH+SSH_CLIENT+SSH_CLIENT_MAX_CHANNELS+CLIENT_RX_BUF` | `L5-Session/SSHReverseTunnel` | 846,437 | 110,960 |
...
| `TLS+TLS_ARENA_SIZE` | `L6-Presentation/SecureWebSocket` | 857,625 | 105,664 |
| `TLS+TLS_RESUMPTION+TLS_ARENA_SIZE` | `L4-Transport/TlsResumption` | 858,533 | 105,824 |
| `TLS+MTLS+TLS_ARENA_SIZE` | `L4-Transport/mTLS` | 858,629 | 106,000 |
| `POWER_MGMT` | `L7-Application/PowerGovernor` | 881,357 | 85,640 |
| `SSH+FILE_SERVING+SSH_SFTP+SSH_SCP` | `L5-Session/SSHSftp` | 883,261 | 118,560 |
