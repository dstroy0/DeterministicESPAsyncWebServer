...
| `ACCEPT_THROTTLE` | `L4-Transport/AcceptThrottle` | 753,157 | 81,828 |
...
| `DIFFSERV` | `L4-Transport/DiffServ` | 753,625 | 81,820 |
...
| `core/ChunkedResponse` | `L7-Application/ChunkedResponse` | 753,985 | 81,836 |
...
| `core/InterfaceFilter` | `L7-Application/InterfaceFilter` | 755,013 | 81,820 |
| `CSRF` | `L7-Application/Csrf` | 755,069 | 81,876 |
| `core/Templating` | `L7-Application/Templating` | 755,073 | 81,868 |
...
| `WS_DEFLATE` | `L6-Presentation/WebSocketCompression` | 758,177 | 90,028 |
...
| `TLS+TLS_ARENA_SIZE` | `L6-Presentation/SecureWebSocket` | 858,297 | 105,680 |
| `TLS+TLS_RESUMPTION+TLS_ARENA_SIZE` | `L4-Transport/TlsResumption` | 859,065 | 105,840 |
| `TLS+MTLS+TLS_ARENA_SIZE` | `L4-Transport/mTLS` | 859,145 | 106,016 |
