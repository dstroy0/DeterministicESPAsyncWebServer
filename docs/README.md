...
| `ACCEPT_THROTTLE` | `L4-Transport/02.AcceptThrottle` | 750,969 | 65,984 |
| `core/02.CORS` | `L7-Application/02.CORS` | 751,113 | 65,976 |
| `core/04.BasicAuth` | `L6-Presentation/04.BasicAuth` | 751,185 | 65,976 |
| `RADIO_POWER+RADIO_WIFI_PS` | `L7-Application/47.RadioPower` | 751,189 | 65,976 |
| `core/05.DigestAuth` | `L6-Presentation/05.DigestAuth` | 751,321 | 65,976 |
| `DIAG` | `L7-Application/20.Diagnostics` | 751,361 | 65,976 |
| `core/06.RegexRoutes` | `L7-Application/06.RegexRoutes` | 751,441 | 65,976 |
| `PER_IP_THROTTLE` | `L4-Transport/05.PerIpThrottle` | 751,501 | 66,424 |
| `DEVICE_ID` | `L7-Application/32.DeviceUuid` | 751,533 | 66,016 |
| `core/05.PathParams` | `L7-Application/05.PathParams` | 751,541 | 65,976 |
| `core/09.WebSocket` | `L6-Presentation/09.WebSocket` | 751,569 | 65,976 |
| `GUARDRAILS` | `L7-Application/40.Guardrails` | 751,669 | 65,992 |
| `core/07.ResponseHeaders` | `L7-Application/07.ResponseHeaders` | 751,689 | 65,976 |
| `core/04.Middleware` | `L7-Application/04.Middleware` | 751,765 | 65,984 |
| `KEEPALIVE` | `L4-Transport/01.KeepAlive` | 751,801 | 65,984 |
| `core/08.ServerSentEvents` | `L6-Presentation/08.ServerSentEvents` | 751,821 | 65,984 |
| `core/36.NetEgress` | `L7-Application/36.NetEgress` | 751,841 | 65,976 |
| `PARTITION_MONITOR` | `L7-Application/37.PartitionMonitor` | 751,885 | 65,984 |
| `core/01.ChunkedResponse` | `L7-Application/01.ChunkedResponse` | 751,897 | 65,992 |
| `core/01.FormParams` | `L6-Presentation/01.FormParams` | 751,969 | 65,976 |
| `OTA_ROLLBACK` | `L7-Application/44.OtaRollback` | 752,177 | 65,992 |
| `AUTH_LOCKOUT` | `L6-Presentation/12.AuthLockout` | 752,213 | 66,552 |
| `core/03.Multipart` | `L6-Presentation/03.Multipart` | 752,281 | 65,976 |
| `TOTP` | `L7-Application/45.Totp` | 752,337 | 66,016 |
| `IP_ALLOWLIST` | `L4-Transport/07.IpAllowlist` | 752,489 | 65,976 |
| `CSRF` | `L7-Application/33.Csrf` | 752,561 | 66,032 |
| `LOGBUF` | `L7-Application/41.LogBuffer` | 752,641 | 69,104 |
| `core/03.InterfaceFilter` | `L7-Application/03.InterfaceFilter` | 752,749 | 65,976 |
| `MODBUS` | `L7-Application/30.ModbusTcp` | 752,893 | 66,264 |
| `core/08.Templating` | `L7-Application/08.Templating` | 752,993 | 66,024 |
| `STATS` | `L7-Application/22.Stats` | 753,041 | 66,080 |
| `MODBUS+MODBUS_MASTER` | `L7-Application/43.ModbusScan` | 753,225 | 66,256 |
| `core/01.Basic` | `Foundation/01.Basic` | 753,229 | 65,992 |
| `JWT` | `L6-Presentation/06.JWTAuth` | 753,325 | 66,552 |
| `AUDIT_LOG` | `L7-Application/49.AuditLog` | 753,405 | 68,968 |
| `TELNET` | `L5-Session/03.Telnet` | 753,417 | 66,520 |
| `CBOR` | `L6-Presentation/13.Cbor` | 753,477 | 66,056 |
| `IPV6` | `Foundation/20.IPv6` | 753,613 | 65,976 |
| `core/03.Expert` | `Foundation/03.Expert` | 753,889 | 66,000 |
| `SYSLOG` | `L7-Application/19.Syslog` | 754,545 | 67,840 |
| `MSGPACK` | `L6-Presentation/14.MsgPack` | 754,765 | 66,056 |
| `STATS+METRICS` | `L7-Application/21.PrometheusMetrics` | 755,177 | 66,120 |
| `core/02.Json` | `L6-Presentation/02.Json` | 755,221 | 65,984 |
| `GPIO_MAP` | `L7-Application/38.GpioMap` | 755,425 | 66,040 |
| `WS_DEFLATE` | `L6-Presentation/11.WebSocketCompression` | 755,829 | 74,192 |
| `WEB_TERMINAL` | `L6-Presentation/10.WebTerminal` | 755,913 | 66,064 |
| `GRAPHQL` | `L7-Application/52.GraphQL` | 756,053 | 70,392 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/42.ConfigExport` | 756,117 | 66,044 |
| `OTA` | `L7-Application/16.OTA` | 756,445 | 102,112 |
| `COAP` | `L7-Application/13.CoAP` | 756,805 | 68,496 |
| `DNS_RESOLVER` | `L7-Application/48.DnsResolver` | 757,113 | 67,264 |
| `PROVISIONING` | `L7-Application/17.Provisioning` | 758,745 | 67,548 |
| `OPCUA` | `L7-Application/55.OpcUa` | 759,093 | 76,264 |
| `core/02.Advanced` | `Foundation/02.Advanced` | 759,885 | 66,088 |
| `SNMP` | `L7-Application/14.SNMP` | 759,945 | 78,384 |
| `TELEMETRY` | `L7-Application/34.Telemetry` | 759,997 | 66,300 |
| `RELAY` | `L7-Application/70.PortForward` | 761,077 | 100,592 |
| `HTTP_CLIENT+WEBHOOK` | `L7-Application/46.Webhook` | 761,677 | 85,736 |
| `OAUTH2+HTTP_CLIENT` | `L7-Application/54.OAuth2` | 763,985 | 88,800 |
| `OIDC` | `L7-Application/50.OidcAuth` | 764,609 | 79,120 |
| `PROMISC+FORWARD+ETHERNET` | `Foundation/21.WifiCapture` | 764,637 | 47,520 |
| `core/04.Sysadmin` | `Foundation/04.Sysadmin` | 765,105 | 65,992 |
...
| `DASHBOARD` | `L7-Application/35.Dashboard` | 771,913 | 66,352 |
| `NTP+TIME_SOURCE` | `L7-Application/31.TimeSourceFallback` | 772,353 | 67,596 |
| `MDNS` | `L7-Application/15.mDNS` | 776,613 | 67,880 |
| `NTP` | `L7-Application/18.SNTP` | 776,869 | 68,528 |
| `OPCUA+OPCUA_CLIENT` | `L7-Application/56.OpcUaClient` | 782,029 | 80,136 |
| `ETHERNET` | `Foundation/19.Ethernet` | 789,777 | 66,028 |
| `core/10.FileServing` | `L7-Application/10.FileServing` | 792,497 | 66,016 |
| `UPLOAD` | `L7-Application/11.FileUpload` | 793,621 | 71,216 |
| `RANGE` | `L7-Application/12.Range` | 793,749 | 66,016 |
| `VFS` | `L7-Application/51.Vfs` | 794,677 | 70,504 |
| `WEBDAV` | `L7-Application/29.WebDav` | 820,469 | 105,352 |
| `SSH` | `L5-Session/03.SSHHostKey` | 821,017 | 88,316 |
| `ETAG` | `L7-Application/09.ETag` | 827,249 | 67,288 |
| `WS_CLIENT+TLS+WS_CLIENT_TLS` | `L7-Application/25.WebSocketClient` | 831,333 | 120,548 |
| `TLS` | `L6-Presentation/07.SecureWebSocket` | 855,237 | 116,900 |
| `TLS+TLS_RESUMPTION` | `L4-Transport/06.TlsResumption` | 856,065 | 117,060 |
| `TLS+MTLS` | `L4-Transport/04.mTLS` | 856,205 | 117,236 |
