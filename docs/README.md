...
| `DMA+PREEMPT_QUEUE+DMA_SIMULATE` | `Foundation/07.DmaIngest` | 269,393 | 28,600 |
| `core/02.SSHCryptoSelfTest` | `L5-Session/02.SSHCryptoSelfTest` | 269,537 | 21,476 |
| `DMA+PREEMPT_QUEUE+FORWARD+DMA_SIMULATE` | `Foundation/09.InterfaceForward` | 270,445 | 28,896 |
...
| `DNS_SERVER` | `L7-Application/60.DnsServer` | 725,649 | 45,976 |
| `SMTP` | `L7-Application/57.SmtpAlert` | 726,893 | 43,408 |
| `COAP+COAP_BLOCK+COAP_MAX_PAYLOAD` | `L7-Application/28.CoapBlock` | 727,537 | 48,352 |
| `UDP_TELEMETRY` | `L7-Application/39.UdpTelemetry` | 727,905 | 44,944 |
| `STATSD` | `L7-Application/59.StatsdMetrics` | 728,385 | 45,088 |
...
| `HTTP_CLIENT` | `L7-Application/23.HttpClient` | 734,465 | 63,160 |
| `MQTT` | `L7-Application/24.MqttClient` | 736,117 | 65,320 |
| `NTP_SERVER+TIME_SOURCE+NMEA0183+NTP` | `L7-Application/58.NtpServer` | 748,041 | 46,668 |
| `ACCEPT_THROTTLE` | `L4-Transport/02.AcceptThrottle` | 750,861 | 66,360 |
| `core/02.CORS` | `L7-Application/02.CORS` | 751,029 | 66,352 |
| `RADIO_POWER+RADIO_WIFI_PS` | `L7-Application/47.RadioPower` | 751,057 | 66,352 |
| `core/04.BasicAuth` | `L6-Presentation/04.BasicAuth` | 751,101 | 66,352 |
| `core/05.DigestAuth` | `L6-Presentation/05.DigestAuth` | 751,221 | 66,352 |
| `DIAG` | `L7-Application/20.Diagnostics` | 751,257 | 66,352 |
| `core/06.RegexRoutes` | `L7-Application/06.RegexRoutes` | 751,337 | 66,352 |
| `PER_IP_THROTTLE` | `L4-Transport/05.PerIpThrottle` | 751,401 | 66,800 |
| `DEVICE_ID` | `L7-Application/32.DeviceUuid` | 751,433 | 66,392 |
| `core/05.PathParams` | `L7-Application/05.PathParams` | 751,437 | 66,352 |
| `core/09.WebSocket` | `L6-Presentation/09.WebSocket` | 751,493 | 66,352 |
| `GUARDRAILS` | `L7-Application/40.Guardrails` | 751,581 | 66,360 |
| `core/07.ResponseHeaders` | `L7-Application/07.ResponseHeaders` | 751,585 | 66,352 |
| `core/04.Middleware` | `L7-Application/04.Middleware` | 751,689 | 66,360 |
| `core/01.ChunkedResponse` | `L7-Application/01.ChunkedResponse` | 751,741 | 66,368 |
| `core/08.ServerSentEvents` | `L6-Presentation/08.ServerSentEvents` | 751,745 | 66,360 |
| `core/36.NetEgress` | `L7-Application/36.NetEgress` | 751,745 | 66,352 |
| `PARTITION_MONITOR` | `L7-Application/37.PartitionMonitor` | 751,785 | 66,352 |
| `KEEPALIVE` | `L4-Transport/01.KeepAlive` | 751,829 | 66,360 |
| `core/01.FormParams` | `L6-Presentation/01.FormParams` | 751,877 | 66,352 |
| `core/03.Multipart` | `L6-Presentation/03.Multipart` | 752,017 | 66,352 |
| `OTA_ROLLBACK` | `L7-Application/44.OtaRollback` | 752,089 | 66,360 |
| `AUTH_LOCKOUT` | `L6-Presentation/12.AuthLockout` | 752,105 | 66,928 |
| `TOTP` | `L7-Application/45.Totp` | 752,233 | 66,392 |
| `IP_ALLOWLIST` | `L4-Transport/07.IpAllowlist` | 752,381 | 66,352 |
| `CSRF` | `L7-Application/33.Csrf` | 752,453 | 66,400 |
| `LOGBUF` | `L7-Application/41.LogBuffer` | 752,541 | 69,480 |
| `core/03.InterfaceFilter` | `L7-Application/03.InterfaceFilter` | 752,661 | 66,352 |
| `MODBUS` | `L7-Application/30.ModbusTcp` | 752,825 | 66,632 |
| `core/08.Templating` | `L7-Application/08.Templating` | 752,865 | 66,392 |
| `STATS` | `L7-Application/22.Stats` | 752,913 | 66,448 |
| `core/01.Basic` | `Foundation/01.Basic` | 753,133 | 66,360 |
| `MODBUS+MODBUS_MASTER` | `L7-Application/43.ModbusScan` | 753,141 | 66,624 |
| `JWT` | `L6-Presentation/06.JWTAuth` | 753,221 | 66,928 |
| `CBOR` | `L6-Presentation/13.Cbor` | 753,313 | 66,424 |
| `AUDIT_LOG` | `L7-Application/49.AuditLog` | 753,321 | 69,336 |
| `TELNET` | `L5-Session/03.Telnet` | 753,357 | 66,888 |
| `IPV6` | `Foundation/20.IPv6` | 753,497 | 66,352 |
| `core/03.Expert` | `Foundation/03.Expert` | 753,745 | 66,368 |
| `SYSLOG` | `L7-Application/19.Syslog` | 754,425 | 68,224 |
| `MSGPACK` | `L6-Presentation/14.MsgPack` | 754,609 | 66,424 |
| `core/02.Json` | `L6-Presentation/02.Json` | 754,769 | 66,352 |
| `STATS+METRICS` | `L7-Application/21.PrometheusMetrics` | 755,061 | 66,496 |
| `GPIO_MAP` | `L7-Application/38.GpioMap` | 755,317 | 66,408 |
| `WS_DEFLATE` | `L6-Presentation/11.WebSocketCompression` | 755,705 | 74,552 |
| `WEB_TERMINAL` | `L6-Presentation/10.WebTerminal` | 755,813 | 66,440 |
| `GRAPHQL` | `L7-Application/52.GraphQL` | 755,921 | 70,760 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/42.ConfigExport` | 756,021 | 66,412 |
| `OTA` | `L7-Application/16.OTA` | 756,277 | 102,488 |
| `COAP` | `L7-Application/13.CoAP` | 756,689 | 68,872 |
| `DNS_RESOLVER` | `L7-Application/48.DnsResolver` | 757,017 | 67,632 |
| `PROVISIONING` | `L7-Application/17.Provisioning` | 758,637 | 67,916 |
| `OPCUA` | `L7-Application/55.OpcUa` | 759,237 | 76,640 |
| `core/02.Advanced` | `Foundation/02.Advanced` | 759,769 | 66,464 |
| `SNMP` | `L7-Application/14.SNMP` | 759,885 | 78,752 |
| `TELEMETRY` | `L7-Application/34.Telemetry` | 759,885 | 66,668 |
| `HTTP_CLIENT+WEBHOOK` | `L7-Application/46.Webhook` | 761,565 | 86,112 |
| `OAUTH2+HTTP_CLIENT` | `L7-Application/54.OAuth2` | 763,521 | 89,176 |
| `PROMISC+FORWARD+ETHERNET` | `Foundation/21.WifiCapture` | 764,269 | 47,320 |
| `OIDC` | `L7-Application/50.OidcAuth` | 764,497 | 79,472 |
| `core/04.Sysadmin` | `Foundation/04.Sysadmin` | 764,985 | 66,360 |
| `RTC+TIME_SOURCE+NTP` | `L7-Application/61.Rtc` | 766,629 | 45,372 |
| `BUS_CAPTURE+FORWARD+ETHERNET` | `Foundation/22.CanCapture` | 770,793 | 45,316 |
| `DASHBOARD` | `L7-Application/35.Dashboard` | 771,829 | 66,728 |
| `NTP+TIME_SOURCE` | `L7-Application/31.TimeSourceFallback` | 772,217 | 67,964 |
| `MDNS` | `L7-Application/15.mDNS` | 776,501 | 68,256 |
| `NTP` | `L7-Application/18.SNTP` | 776,757 | 68,904 |
| `OPCUA+OPCUA_CLIENT` | `L7-Application/56.OpcUaClient` | 782,153 | 80,504 |
| `ETHERNET` | `Foundation/19.Ethernet` | 789,677 | 66,396 |
| `core/10.FileServing` | `L7-Application/10.FileServing` | 792,413 | 66,384 |
| `UPLOAD` | `L7-Application/11.FileUpload` | 793,461 | 71,584 |
| `RANGE` | `L7-Application/12.Range` | 793,677 | 66,384 |
| `VFS` | `L7-Application/51.Vfs` | 794,597 | 70,880 |
| `WEBDAV` | `L7-Application/29.WebDav` | 820,153 | 105,720 |
| `SSH` | `L5-Session/03.SSHHostKey` | 820,965 | 88,676 |
| `ETAG` | `L7-Application/09.ETag` | 827,193 | 67,656 |
| `WS_CLIENT+TLS+WS_CLIENT_TLS` | `L7-Application/25.WebSocketClient` | 831,737 | 121,316 |
| `TLS` | `L6-Presentation/07.SecureWebSocket` | 855,225 | 117,276 |
| `TLS+TLS_RESUMPTION` | `L4-Transport/06.TlsResumption` | 856,065 | 117,436 |
| `TLS+MTLS` | `L4-Transport/04.mTLS` | 856,173 | 117,612 |
