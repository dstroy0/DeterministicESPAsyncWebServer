...
| `SMTP` | `L7-Application/57.SmtpAlert` | 726,521 | 43,408 |
...
| `ACCEPT_THROTTLE` | `L4-Transport/02.AcceptThrottle` | 750,493 | 66,360 |
| `core/02.CORS` | `L7-Application/02.CORS` | 750,665 | 66,352 |
...
| `core/05.PathParams` | `L7-Application/05.PathParams` | 751,069 | 66,352 |
| `core/09.WebSocket` | `L6-Presentation/09.WebSocket` | 751,121 | 66,352 |
| `GUARDRAILS` | `L7-Application/40.Guardrails` | 751,201 | 66,360 |
| `core/07.ResponseHeaders` | `L7-Application/07.ResponseHeaders` | 751,217 | 66,352 |
| `core/04.Middleware` | `L7-Application/04.Middleware` | 751,313 | 66,360 |
| `core/01.ChunkedResponse` | `L7-Application/01.ChunkedResponse` | 751,365 | 66,368 |
| `core/08.ServerSentEvents` | `L6-Presentation/08.ServerSentEvents` | 751,369 | 66,360 |
| `core/36.NetEgress` | `L7-Application/36.NetEgress` | 751,369 | 66,352 |
| `PARTITION_MONITOR` | `L7-Application/37.PartitionMonitor` | 751,409 | 66,352 |
| `KEEPALIVE` | `L4-Transport/01.KeepAlive` | 751,453 | 66,360 |
| `core/01.FormParams` | `L6-Presentation/01.FormParams` | 751,509 | 66,352 |
| `OTA_ROLLBACK` | `L7-Application/44.OtaRollback` | 751,717 | 66,360 |
| `AUTH_LOCKOUT` | `L6-Presentation/12.AuthLockout` | 751,761 | 66,928 |
| `core/03.Multipart` | `L6-Presentation/03.Multipart` | 751,805 | 66,352 |
| `TOTP` | `L7-Application/45.Totp` | 751,861 | 66,392 |
| `IP_ALLOWLIST` | `L4-Transport/07.IpAllowlist` | 752,041 | 66,352 |
...
| `core/01.Basic` | `Foundation/01.Basic` | 752,761 | 66,360 |
| `MODBUS+MODBUS_MASTER` | `L7-Application/43.ModbusScan` | 752,781 | 66,624 |
| `JWT` | `L6-Presentation/06.JWTAuth` | 752,861 | 66,928 |
| `AUDIT_LOG` | `L7-Application/49.AuditLog` | 752,957 | 69,336 |
| `CBOR` | `L6-Presentation/13.Cbor` | 752,977 | 66,424 |
| `TELNET` | `L5-Session/03.Telnet` | 753,005 | 66,888 |
| `IPV6` | `Foundation/20.IPv6` | 753,149 | 66,352 |
| `core/03.Expert` | `Foundation/03.Expert` | 753,397 | 66,368 |
| `SYSLOG` | `L7-Application/19.Syslog` | 754,077 | 68,224 |
| `MSGPACK` | `L6-Presentation/14.MsgPack` | 754,269 | 66,424 |
| `STATS+METRICS` | `L7-Application/21.PrometheusMetrics` | 754,689 | 66,496 |
| `core/02.Json` | `L6-Presentation/02.Json` | 754,765 | 66,352 |
| `GPIO_MAP` | `L7-Application/38.GpioMap` | 754,953 | 66,408 |
| `WS_DEFLATE` | `L6-Presentation/11.WebSocketCompression` | 755,349 | 74,552 |
| `WEB_TERMINAL` | `L6-Presentation/10.WebTerminal` | 755,465 | 66,440 |
| `GRAPHQL` | `L7-Application/52.GraphQL` | 755,569 | 70,760 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/42.ConfigExport` | 755,637 | 66,412 |
| `OTA` | `L7-Application/16.OTA` | 755,885 | 102,488 |
| `COAP` | `L7-Application/13.CoAP` | 756,337 | 68,872 |
| `DNS_RESOLVER` | `L7-Application/48.DnsResolver` | 756,657 | 67,632 |
| `PROVISIONING` | `L7-Application/17.Provisioning` | 758,277 | 67,916 |
| `OPCUA` | `L7-Application/55.OpcUa` | 758,641 | 76,640 |
| `core/02.Advanced` | `Foundation/02.Advanced` | 759,421 | 66,464 |
| `SNMP` | `L7-Application/14.SNMP` | 759,493 | 78,752 |
| `TELEMETRY` | `L7-Application/34.Telemetry` | 759,529 | 66,668 |
| `HTTP_CLIENT+WEBHOOK` | `L7-Application/46.Webhook` | 761,193 | 86,112 |
| `OAUTH2+HTTP_CLIENT` | `L7-Application/54.OAuth2` | 763,533 | 89,176 |
| `OIDC` | `L7-Application/50.OidcAuth` | 764,141 | 79,472 |
| `core/04.Sysadmin` | `Foundation/04.Sysadmin` | 764,621 | 66,360 |
...
| `DASHBOARD` | `L7-Application/35.Dashboard` | 771,477 | 66,728 |
| `NTP+TIME_SOURCE` | `L7-Application/31.TimeSourceFallback` | 771,885 | 67,964 |
| `MDNS` | `L7-Application/15.mDNS` | 776,145 | 68,256 |
| `NTP` | `L7-Application/18.SNTP` | 776,397 | 68,904 |
| `OPCUA+OPCUA_CLIENT` | `L7-Application/56.OpcUaClient` | 781,573 | 80,504 |
| `ETHERNET` | `Foundation/19.Ethernet` | 789,301 | 66,396 |
| `core/10.FileServing` | `L7-Application/10.FileServing` | 792,057 | 66,384 |
| `UPLOAD` | `L7-Application/11.FileUpload` | 793,121 | 71,584 |
...
| `TLS+TLS_RESUMPTION` | `L4-Transport/06.TlsResumption` | 855,701 | 117,436 |
| `TLS+MTLS` | `L4-Transport/04.mTLS` | 855,809 | 117,612 |
