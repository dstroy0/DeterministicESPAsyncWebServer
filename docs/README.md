...
| `core/03.Multipart` | `L6-Presentation/03.Multipart` | 751,645 | 66,352 |
...
| `GRAPHQL` | `L7-Application/52.GraphQL` | 755,565 | 70,760 |
...
| `HTTP_CLIENT+WEBHOOK` | `L7-Application/46.Webhook` | 761,181 | 86,112 |
| `OAUTH2+HTTP_CLIENT` | `L7-Application/54.OAuth2` | 763,529 | 89,176 |
...
| `DASHBOARD` | `L7-Application/35.Dashboard` | 771,469 | 66,728 |
