...
| `ACCEPT_THROTTLE` | `L4-Transport/02.AcceptThrottle` | 750,705 | 65,992 |
| `core/02.CORS` | `L7-Application/02.CORS` | 750,865 | 65,984 |
| `RADIO_POWER+RADIO_WIFI_PS` | `L7-Application/47.RadioPower` | 750,937 | 65,984 |
| `core/04.BasicAuth` | `L6-Presentation/04.BasicAuth` | 750,937 | 65,984 |
| `core/05.DigestAuth` | `L6-Presentation/05.DigestAuth` | 751,053 | 65,984 |
| `DIAG` | `L7-Application/20.Diagnostics` | 751,101 | 65,984 |
| `core/06.RegexRoutes` | `L7-Application/06.RegexRoutes` | 751,173 | 65,984 |
| `PER_IP_THROTTLE` | `L4-Transport/05.PerIpThrottle` | 751,241 | 66,432 |
| `DEVICE_ID` | `L7-Application/32.DeviceUuid` | 751,269 | 66,024 |
| `core/05.PathParams` | `L7-Application/05.PathParams` | 751,273 | 65,984 |
| `core/09.WebSocket` | `L6-Presentation/09.WebSocket` | 751,317 | 65,984 |
| `GUARDRAILS` | `L7-Application/40.Guardrails` | 751,409 | 65,984 |
| `core/07.ResponseHeaders` | `L7-Application/07.ResponseHeaders` | 751,421 | 65,984 |
| `KEEPALIVE` | `L4-Transport/01.KeepAlive` | 751,513 | 65,992 |
| `core/04.Middleware` | `L7-Application/04.Middleware` | 751,513 | 65,984 |
| `core/08.ServerSentEvents` | `L6-Presentation/08.ServerSentEvents` | 751,553 | 65,992 |
| `core/01.ChunkedResponse` | `L7-Application/01.ChunkedResponse` | 751,561 | 65,992 |
| `core/36.NetEgress` | `L7-Application/36.NetEgress` | 751,573 | 65,984 |
| `PARTITION_MONITOR` | `L7-Application/37.PartitionMonitor` | 751,617 | 65,984 |
| `core/01.FormParams` | `L6-Presentation/01.FormParams` | 751,713 | 65,984 |
| `OTA_ROLLBACK` | `L7-Application/44.OtaRollback` | 751,925 | 65,984 |
| `AUTH_LOCKOUT` | `L6-Presentation/12.AuthLockout` | 751,949 | 66,560 |
| `core/03.Multipart` | `L6-Presentation/03.Multipart` | 752,013 | 65,984 |
| `TOTP` | `L7-Application/45.Totp` | 752,069 | 66,016 |
| `IP_ALLOWLIST` | `L4-Transport/07.IpAllowlist` | 752,249 | 65,984 |
| `CSRF` | `L7-Application/33.Csrf` | 752,305 | 66,032 |
| `LOGBUF` | `L7-Application/41.LogBuffer` | 752,373 | 69,104 |
| `core/03.InterfaceFilter` | `L7-Application/03.InterfaceFilter` | 752,501 | 65,984 |
| `MODBUS` | `L7-Application/30.ModbusTcp` | 752,625 | 66,256 |
| `core/08.Templating` | `L7-Application/08.Templating` | 752,685 | 66,016 |
| `STATS` | `L7-Application/22.Stats` | 752,741 | 66,080 |
| `MODBUS+MODBUS_MASTER` | `L7-Application/43.ModbusScan` | 752,957 | 66,256 |
| `core/01.Basic` | `Foundation/01.Basic` | 752,973 | 65,984 |
| `JWT` | `L6-Presentation/06.JWTAuth` | 753,061 | 66,560 |
| `TELNET` | `L5-Session/03.Telnet` | 753,157 | 66,512 |
| `AUDIT_LOG` | `L7-Application/49.AuditLog` | 753,165 | 68,968 |
| `CBOR` | `L6-Presentation/13.Cbor` | 753,169 | 66,056 |
| `IPV6` | `Foundation/20.IPv6` | 753,357 | 65,984 |
| `core/03.Expert` | `Foundation/03.Expert` | 753,621 | 66,000 |
| `SYSLOG` | `L7-Application/19.Syslog` | 754,281 | 67,840 |
| `MSGPACK` | `L6-Presentation/14.MsgPack` | 754,441 | 66,056 |
| `STATS+METRICS` | `L7-Application/21.PrometheusMetrics` | 754,885 | 66,120 |
| `core/02.Json` | `L6-Presentation/02.Json` | 754,973 | 65,984 |
| `GPIO_MAP` | `L7-Application/38.GpioMap` | 755,157 | 66,040 |
| `WS_DEFLATE` | `L6-Presentation/11.WebSocketCompression` | 755,545 | 74,184 |
| `WEB_TERMINAL` | `L6-Presentation/10.WebTerminal` | 755,657 | 66,064 |
| `GRAPHQL` | `L7-Application/52.GraphQL` | 755,781 | 70,384 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/42.ConfigExport` | 755,849 | 66,044 |
| `OTA` | `L7-Application/16.OTA` | 756,161 | 102,112 |
| `COAP` | `L7-Application/13.CoAP` | 756,541 | 68,496 |
| `DNS_RESOLVER` | `L7-Application/48.DnsResolver` | 756,861 | 67,264 |
| `PROVISIONING` | `L7-Application/17.Provisioning` | 758,481 | 67,548 |
| `OPCUA` | `L7-Application/55.OpcUa` | 758,845 | 76,272 |
| `core/02.Advanced` | `Foundation/02.Advanced` | 759,617 | 66,096 |
| `SNMP` | `L7-Application/14.SNMP` | 759,697 | 78,384 |
| `TELEMETRY` | `L7-Application/34.Telemetry` | 759,733 | 66,300 |
| `RELAY` | `L7-Application/70.PortForward` | 760,809 | 100,600 |
| `HTTP_CLIENT+WEBHOOK` | `L7-Application/46.Webhook` | 761,405 | 85,736 |
...
| `core/04.Sysadmin` | `Foundation/04.Sysadmin` | 764,833 | 65,992 |
...
| `DASHBOARD` | `L7-Application/35.Dashboard` | 771,645 | 66,352 |
| `NTP+TIME_SOURCE` | `L7-Application/31.TimeSourceFallback` | 772,089 | 67,596 |
| `MDNS` | `L7-Application/15.mDNS` | 776,349 | 67,888 |
| `NTP` | `L7-Application/18.SNTP` | 776,601 | 68,536 |
| `OPCUA+OPCUA_CLIENT` | `L7-Application/56.OpcUaClient` | 781,765 | 80,128 |
| `ETHERNET` | `Foundation/19.Ethernet` | 789,513 | 66,028 |
| `core/10.FileServing` | `L7-Application/10.FileServing` | 792,261 | 66,016 |
| `UPLOAD` | `L7-Application/11.FileUpload` | 793,397 | 71,208 |
| `RANGE` | `L7-Application/12.Range` | 793,513 | 66,016 |
| `VFS` | `L7-Application/51.Vfs` | 794,457 | 70,512 |
| `WEBDAV` | `L7-Application/29.WebDav` | 820,213 | 105,352 |
| `SSH` | `L5-Session/03.SSHHostKey` | 820,785 | 88,308 |
| `ETAG` | `L7-Application/09.ETag` | 827,029 | 67,288 |
| `WS_CLIENT+TLS+WS_CLIENT_TLS` | `L7-Application/25.WebSocketClient` | 831,333 | 120,548 |
| `TLS` | `L6-Presentation/07.SecureWebSocket` | 854,957 | 116,900 |
| `TLS+TLS_RESUMPTION` | `L4-Transport/06.TlsResumption` | 855,825 | 117,060 |
| `TLS+MTLS` | `L4-Transport/04.mTLS` | 855,921 | 117,236 |
