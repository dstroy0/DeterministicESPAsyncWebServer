...
| `ACCEPT_THROTTLE` | `L4-Transport/02.AcceptThrottle` | 750,841 | 66,360 |
| `core/02.CORS` | `L7-Application/02.CORS` | 751,013 | 66,352 |
...
| `core/05.PathParams` | `L7-Application/05.PathParams` | 751,421 | 66,352 |
| `core/09.WebSocket` | `L6-Presentation/09.WebSocket` | 751,477 | 66,352 |
| `GUARDRAILS` | `L7-Application/40.Guardrails` | 751,561 | 66,360 |
| `core/07.ResponseHeaders` | `L7-Application/07.ResponseHeaders` | 751,569 | 66,352 |
| `core/04.Middleware` | `L7-Application/04.Middleware` | 751,673 | 66,360 |
| `core/01.ChunkedResponse` | `L7-Application/01.ChunkedResponse` | 751,725 | 66,368 |
| `core/08.ServerSentEvents` | `L6-Presentation/08.ServerSentEvents` | 751,729 | 66,360 |
| `core/36.NetEgress` | `L7-Application/36.NetEgress` | 751,729 | 66,352 |
| `PARTITION_MONITOR` | `L7-Application/37.PartitionMonitor` | 751,769 | 66,352 |
| `KEEPALIVE` | `L4-Transport/01.KeepAlive` | 751,813 | 66,360 |
| `core/01.FormParams` | `L6-Presentation/01.FormParams` | 751,861 | 66,352 |
| `core/03.Multipart` | `L6-Presentation/03.Multipart` | 752,001 | 66,352 |
| `OTA_ROLLBACK` | `L7-Application/44.OtaRollback` | 752,073 | 66,360 |
| `AUTH_LOCKOUT` | `L6-Presentation/12.AuthLockout` | 752,089 | 66,928 |
| `TOTP` | `L7-Application/45.Totp` | 752,217 | 66,392 |
| `IP_ALLOWLIST` | `L4-Transport/07.IpAllowlist` | 752,365 | 66,352 |
...
| `core/01.Basic` | `Foundation/01.Basic` | 753,117 | 66,360 |
| `MODBUS+MODBUS_MASTER` | `L7-Application/43.ModbusScan` | 753,125 | 66,624 |
| `JWT` | `L6-Presentation/06.JWTAuth` | 753,205 | 66,928 |
| `CBOR` | `L6-Presentation/13.Cbor` | 753,297 | 66,424 |
| `AUDIT_LOG` | `L7-Application/49.AuditLog` | 753,305 | 69,336 |
| `TELNET` | `L5-Session/03.Telnet` | 753,341 | 66,888 |
| `IPV6` | `Foundation/20.IPv6` | 753,473 | 66,352 |
| `core/03.Expert` | `Foundation/03.Expert` | 753,729 | 66,368 |
| `SYSLOG` | `L7-Application/19.Syslog` | 754,409 | 68,224 |
| `MSGPACK` | `L6-Presentation/14.MsgPack` | 754,593 | 66,424 |
| `STATS+METRICS` | `L7-Application/21.PrometheusMetrics` | 755,049 | 66,496 |
| `core/02.Json` | `L6-Presentation/02.Json` | 755,109 | 66,352 |
| `GPIO_MAP` | `L7-Application/38.GpioMap` | 755,301 | 66,408 |
| `WS_DEFLATE` | `L6-Presentation/11.WebSocketCompression` | 755,689 | 74,552 |
| `WEB_TERMINAL` | `L6-Presentation/10.WebTerminal` | 755,797 | 66,440 |
| `GRAPHQL` | `L7-Application/52.GraphQL` | 755,901 | 70,760 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/42.ConfigExport` | 756,009 | 66,412 |
| `OTA` | `L7-Application/16.OTA` | 756,261 | 102,488 |
| `COAP` | `L7-Application/13.CoAP` | 756,673 | 68,872 |
| `DNS_RESOLVER` | `L7-Application/48.DnsResolver` | 757,001 | 67,632 |
| `PROVISIONING` | `L7-Application/17.Provisioning` | 758,621 | 67,916 |
| `OPCUA` | `L7-Application/55.OpcUa` | 758,997 | 76,640 |
| `core/02.Advanced` | `Foundation/02.Advanced` | 759,753 | 66,464 |
| `SNMP` | `L7-Application/14.SNMP` | 759,869 | 78,752 |
| `TELEMETRY` | `L7-Application/34.Telemetry` | 759,869 | 66,668 |
| `HTTP_CLIENT+WEBHOOK` | `L7-Application/46.Webhook` | 761,549 | 86,112 |
| `OAUTH2+HTTP_CLIENT` | `L7-Application/54.OAuth2` | 763,865 | 89,176 |
| `PROMISC+FORWARD+ETHERNET` | `Foundation/21.WifiCapture` | 764,269 | 47,320 |
| `OIDC` | `L7-Application/50.OidcAuth` | 764,481 | 79,472 |
| `core/04.Sysadmin` | `Foundation/04.Sysadmin` | 764,969 | 66,360 |
...
| `DASHBOARD` | `L7-Application/35.Dashboard` | 771,813 | 66,728 |
| `NTP+TIME_SOURCE` | `L7-Application/31.TimeSourceFallback` | 772,225 | 67,964 |
| `MDNS` | `L7-Application/15.mDNS` | 776,485 | 68,256 |
| `NTP` | `L7-Application/18.SNTP` | 776,741 | 68,904 |
| `OPCUA+OPCUA_CLIENT` | `L7-Application/56.OpcUaClient` | 781,917 | 80,504 |
| `ETHERNET` | `Foundation/19.Ethernet` | 789,661 | 66,396 |
| `core/10.FileServing` | `L7-Application/10.FileServing` | 792,393 | 66,384 |
| `UPLOAD` | `L7-Application/11.FileUpload` | 793,445 | 71,584 |
| `RANGE` | `L7-Application/12.Range` | 793,661 | 66,384 |
| `VFS` | `L7-Application/51.Vfs` | 794,581 | 70,880 |
| `WEBDAV` | `L7-Application/29.WebDav` | 820,137 | 105,720 |
| `SSH` | `L5-Session/03.SSHHostKey` | 820,949 | 88,676 |
| `ETAG` | `L7-Application/09.ETag` | 827,173 | 67,656 |
| `WS_CLIENT+TLS+WS_CLIENT_TLS` | `L7-Application/25.WebSocketClient` | 831,701 | 120,580 |
| `TLS` | `L6-Presentation/07.SecureWebSocket` | 855,205 | 117,276 |
| `TLS+TLS_RESUMPTION` | `L4-Transport/06.TlsResumption` | 856,045 | 117,436 |
| `TLS+MTLS` | `L4-Transport/04.mTLS` | 856,153 | 117,612 |
