...
| `COAP+COAP_BLOCK+COAP_MAX_PAYLOAD` | `L7-Application/28.CoapBlock` | 727,505 | 48,352 |
| `UDP_TELEMETRY` | `L7-Application/39.UdpTelemetry` | 727,877 | 44,944 |
| `STATSD` | `L7-Application/59.StatsdMetrics` | 728,357 | 45,088 |
| `SNMP+SNMP_TRAP` | `L7-Application/26.SnmpTrap` | 728,377 | 44,928 |
| `COAP+COAP_OBSERVE` | `L7-Application/27.CoapObserve` | 729,329 | 46,104 |
...
| `ACCEPT_THROTTLE` | `L4-Transport/02.AcceptThrottle` | 750,869 | 74,600 |
| `core/02.CORS` | `L7-Application/02.CORS` | 751,037 | 74,568 |
| `RADIO_POWER+RADIO_WIFI_PS` | `L7-Application/47.RadioPower` | 751,065 | 74,568 |
| `core/04.BasicAuth` | `L6-Presentation/04.BasicAuth` | 751,109 | 74,568 |
| `core/05.DigestAuth` | `L6-Presentation/05.DigestAuth` | 751,229 | 74,568 |
| `DIAG` | `L7-Application/20.Diagnostics` | 751,265 | 74,568 |
| `core/06.RegexRoutes` | `L7-Application/06.RegexRoutes` | 751,345 | 74,568 |
| `PER_IP_THROTTLE` | `L4-Transport/05.PerIpThrottle` | 751,409 | 75,016 |
| `DEVICE_ID` | `L7-Application/32.DeviceUuid` | 751,441 | 74,632 |
| `core/05.PathParams` | `L7-Application/05.PathParams` | 751,445 | 74,568 |
| `core/09.WebSocket` | `L6-Presentation/09.WebSocket` | 751,501 | 74,568 |
| `GUARDRAILS` | `L7-Application/40.Guardrails` | 751,589 | 74,600 |
| `core/07.ResponseHeaders` | `L7-Application/07.ResponseHeaders` | 751,593 | 74,568 |
| `core/04.Middleware` | `L7-Application/04.Middleware` | 751,697 | 74,600 |
| `core/01.ChunkedResponse` | `L7-Application/01.ChunkedResponse` | 751,745 | 74,600 |
| `core/08.ServerSentEvents` | `L6-Presentation/08.ServerSentEvents` | 751,753 | 74,600 |
| `core/36.NetEgress` | `L7-Application/36.NetEgress` | 751,753 | 74,568 |
| `PARTITION_MONITOR` | `L7-Application/37.PartitionMonitor` | 751,793 | 74,568 |
| `KEEPALIVE` | `L4-Transport/01.KeepAlive` | 751,837 | 74,600 |
| `core/01.FormParams` | `L6-Presentation/01.FormParams` | 751,885 | 74,568 |
| `core/03.Multipart` | `L6-Presentation/03.Multipart` | 752,025 | 74,568 |
| `OTA_ROLLBACK` | `L7-Application/44.OtaRollback` | 752,097 | 74,608 |
| `AUTH_LOCKOUT` | `L6-Presentation/12.AuthLockout` | 752,113 | 75,144 |
| `TOTP` | `L7-Application/45.Totp` | 752,241 | 74,632 |
| `IP_ALLOWLIST` | `L4-Transport/07.IpAllowlist` | 752,389 | 74,568 |
| `CSRF` | `L7-Application/33.Csrf` | 752,421 | 66,248 |
| `LOGBUF` | `L7-Application/41.LogBuffer` | 752,549 | 77,712 |
| `core/03.InterfaceFilter` | `L7-Application/03.InterfaceFilter` | 752,673 | 74,568 |
| `MODBUS` | `L7-Application/30.ModbusTcp` | 752,833 | 74,856 |
| `core/08.Templating` | `L7-Application/08.Templating` | 752,873 | 74,640 |
| `STATS` | `L7-Application/22.Stats` | 752,921 | 74,672 |
| `core/01.Basic` | `Foundation/01.Basic` | 753,141 | 74,608 |
| `MODBUS+MODBUS_MASTER` | `L7-Application/43.ModbusScan` | 753,149 | 74,856 |
| `JWT` | `L6-Presentation/06.JWTAuth` | 753,229 | 75,144 |
| `CBOR` | `L6-Presentation/13.Cbor` | 753,317 | 74,672 |
| `AUDIT_LOG` | `L7-Application/49.AuditLog` | 753,329 | 77,576 |
| `TELNET` | `L5-Session/03.Telnet` | 753,365 | 75,120 |
| `IPV6` | `Foundation/20.IPv6` | 753,505 | 74,568 |
| `core/03.Expert` | `Foundation/03.Expert` | 753,753 | 74,608 |
| `SYSLOG` | `L7-Application/19.Syslog` | 754,365 | 68,064 |
| `MSGPACK` | `L6-Presentation/14.MsgPack` | 754,613 | 74,672 |
| `core/02.Json` | `L6-Presentation/02.Json` | 754,777 | 74,576 |
| `STATS+METRICS` | `L7-Application/21.PrometheusMetrics` | 755,033 | 66,344 |
| `GPIO_MAP` | `L7-Application/38.GpioMap` | 755,325 | 74,648 |
| `WS_DEFLATE` | `L6-Presentation/11.WebSocketCompression` | 755,713 | 74,576 |
| `WEB_TERMINAL` | `L6-Presentation/10.WebTerminal` | 755,821 | 74,672 |
| `GRAPHQL` | `L7-Application/52.GraphQL` | 755,929 | 78,992 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/42.ConfigExport` | 756,029 | 74,652 |
| `OTA` | `L7-Application/16.OTA` | 756,285 | 110,728 |
| `COAP` | `L7-Application/13.CoAP` | 756,697 | 77,112 |
| `DNS_RESOLVER` | `L7-Application/48.DnsResolver` | 757,025 | 75,856 |
| `PROVISIONING` | `L7-Application/17.Provisioning` | 758,645 | 76,140 |
| `OPCUA` | `L7-Application/55.OpcUa` | 759,245 | 84,880 |
| `core/02.Advanced` | `Foundation/02.Advanced` | 759,777 | 74,680 |
| `SNMP` | `L7-Application/14.SNMP` | 759,893 | 87,000 |
| `TELEMETRY` | `L7-Application/34.Telemetry` | 759,893 | 74,908 |
| `HTTP_CLIENT+WEBHOOK` | `L7-Application/46.Webhook` | 761,573 | 94,352 |
| `OAUTH2+HTTP_CLIENT` | `L7-Application/54.OAuth2` | 763,529 | 97,392 |
| `PROMISC+FORWARD+ETHERNET` | `Foundation/21.WifiCapture` | 764,269 | 47,320 |
| `OIDC` | `L7-Application/50.OidcAuth` | 764,505 | 79,496 |
| `core/04.Sysadmin` | `Foundation/04.Sysadmin` | 764,993 | 74,608 |
...
| `DASHBOARD` | `L7-Application/35.Dashboard` | 771,797 | 66,568 |
| `NTP+TIME_SOURCE` | `L7-Application/31.TimeSourceFallback` | 772,225 | 76,196 |
| `MDNS` | `L7-Application/15.mDNS` | 776,509 | 76,472 |
| `NTP` | `L7-Application/18.SNTP` | 776,765 | 77,120 |
| `OPCUA+OPCUA_CLIENT` | `L7-Application/56.OpcUaClient` | 782,117 | 80,352 |
| `ETHERNET` | `Foundation/19.Ethernet` | 789,685 | 74,644 |
| `core/10.FileServing` | `L7-Application/10.FileServing` | 792,421 | 74,608 |
| `UPLOAD` | `L7-Application/11.FileUpload` | 793,469 | 79,824 |
| `RANGE` | `L7-Application/12.Range` | 793,685 | 74,608 |
| `VFS` | `L7-Application/51.Vfs` | 794,565 | 70,728 |
| `WEBDAV` | `L7-Application/29.WebDav` | 820,157 | 113,960 |
| `SSH` | `L5-Session/01.SSH` | 821,593 | 88,700 |
| `ETAG` | `L7-Application/09.ETag` | 827,201 | 75,880 |
