...
| [Multipart](FEATURES.md#multipart "multipart/form-data body parser") | [NTP](FEATURES.md#ntp "SNTP wall-clock time sync via the ESP-IDF SNTP client") | [OAuth2](FEATURES.md#oauth2 "OAuth2 token-endpoint client") | [OIDC](FEATURES.md#oidc "OpenID Connect ID-token verification, RS256") | [OPC-UA](FEATURES.md#opc-ua "OPC UA Binary server: handshake + SecureChannel + Session + Read") |
