...
| `ACCEPT_THROTTLE` | `L4-Transport/AcceptThrottle` | 752,789 | 81,796 |
| `core/CORS` | `L7-Application/CORS` | 752,945 | 81,788 |
| `core/DigestAuth` | `L6-Presentation/DigestAuth` | 753,009 | 81,788 |
| `core/BasicAuth` | `L6-Presentation/BasicAuth` | 753,021 | 81,788 |
| `RADIO_POWER+RADIO_WIFI_PS` | `L7-Application/RadioPower` | 753,029 | 81,788 |
| `core/MediaStreaming` | `L7-Application/MediaStreaming` | 753,081 | 81,788 |
| `core/RegexRoutes` | `L7-Application/RegexRoutes` | 753,129 | 81,788 |
| `KEEPALIVE` | `L4-Transport/KeepAlive` | 753,169 | 81,788 |
| `DEVICE_ID` | `L7-Application/DeviceUuid` | 753,241 | 81,828 |
| `DIFFSERV` | `L4-Transport/DiffServ` | 753,253 | 81,788 |
| `core/PathParams` | `L7-Application/PathParams` | 753,277 | 81,788 |
| `ADS` | `L7-Application/AdsClient` | 753,317 | 44,204 |
| `GUARDRAILS` | `L7-Application/Guardrails` | 753,329 | 81,796 |
| `PER_IP_THROTTLE` | `L4-Transport/PerIpThrottle` | 753,365 | 82,236 |
| `core/ResponseHeaders` | `L7-Application/ResponseHeaders` | 753,405 | 81,788 |
| `core/WebSocket` | `L6-Presentation/WebSocket` | 753,409 | 81,788 |
| `core/Middleware` | `L7-Application/Middleware` | 753,501 | 81,796 |
| `core/ChunkedResponse` | `L7-Application/ChunkedResponse` | 753,597 | 81,804 |
| `DIAG` | `L7-Application/Diagnostics` | 753,637 | 81,788 |
| `core/NetEgress` | `L7-Application/NetEgress` | 753,685 | 81,788 |
| `core/FormParams` | `L6-Presentation/FormParams` | 753,697 | 81,788 |
| `PARTITION_MONITOR` | `L7-Application/PartitionMonitor` | 753,733 | 81,788 |
| `core/ServerSentEvents` | `L6-Presentation/ServerSentEvents` | 753,853 | 81,796 |
| `OTA_ROLLBACK` | `L7-Application/OtaRollback` | 754,021 | 81,796 |
| `AUTH_LOCKOUT` | `L6-Presentation/AuthLockout` | 754,121 | 82,364 |
| `TOTP` | `L7-Application/Totp` | 754,165 | 81,828 |
| `core/Multipart` | `L6-Presentation/Multipart` | 754,197 | 81,788 |
| `LOGBUF` | `L7-Application/LogBuffer` | 754,349 | 84,916 |
| `IP_ALLOWLIST` | `L4-Transport/IpAllowlist` | 754,409 | 81,788 |
| `core/InterfaceFilter` | `L7-Application/InterfaceFilter` | 754,649 | 81,788 |
| `CSRF` | `L7-Application/Csrf` | 754,681 | 81,836 |
| `core/Templating` | `L7-Application/Templating` | 754,681 | 81,828 |
| `MODBUS` | `L7-Application/ModbusTcp` | 754,705 | 82,068 |
| `SPA_ROUTER` | `L7-Application/SpaFallback` | 754,789 | 81,788 |
| `STATS` | `L7-Application/Stats` | 754,921 | 81,884 |
| `CONTROL` | `L7-Application/PidTuning` | 755,085 | 89,868 |
| `core/Basic` | `Foundation/Basic` | 755,161 | 81,796 |
| `MODBUS+MODBUS_MASTER` | `L7-Application/ModbusScan` | 755,177 | 82,060 |
| `JWT` | `L6-Presentation/JWTAuth` | 755,277 | 82,940 |
| `TELNET` | `L5-Session/Telnet` | 755,329 | 82,324 |
| `CBOR` | `L6-Presentation/Cbor` | 755,425 | 81,860 |
| `AUDIT_LOG` | `L7-Application/AuditLog` | 755,441 | 84,772 |
| `IPV6` | `Foundation/IPv6` | 755,669 | 81,788 |
| `core/Expert` | `Foundation/Expert` | 755,845 | 81,804 |
| `MSGPACK` | `L6-Presentation/MsgPack` | 756,821 | 81,860 |
| `STATS+METRICS` | `L7-Application/PrometheusMetrics` | 756,941 | 81,932 |
| `SYSLOG` | `L7-Application/Syslog` | 757,037 | 83,700 |
| `core/Json` | `L6-Presentation/Json` | 757,097 | 81,788 |
| `AUTH_LOCKOUT+FORWARDED_TRUST` | `L6-Presentation/ForwardedTrust` | 757,321 | 82,404 |
| `GPIO_MAP` | `L7-Application/GpioMap` | 757,485 | 81,844 |
| `WEB_TERMINAL` | `L6-Presentation/WebTerminal` | 757,761 | 81,876 |
| `WS_DEFLATE` | `L6-Presentation/WebSocketCompression` | 757,801 | 89,996 |
| `GRAPHQL` | `L7-Application/GraphQL` | 757,893 | 86,196 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/ConfigExport` | 758,009 | 81,848 |
| `OTA` | `L7-Application/OTA` | 758,581 | 102,140 |
| `COAP` | `L7-Application/CoAP` | 759,001 | 84,356 |
| `DNS_RESOLVER` | `L7-Application/DnsResolver` | 759,149 | 83,068 |
| `PROVISIONING` | `L7-Application/Provisioning` | 761,337 | 83,416 |
| `OPCUA` | `L7-Application/OpcUa` | 761,445 | 92,076 |
| `core/Advanced` | `Foundation/Advanced` | 761,789 | 81,900 |
| `TELEMETRY` | `L7-Application/Telemetry` | 762,061 | 82,104 |
| `SNMP` | `L7-Application/SNMP` | 762,305 | 94,236 |
| `RELAY` | `L7-Application/PortForward` | 762,901 | 116,404 |
| `HTTP_CLIENT+WEBHOOK` | `L7-Application/Webhook` | 763,701 | 101,548 |
| `OPCUA+OPCUA_CLIENT` | `L7-Application/OpcUaClient` | 765,841 | 94,684 |
| `OAUTH2+HTTP_CLIENT` | `L7-Application/OAuth2` | 766,049 | 104,612 |
| `PROMISC+FORWARD+ETHERNET` | `Peripherals/WifiCapture` | 766,049 | 47,584 |
| `core/Sysadmin` | `Foundation/Sysadmin` | 766,957 | 81,796 |
| `OIDC` | `L7-Application/OidcAuth` | 766,993 | 99,844 |
| `RTC+TIME_SOURCE+NTP` | `Drivers/Rtc` | 767,001 | 45,388 |
| `OPCUA+UMATI` | `L7-Application/Umati` | 768,013 | 92,220 |
| `NTRIP_CASTER` | `L7-Application/NtripCaster` | 771,009 | 84,704 |
| `BUS_CAPTURE+FORWARD+ETHERNET` | `Peripherals/CanCapture` | 771,997 | 45,568 |
| `DASHBOARD` | `L7-Application/Dashboard` | 774,081 | 82,164 |
| `EDGE_CACHE+HTTP_CACHE+HTTP_CLIENT` | `L7-Application/EdgeCache` | 774,213 | 119,268 |
| `NTP+TIME_SOURCE` | `L7-Application/TimeSourceFallback` | 774,473 | 83,396 |
| `EDGE_CACHE+HTTP_CACHE+HTTP_CLIENT+EDGE_MESH` | `L7-Application/MeshCache` | 778,433 | 124,240 |
| `MDNS` | `L7-Application/mDNS` | 778,577 | 83,696 |
| `EDGE_CACHE+HTTP_CACHE+HTTP_CLIENT+EDGE_MESH+EDGE_CACHE_SLOTS+EDGE_FETCH_SLOTS+MESH_MAX_PEERS` | `L7-Application/MeshCache` | 778,749 | 115,324 |
| `NTP` | `L7-Application/SNTP` | 778,989 | 84,336 |
| `MDNS+PROMISC+WIFI_SNIFFER+MDNS_ADAPTIVE` | `L7-Application/MdnsAdaptive` | 780,649 | 83,776 |
| `IFACE_BRIDGE` | `L7-Application/InterfaceBridge` | 781,121 | 82,636 |
| `COAP+DTLS` | `L7-Application/CoapSecure` | 781,425 | 102,932 |
| `ETHERNET` | `Peripherals/Ethernet` | 792,329 | 81,840 |
| `ETHERNET+ETH_W5500+ETH_W5500_CS+ETH_W5500_RST+ETH_W5500_INT+ETH_W5500_SCK+ETH_W5500_MISO+ETH_W5500_MOSI` | `Peripherals/EthernetW5500` | 792,361 | 81,840 |
| `core/FileServing` | `L7-Application/FileServing` | 794,489 | 81,820 |
| `UPLOAD` | `L7-Application/FileUpload` | 795,453 | 101,956 |
| `RANGE` | `L7-Application/Range` | 795,641 | 81,820 |
| `VFS` | `L7-Application/Vfs` | 796,673 | 86,316 |
| `WEBDAV` | `L7-Application/WebDav` | 821,069 | 105,352 |
| `WEBDAV+WEBDAV_MAX_ENTRIES+WEBDAV_BUF_SIZE` | `L7-Application/WebDav` | 822,537 | 90,860 |
| `ETAG` | `L7-Application/ETag` | 829,357 | 83,084 |
| `SSH` | `L5-Session/SSHHostKey` | 831,145 | 109,208 |
...
| `HOTSWAP` | `L7-Application/HotSwapStorage` | 838,777 | 82,720 |
| `EXC_DECODER+FTP+FTP_SESSION` | `L7-Application/CoreDump` | 841,541 | 83,428 |
| `HTTP_DELIVERY+FILE_SERVING+RANGE` | `L7-Application/HttpDelivery` | 843,057 | 82,696 |
| `SSH+SSH_CLIENT+SSH_CLIENT_MAX_CHANNELS+CLIENT_RX_BUF` | `L5-Session/SSHReverseTunnel` | 846,569 | 110,960 |
...
| `TLS+TLS_ARENA_SIZE` | `L6-Presentation/SecureWebSocket` | 857,909 | 105,672 |
| `TLS+TLS_RESUMPTION+TLS_ARENA_SIZE` | `L4-Transport/TlsResumption` | 858,677 | 105,832 |
| `TLS+MTLS+TLS_ARENA_SIZE` | `L4-Transport/mTLS` | 858,745 | 106,008 |
| `POWER_MGMT` | `L7-Application/PowerGovernor` | 881,477 | 85,640 |
| `SSH+FILE_SERVING+SSH_SFTP+SSH_SCP` | `L5-Session/SSHSftp` | 883,373 | 118,560 |
