...
| `SMB` | `L7-Application/SmbFileClient` | 767,041 | 67,564 |
...
| `COAP+DTLS` | `L7-Application/CoapSecure` | 782,357 | 105,956 |
...
| `SSH` | `L5-Session/SSHHostKey` | 832,449 | 110,400 |
...
| `SSH+SSH_CLIENT+SSH_CLIENT_MAX_CHANNELS+CLIENT_RX_BUF` | `L5-Session/SSHReverseTunnel` | 847,833 | 112,136 |
...
| `SSH+FILE_SERVING+SSH_SFTP+SSH_SCP` | `L5-Session/SSHSftp` | 884,637 | 119,728 |
