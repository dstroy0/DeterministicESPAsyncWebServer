...
| `ACCEPT_THROTTLE` | `L4-Transport/02.AcceptThrottle` | 750,925 | 65,984 |
| `RADIO_POWER+RADIO_WIFI_PS` | `L7-Application/47.RadioPower` | 750,937 | 65,984 |
| `core/04.BasicAuth` | `L6-Presentation/04.BasicAuth` | 751,141 | 65,976 |
| `DEVICE_ID` | `L7-Application/32.DeviceUuid` | 751,261 | 66,016 |
| `core/05.DigestAuth` | `L6-Presentation/05.DigestAuth` | 751,277 | 65,976 |
| `core/06.RegexRoutes` | `L7-Application/06.RegexRoutes` | 751,397 | 65,976 |
...
| `PER_IP_THROTTLE` | `L4-Transport/05.PerIpThrottle` | 751,457 | 66,424 |
| `core/05.PathParams` | `L7-Application/05.PathParams` | 751,497 | 65,976 |
| `KEEPALIVE` | `L4-Transport/01.KeepAlive` | 751,509 | 65,984 |
| `core/09.WebSocket` | `L6-Presentation/09.WebSocket` | 751,525 | 65,976 |
...
| `core/04.Middleware` | `L7-Application/04.Middleware` | 751,721 | 65,984 |
| `core/08.ServerSentEvents` | `L6-Presentation/08.ServerSentEvents` | 751,777 | 65,984 |
| `OTA_ROLLBACK` | `L7-Application/44.OtaRollback` | 751,917 | 65,992 |
| `core/01.FormParams` | `L6-Presentation/01.FormParams` | 751,925 | 65,976 |
| `TOTP` | `L7-Application/45.Totp` | 752,069 | 66,016 |
| `AUTH_LOCKOUT` | `L6-Presentation/12.AuthLockout` | 752,181 | 66,552 |
| `core/03.Multipart` | `L6-Presentation/03.Multipart` | 752,237 | 65,976 |
| `CSRF` | `L7-Application/33.Csrf` | 752,305 | 66,032 |
| `LOGBUF` | `L7-Application/41.LogBuffer` | 752,373 | 69,104 |
| `IP_ALLOWLIST` | `L4-Transport/07.IpAllowlist` | 752,445 | 65,976 |
| `MODBUS` | `L7-Application/30.ModbusTcp` | 752,617 | 66,264 |
| `core/03.InterfaceFilter` | `L7-Application/03.InterfaceFilter` | 752,705 | 65,976 |
| `STATS` | `L7-Application/22.Stats` | 752,741 | 66,080 |
| `DIAG` | `Foundation/05.Configuration` | 752,805 | 62,760 |
| `MODBUS+MODBUS_MASTER` | `L7-Application/43.ModbusScan` | 752,949 | 66,256 |
| `core/08.Templating` | `L7-Application/08.Templating` | 752,949 | 66,024 |
...
| `core/01.Basic` | `Foundation/01.Basic` | 753,185 | 65,992 |
| `CBOR` | `L6-Presentation/13.Cbor` | 753,433 | 66,056 |
| `IPV6` | `Foundation/20.IPv6` | 753,569 | 65,976 |
| `core/03.Expert` | `Foundation/03.Expert` | 753,845 | 66,000 |
| `SYSLOG` | `L7-Application/19.Syslog` | 754,281 | 67,840 |
| `MSGPACK` | `L6-Presentation/14.MsgPack` | 754,721 | 66,056 |
| `STATS+METRICS` | `L7-Application/21.PrometheusMetrics` | 754,893 | 66,128 |
| `GPIO_MAP` | `L7-Application/38.GpioMap` | 755,157 | 66,040 |
| `core/02.Json` | `L6-Presentation/02.Json` | 755,177 | 65,984 |
...
| `OTA` | `L7-Application/16.OTA` | 756,401 | 102,112 |
| `COAP` | `L7-Application/13.CoAP` | 756,761 | 68,496 |
...
| `core/02.Advanced` | `Foundation/02.Advanced` | 759,841 | 66,088 |
| `SNMP` | `L7-Application/14.SNMP` | 759,901 | 78,384 |
...
| `MDNS` | `L7-Application/15.mDNS` | 776,569 | 67,880 |
| `NTP` | `L7-Application/18.SNTP` | 776,601 | 68,536 |
| `OPCUA+OPCUA_CLIENT` | `L7-Application/56.OpcUaClient` | 781,765 | 80,128 |
| `ETHERNET` | `Foundation/19.Ethernet` | 789,733 | 66,028 |
| `core/10.FileServing` | `L7-Application/10.FileServing` | 792,457 | 66,016 |
...
| `SSH` | `L5-Session/03.SSHHostKey` | 820,973 | 88,316 |
| `ETAG` | `L7-Application/09.ETag` | 827,209 | 67,288 |
| `WS_CLIENT+TLS+WS_CLIENT_TLS` | `L7-Application/25.WebSocketClient` | 831,333 | 120,548 |
| `TLS` | `L6-Presentation/07.SecureWebSocket` | 855,201 | 116,900 |
| `TLS+MTLS` | `L4-Transport/04.mTLS` | 855,933 | 117,236 |
| `TLS+TLS_RESUMPTION` | `L4-Transport/06.TlsResumption` | 856,057 | 117,060 |
