...
| `ACCEPT_THROTTLE` | `L4-Transport/AcceptThrottle` | 752,605 | 81,796 |
| `core/CORS` | `L7-Application/CORS` | 752,773 | 81,788 |
| `core/DigestAuth` | `L6-Presentation/DigestAuth` | 752,849 | 81,788 |
| `core/BasicAuth` | `L6-Presentation/BasicAuth` | 752,861 | 81,788 |
| `RADIO_POWER+RADIO_WIFI_PS` | `L7-Application/RadioPower` | 752,865 | 81,788 |
| `core/MediaStreaming` | `L7-Application/MediaStreaming` | 752,917 | 81,788 |
| `core/RegexRoutes` | `L7-Application/RegexRoutes` | 752,969 | 81,788 |
| `KEEPALIVE` | `L4-Transport/KeepAlive` | 753,009 | 81,788 |
| `DEVICE_ID` | `L7-Application/DeviceUuid` | 753,065 | 81,828 |
| `core/PathParams` | `L7-Application/PathParams` | 753,093 | 81,788 |
| `PER_IP_THROTTLE` | `L4-Transport/PerIpThrottle` | 753,161 | 82,236 |
| `GUARDRAILS` | `L7-Application/Guardrails` | 753,169 | 81,804 |
| `core/ResponseHeaders` | `L7-Application/ResponseHeaders` | 753,225 | 81,788 |
| `core/WebSocket` | `L6-Presentation/WebSocket` | 753,233 | 81,788 |
| `ADS` | `L7-Application/AdsClient` | 753,317 | 44,204 |
| `core/Middleware` | `L7-Application/Middleware` | 753,321 | 81,796 |
| `core/ChunkedResponse` | `L7-Application/ChunkedResponse` | 753,449 | 81,804 |
| `DIAG` | `L7-Application/Diagnostics` | 753,461 | 81,788 |
| `core/ServerSentEvents` | `L6-Presentation/ServerSentEvents` | 753,497 | 81,796 |
| `core/NetEgress` | `L7-Application/NetEgress` | 753,529 | 81,788 |
| `core/FormParams` | `L6-Presentation/FormParams` | 753,553 | 81,788 |
| `PARTITION_MONITOR` | `L7-Application/PartitionMonitor` | 753,593 | 81,796 |
| `OTA_ROLLBACK` | `L7-Application/OtaRollback` | 753,853 | 81,804 |
| `AUTH_LOCKOUT` | `L6-Presentation/AuthLockout` | 753,961 | 82,364 |
| `TOTP` | `L7-Application/Totp` | 754,017 | 81,828 |
| `core/Multipart` | `L6-Presentation/Multipart` | 754,041 | 81,788 |
| `LOGBUF` | `L7-Application/LogBuffer` | 754,173 | 84,916 |
| `IP_ALLOWLIST` | `L4-Transport/IpAllowlist` | 754,245 | 81,788 |
| `core/InterfaceFilter` | `L7-Application/InterfaceFilter` | 754,473 | 81,788 |
| `CSRF` | `L7-Application/Csrf` | 754,501 | 81,844 |
| `MODBUS` | `L7-Application/ModbusTcp` | 754,521 | 82,076 |
| `core/Templating` | `L7-Application/Templating` | 754,533 | 81,836 |
| `SPA_ROUTER` | `L7-Application/SpaFallback` | 754,633 | 81,788 |
| `STATS` | `L7-Application/Stats` | 754,765 | 81,892 |
| `CONTROL` | `L7-Application/PidTuning` | 754,897 | 89,868 |
| `MODBUS+MODBUS_MASTER` | `L7-Application/ModbusScan` | 754,981 | 82,068 |
| `JWT` | `L6-Presentation/JWTAuth` | 754,985 | 82,940 |
| `core/Basic` | `Foundation/Basic` | 755,005 | 81,804 |
| `TELNET` | `L5-Session/Telnet` | 755,177 | 82,332 |
| `AUDIT_LOG` | `L7-Application/AuditLog` | 755,237 | 84,780 |
| `CBOR` | `L6-Presentation/Cbor` | 755,273 | 81,868 |
| `IPV6` | `Foundation/IPv6` | 755,473 | 81,788 |
| `core/Expert` | `Foundation/Expert` | 755,681 | 81,812 |
| `SYSLOG` | `L7-Application/Syslog` | 756,461 | 83,700 |
| `MSGPACK` | `L6-Presentation/MsgPack` | 756,613 | 81,868 |
| `STATS+METRICS` | `L7-Application/PrometheusMetrics` | 756,761 | 81,932 |
| `core/Json` | `L6-Presentation/Json` | 756,897 | 81,796 |
| `AUTH_LOCKOUT+FORWARDED_TRUST` | `L6-Presentation/ForwardedTrust` | 757,121 | 82,404 |
| `GPIO_MAP` | `L7-Application/GpioMap` | 757,285 | 81,852 |
| `WEB_TERMINAL` | `L6-Presentation/WebTerminal` | 757,597 | 81,876 |
| `WS_DEFLATE` | `L6-Presentation/WebSocketCompression` | 757,617 | 90,004 |
| `GRAPHQL` | `L7-Application/GraphQL` | 757,725 | 86,204 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/ConfigExport` | 757,833 | 81,856 |
| `OTA` | `L7-Application/OTA` | 758,377 | 102,132 |
| `COAP` | `L7-Application/CoAP` | 758,805 | 84,356 |
| `DNS_RESOLVER` | `L7-Application/DnsResolver` | 758,945 | 83,076 |
| `PROVISIONING` | `L7-Application/Provisioning` | 761,125 | 83,424 |
| `OPCUA` | `L7-Application/OpcUa` | 761,225 | 92,076 |
| `core/Advanced` | `Foundation/Advanced` | 761,609 | 81,900 |
| `TELEMETRY` | `L7-Application/Telemetry` | 761,853 | 82,112 |
| `SNMP` | `L7-Application/SNMP` | 762,081 | 94,244 |
| `RELAY` | `L7-Application/PortForward` | 762,673 | 116,404 |
| `HTTP_CLIENT+WEBHOOK` | `L7-Application/Webhook` | 763,477 | 101,548 |
| `OPCUA+OPCUA_CLIENT` | `L7-Application/OpcUaClient` | 765,609 | 94,692 |
| `OAUTH2+HTTP_CLIENT` | `L7-Application/OAuth2` | 765,817 | 104,612 |
| `PROMISC+FORWARD+ETHERNET` | `Peripherals/WifiCapture` | 766,049 | 47,584 |
| `OIDC` | `L7-Application/OidcAuth` | 766,765 | 99,844 |
| `core/Sysadmin` | `Foundation/Sysadmin` | 766,801 | 81,804 |
| `RTC+TIME_SOURCE+NTP` | `Drivers/Rtc` | 767,001 | 45,388 |
| `OPCUA+UMATI` | `L7-Application/Umati` | 767,789 | 92,220 |
| `NTRIP_CASTER` | `L7-Application/NtripCaster` | 770,793 | 84,712 |
| `BUS_CAPTURE+FORWARD+ETHERNET` | `Peripherals/CanCapture` | 771,997 | 45,568 |
| `DASHBOARD` | `L7-Application/Dashboard` | 773,681 | 82,164 |
| `EDGE_CACHE+HTTP_CACHE+HTTP_CLIENT` | `L7-Application/EdgeCache` | 773,985 | 119,276 |
| `NTP+TIME_SOURCE` | `L7-Application/TimeSourceFallback` | 774,357 | 83,396 |
| `MDNS` | `L7-Application/mDNS` | 778,369 | 83,688 |
| `EDGE_CACHE+HTTP_CACHE+HTTP_CLIENT+EDGE_MESH` | `L7-Application/MeshCache` | 778,433 | 124,240 |
| `EDGE_CACHE+HTTP_CACHE+HTTP_CLIENT+EDGE_MESH+EDGE_CACHE_SLOTS+EDGE_FETCH_SLOTS+MESH_MAX_PEERS` | `L7-Application/MeshCache` | 778,533 | 115,332 |
| `NTP` | `L7-Application/SNTP` | 778,877 | 84,328 |
| `MDNS+PROMISC+WIFI_SNIFFER+MDNS_ADAPTIVE` | `L7-Application/MdnsAdaptive` | 780,425 | 83,776 |
| `IFACE_BRIDGE` | `L7-Application/InterfaceBridge` | 780,845 | 82,628 |
| `COAP+DTLS` | `L7-Application/CoapSecure` | 781,269 | 102,924 |
| `ETHERNET` | `Peripherals/Ethernet` | 792,033 | 81,848 |
| `ETHERNET+ETH_W5500+ETH_W5500_CS+ETH_W5500_RST+ETH_W5500_INT+ETH_W5500_SCK+ETH_W5500_MISO+ETH_W5500_MOSI` | `Peripherals/EthernetW5500` | 792,065 | 81,848 |
| `core/FileServing` | `L7-Application/FileServing` | 794,273 | 81,828 |
| `UPLOAD` | `L7-Application/FileUpload` | 795,233 | 101,964 |
| `RANGE` | `L7-Application/Range` | 795,425 | 81,828 |
| `VFS` | `L7-Application/Vfs` | 796,457 | 86,316 |
| `WEBDAV` | `L7-Application/WebDav` | 821,069 | 105,352 |
| `WEBDAV+WEBDAV_MAX_ENTRIES+WEBDAV_BUF_SIZE` | `L7-Application/WebDav` | 822,261 | 90,860 |
| `ETAG` | `L7-Application/ETag` | 829,097 | 83,092 |
| `SSH` | `L5-Session/SSHHostKey` | 830,173 | 109,208 |
...
| `HOTSWAP` | `L7-Application/HotSwapStorage` | 838,465 | 82,728 |
| `EXC_DECODER+FTP+FTP_SESSION` | `L7-Application/CoreDump` | 841,361 | 83,428 |
| `HTTP_DELIVERY+FILE_SERVING+RANGE` | `L7-Application/HttpDelivery` | 842,749 | 82,704 |
| `SSH+SSH_CLIENT+SSH_CLIENT_MAX_CHANNELS+CLIENT_RX_BUF` | `L5-Session/SSHReverseTunnel` | 845,625 | 110,960 |
...
| `TLS+TLS_ARENA_SIZE` | `L6-Presentation/SecureWebSocket` | 857,101 | 105,664 |
| `TLS+TLS_RESUMPTION+TLS_ARENA_SIZE` | `L4-Transport/TlsResumption` | 858,025 | 105,824 |
| `TLS+MTLS+TLS_ARENA_SIZE` | `L4-Transport/mTLS` | 858,117 | 106,000 |
| `POWER_MGMT` | `L7-Application/PowerGovernor` | 881,317 | 85,648 |
| `SSH+FILE_SERVING+SSH_SFTP+SSH_SCP` | `L5-Session/SSHSftp` | 882,453 | 118,560 |
