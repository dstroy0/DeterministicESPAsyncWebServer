...
| `core/ServerSentEvents` | `L6-Presentation/ServerSentEvents` | 753,713 | 81,788 |
...
| `DIAG` | `Foundation/Configuration` | 755,073 | 77,540 |
...
| `DASHBOARD` | `L7-Application/Dashboard` | 773,961 | 82,156 |
...
| `TLS+TLS_ARENA_SIZE` | `L6-Presentation/SecureWebSocket` | 857,777 | 105,664 |
