...
| `ACCEPT_THROTTLE` | `L4-Transport/02.AcceptThrottle` | 751,273 | 65,984 |
| `core/02.CORS` | `L7-Application/02.CORS` | 751,417 | 65,976 |
| `RADIO_POWER+RADIO_WIFI_PS` | `L7-Application/47.RadioPower` | 751,489 | 65,976 |
| `core/04.BasicAuth` | `L6-Presentation/04.BasicAuth` | 751,489 | 65,976 |
| `core/05.DigestAuth` | `L6-Presentation/05.DigestAuth` | 751,625 | 65,976 |
| `DIAG` | `L7-Application/20.Diagnostics` | 751,665 | 65,976 |
| `core/06.RegexRoutes` | `L7-Application/06.RegexRoutes` | 751,749 | 65,976 |
| `PER_IP_THROTTLE` | `L4-Transport/05.PerIpThrottle` | 751,809 | 66,424 |
| `DEVICE_ID` | `L7-Application/32.DeviceUuid` | 751,845 | 66,016 |
| `core/05.PathParams` | `L7-Application/05.PathParams` | 751,853 | 65,976 |
| `core/09.WebSocket` | `L6-Presentation/09.WebSocket` | 751,873 | 65,976 |
| `GUARDRAILS` | `L7-Application/40.Guardrails` | 751,981 | 65,992 |
| `core/07.ResponseHeaders` | `L7-Application/07.ResponseHeaders` | 751,997 | 65,976 |
| `core/04.Middleware` | `L7-Application/04.Middleware` | 752,073 | 65,984 |
| `KEEPALIVE` | `L4-Transport/01.KeepAlive` | 752,113 | 65,984 |
| `core/08.ServerSentEvents` | `L6-Presentation/08.ServerSentEvents` | 752,129 | 65,984 |
| `core/36.NetEgress` | `L7-Application/36.NetEgress` | 752,145 | 65,976 |
| `PARTITION_MONITOR` | `L7-Application/37.PartitionMonitor` | 752,189 | 65,984 |
| `core/01.ChunkedResponse` | `L7-Application/01.ChunkedResponse` | 752,197 | 65,992 |
| `core/01.FormParams` | `L6-Presentation/01.FormParams` | 752,273 | 65,976 |
| `OTA_ROLLBACK` | `L7-Application/44.OtaRollback` | 752,481 | 65,992 |
| `AUTH_LOCKOUT` | `L6-Presentation/12.AuthLockout` | 752,497 | 66,552 |
| `core/03.Multipart` | `L6-Presentation/03.Multipart` | 752,561 | 65,976 |
| `TOTP` | `L7-Application/45.Totp` | 752,645 | 66,016 |
| `IP_ALLOWLIST` | `L4-Transport/07.IpAllowlist` | 752,793 | 65,976 |
| `CSRF` | `L7-Application/33.Csrf` | 752,865 | 66,032 |
| `LOGBUF` | `L7-Application/41.LogBuffer` | 752,949 | 69,104 |
| `core/03.InterfaceFilter` | `L7-Application/03.InterfaceFilter` | 753,057 | 65,976 |
| `MODBUS` | `L7-Application/30.ModbusTcp` | 753,197 | 66,264 |
| `core/08.Templating` | `L7-Application/08.Templating` | 753,277 | 66,024 |
| `STATS` | `L7-Application/22.Stats` | 753,325 | 66,080 |
| `MODBUS+MODBUS_MASTER` | `L7-Application/43.ModbusScan` | 753,517 | 66,256 |
| `core/01.Basic` | `Foundation/01.Basic` | 753,537 | 65,992 |
| `JWT` | `L6-Presentation/06.JWTAuth` | 753,621 | 66,552 |
| `TELNET` | `L5-Session/03.Telnet` | 753,693 | 66,520 |
| `AUDIT_LOG` | `L7-Application/49.AuditLog` | 753,721 | 68,968 |
| `CBOR` | `L6-Presentation/13.Cbor` | 753,785 | 66,056 |
| `IPV6` | `Foundation/20.IPv6` | 753,913 | 65,976 |
| `core/03.Expert` | `Foundation/03.Expert` | 754,169 | 66,000 |
| `SYSLOG` | `L7-Application/19.Syslog` | 754,845 | 67,840 |
| `MSGPACK` | `L6-Presentation/14.MsgPack` | 755,069 | 66,056 |
| `STATS+METRICS` | `L7-Application/21.PrometheusMetrics` | 755,477 | 66,120 |
| `core/02.Json` | `L6-Presentation/02.Json` | 755,537 | 65,984 |
| `GPIO_MAP` | `L7-Application/38.GpioMap` | 755,733 | 66,040 |
| `WS_DEFLATE` | `L6-Presentation/11.WebSocketCompression` | 756,141 | 74,192 |
| `WEB_TERMINAL` | `L6-Presentation/10.WebTerminal` | 756,193 | 66,064 |
| `GRAPHQL` | `L7-Application/52.GraphQL` | 756,369 | 70,392 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/42.ConfigExport` | 756,417 | 66,044 |
| `OTA` | `L7-Application/16.OTA` | 756,745 | 102,112 |
| `COAP` | `L7-Application/13.CoAP` | 757,125 | 68,496 |
| `DNS_RESOLVER` | `L7-Application/48.DnsResolver` | 757,413 | 67,264 |
| `PROVISIONING` | `L7-Application/17.Provisioning` | 759,045 | 67,548 |
| `OPCUA` | `L7-Application/55.OpcUa` | 759,393 | 76,264 |
| `core/02.Advanced` | `Foundation/02.Advanced` | 760,177 | 66,088 |
| `SNMP` | `L7-Application/14.SNMP` | 760,249 | 78,384 |
| `TELEMETRY` | `L7-Application/34.Telemetry` | 760,297 | 66,300 |
| `RELAY` | `L7-Application/70.PortForward` | 761,381 | 100,592 |
| `HTTP_CLIENT+WEBHOOK` | `L7-Application/46.Webhook` | 761,985 | 85,736 |
| `OAUTH2+HTTP_CLIENT` | `L7-Application/54.OAuth2` | 764,293 | 88,800 |
| `PROMISC+FORWARD+ETHERNET` | `Foundation/21.WifiCapture` | 764,637 | 47,520 |
| `OIDC` | `L7-Application/50.OidcAuth` | 764,921 | 79,120 |
| `core/04.Sysadmin` | `Foundation/04.Sysadmin` | 765,405 | 65,992 |
...
| `DASHBOARD` | `L7-Application/35.Dashboard` | 772,213 | 66,352 |
| `NTP+TIME_SOURCE` | `L7-Application/31.TimeSourceFallback` | 772,653 | 67,596 |
| `MDNS` | `L7-Application/15.mDNS` | 776,909 | 67,880 |
| `NTP` | `L7-Application/18.SNTP` | 777,169 | 68,528 |
| `OPCUA+OPCUA_CLIENT` | `L7-Application/56.OpcUaClient` | 782,333 | 80,136 |
| `ETHERNET` | `Foundation/19.Ethernet` | 790,085 | 66,028 |
| `core/10.FileServing` | `L7-Application/10.FileServing` | 792,789 | 66,016 |
| `UPLOAD` | `L7-Application/11.FileUpload` | 793,925 | 71,216 |
| `RANGE` | `L7-Application/12.Range` | 794,033 | 66,016 |
| `VFS` | `L7-Application/51.Vfs` | 795,013 | 70,504 |
| `WEBDAV` | `L7-Application/29.WebDav` | 820,781 | 105,352 |
| `SSH` | `L5-Session/03.SSHHostKey` | 821,329 | 88,316 |
| `ETAG` | `L7-Application/09.ETag` | 827,557 | 67,288 |
| `WS_CLIENT+TLS+WS_CLIENT_TLS` | `L7-Application/25.WebSocketClient` | 831,333 | 120,548 |
| `TLS` | `L6-Presentation/07.SecureWebSocket` | 855,541 | 122,020 |
| `TLS+TLS_RESUMPTION` | `L4-Transport/06.TlsResumption` | 856,345 | 122,180 |
| `TLS+MTLS` | `L4-Transport/04.mTLS` | 856,485 | 122,356 |
