...
| `ACCEPT_THROTTLE` | `L4-Transport/02.AcceptThrottle` | 751,265 | 65,984 |
| `core/02.CORS` | `L7-Application/02.CORS` | 751,409 | 65,976 |
| `RADIO_POWER+RADIO_WIFI_PS` | `L7-Application/47.RadioPower` | 751,481 | 65,976 |
| `core/04.BasicAuth` | `L6-Presentation/04.BasicAuth` | 751,481 | 65,976 |
| `core/05.DigestAuth` | `L6-Presentation/05.DigestAuth` | 751,617 | 65,976 |
| `DIAG` | `L7-Application/20.Diagnostics` | 751,657 | 65,976 |
| `core/06.RegexRoutes` | `L7-Application/06.RegexRoutes` | 751,741 | 65,976 |
| `core/09.WebSocket` | `L6-Presentation/09.WebSocket` | 751,769 | 65,976 |
| `PER_IP_THROTTLE` | `L4-Transport/05.PerIpThrottle` | 751,805 | 66,424 |
| `DEVICE_ID` | `L7-Application/32.DeviceUuid` | 751,837 | 66,016 |
| `core/05.PathParams` | `L7-Application/05.PathParams` | 751,845 | 65,976 |
| `GUARDRAILS` | `L7-Application/40.Guardrails` | 751,973 | 65,992 |
| `core/07.ResponseHeaders` | `L7-Application/07.ResponseHeaders` | 751,989 | 65,976 |
| `core/04.Middleware` | `L7-Application/04.Middleware` | 752,065 | 65,984 |
| `KEEPALIVE` | `L4-Transport/01.KeepAlive` | 752,105 | 65,984 |
| `core/08.ServerSentEvents` | `L6-Presentation/08.ServerSentEvents` | 752,121 | 65,984 |
| `core/36.NetEgress` | `L7-Application/36.NetEgress` | 752,137 | 65,976 |
| `PARTITION_MONITOR` | `L7-Application/37.PartitionMonitor` | 752,181 | 65,984 |
| `core/01.ChunkedResponse` | `L7-Application/01.ChunkedResponse` | 752,189 | 65,992 |
| `core/01.FormParams` | `L6-Presentation/01.FormParams` | 752,265 | 65,976 |
| `OTA_ROLLBACK` | `L7-Application/44.OtaRollback` | 752,473 | 65,992 |
| `AUTH_LOCKOUT` | `L6-Presentation/12.AuthLockout` | 752,489 | 66,552 |
| `core/03.Multipart` | `L6-Presentation/03.Multipart` | 752,581 | 65,976 |
| `TOTP` | `L7-Application/45.Totp` | 752,637 | 66,016 |
| `IP_ALLOWLIST` | `L4-Transport/07.IpAllowlist` | 752,789 | 65,976 |
| `CSRF` | `L7-Application/33.Csrf` | 752,857 | 66,032 |
| `LOGBUF` | `L7-Application/41.LogBuffer` | 752,941 | 69,104 |
| `core/03.InterfaceFilter` | `L7-Application/03.InterfaceFilter` | 753,049 | 65,976 |
| `MODBUS` | `L7-Application/30.ModbusTcp` | 753,189 | 66,264 |
| `core/08.Templating` | `L7-Application/08.Templating` | 753,297 | 66,024 |
| `STATS` | `L7-Application/22.Stats` | 753,317 | 66,080 |
| `MODBUS+MODBUS_MASTER` | `L7-Application/43.ModbusScan` | 753,509 | 66,256 |
| `core/01.Basic` | `Foundation/01.Basic` | 753,525 | 65,992 |
| `JWT` | `L6-Presentation/06.JWTAuth` | 753,613 | 66,552 |
| `TELNET` | `L5-Session/03.Telnet` | 753,685 | 66,520 |
| `AUDIT_LOG` | `L7-Application/49.AuditLog` | 753,713 | 68,968 |
| `CBOR` | `L6-Presentation/13.Cbor` | 753,777 | 66,056 |
| `IPV6` | `Foundation/20.IPv6` | 753,905 | 65,976 |
| `core/03.Expert` | `Foundation/03.Expert` | 754,157 | 66,000 |
| `SYSLOG` | `L7-Application/19.Syslog` | 754,837 | 67,840 |
| `MSGPACK` | `L6-Presentation/14.MsgPack` | 755,061 | 66,056 |
| `STATS+METRICS` | `L7-Application/21.PrometheusMetrics` | 755,469 | 66,120 |
| `core/02.Json` | `L6-Presentation/02.Json` | 755,529 | 65,984 |
| `GPIO_MAP` | `L7-Application/38.GpioMap` | 755,725 | 66,040 |
| `WS_DEFLATE` | `L6-Presentation/11.WebSocketCompression` | 756,133 | 74,192 |
| `WEB_TERMINAL` | `L6-Presentation/10.WebTerminal` | 756,181 | 66,064 |
| `GRAPHQL` | `L7-Application/52.GraphQL` | 756,361 | 70,392 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/42.ConfigExport` | 756,409 | 66,044 |
| `OTA` | `L7-Application/16.OTA` | 756,733 | 102,112 |
| `COAP` | `L7-Application/13.CoAP` | 757,117 | 68,496 |
| `DNS_RESOLVER` | `L7-Application/48.DnsResolver` | 757,405 | 67,264 |
| `PROVISIONING` | `L7-Application/17.Provisioning` | 759,037 | 67,548 |
| `OPCUA` | `L7-Application/55.OpcUa` | 759,385 | 76,264 |
| `core/02.Advanced` | `Foundation/02.Advanced` | 760,169 | 66,088 |
| `SNMP` | `L7-Application/14.SNMP` | 760,241 | 78,384 |
| `TELEMETRY` | `L7-Application/34.Telemetry` | 760,289 | 66,300 |
| `RELAY` | `L7-Application/70.PortForward` | 761,369 | 100,592 |
| `HTTP_CLIENT+WEBHOOK` | `L7-Application/46.Webhook` | 761,977 | 85,736 |
| `OAUTH2+HTTP_CLIENT` | `L7-Application/54.OAuth2` | 764,285 | 88,800 |
| `PROMISC+FORWARD+ETHERNET` | `Foundation/21.WifiCapture` | 764,637 | 47,520 |
| `OIDC` | `L7-Application/50.OidcAuth` | 764,913 | 79,120 |
| `core/04.Sysadmin` | `Foundation/04.Sysadmin` | 765,301 | 65,992 |
...
| `DASHBOARD` | `L7-Application/35.Dashboard` | 772,205 | 66,352 |
| `NTP+TIME_SOURCE` | `L7-Application/31.TimeSourceFallback` | 772,645 | 67,596 |
| `MDNS` | `L7-Application/15.mDNS` | 776,901 | 67,880 |
| `NTP` | `L7-Application/18.SNTP` | 777,161 | 68,528 |
| `OPCUA+OPCUA_CLIENT` | `L7-Application/56.OpcUaClient` | 782,325 | 80,136 |
| `ETHERNET` | `Foundation/19.Ethernet` | 790,077 | 66,028 |
| `core/10.FileServing` | `L7-Application/10.FileServing` | 792,781 | 66,016 |
| `UPLOAD` | `L7-Application/11.FileUpload` | 793,917 | 71,216 |
| `RANGE` | `L7-Application/12.Range` | 794,025 | 66,016 |
| `VFS` | `L7-Application/51.Vfs` | 795,005 | 70,504 |
| `WEBDAV` | `L7-Application/29.WebDav` | 820,769 | 105,352 |
| `SSH` | `L5-Session/03.SSHHostKey` | 821,317 | 88,316 |
| `ETAG` | `L7-Application/09.ETag` | 827,549 | 67,288 |
| `WS_CLIENT+TLS+WS_CLIENT_TLS` | `L7-Application/25.WebSocketClient` | 831,333 | 120,548 |
| `TLS` | `L6-Presentation/07.SecureWebSocket` | 855,533 | 116,900 |
| `TLS+TLS_RESUMPTION` | `L4-Transport/06.TlsResumption` | 856,333 | 117,060 |
| `TLS+MTLS` | `L4-Transport/04.mTLS` | 856,477 | 117,236 |
