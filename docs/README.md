...
| `DNS_SERVER` | `L7-Application/60.DnsServer` | 725,673 | 45,976 |
| `COAP+COAP_BLOCK+COAP_MAX_PAYLOAD` | `L7-Application/28.CoapBlock` | 727,549 | 48,352 |
...
| `DNC` | `L7-Application/69.EthernetDnc` | 733,825 | 61,112 |
...
| `ACCEPT_THROTTLE` | `L4-Transport/02.AcceptThrottle` | 750,917 | 66,264 |
| `core/02.CORS` | `L7-Application/02.CORS` | 751,081 | 66,256 |
| `core/04.BasicAuth` | `L6-Presentation/04.BasicAuth` | 751,153 | 66,256 |
| `RADIO_POWER+RADIO_WIFI_PS` | `L7-Application/47.RadioPower` | 751,157 | 66,256 |
| `core/05.DigestAuth` | `L6-Presentation/05.DigestAuth` | 751,277 | 66,256 |
| `core/06.RegexRoutes` | `L7-Application/06.RegexRoutes` | 751,393 | 66,256 |
| `PER_IP_THROTTLE` | `L4-Transport/05.PerIpThrottle` | 751,457 | 66,704 |
| `core/05.PathParams` | `L7-Application/05.PathParams` | 751,493 | 66,256 |
| `DEVICE_ID` | `L7-Application/32.DeviceUuid` | 751,533 | 66,368 |
| `core/09.WebSocket` | `L6-Presentation/09.WebSocket` | 751,541 | 66,256 |
| `core/07.ResponseHeaders` | `L7-Application/07.ResponseHeaders` | 751,641 | 66,256 |
| `GUARDRAILS` | `L7-Application/40.Guardrails` | 751,677 | 66,336 |
| `core/04.Middleware` | `L7-Application/04.Middleware` | 751,733 | 66,256 |
| `core/01.ChunkedResponse` | `L7-Application/01.ChunkedResponse` | 751,789 | 66,264 |
| `core/08.ServerSentEvents` | `L6-Presentation/08.ServerSentEvents` | 751,797 | 66,264 |
| `KEEPALIVE` | `L4-Transport/01.KeepAlive` | 751,801 | 66,264 |
| `PARTITION_MONITOR` | `L7-Application/37.PartitionMonitor` | 751,833 | 66,264 |
| `core/36.NetEgress` | `L7-Application/36.NetEgress` | 751,841 | 66,328 |
| `core/01.FormParams` | `L6-Presentation/01.FormParams` | 751,933 | 66,256 |
| `AUTH_LOCKOUT` | `L6-Presentation/12.AuthLockout` | 752,165 | 66,832 |
| `OTA_ROLLBACK` | `L7-Application/44.OtaRollback` | 752,193 | 66,336 |
| `core/03.Multipart` | `L6-Presentation/03.Multipart` | 752,229 | 66,256 |
| `TOTP` | `L7-Application/45.Totp` | 752,289 | 66,288 |
| `IP_ALLOWLIST` | `L4-Transport/07.IpAllowlist` | 752,477 | 66,256 |
| `CSRF` | `L7-Application/33.Csrf` | 752,537 | 66,376 |
| `LOGBUF` | `L7-Application/41.LogBuffer` | 752,593 | 69,376 |
| `core/03.InterfaceFilter` | `L7-Application/03.InterfaceFilter` | 752,717 | 66,256 |
| `DIAG` | `Foundation/05.Configuration` | 752,801 | 63,008 |
| `core/08.Templating` | `L7-Application/08.Templating` | 752,917 | 66,296 |
| `MODBUS` | `L7-Application/30.ModbusTcp` | 752,929 | 66,608 |
| `STATS` | `L7-Application/22.Stats` | 753,001 | 66,424 |
| `core/01.Basic` | `Foundation/01.Basic` | 753,189 | 66,264 |
| `MODBUS+MODBUS_MASTER` | `L7-Application/43.ModbusScan` | 753,209 | 66,536 |
| `JWT` | `L6-Presentation/06.JWTAuth` | 753,277 | 66,832 |
| `CBOR` | `L6-Presentation/13.Cbor` | 753,397 | 66,336 |
| `AUDIT_LOG` | `L7-Application/49.AuditLog` | 753,425 | 69,312 |
| `TELNET` | `L5-Session/03.Telnet` | 753,429 | 66,792 |
| `IPV6` | `Foundation/20.IPv6` | 753,577 | 66,256 |
| `core/03.Expert` | `Foundation/03.Expert` | 753,821 | 66,280 |
| `SYSLOG` | `L7-Application/19.Syslog` | 754,501 | 68,120 |
| `MSGPACK` | `L6-Presentation/14.MsgPack` | 754,685 | 66,336 |
| `STATS+METRICS` | `L7-Application/21.PrometheusMetrics` | 755,165 | 66,472 |
| `core/02.Json` | `L6-Presentation/02.Json` | 755,193 | 66,264 |
| `GPIO_MAP` | `L7-Application/38.GpioMap` | 755,425 | 66,384 |
| `WS_DEFLATE` | `L6-Presentation/11.WebSocketCompression` | 755,773 | 74,464 |
| `WEB_TERMINAL` | `L6-Presentation/10.WebTerminal` | 755,881 | 66,336 |
| `GRAPHQL` | `L7-Application/52.GraphQL` | 756,049 | 70,736 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/42.ConfigExport` | 756,069 | 66,324 |
| `OTA` | `L7-Application/16.OTA` | 756,377 | 102,384 |
| `COAP` | `L7-Application/13.CoAP` | 756,761 | 68,768 |
| `DNS_RESOLVER` | `L7-Application/48.DnsResolver` | 757,133 | 67,608 |
| `PROVISIONING` | `L7-Application/17.Provisioning` | 758,697 | 67,828 |
| `OPCUA` | `L7-Application/55.OpcUa` | 759,065 | 76,544 |
| `core/02.Advanced` | `Foundation/02.Advanced` | 759,837 | 66,368 |
| `SNMP` | `L7-Application/14.SNMP` | 759,917 | 78,664 |
| `TELEMETRY` | `L7-Application/34.Telemetry` | 760,001 | 66,644 |
| `RELAY` | `L7-Application/70.PortForward` | 761,105 | 100,944 |
| `HTTP_CLIENT+WEBHOOK` | `L7-Application/46.Webhook` | 761,629 | 86,008 |
| `OAUTH2+HTTP_CLIENT` | `L7-Application/54.OAuth2` | 764,009 | 89,176 |
| `OIDC` | `L7-Application/50.OidcAuth` | 764,621 | 79,472 |
| `PROMISC+FORWARD+ETHERNET` | `Foundation/21.WifiCapture` | 764,629 | 47,520 |
| `core/04.Sysadmin` | `Foundation/04.Sysadmin` | 765,049 | 66,272 |
| `RTC+TIME_SOURCE+NTP` | `L7-Application/61.Rtc` | 766,653 | 45,372 |
| `BUS_CAPTURE+FORWARD+ETHERNET` | `Foundation/22.CanCapture` | 771,157 | 45,516 |
| `DASHBOARD` | `L7-Application/35.Dashboard` | 771,941 | 66,704 |
| `NTP+TIME_SOURCE` | `L7-Application/31.TimeSourceFallback` | 772,309 | 67,876 |
| `MDNS` | `L7-Application/15.mDNS` | 776,569 | 68,160 |
| `NTP` | `L7-Application/18.SNTP` | 776,869 | 68,880 |
| `OPCUA+OPCUA_CLIENT` | `L7-Application/56.OpcUaClient` | 782,001 | 80,408 |
| `ETHERNET` | `Foundation/19.Ethernet` | 789,733 | 66,308 |
| `core/10.FileServing` | `L7-Application/10.FileServing` | 792,489 | 66,296 |
| `UPLOAD` | `L7-Application/11.FileUpload` | 793,609 | 71,488 |
| `RANGE` | `L7-Application/12.Range` | 793,733 | 66,296 |
| `VFS` | `L7-Application/51.Vfs` | 794,721 | 70,856 |
| `WEBDAV` | `L7-Application/29.WebDav` | 820,285 | 105,696 |
| `SSH` | `L5-Session/03.SSHHostKey` | 821,097 | 88,588 |
| `ETAG` | `L7-Application/09.ETag` | 827,293 | 67,568 |
| `WS_CLIENT+TLS+WS_CLIENT_TLS` | `L7-Application/25.WebSocketClient` | 831,329 | 120,580 |
| `TLS` | `L6-Presentation/07.SecureWebSocket` | 855,297 | 117,172 |
| `TLS+TLS_RESUMPTION` | `L4-Transport/06.TlsResumption` | 856,125 | 117,332 |
| `TLS+MTLS` | `L4-Transport/04.mTLS` | 856,245 | 117,508 |
