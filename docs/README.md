...
| `ACCEPT_THROTTLE` | `L4-Transport/02.AcceptThrottle` | 750,697 | 65,984 |
| `core/02.CORS` | `L7-Application/02.CORS` | 750,853 | 65,976 |
| `core/04.BasicAuth` | `L6-Presentation/04.BasicAuth` | 750,929 | 65,976 |
| `RADIO_POWER+RADIO_WIFI_PS` | `L7-Application/47.RadioPower` | 750,937 | 65,984 |
| `core/05.DigestAuth` | `L6-Presentation/05.DigestAuth` | 751,045 | 65,976 |
| `DIAG` | `L7-Application/20.Diagnostics` | 751,101 | 65,976 |
| `core/06.RegexRoutes` | `L7-Application/06.RegexRoutes` | 751,165 | 65,976 |
| `PER_IP_THROTTLE` | `L4-Transport/05.PerIpThrottle` | 751,233 | 66,424 |
| `DEVICE_ID` | `L7-Application/32.DeviceUuid` | 751,261 | 66,016 |
| `core/05.PathParams` | `L7-Application/05.PathParams` | 751,265 | 65,976 |
| `core/09.WebSocket` | `L6-Presentation/09.WebSocket` | 751,309 | 65,976 |
| `GUARDRAILS` | `L7-Application/40.Guardrails` | 751,401 | 65,992 |
| `core/07.ResponseHeaders` | `L7-Application/07.ResponseHeaders` | 751,413 | 65,976 |
| `core/04.Middleware` | `L7-Application/04.Middleware` | 751,505 | 65,984 |
| `KEEPALIVE` | `L4-Transport/01.KeepAlive` | 751,509 | 65,984 |
| `core/08.ServerSentEvents` | `L6-Presentation/08.ServerSentEvents` | 751,545 | 65,984 |
| `core/01.ChunkedResponse` | `L7-Application/01.ChunkedResponse` | 751,553 | 65,992 |
| `core/36.NetEgress` | `L7-Application/36.NetEgress` | 751,573 | 65,984 |
| `PARTITION_MONITOR` | `L7-Application/37.PartitionMonitor` | 751,609 | 65,984 |
| `core/01.FormParams` | `L6-Presentation/01.FormParams` | 751,705 | 65,976 |
| `OTA_ROLLBACK` | `L7-Application/44.OtaRollback` | 751,917 | 65,992 |
| `AUTH_LOCKOUT` | `L6-Presentation/12.AuthLockout` | 751,941 | 66,552 |
| `core/03.Multipart` | `L6-Presentation/03.Multipart` | 752,005 | 65,976 |
| `TOTP` | `L7-Application/45.Totp` | 752,069 | 66,016 |
| `IP_ALLOWLIST` | `L4-Transport/07.IpAllowlist` | 752,241 | 65,976 |
| `CSRF` | `L7-Application/33.Csrf` | 752,305 | 66,032 |
| `LOGBUF` | `L7-Application/41.LogBuffer` | 752,373 | 69,104 |
| `core/03.InterfaceFilter` | `L7-Application/03.InterfaceFilter` | 752,493 | 65,976 |
| `MODBUS` | `L7-Application/30.ModbusTcp` | 752,617 | 66,264 |
| `core/08.Templating` | `L7-Application/08.Templating` | 752,677 | 66,024 |
| `STATS` | `L7-Application/22.Stats` | 752,741 | 66,080 |
| `MODBUS+MODBUS_MASTER` | `L7-Application/43.ModbusScan` | 752,949 | 66,256 |
| `core/01.Basic` | `Foundation/01.Basic` | 752,961 | 65,992 |
| `JWT` | `L6-Presentation/06.JWTAuth` | 753,053 | 66,552 |
| `TELNET` | `L5-Session/03.Telnet` | 753,149 | 66,520 |
| `CBOR` | `L6-Presentation/13.Cbor` | 753,161 | 66,056 |
| `AUDIT_LOG` | `L7-Application/49.AuditLog` | 753,165 | 68,968 |
| `IPV6` | `Foundation/20.IPv6` | 753,349 | 65,976 |
| `core/03.Expert` | `Foundation/03.Expert` | 753,613 | 66,000 |
| `SYSLOG` | `L7-Application/19.Syslog` | 754,281 | 67,840 |
| `MSGPACK` | `L6-Presentation/14.MsgPack` | 754,433 | 66,056 |
| `STATS+METRICS` | `L7-Application/21.PrometheusMetrics` | 754,893 | 66,128 |
| `core/02.Json` | `L6-Presentation/02.Json` | 754,965 | 65,984 |
| `GPIO_MAP` | `L7-Application/38.GpioMap` | 755,157 | 66,040 |
| `WS_DEFLATE` | `L6-Presentation/11.WebSocketCompression` | 755,537 | 74,192 |
| `WEB_TERMINAL` | `L6-Presentation/10.WebTerminal` | 755,649 | 66,064 |
| `GRAPHQL` | `L7-Application/52.GraphQL` | 755,781 | 70,384 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/42.ConfigExport` | 755,849 | 66,044 |
| `OTA` | `L7-Application/16.OTA` | 756,153 | 102,112 |
| `COAP` | `L7-Application/13.CoAP` | 756,533 | 68,496 |
| `DNS_RESOLVER` | `L7-Application/48.DnsResolver` | 756,861 | 67,264 |
| `PROVISIONING` | `L7-Application/17.Provisioning` | 758,473 | 67,548 |
| `OPCUA` | `L7-Application/55.OpcUa` | 758,837 | 76,264 |
| `core/02.Advanced` | `Foundation/02.Advanced` | 759,605 | 66,088 |
| `SNMP` | `L7-Application/14.SNMP` | 759,689 | 78,384 |
| `TELEMETRY` | `L7-Application/34.Telemetry` | 759,733 | 66,300 |
| `RELAY` | `L7-Application/70.PortForward` | 760,801 | 100,592 |
| `HTTP_CLIENT+WEBHOOK` | `L7-Application/46.Webhook` | 761,405 | 85,736 |
| `OAUTH2+HTTP_CLIENT` | `L7-Application/54.OAuth2` | 763,729 | 88,800 |
| `OIDC` | `L7-Application/50.OidcAuth` | 764,333 | 79,120 |
| `PROMISC+FORWARD+ETHERNET` | `Foundation/21.WifiCapture` | 764,637 | 47,520 |
| `core/04.Sysadmin` | `Foundation/04.Sysadmin` | 764,821 | 65,992 |
...
| `DASHBOARD` | `L7-Application/35.Dashboard` | 771,637 | 66,352 |
| `NTP+TIME_SOURCE` | `L7-Application/31.TimeSourceFallback` | 772,081 | 67,596 |
| `MDNS` | `L7-Application/15.mDNS` | 776,341 | 67,880 |
| `NTP` | `L7-Application/18.SNTP` | 776,601 | 68,536 |
| `OPCUA+OPCUA_CLIENT` | `L7-Application/56.OpcUaClient` | 781,765 | 80,128 |
| `ETHERNET` | `Foundation/19.Ethernet` | 789,505 | 66,028 |
| `core/10.FileServing` | `L7-Application/10.FileServing` | 792,241 | 66,016 |
| `UPLOAD` | `L7-Application/11.FileUpload` | 793,365 | 71,216 |
| `RANGE` | `L7-Application/12.Range` | 793,493 | 66,016 |
| `VFS` | `L7-Application/51.Vfs` | 794,425 | 70,504 |
| `WEBDAV` | `L7-Application/29.WebDav` | 820,205 | 105,352 |
| `SSH` | `L5-Session/03.SSHHostKey` | 820,745 | 88,316 |
| `ETAG` | `L7-Application/09.ETag` | 826,993 | 67,288 |
...
| `TLS+MTLS` | `L4-Transport/04.mTLS` | 855,933 | 117,236 |
