...
| `SCPI` | `L7-Application/Scpi` | 725,361 | 43,812 |
...
| `IKEV2` | `L5-Session/IKEv2` | 727,489 | 43,948 |
...
| `core/DigestAuth` | `L6-Presentation/DigestAuth` | 753,477 | 81,820 |
| `core/BasicAuth` | `L6-Presentation/BasicAuth` | 753,489 | 81,820 |
| `RADIO_POWER+RADIO_WIFI_PS` | `L7-Application/RadioPower` | 753,501 | 81,820 |
| `core/MediaStreaming` | `L7-Application/MediaStreaming` | 753,553 | 81,820 |
| `core/RegexRoutes` | `L7-Application/RegexRoutes` | 753,593 | 81,820 |
| `KEEPALIVE` | `L4-Transport/KeepAlive` | 753,637 | 81,820 |
| `DEVICE_ID` | `L7-Application/DeviceUuid` | 753,681 | 81,860 |
| `DIFFSERV` | `L4-Transport/DiffServ` | 753,701 | 81,820 |
| `core/PathParams` | `L7-Application/PathParams` | 753,717 | 81,820 |
| `GUARDRAILS` | `L7-Application/Guardrails` | 753,793 | 81,836 |
| `PER_IP_THROTTLE` | `L4-Transport/PerIpThrottle` | 753,805 | 82,268 |
| `core/ResponseHeaders` | `L7-Application/ResponseHeaders` | 753,849 | 81,820 |
...
| `core/ServerSentEvents` | `L6-Presentation/ServerSentEvents` | 754,321 | 81,828 |
| `OTA_ROLLBACK` | `L7-Application/OtaRollback` | 754,477 | 81,836 |
| `AUTH_LOCKOUT` | `L6-Presentation/AuthLockout` | 754,569 | 82,396 |
| `TOTP` | `L7-Application/Totp` | 754,633 | 81,860 |
| `core/Multipart` | `L6-Presentation/Multipart` | 754,657 | 81,820 |
| `LOGBUF` | `L7-Application/LogBuffer` | 754,809 | 84,948 |
| `IP_ALLOWLIST` | `L4-Transport/IpAllowlist` | 754,861 | 81,820 |
| `CSRF` | `L7-Application/Csrf` | 755,041 | 84,020 |
...
| `PACKML` | `L7-Application/PackML` | 755,921 | 81,868 |
| `MODBUS+MODBUS_MASTER` | `L7-Application/ModbusScan` | 756,081 | 82,100 |
| `IPV6` | `Foundation/IPv6` | 756,117 | 81,820 |
| `core/Expert` | `Foundation/Expert` | 756,317 | 81,844 |
| `MSGPACK` | `L6-Presentation/MsgPack` | 757,257 | 81,900 |
| `STATS+METRICS` | `L7-Application/PrometheusMetrics` | 757,389 | 81,964 |
| `SYSLOG` | `L7-Application/Syslog` | 757,481 | 83,732 |
| `core/Json` | `L6-Presentation/Json` | 757,537 | 81,828 |
| `AUTH_LOCKOUT+FORWARDED_TRUST` | `L6-Presentation/ForwardedTrust` | 757,761 | 82,436 |
| `GPIO_MAP` | `L7-Application/GpioMap` | 757,925 | 81,884 |
| `WEB_TERMINAL` | `L6-Presentation/WebTerminal` | 758,209 | 81,908 |
| `WS_DEFLATE` | `L6-Presentation/WebSocketCompression` | 758,253 | 90,028 |
| `GRAPHQL` | `L7-Application/GraphQL` | 758,357 | 86,236 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/ConfigExport` | 758,469 | 81,888 |
| `OTA` | `L7-Application/OTA` | 759,013 | 102,156 |
| `DNS_RESOLVER` | `L7-Application/DnsResolver` | 759,585 | 83,108 |
| `COAP` | `L7-Application/CoAP` | 760,937 | 85,540 |
| `PROVISIONING` | `L7-Application/Provisioning` | 761,777 | 83,456 |
| `OPCUA` | `L7-Application/OpcUa` | 761,997 | 92,108 |
| `core/Advanced` | `Foundation/Advanced` | 762,237 | 81,932 |
| `TELEMETRY` | `L7-Application/Telemetry` | 762,501 | 82,144 |
| `SNMP` | `L7-Application/SNMP` | 762,733 | 94,276 |
...
| `SMB` | `L7-Application/SmbFileClient` | 766,921 | 67,884 |
...
| `NTRIP_CASTER` | `L7-Application/NtripCaster` | 771,453 | 84,744 |
| `BUS_CAPTURE+FORWARD+ETHERNET` | `Peripherals/CanCapture` | 771,997 | 45,568 |
| `DASHBOARD` | `L7-Application/Dashboard` | 774,521 | 82,196 |
| `EDGE_CACHE+HTTP_CACHE+HTTP_CLIENT` | `L7-Application/EdgeCache` | 774,697 | 119,308 |
| `NTP+TIME_SOURCE` | `L7-Application/TimeSourceFallback` | 774,901 | 83,436 |
| `EDGE_CACHE+HTTP_CACHE+HTTP_CLIENT+EDGE_MESH` | `L7-Application/MeshCache` | 778,433 | 124,240 |
| `MDNS` | `L7-Application/mDNS` | 779,041 | 83,728 |
...
| `COAP+DTLS` | `L7-Application/CoapSecure` | 782,389 | 106,276 |
...
| `UPLOAD` | `L7-Application/FileUpload` | 795,865 | 101,980 |
| `RANGE` | `L7-Application/Range` | 796,065 | 81,860 |
| `VFS` | `L7-Application/Vfs` | 797,093 | 86,348 |
...
| `SSH+SSH_CLIENT+SSH_CLIENT_MAX_CHANNELS+CLIENT_RX_BUF` | `L5-Session/SSHReverseTunnel` | 847,793 | 112,456 |
...
| `SSH+FILE_SERVING+SSH_SFTP+SSH_SCP` | `L5-Session/SSHSftp` | 884,597 | 120,048 |
