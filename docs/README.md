...
| `ACCEPT_THROTTLE` | `L4-Transport/02.AcceptThrottle` | 752,053 | 81,784 |
| `core/71.MediaStreaming` | `L7-Application/71.MediaStreaming` | 752,141 | 81,776 |
| `core/02.CORS` | `L7-Application/02.CORS` | 752,217 | 81,776 |
| `RADIO_POWER+RADIO_WIFI_PS` | `L7-Application/47.RadioPower` | 752,285 | 81,776 |
| `core/04.BasicAuth` | `L6-Presentation/04.BasicAuth` | 752,289 | 81,776 |
| `core/05.DigestAuth` | `L6-Presentation/05.DigestAuth` | 752,413 | 81,776 |
| `core/06.RegexRoutes` | `L7-Application/06.RegexRoutes` | 752,537 | 81,776 |
| `PER_IP_THROTTLE` | `L4-Transport/05.PerIpThrottle` | 752,557 | 82,224 |
| `KEEPALIVE` | `L4-Transport/01.KeepAlive` | 752,577 | 81,776 |
| `DEVICE_ID` | `L7-Application/32.DeviceUuid` | 752,609 | 81,816 |
| `core/05.PathParams` | `L7-Application/05.PathParams` | 752,621 | 81,776 |
| `core/09.WebSocket` | `L6-Presentation/09.WebSocket` | 752,661 | 81,776 |
| `GUARDRAILS` | `L7-Application/40.Guardrails` | 752,729 | 81,792 |
| `core/07.ResponseHeaders` | `L7-Application/07.ResponseHeaders` | 752,753 | 81,776 |
| `core/04.Middleware` | `L7-Application/04.Middleware` | 752,845 | 81,784 |
| `core/08.ServerSentEvents` | `L6-Presentation/08.ServerSentEvents` | 752,853 | 81,784 |
...
| `core/01.ChunkedResponse` | `L7-Application/01.ChunkedResponse` | 752,945 | 81,792 |
| `core/01.FormParams` | `L6-Presentation/01.FormParams` | 753,045 | 81,776 |
| `OTA_ROLLBACK` | `L7-Application/44.OtaRollback` | 753,273 | 81,792 |
| `AUTH_LOCKOUT` | `L6-Presentation/12.AuthLockout` | 753,285 | 82,352 |
| `core/03.Multipart` | `L6-Presentation/03.Multipart` | 753,357 | 81,776 |
| `TOTP` | `L7-Application/45.Totp` | 753,393 | 81,816 |
| `IP_ALLOWLIST` | `L4-Transport/07.IpAllowlist` | 753,581 | 81,776 |
| `CSRF` | `L7-Application/33.Csrf` | 753,657 | 81,832 |
| `LOGBUF` | `L7-Application/41.LogBuffer` | 753,713 | 84,904 |
| `core/03.InterfaceFilter` | `L7-Application/03.InterfaceFilter` | 753,845 | 81,776 |
| `MODBUS` | `L7-Application/30.ModbusTcp` | 753,965 | 82,064 |
| `core/08.Templating` | `L7-Application/08.Templating` | 754,021 | 81,824 |
| `STATS` | `L7-Application/22.Stats` | 754,093 | 81,880 |
| `CONTROL` | `L7-Application/74.PidTuning` | 754,201 | 89,856 |
| `MODBUS+MODBUS_MASTER` | `L7-Application/43.ModbusScan` | 754,305 | 82,056 |
| `core/01.Basic` | `Foundation/01.Basic` | 754,305 | 81,792 |
| `DIAG` | `Foundation/05.Configuration` | 754,353 | 77,536 |
| `JWT` | `L6-Presentation/06.JWTAuth` | 754,401 | 82,928 |
| `TELNET` | `L5-Session/04.Telnet` | 754,461 | 82,320 |
| `AUDIT_LOG` | `L7-Application/49.AuditLog` | 754,509 | 84,768 |
| `CBOR` | `L6-Presentation/13.Cbor` | 754,553 | 81,856 |
| `IPV6` | `Foundation/20.IPv6` | 754,705 | 81,776 |
| `core/03.Expert` | `Foundation/03.Expert` | 754,953 | 81,800 |
| `SYSLOG` | `L7-Application/19.Syslog` | 755,617 | 83,640 |
| `MSGPACK` | `L6-Presentation/14.MsgPack` | 755,853 | 81,856 |
| `STATS+METRICS` | `L7-Application/21.PrometheusMetrics` | 756,249 | 81,920 |
| `core/02.Json` | `L6-Presentation/02.Json` | 756,313 | 81,784 |
| `GPIO_MAP` | `L7-Application/38.GpioMap` | 756,525 | 81,840 |
| `WS_DEFLATE` | `L6-Presentation/11.WebSocketCompression` | 756,909 | 89,976 |
| `WEB_TERMINAL` | `L6-Presentation/10.WebTerminal` | 757,053 | 81,864 |
| `GRAPHQL` | `L7-Application/52.GraphQL` | 757,101 | 86,192 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/42.ConfigExport` | 757,189 | 81,844 |
| `OTA` | `L7-Application/16.OTA` | 757,509 | 102,128 |
| `COAP` | `L7-Application/13.CoAP` | 757,913 | 84,296 |
...
| `core/02.Advanced` | `Foundation/02.Advanced` | 760,973 | 81,888 |
| `SNMP` | `L7-Application/14.SNMP` | 761,037 | 94,184 |
...
| `core/04.Sysadmin` | `Foundation/04.Sysadmin` | 766,185 | 81,792 |
| `RTC+TIME_SOURCE+NTP` | `L7-Application/61.Rtc` | 766,653 | 45,372 |
| `OPCUA+UMATI` | `L7-Application/72.Umati` | 766,897 | 92,208 |
| `NTRIP_CASTER` | `L7-Application/76.NtripCaster` | 770,357 | 84,700 |
...
| `MDNS` | `L7-Application/15.mDNS` | 777,697 | 83,680 |
| `NTP` | `L7-Application/18.SNTP` | 777,949 | 84,328 |
| `COAP+DTLS` | `L7-Application/78.CoapSecure` | 779,785 | 102,864 |
...
| `ETHERNET` | `Foundation/19.Ethernet` | 791,093 | 81,828 |
| `ETHERNET+ETH_W5500+ETH_W5500_CS+ETH_W5500_RST+ETH_W5500_INT+ETH_W5500_SCK+ETH_W5500_MISO+ETH_W5500_MOSI` | `Foundation/23.EthernetW5500` | 791,109 | 81,828 |
| `core/10.FileServing` | `L7-Application/10.FileServing` | 793,593 | 81,816 |
| `UPLOAD` | `L7-Application/11.FileUpload` | 794,737 | 91,128 |
| `RANGE` | `L7-Application/12.Range` | 794,821 | 81,816 |
...
| `SSH` | `L5-Session/01.SSH` | 827,781 | 108,644 |
| `ETAG` | `L7-Application/09.ETag` | 828,337 | 83,088 |
...
| `TLS+TLS_ARENA_SIZE` | `L6-Presentation/07.SecureWebSocket` | 856,361 | 105,652 |
| `TLS+TLS_RESUMPTION` | `L4-Transport/06.TlsResumption` | 856,693 | 122,180 |
| `TLS+MTLS` | `L4-Transport/04.mTLS` | 856,829 | 122,356 |
| `TLS+TLS_RESUMPTION+TLS_ARENA_SIZE` | `L4-Transport/06.TlsResumption` | 857,217 | 105,812 |
| `TLS+MTLS+TLS_ARENA_SIZE` | `L4-Transport/04.mTLS` | 857,377 | 105,988 |
