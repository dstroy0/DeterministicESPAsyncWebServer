...
| `DIAG` | `L7-Application/20.Diagnostics` | 752,889 | 81,776 |
...
| `OPCUA` | `L7-Application/55.OpcUa` | 760,189 | 92,064 |
...
| `OPCUA+OPCUA_CLIENT` | `L7-Application/56.OpcUaClient` | 783,149 | 95,936 |
