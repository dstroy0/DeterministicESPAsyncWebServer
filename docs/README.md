...
| `ACCEPT_THROTTLE` | `L4-Transport/AcceptThrottle` | 752,617 | 81,796 |
| `core/CORS` | `L7-Application/CORS` | 752,785 | 81,788 |
| `core/DigestAuth` | `L6-Presentation/DigestAuth` | 752,861 | 81,788 |
| `core/BasicAuth` | `L6-Presentation/BasicAuth` | 752,873 | 81,788 |
| `RADIO_POWER+RADIO_WIFI_PS` | `L7-Application/RadioPower` | 752,877 | 81,788 |
...
| `GUARDRAILS` | `L7-Application/Guardrails` | 753,181 | 81,804 |
| `core/ResponseHeaders` | `L7-Application/ResponseHeaders` | 753,237 | 81,788 |
| `core/WebSocket` | `L6-Presentation/WebSocket` | 753,249 | 81,788 |
| `ADS` | `L7-Application/AdsClient` | 753,317 | 44,204 |
| `core/Middleware` | `L7-Application/Middleware` | 753,333 | 81,796 |
| `core/ChunkedResponse` | `L7-Application/ChunkedResponse` | 753,461 | 81,804 |
| `DIAG` | `L7-Application/Diagnostics` | 753,473 | 81,788 |
| `core/ServerSentEvents` | `L6-Presentation/ServerSentEvents` | 753,509 | 81,796 |
| `core/NetEgress` | `L7-Application/NetEgress` | 753,541 | 81,788 |
| `core/FormParams` | `L6-Presentation/FormParams` | 753,565 | 81,788 |
| `PARTITION_MONITOR` | `L7-Application/PartitionMonitor` | 753,605 | 81,796 |
| `OTA_ROLLBACK` | `L7-Application/OtaRollback` | 753,865 | 81,804 |
| `AUTH_LOCKOUT` | `L6-Presentation/AuthLockout` | 753,973 | 82,364 |
| `TOTP` | `L7-Application/Totp` | 754,037 | 81,828 |
| `core/Multipart` | `L6-Presentation/Multipart` | 754,053 | 81,788 |
| `LOGBUF` | `L7-Application/LogBuffer` | 754,185 | 84,916 |
| `IP_ALLOWLIST` | `L4-Transport/IpAllowlist` | 754,257 | 81,788 |
| `core/InterfaceFilter` | `L7-Application/InterfaceFilter` | 754,485 | 81,788 |
| `CSRF` | `L7-Application/Csrf` | 754,513 | 81,844 |
| `MODBUS` | `L7-Application/ModbusTcp` | 754,533 | 82,076 |
| `core/Templating` | `L7-Application/Templating` | 754,545 | 81,836 |
| `SPA_ROUTER` | `L7-Application/SpaFallback` | 754,645 | 81,788 |
| `STATS` | `L7-Application/Stats` | 754,777 | 81,892 |
| `CONTROL` | `L7-Application/PidTuning` | 754,909 | 89,868 |
| `MODBUS+MODBUS_MASTER` | `L7-Application/ModbusScan` | 754,993 | 82,068 |
| `JWT` | `L6-Presentation/JWTAuth` | 754,997 | 82,940 |
| `core/Basic` | `Foundation/Basic` | 755,017 | 81,804 |
| `TELNET` | `L5-Session/Telnet` | 755,189 | 82,332 |
| `AUDIT_LOG` | `L7-Application/AuditLog` | 755,249 | 84,780 |
| `CBOR` | `L6-Presentation/Cbor` | 755,285 | 81,868 |
| `IPV6` | `Foundation/IPv6` | 755,485 | 81,788 |
| `core/Expert` | `Foundation/Expert` | 755,693 | 81,812 |
| `SYSLOG` | `L7-Application/Syslog` | 756,473 | 83,700 |
| `MSGPACK` | `L6-Presentation/MsgPack` | 756,625 | 81,868 |
| `STATS+METRICS` | `L7-Application/PrometheusMetrics` | 756,773 | 81,932 |
| `core/Json` | `L6-Presentation/Json` | 756,909 | 81,796 |
| `AUTH_LOCKOUT+FORWARDED_TRUST` | `L6-Presentation/ForwardedTrust` | 757,133 | 82,404 |
| `GPIO_MAP` | `L7-Application/GpioMap` | 757,297 | 81,852 |
| `WEB_TERMINAL` | `L6-Presentation/WebTerminal` | 757,613 | 81,876 |
| `WS_DEFLATE` | `L6-Presentation/WebSocketCompression` | 757,629 | 90,004 |
| `GRAPHQL` | `L7-Application/GraphQL` | 757,737 | 86,204 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/ConfigExport` | 757,845 | 81,856 |
| `OTA` | `L7-Application/OTA` | 758,389 | 102,132 |
| `COAP` | `L7-Application/CoAP` | 758,817 | 84,356 |
| `DNS_RESOLVER` | `L7-Application/DnsResolver` | 758,957 | 83,076 |
| `PROVISIONING` | `L7-Application/Provisioning` | 761,137 | 83,424 |
| `OPCUA` | `L7-Application/OpcUa` | 761,237 | 92,076 |
| `core/Advanced` | `Foundation/Advanced` | 761,621 | 81,900 |
| `TELEMETRY` | `L7-Application/Telemetry` | 761,865 | 82,112 |
| `SNMP` | `L7-Application/SNMP` | 762,093 | 94,244 |
| `RELAY` | `L7-Application/PortForward` | 762,685 | 116,404 |
| `HTTP_CLIENT+WEBHOOK` | `L7-Application/Webhook` | 763,493 | 101,548 |
| `OPCUA+OPCUA_CLIENT` | `L7-Application/OpcUaClient` | 765,621 | 94,692 |
| `OAUTH2+HTTP_CLIENT` | `L7-Application/OAuth2` | 765,829 | 104,612 |
| `PROMISC+FORWARD+ETHERNET` | `Peripherals/WifiCapture` | 766,049 | 47,584 |
| `OIDC` | `L7-Application/OidcAuth` | 766,777 | 99,844 |
| `core/Sysadmin` | `Foundation/Sysadmin` | 766,813 | 81,804 |
| `RTC+TIME_SOURCE+NTP` | `Drivers/Rtc` | 767,001 | 45,388 |
| `OPCUA+UMATI` | `L7-Application/Umati` | 767,801 | 92,220 |
| `NTRIP_CASTER` | `L7-Application/NtripCaster` | 770,805 | 84,712 |
| `BUS_CAPTURE+FORWARD+ETHERNET` | `Peripherals/CanCapture` | 771,997 | 45,568 |
| `DASHBOARD` | `L7-Application/Dashboard` | 773,693 | 82,164 |
| `EDGE_CACHE+HTTP_CACHE+HTTP_CLIENT` | `L7-Application/EdgeCache` | 773,997 | 119,276 |
| `NTP+TIME_SOURCE` | `L7-Application/TimeSourceFallback` | 774,369 | 83,396 |
| `MDNS` | `L7-Application/mDNS` | 778,381 | 83,688 |
| `EDGE_CACHE+HTTP_CACHE+HTTP_CLIENT+EDGE_MESH` | `L7-Application/MeshCache` | 778,433 | 124,240 |
| `EDGE_CACHE+HTTP_CACHE+HTTP_CLIENT+EDGE_MESH+EDGE_CACHE_SLOTS+EDGE_FETCH_SLOTS+MESH_MAX_PEERS` | `L7-Application/MeshCache` | 778,545 | 115,332 |
| `NTP` | `L7-Application/SNTP` | 778,889 | 84,328 |
| `MDNS+PROMISC+WIFI_SNIFFER+MDNS_ADAPTIVE` | `L7-Application/MdnsAdaptive` | 780,437 | 83,776 |
| `IFACE_BRIDGE` | `L7-Application/InterfaceBridge` | 780,857 | 82,628 |
| `COAP+DTLS` | `L7-Application/CoapSecure` | 781,293 | 102,924 |
| `ETHERNET` | `Peripherals/Ethernet` | 792,045 | 81,848 |
| `ETHERNET+ETH_W5500+ETH_W5500_CS+ETH_W5500_RST+ETH_W5500_INT+ETH_W5500_SCK+ETH_W5500_MISO+ETH_W5500_MOSI` | `Peripherals/EthernetW5500` | 792,077 | 81,848 |
| `core/FileServing` | `L7-Application/FileServing` | 794,285 | 81,828 |
| `UPLOAD` | `L7-Application/FileUpload` | 795,245 | 101,964 |
| `RANGE` | `L7-Application/Range` | 795,437 | 81,828 |
| `VFS` | `L7-Application/Vfs` | 796,469 | 86,316 |
| `WEBDAV` | `L7-Application/WebDav` | 821,069 | 105,352 |
| `WEBDAV+WEBDAV_MAX_ENTRIES+WEBDAV_BUF_SIZE` | `L7-Application/WebDav` | 822,273 | 90,860 |
| `ETAG` | `L7-Application/ETag` | 829,109 | 83,092 |
| `SSH` | `L5-Session/SSHHostKey` | 830,545 | 109,208 |
...
| `HOTSWAP` | `L7-Application/HotSwapStorage` | 838,477 | 82,728 |
| `EXC_DECODER+FTP+FTP_SESSION` | `L7-Application/CoreDump` | 841,377 | 83,428 |
| `HTTP_DELIVERY+FILE_SERVING+RANGE` | `L7-Application/HttpDelivery` | 842,761 | 82,704 |
| `SSH+SSH_CLIENT+SSH_CLIENT_MAX_CHANNELS+CLIENT_RX_BUF` | `L5-Session/SSHReverseTunnel` | 845,937 | 110,960 |
...
| `TLS+TLS_ARENA_SIZE` | `L6-Presentation/SecureWebSocket` | 857,125 | 105,664 |
| `TLS+TLS_RESUMPTION+TLS_ARENA_SIZE` | `L4-Transport/TlsResumption` | 858,045 | 105,824 |
| `TLS+MTLS+TLS_ARENA_SIZE` | `L4-Transport/mTLS` | 858,137 | 106,000 |
| `POWER_MGMT` | `L7-Application/PowerGovernor` | 881,329 | 85,648 |
| `SSH+FILE_SERVING+SSH_SFTP+SSH_SCP` | `L5-Session/SSHSftp` | 882,765 | 118,560 |
