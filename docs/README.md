...
| `SMTP` | `L7-Application/SmtpAlert` | 735,213 | 61,124 |
...
| `SIMATIC` | `L7-Application/SimaticSerial` | 755,517 | 83,292 |
...
| `EDGE_CACHE+HTTP_CACHE+HTTP_CLIENT` | `L7-Application/EdgeCache` | 774,569 | 119,308 |
...
| `EDGE_CACHE+HTTP_CACHE+HTTP_CLIENT+EDGE_MESH+EDGE_CACHE_SLOTS+EDGE_FETCH_SLOTS+MESH_MAX_PEERS` | `L7-Application/MeshCache` | 779,133 | 115,364 |
...
| `SSH` | `L5-Session/SSHHostKey` | 831,557 | 109,248 |
...
| `SSH+SSH_CLIENT+SSH_CLIENT_MAX_CHANNELS+CLIENT_RX_BUF` | `L5-Session/SSHReverseTunnel` | 846,969 | 110,984 |
...
| `SSH+FILE_SERVING+SSH_SFTP+SSH_SCP` | `L5-Session/SSHSftp` | 883,809 | 118,600 |
