...
| `ACCEPT_THROTTLE` | `L4-Transport/02.AcceptThrottle` | 750,837 | 65,992 |
| `core/02.CORS` | `L7-Application/02.CORS` | 750,997 | 65,984 |
| `RADIO_POWER+RADIO_WIFI_PS` | `L7-Application/47.RadioPower` | 751,065 | 65,984 |
| `core/04.BasicAuth` | `L6-Presentation/04.BasicAuth` | 751,065 | 65,984 |
| `core/05.DigestAuth` | `L6-Presentation/05.DigestAuth` | 751,181 | 65,984 |
| `DIAG` | `L7-Application/20.Diagnostics` | 751,229 | 65,984 |
| `core/06.RegexRoutes` | `L7-Application/06.RegexRoutes` | 751,301 | 65,984 |
| `PER_IP_THROTTLE` | `L4-Transport/05.PerIpThrottle` | 751,365 | 66,432 |
| `DEVICE_ID` | `L7-Application/32.DeviceUuid` | 751,397 | 66,024 |
| `core/05.PathParams` | `L7-Application/05.PathParams` | 751,401 | 65,984 |
| `core/09.WebSocket` | `L6-Presentation/09.WebSocket` | 751,445 | 65,984 |
| `GUARDRAILS` | `L7-Application/40.Guardrails` | 751,533 | 65,984 |
| `core/07.ResponseHeaders` | `L7-Application/07.ResponseHeaders` | 751,549 | 65,984 |
| `core/04.Middleware` | `L7-Application/04.Middleware` | 751,641 | 65,984 |
| `core/08.ServerSentEvents` | `L6-Presentation/08.ServerSentEvents` | 751,677 | 65,992 |
| `core/01.ChunkedResponse` | `L7-Application/01.ChunkedResponse` | 751,689 | 65,992 |
| `core/36.NetEgress` | `L7-Application/36.NetEgress` | 751,701 | 65,984 |
| `KEEPALIVE` | `L4-Transport/01.KeepAlive` | 751,705 | 65,992 |
| `PARTITION_MONITOR` | `L7-Application/37.PartitionMonitor` | 751,741 | 65,984 |
| `core/01.FormParams` | `L6-Presentation/01.FormParams` | 751,837 | 65,984 |
| `OTA_ROLLBACK` | `L7-Application/44.OtaRollback` | 752,053 | 65,984 |
| `AUTH_LOCKOUT` | `L6-Presentation/12.AuthLockout` | 752,069 | 66,560 |
| `core/03.Multipart` | `L6-Presentation/03.Multipart` | 752,137 | 65,984 |
| `TOTP` | `L7-Application/45.Totp` | 752,193 | 66,016 |
| `IP_ALLOWLIST` | `L4-Transport/07.IpAllowlist` | 752,373 | 65,984 |
| `CSRF` | `L7-Application/33.Csrf` | 752,457 | 66,032 |
| `LOGBUF` | `L7-Application/41.LogBuffer` | 752,497 | 69,104 |
| `core/03.InterfaceFilter` | `L7-Application/03.InterfaceFilter` | 752,657 | 65,984 |
| `MODBUS` | `L7-Application/30.ModbusTcp` | 752,753 | 66,256 |
| `core/08.Templating` | `L7-Application/08.Templating` | 752,821 | 66,016 |
| `STATS` | `L7-Application/22.Stats` | 752,877 | 66,080 |
| `MODBUS+MODBUS_MASTER` | `L7-Application/43.ModbusScan` | 753,081 | 66,256 |
| `core/01.Basic` | `Foundation/01.Basic` | 753,097 | 65,984 |
| `JWT` | `L6-Presentation/06.JWTAuth` | 753,185 | 66,560 |
| `TELNET` | `L5-Session/03.Telnet` | 753,285 | 66,512 |
| `AUDIT_LOG` | `L7-Application/49.AuditLog` | 753,289 | 68,968 |
| `CBOR` | `L6-Presentation/13.Cbor` | 753,297 | 66,056 |
| `IPV6` | `Foundation/20.IPv6` | 753,481 | 65,984 |
| `core/03.Expert` | `Foundation/03.Expert` | 753,745 | 66,000 |
| `SYSLOG` | `L7-Application/19.Syslog` | 754,417 | 67,848 |
| `MSGPACK` | `L6-Presentation/14.MsgPack` | 754,589 | 66,056 |
| `STATS+METRICS` | `L7-Application/21.PrometheusMetrics` | 755,029 | 66,120 |
| `core/02.Json` | `L6-Presentation/02.Json` | 755,101 | 65,984 |
| `GPIO_MAP` | `L7-Application/38.GpioMap` | 755,285 | 66,040 |
| `WS_DEFLATE` | `L6-Presentation/11.WebSocketCompression` | 755,669 | 74,184 |
| `WEB_TERMINAL` | `L6-Presentation/10.WebTerminal` | 755,785 | 66,064 |
| `GRAPHQL` | `L7-Application/52.GraphQL` | 755,905 | 70,384 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/42.ConfigExport` | 755,973 | 66,044 |
| `OTA` | `L7-Application/16.OTA` | 756,289 | 102,112 |
| `COAP` | `L7-Application/13.CoAP` | 756,669 | 68,496 |
| `DNS_RESOLVER` | `L7-Application/48.DnsResolver` | 756,989 | 67,264 |
| `PROVISIONING` | `L7-Application/17.Provisioning` | 758,613 | 67,548 |
| `OPCUA` | `L7-Application/55.OpcUa` | 758,957 | 76,272 |
| `core/02.Advanced` | `Foundation/02.Advanced` | 759,749 | 66,096 |
| `SNMP` | `L7-Application/14.SNMP` | 759,825 | 78,384 |
| `TELEMETRY` | `L7-Application/34.Telemetry` | 759,861 | 66,300 |
| `RELAY` | `L7-Application/70.PortForward` | 760,937 | 100,600 |
| `HTTP_CLIENT+WEBHOOK` | `L7-Application/46.Webhook` | 761,517 | 85,736 |
...
| `core/04.Sysadmin` | `Foundation/04.Sysadmin` | 764,957 | 65,992 |
...
| `DASHBOARD` | `L7-Application/35.Dashboard` | 771,773 | 66,352 |
| `NTP+TIME_SOURCE` | `L7-Application/31.TimeSourceFallback` | 772,217 | 67,596 |
| `MDNS` | `L7-Application/15.mDNS` | 776,477 | 67,888 |
| `NTP` | `L7-Application/18.SNTP` | 776,729 | 68,536 |
| `OPCUA+OPCUA_CLIENT` | `L7-Application/56.OpcUaClient` | 781,897 | 80,128 |
| `ETHERNET` | `Foundation/19.Ethernet` | 789,633 | 66,028 |
| `core/10.FileServing` | `L7-Application/10.FileServing` | 792,385 | 66,016 |
| `UPLOAD` | `L7-Application/11.FileUpload` | 793,521 | 71,208 |
| `RANGE` | `L7-Application/12.Range` | 793,637 | 66,016 |
| `VFS` | `L7-Application/51.Vfs` | 794,581 | 70,512 |
| `WEBDAV` | `L7-Application/29.WebDav` | 820,273 | 105,352 |
| `SSH` | `L5-Session/03.SSHHostKey` | 820,949 | 88,308 |
| `ETAG` | `L7-Application/09.ETag` | 827,189 | 67,288 |
| `WS_CLIENT+TLS+WS_CLIENT_TLS` | `L7-Application/25.WebSocketClient` | 831,333 | 120,548 |
| `TLS` | `L6-Presentation/07.SecureWebSocket` | 855,097 | 116,900 |
| `TLS+TLS_RESUMPTION` | `L4-Transport/06.TlsResumption` | 855,969 | 117,060 |
| `TLS+MTLS` | `L4-Transport/04.mTLS` | 856,089 | 117,236 |
