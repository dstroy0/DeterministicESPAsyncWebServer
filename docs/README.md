...
| `core/71.MediaStreaming` | `L7-Application/71.MediaStreaming` | 752,249 | 81,776 |
| `core/02.CORS` | `L7-Application/02.CORS` | 752,313 | 81,776 |
| `core/04.BasicAuth` | `L6-Presentation/04.BasicAuth` | 752,385 | 81,776 |
| `RADIO_POWER+RADIO_WIFI_PS` | `L7-Application/47.RadioPower` | 752,389 | 81,776 |
...
| `DEVICE_ID` | `L7-Application/32.DeviceUuid` | 752,713 | 81,816 |
...
| `GUARDRAILS` | `L7-Application/40.Guardrails` | 752,837 | 81,792 |
...
| `DIAG` | `L7-Application/20.Diagnostics` | 752,989 | 81,776 |
| `core/36.NetEgress` | `L7-Application/36.NetEgress` | 753,017 | 81,776 |
| `PARTITION_MONITOR` | `L7-Application/37.PartitionMonitor` | 753,045 | 81,784 |
...
| `OTA_ROLLBACK` | `L7-Application/44.OtaRollback` | 753,377 | 81,792 |
| `AUTH_LOCKOUT` | `L6-Presentation/12.AuthLockout` | 753,389 | 82,352 |
| `core/03.Multipart` | `L6-Presentation/03.Multipart` | 753,453 | 81,776 |
| `TOTP` | `L7-Application/45.Totp` | 753,497 | 81,816 |
| `IP_ALLOWLIST` | `L4-Transport/07.IpAllowlist` | 753,677 | 81,776 |
| `LOGBUF` | `L7-Application/41.LogBuffer` | 753,817 | 84,904 |
| `CSRF` | `L7-Application/33.Csrf` | 753,909 | 81,832 |
| `core/03.InterfaceFilter` | `L7-Application/03.InterfaceFilter` | 753,941 | 81,776 |
| `MODBUS` | `L7-Application/30.ModbusTcp` | 754,069 | 82,064 |
| `core/08.Templating` | `L7-Application/08.Templating` | 754,117 | 81,824 |
| `STATS` | `L7-Application/22.Stats` | 754,193 | 81,880 |
| `CONTROL` | `L7-Application/74.PidTuning` | 754,305 | 89,856 |
| `core/01.Basic` | `Foundation/01.Basic` | 754,401 | 81,792 |
| `MODBUS+MODBUS_MASTER` | `L7-Application/43.ModbusScan` | 754,409 | 82,056 |
| `JWT` | `L6-Presentation/06.JWTAuth` | 754,529 | 82,928 |
| `TELNET` | `L5-Session/04.Telnet` | 754,557 | 82,320 |
| `AUDIT_LOG` | `L7-Application/49.AuditLog` | 754,613 | 84,768 |
...
| `SYSLOG` | `L7-Application/19.Syslog` | 755,721 | 83,640 |
| `MSGPACK` | `L6-Presentation/14.MsgPack` | 755,949 | 81,856 |
| `core/02.Json` | `L6-Presentation/02.Json` | 756,317 | 81,784 |
| `STATS+METRICS` | `L7-Application/21.PrometheusMetrics` | 756,349 | 81,920 |
| `GPIO_MAP` | `L7-Application/38.GpioMap` | 756,633 | 81,840 |
...
| `GRAPHQL` | `L7-Application/52.GraphQL` | 757,233 | 86,192 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/42.ConfigExport` | 757,293 | 81,844 |
| `OTA` | `L7-Application/16.OTA` | 757,605 | 102,128 |
| `COAP` | `L7-Application/13.CoAP` | 757,977 | 84,296 |
| `DNS_RESOLVER` | `L7-Application/48.DnsResolver` | 758,297 | 83,064 |
| `PROVISIONING` | `L7-Application/17.Provisioning` | 759,937 | 83,348 |
| `OPCUA` | `L7-Application/55.OpcUa` | 760,477 | 92,064 |
| `core/02.Advanced` | `Foundation/02.Advanced` | 761,073 | 81,888 |
| `SNMP` | `L7-Application/14.SNMP` | 761,129 | 94,184 |
| `TELEMETRY` | `L7-Application/34.Telemetry` | 761,181 | 82,100 |
| `RELAY` | `L7-Application/70.PortForward` | 762,317 | 116,392 |
| `HTTP_CLIENT+WEBHOOK` | `L7-Application/46.Webhook` | 762,853 | 101,536 |
| `PROMISC+FORWARD+ETHERNET` | `Foundation/21.WifiCapture` | 764,637 | 47,520 |
| `OAUTH2+HTTP_CLIENT` | `L7-Application/54.OAuth2` | 765,077 | 104,600 |
| `OIDC` | `L7-Application/50.OidcAuth` | 766,129 | 99,824 |
| `core/04.Sysadmin` | `Foundation/04.Sysadmin` | 766,281 | 81,792 |
| `RTC+TIME_SOURCE+NTP` | `L7-Application/61.Rtc` | 766,653 | 45,372 |
| `OPCUA+UMATI` | `L7-Application/72.Umati` | 767,197 | 92,208 |
| `NTRIP_CASTER` | `L7-Application/76.NtripCaster` | 770,465 | 84,700 |
| `BUS_CAPTURE+FORWARD+ETHERNET` | `Foundation/22.CanCapture` | 771,165 | 45,516 |
| `ADS` | `L7-Application/73.AdsClient` | 771,933 | 45,440 |
| `DASHBOARD` | `L7-Application/35.Dashboard` | 773,105 | 82,152 |
| `NTP+TIME_SOURCE` | `L7-Application/31.TimeSourceFallback` | 773,529 | 83,396 |
| `MDNS` | `L7-Application/15.mDNS` | 777,793 | 83,680 |
| `NTP` | `L7-Application/18.SNTP` | 778,053 | 84,328 |
| `COAP+DTLS` | `L7-Application/78.CoapSecure` | 780,005 | 102,864 |
| `IFACE_BRIDGE` | `L7-Application/75.InterfaceBridge` | 780,373 | 82,624 |
...
| `VFS` | `L7-Application/51.Vfs` | 795,897 | 86,304 |
| `WEBDAV` | `L7-Application/29.WebDav` | 821,069 | 105,352 |
| `WEBDAV+WEBDAV_MAX_ENTRIES+WEBDAV_BUF_SIZE` | `L7-Application/29.WebDav` | 821,573 | 90,856 |
| `SSH` | `L5-Session/03.SSHHostKey` | 827,445 | 108,644 |
