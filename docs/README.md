...
| `ACCEPT_THROTTLE` | `L4-Transport/02.AcceptThrottle` | 750,865 | 74,600 |
| `core/02.CORS` | `L7-Application/02.CORS` | 751,033 | 74,568 |
| `RADIO_POWER+RADIO_WIFI_PS` | `L7-Application/47.RadioPower` | 751,061 | 74,568 |
| `core/04.BasicAuth` | `L6-Presentation/04.BasicAuth` | 751,105 | 74,568 |
| `core/05.DigestAuth` | `L6-Presentation/05.DigestAuth` | 751,225 | 74,568 |
| `core/06.RegexRoutes` | `L7-Application/06.RegexRoutes` | 751,341 | 74,568 |
| `PER_IP_THROTTLE` | `L4-Transport/05.PerIpThrottle` | 751,405 | 75,016 |
| `DEVICE_ID` | `L7-Application/32.DeviceUuid` | 751,437 | 74,632 |
| `core/05.PathParams` | `L7-Application/05.PathParams` | 751,441 | 74,568 |
| `core/09.WebSocket` | `L6-Presentation/09.WebSocket` | 751,497 | 74,568 |
| `GUARDRAILS` | `L7-Application/40.Guardrails` | 751,585 | 74,600 |
| `core/07.ResponseHeaders` | `L7-Application/07.ResponseHeaders` | 751,589 | 74,568 |
| `core/04.Middleware` | `L7-Application/04.Middleware` | 751,693 | 74,600 |
| `core/01.ChunkedResponse` | `L7-Application/01.ChunkedResponse` | 751,745 | 74,600 |
| `core/08.ServerSentEvents` | `L6-Presentation/08.ServerSentEvents` | 751,749 | 74,600 |
| `core/36.NetEgress` | `L7-Application/36.NetEgress` | 751,749 | 74,568 |
| `PARTITION_MONITOR` | `L7-Application/37.PartitionMonitor` | 751,789 | 74,568 |
| `KEEPALIVE` | `L4-Transport/01.KeepAlive` | 751,833 | 74,600 |
| `core/01.FormParams` | `L6-Presentation/01.FormParams` | 751,881 | 74,568 |
| `core/03.Multipart` | `L6-Presentation/03.Multipart` | 752,021 | 74,568 |
| `OTA_ROLLBACK` | `L7-Application/44.OtaRollback` | 752,093 | 74,608 |
| `AUTH_LOCKOUT` | `L6-Presentation/12.AuthLockout` | 752,109 | 75,144 |
| `TOTP` | `L7-Application/45.Totp` | 752,237 | 74,632 |
| `IP_ALLOWLIST` | `L4-Transport/07.IpAllowlist` | 752,385 | 74,568 |
| `CSRF` | `L7-Application/33.Csrf` | 752,457 | 74,632 |
| `LOGBUF` | `L7-Application/41.LogBuffer` | 752,545 | 77,712 |
| `core/03.InterfaceFilter` | `L7-Application/03.InterfaceFilter` | 752,669 | 74,568 |
| `DIAG` | `Foundation/05.Configuration` | 752,753 | 71,336 |
| `MODBUS` | `L7-Application/30.ModbusTcp` | 752,829 | 74,856 |
| `core/08.Templating` | `L7-Application/08.Templating` | 752,869 | 74,640 |
| `STATS` | `L7-Application/22.Stats` | 752,917 | 74,672 |
| `core/01.Basic` | `Foundation/01.Basic` | 753,137 | 74,608 |
| `MODBUS+MODBUS_MASTER` | `L7-Application/43.ModbusScan` | 753,145 | 74,856 |
| `JWT` | `L6-Presentation/06.JWTAuth` | 753,225 | 75,144 |
| `CBOR` | `L6-Presentation/13.Cbor` | 753,317 | 74,672 |
| `AUDIT_LOG` | `L7-Application/49.AuditLog` | 753,325 | 77,576 |
| `TELNET` | `L5-Session/03.Telnet` | 753,361 | 75,120 |
| `IPV6` | `Foundation/20.IPv6` | 753,501 | 74,568 |
| `core/03.Expert` | `Foundation/03.Expert` | 753,753 | 74,608 |
| `SYSLOG` | `L7-Application/19.Syslog` | 754,429 | 76,440 |
| `MSGPACK` | `L6-Presentation/14.MsgPack` | 754,621 | 74,672 |
| `core/02.Json` | `L6-Presentation/02.Json` | 754,773 | 74,576 |
| `STATS+METRICS` | `L7-Application/21.PrometheusMetrics` | 755,065 | 74,736 |
| `GPIO_MAP` | `L7-Application/38.GpioMap` | 755,321 | 74,648 |
| `WS_DEFLATE` | `L6-Presentation/11.WebSocketCompression` | 755,709 | 74,576 |
| `WEB_TERMINAL` | `L6-Presentation/10.WebTerminal` | 755,817 | 74,672 |
| `GRAPHQL` | `L7-Application/52.GraphQL` | 755,925 | 78,992 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/42.ConfigExport` | 756,025 | 74,652 |
| `OTA` | `L7-Application/16.OTA` | 756,281 | 110,728 |
| `COAP` | `L7-Application/13.CoAP` | 756,693 | 77,112 |
| `DNS_RESOLVER` | `L7-Application/48.DnsResolver` | 757,021 | 75,856 |
| `PROVISIONING` | `L7-Application/17.Provisioning` | 758,641 | 76,140 |
| `OPCUA` | `L7-Application/55.OpcUa` | 759,241 | 84,880 |
| `core/02.Advanced` | `Foundation/02.Advanced` | 759,773 | 74,680 |
| `SNMP` | `L7-Application/14.SNMP` | 759,889 | 87,000 |
| `TELEMETRY` | `L7-Application/34.Telemetry` | 759,889 | 74,908 |
| `HTTP_CLIENT+WEBHOOK` | `L7-Application/46.Webhook` | 761,569 | 94,352 |
| `OAUTH2+HTTP_CLIENT` | `L7-Application/54.OAuth2` | 763,525 | 97,392 |
| `PROMISC+FORWARD+ETHERNET` | `Foundation/21.WifiCapture` | 764,269 | 47,320 |
| `OIDC` | `L7-Application/50.OidcAuth` | 764,501 | 79,496 |
| `core/04.Sysadmin` | `Foundation/04.Sysadmin` | 764,989 | 74,608 |
...
| `DASHBOARD` | `L7-Application/35.Dashboard` | 771,833 | 74,952 |
| `NTP+TIME_SOURCE` | `L7-Application/31.TimeSourceFallback` | 772,221 | 76,196 |
| `MDNS` | `L7-Application/15.mDNS` | 776,505 | 76,472 |
| `NTP` | `L7-Application/18.SNTP` | 776,761 | 77,120 |
| `OPCUA+OPCUA_CLIENT` | `L7-Application/56.OpcUaClient` | 782,157 | 88,720 |
| `ETHERNET` | `Foundation/19.Ethernet` | 789,681 | 74,644 |
| `core/10.FileServing` | `L7-Application/10.FileServing` | 792,417 | 74,608 |
| `UPLOAD` | `L7-Application/11.FileUpload` | 793,465 | 79,824 |
| `RANGE` | `L7-Application/12.Range` | 793,681 | 74,608 |
| `VFS` | `L7-Application/51.Vfs` | 794,601 | 79,120 |
| `WEBDAV` | `L7-Application/29.WebDav` | 820,157 | 113,960 |
| `SSH` | `L5-Session/03.SSHHostKey` | 820,969 | 88,700 |
| `ETAG` | `L7-Application/09.ETag` | 827,197 | 75,880 |
