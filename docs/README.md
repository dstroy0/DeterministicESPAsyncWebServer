...
| `ACCEPT_THROTTLE` | `L4-Transport/02.AcceptThrottle` | 750,965 | 66,360 |
| `core/02.CORS` | `L7-Application/02.CORS` | 751,133 | 66,352 |
| `RADIO_POWER+RADIO_WIFI_PS` | `L7-Application/47.RadioPower` | 751,161 | 66,352 |
| `core/04.BasicAuth` | `L6-Presentation/04.BasicAuth` | 751,205 | 66,352 |
| `core/05.DigestAuth` | `L6-Presentation/05.DigestAuth` | 751,333 | 66,352 |
| `DIAG` | `L7-Application/20.Diagnostics` | 751,365 | 66,352 |
| `core/06.RegexRoutes` | `L7-Application/06.RegexRoutes` | 751,449 | 66,352 |
| `PER_IP_THROTTLE` | `L4-Transport/05.PerIpThrottle` | 751,501 | 66,800 |
| `DEVICE_ID` | `L7-Application/32.DeviceUuid` | 751,537 | 66,392 |
| `core/05.PathParams` | `L7-Application/05.PathParams` | 751,541 | 66,352 |
| `core/09.WebSocket` | `L6-Presentation/09.WebSocket` | 751,605 | 66,352 |
| `GUARDRAILS` | `L7-Application/40.Guardrails` | 751,681 | 66,360 |
| `core/07.ResponseHeaders` | `L7-Application/07.ResponseHeaders` | 751,697 | 66,352 |
| `core/04.Middleware` | `L7-Application/04.Middleware` | 751,785 | 66,360 |
| `core/01.ChunkedResponse` | `L7-Application/01.ChunkedResponse` | 751,845 | 66,368 |
| `core/36.NetEgress` | `L7-Application/36.NetEgress` | 751,845 | 66,352 |
| `core/08.ServerSentEvents` | `L6-Presentation/08.ServerSentEvents` | 751,849 | 66,360 |
| `KEEPALIVE` | `L4-Transport/01.KeepAlive` | 751,885 | 66,360 |
| `PARTITION_MONITOR` | `L7-Application/37.PartitionMonitor` | 751,889 | 66,352 |
| `core/01.FormParams` | `L6-Presentation/01.FormParams` | 751,985 | 66,352 |
| `OTA_ROLLBACK` | `L7-Application/44.OtaRollback` | 752,197 | 66,360 |
| `AUTH_LOCKOUT` | `L6-Presentation/12.AuthLockout` | 752,217 | 66,928 |
| `core/03.Multipart` | `L6-Presentation/03.Multipart` | 752,281 | 66,352 |
| `TOTP` | `L7-Application/45.Totp` | 752,341 | 66,392 |
| `IP_ALLOWLIST` | `L4-Transport/07.IpAllowlist` | 752,521 | 66,352 |
| `CSRF` | `L7-Application/33.Csrf` | 752,541 | 66,400 |
| `LOGBUF` | `L7-Application/41.LogBuffer` | 752,645 | 69,480 |
| `core/03.InterfaceFilter` | `L7-Application/03.InterfaceFilter` | 752,769 | 66,352 |
| `MODBUS` | `L7-Application/30.ModbusTcp` | 752,933 | 66,632 |
| `core/08.Templating` | `L7-Application/08.Templating` | 752,969 | 66,392 |
| `STATS` | `L7-Application/22.Stats` | 753,005 | 66,448 |
| `core/01.Basic` | `Foundation/01.Basic` | 753,241 | 66,360 |
| `MODBUS+MODBUS_MASTER` | `L7-Application/43.ModbusScan` | 753,265 | 66,624 |
| `JWT` | `L6-Presentation/06.JWTAuth` | 753,341 | 66,928 |
| `AUDIT_LOG` | `L7-Application/49.AuditLog` | 753,429 | 69,336 |
| `CBOR` | `L6-Presentation/13.Cbor` | 753,433 | 66,424 |
| `TELNET` | `L5-Session/03.Telnet` | 753,485 | 66,888 |
| `IPV6` | `Foundation/20.IPv6` | 753,621 | 66,352 |
| `core/03.Expert` | `Foundation/03.Expert` | 753,877 | 66,368 |
| `SYSLOG` | `L7-Application/19.Syslog` | 754,553 | 68,224 |
| `MSGPACK` | `L6-Presentation/14.MsgPack` | 754,737 | 66,424 |
| `STATS+METRICS` | `L7-Application/21.PrometheusMetrics` | 755,169 | 66,496 |
| `core/02.Json` | `L6-Presentation/02.Json` | 755,245 | 66,352 |
| `GPIO_MAP` | `L7-Application/38.GpioMap` | 755,429 | 66,408 |
| `WS_DEFLATE` | `L6-Presentation/11.WebSocketCompression` | 755,833 | 74,552 |
| `WEB_TERMINAL` | `L6-Presentation/10.WebTerminal` | 755,945 | 66,440 |
| `GRAPHQL` | `L7-Application/52.GraphQL` | 756,049 | 70,760 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/42.ConfigExport` | 756,117 | 66,412 |
| `OTA` | `L7-Application/16.OTA` | 756,357 | 102,488 |
| `COAP` | `L7-Application/13.CoAP` | 756,813 | 68,872 |
| `DNS_RESOLVER` | `L7-Application/48.DnsResolver` | 757,137 | 67,632 |
| `PROVISIONING` | `L7-Application/17.Provisioning` | 758,749 | 67,916 |
| `OPCUA` | `L7-Application/55.OpcUa` | 759,117 | 76,640 |
| `core/02.Advanced` | `Foundation/02.Advanced` | 759,889 | 66,464 |
| `SNMP` | `L7-Application/14.SNMP` | 759,969 | 78,752 |
| `TELEMETRY` | `L7-Application/34.Telemetry` | 760,005 | 66,668 |
| `RELAY` | `L7-Application/70.PortForward` | 761,113 | 100,968 |
| `HTTP_CLIENT+WEBHOOK` | `L7-Application/46.Webhook` | 761,685 | 86,112 |
...
| `core/04.Sysadmin` | `Foundation/04.Sysadmin` | 765,105 | 66,360 |
...
| `DASHBOARD` | `L7-Application/35.Dashboard` | 771,957 | 66,728 |
| `NTP+TIME_SOURCE` | `L7-Application/31.TimeSourceFallback` | 772,361 | 67,964 |
| `MDNS` | `L7-Application/15.mDNS` | 776,621 | 68,256 |
| `NTP` | `L7-Application/18.SNTP` | 776,877 | 68,904 |
| `OPCUA+OPCUA_CLIENT` | `L7-Application/56.OpcUaClient` | 782,053 | 80,504 |
| `ETHERNET` | `Foundation/19.Ethernet` | 789,785 | 66,396 |
| `core/10.FileServing` | `L7-Application/10.FileServing` | 792,537 | 66,384 |
| `UPLOAD` | `L7-Application/11.FileUpload` | 793,589 | 71,584 |
| `RANGE` | `L7-Application/12.Range` | 793,789 | 66,384 |
| `VFS` | `L7-Application/51.Vfs` | 794,725 | 70,880 |
| `WEBDAV` | `L7-Application/29.WebDav` | 820,285 | 105,720 |
| `SSH` | `L5-Session/03.SSHHostKey` | 821,045 | 88,676 |
| `ETAG` | `L7-Application/09.ETag` | 827,345 | 67,656 |
| `WS_CLIENT+TLS+WS_CLIENT_TLS` | `L7-Application/25.WebSocketClient` | 831,333 | 120,580 |
| `TLS` | `L6-Presentation/07.SecureWebSocket` | 855,341 | 117,276 |
| `TLS+TLS_RESUMPTION` | `L4-Transport/06.TlsResumption` | 856,161 | 117,436 |
| `TLS+MTLS` | `L4-Transport/04.mTLS` | 856,281 | 117,612 |
