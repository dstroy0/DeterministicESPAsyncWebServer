...
| `ACCEPT_THROTTLE` | `L4-Transport/02.AcceptThrottle` | 750,969 | 66,296 |
| `core/02.CORS` | `L7-Application/02.CORS` | 751,133 | 66,288 |
| `RADIO_POWER+RADIO_WIFI_PS` | `L7-Application/47.RadioPower` | 751,205 | 66,328 |
| `core/04.BasicAuth` | `L6-Presentation/04.BasicAuth` | 751,205 | 66,288 |
| `core/05.DigestAuth` | `L6-Presentation/05.DigestAuth` | 751,329 | 66,288 |
| `core/06.RegexRoutes` | `L7-Application/06.RegexRoutes` | 751,449 | 66,288 |
| `PER_IP_THROTTLE` | `L4-Transport/05.PerIpThrottle` | 751,505 | 66,736 |
| `DEVICE_ID` | `L7-Application/32.DeviceUuid` | 751,533 | 66,368 |
| `core/05.PathParams` | `L7-Application/05.PathParams` | 751,549 | 66,288 |
| `core/09.WebSocket` | `L6-Presentation/09.WebSocket` | 751,593 | 66,288 |
| `GUARDRAILS` | `L7-Application/40.Guardrails` | 751,677 | 66,336 |
| `core/07.ResponseHeaders` | `L7-Application/07.ResponseHeaders` | 751,693 | 66,288 |
| `core/04.Middleware` | `L7-Application/04.Middleware` | 751,789 | 66,288 |
| `core/36.NetEgress` | `L7-Application/36.NetEgress` | 751,841 | 66,328 |
| `core/01.ChunkedResponse` | `L7-Application/01.ChunkedResponse` | 751,845 | 66,296 |
| `core/08.ServerSentEvents` | `L6-Presentation/08.ServerSentEvents` | 751,849 | 66,296 |
| `KEEPALIVE` | `L4-Transport/01.KeepAlive` | 751,885 | 66,296 |
| `PARTITION_MONITOR` | `L7-Application/37.PartitionMonitor` | 751,885 | 66,328 |
| `core/01.FormParams` | `L6-Presentation/01.FormParams` | 751,985 | 66,288 |
| `OTA_ROLLBACK` | `L7-Application/44.OtaRollback` | 752,193 | 66,336 |
| `AUTH_LOCKOUT` | `L6-Presentation/12.AuthLockout` | 752,217 | 66,864 |
| `core/03.Multipart` | `L6-Presentation/03.Multipart` | 752,281 | 66,288 |
| `TOTP` | `L7-Application/45.Totp` | 752,337 | 66,368 |
| `IP_ALLOWLIST` | `L4-Transport/07.IpAllowlist` | 752,529 | 66,288 |
| `CSRF` | `L7-Application/33.Csrf` | 752,537 | 66,376 |
| `LOGBUF` | `L7-Application/41.LogBuffer` | 752,641 | 69,456 |
| `core/03.InterfaceFilter` | `L7-Application/03.InterfaceFilter` | 752,769 | 66,288 |
| `DIAG` | `Foundation/05.Configuration` | 752,853 | 63,040 |
| `MODBUS` | `L7-Application/30.ModbusTcp` | 752,929 | 66,608 |
| `core/08.Templating` | `L7-Application/08.Templating` | 752,969 | 66,328 |
| `STATS` | `L7-Application/22.Stats` | 753,001 | 66,424 |
| `core/01.Basic` | `Foundation/01.Basic` | 753,241 | 66,296 |
| `MODBUS+MODBUS_MASTER` | `L7-Application/43.ModbusScan` | 753,257 | 66,600 |
| `JWT` | `L6-Presentation/06.JWTAuth` | 753,341 | 66,864 |
| `AUDIT_LOG` | `L7-Application/49.AuditLog` | 753,425 | 69,312 |
| `CBOR` | `L6-Presentation/13.Cbor` | 753,433 | 66,368 |
| `TELNET` | `L5-Session/03.Telnet` | 753,485 | 66,824 |
| `IPV6` | `Foundation/20.IPv6` | 753,621 | 66,288 |
| `core/03.Expert` | `Foundation/03.Expert` | 753,877 | 66,312 |
| `SYSLOG` | `L7-Application/19.Syslog` | 754,549 | 68,200 |
| `MSGPACK` | `L6-Presentation/14.MsgPack` | 754,733 | 66,400 |
| `STATS+METRICS` | `L7-Application/21.PrometheusMetrics` | 755,165 | 66,472 |
| `core/02.Json` | `L6-Presentation/02.Json` | 755,245 | 66,296 |
| `GPIO_MAP` | `L7-Application/38.GpioMap` | 755,425 | 66,384 |
| `WS_DEFLATE` | `L6-Presentation/11.WebSocketCompression` | 755,829 | 74,496 |
| `WEB_TERMINAL` | `L6-Presentation/10.WebTerminal` | 755,933 | 66,368 |
| `GRAPHQL` | `L7-Application/52.GraphQL` | 756,049 | 70,736 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/42.ConfigExport` | 756,117 | 66,388 |
| `OTA` | `L7-Application/16.OTA` | 756,357 | 102,416 |
| `COAP` | `L7-Application/13.CoAP` | 756,809 | 68,848 |
| `DNS_RESOLVER` | `L7-Application/48.DnsResolver` | 757,133 | 67,608 |
| `PROVISIONING` | `L7-Application/17.Provisioning` | 758,749 | 67,860 |
| `OPCUA` | `L7-Application/55.OpcUa` | 759,113 | 76,616 |
| `core/02.Advanced` | `Foundation/02.Advanced` | 759,885 | 66,440 |
| `SNMP` | `L7-Application/14.SNMP` | 759,965 | 78,728 |
| `TELEMETRY` | `L7-Application/34.Telemetry` | 760,001 | 66,644 |
| `RELAY` | `L7-Application/70.PortForward` | 761,105 | 100,944 |
| `HTTP_CLIENT+WEBHOOK` | `L7-Application/46.Webhook` | 761,681 | 86,088 |
...
| `core/04.Sysadmin` | `Foundation/04.Sysadmin` | 765,105 | 66,304 |
...
| `NTP+TIME_SOURCE` | `L7-Application/31.TimeSourceFallback` | 772,357 | 67,940 |
| `MDNS` | `L7-Application/15.mDNS` | 776,621 | 68,192 |
| `NTP` | `L7-Application/18.SNTP` | 776,869 | 68,880 |
| `OPCUA+OPCUA_CLIENT` | `L7-Application/56.OpcUaClient` | 782,049 | 80,480 |
| `ETHERNET` | `Foundation/19.Ethernet` | 789,785 | 66,340 |
| `core/10.FileServing` | `L7-Application/10.FileServing` | 792,541 | 66,328 |
| `UPLOAD` | `L7-Application/11.FileUpload` | 793,589 | 71,520 |
| `RANGE` | `L7-Application/12.Range` | 793,793 | 66,328 |
| `VFS` | `L7-Application/51.Vfs` | 794,721 | 70,856 |
| `WEBDAV` | `L7-Application/29.WebDav` | 820,285 | 105,696 |
| `SSH` | `L5-Session/03.SSHHostKey` | 821,153 | 88,620 |
| `ETAG` | `L7-Application/09.ETag` | 827,349 | 67,600 |
| `WS_CLIENT+TLS+WS_CLIENT_TLS` | `L7-Application/25.WebSocketClient` | 831,329 | 120,580 |
| `TLS` | `L6-Presentation/07.SecureWebSocket` | 855,361 | 117,204 |
| `TLS+TLS_RESUMPTION` | `L4-Transport/06.TlsResumption` | 856,177 | 117,412 |
| `TLS+MTLS` | `L4-Transport/04.mTLS` | 856,309 | 117,540 |
