...
| `core/02.Json` | `L6-Presentation/02.Json` | 754,753 | 66,352 |
...
| `OPCUA` | `L7-Application/55.OpcUa` | 759,221 | 76,640 |
...
| `OAUTH2+HTTP_CLIENT` | `L7-Application/54.OAuth2` | 763,505 | 89,176 |
...
| `NTP+TIME_SOURCE` | `L7-Application/31.TimeSourceFallback` | 772,201 | 67,964 |
| `MDNS` | `L7-Application/15.mDNS` | 776,485 | 68,256 |
| `NTP` | `L7-Application/18.SNTP` | 776,741 | 68,904 |
| `OPCUA+OPCUA_CLIENT` | `L7-Application/56.OpcUaClient` | 782,137 | 80,504 |
