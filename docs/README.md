...
| `DMA+PREEMPT_QUEUE+FORWARD+DMA_SIMULATE` | `Foundation/09.InterfaceForward` | 270,377 | 28,896 |
| `DMA+PREEMPT_QUEUE+GATEWAY+DMA_SIMULATE` | `Foundation/10.RadioGateway` | 270,481 | 28,720 |
...
| `DNS_SERVER` | `L7-Application/60.DnsServer` | 725,617 | 45,976 |
...
| `HTTP_CLIENT` | `L7-Application/23.HttpClient` | 734,457 | 63,176 |
| `MQTT` | `L7-Application/24.MqttClient` | 736,109 | 65,328 |
| `NTP_SERVER+TIME_SOURCE+NMEA0183+NTP` | `L7-Application/58.NtpServer` | 748,009 | 46,668 |
...
| `LOGBUF` | `L7-Application/41.LogBuffer` | 752,509 | 69,320 |
...
| `MODBUS+MODBUS_MASTER` | `L7-Application/43.ModbusScan` | 753,109 | 66,480 |
| `JWT` | `L6-Presentation/06.JWTAuth` | 753,189 | 66,776 |
| `CBOR` | `L6-Presentation/13.Cbor` | 753,277 | 66,280 |
| `AUDIT_LOG` | `L7-Application/49.AuditLog` | 753,285 | 69,192 |
...
| `GPIO_MAP` | `L7-Application/38.GpioMap` | 755,285 | 66,264 |
| `WS_DEFLATE` | `L6-Presentation/11.WebSocketCompression` | 755,677 | 74,392 |
| `WEB_TERMINAL` | `L6-Presentation/10.WebTerminal` | 755,781 | 66,280 |
| `GRAPHQL` | `L7-Application/52.GraphQL` | 755,885 | 70,608 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/42.ConfigExport` | 755,993 | 66,268 |
| `OTA` | `L7-Application/16.OTA` | 756,257 | 102,328 |
| `COAP` | `L7-Application/13.CoAP` | 756,625 | 68,712 |
| `DNS_RESOLVER` | `L7-Application/48.DnsResolver` | 756,985 | 67,488 |
| `PROVISIONING` | `L7-Application/17.Provisioning` | 758,581 | 67,772 |
| `OPCUA` | `L7-Application/55.OpcUa` | 759,217 | 76,496 |
| `core/02.Advanced` | `Foundation/02.Advanced` | 759,737 | 66,312 |
| `SNMP` | `L7-Application/14.SNMP` | 759,821 | 78,608 |
| `TELEMETRY` | `L7-Application/34.Telemetry` | 759,853 | 66,524 |
| `HTTP_CLIENT+WEBHOOK` | `L7-Application/46.Webhook` | 761,509 | 85,952 |
| `OAUTH2+HTTP_CLIENT` | `L7-Application/54.OAuth2` | 763,465 | 89,024 |
| `PROMISC+FORWARD+ETHERNET` | `Foundation/21.WifiCapture` | 764,241 | 47,320 |
...
| `BUS_CAPTURE+FORWARD+ETHERNET` | `Foundation/22.CanCapture` | 770,765 | 45,316 |
| `DASHBOARD` | `L7-Application/35.Dashboard` | 771,797 | 66,568 |
| `NTP+TIME_SOURCE` | `L7-Application/31.TimeSourceFallback` | 772,185 | 67,820 |
...
| `UPLOAD` | `L7-Application/11.FileUpload` | 793,441 | 71,432 |
...
| `WS_CLIENT+TLS+WS_CLIENT_TLS` | `L7-Application/25.WebSocketClient` | 831,689 | 120,436 |
