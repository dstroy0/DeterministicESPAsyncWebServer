...
| `ACCEPT_THROTTLE` | `L4-Transport/02.AcceptThrottle` | 750,961 | 66,336 |
| `core/02.CORS` | `L7-Application/02.CORS` | 751,129 | 66,328 |
| `core/04.BasicAuth` | `L6-Presentation/04.BasicAuth` | 751,201 | 66,328 |
| `RADIO_POWER+RADIO_WIFI_PS` | `L7-Application/47.RadioPower` | 751,205 | 66,328 |
| `core/05.DigestAuth` | `L6-Presentation/05.DigestAuth` | 751,325 | 66,328 |
| `core/06.RegexRoutes` | `L7-Application/06.RegexRoutes` | 751,445 | 66,328 |
| `PER_IP_THROTTLE` | `L4-Transport/05.PerIpThrottle` | 751,497 | 66,776 |
| `DEVICE_ID` | `L7-Application/32.DeviceUuid` | 751,533 | 66,368 |
| `core/05.PathParams` | `L7-Application/05.PathParams` | 751,537 | 66,328 |
| `core/09.WebSocket` | `L6-Presentation/09.WebSocket` | 751,589 | 66,328 |
| `GUARDRAILS` | `L7-Application/40.Guardrails` | 751,677 | 66,336 |
| `core/07.ResponseHeaders` | `L7-Application/07.ResponseHeaders` | 751,689 | 66,328 |
| `core/04.Middleware` | `L7-Application/04.Middleware` | 751,789 | 66,336 |
| `core/01.ChunkedResponse` | `L7-Application/01.ChunkedResponse` | 751,841 | 66,344 |
| `core/36.NetEgress` | `L7-Application/36.NetEgress` | 751,841 | 66,328 |
| `core/08.ServerSentEvents` | `L6-Presentation/08.ServerSentEvents` | 751,845 | 66,336 |
| `KEEPALIVE` | `L4-Transport/01.KeepAlive` | 751,881 | 66,336 |
| `PARTITION_MONITOR` | `L7-Application/37.PartitionMonitor` | 751,885 | 66,328 |
| `core/01.FormParams` | `L6-Presentation/01.FormParams` | 751,981 | 66,328 |
| `OTA_ROLLBACK` | `L7-Application/44.OtaRollback` | 752,193 | 66,336 |
| `AUTH_LOCKOUT` | `L6-Presentation/12.AuthLockout` | 752,213 | 66,904 |
| `core/03.Multipart` | `L6-Presentation/03.Multipart` | 752,277 | 66,328 |
| `TOTP` | `L7-Application/45.Totp` | 752,337 | 66,368 |
| `IP_ALLOWLIST` | `L4-Transport/07.IpAllowlist` | 752,517 | 66,328 |
| `CSRF` | `L7-Application/33.Csrf` | 752,537 | 66,376 |
| `LOGBUF` | `L7-Application/41.LogBuffer` | 752,641 | 69,456 |
| `core/03.InterfaceFilter` | `L7-Application/03.InterfaceFilter` | 752,765 | 66,328 |
| `DIAG` | `Foundation/05.Configuration` | 752,849 | 63,080 |
| `MODBUS` | `L7-Application/30.ModbusTcp` | 752,929 | 66,608 |
| `core/08.Templating` | `L7-Application/08.Templating` | 752,965 | 66,368 |
| `STATS` | `L7-Application/22.Stats` | 753,001 | 66,424 |
| `core/01.Basic` | `Foundation/01.Basic` | 753,237 | 66,336 |
| `MODBUS+MODBUS_MASTER` | `L7-Application/43.ModbusScan` | 753,257 | 66,600 |
| `JWT` | `L6-Presentation/06.JWTAuth` | 753,337 | 66,904 |
| `AUDIT_LOG` | `L7-Application/49.AuditLog` | 753,425 | 69,312 |
| `CBOR` | `L6-Presentation/13.Cbor` | 753,429 | 66,400 |
| `TELNET` | `L5-Session/03.Telnet` | 753,481 | 66,864 |
| `IPV6` | `Foundation/20.IPv6` | 753,617 | 66,328 |
| `core/03.Expert` | `Foundation/03.Expert` | 753,873 | 66,344 |
...
| `core/02.Json` | `L6-Presentation/02.Json` | 755,241 | 66,328 |
| `GPIO_MAP` | `L7-Application/38.GpioMap` | 755,425 | 66,384 |
| `WS_DEFLATE` | `L6-Presentation/11.WebSocketCompression` | 755,825 | 74,520 |
| `WEB_TERMINAL` | `L6-Presentation/10.WebTerminal` | 755,929 | 66,416 |
| `GRAPHQL` | `L7-Application/52.GraphQL` | 756,049 | 70,736 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/42.ConfigExport` | 756,113 | 66,388 |
| `OTA` | `L7-Application/16.OTA` | 756,353 | 102,464 |
| `COAP` | `L7-Application/13.CoAP` | 756,809 | 68,848 |
| `DNS_RESOLVER` | `L7-Application/48.DnsResolver` | 757,133 | 67,608 |
| `PROVISIONING` | `L7-Application/17.Provisioning` | 758,745 | 67,892 |
...
| `core/04.Sysadmin` | `Foundation/04.Sysadmin` | 765,101 | 66,336 |
...
| `MDNS` | `L7-Application/15.mDNS` | 776,617 | 68,232 |
| `NTP` | `L7-Application/18.SNTP` | 776,869 | 68,880 |
| `OPCUA+OPCUA_CLIENT` | `L7-Application/56.OpcUaClient` | 782,049 | 80,480 |
| `ETHERNET` | `Foundation/19.Ethernet` | 789,781 | 66,372 |
| `core/10.FileServing` | `L7-Application/10.FileServing` | 792,533 | 66,360 |
| `UPLOAD` | `L7-Application/11.FileUpload` | 793,585 | 71,560 |
| `RANGE` | `L7-Application/12.Range` | 793,785 | 66,360 |
| `VFS` | `L7-Application/51.Vfs` | 794,721 | 70,856 |
| `WEBDAV` | `L7-Application/29.WebDav` | 820,285 | 105,696 |
| `SSH` | `L5-Session/03.SSHHostKey` | 821,145 | 88,676 |
