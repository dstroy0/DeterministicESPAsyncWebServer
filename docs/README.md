...
| `core/05.DigestAuth` | `L6-Presentation/05.DigestAuth` | 752,281 | 81,768 |
| `core/06.RegexRoutes` | `L7-Application/06.RegexRoutes` | 752,405 | 81,768 |
| `PER_IP_THROTTLE` | `L4-Transport/05.PerIpThrottle` | 752,433 | 82,216 |
| `KEEPALIVE` | `L4-Transport/01.KeepAlive` | 752,449 | 81,768 |
| `DEVICE_ID` | `L7-Application/32.DeviceUuid` | 752,493 | 81,808 |
| `core/05.PathParams` | `L7-Application/05.PathParams` | 752,525 | 81,768 |
| `core/09.WebSocket` | `L6-Presentation/09.WebSocket` | 752,549 | 81,768 |
| `GUARDRAILS` | `L7-Application/40.Guardrails` | 752,641 | 81,784 |
| `core/07.ResponseHeaders` | `L7-Application/07.ResponseHeaders` | 752,657 | 81,768 |
| `core/04.Middleware` | `L7-Application/04.Middleware` | 752,749 | 81,776 |
| `core/08.ServerSentEvents` | `L6-Presentation/08.ServerSentEvents` | 752,761 | 81,776 |
| `DIAG` | `L7-Application/20.Diagnostics` | 752,765 | 81,768 |
| `core/36.NetEgress` | `L7-Application/36.NetEgress` | 752,821 | 81,768 |
| `PARTITION_MONITOR` | `L7-Application/37.PartitionMonitor` | 752,825 | 81,776 |
| `core/01.ChunkedResponse` | `L7-Application/01.ChunkedResponse` | 752,849 | 81,784 |
| `core/01.FormParams` | `L6-Presentation/01.FormParams` | 752,917 | 81,768 |
| `AUTH_LOCKOUT` | `L6-Presentation/12.AuthLockout` | 753,157 | 82,344 |
| `OTA_ROLLBACK` | `L7-Application/44.OtaRollback` | 753,157 | 81,784 |
| `core/03.Multipart` | `L6-Presentation/03.Multipart` | 753,233 | 81,768 |
| `TOTP` | `L7-Application/45.Totp` | 753,273 | 81,808 |
| `IP_ALLOWLIST` | `L4-Transport/07.IpAllowlist` | 753,457 | 81,768 |
| `CSRF` | `L7-Application/33.Csrf` | 753,553 | 81,824 |
| `LOGBUF` | `L7-Application/41.LogBuffer` | 753,597 | 84,896 |
| `core/03.InterfaceFilter` | `L7-Application/03.InterfaceFilter` | 753,717 | 81,768 |
| `MODBUS` | `L7-Application/30.ModbusTcp` | 753,853 | 82,056 |
| `core/08.Templating` | `L7-Application/08.Templating` | 753,933 | 81,816 |
| `STATS` | `L7-Application/22.Stats` | 753,993 | 81,872 |
...
| `core/03.Expert` | `Foundation/03.Expert` | 754,833 | 81,792 |
| `SYSLOG` | `L7-Application/19.Syslog` | 755,497 | 83,632 |
| `MSGPACK` | `L6-Presentation/14.MsgPack` | 755,753 | 81,848 |
| `STATS+METRICS` | `L7-Application/21.PrometheusMetrics` | 756,129 | 81,912 |
| `core/02.Json` | `L6-Presentation/02.Json` | 756,209 | 81,776 |
| `GPIO_MAP` | `L7-Application/38.GpioMap` | 756,409 | 81,832 |
| `WS_DEFLATE` | `L6-Presentation/11.WebSocketCompression` | 756,813 | 89,968 |
| `WEB_TERMINAL` | `L6-Presentation/10.WebTerminal` | 756,861 | 81,856 |
| `GRAPHQL` | `L7-Application/52.GraphQL` | 757,013 | 86,184 |
| `OTA` | `L7-Application/16.OTA` | 757,017 | 102,112 |
| `CONFIG_STORE+CONFIG_IO` | `L7-Application/42.ConfigExport` | 757,057 | 81,836 |
| `COAP` | `L7-Application/13.CoAP` | 757,789 | 84,288 |
| `DNS_RESOLVER` | `L7-Application/48.DnsResolver` | 758,077 | 83,056 |
| `PROVISIONING` | `L7-Application/17.Provisioning` | 759,713 | 83,340 |
| `OPCUA` | `L7-Application/55.OpcUa` | 760,069 | 92,056 |
| `core/02.Advanced` | `Foundation/02.Advanced` | 760,849 | 81,880 |
| `SNMP` | `L7-Application/14.SNMP` | 760,909 | 94,176 |
| `TELEMETRY` | `L7-Application/34.Telemetry` | 760,949 | 82,092 |
| `RELAY` | `L7-Application/70.PortForward` | 762,085 | 116,384 |
| `HTTP_CLIENT+WEBHOOK` | `L7-Application/46.Webhook` | 762,633 | 101,528 |
| `PROMISC+FORWARD+ETHERNET` | `Foundation/21.WifiCapture` | 764,637 | 47,520 |
| `OAUTH2+HTTP_CLIENT` | `L7-Application/54.OAuth2` | 764,969 | 104,592 |
| `OIDC` | `L7-Application/50.OidcAuth` | 765,573 | 99,824 |
| `core/04.Sysadmin` | `Foundation/04.Sysadmin` | 766,069 | 81,784 |
...
| `DASHBOARD` | `L7-Application/35.Dashboard` | 772,889 | 82,144 |
| `NTP+TIME_SOURCE` | `L7-Application/31.TimeSourceFallback` | 773,301 | 83,388 |
| `MDNS` | `L7-Application/15.mDNS` | 777,569 | 83,672 |
| `NTP` | `L7-Application/18.SNTP` | 777,833 | 84,320 |
| `OPCUA+OPCUA_CLIENT` | `L7-Application/56.OpcUaClient` | 783,021 | 95,928 |
| `ETHERNET` | `Foundation/19.Ethernet` | 790,965 | 81,820 |
| `ETHERNET+ETH_W5500+ETH_W5500_CS+ETH_W5500_RST+ETH_W5500_INT+ETH_W5500_SCK+ETH_W5500_MISO+ETH_W5500_MOSI` | `Foundation/23.EthernetW5500` | 790,981 | 81,820 |
...
| `VFS` | `L7-Application/51.Vfs` | 795,677 | 86,296 |
| `WEBDAV` | `L7-Application/29.WebDav` | 821,069 | 105,352 |
| `SSH` | `L5-Session/03.SSHHostKey` | 822,045 | 108,220 |
| `ETAG` | `L7-Application/09.ETag` | 828,213 | 83,080 |
