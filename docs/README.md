...
| `MDNS+PROMISC+WIFI_SNIFFER+MDNS_ADAPTIVE` | `L7-Application/MdnsAdaptive` | 780,401 | 83,776 |
...
| `UPLOAD` | `L7-Application/FileUpload` | 795,209 | 101,964 |
...
| `SSH` | `L5-Session/SSHHostKey` | 830,149 | 109,208 |
...
| `SSH+FILE_SERVING+SSH_SFTP+SSH_SCP` | `L5-Session/SSHSftp` | 882,429 | 118,560 |
