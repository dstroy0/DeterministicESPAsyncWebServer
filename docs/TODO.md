...
- **SMB/CIFS client** - _in progress_: increment 1 (SMB2 wire codec: transport + sync header + NEGOTIATE)
  **shipped**; next = the NTLM crypto (MD4/MD5/HMAC-MD5 + KAT) then SESSION_SETUP, then the file commands.
