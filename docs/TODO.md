...
- **SMB/CIFS client** - _in progress_: increments 1 (SMB2 wire codec) + 2 (NTLM digests) + 3 (NTLMv2
  response, MS-NLMP §4.2-verified) **shipped**; next = the NTLMSSP messages + SESSION_SETUP, then the file commands.
