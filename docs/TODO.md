...
- **SMB/CIFS client** - _in progress_: increments 1 (SMB2 wire codec) + 2 (NTLM digests) + 3 (NTLMv2
  response) + 4 (NTLMSSP messages) **shipped**; next = SPNEGO + the SESSION_SETUP flow, then the file commands.
