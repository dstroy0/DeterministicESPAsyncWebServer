...
- [x] **Architecture pass.** Pluggable per-protocol handler dispatch
      ...
      `pc_conn_sndbuf`, context-safe `Tcp.conn->raw_send`), response header+body
