...
- **SMB/CIFS client** - _in progress_: increments 1 (SMB2 wire codec) + 2 (NTLM digests MD4/MD5/HMAC-MD5,
  KAT-verified) **shipped**; next = the NTLMv2 response + SESSION_SETUP/NTLMSSP, then the file commands.
