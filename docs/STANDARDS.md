...
- [MS-SMB2](https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-smb2) - SMB2 (Server Message Block 2) - **impl** (client wire codec: the sync header, NEGOTIATE, the SESSION_SETUP framing that carries the SPNEGO tokens §2.2.5/§2.2.6, and the TREE_CONNECT / CREATE / CLOSE file commands §2.2.9-§2.2.16; READ / WRITE are staged).
