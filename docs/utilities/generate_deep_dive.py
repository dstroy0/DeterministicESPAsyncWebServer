...
def parse_test_file(filepath):
    ...
    for test_fn in run_tests:
        ...
        test_cases.append(
            {"fn_name": test_fn, "title": clean_name(test_fn), "description": comment, "assertions": assertions}
        )
...
if __name__ == "__main__":
    ...
    markdown.append(
        f"This section contains a thorough directory of all test cases across all {len(suites)} test suites. Click on any test suite to expand its test cases, and click on individual test cases to expand their objectives and assertions.\n"
    )
