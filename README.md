...
[![Version](https://img.shields.io/badge/version-v0.0.6-blue)](docs/CHANGELOG.md)
...
**[Per-feature build footprints &rarr;](docs/FOOTPRINTS.md)** - 78 features that add measurable flash, each measured from isolated builds as a range: best case (its dependencies are already linked) to worst case (budget with this). Every example's absolute total is there too.
