...
void test_device_write()
{
    ...
    TEST_ASSERT_EQUAL_size_t(0, pc_vxi11_build_device_write(buf, sizeof(buf), 2, 1, 0, 0, 0, nullptr, 4));
}
...
void test_build_overflow()
{
    ...
    TEST_ASSERT_EQUAL_size_t(0, pc_vxi11_build_create_link(nullptr, 128, 1, 0, false, 0, "inst0"));
}
...
{
    uint8_t buf[4];
    TEST_ASSERT_EQUAL_size_t(0, pc_rpc_record_mark(nullptr, sizeof(buf), 16));
    TEST_ASSERT_EQUAL_size_t(0, pc_rpc_record_mark(buf, 3, 16)); // no room for the 4-byte mark

    const uint8_t rm[] = {0x80, 0x00, 0x00, 0x10};
    TEST_ASSERT_FALSE(pc_rpc_parse_record_mark(nullptr, 4, nullptr, nullptr));
    TEST_ASSERT_FALSE(pc_rpc_parse_record_mark(rm, 3, nullptr, nullptr)); // short frame
    // both outputs are optional
    TEST_ASSERT_TRUE(pc_rpc_parse_record_mark(rm, 4, nullptr, nullptr));
}
...
void test_reply_full_length_rejects()
{
    ...
    TEST_ASSERT_FALSE(pc_rpc_parse_reply(nullptr, 24, &xid, &astat, &off));
}
...
void test_reply_optional_outputs()
{
    ...
    TEST_ASSERT_TRUE(pc_rpc_parse_reply(b, o, &xid, nullptr, nullptr));
    TEST_ASSERT_EQUAL_UINT32(0xABCD, xid);
    // every output is optional
    TEST_ASSERT_TRUE(pc_rpc_parse_reply(b, o, nullptr, nullptr, nullptr));
}
...
void test_getport_reject_paths()
{
    ...
    o = reply_header(b, 7, 0);
    o = put32(b, o, 1280);
    TEST_ASSERT_TRUE(pc_vxi11_parse_getport_resp(b, o, nullptr));
}
...
void test_create_link_lock_and_empty_device()
{
    ...
    n = pc_vxi11_build_create_link(buf, sizeof(buf), 1, 0, false, 0, nullptr);
...
void test_create_link_resp_reject_paths()
{
    ...
    o = put32(b, o, 2);
    o = put32(b, o, 3);
    TEST_ASSERT_FALSE(pc_vxi11_parse_create_link_resp(b, o, nullptr)); // nowhere to decode into
...
void test_device_write_empty_payload()
{
    ...
    TEST_ASSERT_EQUAL_size_t(64, pc_vxi11_build_device_write(buf, sizeof(buf), 2, 1, 0, 0, 0, nullptr, 0));
}
...
void test_write_resp_reject_paths()
{
    ...
    o = put32(b, o, 0);
    o = put32(b, o, 6);
    TEST_ASSERT_FALSE(pc_vxi11_parse_write_resp(b, o, nullptr));
...
void test_read_resp_reject_paths()
{
    ...
    TEST_ASSERT_FALSE(pc_vxi11_parse_read_resp(b, o, nullptr));
...
void test_readstb_and_error_resp_reject_paths()
{
    ...
    o = put32(b, o, 0);
    o = put32(b, o, 0x40);
    TEST_ASSERT_FALSE(pc_vxi11_parse_readstb_resp(b, o, nullptr));
    ...
    TEST_ASSERT_TRUE(pc_vxi11_parse_error_resp(b, o, nullptr));
}
