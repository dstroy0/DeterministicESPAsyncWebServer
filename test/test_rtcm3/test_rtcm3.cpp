...
void test_frame_parse_edges()
{
    ...
    TEST_ASSERT_EQUAL_size_t(0, pc_rtcm3_frame_parse(notpre, sizeof(notpre), nullptr));
    TEST_ASSERT_EQUAL_size_t(sizeof(FRAME_1005), pc_rtcm3_frame_parse(FRAME_1005, sizeof(FRAME_1005), nullptr));
...
void test_frame_build_edges()
{
    ...
    TEST_ASSERT_EQUAL_size_t(0, pc_rtcm3_frame_build(nullptr, sizeof(frame), body, sizeof(body)));
    ...
    TEST_ASSERT_EQUAL_size_t(n3, pc_rtcm3_frame_build(frame, sizeof(frame), nullptr, 3));
    memset(&f, 0, sizeof(f));
...
void test_parse_1005_rejects_bad_input()
{
    ...
    TEST_ASSERT_FALSE(pc_rtcm3_parse_1005(nullptr, 19, &arp));
    TEST_ASSERT_FALSE(pc_rtcm3_parse_1005(body, 19, nullptr));
