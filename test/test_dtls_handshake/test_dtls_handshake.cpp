...
static void test_ack_roundtrip(void)
{
    ...
    n = pc_dtls_ack_build(nullptr, 0, out, sizeof(out));
...
static void test_ack_build_rejects(void)
{
    ...
    TEST_ASSERT_EQUAL_size_t(0, pc_dtls_ack_build(nullptr, 4096, out, sizeof(out)));
...
static void test_cookie_make_rejects(void)
{
    ...
    TEST_ASSERT_EQUAL_size_t(
        0, pc_dtls_cookie_make(COOKIE_KEY, 1, nullptr, 0x10000, COOKIE_ADDR, sizeof(COOKIE_ADDR), out, sizeof(out)));
...
static void test_cookie_empty_payload_roundtrip(void)
{
    uint8_t cookie[PC_DTLS_COOKIE_MAX];
    size_t n =
        pc_dtls_cookie_make(COOKIE_KEY, 4242, nullptr, 0, COOKIE_ADDR, sizeof(COOKIE_ADDR), cookie, sizeof(cookie));
