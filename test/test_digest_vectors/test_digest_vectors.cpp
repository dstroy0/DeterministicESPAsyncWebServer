...
// expected response with the SAME dws_sha256 the server uses, so it cannot catch
...
// If dws_sha256 or the RFC 7616 string construction ever drifts, these fail even
...
// Ground dws_sha256 itself against the FIPS 180-4 published vectors so the
