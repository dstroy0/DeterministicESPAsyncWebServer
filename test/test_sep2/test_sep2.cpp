...
{
    char buf[64];
    TEST_ASSERT_EQUAL_size_t(0, pc_sep2_device_capability(900, "/edev", "/derp", nullptr, sizeof(buf)));
...
{
    char buf[64];
    TEST_ASSERT_EQUAL_size_t(0, pc_sep2_end_device(123456789ULL, "3E4F...A1", "/edev/0", nullptr, sizeof(buf)));
...
{
    char buf[64];
    TEST_ASSERT_EQUAL_size_t(0, pc_sep2_der_control("A1B2", 1720000000u, 3600, -1500, nullptr, sizeof(buf)));
