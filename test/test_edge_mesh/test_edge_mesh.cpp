...
static void test_requester_timeout()
{
    ...
    TEST_ASSERT_EQUAL(EdgeMeshStatus::FAILED, edge_mesh_fetch_pump(&mf, &t, 1000 + PC_MESH_QUERY_MS + 1));
}
...
static void test_parse_request_null_outputs()
{
    ...
    TEST_ASSERT_EQUAL(EdgeMeshParse::HIT,
                      edge_mesh_parse_request(req, n, nullptr, nullptr, PC_EDGE_KEY_MAX, nullptr, PC_MESH_HDRS_MAX));
}
