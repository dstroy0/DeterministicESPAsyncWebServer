...
{
    SseConn *sse = pc_sse_alloc(0, "/events");
    TEST_ASSERT_FALSE(pc_sse_write(sse, nullptr, nullptr, nullptr));
}
...
void test_sse_write_returns_false_when_conn_not_active()
{
    ...
    TEST_ASSERT_FALSE(pc_sse_write(sse, "hello", nullptr, nullptr));
}
...
void test_sse_write_returns_false_when_pcb_null()
{
    ...
    TEST_ASSERT_FALSE(pc_sse_write(sse, "data", nullptr, nullptr));
}

void test_sse_write_data_only_returns_true()
{
    SseConn *sse = pc_sse_alloc(0, "/events");
    TEST_ASSERT_TRUE(pc_sse_write(sse, "hello", nullptr, nullptr));
}

void test_sse_write_with_event_returns_true()
{
    SseConn *sse = pc_sse_alloc(0, "/events");
    TEST_ASSERT_TRUE(pc_sse_write(sse, "payload", "update", nullptr));
}

void test_sse_write_with_id_returns_true()
{
    SseConn *sse = pc_sse_alloc(0, "/events");
    TEST_ASSERT_TRUE(pc_sse_write(sse, "payload", nullptr, "42"));
}
...
void test_sse_write_does_not_affect_other_slots()
{
    ...
    pc_sse_write(s0, "msg", nullptr, nullptr);
...
{
    char buf[64];
    int n = pc_sse_format(buf, sizeof(buf), "hello", nullptr, nullptr);
...
{
    char buf[64];
    int n = pc_sse_format(buf, sizeof(buf), "payload", "update", nullptr);
...
{
    char buf[64];
    int n = pc_sse_format(buf, sizeof(buf), "payload", nullptr, "42");
...
{
    char buf[64];
    TEST_ASSERT_EQUAL(0, pc_sse_format(buf, sizeof(buf), nullptr, "x", "1"));
}
...
{
    char buf[8];
    TEST_ASSERT_EQUAL(0, pc_sse_format(buf, 0, "data", nullptr, nullptr));
}
...
{
    char buf[5];
    TEST_ASSERT_EQUAL(0, pc_sse_format(buf, sizeof(buf), "y", "x", nullptr));
}
...
void test_sse_format_event_newline_overflows()
{
    ...
    TEST_ASSERT_EQUAL(0, pc_sse_format(buf, sizeof(buf), "unused", "ab", nullptr));
}
...
void test_sse_format_id_block_failure_arms()
{
    ...
    TEST_ASSERT_EQUAL(0, pc_sse_format(a, sizeof(a), "d", nullptr, "z"));

    char b[7]; // "id: " (4) fits, "XYZ" (3) does not (n-1 == 6)
    TEST_ASSERT_EQUAL(0, pc_sse_format(b, sizeof(b), "d", nullptr, "XYZ"));

    char c[7]; // "id: " (4) + "XY" (2) == 6 == n-1; the '\n' has no room left
    TEST_ASSERT_EQUAL(0, pc_sse_format(c, sizeof(c), "d", nullptr, "XY"));
}
...
void test_sse_format_data_block_failure_arms()
{
    ...
    TEST_ASSERT_EQUAL(0, pc_sse_format(a, sizeof(a), "abcdef", nullptr, nullptr));

    char b[10]; // "data: " (6) fits, "abcdef" (6) does not (n-1 == 9)
    TEST_ASSERT_EQUAL(0, pc_sse_format(b, sizeof(b), "abcdef", nullptr, nullptr));

    char c[9]; // "data: " (6) + "ab" (2) == 8 == n-1; the "\n\n" terminator has no room left
    TEST_ASSERT_EQUAL(0, pc_sse_format(c, sizeof(c), "ab", nullptr, nullptr));
}
