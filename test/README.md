...
| `native_clock` | default | `test_clock` | Pluggable monotonic clock (services/pc_clock): default millis(), custom clock divided down to the internal 1000 Hz. |
...
| `native_inflate` | `PC_ENABLE_WS_DEFLATE=1` | `test_inflate` | RFC 1951 INFLATE core (the WebSocket permessage-deflate decompressor). |
...
| `native_ssh_comp` | `PC_ENABLE_SSH=1`, `PC_ENABLE_SSH_ZLIB=1`, `PC_ENABLE_WS_DEFLATE=1` | `test_ssh_comp` | SSH s2c compression WIRING with the full SSH stack built with PC_ENABLE_SSH_ZLIB=1: the compression owner (ssh_comp) + its NEWKEYS / USERAUTH_SUCCESS activation + the packet-layer compress path in ssh... |
...
| `native_ws_deflate` | `PC_ENFORCE_HOST_HEADER=0`, `PC_ENABLE_WS_DEFLATE=1` | `test_websocket` | WebSocket permessage-deflate (RFC 7692) inbound path wired through the real WS stack: handshake negotiation, the RSV1 frame path, and INFLATE delivery (with the table scratch borrowed from the shared ... |
...
A thorough directory of all **1047 test cases** across **38 suites**. Expand a suite to see its test cases, and a test case to see its objective and assertions.
...
<summary><b>test_forward (33 tests)</b></summary>
  ...
  <details style="margin-left: 20px;">
    ...
    * **Assertions**:
      * <code>Assert true (pc_forward_add_rule(1, 2, pc_fwd_action::PC_FWD_ALLOW, 0))</code>
  ...
  <details style="margin-left: 20px;">
    ...
    * **Assertions**:
      ...
      * <code>Assert false (pc_forward_add_if(9, pc_if_kind::PC_IF_OTHER, nullptr, nullptr))</code>
      * <code>Assert true (add_if(2))</code>
      * <code>Assert true (add_if(3))</code>
      * <code>Assert true (add_if(4))</code>
      * <code>Assert false (add_if(5)); // table full (PC_FWD_MAX_IFACES = 4)</code>
  </details>
  ...
  <details style="margin-left: 20px;">
    ...
    * **Assertions**:
      * <code>Assert true (pc_forward_add_rule(1, 2, pc_fwd_action::PC_FWD_ALLOW, 0))</code>
      * <code>Assert false (pc_forward_add_rule(1, 3, pc_fwd_action::PC_FWD_ALLOW, 0))</code>
  </details>
  ...
  <details style="margin-left: 20px;">
    ...
    * **Assertions**:
      * <code>Assert true (pc_forward_acl_add(1, 0, pat, msk, 1, pc_fwd_action::PC_FWD_DENY))</code>
  ...
  <details style="margin-left: 20px;">
    ...
    * **Assertions**:
      ...
      * <code>Assert true (pc_forward_acl_add(PC_FWD_IF_ANY, 0, nullptr, nullptr, 0, pc_fwd_action::PC_FWD_ALLOW))</code>
      * <code>Assert false (pc_forward_acl_add(PC_FWD_IF_ANY, 0, nullptr, nullptr, 0, pc_fwd_action::PC_FWD_ALLOW))</code>
  </details>
  ...
  <details style="margin-left: 20px;">
    ...
    * **Assertions**:
      * <code>Assert false (pc_forward_acl_add(1, 0, nullptr, msk, 1, pc_fwd_action::PC_FWD_DENY))</code>
      * <code>Assert false (pc_forward_acl_add(1, 0, pat, nullptr, 1, pc_fwd_action::PC_FWD_DENY))</code>
  </details>
  ...
  <details style="margin-left: 20px;">
    ...
    * **Assertions**:
      * <code>Assert true (route_firstbyte(PC_FWD_IF_ANY, 'X', 3, 0))</code>
  ...
  <details style="margin-left: 20px;">
    ...
    * **Assertions**:
      * <code>Assert true (route_firstbyte(PC_FWD_IF_ANY, 'Z', 2, 0))</code>
  ...
  <details style="margin-left: 20px;">
    ...
    * **Assertions**:
      * <code>Assert true (pc_forward_route_add(PC_FWD_IF_ANY, 0, nullptr, nullptr, 0, 2, 0))</code>
  ...
  <details style="margin-left: 20px;">
    ...
    * **Assertions**:
      * <code>Assert false (pc_forward_route_add(PC_FWD_IF_ANY, 0, pat, msk, PC_FWD_ACL_PATLEN + 1, 2, 0))</code>
      * <code>Assert false (pc_forward_route_add(PC_FWD_IF_ANY, 0, nullptr, msk, 1, 2, 0))</code>
      * <code>Assert false (pc_forward_route_add(PC_FWD_IF_ANY, 0, pat, nullptr, 1, 2, 0))</code>
      * <code>Assert true (route_firstbyte(PC_FWD_IF_ANY, 'A', 2, 0))</code>
      * <code>Assert false (route_firstbyte(PC_FWD_IF_ANY, 'A', 2, 0))</code>
  </details>
