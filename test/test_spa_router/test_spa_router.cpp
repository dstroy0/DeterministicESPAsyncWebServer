...
{
    TEST_ASSERT_EQUAL_INT(DetwsSpaAction::DWS_SPA_SERVE_SHELL, dws_spa_route("/", "/api/"));
    TEST_ASSERT_EQUAL_INT(DetwsSpaAction::DWS_SPA_SERVE_SHELL, dws_spa_route("", "/api/"));
    TEST_ASSERT_EQUAL_INT(DetwsSpaAction::DWS_SPA_SERVE_SHELL, dws_spa_route("/dashboard", "/api/"));
    TEST_ASSERT_EQUAL_INT(DetwsSpaAction::DWS_SPA_SERVE_SHELL, dws_spa_route("/devices/42", "/api/"));
    TEST_ASSERT_EQUAL_INT(DetwsSpaAction::DWS_SPA_SERVE_FILE, dws_spa_route("/app.js", "/api/"));
    TEST_ASSERT_EQUAL_INT(DetwsSpaAction::DWS_SPA_SERVE_FILE, dws_spa_route("/assets/logo.svg", "/api/"));
    TEST_ASSERT_EQUAL_INT(DetwsSpaAction::DWS_SPA_PASSTHROUGH, dws_spa_route("/api/state", "/api/"));
    TEST_ASSERT_EQUAL_INT(DetwsSpaAction::DWS_SPA_PASSTHROUGH, dws_spa_route("/api/devices/42", "/api/"));
    // No API prefix configured: an /api path is just a route.
    TEST_ASSERT_EQUAL_INT(DetwsSpaAction::DWS_SPA_SERVE_SHELL, dws_spa_route("/api/state", nullptr));
}
