...
void test_order_and_interleave(void)
{
    ...
    TEST_ASSERT_EQUAL_INT(PC_IP_V4, list[1].family);
    TEST_ASSERT_EQUAL_INT(PC_IP_V6, list[2].family);
}
...
void test_pref_null_and_none(void)
{
    ...
    TEST_ASSERT_EQUAL_INT(-1, pc_he_pref(NULL));
    pc_ip none_ip;
    none_ip.family = PC_IP_NONE;
...
void test_order_family_imbalance_drains_v6(void)
{
    ...
    TEST_ASSERT_EQUAL_INT(PC_IP_V4, list[1].family);
    TEST_ASSERT_EQUAL_INT(PC_IP_V6, list[2].family);
    TEST_ASSERT_EQUAL_INT(PC_IP_V6, list[3].family);
}
