...
{
    TEST_ASSERT_EQUAL_INT(DAV_M_OPTIONS, pc_webdav_method("OPTIONS"));
    TEST_ASSERT_EQUAL_INT(DAV_M_PROPFIND, pc_webdav_method("PROPFIND"));
    TEST_ASSERT_EQUAL_INT(DAV_M_PROPPATCH, pc_webdav_method("PROPPATCH"));
    TEST_ASSERT_EQUAL_INT(DAV_M_MKCOL, pc_webdav_method("MKCOL"));
    TEST_ASSERT_EQUAL_INT(DAV_M_COPY, pc_webdav_method("COPY"));
    TEST_ASSERT_EQUAL_INT(DAV_M_MOVE, pc_webdav_method("MOVE"));
    TEST_ASSERT_EQUAL_INT(DAV_M_LOCK, pc_webdav_method("LOCK"));
    TEST_ASSERT_EQUAL_INT(DAV_M_UNLOCK, pc_webdav_method("UNLOCK"));
    TEST_ASSERT_EQUAL_INT(DAV_M_PUT, pc_webdav_method("PUT"));
    TEST_ASSERT_EQUAL_INT(DAV_M_GET, pc_webdav_method("GET"));
    TEST_ASSERT_EQUAL_INT(DAV_M_DELETE, pc_webdav_method("DELETE"));
    TEST_ASSERT_EQUAL_INT(DAV_M_UNSUPPORTED, pc_webdav_method("BREW"));
    TEST_ASSERT_EQUAL_INT(DAV_M_UNSUPPORTED, pc_webdav_method(NULL));
}
...
{
    TEST_ASSERT_EQUAL_INT(DAV_M_HEAD, pc_webdav_method("HEAD"));
    TEST_ASSERT_EQUAL_INT(DAV_M_OPTIONS, pc_webdav_method("OPTIONS"));
    TEST_ASSERT_EQUAL_INT(DAV_M_MKCOL, pc_webdav_method("MKCOL"));
    TEST_ASSERT_EQUAL_INT(DAV_M_COPY, pc_webdav_method("COPY"));
    TEST_ASSERT_EQUAL_INT(DAV_M_MOVE, pc_webdav_method("MOVE"));
    TEST_ASSERT_EQUAL_INT(DAV_M_LOCK, pc_webdav_method("LOCK"));
    TEST_ASSERT_EQUAL_INT(DAV_M_UNLOCK, pc_webdav_method("UNLOCK"));
    TEST_ASSERT_EQUAL_INT(DAV_M_UNSUPPORTED, pc_webdav_method("BOGUS"));
    TEST_ASSERT_EQUAL_INT(DAV_M_UNSUPPORTED, pc_webdav_method(NULL));
}
...
void test_lock_acquire_and_write_gate()
{
    ...
    TEST_ASSERT_TRUE(pc_dav_lock_can_write(&t, "/b.txt", NULL));
...
void test_if_header_token_extraction()
{
    ...
    TEST_ASSERT_FALSE(pc_dav_if_token(NULL, out, sizeof(out)));
...
void test_lock_timeout_sweep()
{
    ...
    TEST_ASSERT_TRUE(pc_dav_lock_can_write(&t, "/timed", NULL));
