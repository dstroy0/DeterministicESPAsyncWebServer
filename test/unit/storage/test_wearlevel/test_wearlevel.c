...
{
    TEST_ASSERT_EQUAL_size_t(0, pc_wearlevel_pick(NULL, 4));
    uint32_t c[1] = {3};
...
void test_mark_saturates_and_bounds(void)
{
    ...
    pc_wearlevel_mark(NULL, 2, 0); // null counts: no-op, must not crash
}
...
void test_spread(void)
{
    ...
    TEST_ASSERT_EQUAL_UINT32(0, pc_wearlevel_spread(NULL, 3));
