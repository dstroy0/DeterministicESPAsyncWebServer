...
void test_build_server_hello()
{
    ...
    uint8_t out[128];
    size_t n = pc_tls13_build_server_hello(out, sizeof(out), random, nullptr, 0, pub);
...
void test_tls13_builder_cap_guards()
{
    ...
    TEST_ASSERT_EQUAL_UINT(0, pc_tls13_build_server_hello(out, 10, r32, nullptr, 0, pub)); // w_bytes(random) overruns
    uint8_t thash[32] = {0};
...
void test_tls13_builders_dtls_codepoints()
{
    ...
    size_t n = pc_tls13_build_server_hello(out, sizeof(out), random, nullptr, 0, pub, 32, TLS_GROUP_X25519,
                                           /*dtls=*/true);
    TEST_ASSERT_TRUE(n > 0);
    ...
    n = pc_tls13_build_server_hello(out, sizeof(out), random, nullptr, 0, pub, 32, TLS_GROUP_X25519, /*dtls=*/false);
    TEST_ASSERT_TRUE(n > 0);
    ...
    size_t with_cookie = pc_tls13_build_hello_retry_request(out, sizeof(out), nullptr, 0, TLS_GROUP_X25519, cookie,
    ...
    // codepoints are used.
    size_t no_cookie = pc_tls13_build_hello_retry_request(out, sizeof(out), nullptr, 0, TLS_GROUP_X25519, nullptr, 0,
                                                          /*dtls=*/false);
...
void test_tls13_builder_overflow_guards()
{
    ...
    TEST_ASSERT_EQUAL_UINT(0, pc_tls13_build_hello_retry_request(out, sizeof(out), nullptr, 0, TLS_GROUP_X25519, cookie,
                                                                 0xFFFE, /*dtls=*/false));

    // A HelloRetryRequest that does not fit: sweep every capacity below the needed one.
    size_t need = pc_tls13_build_hello_retry_request(out, sizeof(out), nullptr, 0, TLS_GROUP_X25519, cookie,
                                                     sizeof(cookie), /*dtls=*/true);
    TEST_ASSERT_TRUE(need > 0);
    TEST_ASSERT_EQUAL_UINT(0, pc_tls13_build_hello_retry_request(out, need - 1, nullptr, 0, TLS_GROUP_X25519, cookie,
                                                                 sizeof(cookie), /*dtls=*/true));
...
void test_tls13_build_server_hello_conn_id()
{
    ...
    uint8_t out[128];
    size_t without = pc_tls13_build_server_hello(out, sizeof(out), random, nullptr, 0, pub);
    size_t with = pc_tls13_build_server_hello(out, sizeof(out), random, nullptr, 0, pub, 32, TLS_GROUP_X25519,
