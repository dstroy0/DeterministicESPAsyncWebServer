...
{
    char jb[16];
    TEST_ASSERT_GREATER_THAN(0, (int)pc_senml_json_build(jb, sizeof(jb), nullptr, 0));
...
void test_resolve_edges()
{
    ...
    TEST_ASSERT_EQUAL_size_t(0, pc_senml_resolve(nullptr, 2, res, 2));
    TEST_ASSERT_EQUAL_size_t(0, pc_senml_resolve(rec, 2, nullptr, 2));
