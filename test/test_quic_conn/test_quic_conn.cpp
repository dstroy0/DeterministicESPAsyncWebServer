...
void test_connection_close_api()
{
    ...
    pc_quic_conn_close(&qc, QuicErr::QUIC_ERR_NO_ERROR);
    uint8_t cdg[512];
...
void test_quic_recv_connection_close()
{
    ...
    uint8_t fr[32];
    size_t fl = pc_quic_build_connection_close(fr, sizeof(fr), QuicErr::QUIC_ERR_NO_ERROR, 0, nullptr, 0);
    uint8_t dg[256];
    size_t dl = build_long(dg, sizeof(dg), QuicLongPacket::QUIC_LP_INITIAL, ODCID, sizeof(ODCID), CLIENT_SCID,
...
void test_quic_recv_malformed_initial_headers()
{
    ...
    size_t hn = pc_quic_build_long_header(dg, sizeof dg, QuicLongPacket::QUIC_LP_INITIAL, QUIC_VERSION_1, ODCID,
...
void test_quic_conn_close_after_peer_close()
{
    ...
    pc_quic_conn_close(&qc, QuicErr::QUIC_ERR_FRAME_ENCODING);
...
void test_quic_conn_crypto_flight_fragmented()
{
    ...
    (void)pc_quic_tls_flight(&qc.tls, QuicEnc::QUIC_ENC_HANDSHAKE, &hs_flight_len);
