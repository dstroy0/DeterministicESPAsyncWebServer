...
{
    uint8_t g[PCAP_GLOBAL_HDR_LEN];
    TEST_ASSERT_EQUAL_UINT(PCAP_GLOBAL_HDR_LEN, pcap_global_header(g, sizeof(g)));
    ...
    TEST_ASSERT_EQUAL_UINT(0, pcap_global_header(g, 10)); // too small

    uint8_t r[PCAP_REC_HDR_LEN];
    TEST_ASSERT_EQUAL_UINT(PCAP_REC_HDR_LEN, pcap_record_header(r, sizeof(r), 0x11223344, 0x55667788, 100, 120));
