...
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:01.622 |
| `test_application`       | `native_app`            |    72 |   ✅   | 00:00:01.080 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.574 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.649 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.647 |
| `test_response_headers`  | `native_app`            |    12 |   ✅   | 00:00:00.654 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.628 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.639 |
| `test_regex`             | `native_app`            |    13 |   ✅   | 00:00:00.652 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.648 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.663 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.639 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.670 |
| `test_json`              | `native_app`            |    28 |   ✅   | 00:00:01.720 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.664 |
| `test_multipart`         | `native_app`            |    25 |   ✅   | 00:00:00.680 |
| `test_chunked`           | `native_app`            |    14 |   ✅   | 00:00:00.668 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.637 |
| `test_webdav_handler`    | `native_webdav_handler` |    29 |   ✅   | 00:00:01.649 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.543 |
...
| `test_keepalive`         | `native_keepalive`      |    11 |   ✅   | 00:00:01.495 |
| `test_range`             | `native_range`          |    20 |   ✅   | 00:00:01.602 |
...
| `test_upload`            | `native_upload`         |     8 |   ✅   | 00:00:01.530 |
...
| `test_h3_server`         | `native_h3_server`      |     1 |   ✅   | 00:00:02.008 |
