...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:10.410 |
| `test_cia402`            | `native_cia402`         |    15 |   ✅   | 00:00:00.836 |
| `test_control`           | `native_control`        |    17 |   ✅   | 00:00:00.790 |
| `test_dbm`               | `native_dbm`            |    13 |   ✅   | 00:00:00.895 |
| `test_docstore`          | `native_docstore`       |     7 |   ✅   | 00:00:00.960 |
| `test_dnc`               | `native_dnc`            |    14 |   ✅   | 00:00:00.826 |
| `test_dnc_stream`        | `native_dnc`            |     8 |   ✅   | 00:00:00.664 |
| `test_ftp`               | `native_ftp`            |    21 |   ✅   | 00:00:00.800 |
| `test_httpcache`         | `native_httpcache`      |    15 |   ✅   | 00:00:00.816 |
| `test_edge_cache`        | `native_edge_cache`     |    27 |   ✅   | 00:00:01.024 |
| `test_edge_fetch`        | `native_edge_cache`     |     7 |   ✅   | 00:00:00.658 |
| `test_edge_cache_sd`     | `native_edge_cache_sd`  |    15 |   ✅   | 00:00:01.090 |
| `test_edge_mesh`         | `native_edge_mesh`      |    14 |   ✅   | 00:00:00.997 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.773 |
| `test_det_ip`            | `native_det_ip`         |    11 |   ✅   | 00:00:00.775 |
| `test_det_arena`         | `native_det_arena`      |    19 |   ✅   | 00:00:00.764 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    19 |   ✅   | 00:00:05.130 |
| `test_crypto_kat`        | `native_crypto_kat`     |     9 |   ✅   | 00:00:02.739 |
| `test_promisc`           | `native_promisc`        |     9 |   ✅   | 00:00:00.767 |
| `test_bus_capture`       | `native_bus_capture`    |     7 |   ✅   | 00:00:00.797 |
| `test_j1939`             | `native_j1939`          |    11 |   ✅   | 00:00:00.791 |
| `test_devicenet`         | `native_devicenet`      |    11 |   ✅   | 00:00:00.809 |
| `test_nmea2000`          | `native_nmea2000`       |     7 |   ✅   | 00:00:00.819 |
| `test_mbus`              | `native_mbus`           |    12 |   ✅   | 00:00:00.807 |
| `test_iec60870`          | `native_iec60870`       |    13 |   ✅   | 00:00:00.794 |
| `test_sdi12`             | `native_sdi12`          |     7 |   ✅   | 00:00:00.796 |
| `test_dmx`               | `native_dmx`            |     6 |   ✅   | 00:00:00.767 |
| `test_nmea0183`          | `native_nmea0183`       |     8 |   ✅   | 00:00:00.797 |
| `test_iolink`            | `native_iolink`         |     6 |   ✅   | 00:00:00.800 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:01.383 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.767 |
| `test_transport`         | `native`                |    45 |   ✅   | 00:00:00.781 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.732 |
| `test_websocket`         | `native`                |    69 |   ✅   | 00:00:00.841 |
| `test_sse`               | `native`                |    46 |   ✅   | 00:00:00.753 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.960 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:01.373 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.833 |
| `test_provisioning`      | `native_prov`           |     7 |   ✅   | 00:00:00.815 |
| `test_ssh_channel`       | `native_ssh`            |    40 |   ✅   | 00:00:01.520 |
| `test_ssh_auth`          | `native_ssh`            |    21 |   ✅   | 00:00:03.764 |
| `test_ssh_crypto`        | `native_ssh`            |    58 |   ✅   | 00:00:06.471 |
| `test_ssh_transport`     | `native_ssh`            |    47 |   ✅   | 00:00:03.511 |
| `test_ssh_server`        | `native_ssh`            |    27 |   ✅   | 00:00:01.142 |
| `test_ssh_pqc`           | `native_ssh_pqc`        |     4 |   ✅   | 00:00:01.613 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.453 |
| `test_ssh_conn`          | `native_ssh_conn`       |    16 |   ✅   | 00:00:02.352 |
| `test_ssh_sftp`          | `native_ssh_sftp`       |    14 |   ✅   | 00:00:00.819 |
| `test_scp`               | `native_scp`            |     6 |   ✅   | 00:00:00.823 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:01.903 |
| `test_application`       | `native_app`            |    72 |   ✅   | 00:00:00.968 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.687 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.793 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.783 |
| `test_response_headers`  | `native_app`            |    12 |   ✅   | 00:00:00.800 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.739 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.768 |
| `test_regex`             | `native_app`            |    13 |   ✅   | 00:00:00.779 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.778 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.811 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.769 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.769 |
| `test_json`              | `native_app`            |    28 |   ✅   | 00:00:00.702 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.743 |
| `test_multipart`         | `native_app`            |    25 |   ✅   | 00:00:00.785 |
| `test_chunked`           | `native_app`            |    14 |   ✅   | 00:00:00.804 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.766 |
| `test_webdav_handler`    | `native_webdav_handler` |    29 |   ✅   | 00:00:02.067 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.899 |
| `test_snmp_ber`          | `native_snmp`           |    21 |   ✅   | 00:00:00.898 |
| `test_snmp_agent`        | `native_snmp`           |    28 |   ✅   | 00:00:00.732 |
| `test_snmp_v3`           | `native_snmp_v3`        |    22 |   ✅   | 00:00:02.997 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.979 |
| `test_coap`              | `native_coap`           |    44 |   ✅   | 00:00:00.983 |
| `test_coap`              | `native_coap_observe`   |    46 |   ✅   | 00:00:01.004 |
| `test_webdav`            | `native_webdav`         |    25 |   ✅   | 00:00:00.828 |
| `test_modbus`            | `native_modbus`         |    23 |   ✅   | 00:00:00.773 |
| `test_cloudevents`       | `native_cloudevents`    |     8 |   ✅   | 00:00:00.970 |
| `test_redis_resp`        | `native_redis`          |    14 |   ✅   | 00:00:00.811 |
| `test_sqlite`            | `native_sqlite`         |    23 |   ✅   | 00:00:00.846 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.796 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.828 |
| `test_flow_export`       | `native_flow_export`    |     8 |   ✅   | 00:00:00.802 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.826 |
| `test_preempt_queue`     | `native_preempt_queue`  |    12 |   ✅   | 00:00:00.874 |
| `test_dma`               | `native_dma`            |    12 |   ✅   | 00:00:00.971 |
| `test_forward`           | `native_forward`        |    26 |   ✅   | 00:00:01.099 |
| `test_gateway`           | `native_gateway`        |    12 |   ✅   | 00:00:00.951 |
| `test_lora`              | `native_lora`           |    14 |   ✅   | 00:00:00.772 |
| `test_nrf24`             | `native_nrf24`          |    11 |   ✅   | 00:00:00.774 |
| `test_enocean`           | `native_enocean`        |    10 |   ✅   | 00:00:00.760 |
...
| `test_wamp`              | `native_wamp`           |    15 |   ✅   | 00:00:00.831 |
| `test_sunspec`           | `native_sunspec`        |     7 |   ✅   | 00:00:00.765 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.773 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.762 |
| `test_grpcweb`           | `native_grpcweb`        |     9 |   ✅   | 00:00:00.781 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    14 |   ✅   | 00:00:00.801 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.781 |
| `test_hostlink`          | `native_hostlink`       |     8 |   ✅   | 00:00:00.772 |
| `test_scpi`              | `native_scpi`           |    24 |   ✅   | 00:00:00.821 |
| `test_hislip`            | `native_hislip`         |    11 |   ✅   | 00:00:00.801 |
| `test_vxi11`             | `native_vxi11`          |    10 |   ✅   | 00:00:00.793 |
| `test_gpib`              | `native_gpib`           |    10 |   ✅   | 00:00:00.778 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.876 |
| `test_df1`               | `native_df1`            |    10 |   ✅   | 00:00:00.785 |
| `test_cotp`              | `native_cotp`           |     7 |   ✅   | 00:00:00.793 |
| `test_s7comm`            | `native_s7comm`         |     9 |   ✅   | 00:00:00.770 |
| `test_melsec`            | `native_melsec`         |     7 |   ✅   | 00:00:00.770 |
| `test_ads`               | `native_ads`            |    17 |   ✅   | 00:00:00.810 |
| `test_focas`             | `native_focas`          |    11 |   ✅   | 00:00:00.802 |
| `test_pqc_sha3`          | `native_pqc`            |     4 |   ✅   | 00:00:00.815 |
| `test_pqc_mlkem`         | `native_pqc`            |     3 |   ✅   | 00:00:00.603 |
| `test_iface_bridge`      | `native_iface_bridge`   |     7 |   ✅   | 00:00:00.826 |
| `test_rtcm3`             | `native_rtcm3`          |    11 |   ✅   | 00:00:00.769 |
| `test_gnss_survey`       | `native_gnss_survey`    |    22 |   ✅   | 00:00:00.847 |
| `test_ntrip_caster`      | `native_ntrip_caster`   |    14 |   ✅   | 00:00:00.778 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.765 |
| `test_enip`              | `native_enip`           |     7 |   ✅   | 00:00:00.763 |
| `test_amqp`              | `native_amqp`           |     8 |   ✅   | 00:00:00.802 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.769 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.797 |
| `test_proxy_protocol`    | `native_proxy_protocol` |    10 |   ✅   | 00:00:00.778 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.820 |
| `test_modbus_master`     | `native_modbus_master`  |    12 |   ✅   | 00:00:00.827 |
| `test_ota_rollback`      | `native_ota_rollback`   |     6 |   ✅   | 00:00:00.772 |
| `test_totp`              | `native_totp`           |     5 |   ✅   | 00:00:00.836 |
| `test_webhook`           | `native_webhook`        |     9 |   ✅   | 00:00:00.786 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.803 |
| `test_dns_resolver`      | `native_dns_resolver`   |     5 |   ✅   | 00:00:00.801 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.849 |
| `test_oidc`              | `native_oidc`           |    19 |   ✅   | 00:00:14.274 |
| `test_vfs`               | `native_vfs`            |    12 |   ✅   | 00:00:00.799 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.801 |
| `test_espnow`            | `native_espnow`         |     8 |   ✅   | 00:00:00.796 |
| `test_oauth2`            | `native_oauth2`         |     9 |   ✅   | 00:00:00.842 |
| `test_opcua`             | `native_opcua`          |    47 |   ✅   | 00:00:01.009 |
| `test_opcua_client`      | `native_opcua_client`   |    20 |   ✅   | 00:00:00.939 |
| `test_umati`             | `native_umati`          |    11 |   ✅   | 00:00:00.839 |
| `test_keepalive`         | `native_keepalive`      |    11 |   ✅   | 00:00:01.853 |
| `test_range`             | `native_range`          |    20 |   ✅   | 00:00:01.882 |
...
| `test_ntlm`              | `native_smb`            |     8 |   ✅   | 00:00:00.621 |
| `test_ntlmssp`           | `native_smb`            |     5 |   ✅   | 00:00:00.611 |
| `test_smb2`              | `native_smb`            |    19 |   ✅   | 00:00:00.690 |
| `test_smtp`              | `native_smtp`           |    22 |   ✅   | 00:00:01.038 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.770 |
| `test_dns_server`        | `native_dns_server`     |    13 |   ✅   | 00:00:00.799 |
| `test_rtc`               | `native_rtc`            |     9 |   ✅   | 00:00:00.782 |
| `test_relay`             | `native_relay`          |     6 |   ✅   | 00:00:00.812 |
| `test_ld2410`            | `native_ld2410`         |     8 |   ✅   | 00:00:00.834 |
| `test_sen0192`           | `native_sen0192`        |     5 |   ✅   | 00:00:00.810 |
| `test_mpr121`            | `native_mpr121`         |     6 |   ✅   | 00:00:00.784 |
| `test_sht3x`             | `native_sht3x`          |     6 |   ✅   | 00:00:00.802 |
| `test_pca9685`           | `native_pca9685`        |     5 |   ✅   | 00:00:00.772 |
| `test_ads1115`           | `native_ads1115`        |     5 |   ✅   | 00:00:00.797 |
| `test_ina219`            | `native_ina219`         |     5 |   ✅   | 00:00:00.773 |
| `test_hpack`             | `native_hpack`          |    15 |   ✅   | 00:00:00.950 |
| `test_h2_frame`          | `native_h2frame`        |     7 |   ✅   | 00:00:00.791 |
| `test_h2_conn`           | `native_h2conn`         |    22 |   ✅   | 00:00:01.194 |
...
| `test_upload`            | `native_upload`         |     8 |   ✅   | 00:00:01.865 |
...
| `test_ws_client`         | `native_ws_client`      |    17 |   ✅   | 00:00:00.840 |
| `test_scratch`           | `native_scratch`        |    15 |   ✅   | 00:00:00.822 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.819 |
| `test_inflate`           | `native_inflate`        |    14 |   ✅   | 00:00:00.785 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.836 |
| `test_ssh_zlib`          | `native_ssh_zlib`       |     9 |   ✅   | 00:00:00.869 |
| `test_ssh_comp`          | `native_ssh_comp`       |     8 |   ✅   | 00:00:01.526 |
| `test_websocket`         | `native_ws_deflate`     |    74 |   ✅   | 00:00:01.413 |
| `test_time_source`       | `native_time_source`    |    10 |   ✅   | 00:00:00.767 |
| `test_config_store`      | `native_config_store`   |    15 |   ✅   | 00:00:00.775 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.817 |
| `test_auth_lockout`      | `native_auth_lockout`   |    12 |   ✅   | 00:00:00.824 |
| `test_csrf`              | `native_csrf`           |    10 |   ✅   | 00:00:00.847 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.833 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.815 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.789 |
| `test_partition_monitor` | `native_partition`      |     6 |   ✅   | 00:00:00.804 |
| `test_cbor`              | `native_cbor`           |    21 |   ✅   | 00:00:00.815 |
| `test_msgpack`           | `native_msgpack`        |    23 |   ✅   | 00:00:00.836 |
| `test_gpio_map`          | `native_gpio_map`       |     9 |   ✅   | 00:00:00.812 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     8 |   ✅   | 00:00:00.809 |
| `test_statsd`            | `native_statsd`         |    10 |   ✅   | 00:00:00.851 |
| `test_guardrails`        | `native_guardrails`     |     9 |   ✅   | 00:00:00.786 |
| `test_failsafe`          | `native_failsafe`       |     7 |   ✅   | 00:00:00.823 |
| `test_sleep_sched`       | `native_sleep_sched`    |     8 |   ✅   | 00:00:00.814 |
| `test_wearlevel`         | `native_wearlevel`      |     5 |   ✅   | 00:00:00.807 |
| `test_netadapt`          | `native_netadapt`       |     6 |   ✅   | 00:00:00.794 |
| `test_dshot`             | `native_dshot`          |     8 |   ✅   | 00:00:00.799 |
| `test_hart`              | `native_hart`           |     7 |   ✅   | 00:00:00.792 |
| `test_nts`               | `native_nts`            |     5 |   ✅   | 00:00:00.805 |
| `test_dds`               | `native_dds`            |     5 |   ✅   | 00:00:00.805 |
| `test_xmpp`              | `native_xmpp`           |    11 |   ✅   | 00:00:00.820 |
| `test_rawl2`             | `native_rawl2`          |     5 |   ✅   | 00:00:00.812 |
| `test_spa_router`        | `native_spa_router`     |     2 |   ✅   | 00:00:00.795 |
| `test_goose`             | `native_goose`          |     4 |   ✅   | 00:00:00.812 |
| `test_mtconnect`         | `native_mtconnect`      |    12 |   ✅   | 00:00:00.828 |
| `test_wal`               | `native_wal`            |     6 |   ✅   | 00:00:00.840 |
| `test_wal_store`         | `native_wal`            |    29 |   ✅   | 00:00:00.694 |
| `test_j2735`             | `native_j2735`          |    11 |   ✅   | 00:00:00.811 |
| `test_nema_ts2`          | `native_nema_ts2`       |     4 |   ✅   | 00:00:00.816 |
| `test_snp`               | `native_snp`            |     5 |   ✅   | 00:00:00.796 |
| `test_directnet`         | `native_directnet`      |     5 |   ✅   | 00:00:00.813 |
| `test_sep2`              | `native_sep2`           |     5 |   ✅   | 00:00:00.814 |
| `test_profinet`          | `native_profinet`       |     5 |   ✅   | 00:00:00.803 |
| `test_ntcip`             | `native_ntcip`          |     3 |   ✅   | 00:00:00.792 |
| `test_openadr`           | `native_openadr`        |     5 |   ✅   | 00:00:00.819 |
| `test_mms`               | `native_mms`            |    11 |   ✅   | 00:00:00.812 |
| `test_cclink`            | `native_cclink`         |     5 |   ✅   | 00:00:00.804 |
| `test_powerlink`         | `native_powerlink`      |     4 |   ✅   | 00:00:00.803 |
| `test_sercos`            | `native_sercos`         |     4 |   ✅   | 00:00:00.809 |
| `test_profibus`          | `native_profibus`       |     5 |   ✅   | 00:00:00.797 |
| `test_lonworks`          | `native_lonworks`       |     5 |   ✅   | 00:00:00.792 |
| `test_mbplus`            | `native_mbplus`         |     6 |   ✅   | 00:00:00.812 |
| `test_interbus`          | `native_interbus`       |     5 |   ✅   | 00:00:00.817 |
| `test_iccp`              | `native_iccp`           |     5 |   ✅   | 00:00:00.798 |
| `test_wave`              | `native_wave`           |     9 |   ✅   | 00:00:00.831 |
| `test_utmc`              | `native_utmc`           |     6 |   ✅   | 00:00:00.814 |
| `test_ocit`              | `native_ocit`           |     4 |   ✅   | 00:00:00.792 |
| `test_atc`               | `native_atc`            |     5 |   ✅   | 00:00:00.811 |
| `test_southbound`        | `native_southbound`     |     6 |   ✅   | 00:00:00.806 |
| `test_exc_decoder`       | `native_exc_decoder`    |     7 |   ✅   | 00:00:00.808 |
| `test_http_delivery`     | `native_http_delivery`  |     8 |   ✅   | 00:00:00.820 |
| `test_hw_health`         | `native_hw_health`      |     7 |   ✅   | 00:00:00.827 |
| `test_mdns_adaptive`     | `native_mdns_adaptive`  |     5 |   ✅   | 00:00:00.794 |
| `test_sockpool`          | `native_sockpool`       |     6 |   ✅   | 00:00:00.790 |
| `test_psram_pool`        | `native_psram_pool`     |     5 |   ✅   | 00:00:00.803 |
| `test_happy_eyeballs`    | `native_happy_eyeballs` |     5 |   ✅   | 00:00:00.831 |
| `test_wifi_sniffer`      | `native_wifi_sniffer`   |     6 |   ✅   | 00:00:00.797 |
| `test_link_manager`      | `native_link_manager`   |     7 |   ✅   | 00:00:00.803 |
| `test_cc1101`            | `native_cc1101`         |    18 |   ✅   | 00:00:00.804 |
| `test_fdc2214`           | `native_fdc2214`        |     4 |   ✅   | 00:00:00.804 |
| `test_ldc1614`           | `native_ldc1614`        |     4 |   ✅   | 00:00:00.819 |
| `test_vl53l0x`           | `native_vl53l0x`        |     3 |   ✅   | 00:00:00.787 |
| `test_radio_sniff`       | `native_radio_sniff`    |     4 |   ✅   | 00:00:00.795 |
| `test_ble_gatt`          | `native_ble_gatt`       |     7 |   ✅   | 00:00:00.816 |
| `test_tls_policy`        | `native_tls_policy`     |     4 |   ✅   | 00:00:00.800 |
| `test_wisun`             | `native_wisun`          |    10 |   ✅   | 00:00:00.862 |
| `test_logbuf`            | `native_logbuf`         |     5 |   ✅   | 00:00:00.809 |
| `test_config_io`         | `native_config_io`      |     5 |   ✅   | 00:00:00.859 |
| `test_workers`           | `native_workers`        |     6 |   ✅   | 00:00:00.972 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.773 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.978 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.412 |
| `test_qpack`             | `native_qpack`          |    11 |   ✅   | 00:00:00.974 |
| `test_quic_packet`       | `native_quic_packet`    |     8 |   ✅   | 00:00:00.810 |
| `test_quic_frame`        | `native_quic_frame`     |    11 |   ✅   | 00:00:00.828 |
| `test_quic_crypto`       | `native_quic_crypto`    |    13 |   ✅   | 00:00:00.968 |
| `test_dtls_record`       | `native_dtls`           |    16 |   ✅   | 00:00:00.971 |
| `test_dtls_handshake`    | `native_dtls_hs`        |    15 |   ✅   | 00:00:00.875 |
| `test_dtls_tls13`        | `native_dtls_tls13`     |     6 |   ✅   | 00:00:00.930 |
| `test_dtls_conn`         | `native_dtls_conn`      |     8 |   ✅   | 00:00:01.441 |
| `test_coaps`             | `native_coaps`          |     6 |   ✅   | 00:00:01.433 |
| `test_coaps_server`      | `native_coaps_server`   |    15 |   ✅   | 00:00:01.620 |
| `test_tls13_kdf`         | `native_tls13_kdf`      |     6 |   ✅   | 00:00:00.903 |
| `test_quic_tp`           | `native_quic_tp`        |     8 |   ✅   | 00:00:00.840 |
| `test_tls13_msg`         | `native_tls13_msg`      |    11 |   ✅   | 00:00:00.979 |
| `test_quic_tls`          | `native_quic_tls`       |    13 |   ✅   | 00:00:01.379 |
| `test_quic_tls`          | `native_quic_tls_pqc`   |    14 |   ✅   | 00:00:01.494 |
| `test_quic_conn`         | `native_quic_conn`      |    27 |   ✅   | 00:00:02.563 |
| `test_h3_conn`           | `native_h3_conn`        |    11 |   ✅   | 00:00:01.350 |
| `test_h3_e2e`            | `native_h3_e2e`         |     1 |   ✅   | 00:00:01.364 |
| `test_quic_server`       | `native_quic_server`    |     4 |   ✅   | 00:00:01.439 |
| `test_h3_server`         | `native_h3_server`      |     1 |   ✅   | 00:00:02.566 |
