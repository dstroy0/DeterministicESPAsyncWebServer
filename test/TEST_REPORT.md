...
**Generated:** 2026-07-14 16:01:25
**Command:** `pio test` over 225 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 3153 passed - 668s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:03.331 |
| `test_cia402`            | `native_cia402`         |     9 |   ✅   | 00:00:00.792 |
| `test_control`           | `native_control`        |    12 |   ✅   | 00:00:00.761 |
| `test_dbm`               | `native_dbm`            |    13 |   ✅   | 00:00:00.838 |
| `test_docstore`          | `native_docstore`       |     5 |   ✅   | 00:00:00.907 |
| `test_dnc`               | `native_dnc`            |    14 |   ✅   | 00:00:00.796 |
| `test_dnc_stream`        | `native_dnc`            |     8 |   ✅   | 00:00:00.593 |
| `test_ftp`               | `native_ftp`            |    21 |   ✅   | 00:00:00.787 |
| `test_httpcache`         | `native_httpcache`      |    15 |   ✅   | 00:00:00.797 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.745 |
| `test_det_ip`            | `native_det_ip`         |    11 |   ✅   | 00:00:00.768 |
| `test_det_arena`         | `native_det_arena`      |    19 |   ✅   | 00:00:00.768 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    17 |   ✅   | 00:00:03.996 |
| `test_crypto_kat`        | `native_crypto_kat`     |     9 |   ✅   | 00:00:02.355 |
...
| `test_devicenet`         | `native_devicenet`      |    11 |   ✅   | 00:00:00.768 |
| `test_nmea2000`          | `native_nmea2000`       |     7 |   ✅   | 00:00:00.784 |
| `test_mbus`              | `native_mbus`           |    12 |   ✅   | 00:00:00.751 |
| `test_iec60870`          | `native_iec60870`       |    13 |   ✅   | 00:00:00.770 |
| `test_sdi12`             | `native_sdi12`          |     7 |   ✅   | 00:00:00.772 |
| `test_dmx`               | `native_dmx`            |     6 |   ✅   | 00:00:00.767 |
| `test_nmea0183`          | `native_nmea0183`       |     8 |   ✅   | 00:00:00.771 |
| `test_iolink`            | `native_iolink`         |     6 |   ✅   | 00:00:00.760 |
| `test_sse`               | `native`                |    46 |   ✅   | 00:00:01.298 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.686 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.743 |
| `test_transport`         | `native`                |    45 |   ✅   | 00:00:00.726 |
| `test_websocket`         | `native`                |    69 |   ✅   | 00:00:00.774 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.718 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.920 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:01.317 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.822 |
| `test_provisioning`      | `native_prov`           |     7 |   ✅   | 00:00:00.788 |
| `test_ssh_crypto`        | `native_ssh`            |    53 |   ✅   | 00:00:04.287 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.747 |
| `test_ssh_server`        | `native_ssh`            |    27 |   ✅   | 00:00:01.111 |
| `test_ssh_transport`     | `native_ssh`            |    37 |   ✅   | 00:00:01.717 |
| `test_ssh_channel`       | `native_ssh`            |    37 |   ✅   | 00:00:00.719 |
| `test_ssh_pqc`           | `native_ssh_pqc`        |     4 |   ✅   | 00:00:01.375 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.263 |
| `test_ssh_conn`          | `native_ssh_conn`       |    16 |   ✅   | 00:00:02.185 |
| `test_regex`             | `native_app`            |    13 |   ✅   | 00:00:01.791 |
...
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.706 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.714 |
| `test_json`              | `native_app`            |    28 |   ✅   | 00:00:00.681 |
| `test_response_headers`  | `native_app`            |    12 |   ✅   | 00:00:00.722 |
...
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.724 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.747 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.710 |
| `test_chunked`           | `native_app`            |    14 |   ✅   | 00:00:00.733 |
| `test_application`       | `native_app`            |    72 |   ✅   | 00:00:00.906 |
| `test_webdav_handler`    | `native_webdav_handler` |    29 |   ✅   | 00:00:01.887 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.791 |
| `test_snmp_ber`          | `native_snmp`           |    21 |   ✅   | 00:00:00.828 |
| `test_snmp_agent`        | `native_snmp`           |    28 |   ✅   | 00:00:00.653 |
| `test_snmp_v3`           | `native_snmp_v3`        |    22 |   ✅   | 00:00:03.094 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.947 |
| `test_coap`              | `native_coap`           |    44 |   ✅   | 00:00:00.904 |
| `test_coap`              | `native_coap_observe`   |    46 |   ✅   | 00:00:00.927 |
...
| `test_redis_resp`        | `native_redis`          |    14 |   ✅   | 00:00:00.766 |
| `test_sqlite`            | `native_sqlite`         |    23 |   ✅   | 00:00:00.781 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.765 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.759 |
| `test_flow_export`       | `native_flow_export`    |     8 |   ✅   | 00:00:00.759 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.763 |
| `test_preempt_queue`     | `native_preempt_queue`  |    12 |   ✅   | 00:00:00.795 |
| `test_dma`               | `native_dma`            |    12 |   ✅   | 00:00:00.888 |
| `test_forward`           | `native_forward`        |    26 |   ✅   | 00:00:01.008 |
| `test_gateway`           | `native_gateway`        |    12 |   ✅   | 00:00:00.916 |
| `test_lora`              | `native_lora`           |    14 |   ✅   | 00:00:00.748 |
...
| `test_zigbee`            | `native_zigbee`         |    10 |   ✅   | 00:00:00.762 |
| `test_thread`            | `native_thread`         |    15 |   ✅   | 00:00:00.753 |
| `test_wamp`              | `native_wamp`           |    15 |   ✅   | 00:00:00.794 |
| `test_sunspec`           | `native_sunspec`        |     7 |   ✅   | 00:00:00.755 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.754 |
...
| `test_hostlink`          | `native_hostlink`       |     8 |   ✅   | 00:00:00.754 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.849 |
| `test_df1`               | `native_df1`            |    10 |   ✅   | 00:00:00.752 |
| `test_cotp`              | `native_cotp`           |     7 |   ✅   | 00:00:00.760 |
| `test_s7comm`            | `native_s7comm`         |     9 |   ✅   | 00:00:00.751 |
| `test_melsec`            | `native_melsec`         |     7 |   ✅   | 00:00:00.755 |
| `test_ads`               | `native_ads`            |    11 |   ✅   | 00:00:00.756 |
| `test_focas`             | `native_focas`          |    11 |   ✅   | 00:00:00.763 |
| `test_pqc_mlkem`         | `native_pqc`            |     3 |   ✅   | 00:00:00.787 |
| `test_pqc_sha3`          | `native_pqc`            |     4 |   ✅   | 00:00:00.574 |
| `test_iface_bridge`      | `native_iface_bridge`   |     7 |   ✅   | 00:00:00.780 |
| `test_rtcm3`             | `native_rtcm3`          |    11 |   ✅   | 00:00:00.759 |
| `test_gnss_survey`       | `native_gnss_survey`    |     9 |   ✅   | 00:00:00.824 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.744 |
| `test_enip`              | `native_enip`           |     7 |   ✅   | 00:00:00.750 |
| `test_amqp`              | `native_amqp`           |     8 |   ✅   | 00:00:00.754 |
...
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.801 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.784 |
| `test_ota_rollback`      | `native_ota_rollback`   |     6 |   ✅   | 00:00:00.726 |
| `test_totp`              | `native_totp`           |     5 |   ✅   | 00:00:00.784 |
| `test_webhook`           | `native_webhook`        |     9 |   ✅   | 00:00:00.741 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.722 |
| `test_dns_resolver`      | `native_dns_resolver`   |     5 |   ✅   | 00:00:00.748 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.809 |
| `test_oidc`              | `native_oidc`           |    19 |   ✅   | 00:00:13.780 |
| `test_vfs`               | `native_vfs`            |    12 |   ✅   | 00:00:00.756 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.768 |
| `test_espnow`            | `native_espnow`         |     8 |   ✅   | 00:00:00.757 |
| `test_oauth2`            | `native_oauth2`         |     9 |   ✅   | 00:00:00.804 |
| `test_opcua`             | `native_opcua`          |    47 |   ✅   | 00:00:00.917 |
| `test_opcua_client`      | `native_opcua_client`   |    20 |   ✅   | 00:00:00.844 |
| `test_umati`             | `native_umati`          |    11 |   ✅   | 00:00:00.830 |
| `test_keepalive`         | `native_keepalive`      |    11 |   ✅   | 00:00:01.724 |
| `test_range`             | `native_range`          |    20 |   ✅   | 00:00:01.699 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.789 |
| `test_ntlm`              | `native_smb`            |     3 |   ✅   | 00:00:00.913 |
| `test_smb_client`        | `native_smb`            |    10 |   ✅   | 00:00:00.616 |
| `test_ntlmssp`           | `native_smb`            |     5 |   ✅   | 00:00:00.591 |
| `test_smb_crypto`        | `native_smb`            |     5 |   ✅   | 00:00:00.574 |
| `test_smb2`              | `native_smb`            |    19 |   ✅   | 00:00:00.657 |
| `test_spnego`            | `native_smb`            |     4 |   ✅   | 00:00:00.577 |
| `test_smtp`              | `native_smtp`           |    22 |   ✅   | 00:00:00.969 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.753 |
| `test_dns_server`        | `native_dns_server`     |    13 |   ✅   | 00:00:00.762 |
| `test_rtc`               | `native_rtc`            |     9 |   ✅   | 00:00:00.752 |
| `test_relay`             | `native_relay`          |     6 |   ✅   | 00:00:00.758 |
| `test_ld2410`            | `native_ld2410`         |     8 |   ✅   | 00:00:00.761 |
| `test_mpr121`            | `native_mpr121`         |     6 |   ✅   | 00:00:00.754 |
| `test_sht3x`             | `native_sht3x`          |     6 |   ✅   | 00:00:00.754 |
| `test_pca9685`           | `native_pca9685`        |     5 |   ✅   | 00:00:00.752 |
| `test_ads1115`           | `native_ads1115`        |     5 |   ✅   | 00:00:00.757 |
| `test_ina219`            | `native_ina219`         |     5 |   ✅   | 00:00:00.744 |
| `test_hpack`             | `native_hpack`          |    15 |   ✅   | 00:00:00.895 |
| `test_h2_frame`          | `native_h2frame`        |     7 |   ✅   | 00:00:00.757 |
| `test_h2_conn`           | `native_h2conn`         |    22 |   ✅   | 00:00:01.123 |
| `test_quic_varint`       | `native_quic_varint`    |     3 |   ✅   | 00:00:00.749 |
| `test_h3_frame`          | `native_h3frame`        |     7 |   ✅   | 00:00:00.775 |
| `test_jwt`               | `native_jwt`            |    22 |   ✅   | 00:00:00.850 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.756 |
...
| `test_ws_client`         | `native_ws_client`      |    17 |   ✅   | 00:00:00.829 |
| `test_scratch`           | `native_scratch`        |    15 |   ✅   | 00:00:00.819 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.796 |
...
| `test_ssh_comp`          | `native_ssh_comp`       |     6 |   ✅   | 00:00:01.426 |
| `test_websocket`         | `native_ws_deflate`     |    74 |   ✅   | 00:00:01.393 |
| `test_time_source`       | `native_time_source`    |    10 |   ✅   | 00:00:00.768 |
| `test_config_store`      | `native_config_store`   |    15 |   ✅   | 00:00:00.789 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.817 |
| `test_auth_lockout`      | `native_auth_lockout`   |    12 |   ✅   | 00:00:00.824 |
| `test_csrf`              | `native_csrf`           |    10 |   ✅   | 00:00:00.848 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.816 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.799 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.772 |
| `test_partition_monitor` | `native_partition`      |     6 |   ✅   | 00:00:00.783 |
| `test_cbor`              | `native_cbor`           |    21 |   ✅   | 00:00:00.807 |
| `test_msgpack`           | `native_msgpack`        |    23 |   ✅   | 00:00:00.792 |
...
| `test_failsafe`          | `native_failsafe`       |     7 |   ✅   | 00:00:00.803 |
| `test_sleep_sched`       | `native_sleep_sched`    |     8 |   ✅   | 00:00:00.772 |
...
| `test_mtconnect`         | `native_mtconnect`      |    12 |   ✅   | 00:00:00.789 |
| `test_wal`               | `native_wal`            |     6 |   ✅   | 00:00:00.805 |
| `test_wal_store`         | `native_wal`            |     7 |   ✅   | 00:00:00.617 |
| `test_j2735`             | `native_j2735`          |    11 |   ✅   | 00:00:00.776 |
| `test_nema_ts2`          | `native_nema_ts2`       |     4 |   ✅   | 00:00:00.771 |
| `test_snp`               | `native_snp`            |     5 |   ✅   | 00:00:00.759 |
| `test_directnet`         | `native_directnet`      |     5 |   ✅   | 00:00:00.766 |
| `test_sep2`              | `native_sep2`           |     5 |   ✅   | 00:00:00.787 |
| `test_profinet`          | `native_profinet`       |     5 |   ✅   | 00:00:00.769 |
| `test_ntcip`             | `native_ntcip`          |     3 |   ✅   | 00:00:00.760 |
| `test_openadr`           | `native_openadr`        |     5 |   ✅   | 00:00:00.764 |
...
| `test_sercos`            | `native_sercos`         |     4 |   ✅   | 00:00:00.778 |
| `test_profibus`          | `native_profibus`       |     5 |   ✅   | 00:00:00.762 |
...
| `test_wave`              | `native_wave`           |     9 |   ✅   | 00:00:00.786 |
...
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.717 |
| `test_qpack`             | `native_qpack`          |    11 |   ✅   | 00:00:00.888 |
| `test_quic_packet`       | `native_quic_packet`    |     8 |   ✅   | 00:00:00.769 |
| `test_quic_frame`        | `native_quic_frame`     |     9 |   ✅   | 00:00:00.790 |
| `test_quic_crypto`       | `native_quic_crypto`    |     7 |   ✅   | 00:00:00.901 |
| `test_tls13_kdf`         | `native_tls13_kdf`      |     5 |   ✅   | 00:00:00.822 |
| `test_quic_tp`           | `native_quic_tp`        |     8 |   ✅   | 00:00:00.780 |
| `test_tls13_msg`         | `native_tls13_msg`      |    11 |   ✅   | 00:00:00.887 |
| `test_quic_tls`          | `native_quic_tls`       |    13 |   ✅   | 00:00:01.251 |
| `test_quic_tls`          | `native_quic_tls_pqc`   |    14 |   ✅   | 00:00:01.337 |
| `test_quic_conn`         | `native_quic_conn`      |    27 |   ✅   | 00:00:02.144 |
| `test_h3_conn`           | `native_h3_conn`        |    11 |   ✅   | 00:00:01.217 |
| `test_h3_e2e`            | `native_h3_e2e`         |     1 |   ✅   | 00:00:01.258 |
| `test_quic_server`       | `native_quic_server`    |     4 |   ✅   | 00:00:01.342 |
| `test_h3_server`         | `native_h3_server`      |     1 |   ✅   | 00:00:02.318 |
| `test_ssh_chachapoly`    | `native_ssh_chachapoly` |     4 |   ✅   | 00:00:00.808 |
