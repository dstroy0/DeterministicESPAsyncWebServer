...
**Generated:** 2026-07-14 19:44:09
**Command:** `pio test` over 228 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 3181 passed - 754s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:03.539 |
| `test_cia402`            | `native_cia402`         |     9 |   ✅   | 00:00:00.793 |
| `test_control`           | `native_control`        |    12 |   ✅   | 00:00:00.741 |
| `test_dbm`               | `native_dbm`            |    13 |   ✅   | 00:00:00.813 |
| `test_docstore`          | `native_docstore`       |     5 |   ✅   | 00:00:00.893 |
| `test_dnc`               | `native_dnc`            |    14 |   ✅   | 00:00:00.769 |
| `test_dnc_stream`        | `native_dnc`            |     8 |   ✅   | 00:00:00.592 |
| `test_ftp`               | `native_ftp`            |    21 |   ✅   | 00:00:00.761 |
| `test_httpcache`         | `native_httpcache`      |    15 |   ✅   | 00:00:00.765 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.736 |
| `test_det_ip`            | `native_det_ip`         |    11 |   ✅   | 00:00:00.759 |
| `test_det_arena`         | `native_det_arena`      |    19 |   ✅   | 00:00:00.733 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    17 |   ✅   | 00:00:04.890 |
| `test_crypto_kat`        | `native_crypto_kat`     |     9 |   ✅   | 00:00:02.813 |
| `test_promisc`           | `native_promisc`        |     9 |   ✅   | 00:00:00.741 |
| `test_bus_capture`       | `native_bus_capture`    |     7 |   ✅   | 00:00:00.754 |
| `test_j1939`             | `native_j1939`          |    11 |   ✅   | 00:00:00.743 |
| `test_devicenet`         | `native_devicenet`      |    11 |   ✅   | 00:00:00.753 |
| `test_nmea2000`          | `native_nmea2000`       |     7 |   ✅   | 00:00:00.786 |
| `test_mbus`              | `native_mbus`           |    12 |   ✅   | 00:00:00.751 |
| `test_iec60870`          | `native_iec60870`       |    13 |   ✅   | 00:00:00.749 |
| `test_sdi12`             | `native_sdi12`          |     7 |   ✅   | 00:00:00.744 |
| `test_dmx`               | `native_dmx`            |     6 |   ✅   | 00:00:00.744 |
| `test_nmea0183`          | `native_nmea0183`       |     8 |   ✅   | 00:00:00.762 |
| `test_iolink`            | `native_iolink`         |     6 |   ✅   | 00:00:00.742 |
| `test_sse`               | `native`                |    46 |   ✅   | 00:00:01.295 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.674 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.731 |
| `test_transport`         | `native`                |    45 |   ✅   | 00:00:00.733 |
| `test_websocket`         | `native`                |    69 |   ✅   | 00:00:00.761 |
...
| `test_provisioning`      | `native_prov`           |     7 |   ✅   | 00:00:00.782 |
| `test_ssh_crypto`        | `native_ssh`            |    55 |   ✅   | 00:00:07.014 |
| `test_ssh_auth`          | `native_ssh`            |    20 |   ✅   | 00:00:03.361 |
| `test_ssh_server`        | `native_ssh`            |    27 |   ✅   | 00:00:01.068 |
| `test_ssh_transport`     | `native_ssh`            |    40 |   ✅   | 00:00:01.908 |
| `test_ssh_channel`       | `native_ssh`            |    37 |   ✅   | 00:00:00.730 |
| `test_ssh_pqc`           | `native_ssh_pqc`        |     4 |   ✅   | 00:00:01.438 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.321 |
| `test_ssh_conn`          | `native_ssh_conn`       |    16 |   ✅   | 00:00:02.254 |
| `test_regex`             | `native_app`            |    13 |   ✅   | 00:00:01.834 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.713 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.735 |
...
| `test_json`              | `native_app`            |    28 |   ✅   | 00:00:00.692 |
| `test_response_headers`  | `native_app`            |    12 |   ✅   | 00:00:00.749 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.727 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.768 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.733 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.690 |
| `test_multipart`         | `native_app`            |    25 |   ✅   | 00:00:00.754 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.733 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.745 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.727 |
| `test_chunked`           | `native_app`            |    14 |   ✅   | 00:00:00.732 |
| `test_application`       | `native_app`            |    72 |   ✅   | 00:00:00.927 |
| `test_webdav_handler`    | `native_webdav_handler` |    29 |   ✅   | 00:00:01.946 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.898 |
| `test_snmp_ber`          | `native_snmp`           |    21 |   ✅   | 00:00:00.847 |
| `test_snmp_agent`        | `native_snmp`           |    28 |   ✅   | 00:00:00.662 |
| `test_snmp_v3`           | `native_snmp_v3`        |    22 |   ✅   | 00:00:02.950 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.971 |
| `test_coap`              | `native_coap`           |    44 |   ✅   | 00:00:00.927 |
| `test_coap`              | `native_coap_observe`   |    46 |   ✅   | 00:00:00.943 |
| `test_webdav`            | `native_webdav`         |    25 |   ✅   | 00:00:00.805 |
| `test_modbus`            | `native_modbus`         |    23 |   ✅   | 00:00:00.767 |
| `test_cloudevents`       | `native_cloudevents`    |     8 |   ✅   | 00:00:00.905 |
| `test_redis_resp`        | `native_redis`          |    14 |   ✅   | 00:00:00.755 |
| `test_sqlite`            | `native_sqlite`         |    23 |   ✅   | 00:00:00.796 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.773 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.785 |
| `test_flow_export`       | `native_flow_export`    |     8 |   ✅   | 00:00:00.783 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.788 |
| `test_preempt_queue`     | `native_preempt_queue`  |    12 |   ✅   | 00:00:00.820 |
| `test_dma`               | `native_dma`            |    12 |   ✅   | 00:00:00.946 |
| `test_forward`           | `native_forward`        |    26 |   ✅   | 00:00:01.047 |
| `test_gateway`           | `native_gateway`        |    12 |   ✅   | 00:00:00.920 |
| `test_lora`              | `native_lora`           |    14 |   ✅   | 00:00:00.756 |
| `test_nrf24`             | `native_nrf24`          |    11 |   ✅   | 00:00:00.764 |
| `test_enocean`           | `native_enocean`        |    10 |   ✅   | 00:00:00.754 |
| `test_pn532`             | `native_pn532`          |    11 |   ✅   | 00:00:00.765 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.753 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.741 |
| `test_zigbee`            | `native_zigbee`         |    10 |   ✅   | 00:00:00.750 |
| `test_thread`            | `native_thread`         |    15 |   ✅   | 00:00:00.771 |
| `test_wamp`              | `native_wamp`           |    15 |   ✅   | 00:00:00.813 |
| `test_sunspec`           | `native_sunspec`        |     7 |   ✅   | 00:00:00.774 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.780 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.775 |
| `test_grpcweb`           | `native_grpcweb`        |     9 |   ✅   | 00:00:00.781 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    14 |   ✅   | 00:00:00.775 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.782 |
| `test_hostlink`          | `native_hostlink`       |     8 |   ✅   | 00:00:00.767 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.875 |
| `test_df1`               | `native_df1`            |    10 |   ✅   | 00:00:00.780 |
| `test_cotp`              | `native_cotp`           |     7 |   ✅   | 00:00:00.790 |
| `test_s7comm`            | `native_s7comm`         |     9 |   ✅   | 00:00:00.773 |
| `test_melsec`            | `native_melsec`         |     7 |   ✅   | 00:00:00.781 |
| `test_ads`               | `native_ads`            |    11 |   ✅   | 00:00:00.784 |
| `test_focas`             | `native_focas`          |    11 |   ✅   | 00:00:00.772 |
| `test_pqc_mlkem`         | `native_pqc`            |     3 |   ✅   | 00:00:00.805 |
| `test_pqc_sha3`          | `native_pqc`            |     4 |   ✅   | 00:00:00.596 |
| `test_iface_bridge`      | `native_iface_bridge`   |     7 |   ✅   | 00:00:00.805 |
| `test_rtcm3`             | `native_rtcm3`          |    11 |   ✅   | 00:00:00.776 |
| `test_gnss_survey`       | `native_gnss_survey`    |     9 |   ✅   | 00:00:00.861 |
| `test_ntrip_caster`      | `native_ntrip_caster`   |    14 |   ✅   | 00:00:00.822 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.785 |
| `test_enip`              | `native_enip`           |     7 |   ✅   | 00:00:00.773 |
| `test_amqp`              | `native_amqp`           |     8 |   ✅   | 00:00:00.755 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.775 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.767 |
| `test_proxy_protocol`    | `native_proxy_protocol` |    10 |   ✅   | 00:00:00.784 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.804 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.827 |
| `test_ota_rollback`      | `native_ota_rollback`   |     6 |   ✅   | 00:00:00.766 |
| `test_totp`              | `native_totp`           |     5 |   ✅   | 00:00:00.806 |
| `test_webhook`           | `native_webhook`        |     9 |   ✅   | 00:00:00.784 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.754 |
| `test_dns_resolver`      | `native_dns_resolver`   |     5 |   ✅   | 00:00:00.775 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.836 |
| `test_oidc`              | `native_oidc`           |    19 |   ✅   | 00:00:14.208 |
| `test_vfs`               | `native_vfs`            |    12 |   ✅   | 00:00:00.777 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.784 |
| `test_espnow`            | `native_espnow`         |     8 |   ✅   | 00:00:00.773 |
| `test_oauth2`            | `native_oauth2`         |     9 |   ✅   | 00:00:00.827 |
| `test_opcua`             | `native_opcua`          |    47 |   ✅   | 00:00:00.953 |
| `test_opcua_client`      | `native_opcua_client`   |    20 |   ✅   | 00:00:00.846 |
| `test_umati`             | `native_umati`          |    11 |   ✅   | 00:00:00.836 |
| `test_keepalive`         | `native_keepalive`      |    11 |   ✅   | 00:00:01.781 |
| `test_range`             | `native_range`          |    20 |   ✅   | 00:00:01.786 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.821 |
| `test_ntlm`              | `native_smb`            |     3 |   ✅   | 00:00:00.933 |
| `test_smb_client`        | `native_smb`            |    10 |   ✅   | 00:00:00.623 |
| `test_ntlmssp`           | `native_smb`            |     5 |   ✅   | 00:00:00.609 |
| `test_smb_crypto`        | `native_smb`            |     5 |   ✅   | 00:00:00.604 |
| `test_smb2`              | `native_smb`            |    19 |   ✅   | 00:00:00.669 |
| `test_spnego`            | `native_smb`            |     4 |   ✅   | 00:00:00.605 |
| `test_smtp`              | `native_smtp`           |    22 |   ✅   | 00:00:01.012 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.768 |
| `test_dns_server`        | `native_dns_server`     |    13 |   ✅   | 00:00:00.775 |
| `test_rtc`               | `native_rtc`            |     9 |   ✅   | 00:00:00.773 |
| `test_relay`             | `native_relay`          |     6 |   ✅   | 00:00:00.778 |
| `test_ld2410`            | `native_ld2410`         |     8 |   ✅   | 00:00:00.771 |
| `test_sen0192`           | `native_sen0192`        |     5 |   ✅   | 00:00:00.773 |
| `test_mpr121`            | `native_mpr121`         |     6 |   ✅   | 00:00:00.790 |
| `test_sht3x`             | `native_sht3x`          |     6 |   ✅   | 00:00:00.745 |
| `test_pca9685`           | `native_pca9685`        |     5 |   ✅   | 00:00:00.766 |
| `test_ads1115`           | `native_ads1115`        |     5 |   ✅   | 00:00:00.761 |
| `test_ina219`            | `native_ina219`         |     5 |   ✅   | 00:00:00.777 |
| `test_hpack`             | `native_hpack`          |    15 |   ✅   | 00:00:00.934 |
| `test_h2_frame`          | `native_h2frame`        |     7 |   ✅   | 00:00:00.772 |
| `test_h2_conn`           | `native_h2conn`         |    22 |   ✅   | 00:00:01.165 |
| `test_quic_varint`       | `native_quic_varint`    |     3 |   ✅   | 00:00:00.763 |
| `test_h3_frame`          | `native_h3frame`        |     7 |   ✅   | 00:00:00.806 |
| `test_jwt`               | `native_jwt`            |    22 |   ✅   | 00:00:00.865 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.817 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.785 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.847 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.798 |
| `test_ws_client`         | `native_ws_client`      |    17 |   ✅   | 00:00:00.827 |
| `test_scratch`           | `native_scratch`        |    15 |   ✅   | 00:00:00.822 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.810 |
| `test_inflate`           | `native_inflate`        |    14 |   ✅   | 00:00:00.761 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.838 |
| `test_ssh_zlib`          | `native_ssh_zlib`       |     9 |   ✅   | 00:00:00.860 |
| `test_ssh_comp`          | `native_ssh_comp`       |     6 |   ✅   | 00:00:01.437 |
| `test_websocket`         | `native_ws_deflate`     |    74 |   ✅   | 00:00:01.409 |
| `test_time_source`       | `native_time_source`    |    10 |   ✅   | 00:00:00.773 |
| `test_config_store`      | `native_config_store`   |    15 |   ✅   | 00:00:00.788 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.798 |
| `test_auth_lockout`      | `native_auth_lockout`   |    12 |   ✅   | 00:00:00.822 |
| `test_csrf`              | `native_csrf`           |    10 |   ✅   | 00:00:00.842 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.801 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.793 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.752 |
| `test_partition_monitor` | `native_partition`      |     6 |   ✅   | 00:00:00.791 |
| `test_cbor`              | `native_cbor`           |    21 |   ✅   | 00:00:00.793 |
| `test_msgpack`           | `native_msgpack`        |    23 |   ✅   | 00:00:00.800 |
| `test_gpio_map`          | `native_gpio_map`       |     9 |   ✅   | 00:00:00.790 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     8 |   ✅   | 00:00:00.776 |
| `test_statsd`            | `native_statsd`         |    10 |   ✅   | 00:00:00.807 |
| `test_guardrails`        | `native_guardrails`     |     9 |   ✅   | 00:00:00.762 |
| `test_failsafe`          | `native_failsafe`       |     7 |   ✅   | 00:00:00.784 |
...
| `test_dshot`             | `native_dshot`          |     8 |   ✅   | 00:00:00.752 |
| `test_hart`              | `native_hart`           |     7 |   ✅   | 00:00:00.745 |
| `test_nts`               | `native_nts`            |     5 |   ✅   | 00:00:00.747 |
| `test_dds`               | `native_dds`            |     5 |   ✅   | 00:00:00.740 |
| `test_xmpp`              | `native_xmpp`           |    11 |   ✅   | 00:00:00.745 |
| `test_rawl2`             | `native_rawl2`          |     5 |   ✅   | 00:00:00.753 |
| `test_spa_router`        | `native_spa_router`     |     2 |   ✅   | 00:00:00.755 |
| `test_goose`             | `native_goose`          |     4 |   ✅   | 00:00:00.771 |
| `test_mtconnect`         | `native_mtconnect`      |    12 |   ✅   | 00:00:00.792 |
| `test_wal`               | `native_wal`            |     6 |   ✅   | 00:00:00.806 |
| `test_wal_store`         | `native_wal`            |     7 |   ✅   | 00:00:00.604 |
| `test_j2735`             | `native_j2735`          |    11 |   ✅   | 00:00:00.766 |
| `test_nema_ts2`          | `native_nema_ts2`       |     4 |   ✅   | 00:00:00.781 |
| `test_snp`               | `native_snp`            |     5 |   ✅   | 00:00:00.761 |
| `test_directnet`         | `native_directnet`      |     5 |   ✅   | 00:00:00.768 |
| `test_sep2`              | `native_sep2`           |     5 |   ✅   | 00:00:00.781 |
| `test_profinet`          | `native_profinet`       |     5 |   ✅   | 00:00:00.783 |
| `test_ntcip`             | `native_ntcip`          |     3 |   ✅   | 00:00:00.763 |
| `test_openadr`           | `native_openadr`        |     5 |   ✅   | 00:00:00.781 |
| `test_mms`               | `native_mms`            |    11 |   ✅   | 00:00:00.771 |
| `test_cclink`            | `native_cclink`         |     5 |   ✅   | 00:00:00.781 |
| `test_powerlink`         | `native_powerlink`      |     4 |   ✅   | 00:00:00.784 |
| `test_sercos`            | `native_sercos`         |     4 |   ✅   | 00:00:00.763 |
| `test_profibus`          | `native_profibus`       |     5 |   ✅   | 00:00:00.765 |
| `test_lonworks`          | `native_lonworks`       |     5 |   ✅   | 00:00:00.767 |
| `test_mbplus`            | `native_mbplus`         |     6 |   ✅   | 00:00:00.768 |
| `test_interbus`          | `native_interbus`       |     5 |   ✅   | 00:00:00.764 |
| `test_iccp`              | `native_iccp`           |     5 |   ✅   | 00:00:00.777 |
| `test_wave`              | `native_wave`           |     9 |   ✅   | 00:00:00.779 |
| `test_utmc`              | `native_utmc`           |     6 |   ✅   | 00:00:00.779 |
| `test_ocit`              | `native_ocit`           |     4 |   ✅   | 00:00:00.779 |
| `test_atc`               | `native_atc`            |     5 |   ✅   | 00:00:00.770 |
| `test_southbound`        | `native_southbound`     |     6 |   ✅   | 00:00:00.767 |
| `test_exc_decoder`       | `native_exc_decoder`    |     7 |   ✅   | 00:00:00.784 |
| `test_http_delivery`     | `native_http_delivery`  |     8 |   ✅   | 00:00:00.812 |
| `test_hw_health`         | `native_hw_health`      |     7 |   ✅   | 00:00:00.787 |
| `test_mdns_adaptive`     | `native_mdns_adaptive`  |     5 |   ✅   | 00:00:00.773 |
| `test_sockpool`          | `native_sockpool`       |     6 |   ✅   | 00:00:00.771 |
| `test_psram_pool`        | `native_psram_pool`     |     5 |   ✅   | 00:00:00.786 |
| `test_happy_eyeballs`    | `native_happy_eyeballs` |     5 |   ✅   | 00:00:00.835 |
| `test_wifi_sniffer`      | `native_wifi_sniffer`   |     6 |   ✅   | 00:00:00.763 |
| `test_link_manager`      | `native_link_manager`   |     4 |   ✅   | 00:00:00.770 |
| `test_cc1101`            | `native_cc1101`         |    11 |   ✅   | 00:00:00.774 |
| `test_fdc2214`           | `native_fdc2214`        |     4 |   ✅   | 00:00:00.760 |
| `test_ldc1614`           | `native_ldc1614`        |     4 |   ✅   | 00:00:00.770 |
| `test_vl53l0x`           | `native_vl53l0x`        |     3 |   ✅   | 00:00:00.748 |
| `test_radio_sniff`       | `native_radio_sniff`    |     4 |   ✅   | 00:00:00.777 |
| `test_ble_gatt`          | `native_ble_gatt`       |     7 |   ✅   | 00:00:00.767 |
| `test_tls_policy`        | `native_tls_policy`     |     4 |   ✅   | 00:00:00.767 |
| `test_wisun`             | `native_wisun`          |    10 |   ✅   | 00:00:00.790 |
| `test_logbuf`            | `native_logbuf`         |     5 |   ✅   | 00:00:00.780 |
| `test_config_io`         | `native_config_io`      |     5 |   ✅   | 00:00:00.804 |
| `test_workers`           | `native_workers`        |     6 |   ✅   | 00:00:00.915 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.781 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.887 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.305 |
| `test_qpack`             | `native_qpack`          |    11 |   ✅   | 00:00:00.934 |
| `test_quic_packet`       | `native_quic_packet`    |     8 |   ✅   | 00:00:00.814 |
| `test_quic_frame`        | `native_quic_frame`     |     9 |   ✅   | 00:00:00.804 |
| `test_quic_crypto`       | `native_quic_crypto`    |     7 |   ✅   | 00:00:00.924 |
| `test_tls13_kdf`         | `native_tls13_kdf`      |     5 |   ✅   | 00:00:00.857 |
| `test_quic_tp`           | `native_quic_tp`        |     8 |   ✅   | 00:00:00.808 |
| `test_tls13_msg`         | `native_tls13_msg`      |    11 |   ✅   | 00:00:00.918 |
| `test_quic_tls`          | `native_quic_tls`       |    13 |   ✅   | 00:00:01.352 |
| `test_quic_tls`          | `native_quic_tls_pqc`   |    14 |   ✅   | 00:00:01.410 |
| `test_quic_conn`         | `native_quic_conn`      |    27 |   ✅   | 00:00:02.489 |
| `test_h3_conn`           | `native_h3_conn`        |    11 |   ✅   | 00:00:01.278 |
| `test_h3_e2e`            | `native_h3_e2e`         |     1 |   ✅   | 00:00:01.273 |
| `test_quic_server`       | `native_quic_server`    |     4 |   ✅   | 00:00:01.381 |
| `test_h3_server`         | `native_h3_server`      |     1 |   ✅   | 00:00:02.419 |
| `test_ssh_chachapoly`    | `native_ssh_chachapoly` |     4 |   ✅   | 00:00:00.813 |
| `test_ssh_aesgcm`        | `native_ssh_aesgcm`     |     3 |   ✅   | 00:00:00.763 |
...
## test_cia402 - native_cia402 - ✅ 9 passed
...
## test_control - native_control - ✅ 12 passed
...
## test_docstore - native_docstore - ✅ 5 passed
...
## test_ssh_crypto - native_ssh - ✅ 55 passed
...
|  35 | `test_rsa_sha512_kat_sign_verify`            |   ✅   | Rsa sha512 kat sign verify                                                                      |
|  36 | `test_pkt_send_recv_unencrypted`             |   ✅   | Pkt send recv unencrypted                                                                       |
|  37 | `test_pkt_padding_alignment`                 |   ✅   | Packet length + padding must be multiple of 16.                                                 |
|  38 | `test_pkt_seq_increments`                    |   ✅   | Pkt seq increments                                                                              |
|  39 | `test_pkt_disconnect_zeroes_state`           |   ✅   | Pkt disconnect zeroes state                                                                     |
|  40 | `test_pkt_encrypted_roundtrip`               |   ✅   | Pkt encrypted roundtrip                                                                         |
|  41 | `test_pkt_chacha20poly1305_roundtrip`        |   ✅   | Install a chacha20-poly1305 session with the same key both directions, so ssh_pkt_send()        |
|  42 | `test_pkt_aes256gcm_roundtrip`               |   ✅   | Install an aes256-gcm@openssh.com session with the same key/IV both directions, so ssh_pkt_send |
|  43 | `test_pkt_aes_etm_sha256_roundtrip`          |   ✅   | Pkt aes etm sha256 roundtrip                                                                    |
|  44 | `test_pkt_aes_etm_sha512_roundtrip`          |   ✅   | Pkt aes etm sha512 roundtrip                                                                    |
|  45 | `test_pkt_encrypted_fragmented`              |   ✅   | Pkt encrypted fragmented                                                                        |
|  46 | `test_pkt_encrypted_two_packets`             |   ✅   | Pkt encrypted two packets                                                                       |
|  47 | `test_pkt_chacha_padding_and_incomplete`     |   ✅   | Pkt chacha padding and incomplete                                                               |
|  48 | `test_pkt_etm_padding_and_incomplete`        |   ✅   | Pkt etm padding and incomplete                                                                  |
|  49 | `test_pkt_chacha_forged_rejects`             |   ✅   | Pkt chacha forged rejects                                                                       |
|  50 | `test_pkt_etm_bad_length`                    |   ✅   | Pkt etm bad length                                                                              |
|  51 | `test_pkt_etm_forged_rejects`                |   ✅   | Pkt etm forged rejects                                                                          |
|  52 | `test_pkt_scratch_exhausted`                 |   ✅   | Pkt scratch exhausted                                                                           |
|  53 | `test_pkt_eam_forged_rejects`                |   ✅   | Pkt eam forged rejects                                                                          |
|  54 | `test_ssh_kdf_canonical_mpint_k`             |   ✅   | Ssh kdf canonical mpint k                                                                       |
|  55 | `test_ssh_kdf_extension_chain`               |   ✅   | Ssh kdf extension chain                                                                         |

</details>

---

## test_ssh_auth - native_ssh - ✅ 20 passed
...
|  18 | `test_pubkey_ed25519_valid_signature_succeeds` |   ✅   | Pubkey ed25519 valid signature succeeds           |
|  19 | `test_pubkey_tampered_signature_fails`         |   ✅   | Pubkey tampered signature fails                   |
|  20 | `test_pubkey_unauthorized_key_fails`           |   ✅   | Pubkey unauthorized key fails                     |
...
## test_ssh_transport - native_ssh - ✅ 40 passed
...
|  20 | `test_kexinit_parse_selects_etm_mac`                       |   ✅   | Kexinit parse selects etm mac                                                   |
|  21 | `test_kexinit_parse_rejects_truncated`                     |   ✅   | Kexinit parse rejects truncated                                                 |
|  22 | `test_exchange_hash_matches_independent_assembly`          |   ✅   | Populate the session fields the hash reads.                                     |
|  23 | `test_exchange_hash_changes_with_input`                    |   ✅   | Exchange hash changes with input                                                |
|  24 | `test_kexdh_parse_init_extracts_e_with_padding`            |   ✅   | Kexdh parse init extracts e with padding                                        |
|  25 | `test_kexdh_parse_init_extracts_small_e`                   |   ✅   | Kexdh parse init extracts small e                                               |
|  26 | `test_kexdh_parse_init_rejects_wrong_type`                 |   ✅   | Kexdh parse init rejects wrong type                                             |
|  27 | `test_kexdh_parse_init_rejects_oversized_e`                |   ✅   | mpint with 300 magnitude bytes → exceeds 2048 bits.                             |
|  28 | `test_kexdh_build_reply_structure`                         |   ✅   | Kexdh build reply structure                                                     |
|  29 | `test_kexdh_handle_produces_reply_and_installs_keys`       |   ✅   | Kexdh handle produces reply and installs keys                                   |
|  30 | `test_kexdh_handle_rejects_invalid_e`                      |   ✅   | Kexdh handle rejects invalid e                                                  |
|  31 | `test_kexdh_handle_curve25519_ed25519_end_to_end`          |   ✅   | Fixed baseline host keys for deterministic regression, plus one fresh throwaway |
|  32 | `test_kexdh_handle_curve25519_rejects_low_order`           |   ✅   | Kexdh handle curve25519 rejects low order                                       |
|  33 | `test_kexdh_handle_rsa_sha512_signature`                   |   ✅   | Kexdh handle rsa sha512 signature                                               |
|  34 | `test_derive_keys_session_id_affects_output`               |   ✅   | Derive keys session id affects output                                           |
|  35 | `test_rekey_needed_threshold`                              |   ✅   | Rekey needed threshold                                                          |
|  36 | `test_rekey_due_volume_and_time`                           |   ✅   | Neither budget spent.                                                           |
|  37 | `test_begin_rekey_preserves_session_and_auth`              |   ✅   | Begin rekey preserves session and auth                                          |
|  38 | `test_kdf_edge_paths_and_slot_guards`                      |   ✅   | Kdf edge paths and slot guards                                                  |
|  39 | `test_kexinit_parse_truncation_points`                     |   ✅   | Kexinit parse truncation points                                                 |
|  40 | `test_ssh_transport_more_guards`                           |   ✅   | Ssh transport more guards                                                       |
...
## test_gnss_survey - native_gnss_survey - ✅ 9 passed
...
## test_smb_client - native_smb - ✅ 10 passed
...
## test_spnego - native_smb - ✅ 4 passed
...
## test_wal_store - native_wal - ✅ 7 passed
...
## test_quic_frame - native_quic_frame - ✅ 9 passed
...
|   3 | `test_ack`                     |   ✅   | Ack                                                                                 |
|   4 | `test_crypto`                  |   ✅   | Crypto                                                                              |
|   5 | `test_stream`                  |   ✅   | With offset + FIN.                                                                  |
|   6 | `test_max_data_and_close`      |   ✅   | Max data and close                                                                  |
|   7 | `test_sequence_and_truncation` |   ✅   | A packet payload: PADDING, PING, then a CRYPTO frame - parse them in order.         |
|   8 | `test_builder_overflow`        |   ✅   | Builder overflow                                                                    |
|   9 | `test_parse_errors`            |   ✅   | Parse errors                                                                        |
