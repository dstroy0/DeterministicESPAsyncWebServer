...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:03.699 |
| `test_dbm`               | `native_dbm`            |    13 |   ✅   | 00:00:00.608 |
| `test_docstore`          | `native_docstore`       |     5 |   ✅   | 00:00:00.622 |
| `test_dnc`               | `native_dnc`            |    14 |   ✅   | 00:00:00.789 |
| `test_dnc_stream`        | `native_dnc`            |     8 |   ✅   | 00:00:00.399 |
...
| `test_det_ip`            | `native_det_ip`         |    11 |   ✅   | 00:00:00.623 |
...
| `test_promisc`           | `native_promisc`        |     9 |   ✅   | 00:00:00.544 |
| `test_bus_capture`       | `native_bus_capture`    |     7 |   ✅   | 00:00:00.535 |
| `test_j1939`             | `native_j1939`          |    11 |   ✅   | 00:00:00.534 |
| `test_devicenet`         | `native_devicenet`      |    11 |   ✅   | 00:00:00.557 |
| `test_nmea2000`          | `native_nmea2000`       |     7 |   ✅   | 00:00:00.611 |
| `test_mbus`              | `native_mbus`           |    12 |   ✅   | 00:00:00.580 |
| `test_iec60870`          | `native_iec60870`       |    13 |   ✅   | 00:00:00.543 |
| `test_sdi12`             | `native_sdi12`          |     7 |   ✅   | 00:00:00.515 |
| `test_dmx`               | `native_dmx`            |     6 |   ✅   | 00:00:00.537 |
| `test_nmea0183`          | `native_nmea0183`       |     8 |   ✅   | 00:00:00.535 |
| `test_iolink`            | `native_iolink`         |     6 |   ✅   | 00:00:00.530 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:00.941 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.438 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.510 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.479 |
| `test_websocket`         | `native`                |    69 |   ✅   | 00:00:00.548 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.491 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.663 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:00.917 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.554 |
...
| `test_ssh_server`        | `native_ssh`            |    26 |   ✅   | 00:00:00.770 |
...
| `test_ssh_conn`          | `native_ssh_conn`       |    15 |   ✅   | 00:00:01.497 |
| `test_regex`             | `native_app`            |    13 |   ✅   | 00:00:01.121 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.478 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.499 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.438 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.474 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.501 |
| `test_json`              | `native_app`            |    28 |   ✅   | 00:00:00.489 |
| `test_response_headers`  | `native_app`            |    12 |   ✅   | 00:00:00.644 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.492 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.501 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.493 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.476 |
| `test_multipart`         | `native_app`            |    25 |   ✅   | 00:00:00.552 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.484 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.517 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.486 |
| `test_chunked`           | `native_app`            |    14 |   ✅   | 00:00:00.526 |
| `test_application`       | `native_app`            |    71 |   ✅   | 00:00:00.681 |
| `test_webdav_handler`    | `native_webdav_handler` |    29 |   ✅   | 00:00:01.146 |
...
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.687 |
...
| `test_cloudevents`       | `native_cloudevents`    |     8 |   ✅   | 00:00:00.633 |
...
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.547 |
| `test_flow_export`       | `native_flow_export`    |     8 |   ✅   | 00:00:00.536 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.521 |
| `test_preempt_queue`     | `native_preempt_queue`  |    12 |   ✅   | 00:00:00.895 |
| `test_dma`               | `native_dma`            |    12 |   ✅   | 00:00:00.635 |
| `test_forward`           | `native_forward`        |    26 |   ✅   | 00:00:00.940 |
| `test_gateway`           | `native_gateway`        |    12 |   ✅   | 00:00:00.620 |
| `test_lora`              | `native_lora`           |    14 |   ✅   | 00:00:00.548 |
| `test_nrf24`             | `native_nrf24`          |    11 |   ✅   | 00:00:00.569 |
| `test_enocean`           | `native_enocean`        |    10 |   ✅   | 00:00:00.537 |
| `test_pn532`             | `native_pn532`          |    11 |   ✅   | 00:00:00.577 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.656 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.564 |
| `test_zigbee`            | `native_zigbee`         |    10 |   ✅   | 00:00:00.530 |
| `test_thread`            | `native_thread`         |    15 |   ✅   | 00:00:00.562 |
| `test_wamp`              | `native_wamp`           |    15 |   ✅   | 00:00:00.593 |
| `test_sunspec`           | `native_sunspec`        |     7 |   ✅   | 00:00:00.539 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.539 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.521 |
| `test_grpcweb`           | `native_grpcweb`        |     9 |   ✅   | 00:00:00.576 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    14 |   ✅   | 00:00:00.541 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.535 |
| `test_hostlink`          | `native_hostlink`       |     8 |   ✅   | 00:00:00.545 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.623 |
| `test_df1`               | `native_df1`            |    10 |   ✅   | 00:00:00.679 |
| `test_cotp`              | `native_cotp`           |     7 |   ✅   | 00:00:00.646 |
| `test_s7comm`            | `native_s7comm`         |     9 |   ✅   | 00:00:00.631 |
| `test_melsec`            | `native_melsec`         |     7 |   ✅   | 00:00:00.648 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.534 |
| `test_enip`              | `native_enip`           |     7 |   ✅   | 00:00:01.197 |
| `test_amqp`              | `native_amqp`           |     8 |   ✅   | 00:00:00.500 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.698 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.560 |
| `test_proxy_protocol`    | `native_proxy_protocol` |    10 |   ✅   | 00:00:00.560 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.740 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.563 |
| `test_ota_rollback`      | `native_ota_rollback`   |     6 |   ✅   | 00:00:00.506 |
| `test_totp`              | `native_totp`           |     5 |   ✅   | 00:00:00.555 |
| `test_webhook`           | `native_webhook`        |     9 |   ✅   | 00:00:00.520 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.499 |
| `test_dns_resolver`      | `native_dns_resolver`   |     5 |   ✅   | 00:00:00.537 |
...
| `test_keepalive`         | `native_keepalive`      |    11 |   ✅   | 00:00:01.143 |
| `test_range`             | `native_range`          |    20 |   ✅   | 00:00:01.356 |
...
| `test_rtc`               | `native_rtc`            |     9 |   ✅   | 00:00:00.546 |
| `test_relay`             | `native_relay`          |     6 |   ✅   | 00:00:00.546 |
| `test_ld2410`            | `native_ld2410`         |     8 |   ✅   | 00:00:00.608 |
| `test_mpr121`            | `native_mpr121`         |     6 |   ✅   | 00:00:00.558 |
| `test_sht3x`             | `native_sht3x`          |     6 |   ✅   | 00:00:00.573 |
| `test_pca9685`           | `native_pca9685`        |     5 |   ✅   | 00:00:00.569 |
| `test_ads1115`           | `native_ads1115`        |     5 |   ✅   | 00:00:00.545 |
| `test_ina219`            | `native_ina219`         |     5 |   ✅   | 00:00:00.549 |
| `test_hpack`             | `native_hpack`          |    15 |   ✅   | 00:00:00.715 |
| `test_h2_frame`          | `native_h2frame`        |     7 |   ✅   | 00:00:00.671 |
| `test_h2_conn`           | `native_h2conn`         |    22 |   ✅   | 00:00:00.817 |
...
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.576 |
| `test_inflate`           | `native_inflate`        |    14 |   ✅   | 00:00:00.530 |
...
| `test_websocket`         | `native_ws_deflate`     |    74 |   ✅   | 00:00:01.253 |
...
| `test_auth_lockout`      | `native_auth_lockout`   |    12 |   ✅   | 00:00:00.605 |
...
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.537 |
| `test_partition_monitor` | `native_partition`      |     6 |   ✅   | 00:00:00.833 |
| `test_cbor`              | `native_cbor`           |    21 |   ✅   | 00:00:00.630 |
| `test_msgpack`           | `native_msgpack`        |    23 |   ✅   | 00:00:00.710 |
| `test_gpio_map`          | `native_gpio_map`       |     9 |   ✅   | 00:00:00.596 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     8 |   ✅   | 00:00:00.561 |
| `test_statsd`            | `native_statsd`         |    10 |   ✅   | 00:00:00.627 |
| `test_guardrails`        | `native_guardrails`     |     9 |   ✅   | 00:00:00.557 |
| `test_failsafe`          | `native_failsafe`       |     7 |   ✅   | 00:00:00.579 |
| `test_sleep_sched`       | `native_sleep_sched`    |     8 |   ✅   | 00:00:00.591 |
| `test_wearlevel`         | `native_wearlevel`      |     5 |   ✅   | 00:00:00.551 |
| `test_netadapt`          | `native_netadapt`       |     6 |   ✅   | 00:00:00.537 |
| `test_dshot`             | `native_dshot`          |     8 |   ✅   | 00:00:00.577 |
| `test_hart`              | `native_hart`           |     7 |   ✅   | 00:00:00.548 |
...
| `test_wal`               | `native_wal`            |     6 |   ✅   | 00:00:00.566 |
| `test_wal_store`         | `native_wal`            |     7 |   ✅   | 00:00:00.425 |
| `test_j2735`             | `native_j2735`          |    11 |   ✅   | 00:00:00.528 |
| `test_nema_ts2`          | `native_nema_ts2`       |     4 |   ✅   | 00:00:00.558 |
| `test_snp`               | `native_snp`            |     5 |   ✅   | 00:00:00.636 |
| `test_directnet`         | `native_directnet`      |     5 |   ✅   | 00:00:00.629 |
| `test_sep2`              | `native_sep2`           |     5 |   ✅   | 00:00:00.544 |
| `test_profinet`          | `native_profinet`       |     5 |   ✅   | 00:00:00.564 |
| `test_ntcip`             | `native_ntcip`          |     3 |   ✅   | 00:00:00.580 |
| `test_openadr`           | `native_openadr`        |     5 |   ✅   | 00:00:00.593 |
| `test_mms`               | `native_mms`            |    11 |   ✅   | 00:00:00.526 |
| `test_cclink`            | `native_cclink`         |     5 |   ✅   | 00:00:00.578 |
| `test_powerlink`         | `native_powerlink`      |     4 |   ✅   | 00:00:00.540 |
| `test_sercos`            | `native_sercos`         |     4 |   ✅   | 00:00:00.560 |
| `test_profibus`          | `native_profibus`       |     5 |   ✅   | 00:00:00.557 |
| `test_lonworks`          | `native_lonworks`       |     5 |   ✅   | 00:00:00.560 |
...
| `test_http_delivery`     | `native_http_delivery`  |     8 |   ✅   | 00:00:00.587 |
| `test_hw_health`         | `native_hw_health`      |     7 |   ✅   | 00:00:00.620 |
...
| `test_happy_eyeballs`    | `native_happy_eyeballs` |     5 |   ✅   | 00:00:00.608 |
...
| `test_fdc2214`           | `native_fdc2214`        |     4 |   ✅   | 00:00:00.613 |
| `test_ldc1614`           | `native_ldc1614`        |     4 |   ✅   | 00:00:00.588 |
| `test_vl53l0x`           | `native_vl53l0x`        |     3 |   ✅   | 00:00:00.596 |
...
| `test_quic_packet`       | `native_quic_packet`    |     8 |   ✅   | 00:00:00.595 |
| `test_quic_frame`        | `native_quic_frame`     |     9 |   ✅   | 00:00:00.612 |
| `test_quic_crypto`       | `native_quic_crypto`    |     7 |   ✅   | 00:00:00.697 |
| `test_tls13_kdf`         | `native_tls13_kdf`      |     5 |   ✅   | 00:00:00.678 |
| `test_quic_tp`           | `native_quic_tp`        |     8 |   ✅   | 00:00:00.634 |
| `test_tls13_msg`         | `native_tls13_msg`      |    11 |   ✅   | 00:00:00.678 |
| `test_quic_tls`          | `native_quic_tls`       |    13 |   ✅   | 00:00:00.899 |
| `test_quic_conn`         | `native_quic_conn`      |    27 |   ✅   | 00:00:01.487 |
...
| `test_h3_server`         | `native_h3_server`      |     1 |   ✅   | 00:00:01.564 |
