...
**Generated:** 2026-07-14 04:10:24
**Command:** `pio test` over 215 auto-discovered native envs (excludes native_pentest, native_codeql)
**Result:** ✅ 3058 passed - 618s
...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:03.359 |
...
| `test_det_arena`         | `native_det_arena`      |    19 |   ✅   | 00:00:00.773 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    17 |   ✅   | 00:00:03.987 |
| `test_crypto_kat`        | `native_crypto_kat`     |     9 |   ✅   | 00:00:02.370 |
| `test_promisc`           | `native_promisc`        |     9 |   ✅   | 00:00:00.772 |
| `test_bus_capture`       | `native_bus_capture`    |     7 |   ✅   | 00:00:00.772 |
| `test_j1939`             | `native_j1939`          |    11 |   ✅   | 00:00:00.771 |
| `test_devicenet`         | `native_devicenet`      |    11 |   ✅   | 00:00:00.778 |
...
| `test_sdi12`             | `native_sdi12`          |     7 |   ✅   | 00:00:00.780 |
| `test_dmx`               | `native_dmx`            |     6 |   ✅   | 00:00:00.782 |
| `test_nmea0183`          | `native_nmea0183`       |     8 |   ✅   | 00:00:00.774 |
| `test_iolink`            | `native_iolink`         |     6 |   ✅   | 00:00:00.770 |
| `test_sse`               | `native`                |    46 |   ✅   | 00:00:01.288 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.689 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.750 |
| `test_transport`         | `native`                |    45 |   ✅   | 00:00:00.740 |
| `test_websocket`         | `native`                |    69 |   ✅   | 00:00:00.791 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.730 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.930 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:01.329 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.862 |
| `test_provisioning`      | `native_prov`           |     7 |   ✅   | 00:00:00.800 |
| `test_ssh_crypto`        | `native_ssh`            |    53 |   ✅   | 00:00:04.324 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.759 |
| `test_ssh_server`        | `native_ssh`            |    27 |   ✅   | 00:00:01.110 |
| `test_ssh_transport`     | `native_ssh`            |    37 |   ✅   | 00:00:01.725 |
| `test_ssh_channel`       | `native_ssh`            |    37 |   ✅   | 00:00:00.734 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.284 |
| `test_ssh_conn`          | `native_ssh_conn`       |    16 |   ✅   | 00:00:02.268 |
| `test_regex`             | `native_app`            |    13 |   ✅   | 00:00:01.846 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.731 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.730 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.642 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.715 |
...
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.734 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.700 |
| `test_multipart`         | `native_app`            |    25 |   ✅   | 00:00:00.767 |
...
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.851 |
| `test_snmp_ber`          | `native_snmp`           |    21 |   ✅   | 00:00:00.859 |
| `test_snmp_agent`        | `native_snmp`           |    28 |   ✅   | 00:00:00.678 |
| `test_snmp_v3`           | `native_snmp_v3`        |    22 |   ✅   | 00:00:03.134 |
...
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.780 |
| `test_flow_export`       | `native_flow_export`    |     8 |   ✅   | 00:00:00.787 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.786 |
| `test_preempt_queue`     | `native_preempt_queue`  |    12 |   ✅   | 00:00:00.810 |
| `test_dma`               | `native_dma`            |    12 |   ✅   | 00:00:00.922 |
| `test_forward`           | `native_forward`        |    26 |   ✅   | 00:00:01.095 |
| `test_gateway`           | `native_gateway`        |    12 |   ✅   | 00:00:00.922 |
| `test_lora`              | `native_lora`           |    14 |   ✅   | 00:00:00.771 |
| `test_nrf24`             | `native_nrf24`          |    11 |   ✅   | 00:00:00.786 |
...
| `test_zigbee`            | `native_zigbee`         |    10 |   ✅   | 00:00:00.770 |
| `test_thread`            | `native_thread`         |    15 |   ✅   | 00:00:00.779 |
| `test_wamp`              | `native_wamp`           |    15 |   ✅   | 00:00:00.851 |
| `test_sunspec`           | `native_sunspec`        |     7 |   ✅   | 00:00:00.775 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.773 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.773 |
| `test_grpcweb`           | `native_grpcweb`        |     9 |   ✅   | 00:00:00.780 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    14 |   ✅   | 00:00:00.782 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.762 |
| `test_hostlink`          | `native_hostlink`       |     8 |   ✅   | 00:00:00.773 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.887 |
| `test_df1`               | `native_df1`            |    10 |   ✅   | 00:00:00.778 |
| `test_cotp`              | `native_cotp`           |     7 |   ✅   | 00:00:00.770 |
| `test_s7comm`            | `native_s7comm`         |     9 |   ✅   | 00:00:00.765 |
| `test_melsec`            | `native_melsec`         |     7 |   ✅   | 00:00:00.783 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.771 |
| `test_enip`              | `native_enip`           |     7 |   ✅   | 00:00:00.783 |
| `test_amqp`              | `native_amqp`           |     8 |   ✅   | 00:00:00.763 |
...
| `test_dns_resolver`      | `native_dns_resolver`   |     5 |   ✅   | 00:00:00.769 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.823 |
| `test_oidc`              | `native_oidc`           |    19 |   ✅   | 00:00:13.762 |
| `test_vfs`               | `native_vfs`            |    12 |   ✅   | 00:00:00.786 |
...
| `test_opcua`             | `native_opcua`          |    47 |   ✅   | 00:00:00.895 |
| `test_opcua_client`      | `native_opcua_client`   |    20 |   ✅   | 00:00:00.846 |
| `test_umati`             | `native_umati`          |    11 |   ✅   | 00:00:00.844 |
...
| `test_smb_client`        | `native_smb`            |    10 |   ✅   | 00:00:00.619 |
| `test_ntlmssp`           | `native_smb`            |     5 |   ✅   | 00:00:00.598 |
| `test_smb_crypto`        | `native_smb`            |     5 |   ✅   | 00:00:00.593 |
| `test_smb2`              | `native_smb`            |    19 |   ✅   | 00:00:00.672 |
| `test_spnego`            | `native_smb`            |     4 |   ✅   | 00:00:00.589 |
...
| `test_relay`             | `native_relay`          |     6 |   ✅   | 00:00:00.763 |
| `test_ld2410`            | `native_ld2410`         |     8 |   ✅   | 00:00:00.774 |
| `test_mpr121`            | `native_mpr121`         |     6 |   ✅   | 00:00:00.773 |
| `test_sht3x`             | `native_sht3x`          |     6 |   ✅   | 00:00:00.767 |
| `test_pca9685`           | `native_pca9685`        |     5 |   ✅   | 00:00:00.771 |
| `test_ads1115`           | `native_ads1115`        |     5 |   ✅   | 00:00:00.766 |
...
| `test_h3_frame`          | `native_h3frame`        |     7 |   ✅   | 00:00:00.792 |
| `test_jwt`               | `native_jwt`            |    22 |   ✅   | 00:00:00.849 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.747 |
...
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.813 |
...
| `test_config_store`      | `native_config_store`   |    15 |   ✅   | 00:00:00.772 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.793 |
| `test_auth_lockout`      | `native_auth_lockout`   |    12 |   ✅   | 00:00:00.802 |
| `test_csrf`              | `native_csrf`           |    10 |   ✅   | 00:00:00.840 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.795 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.780 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.744 |
| `test_partition_monitor` | `native_partition`      |     6 |   ✅   | 00:00:00.783 |
| `test_cbor`              | `native_cbor`           |    21 |   ✅   | 00:00:00.769 |
| `test_msgpack`           | `native_msgpack`        |    23 |   ✅   | 00:00:00.778 |
| `test_gpio_map`          | `native_gpio_map`       |     9 |   ✅   | 00:00:00.772 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     8 |   ✅   | 00:00:00.777 |
| `test_statsd`            | `native_statsd`         |    10 |   ✅   | 00:00:00.823 |
| `test_guardrails`        | `native_guardrails`     |     9 |   ✅   | 00:00:00.777 |
| `test_failsafe`          | `native_failsafe`       |     7 |   ✅   | 00:00:00.778 |
| `test_sleep_sched`       | `native_sleep_sched`    |     8 |   ✅   | 00:00:00.770 |
...
| `test_hart`              | `native_hart`           |     7 |   ✅   | 00:00:00.763 |
| `test_nts`               | `native_nts`            |     5 |   ✅   | 00:00:00.769 |
| `test_dds`               | `native_dds`            |     5 |   ✅   | 00:00:00.766 |
| `test_xmpp`              | `native_xmpp`           |    11 |   ✅   | 00:00:00.779 |
| `test_rawl2`             | `native_rawl2`          |     5 |   ✅   | 00:00:00.766 |
| `test_spa_router`        | `native_spa_router`     |     2 |   ✅   | 00:00:00.746 |
...
| `test_j2735`             | `native_j2735`          |    11 |   ✅   | 00:00:00.761 |
...
| `test_sep2`              | `native_sep2`           |     5 |   ✅   | 00:00:00.776 |
...
| `test_mms`               | `native_mms`            |    11 |   ✅   | 00:00:00.767 |
| `test_cclink`            | `native_cclink`         |     5 |   ✅   | 00:00:00.774 |
| `test_powerlink`         | `native_powerlink`      |     4 |   ✅   | 00:00:00.778 |
| `test_sercos`            | `native_sercos`         |     4 |   ✅   | 00:00:00.765 |
| `test_profibus`          | `native_profibus`       |     5 |   ✅   | 00:00:00.762 |
| `test_lonworks`          | `native_lonworks`       |     5 |   ✅   | 00:00:00.773 |
| `test_mbplus`            | `native_mbplus`         |     6 |   ✅   | 00:00:00.776 |
| `test_interbus`          | `native_interbus`       |     5 |   ✅   | 00:00:00.773 |
| `test_iccp`              | `native_iccp`           |     5 |   ✅   | 00:00:00.763 |
...
| `test_http_delivery`     | `native_http_delivery`  |     8 |   ✅   | 00:00:00.760 |
| `test_hw_health`         | `native_hw_health`      |     7 |   ✅   | 00:00:00.775 |
| `test_mdns_adaptive`     | `native_mdns_adaptive`  |     5 |   ✅   | 00:00:00.764 |
| `test_sockpool`          | `native_sockpool`       |     6 |   ✅   | 00:00:00.765 |
...
| `test_cc1101`            | `native_cc1101`         |    11 |   ✅   | 00:00:00.793 |
| `test_fdc2214`           | `native_fdc2214`        |     4 |   ✅   | 00:00:00.771 |
| `test_ldc1614`           | `native_ldc1614`        |     4 |   ✅   | 00:00:00.766 |
| `test_vl53l0x`           | `native_vl53l0x`        |     3 |   ✅   | 00:00:00.745 |
| `test_radio_sniff`       | `native_radio_sniff`    |     4 |   ✅   | 00:00:00.770 |
| `test_ble_gatt`          | `native_ble_gatt`       |     7 |   ✅   | 00:00:00.763 |
| `test_tls_policy`        | `native_tls_policy`     |     4 |   ✅   | 00:00:00.765 |
| `test_wisun`             | `native_wisun`          |    10 |   ✅   | 00:00:00.819 |
| `test_logbuf`            | `native_logbuf`         |     5 |   ✅   | 00:00:00.773 |
| `test_config_io`         | `native_config_io`      |     5 |   ✅   | 00:00:00.797 |
| `test_workers`           | `native_workers`        |     6 |   ✅   | 00:00:00.910 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.759 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.881 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.331 |
| `test_qpack`             | `native_qpack`          |    11 |   ✅   | 00:00:00.908 |
| `test_quic_packet`       | `native_quic_packet`    |     8 |   ✅   | 00:00:00.764 |
| `test_quic_frame`        | `native_quic_frame`     |     9 |   ✅   | 00:00:00.795 |
| `test_quic_crypto`       | `native_quic_crypto`    |     7 |   ✅   | 00:00:00.920 |
| `test_tls13_kdf`         | `native_tls13_kdf`      |     5 |   ✅   | 00:00:00.879 |
| `test_quic_tp`           | `native_quic_tp`        |     8 |   ✅   | 00:00:00.799 |
| `test_tls13_msg`         | `native_tls13_msg`      |    11 |   ✅   | 00:00:00.927 |
| `test_quic_tls`          | `native_quic_tls`       |    13 |   ✅   | 00:00:01.270 |
| `test_quic_conn`         | `native_quic_conn`      |    27 |   ✅   | 00:00:02.238 |
| `test_h3_conn`           | `native_h3_conn`        |    11 |   ✅   | 00:00:01.249 |
| `test_h3_e2e`            | `native_h3_e2e`         |     1 |   ✅   | 00:00:01.269 |
| `test_quic_server`       | `native_quic_server`    |     4 |   ✅   | 00:00:01.342 |
| `test_h3_server`         | `native_h3_server`      |     1 |   ✅   | 00:00:02.357 |
| `test_ssh_chachapoly`    | `native_ssh_chachapoly` |     4 |   ✅   | 00:00:00.811 |
