...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:08.410 |
| `test_dbm`               | `native_dbm`            |    13 |   ✅   | 00:00:00.843 |
| `test_docstore`          | `native_docstore`       |     5 |   ✅   | 00:00:00.939 |
| `test_dnc`               | `native_dnc`            |    14 |   ✅   | 00:00:00.787 |
| `test_dnc_stream`        | `native_dnc`            |     8 |   ✅   | 00:00:00.579 |
| `test_ftp`               | `native_ftp`            |    16 |   ✅   | 00:00:00.784 |
| `test_httpcache`         | `native_httpcache`      |    11 |   ✅   | 00:00:00.788 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.766 |
| `test_det_ip`            | `native_det_ip`         |    11 |   ✅   | 00:00:00.758 |
| `test_det_arena`         | `native_det_arena`      |    19 |   ✅   | 00:00:00.753 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:04.818 |
...
| `test_j1939`             | `native_j1939`          |    11 |   ✅   | 00:00:00.766 |
...
| `test_sdi12`             | `native_sdi12`          |     7 |   ✅   | 00:00:00.777 |
| `test_dmx`               | `native_dmx`            |     6 |   ✅   | 00:00:00.758 |
| `test_nmea0183`          | `native_nmea0183`       |     8 |   ✅   | 00:00:00.767 |
| `test_iolink`            | `native_iolink`         |     6 |   ✅   | 00:00:00.759 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.335 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.680 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.731 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.726 |
| `test_websocket`         | `native`                |    69 |   ✅   | 00:00:00.779 |
...
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.818 |
| `test_provisioning`      | `native_prov`           |     7 |   ✅   | 00:00:00.771 |
| `test_ssh_crypto`        | `native_ssh`            |    53 |   ✅   | 00:00:04.407 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.747 |
| `test_ssh_server`        | `native_ssh`            |    26 |   ✅   | 00:00:01.078 |
| `test_ssh_transport`     | `native_ssh`            |    37 |   ✅   | 00:00:01.817 |
| `test_ssh_channel`       | `native_ssh`            |    37 |   ✅   | 00:00:00.726 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.288 |
| `test_ssh_conn`          | `native_ssh_conn`       |    15 |   ✅   | 00:00:02.158 |
| `test_regex`             | `native_app`            |    13 |   ✅   | 00:00:01.615 |
| `test_template`          | `native_app`            |     6 |   ✅   | 00:00:00.720 |
| `test_path_params`       | `native_app`            |     8 |   ✅   | 00:00:00.720 |
| `test_digest_vectors`    | `native_app`            |     4 |   ✅   | 00:00:00.639 |
| `test_form_params`       | `native_app`            |     5 |   ✅   | 00:00:00.709 |
| `test_iface`             | `native_app`            |     7 |   ✅   | 00:00:00.711 |
| `test_json`              | `native_app`            |    28 |   ✅   | 00:00:00.687 |
| `test_response_headers`  | `native_app`            |    12 |   ✅   | 00:00:00.725 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.718 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.756 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.727 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.679 |
| `test_multipart`         | `native_app`            |    25 |   ✅   | 00:00:00.758 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.725 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.758 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.720 |
| `test_chunked`           | `native_app`            |    14 |   ✅   | 00:00:00.726 |
| `test_application`       | `native_app`            |    71 |   ✅   | 00:00:00.928 |
| `test_webdav_handler`    | `native_webdav_handler` |    29 |   ✅   | 00:00:01.717 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.601 |
| `test_snmp_ber`          | `native_snmp`           |    21 |   ✅   | 00:00:00.845 |
| `test_snmp_agent`        | `native_snmp`           |    28 |   ✅   | 00:00:00.664 |
| `test_snmp_v3`           | `native_snmp_v3`        |    22 |   ✅   | 00:00:02.969 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.974 |
...
| `test_redis_resp`        | `native_redis`          |    14 |   ✅   | 00:00:00.760 |
| `test_sqlite`            | `native_sqlite`         |    23 |   ✅   | 00:00:00.789 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.759 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.775 |
| `test_flow_export`       | `native_flow_export`    |     8 |   ✅   | 00:00:00.766 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.770 |
| `test_preempt_queue`     | `native_preempt_queue`  |    12 |   ✅   | 00:00:00.826 |
| `test_dma`               | `native_dma`            |    12 |   ✅   | 00:00:00.929 |
...
| `test_nrf24`             | `native_nrf24`          |    11 |   ✅   | 00:00:00.767 |
| `test_enocean`           | `native_enocean`        |    10 |   ✅   | 00:00:00.762 |
| `test_pn532`             | `native_pn532`          |    11 |   ✅   | 00:00:00.764 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.760 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.760 |
| `test_zigbee`            | `native_zigbee`         |    10 |   ✅   | 00:00:00.765 |
| `test_thread`            | `native_thread`         |    15 |   ✅   | 00:00:00.757 |
| `test_wamp`              | `native_wamp`           |    15 |   ✅   | 00:00:00.819 |
| `test_sunspec`           | `native_sunspec`        |     7 |   ✅   | 00:00:00.774 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.759 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.756 |
| `test_grpcweb`           | `native_grpcweb`        |     9 |   ✅   | 00:00:00.767 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    14 |   ✅   | 00:00:00.775 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.757 |
| `test_hostlink`          | `native_hostlink`       |     8 |   ✅   | 00:00:00.766 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.859 |
| `test_df1`               | `native_df1`            |    10 |   ✅   | 00:00:00.792 |
| `test_cotp`              | `native_cotp`           |     7 |   ✅   | 00:00:00.776 |
| `test_s7comm`            | `native_s7comm`         |     9 |   ✅   | 00:00:00.772 |
| `test_melsec`            | `native_melsec`         |     7 |   ✅   | 00:00:00.765 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.773 |
| `test_enip`              | `native_enip`           |     7 |   ✅   | 00:00:00.772 |
| `test_amqp`              | `native_amqp`           |     8 |   ✅   | 00:00:00.771 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.775 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.792 |
| `test_proxy_protocol`    | `native_proxy_protocol` |    10 |   ✅   | 00:00:00.766 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.809 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.813 |
| `test_ota_rollback`      | `native_ota_rollback`   |     6 |   ✅   | 00:00:00.742 |
...
| `test_dns_resolver`      | `native_dns_resolver`   |     5 |   ✅   | 00:00:00.757 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.851 |
| `test_oidc`              | `native_oidc`           |    19 |   ✅   | 00:00:14.637 |
| `test_vfs`               | `native_vfs`            |    12 |   ✅   | 00:00:00.777 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.796 |
| `test_espnow`            | `native_espnow`         |     8 |   ✅   | 00:00:00.772 |
| `test_oauth2`            | `native_oauth2`         |     9 |   ✅   | 00:00:00.803 |
| `test_opcua`             | `native_opcua`          |    47 |   ✅   | 00:00:00.915 |
| `test_opcua_client`      | `native_opcua_client`   |    20 |   ✅   | 00:00:00.843 |
| `test_keepalive`         | `native_keepalive`      |    11 |   ✅   | 00:00:01.470 |
| `test_range`             | `native_range`          |    20 |   ✅   | 00:00:01.494 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.807 |
| `test_ntlm`              | `native_smb`            |     3 |   ✅   | 00:00:00.935 |
| `test_smb_client`        | `native_smb`            |    10 |   ✅   | 00:00:00.620 |
| `test_ntlmssp`           | `native_smb`            |     5 |   ✅   | 00:00:00.600 |
| `test_smb_crypto`        | `native_smb`            |     5 |   ✅   | 00:00:00.595 |
| `test_smb2`              | `native_smb`            |    19 |   ✅   | 00:00:00.682 |
| `test_spnego`            | `native_smb`            |     4 |   ✅   | 00:00:00.603 |
| `test_smtp`              | `native_smtp`           |    22 |   ✅   | 00:00:01.021 |
...
| `test_ld2410`            | `native_ld2410`         |     8 |   ✅   | 00:00:00.751 |
| `test_mpr121`            | `native_mpr121`         |     6 |   ✅   | 00:00:00.742 |
| `test_sht3x`             | `native_sht3x`          |     6 |   ✅   | 00:00:00.751 |
| `test_pca9685`           | `native_pca9685`        |     5 |   ✅   | 00:00:00.774 |
| `test_ads1115`           | `native_ads1115`        |     5 |   ✅   | 00:00:00.759 |
| `test_ina219`            | `native_ina219`         |     5 |   ✅   | 00:00:00.780 |
| `test_hpack`             | `native_hpack`          |    15 |   ✅   | 00:00:00.940 |
| `test_h2_frame`          | `native_h2frame`        |     7 |   ✅   | 00:00:00.775 |
...
| `test_jwt`               | `native_jwt`            |    22 |   ✅   | 00:00:00.832 |
| `test_upload`            | `native_upload`         |     3 |   ✅   | 00:00:01.511 |
| `test_http_client`       | `native_http_client`    |    15 |   ✅   | 00:00:00.768 |
| `test_compliance`        | `native_compliance`     |    15 |   ✅   | 00:00:00.824 |
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.778 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.831 |
| `test_scratch`           | `native_scratch`        |    15 |   ✅   | 00:00:00.790 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.817 |
| `test_inflate`           | `native_inflate`        |    14 |   ✅   | 00:00:00.763 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.828 |
| `test_ssh_zlib`          | `native_ssh_zlib`       |     9 |   ✅   | 00:00:00.849 |
| `test_ssh_comp`          | `native_ssh_comp`       |     6 |   ✅   | 00:00:01.386 |
| `test_websocket`         | `native_ws_deflate`     |    74 |   ✅   | 00:00:01.403 |
| `test_time_source`       | `native_time_source`    |    10 |   ✅   | 00:00:00.770 |
| `test_config_store`      | `native_config_store`   |    15 |   ✅   | 00:00:00.773 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.806 |
| `test_auth_lockout`      | `native_auth_lockout`   |    12 |   ✅   | 00:00:00.793 |
| `test_csrf`              | `native_csrf`           |    10 |   ✅   | 00:00:00.832 |
...
| `test_partition_monitor` | `native_partition`      |     6 |   ✅   | 00:00:00.769 |
| `test_cbor`              | `native_cbor`           |    21 |   ✅   | 00:00:00.783 |
| `test_msgpack`           | `native_msgpack`        |    23 |   ✅   | 00:00:00.815 |
| `test_gpio_map`          | `native_gpio_map`       |     9 |   ✅   | 00:00:00.776 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     8 |   ✅   | 00:00:00.768 |
| `test_statsd`            | `native_statsd`         |    10 |   ✅   | 00:00:00.815 |
| `test_guardrails`        | `native_guardrails`     |     9 |   ✅   | 00:00:00.778 |
| `test_failsafe`          | `native_failsafe`       |     7 |   ✅   | 00:00:00.787 |
...
| `test_dshot`             | `native_dshot`          |     8 |   ✅   | 00:00:00.761 |
| `test_hart`              | `native_hart`           |     7 |   ✅   | 00:00:00.762 |
| `test_nts`               | `native_nts`            |     5 |   ✅   | 00:00:00.762 |
| `test_dds`               | `native_dds`            |     5 |   ✅   | 00:00:00.766 |
| `test_xmpp`              | `native_xmpp`           |    11 |   ✅   | 00:00:00.759 |
| `test_rawl2`             | `native_rawl2`          |     5 |   ✅   | 00:00:00.780 |
| `test_spa_router`        | `native_spa_router`     |     2 |   ✅   | 00:00:00.735 |
| `test_goose`             | `native_goose`          |     4 |   ✅   | 00:00:00.756 |
| `test_mtconnect`         | `native_mtconnect`      |    12 |   ✅   | 00:00:00.776 |
| `test_wal`               | `native_wal`            |     6 |   ✅   | 00:00:00.789 |
| `test_wal_store`         | `native_wal`            |     7 |   ✅   | 00:00:00.583 |
| `test_j2735`             | `native_j2735`          |    11 |   ✅   | 00:00:00.748 |
| `test_nema_ts2`          | `native_nema_ts2`       |     4 |   ✅   | 00:00:00.760 |
| `test_snp`               | `native_snp`            |     5 |   ✅   | 00:00:00.765 |
| `test_directnet`         | `native_directnet`      |     5 |   ✅   | 00:00:00.758 |
| `test_sep2`              | `native_sep2`           |     5 |   ✅   | 00:00:00.764 |
| `test_profinet`          | `native_profinet`       |     5 |   ✅   | 00:00:00.766 |
| `test_ntcip`             | `native_ntcip`          |     3 |   ✅   | 00:00:00.759 |
| `test_openadr`           | `native_openadr`        |     5 |   ✅   | 00:00:00.769 |
| `test_mms`               | `native_mms`            |    11 |   ✅   | 00:00:00.779 |
| `test_cclink`            | `native_cclink`         |     5 |   ✅   | 00:00:00.768 |
| `test_powerlink`         | `native_powerlink`      |     4 |   ✅   | 00:00:00.783 |
| `test_sercos`            | `native_sercos`         |     4 |   ✅   | 00:00:00.773 |
| `test_profibus`          | `native_profibus`       |     5 |   ✅   | 00:00:00.798 |
| `test_lonworks`          | `native_lonworks`       |     5 |   ✅   | 00:00:00.780 |
| `test_mbplus`            | `native_mbplus`         |     6 |   ✅   | 00:00:00.775 |
| `test_interbus`          | `native_interbus`       |     5 |   ✅   | 00:00:00.780 |
| `test_iccp`              | `native_iccp`           |     5 |   ✅   | 00:00:00.784 |
| `test_wave`              | `native_wave`           |     9 |   ✅   | 00:00:00.778 |
| `test_utmc`              | `native_utmc`           |     6 |   ✅   | 00:00:00.787 |
| `test_ocit`              | `native_ocit`           |     4 |   ✅   | 00:00:00.765 |
| `test_atc`               | `native_atc`            |     5 |   ✅   | 00:00:00.769 |
| `test_southbound`        | `native_southbound`     |     6 |   ✅   | 00:00:00.779 |
| `test_exc_decoder`       | `native_exc_decoder`    |     7 |   ✅   | 00:00:00.812 |
| `test_http_delivery`     | `native_http_delivery`  |     8 |   ✅   | 00:00:00.785 |
| `test_hw_health`         | `native_hw_health`      |     7 |   ✅   | 00:00:00.806 |
| `test_mdns_adaptive`     | `native_mdns_adaptive`  |     5 |   ✅   | 00:00:00.776 |
| `test_sockpool`          | `native_sockpool`       |     6 |   ✅   | 00:00:00.771 |
| `test_psram_pool`        | `native_psram_pool`     |     5 |   ✅   | 00:00:00.765 |
| `test_happy_eyeballs`    | `native_happy_eyeballs` |     5 |   ✅   | 00:00:00.828 |
| `test_wifi_sniffer`      | `native_wifi_sniffer`   |     6 |   ✅   | 00:00:00.774 |
| `test_link_manager`      | `native_link_manager`   |     4 |   ✅   | 00:00:00.784 |
| `test_cc1101`            | `native_cc1101`         |    11 |   ✅   | 00:00:00.770 |
...
| `test_tls_policy`        | `native_tls_policy`     |     4 |   ✅   | 00:00:00.777 |
| `test_wisun`             | `native_wisun`          |    10 |   ✅   | 00:00:00.798 |
| `test_logbuf`            | `native_logbuf`         |     5 |   ✅   | 00:00:00.769 |
| `test_config_io`         | `native_config_io`      |     5 |   ✅   | 00:00:00.798 |
...
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:01.267 |
| `test_qpack`             | `native_qpack`          |    11 |   ✅   | 00:00:00.959 |
| `test_quic_packet`       | `native_quic_packet`    |     8 |   ✅   | 00:00:00.773 |
| `test_quic_frame`        | `native_quic_frame`     |     9 |   ✅   | 00:00:00.798 |
| `test_quic_crypto`       | `native_quic_crypto`    |     7 |   ✅   | 00:00:00.926 |
| `test_tls13_kdf`         | `native_tls13_kdf`      |     5 |   ✅   | 00:00:00.842 |
| `test_quic_tp`           | `native_quic_tp`        |     8 |   ✅   | 00:00:00.797 |
| `test_tls13_msg`         | `native_tls13_msg`      |    11 |   ✅   | 00:00:00.933 |
| `test_quic_tls`          | `native_quic_tls`       |    13 |   ✅   | 00:00:01.331 |
| `test_quic_conn`         | `native_quic_conn`      |    27 |   ✅   | 00:00:02.499 |
| `test_h3_conn`           | `native_h3_conn`        |    11 |   ✅   | 00:00:01.271 |
| `test_h3_e2e`            | `native_h3_e2e`         |     1 |   ✅   | 00:00:01.281 |
| `test_quic_server`       | `native_quic_server`    |     4 |   ✅   | 00:00:01.395 |
| `test_h3_server`         | `native_h3_server`      |     1 |   ✅   | 00:00:02.164 |
| `test_ssh_chachapoly`    | `native_ssh_chachapoly` |     4 |   ✅   | 00:00:00.834 |
