...
| :----------------------- | :---------------------- | ----: | :----: | -----------: |
| `test_canopen`           | `native_canopen`        |    17 |   ✅   | 00:00:00.764 |
| `test_det_primitives`    | `native_det_primitives` |     5 |   ✅   | 00:00:00.590 |
| `test_det_ip`            | `native_det_ip`         |    11 |   ✅   | 00:00:00.592 |
| `test_det_arena`         | `native_det_arena`      |    19 |   ✅   | 00:00:00.595 |
| `test_ssh_ed25519`       | `native_ssh_ed25519`    |    16 |   ✅   | 00:00:03.210 |
| `test_crypto_kat`        | `native_crypto_kat`     |     8 |   ✅   | 00:00:01.821 |
| `test_promisc`           | `native_promisc`        |     9 |   ✅   | 00:00:00.606 |
| `test_bus_capture`       | `native_bus_capture`    |     7 |   ✅   | 00:00:00.594 |
| `test_j1939`             | `native_j1939`          |    11 |   ✅   | 00:00:00.603 |
...
| `test_iec60870`          | `native_iec60870`       |    13 |   ✅   | 00:00:00.597 |
| `test_sdi12`             | `native_sdi12`          |     7 |   ✅   | 00:00:00.593 |
| `test_dmx`               | `native_dmx`            |     6 |   ✅   | 00:00:00.593 |
| `test_nmea0183`          | `native_nmea0183`       |     8 |   ✅   | 00:00:00.621 |
| `test_iolink`            | `native_iolink`         |     6 |   ✅   | 00:00:00.592 |
| `test_sse`               | `native`                |    37 |   ✅   | 00:00:01.026 |
| `test_session`           | `native`                |    19 |   ✅   | 00:00:00.522 |
| `test_presentation`      | `native`                |    63 |   ✅   | 00:00:00.571 |
| `test_transport`         | `native`                |    44 |   ✅   | 00:00:00.584 |
| `test_websocket`         | `native`                |    69 |   ✅   | 00:00:00.615 |
| `test_http_parser`       | `native`                |    93 |   ✅   | 00:00:00.559 |
| `test_observability`     | `native_observability`  |    17 |   ✅   | 00:00:00.708 |
| `test_accept_gate`       | `native_accept_gate`    |    13 |   ✅   | 00:00:00.995 |
| `test_http_ota`          | `native_ota`            |     3 |   ✅   | 00:00:00.651 |
| `test_provisioning`      | `native_prov`           |     7 |   ✅   | 00:00:00.617 |
| `test_ssh_crypto`        | `native_ssh`            |    53 |   ✅   | 00:00:03.406 |
| `test_ssh_auth`          | `native_ssh`            |    19 |   ✅   | 00:00:00.582 |
| `test_ssh_server`        | `native_ssh`            |    26 |   ✅   | 00:00:00.866 |
| `test_ssh_transport`     | `native_ssh`            |    37 |   ✅   | 00:00:01.519 |
| `test_ssh_channel`       | `native_ssh`            |    37 |   ✅   | 00:00:00.558 |
| `test_ssh_hardening`     | `native_ssh_hardened`   |     2 |   ✅   | 00:00:01.026 |
| `test_ssh_conn`          | `native_ssh_conn`       |    15 |   ✅   | 00:00:01.671 |
| `test_regex`             | `native_app`            |    13 |   ✅   | 00:00:01.257 |
...
| `test_json`              | `native_app`            |    28 |   ✅   | 00:00:00.528 |
| `test_response_headers`  | `native_app`            |    12 |   ✅   | 00:00:00.567 |
| `test_middleware`        | `native_app`            |     9 |   ✅   | 00:00:00.558 |
| `test_digest_auth`       | `native_app`            |    11 |   ✅   | 00:00:00.602 |
| `test_web_terminal`      | `native_app`            |     9 |   ✅   | 00:00:00.556 |
| `test_defer`             | `native_app`            |     3 |   ✅   | 00:00:00.530 |
| `test_multipart`         | `native_app`            |    19 |   ✅   | 00:00:00.564 |
| `test_auth`              | `native_app`            |    13 |   ✅   | 00:00:00.563 |
| `test_file_serving`      | `native_app`            |    12 |   ✅   | 00:00:00.582 |
| `test_dispatch`          | `native_app`            |    11 |   ✅   | 00:00:00.554 |
| `test_chunked`           | `native_app`            |    14 |   ✅   | 00:00:00.570 |
| `test_application`       | `native_app`            |    71 |   ✅   | 00:00:00.772 |
| `test_webdav_handler`    | `native_webdav_handler` |    29 |   ✅   | 00:00:01.269 |
| `test_diag`              | `native_diag`           |     2 |   ✅   | 00:00:01.215 |
| `test_snmp_ber`          | `native_snmp`           |    21 |   ✅   | 00:00:00.675 |
| `test_snmp_agent`        | `native_snmp`           |    28 |   ✅   | 00:00:00.517 |
| `test_snmp_v3`           | `native_snmp_v3`        |    22 |   ✅   | 00:00:02.432 |
| `test_telnet`            | `native_telnet`         |    15 |   ✅   | 00:00:00.745 |
| `test_coap`              | `native_coap`           |    44 |   ✅   | 00:00:00.731 |
| `test_coap`              | `native_coap_observe`   |    46 |   ✅   | 00:00:00.715 |
| `test_webdav`            | `native_webdav`         |    25 |   ✅   | 00:00:00.622 |
| `test_modbus`            | `native_modbus`         |    23 |   ✅   | 00:00:00.636 |
| `test_cloudevents`       | `native_cloudevents`    |     8 |   ✅   | 00:00:00.709 |
| `test_redis_resp`        | `native_redis`          |    10 |   ✅   | 00:00:00.595 |
| `test_stomp`             | `native_stomp`          |    14 |   ✅   | 00:00:00.611 |
| `test_mqtt_sn`           | `native_mqtt_sn`        |    13 |   ✅   | 00:00:00.594 |
| `test_flow_export`       | `native_flow_export`    |     8 |   ✅   | 00:00:00.610 |
| `test_protobuf`          | `native_protobuf`       |    13 |   ✅   | 00:00:00.612 |
| `test_preempt_queue`     | `native_preempt_queue`  |    12 |   ✅   | 00:00:00.623 |
| `test_dma`               | `native_dma`            |    12 |   ✅   | 00:00:00.714 |
| `test_forward`           | `native_forward`        |    16 |   ✅   | 00:00:00.773 |
| `test_gateway`           | `native_gateway`        |    12 |   ✅   | 00:00:00.716 |
| `test_lora`              | `native_lora`           |    14 |   ✅   | 00:00:00.602 |
| `test_nrf24`             | `native_nrf24`          |    11 |   ✅   | 00:00:00.602 |
| `test_enocean`           | `native_enocean`        |    10 |   ✅   | 00:00:00.600 |
| `test_pn532`             | `native_pn532`          |    11 |   ✅   | 00:00:00.603 |
| `test_sigfox`            | `native_sigfox`         |     7 |   ✅   | 00:00:00.606 |
| `test_zwave`             | `native_zwave`          |     9 |   ✅   | 00:00:00.615 |
| `test_zigbee`            | `native_zigbee`         |    10 |   ✅   | 00:00:00.618 |
| `test_thread`            | `native_thread`         |    15 |   ✅   | 00:00:00.612 |
| `test_wamp`              | `native_wamp`           |    15 |   ✅   | 00:00:00.633 |
| `test_sunspec`           | `native_sunspec`        |     7 |   ✅   | 00:00:00.607 |
| `test_c37118`            | `native_c37118`         |     6 |   ✅   | 00:00:00.594 |
| `test_dnp3`              | `native_dnp3`           |     8 |   ✅   | 00:00:00.600 |
| `test_grpcweb`           | `native_grpcweb`        |     9 |   ✅   | 00:00:00.601 |
| `test_lwm2m_tlv`         | `native_lwm2m_tlv`      |    14 |   ✅   | 00:00:00.604 |
| `test_fins`              | `native_fins`           |     6 |   ✅   | 00:00:00.595 |
| `test_hostlink`          | `native_hostlink`       |     8 |   ✅   | 00:00:00.614 |
| `test_senml`             | `native_senml`          |     9 |   ✅   | 00:00:00.677 |
| `test_df1`               | `native_df1`            |    10 |   ✅   | 00:00:00.614 |
| `test_cotp`              | `native_cotp`           |     7 |   ✅   | 00:00:00.603 |
| `test_s7comm`            | `native_s7comm`         |     9 |   ✅   | 00:00:00.617 |
| `test_melsec`            | `native_melsec`         |     7 |   ✅   | 00:00:00.597 |
| `test_bacnet`            | `native_bacnet`         |     9 |   ✅   | 00:00:00.595 |
| `test_enip`              | `native_enip`           |     7 |   ✅   | 00:00:00.602 |
| `test_amqp`              | `native_amqp`           |     8 |   ✅   | 00:00:00.597 |
| `test_cip`               | `native_cip`            |     9 |   ✅   | 00:00:00.594 |
| `test_nats`              | `native_nats`           |    14 |   ✅   | 00:00:00.598 |
| `test_proxy_protocol`    | `native_proxy_protocol` |    10 |   ✅   | 00:00:00.605 |
| `test_sparkplug`         | `native_sparkplug`      |     7 |   ✅   | 00:00:00.630 |
| `test_modbus_master`     | `native_modbus_master`  |     5 |   ✅   | 00:00:00.626 |
| `test_ota_rollback`      | `native_ota_rollback`   |     6 |   ✅   | 00:00:00.588 |
| `test_totp`              | `native_totp`           |     5 |   ✅   | 00:00:00.620 |
| `test_webhook`           | `native_webhook`        |     9 |   ✅   | 00:00:00.602 |
| `test_radio_power`       | `native_radio_power`    |     2 |   ✅   | 00:00:00.590 |
| `test_dns_resolver`      | `native_dns_resolver`   |     5 |   ✅   | 00:00:00.611 |
| `test_audit_log`         | `native_audit_log`      |    16 |   ✅   | 00:00:00.651 |
| `test_oidc`              | `native_oidc`           |    19 |   ✅   | 00:00:10.685 |
| `test_vfs`               | `native_vfs`            |    12 |   ✅   | 00:00:00.620 |
| `test_graphql`           | `native_graphql`        |    32 |   ✅   | 00:00:00.627 |
| `test_espnow`            | `native_espnow`         |     8 |   ✅   | 00:00:00.597 |
| `test_oauth2`            | `native_oauth2`         |     9 |   ✅   | 00:00:00.627 |
| `test_opcua`             | `native_opcua`          |    47 |   ✅   | 00:00:00.721 |
| `test_opcua_client`      | `native_opcua_client`   |    20 |   ✅   | 00:00:00.664 |
| `test_keepalive`         | `native_keepalive`      |    11 |   ✅   | 00:00:01.129 |
| `test_range`             | `native_range`          |    20 |   ✅   | 00:00:01.119 |
| `test_syslog`            | `native_syslog`         |    10 |   ✅   | 00:00:00.623 |
| `test_smtp`              | `native_smtp`           |    22 |   ✅   | 00:00:00.760 |
| `test_ntp_server`        | `native_ntp_server`     |     8 |   ✅   | 00:00:00.597 |
| `test_dns_server`        | `native_dns_server`     |    13 |   ✅   | 00:00:00.600 |
| `test_rtc`               | `native_rtc`            |     9 |   ✅   | 00:00:00.608 |
| `test_ld2410`            | `native_ld2410`         |     8 |   ✅   | 00:00:00.608 |
| `test_mpr121`            | `native_mpr121`         |     6 |   ✅   | 00:00:00.603 |
| `test_sht3x`             | `native_sht3x`          |     6 |   ✅   | 00:00:00.604 |
| `test_pca9685`           | `native_pca9685`        |     5 |   ✅   | 00:00:00.593 |
| `test_ads1115`           | `native_ads1115`        |     5 |   ✅   | 00:00:00.603 |
| `test_ina219`            | `native_ina219`         |     5 |   ✅   | 00:00:00.597 |
| `test_hpack`             | `native_hpack`          |    15 |   ✅   | 00:00:00.700 |
| `test_h2_frame`          | `native_h2frame`        |     7 |   ✅   | 00:00:00.603 |
| `test_h2_conn`           | `native_h2conn`         |    22 |   ✅   | 00:00:00.889 |
| `test_quic_varint`       | `native_quic_varint`    |     3 |   ✅   | 00:00:00.595 |
| `test_h3_frame`          | `native_h3frame`        |     7 |   ✅   | 00:00:00.627 |
...
| `test_mqtt`              | `native_mqtt`           |    22 |   ✅   | 00:00:00.616 |
| `test_ws_client`         | `native_ws_client`      |    16 |   ✅   | 00:00:00.646 |
| `test_scratch`           | `native_scratch`        |    15 |   ✅   | 00:00:00.626 |
| `test_snmp_trap`         | `native_snmp_trap`      |     7 |   ✅   | 00:00:00.632 |
| `test_inflate`           | `native_inflate`        |    14 |   ✅   | 00:00:00.612 |
| `test_deflate`           | `native_deflate`        |    10 |   ✅   | 00:00:00.644 |
| `test_ssh_zlib`          | `native_ssh_zlib`       |     9 |   ✅   | 00:00:00.665 |
| `test_ssh_comp`          | `native_ssh_comp`       |     6 |   ✅   | 00:00:01.058 |
| `test_websocket`         | `native_ws_deflate`     |    74 |   ✅   | 00:00:01.077 |
| `test_time_source`       | `native_time_source`    |    10 |   ✅   | 00:00:00.590 |
| `test_config_store`      | `native_config_store`   |    15 |   ✅   | 00:00:00.601 |
| `test_device_id`         | `native_device_id`      |     4 |   ✅   | 00:00:00.628 |
| `test_auth_lockout`      | `native_auth_lockout`   |    12 |   ✅   | 00:00:00.637 |
| `test_csrf`              | `native_csrf`           |    10 |   ✅   | 00:00:00.669 |
| `test_telemetry`         | `native_telemetry`      |     8 |   ✅   | 00:00:00.611 |
| `test_dashboard`         | `native_dashboard`      |    15 |   ✅   | 00:00:00.631 |
| `test_net_egress`        | `native_net_egress`     |     6 |   ✅   | 00:00:00.587 |
| `test_partition_monitor` | `native_partition`      |     6 |   ✅   | 00:00:00.614 |
| `test_cbor`              | `native_cbor`           |    21 |   ✅   | 00:00:00.612 |
| `test_msgpack`           | `native_msgpack`        |    23 |   ✅   | 00:00:00.620 |
| `test_gpio_map`          | `native_gpio_map`       |     9 |   ✅   | 00:00:00.622 |
| `test_udp_telemetry`     | `native_udp_telemetry`  |     8 |   ✅   | 00:00:00.602 |
| `test_statsd`            | `native_statsd`         |    10 |   ✅   | 00:00:00.640 |
| `test_guardrails`        | `native_guardrails`     |     9 |   ✅   | 00:00:00.602 |
| `test_failsafe`          | `native_failsafe`       |     7 |   ✅   | 00:00:00.612 |
| `test_sleep_sched`       | `native_sleep_sched`    |     8 |   ✅   | 00:00:00.607 |
| `test_wearlevel`         | `native_wearlevel`      |     5 |   ✅   | 00:00:00.598 |
| `test_netadapt`          | `native_netadapt`       |     6 |   ✅   | 00:00:00.575 |
| `test_dshot`             | `native_dshot`          |     8 |   ✅   | 00:00:00.597 |
| `test_hart`              | `native_hart`           |     7 |   ✅   | 00:00:00.596 |
| `test_nts`               | `native_nts`            |     5 |   ✅   | 00:00:00.597 |
| `test_dds`               | `native_dds`            |     5 |   ✅   | 00:00:00.593 |
| `test_xmpp`              | `native_xmpp`           |    11 |   ✅   | 00:00:00.618 |
| `test_rawl2`             | `native_rawl2`          |     5 |   ✅   | 00:00:00.593 |
| `test_spa_router`        | `native_spa_router`     |     2 |   ✅   | 00:00:00.578 |
| `test_goose`             | `native_goose`          |     4 |   ✅   | 00:00:00.604 |
| `test_mtconnect`         | `native_mtconnect`      |    12 |   ✅   | 00:00:00.612 |
| `test_j2735`             | `native_j2735`          |    11 |   ✅   | 00:00:00.625 |
| `test_nema_ts2`          | `native_nema_ts2`       |     4 |   ✅   | 00:00:00.600 |
| `test_snp`               | `native_snp`            |     5 |   ✅   | 00:00:00.633 |
| `test_directnet`         | `native_directnet`      |     5 |   ✅   | 00:00:00.603 |
| `test_sep2`              | `native_sep2`           |     5 |   ✅   | 00:00:00.598 |
| `test_profinet`          | `native_profinet`       |     5 |   ✅   | 00:00:00.602 |
| `test_ntcip`             | `native_ntcip`          |     3 |   ✅   | 00:00:00.593 |
| `test_openadr`           | `native_openadr`        |     5 |   ✅   | 00:00:00.628 |
| `test_mms`               | `native_mms`            |    11 |   ✅   | 00:00:00.607 |
| `test_cclink`            | `native_cclink`         |     5 |   ✅   | 00:00:00.608 |
| `test_powerlink`         | `native_powerlink`      |     4 |   ✅   | 00:00:00.611 |
| `test_sercos`            | `native_sercos`         |     4 |   ✅   | 00:00:00.594 |
| `test_profibus`          | `native_profibus`       |     5 |   ✅   | 00:00:00.627 |
| `test_lonworks`          | `native_lonworks`       |     5 |   ✅   | 00:00:00.599 |
| `test_mbplus`            | `native_mbplus`         |     6 |   ✅   | 00:00:00.623 |
| `test_interbus`          | `native_interbus`       |     5 |   ✅   | 00:00:00.601 |
| `test_iccp`              | `native_iccp`           |     5 |   ✅   | 00:00:00.603 |
| `test_wave`              | `native_wave`           |     9 |   ✅   | 00:00:00.632 |
| `test_utmc`              | `native_utmc`           |     6 |   ✅   | 00:00:00.643 |
| `test_ocit`              | `native_ocit`           |     4 |   ✅   | 00:00:00.614 |
| `test_atc`               | `native_atc`            |     5 |   ✅   | 00:00:00.603 |
| `test_southbound`        | `native_southbound`     |     6 |   ✅   | 00:00:00.599 |
| `test_exc_decoder`       | `native_exc_decoder`    |     7 |   ✅   | 00:00:00.611 |
| `test_http_delivery`     | `native_http_delivery`  |     8 |   ✅   | 00:00:00.631 |
| `test_hw_health`         | `native_hw_health`      |     7 |   ✅   | 00:00:00.596 |
| `test_mdns_adaptive`     | `native_mdns_adaptive`  |     5 |   ✅   | 00:00:00.623 |
| `test_sockpool`          | `native_sockpool`       |     6 |   ✅   | 00:00:00.601 |
| `test_psram_pool`        | `native_psram_pool`     |     5 |   ✅   | 00:00:00.593 |
| `test_happy_eyeballs`    | `native_happy_eyeballs` |     5 |   ✅   | 00:00:00.641 |
| `test_wifi_sniffer`      | `native_wifi_sniffer`   |     6 |   ✅   | 00:00:00.601 |
| `test_link_manager`      | `native_link_manager`   |     4 |   ✅   | 00:00:00.609 |
| `test_cc1101`            | `native_cc1101`         |    11 |   ✅   | 00:00:00.592 |
| `test_fdc2214`           | `native_fdc2214`        |     4 |   ✅   | 00:00:00.596 |
| `test_ldc1614`           | `native_ldc1614`        |     4 |   ✅   | 00:00:00.594 |
| `test_vl53l0x`           | `native_vl53l0x`        |     3 |   ✅   | 00:00:00.586 |
| `test_radio_sniff`       | `native_radio_sniff`    |     4 |   ✅   | 00:00:00.600 |
| `test_ble_gatt`          | `native_ble_gatt`       |     7 |   ✅   | 00:00:00.612 |
| `test_tls_policy`        | `native_tls_policy`     |     4 |   ✅   | 00:00:00.595 |
| `test_wisun`             | `native_wisun`          |    10 |   ✅   | 00:00:00.641 |
| `test_logbuf`            | `native_logbuf`         |     5 |   ✅   | 00:00:00.606 |
| `test_config_io`         | `native_config_io`      |     5 |   ✅   | 00:00:00.631 |
| `test_workers`           | `native_workers`        |     6 |   ✅   | 00:00:00.713 |
| `test_clock`             | `native_clock`          |     7 |   ✅   | 00:00:00.587 |
| `test_concurrency`       | `native_concurrency`    |     2 |   ✅   | 00:00:00.713 |
| `test_concurrency`       | `native_tsan`           |     2 |   ✅   | 00:00:00.862 |
| `test_qpack`             | `native_qpack`          |    11 |   ✅   | 00:00:00.720 |
| `test_quic_packet`       | `native_quic_packet`    |     8 |   ✅   | 00:00:00.612 |
| `test_quic_frame`        | `native_quic_frame`     |     9 |   ✅   | 00:00:00.631 |
| `test_quic_crypto`       | `native_quic_crypto`    |     7 |   ✅   | 00:00:00.716 |
| `test_tls13_kdf`         | `native_tls13_kdf`      |     5 |   ✅   | 00:00:00.656 |
| `test_quic_tp`           | `native_quic_tp`        |     8 |   ✅   | 00:00:00.626 |
| `test_tls13_msg`         | `native_tls13_msg`      |    11 |   ✅   | 00:00:00.710 |
| `test_quic_tls`          | `native_quic_tls`       |    13 |   ✅   | 00:00:01.009 |
| `test_quic_conn`         | `native_quic_conn`      |    27 |   ✅   | 00:00:01.749 |
| `test_h3_conn`           | `native_h3_conn`        |    11 |   ✅   | 00:00:00.969 |
| `test_h3_e2e`            | `native_h3_e2e`         |     1 |   ✅   | 00:00:00.999 |
| `test_quic_server`       | `native_quic_server`    |     4 |   ✅   | 00:00:01.034 |
| `test_h3_server`         | `native_h3_server`      |     1 |   ✅   | 00:00:01.601 |
| `test_ssh_chachapoly`    | `native_ssh_chachapoly` |     4 |   ✅   | 00:00:00.640 |
