...
void test_streams_document(void)
{
    ...
    pc_mtc_streams_add(&s, pc_mtc_category::PC_MTC_EVENT, "Availability", "avail", 40, "2026-07-06T00:00:00Z",
                       "AVAILABLE");
    pc_mtc_streams_add(&s, pc_mtc_category::PC_MTC_SAMPLE, "Position", "xpos", 41, "2026-07-06T00:00:01Z", "12.5");
    pc_mtc_streams_add(&s, pc_mtc_category::PC_MTC_CONDITION, "SystemCondition", "sys", 42, "2026-07-06T00:00:02Z",
                       "Fault");
...
void test_streams_escapes_value(void)
{
    ...
    pc_mtc_streams_add(&s, pc_mtc_category::PC_MTC_EVENT, "Message", "msg", 1, "T", "a<b&c");
...
void test_overflow_returns_zero(void)
{
    ...
    pc_mtc_streams_add(&s, pc_mtc_category::PC_MTC_SAMPLE, "Position", "x", 1, "T", "1.0");
...
void test_escape_gt_quote_and_overflow()
{
    ...
    pc_mtc_streams_add(&s2, pc_mtc_category::PC_MTC_SAMPLE, "Position", "xpos", 1, "2026-07-06T00:00:01Z", "12.5");
...
void test_devices_probe_document(void)
{
    ...
    pc_mtc_devices_add_item(&s, pc_mtc_category::PC_MTC_SAMPLE, "xpos", "Position", "Xabs", "MILLIMETER");
    pc_mtc_devices_add_item(&s, pc_mtc_category::PC_MTC_CONDITION, "sys", "SystemCondition", nullptr, nullptr);
...
void test_devices_escape_and_overflow(void)
{
    ...
    pc_mtc_devices_add_item(&s, pc_mtc_category::PC_MTC_EVENT, "i\"d", "T>y", nullptr, nullptr);
    ...
    pc_mtc_devices_add_item(&s2, pc_mtc_category::PC_MTC_SAMPLE, "xpos", "Position", "Xabs", "MILLIMETER");
...
void test_assets_document(void)
{
    ...
    pc_mtc_assets_cutting_tool_begin(&s, "tool-2", nullptr, nullptr, nullptr, nullptr);
    pc_mtc_assets_tool_life(&s, "PART_COUNT", "UP", nullptr, "7");
    pc_mtc_assets_cutting_tool_end(&s);
...
void test_assets_escape_and_overflow(void)
{
    ...
    pc_mtc_assets_cutting_tool_begin(&s, "a<1", "s&n", nullptr, nullptr, nullptr);
    pc_mtc_assets_tool_life(&s, "WEAR", "UP", nullptr, "1>2");
    pc_mtc_assets_cutting_tool_end(&s);
    ...
    pc_mtc_assets_cutting_tool_begin(&s2, "a-tool-with-a-very-long-asset-id", nullptr, nullptr, nullptr, nullptr);
...
void test_sample_buffer_and_query(void)
{
    ...
    TEST_ASSERT_EQUAL_UINT64(
        1, pc_mtc_sample_buffer_add(&b, pc_mtc_category::PC_MTC_SAMPLE, "Position", "xpos", "T1", "1.0"));
    TEST_ASSERT_EQUAL_UINT64(
        2, pc_mtc_sample_buffer_add(&b, pc_mtc_category::PC_MTC_SAMPLE, "Position", "xpos", "T2", "2.0"));
    TEST_ASSERT_EQUAL_UINT64(
        3, pc_mtc_sample_buffer_add(&b, pc_mtc_category::PC_MTC_EVENT, "Execution", "exec", "T3", "ACTIVE"));
...
void test_sample_buffer_eviction(void)
{
    ...
    for (uint32_t i = 1; i <= total; i++)
    {
        ...
        ts[p] = '\0';
        pc_mtc_sample_buffer_add(&b, pc_mtc_category::PC_MTC_SAMPLE, "Position", "xpos", ts, "9.9");
    }
...
void test_sample_query_future_and_empty(void)
{
    ...
    pc_mtc_sample_buffer_add(&b, pc_mtc_category::PC_MTC_SAMPLE, "Position", "xpos", "T", "1.0"); // seq 5
...
void test_streams_null_strings(void)
{
    char buf[1024];
    pc_mtc_streams s;
    pc_mtc_streams_begin(&s, buf, sizeof(buf), 1, 1, nullptr);
    pc_mtc_streams_add(&s, pc_mtc_category::PC_MTC_SAMPLE, nullptr, nullptr, 7, nullptr, nullptr);
    pc_mtc_streams_add(&s, pc_mtc_category::PC_MTC_CONDITION, nullptr, nullptr, 8, nullptr, nullptr);
    size_t n = pc_mtc_streams_end(&s);
    TEST_ASSERT_TRUE(n > 0);
    TEST_ASSERT_EQUAL_size_t(strlen(buf), n);
...
void test_builders_reject_null_buffer_and_zero_cap(void)
{
    ...
    pc_mtc_streams_begin(&s, nullptr, sizeof(b), 1, 1, "d");
    TEST_ASSERT_FALSE(s.ok);
    pc_mtc_streams_add(&s, pc_mtc_category::PC_MTC_EVENT, "T", "i", 1, "ts", "v");
    TEST_ASSERT_EQUAL_size_t(0, pc_mtc_streams_end(&s));
    pc_mtc_streams_begin(&s, b, 0, 1, 1, "d");
    TEST_ASSERT_FALSE(s.ok);
    TEST_ASSERT_EQUAL_size_t(0, pc_mtc_streams_end(&s));

    pc_mtc_devices_begin(&s, nullptr, sizeof(b), 1, "d", "n", "u");
    TEST_ASSERT_FALSE(s.ok);
    pc_mtc_devices_add_item(&s, pc_mtc_category::PC_MTC_EVENT, "i", "T", "n", "mm");
    TEST_ASSERT_EQUAL_size_t(0, pc_mtc_devices_end(&s));
    pc_mtc_devices_begin(&s, b, 0, 1, "d", "n", "u");
    TEST_ASSERT_FALSE(s.ok);
    TEST_ASSERT_EQUAL_size_t(0, pc_mtc_devices_end(&s));

    pc_mtc_assets_begin(&s, nullptr, sizeof(b), 1, 1, 1);
    TEST_ASSERT_FALSE(s.ok);
    pc_mtc_assets_cutting_tool_begin(&s, "a", nullptr, nullptr, nullptr, nullptr);
    pc_mtc_assets_cutting_tool_end(&s);
    ...
    TEST_ASSERT_EQUAL_size_t(0, pc_mtc_error(1, "E", "m", nullptr, sizeof(b)));
...
{
    char buf[512];
    size_t n = pc_mtc_error(7, nullptr, nullptr, buf, sizeof(buf));
    TEST_ASSERT_TRUE(n > 0);
...
void test_devices_null_ids_and_empty_optionals(void)
{
    char buf[1024];
    pc_mtc_streams s;
    pc_mtc_devices_begin(&s, buf, sizeof(buf), 1, nullptr, nullptr, nullptr);
    pc_mtc_devices_add_item(&s, pc_mtc_category::PC_MTC_SAMPLE, nullptr, nullptr, "", "");
    size_t n = pc_mtc_devices_end(&s);
    TEST_ASSERT_TRUE(n > 0);
...
void test_assets_empty_optionals_and_null_strings(void)
{
    ...
    pc_mtc_assets_cutting_tool_begin(&s, nullptr, "", "", "", "");
    pc_mtc_assets_tool_life(&s, nullptr, nullptr, "", nullptr);
    pc_mtc_assets_cutting_tool_end(&s);
    size_t n = pc_mtc_assets_end(&s);
    TEST_ASSERT_TRUE(n > 0);
    TEST_ASSERT_EQUAL_size_t(strlen(buf), n);
...
void test_sample_buffer_null_and_truncated_fields(void)
{
    ...
    TEST_ASSERT_EQUAL_UINT64(
        1, pc_mtc_sample_buffer_add(&b, pc_mtc_category::PC_MTC_EVENT, nullptr, nullptr, nullptr, nullptr));
    ...
    TEST_ASSERT_EQUAL_UINT64(2,
                             pc_mtc_sample_buffer_add(&b, pc_mtc_category::PC_MTC_SAMPLE, long_type, "x", "T2", "1.0"));

    char buf[4096];
    size_t n = pc_mtc_sample_query(&b, buf, sizeof(buf), 1, nullptr, 1, 10);
    TEST_ASSERT_TRUE(n > 0);
    TEST_ASSERT_EQUAL_size_t(strlen(buf), n);
...
void test_sample_query_rejects_null_buffer_and_zero_cap(void)
{
    pc_mtc_sample_buffer b;
    pc_mtc_sample_buffer_init(&b, 1);
    pc_mtc_sample_buffer_add(&b, pc_mtc_category::PC_MTC_SAMPLE, "Position", "x", "T", "1.0");
    TEST_ASSERT_EQUAL_size_t(0, pc_mtc_sample_query(&b, nullptr, 512, 1, "d", 1, 10));
    char buf[512];
