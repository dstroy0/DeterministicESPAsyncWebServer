...
void test_dh_derive_keys_gcm_installs()
{
    ...
    pc_aesgcm_seal(reinterpret_cast<struct pc_aesgcm_key *>(ssh_keys[0].gcm_ctx_c2s), ssh_keys[0].aes_iv_c2s, aad,
    ...
    pc_aesgcm_seal(reinterpret_cast<struct pc_aesgcm_key *>(ssh_keys[0].gcm_ctx_s2c), ssh_keys[0].aes_iv_s2c, aad,
                   sizeof(aad), pt, sizeof(pt), seal_km, seal_km + sizeof(pt));
