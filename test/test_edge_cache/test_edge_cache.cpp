...
static void test_storeability()
{
    ...
    TEST_ASSERT_TRUE(edge_is_storeable(200, "GET", nullptr, "Accept-Encoding", PC_EDGE_BODY_MAX));
    ...
    TEST_ASSERT_FALSE(edge_is_storeable(200, "GET", &cc, nullptr, PC_EDGE_BODY_MAX + 1)); // oversize
}
