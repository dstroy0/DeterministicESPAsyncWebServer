...
void test_io_error_and_args()
{
    ...
    TEST_ASSERT_EQUAL_INT(DNC_STREAM_ERR_ARG, dnc_stream(nullptr, "M30", 3, mock_send, mock_recv, &m));
    TEST_ASSERT_EQUAL_INT(DNC_STREAM_ERR_ARG, dnc_stream(&cfg, nullptr, 3, mock_send, mock_recv, &m));
}
