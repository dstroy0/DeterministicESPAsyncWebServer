...
inline const uint8_t *&_mock_data()   { static const uint8_t *p = nullptr; return p; }
inline size_t        &_mock_size()    { static size_t s = 0; return s; }
inline bool          &_mock_valid()   { static bool v = false; return v; }
