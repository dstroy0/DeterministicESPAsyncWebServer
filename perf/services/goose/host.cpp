...
//   g++ -O2 -std=c++17 -Isrc -Itest/mocks -Itest/support -DDWS_ENABLE_GOOSE=1 -DDWS_ENABLE_RAWL2=1 \
//       perf/services/goose/host.cpp src/services/goose/goose.cpp -o /tmp/bg && /tmp/bg

#define DWS_ENABLE_GOOSE 1
#define DWS_ENABLE_RAWL2 1
