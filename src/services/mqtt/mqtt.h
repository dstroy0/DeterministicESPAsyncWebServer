 ...
 *  - det_mqtt_connect() / det_mqtt_publish() / det_mqtt_subscribe() / det_mqtt_loop() resolve the
...
/** @brief Register the inbound-message callback (call before det_mqtt_connect). */
