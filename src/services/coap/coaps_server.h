...
#endif
#ifndef DETWS_COAPS_IDLE_MS
#define DETWS_COAPS_IDLE_MS 60000 ///< reclaim a connection with no inbound datagram for this long (§idle-reaping)
#endif
