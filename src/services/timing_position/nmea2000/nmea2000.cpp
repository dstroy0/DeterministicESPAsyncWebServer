...
bool pc_n2k_fastpacket_build_frame(CanFrame *out, uint8_t seq, uint8_t frame_idx, uint8_t priority, uint32_t pgn,
...
N2kFpResult pc_n2k_fastpacket_feed(N2kFastPacketRx *rx, const CanFrame *f)
{
    ...
    {
        return N2kFpResult::N2K_FP_IGNORED; // GCOVR_EXCL_LINE  unreachable: pc_j1939_decode_id only fails on a null
                                            // out, and &id is non-null
    }
...
bool pc_n2k_build_single(CanFrame *out, uint8_t priority, uint32_t pgn, uint8_t sa, uint8_t da, const uint8_t *data,
                         uint8_t len)
{
...
bool pc_n2k_decode_position_rapid(const uint8_t *payload, size_t len, N2kPositionRapid *out)
{
...
bool pc_n2k_decode_cog_sog_rapid(const uint8_t *payload, size_t len, N2kCogSogRapid *out)
{
...
bool pc_n2k_decode_engine_rapid(const uint8_t *payload, size_t len, N2kEngineRapid *out)
{
...
bool pc_n2k_decode_temperature(const uint8_t *payload, size_t len, N2kTemperature *out)
{
...
bool pc_n2k_decode_battery_status(const uint8_t *payload, size_t len, N2kBatteryStatus *out)
{
...
bool pc_n2k_decode_fluid_level(const uint8_t *payload, size_t len, N2kFluidLevel *out)
{
...
bool pc_n2k_decode_actual_pressure(const uint8_t *payload, size_t len, N2kActualPressure *out)
{
...
bool pc_n2k_decode_rudder(const uint8_t *payload, size_t len, N2kRudder *out)
{
...
bool pc_n2k_decode_attitude(const uint8_t *payload, size_t len, N2kAttitude *out)
{
...
bool pc_n2k_decode_engine_dynamic(const uint8_t *payload, size_t len, N2kEngineDynamic *out)
{
...
bool pc_n2k_decode_wind_data(const uint8_t *payload, size_t len, N2kWindData *out)
{
...
bool pc_n2k_decode_speed(const uint8_t *payload, size_t len, N2kSpeed *out)
{
...
bool pc_n2k_decode_water_depth(const uint8_t *payload, size_t len, N2kWaterDepth *out)
{
...
bool pc_n2k_decode_vessel_heading(const uint8_t *payload, size_t len, N2kVesselHeading *out)
{
    if (!payload || !out || len < 8)
    {
        return false;
