...
static bool cc_match(pc_cache_control *cc, const char *name, size_t nlen, const char *val, size_t vlen)
{
...
static bool cache_parse_one_directive(const char *s, size_t len, size_t *i, pc_cache_control *cc)
{
