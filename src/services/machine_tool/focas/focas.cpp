...
{
    return pc_focas_build_request(buf, cap, FocasCommand::sys_info, 0, 0, 0, 0, 0, nullptr, 0);
}

size_t pc_focas_build_read_alarm(uint8_t *buf, size_t cap)
{
    return pc_focas_build_request(buf, cap, FocasCommand::read_alarm, 0, 0, 0, 0, 0, nullptr, 0);
}

size_t pc_focas_build_read_param(uint8_t *buf, size_t cap, int32_t first, int32_t last, int32_t axis)
{
    return pc_focas_build_request(buf, cap, FocasCommand::read_cnc_param, first, last, axis, 0, 0, nullptr, 0);
}

size_t pc_focas_build_read_macro(uint8_t *buf, size_t cap, int32_t first, int32_t last)
{
    return pc_focas_build_request(buf, cap, FocasCommand::read_macro, first, last, 0, 0, 0, nullptr, 0);
}

size_t pc_focas_build_read_position(uint8_t *buf, size_t cap, int32_t kind, int32_t axis)
{
    return pc_focas_build_request(buf, cap, FocasCommand::read_position, kind, axis, 0, 0, 0, nullptr, 0);
}

size_t pc_focas_build_read_feedrate(uint8_t *buf, size_t cap)
{
    return pc_focas_build_request(buf, cap, FocasCommand::read_feedrate, 0, 0, 0, 0, 0, nullptr, 0);
}

size_t pc_focas_build_read_spindle(uint8_t *buf, size_t cap)
{
    return pc_focas_build_request(buf, cap, FocasCommand::read_spindle, 0, 0, 0, 0, 0, nullptr, 0);
}
