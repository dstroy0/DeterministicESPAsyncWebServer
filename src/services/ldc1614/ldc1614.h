 ...
 *
 * This codec is pure and host-tested: ::dws_ldc1614_data combines the register pair, ::dws_ldc1614_error pulls
 * the flags, ::dws_ldc1614_sensor_freq_hz scales to frequency, and ::dws_ldc1614_build_config emits a
