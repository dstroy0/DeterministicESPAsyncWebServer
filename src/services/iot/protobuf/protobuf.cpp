...
static bool pc_pb_write_le(PbWriter *w, uint64_t v, size_t n)
{
...
bool pc_pb_uint64(PbWriter *w, uint32_t field, uint64_t v)
{
    return pc_pb_write_tag(w, field, PB_WT_VARINT) && pc_pb_write_varint(w, v);
}

bool pc_pb_int64(PbWriter *w, uint32_t field, int64_t v)
{
    return pc_pb_uint64(w, field, (uint64_t)v); // two's complement; negatives take 10 bytes
}

bool pc_pb_sint64(PbWriter *w, uint32_t field, int64_t v)
{
...
bool pc_pb_fixed32(PbWriter *w, uint32_t field, uint32_t v)
{
    return pc_pb_write_tag(w, field, PB_WT_I32) && pc_pb_write_le(w, v, 4);
}

bool pc_pb_fixed64(PbWriter *w, uint32_t field, uint64_t v)
{
...
bool pc_pb_bytes(PbWriter *w, uint32_t field, const uint8_t *data, size_t len)
{
