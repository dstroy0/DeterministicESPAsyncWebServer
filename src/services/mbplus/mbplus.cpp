...
{
    // CRC-16/X-25: reflected poly 0x8408, init 0xFFFF, xorout 0xFFFF. test_crc diffs the shared
    // engine against the loop that used to live here over every length 0..64.
