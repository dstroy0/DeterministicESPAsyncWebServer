 ...
 *
 * This codec is pure and host-tested: ::pca9685_prescale computes the prescale for a frequency,
 * ::pca9685_us_to_count converts a servo pulse width to a 12-bit count, ::pca9685_channel_reg
 * gives a channel's register base, and ::pca9685_set_pwm_bytes emits the 5-byte channel write.
