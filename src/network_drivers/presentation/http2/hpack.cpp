...
// --- Tables generated from RFC 7541 (Appendix A static, Appendix B Huffman) ------------------

// Huffman: MSB-aligned code and bit length per symbol 0..255, plus EOS(256).
...
// Static table (1-indexed; entry 0 is a placeholder). {name, value}.
