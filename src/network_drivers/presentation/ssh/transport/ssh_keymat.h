...
// travels as a uint8_t through SshDh.derive_keys_sid, ssh_mac_is_etm, ssh_mac_len, and the
 ...
 *
 * FIELD LIFETIME:
 *   y  - generated by SshDh.generate(); zeroed in ssh_dh_wipe().
 *   f  - computed in SshDh.generate() as g^y mod p; sent in KEXDH_REPLY;
