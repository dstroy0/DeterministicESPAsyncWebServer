...
bool pc_quic_tp_apply_cid(uint64_t id, const uint8_t *val, size_t vlen, QuicTransportParams *tp, bool *handled)
{
    *handled = true;
    switch (id)
    {
...
bool pc_quic_tp_apply_varint(uint64_t id, const uint8_t *val, size_t vlen, QuicTransportParams *tp, bool *handled)
{
    *handled = true;
    switch (id)
    {
...
bool pc_quic_tp_apply(uint64_t id, const uint8_t *val, size_t vlen, QuicTransportParams *tp)
{
    bool handled = false;
