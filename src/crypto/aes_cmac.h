...
#ifndef DETERMINISTICESPASYNCWEBSERVER_CRYPTO_AES_CMAC_H
#define DETERMINISTICESPASYNCWEBSERVER_CRYPTO_AES_CMAC_H

#include <stddef.h>
#include <stdint.h>

/** @brief AES-128-CMAC output length (one AES block). */
static constexpr size_t DWS_AES_CMAC_LEN = 16;
...
#endif // DETERMINISTICESPASYNCWEBSERVER_CRYPTO_AES_CMAC_H
