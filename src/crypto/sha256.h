...
#ifndef DETERMINISTICESPASYNCWEBSERVER_CRYPTO_SHA256_H
#define DETERMINISTICESPASYNCWEBSERVER_CRYPTO_SHA256_H

#include <stddef.h>
#include <stdint.h>

/** @brief SHA-256 digest length in bytes. */
#define DWS_SHA256_DIGEST_LEN 32

/** @brief SHA-256 block size in bytes. */
#define DWS_SHA256_BLOCK_LEN 64
 ...
 * @param digest  Output buffer, DWS_SHA256_DIGEST_LEN bytes.
 */
...
#endif // DETERMINISTICESPASYNCWEBSERVER_CRYPTO_SHA256_H
