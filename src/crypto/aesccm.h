 ...
 * the native host a compact software AES (crypto/aes_block.h, shared with the GCM modules) drives the same
...
#ifndef DETERMINISTICESPASYNCWEBSERVER_CRYPTO_AESCCM_H
#define DETERMINISTICESPASYNCWEBSERVER_CRYPTO_AESCCM_H
...
#endif // DETERMINISTICESPASYNCWEBSERVER_CRYPTO_AESCCM_H
