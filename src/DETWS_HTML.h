 ...
 */
static const char DETWS_PROV_FORM[] = "<!DOCTYPE html><html><head><meta name=viewport content='width=device-width'>"
 ...
 */
static const char DETWS_PROV_SAVED_HTML[] = "<html><body>Saved. Rebooting...</body></html>";
