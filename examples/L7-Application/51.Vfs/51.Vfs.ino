...
/**
 * @file 51.Vfs.ino
 * @brief Unified VFS over a real filesystem (DWS_ENABLE_VFS).
 *
 * The same dws_vfs_* API drives a RAM pool in tests and a real filesystem on
 ...
 * backend: `dws_vfs_mount(dws_vfs_ram());` - every endpoint below is
