# 03.InterfaceFilter - per-interface (STA / softAP) routes
...
pio ci --board=esp32dev --project-option="framework=arduino" \
  --lib="." examples/L7-Application/03.InterfaceFilter/03.InterfaceFilter.ino
```
...
The complete sketch ([03.InterfaceFilter.ino](03.InterfaceFilter.ino)),
