...
**Layer:** L7 Application · **Build flags:** `PC_ENABLE_COAP`, `PC_ENABLE_COAP_BLOCK`, `PC_COAP_MAX_PAYLOAD`
...
`PC_COAP_MAX_PAYLOAD` sizes the static reassembly buffer; set it to the largest
