...
void setup()
{
    ...
    dws_log_set_trap(DWSLogLevel::DWS_LOG_WARN, on_trap); // trap on WARN and ERROR
    dws_log(DWSLogLevel::DWS_LOG_INFO, "boot complete");
...
void loop()
{
    ...
    if (millis() - last >= 5000)
    {
        ...
        dws_log(heap < 20000 ? DWSLogLevel::DWS_LOG_WARN : DWSLogLevel::DWS_LOG_INFO, msg);
    }
    server.handle();
}
