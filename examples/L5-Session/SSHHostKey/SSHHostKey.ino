 ...
 *       dws_ssh_hostkey_ed25519_set(). Simplest; the key ships inside the image.
 *
 *   HOST_KEY_PROVISION 2  - RUNTIME SERVICE. The RSA-2048 private key lives in NVS
 *       (namespace "ssh_host_key", key "priv_der"); dws_ssh_rsa_load_pubkey() loads its
...
static bool install_host_key()
{
    ...
    dws_ssh_hostkey_ed25519_set(HOST_KEY_SEED);
