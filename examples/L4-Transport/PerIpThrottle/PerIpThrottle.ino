 ...
 * @brief Per-source-IP connection-flood defense (DWS_ENABLE_PER_IP_THROTTLE).
 *
 * When enabled, the accept callback rejects a new connection once one source IPv4
 * address has opened more than DWS_PER_IP_THROTTLE_MAX connections within
 * DWS_PER_IP_THROTTLE_WINDOW_MS. A fixed BSS table of DWS_PER_IP_THROTTLE_SLOTS
 ...
 * global accept throttle (DWS_ENABLE_ACCEPT_THROTTLE) - see the AcceptThrottle example.
 *
 ...
 *     build_flags = -DDWS_ENABLE_PER_IP_THROTTLE=1
 *                   -DDWS_PER_IP_THROTTLE_MAX=10
 *                   -DDWS_PER_IP_THROTTLE_WINDOW_MS=10000
 *                   -DDWS_PER_IP_THROTTLE_SLOTS=16
