...
**A different setup path than plain HTTPS.** Where [03.HTTPS](../03.HTTPS) used
...
pio ci --board=esp32dev --project-option="framework=arduino" \
  --project-option="build_flags=-DDETWS_ENABLE_TLS=1 -DDETWS_ENABLE_MTLS=1" \
...
The complete sketch ([04.mTLS.ino](04.mTLS.ino)). The demo CA/server/client PEM
