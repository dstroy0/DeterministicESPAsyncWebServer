# 01.FormParams - reading urlencoded form fields
...
pio ci --board=esp32dev --project-option="framework=arduino" \
  --lib="." examples/L6-Presentation/01.FormParams/01.FormParams.ino
```
...
The complete sketch ([01.FormParams.ino](01.FormParams.ino)), reproduced verbatim
