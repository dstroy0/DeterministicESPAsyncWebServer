# 03.Expert - introspection, rate limiting, and profiling
...
> [04.Middleware](../../L7-Application/04.Middleware). This hand-rolled one shows
> the mechanism.
...
pio ci --board=esp32dev --project-option="framework=arduino" \
  --lib="." examples/Foundation/03.Expert/03.Expert.ino
```
...
The complete sketch ([03.Expert.ino](03.Expert.ino)), reproduced verbatim with
