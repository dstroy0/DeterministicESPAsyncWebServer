# 02.Advanced - a RESTful CRUD API
...
the step up from [01.Basic](../01.Basic): same three-part structure
...
> [02.Json](../../L6-Presentation/02.Json).
...
pio ci --board=esp32dev --project-option="framework=arduino" \
  --lib="." examples/Foundation/02.Advanced/02.Advanced.ino
```
...
The complete sketch ([02.Advanced.ino](02.Advanced.ino)), reproduced verbatim
