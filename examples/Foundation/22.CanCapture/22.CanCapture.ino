// 22.CanCapture - listen-only CAN capture, forwarded out Ethernet.
//
// The wired counterpart to 21.WifiCapture. Put the ESP32's CAN (TWAI) controller in LISTEN-ONLY
